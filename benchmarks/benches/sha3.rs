...
macro_rules! impl_comp {
    ($fun:ident, $libcrux:expr, $libcruxsha3:ident, $rust_crypto:ty, $openssl:expr) => {
...
*/
                ...
                group.bench_with_input(
                    BenchmarkId::new("libcrux-sha3-arm64", fmt(*payload_size)),
                    payload_size,
                    |b, payload_size| {
                        b.iter_batched(
                            || randombytes(*payload_size),
                            |payload| {
                                let _d = libcrux_sha3::sha3_arm64::$libcruxsha3(&payload);
                            },
                            BatchSize::SmallInput,
                        )
                    },
