...
)
{
  core_ops_range_Range__size_t lit;
  lit.start = (size_t)0U;
  lit.end = libcrux_kyber_constants_CPA_PKE_KEY_GENERATION_SEED_SIZE;
  Eurydice_slice
...
)
{
  ...
  uu____4 =
    Eurydice_array_to_subslice_from((size_t)1568U,
      ...
      size_t);
  core_slice___Slice_T___copy_from_slice(uu____4,
    core_array___Array_T__N__23__as_slice(160U, c2, uint8_t),
    uint8_t);
...
)
{
  ...
  uint8_t r0[32U];
  memcpy(r0,
    Eurydice_slice_to_array(shared_secret, Eurydice_slice, uint8_t [32U]).val.case_Ok,
  ...
  uint8_t uu____6[32U];
  memcpy(uu____6, r, (size_t)32U * sizeof (uint8_t));
