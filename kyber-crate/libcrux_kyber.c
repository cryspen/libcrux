...
)
{
  ...
  iter =
    core_iter_traits_collect__I__into_iter((
        (core_ops_range_Range__size_t){
          .start = (size_t)0U,
          .end = libcrux_kyber_constants_SHARED_SECRET_SIZE
        }
      ),
      core_ops_range_Range__size_t);
  while (true)
...
)
{
  ...
  iter =
    core_iter_traits_collect__I__into_iter((
        (core_ops_range_Range__size_t){ .start = (size_t)0U, .end = (size_t)128U / step }
      ),
      core_ops_range_Range__size_t);
  while (true)
  {
...
void libcrux_kyber_ntt_ntt_binomially_sampled_ring_element(int32_t re[256U], int32_t ret[256U])
{
  ...
  iter =
    core_iter_traits_collect__I__into_iter((
        (core_ops_range_Range__size_t){ .start = (size_t)0U, .end = (size_t)128U }
      ),
      core_ops_range_Range__size_t);
  while (true)
  {
...
libcrux_kyber_ntt_ntt_multiply(int32_t (*lhs)[256U], int32_t (*rhs)[256U], int32_t ret[256U])
{
  ...
  iter =
    core_iter_traits_collect__I__into_iter((
        (core_ops_range_Range__size_t){
          .start = (size_t)0U,
          .end = libcrux_kyber_constants_COEFFICIENTS_IN_RING_ELEMENT / (size_t)4U
        }
      ),
      core_ops_range_Range__size_t);
  while (true)
...
void
libcrux_kyber_matrix_sample_matrix_A___4size_t(
  uint8_t seed[34U],
  bool transpose,
  int32_t ret[4U][4U][256U]
)
{
...
{
  if (false)
    if (!(core_slice___Slice_T___len(slice, uint8_t) <= (size_t)34U))
    {
      KRML_HOST_EPRINTF("KaRaMeL abort at %s:%d\n%s\n", __FILE__, __LINE__, "assert failure");
      KRML_HOST_EXIT(255U);
    }
  uint8_t out[34U];
...
{
  if (false)
    if (!(core_slice___Slice_T___len(slice, uint8_t) <= (size_t)33U))
    {
      KRML_HOST_EPRINTF("KaRaMeL abort at %s:%d\n%s\n", __FILE__, __LINE__, "assert failure");
      KRML_HOST_EXIT(255U);
    }
...
)
{
  ...
  libcrux_kyber_matrix_sample_matrix_A___4size_t(ret, true, A_transpose);
  uint8_t prf_input[33U];
  ...
  uint8_t public_key_serialized[1568U];
  libcrux_kyber_ind_cpa_serialize_public_key___4size_t_1536size_t_1568size_t(uu____4,
    seed_for_A,
    public_key_serialized);
  int32_t uu____5[4U][256U];
  memcpy(uu____5, secret_as_ntt, (size_t)4U * sizeof (int32_t [256U]));
  uint8_t secret_key_serialized[1536U];
  libcrux_kyber_ind_cpa_serialize_secret_key___4size_t_1536size_t(uu____5,
...
)
{
  ...
  core_slice___Slice_T___copy_from_slice(Eurydice_array_to_subslice((size_t)3168U,
      ...
      (
        (core_ops_range_Range__size_t){
          .start = uu____8,
          .end = uu____9 + core_slice___Slice_T___len(implicit_rejection_value, uint8_t)
        }
      ),
      uint8_t,
      core_ops_range_Range__size_t),
    ...
    uint8_t);
  uint8_t uu____10[3168U];
  memcpy(uu____10, out, (size_t)3168U * sizeof (uint8_t));
  memcpy(ret, uu____10, (size_t)3168U * sizeof (uint8_t));
}
...
)
{
  ...
  libcrux_kyber_types__libcrux_kyber__types__KyberPrivateKey_SIZE__8__from___3168size_t(uu____2,
    private_key);
  ...
  return
    libcrux_kyber_types__libcrux_kyber__types__KyberKeyPair_PRIVATE_KEY_SIZE__PUBLIC_KEY_SIZE___from___3168size_t_1568size_t(uu____3,
      uu____4);
}
...
{
  if (false)
    if (!(core_slice___Slice_T___len(slice, uint8_t) <= (size_t)64U))
    {
      KRML_HOST_EPRINTF("KaRaMeL abort at %s:%d\n%s\n", __FILE__, __LINE__, "assert failure");
      KRML_HOST_EXIT(255U);
    }
...
)
{
  ...
  iter =
    core_iter_traits_collect__I__into_iter((
        (core_ops_range_Range__size_t){
          .start = (size_t)0U,
          .end = (size_t)1536U / libcrux_kyber_constants_BYTES_PER_RING_ELEMENT
        }
      ),
      core_ops_range_Range__size_t);
  while (true)
...
{
  if (false)
    if (!(core_slice___Slice_T___len(slice, uint8_t) <= (size_t)1568U))
    {
      KRML_HOST_EPRINTF("KaRaMeL abort at %s:%d\n%s\n", __FILE__, __LINE__, "assert failure");
      KRML_HOST_EXIT(255U);
    }
...
)
{
  ...
  libcrux_kyber_matrix_sample_matrix_A___4size_t(ret0, false, A_transpose);
  uint8_t prf_input[33U];
  ...
  K___libcrux_kyber_arithmetic_PolynomialRingElement_4size_t__uint8_t
  uu____1 =
    libcrux_kyber_ind_cpa_sample_vector_cbd_then_ntt___4size_t_2size_t_128size_t(uu____0,
      0U);
  ...
  uint8_t c1[1408U];
  libcrux_kyber_ind_cpa_compress_then_serialize_u___4size_t_1408size_t_11size_t_352size_t(uu____3,
    c1);
  uint8_t c2[160U];
  ...
  memcpy(uu____5, ciphertext, (size_t)1568U * sizeof (uint8_t));
  memcpy(ret, uu____5, (size_t)1568U * sizeof (uint8_t));
}
...
)
{
  ...
  core_result_Result__uint8_t_32size_t__core_array_TryFromSliceError uu____4 = dst;
  if (!(uu____4.tag == core_result_Ok))
  {
    if (uu____4.tag == core_result_Err)
    {
      KRML_HOST_EPRINTF("KaRaMeL abort at %s:%d\n%s\n", __FILE__, __LINE__, "panic!");
      KRML_HOST_EXIT(255U);
    }
  ...
  uint8_t r0[32U];
  memcpy(r0, uu____4.val.case_Ok, (size_t)32U * sizeof (uint8_t));
  uint8_t r[32U];
  memcpy(r, r0, (size_t)32U * sizeof (uint8_t));
  uint8_t uu____5[1568U];
  memcpy(uu____5, ciphertext, (size_t)1568U * sizeof (uint8_t));
  uint8_t uu____6[1568U];
  memcpy(uu____6, uu____5, (size_t)1568U * sizeof (uint8_t));
  uint8_t uu____7[32U];
  memcpy(uu____7, r, (size_t)32U * sizeof (uint8_t));
  K___libcrux_kyber_types_KyberCiphertext__1568size_t___uint8_t_32size_t_ lit;
...
{
  if (false)
    if (!(core_slice___Slice_T___len(slice, uint8_t) <= (size_t)1600U))
    {
      KRML_HOST_EPRINTF("KaRaMeL abort at %s:%d\n%s\n", __FILE__, __LINE__, "assert failure");
      KRML_HOST_EXIT(255U);
    }
...
)
{
  ...
  iter =
    core_iter_traits_collect__I__into_iter((
        (core_ops_range_Range__size_t){ .start = (size_t)0U, .end = (size_t)1568U }
      ),
      core_ops_range_Range__size_t);
  while (true)
  {
...
void
libcrux_kyber_matrix_sample_matrix_A___2size_t(
  uint8_t seed[34U],
  bool transpose,
  int32_t ret[2U][2U][256U]
)
{
...
)
{
  ...
  uint8_t ret[34U];
  libcrux_kyber_ind_cpa_into_padded_array___34size_t(seed_for_A, ret);
  libcrux_kyber_matrix_sample_matrix_A___2size_t(ret, true, A_transpose);
  uint8_t prf_input[33U];
  libcrux_kyber_ind_cpa_into_padded_array___33size_t(seed_for_secret_and_error, prf_input);
  uint8_t uu____1[33U];
  memcpy(uu____1, prf_input, (size_t)33U * sizeof (uint8_t));
  ...
  uint8_t public_key_serialized[800U];
  libcrux_kyber_ind_cpa_serialize_public_key___2size_t_768size_t_800size_t(uu____4,
    seed_for_A,
    public_key_serialized);
  int32_t uu____5[2U][256U];
  memcpy(uu____5, secret_as_ntt, (size_t)2U * sizeof (int32_t [256U]));
  uint8_t secret_key_serialized[768U];
  libcrux_kyber_ind_cpa_serialize_secret_key___2size_t_768size_t(uu____5, secret_key_serialized);
...
)
{
  ...
  core_slice___Slice_T___copy_from_slice(Eurydice_array_to_subslice((size_t)1632U,
    ...
    implicit_rejection_value,
    uint8_t);
  uint8_t uu____10[1632U];
  memcpy(uu____10, out, (size_t)1632U * sizeof (uint8_t));
  memcpy(ret, uu____10, (size_t)1632U * sizeof (uint8_t));
}
...
)
{
  ...
  libcrux_kyber_types__libcrux_kyber__types__KyberPrivateKey_SIZE__8__from___1632size_t(uu____2,
    private_key);
  ...
  return
    libcrux_kyber_types__libcrux_kyber__types__KyberKeyPair_PRIVATE_KEY_SIZE__PUBLIC_KEY_SIZE___from___1632size_t_800size_t(uu____3,
      uu____4);
}
...
)
{
  ...
  iter =
    core_iter_traits_collect__I__into_iter((
        (core_ops_range_Range__size_t){
          .start = (size_t)0U,
          .end = (size_t)768U / libcrux_kyber_constants_BYTES_PER_RING_ELEMENT
        }
      ),
      core_ops_range_Range__size_t);
  while (true)
...
{
  if (false)
    if (!(core_slice___Slice_T___len(slice, uint8_t) <= (size_t)768U))
    {
      KRML_HOST_EPRINTF("KaRaMeL abort at %s:%d\n%s\n", __FILE__, __LINE__, "assert failure");
      KRML_HOST_EXIT(255U);
    }
...
)
{
  ...
  uint8_t ret0[34U];
  libcrux_kyber_ind_cpa_into_padded_array___34size_t(seed, ret0);
  libcrux_kyber_matrix_sample_matrix_A___2size_t(ret0, false, A_transpose);
  uint8_t prf_input[33U];
  libcrux_kyber_ind_cpa_into_padded_array___33size_t(randomness, prf_input);
  uint8_t uu____0[33U];
  memcpy(uu____0, prf_input, (size_t)33U * sizeof (uint8_t));
  K___libcrux_kyber_arithmetic_PolynomialRingElement_2size_t__uint8_t
  uu____1 =
    libcrux_kyber_ind_cpa_sample_vector_cbd_then_ntt___2size_t_3size_t_192size_t(uu____0,
      0U);
  ...
  uint8_t c1[640U];
  libcrux_kyber_ind_cpa_compress_then_serialize_u___2size_t_640size_t_10size_t_320size_t(uu____3,
    c1);
  uint8_t c2[128U];
  ...
  memcpy(uu____5, ciphertext, (size_t)768U * sizeof (uint8_t));
  memcpy(ret, uu____5, (size_t)768U * sizeof (uint8_t));
}
...
)
{
  ...
  memcpy(uu____5, ciphertext, (size_t)768U * sizeof (uint8_t));
  uint8_t uu____6[768U];
  memcpy(uu____6, uu____5, (size_t)768U * sizeof (uint8_t));
  uint8_t uu____7[32U];
  memcpy(uu____7, r, (size_t)32U * sizeof (uint8_t));
  K___libcrux_kyber_types_KyberCiphertext__768size_t___uint8_t_32size_t_ lit;
  memcpy(lit.fst, uu____6, (size_t)768U * sizeof (uint8_t));
  memcpy(lit.snd, uu____7, (size_t)32U * sizeof (uint8_t));
  return lit;
}
...
{
  if (false)
    if (!(core_slice___Slice_T___len(slice, uint8_t) <= (size_t)800U))
    {
      KRML_HOST_EPRINTF("KaRaMeL abort at %s:%d\n%s\n", __FILE__, __LINE__, "assert failure");
      KRML_HOST_EXIT(255U);
    }
...
)
{
  ...
  libcrux_kyber_ind_cpa_serialize_secret_key___3size_t_1152size_t(uu____5,
    secret_key_serialized);
...
)
{
  ...
  libcrux_kyber_types__libcrux_kyber__types__KyberPrivateKey_SIZE__8__from___2400size_t(uu____2,
    private_key);
  ...
  return
    libcrux_kyber_types__libcrux_kyber__types__KyberKeyPair_PRIVATE_KEY_SIZE__PUBLIC_KEY_SIZE___from___2400size_t_1184size_t(uu____3,
      uu____4);
}
...
)
{
  ...
  iter =
    core_iter_traits_collect__I__into_iter((
        (core_ops_range_Range__size_t){
          .start = (size_t)0U,
          .end = (size_t)1152U / libcrux_kyber_constants_BYTES_PER_RING_ELEMENT
        }
      ),
      core_ops_range_Range__size_t);
  while (true)
...
{
  if (false)
    if (!(core_slice___Slice_T___len(slice, uint8_t) <= (size_t)1088U))
    {
      KRML_HOST_EPRINTF("KaRaMeL abort at %s:%d\n%s\n", __FILE__, __LINE__, "assert failure");
      KRML_HOST_EXIT(255U);
    }
...
)
{
  ...
  K___libcrux_kyber_arithmetic_PolynomialRingElement_3size_t__uint8_t
  uu____1 =
    libcrux_kyber_ind_cpa_sample_vector_cbd_then_ntt___3size_t_2size_t_128size_t(uu____0,
      0U);
  ...
  uint8_t c1[960U];
  libcrux_kyber_ind_cpa_compress_then_serialize_u___3size_t_960size_t_10size_t_320size_t(uu____3,
    c1);
  uint8_t c2[128U];
  libcrux_kyber_serialize_compress_then_serialize_ring_element_v___4size_t_128size_t(v, c2);
...
{
  if (false)
    if (!(core_slice___Slice_T___len(slice, uint8_t) <= (size_t)1120U))
    {
      KRML_HOST_EPRINTF("KaRaMeL abort at %s:%d\n%s\n", __FILE__, __LINE__, "assert failure");
      KRML_HOST_EXIT(255U);
    }
