...
pub(crate) const CPA_PKE_PUBLIC_KEY_SIZE : usize = (12 * RANK * COEFFICIENTS_IN_RING_ELEMENT)/8 + 32; //1184
...
pub(crate) mod hash_functions {
    ...
    pub(crate) use H;
    pub(crate) const H_DIGEST_SIZE : usize = libcrux::digest::digest_size(libcrux::digest::Algorithm::Sha3_256);
