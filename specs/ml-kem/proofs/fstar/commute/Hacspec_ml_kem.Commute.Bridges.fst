...
(* Per-lane bridge for `f_ntt_layer_1_step`, GROUND-LITERAL per-branch form
   ...
   Branch `b` owns lanes `(4b, 4b+1, 4b+2, 4b+3)` with `z = zeta_b`:
     - lane 4b, 4b+1 (idx < 2): `result = vec + z*vec[+2]`
     - lane 4b+2, 4b+3 (idx ≥ 2): `result = vec[-2] - z*vec`  *)
private
let lemma_ntt_layer_1_step_branch_0_lane_bridge
  ...
  = let zs = zetas_4_ zeta0 zeta1 zeta2 zeta3 in
    ...
    reveal_opaque (`%TS.ntt_layer_1_step_branch_post)
                  (TS.ntt_layer_1_step_branch_post 0 in_arr zeta0 zeta1 zeta2 zeta3 out_arr);
    lemma_ntt_layer_n_16_2_lane p_fe zs 0;
    lemma_ntt_layer_n_16_2_lane p_fe zs 1;
    lemma_ntt_layer_n_16_2_lane p_fe zs 2;
    lemma_ntt_layer_n_16_2_lane p_fe zs 3;
...
private
let lemma_ntt_layer_1_step_branch_1_lane_bridge
    (in_arr out_arr: t_Array i16 (mk_usize 16))
    (zeta0 zeta1 zeta2 zeta3: i16) :
  Lemma
    (requires
  ...
  = let zs = zetas_4_ zeta0 zeta1 zeta2 zeta3 in
    ...
    let r_fe = mont_i16_to_spec_array (sz 16) out_arr in
    reveal_opaque (`%TS.ntt_layer_1_step_branch_post)
                  (TS.ntt_layer_1_step_branch_post 1 in_arr zeta0 zeta1 zeta2 zeta3 out_arr);
    lemma_ntt_layer_n_16_2_lane p_fe zs 4;
    lemma_ntt_layer_n_16_2_lane p_fe zs 5;
    lemma_ntt_layer_n_16_2_lane p_fe zs 6;
    lemma_ntt_layer_n_16_2_lane p_fe zs 7;
...
private
let lemma_ntt_layer_1_step_branch_2_lane_bridge
    (in_arr out_arr: t_Array i16 (mk_usize 16))
    (zeta0 zeta1 zeta2 zeta3: i16) :
  Lemma
    (requires
  ...
  = let zs = zetas_4_ zeta0 zeta1 zeta2 zeta3 in
    ...
    let r_fe = mont_i16_to_spec_array (sz 16) out_arr in
    reveal_opaque (`%TS.ntt_layer_1_step_branch_post)
                  (TS.ntt_layer_1_step_branch_post 2 in_arr zeta0 zeta1 zeta2 zeta3 out_arr);
    lemma_ntt_layer_n_16_2_lane p_fe zs 8;
    lemma_ntt_layer_n_16_2_lane p_fe zs 9;
    lemma_ntt_layer_n_16_2_lane p_fe zs 10;
    lemma_ntt_layer_n_16_2_lane p_fe zs 11;
...
private
let lemma_ntt_layer_1_step_branch_3_lane_bridge
    (in_arr out_arr: t_Array i16 (mk_usize 16))
    (zeta0 zeta1 zeta2 zeta3: i16) :
  Lemma
    (requires
  ...
  = let zs = zetas_4_ zeta0 zeta1 zeta2 zeta3 in
    ...
    let r_fe = mont_i16_to_spec_array (sz 16) out_arr in
    reveal_opaque (`%TS.ntt_layer_1_step_branch_post)
                  (TS.ntt_layer_1_step_branch_post 3 in_arr zeta0 zeta1 zeta2 zeta3 out_arr);
    lemma_ntt_layer_n_16_2_lane p_fe zs 12;
    lemma_ntt_layer_n_16_2_lane p_fe zs 13;
    lemma_ntt_layer_n_16_2_lane p_fe zs 14;
    lemma_ntt_layer_n_16_2_lane p_fe zs 15;
...
(* Per-lane dispatcher: SAME signature/ensures as the original monolithic
   lemma (so `lemma_ntt_layer_1_step_to_hacspec` is unchanged), now a thin
   4-way ground dispatch to the per-branch helpers above. *)
private
let lemma_ntt_layer_1_step_lane_bridge
  ...
  = if i = 0 || i = 1 || i = 2 || i = 3 then
      lemma_ntt_layer_1_step_branch_0_lane_bridge in_arr out_arr zeta0 zeta1 zeta2 zeta3
    else if i = 4 || i = 5 || i = 6 || i = 7 then
      lemma_ntt_layer_1_step_branch_1_lane_bridge in_arr out_arr zeta0 zeta1 zeta2 zeta3
    else if i = 8 || i = 9 || i = 10 || i = 11 then
      lemma_ntt_layer_1_step_branch_2_lane_bridge in_arr out_arr zeta0 zeta1 zeta2 zeta3
    else
      lemma_ntt_layer_1_step_branch_3_lane_bridge in_arr out_arr zeta0 zeta1 zeta2 zeta3
...
(* Per-lane bridge for `f_inv_ntt_layer_1_step`, GROUND-LITERAL per-branch form
   (identical rote transform to the forward `lemma_ntt_layer_1_step_branch_*`).
   Branch `b` owns lanes `(4b, 4b+1, 4b+2, 4b+3)` with `z = zeta_b`; concrete
   `b` collapses the div/mod so the refinement cascade never forms.
     - lane 4b, 4b+1 (idx < 2): `result = vec + vec[+2]`  (inv_butterfly._1)
     - lane 4b+2, 4b+3 (idx ≥ 2): `result = z*(vec - vec[-2])` (inv_butterfly._2) *)
private
let lemma_inv_ntt_layer_1_step_branch_0_lane_bridge
    (in_arr out_arr: t_Array i16 (mk_usize 16))
    (zeta0 zeta1 zeta2 zeta3: i16) :
  Lemma
    (requires
  ...
  = let zs = zetas_4_ zeta0 zeta1 zeta2 zeta3 in
    ...
    reveal_opaque (`%TS.inv_ntt_layer_1_step_branch_post)
                  (TS.inv_ntt_layer_1_step_branch_post 0 in_arr zeta0 zeta1 zeta2 zeta3 out_arr);
    lemma_ntt_inverse_layer_n_16_2_lane p_fe zs 0;
    lemma_ntt_inverse_layer_n_16_2_lane p_fe zs 1;
    lemma_ntt_inverse_layer_n_16_2_lane p_fe zs 2;
    lemma_ntt_inverse_layer_n_16_2_lane p_fe zs 3;
    zetas_4_lane zeta0 zeta1 zeta2 zeta3 (sz 0);
    mont_array_lane out_arr (sz 0);
    mont_array_lane out_arr (sz 1);
    mont_array_lane out_arr (sz 2);
...
private
let lemma_inv_ntt_layer_1_step_branch_1_lane_bridge
    (in_arr out_arr: t_Array i16 (mk_usize 16))
    (zeta0 zeta1 zeta2 zeta3: i16) :
  Lemma
    (requires
  ...
  = let zs = zetas_4_ zeta0 zeta1 zeta2 zeta3 in
    ...
    let r_fe = mont_i16_to_spec_array (sz 16) out_arr in
    reveal_opaque (`%TS.inv_ntt_layer_1_step_branch_post)
                  (TS.inv_ntt_layer_1_step_branch_post 1 in_arr zeta0 zeta1 zeta2 zeta3 out_arr);
    lemma_ntt_inverse_layer_n_16_2_lane p_fe zs 4;
    lemma_ntt_inverse_layer_n_16_2_lane p_fe zs 5;
    lemma_ntt_inverse_layer_n_16_2_lane p_fe zs 6;
    lemma_ntt_inverse_layer_n_16_2_lane p_fe zs 7;
    zetas_4_lane zeta0 zeta1 zeta2 zeta3 (sz 1);
    mont_array_lane out_arr (sz 4);
    mont_array_lane out_arr (sz 5);
    mont_array_lane out_arr (sz 6);
...
private
let lemma_inv_ntt_layer_1_step_branch_2_lane_bridge
    (in_arr out_arr: t_Array i16 (mk_usize 16))
    (zeta0 zeta1 zeta2 zeta3: i16) :
  Lemma
    (requires
  ...
  = let zs = zetas_4_ zeta0 zeta1 zeta2 zeta3 in
    ...
    let r_fe = mont_i16_to_spec_array (sz 16) out_arr in
    reveal_opaque (`%TS.inv_ntt_layer_1_step_branch_post)
                  (TS.inv_ntt_layer_1_step_branch_post 2 in_arr zeta0 zeta1 zeta2 zeta3 out_arr);
    lemma_ntt_inverse_layer_n_16_2_lane p_fe zs 8;
    lemma_ntt_inverse_layer_n_16_2_lane p_fe zs 9;
    lemma_ntt_inverse_layer_n_16_2_lane p_fe zs 10;
    lemma_ntt_inverse_layer_n_16_2_lane p_fe zs 11;
    zetas_4_lane zeta0 zeta1 zeta2 zeta3 (sz 2);
    mont_array_lane out_arr (sz 8);
    mont_array_lane out_arr (sz 9);
    mont_array_lane out_arr (sz 10);
...
private
let lemma_inv_ntt_layer_1_step_branch_3_lane_bridge
    (in_arr out_arr: t_Array i16 (mk_usize 16))
    (zeta0 zeta1 zeta2 zeta3: i16) :
  Lemma
    (requires
  ...
  = let zs = zetas_4_ zeta0 zeta1 zeta2 zeta3 in
    ...
    let r_fe = mont_i16_to_spec_array (sz 16) out_arr in
    reveal_opaque (`%TS.inv_ntt_layer_1_step_branch_post)
                  (TS.inv_ntt_layer_1_step_branch_post 3 in_arr zeta0 zeta1 zeta2 zeta3 out_arr);
    lemma_ntt_inverse_layer_n_16_2_lane p_fe zs 12;
    lemma_ntt_inverse_layer_n_16_2_lane p_fe zs 13;
    lemma_ntt_inverse_layer_n_16_2_lane p_fe zs 14;
    lemma_ntt_inverse_layer_n_16_2_lane p_fe zs 15;
    zetas_4_lane zeta0 zeta1 zeta2 zeta3 (sz 3);
    mont_array_lane out_arr (sz 12);
    mont_array_lane out_arr (sz 13);
    mont_array_lane out_arr (sz 14);
  ...
  Lemma
    ...
    (ensures
      (let zs = zetas_4_ zeta0 zeta1 zeta2 zeta3 in
       ...
       Seq.index r_fe i == Seq.index rhs i))
  = if i = 0 || i = 1 || i = 2 || i = 3 then
      lemma_inv_ntt_layer_1_step_branch_0_lane_bridge in_arr out_arr zeta0 zeta1 zeta2 zeta3
    else if i = 4 || i = 5 || i = 6 || i = 7 then
      lemma_inv_ntt_layer_1_step_branch_1_lane_bridge in_arr out_arr zeta0 zeta1 zeta2 zeta3
    else if i = 8 || i = 9 || i = 10 || i = 11 then
      lemma_inv_ntt_layer_1_step_branch_2_lane_bridge in_arr out_arr zeta0 zeta1 zeta2 zeta3
    else
      lemma_inv_ntt_layer_1_step_branch_3_lane_bridge in_arr out_arr zeta0 zeta1 zeta2 zeta3
...
(* Per-lane bridge for `f_inv_ntt_layer_3_step`, GROUND-LITERAL per-branch form
   ...
   Layer-3 (step 8, single zeta): branch `b` owns lanes `(2b, 2b+1, 2b+8,
   2b+9)`.  `zetas_1_lane` collapses `Seq.index zs 0` to
   `mont_i16_to_spec_fe zeta0`. *)
private
let lemma_inv_ntt_layer_3_step_branch_0_lane_bridge
    (in_arr out_arr: t_Array i16 (mk_usize 16)) (zeta0: i16) :
  Lemma
    (requires TS.inv_ntt_layer_3_step_post in_arr zeta0 out_arr)
    (ensures
  ...
  = let zs = zetas_1_ zeta0 in
    ...
    reveal_opaque (`%TS.inv_ntt_layer_3_step_branch_post)
                  (TS.inv_ntt_layer_3_step_branch_post 0 in_arr zeta0 out_arr);
    lemma_ntt_inverse_layer_n_16_8_lane p_fe zs 0;
    lemma_ntt_inverse_layer_n_16_8_lane p_fe zs 1;
    lemma_ntt_inverse_layer_n_16_8_lane p_fe zs 8;
    lemma_ntt_inverse_layer_n_16_8_lane p_fe zs 9;
...
private
let lemma_inv_ntt_layer_3_step_branch_1_lane_bridge
    (in_arr out_arr: t_Array i16 (mk_usize 16)) (zeta0: i16) :
  Lemma
    (requires TS.inv_ntt_layer_3_step_post in_arr zeta0 out_arr)
    (ensures
  ...
  = let zs = zetas_1_ zeta0 in
    ...
    let r_fe = mont_i16_to_spec_array (sz 16) out_arr in
    reveal_opaque (`%TS.inv_ntt_layer_3_step_branch_post)
                  (TS.inv_ntt_layer_3_step_branch_post 1 in_arr zeta0 out_arr);
    lemma_ntt_inverse_layer_n_16_8_lane p_fe zs 2;
    lemma_ntt_inverse_layer_n_16_8_lane p_fe zs 3;
    lemma_ntt_inverse_layer_n_16_8_lane p_fe zs 10;
    lemma_ntt_inverse_layer_n_16_8_lane p_fe zs 11;
    zetas_1_lane zeta0 (sz 0);
    mont_array_lane out_arr (sz 2);
    mont_array_lane out_arr (sz 3);
    mont_array_lane out_arr (sz 10);
...
private
let lemma_inv_ntt_layer_3_step_branch_2_lane_bridge
    (in_arr out_arr: t_Array i16 (mk_usize 16)) (zeta0: i16) :
  Lemma
    (requires TS.inv_ntt_layer_3_step_post in_arr zeta0 out_arr)
    (ensures
  ...
  = let zs = zetas_1_ zeta0 in
    ...
    let r_fe = mont_i16_to_spec_array (sz 16) out_arr in
    reveal_opaque (`%TS.inv_ntt_layer_3_step_branch_post)
                  (TS.inv_ntt_layer_3_step_branch_post 2 in_arr zeta0 out_arr);
    lemma_ntt_inverse_layer_n_16_8_lane p_fe zs 4;
    lemma_ntt_inverse_layer_n_16_8_lane p_fe zs 5;
    lemma_ntt_inverse_layer_n_16_8_lane p_fe zs 12;
    lemma_ntt_inverse_layer_n_16_8_lane p_fe zs 13;
    zetas_1_lane zeta0 (sz 0);
    mont_array_lane out_arr (sz 4);
    mont_array_lane out_arr (sz 5);
    mont_array_lane out_arr (sz 12);
...
private
let lemma_inv_ntt_layer_3_step_branch_3_lane_bridge
    (in_arr out_arr: t_Array i16 (mk_usize 16)) (zeta0: i16) :
  Lemma
    (requires TS.inv_ntt_layer_3_step_post in_arr zeta0 out_arr)
    (ensures
  ...
  = let zs = zetas_1_ zeta0 in
    ...
    let r_fe = mont_i16_to_spec_array (sz 16) out_arr in
    reveal_opaque (`%TS.inv_ntt_layer_3_step_branch_post)
                  (TS.inv_ntt_layer_3_step_branch_post 3 in_arr zeta0 out_arr);
    lemma_ntt_inverse_layer_n_16_8_lane p_fe zs 6;
    lemma_ntt_inverse_layer_n_16_8_lane p_fe zs 7;
    lemma_ntt_inverse_layer_n_16_8_lane p_fe zs 14;
    lemma_ntt_inverse_layer_n_16_8_lane p_fe zs 15;
    zetas_1_lane zeta0 (sz 0);
    mont_array_lane out_arr (sz 6);
    mont_array_lane out_arr (sz 7);
    mont_array_lane out_arr (sz 14);
...
let lemma_inv_ntt_layer_3_step_lane_bridge
  ...
  = if i = 0 || i = 1 || i = 8 || i = 9 then
      lemma_inv_ntt_layer_3_step_branch_0_lane_bridge in_arr out_arr zeta0
    else if i = 2 || i = 3 || i = 10 || i = 11 then
      lemma_inv_ntt_layer_3_step_branch_1_lane_bridge in_arr out_arr zeta0
    else if i = 4 || i = 5 || i = 12 || i = 13 then
      lemma_inv_ntt_layer_3_step_branch_2_lane_bridge in_arr out_arr zeta0
    else
      lemma_inv_ntt_layer_3_step_branch_3_lane_bridge in_arr out_arr zeta0
...
(* Per-lane bridge for `f_ntt_layer_3_step`, GROUND-LITERAL per-branch form.
   Layer-3 (step 8, single zeta): branch `b` owns lanes
   `(2b, 2b+1, 2b+8, 2b+9)`.  Concrete `b` collapses the `(i%8)/2` div/mod
   so the refinement cascade never forms. *)
private
let lemma_ntt_layer_3_step_branch_0_lane_bridge
    (in_arr out_arr: t_Array i16 (mk_usize 16)) (zeta0: i16) :
  Lemma
    (requires TS.ntt_layer_3_step_post in_arr zeta0 out_arr)
    (ensures
      (let zs = zetas_1_ zeta0 in
       let p_fe = mont_i16_to_spec_array (sz 16) in_arr in
       let r_fe = mont_i16_to_spec_array (sz 16) out_arr in
  ...
  = let zs = zetas_1_ zeta0 in
    ...
    reveal_opaque (`%TS.ntt_layer_3_step_branch_post)
                  (TS.ntt_layer_3_step_branch_post 0 in_arr zeta0 out_arr);
    lemma_ntt_layer_n_16_8_lane p_fe zs 0;
    lemma_ntt_layer_n_16_8_lane p_fe zs 1;
    lemma_ntt_layer_n_16_8_lane p_fe zs 8;
    lemma_ntt_layer_n_16_8_lane p_fe zs 9;
    zetas_1_lane zeta0 (sz 0);
    mont_array_lane out_arr (sz 0);
    mont_array_lane out_arr (sz 1);
    mont_array_lane out_arr (sz 8);
...
private
let lemma_ntt_layer_3_step_branch_1_lane_bridge
    (in_arr out_arr: t_Array i16 (mk_usize 16)) (zeta0: i16) :
  Lemma
    (requires TS.ntt_layer_3_step_post in_arr zeta0 out_arr)
    (ensures
  ...
  = let zs = zetas_1_ zeta0 in
    ...
    let r_fe = mont_i16_to_spec_array (sz 16) out_arr in
    reveal_opaque (`%TS.ntt_layer_3_step_branch_post)
                  (TS.ntt_layer_3_step_branch_post 1 in_arr zeta0 out_arr);
    lemma_ntt_layer_n_16_8_lane p_fe zs 2;
    lemma_ntt_layer_n_16_8_lane p_fe zs 3;
    lemma_ntt_layer_n_16_8_lane p_fe zs 10;
    lemma_ntt_layer_n_16_8_lane p_fe zs 11;
    zetas_1_lane zeta0 (sz 0);
    mont_array_lane out_arr (sz 2);
    mont_array_lane out_arr (sz 3);
    mont_array_lane out_arr (sz 10);
...
private
let lemma_ntt_layer_3_step_branch_2_lane_bridge
    (in_arr out_arr: t_Array i16 (mk_usize 16)) (zeta0: i16) :
  Lemma
    (requires TS.ntt_layer_3_step_post in_arr zeta0 out_arr)
    (ensures
  ...
  = let zs = zetas_1_ zeta0 in
    ...
    let r_fe = mont_i16_to_spec_array (sz 16) out_arr in
    reveal_opaque (`%TS.ntt_layer_3_step_branch_post)
                  (TS.ntt_layer_3_step_branch_post 2 in_arr zeta0 out_arr);
    lemma_ntt_layer_n_16_8_lane p_fe zs 4;
    lemma_ntt_layer_n_16_8_lane p_fe zs 5;
    lemma_ntt_layer_n_16_8_lane p_fe zs 12;
    lemma_ntt_layer_n_16_8_lane p_fe zs 13;
    zetas_1_lane zeta0 (sz 0);
    mont_array_lane out_arr (sz 4);
    mont_array_lane out_arr (sz 5);
    mont_array_lane out_arr (sz 12);
...
private
let lemma_ntt_layer_3_step_branch_3_lane_bridge
    (in_arr out_arr: t_Array i16 (mk_usize 16)) (zeta0: i16) :
  Lemma
    (requires TS.ntt_layer_3_step_post in_arr zeta0 out_arr)
    (ensures
  ...
  = let zs = zetas_1_ zeta0 in
    ...
    let r_fe = mont_i16_to_spec_array (sz 16) out_arr in
    reveal_opaque (`%TS.ntt_layer_3_step_branch_post)
                  (TS.ntt_layer_3_step_branch_post 3 in_arr zeta0 out_arr);
    lemma_ntt_layer_n_16_8_lane p_fe zs 6;
    lemma_ntt_layer_n_16_8_lane p_fe zs 7;
    lemma_ntt_layer_n_16_8_lane p_fe zs 14;
    lemma_ntt_layer_n_16_8_lane p_fe zs 15;
    zetas_1_lane zeta0 (sz 0);
    mont_array_lane out_arr (sz 6);
    mont_array_lane out_arr (sz 7);
    mont_array_lane out_arr (sz 14);
  ...
  Lemma
    ...
    (ensures
      (let zs = zetas_1_ zeta0 in
       ...
       Seq.index r_fe i == Seq.index rhs i))
  = if i = 0 || i = 1 || i = 8 || i = 9 then
      lemma_ntt_layer_3_step_branch_0_lane_bridge in_arr out_arr zeta0
    else if i = 2 || i = 3 || i = 10 || i = 11 then
      lemma_ntt_layer_3_step_branch_1_lane_bridge in_arr out_arr zeta0
    else if i = 4 || i = 5 || i = 12 || i = 13 then
      lemma_ntt_layer_3_step_branch_2_lane_bridge in_arr out_arr zeta0
    else
      lemma_ntt_layer_3_step_branch_3_lane_bridge in_arr out_arr zeta0
