...
fn sha3_256_448bit() {
    let msg = b"abcdbcdecdefdefgefghfghighijhijkijkljklmklmnlmnomnopnopq";
    let expected =
        hex_to_bytes("41c0dba2a9d6240849100376a8235e2c82e1b9998a999e21db32dd97496d3376");
...
fn sha3_256_896bit() {
    ...
    let expected =
        hex_to_bytes("916f6061fe879741ca6469b43971dfdb28b1a32dc36cb3254e812be27aad1d18");
    assert_eq!(sha3_256(msg).to_vec(), expected);
}
