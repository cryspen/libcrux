use crate::{sampling::sample_from_xof, *};

#[inline(always)]
#[allow(non_snake_case)]
pub fn sample_matrix_A<const K: usize>(
    seed: [u8; 34],
    transpose: bool,
...
#[inline(always)]
pub fn compute_message<const K: usize>(
...
#[inline(always)]
pub fn compute_ring_element_v<const K: usize>(
...
#[inline(always)]
pub fn compute_vector_u<const K: usize>(
...
#[inline(always)]
#[allow(non_snake_case)]
pub fn compute_As_plus_e<const K: usize>(
