...
#[derive(Clone, Copy)]
pub struct Vector {
    pub(crate) low: int32x4_t,
    pub(crate) high: int32x4_t,
}
...
#[inline(always)]
pub(crate) fn to_i32_array(v: Vector) -> [i32; 8] {
    let mut out = [0i32; 8];
...
#[inline(always)]
pub(crate) fn from_i32_array(array: [i32; 8]) -> Vector {
    Vector {
...
#[inline(always)]
pub(crate) fn add_constant(mut v: Vector, c: i32) -> Vector {
...
#[inline(always)]
pub(crate) fn add(mut lhs: Vector, rhs: &Vector) -> Vector {
...
#[inline(always)]
pub(crate) fn sub(mut lhs: Vector, rhs: &Vector) -> Vector {
...
#[inline(always)]
pub(crate) fn multiply_by_constant(mut v: Vector, c: i32) -> Vector {
...
#[inline(always)]
pub(crate) fn bitwise_and_with_constant(mut v: Vector, c: i32) -> Vector {
    let c = unsafe { vdupq_n_s32(c) };
...
#[inline(always)]
pub(crate) fn shift_right<const SHIFT_BY: i32>(mut v: Vector) -> Vector {
...
#[inline(always)]
pub(crate) fn shift_left<const SHIFT_BY: i32>(mut lhs: Vector) -> Vector {
...
#[inline(always)]
pub(crate) fn cond_subtract_3329(mut v: Vector) -> Vector {
...
#[inline(always)]
pub(crate) fn barrett_reduce(mut v: Vector) -> Vector {
...
pub(crate) const INVERSE_OF_MODULUS_MOD_MONTGOMERY_R: i32 = 62209;

#[inline(always)]
pub(crate) fn montgomery_reduce_i32x2_t(v: int32x2_t) -> int32x2_t {
...
#[inline(always)]
pub(crate) fn montgomery_reduce_i32x4_t(v: int32x4_t) -> int32x4_t {
    // let t = get_n_least_significant_bits(MONTGOMERY_SHIFT, value as u32)
    //     * INVERSE_OF_MODULUS_MOD_MONTGOMERY_R;
    // let k = get_n_least_significant_bits(MONTGOMERY_SHIFT, t) as i16;
    // let k_times_modulus = (k as i32) * FIELD_MODULUS;
...
#[inline(always)]
pub(crate) fn montgomery_reduce(mut v: Vector) -> Vector {
    // let t = get_n_least_significant_bits(MONTGOMERY_SHIFT, value as u32)
    //     * INVERSE_OF_MODULUS_MOD_MONTGOMERY_R;
    // let k = get_n_least_significant_bits(MONTGOMERY_SHIFT, t) as i16;
    // let k_times_modulus = (k as i32) * FIELD_MODULUS;
...
#[inline(always)]
pub(crate) fn compress_1(mut v: Vector) -> Vector {
...
#[inline(always)]
pub(crate) fn mask_n_least_significant_bits(coefficient_bits: i32) -> i32 {
...
#[inline(always)]
pub(crate) fn compress<const COEFFICIENT_BITS: i32>(mut v: Vector) -> Vector {
...
#[inline(always)]
pub(crate) fn ntt_layer_1_step(mut v: Vector, zeta1: i32, zeta2: i32) -> Vector {
...
#[inline(always)]
pub(crate) fn ntt_layer_2_step(mut v: Vector, zeta: i32) -> Vector {
    // let t = simd::Vector::montgomery_multiply_fe_by_fer(b, zeta_r);
    // b = simd::Vector::sub(a, &t);
    // a = simd::Vector::add(a, &t);
...
#[inline(always)]
pub(crate) fn inv_ntt_layer_1_step(mut v: Vector, zeta1: i32, zeta2: i32) -> Vector {
...
#[inline(always)]
pub(crate) fn inv_ntt_layer_2_step(mut v: Vector, zeta: i32) -> Vector {
    //let a_minus_b = simd::Vector::sub(b, &a);
    //a = simd::Vector::add(a, &b);
    //b = simd::Vector::montgomery_multiply_fe_by_fer(a_minus_b, zeta_r);
    //(a, b)
...
#[inline(always)]
pub(crate) fn ntt_multiply(lhs: &Vector, rhs: &Vector, zeta0: i32, zeta1: i32) -> Vector {
...
#[inline(always)]
pub(crate) fn serialize_1(v: Vector) -> u8 {
...
#[inline(always)]
pub(crate) fn deserialize_1(a: u8) -> Vector {
...
#[inline(always)]
pub(crate) fn serialize_4(v: Vector) -> [u8; 4] {
...
#[inline(always)]
pub(crate) fn deserialize_4(v: &[u8]) -> Vector {
    let output = PortableVector::deserialize_4(v);

    Vector::from_i32_array(PortableVector::to_i32_array(output))
}

#[inline(always)]
pub(crate) fn serialize_5(v: Vector) -> [u8; 5] {
...
#[inline(always)]
pub(crate) fn deserialize_5(v: &[u8]) -> Vector {
...
#[inline(always)]
pub(crate) fn serialize_10(v: Vector) -> [u8; 10] {
    let lowt = unsafe { vtrn1q_s32(v.low, v.high) }; // a0, a4, a2, a6
    let hight = unsafe { vtrn2q_s32(v.low, v.high) }; // a1, a5, a3, a7
...
#[inline(always)]
pub(crate) fn deserialize_10(v: &[u8]) -> Vector {
...
#[inline(always)]
pub(crate) fn serialize_11(v: Vector) -> [u8; 11] {
    let input = PortableVector::from_i32_array(Vector::to_i32_array(v));
    PortableVector::serialize_11(input)
}

#[inline(always)]
pub(crate) fn deserialize_11(v: &[u8]) -> Vector {
...
#[inline(always)]
pub(crate) fn serialize_12(v: Vector) -> [u8; 12] {
    let lowt = unsafe { vtrn1q_s32(v.low, v.high) }; // a0, a4, a2, a6
    let hight = unsafe { vtrn2q_s32(v.low, v.high) }; // a1, a5, a3, a7
...
#[inline(always)]
pub(crate) fn deserialize_12(v: &[u8]) -> Vector {
