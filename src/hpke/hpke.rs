...
pub fn SetupBaseS(
    ...
    let (shared_secret, enc) = match config.1 {
        ...
        KEM::XWingDraft02 => {
            ...
            let XWingKemDraft06PublicKey { pk_m, pk_x } =
                XWingKemDraft06PublicKey::decode(pkR).map_err(|_| HpkeError::EncapError)?;
