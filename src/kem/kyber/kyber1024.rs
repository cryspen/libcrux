...
const C1_BLOCK_SIZE_1024: usize = block_len::<VECTOR_U_COMPRESSION_FACTOR_1024>();
const C1_SIZE_1024: usize = serialized_len::<RANK_1024, C1_BLOCK_SIZE_1024>();
const VECTOR_V_COMPRESSION_FACTOR_1024: usize = 5;
const C2_SIZE_1024: usize = block_len::<VECTOR_V_COMPRESSION_FACTOR_1024>();
const BYTES_PER_ENCODED_ELEMENT_OF_U: usize =
    (COEFFICIENTS_IN_RING_ELEMENT * VECTOR_U_COMPRESSION_FACTOR_1024) / 8;
const VECTOR_U_ENCODED_SIZE_1024: usize = RANK_1024 * BYTES_PER_ENCODED_ELEMENT_OF_U;
const VECTOR_V_ENCODED_SIZE_1024: usize =
...
const CPA_PKE_CIPHERTEXT_SIZE_1024: usize = VECTOR_U_ENCODED_SIZE_1024 + VECTOR_V_ENCODED_SIZE_1024;
