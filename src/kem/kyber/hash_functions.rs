...
use digest::{Shake128State,shake128_init,shake128_absorb_final,shake128_squeeze_nblocks};
#[cfg(simd256)]
use digest::{Shake128StateX4,shake128_init_x4,shake128_absorb_final_x4,shake128_squeeze_nblocks_x4};
...
pub(crate) fn XOF_squeeze_three_blocks<const K: usize>(
    ...
    for i in 0..K {
        out[i] = shake128_squeeze_nblocks(&mut xof_state.states[i]);
    }
    out
}
