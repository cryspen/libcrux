...
|---|---|---|---|---|
| 1 | Forward NTT layer 1-7 correct vs hacspec | `src/ntt.rs::ntt_at_layer_{1,2,3,4_plus,7}` | ❌ no claim — only bounds; hacspec ensures **commented out** at lines 277, 318 ("TODO" markers) | ~2-3 sprints — needs `Hacspec_ml_kem.Ntt.ntt_at_layer_n` spec finalized + per-layer Bridges lemma + body proofs |
