module Libcrux_ml_kem.Mlkem512.Incremental
...
let pk2_len (_: Prims.unit) = Libcrux_ml_kem.Mlkem512.v_RANKED_BYTES_PER_RING_ELEMENT

let key_pair_len (_: Prims.unit) =
  ((((pk1_len () <: usize) +! (pk2_len () <: usize) <: usize) +!
      ((Libcrux_ml_kem.Mlkem512.v_RANK *! mk_usize 16 <: usize) *! mk_usize 32 <: usize)
      <:
      usize) +!
    mk_usize 32
    <:
    usize) +!
  (((Libcrux_ml_kem.Mlkem512.v_RANK *! Libcrux_ml_kem.Mlkem512.v_RANK <: usize) *! mk_usize 16
      <:
      usize) *!
    mk_usize 32
    <:
...
let generate_key_pair (randomness: t_Array u8 (mk_usize 64)) (key_pair: t_Slice u8) =
  let tmp0, out:(t_Slice u8 &
    ...
    Libcrux_ml_kem.Ind_cca.Incremental.Multiplexing.generate_keypair (mk_usize 2) (mk_usize 768)
      (mk_usize 768) (mk_usize 1632) (mk_usize 800) (mk_usize 768) (mk_usize 3) (mk_usize 192)
      randomness key_pair
  in
...
let validate_pk (pk1: Libcrux_ml_kem.Ind_cca.Incremental.Types.t_PublicKey1) (pk2: t_Slice u8) =
  Libcrux_ml_kem.Ind_cca.Incremental.Multiplexing.validate_pk (mk_usize 2) (mk_usize 800) pk1 pk2
...
let encapsulate1
  ...
  | Core.Result.Result_Ok public_key_part ->
    let tmp0, tmp1, out:(t_Slice u8 & t_Slice u8 &
      Core.Result.t_Result (Libcrux_ml_kem.Ind_cca.Incremental.Types.t_Ciphertext1 (mk_usize 640))
        Libcrux_ml_kem.Ind_cca.Incremental.Types.t_Error) =
      Libcrux_ml_kem.Ind_cca.Incremental.Multiplexing.encapsulate1 (mk_usize 2) (mk_usize 768)
        (mk_usize 640) (mk_usize 10) (mk_usize 320) (mk_usize 3) (mk_usize 192) (mk_usize 2)
    ...
    let hax_temp_output:Core.Result.t_Result
      (Libcrux_ml_kem.Ind_cca.Incremental.Types.t_Ciphertext1 (mk_usize 640))
      Libcrux_ml_kem.Ind_cca.Incremental.Types.t_Error =
      out
    in
...
let encapsulate2 (state public_key_part: t_Slice u8) =
  Libcrux_ml_kem.Ind_cca.Incremental.Multiplexing.encapsulate2 (mk_usize 2)
    (mk_usize 768)
    (mk_usize 128)
    (mk_usize 4)
    state
...
let decapsulate_incremental_key
      ...
      (ciphertext1: Libcrux_ml_kem.Ind_cca.Incremental.Types.t_Ciphertext1 (mk_usize 640))
      (ciphertext2: Libcrux_ml_kem.Ind_cca.Incremental.Types.t_Ciphertext2 (mk_usize 128))
     =
  Libcrux_ml_kem.Ind_cca.Incremental.Multiplexing.decapsulate (mk_usize 2) (mk_usize 768)
    (mk_usize 1632) (mk_usize 768) (mk_usize 800) (mk_usize 768) (mk_usize 768) (mk_usize 640)
    (mk_usize 128) (mk_usize 10) (mk_usize 4) (mk_usize 320) (mk_usize 3) (mk_usize 192)
    (mk_usize 2) (mk_usize 128) (mk_usize 800) private_key ciphertext1 ciphertext2
