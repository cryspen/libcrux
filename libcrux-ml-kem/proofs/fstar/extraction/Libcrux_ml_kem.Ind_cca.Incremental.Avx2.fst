module Libcrux_ml_kem.Ind_cca.Incremental.Avx2
  ...
  then
    ...
    let tmp0, out:(t_Slice u8 &
      ...
      Libcrux_ml_kem.Ind_cca.Incremental.generate_keypair_serialized v_K v_PK2_LEN
        ...
        v_ETA1_RANDOMNESS_SIZE #Libcrux_ml_kem.Vector.Avx2.t_SIMD256Vector
        #Libcrux_ml_kem.Hash_functions.Avx2.t_Simd256Hash randomness key_pair
    in
...
let encapsulate1
  ...
  Libcrux_ml_kem.Ind_cca.Incremental.encapsulate1 v_K v_CIPHERTEXT_SIZE v_C1_SIZE
    ...
    #Libcrux_ml_kem.Hash_functions.Avx2.t_Simd256Hash public_key_part randomness
...
let encapsulate1_serialized
  ...
  let tmp0, tmp1, out:(t_Slice u8 & t_Slice u8 &
    ...
    Libcrux_ml_kem.Ind_cca.Incremental.encapsulate1_serialized v_K v_CIPHERTEXT_SIZE v_C1_SIZE
      v_VECTOR_U_COMPRESSION_FACTOR v_VECTOR_U_BLOCK_LEN v_ETA1 v_ETA1_RANDOMNESS_SIZE v_ETA2
      v_ETA2_RANDOMNESS_SIZE #Libcrux_ml_kem.Vector.Avx2.t_SIMD256Vector
      #Libcrux_ml_kem.Hash_functions.Avx2.t_Simd256Hash public_key_part randomness state
      shared_secret
  in
