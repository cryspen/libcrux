...
let v_RANK_768_: usize = Rust_primitives.mk_usize 3
...
let v_RANKED_BYTES_PER_RING_ELEMENT_768_: usize =
  (v_RANK_768_ *! Libcrux_ml_kem.Constants.v_BITS_PER_RING_ELEMENT <: usize) /!
  Rust_primitives.mk_usize 8
...
let v_CPA_PKE_PUBLIC_KEY_SIZE_768_: usize =
  v_T_AS_NTT_ENCODED_SIZE_768_ +! Rust_primitives.mk_usize 32
...
let v_VECTOR_U_COMPRESSION_FACTOR_768_: usize = Rust_primitives.mk_usize 10
...
let v_VECTOR_V_COMPRESSION_FACTOR_768_: usize = Rust_primitives.mk_usize 4
...
val encapsulate
    ...
    : Prims.Pure
      ...
      (ensures
        fun res ->
          let res:(Libcrux_ml_kem.Types.t_MlKemCiphertext (Rust_primitives.mk_usize 1088) &
            t_Array u8 (Rust_primitives.mk_usize 32)) =
            res
          in
...
val generate_key_pair (randomness: t_Array u8 (Rust_primitives.mk_usize 64))
    : Prims.Pure
      ...
      (ensures
        fun res ->
          let res:Libcrux_ml_kem.Types.t_MlKemKeyPair (Rust_primitives.mk_usize 2400)
            (Rust_primitives.mk_usize 1184) =
            res
          in
