...
let inv_ntt_layer_int_vec_step_reduce
      ...
      (zeta_r: i16)
     =
  let _:Prims.unit = assume (Libcrux_ml_kem.Vector.Traits.f_sub_pre #v_Vector b a) in
  let a_minus_b:v_Vector = Libcrux_ml_kem.Vector.Traits.f_sub #v_Vector b a in
  let _:Prims.unit = assume (Libcrux_ml_kem.Vector.Traits.f_add_pre #v_Vector a b) in
  let _:Prims.unit =
    assume (Libcrux_ml_kem.Vector.Traits.f_barrett_reduce_pre #v_Vector
  ...
  let re:Libcrux_ml_kem.Polynomial.t_PolynomialRingElement v_Vector =
    Core.Iter.Traits.Iterator.f_fold (Core.Iter.Traits.Collect.f_into_iter #(Core.Ops.Range.t_Range
      ...
      (fun re round ->
          ...
          in
          let _:Prims.unit =
            assume (Libcrux_ml_kem.Vector.Traits.f_inv_ntt_layer_1_step_pre #v_Vector
  ...
  let re:Libcrux_ml_kem.Polynomial.t_PolynomialRingElement v_Vector =
    Core.Iter.Traits.Iterator.f_fold (Core.Iter.Traits.Collect.f_into_iter #(Core.Ops.Range.t_Range
      ...
      (fun re round ->
          ...
          in
          let _:Prims.unit =
            assume (Libcrux_ml_kem.Vector.Traits.f_inv_ntt_layer_2_step_pre #v_Vector
                  (re.Libcrux_ml_kem.Polynomial.f_coefficients.[ round ] <: v_Vector)
                  (Libcrux_ml_kem.Polynomial.v_ZETAS_TIMES_MONTGOMERY_R.[ (zeta_i -!
                        (round *! sz 2 <: usize)
                        <:
  ...
  let re:Libcrux_ml_kem.Polynomial.t_PolynomialRingElement v_Vector =
    Core.Iter.Traits.Iterator.f_fold (Core.Iter.Traits.Collect.f_into_iter #(Core.Ops.Range.t_Range
      ...
      (fun re round ->
          ...
          let round:usize = round in
          let _:Prims.unit =
            assume (Libcrux_ml_kem.Vector.Traits.f_inv_ntt_layer_3_step_pre #v_Vector
                  (re.Libcrux_ml_kem.Polynomial.f_coefficients.[ round ] <: v_Vector)
