...
let inv_ntt_layer_int_vec_step_reduce
      ...
      (zeta_r: i16)
     =
  let a_minus_b:v_Vector = Libcrux_traits.f_sub #v_Vector b a in
  let a:v_Vector =
    Libcrux_traits.f_barrett_reduce #v_Vector (Libcrux_traits.f_add #v_Vector a b <: v_Vector)
  in
  let b:v_Vector = Libcrux_traits.f_montgomery_multiply_fe_by_fer #v_Vector a_minus_b zeta_r in
          ...
          let re:Libcrux_ml_kem.Polynomial.t_PolynomialRingElement v_Vector =
            {
              ...
              Rust_primitives.Hax.Monomorphized_update_at.update_at_usize re
                  .Libcrux_ml_kem.Polynomial.f_coefficients
                round
                (Libcrux_traits.f_inv_ntt_layer_1_step #v_Vector
          ...
          let re:Libcrux_ml_kem.Polynomial.t_PolynomialRingElement v_Vector =
            {
              ...
              Rust_primitives.Hax.Monomorphized_update_at.update_at_usize re
                  .Libcrux_ml_kem.Polynomial.f_coefficients
                round
                (Libcrux_traits.f_inv_ntt_layer_2_step #v_Vector
                    (re.Libcrux_ml_kem.Polynomial.f_coefficients.[ round ] <: v_Vector)
                    (Libcrux_ml_kem.Polynomial.v_ZETAS_TIMES_MONTGOMERY_R.[ zeta_i ] <: i16)
                    (Libcrux_ml_kem.Polynomial.v_ZETAS_TIMES_MONTGOMERY_R.[ zeta_i -! sz 1 <: usize
                      ]
          ...
          let re:Libcrux_ml_kem.Polynomial.t_PolynomialRingElement v_Vector =
            {
              ...
              Rust_primitives.Hax.Monomorphized_update_at.update_at_usize re
                  .Libcrux_ml_kem.Polynomial.f_coefficients
                round
                (Libcrux_traits.f_inv_ntt_layer_3_step #v_Vector
                    (re.Libcrux_ml_kem.Polynomial.f_coefficients.[ round ] <: v_Vector)
                    (Libcrux_ml_kem.Polynomial.v_ZETAS_TIMES_MONTGOMERY_R.[ zeta_i ] <: i16)
                  <:
                  v_Vector)
