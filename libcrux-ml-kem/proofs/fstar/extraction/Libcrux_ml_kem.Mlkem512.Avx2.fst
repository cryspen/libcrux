...
let decapsulate
     ...
     =
  Libcrux_ml_kem.Ind_cca.Instantiations.Avx2.decapsulate #(sz 2) #(sz 1632) #(sz 768) #(sz 800)
    #(sz 768) #(sz 768) #(sz 640) #(sz 128) #(sz 10) #(sz 4) #(sz 320) #(sz 3) #(sz 192) #(sz 2)
...
let encapsulate
     ...
     =
  Libcrux_ml_kem.Ind_cca.Instantiations.Avx2.encapsulate #(sz 2) #(sz 768) #(sz 800) #(sz 768)
    #(sz 640) #(sz 128) #(sz 10) #(sz 4) #(sz 320) #(sz 3) #(sz 192) #(sz 2) #(sz 128) public_key
    randomness
