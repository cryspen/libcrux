...
let validate_private_key
     ...
     =
  Libcrux_ml_kem.Ind_cca.Instantiations.Portable.validate_private_key (Rust_primitives.mk_usize 3)
...
let decapsulate
      ...
      (ciphertext: Libcrux_ml_kem.Types.t_MlKemCiphertext (Rust_primitives.mk_usize 1088))
     =
  Libcrux_ml_kem.Ind_cca.Instantiations.Portable.decapsulate (Rust_primitives.mk_usize 3)
...
let encapsulate
     ...
     =
  Libcrux_ml_kem.Ind_cca.Instantiations.Portable.encapsulate (Rust_primitives.mk_usize 3)
...
let generate_key_pair (randomness: t_Array u8 (Rust_primitives.mk_usize 64)) =
  Libcrux_ml_kem.Ind_cca.Instantiations.Portable.generate_keypair (Rust_primitives.mk_usize 3)
...
let validate_public_key
      (public_key: Libcrux_ml_kem.Types.t_MlKemPublicKey (Rust_primitives.mk_usize 1184))
     =
  Libcrux_ml_kem.Ind_cca.Instantiations.Portable.validate_public_key (Rust_primitives.mk_usize 3)
    (Rust_primitives.mk_usize 1152)
    (Rust_primitives.mk_usize 1184)
