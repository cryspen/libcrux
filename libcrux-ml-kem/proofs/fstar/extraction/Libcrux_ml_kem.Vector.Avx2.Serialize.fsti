...
val deserialize_1_ (bytes: t_Slice u8)
    : Prims.Pure Libcrux_intrinsics.Avx2_extract.t_Vec256
      (requires (Core.Slice.impl__len #u8 bytes <: usize) =. Rust_primitives.mk_usize 2)
      (ensures
        fun coefficients ->
          let coefficients:Libcrux_intrinsics.Avx2_extract.t_Vec256 = coefficients in
          forall (i: nat{i < 256}).
...
val deserialize_4_ (bytes: t_Slice u8)
    : Prims.Pure Libcrux_intrinsics.Avx2_extract.t_Vec256
      (requires (Core.Slice.impl__len #u8 bytes <: usize) =. Rust_primitives.mk_usize 8)
      (ensures
        fun result ->
...
val serialize_1_ (vector: Libcrux_intrinsics.Avx2_extract.t_Vec256)
    : Prims.Pure (t_Array u8 (Rust_primitives.mk_usize 2))
      ...
      (ensures
        fun result ->
          let result:t_Array u8 (Rust_primitives.mk_usize 2) = result in
...
val serialize_10_ (vector: Libcrux_intrinsics.Avx2_extract.t_Vec256)
    : Prims.Pure (t_Array u8 (Rust_primitives.mk_usize 20))
      ...
      (ensures
        fun r ->
          let r:t_Array u8 (Rust_primitives.mk_usize 20) = r in
...
val serialize_12_ (vector: Libcrux_intrinsics.Avx2_extract.t_Vec256)
    : Prims.Pure (t_Array u8 (Rust_primitives.mk_usize 24))
      ...
      (ensures
        fun r ->
          let r:t_Array u8 (Rust_primitives.mk_usize 24) = r in
...
val serialize_4_ (vector: Libcrux_intrinsics.Avx2_extract.t_Vec256)
    : Prims.Pure (t_Array u8 (Rust_primitives.mk_usize 8))
      ...
      (ensures
        fun r ->
          let r:t_Array u8 (Rust_primitives.mk_usize 8) = r in
