...
let pk2_len (_: Prims.unit) = Libcrux_ml_kem.Mlkem1024.v_RANKED_BYTES_PER_RING_ELEMENT

let key_pair_len (_: Prims.unit) =
  ((((pk1_len () <: usize) +! (pk2_len () <: usize) <: usize) +!
      ((Libcrux_ml_kem.Mlkem1024.v_RANK *! mk_usize 16 <: usize) *! mk_usize 32 <: usize)
      <:
      usize) +!
    mk_usize 32
    <:
    usize) +!
  (((Libcrux_ml_kem.Mlkem1024.v_RANK *! Libcrux_ml_kem.Mlkem1024.v_RANK <: usize) *! mk_usize 16
      <:
      usize) *!
    mk_usize 32
    <:
...
let generate_key_pair (randomness: t_Array u8 (mk_usize 64)) (key_pair: t_Slice u8) =
  let tmp0, out:(t_Slice u8 &
    ...
    Libcrux_ml_kem.Ind_cca.Incremental.Multiplexing.generate_keypair (mk_usize 4) (mk_usize 1536)
      (mk_usize 1536) (mk_usize 3168) (mk_usize 1568) (mk_usize 1536) (mk_usize 2) (mk_usize 128)
      randomness key_pair
  in
...
let validate_pk (pk1: Libcrux_ml_kem.Ind_cca.Incremental.Types.t_PublicKey1) (pk2: t_Slice u8) =
  Libcrux_ml_kem.Ind_cca.Incremental.Multiplexing.validate_pk (mk_usize 4) (mk_usize 1568) pk1 pk2
...
let encapsulate1
  ...
  | Core.Result.Result_Ok public_key_part ->
    let tmp0, tmp1, out:(t_Slice u8 & t_Slice u8 &
      Core.Result.t_Result (Libcrux_ml_kem.Ind_cca.Incremental.Types.t_Ciphertext1 (mk_usize 1408))
        Libcrux_ml_kem.Ind_cca.Incremental.Types.t_Error) =
      Libcrux_ml_kem.Ind_cca.Incremental.Multiplexing.encapsulate1 (mk_usize 4) (mk_usize 1568)
        (mk_usize 1408) (mk_usize 11) (mk_usize 352) (mk_usize 2) (mk_usize 128) (mk_usize 2)
...
let encapsulate2 (state public_key_part: t_Slice u8) =
  Libcrux_ml_kem.Ind_cca.Incremental.Multiplexing.encapsulate2 (mk_usize 4)
    (mk_usize 1536)
    (mk_usize 160)
    (mk_usize 5)
    state
...
let decapsulate_incremental_key
     ...
     =
  Libcrux_ml_kem.Ind_cca.Incremental.Multiplexing.decapsulate (mk_usize 4) (mk_usize 1536)
    (mk_usize 3168) (mk_usize 1536) (mk_usize 1568) (mk_usize 1568) (mk_usize 1536) (mk_usize 1408)
    (mk_usize 160) (mk_usize 11) (mk_usize 5) (mk_usize 352) (mk_usize 2) (mk_usize 128)
    (mk_usize 2) (mk_usize 128) (mk_usize 1600) private_key ciphertext1 ciphertext2
