...
let ntt_layer_7_int_vec_step
      ...
      (a b: v_Vector)
     =
  let t:v_Vector = Libcrux_ml_kem.Simd.Simd_trait.f_multiply_by_constant b (-1600l) in
  let b:v_Vector = Libcrux_ml_kem.Simd.Simd_trait.f_sub a t in
  let a:v_Vector = Libcrux_ml_kem.Simd.Simd_trait.f_add a t in
...
let inv_ntt_layer_int_vec_step
      ...
      (zeta_r: i32)
     =
  let a_minus_b:v_Vector = Libcrux_ml_kem.Simd.Simd_trait.f_sub b a in
  let a:v_Vector = Libcrux_ml_kem.Simd.Simd_trait.f_add a b in
  let b:v_Vector =
...
let ntt_layer_int_vec_step
      ...
      (zeta_r: i32)
     =
  let t:v_Vector = Libcrux_ml_kem.Simd.Simd_trait.f_montgomery_multiply_fe_by_fer b zeta_r in
  let b:v_Vector = Libcrux_ml_kem.Simd.Simd_trait.f_sub a t in
  let a:v_Vector = Libcrux_ml_kem.Simd.Simd_trait.f_add a t in
  a, b <: (v_Vector & v_Vector)
...
let impl__ZERO
     ...
     =
  {
    f_coefficients
    =
    Rust_primitives.Hax.repeat (Libcrux_ml_kem.Simd.Simd_trait.f_ZERO () <: v_Vector) (sz 32)
  }
  <:
      ...
      (fun result j ->
          ...
          let coefficient_normal_form:v_Vector =
            Libcrux_ml_kem.Simd.Simd_trait.f_montgomery_reduce (Libcrux_ml_kem.Simd.Simd_trait.f_multiply_by_constant
                  (result.f_coefficients.[ j ] <: v_Vector)
                  1441l
                <:
                v_Vector)
          in
          ...
          let result:t_PolynomialRingElement v_Vector =
            {
              ...
              Rust_primitives.Hax.Monomorphized_update_at.update_at_usize result.f_coefficients
                ...
                (Libcrux_ml_kem.Simd.Simd_trait.f_barrett_reduce (Libcrux_ml_kem.Simd.Simd_trait.f_add
                        coefficient_normal_form
                        (Libcrux_ml_kem.Simd.Simd_trait.f_add (self.f_coefficients.[ i ] <: v_Vector
                            )
            ...
            Rust_primitives.Hax.Monomorphized_update_at.update_at_usize result.f_coefficients
              ...
              (Libcrux_ml_kem.Simd.Simd_trait.f_from_i32_array (Core.Result.impl__unwrap (Core.Convert.f_try_into
                          (a.[ {
                                ...
                                =
                                i *! Libcrux_ml_kem.Simd.Simd_trait.v_FIELD_ELEMENTS_IN_VECTOR
                                <:
                                usize;
                                Core.Ops.Range.f_end
                                =
      ...
      (fun out i ->
          ...
          let i:usize = i in
          {
            ...
            Rust_primitives.Hax.Monomorphized_update_at.update_at_usize out.f_coefficients
              i
              (Libcrux_ml_kem.Simd.Simd_trait.f_ntt_multiply (self.f_coefficients.[ i ] <: v_Vector)
                  (rhs.f_coefficients.[ i ] <: v_Vector)
    ...
    Core.Iter.Traits.Iterator.f_fold (Core.Iter.Traits.Collect.f_into_iter ({
      ...
      (fun self i ->
          ...
          let i:usize = i in
          {
            ...
            Rust_primitives.Hax.Monomorphized_update_at.update_at_usize self.f_coefficients
              i
              (Libcrux_ml_kem.Simd.Simd_trait.f_barrett_reduce (self.f_coefficients.[ i ]
                    <:
                    v_Vector)
                <:
                v_Vector)
    ...
    Core.Iter.Traits.Iterator.f_fold (Core.Iter.Traits.Collect.f_into_iter ({
      ...
      (fun temp_0_ round ->
          ...
          let offset_vec:usize =
            offset /! Libcrux_ml_kem.Simd.Simd_trait.v_FIELD_ELEMENTS_IN_VECTOR
          in
          let step_vec:usize = step /! Libcrux_ml_kem.Simd.Simd_trait.v_FIELD_ELEMENTS_IN_VECTOR in
          let re:t_PolynomialRingElement v_Vector =
            Core.Iter.Traits.Iterator.f_fold (Core.Iter.Traits.Collect.f_into_iter ({
