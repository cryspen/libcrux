    ...
    Core.Iter.Traits.Iterator.f_fold (Core.Iter.Traits.Collect.f_into_iter ({
      ...
      (fun result j ->
          ...
          let coefficient_normal_form:v_Vector =
            Libcrux_traits.f_montgomery_multiply_by_constant (result.f_coefficients.[ j ]
                <:
                v_Vector)
              1441s
          in
    ...
    Core.Iter.Traits.Iterator.f_fold (Core.Iter.Traits.Collect.f_into_iter ({
      ...
      (fun result i ->
          ...
          let i:usize = i in
          {
            ...
            Rust_primitives.Hax.Monomorphized_update_at.update_at_usize result.f_coefficients
              i
              (Libcrux_traits.f_from_i16_array (Core.Result.impl__unwrap (Core.Convert.f_try_into (a.[
                              {
