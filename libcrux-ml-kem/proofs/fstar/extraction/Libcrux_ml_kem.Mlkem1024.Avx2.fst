...
let validate_private_key
     ...
     =
  Libcrux_ml_kem.Ind_cca.Instantiations.Avx2.validate_private_key (Rust_primitives.mk_usize 4)
...
let decapsulate
      ...
      (ciphertext: Libcrux_ml_kem.Types.t_MlKemCiphertext (Rust_primitives.mk_usize 1568))
     =
  Libcrux_ml_kem.Ind_cca.Instantiations.Avx2.decapsulate (Rust_primitives.mk_usize 4)
...
let encapsulate
     ...
     =
  Libcrux_ml_kem.Ind_cca.Instantiations.Avx2.encapsulate (Rust_primitives.mk_usize 4)
...
let generate_key_pair (randomness: t_Array u8 (Rust_primitives.mk_usize 64)) =
  Libcrux_ml_kem.Ind_cca.Instantiations.Avx2.generate_keypair (Rust_primitives.mk_usize 4)
...
let validate_public_key
      (public_key: Libcrux_ml_kem.Types.t_MlKemPublicKey (Rust_primitives.mk_usize 1568))
     =
  Libcrux_ml_kem.Ind_cca.Instantiations.Avx2.validate_public_key (Rust_primitives.mk_usize 4)
    (Rust_primitives.mk_usize 1536)
    (Rust_primitives.mk_usize 1568)
