...
let encapsulate1
     ...
     =
  Libcrux_ml_kem.Ind_cca.Incremental.Multiplexing.Alloc.encapsulate1 (mk_usize 4) (mk_usize 1568)
...
let encapsulate2
     ...
     =
  Libcrux_ml_kem.Ind_cca.Incremental.Multiplexing.Alloc.encapsulate2 (mk_usize 4)
    (mk_usize 1536)
    (mk_usize 160)
    (mk_usize 5)
...
let decapsulate
     ...
     =
  Libcrux_ml_kem.Ind_cca.Incremental.Multiplexing.Alloc.decapsulate (mk_usize 4) (mk_usize 3168)
