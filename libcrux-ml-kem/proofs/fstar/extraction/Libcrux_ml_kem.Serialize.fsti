...
val compress_then_serialize_10_
    ...
    : Prims.Pure (t_Array u8 v_OUT_LEN)
      (requires
        ((sz 20 *! Libcrux_ml_kem.Polynomial.v_VECTORS_IN_RING_ELEMENT <: usize) +! sz 20 <: usize) <=.
        v_OUT_LEN)
      (fun _ -> Prims.l_True)
...
val compress_then_serialize_11_
    ...
    : Prims.Pure (t_Array u8 v_OUT_LEN)
      (requires
        ((sz 22 *! Libcrux_ml_kem.Polynomial.v_VECTORS_IN_RING_ELEMENT <: usize) +! sz 22 <: usize) <=.
        v_OUT_LEN)
      (fun _ -> Prims.l_True)
