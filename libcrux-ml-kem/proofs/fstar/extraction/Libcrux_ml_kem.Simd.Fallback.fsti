module Libcrux_ml_kem.Simd.Fallback
#set-options "--fuel 0 --ifuel 1 --z3rlimit 15"
open Core
open FStar.Mul

type t_FallbackVector = { f_elements:t_Array i32 (sz 8) }

[@@ FStar.Tactics.Typeclasses.tcinstance]
let impl: Libcrux_ml_kem.Simd.Simd_trait.t_Operations t_FallbackVector =
  {
    f_Vector = t_FallbackVector;
    f_Vector_15713626723705489010 = FStar.Tactics.Typeclasses.solve ();
    f_FIELD_ELEMENTS_IN_VECTOR = sz 8;
    f_ZERO = { f_elements = Rust_primitives.Hax.repeat 0l (sz 8) } <: t_FallbackVector;
    f_to_i32_array_pre = (fun (v: t_FallbackVector) -> true);
    f_to_i32_array_post = (fun (v: t_FallbackVector) (out: t_Array i32 (sz 8)) -> true);
    f_to_i32_array = (fun (v: t_FallbackVector) -> v.f_elements);
    f_from_i32_array_pre = (fun (array: t_Array i32 (sz 8)) -> true);
    f_from_i32_array_post = (fun (array: t_Array i32 (sz 8)) (out: t_FallbackVector) -> true);
    f_from_i32_array
    =
    (fun (array: t_Array i32 (sz 8)) -> { f_elements = array } <: t_FallbackVector);
    f_add_constant_pre = (fun (v: t_FallbackVector) (c: i32) -> true);
    f_add_constant_post = (fun (v: t_FallbackVector) (c: i32) (out: t_FallbackVector) -> true);
    f_add_constant
    =
    (fun (v: t_FallbackVector) (c: i32) ->
        let v:t_FallbackVector =
        ...
        in
        v);
    f_add_pre = (fun (lhs: t_FallbackVector) (rhs: t_FallbackVector) -> true);
    f_add_post
    =
    (fun (lhs: t_FallbackVector) (rhs: t_FallbackVector) (out: t_FallbackVector) -> true);
    f_add
    =
    (fun (lhs: t_FallbackVector) (rhs: t_FallbackVector) ->
        let lhs:t_FallbackVector =
          Core.Iter.Traits.Iterator.f_fold (Core.Iter.Traits.Collect.f_into_iter ({
                    Core.Ops.Range.f_start = sz 0;
                    Core.Ops.Range.f_end = Libcrux_ml_kem.Simd.Simd_trait.f_FIELD_ELEMENTS_IN_VECTOR
                  }
            ...
            lhs
            (fun lhs i ->
                let lhs:t_FallbackVector = lhs in
                let i:usize = i in
                {
                  lhs with
                  f_elements
        ...
        in
        lhs);
    f_sub_pre = (fun (lhs: t_FallbackVector) (rhs: t_FallbackVector) -> true);
    f_sub_post
    =
    (fun (lhs: t_FallbackVector) (rhs: t_FallbackVector) (out: t_FallbackVector) -> true);
    f_sub
    ...
    (fun (lhs: t_FallbackVector) (rhs: t_FallbackVector) ->
        ...
        in
        lhs);
    f_multiply_by_constant_pre = (fun (v: t_FallbackVector) (c: i32) -> true);
    f_multiply_by_constant_post
    =
    (fun (v: t_FallbackVector) (c: i32) (out: t_FallbackVector) -> true);
    ...
    (fun (v: t_FallbackVector) (c: i32) ->
        ...
        in
        v);
    f_bitwise_and_with_constant_pre = (fun (v: t_FallbackVector) (c: i32) -> true);
    ...
    (fun (v: t_FallbackVector) (c: i32) ->
        ...
        in
        v);
    f_shift_right_pre = (fun (v: t_FallbackVector) (shift_amount: u8) -> true);
    f_shift_right_post
    =
    (fun (v: t_FallbackVector) (shift_amount: u8) (out: t_FallbackVector) -> true);
    f_shift_right
    =
    (fun (v: t_FallbackVector) (shift_amount: u8) ->
        let v:t_FallbackVector =
          Core.Iter.Traits.Iterator.f_fold (Core.Iter.Traits.Collect.f_into_iter ({
                    Core.Ops.Range.f_start = sz 0;
                    Core.Ops.Range.f_end = Libcrux_ml_kem.Simd.Simd_trait.f_FIELD_ELEMENTS_IN_VECTOR
        ...
        in
        v);
    f_shift_left_pre = (fun (lhs: t_FallbackVector) (shift_amount: u8) -> true);
    f_shift_left_post
    =
    (fun (lhs: t_FallbackVector) (shift_amount: u8) (out: t_FallbackVector) -> true);
    f_shift_left
    =
    (fun (lhs: t_FallbackVector) (shift_amount: u8) ->
        let lhs:t_FallbackVector =
          Core.Iter.Traits.Iterator.f_fold (Core.Iter.Traits.Collect.f_into_iter ({
                    Core.Ops.Range.f_start = sz 0;
                    Core.Ops.Range.f_end = Libcrux_ml_kem.Simd.Simd_trait.f_FIELD_ELEMENTS_IN_VECTOR
        ...
        in
        lhs);
    f_modulo_a_constant_pre = (fun (v: t_FallbackVector) (modulus: i32) -> true);
    f_modulo_a_constant_post
    =
    (fun (v: t_FallbackVector) (modulus: i32) (out: t_FallbackVector) -> true);
    f_modulo_a_constant
    =
    (fun (v: t_FallbackVector) (modulus: i32) ->
        let v:t_FallbackVector =
          Core.Iter.Traits.Iterator.f_fold (Core.Iter.Traits.Collect.f_into_iter ({
                    Core.Ops.Range.f_start = sz 0;
                    Core.Ops.Range.f_end = Libcrux_ml_kem.Simd.Simd_trait.f_FIELD_ELEMENTS_IN_VECTOR
        ...
        in
        v);
    f_barrett_reduce_pre = (fun (v: t_FallbackVector) -> true);
    f_barrett_reduce_post = (fun (v: t_FallbackVector) (out: t_FallbackVector) -> true);
    f_barrett_reduce
    =
    (fun (v: t_FallbackVector) ->
        let v:t_FallbackVector =
          Core.Iter.Traits.Iterator.f_fold (Core.Iter.Traits.Collect.f_into_iter ({
                    Core.Ops.Range.f_start = sz 0;
                    Core.Ops.Range.f_end = Libcrux_ml_kem.Simd.Simd_trait.f_FIELD_ELEMENTS_IN_VECTOR
        ...
        in
        v);
    f_montgomery_reduce_pre = (fun (v: t_FallbackVector) -> true);
    f_montgomery_reduce_post = (fun (v: t_FallbackVector) (out: t_FallbackVector) -> true);
    f_montgomery_reduce
    =
    (fun (v: t_FallbackVector) ->
        let v:t_FallbackVector =
        ...
        in
        v);
    f_compress_1_pre = (fun (v: t_FallbackVector) -> true);
    f_compress_1_post = (fun (v: t_FallbackVector) (out: t_FallbackVector) -> true);
    f_compress_1_
    =
    (fun (v: t_FallbackVector) ->
        let v:t_FallbackVector =
        ...
        in
        v);
    f_compress_pre = (fun (coefficient_bits: u8) (v: t_FallbackVector) -> true);
    f_compress_post
    =
    (fun (coefficient_bits: u8) (v: t_FallbackVector) (out: t_FallbackVector) -> true);
    f_compress
    =
    (fun (coefficient_bits: u8) (v: t_FallbackVector) ->
        let v:t_FallbackVector =
          Core.Iter.Traits.Iterator.f_fold (Core.Iter.Traits.Collect.f_into_iter ({
                    Core.Ops.Range.f_start = sz 0;
                    Core.Ops.Range.f_end = Libcrux_ml_kem.Simd.Simd_trait.f_FIELD_ELEMENTS_IN_VECTOR
        ...
        in
        v);
    f_ntt_layer_1_step_pre = (fun (v: t_FallbackVector) (zeta1: i32) (zeta2: i32) -> true);
    f_ntt_layer_1_step_post
    =
    (fun (v: t_FallbackVector) (zeta1: i32) (zeta2: i32) (out: t_FallbackVector) -> true);
    f_ntt_layer_1_step
    =
    (fun (v: t_FallbackVector) (zeta1: i32) (zeta2: i32) ->
        let t:i32 =
        ...
        in
        v);
    f_ntt_layer_2_step_pre = (fun (v: t_FallbackVector) (zeta: i32) -> true);
    f_ntt_layer_2_step_post
    =
    (fun (v: t_FallbackVector) (zeta: i32) (out: t_FallbackVector) -> true);
    f_ntt_layer_2_step
    =
    (fun (v: t_FallbackVector) (zeta: i32) ->
        let t:i32 =
        ...
        in
        v);
    f_inv_ntt_layer_1_step_pre = (fun (v: t_FallbackVector) (zeta1: i32) (zeta2: i32) -> true);
    ...
    (fun (v: t_FallbackVector) (zeta1: i32) (zeta2: i32) ->
        ...
        in
        v);
    f_inv_ntt_layer_2_step_pre = (fun (v: t_FallbackVector) (zeta: i32) -> true);
    ...
    f_ntt_multiply_pre
    =
    (fun (lhs: t_FallbackVector) (rhs: t_FallbackVector) (zeta0: i32) (zeta1: i32) -> true);
    f_ntt_multiply_post
    =
    (fun
        (lhs: t_FallbackVector)
        (rhs: t_FallbackVector)
        (zeta0: i32)
        (zeta1: i32)
        (out1: t_FallbackVector)
        ->
        true);
    f_ntt_multiply
    =
    (fun (lhs: t_FallbackVector) (rhs: t_FallbackVector) (zeta0: i32) (zeta1: i32) ->
        let out:t_FallbackVector = Libcrux_ml_kem.Simd.Simd_trait.f_ZERO () in
        let product:(i32 & i32) =
        ...
        in
        out);
    f_serialize_1_pre = (fun (v: t_FallbackVector) -> true);
    f_serialize_1_post = (fun (v: t_FallbackVector) (out: u8) -> true);
    f_serialize_1_
    =
    (fun (v: t_FallbackVector) ->
    ...
    f_deserialize_1_post = (fun (v: u8) (out: t_FallbackVector) -> true);
    f_deserialize_1_
    =
    (fun (v: u8) ->
        let result:t_FallbackVector = Libcrux_ml_kem.Simd.Simd_trait.f_ZERO () in
        let result:t_FallbackVector =
          Core.Iter.Traits.Iterator.f_fold (Core.Iter.Traits.Collect.f_into_iter ({
                    Core.Ops.Range.f_start = sz 0;
                    Core.Ops.Range.f_end = Libcrux_ml_kem.Simd.Simd_trait.f_FIELD_ELEMENTS_IN_VECTOR
                  }
            ...
            result
            (fun result i ->
                let result:t_FallbackVector = result in
                let i:usize = i in
                {
                  result with
                  f_elements
        ...
        in
        result);
    f_serialize_4_pre = (fun (v: t_FallbackVector) -> true);
    f_serialize_4_post = (fun (v: t_FallbackVector) (out: t_Array u8 (sz 4)) -> true);
    f_serialize_4_
    =
    (fun (v: t_FallbackVector) ->
    ...
    f_deserialize_4_post = (fun (bytes: t_Slice u8) (out: t_FallbackVector) -> true);
    f_deserialize_4_
    =
    (fun (bytes: t_Slice u8) ->
        let v:t_FallbackVector = Libcrux_ml_kem.Simd.Simd_trait.f_ZERO () in
        let v:t_FallbackVector =
          {
            v with
            f_elements
        ...
        in
        v);
    f_serialize_5_pre = (fun (v: t_FallbackVector) -> true);
    f_serialize_5_post = (fun (v: t_FallbackVector) (out: t_Array u8 (sz 5)) -> true);
    f_serialize_5_
    =
    (fun (v: t_FallbackVector) ->
    ...
    f_deserialize_5_post = (fun (bytes: t_Slice u8) (out: t_FallbackVector) -> true);
    f_deserialize_5_
    =
    (fun (bytes: t_Slice u8) ->
        let v:t_FallbackVector = Libcrux_ml_kem.Simd.Simd_trait.f_ZERO () in
        ...
        in
        v);
    f_serialize_10_pre = (fun (v: t_FallbackVector) -> true);
    f_serialize_10_post = (fun (v: t_FallbackVector) (out: t_Array u8 (sz 10)) -> true);
    f_serialize_10_
    =
    (fun (v: t_FallbackVector) ->
    ...
    f_deserialize_10_post = (fun (bytes: t_Slice u8) (out: t_FallbackVector) -> true);
    f_deserialize_10_
    =
    (fun (bytes: t_Slice u8) ->
        let result:t_FallbackVector = Libcrux_ml_kem.Simd.Simd_trait.f_ZERO () in
        ...
        in
        result);
    f_serialize_11_pre = (fun (v: t_FallbackVector) -> true);
    f_serialize_11_post = (fun (v: t_FallbackVector) (out: t_Array u8 (sz 11)) -> true);
    f_serialize_11_
    =
    (fun (v: t_FallbackVector) ->
    ...
    f_deserialize_11_post = (fun (bytes: t_Slice u8) (out: t_FallbackVector) -> true);
    f_deserialize_11_
    =
    (fun (bytes: t_Slice u8) ->
        let result:t_FallbackVector = Libcrux_ml_kem.Simd.Simd_trait.f_ZERO () in
        ...
        in
        result);
    f_serialize_12_pre = (fun (v: t_FallbackVector) -> true);
    f_serialize_12_post = (fun (v: t_FallbackVector) (out: t_Array u8 (sz 12)) -> true);
    f_serialize_12_
    =
    (fun (v: t_FallbackVector) ->
    ...
    f_deserialize_12_post = (fun (bytes: t_Slice u8) (out: t_FallbackVector) -> true);
    f_deserialize_12_
    =
    fun (bytes: t_Slice u8) ->
      let re:t_FallbackVector = Libcrux_ml_kem.Simd.Simd_trait.f_ZERO () in
