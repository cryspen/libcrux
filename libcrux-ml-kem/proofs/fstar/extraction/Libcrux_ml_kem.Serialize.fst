  ...
  let serialized:t_Array u8 v_OUT_LEN =
    Core.Iter.Traits.Iterator.f_fold (Core.Iter.Traits.Collect.f_into_iter ({
      ...
      (fun serialized i ->
          ...
          let i:usize = i in
          let coefficient:Libcrux_ml_kem.Simd.Simd128.t_SIMD128Vector =
  ...
  let serialized:t_Array u8 v_OUT_LEN =
    Core.Iter.Traits.Iterator.f_fold (Core.Iter.Traits.Collect.f_into_iter ({
      ...
      (fun serialized i ->
          let serialized:t_Array u8 v_OUT_LEN = serialized in
          let i:usize = i in
          let coefficients:Libcrux_ml_kem.Simd.Simd128.t_SIMD128Vector =
      ...
      (fun serialized i ->
          ...
          let coefficient:Libcrux_ml_kem.Simd.Simd128.t_SIMD128Vector =
            Libcrux_ml_kem.Simd.Simd_trait.f_to_unsigned_representative (re
                ...
                Libcrux_ml_kem.Simd.Simd128.t_SIMD128Vector)
          in
          let coefficient_compressed:Libcrux_ml_kem.Simd.Simd128.t_SIMD128Vector =
