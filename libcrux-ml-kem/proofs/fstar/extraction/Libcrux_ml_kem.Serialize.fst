  ...
  let serialized:t_Array u8 v_OUT_LEN =
    Core.Iter.Traits.Iterator.f_fold (Core.Iter.Traits.Collect.f_into_iter ({
      ...
      (fun serialized i ->
          ...
          let i:usize = i in
          let coefficient:Libcrux_ml_kem.Simd.Fallback.t_FallbackVector =
  ...
  let serialized:t_Array u8 v_OUT_LEN =
    Core.Iter.Traits.Iterator.f_fold (Core.Iter.Traits.Collect.f_into_iter ({
      ...
      (fun serialized i ->
          let serialized:t_Array u8 v_OUT_LEN = serialized in
          let i:usize = i in
          let coefficients:Libcrux_ml_kem.Simd.Fallback.t_FallbackVector =
      ...
      (fun serialized i ->
          ...
          let coefficient:Libcrux_ml_kem.Simd.Fallback.t_FallbackVector =
            Libcrux_ml_kem.Simd.Simd_trait.f_to_unsigned_representative (re
                ...
                Libcrux_ml_kem.Simd.Fallback.t_FallbackVector)
          in
          let coefficient_compressed:Libcrux_ml_kem.Simd.Fallback.t_FallbackVector =
