  ...
  let v_A_transpose:t_Array
    ...
    Rust_primitives.Hax.Folds.fold_range (Rust_primitives.mk_usize 0)
      ...
      (fun v_A_transpose i ->
          ...
          in
          let i:usize = i in
          let seeds:t_Array (t_Array u8 (Rust_primitives.mk_usize 34)) v_K =
            Rust_primitives.Hax.repeat seed v_K
          in
          let seeds:t_Array (t_Array u8 (Rust_primitives.mk_usize 34)) v_K =
            Rust_primitives.Hax.Folds.fold_range (Rust_primitives.mk_usize 0)
              v_K
              (fun seeds temp_1_ ->
                  let seeds:t_Array (t_Array u8 (Rust_primitives.mk_usize 34)) v_K = seeds in
                  let _:usize = temp_1_ in
                  true)
              seeds
              (fun seeds j ->
