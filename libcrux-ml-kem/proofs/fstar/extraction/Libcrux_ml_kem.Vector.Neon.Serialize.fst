...
let deserialize_1_ (a: t_Slice u8) =
  let one:u8 = Libcrux_intrinsics.Arm64_extract.v__vdupq_n_s16 (Rust_primitives.mk_i16 1) in
  let low:u8 =
    Libcrux_intrinsics.Arm64_extract.v__vdupq_n_s16 (cast (a.[ Rust_primitives.mk_usize 0 ] <: u8)
        <:
        i16)
  in
  let high:u8 =
    Libcrux_intrinsics.Arm64_extract.v__vdupq_n_s16 (cast (a.[ Rust_primitives.mk_usize 1 ] <: u8)
        <:
        i16)
  in
  let (shifter: t_Array i16 (Rust_primitives.mk_usize 8)):t_Array i16 (Rust_primitives.mk_usize 8) =
    let list =
      [
        ...
        Rust_primitives.mk_i16 (-5);
        Rust_primitives.mk_i16 (-6);
        Rust_primitives.mk_i16 (-7)
      ]
    in
...
let deserialize_12_ (v: t_Slice u8) =
  let (indexes: t_Array u8 (Rust_primitives.mk_usize 16)):t_Array u8 (Rust_primitives.mk_usize 16) =
    let list =
      [
        Rust_primitives.mk_u8 0; Rust_primitives.mk_u8 1; Rust_primitives.mk_u8 1;
        ...
        Rust_primitives.mk_u8 7; Rust_primitives.mk_u8 7; Rust_primitives.mk_u8 8;
        Rust_primitives.mk_u8 9; Rust_primitives.mk_u8 10; Rust_primitives.mk_u8 10;
        Rust_primitives.mk_u8 11
      ]
    in
  ...
  let (shifts: t_Array i16 (Rust_primitives.mk_usize 8)):t_Array i16 (Rust_primitives.mk_usize 8) =
    let list =
      [
        Rust_primitives.mk_i16 0;
        Rust_primitives.mk_i16 (-4);
  ...
  let mask12:u8 = Libcrux_intrinsics.Arm64_extract.v__vdupq_n_u16 (Rust_primitives.mk_u16 4095) in
  let input0:t_Array u8 (Rust_primitives.mk_usize 16) =
  ...
  let input1:t_Array u8 (Rust_primitives.mk_usize 16) =
    Rust_primitives.Hax.repeat (Rust_primitives.mk_u8 0) (Rust_primitives.mk_usize 16)
  in
  let input1:t_Array u8 (Rust_primitives.mk_usize 16) =
...
let serialize_10_ (v: Libcrux_ml_kem.Vector.Neon.Vector_type.t_SIMD128Vector) =
  ...
  in
  let mixt:u8 =
    Libcrux_intrinsics.Arm64_extract.v__vsliq_n_s32 (Rust_primitives.mk_i32 10) low0 low1
  in
  let low0:u8 =
  ...
  in
  let low_mix:u8 =
    Libcrux_intrinsics.Arm64_extract.v__vsliq_n_s64 (Rust_primitives.mk_i32 20) low0 low1
  in
  let high0:u8 =
    Libcrux_intrinsics.Arm64_extract.v__vreinterpretq_s32_s16 (Libcrux_intrinsics.Arm64_extract.v__vtrn1q_s16
  ...
  in
  let mixt:u8 =
    Libcrux_intrinsics.Arm64_extract.v__vsliq_n_s32 (Rust_primitives.mk_i32 10) high0 high1
  in
  let high0:u8 =
    Libcrux_intrinsics.Arm64_extract.v__vreinterpretq_s64_s32 (Libcrux_intrinsics.Arm64_extract.v__vtrn1q_s32
          mixt
  ...
  in
  let high_mix:u8 =
    Libcrux_intrinsics.Arm64_extract.v__vsliq_n_s64 (Rust_primitives.mk_i32 20) high0 high1
  in
  let result32:t_Array u8 (Rust_primitives.mk_usize 32) =
  ...
  let result32:t_Array u8 (Rust_primitives.mk_usize 32) =
    Rust_primitives.Hax.Monomorphized_update_at.update_at_range result32
      ({
          Core.Ops.Range.f_start = Rust_primitives.mk_usize 16;
          Core.Ops.Range.f_end = Rust_primitives.mk_usize 32
        }
        <:
        Core.Ops.Range.t_Range usize)
      (Libcrux_intrinsics.Arm64_extract.v__vst1q_u8 (result32.[ {
        ...
        t_Slice u8)
  in
  let result:t_Array u8 (Rust_primitives.mk_usize 20) =
    Rust_primitives.Hax.repeat (Rust_primitives.mk_u8 0) (Rust_primitives.mk_usize 20)
  in
  let result:t_Array u8 (Rust_primitives.mk_usize 20) =
    ...
    Rust_primitives.Hax.Monomorphized_update_at.update_at_range result
      ...
      (Core.Slice.impl__copy_from_slice #u8
          (result.[ {
            ...
            t_Slice u8)
          (result32.[ {
                Core.Ops.Range.f_start = Rust_primitives.mk_usize 24;
                Core.Ops.Range.f_end = Rust_primitives.mk_usize 29
              }
              <:
              Core.Ops.Range.t_Range usize ]
            <:
...
let serialize_12_ (v: Libcrux_ml_kem.Vector.Neon.Vector_type.t_SIMD128Vector) =
  ...
  in
  let mixt:u8 =
    Libcrux_intrinsics.Arm64_extract.v__vsliq_n_s32 (Rust_primitives.mk_i32 12) low0 low1
  in
  let low0:u8 =
    Libcrux_intrinsics.Arm64_extract.v__vreinterpretq_s64_s32 (Libcrux_intrinsics.Arm64_extract.v__vtrn1q_s32
          mixt
  ...
  in
  let low_mix:u8 =
    Libcrux_intrinsics.Arm64_extract.v__vsliq_n_s64 (Rust_primitives.mk_i32 24) low0 low1
  in
  let high0:u8 =
    Libcrux_intrinsics.Arm64_extract.v__vreinterpretq_s32_s16 (Libcrux_intrinsics.Arm64_extract.v__vtrn1q_s16
          v.Libcrux_ml_kem.Vector.Neon.Vector_type.f_high
  ...
  in
  let mixt:u8 =
    Libcrux_intrinsics.Arm64_extract.v__vsliq_n_s32 (Rust_primitives.mk_i32 12) high0 high1
  in
  let high0:u8 =
    Libcrux_intrinsics.Arm64_extract.v__vreinterpretq_s64_s32 (Libcrux_intrinsics.Arm64_extract.v__vtrn1q_s32
          mixt
  ...
  in
  let high_mix:u8 =
    Libcrux_intrinsics.Arm64_extract.v__vsliq_n_s64 (Rust_primitives.mk_i32 24) high0 high1
  in
  let result32:t_Array u8 (Rust_primitives.mk_usize 32) =
    Rust_primitives.Hax.repeat (Rust_primitives.mk_u8 0) (Rust_primitives.mk_usize 32)
  in
  ...
  let result32:t_Array u8 (Rust_primitives.mk_usize 32) =
    Rust_primitives.Hax.Monomorphized_update_at.update_at_range result32
      ...
      (Libcrux_intrinsics.Arm64_extract.v__vst1q_u8 (result32.[ {
        ...
        t_Slice u8)
  in
  let result:t_Array u8 (Rust_primitives.mk_usize 24) =
  ...
  let result:t_Array u8 (Rust_primitives.mk_usize 24) =
    Rust_primitives.Hax.Monomorphized_update_at.update_at_range result
      ...
      (Core.Slice.impl__copy_from_slice #u8
          ...
          (result32.[ {
                Core.Ops.Range.f_start = Rust_primitives.mk_usize 24;
                Core.Ops.Range.f_end = Rust_primitives.mk_usize 30
              }
              <:
              Core.Ops.Range.t_Range usize ]
            <:
...
let serialize_4_ (v: Libcrux_ml_kem.Vector.Neon.Vector_type.t_SIMD128Vector) =
  let (shifter: t_Array i16 (Rust_primitives.mk_usize 8)):t_Array i16 (Rust_primitives.mk_usize 8) =
    let list =
      [
        Rust_primitives.mk_i16 0;
        Rust_primitives.mk_i16 4;
        Rust_primitives.mk_i16 8;
        Rust_primitives.mk_i16 12;
        Rust_primitives.mk_i16 0;
        Rust_primitives.mk_i16 4;
        Rust_primitives.mk_i16 8;
        Rust_primitives.mk_i16 12
  ...
  in
  let sum:u64 =
    ((sum0 |. (sum1 <<! Rust_primitives.mk_i32 16 <: u64) <: u64) |.
      (sum2 <<! Rust_primitives.mk_i32 32 <: u64)
      <:
      u64) |.
    (sum3 <<! Rust_primitives.mk_i32 48 <: u64)
  in
...
let deserialize_4_ (v: t_Slice u8) =
  let input:Libcrux_ml_kem.Vector.Portable.Vector_type.t_PortableVector =
    Libcrux_ml_kem.Vector.Traits.f_deserialize_4_ #Libcrux_ml_kem.Vector.Portable.Vector_type.t_PortableVector
      ...
      v
  in
  let input_i16s:t_Array i16 (Rust_primitives.mk_usize 16) =
    Libcrux_ml_kem.Vector.Traits.f_to_i16_array #Libcrux_ml_kem.Vector.Portable.Vector_type.t_PortableVector
      #FStar.Tactics.Typeclasses.solve
      input
  in
...
let serialize_11_ (v: Libcrux_ml_kem.Vector.Neon.Vector_type.t_SIMD128Vector) =
  let out_i16s:t_Array i16 (Rust_primitives.mk_usize 16) =
    Libcrux_ml_kem.Vector.Neon.Vector_type.to_i16_array v
  in
