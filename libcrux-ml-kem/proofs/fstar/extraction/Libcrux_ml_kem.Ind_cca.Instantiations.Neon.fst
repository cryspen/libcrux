...
let decapsulate
     ...
     =
  Libcrux_ml_kem.Ind_cca.decapsulate #v_K #v_SECRET_KEY_SIZE #v_CPA_SECRET_KEY_SIZE
...
let encapsulate
     ...
     =
  Libcrux_ml_kem.Ind_cca.encapsulate #v_K #v_CIPHERTEXT_SIZE #v_PUBLIC_KEY_SIZE
