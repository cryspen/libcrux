...
let impl_3: Libcrux_ml_kem.Vector.Traits.t_Operations t_SIMD256Vector =
  {
    ...
    (fun (lhs: t_SIMD256Vector) (rhs: t_SIMD256Vector) ->
        Libcrux_ml_kem.Vector.Traits.add_pre (impl.f_repr lhs) (impl.f_repr rhs));
    f_add_post
    =
    (fun (lhs: t_SIMD256Vector) (rhs: t_SIMD256Vector) (result: t_SIMD256Vector) ->
        Libcrux_ml_kem.Vector.Traits.add_post (impl.f_repr lhs)
          (impl.f_repr rhs)
          (impl.f_repr result));
    f_add
    =
    ...
    =
    (fun (lhs: t_SIMD256Vector) (rhs: t_SIMD256Vector) ->
        Libcrux_ml_kem.Vector.Traits.sub_pre (impl.f_repr lhs) (impl.f_repr rhs));
    f_sub_post
    =
    (fun (lhs: t_SIMD256Vector) (rhs: t_SIMD256Vector) (result: t_SIMD256Vector) ->
        Libcrux_ml_kem.Vector.Traits.sub_post (impl.f_repr lhs)
          (impl.f_repr rhs)
          (impl.f_repr result));
    f_sub
    =
    ...
    f_serialize_5__pre = (fun (vector: t_SIMD256Vector) -> true);
    f_serialize_5__post = (fun (vector: t_SIMD256Vector) (out: t_Array u8 (mk_usize 10)) -> true);
    f_serialize_5_
    =
    (fun (vector: t_SIMD256Vector) ->
    ...
    f_deserialize_5__post = (fun (bytes: t_Slice u8) (out: t_SIMD256Vector) -> true);
    f_deserialize_5_
    =
    ...
    f_serialize_11__pre = (fun (vector: t_SIMD256Vector) -> true);
    f_serialize_11__post = (fun (vector: t_SIMD256Vector) (out: t_Array u8 (mk_usize 22)) -> true);
    f_serialize_11_
    =
    (fun (vector: t_SIMD256Vector) ->
    ...
    f_deserialize_11__post = (fun (bytes: t_Slice u8) (out: t_SIMD256Vector) -> true);
    f_deserialize_11_
    =
    (fun (bytes: t_Slice u8) ->
