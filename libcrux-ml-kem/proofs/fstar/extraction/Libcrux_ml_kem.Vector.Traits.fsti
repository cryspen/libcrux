...
class t_Operations (v_Self: Type0) = {
  ...
  f_serialize_1_post:a: v_Self -> result: t_Array u8 (mk_usize 2)
    -> pred:
      Type0
        { pred ==>
  ...
  f_serialize_4_post:a: v_Self -> result: t_Array u8 (mk_usize 8)
    -> pred:
      Type0
        { pred ==>
  ...
  f_serialize_5_post:v_Self -> t_Array u8 (mk_usize 10) -> Type0;
  ...
  f_serialize_10_post:a: v_Self -> result: t_Array u8 (mk_usize 20)
    -> pred:
      Type0
        { pred ==>
  ...
  f_serialize_11_post:v_Self -> t_Array u8 (mk_usize 22) -> Type0;
  ...
  f_serialize_12_post:a: v_Self -> result: t_Array u8 (mk_usize 24)
    -> pred:
      Type0
        { pred ==>
