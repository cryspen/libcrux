...
class t_Repr (v_Self: Type0) = {
  ...
  f_repr_post:v_Self -> t_Array i16 (Rust_primitives.mk_usize 16) -> Type0;
  f_repr:x0: v_Self
    -> Prims.Pure (t_Array i16 (Rust_primitives.mk_usize 16))
        (f_repr_pre x0)
        (fun result -> f_repr_post x0 result)
}
...
class t_Operations (v_Self: Type0) = {
  ...
  f_from_i16_array_pre:array: t_Slice i16
    -> pred:
      Type0{(Core.Slice.impl__len #i16 array <: usize) =. Rust_primitives.mk_usize 16 ==> pred};
  ...
  f_to_i16_array_post:x: v_Self -> result: t_Array i16 (Rust_primitives.mk_usize 16)
  ...
  f_serialize_1_post:a: v_Self -> result: t_Array u8 (Rust_primitives.mk_usize 2)
    -> pred:
      Type0
        { pred ==>
  ...
  f_deserialize_1_pre:a: t_Slice u8
    -> pred: Type0{(Core.Slice.impl__len #u8 a <: usize) =. Rust_primitives.mk_usize 2 ==> pred};
  ...
  f_serialize_4_post:a: v_Self -> result: t_Array u8 (Rust_primitives.mk_usize 8)
    -> pred:
      Type0
        { pred ==>
  ...
  f_deserialize_4_pre:a: t_Slice u8
    -> pred: Type0{(Core.Slice.impl__len #u8 a <: usize) =. Rust_primitives.mk_usize 8 ==> pred};
  ...
  f_serialize_5_post:v_Self -> t_Array u8 (Rust_primitives.mk_usize 10) -> Type0;
  ...
  f_deserialize_5_pre:a: t_Slice u8
    -> pred: Type0{(Core.Slice.impl__len #u8 a <: usize) =. Rust_primitives.mk_usize 10 ==> pred};
  ...
  f_serialize_10_post:a: v_Self -> result: t_Array u8 (Rust_primitives.mk_usize 20)
    -> pred:
      Type0
        { pred ==>
  ...
  f_deserialize_10_pre:a: t_Slice u8
    -> pred: Type0{(Core.Slice.impl__len #u8 a <: usize) =. Rust_primitives.mk_usize 20 ==> pred};
  ...
  f_serialize_11_post:v_Self -> t_Array u8 (Rust_primitives.mk_usize 22) -> Type0;
  f_serialize_11_:x0: v_Self
    -> Prims.Pure (t_Array u8 (Rust_primitives.mk_usize 22))
        (f_serialize_11_pre x0)
        (fun result -> f_serialize_11_post x0 result);
  f_deserialize_11_pre:a: t_Slice u8
    -> pred: Type0{(Core.Slice.impl__len #u8 a <: usize) =. Rust_primitives.mk_usize 22 ==> pred};
  ...
  f_serialize_12_post:a: v_Self -> result: t_Array u8 (Rust_primitives.mk_usize 24)
    -> pred:
      Type0
        { pred ==>
  ...
  f_deserialize_12_pre:a: t_Slice u8
    -> pred: Type0{(Core.Slice.impl__len #u8 a <: usize) =. Rust_primitives.mk_usize 24 ==> pred};
...
let v_BARRETT_SHIFT: i32 = Rust_primitives.mk_i32 26

let v_BARRETT_R: i32 = Rust_primitives.mk_i32 1 <<! v_BARRETT_SHIFT

let v_FIELD_ELEMENTS_IN_VECTOR: usize = Rust_primitives.mk_usize 16

let v_FIELD_MODULUS: i16 = Rust_primitives.mk_i16 3329

let v_INVERSE_OF_MODULUS_MOD_MONTGOMERY_R: u32 = Rust_primitives.mk_u32 62209

let v_MONTGOMERY_R_SQUARED_MOD_FIELD_MODULUS: i16 = Rust_primitives.mk_i16 1353
