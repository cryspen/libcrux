...
class t_Operations (v_Self: Type0) = {
  ...
  f_ntt_layer_1_step_post:
      ...
      zeta3: i16 ->
      out: v_Self
    -> pred: Type0{pred ==> Spec.Utils.is_i16b_array_opaque (11207 + 6 * 3328) (f_repr out)};
  ...
  f_ntt_layer_2_step_post:a: v_Self -> zeta0: i16 -> zeta1: i16 -> out: v_Self
    -> pred: Type0{pred ==> Spec.Utils.is_i16b_array_opaque (11207 + 5 * 3328) (f_repr out)};
  ...
  f_ntt_layer_3_step_post:a: v_Self -> zeta: i16 -> out: v_Self
    -> pred: Type0{pred ==> Spec.Utils.is_i16b_array_opaque (11207 + 4 * 3328) (f_repr out)};
  ...
  f_inv_ntt_layer_3_step_pre:a: v_Self -> zeta: i16
    -> pred:
      Type0
        {Spec.Utils.is_i16b 1664 zeta /\ Spec.Utils.is_i16b_array_opaque 3328 (f_repr a) ==> pred};
