    ...
    : Prims.Pure Libcrux_ml_kem.Vector.Portable.Vector_type.t_PortableVector
      ...
      (ensures
        fun result ->
          ...
          Spec.Utils.is_i16b_array (8 * 3328) result.f_elements /\
          Spec.Utils.ntt_layer_1_butterfly_post vec.f_elements
            result.f_elements
            zeta0
            zeta1
            zeta2
...
val ntt_layer_2_step
    ...
    : Prims.Pure Libcrux_ml_kem.Vector.Portable.Vector_type.t_PortableVector
      ...
      (ensures
        fun result ->
          let result:Libcrux_ml_kem.Vector.Portable.Vector_type.t_PortableVector = result in
          Spec.Utils.is_i16b_array (7 * 3328) result.f_elements /\
...
val ntt_layer_3_step (vec: Libcrux_ml_kem.Vector.Portable.Vector_type.t_PortableVector) (zeta: i16)
    : Prims.Pure Libcrux_ml_kem.Vector.Portable.Vector_type.t_PortableVector
      (requires Spec.Utils.is_i16b 1664 zeta /\ Spec.Utils.is_i16b_array (5 * 3328) vec.f_elements)
      (ensures
        fun result ->
          let result:Libcrux_ml_kem.Vector.Portable.Vector_type.t_PortableVector = result in
    ...
    : Prims.Pure Libcrux_ml_kem.Vector.Portable.Vector_type.t_PortableVector
      ...
      (ensures
        fun out_future ->
          ...
          Spec.Utils.modifies2_16 out.f_elements
            out_future.f_elements
            (sz 2 *! i)
            ((sz 2 *! i) +! sz 1) /\ ntt_multiply_binomials_post a b zeta i out_future)
      ...
      (ensures
        fun result ->
          ...
          (let nzeta0:i16 = mk_i16 0 -! zeta0 in
            ...
            let zetas =
              Seq.seq_of_list [zeta0; nzeta0; zeta1; nzeta1; zeta2; nzeta2; zeta3; nzeta3]
            in
            Spec.Utils.forall8 (fun i ->
                  ntt_multiply_binomials_post lhs rhs (Seq.index zetas i) (sz i) result)))
