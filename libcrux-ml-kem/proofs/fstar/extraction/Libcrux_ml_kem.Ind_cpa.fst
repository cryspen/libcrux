  ...
  let domain_separator, error_1_, prf_input:(u8 &
    ...
    Core.Iter.Traits.Iterator.f_fold (Core.Iter.Traits.Collect.f_into_iter ({
      ...
      (domain_separator, error_1_, prf_input
        <:
        (u8 & t_Array Libcrux_ml_kem.Polynomial.t_PolynomialRingElement v_K & t_Array u8 (sz 33)))
      (fun temp_0_ i ->
          let domain_separator, error_1_, prf_input:(u8 &
            t_Array Libcrux_ml_kem.Polynomial.t_PolynomialRingElement v_K &
            t_Array u8 (sz 33)) =
          ...
          let (prf_output: t_Array u8 v_ETA2_RANDOMNESS_SIZE):t_Array u8 v_ETA2_RANDOMNESS_SIZE =
            Libcrux_ml_kem.Hash_functions.v_PRF v_ETA2_RANDOMNESS_SIZE
          ...
          (u8 & t_Array Libcrux_ml_kem.Polynomial.t_PolynomialRingElement v_K & t_Array u8 (sz 33)))
  in
  let hax_temp_output:t_Array Libcrux_ml_kem.Polynomial.t_PolynomialRingElement v_K = error_1_ in
...
let sample_vector_cbd_then_ntt
  ...
  let domain_separator, prf_input, re_as_ntt:(u8 & t_Array u8 (sz 33) &
    ...
    Core.Iter.Traits.Iterator.f_fold (Core.Iter.Traits.Collect.f_into_iter ({
      ...
      (domain_separator, prf_input, re_as_ntt
        <:
        (u8 & t_Array u8 (sz 33) & t_Array Libcrux_ml_kem.Polynomial.t_PolynomialRingElement v_K))
      (fun temp_0_ i ->
          let domain_separator, prf_input, re_as_ntt:(u8 & t_Array u8 (sz 33) &
            t_Array Libcrux_ml_kem.Polynomial.t_PolynomialRingElement v_K) =
            temp_0_
          ...
          let (prf_output: t_Array u8 v_ETA_RANDOMNESS_SIZE):t_Array u8 v_ETA_RANDOMNESS_SIZE =
            Libcrux_ml_kem.Hash_functions.v_PRF v_ETA_RANDOMNESS_SIZE
              (Rust_primitives.unsize prf_input <: t_Slice u8)
          in
          let r:Libcrux_ml_kem.Polynomial.t_PolynomialRingElement =
          ...
          let re_as_ntt:t_Array Libcrux_ml_kem.Polynomial.t_PolynomialRingElement v_K =
            Rust_primitives.Hax.Monomorphized_update_at.update_at_usize re_as_ntt
              i
              (Libcrux_ml_kem.Ntt.ntt_binomially_sampled_ring_element r
                <:
                Libcrux_ml_kem.Polynomial.t_PolynomialRingElement)
          in
          domain_separator, prf_input, re_as_ntt
  ...
  <:
  (t_Array Libcrux_ml_kem.Polynomial.t_PolynomialRingElement v_K & u8)
  ...
  let out:t_Array u8 v_OUT_LEN =
    Core.Iter.Traits.Iterator.f_fold (Core.Iter.Traits.Collect.f_into_iter (Core.Iter.Traits.Iterator.f_enumerate
              (Core.Iter.Traits.Collect.f_into_iter input
                <:
                Core.Array.Iter.t_IntoIter Libcrux_ml_kem.Polynomial.t_PolynomialRingElement v_K)
            <:
      ...
      (fun out temp_1_ ->
          ...
          let i, re:(usize & Libcrux_ml_kem.Polynomial.t_PolynomialRingElement) = temp_1_ in
          Rust_primitives.Hax.Monomorphized_update_at.update_at_range out
            ({
  ...
  let u_as_ntt:t_Array Libcrux_ml_kem.Polynomial.t_PolynomialRingElement v_K =
    Core.Iter.Traits.Iterator.f_fold (Core.Iter.Traits.Collect.f_into_iter (Core.Iter.Traits.Iterator.f_enumerate
      ...
      (fun u_as_ntt temp_1_ ->
          let u_as_ntt:t_Array Libcrux_ml_kem.Polynomial.t_PolynomialRingElement v_K = u_as_ntt in
          let i, u_bytes:(usize & t_Slice u8) = temp_1_ in
          let u:Libcrux_ml_kem.Polynomial.t_PolynomialRingElement =
          ...
          let u_as_ntt:t_Array Libcrux_ml_kem.Polynomial.t_PolynomialRingElement v_K =
            Rust_primitives.Hax.Monomorphized_update_at.update_at_usize u_as_ntt
              i
              (Libcrux_ml_kem.Ntt.ntt_vector_u v_U_COMPRESSION_FACTOR u
                <:
                Libcrux_ml_kem.Polynomial.t_PolynomialRingElement)
          in
          u_as_ntt)
...
let encrypt
     ...
     =
  let tt_as_ntt:t_Array Libcrux_ml_kem.Polynomial.t_PolynomialRingElement v_K =
  ...
  let r_as_ntt, domain_separator:(t_Array Libcrux_ml_kem.Polynomial.t_PolynomialRingElement v_K & u8
  ) =
  ...
  let error_1_:t_Array Libcrux_ml_kem.Polynomial.t_PolynomialRingElement v_K = out in
  let prf_input:t_Array u8 (sz 33) =
  ...
  let (prf_output: t_Array u8 v_ETA2_RANDOMNESS_SIZE):t_Array u8 v_ETA2_RANDOMNESS_SIZE =
    Libcrux_ml_kem.Hash_functions.v_PRF v_ETA2_RANDOMNESS_SIZE
      (Rust_primitives.unsize prf_input <: t_Slice u8)
  in
  let error_2_:Libcrux_ml_kem.Polynomial.t_PolynomialRingElement =
    Libcrux_ml_kem.Sampling.sample_from_binomial_distribution v_ETA2
      (Rust_primitives.unsize prf_output <: t_Slice u8)
  in
  let u:t_Array Libcrux_ml_kem.Polynomial.t_PolynomialRingElement v_K =
    Libcrux_ml_kem.Matrix.compute_vector_u v_K v_A_transpose r_as_ntt error_1_
  in
  let message_as_ring_element:Libcrux_ml_kem.Polynomial.t_PolynomialRingElement =
    Libcrux_ml_kem.Serialize.deserialize_then_decompress_message message
  in
  let v:Libcrux_ml_kem.Polynomial.t_PolynomialRingElement =
...
let decrypt
  ...
  in
  let message:Libcrux_ml_kem.Polynomial.t_PolynomialRingElement =
...
let generate_keypair
     ...
     =
  let hashed:t_Array u8 (sz 64) = Libcrux_ml_kem.Hash_functions.v_G key_generation_seed in
  ...
  in
  let secret_as_ntt, domain_separator:(t_Array Libcrux_ml_kem.Polynomial.t_PolynomialRingElement v_K &
    u8) =
    sample_vector_cbd_then_ntt v_K v_ETA1 v_ETA1_RANDOMNESS_SIZE prf_input 0uy
  in
  let error_as_ntt, _:(t_Array Libcrux_ml_kem.Polynomial.t_PolynomialRingElement v_K & u8) =
