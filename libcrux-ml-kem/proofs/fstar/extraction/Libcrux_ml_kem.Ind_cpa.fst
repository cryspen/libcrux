  ...
  let domain_separator, error_1_, prf_input:(u8 &
    ...
    Core.Iter.Traits.Iterator.f_fold (Core.Iter.Traits.Collect.f_into_iter ({
      ...
      (domain_separator, error_1_, prf_input
        <:
        (u8 & t_Array (Libcrux_ml_kem.Polynomial.t_PolynomialRingElement v_Vector) v_K &
          t_Array u8 (sz 33)))
      (fun temp_0_ i ->
          let domain_separator, error_1_, prf_input:(u8 &
            t_Array (Libcrux_ml_kem.Polynomial.t_PolynomialRingElement v_Vector) v_K &
      ...
      (fun temp_0_ i ->
          ...
          let (prf_output: t_Array u8 v_ETA_RANDOMNESS_SIZE):t_Array u8 v_ETA_RANDOMNESS_SIZE =
            Libcrux_ml_kem.Hash_functions.v_PRF v_ETA_RANDOMNESS_SIZE
              (Rust_primitives.unsize prf_input <: t_Slice u8)
          in
          let r:Libcrux_ml_kem.Polynomial.t_PolynomialRingElement v_Vector =
          ...
          let re_as_ntt:t_Array (Libcrux_ml_kem.Polynomial.t_PolynomialRingElement v_Vector) v_K =
            Rust_primitives.Hax.Monomorphized_update_at.update_at_usize re_as_ntt
              i
              (Libcrux_ml_kem.Ntt.impl__ntt_binomially_sampled_ring_element r
                <:
                Libcrux_ml_kem.Polynomial.t_PolynomialRingElement v_Vector)
          in
          domain_separator, prf_input, re_as_ntt
  ...
  let u_as_ntt:t_Array (Libcrux_ml_kem.Polynomial.t_PolynomialRingElement v_Vector) v_K =
    Core.Iter.Traits.Iterator.f_fold (Core.Iter.Traits.Collect.f_into_iter (Core.Iter.Traits.Iterator.f_enumerate
      ...
      (fun u_as_ntt temp_1_ ->
          ...
          let u:Libcrux_ml_kem.Polynomial.t_PolynomialRingElement v_Vector =
          ...
          let u_as_ntt:t_Array (Libcrux_ml_kem.Polynomial.t_PolynomialRingElement v_Vector) v_K =
            Rust_primitives.Hax.Monomorphized_update_at.update_at_usize u_as_ntt
              i
              (Libcrux_ml_kem.Ntt.impl__ntt_vector_u v_U_COMPRESSION_FACTOR u
                <:
                Libcrux_ml_kem.Polynomial.t_PolynomialRingElement v_Vector)
          in
          u_as_ntt)
...
let encrypt
  ...
  let error_1_:t_Array (Libcrux_ml_kem.Polynomial.t_PolynomialRingElement v_Vector) v_K = out in
  let prf_input:t_Array u8 (sz 33) =
