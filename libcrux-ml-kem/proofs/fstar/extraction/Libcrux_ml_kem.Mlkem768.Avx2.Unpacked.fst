...
let decapsulate
     ...
     =
  Libcrux_ml_kem.Ind_cca.Instantiations.Avx2.Unpacked.decapsulate (mk_usize 3) (mk_usize 2400)
...
let encapsulate
     ...
     =
  Libcrux_ml_kem.Ind_cca.Instantiations.Avx2.Unpacked.encapsulate (mk_usize 3) (mk_usize 1088)
...
let generate_key_pair_mut
  ...
  let key_pair:Libcrux_ml_kem.Ind_cca.Unpacked.t_MlKemKeyPairUnpacked (mk_usize 3)
    Libcrux_ml_kem.Vector.Avx2.t_SIMD256Vector =
    Libcrux_ml_kem.Ind_cca.Instantiations.Avx2.Unpacked.generate_keypair (mk_usize 3)
      (mk_usize 1152)
      (mk_usize 2400)
      (mk_usize 1184)
      (mk_usize 1152)
...
let key_pair_from_private_mut
  ...
  let key_pair:Libcrux_ml_kem.Ind_cca.Unpacked.t_MlKemKeyPairUnpacked (mk_usize 3)
    Libcrux_ml_kem.Vector.Avx2.t_SIMD256Vector =
    Libcrux_ml_kem.Ind_cca.Instantiations.Avx2.Unpacked.keypair_from_private_key (mk_usize 3)
      (mk_usize 2400)
      (mk_usize 1152)
      (mk_usize 1184)
      (mk_usize 1152)
