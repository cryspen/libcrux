...
let v_ETA1: usize = Rust_primitives.mk_usize 2

let v_ETA1_RANDOMNESS_SIZE: usize = v_ETA1 *! Rust_primitives.mk_usize 64

let v_ETA2: usize = Rust_primitives.mk_usize 2

let v_ETA2_RANDOMNESS_SIZE: usize = v_ETA2 *! Rust_primitives.mk_usize 64

let v_RANK_1024_: usize = Rust_primitives.mk_usize 4
...
let v_RANKED_BYTES_PER_RING_ELEMENT_1024_: usize =
  (v_RANK_1024_ *! Libcrux_ml_kem.Constants.v_BITS_PER_RING_ELEMENT <: usize) /!
  Rust_primitives.mk_usize 8
...
let v_CPA_PKE_PUBLIC_KEY_SIZE_1024_: usize =
  v_T_AS_NTT_ENCODED_SIZE_1024_ +! Rust_primitives.mk_usize 32
...
let v_VECTOR_U_COMPRESSION_FACTOR_1024_: usize = Rust_primitives.mk_usize 11
...
let v_VECTOR_V_COMPRESSION_FACTOR_1024_: usize = Rust_primitives.mk_usize 5
...
val encapsulate
    ...
    : Prims.Pure
      (Libcrux_ml_kem.Types.t_MlKemCiphertext (Rust_primitives.mk_usize 1568) &
        t_Array u8 (Rust_primitives.mk_usize 32))
      Prims.l_True
      (ensures
        fun res ->
          let res:(Libcrux_ml_kem.Types.t_MlKemCiphertext (Rust_primitives.mk_usize 1568) &
            t_Array u8 (Rust_primitives.mk_usize 32)) =
            res
          in
...
val generate_key_pair (randomness: t_Array u8 (Rust_primitives.mk_usize 64))
    : Prims.Pure
      (Libcrux_ml_kem.Types.t_MlKemKeyPair (Rust_primitives.mk_usize 3168)
          (Rust_primitives.mk_usize 1568))
      Prims.l_True
      (ensures
        fun res ->
          let res:Libcrux_ml_kem.Types.t_MlKemKeyPair (Rust_primitives.mk_usize 3168)
            (Rust_primitives.mk_usize 1568) =
            res
          in
