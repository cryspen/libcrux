...
let v_RANK_1024_: usize = mk_usize 4
...
let v_RANKED_BYTES_PER_RING_ELEMENT_1024_: usize =
  (v_RANK_1024_ *! Libcrux_ml_kem.Constants.v_BITS_PER_RING_ELEMENT <: usize) /! mk_usize 8
...
let v_CPA_PKE_PUBLIC_KEY_SIZE_1024_: usize = v_T_AS_NTT_ENCODED_SIZE_1024_ +! mk_usize 32
...
let v_VECTOR_U_COMPRESSION_FACTOR_1024_: usize = mk_usize 11
...
let v_VECTOR_V_COMPRESSION_FACTOR_1024_: usize = mk_usize 5
