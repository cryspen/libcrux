...
let decapsulate
     ...
     =
  Libcrux_ml_kem.Ind_cca.Multiplexing.decapsulate #(sz 4) #(sz 3168) #(sz 1536) #(sz 1568)
...
let encapsulate
     ...
     =
  Libcrux_ml_kem.Ind_cca.Multiplexing.encapsulate #(sz 4) #(sz 1568) #(sz 1568) #(sz 1536)
