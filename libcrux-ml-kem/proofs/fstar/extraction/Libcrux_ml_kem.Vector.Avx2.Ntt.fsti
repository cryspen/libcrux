    ...
    : Prims.Pure Libcrux_intrinsics.Avx2_extract.t_Vec256
      ...
      (ensures
        fun result ->
          let result:Libcrux_intrinsics.Avx2_extract.t_Vec256 = result in
          Libcrux_intrinsics.Avx2_extract.vec256_as_i16x16 result ==
          Spec.MLKEM.poly_ntt_layer_2_step (Libcrux_intrinsics.Avx2_extract.vec256_as_i16x16 vector)
            zeta0
            zeta1)
    ...
    : Prims.Pure Libcrux_intrinsics.Avx2_extract.t_Vec256
      ...
      (ensures
        fun result ->
          let result:Libcrux_intrinsics.Avx2_extract.t_Vec256 = result in
          Libcrux_intrinsics.Avx2_extract.vec256_as_i16x16 result ==
          Spec.MLKEM.poly_ntt_layer_3_step (Libcrux_intrinsics.Avx2_extract.vec256_as_i16x16 vector)
            zeta)
