module Libcrux_ml_kem.Mlkem512.Incremental.Alloc
...
let encapsulate1
     ...
     =
  Libcrux_ml_kem.Ind_cca.Incremental.Multiplexing.Alloc.encapsulate1 (mk_usize 2) (mk_usize 768)
...
let encapsulate2
     ...
     =
  Libcrux_ml_kem.Ind_cca.Incremental.Multiplexing.Alloc.encapsulate2 (mk_usize 2)
    (mk_usize 768)
    (mk_usize 128)
    (mk_usize 4)
...
let decapsulate
     ...
     =
  Libcrux_ml_kem.Ind_cca.Incremental.Multiplexing.Alloc.decapsulate (mk_usize 2) (mk_usize 1632)
