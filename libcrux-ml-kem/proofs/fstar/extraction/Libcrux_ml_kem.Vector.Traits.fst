...
let decompress_1_
  ...
  let _:Prims.unit =
    assert (forall i. Seq.index (i1._super_8706949974463268012.f_repr z) i == (mk_i16 0))
  in
  let _:Prims.unit =
    assert (forall i.
  ...
  let _:Prims.unit =
    assert (forall i.
          Seq.index (i1._super_8706949974463268012.f_repr s) i == (mk_i16 0) \/
  ...
  f_bitwise_and_with_constant #v_T #FStar.Tactics.Typeclasses.solve s (Rust_primitives.mk_i16 1665)
...
let to_unsigned_representative
      ...
      (a: v_T)
     =
  let t:v_T = f_shift_right #v_T #FStar.Tactics.Typeclasses.solve (Rust_primitives.mk_i32 15) a in
  let fm:v_T =
