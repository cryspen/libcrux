...
let decapsulate
  ...
  then
    Libcrux_ml_kem.Ind_cca.Instantiations.Avx2.decapsulate #v_K #v_SECRET_KEY_SIZE
      #v_CPA_SECRET_KEY_SIZE #v_PUBLIC_KEY_SIZE #v_CIPHERTEXT_SIZE #v_T_AS_NTT_ENCODED_SIZE
      #v_C1_SIZE #v_C2_SIZE #v_VECTOR_U_COMPRESSION_FACTOR #v_VECTOR_V_COMPRESSION_FACTOR
      #v_C1_BLOCK_SIZE #v_ETA1 #v_ETA1_RANDOMNESS_SIZE #v_ETA2 #v_ETA2_RANDOMNESS_SIZE
...
let encapsulate
  ...
  if Libcrux_platform.Platform.simd256_support ()
  then
    Libcrux_ml_kem.Ind_cca.Instantiations.Avx2.encapsulate #v_K #v_CIPHERTEXT_SIZE
      #v_PUBLIC_KEY_SIZE #v_T_AS_NTT_ENCODED_SIZE #v_C1_SIZE #v_C2_SIZE
      #v_VECTOR_U_COMPRESSION_FACTOR #v_VECTOR_V_COMPRESSION_FACTOR #v_VECTOR_U_BLOCK_LEN #v_ETA1
      #v_ETA1_RANDOMNESS_SIZE #v_ETA2 #v_ETA2_RANDOMNESS_SIZE public_key randomness
  else
    if Libcrux_platform.Platform.simd128_support ()
    then
      Libcrux_ml_kem.Ind_cca.Instantiations.Neon.encapsulate #v_K #v_CIPHERTEXT_SIZE
        #v_PUBLIC_KEY_SIZE #v_T_AS_NTT_ENCODED_SIZE #v_C1_SIZE #v_C2_SIZE
        #v_VECTOR_U_COMPRESSION_FACTOR #v_VECTOR_V_COMPRESSION_FACTOR #v_VECTOR_U_BLOCK_LEN #v_ETA1
        #v_ETA1_RANDOMNESS_SIZE #v_ETA2 #v_ETA2_RANDOMNESS_SIZE public_key randomness
    else
...
let validate_public_key
  ...
  if Libcrux_platform.Platform.simd256_support ()
  then
    Libcrux_ml_kem.Ind_cca.Instantiations.Avx2.validate_public_key #v_K
    ...
    if Libcrux_platform.Platform.simd128_support ()
    then
      Libcrux_ml_kem.Ind_cca.Instantiations.Neon.validate_public_key #v_K
        #v_RANKED_BYTES_PER_RING_ELEMENT
        #v_PUBLIC_KEY_SIZE
        public_key
    else
