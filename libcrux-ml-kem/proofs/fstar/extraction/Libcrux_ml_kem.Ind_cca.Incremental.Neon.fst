  ...
  then
    ...
    let tmp0, out:(t_Slice u8 &
      ...
      Libcrux_ml_kem.Ind_cca.Incremental.generate_keypair_serialized v_K v_PK2_LEN
        ...
        v_ETA1_RANDOMNESS_SIZE #Libcrux_ml_kem.Vector.Neon.Vector_type.t_SIMD128Vector
        #Libcrux_ml_kem.Hash_functions.Neon.t_Simd128Hash randomness key_pair
    in
...
let encapsulate1
  ...
  Libcrux_ml_kem.Ind_cca.Incremental.encapsulate1 v_K v_CIPHERTEXT_SIZE v_C1_SIZE
    ...
    #Libcrux_ml_kem.Hash_functions.Neon.t_Simd128Hash public_key_part randomness
...
let encapsulate1_serialized
  ...
  let tmp0, tmp1, out:(t_Slice u8 & t_Slice u8 &
    ...
    Libcrux_ml_kem.Ind_cca.Incremental.encapsulate1_serialized v_K v_CIPHERTEXT_SIZE v_C1_SIZE
      v_VECTOR_U_COMPRESSION_FACTOR v_VECTOR_U_BLOCK_LEN v_ETA1 v_ETA1_RANDOMNESS_SIZE v_ETA2
      v_ETA2_RANDOMNESS_SIZE #Libcrux_ml_kem.Vector.Neon.Vector_type.t_SIMD128Vector
      #Libcrux_ml_kem.Hash_functions.Neon.t_Simd128Hash public_key_part randomness state
      shared_secret
  in
...
let decapsulate
  ...
  Libcrux_ml_kem.Ind_cca.Incremental.decapsulate v_K v_SECRET_KEY_SIZE v_CPA_SECRET_KEY_SIZE
    ...
    #Libcrux_ml_kem.Vector.Neon.Vector_type.t_SIMD128Vector
    #Libcrux_ml_kem.Hash_functions.Neon.t_Simd128Hash private_key ciphertext1 ciphertext2
