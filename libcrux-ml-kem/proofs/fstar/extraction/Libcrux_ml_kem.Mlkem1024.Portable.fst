...
let validate_public_key (public_key: Libcrux_ml_kem.Types.t_MlKemPublicKey (mk_usize 1568)) =
  Libcrux_ml_kem.Ind_cca.Instantiations.Portable.validate_public_key (mk_usize 4)
    (mk_usize 1568)
...
let validate_private_key
     ...
     =
  Libcrux_ml_kem.Ind_cca.Instantiations.Portable.validate_private_key (mk_usize 4)
    (mk_usize 3168)
    (mk_usize 1568)
    private_key
    ciphertext
...
let validate_private_key_only (private_key: Libcrux_ml_kem.Types.t_MlKemPrivateKey (mk_usize 3168)) =
  Libcrux_ml_kem.Ind_cca.Instantiations.Portable.validate_private_key_only (mk_usize 4)
    (mk_usize 3168)
    private_key

let generate_key_pair (randomness: t_Array u8 (mk_usize 64)) =
  Libcrux_ml_kem.Ind_cca.Instantiations.Portable.generate_keypair (mk_usize 4)
    (mk_usize 1536)
    (mk_usize 3168)
    (mk_usize 1568)
    (mk_usize 2)
...
let encapsulate
     ...
     =
  Libcrux_ml_kem.Ind_cca.Instantiations.Portable.encapsulate (mk_usize 4) (mk_usize 1568)
...
let decapsulate
      ...
      (ciphertext: Libcrux_ml_kem.Types.t_MlKemCiphertext (mk_usize 1568))
     =
  Libcrux_ml_kem.Ind_cca.Instantiations.Portable.decapsulate (mk_usize 4) (mk_usize 3168)
