...
let decapsulate
     ...
     =
  Libcrux_ml_kem.Ind_cca.Instantiations.Portable.decapsulate #(sz 4) #(sz 3168) #(sz 1536)
    #(sz 1568) #(sz 1568) #(sz 1536) #(sz 1408) #(sz 160) #(sz 11) #(sz 5) #(sz 352) #(sz 2)
    #(sz 128) #(sz 2) #(sz 128) #(sz 1600) private_key ciphertext

let encapsulate
      (public_key: Libcrux_ml_kem.Types.t_MlKemPublicKey (sz 1568))
      (randomness: t_Array u8 (sz 32))
     =
  Libcrux_ml_kem.Ind_cca.Instantiations.Portable.encapsulate #(sz 4) #(sz 1568) #(sz 1568)
    #(sz 1536) #(sz 1408) #(sz 160) #(sz 11) #(sz 5) #(sz 352) #(sz 2) #(sz 128) #(sz 2) #(sz 128)
