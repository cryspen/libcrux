...
let impl_3: Libcrux_ml_kem.Vector.Traits.t_Operations t_SIMD256Vector =
  {
    ...
    f_ZERO_post
    =
    (fun (_: Prims.unit) (result: t_SIMD256Vector) -> impl.f_repr out == Seq.create 16 0s);
    ...
    =
    (fun (array: t_Slice i16) (result: t_SIMD256Vector) -> impl.f_repr out == array);
    f_from_i16_array = (fun (array: t_Slice i16) -> vec_from_i16_array array);
    f_to_i16_array_pre = (fun (x: t_SIMD256Vector) -> true);
    f_to_i16_array_post
    =
    (fun (x: t_SIMD256Vector) (result: t_Array i16 (sz 16)) -> out == impl.f_repr x);
    ...
    =
    (fun (v: t_SIMD256Vector) (c: i16) (result: t_SIMD256Vector) ->
    ...
    f_shift_right_post
    =
    (fun (v_SHIFT_BY: i32) (vector: t_SIMD256Vector) (result: t_SIMD256Vector) ->
