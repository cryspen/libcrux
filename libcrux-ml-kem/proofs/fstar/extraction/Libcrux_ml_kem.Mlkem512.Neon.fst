...
let validate_public_key (public_key: Libcrux_ml_kem.Types.t_MlKemPublicKey (mk_usize 800)) =
  Libcrux_ml_kem.Ind_cca.Instantiations.Neon.validate_public_key (mk_usize 2)
    (mk_usize 800)
...
let validate_private_key
     ...
     =
  Libcrux_ml_kem.Ind_cca.Instantiations.Neon.validate_private_key (mk_usize 2)
    (mk_usize 1632)
    (mk_usize 768)
    private_key
    ciphertext
...
let validate_private_key_only (private_key: Libcrux_ml_kem.Types.t_MlKemPrivateKey (mk_usize 1632)) =
  Libcrux_ml_kem.Ind_cca.Instantiations.Neon.validate_private_key_only (mk_usize 2)
    (mk_usize 1632)
    private_key

let generate_key_pair (randomness: t_Array u8 (mk_usize 64)) =
  Libcrux_ml_kem.Ind_cca.Instantiations.Neon.generate_keypair (mk_usize 2)
    (mk_usize 768)
    (mk_usize 1632)
    (mk_usize 800)
    (mk_usize 3)
...
let encapsulate
     ...
     =
  Libcrux_ml_kem.Ind_cca.Instantiations.Neon.encapsulate (mk_usize 2) (mk_usize 768) (mk_usize 800)
...
let decapsulate
      ...
      (ciphertext: Libcrux_ml_kem.Types.t_MlKemCiphertext (mk_usize 768))
     =
  Libcrux_ml_kem.Ind_cca.Instantiations.Neon.decapsulate (mk_usize 2) (mk_usize 1632) (mk_usize 768)
