...
let decapsulate
     ...
     =
  Libcrux_ml_kem.Ind_cca.Instantiations.Neon.decapsulate #(sz 2) #(sz 1632) #(sz 768) #(sz 800)
...
let encapsulate
     ...
     =
  Libcrux_ml_kem.Ind_cca.Instantiations.Neon.encapsulate #(sz 2) #(sz 768) #(sz 800) #(sz 768)
