...
let sample_from_uniform_distribution_next
     ...
     =
  let out, sampled_coefficients:(t_Array (t_Array i16 (Rust_primitives.mk_usize 272)) v_K &
    t_Array usize v_K) =
    Rust_primitives.Hax.Folds.fold_range (Rust_primitives.mk_usize 0)
      ...
      (out, sampled_coefficients
        <:
        (t_Array (t_Array i16 (Rust_primitives.mk_usize 272)) v_K & t_Array usize v_K))
      (fun temp_0_ i ->
          let out, sampled_coefficients:(t_Array (t_Array i16 (Rust_primitives.mk_usize 272)) v_K &
            t_Array usize v_K) =
            temp_0_
          ...
          let i:usize = i in
          Rust_primitives.Hax.Folds.fold_range (Rust_primitives.mk_usize 0)
            (v_N /! Rust_primitives.mk_usize 24 <: usize)
            (fun temp_0_ temp_1_ ->
                let out, sampled_coefficients:(t_Array (t_Array i16 (Rust_primitives.mk_usize 272))
                    v_K &
                  t_Array usize v_K) =
                  temp_0_
                in
                  ...
                  let tmp0, out1:(t_Slice i16 & usize) =
                    Libcrux_ml_kem.Vector.Traits.f_rej_sample #v_Vector
                      ...
                      ((randomness.[ i ] <: t_Array u8 v_N).[ {
                            Core.Ops.Range.f_start = r *! Rust_primitives.mk_usize 24 <: usize;
                            Core.Ops.Range.f_end
                            =
                            (r *! Rust_primitives.mk_usize 24 <: usize) +!
                            Rust_primitives.mk_usize 24
                            <:
                            usize
                          }
                          <:
                        ...
                        <:
                        t_Slice u8)
                      ((out.[ i ] <: t_Array i16 (Rust_primitives.mk_usize 272)).[ {
                            Core.Ops.Range.f_start = sampled_coefficients.[ i ] <: usize;
                            Core.Ops.Range.f_end
                            =
                            (sampled_coefficients.[ i ] <: usize) +! Rust_primitives.mk_usize 16
                            <:
                            usize
                          }
                          <:
                        ...
                        t_Slice i16)
                  in
                  let out:t_Array (t_Array i16 (Rust_primitives.mk_usize 272)) v_K =
                    Rust_primitives.Hax.Monomorphized_update_at.update_at_usize out
                      i
                      (Rust_primitives.Hax.Monomorphized_update_at.update_at_range (out.[ i ]
                            <:
                            t_Array i16 (Rust_primitives.mk_usize 272))
                          ({
                              Core.Ops.Range.f_start = sampled_coefficients.[ i ] <: usize;
                              Core.Ops.Range.f_end
                              =
...
let sample_from_binomial_distribution_2_
  ...
  let sampled_i16s:t_Array i16 (Rust_primitives.mk_usize 256) =
    Rust_primitives.Hax.repeat (Rust_primitives.mk_i16 0) (Rust_primitives.mk_usize 256)
  in
  let sampled_i16s:t_Array i16 (Rust_primitives.mk_usize 256) =
    Rust_primitives.Hax.Folds.fold_enumerated_chunked_slice (Rust_primitives.mk_usize 4)
      randomness
      (fun sampled_i16s temp_1_ ->
          let sampled_i16s:t_Array i16 (Rust_primitives.mk_usize 256) = sampled_i16s in
          let _:usize = temp_1_ in
          true)
      sampled_i16s
      (fun sampled_i16s temp_1_ ->
          ...
          let (random_bits_as_u32: u32):u32 =
            (((cast (byte_chunk.[ Rust_primitives.mk_usize 0 ] <: u8) <: u32) |.
                ((cast (byte_chunk.[ Rust_primitives.mk_usize 1 ] <: u8) <: u32) <<!
                  Rust_primitives.mk_i32 8
                  <:
                  u32)
                <:
                u32) |.
              ((cast (byte_chunk.[ Rust_primitives.mk_usize 2 ] <: u8) <: u32) <<!
                Rust_primitives.mk_i32 16
                <:
                u32)
              <:
              u32) |.
            ((cast (byte_chunk.[ Rust_primitives.mk_usize 3 ] <: u8) <: u32) <<!
              Rust_primitives.mk_i32 24
              <:
              u32)
          in
          let even_bits:u32 = random_bits_as_u32 &. Rust_primitives.mk_u32 1431655765 in
          let odd_bits:u32 =
            (random_bits_as_u32 >>! Rust_primitives.mk_i32 1 <: u32) &.
          ...
          Rust_primitives.Hax.Folds.fold_range_step_by (Rust_primitives.mk_u32 0)
            ...
            (fun sampled_i16s outcome_set ->
                ...
                let outcome_1_:i16 =
                  cast ((coin_toss_outcomes >>! outcome_set <: u32) &. Rust_primitives.mk_u32 3
                      <:
                      u32)
                  <:
                  i16
                in
                let outcome_2_:i16 =
                  cast ((coin_toss_outcomes >>! (outcome_set +! Rust_primitives.mk_u32 2 <: u32)
                        <:
                        u32) &.
                      Rust_primitives.mk_u32 3
                      <:
                      u32)
                  <:
                  i16
                ...
                let sampled_i16s:t_Array i16 (Rust_primitives.mk_usize 256) =
                  Rust_primitives.Hax.Monomorphized_update_at.update_at_usize sampled_i16s
                    ((Rust_primitives.mk_usize 8 *! chunk_number <: usize) +! offset <: usize)
...
let sample_from_binomial_distribution_3_
  ...
  in
  let sampled_i16s:t_Array i16 (Rust_primitives.mk_usize 256) =
    Rust_primitives.Hax.Folds.fold_enumerated_chunked_slice (Rust_primitives.mk_usize 3)
      randomness
      (fun sampled_i16s temp_1_ ->
          let sampled_i16s:t_Array i16 (Rust_primitives.mk_usize 256) = sampled_i16s in
          let _:usize = temp_1_ in
      ...
      (fun sampled_i16s temp_1_ ->
          ...
          let (random_bits_as_u24: u32):u32 =
            ...
            ((cast (byte_chunk.[ Rust_primitives.mk_usize 2 ] <: u8) <: u32) <<!
              ...
              u32)
          in
          let first_bits:u32 = random_bits_as_u24 &. Rust_primitives.mk_u32 2396745 in
          let second_bits:u32 =
            (random_bits_as_u24 >>! Rust_primitives.mk_i32 1 <: u32) &.
            Rust_primitives.mk_u32 2396745
          in
          let third_bits:u32 =
            (random_bits_as_u24 >>! Rust_primitives.mk_i32 2 <: u32) &.
            Rust_primitives.mk_u32 2396745
          in
          let _:Prims.unit =
          ...
          Rust_primitives.Hax.Folds.fold_range_step_by (Rust_primitives.mk_i32 0)
            ...
            (fun sampled_i16s outcome_set ->
                ...
                let outcome_1_:i16 =
                  cast ((coin_toss_outcomes >>! outcome_set <: u32) &. Rust_primitives.mk_u32 7
                      <:
                      u32)
                  <:
                  i16
                in
                let outcome_2_:i16 =
                  cast ((coin_toss_outcomes >>! (outcome_set +! Rust_primitives.mk_i32 3 <: i32)
                        <:
                        u32) &.
                      Rust_primitives.mk_u32 7
                      <:
                      u32)
                  <:
                  i16
                ...
                let sampled_i16s:t_Array i16 (Rust_primitives.mk_usize 256) =
                  Rust_primitives.Hax.Monomorphized_update_at.update_at_usize sampled_i16s
                    ((Rust_primitives.mk_usize 4 *! chunk_number <: usize) +! offset <: usize)
                    (outcome_1_ -! outcome_2_ <: i16)
                in
                sampled_i16s))
  in
...
let sample_from_xof
  ...
  let (sampled_coefficients: t_Array usize v_K):t_Array usize v_K =
    Rust_primitives.Hax.repeat (Rust_primitives.mk_usize 0) v_K
  in
  let (out: t_Array (t_Array i16 (Rust_primitives.mk_usize 272)) v_K):t_Array
    (t_Array i16 (Rust_primitives.mk_usize 272)) v_K =
    Rust_primitives.Hax.repeat (Rust_primitives.Hax.repeat (Rust_primitives.mk_i16 0)
          (Rust_primitives.mk_usize 272)
        <:
        t_Array i16 (Rust_primitives.mk_usize 272))
      v_K
  in
  let xof_state:v_Hasher =
    Libcrux_ml_kem.Hash_functions.f_shake128_init_absorb_final #v_Hasher
      ...
      seeds
  in
  let tmp0, out1:(v_Hasher & t_Array (t_Array u8 (Rust_primitives.mk_usize 504)) v_K) =
  ...
  let randomness:t_Array (t_Array u8 (Rust_primitives.mk_usize 504)) v_K = out1 in
  let tmp0, tmp1, out1:(t_Array usize v_K & t_Array (t_Array i16 (Rust_primitives.mk_usize 272)) v_K &
    bool) =
    sample_from_uniform_distribution_next #v_Vector
      v_K
      (Rust_primitives.mk_usize 504)
      randomness
      sampled_coefficients
      out
  in
  let sampled_coefficients:t_Array usize v_K = tmp0 in
  let out:t_Array (t_Array i16 (Rust_primitives.mk_usize 272)) v_K = tmp1 in
  let done:bool = out1 in
  let done, out, sampled_coefficients, xof_state:(bool &
    t_Array (t_Array i16 (Rust_primitives.mk_usize 272)) v_K &
    t_Array usize v_K &
    v_Hasher) =
    Rust_primitives.f_while_loop (fun temp_0_ ->
      ...
      (done, out, sampled_coefficients, xof_state
        <:
        (bool & t_Array (t_Array i16 (Rust_primitives.mk_usize 272)) v_K & t_Array usize v_K &
          v_Hasher))
      (fun temp_0_ ->
          let done, out, sampled_coefficients, xof_state:(bool &
            t_Array (t_Array i16 (Rust_primitives.mk_usize 272)) v_K &
            ...
            temp_0_
          in
          let tmp0, out1:(v_Hasher & t_Array (t_Array u8 (Rust_primitives.mk_usize 168)) v_K) =
          ...
          in
          let xof_state:v_Hasher = tmp0 in
          let randomness:t_Array (t_Array u8 (Rust_primitives.mk_usize 168)) v_K = out1 in
          let tmp0, tmp1, out1:(t_Array usize v_K &
            t_Array (t_Array i16 (Rust_primitives.mk_usize 272)) v_K &
            bool) =
            sample_from_uniform_distribution_next #v_Vector
              v_K
              (Rust_primitives.mk_usize 168)
              randomness
              sampled_coefficients
              out
          in
          ...
          (bool & t_Array (t_Array i16 (Rust_primitives.mk_usize 272)) v_K & t_Array usize v_K &
            v_Hasher))
  in
  Core.Array.impl_23__map #(t_Array i16 (Rust_primitives.mk_usize 272))
    v_K
    #(Libcrux_ml_kem.Polynomial.t_PolynomialRingElement v_Vector)
    out
    (fun s ->
        let s:t_Array i16 (Rust_primitives.mk_usize 272) = s in
        Libcrux_ml_kem.Polynomial.impl_2__from_i16_array #v_Vector
          (s.[ {
                Core.Ops.Range.f_start = Rust_primitives.mk_usize 0;
                Core.Ops.Range.f_end = Rust_primitives.mk_usize 256
              }
              <:
              Core.Ops.Range.t_Range usize ]
            <:
