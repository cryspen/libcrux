...
class t_ArithmeticOperations (v_Self: Type) = {
...
class t_ArrayOperations (v_Self: Type) = {
...
class t_BitwiseOperations (v_Self: Type) = {
...
class t_CompressionOperations (v_Self: Type) = {
...
class t_ModularOperations (v_Self: Type) = {
...
class t_NTTOperations (v_Self: Type) = {
...
class t_SerializeOperations (v_Self: Type) = {
...
class t_Operations (v_Self: Type) = {
  [@@@ FStar.Tactics.Typeclasses.no_method]_super_16550665238208597986:t_ArrayOperations v_Self;
  [@@@ FStar.Tactics.Typeclasses.no_method]_super_9181983936900423582:t_ArithmeticOperations v_Self;
  [@@@ FStar.Tactics.Typeclasses.no_method]_super_11057338832248834886:t_ModularOperations v_Self;
  [@@@ FStar.Tactics.Typeclasses.no_method]_super_5739476159407468282:t_BitwiseOperations v_Self;
  [@@@ FStar.Tactics.Typeclasses.no_method]_super_13298396156660513588:t_CompressionOperations
  v_Self;
  [@@@ FStar.Tactics.Typeclasses.no_method]_super_1988623142765322925:t_NTTOperations v_Self;
  [@@@ FStar.Tactics.Typeclasses.no_method]_super_18188678553863793517:t_SerializeOperations v_Self;
