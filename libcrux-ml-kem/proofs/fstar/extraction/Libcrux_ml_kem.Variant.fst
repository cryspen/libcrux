...
let impl: t_Variant t_MlKem =
  {
    ...
    (fun
        ...
        ->
        let out:t_Array u8 (mk_usize 32) = Rust_primitives.Hax.repeat (mk_u8 0) (mk_usize 32) in
        let out:t_Array u8 (mk_usize 32) = Core.Slice.impl__copy_from_slice #u8 out randomness in
        out);
    ...
    (fun
        ...
        ->
        (Core.Slice.impl__len #u8 key_generation_seed <: usize) =. mk_usize 32);
    ...
    fun
      ...
      (key_generation_seed: t_Slice u8)
      ->
      let seed:t_Array u8 (mk_usize 33) = Rust_primitives.Hax.repeat (mk_u8 0) (mk_usize 33) in
