...
let validate_private_key
     ...
     =
  Libcrux_ml_kem.Ind_cca.Instantiations.Neon.validate_private_key (mk_usize 3)
    (mk_usize 2400)
    (mk_usize 1088)
    private_key
    ciphertext

let validate_private_key_only (private_key: Libcrux_ml_kem.Types.t_MlKemPrivateKey (mk_usize 2400)) =
  Libcrux_ml_kem.Ind_cca.Instantiations.Neon.validate_private_key_only (mk_usize 3)
    (mk_usize 2400)
    private_key
...
let decapsulate
      ...
      (ciphertext: Libcrux_ml_kem.Types.t_MlKemCiphertext (mk_usize 1088))
     =
  Libcrux_ml_kem.Ind_cca.Instantiations.Neon.decapsulate (mk_usize 3) (mk_usize 2400)
...
let encapsulate
     ...
     =
  Libcrux_ml_kem.Ind_cca.Instantiations.Neon.encapsulate (mk_usize 3) (mk_usize 1088)
...
let generate_key_pair (randomness: t_Array u8 (mk_usize 64)) =
  Libcrux_ml_kem.Ind_cca.Instantiations.Neon.generate_keypair (mk_usize 3)
    (mk_usize 1152)
    (mk_usize 2400)
    (mk_usize 1184)
    (mk_usize 1152)
...
let validate_public_key (public_key: Libcrux_ml_kem.Types.t_MlKemPublicKey (mk_usize 1184)) =
  Libcrux_ml_kem.Ind_cca.Instantiations.Neon.validate_public_key (mk_usize 3)
    (mk_usize 1152)
    (mk_usize 1184)
