  ...
  let re, zeta_i:(Libcrux_ml_kem.Polynomial.t_PolynomialRingElement v_Vector & usize) =
    Core.Iter.Traits.Iterator.f_fold (Core.Iter.Traits.Collect.f_into_iter ({
      ...
      (fun temp_0_ round ->
          ...
          re, zeta_i <: (Libcrux_ml_kem.Polynomial.t_PolynomialRingElement v_Vector & usize))
  in
  let hax_temp_output:Libcrux_ml_kem.Polynomial.t_PolynomialRingElement v_Vector = re in
  zeta_i, hax_temp_output <: (usize & Libcrux_ml_kem.Polynomial.t_PolynomialRingElement v_Vector)
