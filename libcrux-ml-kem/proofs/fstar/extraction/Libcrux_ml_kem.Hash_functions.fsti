...
class t_Hash (v_Self: Type0) (v_K: usize) = {
  ...
  f_shake128_init_absorb_pre:t_Array (t_Array u8 (sz 34)) v_K -> bool;
  f_shake128_init_absorb_post:t_Array (t_Array u8 (sz 34)) v_K -> v_Self -> bool;
  ...
  f_shake128_squeeze_three_blocks_pre:v_Self -> bool;
  ...
  f_shake128_squeeze_block_pre:v_Self -> bool;
  f_shake128_squeeze_block_post:v_Self -> (v_Self & t_Array (t_Array u8 (sz 168)) v_K) -> bool;
