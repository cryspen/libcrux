...
let generate_key_pair
      ...
      (#[FStar.Tactics.Typeclasses.tcresolve ()] i1: Rand_core.t_RngCore iimpl_277843321_)
      (#[FStar.Tactics.Typeclasses.tcresolve ()] i2: Rand_core.t_CryptoRng iimpl_277843321_)
      (rng: iimpl_277843321_)
     =
  let randomness:t_Array u8 (mk_usize 64) = Rust_primitives.Hax.repeat (mk_u8 0) (mk_usize 64) in
  let tmp0, tmp1:(iimpl_277843321_ & t_Array u8 (mk_usize 64)) =
    Rand_core.f_fill_bytes #iimpl_277843321_ #FStar.Tactics.Typeclasses.solve rng randomness
  in
  let rng:iimpl_277843321_ = tmp0 in
  ...
  rng, hax_temp_output
  <:
  (iimpl_277843321_ & Libcrux_ml_kem.Types.t_MlKemKeyPair (mk_usize 2400) (mk_usize 1184))
...
let encapsulate
  ...
  let tmp0, tmp1:(iimpl_277843321_ & t_Array u8 (mk_usize 32)) =
    Rand_core.f_fill_bytes #iimpl_277843321_ #FStar.Tactics.Typeclasses.solve rng randomness
  in
  let rng:iimpl_277843321_ = tmp0 in
