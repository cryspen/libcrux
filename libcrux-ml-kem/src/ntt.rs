...
#[cfg_attr(hax, hax_lib::requires(fstar!("v ${*zeta_i} == 63 /\\
    ntt_re_range_2 $re")))]
#[cfg_attr(hax, hax_lib::ensures(|result| fstar!("ntt_re_range_1 ${re}_future /\\
...
pub(crate) fn ntt_at_layer_1<Vector: Operations>(
    ...
    #[cfg(hax)]
    fstar!("reveal_opaque (`%ntt_re_range_2) (ntt_re_range_2 #$:Vector)");
    #[cfg(hax)]
    fstar!("reveal_opaque (`%ntt_re_range_1) (ntt_re_range_1 #$:Vector)");
...
#[cfg_attr(hax, hax_lib::requires(fstar!("v ${*zeta_i} == 31 /\\
    ntt_re_range_3 $re")))]
#[cfg_attr(hax, hax_lib::ensures(|result| fstar!("ntt_re_range_2 ${re}_future /\\
    v ${*zeta_i}_future == 63")))]
pub(crate) fn ntt_at_layer_2<Vector: Operations>(
    ...
    #[cfg(hax)]
    fstar!("reveal_opaque (`%ntt_re_range_3) (ntt_re_range_3 #$:Vector)");
    #[cfg(hax)]
    fstar!("reveal_opaque (`%ntt_re_range_2) (ntt_re_range_2 #$:Vector)");
    let _zeta_i_init = *zeta_i;
    // The semicolon and parentheses at the end of loop are a workaround
...
#[cfg_attr(hax, hax_lib::requires(fstar!("v ${*zeta_i} == 15 /\\
    ntt_re_range_4 $re")))]
#[cfg_attr(hax, hax_lib::ensures(|result| fstar!("ntt_re_range_3 ${re}_future /\\
    v ${*zeta_i}_future == 31")))]
pub(crate) fn ntt_at_layer_3<Vector: Operations>(
    ...
    #[cfg(hax)]
    fstar!("reveal_opaque (`%ntt_re_range_4) (ntt_re_range_4 #$:Vector)");
    #[cfg(hax)]
    fstar!("reveal_opaque (`%ntt_re_range_3) (ntt_re_range_3 #$:Vector)");
    let _zeta_i_init = *zeta_i;
    // The semicolon and parentheses at the end of loop are a workaround
...
#[inline(always)]
#[cfg_attr(hax, hax_lib::requires(fstar!("Spec.Utils.is_i16b 1664 $zeta_r /\\
...
#[cfg_attr(hax, hax_lib::requires(fstar!("v $layer >= 4 /\\ v $layer <= 7 /\\
    ((v $layer == 4 ==> v ${*zeta_i} == 7) /\\
    (v $layer == 5 ==> v ${*zeta_i} == 3) /\\
    (v $layer == 6 ==> v ${*zeta_i} == 1) /\\
    (v $layer == 7 ==> v ${*zeta_i} == 0))")))]
#[cfg_attr(hax, hax_lib::ensures(|result| fstar!("ntt_re_range_4 ${re}_future /\\
...
#[cfg_attr(hax, hax_lib::requires(fstar!("forall i. i < 8 ==> ntt_layer_7_pre (${re}.f_coefficients.[ sz i ])
...
pub(crate) fn ntt_at_layer_7<Vector: Operations>(re: &mut PolynomialRingElement<Vector>) {
    ...
    for j in 0..step {
        ...
        #[cfg(hax)]
        fstar!("reveal_opaque (`%ntt_layer_7_pre) (ntt_layer_7_pre #$:Vector)");
