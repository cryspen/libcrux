...
#[inline(always)]
pub(crate) fn deserialize_to_uncompressed_ring_element(serialized: &[u8]) -> PolynomialRingElement {
...
#[inline(always)]
pub(crate) fn deserialize_ring_elements_reduced<const PUBLIC_KEY_SIZE: usize, const K: usize>(
    public_key: &[u8],
...
#[inline(always)]
pub(crate) fn compress_then_serialize_ring_element_u<
...
#[inline(always)]
pub(crate) fn compress_then_serialize_ring_element_v<
    const COMPRESSION_FACTOR: usize,
    const OUT_LEN: usize,
>(
    re: PolynomialRingElement,
...
#[inline(always)]
pub(crate) fn deserialize_then_decompress_ring_element_u<const COMPRESSION_FACTOR: usize>(
    serialized: &[u8],
) -> PolynomialRingElement {
...
#[inline(always)]
pub(crate) fn deserialize_then_decompress_ring_element_v<const COMPRESSION_FACTOR: usize>(
    serialized: &[u8],
) -> PolynomialRingElement {
    hax_debug_assert!(serialized.len() == (COEFFICIENTS_IN_RING_ELEMENT * COMPRESSION_FACTOR) / 8);
