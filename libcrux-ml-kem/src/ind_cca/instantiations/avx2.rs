...
pub(crate) mod incremental {
    ...
    pub fn encapsulate1<
        const K: usize,
        const CPA_PKE_CIPHERTEXT_SIZE: usize,
        const C1_SIZE: usize,
        const VECTOR_U_COMPRESSION_FACTOR: usize,
        const C1_BLOCK_SIZE: usize,
        const ETA1: usize,
    ...
    >(
        ...
        Ciphertext1<C1_SIZE>,
        EncapsState<K, crate::vector::SIMD256Vector>,
    ) {
    ...
    pub fn encapsulate2<
        ...
        const VECTOR_V_COMPRESSION_FACTOR: usize,
    >(
        state: &EncapsState<K, crate::vector::SIMD256Vector>,
        public_key_part: &PublicKey2<K, crate::vector::SIMD256Vector>,
    ) -> Ciphertext2<C2_SIZE> {
    ...
    pub fn decapsulate<
        ...
        const CPA_PKE_PUBLIC_KEY_SIZE: usize,
        const CPA_PKE_CIPHERTEXT_SIZE: usize,
        const T_AS_NTT_ENCODED_SIZE: usize,
        const C1_SIZE: usize,
        const C2_SIZE: usize,
