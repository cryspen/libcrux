...
>(
    ...
    let mut u_as_ntt: [PolynomialRingElement<Vector>; K] = todo!();
    cloop! {
...
fn deserialize_secret_key<const K: usize, Vector: Operations>(
    ...
    let mut secret_as_ntt: [PolynomialRingElement<Vector>; K] = todo!();
