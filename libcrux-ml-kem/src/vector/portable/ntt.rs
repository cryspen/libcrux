...
#[inline(always)]
#[cfg_attr(hax, hax_lib::fstar::before(interface, "[@@ \"opaque_to_smt\"]"))]
#[cfg_attr(hax, hax_lib::requires(fstar!("v i < 16 /\\ v j < 16 /\\ v i <> v j /\\ 
...
#[cfg_attr(hax, hax_lib::ensures(|result| fstar!("(forall k. (k <> v i /\\ k <> v j) ==>
...
#[cfg_attr(hax, hax_lib::ensures(|result| fstar!("Spec.Utils.is_i16b_array (11207+6*3328) ${result}.f_elements")))]
...
#[cfg_attr(hax, hax_lib::ensures(|result| fstar!("Spec.Utils.is_i16b_array (11207+5*3328) ${result}.f_elements")))]
...
#[cfg_attr(hax, hax_lib::ensures(|result| fstar!("Spec.Utils.is_i16b_array (11207+4*3328) ${result}.f_elements")))]
...
#[cfg_attr(hax, hax_lib::ensures(|result| fstar!("Spec.Utils.is_i16b_array (4*3328) ${vec}_future.f_elements /\\
...
#[cfg_attr(hax, hax_lib::fstar::before(interface, "[@@ \"opaque_to_smt\"]"))]
#[cfg_attr(hax, hax_lib::requires(fstar!("v i < 8 /\\ Spec.Utils.is_i16b 1664 $zeta /\\
...
#[cfg_attr(hax, hax_lib::ensures(|()| fstar!("
...
#[cfg_attr(hax, hax_lib::fstar::verification_status(panic_free))]
#[cfg_attr(hax, hax_lib::fstar::options("--z3rlimit 100"))]
#[cfg_attr(hax, hax_lib::requires(fstar!("Spec.Utils.is_i16b 1664 $zeta0 /\\
