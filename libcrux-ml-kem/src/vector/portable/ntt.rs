...
#[hax_lib::requires(fstar!(r#"v i < 16 /\ v j < 16 /\ v i <> v j /\ 
                            ...
                            Spec.Utils.is_i16b_array (4803 + 6 * 3328) vec.f_elements /\
                            Spec.Utils.is_i16b (4803 + 5*3328) vec.f_elements.[i] /\
                            Spec.Utils.is_i16b (4803 + 5*3328) vec.f_elements.[j]"#))]
...
#[hax_lib::requires(fstar!(r#"Spec.Utils.is_i16b 1664 zeta0 /\ Spec.Utils.is_i16b 1664 zeta1 /\
                            ...
                            Spec.Utils.is_i16b_array (4803+5*3328) ${vec}.f_elements"#))]
#[hax_lib::ensures(|result| fstar!(r#"Spec.Utils.is_i16b_array (4803+6*3328) ${result}.f_elements"#))]
...
#[hax_lib::fstar::options("--z3rlimit 100")]
#[hax_lib::requires(fstar!(r#"Spec.Utils.is_i16b 1664 zeta0 /\ Spec.Utils.is_i16b 1664 zeta1 /\
                            Spec.Utils.is_i16b_array (4803+4*3328) ${vec}.f_elements"#))]
#[hax_lib::ensures(|result| fstar!(r#"Spec.Utils.is_i16b_array (4803+5*3328) ${result}.f_elements"#))]
...
#[hax_lib::requires(fstar!(r#"Spec.Utils.is_i16b 1664 zeta /\
                            Spec.Utils.is_i16b_array (4803+3*3328) ${vec}.f_elements"#))]
#[hax_lib::ensures(|result| fstar!(r#"Spec.Utils.is_i16b_array (4803+4*3328) ${result}.f_elements"#))]
