...
pub(crate) fn ntt_layer_1_step(
    ...
    *vector = mm256_add_epi16(lhs, rhs);
}

#[inline(always)]
#[hax_lib::requires(fstar!(r#"Spec.Utils.is_i16b 1664 zeta0 /\ Spec.Utils.is_i16b 1664 zeta1"#))]
pub(crate) fn ntt_layer_2_step(vector: &mut Vec256, zeta0: i16, zeta1: i16) {
    let zetas = mm256_set_epi16(
...
pub(crate) fn ntt_layer_3_step(vector: &mut Vec256, zeta: i16) {
    ...
    *vector = mm256_castsi128_si256(lower_coefficients);
    *vector = mm256_inserti128_si256::<1>(*vector, upper_coefficients);
}
...
pub(crate) fn inv_ntt_layer_1_step(
    ...
    let mut sum = mm256_add_epi16(lhs, rhs);
    ...
    arithmetic::barrett_reduce(&mut sum);

    *vector = mm256_blend_epi16::<0b1_1_0_0_1_1_0_0>(sum, sum_times_zetas);
}

#[inline(always)]
#[hax_lib::requires(fstar!(r#"Spec.Utils.is_i16b 1664 zeta0 /\ Spec.Utils.is_i16b 1664 zeta1"#))]
pub(crate) fn inv_ntt_layer_2_step(vector: &mut Vec256, zeta0: i16, zeta1: i16) {
    ...
    *vector = mm256_blend_epi16::<0b1_1_1_1_0_0_0_0>(sum, sum_times_zetas);
}

#[inline(always)]
#[hax_lib::requires(fstar!(r#"Spec.Utils.is_i16b 1664 zeta"#))]
pub(crate) fn inv_ntt_layer_3_step(vector: &mut Vec256, zeta: i16) {
...
pub(crate) fn ntt_multiply(
    ...
    *out = mm256_blend_epi16::<0b1_0_1_0_1_0_1_0>(products_left, products_right);
}
