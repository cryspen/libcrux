...
#[cfg_attr(hax, hax_lib::ensures(|result| fstar!("repr ${result} == Seq.create 16 0s")))]
...
impl Operations for SIMD256Vector {
    #[inline(always)]
    #[cfg_attr(hax, ensures(|out| fstar!("impl.f_repr out == Seq.create 16 0s")))]
    fn ZERO() -> Self {
        vec_zero()
    }
    ...
    #[cfg_attr(hax, hax_lib::ensures(|out| fstar!("impl.f_repr out == Spec.Utils.map_array (fun x -> x &. $constant) (impl.f_repr $vector)")))]
    ...
    #[cfg_attr(hax, hax_lib::ensures(|out| fstar!("(v_SHIFT_BY >=. 0l /\\ v_SHIFT_BY <. 16l) ==> impl.f_repr out == Spec.Utils.map_array (fun x -> x >>! ${SHIFT_BY}) (impl.f_repr $vector)")))]
    ...
    #[cfg_attr(hax, hax_lib::requires(fstar!("Spec.Utils.is_i16b_array (pow2 12 - 1) (impl.f_repr $vector)")))]
    #[cfg_attr(hax, hax_lib::ensures(|out| fstar!("impl.f_repr out == Spec.Utils.map_array (fun x -> if x >=. 3329s then x -! 3329s else x) (impl.f_repr $vector)")))]
    ...
    #[cfg_attr(hax, hax_lib::requires(fstar!("Spec.Utils.is_i16b_array 28296 (impl.f_repr ${vector})")))]
    ...
    #[cfg_attr(hax, hax_lib::requires(fstar!("forall (i:nat). i < 16 ==> v (Seq.index (impl.f_repr $vector) i) >= 0 /\\
    ...
    #[cfg_attr(hax, hax_lib::requires(fstar!("Spec.MLKEM.serialize_pre 1 (impl.f_repr $vector)")))]
    // Output name has be `out` https://github.com/hacspec/hax/issues/832
    #[cfg_attr(hax, hax_lib::ensures(|out| fstar!("Spec.MLKEM.serialize_pre 1 (impl.f_repr $vector) ==> Spec.MLKEM.serialize_post 1 (impl.f_repr $vector) $out")))]
    ...
    // Output name has be `out` https://github.com/hacspec/hax/issues/832
    #[cfg_attr(hax, hax_lib::ensures(|out| fstar!("sz (Seq.length $bytes) =. sz 2 ==> Spec.MLKEM.deserialize_post 1 $bytes (impl.f_repr $out)")))]
    ...
    #[cfg_attr(hax, hax_lib::requires(fstar!("Spec.MLKEM.serialize_pre 4 (impl.f_repr $vector)")))]
    // Output name has be `out` https://github.com/hacspec/hax/issues/832
    #[cfg_attr(hax, hax_lib::ensures(|out| fstar!("Spec.MLKEM.serialize_pre 4 (impl.f_repr $vector) ==> Spec.MLKEM.serialize_post 4 (impl.f_repr $vector) $out")))]
    ...
    // Output name has be `out` https://github.com/hacspec/hax/issues/832
    #[cfg_attr(hax, hax_lib::ensures(|out| fstar!("sz (Seq.length $bytes) =. sz 8 ==> Spec.MLKEM.deserialize_post 4 $bytes (impl.f_repr $out)")))]
    ...
    #[cfg_attr(hax, hax_lib::requires(fstar!("Spec.MLKEM.serialize_pre 10 (impl.f_repr $vector)")))]
    // Output name has be `out` https://github.com/hacspec/hax/issues/832
    #[cfg_attr(hax, hax_lib::ensures(|out| fstar!("Spec.MLKEM.serialize_pre 10 (impl.f_repr $vector) ==> Spec.MLKEM.serialize_post 10 (impl.f_repr $vector) $out")))]
    ...
    // Output name has be `out` https://github.com/hacspec/hax/issues/832
    #[cfg_attr(hax, hax_lib::ensures(|out| fstar!("sz (Seq.length $bytes) =. sz 20 ==> Spec.MLKEM.deserialize_post 10 $bytes (impl.f_repr $out)")))]
    ...
    #[cfg_attr(hax, hax_lib::requires(fstar!("Spec.MLKEM.serialize_pre 12 (impl.f_repr $vector)")))]
    // Output name has be `out` https://github.com/hacspec/hax/issues/832
    #[cfg_attr(hax, hax_lib::ensures(|out| fstar!("Spec.MLKEM.serialize_pre 12 (impl.f_repr $vector) ==> Spec.MLKEM.serialize_post 12 (impl.f_repr $vector) $out")))]
    ...
    // Output name has be `out` https://github.com/hacspec/hax/issues/832
    #[cfg_attr(hax, hax_lib::ensures(|out| fstar!("sz (Seq.length $bytes) =. sz 24 ==> Spec.MLKEM.deserialize_post 12 $bytes (impl.f_repr $out)")))]
