...
class extractAction(argparse.Action):
    ...
    def __call__(self, parser, args, values, option_string=None) -> None:
        ...
        interface_include = "+** -libcrux_ml_kem::vector::traits -libcrux_ml_kem::types -libcrux_ml_kem::constants -libcrux_ml_kem::traits::spec -libcrux_ml_kem::ntt::spec"
        cargo_hax_into = [
            "cargo",
            "hax",
            "-C",
...
class proveAction(argparse.Action):
    ...
    def __call__(self, parser, args, values, option_string=None) -> None:
        ...
        shell(["make", "-k", "-j4", "-C", "proofs/fstar/extraction/"], env=admit_env)
        return None
