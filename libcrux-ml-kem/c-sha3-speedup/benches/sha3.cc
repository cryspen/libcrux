...
shake128_34_504(benchmark::State &state)
{
    ...
    libcrux_sha3_avx2_x4_incremental_shake128_absorb_final(&st,EURYDICE_SLICE(input,0,34),EURYDICE_SLICE(input,0,34),EURYDICE_SLICE(input,0,34),EURYDICE_SLICE(input,0,34));
    libcrux_sha3_avx2_x4_incremental_shake128_squeeze_first_three_blocks(&st,EURYDICE_SLICE(digest0,0,504),EURYDICE_SLICE(digest1,0,504),EURYDICE_SLICE(digest2,0,504),EURYDICE_SLICE(digest3,0,504));
