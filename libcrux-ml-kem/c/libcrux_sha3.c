...
inline void libcrux_sha3_portable_sha224(Eurydice_slice digest,
                                         Eurydice_slice data) {
  Eurydice_slice buf0[1U] = {data};
  Eurydice_slice buf[1U] = {digest};
...
inline void libcrux_sha3_portable_sha384(Eurydice_slice digest,
                                         Eurydice_slice data) {
  Eurydice_slice buf0[1U] = {data};
  Eurydice_slice buf[1U] = {digest};
...
inline void libcrux_sha3_sha224_ema(Eurydice_slice digest,
...
inline void libcrux_sha3_sha256_ema(Eurydice_slice digest,
                                    Eurydice_slice payload) {
...
inline void libcrux_sha3_sha384_ema(Eurydice_slice digest,
                                    Eurydice_slice payload) {
...
inline void libcrux_sha3_sha512_ema(Eurydice_slice digest,
                                    Eurydice_slice payload) {
...
inline void libcrux_sha3_portable_shake128(Eurydice_slice digest,
                                           Eurydice_slice data) {
  Eurydice_slice buf0[1U] = {data};
  Eurydice_slice buf[1U] = {digest};
