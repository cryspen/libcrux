...
*/
<<<<<<< HEAD
static void decapsulate_b31(
    libcrux_ml_kem_types_MlKemPrivateKey_95 *private_key,
    libcrux_ml_kem_mlkem1024_MlKem1024Ciphertext *ciphertext,
    uint8_t ret[32U]) {
  libcrux_ml_kem_ind_cca_decapsulate_161(private_key, ciphertext, ret);
}
...
void libcrux_ml_kem_mlkem1024_portable_decapsulate(
    ...
    libcrux_ml_kem_mlkem1024_MlKem1024Ciphertext *ciphertext,
    uint8_t ret[32U]) {
  decapsulate_b31(private_key, ciphertext, ret);
}
...
- IMPLICIT_REJECTION_HASH_INPUT_SIZE= 1600
*/
static void decapsulate_unpacked_171(
    libcrux_ml_kem_ind_cca_unpacked_MlKemKeyPairUnpacked_42 *key_pair,
    libcrux_ml_kem_mlkem1024_MlKem1024Ciphertext *ciphertext,
    uint8_t ret[32U]) {
  libcrux_ml_kem_ind_cca_unpacked_decapsulate_unpacked_f21(key_pair, ciphertext,
                                                           ret);
}
...
void libcrux_ml_kem_mlkem1024_portable_decapsulate_unpacked(
    ...
    libcrux_ml_kem_mlkem1024_MlKem1024Ciphertext *ciphertext,
    uint8_t ret[32U]) {
  decapsulate_unpacked_171(private_key, ciphertext, ret);
=======
static void decapsulate_c41(
    libcrux_ml_kem_types_MlKemPrivateKey_95 *private_key,
    libcrux_ml_kem_types_MlKemCiphertext_1f *ciphertext, uint8_t ret[32U]) {
  libcrux_ml_kem_ind_cca_decapsulate_6a1(private_key, ciphertext, ret);
}
...
void libcrux_ml_kem_mlkem1024_portable_decapsulate(
    libcrux_ml_kem_types_MlKemPrivateKey_95 *private_key,
    libcrux_ml_kem_types_MlKemCiphertext_1f *ciphertext, uint8_t ret[32U]) {
  decapsulate_c41(private_key, ciphertext, ret);
>>>>>>> main
}
...
*/
<<<<<<< HEAD
static tuple_21 encapsulate_cd1(
=======
static tuple_21 encapsulate_591(
>>>>>>> main
...
<<<<<<< HEAD
  return libcrux_ml_kem_ind_cca_encapsulate_931(uu____0, copy_of_randomness);
=======
  return libcrux_ml_kem_ind_cca_encapsulate_b11(uu____0, copy_of_randomness);
>>>>>>> main
}
...
tuple_21 libcrux_ml_kem_mlkem1024_portable_encapsulate(
  ...
  memcpy(copy_of_randomness, randomness, (size_t)32U * sizeof(uint8_t));
<<<<<<< HEAD
  return encapsulate_cd1(uu____0, copy_of_randomness);
}
...
- ETA2_RANDOMNESS_SIZE= 128
*/
static tuple_21 encapsulate_unpacked_571(
...
tuple_21 libcrux_ml_kem_mlkem1024_portable_encapsulate_unpacked(
  ...
  uint8_t copy_of_randomness[32U];
  memcpy(copy_of_randomness, randomness, (size_t)32U * sizeof(uint8_t));
  return encapsulate_unpacked_571(uu____0, copy_of_randomness);
}

=======
  return encapsulate_591(uu____0, copy_of_randomness);
}
...
*/
<<<<<<< HEAD
static libcrux_ml_kem_mlkem1024_MlKem1024KeyPair generate_keypair_ff1(
=======
static libcrux_ml_kem_mlkem1024_MlKem1024KeyPair generate_keypair_6b1(
>>>>>>> main
...
<<<<<<< HEAD
  return libcrux_ml_kem_ind_cca_generate_keypair_6c1(copy_of_randomness);
}
...
libcrux_ml_kem_mlkem1024_portable_generate_key_pair(uint8_t randomness[64U]) {
  ...
  uint8_t copy_of_randomness[64U];
  memcpy(copy_of_randomness, randomness, (size_t)64U * sizeof(uint8_t));
  return generate_keypair_ff1(copy_of_randomness);
}
...
generate_keypair_unpacked_c61(uint8_t randomness[64U]) {
  /* Passing arrays by value in Rust generates a copy in C */
  uint8_t copy_of_randomness[64U];
  memcpy(copy_of_randomness, randomness, (size_t)64U * sizeof(uint8_t));
...
libcrux_ml_kem_mlkem1024_portable_generate_key_pair_unpacked(
  ...
  uint8_t copy_of_randomness[64U];
  memcpy(copy_of_randomness, randomness, (size_t)64U * sizeof(uint8_t));
  return generate_keypair_unpacked_c61(copy_of_randomness);
=======
  return libcrux_ml_kem_ind_cca_generate_keypair_541(copy_of_randomness);
}
...
libcrux_ml_kem_mlkem1024_portable_generate_key_pair(uint8_t randomness[64U]) {
  ...
  uint8_t copy_of_randomness[64U];
  memcpy(copy_of_randomness, randomness, (size_t)64U * sizeof(uint8_t));
  return generate_keypair_6b1(copy_of_randomness);
}
...
- CIPHERTEXT_SIZE= 1568
*/
static KRML_MUSTINLINE bool validate_private_key_7c1(
    libcrux_ml_kem_types_MlKemPrivateKey_95 *private_key,
    libcrux_ml_kem_types_MlKemCiphertext_1f *ciphertext) {
  return libcrux_ml_kem_ind_cca_validate_private_key_0f(private_key,
                                                        ciphertext);
>>>>>>> main
}
...
bool libcrux_ml_kem_mlkem1024_portable_validate_private_key(
    libcrux_ml_kem_types_MlKemPrivateKey_95 *private_key,
    libcrux_ml_kem_types_MlKemCiphertext_1f *ciphertext) {
  return validate_private_key_7c1(private_key, ciphertext);
}
...
*/
<<<<<<< HEAD
static bool validate_public_key_091(uint8_t *public_key) {
  return libcrux_ml_kem_ind_cca_validate_public_key_821(public_key);
=======
static KRML_MUSTINLINE bool validate_public_key_981(uint8_t *public_key) {
  return libcrux_ml_kem_ind_cca_validate_public_key_951(public_key);
>>>>>>> main
}
...
core_option_Option_99 libcrux_ml_kem_mlkem1024_portable_validate_public_key(
  ...
  if (validate_public_key_091(public_key.value)) {
...
bool libcrux_ml_kem_mlkem1024_portable_validate_public_key(
    libcrux_ml_kem_types_MlKemPublicKey_1f *public_key) {
  return validate_public_key_981(public_key->value);
>>>>>>> main
}
