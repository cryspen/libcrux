...
static void decapsulate_8b(
    ...
    uint8_t ret[32U]) {
  libcrux_ml_kem_ind_cca_decapsulate_6b1(private_key, ciphertext, ret);
}
...
static void decapsulate_unpacked_87(
    ...
    libcrux_ml_kem_mlkem1024_MlKem1024Ciphertext *ciphertext,
    uint8_t ret[32U]) {
  libcrux_ml_kem_ind_cca_unpacked_decapsulate_unpacked_311(key_pair, ciphertext,
                                                           ret);
}
...
static tuple_21 encapsulate_c4(
  ...
  return libcrux_ml_kem_ind_cca_encapsulate_e11(uu____0, uu____1);
}
...
static tuple_21 encapsulate_unpacked_7c(
  ...
  uint8_t uu____1[32U];
  memcpy(uu____1, randomness, (size_t)32U * sizeof(uint8_t));
  return libcrux_ml_kem_ind_cca_unpacked_encapsulate_unpacked_e01(uu____0,
                                                                  uu____1);
}
...
tuple_21 libcrux_ml_kem_mlkem1024_portable_encapsulate_unpacked(
  ...
  uint8_t uu____1[32U];
  memcpy(uu____1, randomness, (size_t)32U * sizeof(uint8_t));
  return encapsulate_unpacked_7c(uu____0, uu____1);
}
...
- ETA1_RANDOMNESS_SIZE= 128
*/
static libcrux_ml_kem_mlkem1024_MlKem1024KeyPair generate_keypair_43(
    uint8_t randomness[64U]) {
  uint8_t uu____0[64U];
  memcpy(uu____0, randomness, (size_t)64U * sizeof(uint8_t));
  return libcrux_ml_kem_ind_cca_generate_keypair_3c1(uu____0);
}
...
libcrux_ml_kem_mlkem1024_portable_generate_key_pair(uint8_t randomness[64U]) {
  uint8_t uu____0[64U];
  memcpy(uu____0, randomness, (size_t)64U * sizeof(uint8_t));
  return generate_keypair_43(uu____0);
}
...
generate_keypair_unpacked_84(uint8_t randomness[64U]) {
  uint8_t uu____0[64U];
  memcpy(uu____0, randomness, (size_t)64U * sizeof(uint8_t));
  return libcrux_ml_kem_ind_cca_unpacked_generate_keypair_unpacked_e61(uu____0);
}
...
libcrux_ml_kem_mlkem1024_portable_generate_key_pair_unpacked(
  ...
  uint8_t uu____0[64U];
  memcpy(uu____0, randomness, (size_t)64U * sizeof(uint8_t));
  return generate_keypair_unpacked_84(uu____0);
}
...
- PUBLIC_KEY_SIZE= 1568
*/
static bool validate_public_key_c81(uint8_t *public_key) {
  return libcrux_ml_kem_ind_cca_validate_public_key_251(public_key);
}

core_option_Option_99 libcrux_ml_kem_mlkem1024_portable_validate_public_key(
    libcrux_ml_kem_types_MlKemPublicKey_1f public_key) {
  core_option_Option_99 uu____0;
  if (validate_public_key_c81(public_key.value)) {
