...
*/
static libcrux_ml_kem_polynomial_PolynomialRingElement_1c ZERO_89_a5(void) {
...
deserialize_to_reduced_ring_element_79(Eurydice_slice serialized) {
  libcrux_ml_kem_polynomial_PolynomialRingElement_1c re = ZERO_89_a5();
...
- K= 2
*/
static KRML_MUSTINLINE void deserialize_ring_elements_reduced_504(
...
shift_right_39(libcrux_ml_kem_vector_neon_vector_type_SIMD128Vector v) {
...
- SHIFT_BY= 15
*/
static libcrux_ml_kem_vector_neon_vector_type_SIMD128Vector shift_right_20_41(
    libcrux_ml_kem_vector_neon_vector_type_SIMD128Vector v) {
  return shift_right_39(v);
}
...
to_unsigned_representative_61(
    libcrux_ml_kem_vector_neon_vector_type_SIMD128Vector a) {
  libcrux_ml_kem_vector_neon_vector_type_SIMD128Vector t = shift_right_20_41(a);
...
static KRML_MUSTINLINE void serialize_uncompressed_ring_element_9c(
  ...
  for (size_t i = (size_t)0U;
    ...
    size_t i0 = i;
    libcrux_ml_kem_vector_neon_vector_type_SIMD128Vector coefficient =
        to_unsigned_representative_61(re->coefficients[i0]);
    uint8_t bytes[24U];
...
- OUT_LEN= 768
*/
static KRML_MUSTINLINE void serialize_secret_key_091(
...
- PUBLIC_KEY_SIZE= 800
*/
static KRML_MUSTINLINE void serialize_public_key_5d1(
  ...
  uint8_t ret0[768U];
  serialize_secret_key_091(t_as_ntt, ret0);
  core_slice___Slice_T___copy_from_slice(
      uu____0,
...
- PUBLIC_KEY_SIZE= 800
*/
bool libcrux_ml_kem_ind_cca_validate_public_key_cb1(uint8_t *public_key) {
  libcrux_ml_kem_polynomial_PolynomialRingElement_1c deserialized_pk[2U];
  deserialize_ring_elements_reduced_504(
...
- K= 2
*/
static KRML_MUSTINLINE void G_48_401(Eurydice_slice input, uint8_t ret[64U]) {
...
shake128_init_absorb_e41(uint8_t input[2U][34U]) {
  libcrux_sha3_neon_x2_incremental_KeccakState uu____0 =
      libcrux_sha3_neon_x2_incremental_shake128_init();
  libcrux_sha3_neon_x2_incremental_KeccakState state[2U] = {
  ...
  memcpy(lit.shake128_state, state,
         (size_t)2U * sizeof(libcrux_sha3_neon_x2_incremental_KeccakState));
  return lit;
}
...
*/
static KRML_MUSTINLINE Simd128Hash
shake128_init_absorb_48_b11(uint8_t input[2U][34U]) {
  uint8_t uu____0[2U][34U];
  memcpy(uu____0, input, (size_t)2U * sizeof(uint8_t[34U]));
  return shake128_init_absorb_e41(uu____0);
}
...
- K= 2
*/
static KRML_MUSTINLINE void shake128_squeeze_three_blocks_7f1(
...
- K= 2
*/
static KRML_MUSTINLINE void shake128_squeeze_three_blocks_48_591(
    Simd128Hash *self, uint8_t ret[2U][504U]) {
  shake128_squeeze_three_blocks_7f1(self, ret);
}
...
- N= 504
*/
static KRML_MUSTINLINE bool sample_from_uniform_distribution_next_193(
...
- K= 2
*/
static KRML_MUSTINLINE void shake128_squeeze_block_651(Simd128Hash *st,
                                                       uint8_t ret[2U][168U]) {
...
- K= 2
*/
static KRML_MUSTINLINE void shake128_squeeze_block_48_951(
    Simd128Hash *self, uint8_t ret[2U][168U]) {
  shake128_squeeze_block_651(self, ret);
}
...
- N= 168
*/
static KRML_MUSTINLINE bool sample_from_uniform_distribution_next_194(
...
*/
static KRML_MUSTINLINE libcrux_ml_kem_polynomial_PolynomialRingElement_1c
from_i16_array_89_fd(Eurydice_slice a) {
  libcrux_ml_kem_polynomial_PolynomialRingElement_1c result = ZERO_89_a5();
  for (size_t i = (size_t)0U;
       i < LIBCRUX_ML_KEM_POLYNOMIAL_VECTORS_IN_RING_ELEMENT; i++) {
    size_t i0 = i;
...
- K= 2
*/
static libcrux_ml_kem_polynomial_PolynomialRingElement_1c closure_6f1(
    int16_t s[272U]) {
  return from_i16_array_89_fd(Eurydice_array_to_subslice2(
...
- K= 2
*/
static KRML_MUSTINLINE void sample_from_xof_511(
  ...
  Simd128Hash xof_state = shake128_init_absorb_48_b11(uu____0);
  uint8_t randomness0[2U][504U];
  shake128_squeeze_three_blocks_48_591(&xof_state, randomness0);
  uint8_t uu____1[2U][504U];
  memcpy(uu____1, randomness0, (size_t)2U * sizeof(uint8_t[504U]));
  bool done = sample_from_uniform_distribution_next_193(
  ...
  while (true) {
    if (done) {
      ...
      shake128_squeeze_block_48_951(&xof_state, randomness);
      uint8_t uu____2[2U][168U];
      memcpy(uu____2, randomness, (size_t)2U * sizeof(uint8_t[168U]));
      done = sample_from_uniform_distribution_next_194(
...
- K= 2
*/
static KRML_MUSTINLINE void sample_matrix_A_321(
  ...
  KRML_MAYBE_FOR2(
      ...
      sample_from_xof_511(uu____1, sampled);
      for (size_t i = (size_t)0U;
           i < core_slice___Slice_T___len(
                   Eurydice_array_to_slice(
                       (size_t)2U, sampled,
...
- LEN= 192
*/
static KRML_MUSTINLINE void PRFxN_241(uint8_t (*input)[33U],
                                      uint8_t ret[2U][192U]) {
...
- LEN= 192
*/
static KRML_MUSTINLINE void PRFxN_48_191(uint8_t (*input)[33U],
                                         uint8_t ret[2U][192U]) {
  PRFxN_241(input, ret);
}
...
*/
static KRML_MUSTINLINE libcrux_ml_kem_polynomial_PolynomialRingElement_1c
sample_from_binomial_distribution_2_02(Eurydice_slice randomness) {
  ...
  return from_i16_array_89_fd(Eurydice_array_to_slice(
...
*/
static KRML_MUSTINLINE libcrux_ml_kem_polynomial_PolynomialRingElement_1c
sample_from_binomial_distribution_3_00(Eurydice_slice randomness) {
  int16_t sampled_i16s[256U] = {0U};
  for (size_t i0 = (size_t)0U;
       i0 <
...
*/
static KRML_MUSTINLINE libcrux_ml_kem_polynomial_PolynomialRingElement_1c
sample_from_binomial_distribution_920(Eurydice_slice randomness) {
  return sample_from_binomial_distribution_3_00(randomness);
}
...
*/
static KRML_MUSTINLINE void ntt_at_layer_7_50(
...
ntt_layer_int_vec_step_f1(
  ...
  libcrux_ml_kem_vector_neon_vector_type_SIMD128Vector t =
      montgomery_multiply_fe_cf(b, zeta_r);
...
*/
static KRML_MUSTINLINE void ntt_at_layer_4_plus_fd(
...
*/
static KRML_MUSTINLINE void ntt_at_layer_3_69(
    size_t *zeta_i, libcrux_ml_kem_polynomial_PolynomialRingElement_1c *re) {
  KRML_MAYBE_FOR16(
...
*/
static KRML_MUSTINLINE void ntt_at_layer_2_1a(
    size_t *zeta_i, libcrux_ml_kem_polynomial_PolynomialRingElement_1c *re) {
  KRML_MAYBE_FOR16(
      i, (size_t)0U, (size_t)16U, (size_t)1U, size_t round = i;
      zeta_i[0U] = zeta_i[0U] + (size_t)1U;
...
*/
static KRML_MUSTINLINE void ntt_at_layer_1_57(
    size_t *zeta_i, libcrux_ml_kem_polynomial_PolynomialRingElement_1c *re) {
  KRML_MAYBE_FOR16(
      i, (size_t)0U, (size_t)16U, (size_t)1U, size_t round = i;
      zeta_i[0U] = zeta_i[0U] + (size_t)1U;
...
*/
static KRML_MUSTINLINE void poly_barrett_reduce_89_c5(
...
*/
static KRML_MUSTINLINE void ntt_binomially_sampled_ring_element_b6(
    libcrux_ml_kem_polynomial_PolynomialRingElement_1c *re) {
  ntt_at_layer_7_50(re);
  size_t zeta_i = (size_t)1U;
  ntt_at_layer_4_plus_fd(&zeta_i, re, (size_t)6U);
  ntt_at_layer_4_plus_fd(&zeta_i, re, (size_t)5U);
  ntt_at_layer_4_plus_fd(&zeta_i, re, (size_t)4U);
  ntt_at_layer_3_69(&zeta_i, re);
  ntt_at_layer_2_1a(&zeta_i, re);
  ntt_at_layer_1_57(&zeta_i, re);
  poly_barrett_reduce_89_c5(re);
}
...
static KRML_MUSTINLINE tuple_741 sample_vector_cbd_then_ntt_1a1(
  ...
  PRFxN_48_191(prf_inputs, prf_outputs);
  KRML_MAYBE_FOR2(i, (size_t)0U, (size_t)2U, (size_t)1U, size_t i0 = i;
                  re_as_ntt[i0] = sample_from_binomial_distribution_920(
                      Eurydice_array_to_slice((size_t)192U, prf_outputs[i0],
                                              uint8_t, Eurydice_slice));
                  ntt_binomially_sampled_ring_element_b6(&re_as_ntt[i0]););
...
ntt_multiply_89_16(libcrux_ml_kem_polynomial_PolynomialRingElement_1c *self,
  ...
  libcrux_ml_kem_polynomial_PolynomialRingElement_1c out = ZERO_89_a5();
  for (size_t i = (size_t)0U;
       i < LIBCRUX_ML_KEM_POLYNOMIAL_VECTORS_IN_RING_ELEMENT; i++) {
    size_t i0 = i;
    libcrux_ml_kem_vector_neon_vector_type_SIMD128Vector uu____0 =
...
- K= 2
*/
static KRML_MUSTINLINE void add_to_ring_element_89_974(
    libcrux_ml_kem_polynomial_PolynomialRingElement_1c *self,
    libcrux_ml_kem_polynomial_PolynomialRingElement_1c *rhs) {
  for (size_t i = (size_t)0U;
       i < core_slice___Slice_T___len(
...
*/
static libcrux_ml_kem_vector_neon_vector_type_SIMD128Vector
to_standard_domain_e2(libcrux_ml_kem_vector_neon_vector_type_SIMD128Vector v) {
...
*/
static KRML_MUSTINLINE void add_standard_error_reduce_89_79(
    libcrux_ml_kem_polynomial_PolynomialRingElement_1c *self,
  ...
  for (size_t i = (size_t)0U;
    ...
    size_t j = i;
    libcrux_ml_kem_vector_neon_vector_type_SIMD128Vector
        coefficient_normal_form = to_standard_domain_e2(self->coefficients[j]);
    libcrux_ml_kem_vector_neon_vector_type_SIMD128Vector uu____0 =
        libcrux_ml_kem_vector_neon_barrett_reduce_20(
...
- K= 2
*/
static KRML_MUSTINLINE void compute_As_plus_e_281(
  ...
  for (size_t i0 = (size_t)0U;
    ...
    for (size_t i = (size_t)0U;
      ...
      add_to_ring_element_89_974(&result[i1], &product);
    }
    add_standard_error_reduce_89_79(&result[i1], &error_as_ntt[i1]);
  }
  memcpy(
      ret, result,
      (size_t)2U * sizeof(libcrux_ml_kem_polynomial_PolynomialRingElement_1c));
...
*/
static tuple_4c1 generate_keypair_unpacked_dd1(
    Eurydice_slice key_generation_seed) {
  uint8_t hashed[64U];
  G_48_401(key_generation_seed, hashed);
  ...
  sample_matrix_A_321(ret, true, A_transpose);
  ...
  tuple_741 uu____2 = sample_vector_cbd_then_ntt_1a1(uu____1, 0U);
  ...
  memcpy(
      error_as_ntt,
      sample_vector_cbd_then_ntt_1a1(uu____3, domain_separator).fst,
      (size_t)2U * sizeof(libcrux_ml_kem_polynomial_PolynomialRingElement_1c));
  libcrux_ml_kem_polynomial_PolynomialRingElement_1c t_as_ntt[2U];
  compute_As_plus_e_281(A_transpose, secret_as_ntt, error_as_ntt, t_as_ntt);
...
*/
static inline libcrux_ml_kem_polynomial_PolynomialRingElement_1c clone_d5_4b(
    libcrux_ml_kem_polynomial_PolynomialRingElement_1c *self) {
  libcrux_ml_kem_polynomial_PolynomialRingElement_1c lit;
...
- K= 2
*/
static KRML_MUSTINLINE void H_48_871(Eurydice_slice input, uint8_t ret[32U]) {
...
libcrux_ml_kem_ind_cca_generate_keypair_unpacked_e81(uint8_t randomness[64U]) {
  ...
  tuple_4c1 uu____0 = generate_keypair_unpacked_dd1(ind_cpa_keypair_randomness);
  ...
  KRML_MAYBE_FOR2(i, (size_t)0U, (size_t)2U, (size_t)1U, closure_5e1(A[i]););
  KRML_MAYBE_FOR2(
      i0, (size_t)0U, (size_t)2U, (size_t)1U, size_t i1 = i0; KRML_MAYBE_FOR2(
          ...
          libcrux_ml_kem_polynomial_PolynomialRingElement_1c uu____1 =
              clone_d5_4b(&ind_cpa_public_key.A[j][i1]);
          A[i1][j] = uu____1;););
  ...
  H_48_871(Eurydice_array_to_slice((size_t)800U, pk_serialized, uint8_t,
                                   Eurydice_slice),
           public_key_hash);
...
- ETA1_RANDOMNESS_SIZE= 192
*/
static libcrux_ml_kem_utils_extraction_helper_Keypair512 generate_keypair_371(
    Eurydice_slice key_generation_seed) {
  tuple_4c1 uu____0 = generate_keypair_unpacked_dd1(key_generation_seed);
  ...
  uint8_t public_key_serialized[800U];
  serialize_public_key_5d1(pk.t_as_ntt,
                           Eurydice_array_to_slice((size_t)32U, pk.seed_for_A,
                                                   uint8_t, Eurydice_slice),
                           public_key_serialized);
  uint8_t secret_key_serialized[768U];
  serialize_secret_key_091(sk.secret_as_ntt, secret_key_serialized);
...
*/
static KRML_MUSTINLINE void serialize_kem_secret_key_9c1(
...
libcrux_ml_kem_ind_cca_generate_keypair_071(uint8_t randomness[64U]) {
  Eurydice_slice ind_cpa_keypair_randomness = Eurydice_array_to_subslice2(
      randomness, (size_t)0U,
      LIBCRUX_ML_KEM_CONSTANTS_CPA_PKE_KEY_GENERATION_SEED_SIZE, uint8_t,
      Eurydice_slice);
  ...
  libcrux_ml_kem_utils_extraction_helper_Keypair512 uu____0 =
      generate_keypair_371(ind_cpa_keypair_randomness);
...
- LEN= 128
*/
static KRML_MUSTINLINE void PRFxN_242(uint8_t (*input)[33U],
                                      uint8_t ret[2U][128U]) {
...
- LEN= 128
*/
static KRML_MUSTINLINE void PRFxN_48_192(uint8_t (*input)[33U],
                                         uint8_t ret[2U][128U]) {
  PRFxN_242(input, ret);
}
...
*/
static KRML_MUSTINLINE libcrux_ml_kem_polynomial_PolynomialRingElement_1c
sample_from_binomial_distribution_92(Eurydice_slice randomness) {
  return sample_from_binomial_distribution_2_02(randomness);
}
...
sample_ring_element_cbd_451(uint8_t prf_input[33U], uint8_t domain_separator) {
  libcrux_ml_kem_polynomial_PolynomialRingElement_1c error_1[2U];
  KRML_MAYBE_FOR2(i, (size_t)0U, (size_t)2U, (size_t)1U,
                  error_1[i] = ZERO_89_a5(););
  uint8_t uu____0[33U];
  memcpy(uu____0, prf_input, (size_t)33U * sizeof(uint8_t));
  uint8_t prf_inputs[2U][33U];
  KRML_MAYBE_FOR2(
  ...
  PRFxN_48_192(prf_inputs, prf_outputs);
  KRML_MAYBE_FOR2(
      i, (size_t)0U, (size_t)2U, (size_t)1U, size_t i0 = i;
      libcrux_ml_kem_polynomial_PolynomialRingElement_1c uu____1 =
          sample_from_binomial_distribution_92(Eurydice_array_to_slice(
...
- LEN= 128
*/
static KRML_MUSTINLINE void PRF_48_a54(Eurydice_slice input,
                                       uint8_t ret[128U]) {
  PRF_b40(input, ret);
}
...
*/
static KRML_MUSTINLINE void invert_ntt_at_layer_1_13(
    size_t *zeta_i, libcrux_ml_kem_polynomial_PolynomialRingElement_1c *re) {
  KRML_MAYBE_FOR16(
      i, (size_t)0U, (size_t)16U, (size_t)1U, size_t round = i;
      zeta_i[0U] = zeta_i[0U] - (size_t)1U;
...
*/
static KRML_MUSTINLINE void invert_ntt_at_layer_2_81(
    size_t *zeta_i, libcrux_ml_kem_polynomial_PolynomialRingElement_1c *re) {
  KRML_MAYBE_FOR16(
      i, (size_t)0U, (size_t)16U, (size_t)1U, size_t round = i;
      zeta_i[0U] = zeta_i[0U] - (size_t)1U;
...
*/
static KRML_MUSTINLINE void invert_ntt_at_layer_3_ea(
    size_t *zeta_i, libcrux_ml_kem_polynomial_PolynomialRingElement_1c *re) {
  KRML_MAYBE_FOR16(
      i, (size_t)0U, (size_t)16U, (size_t)1U, size_t round = i;
      zeta_i[0U] = zeta_i[0U] - (size_t)1U;
...
inv_ntt_layer_int_vec_step_reduce_eb(
  ...
  b = montgomery_multiply_fe_cf(a_minus_b, zeta_r);
  return (CLITERAL(libcrux_ml_kem_vector_neon_vector_type_SIMD128Vector_x2){
      .fst = a, .snd = b});
}
...
*/
static KRML_MUSTINLINE void invert_ntt_at_layer_4_plus_b6(
    size_t *zeta_i, libcrux_ml_kem_polynomial_PolynomialRingElement_1c *re,
    size_t layer) {
  size_t step = (size_t)1U << (uint32_t)layer;
  for (size_t i0 = (size_t)0U; i0 < (size_t)128U >> (uint32_t)layer; i0++) {
...
static KRML_MUSTINLINE void invert_ntt_montgomery_b51(
  ...
  invert_ntt_at_layer_1_13(&zeta_i, re);
  invert_ntt_at_layer_2_81(&zeta_i, re);
  invert_ntt_at_layer_3_ea(&zeta_i, re);
  invert_ntt_at_layer_4_plus_b6(&zeta_i, re, (size_t)4U);
  invert_ntt_at_layer_4_plus_b6(&zeta_i, re, (size_t)5U);
  invert_ntt_at_layer_4_plus_b6(&zeta_i, re, (size_t)6U);
  invert_ntt_at_layer_4_plus_b6(&zeta_i, re, (size_t)7U);
  poly_barrett_reduce_89_c5(re);
}
...
*/
static KRML_MUSTINLINE void add_error_reduce_89_0a(
    libcrux_ml_kem_polynomial_PolynomialRingElement_1c *self,
    libcrux_ml_kem_polynomial_PolynomialRingElement_1c *error) {
  for (size_t i = (size_t)0U;
       i < LIBCRUX_ML_KEM_POLYNOMIAL_VECTORS_IN_RING_ELEMENT; i++) {
...
- K= 2
*/
static KRML_MUSTINLINE void compute_vector_u_e11(
  ...
  for (size_t i0 = (size_t)0U;
    ...
    add_error_reduce_89_0a(&result[i1], &error_1[i1]);
  }
  memcpy(
      ret, result,
      (size_t)2U * sizeof(libcrux_ml_kem_polynomial_PolynomialRingElement_1c));
...
*/
static libcrux_ml_kem_vector_neon_vector_type_SIMD128Vector decompress_1_1e(
    libcrux_ml_kem_vector_neon_vector_type_SIMD128Vector v) {
...
*/
static KRML_MUSTINLINE libcrux_ml_kem_polynomial_PolynomialRingElement_1c
deserialize_then_decompress_message_be(uint8_t serialized[32U]) {
  libcrux_ml_kem_polynomial_PolynomialRingElement_1c re = ZERO_89_a5();
  KRML_MAYBE_FOR16(
      ...
      libcrux_ml_kem_vector_neon_vector_type_SIMD128Vector
          coefficient_compressed = libcrux_ml_kem_vector_neon_deserialize_1_20(
              Eurydice_array_to_subslice2(serialized, (size_t)2U * i0,
                                          ...
                                          Eurydice_slice));
      libcrux_ml_kem_vector_neon_vector_type_SIMD128Vector uu____0 =
          decompress_1_1e(coefficient_compressed);
      re.coefficients[i0] = uu____0;);
  return re;
}
...
*/
static KRML_MUSTINLINE libcrux_ml_kem_polynomial_PolynomialRingElement_1c
add_message_error_reduce_89_4d(
    libcrux_ml_kem_polynomial_PolynomialRingElement_1c *self,
...
compute_ring_element_v_e51(
  ...
  KRML_MAYBE_FOR2(i, (size_t)0U, (size_t)2U, (size_t)1U, size_t i0 = i;
                  ...
                  add_to_ring_element_89_974(&result, &product););
  invert_ntt_montgomery_b51(&result);
  result = add_message_error_reduce_89_4d(error_2, message, result);
  return result;
}
...
- COEFFICIENT_BITS= 10
*/
static KRML_MUSTINLINE _uint32x4_t compress_int32x4_t_89(_uint32x4_t v) {
...
*/
static KRML_MUSTINLINE libcrux_ml_kem_vector_neon_vector_type_SIMD128Vector
compress_16(libcrux_ml_kem_vector_neon_vector_type_SIMD128Vector v) {
  ...
  _uint32x4_t low0 = compress_int32x4_t_89(low00);
  _uint32x4_t low1 = compress_int32x4_t_89(low10);
  _uint32x4_t high0 = compress_int32x4_t_89(high00);
  _uint32x4_t high1 = compress_int32x4_t_89(high10);
  _int16x8_t low =
...
- COEFFICIENT_BITS= 10
*/
static libcrux_ml_kem_vector_neon_vector_type_SIMD128Vector compress_20_8c(
    libcrux_ml_kem_vector_neon_vector_type_SIMD128Vector v) {
  return compress_16(v);
}
...
- OUT_LEN= 320
*/
static KRML_MUSTINLINE void compress_then_serialize_10_f70(
  ...
  for (size_t i = (size_t)0U;
    ...
    size_t i0 = i;
    libcrux_ml_kem_vector_neon_vector_type_SIMD128Vector coefficient =
        compress_20_8c(to_unsigned_representative_61(re->coefficients[i0]));
    uint8_t bytes[20U];
...
- COEFFICIENT_BITS= 11
*/
static KRML_MUSTINLINE _uint32x4_t compress_int32x4_t_890(_uint32x4_t v) {
  _uint32x4_t half = _vdupq_n_u32(1664U);
...
*/
static KRML_MUSTINLINE libcrux_ml_kem_vector_neon_vector_type_SIMD128Vector
compress_160(libcrux_ml_kem_vector_neon_vector_type_SIMD128Vector v) {
  _int16x8_t mask = _vdupq_n_s16(
      libcrux_ml_kem_vector_neon_compress_mask_n_least_significant_bits(
          (int16_t)(int32_t)11));
  _uint32x4_t mask16 = _vdupq_n_u32(65535U);
  ...
  _uint32x4_t high10 =
      _vshrq_n_u32((int32_t)16, _vreinterpretq_u32_s16(v.high), _uint32x4_t);
  _uint32x4_t low0 = compress_int32x4_t_890(low00);
  _uint32x4_t low1 = compress_int32x4_t_890(low10);
  _uint32x4_t high0 = compress_int32x4_t_890(high00);
  _uint32x4_t high1 = compress_int32x4_t_890(high10);
  _int16x8_t low =
      _vtrn1q_s16(_vreinterpretq_s16_u32(low0), _vreinterpretq_s16_u32(low1));
  _int16x8_t high =
      _vtrn1q_s16(_vreinterpretq_s16_u32(high0), _vreinterpretq_s16_u32(high1));
...
- COEFFICIENT_BITS= 11
*/
static libcrux_ml_kem_vector_neon_vector_type_SIMD128Vector compress_20_8c0(
    libcrux_ml_kem_vector_neon_vector_type_SIMD128Vector v) {
  return compress_160(v);
}
...
- OUT_LEN= 320
*/
static KRML_MUSTINLINE void compress_then_serialize_ring_element_u_910(
    libcrux_ml_kem_polynomial_PolynomialRingElement_1c *re, uint8_t ret[320U]) {
  uint8_t uu____0[320U];
  compress_then_serialize_10_f70(re, uu____0);
...
- BLOCK_LEN= 320
*/
static void compress_then_serialize_u_db1(
  ...
  for (size_t i = (size_t)0U;
    ...
    Eurydice_slice uu____0 = Eurydice_slice_subslice2(
        ...
        Eurydice_slice);
    uint8_t ret[320U];
    compress_then_serialize_ring_element_u_910(&re, ret);
    core_slice___Slice_T___copy_from_slice(
        uu____0,
...
- COEFFICIENT_BITS= 4
*/
static KRML_MUSTINLINE _uint32x4_t compress_int32x4_t_891(_uint32x4_t v) {
  _uint32x4_t half = _vdupq_n_u32(1664U);
...
*/
static KRML_MUSTINLINE libcrux_ml_kem_vector_neon_vector_type_SIMD128Vector
compress_161(libcrux_ml_kem_vector_neon_vector_type_SIMD128Vector v) {
  _int16x8_t mask = _vdupq_n_s16(
      libcrux_ml_kem_vector_neon_compress_mask_n_least_significant_bits(
          (int16_t)(int32_t)4));
  _uint32x4_t mask16 = _vdupq_n_u32(65535U);
  ...
  _uint32x4_t high10 =
      _vshrq_n_u32((int32_t)16, _vreinterpretq_u32_s16(v.high), _uint32x4_t);
  _uint32x4_t low0 = compress_int32x4_t_891(low00);
  _uint32x4_t low1 = compress_int32x4_t_891(low10);
  _uint32x4_t high0 = compress_int32x4_t_891(high00);
  _uint32x4_t high1 = compress_int32x4_t_891(high10);
  _int16x8_t low =
      _vtrn1q_s16(_vreinterpretq_s16_u32(low0), _vreinterpretq_s16_u32(low1));
  _int16x8_t high =
      _vtrn1q_s16(_vreinterpretq_s16_u32(high0), _vreinterpretq_s16_u32(high1));
...
- COEFFICIENT_BITS= 4
*/
static libcrux_ml_kem_vector_neon_vector_type_SIMD128Vector compress_20_8c1(
    libcrux_ml_kem_vector_neon_vector_type_SIMD128Vector v) {
  return compress_161(v);
}
...
*/
static KRML_MUSTINLINE void compress_then_serialize_4_2f(
    libcrux_ml_kem_polynomial_PolynomialRingElement_1c re,
  ...
  for (size_t i = (size_t)0U;
    ...
    size_t i0 = i;
    libcrux_ml_kem_vector_neon_vector_type_SIMD128Vector coefficient =
        compress_20_8c1(to_unsigned_representative_61(re.coefficients[i0]));
    uint8_t bytes[8U];
...
- COEFFICIENT_BITS= 5
*/
static KRML_MUSTINLINE _uint32x4_t compress_int32x4_t_892(_uint32x4_t v) {
  _uint32x4_t half = _vdupq_n_u32(1664U);
...
*/
static KRML_MUSTINLINE libcrux_ml_kem_vector_neon_vector_type_SIMD128Vector
compress_162(libcrux_ml_kem_vector_neon_vector_type_SIMD128Vector v) {
  _int16x8_t mask = _vdupq_n_s16(
      libcrux_ml_kem_vector_neon_compress_mask_n_least_significant_bits(
          (int16_t)(int32_t)5));
  _uint32x4_t mask16 = _vdupq_n_u32(65535U);
  ...
  _uint32x4_t high10 =
      _vshrq_n_u32((int32_t)16, _vreinterpretq_u32_s16(v.high), _uint32x4_t);
  _uint32x4_t low0 = compress_int32x4_t_892(low00);
  _uint32x4_t low1 = compress_int32x4_t_892(low10);
  _uint32x4_t high0 = compress_int32x4_t_892(high00);
  _uint32x4_t high1 = compress_int32x4_t_892(high10);
  _int16x8_t low =
      _vtrn1q_s16(_vreinterpretq_s16_u32(low0), _vreinterpretq_s16_u32(low1));
  _int16x8_t high =
      _vtrn1q_s16(_vreinterpretq_s16_u32(high0), _vreinterpretq_s16_u32(high1));
...
- COEFFICIENT_BITS= 5
*/
static libcrux_ml_kem_vector_neon_vector_type_SIMD128Vector compress_20_8c2(
    libcrux_ml_kem_vector_neon_vector_type_SIMD128Vector v) {
  return compress_162(v);
}
...
*/
static KRML_MUSTINLINE void compress_then_serialize_5_48(
    libcrux_ml_kem_polynomial_PolynomialRingElement_1c re,
    Eurydice_slice serialized) {
  for (size_t i = (size_t)0U;
       i < LIBCRUX_ML_KEM_POLYNOMIAL_VECTORS_IN_RING_ELEMENT; i++) {
    ...
    libcrux_ml_kem_vector_neon_vector_type_SIMD128Vector coefficients =
        compress_20_8c2(to_unsigned_representative_61(re.coefficients[i0]));
    uint8_t bytes[10U];
...
- OUT_LEN= 128
*/
static KRML_MUSTINLINE void compress_then_serialize_ring_element_v_9e0(
    libcrux_ml_kem_polynomial_PolynomialRingElement_1c re, Eurydice_slice out) {
  compress_then_serialize_4_2f(re, out);
}
...
static void encrypt_unpacked_021(
  ...
  uint8_t uu____0[33U];
  memcpy(uu____0, prf_input, (size_t)33U * sizeof(uint8_t));
  tuple_741 uu____1 = sample_vector_cbd_then_ntt_1a1(uu____0, 0U);
  ...
  tuple_741 uu____3 = sample_ring_element_cbd_451(uu____2, domain_separator0);
  libcrux_ml_kem_polynomial_PolynomialRingElement_1c error_1[2U];
  memcpy(
      error_1, uu____3.fst,
      (size_t)2U * sizeof(libcrux_ml_kem_polynomial_PolynomialRingElement_1c));
  ...
  compute_vector_u_e11(public_key->A, r_as_ntt, error_1, u);
  uint8_t uu____4[32U];
  ...
  libcrux_ml_kem_polynomial_PolynomialRingElement_1c message_as_ring_element =
      deserialize_then_decompress_message_be(uu____4);
  libcrux_ml_kem_polynomial_PolynomialRingElement_1c v =
      compute_ring_element_v_e51(public_key->t_as_ntt, r_as_ntt, &error_2,
  ...
  compress_then_serialize_ring_element_v_9e0(
      uu____6,
...
- ETA2_RANDOMNESS_SIZE= 128
*/
tuple_ec libcrux_ml_kem_ind_cca_encapsulate_unpacked_6a1(
  ...
  encrypt_unpacked_021(uu____2, uu____3, pseudorandomness, ciphertext);
...
- K= 2
*/
static KRML_MUSTINLINE void entropy_preprocess_af_101(Eurydice_slice randomness,
                                                      uint8_t ret[32U]) {
  uint8_t out[32U] = {0U};
  core_slice___Slice_T___copy_from_slice(
...
- K= 2
*/
static KRML_MUSTINLINE void deserialize_ring_elements_reduced_503(
    Eurydice_slice public_key,
    libcrux_ml_kem_polynomial_PolynomialRingElement_1c ret[2U]) {
  libcrux_ml_kem_polynomial_PolynomialRingElement_1c deserialized_pk[2U];
  KRML_MAYBE_FOR2(i, (size_t)0U, (size_t)2U, (size_t)1U,
...
- ETA2_RANDOMNESS_SIZE= 128
*/
static void encrypt_081(Eurydice_slice public_key, uint8_t message[32U],
                        Eurydice_slice randomness, uint8_t ret[768U]) {
  libcrux_ml_kem_polynomial_PolynomialRingElement_1c t_as_ntt[2U];
  deserialize_ring_elements_reduced_503(
  ...
  sample_matrix_A_321(ret0, false, A);
  uint8_t seed_for_A[32U];
  core_result_Result_00 dst;
  ...
  memcpy(uu____4, message, (size_t)32U * sizeof(uint8_t));
  uint8_t ret1[768U];
  encrypt_unpacked_021(uu____3, uu____4, randomness, ret1);
...
- CIPHERTEXT_SIZE= 768
*/
static KRML_MUSTINLINE void kdf_af_bf1(Eurydice_slice shared_secret,
                                       uint8_t ret[32U]) {
  uint8_t out[32U] = {0U};
  core_slice___Slice_T___copy_from_slice(
      Eurydice_array_to_slice((size_t)32U, out, uint8_t, Eurydice_slice),
...
- ETA2_RANDOMNESS_SIZE= 128
*/
tuple_ec libcrux_ml_kem_ind_cca_encapsulate_de1(
    libcrux_ml_kem_types_MlKemPublicKey_be *public_key,
    uint8_t randomness[32U]) {
  uint8_t randomness0[32U];
  entropy_preprocess_af_101(
      Eurydice_array_to_slice((size_t)32U, randomness, uint8_t, Eurydice_slice),
      randomness0);
  uint8_t to_hash[64U];
  libcrux_ml_kem_utils_into_padded_array_2d(
  ...
  Eurydice_slice uu____0 = Eurydice_array_to_subslice_from(
      ...
      size_t, Eurydice_slice);
  uint8_t ret[32U];
  H_48_871(Eurydice_array_to_slice(
  ...
  uint8_t ciphertext[768U];
  encrypt_081(uu____2, uu____3, pseudorandomness, ciphertext);
  uint8_t uu____4[768U];
  memcpy(uu____4, ciphertext, (size_t)768U * sizeof(uint8_t));
  libcrux_ml_kem_types_MlKemCiphertext_e8 ciphertext0 =
      libcrux_ml_kem_types_from_01_f5(uu____4);
  uint8_t shared_secret_array[32U];
  kdf_af_bf1(shared_secret, shared_secret_array);
...
- COEFFICIENT_BITS= 10
*/
static KRML_MUSTINLINE _uint32x4_t decompress_uint32x4_t_b5(_uint32x4_t v) {
...
*/
static KRML_MUSTINLINE libcrux_ml_kem_vector_neon_vector_type_SIMD128Vector
decompress_ciphertext_coefficient_0f(
    libcrux_ml_kem_vector_neon_vector_type_SIMD128Vector v) {
  _uint32x4_t mask16 = _vdupq_n_u32(65535U);
  _uint32x4_t low00 = _vandq_u32(_vreinterpretq_u32_s16(v.low), mask16);
  _uint32x4_t low10 =
  ...
  _uint32x4_t high10 =
      _vshrq_n_u32((int32_t)16, _vreinterpretq_u32_s16(v.high), _uint32x4_t);
  _uint32x4_t low0 = decompress_uint32x4_t_b5(low00);
  _uint32x4_t low1 = decompress_uint32x4_t_b5(low10);
  _uint32x4_t high0 = decompress_uint32x4_t_b5(high00);
  _uint32x4_t high1 = decompress_uint32x4_t_b5(high10);
  v.low =
      _vtrn1q_s16(_vreinterpretq_s16_u32(low0), _vreinterpretq_s16_u32(low1));
  v.high =
      _vtrn1q_s16(_vreinterpretq_s16_u32(high0), _vreinterpretq_s16_u32(high1));
...
*/
static libcrux_ml_kem_vector_neon_vector_type_SIMD128Vector
decompress_ciphertext_coefficient_20_06(
    libcrux_ml_kem_vector_neon_vector_type_SIMD128Vector v) {
  return decompress_ciphertext_coefficient_0f(v);
}
...
*/
static KRML_MUSTINLINE libcrux_ml_kem_polynomial_PolynomialRingElement_1c
deserialize_then_decompress_10_f9(Eurydice_slice serialized) {
  libcrux_ml_kem_polynomial_PolynomialRingElement_1c re = ZERO_89_a5();
  for (size_t i = (size_t)0U;
       i <
    ...
    libcrux_ml_kem_vector_neon_vector_type_SIMD128Vector uu____0 =
        decompress_ciphertext_coefficient_20_06(coefficient);
    re.coefficients[i0] = uu____0;
  }
  return re;
}
...
- COEFFICIENT_BITS= 11
*/
static KRML_MUSTINLINE _uint32x4_t decompress_uint32x4_t_b50(_uint32x4_t v) {
...
*/
static KRML_MUSTINLINE libcrux_ml_kem_vector_neon_vector_type_SIMD128Vector
decompress_ciphertext_coefficient_0f0(
    libcrux_ml_kem_vector_neon_vector_type_SIMD128Vector v) {
  _uint32x4_t mask16 = _vdupq_n_u32(65535U);
  _uint32x4_t low00 = _vandq_u32(_vreinterpretq_u32_s16(v.low), mask16);
  _uint32x4_t low10 =
  ...
  _uint32x4_t high10 =
      _vshrq_n_u32((int32_t)16, _vreinterpretq_u32_s16(v.high), _uint32x4_t);
  _uint32x4_t low0 = decompress_uint32x4_t_b50(low00);
  _uint32x4_t low1 = decompress_uint32x4_t_b50(low10);
  _uint32x4_t high0 = decompress_uint32x4_t_b50(high00);
  _uint32x4_t high1 = decompress_uint32x4_t_b50(high10);
  v.low =
      _vtrn1q_s16(_vreinterpretq_s16_u32(low0), _vreinterpretq_s16_u32(low1));
  v.high =
      _vtrn1q_s16(_vreinterpretq_s16_u32(high0), _vreinterpretq_s16_u32(high1));
...
*/
static libcrux_ml_kem_vector_neon_vector_type_SIMD128Vector
decompress_ciphertext_coefficient_20_060(
    libcrux_ml_kem_vector_neon_vector_type_SIMD128Vector v) {
  return decompress_ciphertext_coefficient_0f0(v);
}
...
*/
static KRML_MUSTINLINE libcrux_ml_kem_polynomial_PolynomialRingElement_1c
deserialize_then_decompress_11_69(Eurydice_slice serialized) {
  libcrux_ml_kem_polynomial_PolynomialRingElement_1c re = ZERO_89_a5();
  for (size_t i = (size_t)0U;
       i <
    ...
    libcrux_ml_kem_vector_neon_vector_type_SIMD128Vector uu____0 =
        decompress_ciphertext_coefficient_20_060(coefficient);
    re.coefficients[i0] = uu____0;
  }
  return re;
}
...
*/
static KRML_MUSTINLINE libcrux_ml_kem_polynomial_PolynomialRingElement_1c
deserialize_then_decompress_ring_element_u_350(Eurydice_slice serialized) {
  return deserialize_then_decompress_10_f9(serialized);
}
...
- VECTOR_U_COMPRESSION_FACTOR= 10
*/
static KRML_MUSTINLINE void ntt_vector_u_700(
    libcrux_ml_kem_polynomial_PolynomialRingElement_1c *re) {
  size_t zeta_i = (size_t)0U;
  ntt_at_layer_4_plus_fd(&zeta_i, re, (size_t)7U);
  ntt_at_layer_4_plus_fd(&zeta_i, re, (size_t)6U);
  ntt_at_layer_4_plus_fd(&zeta_i, re, (size_t)5U);
  ntt_at_layer_4_plus_fd(&zeta_i, re, (size_t)4U);
  ntt_at_layer_3_69(&zeta_i, re);
...
- U_COMPRESSION_FACTOR= 10
*/
static KRML_MUSTINLINE void deserialize_then_decompress_u_c31(
    uint8_t *ciphertext,
    libcrux_ml_kem_polynomial_PolynomialRingElement_1c ret[2U]) {
  libcrux_ml_kem_polynomial_PolynomialRingElement_1c u_as_ntt[2U];
  KRML_MAYBE_FOR2(i, (size_t)0U, (size_t)2U, (size_t)1U,
                  u_as_ntt[i] = ZERO_89_a5(););
  for (size_t i = (size_t)0U;
       i < core_slice___Slice_T___len(
    ...
    Eurydice_slice u_bytes = Eurydice_array_to_subslice2(
        ...
        i0 * (LIBCRUX_ML_KEM_CONSTANTS_COEFFICIENTS_IN_RING_ELEMENT *
            ...
            LIBCRUX_ML_KEM_CONSTANTS_COEFFICIENTS_IN_RING_ELEMENT *
                (size_t)10U / (size_t)8U,
        uint8_t, Eurydice_slice);
    u_as_ntt[i0] = deserialize_then_decompress_ring_element_u_350(u_bytes);
    ntt_vector_u_700(&u_as_ntt[i0]);
  }
  memcpy(
      ret, u_as_ntt,
      (size_t)2U * sizeof(libcrux_ml_kem_polynomial_PolynomialRingElement_1c));
...
- COEFFICIENT_BITS= 4
*/
static KRML_MUSTINLINE _uint32x4_t decompress_uint32x4_t_b51(_uint32x4_t v) {
...
*/
static KRML_MUSTINLINE libcrux_ml_kem_vector_neon_vector_type_SIMD128Vector
decompress_ciphertext_coefficient_0f1(
    libcrux_ml_kem_vector_neon_vector_type_SIMD128Vector v) {
  _uint32x4_t mask16 = _vdupq_n_u32(65535U);
  _uint32x4_t low00 = _vandq_u32(_vreinterpretq_u32_s16(v.low), mask16);
  _uint32x4_t low10 =
  ...
  _uint32x4_t high10 =
      _vshrq_n_u32((int32_t)16, _vreinterpretq_u32_s16(v.high), _uint32x4_t);
  _uint32x4_t low0 = decompress_uint32x4_t_b51(low00);
  _uint32x4_t low1 = decompress_uint32x4_t_b51(low10);
  _uint32x4_t high0 = decompress_uint32x4_t_b51(high00);
  _uint32x4_t high1 = decompress_uint32x4_t_b51(high10);
  v.low =
      _vtrn1q_s16(_vreinterpretq_s16_u32(low0), _vreinterpretq_s16_u32(low1));
  v.high =
      _vtrn1q_s16(_vreinterpretq_s16_u32(high0), _vreinterpretq_s16_u32(high1));
...
*/
static libcrux_ml_kem_vector_neon_vector_type_SIMD128Vector
decompress_ciphertext_coefficient_20_061(
    libcrux_ml_kem_vector_neon_vector_type_SIMD128Vector v) {
  return decompress_ciphertext_coefficient_0f1(v);
}
...
*/
static KRML_MUSTINLINE libcrux_ml_kem_polynomial_PolynomialRingElement_1c
deserialize_then_decompress_4_4f(Eurydice_slice serialized) {
  libcrux_ml_kem_polynomial_PolynomialRingElement_1c re = ZERO_89_a5();
  for (size_t i = (size_t)0U;
    ...
    libcrux_ml_kem_vector_neon_vector_type_SIMD128Vector uu____0 =
        decompress_ciphertext_coefficient_20_061(coefficient);
    re.coefficients[i0] = uu____0;
  }
  return re;
}
...
- COEFFICIENT_BITS= 5
*/
static KRML_MUSTINLINE _uint32x4_t decompress_uint32x4_t_b52(_uint32x4_t v) {
...
*/
static KRML_MUSTINLINE libcrux_ml_kem_vector_neon_vector_type_SIMD128Vector
decompress_ciphertext_coefficient_0f2(
    libcrux_ml_kem_vector_neon_vector_type_SIMD128Vector v) {
  _uint32x4_t mask16 = _vdupq_n_u32(65535U);
  _uint32x4_t low00 = _vandq_u32(_vreinterpretq_u32_s16(v.low), mask16);
  _uint32x4_t low10 =
  ...
  _uint32x4_t high10 =
      _vshrq_n_u32((int32_t)16, _vreinterpretq_u32_s16(v.high), _uint32x4_t);
  _uint32x4_t low0 = decompress_uint32x4_t_b52(low00);
  _uint32x4_t low1 = decompress_uint32x4_t_b52(low10);
  _uint32x4_t high0 = decompress_uint32x4_t_b52(high00);
  _uint32x4_t high1 = decompress_uint32x4_t_b52(high10);
  v.low =
      _vtrn1q_s16(_vreinterpretq_s16_u32(low0), _vreinterpretq_s16_u32(low1));
  v.high =
      _vtrn1q_s16(_vreinterpretq_s16_u32(high0), _vreinterpretq_s16_u32(high1));
...
*/
static libcrux_ml_kem_vector_neon_vector_type_SIMD128Vector
decompress_ciphertext_coefficient_20_062(
    libcrux_ml_kem_vector_neon_vector_type_SIMD128Vector v) {
  return decompress_ciphertext_coefficient_0f2(v);
}
...
*/
static KRML_MUSTINLINE libcrux_ml_kem_polynomial_PolynomialRingElement_1c
deserialize_then_decompress_5_bd(Eurydice_slice serialized) {
  libcrux_ml_kem_polynomial_PolynomialRingElement_1c re = ZERO_89_a5();
  for (size_t i = (size_t)0U;
       i <
    ...
    libcrux_ml_kem_vector_neon_vector_type_SIMD128Vector uu____1 =
        decompress_ciphertext_coefficient_20_062(re.coefficients[i0]);
...
*/
static KRML_MUSTINLINE libcrux_ml_kem_polynomial_PolynomialRingElement_1c
deserialize_then_decompress_ring_element_v_ee0(Eurydice_slice serialized) {
  return deserialize_then_decompress_4_4f(serialized);
}
...
*/
static KRML_MUSTINLINE libcrux_ml_kem_polynomial_PolynomialRingElement_1c
subtract_reduce_89_66(libcrux_ml_kem_polynomial_PolynomialRingElement_1c *self,
...
compute_message_0a1(
  ...
  KRML_MAYBE_FOR2(i, (size_t)0U, (size_t)2U, (size_t)1U, size_t i0 = i;
                  ...
                  add_to_ring_element_89_974(&result, &product););
  invert_ntt_montgomery_b51(&result);
  result = subtract_reduce_89_66(v, result);
  return result;
}
...
- V_COMPRESSION_FACTOR= 4
*/
static void decrypt_unpacked_2b1(
    libcrux_ml_kem_ind_cpa_unpacked_IndCpaPrivateKeyUnpacked_66 *secret_key,
    uint8_t *ciphertext, uint8_t ret[32U]) {
  libcrux_ml_kem_polynomial_PolynomialRingElement_1c u_as_ntt[2U];
  deserialize_then_decompress_u_c31(ciphertext, u_as_ntt);
  libcrux_ml_kem_polynomial_PolynomialRingElement_1c v =
      deserialize_then_decompress_ring_element_v_ee0(
          Eurydice_array_to_subslice_from((size_t)768U, ciphertext,
                                          (size_t)640U, uint8_t, size_t,
                                          Eurydice_slice));
  libcrux_ml_kem_polynomial_PolynomialRingElement_1c message =
      compute_message_0a1(&v, secret_key->secret_as_ntt, u_as_ntt);
  uint8_t ret0[32U];
...
- LEN= 32
*/
static KRML_MUSTINLINE void PRF_48_a53(Eurydice_slice input, uint8_t ret[32U]) {
  PRF_b4(input, ret);
}
...
*/
void libcrux_ml_kem_ind_cca_decapsulate_unpacked_001(
    libcrux_ml_kem_ind_cca_unpacked_MlKemKeyPairUnpacked_66 *key_pair,
    libcrux_ml_kem_types_MlKemCiphertext_e8 *ciphertext, uint8_t ret[32U]) {
  uint8_t decrypted[32U];
  decrypt_unpacked_2b1(&key_pair->private_key.ind_cpa_private_key,
  ...
  encrypt_unpacked_021(uu____3, uu____4, pseudorandomness, expected_ciphertext);
  uint8_t selector =
...
*/
static KRML_MUSTINLINE libcrux_ml_kem_polynomial_PolynomialRingElement_1c
deserialize_to_uncompressed_ring_element_f7(Eurydice_slice serialized) {
  libcrux_ml_kem_polynomial_PolynomialRingElement_1c re = ZERO_89_a5();
  for (size_t i = (size_t)0U;
       i <
       core_slice___Slice_T___len(serialized, uint8_t, size_t) / (size_t)24U;
...
- K= 2
*/
static KRML_MUSTINLINE void deserialize_secret_key_4d1(
    Eurydice_slice secret_key,
    libcrux_ml_kem_polynomial_PolynomialRingElement_1c ret[2U]) {
  libcrux_ml_kem_polynomial_PolynomialRingElement_1c secret_as_ntt[2U];
  KRML_MAYBE_FOR2(i, (size_t)0U, (size_t)2U, (size_t)1U,
                  secret_as_ntt[i] = ZERO_89_a5(););
  for (size_t i = (size_t)0U;
    ...
    Eurydice_slice secret_bytes = Eurydice_slice_subslice2(
        ...
        uint8_t, Eurydice_slice);
    libcrux_ml_kem_polynomial_PolynomialRingElement_1c uu____0 =
        deserialize_to_uncompressed_ring_element_f7(secret_bytes);
...
- V_COMPRESSION_FACTOR= 4
*/
static void decrypt_931(Eurydice_slice secret_key, uint8_t *ciphertext,
                        uint8_t ret[32U]) {
  libcrux_ml_kem_polynomial_PolynomialRingElement_1c secret_as_ntt[2U];
  deserialize_secret_key_4d1(secret_key, secret_as_ntt);
  libcrux_ml_kem_polynomial_PolynomialRingElement_1c uu____0[2U];
  memcpy(
  ...
  memcpy(
      ...
      (size_t)2U * sizeof(libcrux_ml_kem_polynomial_PolynomialRingElement_1c));
  uint8_t ret0[32U];
  decrypt_unpacked_2b1(&secret_key_unpacked, ciphertext, ret0);
  memcpy(ret, ret0, (size_t)32U * sizeof(uint8_t));
}
...
- IMPLICIT_REJECTION_HASH_INPUT_SIZE= 800
*/
void libcrux_ml_kem_ind_cca_decapsulate_731(
    libcrux_ml_kem_types_MlKemPrivateKey_5e *private_key,
    libcrux_ml_kem_types_MlKemCiphertext_e8 *ciphertext, uint8_t ret[32U]) {
  Eurydice_slice_uint8_t_x2 uu____0 = core_slice___Slice_T___split_at(
  ...
  uint8_t decrypted[32U];
  decrypt_931(ind_cpa_secret_key, ciphertext->value, decrypted);
  uint8_t to_hash0[64U];
  libcrux_ml_kem_utils_into_padded_array_2d(
      Eurydice_array_to_slice((size_t)32U, decrypted, uint8_t, Eurydice_slice),
      to_hash0);
  ...
  uint8_t expected_ciphertext[768U];
  encrypt_081(uu____5, uu____6, pseudorandomness, expected_ciphertext);
  uint8_t implicit_rejection_shared_secret[32U];
  kdf_af_bf1(
  ...
  kdf_af_bf1(shared_secret0, shared_secret);
  uint8_t ret0[32U];
...
- K= 3
*/
static KRML_MUSTINLINE void deserialize_ring_elements_reduced_502(
    Eurydice_slice public_key,
...
- OUT_LEN= 1152
*/
static KRML_MUSTINLINE void serialize_secret_key_090(
    libcrux_ml_kem_polynomial_PolynomialRingElement_1c *key,
    uint8_t ret[1152U]) {
...
- PUBLIC_KEY_SIZE= 1184
*/
static KRML_MUSTINLINE void serialize_public_key_5d0(
    libcrux_ml_kem_polynomial_PolynomialRingElement_1c *t_as_ntt,
  ...
  uint8_t ret0[1152U];
  serialize_secret_key_090(t_as_ntt, ret0);
  core_slice___Slice_T___copy_from_slice(
      uu____0,
...
- PUBLIC_KEY_SIZE= 1184
*/
bool libcrux_ml_kem_ind_cca_validate_public_key_cb0(uint8_t *public_key) {
  libcrux_ml_kem_polynomial_PolynomialRingElement_1c deserialized_pk[3U];
  deserialize_ring_elements_reduced_502(
      Eurydice_array_to_subslice_to((size_t)1184U, public_key, (size_t)1152U,
                                    uint8_t, size_t, Eurydice_slice),
      deserialized_pk);
  libcrux_ml_kem_polynomial_PolynomialRingElement_1c *uu____0 = deserialized_pk;
  uint8_t public_key_serialized[1184U];
  serialize_public_key_5d0(
      uu____0,
...
- K= 3
*/
static KRML_MUSTINLINE void G_48_400(Eurydice_slice input, uint8_t ret[64U]) {
  libcrux_ml_kem_hash_functions_neon_G(input, ret);
}
...
*/
static KRML_MUSTINLINE Simd128Hash
shake128_init_absorb_e40(uint8_t input[3U][34U]) {
  libcrux_sha3_neon_x2_incremental_KeccakState uu____0 =
      libcrux_sha3_neon_x2_incremental_shake128_init();
  libcrux_sha3_neon_x2_incremental_KeccakState state[2U] = {
      uu____0, libcrux_sha3_neon_x2_incremental_shake128_init()};
...
*/
static KRML_MUSTINLINE Simd128Hash
shake128_init_absorb_48_b10(uint8_t input[3U][34U]) {
  uint8_t uu____0[3U][34U];
  memcpy(uu____0, input, (size_t)3U * sizeof(uint8_t[34U]));
  return shake128_init_absorb_e40(uu____0);
}
...
- K= 3
*/
static KRML_MUSTINLINE void shake128_squeeze_three_blocks_7f0(
...
- K= 3
*/
static KRML_MUSTINLINE void shake128_squeeze_three_blocks_48_590(
    Simd128Hash *self, uint8_t ret[3U][504U]) {
  shake128_squeeze_three_blocks_7f0(self, ret);
}
...
- N= 504
*/
static KRML_MUSTINLINE bool sample_from_uniform_distribution_next_191(
...
- K= 3
*/
static KRML_MUSTINLINE void shake128_squeeze_block_650(Simd128Hash *st,
                                                       uint8_t ret[3U][168U]) {
...
- K= 3
*/
static KRML_MUSTINLINE void shake128_squeeze_block_48_950(
    Simd128Hash *self, uint8_t ret[3U][168U]) {
  shake128_squeeze_block_650(self, ret);
}
...
- N= 168
*/
static KRML_MUSTINLINE bool sample_from_uniform_distribution_next_192(
...
- K= 3
*/
static libcrux_ml_kem_polynomial_PolynomialRingElement_1c closure_6f0(
    int16_t s[272U]) {
  return from_i16_array_89_fd(Eurydice_array_to_subslice2(
      s, (size_t)0U, (size_t)256U, int16_t, Eurydice_slice));
}
...
- K= 3
*/
static KRML_MUSTINLINE void sample_from_xof_510(
  ...
  Simd128Hash xof_state = shake128_init_absorb_48_b10(uu____0);
  uint8_t randomness0[3U][504U];
  shake128_squeeze_three_blocks_48_590(&xof_state, randomness0);
  uint8_t uu____1[3U][504U];
  memcpy(uu____1, randomness0, (size_t)3U * sizeof(uint8_t[504U]));
  bool done = sample_from_uniform_distribution_next_191(
      uu____1, sampled_coefficients, out);
  while (true) {
    if (done) {
      break;
      ...
      shake128_squeeze_block_48_950(&xof_state, randomness);
      uint8_t uu____2[3U][168U];
      memcpy(uu____2, randomness, (size_t)3U * sizeof(uint8_t[168U]));
      done = sample_from_uniform_distribution_next_192(
          uu____2, sampled_coefficients, out);
    }
  }
...
- K= 3
*/
static KRML_MUSTINLINE void sample_matrix_A_320(
    uint8_t seed[34U], bool transpose,
  ...
  KRML_MAYBE_FOR3(
      ...
      sample_from_xof_510(uu____1, sampled);
      for (size_t i = (size_t)0U;
           i < core_slice___Slice_T___len(
                   Eurydice_array_to_slice(
                       (size_t)3U, sampled,
...
- LEN= 128
*/
static KRML_MUSTINLINE void PRFxN_240(uint8_t (*input)[33U],
                                      uint8_t ret[3U][128U]) {
...
- LEN= 128
*/
static KRML_MUSTINLINE void PRFxN_48_190(uint8_t (*input)[33U],
                                         uint8_t ret[3U][128U]) {
  PRFxN_240(input, ret);
}
...
*/
static KRML_MUSTINLINE tuple_b00 sample_vector_cbd_then_ntt_1a0(
    uint8_t prf_input[33U], uint8_t domain_separator) {
  ...
  PRFxN_48_190(prf_inputs, prf_outputs);
  KRML_MAYBE_FOR3(i, (size_t)0U, (size_t)3U, (size_t)1U, size_t i0 = i;
                  re_as_ntt[i0] = sample_from_binomial_distribution_92(
...
- K= 3
*/
static KRML_MUSTINLINE void compute_As_plus_e_280(
...
*/
static tuple_9b0 generate_keypair_unpacked_dd0(
    Eurydice_slice key_generation_seed) {
  uint8_t hashed[64U];
  G_48_400(key_generation_seed, hashed);
  Eurydice_slice_uint8_t_x2 uu____0 = core_slice___Slice_T___split_at(
      Eurydice_array_to_slice((size_t)64U, hashed, uint8_t, Eurydice_slice),
      (size_t)32U, uint8_t, Eurydice_slice_uint8_t_x2);
  Eurydice_slice seed_for_A0 = uu____0.fst;
  ...
  uint8_t ret[34U];
  libcrux_ml_kem_utils_into_padded_array_2d1(seed_for_A0, ret);
  sample_matrix_A_320(ret, true, A_transpose);
  uint8_t prf_input[33U];
  libcrux_ml_kem_utils_into_padded_array_2d2(seed_for_secret_and_error,
                                             prf_input);
  uint8_t uu____1[33U];
  memcpy(uu____1, prf_input, (size_t)33U * sizeof(uint8_t));
  tuple_b00 uu____2 = sample_vector_cbd_then_ntt_1a0(uu____1, 0U);
  ...
  memcpy(
      error_as_ntt,
      sample_vector_cbd_then_ntt_1a0(uu____3, domain_separator).fst,
      (size_t)3U * sizeof(libcrux_ml_kem_polynomial_PolynomialRingElement_1c));
  libcrux_ml_kem_polynomial_PolynomialRingElement_1c t_as_ntt[3U];
  compute_As_plus_e_280(A_transpose, secret_as_ntt, error_as_ntt, t_as_ntt);
  uint8_t seed_for_A[32U];
  core_result_Result_00 dst;
  Eurydice_slice_to_array2(&dst, seed_for_A0, Eurydice_slice, uint8_t[32U],
                           void *);
...
- K= 3
*/
static KRML_MUSTINLINE void H_48_870(Eurydice_slice input, uint8_t ret[32U]) {
  libcrux_ml_kem_hash_functions_neon_H(input, ret);
}
...
libcrux_ml_kem_ind_cca_generate_keypair_unpacked_e80(uint8_t randomness[64U]) {
  Eurydice_slice ind_cpa_keypair_randomness = Eurydice_array_to_subslice2(
      randomness, (size_t)0U,
      LIBCRUX_ML_KEM_CONSTANTS_CPA_PKE_KEY_GENERATION_SEED_SIZE, uint8_t,
      Eurydice_slice);
  Eurydice_slice implicit_rejection_value0 = Eurydice_array_to_subslice_from(
      ...
      LIBCRUX_ML_KEM_CONSTANTS_CPA_PKE_KEY_GENERATION_SEED_SIZE, uint8_t,
      size_t, Eurydice_slice);
  tuple_9b0 uu____0 = generate_keypair_unpacked_dd0(ind_cpa_keypair_randomness);
  ...
  KRML_MAYBE_FOR3(i, (size_t)0U, (size_t)3U, (size_t)1U, closure_5e0(A[i]););
  KRML_MAYBE_FOR3(
  ...
  serialize_public_key_5d0(
      ...
      pk_serialized);
  uint8_t public_key_hash[32U];
  H_48_870(Eurydice_array_to_slice((size_t)1184U, pk_serialized, uint8_t,
                                   Eurydice_slice),
           public_key_hash);
  uint8_t implicit_rejection_value[32U];
  core_result_Result_00 dst;
...
- ETA1_RANDOMNESS_SIZE= 128
*/
static libcrux_ml_kem_utils_extraction_helper_Keypair768 generate_keypair_370(
    Eurydice_slice key_generation_seed) {
  tuple_9b0 uu____0 = generate_keypair_unpacked_dd0(key_generation_seed);
  ...
  uint8_t public_key_serialized[1184U];
  serialize_public_key_5d0(pk.t_as_ntt,
                           Eurydice_array_to_slice((size_t)32U, pk.seed_for_A,
                                                   uint8_t, Eurydice_slice),
                           public_key_serialized);
  uint8_t secret_key_serialized[1152U];
  serialize_secret_key_090(sk.secret_as_ntt, secret_key_serialized);
...
*/
static KRML_MUSTINLINE void serialize_kem_secret_key_9c0(
    Eurydice_slice private_key, Eurydice_slice public_key,
...
libcrux_ml_kem_ind_cca_generate_keypair_070(uint8_t randomness[64U]) {
  Eurydice_slice ind_cpa_keypair_randomness = Eurydice_array_to_subslice2(
      randomness, (size_t)0U,
      LIBCRUX_ML_KEM_CONSTANTS_CPA_PKE_KEY_GENERATION_SEED_SIZE, uint8_t,
      Eurydice_slice);
  ...
  libcrux_ml_kem_utils_extraction_helper_Keypair768 uu____0 =
      generate_keypair_370(ind_cpa_keypair_randomness);
  uint8_t ind_cpa_private_key[1152U];
  memcpy(ind_cpa_private_key, uu____0.fst, (size_t)1152U * sizeof(uint8_t));
  uint8_t public_key[1184U];
  memcpy(public_key, uu____0.snd, (size_t)1184U * sizeof(uint8_t));
  uint8_t secret_key_serialized[2400U];
  serialize_kem_secret_key_9c0(
...
sample_ring_element_cbd_450(uint8_t prf_input[33U], uint8_t domain_separator) {
...
- LEN= 128
*/
static KRML_MUSTINLINE void PRF_48_a52(Eurydice_slice input,
                                       uint8_t ret[128U]) {
  PRF_b40(input, ret);
}
...
- K= 3
*/
static KRML_MUSTINLINE void compute_vector_u_e10(
...
- BLOCK_LEN= 320
*/
static void compress_then_serialize_u_db0(
...
static void encrypt_unpacked_020(
  ...
  uint8_t uu____0[33U];
  memcpy(uu____0, prf_input, (size_t)33U * sizeof(uint8_t));
  tuple_b00 uu____1 = sample_vector_cbd_then_ntt_1a0(uu____0, 0U);
  ...
  uint8_t uu____2[33U];
  memcpy(uu____2, prf_input, (size_t)33U * sizeof(uint8_t));
  tuple_b00 uu____3 = sample_ring_element_cbd_450(uu____2, domain_separator0);
  libcrux_ml_kem_polynomial_PolynomialRingElement_1c error_1[3U];
  memcpy(
      error_1, uu____3.fst,
      (size_t)3U * sizeof(libcrux_ml_kem_polynomial_PolynomialRingElement_1c));
  ...
  compute_vector_u_e10(public_key->A, r_as_ntt, error_1, u);
  uint8_t uu____4[32U];
  memcpy(uu____4, message, (size_t)32U * sizeof(uint8_t));
  libcrux_ml_kem_polynomial_PolynomialRingElement_1c message_as_ring_element =
      deserialize_then_decompress_message_be(uu____4);
  libcrux_ml_kem_polynomial_PolynomialRingElement_1c v =
      compute_ring_element_v_e50(public_key->t_as_ntt, r_as_ntt, &error_2,
                                 &message_as_ring_element);
...
- ETA2_RANDOMNESS_SIZE= 128
*/
tuple_3c libcrux_ml_kem_ind_cca_encapsulate_unpacked_6a0(
  ...
  encrypt_unpacked_020(uu____2, uu____3, pseudorandomness, ciphertext);
  uint8_t shared_secret_array[32U] = {0U};
  core_slice___Slice_T___copy_from_slice(
      Eurydice_array_to_slice((size_t)32U, shared_secret_array, uint8_t,
                              Eurydice_slice),
...
- K= 3
*/
static KRML_MUSTINLINE void entropy_preprocess_af_100(Eurydice_slice randomness,
                                                      uint8_t ret[32U]) {
  uint8_t out[32U] = {0U};
  core_slice___Slice_T___copy_from_slice(
      Eurydice_array_to_slice((size_t)32U, out, uint8_t, Eurydice_slice),
...
- K= 3
*/
static KRML_MUSTINLINE void deserialize_ring_elements_reduced_501(
    Eurydice_slice public_key,
    libcrux_ml_kem_polynomial_PolynomialRingElement_1c ret[3U]) {
  libcrux_ml_kem_polynomial_PolynomialRingElement_1c deserialized_pk[3U];
  KRML_MAYBE_FOR3(i, (size_t)0U, (size_t)3U, (size_t)1U,
...
- ETA2_RANDOMNESS_SIZE= 128
*/
static void encrypt_080(Eurydice_slice public_key, uint8_t message[32U],
                        Eurydice_slice randomness, uint8_t ret[1088U]) {
  libcrux_ml_kem_polynomial_PolynomialRingElement_1c t_as_ntt[3U];
  deserialize_ring_elements_reduced_501(
  ...
  uint8_t ret0[34U];
  libcrux_ml_kem_utils_into_padded_array_2d1(seed, ret0);
  sample_matrix_A_320(ret0, false, A);
  uint8_t seed_for_A[32U];
  core_result_Result_00 dst;
  Eurydice_slice_to_array2(&dst, seed, Eurydice_slice, uint8_t[32U], void *);
  core_result_unwrap_41_83(dst, seed_for_A);
  ...
  memcpy(uu____4, message, (size_t)32U * sizeof(uint8_t));
  uint8_t ret1[1088U];
  encrypt_unpacked_020(uu____3, uu____4, randomness, ret1);
...
- CIPHERTEXT_SIZE= 1088
*/
static KRML_MUSTINLINE void kdf_af_bf0(Eurydice_slice shared_secret,
                                       uint8_t ret[32U]) {
  uint8_t out[32U] = {0U};
  core_slice___Slice_T___copy_from_slice(
      Eurydice_array_to_slice((size_t)32U, out, uint8_t, Eurydice_slice),
...
- ETA2_RANDOMNESS_SIZE= 128
*/
tuple_3c libcrux_ml_kem_ind_cca_encapsulate_de0(
    libcrux_ml_kem_types_MlKemPublicKey_15 *public_key,
    uint8_t randomness[32U]) {
  uint8_t randomness0[32U];
  entropy_preprocess_af_100(
      Eurydice_array_to_slice((size_t)32U, randomness, uint8_t, Eurydice_slice),
      randomness0);
  uint8_t to_hash[64U];
  libcrux_ml_kem_utils_into_padded_array_2d(
  ...
  Eurydice_slice uu____0 = Eurydice_array_to_subslice_from(
      ...
      size_t, Eurydice_slice);
  uint8_t ret[32U];
  H_48_870(Eurydice_array_to_slice(
  ...
  memcpy(uu____3, randomness0, (size_t)32U * sizeof(uint8_t));
  uint8_t ciphertext[1088U];
  encrypt_080(uu____2, uu____3, pseudorandomness, ciphertext);
  uint8_t uu____4[1088U];
  memcpy(uu____4, ciphertext, (size_t)1088U * sizeof(uint8_t));
  libcrux_ml_kem_mlkem768_MlKem768Ciphertext ciphertext0 =
      libcrux_ml_kem_types_from_01_f50(uu____4);
  uint8_t shared_secret_array[32U];
  kdf_af_bf0(shared_secret, shared_secret_array);
...
- U_COMPRESSION_FACTOR= 10
*/
static KRML_MUSTINLINE void deserialize_then_decompress_u_c30(
    uint8_t *ciphertext,
    libcrux_ml_kem_polynomial_PolynomialRingElement_1c ret[3U]) {
...
- V_COMPRESSION_FACTOR= 4
*/
static void decrypt_unpacked_2b0(
    libcrux_ml_kem_ind_cpa_unpacked_IndCpaPrivateKeyUnpacked_fd *secret_key,
    uint8_t *ciphertext, uint8_t ret[32U]) {
  libcrux_ml_kem_polynomial_PolynomialRingElement_1c u_as_ntt[3U];
  deserialize_then_decompress_u_c30(ciphertext, u_as_ntt);
  libcrux_ml_kem_polynomial_PolynomialRingElement_1c v =
      deserialize_then_decompress_ring_element_v_ee0(
          Eurydice_array_to_subslice_from((size_t)1088U, ciphertext,
                                          ...
                                          Eurydice_slice));
  libcrux_ml_kem_polynomial_PolynomialRingElement_1c message =
      compute_message_0a0(&v, secret_key->secret_as_ntt, u_as_ntt);
  uint8_t ret0[32U];
  compress_then_serialize_message_53(message, ret0);
  memcpy(ret, ret0, (size_t)32U * sizeof(uint8_t));
}
...
- LEN= 32
*/
static KRML_MUSTINLINE void PRF_48_a51(Eurydice_slice input, uint8_t ret[32U]) {
  PRF_b4(input, ret);
}
...
*/
void libcrux_ml_kem_ind_cca_decapsulate_unpacked_000(
    libcrux_ml_kem_ind_cca_unpacked_MlKemKeyPairUnpacked_fd *key_pair,
    libcrux_ml_kem_mlkem768_MlKem768Ciphertext *ciphertext, uint8_t ret[32U]) {
  uint8_t decrypted[32U];
  decrypt_unpacked_2b0(&key_pair->private_key.ind_cpa_private_key,
                       ciphertext->value, decrypted);
  uint8_t to_hash0[64U];
  libcrux_ml_kem_utils_into_padded_array_2d(
      Eurydice_array_to_slice((size_t)32U, decrypted, uint8_t, Eurydice_slice),
  ...
  encrypt_unpacked_020(uu____3, uu____4, pseudorandomness, expected_ciphertext);
  uint8_t selector =
      libcrux_ml_kem_constant_time_ops_compare_ciphertexts_in_constant_time(
...
- K= 3
*/
static KRML_MUSTINLINE void deserialize_secret_key_4d0(
    Eurydice_slice secret_key,
    libcrux_ml_kem_polynomial_PolynomialRingElement_1c ret[3U]) {
  libcrux_ml_kem_polynomial_PolynomialRingElement_1c secret_as_ntt[3U];
  KRML_MAYBE_FOR3(i, (size_t)0U, (size_t)3U, (size_t)1U,
...
- V_COMPRESSION_FACTOR= 4
*/
static void decrypt_930(Eurydice_slice secret_key, uint8_t *ciphertext,
                        uint8_t ret[32U]) {
  libcrux_ml_kem_polynomial_PolynomialRingElement_1c secret_as_ntt[3U];
  deserialize_secret_key_4d0(secret_key, secret_as_ntt);
  libcrux_ml_kem_polynomial_PolynomialRingElement_1c uu____0[3U];
  memcpy(
      uu____0, secret_as_ntt,
      (size_t)3U * sizeof(libcrux_ml_kem_polynomial_PolynomialRingElement_1c));
  ...
  memcpy(
      ...
      (size_t)3U * sizeof(libcrux_ml_kem_polynomial_PolynomialRingElement_1c));
  uint8_t ret0[32U];
  decrypt_unpacked_2b0(&secret_key_unpacked, ciphertext, ret0);
  memcpy(ret, ret0, (size_t)32U * sizeof(uint8_t));
}
...
- IMPLICIT_REJECTION_HASH_INPUT_SIZE= 1120
*/
void libcrux_ml_kem_ind_cca_decapsulate_730(
    libcrux_ml_kem_types_MlKemPrivateKey_55 *private_key,
    libcrux_ml_kem_mlkem768_MlKem768Ciphertext *ciphertext, uint8_t ret[32U]) {
  Eurydice_slice_uint8_t_x2 uu____0 = core_slice___Slice_T___split_at(
  ...
  Eurydice_slice implicit_rejection_value = uu____2.snd;
  uint8_t decrypted[32U];
  decrypt_930(ind_cpa_secret_key, ciphertext->value, decrypted);
  uint8_t to_hash0[64U];
  libcrux_ml_kem_utils_into_padded_array_2d(
      Eurydice_array_to_slice((size_t)32U, decrypted, uint8_t, Eurydice_slice),
      to_hash0);
  ...
  memcpy(uu____6, decrypted, (size_t)32U * sizeof(uint8_t));
  uint8_t expected_ciphertext[1088U];
  encrypt_080(uu____5, uu____6, pseudorandomness, expected_ciphertext);
  uint8_t implicit_rejection_shared_secret[32U];
  kdf_af_bf0(
      Eurydice_array_to_slice((size_t)32U, implicit_rejection_shared_secret0,
                              uint8_t, Eurydice_slice),
      implicit_rejection_shared_secret);
  uint8_t shared_secret[32U];
  kdf_af_bf0(shared_secret0, shared_secret);
  uint8_t ret0[32U];
  libcrux_ml_kem_constant_time_ops_compare_ciphertexts_select_shared_secret_in_constant_time(
      libcrux_ml_kem_types_as_ref_00_ed0(ciphertext),
      Eurydice_array_to_slice((size_t)1088U, expected_ciphertext, uint8_t,
...
- K= 4
*/
static KRML_MUSTINLINE void deserialize_ring_elements_reduced_500(
    Eurydice_slice public_key,
...
- OUT_LEN= 1536
*/
static KRML_MUSTINLINE void serialize_secret_key_09(
    libcrux_ml_kem_polynomial_PolynomialRingElement_1c *key,
    uint8_t ret[1536U]) {
...
- PUBLIC_KEY_SIZE= 1568
*/
static KRML_MUSTINLINE void serialize_public_key_5d(
    libcrux_ml_kem_polynomial_PolynomialRingElement_1c *t_as_ntt,
  ...
  uint8_t ret0[1536U];
  serialize_secret_key_09(t_as_ntt, ret0);
  core_slice___Slice_T___copy_from_slice(
      uu____0,
...
- PUBLIC_KEY_SIZE= 1568
*/
bool libcrux_ml_kem_ind_cca_validate_public_key_cb(uint8_t *public_key) {
  libcrux_ml_kem_polynomial_PolynomialRingElement_1c deserialized_pk[4U];
  deserialize_ring_elements_reduced_500(
      Eurydice_array_to_subslice_to((size_t)1568U, public_key, (size_t)1536U,
                                    uint8_t, size_t, Eurydice_slice),
      deserialized_pk);
  libcrux_ml_kem_polynomial_PolynomialRingElement_1c *uu____0 = deserialized_pk;
  uint8_t public_key_serialized[1568U];
  serialize_public_key_5d(
      uu____0,
...
- K= 4
*/
static KRML_MUSTINLINE void G_48_40(Eurydice_slice input, uint8_t ret[64U]) {
  libcrux_ml_kem_hash_functions_neon_G(input, ret);
}
...
*/
static KRML_MUSTINLINE Simd128Hash
shake128_init_absorb_e4(uint8_t input[4U][34U]) {
  libcrux_sha3_neon_x2_incremental_KeccakState uu____0 =
      libcrux_sha3_neon_x2_incremental_shake128_init();
  libcrux_sha3_neon_x2_incremental_KeccakState state[2U] = {
      uu____0, libcrux_sha3_neon_x2_incremental_shake128_init()};
...
*/
static KRML_MUSTINLINE Simd128Hash
shake128_init_absorb_48_b1(uint8_t input[4U][34U]) {
  uint8_t uu____0[4U][34U];
  memcpy(uu____0, input, (size_t)4U * sizeof(uint8_t[34U]));
  return shake128_init_absorb_e4(uu____0);
}
...
- K= 4
*/
static KRML_MUSTINLINE void shake128_squeeze_three_blocks_7f(
...
- K= 4
*/
static KRML_MUSTINLINE void shake128_squeeze_three_blocks_48_59(
    Simd128Hash *self, uint8_t ret[4U][504U]) {
  shake128_squeeze_three_blocks_7f(self, ret);
}
...
- N= 504
*/
static KRML_MUSTINLINE bool sample_from_uniform_distribution_next_19(
...
- K= 4
*/
static KRML_MUSTINLINE void shake128_squeeze_block_65(Simd128Hash *st,
                                                      uint8_t ret[4U][168U]) {
...
- K= 4
*/
static KRML_MUSTINLINE void shake128_squeeze_block_48_95(
    Simd128Hash *self, uint8_t ret[4U][168U]) {
  shake128_squeeze_block_65(self, ret);
}
...
- N= 168
*/
static KRML_MUSTINLINE bool sample_from_uniform_distribution_next_190(
...
- K= 4
*/
static libcrux_ml_kem_polynomial_PolynomialRingElement_1c closure_6f(
    int16_t s[272U]) {
  return from_i16_array_89_fd(Eurydice_array_to_subslice2(
      s, (size_t)0U, (size_t)256U, int16_t, Eurydice_slice));
}
...
- K= 4
*/
static KRML_MUSTINLINE void sample_from_xof_51(
  ...
  Simd128Hash xof_state = shake128_init_absorb_48_b1(uu____0);
  uint8_t randomness0[4U][504U];
  shake128_squeeze_three_blocks_48_59(&xof_state, randomness0);
  uint8_t uu____1[4U][504U];
  memcpy(uu____1, randomness0, (size_t)4U * sizeof(uint8_t[504U]));
  bool done = sample_from_uniform_distribution_next_19(
      uu____1, sampled_coefficients, out);
  while (true) {
    if (done) {
      break;
      ...
      shake128_squeeze_block_48_95(&xof_state, randomness);
      uint8_t uu____2[4U][168U];
      memcpy(uu____2, randomness, (size_t)4U * sizeof(uint8_t[168U]));
      done = sample_from_uniform_distribution_next_190(
          uu____2, sampled_coefficients, out);
    }
  }
...
- K= 4
*/
static KRML_MUSTINLINE void sample_matrix_A_32(
    uint8_t seed[34U], bool transpose,
  ...
  KRML_MAYBE_FOR4(
      ...
      sample_from_xof_51(uu____1, sampled);
      for (size_t i = (size_t)0U;
           i < core_slice___Slice_T___len(
                   Eurydice_array_to_slice(
                       (size_t)4U, sampled,
...
- LEN= 128
*/
static KRML_MUSTINLINE void PRFxN_24(uint8_t (*input)[33U],
                                     uint8_t ret[4U][128U]) {
...
- LEN= 128
*/
static KRML_MUSTINLINE void PRFxN_48_19(uint8_t (*input)[33U],
                                        uint8_t ret[4U][128U]) {
  PRFxN_24(input, ret);
}
...
- ETA_RANDOMNESS_SIZE= 128
*/
static KRML_MUSTINLINE tuple_71 sample_vector_cbd_then_ntt_1a(
    uint8_t prf_input[33U], uint8_t domain_separator) {
  ...
  PRFxN_48_19(prf_inputs, prf_outputs);
  KRML_MAYBE_FOR4(i, (size_t)0U, (size_t)4U, (size_t)1U, size_t i0 = i;
                  re_as_ntt[i0] = sample_from_binomial_distribution_92(
                      Eurydice_array_to_slice((size_t)128U, prf_outputs[i0],
                                              uint8_t, Eurydice_slice));
...
- K= 4
*/
static KRML_MUSTINLINE void compute_As_plus_e_28(
...
- ETA1_RANDOMNESS_SIZE= 128
*/
static tuple_54 generate_keypair_unpacked_dd(
    Eurydice_slice key_generation_seed) {
  uint8_t hashed[64U];
  G_48_40(key_generation_seed, hashed);
  Eurydice_slice_uint8_t_x2 uu____0 = core_slice___Slice_T___split_at(
      Eurydice_array_to_slice((size_t)64U, hashed, uint8_t, Eurydice_slice),
      (size_t)32U, uint8_t, Eurydice_slice_uint8_t_x2);
  Eurydice_slice seed_for_A0 = uu____0.fst;
  ...
  uint8_t ret[34U];
  libcrux_ml_kem_utils_into_padded_array_2d1(seed_for_A0, ret);
  sample_matrix_A_32(ret, true, A_transpose);
  uint8_t prf_input[33U];
  libcrux_ml_kem_utils_into_padded_array_2d2(seed_for_secret_and_error,
                                             prf_input);
  uint8_t uu____1[33U];
  memcpy(uu____1, prf_input, (size_t)33U * sizeof(uint8_t));
  tuple_71 uu____2 = sample_vector_cbd_then_ntt_1a(uu____1, 0U);
  ...
  memcpy(
      error_as_ntt,
      sample_vector_cbd_then_ntt_1a(uu____3, domain_separator).fst,
      (size_t)4U * sizeof(libcrux_ml_kem_polynomial_PolynomialRingElement_1c));
  libcrux_ml_kem_polynomial_PolynomialRingElement_1c t_as_ntt[4U];
  compute_As_plus_e_28(A_transpose, secret_as_ntt, error_as_ntt, t_as_ntt);
  uint8_t seed_for_A[32U];
  core_result_Result_00 dst;
  Eurydice_slice_to_array2(&dst, seed_for_A0, Eurydice_slice, uint8_t[32U],
                           void *);
...
- K= 4
*/
static KRML_MUSTINLINE void H_48_87(Eurydice_slice input, uint8_t ret[32U]) {
  libcrux_ml_kem_hash_functions_neon_H(input, ret);
}
...
libcrux_ml_kem_ind_cca_generate_keypair_unpacked_e8(uint8_t randomness[64U]) {
  Eurydice_slice ind_cpa_keypair_randomness = Eurydice_array_to_subslice2(
      randomness, (size_t)0U,
      LIBCRUX_ML_KEM_CONSTANTS_CPA_PKE_KEY_GENERATION_SEED_SIZE, uint8_t,
      Eurydice_slice);
  Eurydice_slice implicit_rejection_value0 = Eurydice_array_to_subslice_from(
      ...
      LIBCRUX_ML_KEM_CONSTANTS_CPA_PKE_KEY_GENERATION_SEED_SIZE, uint8_t,
      size_t, Eurydice_slice);
  tuple_54 uu____0 = generate_keypair_unpacked_dd(ind_cpa_keypair_randomness);
  ...
  KRML_MAYBE_FOR4(i, (size_t)0U, (size_t)4U, (size_t)1U, closure_5e(A[i]););
  KRML_MAYBE_FOR4(
  ...
  serialize_public_key_5d(
      ...
      pk_serialized);
  uint8_t public_key_hash[32U];
  H_48_87(Eurydice_array_to_slice((size_t)1568U, pk_serialized, uint8_t,
                                  Eurydice_slice),
          public_key_hash);
  uint8_t implicit_rejection_value[32U];
  core_result_Result_00 dst;
...
- ETA1_RANDOMNESS_SIZE= 128
*/
static libcrux_ml_kem_utils_extraction_helper_Keypair1024 generate_keypair_37(
    Eurydice_slice key_generation_seed) {
  tuple_54 uu____0 = generate_keypair_unpacked_dd(key_generation_seed);
  ...
  uint8_t public_key_serialized[1568U];
  serialize_public_key_5d(pk.t_as_ntt,
                          Eurydice_array_to_slice((size_t)32U, pk.seed_for_A,
                                                  uint8_t, Eurydice_slice),
                          public_key_serialized);
  uint8_t secret_key_serialized[1536U];
  serialize_secret_key_09(sk.secret_as_ntt, secret_key_serialized);
...
*/
static KRML_MUSTINLINE void serialize_kem_secret_key_9c(
    Eurydice_slice private_key, Eurydice_slice public_key,
...
libcrux_ml_kem_ind_cca_generate_keypair_07(uint8_t randomness[64U]) {
  Eurydice_slice ind_cpa_keypair_randomness = Eurydice_array_to_subslice2(
      randomness, (size_t)0U,
      LIBCRUX_ML_KEM_CONSTANTS_CPA_PKE_KEY_GENERATION_SEED_SIZE, uint8_t,
      Eurydice_slice);
  ...
  libcrux_ml_kem_utils_extraction_helper_Keypair1024 uu____0 =
      generate_keypair_37(ind_cpa_keypair_randomness);
...
sample_ring_element_cbd_45(uint8_t prf_input[33U], uint8_t domain_separator) {
...
- LEN= 128
*/
static KRML_MUSTINLINE void PRF_48_a50(Eurydice_slice input,
                                       uint8_t ret[128U]) {
  PRF_b40(input, ret);
}
...
- K= 4
*/
static KRML_MUSTINLINE void compute_vector_u_e1(
...
- OUT_LEN= 352
*/
static KRML_MUSTINLINE void compress_then_serialize_11_86(
  ...
  for (size_t i = (size_t)0U;
    ...
    size_t i0 = i;
    libcrux_ml_kem_vector_neon_vector_type_SIMD128Vector coefficient =
        compress_20_8c0(to_unsigned_representative_61(re->coefficients[i0]));
    uint8_t bytes[22U];
...
- OUT_LEN= 352
*/
static KRML_MUSTINLINE void compress_then_serialize_ring_element_u_91(
    libcrux_ml_kem_polynomial_PolynomialRingElement_1c *re, uint8_t ret[352U]) {
  uint8_t uu____0[352U];
  compress_then_serialize_11_86(re, uu____0);
...
- BLOCK_LEN= 352
*/
static void compress_then_serialize_u_db(
  ...
  for (size_t i = (size_t)0U;
    ...
    Eurydice_slice uu____0 = Eurydice_slice_subslice2(
        ...
        Eurydice_slice);
    uint8_t ret[352U];
    compress_then_serialize_ring_element_u_91(&re, ret);
    core_slice___Slice_T___copy_from_slice(
        uu____0,
...
- OUT_LEN= 160
*/
static KRML_MUSTINLINE void compress_then_serialize_ring_element_v_9e(
    libcrux_ml_kem_polynomial_PolynomialRingElement_1c re, Eurydice_slice out) {
  compress_then_serialize_5_48(re, out);
}
...
static void encrypt_unpacked_02(
  ...
  uint8_t uu____0[33U];
  memcpy(uu____0, prf_input, (size_t)33U * sizeof(uint8_t));
  tuple_71 uu____1 = sample_vector_cbd_then_ntt_1a(uu____0, 0U);
  ...
  uint8_t uu____2[33U];
  memcpy(uu____2, prf_input, (size_t)33U * sizeof(uint8_t));
  tuple_71 uu____3 = sample_ring_element_cbd_45(uu____2, domain_separator0);
  libcrux_ml_kem_polynomial_PolynomialRingElement_1c error_1[4U];
  memcpy(
      error_1, uu____3.fst,
      (size_t)4U * sizeof(libcrux_ml_kem_polynomial_PolynomialRingElement_1c));
  ...
  compute_vector_u_e1(public_key->A, r_as_ntt, error_1, u);
  uint8_t uu____4[32U];
  memcpy(uu____4, message, (size_t)32U * sizeof(uint8_t));
  libcrux_ml_kem_polynomial_PolynomialRingElement_1c message_as_ring_element =
      deserialize_then_decompress_message_be(uu____4);
  libcrux_ml_kem_polynomial_PolynomialRingElement_1c v =
      compute_ring_element_v_e5(public_key->t_as_ntt, r_as_ntt, &error_2,
                                &message_as_ring_element);
  ...
  memcpy(
      uu____5, u,
      (size_t)4U * sizeof(libcrux_ml_kem_polynomial_PolynomialRingElement_1c));
  compress_then_serialize_u_db(
      uu____5,
      Eurydice_array_to_subslice2(ciphertext, (size_t)0U, (size_t)1408U,
                                  uint8_t, Eurydice_slice));
  libcrux_ml_kem_polynomial_PolynomialRingElement_1c uu____6 = v;
  compress_then_serialize_ring_element_v_9e(
      uu____6,
...
- ETA2_RANDOMNESS_SIZE= 128
*/
tuple_21 libcrux_ml_kem_ind_cca_encapsulate_unpacked_6a(
  ...
  encrypt_unpacked_02(uu____2, uu____3, pseudorandomness, ciphertext);
  uint8_t shared_secret_array[32U] = {0U};
  core_slice___Slice_T___copy_from_slice(
      Eurydice_array_to_slice((size_t)32U, shared_secret_array, uint8_t,
                              Eurydice_slice),
...
- K= 4
*/
static KRML_MUSTINLINE void entropy_preprocess_af_10(Eurydice_slice randomness,
                                                     uint8_t ret[32U]) {
  uint8_t out[32U] = {0U};
  core_slice___Slice_T___copy_from_slice(
      Eurydice_array_to_slice((size_t)32U, out, uint8_t, Eurydice_slice),
...
- K= 4
*/
static KRML_MUSTINLINE void deserialize_ring_elements_reduced_50(
    Eurydice_slice public_key,
    libcrux_ml_kem_polynomial_PolynomialRingElement_1c ret[4U]) {
  libcrux_ml_kem_polynomial_PolynomialRingElement_1c deserialized_pk[4U];
  KRML_MAYBE_FOR4(i, (size_t)0U, (size_t)4U, (size_t)1U,
...
- ETA2_RANDOMNESS_SIZE= 128
*/
static void encrypt_08(Eurydice_slice public_key, uint8_t message[32U],
                       Eurydice_slice randomness, uint8_t ret[1568U]) {
  libcrux_ml_kem_polynomial_PolynomialRingElement_1c t_as_ntt[4U];
  deserialize_ring_elements_reduced_50(
  ...
  uint8_t ret0[34U];
  libcrux_ml_kem_utils_into_padded_array_2d1(seed, ret0);
  sample_matrix_A_32(ret0, false, A);
  uint8_t seed_for_A[32U];
  core_result_Result_00 dst;
  Eurydice_slice_to_array2(&dst, seed, Eurydice_slice, uint8_t[32U], void *);
  core_result_unwrap_41_83(dst, seed_for_A);
  ...
  memcpy(uu____4, message, (size_t)32U * sizeof(uint8_t));
  uint8_t ret1[1568U];
  encrypt_unpacked_02(uu____3, uu____4, randomness, ret1);
...
- CIPHERTEXT_SIZE= 1568
*/
static KRML_MUSTINLINE void kdf_af_bf(Eurydice_slice shared_secret,
                                      uint8_t ret[32U]) {
  uint8_t out[32U] = {0U};
  core_slice___Slice_T___copy_from_slice(
      Eurydice_array_to_slice((size_t)32U, out, uint8_t, Eurydice_slice),
...
- ETA2_RANDOMNESS_SIZE= 128
*/
tuple_21 libcrux_ml_kem_ind_cca_encapsulate_de(
    libcrux_ml_kem_types_MlKemPublicKey_1f *public_key,
    uint8_t randomness[32U]) {
  uint8_t randomness0[32U];
  entropy_preprocess_af_10(
      Eurydice_array_to_slice((size_t)32U, randomness, uint8_t, Eurydice_slice),
      randomness0);
  uint8_t to_hash[64U];
  libcrux_ml_kem_utils_into_padded_array_2d(
  ...
  Eurydice_slice uu____0 = Eurydice_array_to_subslice_from(
      ...
      size_t, Eurydice_slice);
  uint8_t ret[32U];
  H_48_87(Eurydice_array_to_slice(
  ...
  memcpy(uu____3, randomness0, (size_t)32U * sizeof(uint8_t));
  uint8_t ciphertext[1568U];
  encrypt_08(uu____2, uu____3, pseudorandomness, ciphertext);
  uint8_t uu____4[1568U];
  memcpy(uu____4, ciphertext, (size_t)1568U * sizeof(uint8_t));
  libcrux_ml_kem_mlkem1024_MlKem1024Ciphertext ciphertext0 =
      libcrux_ml_kem_types_from_01_f51(uu____4);
  uint8_t shared_secret_array[32U];
  kdf_af_bf(shared_secret, shared_secret_array);
...
*/
static KRML_MUSTINLINE libcrux_ml_kem_polynomial_PolynomialRingElement_1c
deserialize_then_decompress_ring_element_u_35(Eurydice_slice serialized) {
  return deserialize_then_decompress_11_69(serialized);
}
...
- VECTOR_U_COMPRESSION_FACTOR= 11
*/
static KRML_MUSTINLINE void ntt_vector_u_70(
    libcrux_ml_kem_polynomial_PolynomialRingElement_1c *re) {
  size_t zeta_i = (size_t)0U;
  ntt_at_layer_4_plus_fd(&zeta_i, re, (size_t)7U);
  ntt_at_layer_4_plus_fd(&zeta_i, re, (size_t)6U);
...
- U_COMPRESSION_FACTOR= 11
*/
static KRML_MUSTINLINE void deserialize_then_decompress_u_c3(
    uint8_t *ciphertext,
    libcrux_ml_kem_polynomial_PolynomialRingElement_1c ret[4U]) {
    ...
    Eurydice_slice u_bytes = Eurydice_array_to_subslice2(
        ...
        i0 * (LIBCRUX_ML_KEM_CONSTANTS_COEFFICIENTS_IN_RING_ELEMENT *
            ...
            LIBCRUX_ML_KEM_CONSTANTS_COEFFICIENTS_IN_RING_ELEMENT *
                (size_t)11U / (size_t)8U,
        uint8_t, Eurydice_slice);
    u_as_ntt[i0] = deserialize_then_decompress_ring_element_u_35(u_bytes);
    ntt_vector_u_70(&u_as_ntt[i0]);
  }
  memcpy(
      ret, u_as_ntt,
      (size_t)4U * sizeof(libcrux_ml_kem_polynomial_PolynomialRingElement_1c));
...
*/
static KRML_MUSTINLINE libcrux_ml_kem_polynomial_PolynomialRingElement_1c
deserialize_then_decompress_ring_element_v_ee(Eurydice_slice serialized) {
  return deserialize_then_decompress_5_bd(serialized);
}
...
- V_COMPRESSION_FACTOR= 5
*/
static void decrypt_unpacked_2b(
    libcrux_ml_kem_ind_cpa_unpacked_IndCpaPrivateKeyUnpacked_2c *secret_key,
    uint8_t *ciphertext, uint8_t ret[32U]) {
  libcrux_ml_kem_polynomial_PolynomialRingElement_1c u_as_ntt[4U];
  deserialize_then_decompress_u_c3(ciphertext, u_as_ntt);
  libcrux_ml_kem_polynomial_PolynomialRingElement_1c v =
      deserialize_then_decompress_ring_element_v_ee(
          Eurydice_array_to_subslice_from((size_t)1568U, ciphertext,
                                          (size_t)1408U, uint8_t, size_t,
                                          Eurydice_slice));
  libcrux_ml_kem_polynomial_PolynomialRingElement_1c message =
      compute_message_0a(&v, secret_key->secret_as_ntt, u_as_ntt);
  uint8_t ret0[32U];
  compress_then_serialize_message_53(message, ret0);
  memcpy(ret, ret0, (size_t)32U * sizeof(uint8_t));
}
...
- LEN= 32
*/
static KRML_MUSTINLINE void PRF_48_a5(Eurydice_slice input, uint8_t ret[32U]) {
  PRF_b4(input, ret);
}
...
*/
void libcrux_ml_kem_ind_cca_decapsulate_unpacked_00(
    libcrux_ml_kem_ind_cca_unpacked_MlKemKeyPairUnpacked_2c *key_pair,
    libcrux_ml_kem_mlkem1024_MlKem1024Ciphertext *ciphertext,
    uint8_t ret[32U]) {
  uint8_t decrypted[32U];
  decrypt_unpacked_2b(&key_pair->private_key.ind_cpa_private_key,
                      ciphertext->value, decrypted);
  uint8_t to_hash0[64U];
  libcrux_ml_kem_utils_into_padded_array_2d(
      Eurydice_array_to_slice((size_t)32U, decrypted, uint8_t, Eurydice_slice),
  ...
  encrypt_unpacked_02(uu____3, uu____4, pseudorandomness, expected_ciphertext);
  uint8_t selector =
      libcrux_ml_kem_constant_time_ops_compare_ciphertexts_in_constant_time(
...
- K= 4
*/
static KRML_MUSTINLINE void deserialize_secret_key_4d(
    Eurydice_slice secret_key,
    libcrux_ml_kem_polynomial_PolynomialRingElement_1c ret[4U]) {
  libcrux_ml_kem_polynomial_PolynomialRingElement_1c secret_as_ntt[4U];
  KRML_MAYBE_FOR4(i, (size_t)0U, (size_t)4U, (size_t)1U,
...
- V_COMPRESSION_FACTOR= 5
*/
static void decrypt_93(Eurydice_slice secret_key, uint8_t *ciphertext,
                       uint8_t ret[32U]) {
  libcrux_ml_kem_polynomial_PolynomialRingElement_1c secret_as_ntt[4U];
  deserialize_secret_key_4d(secret_key, secret_as_ntt);
  libcrux_ml_kem_polynomial_PolynomialRingElement_1c uu____0[4U];
  memcpy(
      uu____0, secret_as_ntt,
      (size_t)4U * sizeof(libcrux_ml_kem_polynomial_PolynomialRingElement_1c));
  ...
  memcpy(
      ...
      (size_t)4U * sizeof(libcrux_ml_kem_polynomial_PolynomialRingElement_1c));
  uint8_t ret0[32U];
  decrypt_unpacked_2b(&secret_key_unpacked, ciphertext, ret0);
  memcpy(ret, ret0, (size_t)32U * sizeof(uint8_t));
}
...
- IMPLICIT_REJECTION_HASH_INPUT_SIZE= 1600
*/
void libcrux_ml_kem_ind_cca_decapsulate_73(
    libcrux_ml_kem_types_MlKemPrivateKey_95 *private_key,
    libcrux_ml_kem_mlkem1024_MlKem1024Ciphertext *ciphertext,
    uint8_t ret[32U]) {
  Eurydice_slice_uint8_t_x2 uu____0 = core_slice___Slice_T___split_at(
  ...
  Eurydice_slice implicit_rejection_value = uu____2.snd;
  uint8_t decrypted[32U];
  decrypt_93(ind_cpa_secret_key, ciphertext->value, decrypted);
  uint8_t to_hash0[64U];
  libcrux_ml_kem_utils_into_padded_array_2d(
      Eurydice_array_to_slice((size_t)32U, decrypted, uint8_t, Eurydice_slice),
      to_hash0);
  ...
  memcpy(uu____6, decrypted, (size_t)32U * sizeof(uint8_t));
  uint8_t expected_ciphertext[1568U];
  encrypt_08(uu____5, uu____6, pseudorandomness, expected_ciphertext);
  uint8_t implicit_rejection_shared_secret[32U];
  kdf_af_bf(
      Eurydice_array_to_slice((size_t)32U, implicit_rejection_shared_secret0,
                              uint8_t, Eurydice_slice),
      implicit_rejection_shared_secret);
  uint8_t shared_secret[32U];
  kdf_af_bf(shared_secret0, shared_secret);
  uint8_t ret0[32U];
  libcrux_ml_kem_constant_time_ops_compare_ciphertexts_select_shared_secret_in_constant_time(
      libcrux_ml_kem_types_as_ref_00_ed1(ciphertext),
      Eurydice_array_to_slice((size_t)1568U, expected_ciphertext, uint8_t,
