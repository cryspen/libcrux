...
libcrux_ml_kem_hash_functions_neon_G(Eurydice_slice input)
{
  ...
  libcrux_sha3_neon_sha512(Eurydice_array_to_slice((size_t)64U, &digest, uint8_t), input);
  return digest;
}

KRML_MUSTINLINE Eurydice_arr_60 libcrux_ml_kem_hash_functions_neon_H(Eurydice_slice input)
{
  Eurydice_arr_60 digest = { .data = { 0U } };
  libcrux_sha3_neon_sha256(Eurydice_array_to_slice((size_t)32U, &digest, uint8_t), input);
  return digest;
}
...
libcrux_ml_kem_vector_neon_vector_type_ZERO(void)
{
  return
    (
      KRML_CLITERAL(libcrux_ml_kem_vector_neon_vector_type_SIMD128Vector){
...
libcrux_ml_kem_vector_neon_vector_type_from_i16_array(Eurydice_slice array)
{
  return
    (
      KRML_CLITERAL(libcrux_ml_kem_vector_neon_vector_type_SIMD128Vector){
        .low = _vld1q_s16(Eurydice_slice_subslice3(array, (size_t)0U, (size_t)8U, int16_t *)),
        .high = _vld1q_s16(Eurydice_slice_subslice3(array, (size_t)8U, (size_t)16U, int16_t *))
      }
    );
}
...
)
{
  ...
  _vst1q_s16(Eurydice_array_to_subslice3(&out, (size_t)0U, (size_t)8U, int16_t *), v.low);
  _vst1q_s16(Eurydice_array_to_subslice3(&out, (size_t)8U, (size_t)16U, int16_t *), v.high);
  return out;
}
...
libcrux_ml_kem_vector_neon_vector_type_from_bytes(Eurydice_slice array)
{
  return
    (
      KRML_CLITERAL(libcrux_ml_kem_vector_neon_vector_type_SIMD128Vector){
        .low = _vld1q_bytes(Eurydice_slice_subslice3(array, (size_t)0U, (size_t)16U, uint8_t *)),
        .high = _vld1q_bytes(Eurydice_slice_subslice3(array, (size_t)16U, (size_t)32U, uint8_t *))
      }
    );
}
...
{
  _vst1q_bytes(Eurydice_slice_subslice3(bytes, (size_t)0U, (size_t)16U, uint8_t *), v.low);
  _vst1q_bytes(Eurydice_slice_subslice3(bytes, (size_t)16U, (size_t)32U, uint8_t *), v.high);
}
...
libcrux_ml_kem_vector_neon_arithmetic_barrett_reduce_int16x8_t(int16x8_t v)
{
  ...
  int16x8_t vec = _vqdmulhq_n_s16(v, LIBCRUX_ML_KEM_VECTOR_NEON_ARITHMETIC_BARRETT_MULTIPLIER);
  int16x8_t vec0 = _vaddq_s16(vec, adder);
  int16x8_t quotient = _vshrq_n_s16((int32_t)11, vec0, int16x8_t);
  int16x8_t sub = _vmulq_n_s16(quotient, LIBCRUX_ML_KEM_VECTOR_TRAITS_FIELD_MODULUS);
...
)
{
  ...
  v.high = libcrux_ml_kem_vector_neon_arithmetic_barrett_reduce_int16x8_t(v.high);
  return v;
}
...
)
{
  int16x8_t
  k =
    _vreinterpretq_s16_u16(_vmulq_n_u16(_vreinterpretq_u16_s16(low),
        (uint16_t)LIBCRUX_ML_KEM_VECTOR_TRAITS_INVERSE_OF_MODULUS_MOD_MONTGOMERY_R));
  int16x8_t
  c =
    _vshrq_n_s16((int32_t)1,
...
)
{
  ...
  return libcrux_ml_kem_vector_neon_arithmetic_montgomery_reduce_int16x8_t(v_low, v_high);
}
...
{
  v.low =
    libcrux_ml_kem_vector_neon_arithmetic_montgomery_multiply_by_constant_int16x8_t(v.low,
      c);
  v.high =
    libcrux_ml_kem_vector_neon_arithmetic_montgomery_multiply_by_constant_int16x8_t(v.high,
      c);
  return v;
}
...
{
  return libcrux_ml_kem_vector_neon_arithmetic_montgomery_multiply_by_constant(v, c);
}
...
)
{
  ...
  libcrux_ml_kem_vector_neon_vector_type_SIMD128Vector
  fm =
    libcrux_ml_kem_vector_neon_arithmetic_bitwise_and_with_constant(t,
...
)
{
  ...
  int16x8_t shifted_positive_in_range = _vsubq_s16(shifted_to_positive, quarter);
  v.low =
    _vreinterpretq_s16_u16(_vshrq_n_u16((int32_t)15,
        _vreinterpretq_u16_s16(shifted_positive_in_range),
        uint16x8_t));
  ...
  int16x8_t shifted_positive_in_range0 = _vsubq_s16(shifted_to_positive0, quarter);
  v.high =
    _vreinterpretq_s16_u16(_vshrq_n_u16((int32_t)15,
        _vreinterpretq_u16_s16(shifted_positive_in_range0),
        uint16x8_t));
  return v;
}
...
{
  libcrux_ml_kem_vector_neon_vector_type_SIMD128Vector
  z = libcrux_ml_kem_vector_neon_vector_type_ZERO();
  libcrux_ml_kem_vector_neon_vector_type_SIMD128Vector
  s = libcrux_ml_kem_vector_neon_arithmetic_sub(z, &a);
  return libcrux_ml_kem_vector_neon_arithmetic_bitwise_and_with_constant(s, (int16_t)1665);
}
...
{
  Eurydice_arr_e5 zetas = { .data = { zeta1, zeta1, zeta3, zeta3, zeta2, zeta2, zeta4, zeta4 } };
  int16x8_t zeta = _vld1q_s16(Eurydice_array_to_slice((size_t)8U, &zetas, int16_t));
  int16x8_t
  dup_a =
    _vreinterpretq_s16_s32(_vtrn1q_s32(_vreinterpretq_s32_s16(v.low),
        _vreinterpretq_s32_s16(v.high)));
  int16x8_t
  dup_b =
    _vreinterpretq_s16_s32(_vtrn2q_s32(_vreinterpretq_s32_s16(v.low),
        _vreinterpretq_s32_s16(v.high)));
  int16x8_t t = libcrux_ml_kem_vector_neon_arithmetic_montgomery_multiply_int16x8_t(dup_b, zeta);
  int16x8_t b = _vsubq_s16(dup_a, t);
  int16x8_t a = _vaddq_s16(dup_a, t);
  v.low =
    _vreinterpretq_s16_s32(_vtrn1q_s32(_vreinterpretq_s32_s16(a), _vreinterpretq_s32_s16(b)));
  v.high =
    _vreinterpretq_s16_s32(_vtrn2q_s32(_vreinterpretq_s32_s16(a), _vreinterpretq_s32_s16(b)));
  return v;
}
...
{
  return libcrux_ml_kem_vector_neon_ntt_ntt_layer_1_step(a, zeta1, zeta2, zeta3, zeta4);
}
...
{
  Eurydice_arr_e5 zetas = { .data = { zeta1, zeta1, zeta1, zeta1, zeta2, zeta2, zeta2, zeta2 } };
  int16x8_t zeta = _vld1q_s16(Eurydice_array_to_slice((size_t)8U, &zetas, int16_t));
  int16x8_t
  dup_a =
    _vreinterpretq_s16_s64(_vtrn1q_s64(_vreinterpretq_s64_s16(v.low),
        _vreinterpretq_s64_s16(v.high)));
  int16x8_t
  dup_b =
    _vreinterpretq_s16_s64(_vtrn2q_s64(_vreinterpretq_s64_s16(v.low),
        _vreinterpretq_s64_s16(v.high)));
  int16x8_t t = libcrux_ml_kem_vector_neon_arithmetic_montgomery_multiply_int16x8_t(dup_b, zeta);
  int16x8_t b = _vsubq_s16(dup_a, t);
  int16x8_t a = _vaddq_s16(dup_a, t);
  v.low =
    _vreinterpretq_s16_s64(_vtrn1q_s64(_vreinterpretq_s64_s16(a), _vreinterpretq_s64_s16(b)));
  v.high =
    _vreinterpretq_s16_s64(_vtrn2q_s64(_vreinterpretq_s64_s16(a), _vreinterpretq_s64_s16(b)));
  return v;
}
...
)
{
  ...
  int16x8_t
  t = libcrux_ml_kem_vector_neon_arithmetic_montgomery_multiply_int16x8_t(v.high, zeta0);
...
)
{
  ...
  int16x8_t a1 = libcrux_ml_kem_vector_neon_arithmetic_barrett_reduce_int16x8_t(a);
  int16x8_t
  b = libcrux_ml_kem_vector_neon_arithmetic_montgomery_multiply_int16x8_t(b_minus_a, zeta);
  v.low =
    _vreinterpretq_s16_s32(_vtrn1q_s32(_vreinterpretq_s32_s16(a1), _vreinterpretq_s32_s16(b)));
  v.high =
    _vreinterpretq_s16_s32(_vtrn2q_s32(_vreinterpretq_s32_s16(a1), _vreinterpretq_s32_s16(b)));
  return v;
}
...
{
  return libcrux_ml_kem_vector_neon_ntt_inv_ntt_layer_1_step(a, zeta1, zeta2, zeta3, zeta4);
}
...
)
{
  ...
  v.high = libcrux_ml_kem_vector_neon_arithmetic_montgomery_multiply_int16x8_t(b_minus_a, zeta0);
  return v;
}
...
{
  Eurydice_arr_e5
  zetas = { .data = { zeta1, zeta3, -zeta1, -zeta3, zeta2, zeta4, -zeta2, -zeta4 } };
  int16x8_t zeta = _vld1q_s16(Eurydice_array_to_slice((size_t)8U, &zetas, int16_t));
  ...
  int16x8_t a1b1 = libcrux_ml_kem_vector_neon_arithmetic_montgomery_multiply_int16x8_t(a1, b1);
  int32x4_t a1b1_low = _vmull_s16(_vget_low_s16(a1b1), _vget_low_s16(zeta));
  int32x4_t a1b1_high = _vmull_high_s16(a1b1, zeta);
  int16x8_t
  fst_low = _vreinterpretq_s16_s32(_vmlal_s16(a1b1_low, _vget_low_s16(a0), _vget_low_s16(b0)));
  int16x8_t fst_high = _vreinterpretq_s16_s32(_vmlal_high_s16(a1b1_high, a0, b0));
  int32x4_t a0b1_low = _vmull_s16(_vget_low_s16(a0), _vget_low_s16(b1));
  int32x4_t a0b1_high = _vmull_high_s16(a0, b1);
  int16x8_t
  snd_low = _vreinterpretq_s16_s32(_vmlal_s16(a0b1_low, _vget_low_s16(a1), _vget_low_s16(b0)));
  int16x8_t snd_high = _vreinterpretq_s16_s32(_vmlal_high_s16(a0b1_high, a1, b0));
  ...
  int16x8_t
  fst = libcrux_ml_kem_vector_neon_arithmetic_montgomery_reduce_int16x8_t(fst_low16, fst_high16);
  int16x8_t
  snd = libcrux_ml_kem_vector_neon_arithmetic_montgomery_reduce_int16x8_t(snd_low16, snd_high16);
  ...
  Eurydice_arr_88
  indexes = { .data = { 0U, 1U, 2U, 3U, 8U, 9U, 10U, 11U, 4U, 5U, 6U, 7U, 12U, 13U, 14U, 15U } };
  uint8x16_t index = _vld1q_u8(Eurydice_array_to_slice((size_t)16U, &indexes, uint8_t));
  int16x8_t low2 = _vreinterpretq_s16_u8(_vqtbl1q_u8(_vreinterpretq_u8_s16(low1), index));
  int16x8_t high2 = _vreinterpretq_s16_u8(_vqtbl1q_u8(_vreinterpretq_u8_s16(high1), index));
  return
    (
      KRML_CLITERAL(libcrux_ml_kem_vector_neon_vector_type_SIMD128Vector){
        .low = low2,
...
{
  return libcrux_ml_kem_vector_neon_ntt_ntt_multiply(lhs, rhs, zeta1, zeta2, zeta3, zeta4);
}
...
)
{
  ...
  shifter =
    {
      .data = {
        (int16_t)0, (int16_t)1, (int16_t)2, (int16_t)3, (int16_t)4, (int16_t)5, (int16_t)6,
        (int16_t)7
      }
    };
  int16x8_t shift = _vld1q_s16(Eurydice_array_to_slice((size_t)8U, &shifter, int16_t));
  ...
  return (KRML_CLITERAL(Eurydice_arr_8b){ .data = { (uint8_t)low, (uint8_t)high } });
}
...
libcrux_ml_kem_vector_neon_serialize_deserialize_1(Eurydice_slice a)
{
  ...
  int16x8_t
  low0 = _vdupq_n_s16((int16_t)Eurydice_slice_index(a, (size_t)0U, uint8_t, uint8_t *));
  int16x8_t
  high0 = _vdupq_n_s16((int16_t)Eurydice_slice_index(a, (size_t)1U, uint8_t, uint8_t *));
  Eurydice_arr_e5
  shifter =
    {
      .data = {
...
libcrux_ml_kem_vector_neon_serialize_deserialize_4(Eurydice_slice v)
{
  ...
  Eurydice_arr_e2 input_i16s = libcrux_ml_kem_vector_portable_to_i16_array_b8(input);
  return
    (
      KRML_CLITERAL(libcrux_ml_kem_vector_neon_vector_type_SIMD128Vector){
        .low = _vld1q_s16(Eurydice_array_to_subslice3(&input_i16s,
            (size_t)0U,
            (size_t)8U,
            int16_t *)),
        .high = _vld1q_s16(Eurydice_array_to_subslice3(&input_i16s,
            (size_t)8U,
            (size_t)16U,
            int16_t *))
      }
...
{
  Eurydice_arr_e2 out_i16s = libcrux_ml_kem_vector_neon_vector_type_to_i16_array(v);
  Eurydice_arr_e2
  out =
    libcrux_ml_kem_vector_portable_from_i16_array_b8(Eurydice_array_to_slice((size_t)16U,
        &out_i16s,
        int16_t));
...
libcrux_ml_kem_vector_neon_serialize_deserialize_5(Eurydice_slice v)
{
  ...
  Eurydice_arr_e2 array = libcrux_ml_kem_vector_portable_to_i16_array_b8(output);
  return
    (
      KRML_CLITERAL(libcrux_ml_kem_vector_neon_vector_type_SIMD128Vector){
        .low = _vld1q_s16(Eurydice_array_to_subslice3(&array, (size_t)0U, (size_t)8U, int16_t *)),
        .high = _vld1q_s16(Eurydice_array_to_subslice3(&array, (size_t)8U, (size_t)16U, int16_t *))
      }
    );
}
...
)
{
  ...
  _vst1q_u8(Eurydice_array_to_subslice3(&result32, (size_t)0U, (size_t)16U, uint8_t *),
    _vreinterpretq_u8_s64(low_mix));
  _vst1q_u8(Eurydice_array_to_subslice3(&result32, (size_t)16U, (size_t)32U, uint8_t *),
    _vreinterpretq_u8_s64(high_mix));
  Eurydice_arr_dc result = { .data = { 0U } };
  Eurydice_slice_copy(Eurydice_array_to_subslice3(&result, (size_t)0U, (size_t)5U, uint8_t *),
    Eurydice_array_to_subslice3(&result32, (size_t)0U, (size_t)5U, uint8_t *),
    uint8_t);
  Eurydice_slice_copy(Eurydice_array_to_subslice3(&result, (size_t)5U, (size_t)10U, uint8_t *),
    Eurydice_array_to_subslice3(&result32, (size_t)8U, (size_t)13U, uint8_t *),
    uint8_t);
  Eurydice_slice_copy(Eurydice_array_to_subslice3(&result, (size_t)10U, (size_t)15U, uint8_t *),
    Eurydice_array_to_subslice3(&result32, (size_t)16U, (size_t)21U, uint8_t *),
    uint8_t);
  Eurydice_slice_copy(Eurydice_array_to_subslice3(&result, (size_t)15U, (size_t)20U, uint8_t *),
    Eurydice_array_to_subslice3(&result32, (size_t)24U, (size_t)29U, uint8_t *),
    uint8_t);
  return result;
}
...
)
{
  ...
  Eurydice_slice_copy(Eurydice_array_to_subslice3(&result, (size_t)0U, (size_t)6U, uint8_t *),
    Eurydice_array_to_subslice3(&result32, (size_t)0U, (size_t)6U, uint8_t *),
    uint8_t);
  Eurydice_slice_copy(Eurydice_array_to_subslice3(&result, (size_t)6U, (size_t)12U, uint8_t *),
    Eurydice_array_to_subslice3(&result32, (size_t)8U, (size_t)14U, uint8_t *),
    uint8_t);
  Eurydice_slice_copy(Eurydice_array_to_subslice3(&result, (size_t)12U, (size_t)18U, uint8_t *),
    Eurydice_array_to_subslice3(&result32, (size_t)16U, (size_t)22U, uint8_t *),
    uint8_t);
  Eurydice_slice_copy(Eurydice_array_to_subslice3(&result, (size_t)18U, (size_t)24U, uint8_t *),
    Eurydice_array_to_subslice3(&result32, (size_t)24U, (size_t)30U, uint8_t *),
    uint8_t);
  return result;
}
...
{
  Eurydice_arr_88
  indexes = { .data = { 0U, 1U, 1U, 2U, 3U, 4U, 4U, 5U, 6U, 7U, 7U, 8U, 9U, 10U, 10U, 11U } };
  uint8x16_t index_vec = _vld1q_u8(Eurydice_array_to_slice((size_t)16U, &indexes, uint8_t));
  Eurydice_arr_e5
  shifts =
    {
      .data = {
  ...
  int16x8_t shift_vec = _vld1q_s16(Eurydice_array_to_slice((size_t)8U, &shifts, int16_t));
  uint16x8_t mask12 = _vdupq_n_u16(4095U);
  Eurydice_arr_88 input0 = { .data = { 0U } };
  Eurydice_slice_copy(Eurydice_array_to_subslice3(&input0, (size_t)0U, (size_t)12U, uint8_t *),
    Eurydice_slice_subslice3(v, (size_t)0U, (size_t)12U, uint8_t *),
    uint8_t);
  uint8x16_t input_vec0 = _vld1q_u8(Eurydice_array_to_slice((size_t)16U, &input0, uint8_t));
  Eurydice_arr_88 input1 = { .data = { 0U } };
  Eurydice_slice_copy(Eurydice_array_to_subslice3(&input1, (size_t)0U, (size_t)12U, uint8_t *),
    Eurydice_slice_subslice3(v, (size_t)12U, (size_t)24U, uint8_t *),
    uint8_t);
  uint8x16_t input_vec1 = _vld1q_u8(Eurydice_array_to_slice((size_t)16U, &input1, uint8_t));
...
libcrux_ml_kem_vector_neon_rej_sample(Eurydice_slice a, Eurydice_slice result)
{
  ...
  iter =
    core_iter_traits_collect__core__iter__traits__collect__IntoIterator_Clause1_Item__I__for_I__into_iter(core_slice___Slice_T___chunks(a,
        (size_t)3U,
        uint8_t,
        core_slice_iter_Chunks),
      core_slice_iter_Chunks,
  ...
  while (true)
  {
    ...
    uu____0 =
      core_slice_iter__core__iter__traits__iterator__Iterator___a___Slice_T____for_core__slice__iter__Chunks__a__T__TraitClause_0___next(&iter,
        uint8_t,
        core_option_Option_1b);
...
static Eurydice_arr_f9 ZERO_d6_c5(void)
{
  ...
  memcpy(lit.data,
    repeat_expression,
    (size_t)16U * sizeof (libcrux_ml_kem_vector_neon_vector_type_SIMD128Vector));
  return lit;
}
...
deserialize_to_reduced_ring_element_c5(Eurydice_slice serialized)
{
  ...
  for (size_t i = (size_t)0U; i < Eurydice_slice_len(serialized, uint8_t) / (size_t)24U; i++)
  {
    ...
    Eurydice_slice
    bytes =
      Eurydice_slice_subslice3(serialized,
        i0 * (size_t)24U,
        i0 * (size_t)24U + (size_t)24U,
        uint8_t *);
    libcrux_ml_kem_vector_neon_vector_type_SIMD128Vector
    coefficient = libcrux_ml_kem_vector_neon_deserialize_12_61(bytes);
    libcrux_ml_kem_vector_neon_vector_type_SIMD128Vector
    uu____0 = libcrux_ml_kem_vector_neon_cond_subtract_3329_61(coefficient);
    re.data[i0] = uu____0;
  }
  return re;
}
...
)
{
    ...
    i++)
  {
    ...
    Eurydice_slice
    ring_element =
      Eurydice_slice_subslice3(public_key,
        i0 * LIBCRUX_ML_KEM_CONSTANTS_BYTES_PER_RING_ELEMENT,
        i0 * LIBCRUX_ML_KEM_CONSTANTS_BYTES_PER_RING_ELEMENT +
          LIBCRUX_ML_KEM_CONSTANTS_BYTES_PER_RING_ELEMENT,
        uint8_t *);
    Eurydice_arr_f9 uu____0 = deserialize_to_reduced_ring_element_c5(ring_element);
    deserialized_pk->data[i0] = uu____0;
  }
}

/**
A monomorphic instance of libcrux_ml_kem.hash_functions.neon.shake128_init_absorb_final
with const generics
- K= 2
*/
static KRML_MUSTINLINE Eurydice_arr_54 shake128_init_absorb_final_fd(Eurydice_arr_340 *input)
{
  Eurydice_arr_fe uu____0 = libcrux_sha3_neon_x2_incremental_init();
  Eurydice_arr_54 state = { .data = { uu____0, libcrux_sha3_neon_x2_incremental_init() } };
  libcrux_sha3_neon_x2_incremental_shake128_absorb_final(state.data,
...
/**
This function found in impl {libcrux_ml_kem::hash_functions::Hash<K> for libcrux_ml_kem::hash_functions::neon::Simd128Hash}
*/
/**
A monomorphic instance of libcrux_ml_kem.hash_functions.neon.shake128_init_absorb_final_2d
with const generics
- K= 2
*/
...
/**
A monomorphic instance of libcrux_ml_kem.hash_functions.neon.shake128_squeeze_first_three_blocks
with const generics
- K= 2
*/
...
shake128_squeeze_first_three_blocks_fd(Eurydice_arr_54 *st)
{
  ...
  libcrux_sha3_neon_x2_incremental_shake128_squeeze_first_three_blocks(st->data,
    Eurydice_array_to_slice((size_t)504U, &out0, uint8_t),
...
*/
/**
A monomorphic instance of libcrux_ml_kem.hash_functions.neon.shake128_squeeze_first_three_blocks_2d
with const generics
- K= 2
*/
static KRML_MUSTINLINE Eurydice_arr_45
...
sample_from_uniform_distribution_next_37(
  Eurydice_arr_45 *randomness,
  Eurydice_arr_fb *sampled_coefficients,
  Eurydice_arr_04 *out
)
{
  KRML_MAYBE_FOR2(i0,
    ...
    for (size_t i = (size_t)0U; i < (size_t)504U / (size_t)24U; i++)
    {
      ...
      if (sampled_coefficients->data[i1] < LIBCRUX_ML_KEM_CONSTANTS_COEFFICIENTS_IN_RING_ELEMENT)
      {
        size_t
        sampled =
          libcrux_ml_kem_vector_neon_rej_sample_61(Eurydice_array_to_subslice3(&randomness->data[i1],
              r * (size_t)24U,
              r * (size_t)24U + (size_t)24U,
              uint8_t *),
            Eurydice_array_to_subslice3(&out->data[i1],
...
/**
A monomorphic instance of libcrux_ml_kem.hash_functions.neon.shake128_squeeze_next_block
with const generics
- K= 2
*/
static KRML_MUSTINLINE Eurydice_arr_a9 shake128_squeeze_next_block_fd(Eurydice_arr_54 *st)
{
  ...
  KRML_MAYBE_UNUSED_VAR(out3);
  libcrux_sha3_neon_x2_incremental_shake128_squeeze_next_block(st->data,
...
*/
/**
A monomorphic instance of libcrux_ml_kem.hash_functions.neon.shake128_squeeze_next_block_2d
with const generics
- K= 2
*/
static KRML_MUSTINLINE Eurydice_arr_a9 shake128_squeeze_next_block_2d_fd(Eurydice_arr_54 *self)
{
...
*/
static KRML_MUSTINLINE bool
sample_from_uniform_distribution_next_370(
...
static KRML_MUSTINLINE Eurydice_arr_f9 from_i16_array_c5(Eurydice_slice a)
{
  ...
  for (size_t i = (size_t)0U; i < LIBCRUX_ML_KEM_POLYNOMIAL_VECTORS_IN_RING_ELEMENT; i++)
  {
    size_t i0 = i;
    result.data[i0] =
      libcrux_ml_kem_vector_neon_from_i16_array_61(Eurydice_slice_subslice3(a,
          i0 * (size_t)16U,
...
static Eurydice_arr_f9 call_mut_e7_cd1(Eurydice_arr_a00 tupled_args)
{
  ...
  return
    from_i16_array_d6_c5(Eurydice_array_to_subslice3(&s, (size_t)0U, (size_t)256U, int16_t *));
}
...
- K= 2
*/
static KRML_MUSTINLINE Eurydice_arr_f30 sample_from_xof_cd1(Eurydice_arr_340 *seeds)
{
  ...
  Eurydice_arr_45 randomness0 = shake128_squeeze_first_three_blocks_2d_fd(&xof_state);
  bool
  done = sample_from_uniform_distribution_next_37(&randomness0, &sampled_coefficients, &out);
  while (true)
  {
    if (done)
    {
    ...
    {
      Eurydice_arr_a9 randomness = shake128_squeeze_next_block_2d_fd(&xof_state);
      done = sample_from_uniform_distribution_next_370(&randomness, &sampled_coefficients, &out);
    }
  }
...
*/
static KRML_MUSTINLINE void
sample_matrix_A_cd1(Eurydice_arr_e21 *A_transpose, Eurydice_arr_480 *seed, bool transpose)
{
  KRML_MAYBE_FOR2(i0,
    (size_t)0U,
    (size_t)2U,
    (size_t)1U,
    size_t i1 = i0;
    Eurydice_arr_340 seeds;
    Eurydice_arr_480 repeat_expression[2U];
    KRML_MAYBE_FOR2(i,
      (size_t)0U,
      (size_t)2U,
      (size_t)1U,
      repeat_expression[i] =
        core_array__core__clone__Clone_for__Array_T__N___clone((size_t)34U,
          ...
          uint8_t,
          Eurydice_arr_480););
    memcpy(seeds.data, repeat_expression, (size_t)2U * sizeof (Eurydice_arr_480));
    KRML_MAYBE_FOR2(i,
      (size_t)0U,
      (size_t)2U,
      (size_t)1U,
    ...
    (size_t
      i = (size_t)0U;
      i <
        Eurydice_slice_len(Eurydice_array_to_slice((size_t)2U, &sampled, Eurydice_arr_f9),
          Eurydice_arr_f9);
      i++)
    {
      size_t j = i;
...
)
{
  Eurydice_slice
  uu____0 =
    Eurydice_array_to_subslice_to((size_t)800U,
      public_key,
      (size_t)768U,
      uint8_t,
      size_t,
  ...
  Eurydice_arr_60
  uu____1 =
    libcrux_ml_kem_utils_into_padded_array_9e(Eurydice_array_to_subslice_from((size_t)800U,
        public_key,
        (size_t)768U,
        uint8_t,
        size_t,
  ...
  Eurydice_arr_480
  lvalue =
    libcrux_ml_kem_utils_into_padded_array_b6(Eurydice_array_to_subslice_from((size_t)800U,
        public_key,
        (size_t)768U,
        uint8_t,
        size_t,
  ...
  Eurydice_arr_60
  uu____3 =
    H_2d_fd(Eurydice_array_to_slice((size_t)800U,
        libcrux_ml_kem_types_as_slice_e6_4d(public_key),
        uint8_t));
...
*/
static KRML_MUSTINLINE libcrux_ml_kem_vector_neon_vector_type_SIMD128Vector
to_unsigned_field_modulus_c5(libcrux_ml_kem_vector_neon_vector_type_SIMD128Vector a)
{
...
serialize_uncompressed_ring_element_c5(Eurydice_arr_f9 *re)
{
  ...
  for (size_t i = (size_t)0U; i < LIBCRUX_ML_KEM_POLYNOMIAL_VECTORS_IN_RING_ELEMENT; i++)
  {
    size_t i0 = i;
    libcrux_ml_kem_vector_neon_vector_type_SIMD128Vector
    coefficient = to_unsigned_field_modulus_c5(re->data[i0]);
    Eurydice_arr_6d bytes = libcrux_ml_kem_vector_neon_serialize_12_61(coefficient);
    Eurydice_slice_copy(Eurydice_array_to_subslice3(&serialized,
        (size_t)24U * i0,
        (size_t)24U * i0 + (size_t)24U,
        uint8_t *),
      Eurydice_array_to_slice((size_t)24U, &bytes, uint8_t),
      uint8_t);
  }
  return serialized;
}
...
- K= 2
*/
static KRML_MUSTINLINE void serialize_vector_e3(Eurydice_arr_f30 *key, Eurydice_slice out)
{
  for
  (size_t
    i = (size_t)0U;
    i <
      Eurydice_slice_len(Eurydice_array_to_slice((size_t)2U, key, Eurydice_arr_f9),
        Eurydice_arr_f9);
    i++)
  {
    size_t i0 = i;
    ...
    Eurydice_slice_copy(uu____0, Eurydice_array_to_slice((size_t)384U, &lvalue, uint8_t), uint8_t);
  }
}
...
)
{
  serialize_vector_e3(t_as_ntt,
    Eurydice_array_to_subslice3(serialized,
      (size_t)0U,
      libcrux_ml_kem_constants_ranked_bytes_per_ring_element((size_t)2U),
      uint8_t *));
  Eurydice_slice_copy(Eurydice_array_to_subslice_from((size_t)800U,
      serialized,
      libcrux_ml_kem_constants_ranked_bytes_per_ring_element((size_t)2U),
      uint8_t,
      size_t,
...
{
  serialize_public_key_mut_37(&self->ind_cpa_public_key.t_as_ntt,
    Eurydice_array_to_slice((size_t)32U, &self->ind_cpa_public_key.seed_for_A, uint8_t),
    serialized);
}
...
{
  libcrux_ml_kem_ind_cca_unpacked_serialized_mut_dd_37(&self->public_key, serialized);
}
...
*/
static KRML_MUSTINLINE Eurydice_arr_30
serialized_dd_37(libcrux_ml_kem_ind_cca_unpacked_MlKemPublicKeyUnpacked_7d *self)
{
  return
    libcrux_ml_kem_types_from_fd_4d(serialize_public_key_37(&self->ind_cpa_public_key.t_as_ntt,
        Eurydice_array_to_slice((size_t)32U, &self->ind_cpa_public_key.seed_for_A, uint8_t)));
}
...
)
{
  ...
  libcrux_ml_kem_ind_cca_serialize_kem_secret_key_mut_30(Eurydice_array_to_slice((size_t)768U,
      &ind_cpa_private_key,
      uint8_t),
    Eurydice_array_to_slice((size_t)800U, &ind_cpa_public_key, uint8_t),
    Eurydice_array_to_slice((size_t)32U, &self->private_key.implicit_rejection_value, uint8_t),
    serialized);
}
  ...
  for (size_t i = (size_t)0U; i < Eurydice_slice_len(serialized, uint8_t) / (size_t)24U; i++)
  {
    ...
    bytes =
      Eurydice_slice_subslice3(serialized,
        ...
        uint8_t *);
    libcrux_ml_kem_vector_neon_vector_type_SIMD128Vector
    uu____0 = libcrux_ml_kem_vector_neon_deserialize_12_61(bytes);
    re.data[i0] = uu____0;
  }
  return re;
}
...
*/
static KRML_MUSTINLINE void
deserialize_vector_e3(Eurydice_slice secret_key, Eurydice_arr_f30 *secret_as_ntt)
{
  KRML_MAYBE_FOR2(i,
    (size_t)0U,
    (size_t)2U,
    ...
    Eurydice_arr_f9
    uu____0 =
      deserialize_to_uncompressed_ring_element_c5(Eurydice_slice_subslice3(secret_key,
          i0 * LIBCRUX_ML_KEM_CONSTANTS_BYTES_PER_RING_ELEMENT,
          (i0 + (size_t)1U) * LIBCRUX_ML_KEM_CONSTANTS_BYTES_PER_RING_ELEMENT,
          uint8_t *));
...
/**
A monomorphic instance of libcrux_ml_kem.sampling.sample_from_xof.call_mut_e7
with types libcrux_ml_kem_vector_neon_vector_type_SIMD128Vector, libcrux_ml_kem_hash_functions_portable_PortableHash[[$2size_t]]
with const generics
- K= 2
*/
...
- K= 2
*/
static KRML_MUSTINLINE Eurydice_arr_f30 sample_from_xof_561(Eurydice_arr_340 *seeds)
{
  Eurydice_arr_fb sampled_coefficients = { .data = { 0U } };
  Eurydice_arr_04 out = { .data = { { .data = { 0U } }, { .data = { 0U } } } };
  Eurydice_arr_73
  ...
  Eurydice_arr_45
  randomness0 =
    libcrux_ml_kem_hash_functions_portable_shake128_squeeze_first_three_blocks_4a_fd(&xof_state);
  bool
  done = sample_from_uniform_distribution_next_37(&randomness0, &sampled_coefficients, &out);
  while (true)
  {
    ...
    else
    {
      Eurydice_arr_a9
      randomness =
        libcrux_ml_kem_hash_functions_portable_shake128_squeeze_next_block_4a_fd(&xof_state);
      done = sample_from_uniform_distribution_next_370(&randomness, &sampled_coefficients, &out);
    }
  }
  Eurydice_arr_f30 arr_mapped_str;
...
*/
static KRML_MUSTINLINE void
sample_matrix_A_561(Eurydice_arr_e21 *A_transpose, Eurydice_arr_480 *seed, bool transpose)
{
  KRML_MAYBE_FOR2(i0,
    (size_t)0U,
    (size_t)2U,
...
*/
static KRML_MUSTINLINE void
build_unpacked_public_key_mut_441(
  Eurydice_slice public_key,
  libcrux_ml_kem_ind_cpa_unpacked_IndCpaPublicKeyUnpacked_7d *unpacked_public_key
)
{
  Eurydice_slice
  uu____0 = Eurydice_slice_subslice_to(public_key, (size_t)768U, uint8_t, size_t, uint8_t []);
  deserialize_ring_elements_reduced_e3(uu____0, &unpacked_public_key->t_as_ntt);
  Eurydice_slice
  seed = Eurydice_slice_subslice_from(public_key, (size_t)768U, uint8_t, size_t, uint8_t []);
...
)
{
  ...
  uu____0 =
    libcrux_ml_kem_types_unpack_private_key_0c(Eurydice_array_to_slice((size_t)1632U,
        private_key,
        uint8_t));
  ...
  Eurydice_slice_copy(Eurydice_array_to_slice((size_t)32U,
      ...
      uint8_t),
    Eurydice_slice_subslice_from(ind_cpa_public_key, (size_t)768U, uint8_t, size_t, uint8_t []),
    uint8_t);
}
...
static Eurydice_arr_f30 default_70_e3(void)
{
  ...
  KRML_MAYBE_FOR2(i, (size_t)0U, (size_t)2U, (size_t)1U, repeat_expression[i] = ZERO_d6_c5(););
...
- K= 2
*/
static libcrux_ml_kem_ind_cpa_unpacked_IndCpaPublicKeyUnpacked_7d default_8b_e3(void)
{
  Eurydice_arr_f30 uu____0;
  Eurydice_arr_f9 repeat_expression0[2U];
  KRML_MAYBE_FOR2(i, (size_t)0U, (size_t)2U, (size_t)1U, repeat_expression0[i] = ZERO_d6_c5(););
  memcpy(uu____0.data, repeat_expression0, (size_t)2U * sizeof (Eurydice_arr_f9));
  ...
  memcpy(lit0.A.data, repeat_expression1, (size_t)2U * sizeof (Eurydice_arr_f30));
  return lit0;
}
...
libcrux_ml_kem_ind_cca_unpacked_default_7b_e3(void)
{
  ...
  return
    (
      KRML_CLITERAL(libcrux_ml_kem_mlkem512_neon_unpacked_MlKem512KeyPairUnpacked){
        .private_key = uu____0,
...
- K= 2
*/
static KRML_MUSTINLINE libcrux_sha3_Sha3_512Digest G_2d_fd(Eurydice_slice input)
{
...
cpa_keygen_seed_39_48(Eurydice_slice key_generation_seed)
{
  ...
  Eurydice_slice_copy(Eurydice_array_to_subslice3(&seed,
      (size_t)0U,
...
static KRML_MUSTINLINE Eurydice_arr_a80 PRFxN_49(Eurydice_arr_cf *input)
{
  ...
  KRML_MAYBE_UNUSED_VAR(out3);
  libcrux_sha3_neon_x2_shake256(Eurydice_array_to_slice((size_t)33U, input->data, uint8_t),
...
sample_from_binomial_distribution_2_c5(Eurydice_slice randomness)
{
  ...
  for (size_t i0 = (size_t)0U; i0 < Eurydice_slice_len(randomness, uint8_t) / (size_t)4U; i0++)
  {
    ...
    Eurydice_slice
    byte_chunk =
      Eurydice_slice_subslice3(randomness,
  ...
  return from_i16_array_d6_c5(Eurydice_array_to_slice((size_t)256U, &sampled_i16s, int16_t));
}
...
static KRML_MUSTINLINE void ntt_at_layer_7_c5(Eurydice_arr_f9 *re)
{
  ...
  for (size_t i = (size_t)0U; i < step; i++)
  {
    size_t j = i;
    libcrux_ml_kem_vector_neon_vector_type_SIMD128Vector
    t = libcrux_ml_kem_vector_neon_multiply_by_constant_61(re->data[j + step], (int16_t)-1600);
    re->data[j + step] = libcrux_ml_kem_vector_neon_sub_61(re->data[j], &t);
    libcrux_ml_kem_vector_neon_vector_type_SIMD128Vector
    uu____1 = libcrux_ml_kem_vector_neon_add_61(re->data[j], &t);
    re->data[j] = uu____1;
  }
}
...
{
  libcrux_ml_kem_vector_neon_vector_type_SIMD128Vector
  t = libcrux_ml_kem_vector_neon_montgomery_multiply_by_constant_61(b, zeta_r);
  b = libcrux_ml_kem_vector_neon_sub_61(a, &t);
  a = libcrux_ml_kem_vector_neon_add_61(a, &t);
  return
    (KRML_CLITERAL(libcrux_ml_kem_vector_neon_vector_type_SIMD128Vector_x2){ .fst = a, .snd = b });
}
...
*/
static KRML_MUSTINLINE void
ntt_at_layer_4_plus_c5(size_t *zeta_i, Eurydice_arr_f9 *re, size_t layer)
{
  ...
  for (size_t i0 = (size_t)0U; i0 < (size_t)128U >> (uint32_t)layer; i0++)
  {
    ...
    for (size_t i = offset_vec; i < offset_vec + step_vec; i++)
    {
      ...
      libcrux_ml_kem_vector_neon_vector_type_SIMD128Vector_x2
      uu____0 =
        ntt_layer_int_vec_step_c5(re->data[j],
          re->data[j + step_vec],
...
*/
static KRML_MUSTINLINE void ntt_at_layer_3_c5(size_t *zeta_i, Eurydice_arr_f9 *re)
{
  KRML_MAYBE_FOR16(i,
    (size_t)0U,
    (size_t)16U,
    ...
    libcrux_ml_kem_vector_neon_vector_type_SIMD128Vector
    uu____0 =
      libcrux_ml_kem_vector_neon_ntt_layer_3_step_61(re->data[round],
        libcrux_ml_kem_polynomial_zeta(zeta_i[0U]));
...
*/
static KRML_MUSTINLINE void ntt_at_layer_2_c5(size_t *zeta_i, Eurydice_arr_f9 *re)
{
  KRML_MAYBE_FOR16(i,
    (size_t)0U,
    (size_t)16U,
    ...
    zeta_i[0U] = zeta_i[0U] + (size_t)1U;
    re->data[round] =
      libcrux_ml_kem_vector_neon_ntt_layer_2_step_61(re->data[round],
        libcrux_ml_kem_polynomial_zeta(zeta_i[0U]),
...
*/
static KRML_MUSTINLINE void ntt_at_layer_1_c5(size_t *zeta_i, Eurydice_arr_f9 *re)
{
  KRML_MAYBE_FOR16(i,
    (size_t)0U,
    (size_t)16U,
    ...
    zeta_i[0U] = zeta_i[0U] + (size_t)1U;
    re->data[round] =
      libcrux_ml_kem_vector_neon_ntt_layer_1_step_61(re->data[round],
        libcrux_ml_kem_polynomial_zeta(zeta_i[0U]),
        libcrux_ml_kem_polynomial_zeta(zeta_i[0U] + (size_t)1U),
...
static KRML_MUSTINLINE void poly_barrett_reduce_c5(Eurydice_arr_f9 *myself)
{
  for (size_t i = (size_t)0U; i < LIBCRUX_ML_KEM_POLYNOMIAL_VECTORS_IN_RING_ELEMENT; i++)
  {
    size_t i0 = i;
    libcrux_ml_kem_vector_neon_vector_type_SIMD128Vector
    uu____0 = libcrux_ml_kem_vector_neon_barrett_reduce_61(myself->data[i0]);
...
*/
static KRML_MUSTINLINE void ntt_binomially_sampled_ring_element_c5(Eurydice_arr_f9 *re)
{
...
sample_vector_cbd_then_ntt_1f1(
  Eurydice_arr_f30 *re_as_ntt,
...
)
{
  ...
  KRML_MAYBE_FOR2(i,
    ...
    repeat_expression[i] =
      core_array__core__clone__Clone_for__Array_T__N___clone((size_t)33U,
        ...
        uint8_t,
        Eurydice_arr_3e););
  memcpy(prf_inputs.data, repeat_expression, (size_t)2U * sizeof (Eurydice_arr_3e));
  domain_separator = libcrux_ml_kem_utils_prf_input_inc_fd(&prf_inputs, domain_separator);
  ...
  KRML_MAYBE_FOR2(i,
    ...
    size_t i0 = i;
    re_as_ntt->data[i0] =
      sample_from_binomial_distribution_a5(Eurydice_array_to_slice((size_t)192U,
          &prf_outputs.data[i0],
          uint8_t));
...
*/
static Eurydice_arr_f9 call_mut_73_c21(void **_)
{
  return ZERO_d6_c5();
}
...
*/
static KRML_MUSTINLINE Eurydice_arr_f9
ntt_multiply_c5(Eurydice_arr_f9 *myself, Eurydice_arr_f9 *rhs)
{
  ...
  for (size_t i = (size_t)0U; i < LIBCRUX_ML_KEM_POLYNOMIAL_VECTORS_IN_RING_ELEMENT; i++)
  {
    ...
    libcrux_ml_kem_vector_neon_vector_type_SIMD128Vector
    uu____0 =
      libcrux_ml_kem_vector_neon_ntt_multiply_61(&myself->data[i0],
        &rhs->data[i0],
...
*/
static KRML_MUSTINLINE void
add_to_ring_element_e3(Eurydice_arr_f9 *myself, Eurydice_arr_f9 *rhs)
{
  for
  (size_t
    i = (size_t)0U;
    i <
      Eurydice_slice_len(Eurydice_array_to_slice((size_t)16U,
          myself,
          libcrux_ml_kem_vector_neon_vector_type_SIMD128Vector),
        libcrux_ml_kem_vector_neon_vector_type_SIMD128Vector);
    i++)
  {
    size_t i0 = i;
    libcrux_ml_kem_vector_neon_vector_type_SIMD128Vector
    uu____0 = libcrux_ml_kem_vector_neon_add_61(myself->data[i0], &rhs->data[i0]);
    myself->data[i0] = uu____0;
  }
}
...
*/
static KRML_MUSTINLINE void
add_to_ring_element_d6_e3(Eurydice_arr_f9 *self, Eurydice_arr_f9 *rhs)
{
...
*/
static KRML_MUSTINLINE libcrux_ml_kem_vector_neon_vector_type_SIMD128Vector
to_standard_domain_c5(libcrux_ml_kem_vector_neon_vector_type_SIMD128Vector vector)
{
  return
    libcrux_ml_kem_vector_neon_montgomery_multiply_by_constant_61(vector,
...
*/
static KRML_MUSTINLINE void
add_standard_error_reduce_c5(Eurydice_arr_f9 *myself, Eurydice_arr_f9 *error)
{
  for (size_t i = (size_t)0U; i < LIBCRUX_ML_KEM_POLYNOMIAL_VECTORS_IN_RING_ELEMENT; i++)
  {
    size_t j = i;
    ...
    libcrux_ml_kem_vector_neon_vector_type_SIMD128Vector
    sum = libcrux_ml_kem_vector_neon_add_61(coefficient_normal_form, &error->data[j]);
    libcrux_ml_kem_vector_neon_vector_type_SIMD128Vector
    red = libcrux_ml_kem_vector_neon_barrett_reduce_61(sum);
    myself->data[j] = red;
  }
}
...
*/
static KRML_MUSTINLINE void
add_standard_error_reduce_d6_c5(Eurydice_arr_f9 *self, Eurydice_arr_f9 *error)
{
...
compute_As_plus_e_e3(
  Eurydice_arr_f30 *t_as_ntt,
  Eurydice_arr_e21 *matrix_A,
  Eurydice_arr_f30 *s_as_ntt,
  Eurydice_arr_f30 *error_as_ntt
)
{
  for
  (size_t
    i = (size_t)0U;
    i <
      Eurydice_slice_len(Eurydice_array_to_slice((size_t)2U, matrix_A, Eurydice_arr_f30),
        Eurydice_arr_f30);
    i++)
  {
    size_t i0 = i;
    ...
    (size_t
      i1 = (size_t)0U;
      i1 <
        Eurydice_slice_len(Eurydice_array_to_slice((size_t)2U, row, Eurydice_arr_f9),
          Eurydice_arr_f9);
      i1++)
    {
      size_t j = i1;
      Eurydice_arr_f9 *matrix_element = &row->data[j];
      Eurydice_arr_f9 product = ntt_multiply_d6_c5(matrix_element, &s_as_ntt->data[j]);
      add_to_ring_element_d6_e3(&t_as_ntt->data[i0], &product);
    }
    add_standard_error_reduce_d6_c5(&t_as_ntt->data[i0], &error_as_ntt->data[i0]);
  }
}
...
*/
static KRML_MUSTINLINE void
generate_keypair_unpacked_c21(
  Eurydice_slice key_generation_seed,
  Eurydice_arr_f30 *private_key,
  libcrux_ml_kem_ind_cpa_unpacked_IndCpaPublicKeyUnpacked_7d *public_key
)
{
  libcrux_sha3_Sha3_512Digest hashed = cpa_keygen_seed_39_48(key_generation_seed);
  Eurydice_slice_uint8_t_x2
  uu____0 =
    Eurydice_slice_split_at(Eurydice_array_to_slice((size_t)64U, &hashed, uint8_t),
      (size_t)32U,
      uint8_t,
      Eurydice_slice_uint8_t_x2);
  ...
  /* original Rust expression is not an lvalue in C */
  Eurydice_arr_480 lvalue0 = libcrux_ml_kem_utils_into_padded_array_b6(seed_for_A);
  sample_matrix_A_cd1(uu____1, &lvalue0, true);
  Eurydice_arr_3e
  prf_input = libcrux_ml_kem_utils_into_padded_array_c8(seed_for_secret_and_error);
  uint8_t domain_separator = sample_vector_cbd_then_ntt_1f1(private_key, &prf_input, 0U);
...
- K= 2
*/
static Eurydice_arr_f9 call_mut_b4_e3(void **_)
{
  return ZERO_d6_c5();
}
...
)
{
  ...
  ind_cpa_keypair_randomness =
    Eurydice_array_to_subslice3(&randomness,
      (size_t)0U,
      LIBCRUX_ML_KEM_CONSTANTS_CPA_PKE_KEY_GENERATION_SEED_SIZE,
      uint8_t *);
  Eurydice_slice
  ...
  Eurydice_arr_30
  pk_serialized =
    serialize_public_key_37(&out->public_key.ind_cpa_public_key.t_as_ntt,
      Eurydice_array_to_slice((size_t)32U, &out->public_key.ind_cpa_public_key.seed_for_A, uint8_t));
...
- K= 2
*/
static libcrux_sha3_Sha3_512Digest
encaps_prepare_48(Eurydice_slice randomness, Eurydice_slice pk_hash)
{
  libcrux_sha3_Sha3_512Digest to_hash = libcrux_ml_kem_utils_into_padded_array_24(randomness);
  Eurydice_slice_copy(Eurydice_array_to_subslice_from((size_t)64U,
      &to_hash,
...
with types Eurydice_arr libcrux_ml_kem_polynomial_PolynomialRingElement libcrux_ml_kem_vector_neon_vector_type_SIMD128Vector[[$2size_t]], libcrux_ml_kem_polynomial_PolynomialRingElement libcrux_ml_kem_vector_neon_vector_type_SIMD128Vector
...
*/
static Eurydice_arr_f9 call_mut_f1_d51(void **_)
{
  return ZERO_d6_c5();
}
...
- ETA2_RANDOMNESS_SIZE= 128
*/
static Eurydice_arr_f9 call_mut_dd_d51(void **_)
{
  return ZERO_d6_c5();
}
...
)
{
  ...
  KRML_MAYBE_FOR2(i,
    ...
    Eurydice_arr_f9
    uu____0 =
      sample_from_binomial_distribution_e3(Eurydice_array_to_slice((size_t)128U,
          &prf_outputs.data[i0],
          uint8_t));
...
static KRML_MUSTINLINE Eurydice_arr_d1 PRF_a6(Eurydice_slice input)
{
  ...
  libcrux_sha3_neon_x2_shake256(input,
    input,
    Eurydice_array_to_slice((size_t)128U, &digest, uint8_t),
...
- K= 2
*/
static Eurydice_arr_f9 call_mut_a8_e3(void **_)
{
  return ZERO_d6_c5();
}
...
*/
static KRML_MUSTINLINE void invert_ntt_at_layer_1_c5(size_t *zeta_i, Eurydice_arr_f9 *re)
{
  KRML_MAYBE_FOR16(i,
    (size_t)0U,
    (size_t)16U,
    ...
    zeta_i[0U] = zeta_i[0U] - (size_t)1U;
    re->data[round] =
      libcrux_ml_kem_vector_neon_inv_ntt_layer_1_step_61(re->data[round],
        libcrux_ml_kem_polynomial_zeta(zeta_i[0U]),
        libcrux_ml_kem_polynomial_zeta(zeta_i[0U] - (size_t)1U),
        libcrux_ml_kem_polynomial_zeta(zeta_i[0U] - (size_t)2U),
        libcrux_ml_kem_polynomial_zeta(zeta_i[0U] - (size_t)3U));
...
*/
static KRML_MUSTINLINE void invert_ntt_at_layer_2_c5(size_t *zeta_i, Eurydice_arr_f9 *re)
{
  KRML_MAYBE_FOR16(i,
    (size_t)0U,
    (size_t)16U,
    ...
    zeta_i[0U] = zeta_i[0U] - (size_t)1U;
    re->data[round] =
      libcrux_ml_kem_vector_neon_inv_ntt_layer_2_step_61(re->data[round],
        libcrux_ml_kem_polynomial_zeta(zeta_i[0U]),
        libcrux_ml_kem_polynomial_zeta(zeta_i[0U] - (size_t)1U));
    zeta_i[0U] = zeta_i[0U] - (size_t)1U;);
}
...
*/
static KRML_MUSTINLINE void invert_ntt_at_layer_3_c5(size_t *zeta_i, Eurydice_arr_f9 *re)
{
  KRML_MAYBE_FOR16(i,
    (size_t)0U,
    (size_t)16U,
    ...
    libcrux_ml_kem_vector_neon_vector_type_SIMD128Vector
    uu____0 =
      libcrux_ml_kem_vector_neon_inv_ntt_layer_3_step_61(re->data[round],
        libcrux_ml_kem_polynomial_zeta(zeta_i[0U]));
    re->data[round] = uu____0;);
}
...
{
  libcrux_ml_kem_vector_neon_vector_type_SIMD128Vector
  a_minus_b = libcrux_ml_kem_vector_neon_sub_61(b, &a);
  a = libcrux_ml_kem_vector_neon_barrett_reduce_61(libcrux_ml_kem_vector_neon_add_61(a, &b));
  b = libcrux_ml_kem_vector_neon_montgomery_multiply_by_constant_61(a_minus_b, zeta_r);
  return
    (KRML_CLITERAL(libcrux_ml_kem_vector_neon_vector_type_SIMD128Vector_x2){ .fst = a, .snd = b });
}
...
*/
static KRML_MUSTINLINE void
invert_ntt_at_layer_4_plus_c5(size_t *zeta_i, Eurydice_arr_f9 *re, size_t layer)
{
  size_t step = (size_t)1U << (uint32_t)layer;
  for (size_t i0 = (size_t)0U; i0 < (size_t)128U >> (uint32_t)layer; i0++)
  {
    ...
    for (size_t i = offset_vec; i < offset_vec + step_vec; i++)
    {
      ...
      libcrux_ml_kem_vector_neon_vector_type_SIMD128Vector_x2
      uu____0 =
        inv_ntt_layer_int_vec_step_reduce_c5(re->data[j],
          re->data[j + step_vec],
          libcrux_ml_kem_polynomial_zeta(zeta_i[0U]));
      libcrux_ml_kem_vector_neon_vector_type_SIMD128Vector x = uu____0.fst;
      libcrux_ml_kem_vector_neon_vector_type_SIMD128Vector y = uu____0.snd;
...
*/
static KRML_MUSTINLINE void
add_error_reduce_c5(Eurydice_arr_f9 *myself, Eurydice_arr_f9 *error)
{
  for (size_t i = (size_t)0U; i < LIBCRUX_ML_KEM_POLYNOMIAL_VECTORS_IN_RING_ELEMENT; i++)
  {
    size_t j = i;
    ...
    coefficient_normal_form =
      libcrux_ml_kem_vector_neon_montgomery_multiply_by_constant_61(myself->data[j],
        (int16_t)1441);
    libcrux_ml_kem_vector_neon_vector_type_SIMD128Vector
    sum = libcrux_ml_kem_vector_neon_add_61(coefficient_normal_form, &error->data[j]);
    libcrux_ml_kem_vector_neon_vector_type_SIMD128Vector
...
*/
static KRML_MUSTINLINE void
add_error_reduce_d6_c5(Eurydice_arr_f9 *self, Eurydice_arr_f9 *error)
{
...
)
{
  ...
  (size_t
    i0 = (size_t)0U;
    i0 <
      Eurydice_slice_len(Eurydice_array_to_slice((size_t)2U, a_as_ntt, Eurydice_arr_f30),
        Eurydice_arr_f30);
    i0++)
  {
    size_t i1 = i0;
      ...
      i++)
    {
      ...
      Eurydice_arr_f9 product = ntt_multiply_d6_c5(a_element, &r_as_ntt->data[j]);
...
static KRML_MUSTINLINE uint32x4_t compress_int32x4_t_ef(uint32x4_t v)
{
  ...
  uint32x4_t
  compressed1 =
    _vreinterpretq_u32_s32(_vqdmulhq_n_s32(_vreinterpretq_s32_u32(compressed0), (int32_t)10321340));
...
compress_ef(libcrux_ml_kem_vector_neon_vector_type_SIMD128Vector v)
{
  int16x8_t
  mask =
    _vdupq_n_s16(libcrux_ml_kem_vector_neon_compress_mask_n_least_significant_bits((int16_t)(int32_t)10));
  uint32x4_t mask16 = _vdupq_n_u32(65535U);
  uint32x4_t low00 = _vandq_u32(_vreinterpretq_u32_s16(v.low), mask16);
  uint32x4_t low10 = _vshrq_n_u32((int32_t)16, _vreinterpretq_u32_s16(v.low), uint32x4_t);
  uint32x4_t high00 = _vandq_u32(_vreinterpretq_u32_s16(v.high), mask16);
  uint32x4_t high10 = _vshrq_n_u32((int32_t)16, _vreinterpretq_u32_s16(v.high), uint32x4_t);
  ...
  int16x8_t low = _vtrn1q_s16(_vreinterpretq_s16_u32(low0), _vreinterpretq_s16_u32(low1));
  int16x8_t high = _vtrn1q_s16(_vreinterpretq_s16_u32(high0), _vreinterpretq_s16_u32(high1));
...
compress_61_ef(libcrux_ml_kem_vector_neon_vector_type_SIMD128Vector v)
{
...
- OUT_LEN= 320
*/
static KRML_MUSTINLINE Eurydice_arr_b7 compress_then_serialize_10_3d(Eurydice_arr_f9 *re)
{
  ...
  for (size_t i = (size_t)0U; i < LIBCRUX_ML_KEM_POLYNOMIAL_VECTORS_IN_RING_ELEMENT; i++)
  {
    size_t i0 = i;
    libcrux_ml_kem_vector_neon_vector_type_SIMD128Vector
    coefficient = compress_61_ef(to_unsigned_field_modulus_c5(re->data[i0]));
    Eurydice_arr_dc bytes = libcrux_ml_kem_vector_neon_serialize_10_61(coefficient);
    Eurydice_slice_copy(Eurydice_array_to_subslice3(&serialized,
        (size_t)20U * i0,
        (size_t)20U * i0 + (size_t)20U,
        uint8_t *),
      Eurydice_array_to_slice((size_t)20U, &bytes, uint8_t),
      uint8_t);
  }
  return serialized;
}
...
compress_c4(libcrux_ml_kem_vector_neon_vector_type_SIMD128Vector v)
{
  int16x8_t
  mask =
    _vdupq_n_s16(libcrux_ml_kem_vector_neon_compress_mask_n_least_significant_bits((int16_t)(int32_t)11));
  uint32x4_t mask16 = _vdupq_n_u32(65535U);
  uint32x4_t low00 = _vandq_u32(_vreinterpretq_u32_s16(v.low), mask16);
  uint32x4_t low10 = _vshrq_n_u32((int32_t)16, _vreinterpretq_u32_s16(v.low), uint32x4_t);
  uint32x4_t high00 = _vandq_u32(_vreinterpretq_u32_s16(v.high), mask16);
...
*/
static libcrux_ml_kem_vector_neon_vector_type_SIMD128Vector
compress_61_c4(libcrux_ml_kem_vector_neon_vector_type_SIMD128Vector v)
{
...
*/
static KRML_MUSTINLINE void
compress_then_serialize_u_90(Eurydice_arr_f30 input, Eurydice_slice out)
{
  for
  (size_t
    i = (size_t)0U;
    i <
      Eurydice_slice_len(Eurydice_array_to_slice((size_t)2U, &input, Eurydice_arr_f9),
        Eurydice_arr_f9);
    i++)
  {
    size_t i0 = i;
    ...
    Eurydice_slice_copy(uu____0, Eurydice_array_to_slice((size_t)320U, &lvalue, uint8_t), uint8_t);
  }
}
...
encrypt_c1_d51(Eurydice_slice randomness, Eurydice_arr_e21 *matrix, Eurydice_slice ciphertext)
{
  Eurydice_arr_3e prf_input = libcrux_ml_kem_utils_into_padded_array_c8(randomness);
  ...
  uint8_t domain_separator0 = sample_vector_cbd_then_ntt_1f1(&r_as_ntt, &prf_input, 0U);
  Eurydice_arr_f30 arr_struct;
  KRML_MAYBE_FOR2(i,
    (size_t)0U,
    (size_t)2U,
  ...
  uint8_t
  domain_separator = sample_ring_element_cbd_1f1(&prf_input, domain_separator0, &error_1);
  prf_input.data[32U] = domain_separator;
  Eurydice_arr_d1
  prf_output = PRF_2d_490(Eurydice_array_to_slice((size_t)33U, &prf_input, uint8_t));
  Eurydice_arr_f9
  error_2 =
    sample_from_binomial_distribution_e3(Eurydice_array_to_slice((size_t)128U,
        &prf_output,
...
deserialize_then_decompress_message_c5(Eurydice_arr_60 *serialized)
{
  ...
  KRML_MAYBE_FOR16(i,
    ...
    coefficient_compressed =
      libcrux_ml_kem_vector_neon_deserialize_1_61(Eurydice_array_to_subslice3(serialized,
          (size_t)2U * i0,
          (size_t)2U * i0 + (size_t)2U,
          uint8_t *));
    libcrux_ml_kem_vector_neon_vector_type_SIMD128Vector
    uu____0 = libcrux_ml_kem_vector_neon_decompress_1_61(coefficient_compressed);
    re.data[i0] = uu____0;);
  return re;
}
...
*/
static KRML_MUSTINLINE Eurydice_arr_f9
add_message_error_reduce_c5(
  Eurydice_arr_f9 *myself,
  Eurydice_arr_f9 *message,
  Eurydice_arr_f9 result
)
{
  for (size_t i = (size_t)0U; i < LIBCRUX_ML_KEM_POLYNOMIAL_VECTORS_IN_RING_ELEMENT; i++)
  {
    ...
    libcrux_ml_kem_vector_neon_vector_type_SIMD128Vector
    coefficient_normal_form =
      libcrux_ml_kem_vector_neon_montgomery_multiply_by_constant_61(result.data[i0],
        (int16_t)1441);
    libcrux_ml_kem_vector_neon_vector_type_SIMD128Vector
    sum1 = libcrux_ml_kem_vector_neon_add_61(myself->data[i0], &message->data[i0]);
    libcrux_ml_kem_vector_neon_vector_type_SIMD128Vector
    sum2 = libcrux_ml_kem_vector_neon_add_61(coefficient_normal_form, &sum1);
    libcrux_ml_kem_vector_neon_vector_type_SIMD128Vector
    red = libcrux_ml_kem_vector_neon_barrett_reduce_61(sum2);
    result.data[i0] = red;
  }
  return result;
}
...
*/
static KRML_MUSTINLINE Eurydice_arr_f9
add_message_error_reduce_d6_c5(
  Eurydice_arr_f9 *self,
  Eurydice_arr_f9 *message,
  Eurydice_arr_f9 result
)
{
...
)
{
  ...
  KRML_MAYBE_FOR2(i,
    ...
    (size_t)1U,
    size_t i0 = i;
    Eurydice_arr_f9 product = ntt_multiply_d6_c5(&t_as_ntt->data[i0], &r_as_ntt->data[i0]);
...
compress_d1(libcrux_ml_kem_vector_neon_vector_type_SIMD128Vector v)
{
  int16x8_t
  mask =
    _vdupq_n_s16(libcrux_ml_kem_vector_neon_compress_mask_n_least_significant_bits((int16_t)(int32_t)4));
  uint32x4_t mask16 = _vdupq_n_u32(65535U);
  uint32x4_t low00 = _vandq_u32(_vreinterpretq_u32_s16(v.low), mask16);
  uint32x4_t low10 = _vshrq_n_u32((int32_t)16, _vreinterpretq_u32_s16(v.low), uint32x4_t);
  uint32x4_t high00 = _vandq_u32(_vreinterpretq_u32_s16(v.high), mask16);
...
*/
static libcrux_ml_kem_vector_neon_vector_type_SIMD128Vector
compress_61_d1(libcrux_ml_kem_vector_neon_vector_type_SIMD128Vector v)
{
...
*/
static KRML_MUSTINLINE void
compress_then_serialize_4_c5(Eurydice_arr_f9 re, Eurydice_slice serialized)
{
  for (size_t i = (size_t)0U; i < LIBCRUX_ML_KEM_POLYNOMIAL_VECTORS_IN_RING_ELEMENT; i++)
  {
    size_t i0 = i;
    libcrux_ml_kem_vector_neon_vector_type_SIMD128Vector
    coefficient = compress_61_d1(to_unsigned_field_modulus_c5(re.data[i0]));
    Eurydice_arr_c4 bytes = libcrux_ml_kem_vector_neon_serialize_4_61(coefficient);
    Eurydice_slice_copy(Eurydice_slice_subslice3(serialized,
        (size_t)8U * i0,
        (size_t)8U * i0 + (size_t)8U,
        uint8_t *),
      Eurydice_array_to_slice((size_t)8U, &bytes, uint8_t),
      uint8_t);
  }
}
...
compress_f4(libcrux_ml_kem_vector_neon_vector_type_SIMD128Vector v)
{
  int16x8_t
  mask =
    _vdupq_n_s16(libcrux_ml_kem_vector_neon_compress_mask_n_least_significant_bits((int16_t)(int32_t)5));
  uint32x4_t mask16 = _vdupq_n_u32(65535U);
  uint32x4_t low00 = _vandq_u32(_vreinterpretq_u32_s16(v.low), mask16);
  uint32x4_t low10 = _vshrq_n_u32((int32_t)16, _vreinterpretq_u32_s16(v.low), uint32x4_t);
  uint32x4_t high00 = _vandq_u32(_vreinterpretq_u32_s16(v.high), mask16);
...
*/
static libcrux_ml_kem_vector_neon_vector_type_SIMD128Vector
compress_61_f4(libcrux_ml_kem_vector_neon_vector_type_SIMD128Vector v)
{
...
*/
static KRML_MUSTINLINE void
compress_then_serialize_5_c5(Eurydice_arr_f9 re, Eurydice_slice serialized)
{
  for (size_t i = (size_t)0U; i < LIBCRUX_ML_KEM_POLYNOMIAL_VECTORS_IN_RING_ELEMENT; i++)
  {
    size_t i0 = i;
    libcrux_ml_kem_vector_neon_vector_type_SIMD128Vector
    coefficients =
      compress_61_f4(libcrux_ml_kem_vector_neon_to_unsigned_representative_61(re.data[i0]));
    Eurydice_arr_77 bytes = libcrux_ml_kem_vector_neon_serialize_5_61(coefficients);
    Eurydice_slice_copy(Eurydice_slice_subslice3(serialized,
        (size_t)10U * i0,
        (size_t)10U * i0 + (size_t)10U,
        uint8_t *),
      Eurydice_array_to_slice((size_t)10U, &bytes, uint8_t),
      uint8_t);
  }
}
...
*/
static KRML_MUSTINLINE void
compress_then_serialize_ring_element_v_4c(Eurydice_arr_f9 re, Eurydice_slice out)
{
...
{
  Eurydice_arr_f9 message_as_ring_element = deserialize_then_decompress_message_c5(message);
  Eurydice_arr_f9
...
- ETA2_RANDOMNESS_SIZE= 128
*/
static KRML_MUSTINLINE Eurydice_arr_56
encrypt_unpacked_fa1(
  libcrux_ml_kem_ind_cpa_unpacked_IndCpaPublicKeyUnpacked_7d *public_key,
  Eurydice_arr_60 *message,
...
)
{
  ...
  tuple_710
  uu____0 =
    encrypt_c1_d51(randomness,
      &public_key->A,
      Eurydice_array_to_subslice3(&ciphertext, (size_t)0U, (size_t)640U, uint8_t *));
...
)
{
  ...
  hashed =
    encaps_prepare_48(Eurydice_array_to_slice((size_t)32U, randomness, uint8_t),
  ...
  Eurydice_arr_56
  ciphertext =
    encrypt_unpacked_fa1(&public_key->ind_cpa_public_key,
      randomness,
      pseudorandomness);
  Eurydice_arr_60 shared_secret_array = { .data = { 0U } };
  Eurydice_slice_copy(Eurydice_array_to_slice((size_t)32U, &shared_secret_array, uint8_t),
    shared_secret,
    uint8_t);
  return
    (
...
- U_COMPRESSION_FACTOR= 10
*/
static Eurydice_arr_f9 call_mut_35_4c(void **_)
{
  return ZERO_d6_c5();
}

/**
A monomorphic instance of libcrux_ml_kem.vector.neon.compress.decompress_uint32x4_t
with const generics
- COEFFICIENT_BITS= 10
*/
static KRML_MUSTINLINE uint32x4_t decompress_uint32x4_t_ef(uint32x4_t v)
{
  ...
  uint32x4_t
  decompressed = _vmulq_n_u32(v, (uint32_t)LIBCRUX_ML_KEM_VECTOR_TRAITS_FIELD_MODULUS);
  uint32x4_t decompressed0 = _vaddq_u32(decompressed, coeff);
  return _vshrq_n_u32((int32_t)10, decompressed0, uint32x4_t);
}

/**
A monomorphic instance of libcrux_ml_kem.vector.neon.compress.decompress_ciphertext_coefficient
with const generics
- COEFFICIENT_BITS= 10
*/
static KRML_MUSTINLINE libcrux_ml_kem_vector_neon_vector_type_SIMD128Vector
decompress_ciphertext_coefficient_ef(libcrux_ml_kem_vector_neon_vector_type_SIMD128Vector v)
{
  uint32x4_t mask16 = _vdupq_n_u32(65535U);
  uint32x4_t low00 = _vandq_u32(_vreinterpretq_u32_s16(v.low), mask16);
  uint32x4_t low10 = _vshrq_n_u32((int32_t)16, _vreinterpretq_u32_s16(v.low), uint32x4_t);
...
*/
/**
A monomorphic instance of libcrux_ml_kem.vector.neon.decompress_ciphertext_coefficient_61
with const generics
- COEFFICIENT_BITS= 10
*/
static libcrux_ml_kem_vector_neon_vector_type_SIMD128Vector
decompress_ciphertext_coefficient_61_ef(libcrux_ml_kem_vector_neon_vector_type_SIMD128Vector v)
{
  ...
  for (size_t i = (size_t)0U; i < Eurydice_slice_len(serialized, uint8_t) / (size_t)20U; i++)
  {
    ...
    bytes =
      Eurydice_slice_subslice3(serialized,
        ...
        uint8_t *);
    libcrux_ml_kem_vector_neon_vector_type_SIMD128Vector
    coefficient = libcrux_ml_kem_vector_neon_deserialize_10_61(bytes);
    libcrux_ml_kem_vector_neon_vector_type_SIMD128Vector
    uu____0 = decompress_ciphertext_coefficient_61_ef(coefficient);
    re.data[i0] = uu____0;
  }
  return re;
}
...
*/
static KRML_MUSTINLINE libcrux_ml_kem_vector_neon_vector_type_SIMD128Vector
decompress_ciphertext_coefficient_c4(libcrux_ml_kem_vector_neon_vector_type_SIMD128Vector v)
{
  uint32x4_t mask16 = _vdupq_n_u32(65535U);
  uint32x4_t low00 = _vandq_u32(_vreinterpretq_u32_s16(v.low), mask16);
  uint32x4_t low10 = _vshrq_n_u32((int32_t)16, _vreinterpretq_u32_s16(v.low), uint32x4_t);
...
*/
static libcrux_ml_kem_vector_neon_vector_type_SIMD128Vector
decompress_ciphertext_coefficient_61_c4(libcrux_ml_kem_vector_neon_vector_type_SIMD128Vector v)
{
...
deserialize_then_decompress_11_c5(Eurydice_slice serialized)
{
  ...
  for (size_t i = (size_t)0U; i < Eurydice_slice_len(serialized, uint8_t) / (size_t)22U; i++)
  {
    ...
    bytes =
      Eurydice_slice_subslice3(serialized,
        i0 * (size_t)22U,
        i0 * (size_t)22U + (size_t)22U,
        uint8_t *);
    libcrux_ml_kem_vector_neon_vector_type_SIMD128Vector
    coefficient = libcrux_ml_kem_vector_neon_deserialize_11_61(bytes);
    libcrux_ml_kem_vector_neon_vector_type_SIMD128Vector
    uu____0 = decompress_ciphertext_coefficient_61_c4(coefficient);
    re.data[i0] = uu____0;
  }
  return re;
}
...
deserialize_then_decompress_u_4c(Eurydice_arr_56 *ciphertext)
{
  ...
  (size_t
    i = (size_t)0U;
    i <
      Eurydice_slice_len(Eurydice_array_to_slice((size_t)768U, ciphertext, uint8_t), uint8_t) /
    ...
    i++)
  {
    ...
    Eurydice_slice
    u_bytes =
      Eurydice_array_to_subslice3(ciphertext,
...
*/
static KRML_MUSTINLINE libcrux_ml_kem_vector_neon_vector_type_SIMD128Vector
decompress_ciphertext_coefficient_d1(libcrux_ml_kem_vector_neon_vector_type_SIMD128Vector v)
{
  uint32x4_t mask16 = _vdupq_n_u32(65535U);
  uint32x4_t low00 = _vandq_u32(_vreinterpretq_u32_s16(v.low), mask16);
  uint32x4_t low10 = _vshrq_n_u32((int32_t)16, _vreinterpretq_u32_s16(v.low), uint32x4_t);
...
*/
static libcrux_ml_kem_vector_neon_vector_type_SIMD128Vector
decompress_ciphertext_coefficient_61_d1(libcrux_ml_kem_vector_neon_vector_type_SIMD128Vector v)
{
  ...
  for (size_t i = (size_t)0U; i < Eurydice_slice_len(serialized, uint8_t) / (size_t)8U; i++)
  {
    ...
    bytes =
      Eurydice_slice_subslice3(serialized,
        ...
        uint8_t *);
    libcrux_ml_kem_vector_neon_vector_type_SIMD128Vector
    coefficient = libcrux_ml_kem_vector_neon_deserialize_4_61(bytes);
    libcrux_ml_kem_vector_neon_vector_type_SIMD128Vector
    uu____0 = decompress_ciphertext_coefficient_61_d1(coefficient);
    re.data[i0] = uu____0;
  }
  return re;
}
...
*/
static KRML_MUSTINLINE libcrux_ml_kem_vector_neon_vector_type_SIMD128Vector
decompress_ciphertext_coefficient_f4(libcrux_ml_kem_vector_neon_vector_type_SIMD128Vector v)
{
  uint32x4_t mask16 = _vdupq_n_u32(65535U);
  uint32x4_t low00 = _vandq_u32(_vreinterpretq_u32_s16(v.low), mask16);
  uint32x4_t low10 = _vshrq_n_u32((int32_t)16, _vreinterpretq_u32_s16(v.low), uint32x4_t);
...
*/
static libcrux_ml_kem_vector_neon_vector_type_SIMD128Vector
decompress_ciphertext_coefficient_61_f4(libcrux_ml_kem_vector_neon_vector_type_SIMD128Vector v)
{
...
deserialize_then_decompress_5_c5(Eurydice_slice serialized)
{
  ...
  for (size_t i = (size_t)0U; i < Eurydice_slice_len(serialized, uint8_t) / (size_t)10U; i++)
  {
    ...
    bytes =
      Eurydice_slice_subslice3(serialized,
        i0 * (size_t)10U,
        i0 * (size_t)10U + (size_t)10U,
        uint8_t *);
    re.data[i0] = libcrux_ml_kem_vector_neon_deserialize_5_61(bytes);
    libcrux_ml_kem_vector_neon_vector_type_SIMD128Vector
    uu____1 = decompress_ciphertext_coefficient_61_f4(re.data[i0]);
    re.data[i0] = uu____1;
  }
  return re;
}
...
subtract_reduce_c5(Eurydice_arr_f9 *myself, Eurydice_arr_f9 b)
{
  for (size_t i = (size_t)0U; i < LIBCRUX_ML_KEM_POLYNOMIAL_VECTORS_IN_RING_ELEMENT; i++)
  {
    ...
    libcrux_ml_kem_vector_neon_vector_type_SIMD128Vector
    coefficient_normal_form =
      libcrux_ml_kem_vector_neon_montgomery_multiply_by_constant_61(b.data[i0],
        (int16_t)1441);
    libcrux_ml_kem_vector_neon_vector_type_SIMD128Vector
    diff = libcrux_ml_kem_vector_neon_sub_61(myself->data[i0], &coefficient_normal_form);
    libcrux_ml_kem_vector_neon_vector_type_SIMD128Vector
    red = libcrux_ml_kem_vector_neon_barrett_reduce_61(diff);
    b.data[i0] = red;
  }
  return b;
}
...
compute_message_e3(
  Eurydice_arr_f9 *v,
  Eurydice_arr_f30 *secret_as_ntt,
...
)
{
  ...
  KRML_MAYBE_FOR2(i,
    ...
    (size_t)1U,
    size_t i0 = i;
    Eurydice_arr_f9 product = ntt_multiply_d6_c5(&secret_as_ntt->data[i0], &u_as_ntt->data[i0]);
    add_to_ring_element_d6_e3(&result, &product););
  invert_ntt_montgomery_e3(&result);
...
*/
static KRML_MUSTINLINE Eurydice_arr_60 compress_then_serialize_message_c5(Eurydice_arr_f9 re)
{
  ...
  KRML_MAYBE_FOR16(i,
    ...
    coefficient = to_unsigned_field_modulus_c5(re.data[i0]);
    libcrux_ml_kem_vector_neon_vector_type_SIMD128Vector
    coefficient_compressed = libcrux_ml_kem_vector_neon_compress_1_61(coefficient);
    Eurydice_arr_8b bytes = libcrux_ml_kem_vector_neon_serialize_1_61(coefficient_compressed);
    Eurydice_slice_copy(Eurydice_array_to_subslice3(&serialized,
        (size_t)2U * i0,
        (size_t)2U * i0 + (size_t)2U,
        uint8_t *),
...
decrypt_unpacked_c2(Eurydice_arr_f30 *secret_key, Eurydice_arr_56 *ciphertext)
{
  ...
  Eurydice_arr_f9
  v =
    deserialize_then_decompress_ring_element_v_37(Eurydice_array_to_subslice_from((size_t)768U,
        ciphertext,
        (size_t)640U,
        uint8_t,
        size_t,
...
static KRML_MUSTINLINE Eurydice_arr_60 PRF_9e(Eurydice_slice input)
{
  ...
  libcrux_sha3_neon_x2_shake256(input,
    input,
    Eurydice_array_to_slice((size_t)32U, &digest, uint8_t),
...
{
  Eurydice_arr_60
  decrypted = decrypt_unpacked_c2(&key_pair->private_key.ind_cpa_private_key, ciphertext);
  libcrux_sha3_Sha3_512Digest
  to_hash0 =
    libcrux_ml_kem_utils_into_padded_array_24(Eurydice_array_to_slice((size_t)32U,
        &decrypted,
        uint8_t));
  Eurydice_slice
  uu____0 =
  ...
  Eurydice_slice_copy(uu____0,
    Eurydice_array_to_slice((size_t)32U, &key_pair->public_key.public_key_hash, uint8_t),
    uint8_t);
  libcrux_sha3_Sha3_512Digest
  hashed = G_2d_fd(Eurydice_array_to_slice((size_t)64U, &to_hash0, uint8_t));
  Eurydice_slice_uint8_t_x2
  uu____1 =
    Eurydice_slice_split_at(Eurydice_array_to_slice((size_t)64U, &hashed, uint8_t),
      LIBCRUX_ML_KEM_CONSTANTS_SHARED_SECRET_SIZE,
  ...
  Eurydice_arr_30
  to_hash =
    libcrux_ml_kem_utils_into_padded_array_4d(Eurydice_array_to_slice((size_t)32U,
        &key_pair->private_key.implicit_rejection_value,
        uint8_t));
  Eurydice_slice
  uu____2 =
    Eurydice_array_to_subslice_from((size_t)800U,
      ...
      size_t,
      uint8_t []);
  Eurydice_slice_copy(uu____2, libcrux_ml_kem_types_as_ref_d3_d0(ciphertext), uint8_t);
  Eurydice_arr_60
  implicit_rejection_shared_secret =
    PRF_2d_49(Eurydice_array_to_slice((size_t)800U, &to_hash, uint8_t));
  Eurydice_arr_56
  expected_ciphertext =
    encrypt_unpacked_fa1(&key_pair->public_key.ind_cpa_public_key,
      &decrypted,
      pseudorandomness);
  uint8_t
  selector =
    libcrux_ml_kem_constant_time_ops_compare_ciphertexts_in_constant_time(libcrux_ml_kem_types_as_ref_d3_d0(ciphertext),
...
- K= 2
*/
static Eurydice_arr_f9 call_mut_0b_e3(void **_)
{
  return ZERO_d6_c5();
}
...
bool libcrux_ml_kem_ind_cca_validate_public_key_37(Eurydice_arr_30 *public_key)
{
  Eurydice_arr_f30
  deserialized_pk =
    deserialize_ring_elements_reduced_out_e3(Eurydice_array_to_subslice_to((size_t)800U,
        public_key,
        libcrux_ml_kem_constants_ranked_bytes_per_ring_element((size_t)2U),
        uint8_t,
        size_t,
  ...
  Eurydice_arr_30
  public_key_serialized =
    serialize_public_key_37(uu____0,
      Eurydice_array_to_subslice_from((size_t)800U,
        public_key,
        libcrux_ml_kem_constants_ranked_bytes_per_ring_element((size_t)2U),
        uint8_t,
...
bool libcrux_ml_kem_ind_cca_validate_private_key_only_c1(Eurydice_arr_7f0 *private_key)
{
  Eurydice_arr_60
  t =
    H_2d_fd(Eurydice_array_to_subslice3(private_key,
        (size_t)384U * (size_t)2U,
        (size_t)768U * (size_t)2U + (size_t)32U,
        uint8_t *));
  Eurydice_slice
  expected =
    Eurydice_array_to_subslice3(private_key,
      (size_t)768U * (size_t)2U + (size_t)32U,
...
generate_keypair_cb1(Eurydice_slice key_generation_seed)
{
  ...
  libcrux_ml_kem_ind_cpa_unpacked_IndCpaPublicKeyUnpacked_7d public_key = default_8b_e3();
...
*/
static KRML_MUSTINLINE void
serialize_kem_secret_key_mut_c1(
...
)
{
  ...
  Eurydice_slice_copy(Eurydice_array_to_subslice3(uu____0,
      uu____1,
      uu____2 + Eurydice_slice_len(private_key, uint8_t),
      uint8_t *),
    private_key,
    uint8_t);
  ...
  Eurydice_slice_copy(Eurydice_array_to_subslice3(uu____3,
      uu____4,
      uu____5 + Eurydice_slice_len(public_key, uint8_t),
      uint8_t *),
    public_key,
    uint8_t);
  ...
  Eurydice_slice_copy(uu____6, Eurydice_array_to_slice((size_t)32U, &lvalue, uint8_t), uint8_t);
  pointer = pointer + LIBCRUX_ML_KEM_CONSTANTS_H_DIGEST_SIZE;
  Eurydice_arr_7f0 *uu____7 = serialized;
  size_t uu____8 = pointer;
  size_t uu____9 = pointer;
  Eurydice_slice_copy(Eurydice_array_to_subslice3(uu____7,
      uu____8,
...
- SERIALIZED_KEY_LEN= 1632
*/
static KRML_MUSTINLINE Eurydice_arr_7f0
serialize_kem_secret_key_c1(
  Eurydice_slice private_key,
  Eurydice_slice public_key,
  Eurydice_slice implicit_rejection_value
)
{
  ...
  serialize_kem_secret_key_mut_c1(private_key, public_key, implicit_rejection_value, &out);
  return out;
}
...
libcrux_ml_kem_ind_cca_generate_keypair_581(libcrux_sha3_Sha3_512Digest *randomness)
{
  ...
  implicit_rejection_value =
    Eurydice_array_to_subslice_from((size_t)64U,
      ...
      uint8_t []);
  libcrux_ml_kem_utils_extraction_helper_Keypair512
  uu____0 = generate_keypair_cb1(ind_cpa_keypair_randomness);
  Eurydice_arr_56 ind_cpa_private_key = uu____0.fst;
  Eurydice_arr_30 public_key = uu____0.snd;
  Eurydice_arr_7f0
  secret_key_serialized =
    serialize_kem_secret_key_c1(Eurydice_array_to_slice((size_t)768U,
        &ind_cpa_private_key,
        uint8_t),
      Eurydice_array_to_slice((size_t)800U, &public_key, uint8_t),
      implicit_rejection_value);
  Eurydice_arr_7f0 private_key = libcrux_ml_kem_types_from_77_2a(secret_key_serialized);
  return
    libcrux_ml_kem_types_from_17_fa(private_key,
      libcrux_ml_kem_types_from_fd_4d(public_key));
}
...
- K= 2
*/
static KRML_MUSTINLINE Eurydice_arr_60 entropy_preprocess_39_48(Eurydice_slice randomness)
{
  Eurydice_arr_60 out = { .data = { 0U } };
  Eurydice_slice_copy(Eurydice_array_to_slice((size_t)32U, &out, uint8_t), randomness, uint8_t);
  return out;
}
...
*/
static KRML_MUSTINLINE void
build_unpacked_public_key_mut_4f1(
  Eurydice_slice public_key,
  libcrux_ml_kem_ind_cpa_unpacked_IndCpaPublicKeyUnpacked_7d *unpacked_public_key
)
{
...
- T_AS_NTT_ENCODED_SIZE= 768
*/
static KRML_MUSTINLINE libcrux_ml_kem_ind_cpa_unpacked_IndCpaPublicKeyUnpacked_7d
...
*/
static KRML_MUSTINLINE Eurydice_arr_56
encrypt_fa1(Eurydice_slice public_key, Eurydice_arr_60 *message, Eurydice_slice randomness)
{
  libcrux_ml_kem_ind_cpa_unpacked_IndCpaPublicKeyUnpacked_7d
...
)
{
  Eurydice_arr_60
  randomness0 =
    entropy_preprocess_39_48(Eurydice_array_to_slice((size_t)32U, randomness, uint8_t));
  libcrux_sha3_Sha3_512Digest
  to_hash =
    libcrux_ml_kem_utils_into_padded_array_24(Eurydice_array_to_slice((size_t)32U,
        &randomness0,
  ...
  lvalue =
    H_2d_fd(Eurydice_array_to_slice((size_t)800U,
        libcrux_ml_kem_types_as_slice_e6_4d(public_key),
        uint8_t));
  Eurydice_slice_copy(uu____0, Eurydice_array_to_slice((size_t)32U, &lvalue, uint8_t), uint8_t);
  libcrux_sha3_Sha3_512Digest
  hashed = G_2d_fd(Eurydice_array_to_slice((size_t)64U, &to_hash, uint8_t));
  Eurydice_slice_uint8_t_x2
  uu____1 =
    Eurydice_slice_split_at(Eurydice_array_to_slice((size_t)64U, &hashed, uint8_t),
      LIBCRUX_ML_KEM_CONSTANTS_SHARED_SECRET_SIZE,
  ...
  Eurydice_arr_56
  ciphertext =
    encrypt_fa1(Eurydice_array_to_slice((size_t)800U,
        libcrux_ml_kem_types_as_slice_e6_4d(public_key),
        uint8_t),
      &randomness0,
      pseudorandomness);
  Eurydice_arr_56 uu____2 = libcrux_ml_kem_types_from_e0_d0(ciphertext);
  return (KRML_CLITERAL(tuple_17){ .fst = uu____2, .snd = kdf_39_c1(shared_secret) });
}
...
- V_COMPRESSION_FACTOR= 4
*/
static Eurydice_arr_f9 call_mut_0b_c2(void **_)
{
  return ZERO_d6_c5();
}
...
*/
static KRML_MUSTINLINE Eurydice_arr_60
decrypt_c2(Eurydice_slice secret_key, Eurydice_arr_56 *ciphertext)
{
  Eurydice_arr_f30 arr_struct;
  KRML_MAYBE_FOR2(i,
    (size_t)0U,
...
)
{
  ...
  Eurydice_slice pseudorandomness = uu____1.snd;
  Eurydice_arr_30 to_hash = libcrux_ml_kem_utils_into_padded_array_4d(implicit_rejection_value);
  Eurydice_slice
  uu____2 =
    Eurydice_array_to_subslice_from((size_t)800U,
      &to_hash,
  ...
  implicit_rejection_shared_secret0 =
    PRF_2d_49(Eurydice_array_to_slice((size_t)800U, &to_hash, uint8_t));
  Eurydice_arr_56
  expected_ciphertext = encrypt_fa1(ind_cpa_public_key, &decrypted, pseudorandomness);
  Eurydice_arr_60
  implicit_rejection_shared_secret =
    kdf_39_c1(Eurydice_array_to_slice((size_t)32U, &implicit_rejection_shared_secret0, uint8_t));
  Eurydice_arr_60 shared_secret = kdf_39_c1(shared_secret0);
  return
    libcrux_ml_kem_constant_time_ops_compare_ciphertexts_select_shared_secret_in_constant_time(libcrux_ml_kem_types_as_ref_d3_d0(ciphertext),
      Eurydice_array_to_slice((size_t)768U, &expected_ciphertext, uint8_t),
...
- K= 3
*/
static KRML_MUSTINLINE Eurydice_arr_54 shake128_init_absorb_final_e0(Eurydice_arr_84 *input)
{
  Eurydice_arr_fe uu____0 = libcrux_sha3_neon_x2_incremental_init();
  Eurydice_arr_54 state = { .data = { uu____0, libcrux_sha3_neon_x2_incremental_init() } };
  libcrux_sha3_neon_x2_incremental_shake128_absorb_final(state.data,
    Eurydice_array_to_slice((size_t)34U, input->data, uint8_t),
    Eurydice_array_to_slice((size_t)34U, &input->data[1U], uint8_t));
  libcrux_sha3_neon_x2_incremental_shake128_absorb_final(&state.data[1U],
...
- K= 3
*/
static KRML_MUSTINLINE Eurydice_arr_54 shake128_init_absorb_final_2d_e0(Eurydice_arr_84 *input)
{
...
shake128_squeeze_first_three_blocks_e0(Eurydice_arr_54 *st)
{
  ...
  libcrux_sha3_neon_x2_incremental_shake128_squeeze_first_three_blocks(st->data,
    Eurydice_array_to_slice((size_t)504U, &out0, uint8_t),
    Eurydice_array_to_slice((size_t)504U, &out1, uint8_t));
  libcrux_sha3_neon_x2_incremental_shake128_squeeze_first_three_blocks(&st->data[1U],
...
*/
static KRML_MUSTINLINE bool
sample_from_uniform_distribution_next_21(
...
- K= 3
*/
static KRML_MUSTINLINE Eurydice_arr_d6 shake128_squeeze_next_block_e0(Eurydice_arr_54 *st)
{
  Eurydice_arr_d6
  out = { .data = { { .data = { 0U } }, { .data = { 0U } }, { .data = { 0U } } } };
  Eurydice_arr_27 out0 = { .data = { 0U } };
  ...
  libcrux_sha3_neon_x2_incremental_shake128_squeeze_next_block(st->data,
    Eurydice_array_to_slice((size_t)168U, &out0, uint8_t),
    Eurydice_array_to_slice((size_t)168U, &out1, uint8_t));
  libcrux_sha3_neon_x2_incremental_shake128_squeeze_next_block(&st->data[1U],
...
- K= 3
*/
static KRML_MUSTINLINE Eurydice_arr_d6 shake128_squeeze_next_block_2d_e0(Eurydice_arr_54 *self)
{
...
*/
static KRML_MUSTINLINE bool
sample_from_uniform_distribution_next_210(
...
- K= 3
*/
static KRML_MUSTINLINE Eurydice_arr_fe0 sample_from_xof_cd0(Eurydice_arr_84 *seeds)
{
  Eurydice_arr_c8 sampled_coefficients = { .data = { 0U } };
  Eurydice_arr_d4
  out = { .data = { { .data = { 0U } }, { .data = { 0U } }, { .data = { 0U } } } };
  Eurydice_arr_54 xof_state = shake128_init_absorb_final_2d_e0(seeds);
  Eurydice_arr_35 randomness0 = shake128_squeeze_first_three_blocks_2d_e0(&xof_state);
  bool
  done = sample_from_uniform_distribution_next_21(&randomness0, &sampled_coefficients, &out);
  while (true)
  {
    if (done)
    {
    ...
    {
      Eurydice_arr_d6 randomness = shake128_squeeze_next_block_2d_e0(&xof_state);
      done = sample_from_uniform_distribution_next_210(&randomness, &sampled_coefficients, &out);
    }
  }
...
*/
static KRML_MUSTINLINE void
sample_matrix_A_cd0(Eurydice_arr_aa0 *A_transpose, Eurydice_arr_480 *seed, bool transpose)
{
  KRML_MAYBE_FOR3(i0,
    (size_t)0U,
    (size_t)3U,
    ...
    Eurydice_arr_480 repeat_expression[3U];
    KRML_MAYBE_FOR3(i,
      (size_t)0U,
      (size_t)3U,
      (size_t)1U,
      repeat_expression[i] =
        core_array__core__clone__Clone_for__Array_T__N___clone((size_t)34U,
          ...
          uint8_t,
          Eurydice_arr_480););
    memcpy(seeds.data, repeat_expression, (size_t)3U * sizeof (Eurydice_arr_480));
    KRML_MAYBE_FOR3(i,
      (size_t)0U,
      (size_t)3U,
      (size_t)1U,
    ...
    (size_t
      i = (size_t)0U;
      i <
        Eurydice_slice_len(Eurydice_array_to_slice((size_t)3U, &sampled, Eurydice_arr_f9),
          Eurydice_arr_f9);
      i++)
    {
      size_t j = i;
...
)
{
  ...
  uu____0 =
    Eurydice_array_to_subslice_to((size_t)1184U,
      ...
      size_t,
      uint8_t []);
  deserialize_ring_elements_reduced_a5(uu____0,
    &unpacked_public_key->ind_cpa_public_key.t_as_ntt);
  Eurydice_arr_60
  uu____1 =
    libcrux_ml_kem_utils_into_padded_array_9e(Eurydice_array_to_subslice_from((size_t)1184U,
        public_key,
        (size_t)1152U,
        uint8_t,
        size_t,
  ...
  Eurydice_arr_480
  lvalue =
    libcrux_ml_kem_utils_into_padded_array_b6(Eurydice_array_to_subslice_from((size_t)1184U,
        public_key,
        (size_t)1152U,
        uint8_t,
        size_t,
  ...
  Eurydice_arr_60
  uu____3 =
    H_2d_e0(Eurydice_array_to_slice((size_t)1184U,
  ...
  return
    (
      KRML_CLITERAL(libcrux_ml_kem_ind_cpa_unpacked_IndCpaPublicKeyUnpacked_ec){
        .t_as_ntt = uu____0,
        .seed_for_A = uu____1,
        .A = core_array__core__clone__Clone_for__Array_T__N___clone((size_t)3U,
          &self->A,
          Eurydice_arr_fe0,
          Eurydice_arr_aa0)
      }
...
)
{
  ...
  uu____0 = clone_91_a5(&self->ind_cpa_public_key);
  return
    (
      KRML_CLITERAL(libcrux_ml_kem_ind_cca_unpacked_MlKemPublicKeyUnpacked_ec){
        .ind_cpa_public_key = uu____0,
        .public_key_hash = core_array__core__clone__Clone_for__Array_T__N___clone((size_t)32U,
...
- K= 3
*/
static KRML_MUSTINLINE void serialize_vector_a5(Eurydice_arr_fe0 *key, Eurydice_slice out)
{
  for
  (size_t
    i = (size_t)0U;
    i <
      Eurydice_slice_len(Eurydice_array_to_slice((size_t)3U, key, Eurydice_arr_f9),
        Eurydice_arr_f9);
    i++)
  {
    size_t i0 = i;
...
{
  serialize_vector_a5(t_as_ntt,
    Eurydice_array_to_subslice3(serialized,
      (size_t)0U,
      libcrux_ml_kem_constants_ranked_bytes_per_ring_element((size_t)3U),
      uint8_t *));
  Eurydice_slice_copy(Eurydice_array_to_subslice_from((size_t)1184U,
      serialized,
      libcrux_ml_kem_constants_ranked_bytes_per_ring_element((size_t)3U),
      uint8_t,
      size_t,
...
{
  serialize_public_key_mut_21(&self->ind_cpa_public_key.t_as_ntt,
    Eurydice_array_to_slice((size_t)32U, &self->ind_cpa_public_key.seed_for_A, uint8_t),
    serialized);
}
...
{
  libcrux_ml_kem_ind_cca_unpacked_serialized_mut_dd_21(&self->public_key, serialized);
}
...
*/
static KRML_MUSTINLINE Eurydice_arr_74
serialized_dd_21(libcrux_ml_kem_ind_cca_unpacked_MlKemPublicKeyUnpacked_ec *self)
{
  return
    libcrux_ml_kem_types_from_fd_d0(serialize_public_key_21(&self->ind_cpa_public_key.t_as_ntt,
        Eurydice_array_to_slice((size_t)32U, &self->ind_cpa_public_key.seed_for_A, uint8_t)));
}
...
)
{
  Eurydice_arr_74
  public_key_serialized =
    serialize_public_key_21(&public_key->t_as_ntt,
      Eurydice_array_to_slice((size_t)32U, &public_key->seed_for_A, uint8_t));
  Eurydice_arr_600 secret_key_serialized = { .data = { 0U } };
  serialize_vector_a5(private_key,
...
)
{
  ...
  libcrux_ml_kem_ind_cca_serialize_kem_secret_key_mut_d6(Eurydice_array_to_slice((size_t)1152U,
      &ind_cpa_private_key,
      uint8_t),
...
*/
static KRML_MUSTINLINE void
deserialize_vector_a5(Eurydice_slice secret_key, Eurydice_arr_fe0 *secret_as_ntt)
{
  KRML_MAYBE_FOR3(i,
    (size_t)0U,
    (size_t)3U,
...
/**
A monomorphic instance of libcrux_ml_kem.sampling.sample_from_xof.call_mut_e7
with types libcrux_ml_kem_vector_neon_vector_type_SIMD128Vector, libcrux_ml_kem_hash_functions_portable_PortableHash[[$3size_t]]
with const generics
- K= 3
*/
...
- K= 3
*/
static KRML_MUSTINLINE Eurydice_arr_fe0 sample_from_xof_560(Eurydice_arr_84 *seeds)
{
  Eurydice_arr_c8 sampled_coefficients = { .data = { 0U } };
  Eurydice_arr_d4
  out = { .data = { { .data = { 0U } }, { .data = { 0U } }, { .data = { 0U } } } };
...
*/
static KRML_MUSTINLINE void
sample_matrix_A_560(Eurydice_arr_aa0 *A_transpose, Eurydice_arr_480 *seed, bool transpose)
{
  KRML_MAYBE_FOR3(i0,
    (size_t)0U,
    (size_t)3U,
...
*/
static KRML_MUSTINLINE void
build_unpacked_public_key_mut_440(
  Eurydice_slice public_key,
  libcrux_ml_kem_ind_cpa_unpacked_IndCpaPublicKeyUnpacked_ec *unpacked_public_key
)
{
  Eurydice_slice
  uu____0 = Eurydice_slice_subslice_to(public_key, (size_t)1152U, uint8_t, size_t, uint8_t []);
  deserialize_ring_elements_reduced_a5(uu____0, &unpacked_public_key->t_as_ntt);
  Eurydice_slice
  seed = Eurydice_slice_subslice_from(public_key, (size_t)1152U, uint8_t, size_t, uint8_t []);
...
)
{
  Eurydice_slice_uint8_t_x4
  uu____0 =
    libcrux_ml_kem_types_unpack_private_key_b4(Eurydice_array_to_slice((size_t)2400U,
        private_key,
        uint8_t));
  Eurydice_slice ind_cpa_secret_key = uu____0.fst;
  Eurydice_slice ind_cpa_public_key = uu____0.snd;
  Eurydice_slice ind_cpa_public_key_hash = uu____0.thd;
  Eurydice_slice implicit_rejection_value = uu____0.f3;
  deserialize_vector_a5(ind_cpa_secret_key, &key_pair->private_key.ind_cpa_private_key);
  ...
  Eurydice_slice_copy(Eurydice_array_to_slice((size_t)32U,
      &key_pair->public_key.ind_cpa_public_key.seed_for_A,
      uint8_t),
    Eurydice_slice_subslice_from(ind_cpa_public_key, (size_t)1152U, uint8_t, size_t, uint8_t []),
    uint8_t);
}
...
static Eurydice_arr_fe0 default_70_a5(void)
{
  ...
  KRML_MAYBE_FOR3(i, (size_t)0U, (size_t)3U, (size_t)1U, repeat_expression[i] = ZERO_d6_c5(););
...
- K= 3
*/
static libcrux_ml_kem_ind_cpa_unpacked_IndCpaPublicKeyUnpacked_ec default_8b_a5(void)
{
  Eurydice_arr_fe0 uu____0;
  Eurydice_arr_f9 repeat_expression0[3U];
  KRML_MAYBE_FOR3(i, (size_t)0U, (size_t)3U, (size_t)1U, repeat_expression0[i] = ZERO_d6_c5(););
  memcpy(uu____0.data, repeat_expression0, (size_t)3U * sizeof (Eurydice_arr_f9));
  Eurydice_arr_60 uu____1 = { .data = { 0U } };
  ...
  KRML_MAYBE_FOR3(i0,
    ...
    memcpy(lit.data, repeat_expression, (size_t)3U * sizeof (Eurydice_arr_f9));
    repeat_expression1[i0] = lit;);
  memcpy(lit0.A.data, repeat_expression1, (size_t)3U * sizeof (Eurydice_arr_fe0));
  return lit0;
}
...
libcrux_ml_kem_ind_cca_unpacked_default_7b_a5(void)
{
  ...
  uu____0 =
    { .ind_cpa_private_key = default_70_a5(), .implicit_rejection_value = { .data = { 0U } } };
  return
    (
      KRML_CLITERAL(libcrux_ml_kem_mlkem768_neon_unpacked_MlKem768KeyPairUnpacked){
        .private_key = uu____0,
...
- K= 3
*/
static KRML_MUSTINLINE libcrux_sha3_Sha3_512Digest G_2d_e0(Eurydice_slice input)
{
  return libcrux_ml_kem_hash_functions_neon_G(input);
}
...
static KRML_MUSTINLINE Eurydice_arr_db PRFxN_41(Eurydice_arr_46 *input)
{
  ...
  libcrux_sha3_neon_x2_shake256(Eurydice_array_to_slice((size_t)33U, input->data, uint8_t),
    ...
    Eurydice_array_to_slice((size_t)128U, &out0, uint8_t),
    Eurydice_array_to_slice((size_t)128U, &out1, uint8_t));
  libcrux_sha3_neon_x2_shake256(Eurydice_array_to_slice((size_t)33U, &input->data[2U], uint8_t),
...
*/
static KRML_MUSTINLINE uint8_t
sample_vector_cbd_then_ntt_1f0(
  Eurydice_arr_fe0 *re_as_ntt,
  Eurydice_arr_3e *prf_input,
  uint8_t domain_separator
)
{
  ...
  KRML_MAYBE_FOR3(i,
    ...
    repeat_expression[i] =
      core_array__core__clone__Clone_for__Array_T__N___clone((size_t)33U,
        ...
        uint8_t,
        Eurydice_arr_3e););
  memcpy(prf_inputs.data, repeat_expression, (size_t)3U * sizeof (Eurydice_arr_3e));
...
*/
static Eurydice_arr_f9 call_mut_73_c20(void **_)
{
  return ZERO_d6_c5();
}
...
*/
static KRML_MUSTINLINE void
add_to_ring_element_a5(Eurydice_arr_f9 *myself, Eurydice_arr_f9 *rhs)
{
  for
  (size_t
    i = (size_t)0U;
...
*/
static KRML_MUSTINLINE void
add_to_ring_element_d6_a5(Eurydice_arr_f9 *self, Eurydice_arr_f9 *rhs)
{
...
*/
static KRML_MUSTINLINE void
compute_As_plus_e_a5(
  Eurydice_arr_fe0 *t_as_ntt,
  Eurydice_arr_aa0 *matrix_A,
  Eurydice_arr_fe0 *s_as_ntt,
  Eurydice_arr_fe0 *error_as_ntt
)
{
  for
  (size_t
    i = (size_t)0U;
    i <
      Eurydice_slice_len(Eurydice_array_to_slice((size_t)3U, matrix_A, Eurydice_arr_fe0),
        Eurydice_arr_fe0);
    i++)
  {
    size_t i0 = i;
    ...
    (size_t
      i1 = (size_t)0U;
      i1 <
        Eurydice_slice_len(Eurydice_array_to_slice((size_t)3U, row, Eurydice_arr_f9),
          Eurydice_arr_f9);
      i1++)
    {
      size_t j = i1;
...
*/
static KRML_MUSTINLINE void
generate_keypair_unpacked_c20(
  Eurydice_slice key_generation_seed,
  Eurydice_arr_fe0 *private_key,
  libcrux_ml_kem_ind_cpa_unpacked_IndCpaPublicKeyUnpacked_ec *public_key
)
{
  libcrux_sha3_Sha3_512Digest hashed = cpa_keygen_seed_39_82(key_generation_seed);
  Eurydice_slice_uint8_t_x2
  uu____0 =
    Eurydice_slice_split_at(Eurydice_array_to_slice((size_t)64U, &hashed, uint8_t),
      (size_t)32U,
  ...
  Eurydice_arr_3e
  prf_input = libcrux_ml_kem_utils_into_padded_array_c8(seed_for_secret_and_error);
  uint8_t domain_separator = sample_vector_cbd_then_ntt_1f0(private_key, &prf_input, 0U);
  ...
  compute_As_plus_e_a5(&public_key->t_as_ntt, &public_key->A, private_key, &error_as_ntt);
  core_result_Result_95 dst;
  Eurydice_slice_to_array2(&dst,
    seed_for_A,
    Eurydice_slice,
...
- K= 3
*/
static Eurydice_arr_f9 call_mut_b4_a5(void **_)
{
  return ZERO_d6_c5();
}
...
)
{
  ...
  Eurydice_arr_74
  pk_serialized =
    serialize_public_key_21(&out->public_key.ind_cpa_public_key.t_as_ntt,
      Eurydice_array_to_slice((size_t)32U, &out->public_key.ind_cpa_public_key.seed_for_A, uint8_t));
  out->public_key.public_key_hash =
...
*/
static libcrux_sha3_Sha3_512Digest
encaps_prepare_82(Eurydice_slice randomness, Eurydice_slice pk_hash)
{
  libcrux_sha3_Sha3_512Digest to_hash = libcrux_ml_kem_utils_into_padded_array_24(randomness);
  Eurydice_slice_copy(Eurydice_array_to_subslice_from((size_t)64U,
      &to_hash,
...
/**
A monomorphic instance of K.
with types Eurydice_arr libcrux_ml_kem_polynomial_PolynomialRingElement libcrux_ml_kem_vector_neon_vector_type_SIMD128Vector[[$3size_t]], libcrux_ml_kem_polynomial_PolynomialRingElement libcrux_ml_kem_vector_neon_vector_type_SIMD128Vector
...
- ETA2_RANDOMNESS_SIZE= 128
*/
static Eurydice_arr_f9 call_mut_f1_d50(void **_)
{
  return ZERO_d6_c5();
}
...
- ETA2_RANDOMNESS_SIZE= 128
*/
static Eurydice_arr_f9 call_mut_dd_d50(void **_)
{
  return ZERO_d6_c5();
}
...
- K= 3
*/
static Eurydice_arr_f9 call_mut_a8_a5(void **_)
{
  return ZERO_d6_c5();
}
...
)
{
  ...
  (size_t
    i0 = (size_t)0U;
    i0 <
      Eurydice_slice_len(Eurydice_array_to_slice((size_t)3U, a_as_ntt, Eurydice_arr_fe0),
        Eurydice_arr_fe0);
    i0++)
  {
    size_t i1 = i0;
...
*/
static KRML_MUSTINLINE void
compress_then_serialize_u_b0(Eurydice_arr_fe0 input, Eurydice_slice out)
{
  for
  (size_t
    i = (size_t)0U;
    i <
      Eurydice_slice_len(Eurydice_array_to_slice((size_t)3U, &input, Eurydice_arr_f9),
        Eurydice_arr_f9);
    i++)
  {
    size_t i0 = i;
...
- ETA2_RANDOMNESS_SIZE= 128
*/
static KRML_MUSTINLINE tuple_880
encrypt_c1_d50(Eurydice_slice randomness, Eurydice_arr_aa0 *matrix, Eurydice_slice ciphertext)
{
  Eurydice_arr_3e prf_input = libcrux_ml_kem_utils_into_padded_array_c8(randomness);
  ...
  uint8_t domain_separator0 = sample_vector_cbd_then_ntt_1f0(&r_as_ntt, &prf_input, 0U);
  Eurydice_arr_fe0 arr_struct;
  KRML_MAYBE_FOR3(i,
    (size_t)0U,
    (size_t)3U,
  ...
  uint8_t
  domain_separator = sample_ring_element_cbd_1f0(&prf_input, domain_separator0, &error_1);
  prf_input.data[32U] = domain_separator;
  Eurydice_arr_d1
  prf_output = PRF_2d_410(Eurydice_array_to_slice((size_t)33U, &prf_input, uint8_t));
  Eurydice_arr_f9
  error_2 =
    sample_from_binomial_distribution_e3(Eurydice_array_to_slice((size_t)128U,
        &prf_output,
...
*/
static KRML_MUSTINLINE void
compress_then_serialize_ring_element_v_91(Eurydice_arr_f9 re, Eurydice_slice out)
{
  compress_then_serialize_4_c5(re, out);
}
...
)
{
  Eurydice_arr_f9 message_as_ring_element = deserialize_then_decompress_message_c5(message);
  Eurydice_arr_f9
  v = compute_ring_element_v_a5(t_as_ntt, r_as_ntt, error_2, &message_as_ring_element);
...
)
{
  ...
  tuple_880
  uu____0 =
    encrypt_c1_d50(randomness,
      &public_key->A,
      Eurydice_array_to_subslice3(&ciphertext, (size_t)0U, (size_t)960U, uint8_t *));
...
)
{
  libcrux_sha3_Sha3_512Digest
  hashed =
    encaps_prepare_82(Eurydice_array_to_slice((size_t)32U, randomness, uint8_t),
      Eurydice_array_to_slice((size_t)32U, &public_key->public_key_hash, uint8_t));
  Eurydice_slice_uint8_t_x2
  uu____0 =
    Eurydice_slice_split_at(Eurydice_array_to_slice((size_t)64U, &hashed, uint8_t),
  ...
  Eurydice_arr_2c
  ciphertext =
    encrypt_unpacked_fa0(&public_key->ind_cpa_public_key,
      randomness,
      pseudorandomness);
  Eurydice_arr_60 shared_secret_array = { .data = { 0U } };
  Eurydice_slice_copy(Eurydice_array_to_slice((size_t)32U, &shared_secret_array, uint8_t),
...
- U_COMPRESSION_FACTOR= 10
*/
static Eurydice_arr_f9 call_mut_35_91(void **_)
{
  return ZERO_d6_c5();
}
...
deserialize_then_decompress_u_91(Eurydice_arr_2c *ciphertext)
{
  ...
  (size_t
    i = (size_t)0U;
    i <
      Eurydice_slice_len(Eurydice_array_to_slice((size_t)1088U, ciphertext, uint8_t), uint8_t) /
        (LIBCRUX_ML_KEM_CONSTANTS_COEFFICIENTS_IN_RING_ELEMENT * (size_t)10U / (size_t)8U);
    i++)
  {
    size_t i0 = i;
...
compute_message_a5(
  Eurydice_arr_f9 *v,
  Eurydice_arr_fe0 *secret_as_ntt,
...
decrypt_unpacked_36(Eurydice_arr_fe0 *secret_key, Eurydice_arr_2c *ciphertext)
{
  ...
  Eurydice_arr_f9
  v =
    deserialize_then_decompress_ring_element_v_21(Eurydice_array_to_subslice_from((size_t)1088U,
        ciphertext,
        (size_t)960U,
        uint8_t,
        size_t,
...
{
  Eurydice_arr_60
  decrypted = decrypt_unpacked_36(&key_pair->private_key.ind_cpa_private_key, ciphertext);
  libcrux_sha3_Sha3_512Digest
  to_hash0 =
    libcrux_ml_kem_utils_into_padded_array_24(Eurydice_array_to_slice((size_t)32U,
        &decrypted,
  ...
  Eurydice_slice_copy(uu____0,
    ...
    uint8_t);
  libcrux_sha3_Sha3_512Digest
  hashed = G_2d_e0(Eurydice_array_to_slice((size_t)64U, &to_hash0, uint8_t));
  Eurydice_slice_uint8_t_x2
  uu____1 =
    Eurydice_slice_split_at(Eurydice_array_to_slice((size_t)64U, &hashed, uint8_t),
      LIBCRUX_ML_KEM_CONSTANTS_SHARED_SECRET_SIZE,
  ...
  Eurydice_arr_48
  to_hash =
    libcrux_ml_kem_utils_into_padded_array_15(Eurydice_array_to_slice((size_t)32U,
        &key_pair->private_key.implicit_rejection_value,
        uint8_t));
  Eurydice_slice
  uu____2 =
  ...
  Eurydice_arr_2c
  expected_ciphertext =
    encrypt_unpacked_fa0(&key_pair->public_key.ind_cpa_public_key,
      &decrypted,
      pseudorandomness);
  uint8_t
  selector =
    libcrux_ml_kem_constant_time_ops_compare_ciphertexts_in_constant_time(libcrux_ml_kem_types_as_ref_d3_80(ciphertext),
...
- K= 3
*/
static Eurydice_arr_f9 call_mut_0b_a5(void **_)
{
  return ZERO_d6_c5();
}
...
bool libcrux_ml_kem_ind_cca_validate_public_key_21(Eurydice_arr_74 *public_key)
{
  Eurydice_arr_fe0
  deserialized_pk =
    deserialize_ring_elements_reduced_out_a5(Eurydice_array_to_subslice_to((size_t)1184U,
        public_key,
        libcrux_ml_kem_constants_ranked_bytes_per_ring_element((size_t)3U),
        uint8_t,
        size_t,
  ...
  Eurydice_arr_74
  public_key_serialized =
    serialize_public_key_21(uu____0,
...
bool libcrux_ml_kem_ind_cca_validate_private_key_only_20(Eurydice_arr_ea *private_key)
{
  Eurydice_arr_60
  t =
    H_2d_e0(Eurydice_array_to_subslice3(private_key,
...
generate_keypair_cb0(Eurydice_slice key_generation_seed)
{
  ...
  libcrux_ml_kem_ind_cpa_unpacked_IndCpaPublicKeyUnpacked_ec public_key = default_8b_a5();
...
*/
static KRML_MUSTINLINE void
serialize_kem_secret_key_mut_20(
  Eurydice_slice private_key,
  Eurydice_slice public_key,
  Eurydice_slice implicit_rejection_value,
  Eurydice_arr_ea *serialized
...
)
{
  ...
  serialize_kem_secret_key_mut_20(private_key, public_key, implicit_rejection_value, &out);
  return out;
}
...
libcrux_ml_kem_ind_cca_generate_keypair_580(libcrux_sha3_Sha3_512Digest *randomness)
{
  ...
  implicit_rejection_value =
    Eurydice_array_to_subslice_from((size_t)64U,
      ...
      uint8_t []);
  libcrux_ml_kem_utils_extraction_helper_Keypair768
  uu____0 = generate_keypair_cb0(ind_cpa_keypair_randomness);
  Eurydice_arr_600 ind_cpa_private_key = uu____0.fst;
  Eurydice_arr_74 public_key = uu____0.snd;
  Eurydice_arr_ea
  secret_key_serialized =
    serialize_kem_secret_key_20(Eurydice_array_to_slice((size_t)1152U,
        &ind_cpa_private_key,
        uint8_t),
...
- K= 3
*/
static KRML_MUSTINLINE Eurydice_arr_60 entropy_preprocess_39_82(Eurydice_slice randomness)
{
  Eurydice_arr_60 out = { .data = { 0U } };
  Eurydice_slice_copy(Eurydice_array_to_slice((size_t)32U, &out, uint8_t), randomness, uint8_t);
  return out;
...
*/
static KRML_MUSTINLINE void
build_unpacked_public_key_mut_4f0(
  Eurydice_slice public_key,
  libcrux_ml_kem_ind_cpa_unpacked_IndCpaPublicKeyUnpacked_ec *unpacked_public_key
)
{
...
- T_AS_NTT_ENCODED_SIZE= 1152
*/
static KRML_MUSTINLINE libcrux_ml_kem_ind_cpa_unpacked_IndCpaPublicKeyUnpacked_ec
...
*/
static KRML_MUSTINLINE Eurydice_arr_2c
encrypt_fa0(Eurydice_slice public_key, Eurydice_arr_60 *message, Eurydice_slice randomness)
{
  libcrux_ml_kem_ind_cpa_unpacked_IndCpaPublicKeyUnpacked_ec
...
)
{
  Eurydice_arr_60
  randomness0 =
    entropy_preprocess_39_82(Eurydice_array_to_slice((size_t)32U, randomness, uint8_t));
  libcrux_sha3_Sha3_512Digest
  to_hash =
    libcrux_ml_kem_utils_into_padded_array_24(Eurydice_array_to_slice((size_t)32U,
        &randomness0,
  ...
  Eurydice_slice_copy(uu____0, Eurydice_array_to_slice((size_t)32U, &lvalue, uint8_t), uint8_t);
  libcrux_sha3_Sha3_512Digest
  hashed = G_2d_e0(Eurydice_array_to_slice((size_t)64U, &to_hash, uint8_t));
  Eurydice_slice_uint8_t_x2
  uu____1 =
    Eurydice_slice_split_at(Eurydice_array_to_slice((size_t)64U, &hashed, uint8_t),
      LIBCRUX_ML_KEM_CONSTANTS_SHARED_SECRET_SIZE,
  ...
  Eurydice_arr_2c
  ciphertext =
    encrypt_fa0(Eurydice_array_to_slice((size_t)1184U,
        libcrux_ml_kem_types_as_slice_e6_d0(public_key),
        uint8_t),
      &randomness0,
      pseudorandomness);
  Eurydice_arr_2c uu____2 = libcrux_ml_kem_types_from_e0_80(ciphertext);
  return (KRML_CLITERAL(tuple_56){ .fst = uu____2, .snd = kdf_39_20(shared_secret) });
}
...
- V_COMPRESSION_FACTOR= 4
*/
static Eurydice_arr_f9 call_mut_0b_36(void **_)
{
  return ZERO_d6_c5();
}
...
*/
static KRML_MUSTINLINE Eurydice_arr_60
decrypt_36(Eurydice_slice secret_key, Eurydice_arr_2c *ciphertext)
{
  Eurydice_arr_fe0 arr_struct;
  KRML_MAYBE_FOR3(i,
    (size_t)0U,
...
)
{
  ...
  Eurydice_slice shared_secret0 = uu____1.fst;
  Eurydice_slice pseudorandomness = uu____1.snd;
  Eurydice_arr_48 to_hash = libcrux_ml_kem_utils_into_padded_array_15(implicit_rejection_value);
  Eurydice_slice
  uu____2 =
    Eurydice_array_to_subslice_from((size_t)1120U,
      &to_hash,
  ...
  implicit_rejection_shared_secret0 =
    PRF_2d_41(Eurydice_array_to_slice((size_t)1120U, &to_hash, uint8_t));
  Eurydice_arr_2c
  expected_ciphertext = encrypt_fa0(ind_cpa_public_key, &decrypted, pseudorandomness);
  Eurydice_arr_60
  implicit_rejection_shared_secret =
    kdf_39_20(Eurydice_array_to_slice((size_t)32U, &implicit_rejection_shared_secret0, uint8_t));
  Eurydice_arr_60 shared_secret = kdf_39_20(shared_secret0);
  return
    libcrux_ml_kem_constant_time_ops_compare_ciphertexts_select_shared_secret_in_constant_time(libcrux_ml_kem_types_as_ref_d3_80(ciphertext),
      Eurydice_array_to_slice((size_t)1088U, &expected_ciphertext, uint8_t),
      Eurydice_array_to_slice((size_t)32U, &shared_secret, uint8_t),
      Eurydice_array_to_slice((size_t)32U, &implicit_rejection_shared_secret, uint8_t));
}
...
- K= 4
*/
static KRML_MUSTINLINE Eurydice_arr_54 shake128_init_absorb_final_ac(Eurydice_arr_78 *input)
{
  Eurydice_arr_fe uu____0 = libcrux_sha3_neon_x2_incremental_init();
  Eurydice_arr_54 state = { .data = { uu____0, libcrux_sha3_neon_x2_incremental_init() } };
  libcrux_sha3_neon_x2_incremental_shake128_absorb_final(state.data,
...
- K= 4
*/
static KRML_MUSTINLINE Eurydice_arr_54 shake128_init_absorb_final_2d_ac(Eurydice_arr_78 *input)
{
...
*/
static KRML_MUSTINLINE bool
sample_from_uniform_distribution_next_a1(
  Eurydice_arr_ec *randomness,
  Eurydice_arr_33 *sampled_coefficients,
  Eurydice_arr_8a *out
)
{
  KRML_MAYBE_FOR4(i0,
...
- K= 4
*/
static KRML_MUSTINLINE Eurydice_arr_a6 shake128_squeeze_next_block_ac(Eurydice_arr_54 *st)
{
  Eurydice_arr_a6
  out =
    { .data = { { .data = { 0U } }, { .data = { 0U } }, { .data = { 0U } }, { .data = { 0U } } } };
...
- K= 4
*/
static KRML_MUSTINLINE Eurydice_arr_a6 shake128_squeeze_next_block_2d_ac(Eurydice_arr_54 *self)
{
...
*/
static KRML_MUSTINLINE bool
sample_from_uniform_distribution_next_a10(
...
- K= 4
*/
static KRML_MUSTINLINE Eurydice_arr_7f sample_from_xof_cd(Eurydice_arr_78 *seeds)
{
  ...
  Eurydice_arr_ec randomness0 = shake128_squeeze_first_three_blocks_2d_ac(&xof_state);
  bool
  done = sample_from_uniform_distribution_next_a1(&randomness0, &sampled_coefficients, &out);
  while (true)
  {
    if (done)
    {
    ...
    {
      Eurydice_arr_a6 randomness = shake128_squeeze_next_block_2d_ac(&xof_state);
      done = sample_from_uniform_distribution_next_a10(&randomness, &sampled_coefficients, &out);
    }
  }
...
*/
static KRML_MUSTINLINE void
sample_matrix_A_cd(Eurydice_arr_95 *A_transpose, Eurydice_arr_480 *seed, bool transpose)
{
  KRML_MAYBE_FOR4(i0,
    (size_t)0U,
    (size_t)4U,
    ...
    Eurydice_arr_480 repeat_expression[4U];
    KRML_MAYBE_FOR4(i,
      (size_t)0U,
      (size_t)4U,
      (size_t)1U,
      repeat_expression[i] =
        core_array__core__clone__Clone_for__Array_T__N___clone((size_t)34U,
          ...
          uint8_t,
          Eurydice_arr_480););
    memcpy(seeds.data, repeat_expression, (size_t)4U * sizeof (Eurydice_arr_480));
    KRML_MAYBE_FOR4(i,
      (size_t)0U,
      (size_t)4U,
      (size_t)1U,
    ...
    (size_t
      i = (size_t)0U;
      i <
        Eurydice_slice_len(Eurydice_array_to_slice((size_t)4U, &sampled, Eurydice_arr_f9),
          Eurydice_arr_f9);
      i++)
    {
      size_t j = i;
...
)
{
  ...
  uu____0 =
    Eurydice_array_to_subslice_to((size_t)1568U,
      ...
      size_t,
      uint8_t []);
  deserialize_ring_elements_reduced_40(uu____0,
    &unpacked_public_key->ind_cpa_public_key.t_as_ntt);
  Eurydice_arr_60
  uu____1 =
    libcrux_ml_kem_utils_into_padded_array_9e(Eurydice_array_to_subslice_from((size_t)1568U,
        public_key,
        (size_t)1536U,
        uint8_t,
        size_t,
  ...
  Eurydice_arr_480
  lvalue =
    libcrux_ml_kem_utils_into_padded_array_b6(Eurydice_array_to_subslice_from((size_t)1568U,
        public_key,
        (size_t)1536U,
        uint8_t,
        size_t,
  ...
  Eurydice_arr_60
  uu____3 =
    H_2d_ac(Eurydice_array_to_slice((size_t)1568U,
...
- K= 4
*/
static KRML_MUSTINLINE void serialize_vector_40(Eurydice_arr_7f *key, Eurydice_slice out)
{
  for
  (size_t
    i = (size_t)0U;
    i <
      Eurydice_slice_len(Eurydice_array_to_slice((size_t)4U, key, Eurydice_arr_f9),
        Eurydice_arr_f9);
    i++)
  {
    size_t i0 = i;
...
{
  serialize_vector_40(t_as_ntt,
    Eurydice_array_to_subslice3(serialized,
      (size_t)0U,
      libcrux_ml_kem_constants_ranked_bytes_per_ring_element((size_t)4U),
      uint8_t *));
  Eurydice_slice_copy(Eurydice_array_to_subslice_from((size_t)1568U,
      serialized,
      libcrux_ml_kem_constants_ranked_bytes_per_ring_element((size_t)4U),
      uint8_t,
      size_t,
...
{
  serialize_public_key_mut_a1(&self->ind_cpa_public_key.t_as_ntt,
    Eurydice_array_to_slice((size_t)32U, &self->ind_cpa_public_key.seed_for_A, uint8_t),
    serialized);
}
...
{
  libcrux_ml_kem_ind_cca_unpacked_serialized_mut_dd_a1(&self->public_key, serialized);
}
...
*/
static KRML_MUSTINLINE Eurydice_arr_00
serialized_dd_a1(libcrux_ml_kem_ind_cca_unpacked_MlKemPublicKeyUnpacked_56 *self)
{
  return
    libcrux_ml_kem_types_from_fd_af(serialize_public_key_a1(&self->ind_cpa_public_key.t_as_ntt,
        Eurydice_array_to_slice((size_t)32U, &self->ind_cpa_public_key.seed_for_A, uint8_t)));
}
...
)
{
  Eurydice_arr_00
  public_key_serialized =
    serialize_public_key_a1(&public_key->t_as_ntt,
      Eurydice_array_to_slice((size_t)32U, &public_key->seed_for_A, uint8_t));
  Eurydice_arr_38 secret_key_serialized = { .data = { 0U } };
  serialize_vector_40(private_key,
...
)
{
  ...
  libcrux_ml_kem_ind_cca_serialize_kem_secret_key_mut_60(Eurydice_array_to_slice((size_t)1536U,
      &ind_cpa_private_key,
      uint8_t),
...
*/
static KRML_MUSTINLINE void
deserialize_vector_40(Eurydice_slice secret_key, Eurydice_arr_7f *secret_as_ntt)
{
  KRML_MAYBE_FOR4(i,
    (size_t)0U,
    (size_t)4U,
...
/**
A monomorphic instance of libcrux_ml_kem.sampling.sample_from_xof.call_mut_e7
with types libcrux_ml_kem_vector_neon_vector_type_SIMD128Vector, libcrux_ml_kem_hash_functions_portable_PortableHash[[$4size_t]]
with const generics
- K= 4
*/
...
- K= 4
*/
static KRML_MUSTINLINE Eurydice_arr_7f sample_from_xof_56(Eurydice_arr_78 *seeds)
{
  Eurydice_arr_33 sampled_coefficients = { .data = { 0U } };
  Eurydice_arr_8a
  out =
    { .data = { { .data = { 0U } }, { .data = { 0U } }, { .data = { 0U } }, { .data = { 0U } } } };
  Eurydice_arr_180
  xof_state = libcrux_ml_kem_hash_functions_portable_shake128_init_absorb_final_4a_ac(seeds);
  Eurydice_arr_ec
  randomness0 =
    libcrux_ml_kem_hash_functions_portable_shake128_squeeze_first_three_blocks_4a_ac(&xof_state);
  bool
  done = sample_from_uniform_distribution_next_a1(&randomness0, &sampled_coefficients, &out);
  while (true)
  {
    ...
    else
    {
      Eurydice_arr_a6
      randomness =
        libcrux_ml_kem_hash_functions_portable_shake128_squeeze_next_block_4a_ac(&xof_state);
      done = sample_from_uniform_distribution_next_a10(&randomness, &sampled_coefficients, &out);
    }
  }
  Eurydice_arr_7f arr_mapped_str;
...
*/
static KRML_MUSTINLINE void
sample_matrix_A_56(Eurydice_arr_95 *A_transpose, Eurydice_arr_480 *seed, bool transpose)
{
  KRML_MAYBE_FOR4(i0,
    (size_t)0U,
    (size_t)4U,
...
*/
static KRML_MUSTINLINE void
build_unpacked_public_key_mut_44(
  Eurydice_slice public_key,
  libcrux_ml_kem_ind_cpa_unpacked_IndCpaPublicKeyUnpacked_56 *unpacked_public_key
)
{
  Eurydice_slice
  uu____0 = Eurydice_slice_subslice_to(public_key, (size_t)1536U, uint8_t, size_t, uint8_t []);
  deserialize_ring_elements_reduced_40(uu____0, &unpacked_public_key->t_as_ntt);
  Eurydice_slice
  seed = Eurydice_slice_subslice_from(public_key, (size_t)1536U, uint8_t, size_t, uint8_t []);
...
)
{
  Eurydice_slice_uint8_t_x4
  uu____0 =
    libcrux_ml_kem_types_unpack_private_key_1f(Eurydice_array_to_slice((size_t)3168U,
        private_key,
        uint8_t));
  Eurydice_slice ind_cpa_secret_key = uu____0.fst;
  Eurydice_slice ind_cpa_public_key = uu____0.snd;
  Eurydice_slice ind_cpa_public_key_hash = uu____0.thd;
  Eurydice_slice implicit_rejection_value = uu____0.f3;
  deserialize_vector_40(ind_cpa_secret_key, &key_pair->private_key.ind_cpa_private_key);
  build_unpacked_public_key_mut_44(ind_cpa_public_key, &key_pair->public_key.ind_cpa_public_key);
  Eurydice_slice_copy(Eurydice_array_to_slice((size_t)32U,
      &key_pair->public_key.public_key_hash,
      uint8_t),
    ind_cpa_public_key_hash,
  ...
  Eurydice_slice_copy(Eurydice_array_to_slice((size_t)32U,
      &key_pair->public_key.ind_cpa_public_key.seed_for_A,
      uint8_t),
    Eurydice_slice_subslice_from(ind_cpa_public_key, (size_t)1536U, uint8_t, size_t, uint8_t []),
    uint8_t);
}
...
static Eurydice_arr_7f default_70_40(void)
{
  ...
  KRML_MAYBE_FOR4(i, (size_t)0U, (size_t)4U, (size_t)1U, repeat_expression[i] = ZERO_d6_c5(););
...
- K= 4
*/
static libcrux_ml_kem_ind_cpa_unpacked_IndCpaPublicKeyUnpacked_56 default_8b_40(void)
{
  Eurydice_arr_7f uu____0;
  Eurydice_arr_f9 repeat_expression0[4U];
  KRML_MAYBE_FOR4(i, (size_t)0U, (size_t)4U, (size_t)1U, repeat_expression0[i] = ZERO_d6_c5(););
  memcpy(uu____0.data, repeat_expression0, (size_t)4U * sizeof (Eurydice_arr_f9));
  Eurydice_arr_60 uu____1 = { .data = { 0U } };
...
libcrux_ml_kem_ind_cca_unpacked_default_7b_40(void)
{
  ...
  uu____0 =
    { .ind_cpa_private_key = default_70_40(), .implicit_rejection_value = { .data = { 0U } } };
  return
    (
      KRML_CLITERAL(libcrux_ml_kem_mlkem1024_neon_unpacked_MlKem1024KeyPairUnpacked){
        .private_key = uu____0,
...
- K= 4
*/
static KRML_MUSTINLINE libcrux_sha3_Sha3_512Digest G_2d_ac(Eurydice_slice input)
{
  return libcrux_ml_kem_hash_functions_neon_G(input);
}
...
*/
static KRML_MUSTINLINE uint8_t
sample_vector_cbd_then_ntt_1f(
  Eurydice_arr_7f *re_as_ntt,
  Eurydice_arr_3e *prf_input,
  uint8_t domain_separator
)
{
  ...
  KRML_MAYBE_FOR4(i,
    ...
    repeat_expression[i] =
      core_array__core__clone__Clone_for__Array_T__N___clone((size_t)33U,
        ...
        uint8_t,
        Eurydice_arr_3e););
  memcpy(prf_inputs.data, repeat_expression, (size_t)4U * sizeof (Eurydice_arr_3e));
  domain_separator = libcrux_ml_kem_utils_prf_input_inc_ac(&prf_inputs, domain_separator);
...
- ETA1_RANDOMNESS_SIZE= 128
*/
static Eurydice_arr_f9 call_mut_73_c2(void **_)
{
  return ZERO_d6_c5();
}
...
*/
static KRML_MUSTINLINE void
add_to_ring_element_40(Eurydice_arr_f9 *myself, Eurydice_arr_f9 *rhs)
{
  for
  (size_t
    i = (size_t)0U;
...
*/
static KRML_MUSTINLINE void
add_to_ring_element_d6_40(Eurydice_arr_f9 *self, Eurydice_arr_f9 *rhs)
{
...
*/
static KRML_MUSTINLINE void
compute_As_plus_e_40(
  Eurydice_arr_7f *t_as_ntt,
  Eurydice_arr_95 *matrix_A,
  Eurydice_arr_7f *s_as_ntt,
  Eurydice_arr_7f *error_as_ntt
)
{
  for
  (size_t
    i = (size_t)0U;
    i <
      Eurydice_slice_len(Eurydice_array_to_slice((size_t)4U, matrix_A, Eurydice_arr_7f),
        Eurydice_arr_7f);
    i++)
  {
    size_t i0 = i;
    ...
    (size_t
      i1 = (size_t)0U;
      i1 <
        Eurydice_slice_len(Eurydice_array_to_slice((size_t)4U, row, Eurydice_arr_f9),
          Eurydice_arr_f9);
      i1++)
    {
      size_t j = i1;
...
*/
static KRML_MUSTINLINE void
generate_keypair_unpacked_c2(
  Eurydice_slice key_generation_seed,
  Eurydice_arr_7f *private_key,
  libcrux_ml_kem_ind_cpa_unpacked_IndCpaPublicKeyUnpacked_56 *public_key
)
{
  libcrux_sha3_Sha3_512Digest hashed = cpa_keygen_seed_39_49(key_generation_seed);
  Eurydice_slice_uint8_t_x2
  uu____0 =
    Eurydice_slice_split_at(Eurydice_array_to_slice((size_t)64U, &hashed, uint8_t),
      (size_t)32U,
  ...
  Eurydice_arr_3e
  prf_input = libcrux_ml_kem_utils_into_padded_array_c8(seed_for_secret_and_error);
  uint8_t domain_separator = sample_vector_cbd_then_ntt_1f(private_key, &prf_input, 0U);
  ...
  compute_As_plus_e_40(&public_key->t_as_ntt, &public_key->A, private_key, &error_as_ntt);
  core_result_Result_95 dst;
  Eurydice_slice_to_array2(&dst,
    seed_for_A,
    Eurydice_slice,
...
- K= 4
*/
static Eurydice_arr_f9 call_mut_b4_40(void **_)
{
  return ZERO_d6_c5();
}
...
)
{
  ...
  Eurydice_arr_00
  pk_serialized =
    serialize_public_key_a1(&out->public_key.ind_cpa_public_key.t_as_ntt,
      Eurydice_array_to_slice((size_t)32U, &out->public_key.ind_cpa_public_key.seed_for_A, uint8_t));
  out->public_key.public_key_hash =
...
*/
static libcrux_sha3_Sha3_512Digest
encaps_prepare_49(Eurydice_slice randomness, Eurydice_slice pk_hash)
{
  libcrux_sha3_Sha3_512Digest to_hash = libcrux_ml_kem_utils_into_padded_array_24(randomness);
  Eurydice_slice_copy(Eurydice_array_to_subslice_from((size_t)64U,
      &to_hash,
...
/**
A monomorphic instance of K.
with types Eurydice_arr libcrux_ml_kem_polynomial_PolynomialRingElement libcrux_ml_kem_vector_neon_vector_type_SIMD128Vector[[$4size_t]], libcrux_ml_kem_polynomial_PolynomialRingElement libcrux_ml_kem_vector_neon_vector_type_SIMD128Vector
...
- ETA2_RANDOMNESS_SIZE= 128
*/
static Eurydice_arr_f9 call_mut_f1_d5(void **_)
{
  return ZERO_d6_c5();
}
...
- ETA2_RANDOMNESS_SIZE= 128
*/
static Eurydice_arr_f9 call_mut_dd_d5(void **_)
{
  return ZERO_d6_c5();
}
...
- K= 4
*/
static Eurydice_arr_f9 call_mut_a8_40(void **_)
{
  return ZERO_d6_c5();
}
...
)
{
  ...
  (size_t
    i0 = (size_t)0U;
    i0 <
      Eurydice_slice_len(Eurydice_array_to_slice((size_t)4U, a_as_ntt, Eurydice_arr_7f),
        Eurydice_arr_7f);
    i0++)
  {
    size_t i1 = i0;
...
- OUT_LEN= 352
*/
static KRML_MUSTINLINE Eurydice_arr_79 compress_then_serialize_11_88(Eurydice_arr_f9 *re)
{
  ...
  for (size_t i = (size_t)0U; i < LIBCRUX_ML_KEM_POLYNOMIAL_VECTORS_IN_RING_ELEMENT; i++)
  {
    ...
    libcrux_ml_kem_vector_neon_vector_type_SIMD128Vector
    coefficient =
      compress_61_c4(libcrux_ml_kem_vector_neon_to_unsigned_representative_61(re->data[i0]));
    Eurydice_arr_f3 bytes = libcrux_ml_kem_vector_neon_serialize_11_61(coefficient);
    Eurydice_slice_copy(Eurydice_array_to_subslice3(&serialized,
        (size_t)22U * i0,
        (size_t)22U * i0 + (size_t)22U,
        uint8_t *),
      Eurydice_array_to_slice((size_t)22U, &bytes, uint8_t),
      uint8_t);
  }
  return serialized;
}
...
*/
static KRML_MUSTINLINE void
compress_then_serialize_u_fd(Eurydice_arr_7f input, Eurydice_slice out)
{
  for
  (size_t
    i = (size_t)0U;
    i <
      Eurydice_slice_len(Eurydice_array_to_slice((size_t)4U, &input, Eurydice_arr_f9),
        Eurydice_arr_f9);
    i++)
  {
    size_t i0 = i;
    ...
    Eurydice_slice_copy(uu____0, Eurydice_array_to_slice((size_t)352U, &lvalue, uint8_t), uint8_t);
  }
}
...
encrypt_c1_d5(Eurydice_slice randomness, Eurydice_arr_95 *matrix, Eurydice_slice ciphertext)
{
  Eurydice_arr_3e prf_input = libcrux_ml_kem_utils_into_padded_array_c8(randomness);
  ...
  uint8_t domain_separator0 = sample_vector_cbd_then_ntt_1f(&r_as_ntt, &prf_input, 0U);
  Eurydice_arr_7f arr_struct;
  KRML_MAYBE_FOR4(i,
    (size_t)0U,
    (size_t)4U,
  ...
  uint8_t domain_separator = sample_ring_element_cbd_1f(&prf_input, domain_separator0, &error_1);
  prf_input.data[32U] = domain_separator;
  Eurydice_arr_d1
  prf_output = PRF_2d_440(Eurydice_array_to_slice((size_t)33U, &prf_input, uint8_t));
  Eurydice_arr_f9
  error_2 =
    sample_from_binomial_distribution_e3(Eurydice_array_to_slice((size_t)128U,
        &prf_output,
...
*/
static KRML_MUSTINLINE void
compress_then_serialize_ring_element_v_4d(Eurydice_arr_f9 re, Eurydice_slice out)
{
...
)
{
  Eurydice_arr_f9 message_as_ring_element = deserialize_then_decompress_message_c5(message);
  Eurydice_arr_f9
  v = compute_ring_element_v_40(t_as_ntt, r_as_ntt, error_2, &message_as_ring_element);
...
)
{
  ...
  tuple_0c
  uu____0 =
    encrypt_c1_d5(randomness,
      &public_key->A,
      Eurydice_array_to_subslice3(&ciphertext, (size_t)0U, (size_t)1408U, uint8_t *));
...
)
{
  libcrux_sha3_Sha3_512Digest
  hashed =
    encaps_prepare_49(Eurydice_array_to_slice((size_t)32U, randomness, uint8_t),
      Eurydice_array_to_slice((size_t)32U, &public_key->public_key_hash, uint8_t));
  Eurydice_slice_uint8_t_x2
  uu____0 =
    Eurydice_slice_split_at(Eurydice_array_to_slice((size_t)64U, &hashed, uint8_t),
  ...
  Eurydice_slice pseudorandomness = uu____0.snd;
  Eurydice_arr_00
  ciphertext = encrypt_unpacked_fa(&public_key->ind_cpa_public_key, randomness, pseudorandomness);
  Eurydice_arr_60 shared_secret_array = { .data = { 0U } };
  Eurydice_slice_copy(Eurydice_array_to_slice((size_t)32U, &shared_secret_array, uint8_t),
    shared_secret,
    uint8_t);
...
- U_COMPRESSION_FACTOR= 11
*/
static Eurydice_arr_f9 call_mut_35_4d(void **_)
{
  return ZERO_d6_c5();
}
...
deserialize_then_decompress_u_4d(Eurydice_arr_00 *ciphertext)
{
  ...
  (size_t
    i = (size_t)0U;
    i <
      Eurydice_slice_len(Eurydice_array_to_slice((size_t)1568U, ciphertext, uint8_t), uint8_t) /
...
decrypt_unpacked_21(Eurydice_arr_7f *secret_key, Eurydice_arr_00 *ciphertext)
{
  ...
  Eurydice_arr_f9
  v =
    deserialize_then_decompress_ring_element_v_a1(Eurydice_array_to_subslice_from((size_t)1568U,
        ciphertext,
        (size_t)1408U,
        uint8_t,
        size_t,
...
{
  Eurydice_arr_60
  decrypted = decrypt_unpacked_21(&key_pair->private_key.ind_cpa_private_key, ciphertext);
  libcrux_sha3_Sha3_512Digest
  to_hash0 =
    libcrux_ml_kem_utils_into_padded_array_24(Eurydice_array_to_slice((size_t)32U,
        &decrypted,
  ...
  Eurydice_slice_copy(uu____0,
    ...
    uint8_t);
  libcrux_sha3_Sha3_512Digest
  hashed = G_2d_ac(Eurydice_array_to_slice((size_t)64U, &to_hash0, uint8_t));
  Eurydice_slice_uint8_t_x2
  uu____1 =
    Eurydice_slice_split_at(Eurydice_array_to_slice((size_t)64U, &hashed, uint8_t),
      LIBCRUX_ML_KEM_CONSTANTS_SHARED_SECRET_SIZE,
  ...
  Eurydice_arr_e7
  to_hash =
    libcrux_ml_kem_utils_into_padded_array_7f(Eurydice_array_to_slice((size_t)32U,
        &key_pair->private_key.implicit_rejection_value,
        uint8_t));
  Eurydice_slice
  uu____2 =
    Eurydice_array_to_subslice_from((size_t)1600U,
      ...
      size_t,
      uint8_t []);
  Eurydice_slice_copy(uu____2, libcrux_ml_kem_types_as_ref_d3_af(ciphertext), uint8_t);
  Eurydice_arr_60
  implicit_rejection_shared_secret =
    PRF_2d_44(Eurydice_array_to_slice((size_t)1600U, &to_hash, uint8_t));
  Eurydice_arr_00
  expected_ciphertext =
    encrypt_unpacked_fa(&key_pair->public_key.ind_cpa_public_key,
      &decrypted,
      pseudorandomness);
  uint8_t
  selector =
    libcrux_ml_kem_constant_time_ops_compare_ciphertexts_in_constant_time(libcrux_ml_kem_types_as_ref_d3_af(ciphertext),
...
- K= 4
*/
static Eurydice_arr_f9 call_mut_0b_40(void **_)
{
  return ZERO_d6_c5();
}
...
bool libcrux_ml_kem_ind_cca_validate_public_key_a1(Eurydice_arr_00 *public_key)
{
  Eurydice_arr_7f
  deserialized_pk =
    deserialize_ring_elements_reduced_out_40(Eurydice_array_to_subslice_to((size_t)1568U,
        public_key,
        libcrux_ml_kem_constants_ranked_bytes_per_ring_element((size_t)4U),
        uint8_t,
        size_t,
  ...
  Eurydice_arr_00
  public_key_serialized =
    serialize_public_key_a1(uu____0,
      Eurydice_array_to_subslice_from((size_t)1568U,
        public_key,
        libcrux_ml_kem_constants_ranked_bytes_per_ring_element((size_t)4U),
        uint8_t,
...
bool libcrux_ml_kem_ind_cca_validate_private_key_only_1f(Eurydice_arr_17 *private_key)
{
  Eurydice_arr_60
  t =
    H_2d_ac(Eurydice_array_to_subslice3(private_key,
...
generate_keypair_cb(Eurydice_slice key_generation_seed)
{
  ...
  libcrux_ml_kem_ind_cpa_unpacked_IndCpaPublicKeyUnpacked_56 public_key = default_8b_40();
...
*/
static KRML_MUSTINLINE void
serialize_kem_secret_key_mut_1f(
  Eurydice_slice private_key,
  Eurydice_slice public_key,
  Eurydice_slice implicit_rejection_value,
  Eurydice_arr_17 *serialized
...
- SERIALIZED_KEY_LEN= 3168
*/
static KRML_MUSTINLINE Eurydice_arr_17
...
)
{
  ...
  serialize_kem_secret_key_mut_1f(private_key, public_key, implicit_rejection_value, &out);
  return out;
}
...
libcrux_ml_kem_ind_cca_generate_keypair_58(libcrux_sha3_Sha3_512Digest *randomness)
{
  ...
  implicit_rejection_value =
    Eurydice_array_to_subslice_from((size_t)64U,
      ...
      uint8_t []);
  libcrux_ml_kem_utils_extraction_helper_Keypair1024
  uu____0 = generate_keypair_cb(ind_cpa_keypair_randomness);
  Eurydice_arr_38 ind_cpa_private_key = uu____0.fst;
  Eurydice_arr_00 public_key = uu____0.snd;
  Eurydice_arr_17
  secret_key_serialized =
    serialize_kem_secret_key_1f(Eurydice_array_to_slice((size_t)1536U,
        &ind_cpa_private_key,
        uint8_t),
      Eurydice_array_to_slice((size_t)1568U, &public_key, uint8_t),
      implicit_rejection_value);
  Eurydice_arr_17 private_key = libcrux_ml_kem_types_from_77_39(secret_key_serialized);
  return
    libcrux_ml_kem_types_from_17_94(private_key,
      libcrux_ml_kem_types_from_fd_af(public_key));
}
...
- K= 4
*/
static KRML_MUSTINLINE Eurydice_arr_60 entropy_preprocess_39_49(Eurydice_slice randomness)
{
  Eurydice_arr_60 out = { .data = { 0U } };
  Eurydice_slice_copy(Eurydice_array_to_slice((size_t)32U, &out, uint8_t), randomness, uint8_t);
  return out;
...
*/
static KRML_MUSTINLINE void
build_unpacked_public_key_mut_4f(
  Eurydice_slice public_key,
  libcrux_ml_kem_ind_cpa_unpacked_IndCpaPublicKeyUnpacked_56 *unpacked_public_key
)
{
...
- T_AS_NTT_ENCODED_SIZE= 1536
*/
static KRML_MUSTINLINE libcrux_ml_kem_ind_cpa_unpacked_IndCpaPublicKeyUnpacked_56
...
*/
static KRML_MUSTINLINE Eurydice_arr_00
encrypt_fa(Eurydice_slice public_key, Eurydice_arr_60 *message, Eurydice_slice randomness)
{
  libcrux_ml_kem_ind_cpa_unpacked_IndCpaPublicKeyUnpacked_56
...
libcrux_ml_kem_ind_cca_encapsulate_99(Eurydice_arr_00 *public_key, Eurydice_arr_60 *randomness)
{
  Eurydice_arr_60
  randomness0 =
    entropy_preprocess_39_49(Eurydice_array_to_slice((size_t)32U, randomness, uint8_t));
  libcrux_sha3_Sha3_512Digest
  to_hash =
    libcrux_ml_kem_utils_into_padded_array_24(Eurydice_array_to_slice((size_t)32U,
        &randomness0,
  ...
  Eurydice_slice_copy(uu____0, Eurydice_array_to_slice((size_t)32U, &lvalue, uint8_t), uint8_t);
  libcrux_sha3_Sha3_512Digest
  hashed = G_2d_ac(Eurydice_array_to_slice((size_t)64U, &to_hash, uint8_t));
  Eurydice_slice_uint8_t_x2
  uu____1 =
    Eurydice_slice_split_at(Eurydice_array_to_slice((size_t)64U, &hashed, uint8_t),
      LIBCRUX_ML_KEM_CONSTANTS_SHARED_SECRET_SIZE,
  ...
  Eurydice_arr_00
  ciphertext =
    encrypt_fa(Eurydice_array_to_slice((size_t)1568U,
        libcrux_ml_kem_types_as_slice_e6_af(public_key),
        uint8_t),
      &randomness0,
      pseudorandomness);
  Eurydice_arr_00 uu____2 = libcrux_ml_kem_types_from_e0_af(ciphertext);
  return (KRML_CLITERAL(tuple_2b){ .fst = uu____2, .snd = kdf_39_1f(shared_secret) });
}
...
- V_COMPRESSION_FACTOR= 5
*/
static Eurydice_arr_f9 call_mut_0b_21(void **_)
{
  return ZERO_d6_c5();
}
...
*/
static KRML_MUSTINLINE Eurydice_arr_60
decrypt_21(Eurydice_slice secret_key, Eurydice_arr_00 *ciphertext)
{
  Eurydice_arr_7f arr_struct;
  KRML_MAYBE_FOR4(i,
    (size_t)0U,
...
)
{
  ...
  Eurydice_slice shared_secret0 = uu____1.fst;
  Eurydice_slice pseudorandomness = uu____1.snd;
  Eurydice_arr_e7 to_hash = libcrux_ml_kem_utils_into_padded_array_7f(implicit_rejection_value);
  Eurydice_slice
  uu____2 =
    Eurydice_array_to_subslice_from((size_t)1600U,
      &to_hash,
  ...
  implicit_rejection_shared_secret0 =
    PRF_2d_44(Eurydice_array_to_slice((size_t)1600U, &to_hash, uint8_t));
  Eurydice_arr_00
  expected_ciphertext = encrypt_fa(ind_cpa_public_key, &decrypted, pseudorandomness);
  Eurydice_arr_60
  implicit_rejection_shared_secret =
    kdf_39_1f(Eurydice_array_to_slice((size_t)32U, &implicit_rejection_shared_secret0, uint8_t));
  Eurydice_arr_60 shared_secret = kdf_39_1f(shared_secret0);
  return
    libcrux_ml_kem_constant_time_ops_compare_ciphertexts_select_shared_secret_in_constant_time(libcrux_ml_kem_types_as_ref_d3_af(ciphertext),
      Eurydice_array_to_slice((size_t)1568U, &expected_ciphertext, uint8_t),
      Eurydice_array_to_slice((size_t)32U, &shared_secret, uint8_t),
      Eurydice_array_to_slice((size_t)32U, &implicit_rejection_shared_secret, uint8_t));
}
