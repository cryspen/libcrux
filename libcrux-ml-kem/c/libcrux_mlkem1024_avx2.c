...
*/
<<<<<<< HEAD
static void decapsulate_010(
    libcrux_ml_kem_types_MlKemPrivateKey_95 *private_key,
    libcrux_ml_kem_mlkem1024_MlKem1024Ciphertext *ciphertext,
    uint8_t ret[32U]) {
  libcrux_ml_kem_ind_cca_decapsulate_e20(private_key, ciphertext, ret);
}
...
void libcrux_ml_kem_mlkem1024_avx2_decapsulate(
    ...
    libcrux_ml_kem_mlkem1024_MlKem1024Ciphertext *ciphertext,
    uint8_t ret[32U]) {
  decapsulate_010(private_key, ciphertext, ret);
}
...
- IMPLICIT_REJECTION_HASH_INPUT_SIZE= 1600
*/
static void decapsulate_unpacked_300(
    libcrux_ml_kem_ind_cca_unpacked_MlKemKeyPairUnpacked_01 *key_pair,
    libcrux_ml_kem_mlkem1024_MlKem1024Ciphertext *ciphertext,
    uint8_t ret[32U]) {
  libcrux_ml_kem_ind_cca_unpacked_decapsulate_unpacked_d60(key_pair, ciphertext,
                                                           ret);
}
...
void libcrux_ml_kem_mlkem1024_avx2_decapsulate_unpacked(
    ...
    libcrux_ml_kem_mlkem1024_MlKem1024Ciphertext *ciphertext,
    uint8_t ret[32U]) {
  decapsulate_unpacked_300(private_key, ciphertext, ret);
=======
static void decapsulate_800(
    libcrux_ml_kem_types_MlKemPrivateKey_95 *private_key,
    libcrux_ml_kem_types_MlKemCiphertext_1f *ciphertext, uint8_t ret[32U]) {
  libcrux_ml_kem_ind_cca_decapsulate_970(private_key, ciphertext, ret);
}
...
void libcrux_ml_kem_mlkem1024_avx2_decapsulate(
    libcrux_ml_kem_types_MlKemPrivateKey_95 *private_key,
    libcrux_ml_kem_types_MlKemCiphertext_1f *ciphertext, uint8_t ret[32U]) {
  decapsulate_800(private_key, ciphertext, ret);
>>>>>>> main
}
...
*/
<<<<<<< HEAD
static tuple_21 encapsulate_d90(
=======
static tuple_21 encapsulate_4d0(
>>>>>>> main
...
=======
  return libcrux_ml_kem_ind_cca_encapsulate_9c0(uu____0, copy_of_randomness);
>>>>>>> main
}
...
tuple_21 libcrux_ml_kem_mlkem1024_avx2_encapsulate(
  ...
  memcpy(copy_of_randomness, randomness, (size_t)32U * sizeof(uint8_t));
<<<<<<< HEAD
  return encapsulate_d90(uu____0, copy_of_randomness);
}
...
tuple_21 libcrux_ml_kem_mlkem1024_avx2_encapsulate_unpacked(
  ...
  uint8_t copy_of_randomness[32U];
  memcpy(copy_of_randomness, randomness, (size_t)32U * sizeof(uint8_t));
  return encapsulate_unpacked_8b0(uu____0, copy_of_randomness);
}

=======
  return encapsulate_4d0(uu____0, copy_of_randomness);
}
...
*/
<<<<<<< HEAD
static libcrux_ml_kem_mlkem1024_MlKem1024KeyPair generate_keypair_500(
=======
static libcrux_ml_kem_mlkem1024_MlKem1024KeyPair generate_keypair_740(
>>>>>>> main
...
<<<<<<< HEAD
  return libcrux_ml_kem_ind_cca_generate_keypair_f70(copy_of_randomness);
}
...
libcrux_ml_kem_mlkem1024_avx2_generate_key_pair(uint8_t randomness[64U]) {
  ...
  uint8_t copy_of_randomness[64U];
  memcpy(copy_of_randomness, randomness, (size_t)64U * sizeof(uint8_t));
  return generate_keypair_500(copy_of_randomness);
}
...
libcrux_ml_kem_mlkem1024_avx2_generate_key_pair(uint8_t randomness[64U]) {
  ...
  uint8_t copy_of_randomness[64U];
  memcpy(copy_of_randomness, randomness, (size_t)64U * sizeof(uint8_t));
  return generate_keypair_740(copy_of_randomness);
}
...
generate_keypair_unpacked_5a0(uint8_t randomness[64U]) {
  /* Passing arrays by value in Rust generates a copy in C */
  uint8_t copy_of_randomness[64U];
  memcpy(copy_of_randomness, randomness, (size_t)64U * sizeof(uint8_t));
...
libcrux_ml_kem_mlkem1024_avx2_generate_key_pair_unpacked(
  ...
  uint8_t copy_of_randomness[64U];
  memcpy(copy_of_randomness, randomness, (size_t)64U * sizeof(uint8_t));
  return generate_keypair_unpacked_5a0(copy_of_randomness);
=======
static KRML_MUSTINLINE bool validate_private_key_2d0(
    libcrux_ml_kem_types_MlKemPrivateKey_95 *private_key,
    libcrux_ml_kem_types_MlKemCiphertext_1f *ciphertext) {
  return libcrux_ml_kem_ind_cca_validate_private_key_4d0(private_key,
                                                         ciphertext);
}
...
bool libcrux_ml_kem_mlkem1024_avx2_validate_private_key(
    libcrux_ml_kem_types_MlKemPrivateKey_95 *private_key,
    libcrux_ml_kem_types_MlKemCiphertext_1f *ciphertext) {
  return validate_private_key_2d0(private_key, ciphertext);
>>>>>>> main
}
...
*/
<<<<<<< HEAD
static bool validate_public_key_ae0(uint8_t *public_key) {
  return libcrux_ml_kem_ind_cca_validate_public_key_060(public_key);
=======
static KRML_MUSTINLINE bool validate_public_key_060(uint8_t *public_key) {
  return libcrux_ml_kem_ind_cca_validate_public_key_050(public_key);
>>>>>>> main
}
...
core_option_Option_99 libcrux_ml_kem_mlkem1024_avx2_validate_public_key(
  ...
  if (validate_public_key_ae0(public_key.value)) {
...
bool libcrux_ml_kem_mlkem1024_avx2_validate_public_key(
    libcrux_ml_kem_types_MlKemPublicKey_1f *public_key) {
  return validate_public_key_060(public_key->value);
>>>>>>> main
}
