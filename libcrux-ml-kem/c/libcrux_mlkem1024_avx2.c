...
*/
static tuple_fa
encapsulate_avx2_8f(libcrux_ml_kem_types_MlKemPublicKey_64 *public_key, uint8_t *randomness)
{
...
*/
static tuple_fa
encapsulate_8f(libcrux_ml_kem_types_MlKemPublicKey_64 *public_key, uint8_t *randomness)
{
...
- ETA1_RANDOMNESS_SIZE= 128
*/
static libcrux_ml_kem_mlkem1024_MlKem1024KeyPair generate_keypair_avx2_b4(uint8_t *randomness)
{
...
- ETA1_RANDOMNESS_SIZE= 128
*/
static libcrux_ml_kem_mlkem1024_MlKem1024KeyPair generate_keypair_b4(uint8_t *randomness)
{
...
*/
static bool
validate_private_key_avx2_6b(
  libcrux_ml_kem_types_MlKemPrivateKey_83 *private_key,
  libcrux_ml_kem_types_MlKemCiphertext_64 *ciphertext
)
{
  return libcrux_ml_kem_ind_cca_validate_private_key_b9(private_key, ciphertext);
}
...
validate_private_key_only_44(libcrux_ml_kem_types_MlKemPrivateKey_83 *private_key)
{
