 ...
 * Libcrux: ec0b40a5cfb28bd5ae47b7badde68e44897b20f3
 */
...
u64)}
*/
KRML_MUSTINLINE uint64_t libcrux_sha3_simd_portable_zero_38(void) {
  return 0ULL;
}
...
u64)}
*/
KRML_MUSTINLINE uint64_t libcrux_sha3_simd_portable_xor5_38(
    uint64_t a, uint64_t b, uint64_t c, uint64_t d, uint64_t e) {
...
u64)}
*/
KRML_MUSTINLINE uint64_t libcrux_sha3_simd_portable_and_not_xor_38(uint64_t a,
                                                                   uint64_t b,
                                                                   uint64_t c) {
...
u64)}
*/
KRML_MUSTINLINE uint64_t libcrux_sha3_simd_portable_xor_38(uint64_t a,
                                                           uint64_t b) {
  return a ^ b;
}
...
- N= 1
*/
KRML_MUSTINLINE uint64_t *libcrux_sha3_traits_get_ij_04(uint64_t *arr, size_t i,
                                                        size_t j) {
...
- N= 1
*/
KRML_MUSTINLINE void libcrux_sha3_traits_set_ij_04(uint64_t *arr, size_t i,
...
- RATE= 72
*/
void libcrux_sha3_simd_portable_load_block_16_f8(
...
- N= 1
*/
uint64_t *libcrux_sha3_generic_keccak_index_2b_04(
...
- N= 1
*/
KRML_MUSTINLINE void libcrux_sha3_generic_keccak_theta_rho_80_04(
...
- DELIMITER= 6
*/
void libcrux_sha3_simd_portable_load_last_16_96(
    libcrux_sha3_generic_keccak_KeccakState_17 *self, Eurydice_slice *input,
...
/**
This function found in impl {(libcrux_sha3::traits::Squeeze<u64, 1: usize> for
libcrux_sha3::generic_keccak::KeccakState<u64, 1:
usize>[core::marker::Sized<u64>,
libcrux_sha3::simd::portable::{libcrux_sha3::traits::KeccakItem<1: usize> for
u64}])#2}
...
- RATE= 72
*/
void libcrux_sha3_simd_portable_squeeze1_f8_f8(
...
inline void libcrux_sha3_generic_keccak_portable_keccak1_96(
  ...
  if (blocks == (size_t)0U) {
    ...
    for (size_t i = (size_t)1U; i < blocks; i++) {
      ...
      libcrux_sha3_simd_portable_squeeze1_f8_f8(&s, out, i0 * (size_t)72U,
                                                (size_t)72U);
    }
    if (last < outlen) {
      libcrux_sha3_generic_keccak_keccakf1600_80_04(&s);
...
- RATE= 136
*/
void libcrux_sha3_simd_portable_load_block_16_5b(
    libcrux_sha3_generic_keccak_KeccakState_17 *self, Eurydice_slice *input,
    size_t start) {
...
- DELIMITER= 6
*/
void libcrux_sha3_simd_portable_load_last_16_ad(
    libcrux_sha3_generic_keccak_KeccakState_17 *self, Eurydice_slice *input,
    size_t start, size_t len) {
...
- RATE= 136
*/
void libcrux_sha3_simd_portable_squeeze1_f8_5b(
    libcrux_sha3_generic_keccak_KeccakState_17 *self, Eurydice_slice out,
    size_t start, size_t len) {
...
inline void libcrux_sha3_generic_keccak_portable_keccak1_ad(
  ...
  if (blocks == (size_t)0U) {
    ...
    libcrux_sha3_simd_portable_squeeze1_f8_5b(&s, out, (size_t)0U,
                                              (size_t)136U);
    for (size_t i = (size_t)1U; i < blocks; i++) {
      size_t i0 = i;
      libcrux_sha3_generic_keccak_keccakf1600_80_04(&s);
      libcrux_sha3_simd_portable_squeeze1_f8_5b(&s, out, i0 * (size_t)136U,
                                                (size_t)136U);
    }
    if (last < outlen) {
      libcrux_sha3_generic_keccak_keccakf1600_80_04(&s);
...
- DELIMITER= 31
*/
void libcrux_sha3_simd_portable_load_last_16_ad0(
    libcrux_sha3_generic_keccak_KeccakState_17 *self, Eurydice_slice *input,
    size_t start, size_t len) {
...
*/
void libcrux_sha3_portable_shake256(Eurydice_slice digest,
                                    Eurydice_slice data) {
...
- DELIMITER= 31
*/
void libcrux_sha3_simd_portable_load_last_16_c6(
    libcrux_sha3_generic_keccak_KeccakState_17 *self, Eurydice_slice *input,
    size_t start, size_t len) {
...
- RATE= 168
*/
void libcrux_sha3_simd_portable_squeeze1_f8_3a(
    libcrux_sha3_generic_keccak_KeccakState_17 *self, Eurydice_slice out,
    size_t start, size_t len) {
...
libcrux_sha3_generic_keccak_portable_squeeze_first_three_blocks_0c_3a(
    libcrux_sha3_generic_keccak_KeccakState_17 *self, Eurydice_slice out) {
  libcrux_sha3_simd_portable_squeeze1_f8_3a(self, out, (size_t)0U,
                                            (size_t)168U);
  libcrux_sha3_generic_keccak_keccakf1600_80_04(self);
  libcrux_sha3_simd_portable_squeeze1_f8_3a(self, out, (size_t)168U,
                                            (size_t)168U);
  libcrux_sha3_generic_keccak_keccakf1600_80_04(self);
  libcrux_sha3_simd_portable_squeeze1_f8_3a(
      self, out, (size_t)2U * (size_t)168U, (size_t)168U);
}
...
- RATE= 144
*/
void libcrux_sha3_simd_portable_load_block_16_2c(
    libcrux_sha3_generic_keccak_KeccakState_17 *self, Eurydice_slice *input,
    size_t start) {
...
- DELIMITER= 6
*/
void libcrux_sha3_simd_portable_load_last_16_1e(
    libcrux_sha3_generic_keccak_KeccakState_17 *self, Eurydice_slice *input,
    size_t start, size_t len) {
...
- RATE= 144
*/
void libcrux_sha3_simd_portable_squeeze1_f8_2c(
    libcrux_sha3_generic_keccak_KeccakState_17 *self, Eurydice_slice out,
    size_t start, size_t len) {
...
inline void libcrux_sha3_generic_keccak_portable_keccak1_1e(
  ...
  if (blocks == (size_t)0U) {
    ...
    libcrux_sha3_simd_portable_squeeze1_f8_2c(&s, out, (size_t)0U,
                                              (size_t)144U);
    for (size_t i = (size_t)1U; i < blocks; i++) {
      size_t i0 = i;
      libcrux_sha3_generic_keccak_keccakf1600_80_04(&s);
      libcrux_sha3_simd_portable_squeeze1_f8_2c(&s, out, i0 * (size_t)144U,
                                                (size_t)144U);
    }
    if (last < outlen) {
      libcrux_sha3_generic_keccak_keccakf1600_80_04(&s);
...
*/
KRML_MUSTINLINE void libcrux_sha3_portable_sha224(Eurydice_slice digest,
                                                  Eurydice_slice data) {
...
- RATE= 104
*/
void libcrux_sha3_simd_portable_load_block_16_7a(
    libcrux_sha3_generic_keccak_KeccakState_17 *self, Eurydice_slice *input,
    size_t start) {
...
- DELIMITER= 6
*/
void libcrux_sha3_simd_portable_load_last_16_7c(
    libcrux_sha3_generic_keccak_KeccakState_17 *self, Eurydice_slice *input,
    size_t start, size_t len) {
...
- RATE= 104
*/
void libcrux_sha3_simd_portable_squeeze1_f8_7a(
    libcrux_sha3_generic_keccak_KeccakState_17 *self, Eurydice_slice out,
    size_t start, size_t len) {
...
inline void libcrux_sha3_generic_keccak_portable_keccak1_7c(
  ...
  if (blocks == (size_t)0U) {
    ...
    libcrux_sha3_simd_portable_squeeze1_f8_7a(&s, out, (size_t)0U,
                                              (size_t)104U);
    for (size_t i = (size_t)1U; i < blocks; i++) {
      size_t i0 = i;
      libcrux_sha3_generic_keccak_keccakf1600_80_04(&s);
      libcrux_sha3_simd_portable_squeeze1_f8_7a(&s, out, i0 * (size_t)104U,
                                                (size_t)104U);
    }
    if (last < outlen) {
      libcrux_sha3_generic_keccak_keccakf1600_80_04(&s);
...
*/
KRML_MUSTINLINE void libcrux_sha3_portable_sha384(Eurydice_slice digest,
                                                  Eurydice_slice data) {
...
- RATE= 168
*/
void libcrux_sha3_simd_portable_load_block_16_3a(
    libcrux_sha3_generic_keccak_KeccakState_17 *self, Eurydice_slice *input,
    size_t start) {
...
inline void libcrux_sha3_generic_keccak_portable_keccak1_c6(
  ...
  if (blocks == (size_t)0U) {
    ...
    libcrux_sha3_simd_portable_squeeze1_f8_3a(&s, out, (size_t)0U,
                                              (size_t)168U);
    for (size_t i = (size_t)1U; i < blocks; i++) {
      size_t i0 = i;
      libcrux_sha3_generic_keccak_keccakf1600_80_04(&s);
      libcrux_sha3_simd_portable_squeeze1_f8_3a(&s, out, i0 * (size_t)168U,
                                                (size_t)168U);
    }
    if (last < outlen) {
      libcrux_sha3_generic_keccak_keccakf1600_80_04(&s);
...
*/
KRML_MUSTINLINE void libcrux_sha3_portable_shake128(Eurydice_slice digest,
                                                    Eurydice_slice data) {
...
libcrux_sha3_generic_keccak_portable_squeeze_first_five_blocks_0c_3a(
  ...
  libcrux_sha3_generic_keccak_keccakf1600_80_04(self);
  libcrux_sha3_simd_portable_squeeze1_f8_3a(
      self, out, (size_t)3U * (size_t)168U, (size_t)168U);
  libcrux_sha3_generic_keccak_keccakf1600_80_04(self);
  libcrux_sha3_simd_portable_squeeze1_f8_3a(
      self, out, (size_t)4U * (size_t)168U, (size_t)168U);
}
...
libcrux_sha3_generic_keccak_portable_squeeze_first_block_0c_5b(
    libcrux_sha3_generic_keccak_KeccakState_17 *self, Eurydice_slice out) {
  libcrux_sha3_simd_portable_squeeze1_f8_5b(self, out, (size_t)0U,
                                            (size_t)136U);
}
...
- RATE= 136
*/
KRML_MUSTINLINE void libcrux_sha3_generic_keccak_xof_absorb_35_c6(
    libcrux_sha3_generic_keccak_xof_KeccakXofState_e2 *self,
    Eurydice_slice *inputs) {
...
*/
void libcrux_sha3_portable_incremental_absorb_68(
    libcrux_sha3_generic_keccak_xof_KeccakXofState_e2 *self,
...
- DELIMITER= 31
*/
KRML_MUSTINLINE void libcrux_sha3_generic_keccak_xof_absorb_final_35_9e(
    libcrux_sha3_generic_keccak_xof_KeccakXofState_e2 *self,
    Eurydice_slice *inputs) {
  ...
  libcrux_sha3_simd_portable_load_last_16_ad0(&self->inner, borrowed,
...
usize> for libcrux_sha3::portable::incremental::Shake256Xof)#1}
*/
void libcrux_sha3_portable_incremental_absorb_final_68(
    libcrux_sha3_generic_keccak_xof_KeccakXofState_e2 *self,
    Eurydice_slice input) {
  Eurydice_slice buf[1U] = {input};
...
- RATE= 136
*/
KRML_MUSTINLINE void libcrux_sha3_generic_keccak_xof_squeeze_df_c7(
    libcrux_sha3_generic_keccak_xof_KeccakXofState_e2 *self,
    Eurydice_slice out) {
  if (self->sponge) {
    libcrux_sha3_generic_keccak_keccakf1600_80_04(&self->inner);
  ...
  if (out_len > (size_t)0U) {
    if (out_len <= (size_t)136U) {
      libcrux_sha3_simd_portable_squeeze1_f8_5b(&self->inner, out, (size_t)0U,
                                                out_len);
    } else {
...
usize> for libcrux_sha3::portable::incremental::Shake256Xof)#1}
*/
void libcrux_sha3_portable_incremental_squeeze_68(
    libcrux_sha3_generic_keccak_xof_KeccakXofState_e2 *self,
    Eurydice_slice out) {
...
- RATE= 168
*/
KRML_MUSTINLINE void libcrux_sha3_generic_keccak_xof_absorb_35_c60(
    libcrux_sha3_generic_keccak_xof_KeccakXofState_97 *self,
    Eurydice_slice *inputs) {
  size_t input_remainder_len =
...
*/
void libcrux_sha3_portable_incremental_absorb_2f(
    libcrux_sha3_generic_keccak_xof_KeccakXofState_97 *self,
    Eurydice_slice input) {
  Eurydice_slice buf[1U] = {input};
...
- DELIMITER= 31
*/
KRML_MUSTINLINE void libcrux_sha3_generic_keccak_xof_absorb_final_35_9e0(
    libcrux_sha3_generic_keccak_xof_KeccakXofState_97 *self,
    Eurydice_slice *inputs) {
...
usize> for libcrux_sha3::portable::incremental::Shake128Xof)}
*/
void libcrux_sha3_portable_incremental_absorb_final_2f(
    libcrux_sha3_generic_keccak_xof_KeccakXofState_97 *self,
    Eurydice_slice input) {
  Eurydice_slice buf[1U] = {input};
...
- RATE= 168
*/
KRML_MUSTINLINE void libcrux_sha3_generic_keccak_xof_squeeze_df_13(
    libcrux_sha3_generic_keccak_xof_KeccakXofState_97 *self,
    Eurydice_slice out) {
  if (self->sponge) {
    libcrux_sha3_generic_keccak_keccakf1600_80_04(&self->inner);
  ...
  if (out_len > (size_t)0U) {
    if (out_len <= (size_t)168U) {
      libcrux_sha3_simd_portable_squeeze1_f8_3a(&self->inner, out, (size_t)0U,
                                                out_len);
    } else {
...
usize> for libcrux_sha3::portable::incremental::Shake128Xof)}
*/
void libcrux_sha3_portable_incremental_squeeze_2f(
    libcrux_sha3_generic_keccak_xof_KeccakXofState_97 *self,
    Eurydice_slice out) {
...
u32)#1}
*/
uint32_t libcrux_sha3_from_eb(libcrux_sha3_Algorithm v) {
...
*/
libcrux_sha3_Algorithm libcrux_sha3_from_2d(uint32_t v) {
  switch (v) {
    case 1U: {
      break;
    }
