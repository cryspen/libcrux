...
)
{
  ...
  compute_vector_u__libcrux_ml_kem_vector_PortableVector_3size_t(A_transpose,
    r_as_ntt,
    error_1,
    u);
  uint8_t uu____4[32U];
  ...
  libcrux_ml_kem_polynomial_PolynomialRingElement__libcrux_ml_kem_vector_PortableVector
  v =
    compute_ring_element_v__libcrux_ml_kem_vector_PortableVector_3size_t(t_as_ntt,
      r_as_ntt,
      &error_2,
      &message_as_ring_element);
...
)
{
  ...
  else
  {
    ...
    uu____2 =
      encapsulate_generic__libcrux_ml_kem_vector_PortableVector_libcrux_ml_kem_hash_functions_portable_PortableHash___3size_t___3size_t_1088size_t_1184size_t_1152size_t_960size_t_128size_t_10size_t_4size_t_320size_t_2size_t_128size_t_2size_t_128size_t(uu____5,
        uu____6);
    return uu____2;
  }
  return uu____2;
...
)
{
  ...
  memcpy(uu____1,
    ...
    *
      sizeof (libcrux_ml_kem_polynomial_PolynomialRingElement__libcrux_ml_kem_vector_PortableVector));
  uint8_t ret0[1152U];
  serialize_secret_key__libcrux_ml_kem_vector_PortableVector_3size_t_1152size_t(uu____1, ret0);
  core_slice___Slice_T___copy_from_slice(uu____0,
...
)
{
  ...
  sample_matrix_A__libcrux_ml_kem_vector_PortableVector_libcrux_ml_kem_hash_functions_portable_PortableHash___3size_t___3size_t(ret,
    true,
    A_transpose);
  uint8_t prf_input[33U];
  ...
  serialize_public_key__libcrux_ml_kem_vector_PortableVector_3size_t_1152size_t_1184size_t(uu____4,
    seed_for_A,
    public_key_serialized);
  libcrux_ml_kem_polynomial_PolynomialRingElement__libcrux_ml_kem_vector_PortableVector
  uu____5[3U];
  ...
  serialize_secret_key__libcrux_ml_kem_vector_PortableVector_3size_t_1152size_t(uu____5,
