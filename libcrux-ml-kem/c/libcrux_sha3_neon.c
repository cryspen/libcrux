...
/**
This function found in impl {libcrux_sha3::traits::KeccakItem<2usize> for
core::core_arch::arm_shared::neon::uint64x2_t}
*/
static KRML_MUSTINLINE uint64x2_t zero_f7(void) { return _vdupq_n_u64(0ULL); }
...
core::core_arch::arm_shared::neon::uint64x2_t}
*/
static KRML_MUSTINLINE uint64x2_t xor5_f7(uint64x2_t a, uint64x2_t b,
                                          uint64x2_t c, uint64x2_t d,
                                          uint64x2_t e) {
...
core::core_arch::arm_shared::neon::uint64x2_t}
*/
static KRML_MUSTINLINE uint64x2_t rotate_left1_and_xor_f7(uint64x2_t a,
                                                          uint64x2_t b) {
  return _vrax1q_u640(a, b);
}

static KRML_MUSTINLINE uint64x2_t _vbcaxq_u640(uint64x2_t a, uint64x2_t b,
                                               uint64x2_t c) {
...
core::core_arch::arm_shared::neon::uint64x2_t}
*/
static KRML_MUSTINLINE uint64x2_t and_not_xor_f7(uint64x2_t a, uint64x2_t b,
                                                 uint64x2_t c) {
...
- N= 2
*/
static KRML_MUSTINLINE uint64x2_t *get_ij_65(Eurydice_arr_fe *arr, size_t i,
                                             size_t j) {
...
- N= 2
*/
static KRML_MUSTINLINE void set_ij_65(Eurydice_arr_fe *arr, size_t i, size_t j,
                                      uint64x2_t value) {
...
- RATE= 72
*/
static KRML_MUSTINLINE void load_block_f8(Eurydice_arr_fe *s,
                                          Eurydice_arr_7d *blocks,
                                          size_t offset) {
  for (size_t i = (size_t)0U; i < (size_t)72U / (size_t)16U; i++) {
    size_t i2 = i;
    size_t start = offset + (size_t)16U * i2;
    uint64x2_t v0 = _vld1q_bytes_u64(Eurydice_slice_subslice3(
        blocks->data[0U], start, start + (size_t)16U, uint8_t *));
    uint64x2_t v1 = _vld1q_bytes_u64(Eurydice_slice_subslice3(
        blocks->data[1U], start, start + (size_t)16U, uint8_t *));
    ...
    set_ij_65(s, i0, j0,
              _veorq_u64(get_ij_65(s, i0, j0)[0U], _vtrn1q_u64(v0, v1)));
    set_ij_65(s, i1, j1,
              _veorq_u64(get_ij_65(s, i1, j1)[0U], _vtrn2q_u64(v0, v1)));
  }
  if ((size_t)72U % (size_t)16U != (size_t)0U) {
    ...
    Eurydice_slice_to_array2(
        ...
        Eurydice_slice_subslice3(blocks->data[0U], start, start + (size_t)8U,
                                 uint8_t *),
        Eurydice_slice, Eurydice_arr_c4, core_array_TryFromSliceError);
    ...
    uint64x2_t uvec =
        _vld1q_u64(Eurydice_array_to_slice((size_t)2U, &u, uint64_t));
    set_ij_65(
        s, i / (size_t)5U, i % (size_t)5U,
        _veorq_u64(get_ij_65(s, i / (size_t)5U, i % (size_t)5U)[0U], uvec));
  }
}

/**
This function found in impl {libcrux_sha3::traits::Absorb<2usize> for
libcrux_sha3::generic_keccak::KeccakState<core::core_arch::arm_shared::neon::uint64x2_t,
2usize>[core::marker::Sized<core::core_arch::arm_shared::neon::uint64x2_t>,
libcrux_sha3::simd::arm64::{libcrux_sha3::traits::KeccakItem<2usize> for
core::core_arch::arm_shared::neon::uint64x2_t}]}
*/
/**
...
- RATE= 72
*/
static void load_block_3e_f8(Eurydice_arr_fe *self, Eurydice_arr_7d *input,
                             size_t start) {
...
- RIGHT= 28
*/
static KRML_MUSTINLINE uint64x2_t xor_and_rotate_f7_02(uint64x2_t a,
                                                       uint64x2_t b) {
...
- RIGHT= 61
*/
static KRML_MUSTINLINE uint64x2_t xor_and_rotate_f7_ac(uint64x2_t a,
                                                       uint64x2_t b) {
...
- RIGHT= 23
*/
static KRML_MUSTINLINE uint64x2_t xor_and_rotate_f7_020(uint64x2_t a,
                                                        uint64x2_t b) {
...
- RIGHT= 46
*/
static KRML_MUSTINLINE uint64x2_t xor_and_rotate_f7_a9(uint64x2_t a,
                                                       uint64x2_t b) {
...
- RIGHT= 63
*/
static KRML_MUSTINLINE uint64x2_t xor_and_rotate_f7_76(uint64x2_t a,
                                                       uint64x2_t b) {
...
- RIGHT= 20
*/
static KRML_MUSTINLINE uint64x2_t xor_and_rotate_f7_58(uint64x2_t a,
                                                       uint64x2_t b) {
...
- RIGHT= 54
*/
static KRML_MUSTINLINE uint64x2_t xor_and_rotate_f7_e0(uint64x2_t a,
                                                       uint64x2_t b) {
...
- RIGHT= 19
*/
static KRML_MUSTINLINE uint64x2_t xor_and_rotate_f7_63(uint64x2_t a,
                                                       uint64x2_t b) {
...
- RIGHT= 62
*/
static KRML_MUSTINLINE uint64x2_t xor_and_rotate_f7_6a(uint64x2_t a,
                                                       uint64x2_t b) {
...
- RIGHT= 2
*/
static KRML_MUSTINLINE uint64x2_t xor_and_rotate_f7_ab(uint64x2_t a,
                                                       uint64x2_t b) {
...
- RIGHT= 58
*/
static KRML_MUSTINLINE uint64x2_t xor_and_rotate_f7_5b(uint64x2_t a,
                                                       uint64x2_t b) {
...
- RIGHT= 21
*/
static KRML_MUSTINLINE uint64x2_t xor_and_rotate_f7_6f(uint64x2_t a,
                                                       uint64x2_t b) {
...
- RIGHT= 49
*/
static KRML_MUSTINLINE uint64x2_t xor_and_rotate_f7_62(uint64x2_t a,
                                                       uint64x2_t b) {
...
- RIGHT= 3
*/
static KRML_MUSTINLINE uint64x2_t xor_and_rotate_f7_23(uint64x2_t a,
                                                       uint64x2_t b) {
...
- RIGHT= 36
*/
static KRML_MUSTINLINE uint64x2_t xor_and_rotate_f7_37(uint64x2_t a,
                                                       uint64x2_t b) {
...
- RIGHT= 9
*/
static KRML_MUSTINLINE uint64x2_t xor_and_rotate_f7_bb(uint64x2_t a,
                                                       uint64x2_t b) {
...
- RIGHT= 39
*/
static KRML_MUSTINLINE uint64x2_t xor_and_rotate_f7_b9(uint64x2_t a,
                                                       uint64x2_t b) {
...
- RIGHT= 43
*/
static KRML_MUSTINLINE uint64x2_t xor_and_rotate_f7_54(uint64x2_t a,
                                                       uint64x2_t b) {
...
- RIGHT= 8
*/
static KRML_MUSTINLINE uint64x2_t xor_and_rotate_f7_4c(uint64x2_t a,
                                                       uint64x2_t b) {
...
- RIGHT= 37
*/
static KRML_MUSTINLINE uint64x2_t xor_and_rotate_f7_ce(uint64x2_t a,
                                                       uint64x2_t b) {
...
- RIGHT= 44
*/
static KRML_MUSTINLINE uint64x2_t xor_and_rotate_f7_77(uint64x2_t a,
                                                       uint64x2_t b) {
...
- RIGHT= 25
*/
static KRML_MUSTINLINE uint64x2_t xor_and_rotate_f7_25(uint64x2_t a,
                                                       uint64x2_t b) {
...
- RIGHT= 56
*/
static KRML_MUSTINLINE uint64x2_t xor_and_rotate_f7_af(uint64x2_t a,
                                                       uint64x2_t b) {
...
- RIGHT= 50
*/
static KRML_MUSTINLINE uint64x2_t xor_and_rotate_f7_fd(uint64x2_t a,
                                                       uint64x2_t b) {
...
static KRML_MUSTINLINE void theta_rho_80_65(Eurydice_arr_fe *self) {
  Eurydice_arr_4d c = {
      .data = {
          xor5_f7(
              index_c2_65(self, (KRML_CLITERAL(size_t_x2){
  ...
  set_80_65(
      ...
      xor_f7(index_c2_65(self, (KRML_CLITERAL(size_t_x2){
                                   .fst = (size_t)0U, .snd = (size_t)0U}))[0U],
             t.data[0U]));
  set_80_65(
      self, (size_t)1U, (size_t)0U,
      xor_and_rotate_f7_02(
          index_c2_65(self, (KRML_CLITERAL(size_t_x2){.fst = (size_t)1U,
                                                      .snd = (size_t)0U}))[0U],
          t.data[0U]));
  set_80_65(
      self, (size_t)2U, (size_t)0U,
      xor_and_rotate_f7_ac(
          index_c2_65(self, (KRML_CLITERAL(size_t_x2){.fst = (size_t)2U,
                                                      .snd = (size_t)0U}))[0U],
          t.data[0U]));
  set_80_65(
      self, (size_t)3U, (size_t)0U,
      xor_and_rotate_f7_020(
          index_c2_65(self, (KRML_CLITERAL(size_t_x2){.fst = (size_t)3U,
                                                      .snd = (size_t)0U}))[0U],
          t.data[0U]));
  set_80_65(
      self, (size_t)4U, (size_t)0U,
      xor_and_rotate_f7_a9(
          index_c2_65(self, (KRML_CLITERAL(size_t_x2){.fst = (size_t)4U,
                                                      .snd = (size_t)0U}))[0U],
          t.data[0U]));
  set_80_65(
      self, (size_t)0U, (size_t)1U,
      xor_and_rotate_f7_76(
          index_c2_65(self, (KRML_CLITERAL(size_t_x2){.fst = (size_t)0U,
                                                      .snd = (size_t)1U}))[0U],
          t.data[1U]));
  set_80_65(
      self, (size_t)1U, (size_t)1U,
      xor_and_rotate_f7_58(
          index_c2_65(self, (KRML_CLITERAL(size_t_x2){.fst = (size_t)1U,
                                                      .snd = (size_t)1U}))[0U],
          t.data[1U]));
  set_80_65(
      self, (size_t)2U, (size_t)1U,
      xor_and_rotate_f7_e0(
          index_c2_65(self, (KRML_CLITERAL(size_t_x2){.fst = (size_t)2U,
                                                      .snd = (size_t)1U}))[0U],
          t.data[1U]));
  set_80_65(
      self, (size_t)3U, (size_t)1U,
      xor_and_rotate_f7_63(
          index_c2_65(self, (KRML_CLITERAL(size_t_x2){.fst = (size_t)3U,
                                                      .snd = (size_t)1U}))[0U],
          t.data[1U]));
  set_80_65(
      self, (size_t)4U, (size_t)1U,
      xor_and_rotate_f7_6a(
          index_c2_65(self, (KRML_CLITERAL(size_t_x2){.fst = (size_t)4U,
                                                      .snd = (size_t)1U}))[0U],
          t.data[1U]));
  set_80_65(
      self, (size_t)0U, (size_t)2U,
      xor_and_rotate_f7_ab(
          index_c2_65(self, (KRML_CLITERAL(size_t_x2){.fst = (size_t)0U,
                                                      .snd = (size_t)2U}))[0U],
          t.data[2U]));
  set_80_65(
      self, (size_t)1U, (size_t)2U,
      xor_and_rotate_f7_5b(
          index_c2_65(self, (KRML_CLITERAL(size_t_x2){.fst = (size_t)1U,
                                                      .snd = (size_t)2U}))[0U],
          t.data[2U]));
  set_80_65(
      self, (size_t)2U, (size_t)2U,
      xor_and_rotate_f7_6f(
          index_c2_65(self, (KRML_CLITERAL(size_t_x2){.fst = (size_t)2U,
                                                      .snd = (size_t)2U}))[0U],
          t.data[2U]));
  set_80_65(
      self, (size_t)3U, (size_t)2U,
      xor_and_rotate_f7_62(
          index_c2_65(self, (KRML_CLITERAL(size_t_x2){.fst = (size_t)3U,
                                                      .snd = (size_t)2U}))[0U],
          t.data[2U]));
  set_80_65(
      self, (size_t)4U, (size_t)2U,
      xor_and_rotate_f7_23(
          index_c2_65(self, (KRML_CLITERAL(size_t_x2){.fst = (size_t)4U,
                                                      .snd = (size_t)2U}))[0U],
          t.data[2U]));
  set_80_65(
      self, (size_t)0U, (size_t)3U,
      xor_and_rotate_f7_37(
          index_c2_65(self, (KRML_CLITERAL(size_t_x2){.fst = (size_t)0U,
                                                      .snd = (size_t)3U}))[0U],
          t.data[3U]));
  set_80_65(
      self, (size_t)1U, (size_t)3U,
      xor_and_rotate_f7_bb(
          index_c2_65(self, (KRML_CLITERAL(size_t_x2){.fst = (size_t)1U,
                                                      .snd = (size_t)3U}))[0U],
          t.data[3U]));
  set_80_65(
      self, (size_t)2U, (size_t)3U,
      xor_and_rotate_f7_b9(
          index_c2_65(self, (KRML_CLITERAL(size_t_x2){.fst = (size_t)2U,
                                                      .snd = (size_t)3U}))[0U],
          t.data[3U]));
  set_80_65(
      self, (size_t)3U, (size_t)3U,
      xor_and_rotate_f7_54(
          index_c2_65(self, (KRML_CLITERAL(size_t_x2){.fst = (size_t)3U,
                                                      .snd = (size_t)3U}))[0U],
          t.data[3U]));
  set_80_65(
      self, (size_t)4U, (size_t)3U,
      xor_and_rotate_f7_4c(
          index_c2_65(self, (KRML_CLITERAL(size_t_x2){.fst = (size_t)4U,
                                                      .snd = (size_t)3U}))[0U],
          t.data[3U]));
  set_80_65(
      self, (size_t)0U, (size_t)4U,
      xor_and_rotate_f7_ce(
          index_c2_65(self, (KRML_CLITERAL(size_t_x2){.fst = (size_t)0U,
                                                      .snd = (size_t)4U}))[0U],
          t.data[4U]));
  set_80_65(
      self, (size_t)1U, (size_t)4U,
      xor_and_rotate_f7_77(
          index_c2_65(self, (KRML_CLITERAL(size_t_x2){.fst = (size_t)1U,
                                                      .snd = (size_t)4U}))[0U],
          t.data[4U]));
  set_80_65(
      self, (size_t)2U, (size_t)4U,
      xor_and_rotate_f7_25(
          index_c2_65(self, (KRML_CLITERAL(size_t_x2){.fst = (size_t)2U,
                                                      .snd = (size_t)4U}))[0U],
          t.data[4U]));
  set_80_65(
      self, (size_t)3U, (size_t)4U,
      xor_and_rotate_f7_af(
          index_c2_65(self, (KRML_CLITERAL(size_t_x2){.fst = (size_t)3U,
                                                      .snd = (size_t)4U}))[0U],
          t.data[4U]));
  set_80_65(
      self, (size_t)4U, (size_t)4U,
      xor_and_rotate_f7_fd(
          index_c2_65(self, (KRML_CLITERAL(size_t_x2){.fst = (size_t)4U,
                                                      .snd = (size_t)4U}))[0U],
          t.data[4U]));
}
...
static KRML_MUSTINLINE void pi_80_65(Eurydice_arr_fe *self) {
  ...
  set_80_65(self, (size_t)1U, (size_t)0U,
            index_c2_65(&old, (KRML_CLITERAL(size_t_x2){
                                  .fst = (size_t)0U, .snd = (size_t)3U}))[0U]);
  set_80_65(self, (size_t)2U, (size_t)0U,
            index_c2_65(&old, (KRML_CLITERAL(size_t_x2){
                                  .fst = (size_t)0U, .snd = (size_t)1U}))[0U]);
  set_80_65(self, (size_t)3U, (size_t)0U,
            index_c2_65(&old, (KRML_CLITERAL(size_t_x2){
                                  .fst = (size_t)0U, .snd = (size_t)4U}))[0U]);
  set_80_65(self, (size_t)4U, (size_t)0U,
            index_c2_65(&old, (KRML_CLITERAL(size_t_x2){
                                  .fst = (size_t)0U, .snd = (size_t)2U}))[0U]);
  set_80_65(self, (size_t)0U, (size_t)1U,
            index_c2_65(&old, (KRML_CLITERAL(size_t_x2){
                                  .fst = (size_t)1U, .snd = (size_t)1U}))[0U]);
  set_80_65(self, (size_t)1U, (size_t)1U,
            index_c2_65(&old, (KRML_CLITERAL(size_t_x2){
                                  .fst = (size_t)1U, .snd = (size_t)4U}))[0U]);
  set_80_65(self, (size_t)2U, (size_t)1U,
            index_c2_65(&old, (KRML_CLITERAL(size_t_x2){
                                  .fst = (size_t)1U, .snd = (size_t)2U}))[0U]);
  set_80_65(self, (size_t)3U, (size_t)1U,
            index_c2_65(&old, (KRML_CLITERAL(size_t_x2){
                                  .fst = (size_t)1U, .snd = (size_t)0U}))[0U]);
  set_80_65(self, (size_t)4U, (size_t)1U,
            index_c2_65(&old, (KRML_CLITERAL(size_t_x2){
                                  .fst = (size_t)1U, .snd = (size_t)3U}))[0U]);
  set_80_65(self, (size_t)0U, (size_t)2U,
            index_c2_65(&old, (KRML_CLITERAL(size_t_x2){
                                  .fst = (size_t)2U, .snd = (size_t)2U}))[0U]);
  set_80_65(self, (size_t)1U, (size_t)2U,
            index_c2_65(&old, (KRML_CLITERAL(size_t_x2){
                                  .fst = (size_t)2U, .snd = (size_t)0U}))[0U]);
  set_80_65(self, (size_t)2U, (size_t)2U,
            index_c2_65(&old, (KRML_CLITERAL(size_t_x2){
                                  .fst = (size_t)2U, .snd = (size_t)3U}))[0U]);
  set_80_65(self, (size_t)3U, (size_t)2U,
            index_c2_65(&old, (KRML_CLITERAL(size_t_x2){
                                  .fst = (size_t)2U, .snd = (size_t)1U}))[0U]);
  set_80_65(self, (size_t)4U, (size_t)2U,
            index_c2_65(&old, (KRML_CLITERAL(size_t_x2){
                                  .fst = (size_t)2U, .snd = (size_t)4U}))[0U]);
  set_80_65(self, (size_t)0U, (size_t)3U,
            index_c2_65(&old, (KRML_CLITERAL(size_t_x2){
                                  .fst = (size_t)3U, .snd = (size_t)3U}))[0U]);
  set_80_65(self, (size_t)1U, (size_t)3U,
            index_c2_65(&old, (KRML_CLITERAL(size_t_x2){
                                  .fst = (size_t)3U, .snd = (size_t)1U}))[0U]);
  set_80_65(self, (size_t)2U, (size_t)3U,
            index_c2_65(&old, (KRML_CLITERAL(size_t_x2){
                                  .fst = (size_t)3U, .snd = (size_t)4U}))[0U]);
  set_80_65(self, (size_t)3U, (size_t)3U,
            index_c2_65(&old, (KRML_CLITERAL(size_t_x2){
                                  .fst = (size_t)3U, .snd = (size_t)2U}))[0U]);
  set_80_65(self, (size_t)4U, (size_t)3U,
            index_c2_65(&old, (KRML_CLITERAL(size_t_x2){
                                  .fst = (size_t)3U, .snd = (size_t)0U}))[0U]);
  set_80_65(self, (size_t)0U, (size_t)4U,
            index_c2_65(&old, (KRML_CLITERAL(size_t_x2){
                                  .fst = (size_t)4U, .snd = (size_t)4U}))[0U]);
  set_80_65(self, (size_t)1U, (size_t)4U,
            index_c2_65(&old, (KRML_CLITERAL(size_t_x2){
                                  .fst = (size_t)4U, .snd = (size_t)2U}))[0U]);
  set_80_65(self, (size_t)2U, (size_t)4U,
            index_c2_65(&old, (KRML_CLITERAL(size_t_x2){
                                  .fst = (size_t)4U, .snd = (size_t)0U}))[0U]);
  set_80_65(self, (size_t)3U, (size_t)4U,
            index_c2_65(&old, (KRML_CLITERAL(size_t_x2){
                                  .fst = (size_t)4U, .snd = (size_t)3U}))[0U]);
  set_80_65(self, (size_t)4U, (size_t)4U,
            index_c2_65(&old, (KRML_CLITERAL(size_t_x2){
...
- RATE= 72
*/
static KRML_MUSTINLINE void absorb_block_80_20(Eurydice_arr_fe *self,
                                               Eurydice_arr_7d *blocks,
                                               size_t start) {
...
- DELIMITER= 6
*/
static KRML_MUSTINLINE void load_last_96(Eurydice_arr_fe *state,
                                         Eurydice_arr_7d *blocks, size_t offset,
                                         size_t len) {
  Eurydice_arr_a0 buffer0 = {.data = {0U}};
  Eurydice_slice_copy(
      Eurydice_array_to_subslice3(&buffer0, (size_t)0U, len, uint8_t *),
      Eurydice_slice_subslice3(blocks->data[0U], offset, offset + len,
                               uint8_t *),
      uint8_t);
  buffer0.data[len] = 6U;
  ...
  Eurydice_slice_copy(
      Eurydice_array_to_subslice3(&buffer1, (size_t)0U, len, uint8_t *),
      Eurydice_slice_subslice3(blocks->data[1U], offset, offset + len,
                               uint8_t *),
      uint8_t);
  buffer1.data[len] = 6U;
  ...
  Eurydice_arr_7d lvalue = {
      .data = {Eurydice_array_to_slice((size_t)72U, &buffer0, uint8_t),
               Eurydice_array_to_slice((size_t)72U, &buffer1, uint8_t)}};
...
- DELIMITER= 6
*/
static void load_last_3e_96(Eurydice_arr_fe *self, Eurydice_arr_7d *input,
...
- DELIM= 6
*/
static KRML_MUSTINLINE void absorb_final_80_76(Eurydice_arr_fe *self,
                                               Eurydice_arr_7d *last,
                                               size_t start, size_t len) {
...
- RATE= 72
*/
static KRML_MUSTINLINE void store_block_f8(Eurydice_arr_fe *s,
                                           Eurydice_slice out0,
                                           Eurydice_slice out1, size_t start,
                                           size_t len) {
  for (size_t i = (size_t)0U; i < len / (size_t)16U; i++) {
    ...
    size_t j1 = ((size_t)2U * i2 + (size_t)1U) % (size_t)5U;
    uint64x2_t v0 =
        _vtrn1q_u64(get_ij_65(s, i0, j0)[0U], get_ij_65(s, i1, j1)[0U]);
    uint64x2_t v1 =
        _vtrn2q_u64(get_ij_65(s, i0, j0)[0U], get_ij_65(s, i1, j1)[0U]);
    _vst1q_bytes_u64(Eurydice_slice_subslice3(
                         out0, start + (size_t)16U * i2,
                         start + (size_t)16U * (i2 + (size_t)1U), uint8_t *),
                     v0);
    _vst1q_bytes_u64(Eurydice_slice_subslice3(
                         out1, start + (size_t)16U * i2,
                         start + (size_t)16U * (i2 + (size_t)1U), uint8_t *),
                     v1);
  }
  ...
  if (remaining > (size_t)8U) {
    ...
    uint64x2_t v1 =
        _vtrn2q_u64(get_ij_65(s, i0, j0)[0U], get_ij_65(s, i1, j1)[0U]);
    _vst1q_bytes_u64(Eurydice_array_to_slice((size_t)16U, &out0_tmp, uint8_t),
                     v0);
    _vst1q_bytes_u64(Eurydice_array_to_slice((size_t)16U, &out1_tmp, uint8_t),
                     v1);
    Eurydice_slice_copy(Eurydice_slice_subslice3(out0, start + len - remaining,
                                                 start + len, uint8_t *),
                        Eurydice_array_to_subslice3(&out0_tmp, (size_t)0U,
                                                    remaining, uint8_t *),
                        uint8_t);
    Eurydice_slice_copy(Eurydice_slice_subslice3(out1, start + len - remaining,
                                                 start + len, uint8_t *),
                        Eurydice_array_to_subslice3(&out1_tmp, (size_t)0U,
                                                    remaining, uint8_t *),
                        uint8_t);
    ...
    Eurydice_slice_copy(
        Eurydice_slice_subslice3(out0, start + len - remaining, start + len,
                                 uint8_t *),
        Eurydice_array_to_subslice3(&out01, (size_t)0U, remaining, uint8_t *),
        uint8_t);
    Eurydice_slice_copy(
        Eurydice_slice_subslice3(out1, start + len - remaining, start + len,
                                 uint8_t *),
        Eurydice_array_to_subslice3(&out01, (size_t)8U, (size_t)8U + remaining,
                                    uint8_t *),
        uint8_t);
  }
}
...
{libcrux_sha3::traits::Squeeze2<core::core_arch::arm_shared::neon::uint64x2_t>
for
libcrux_sha3::generic_keccak::KeccakState<core::core_arch::arm_shared::neon::uint64x2_t,
2usize>[core::marker::Sized<core::core_arch::arm_shared::neon::uint64x2_t>,
libcrux_sha3::simd::arm64::{libcrux_sha3::traits::KeccakItem<2usize> for
...
- RATE= 72
*/
static void squeeze_d3_f8(Eurydice_arr_fe *self, Eurydice_slice out0,
                          Eurydice_slice out1, size_t start, size_t len) {
...
- DELIM= 6
*/
static inline void keccak2_96(Eurydice_arr_7d *data, Eurydice_slice out0,
                              Eurydice_slice out1) {
...
void libcrux_sha3_neon_sha512(Eurydice_slice digest, Eurydice_slice data) {
  ...
  keccak2_96(&uu____0, digest,
             Eurydice_array_to_slice((size_t)64U, &dummy, uint8_t));
}
...
- RATE= 136
*/
static KRML_MUSTINLINE void load_block_5b(Eurydice_arr_fe *s,
                                          Eurydice_arr_7d *blocks,
                                          size_t offset) {
...
- RATE= 136
*/
static void load_block_3e_5b(Eurydice_arr_fe *self, Eurydice_arr_7d *input,
                             size_t start) {
...
- RATE= 136
*/
static KRML_MUSTINLINE void absorb_block_80_200(Eurydice_arr_fe *self,
                                                Eurydice_arr_7d *blocks,
                                                size_t start) {
...
- DELIMITER= 6
*/
static KRML_MUSTINLINE void load_last_ad(Eurydice_arr_fe *state,
                                         Eurydice_arr_7d *blocks, size_t offset,
                                         size_t len) {
  ...
  /* original Rust expression is not an lvalue in C */
  Eurydice_arr_7d lvalue = {
      .data = {Eurydice_array_to_slice((size_t)136U, &buffer0, uint8_t),
               Eurydice_array_to_slice((size_t)136U, &buffer1, uint8_t)}};
...
- DELIMITER= 6
*/
static void load_last_3e_ad(Eurydice_arr_fe *self, Eurydice_arr_7d *input,
                            size_t start, size_t len) {
...
- DELIM= 6
*/
static KRML_MUSTINLINE void absorb_final_80_760(Eurydice_arr_fe *self,
                                                Eurydice_arr_7d *last,
                                                size_t start, size_t len) {
...
- RATE= 136
*/
static KRML_MUSTINLINE void store_block_5b(Eurydice_arr_fe *s,
                                           Eurydice_slice out0,
                                           Eurydice_slice out1, size_t start,
                                           size_t len) {
  for (size_t i = (size_t)0U; i < len / (size_t)16U; i++) {
...
- RATE= 136
*/
static void squeeze_d3_5b(Eurydice_arr_fe *self, Eurydice_slice out0,
                          Eurydice_slice out1, size_t start, size_t len) {
...
- DELIM= 6
*/
static inline void keccak2_ad(Eurydice_arr_7d *data, Eurydice_slice out0,
                              Eurydice_slice out1) {
  Eurydice_arr_fe s = new_80_65();
  size_t data_len = Eurydice_slice_len(data->data[0U], uint8_t);
...
- DELIMITER= 31
*/
static KRML_MUSTINLINE void load_last_ad0(Eurydice_arr_fe *state,
                                          Eurydice_arr_7d *blocks,
...
- DELIMITER= 31
*/
static void load_last_3e_ad0(Eurydice_arr_fe *self, Eurydice_arr_7d *input,
                             size_t start, size_t len) {
...
- DELIM= 31
*/
static KRML_MUSTINLINE void absorb_final_80_761(Eurydice_arr_fe *self,
                                                Eurydice_arr_7d *last,
                                                size_t start, size_t len) {
...
- DELIM= 31
*/
static inline void keccak2_ad0(Eurydice_arr_7d *data, Eurydice_slice out0,
                               Eurydice_slice out1) {
  Eurydice_arr_fe s = new_80_65();
  size_t data_len = Eurydice_slice_len(data->data[0U], uint8_t);
  for (size_t i = (size_t)0U; i < data_len / (size_t)136U; i++) {
...
- RATE= 168
*/
static KRML_MUSTINLINE void load_block_3a(Eurydice_arr_fe *s,
                                          Eurydice_arr_7d *blocks,
                                          size_t offset) {
...
- DELIMITER= 31
*/
static KRML_MUSTINLINE void load_last_c6(Eurydice_arr_fe *state,
                                         Eurydice_arr_7d *blocks, size_t offset,
                                         size_t len) {
  ...
  /* original Rust expression is not an lvalue in C */
  Eurydice_arr_7d lvalue = {
      .data = {Eurydice_array_to_slice((size_t)168U, &buffer0, uint8_t),
               Eurydice_array_to_slice((size_t)168U, &buffer1, uint8_t)}};
...
- DELIMITER= 31
*/
static void load_last_3e_c6(Eurydice_arr_fe *self, Eurydice_arr_7d *input,
                            size_t start, size_t len) {
...
- DELIM= 31
*/
static KRML_MUSTINLINE void absorb_final_80_762(Eurydice_arr_fe *self,
                                                Eurydice_arr_7d *last,
                                                size_t start, size_t len) {
...
void libcrux_sha3_neon_x2_incremental_shake128_absorb_final(
  ...
  absorb_final_80_762(uu____0, uu____1, (size_t)0U,
...
- RATE= 168
*/
static KRML_MUSTINLINE void store_block_3a(Eurydice_arr_fe *s,
                                           Eurydice_slice out0,
                                           Eurydice_slice out1, size_t start,
                                           size_t len) {
  for (size_t i = (size_t)0U; i < len / (size_t)16U; i++) {
...
- RATE= 168
*/
static void squeeze_d3_3a(Eurydice_arr_fe *self, Eurydice_slice out0,
                          Eurydice_slice out1, size_t start, size_t len) {
...
libcrux_sha3.generic_keccak.simd128.squeeze_first_three_blocks_7a with const
generics
- RATE= 168
*/
static KRML_MUSTINLINE void squeeze_first_three_blocks_7a_3a(
    Eurydice_arr_fe *self, Eurydice_slice out0, Eurydice_slice out1) {
...
/**
A monomorphic instance of
libcrux_sha3.generic_keccak.simd128.squeeze_next_block_7a with const generics
- RATE= 168
*/
static KRML_MUSTINLINE void squeeze_next_block_7a_3a(Eurydice_arr_fe *self,
                                                     Eurydice_slice out0,
                                                     Eurydice_slice out1,
                                                     size_t start) {
  keccakf1600_80_65(self);
...
- RATE= 144
*/
static KRML_MUSTINLINE void load_block_2c(Eurydice_arr_fe *s,
                                          Eurydice_arr_7d *blocks,
                                          size_t offset) {
...
- RATE= 144
*/
static void load_block_3e_2c(Eurydice_arr_fe *self, Eurydice_arr_7d *input,
                             size_t start) {
...
- RATE= 144
*/
static KRML_MUSTINLINE void absorb_block_80_201(Eurydice_arr_fe *self,
                                                Eurydice_arr_7d *blocks,
                                                size_t start) {
...
- DELIMITER= 6
*/
static KRML_MUSTINLINE void load_last_1e(Eurydice_arr_fe *state,
                                         Eurydice_arr_7d *blocks, size_t offset,
                                         size_t len) {
  ...
  /* original Rust expression is not an lvalue in C */
  Eurydice_arr_7d lvalue = {
      .data = {Eurydice_array_to_slice((size_t)144U, &buffer0, uint8_t),
               Eurydice_array_to_slice((size_t)144U, &buffer1, uint8_t)}};
...
- DELIMITER= 6
*/
static void load_last_3e_1e(Eurydice_arr_fe *self, Eurydice_arr_7d *input,
                            size_t start, size_t len) {
...
- DELIM= 6
*/
static KRML_MUSTINLINE void absorb_final_80_763(Eurydice_arr_fe *self,
                                                Eurydice_arr_7d *last,
                                                size_t start, size_t len) {
...
- RATE= 144
*/
static KRML_MUSTINLINE void store_block_2c(Eurydice_arr_fe *s,
                                           Eurydice_slice out0,
                                           Eurydice_slice out1, size_t start,
                                           size_t len) {
  for (size_t i = (size_t)0U; i < len / (size_t)16U; i++) {
...
- RATE= 144
*/
static void squeeze_d3_2c(Eurydice_arr_fe *self, Eurydice_slice out0,
                          Eurydice_slice out1, size_t start, size_t len) {
...
- DELIM= 6
*/
static inline void keccak2_1e(Eurydice_arr_7d *data, Eurydice_slice out0,
                              Eurydice_slice out1) {
  Eurydice_arr_fe s = new_80_65();
  size_t data_len = Eurydice_slice_len(data->data[0U], uint8_t);
...
KRML_MUSTINLINE void libcrux_sha3_neon_sha224(Eurydice_slice digest,
  ...
  Eurydice_arr_7d uu____0 = {.data = {data, data}};
  keccak2_1e(&uu____0, digest,
             Eurydice_array_to_slice((size_t)28U, &dummy, uint8_t));
}
...
- RATE= 104
*/
static KRML_MUSTINLINE void load_block_7a(Eurydice_arr_fe *s,
                                          Eurydice_arr_7d *blocks,
                                          size_t offset) {
...
- RATE= 104
*/
static void load_block_3e_7a(Eurydice_arr_fe *self, Eurydice_arr_7d *input,
                             size_t start) {
...
- RATE= 104
*/
static KRML_MUSTINLINE void absorb_block_80_202(Eurydice_arr_fe *self,
                                                Eurydice_arr_7d *blocks,
                                                size_t start) {
...
- DELIMITER= 6
*/
static KRML_MUSTINLINE void load_last_7c(Eurydice_arr_fe *state,
                                         Eurydice_arr_7d *blocks, size_t offset,
                                         size_t len) {
  ...
  /* original Rust expression is not an lvalue in C */
  Eurydice_arr_7d lvalue = {
      .data = {Eurydice_array_to_slice((size_t)104U, &buffer0, uint8_t),
               Eurydice_array_to_slice((size_t)104U, &buffer1, uint8_t)}};
...
- DELIMITER= 6
*/
static void load_last_3e_7c(Eurydice_arr_fe *self, Eurydice_arr_7d *input,
                            size_t start, size_t len) {
...
- DELIM= 6
*/
static KRML_MUSTINLINE void absorb_final_80_764(Eurydice_arr_fe *self,
                                                Eurydice_arr_7d *last,
                                                size_t start, size_t len) {
...
- RATE= 104
*/
static KRML_MUSTINLINE void store_block_7a(Eurydice_arr_fe *s,
                                           Eurydice_slice out0,
                                           Eurydice_slice out1, size_t start,
                                           size_t len) {
  for (size_t i = (size_t)0U; i < len / (size_t)16U; i++) {
...
- RATE= 104
*/
static void squeeze_d3_7a(Eurydice_arr_fe *self, Eurydice_slice out0,
                          Eurydice_slice out1, size_t start, size_t len) {
...
- DELIM= 6
*/
static inline void keccak2_7c(Eurydice_arr_7d *data, Eurydice_slice out0,
                              Eurydice_slice out1) {
  Eurydice_arr_fe s = new_80_65();
  size_t data_len = Eurydice_slice_len(data->data[0U], uint8_t);
...
KRML_MUSTINLINE void libcrux_sha3_neon_sha384(Eurydice_slice digest,
  ...
  Eurydice_arr_7d uu____0 = {.data = {data, data}};
  keccak2_7c(&uu____0, digest,
             Eurydice_array_to_slice((size_t)48U, &dummy, uint8_t));
}
...
/**
A monomorphic instance of
libcrux_sha3.generic_keccak.simd128.squeeze_first_five_blocks_7a with const
generics
- RATE= 168
*/
static KRML_MUSTINLINE void squeeze_first_five_blocks_7a_3a(
    Eurydice_arr_fe *self, Eurydice_slice out0, Eurydice_slice out1) {
  squeeze_d3_3a(self, out0, out1, (size_t)0U, (size_t)168U);
  keccakf1600_80_65(self);
  squeeze_d3_3a(self, out0, out1, (size_t)168U, (size_t)168U);
...
KRML_MUSTINLINE void libcrux_sha3_neon_x2_incremental_shake256_absorb_final(
  ...
  Eurydice_arr_7d lvalue = {.data = {data0, data1}};
  Eurydice_arr_7d *uu____1 = &lvalue;
  absorb_final_80_761(uu____0, uu____1, (size_t)0U,
                      Eurydice_slice_len(data0, uint8_t));
}
...
/**
A monomorphic instance of
libcrux_sha3.generic_keccak.simd128.squeeze_first_block_7a with const generics
- RATE= 136
*/
static void squeeze_first_block_7a_5b(Eurydice_arr_fe *self,
                                      Eurydice_slice out0,
                                      Eurydice_slice out1) {
...
- RATE= 136
*/
static KRML_MUSTINLINE void squeeze_next_block_7a_5b(Eurydice_arr_fe *self,
                                                     Eurydice_slice out0,
                                                     Eurydice_slice out1,
                                                     size_t start) {
  keccakf1600_80_65(self);
