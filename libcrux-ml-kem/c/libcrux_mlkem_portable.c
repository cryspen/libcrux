...
*/
static KRML_MUSTINLINE tuple_711 sample_vector_cbd_then_ntt_011(
...
*/
static tuple_541 generate_keypair_unpacked_a91(
  ...
  tuple_711 uu____2 = sample_vector_cbd_then_ntt_011(uu____1, 0U);
  ...
  memcpy(
      ...
      (size_t)4U * sizeof(libcrux_ml_kem_polynomial_PolynomialRingElement_f0));
  return (CLITERAL(tuple_541){.fst = sk, .snd = pk});
}
...
libcrux_ml_kem_ind_cca_generate_keypair_unpacked_0d1(uint8_t randomness[64U]) {
  ...
  tuple_541 uu____0 = generate_keypair_unpacked_a91(ind_cpa_keypair_randomness);
...
static libcrux_ml_kem_utils_extraction_helper_Keypair1024 generate_keypair_e81(
    Eurydice_slice key_generation_seed) {
  tuple_541 uu____0 = generate_keypair_unpacked_a91(key_generation_seed);
...
- ETA2= 2
*/
static KRML_MUSTINLINE tuple_711
...
static void encrypt_unpacked_651(
  ...
  uint8_t uu____0[33U];
  memcpy(uu____0, prf_input, (size_t)33U * sizeof(uint8_t));
  tuple_711 uu____1 = sample_vector_cbd_then_ntt_011(uu____0, 0U);
  ...
  tuple_711 uu____3 = sample_ring_element_cbd_381(uu____2, domain_separator0);
  libcrux_ml_kem_polynomial_PolynomialRingElement_f0 error_1[4U];
  memcpy(
      error_1, uu____3.fst,
      (size_t)4U * sizeof(libcrux_ml_kem_polynomial_PolynomialRingElement_f0));
...
*/
static KRML_MUSTINLINE tuple_740 sample_vector_cbd_then_ntt_010(
    uint8_t prf_input[33U], uint8_t domain_separator) {
...
*/
static tuple_4c0 generate_keypair_unpacked_a90(
    Eurydice_slice key_generation_seed) {
  uint8_t hashed[64U];
  ...
  uint8_t uu____1[33U];
  memcpy(uu____1, prf_input, (size_t)33U * sizeof(uint8_t));
  tuple_740 uu____2 = sample_vector_cbd_then_ntt_010(uu____1, 0U);
...
libcrux_ml_kem_ind_cca_generate_keypair_unpacked_0d0(uint8_t randomness[64U]) {
  ...
  Eurydice_slice implicit_rejection_value0 = Eurydice_array_to_subslice_from(
      ...
      LIBCRUX_ML_KEM_CONSTANTS_CPA_PKE_KEY_GENERATION_SEED_SIZE, uint8_t,
      size_t, Eurydice_slice);
  tuple_4c0 uu____0 = generate_keypair_unpacked_a90(ind_cpa_keypair_randomness);
...
static libcrux_ml_kem_utils_extraction_helper_Keypair512 generate_keypair_e80(
    Eurydice_slice key_generation_seed) {
  tuple_4c0 uu____0 = generate_keypair_unpacked_a90(key_generation_seed);
...
static void encrypt_unpacked_650(
  ...
  uint8_t uu____0[33U];
  memcpy(uu____0, prf_input, (size_t)33U * sizeof(uint8_t));
  tuple_740 uu____1 = sample_vector_cbd_then_ntt_010(uu____0, 0U);
  ...
  uint8_t uu____2[33U];
  memcpy(uu____2, prf_input, (size_t)33U * sizeof(uint8_t));
  tuple_740 uu____3 = sample_ring_element_cbd_380(uu____2, domain_separator0);
  libcrux_ml_kem_polynomial_PolynomialRingElement_f0 error_1[2U];
  memcpy(
      error_1, uu____3.fst,
      (size_t)2U * sizeof(libcrux_ml_kem_polynomial_PolynomialRingElement_f0));
