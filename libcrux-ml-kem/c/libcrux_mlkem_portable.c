...
*/
static libcrux_ml_kem_polynomial_PolynomialRingElement_f0 ZERO_89_02(void) {
...
deserialize_to_reduced_ring_element_d2(Eurydice_slice serialized) {
  libcrux_ml_kem_polynomial_PolynomialRingElement_f0 re = ZERO_89_02();
  for (size_t i = (size_t)0U;
       i <
...
- K= 4
*/
static KRML_MUSTINLINE void deserialize_ring_elements_reduced_524(
  ...
  for (size_t i = (size_t)0U;
    ...
    libcrux_ml_kem_polynomial_PolynomialRingElement_f0 uu____0 =
        deserialize_to_reduced_ring_element_d2(ring_element);
...
*/
static KRML_MUSTINLINE void serialize_uncompressed_ring_element_05(
  ...
  for (size_t i = (size_t)0U;
    ...
    size_t i0 = i;
    libcrux_ml_kem_vector_portable_vector_type_PortableVector coefficient =
        to_unsigned_representative_af(re->coefficients[i0]);
    uint8_t bytes[24U];
...
- OUT_LEN= 1536
*/
static KRML_MUSTINLINE void serialize_secret_key_e81(
  ...
  for (size_t i = (size_t)0U;
    ...
    Eurydice_slice uu____0 = Eurydice_array_to_subslice2(
        ...
        uint8_t, Eurydice_slice);
    uint8_t ret0[384U];
    serialize_uncompressed_ring_element_05(&re, ret0);
    core_slice___Slice_T___copy_from_slice(
        uu____0,
...
- PUBLIC_KEY_SIZE= 1568
*/
static KRML_MUSTINLINE void serialize_public_key_9a1(
  ...
  uint8_t ret0[1536U];
  serialize_secret_key_e81(t_as_ntt, ret0);
  core_slice___Slice_T___copy_from_slice(
      uu____0,
...
bool libcrux_ml_kem_ind_cca_validate_public_key_991(uint8_t *public_key) {
  libcrux_ml_kem_polynomial_PolynomialRingElement_f0 deserialized_pk[4U];
  deserialize_ring_elements_reduced_524(
...
*/
static KRML_MUSTINLINE libcrux_ml_kem_polynomial_PolynomialRingElement_f0
from_i16_array_89_48(Eurydice_slice a) {
  libcrux_ml_kem_polynomial_PolynomialRingElement_f0 result = ZERO_89_02();
  for (size_t i = (size_t)0U;
       i < LIBCRUX_ML_KEM_POLYNOMIAL_VECTORS_IN_RING_ELEMENT; i++) {
    size_t i0 = i;
    libcrux_ml_kem_vector_portable_vector_type_PortableVector uu____0 =
...
static libcrux_ml_kem_polynomial_PolynomialRingElement_f0 closure_131(
    int16_t s[272U]) {
  return from_i16_array_89_48(Eurydice_array_to_subslice2(
...
*/
static KRML_MUSTINLINE libcrux_ml_kem_polynomial_PolynomialRingElement_f0
sample_from_binomial_distribution_2_c8(Eurydice_slice randomness) {
  ...
  return from_i16_array_89_48(Eurydice_array_to_slice(
...
*/
static KRML_MUSTINLINE libcrux_ml_kem_polynomial_PolynomialRingElement_f0
sample_from_binomial_distribution_3_b8(Eurydice_slice randomness) {
  int16_t sampled_i16s[256U] = {0U};
  for (size_t i0 = (size_t)0U;
       i0 <
...
sample_from_binomial_distribution_e3(Eurydice_slice randomness) {
  return sample_from_binomial_distribution_2_c8(randomness);
}
...
*/
static KRML_MUSTINLINE void ntt_at_layer_7_1c(
...
static KRML_MUSTINLINE
    libcrux_ml_kem_vector_portable_vector_type_PortableVector_x2
    ntt_layer_int_vec_step_a6(
        libcrux_ml_kem_vector_portable_vector_type_PortableVector a,
        libcrux_ml_kem_vector_portable_vector_type_PortableVector b,
        int16_t zeta_r) {
  libcrux_ml_kem_vector_portable_vector_type_PortableVector t =
      montgomery_multiply_fe_29(b, zeta_r);
...
*/
static KRML_MUSTINLINE void ntt_at_layer_4_plus_c0(
...
*/
static KRML_MUSTINLINE void ntt_at_layer_2_46(
    size_t *zeta_i, libcrux_ml_kem_polynomial_PolynomialRingElement_f0 *re) {
  KRML_MAYBE_FOR16(
      i, (size_t)0U, (size_t)16U, (size_t)1U, size_t round = i;
      zeta_i[0U] = zeta_i[0U] + (size_t)1U;
...
*/
static KRML_MUSTINLINE void ntt_at_layer_1_c9(
    size_t *zeta_i, libcrux_ml_kem_polynomial_PolynomialRingElement_f0 *re) {
  KRML_MAYBE_FOR16(
      i, (size_t)0U, (size_t)16U, (size_t)1U, size_t round = i;
      zeta_i[0U] = zeta_i[0U] + (size_t)1U;
...
*/
static KRML_MUSTINLINE void poly_barrett_reduce_89_55(
...
static KRML_MUSTINLINE void ntt_binomially_sampled_ring_element_d5(
    libcrux_ml_kem_polynomial_PolynomialRingElement_f0 *re) {
  ntt_at_layer_7_1c(re);
  size_t zeta_i = (size_t)1U;
  ntt_at_layer_4_plus_c0(&zeta_i, re, (size_t)6U);
  ntt_at_layer_4_plus_c0(&zeta_i, re, (size_t)5U);
  ntt_at_layer_4_plus_c0(&zeta_i, re, (size_t)4U);
  ntt_at_layer_3_c1(&zeta_i, re);
  ntt_at_layer_2_46(&zeta_i, re);
  ntt_at_layer_1_c9(&zeta_i, re);
  poly_barrett_reduce_89_55(re);
}
...
*/
static KRML_MUSTINLINE libcrux_ml_kem_polynomial_PolynomialRingElement_f0
ntt_multiply_89_f7(libcrux_ml_kem_polynomial_PolynomialRingElement_f0 *self,
                   libcrux_ml_kem_polynomial_PolynomialRingElement_f0 *rhs) {
  libcrux_ml_kem_polynomial_PolynomialRingElement_f0 out = ZERO_89_02();
  for (size_t i = (size_t)0U;
       i < LIBCRUX_ML_KEM_POLYNOMIAL_VECTORS_IN_RING_ELEMENT; i++) {
    size_t i0 = i;
    libcrux_ml_kem_vector_portable_vector_type_PortableVector uu____0 =
...
- K= 4
*/
static KRML_MUSTINLINE void add_to_ring_element_89_8e1(
    libcrux_ml_kem_polynomial_PolynomialRingElement_f0 *self,
    libcrux_ml_kem_polynomial_PolynomialRingElement_f0 *rhs) {
  for (size_t i = (size_t)0U;
       i < core_slice___Slice_T___len(
...
*/
static KRML_MUSTINLINE void add_standard_error_reduce_89_0b(
    libcrux_ml_kem_polynomial_PolynomialRingElement_f0 *self,
  ...
  for (size_t i = (size_t)0U;
    ...
    size_t j = i;
    libcrux_ml_kem_vector_portable_vector_type_PortableVector
        coefficient_normal_form = to_standard_domain_a1(self->coefficients[j]);
    libcrux_ml_kem_vector_portable_vector_type_PortableVector uu____0 =
        libcrux_ml_kem_vector_portable_barrett_reduce_0d(
...
- K= 4
*/
static KRML_MUSTINLINE void compute_As_plus_e_a51(
  ...
  for (size_t i0 = (size_t)0U;
    ...
    for (size_t i = (size_t)0U;
      ...
      libcrux_ml_kem_polynomial_PolynomialRingElement_f0 product =
          ntt_multiply_89_f7(matrix_element, &s_as_ntt[j]);
      add_to_ring_element_89_8e1(&result[i1], &product);
    }
    add_standard_error_reduce_89_0b(&result[i1], &error_as_ntt[i1]);
  }
  memcpy(
      ret, result,
      (size_t)4U * sizeof(libcrux_ml_kem_polynomial_PolynomialRingElement_f0));
...
*/
static tuple_540 generate_keypair_unpacked_a91(
  ...
  tuple_710 uu____2 = sample_vector_cbd_then_ntt_011(uu____1, 0U);
  ...
  memcpy(
      error_as_ntt,
      sample_vector_cbd_then_ntt_011(uu____3, domain_separator).fst,
      (size_t)4U * sizeof(libcrux_ml_kem_polynomial_PolynomialRingElement_f0));
  libcrux_ml_kem_polynomial_PolynomialRingElement_f0 t_as_ntt[4U];
  compute_As_plus_e_a51(A_transpose, secret_as_ntt, error_as_ntt, t_as_ntt);
...
*/
static inline libcrux_ml_kem_polynomial_PolynomialRingElement_f0 clone_d5_22(
    libcrux_ml_kem_polynomial_PolynomialRingElement_f0 *self) {
  libcrux_ml_kem_polynomial_PolynomialRingElement_f0 lit;
...
libcrux_ml_kem_ind_cca_unpacked_generate_keypair_unpacked_281(
  ...
  tuple_540 uu____0 = generate_keypair_unpacked_a91(ind_cpa_keypair_randomness);
...
- ETA1_RANDOMNESS_SIZE= 128
*/
static libcrux_ml_kem_utils_extraction_helper_Keypair1024 generate_keypair_e81(
    Eurydice_slice key_generation_seed) {
  tuple_540 uu____0 = generate_keypair_unpacked_a91(key_generation_seed);
  ...
  uint8_t public_key_serialized[1568U];
  serialize_public_key_9a1(pk.t_as_ntt,
                           Eurydice_array_to_slice((size_t)32U, pk.seed_for_A,
                                                   uint8_t, Eurydice_slice),
                           public_key_serialized);
  uint8_t secret_key_serialized[1536U];
  serialize_secret_key_e81(sk.secret_as_ntt, secret_key_serialized);
...
*/
static KRML_MUSTINLINE void serialize_kem_secret_key_6b(
...
libcrux_ml_kem_ind_cca_generate_keypair_6f1(uint8_t randomness[64U]) {
  ...
  libcrux_ml_kem_utils_extraction_helper_Keypair1024 uu____0 =
      generate_keypair_e81(ind_cpa_keypair_randomness);
  ...
  libcrux_ml_kem_types_MlKemPrivateKey_95 private_key =
      libcrux_ml_kem_types_from_e7_e00(uu____1);
  ...
  return libcrux_ml_kem_types_from_64_2c0(
      uu____2, libcrux_ml_kem_types_from_07_570(uu____3));
}
...
*/
static KRML_MUSTINLINE void invert_ntt_at_layer_2_84(
    size_t *zeta_i, libcrux_ml_kem_polynomial_PolynomialRingElement_f0 *re) {
  KRML_MAYBE_FOR16(
      i, (size_t)0U, (size_t)16U, (size_t)1U, size_t round = i;
      zeta_i[0U] = zeta_i[0U] - (size_t)1U;
...
*/
static KRML_MUSTINLINE void invert_ntt_at_layer_3_75(
    size_t *zeta_i, libcrux_ml_kem_polynomial_PolynomialRingElement_f0 *re) {
  KRML_MAYBE_FOR16(
      i, (size_t)0U, (size_t)16U, (size_t)1U, size_t round = i;
      zeta_i[0U] = zeta_i[0U] - (size_t)1U;
...
static KRML_MUSTINLINE
  ...
  b = montgomery_multiply_fe_29(a_minus_b, zeta_r);
  return (
      CLITERAL(libcrux_ml_kem_vector_portable_vector_type_PortableVector_x2){
          .fst = a, .snd = b});
}
...
*/
static KRML_MUSTINLINE void invert_ntt_at_layer_4_plus_0f(
    size_t *zeta_i, libcrux_ml_kem_polynomial_PolynomialRingElement_f0 *re,
    size_t layer) {
  size_t step = (size_t)1U << (uint32_t)layer;
  for (size_t i0 = (size_t)0U; i0 < (size_t)128U >> (uint32_t)layer; i0++) {
...
- K= 4
*/
static KRML_MUSTINLINE void invert_ntt_montgomery_d41(
    libcrux_ml_kem_polynomial_PolynomialRingElement_f0 *re) {
  size_t zeta_i =
      LIBCRUX_ML_KEM_CONSTANTS_COEFFICIENTS_IN_RING_ELEMENT / (size_t)2U;
  invert_ntt_at_layer_1_2a(&zeta_i, re);
  invert_ntt_at_layer_2_84(&zeta_i, re);
  invert_ntt_at_layer_3_75(&zeta_i, re);
  invert_ntt_at_layer_4_plus_0f(&zeta_i, re, (size_t)4U);
  invert_ntt_at_layer_4_plus_0f(&zeta_i, re, (size_t)5U);
  invert_ntt_at_layer_4_plus_0f(&zeta_i, re, (size_t)6U);
  invert_ntt_at_layer_4_plus_0f(&zeta_i, re, (size_t)7U);
  poly_barrett_reduce_89_55(re);
}
...
*/
static KRML_MUSTINLINE void add_error_reduce_89_b9(
    libcrux_ml_kem_polynomial_PolynomialRingElement_f0 *self,
    libcrux_ml_kem_polynomial_PolynomialRingElement_f0 *error) {
  for (size_t i = (size_t)0U;
       i < LIBCRUX_ML_KEM_POLYNOMIAL_VECTORS_IN_RING_ELEMENT; i++) {
...
- K= 4
*/
static KRML_MUSTINLINE void compute_vector_u_571(
  ...
  for (size_t i0 = (size_t)0U;
    ...
    for (size_t i = (size_t)0U;
      ...
      libcrux_ml_kem_polynomial_PolynomialRingElement_f0 product =
          ntt_multiply_89_f7(a_element, &r_as_ntt[j]);
      add_to_ring_element_89_8e1(&result[i1], &product);
    }
    invert_ntt_montgomery_d41(&result[i1]);
    add_error_reduce_89_b9(&result[i1], &error_1[i1]);
  }
  memcpy(
      ret, result,
      (size_t)4U * sizeof(libcrux_ml_kem_polynomial_PolynomialRingElement_f0));
...
*/
static libcrux_ml_kem_vector_portable_vector_type_PortableVector
decompress_1_e9(libcrux_ml_kem_vector_portable_vector_type_PortableVector v) {
  libcrux_ml_kem_vector_portable_vector_type_PortableVector uu____0 =
          ...
          coefficient_compressed =
              libcrux_ml_kem_vector_portable_deserialize_1_0d(
                  Eurydice_array_to_subslice2(serialized, (size_t)2U * i0,
                                              ...
                                              uint8_t, Eurydice_slice));
      libcrux_ml_kem_vector_portable_vector_type_PortableVector uu____0 =
          decompress_1_e9(coefficient_compressed);
      re.coefficients[i0] = uu____0;);
  return re;
}
...
*/
static KRML_MUSTINLINE libcrux_ml_kem_polynomial_PolynomialRingElement_f0
add_message_error_reduce_89_11(
    libcrux_ml_kem_polynomial_PolynomialRingElement_f0 *self,
...
compute_ring_element_v_c81(
  ...
  KRML_MAYBE_FOR4(i, (size_t)0U, (size_t)4U, (size_t)1U, size_t i0 = i;
                  libcrux_ml_kem_polynomial_PolynomialRingElement_f0 product =
                      ntt_multiply_89_f7(&t_as_ntt[i0], &r_as_ntt[i0]);
                  add_to_ring_element_89_8e1(&result, &product););
  invert_ntt_montgomery_d41(&result);
  result = add_message_error_reduce_89_11(error_2, message, result);
  return result;
}
...
static KRML_MUSTINLINE void compress_then_serialize_11_2d0(
  ...
  for (size_t i = (size_t)0U;
    ...
    size_t i0 = i;
    libcrux_ml_kem_vector_portable_vector_type_PortableVector coefficient =
        compress_0d_9b0(to_unsigned_representative_af(re->coefficients[i0]));
    uint8_t bytes[22U];
...
- OUT_LEN= 352
*/
static KRML_MUSTINLINE void compress_then_serialize_ring_element_u_d80(
    libcrux_ml_kem_polynomial_PolynomialRingElement_f0 *re, uint8_t ret[352U]) {
  uint8_t uu____0[352U];
  compress_then_serialize_11_2d0(re, uu____0);
...
- BLOCK_LEN= 352
*/
static void compress_then_serialize_u_251(
  ...
  for (size_t i = (size_t)0U;
    ...
    Eurydice_slice uu____0 = Eurydice_slice_subslice2(
        ...
        Eurydice_slice);
    uint8_t ret[352U];
    compress_then_serialize_ring_element_u_d80(&re, ret);
    core_slice___Slice_T___copy_from_slice(
        uu____0,
...
*/
static KRML_MUSTINLINE void compress_then_serialize_4_09(
    libcrux_ml_kem_polynomial_PolynomialRingElement_f0 re,
  ...
  for (size_t i = (size_t)0U;
    ...
    size_t i0 = i;
    libcrux_ml_kem_vector_portable_vector_type_PortableVector coefficient =
        compress_0d_9b1(to_unsigned_representative_af(re.coefficients[i0]));
    uint8_t bytes[8U];
...
*/
static KRML_MUSTINLINE void compress_then_serialize_5_b9(
    libcrux_ml_kem_polynomial_PolynomialRingElement_f0 re,
    Eurydice_slice serialized) {
  for (size_t i = (size_t)0U;
       i < LIBCRUX_ML_KEM_POLYNOMIAL_VECTORS_IN_RING_ELEMENT; i++) {
    ...
    libcrux_ml_kem_vector_portable_vector_type_PortableVector coefficients =
        compress_0d_9b2(to_unsigned_representative_af(re.coefficients[i0]));
    uint8_t bytes[10U];
...
- OUT_LEN= 160
*/
static KRML_MUSTINLINE void compress_then_serialize_ring_element_v_d60(
    libcrux_ml_kem_polynomial_PolynomialRingElement_f0 re, Eurydice_slice out) {
  compress_then_serialize_5_b9(re, out);
}
...
- ETA2_RANDOMNESS_SIZE= 128
*/
static void encrypt_unpacked_651(
  ...
  uint8_t uu____0[33U];
  memcpy(uu____0, prf_input, (size_t)33U * sizeof(uint8_t));
  tuple_710 uu____1 = sample_vector_cbd_then_ntt_011(uu____0, 0U);
  ...
  tuple_710 uu____3 = sample_ring_element_cbd_381(uu____2, domain_separator0);
  libcrux_ml_kem_polynomial_PolynomialRingElement_f0 error_1[4U];
  memcpy(
      error_1, uu____3.fst,
      (size_t)4U * sizeof(libcrux_ml_kem_polynomial_PolynomialRingElement_f0));
  ...
  compute_vector_u_571(public_key->A, r_as_ntt, error_1, u);
  uint8_t uu____4[32U];
  ...
  libcrux_ml_kem_polynomial_PolynomialRingElement_f0 message_as_ring_element =
      deserialize_then_decompress_message_cb(uu____4);
  libcrux_ml_kem_polynomial_PolynomialRingElement_f0 v =
      compute_ring_element_v_c81(public_key->t_as_ntt, r_as_ntt, &error_2,
  ...
  compress_then_serialize_ring_element_v_d60(
      uu____6,
...
tuple_21 libcrux_ml_kem_ind_cca_unpacked_encapsulate_unpacked_a11(
  ...
  encrypt_unpacked_651(uu____2, uu____3, pseudorandomness, ciphertext);
  ...
  libcrux_ml_kem_mlkem1024_MlKem1024Ciphertext uu____5 =
      libcrux_ml_kem_types_from_15_200(uu____4);
  uint8_t uu____6[32U];
...
- K= 4
*/
static KRML_MUSTINLINE void entropy_preprocess_af_46(Eurydice_slice randomness,
                                                     uint8_t ret[32U]) {
  core_result_Result_00 dst;
...
- K= 4
*/
static KRML_MUSTINLINE void deserialize_ring_elements_reduced_523(
    Eurydice_slice public_key,
    libcrux_ml_kem_polynomial_PolynomialRingElement_f0 ret[4U]) {
  libcrux_ml_kem_polynomial_PolynomialRingElement_f0 deserialized_pk[4U];
  KRML_MAYBE_FOR4(i, (size_t)0U, (size_t)4U, (size_t)1U,
...
- ETA2_RANDOMNESS_SIZE= 128
*/
static void encrypt_f71(Eurydice_slice public_key, uint8_t message[32U],
                        Eurydice_slice randomness, uint8_t ret[1568U]) {
  libcrux_ml_kem_polynomial_PolynomialRingElement_f0 t_as_ntt[4U];
  deserialize_ring_elements_reduced_523(
  ...
  memcpy(uu____4, message, (size_t)32U * sizeof(uint8_t));
  uint8_t ret1[1568U];
  encrypt_unpacked_651(uu____3, uu____4, randomness, ret1);
...
- ETA2_RANDOMNESS_SIZE= 128
*/
tuple_21 libcrux_ml_kem_ind_cca_encapsulate_9d1(
    libcrux_ml_kem_types_MlKemPublicKey_1f *public_key,
    uint8_t randomness[32U]) {
  uint8_t randomness0[32U];
  entropy_preprocess_af_46(
      Eurydice_array_to_slice((size_t)32U, randomness, uint8_t, Eurydice_slice),
      randomness0);
  uint8_t to_hash[64U];
  libcrux_ml_kem_utils_into_padded_array_97(
  ...
  H_f1_af1(Eurydice_array_to_slice(
               (size_t)1568U, libcrux_ml_kem_types_as_slice_f6_1f0(public_key),
               uint8_t, Eurydice_slice),
           ret);
  core_slice___Slice_T___copy_from_slice(
      uu____0,
  ...
  Eurydice_slice uu____2 = Eurydice_array_to_slice(
      (size_t)1568U, libcrux_ml_kem_types_as_slice_f6_1f0(public_key), uint8_t,
      Eurydice_slice);
  uint8_t uu____3[32U];
  memcpy(uu____3, randomness0, (size_t)32U * sizeof(uint8_t));
  uint8_t ciphertext[1568U];
  encrypt_f71(uu____2, uu____3, pseudorandomness, ciphertext);
  uint8_t uu____4[1568U];
  memcpy(uu____4, ciphertext, (size_t)1568U * sizeof(uint8_t));
...
*/
static KRML_MUSTINLINE libcrux_ml_kem_polynomial_PolynomialRingElement_f0
deserialize_then_decompress_10_26(Eurydice_slice serialized) {
  libcrux_ml_kem_polynomial_PolynomialRingElement_f0 re = ZERO_89_02();
  for (size_t i = (size_t)0U;
       i <
...
*/
static KRML_MUSTINLINE libcrux_ml_kem_polynomial_PolynomialRingElement_f0
deserialize_then_decompress_11_29(Eurydice_slice serialized) {
  libcrux_ml_kem_polynomial_PolynomialRingElement_f0 re = ZERO_89_02();
  for (size_t i = (size_t)0U;
       i <
...
*/
static KRML_MUSTINLINE libcrux_ml_kem_polynomial_PolynomialRingElement_f0
deserialize_then_decompress_ring_element_u_380(Eurydice_slice serialized) {
  return deserialize_then_decompress_11_29(serialized);
}
...
- VECTOR_U_COMPRESSION_FACTOR= 11
*/
static KRML_MUSTINLINE void ntt_vector_u_820(
    libcrux_ml_kem_polynomial_PolynomialRingElement_f0 *re) {
  size_t zeta_i = (size_t)0U;
  ntt_at_layer_4_plus_c0(&zeta_i, re, (size_t)7U);
  ntt_at_layer_4_plus_c0(&zeta_i, re, (size_t)6U);
  ntt_at_layer_4_plus_c0(&zeta_i, re, (size_t)5U);
  ntt_at_layer_4_plus_c0(&zeta_i, re, (size_t)4U);
  ntt_at_layer_3_c1(&zeta_i, re);
...
- U_COMPRESSION_FACTOR= 11
*/
static KRML_MUSTINLINE void deserialize_then_decompress_u_ec1(
    uint8_t *ciphertext,
    libcrux_ml_kem_polynomial_PolynomialRingElement_f0 ret[4U]) {
  libcrux_ml_kem_polynomial_PolynomialRingElement_f0 u_as_ntt[4U];
  KRML_MAYBE_FOR4(i, (size_t)0U, (size_t)4U, (size_t)1U,
                  u_as_ntt[i] = ZERO_89_02(););
  for (size_t i = (size_t)0U;
       i < core_slice___Slice_T___len(
    ...
    Eurydice_slice u_bytes = Eurydice_array_to_subslice2(
        ...
        uint8_t, Eurydice_slice);
    libcrux_ml_kem_polynomial_PolynomialRingElement_f0 uu____0 =
        deserialize_then_decompress_ring_element_u_380(u_bytes);
    u_as_ntt[i0] = uu____0;
    ntt_vector_u_820(&u_as_ntt[i0]);
  }
  memcpy(
      ret, u_as_ntt,
      (size_t)4U * sizeof(libcrux_ml_kem_polynomial_PolynomialRingElement_f0));
...
*/
static KRML_MUSTINLINE libcrux_ml_kem_polynomial_PolynomialRingElement_f0
deserialize_then_decompress_4_51(Eurydice_slice serialized) {
  libcrux_ml_kem_polynomial_PolynomialRingElement_f0 re = ZERO_89_02();
  for (size_t i = (size_t)0U;
...
*/
static KRML_MUSTINLINE libcrux_ml_kem_polynomial_PolynomialRingElement_f0
deserialize_then_decompress_5_bc(Eurydice_slice serialized) {
  libcrux_ml_kem_polynomial_PolynomialRingElement_f0 re = ZERO_89_02();
  for (size_t i = (size_t)0U;
       i <
...
*/
static KRML_MUSTINLINE libcrux_ml_kem_polynomial_PolynomialRingElement_f0
deserialize_then_decompress_ring_element_v_0b0(Eurydice_slice serialized) {
  return deserialize_then_decompress_5_bc(serialized);
}
...
*/
static KRML_MUSTINLINE libcrux_ml_kem_polynomial_PolynomialRingElement_f0
subtract_reduce_89_52(libcrux_ml_kem_polynomial_PolynomialRingElement_f0 *self,
...
compute_message_ac1(
  ...
  KRML_MAYBE_FOR4(i, (size_t)0U, (size_t)4U, (size_t)1U, size_t i0 = i;
                  libcrux_ml_kem_polynomial_PolynomialRingElement_f0 product =
                      ntt_multiply_89_f7(&secret_as_ntt[i0], &u_as_ntt[i0]);
                  add_to_ring_element_89_8e1(&result, &product););
  invert_ntt_montgomery_d41(&result);
  result = subtract_reduce_89_52(v, result);
  return result;
}
...
*/
static KRML_MUSTINLINE void compress_then_serialize_message_72(
...
- V_COMPRESSION_FACTOR= 5
*/
static void decrypt_unpacked_e51(
    libcrux_ml_kem_ind_cpa_unpacked_IndCpaPrivateKeyUnpacked_42 *secret_key,
    uint8_t *ciphertext, uint8_t ret[32U]) {
  libcrux_ml_kem_polynomial_PolynomialRingElement_f0 u_as_ntt[4U];
  deserialize_then_decompress_u_ec1(ciphertext, u_as_ntt);
  libcrux_ml_kem_polynomial_PolynomialRingElement_f0 v =
  ...
  uint8_t ret0[32U];
  compress_then_serialize_message_72(message, ret0);
...
*/
void libcrux_ml_kem_ind_cca_unpacked_decapsulate_unpacked_f51(
    libcrux_ml_kem_ind_cca_unpacked_MlKemKeyPairUnpacked_42 *key_pair,
    libcrux_ml_kem_mlkem1024_MlKem1024Ciphertext *ciphertext,
    uint8_t ret[32U]) {
  uint8_t decrypted[32U];
  decrypt_unpacked_e51(&key_pair->private_key.ind_cpa_private_key,
  ...
  Eurydice_slice uu____2 = Eurydice_array_to_subslice_from(
      ...
      uint8_t, size_t, Eurydice_slice);
  core_slice___Slice_T___copy_from_slice(
      uu____2, libcrux_ml_kem_types_as_ref_ba_2d0(ciphertext), uint8_t, void *);
  ...
  encrypt_unpacked_651(uu____3, uu____4, pseudorandomness, expected_ciphertext);
  uint8_t selector =
      libcrux_ml_kem_constant_time_ops_compare_ciphertexts_in_constant_time(
          libcrux_ml_kem_types_as_ref_ba_2d0(ciphertext),
...
*/
static KRML_MUSTINLINE libcrux_ml_kem_polynomial_PolynomialRingElement_f0
deserialize_to_uncompressed_ring_element_f5(Eurydice_slice serialized) {
  libcrux_ml_kem_polynomial_PolynomialRingElement_f0 re = ZERO_89_02();
  for (size_t i = (size_t)0U;
       i <
       core_slice___Slice_T___len(serialized, uint8_t, size_t) / (size_t)24U;
...
- K= 4
*/
static KRML_MUSTINLINE void deserialize_secret_key_491(
    Eurydice_slice secret_key,
    libcrux_ml_kem_polynomial_PolynomialRingElement_f0 ret[4U]) {
  libcrux_ml_kem_polynomial_PolynomialRingElement_f0 secret_as_ntt[4U];
  KRML_MAYBE_FOR4(i, (size_t)0U, (size_t)4U, (size_t)1U,
                  secret_as_ntt[i] = ZERO_89_02(););
  for (size_t i = (size_t)0U;
    ...
    Eurydice_slice secret_bytes = Eurydice_slice_subslice2(
        ...
        uint8_t, Eurydice_slice);
    libcrux_ml_kem_polynomial_PolynomialRingElement_f0 uu____0 =
        deserialize_to_uncompressed_ring_element_f5(secret_bytes);
...
- V_COMPRESSION_FACTOR= 5
*/
static void decrypt_5d1(Eurydice_slice secret_key, uint8_t *ciphertext,
                        uint8_t ret[32U]) {
  libcrux_ml_kem_polynomial_PolynomialRingElement_f0 secret_as_ntt[4U];
  deserialize_secret_key_491(secret_key, secret_as_ntt);
  libcrux_ml_kem_polynomial_PolynomialRingElement_f0 uu____0[4U];
  memcpy(
  ...
  memcpy(
      ...
      (size_t)4U * sizeof(libcrux_ml_kem_polynomial_PolynomialRingElement_f0));
  uint8_t ret0[32U];
  decrypt_unpacked_e51(&secret_key_unpacked, ciphertext, ret0);
  memcpy(ret, ret0, (size_t)32U * sizeof(uint8_t));
}
...
- IMPLICIT_REJECTION_HASH_INPUT_SIZE= 1600
*/
void libcrux_ml_kem_ind_cca_decapsulate_a01(
    libcrux_ml_kem_types_MlKemPrivateKey_95 *private_key,
    libcrux_ml_kem_mlkem1024_MlKem1024Ciphertext *ciphertext,
    uint8_t ret[32U]) {
  Eurydice_slice_uint8_t_x2 uu____0 = core_slice___Slice_T___split_at(
  ...
  uint8_t decrypted[32U];
  decrypt_5d1(ind_cpa_secret_key, ciphertext->value, decrypted);
  uint8_t to_hash0[64U];
  libcrux_ml_kem_utils_into_padded_array_97(
      Eurydice_array_to_slice((size_t)32U, decrypted, uint8_t, Eurydice_slice),
      to_hash0);
  ...
  Eurydice_slice uu____4 = Eurydice_array_to_subslice_from(
      ...
      uint8_t, size_t, Eurydice_slice);
  core_slice___Slice_T___copy_from_slice(
      uu____4, libcrux_ml_kem_types_as_ref_ba_2d0(ciphertext), uint8_t, void *);
  ...
  kdf_af_ab(shared_secret0, shared_secret1);
...
- K= 2
*/
static KRML_MUSTINLINE void deserialize_ring_elements_reduced_522(
    Eurydice_slice public_key,
...
- OUT_LEN= 768
*/
static KRML_MUSTINLINE void serialize_secret_key_e80(
    libcrux_ml_kem_polynomial_PolynomialRingElement_f0 *key,
    uint8_t ret[768U]) {
  uint8_t out[768U] = {0U};
  for (size_t i = (size_t)0U;
...
- PUBLIC_KEY_SIZE= 800
*/
static KRML_MUSTINLINE void serialize_public_key_9a0(
    libcrux_ml_kem_polynomial_PolynomialRingElement_f0 *t_as_ntt,
  ...
  uint8_t ret0[768U];
  serialize_secret_key_e80(t_as_ntt, ret0);
  core_slice___Slice_T___copy_from_slice(
      uu____0,
...
*/
static KRML_MUSTINLINE libcrux_ml_kem_polynomial_PolynomialRingElement_f0
sample_from_binomial_distribution_e30(Eurydice_slice randomness) {
  return sample_from_binomial_distribution_3_b8(randomness);
}
...
*/
static KRML_MUSTINLINE tuple_74 sample_vector_cbd_then_ntt_010(
    uint8_t prf_input[33U], uint8_t domain_separator) {
...
- K= 2
*/
static KRML_MUSTINLINE void add_to_ring_element_89_8e0(
    libcrux_ml_kem_polynomial_PolynomialRingElement_f0 *self,
    libcrux_ml_kem_polynomial_PolynomialRingElement_f0 *rhs) {
  for (size_t i = (size_t)0U;
       i < core_slice___Slice_T___len(
...
- K= 2
*/
static KRML_MUSTINLINE void compute_As_plus_e_a50(
  ...
  for (size_t i0 = (size_t)0U;
    ...
    for (size_t i = (size_t)0U;
      ...
      libcrux_ml_kem_polynomial_PolynomialRingElement_f0 product =
          ntt_multiply_89_f7(matrix_element, &s_as_ntt[j]);
      add_to_ring_element_89_8e0(&result[i1], &product);
    }
    add_standard_error_reduce_89_0b(&result[i1], &error_as_ntt[i1]);
  }
  memcpy(
...
*/
static tuple_4c generate_keypair_unpacked_a90(
    Eurydice_slice key_generation_seed) {
  uint8_t hashed[64U];
  ...
  uint8_t uu____1[33U];
  memcpy(uu____1, prf_input, (size_t)33U * sizeof(uint8_t));
  tuple_74 uu____2 = sample_vector_cbd_then_ntt_010(uu____1, 0U);
  ...
  memcpy(
      error_as_ntt,
      sample_vector_cbd_then_ntt_010(uu____3, domain_separator).fst,
      (size_t)2U * sizeof(libcrux_ml_kem_polynomial_PolynomialRingElement_f0));
  libcrux_ml_kem_polynomial_PolynomialRingElement_f0 t_as_ntt[2U];
  compute_As_plus_e_a50(A_transpose, secret_as_ntt, error_as_ntt, t_as_ntt);
  uint8_t seed_for_A[32U];
  core_result_Result_00 dst;
  Eurydice_slice_to_array2(&dst, seed_for_A0, Eurydice_slice, uint8_t[32U],
                           void *);
...
libcrux_ml_kem_ind_cca_unpacked_generate_keypair_unpacked_280(
    uint8_t randomness[64U]) {
  Eurydice_slice ind_cpa_keypair_randomness = Eurydice_array_to_subslice2(
      randomness, (size_t)0U,
      LIBCRUX_ML_KEM_CONSTANTS_CPA_PKE_KEY_GENERATION_SEED_SIZE, uint8_t,
  ...
  Eurydice_slice implicit_rejection_value0 = Eurydice_array_to_subslice_from(
      ...
      LIBCRUX_ML_KEM_CONSTANTS_CPA_PKE_KEY_GENERATION_SEED_SIZE, uint8_t,
      size_t, Eurydice_slice);
  tuple_4c uu____0 = generate_keypair_unpacked_a90(ind_cpa_keypair_randomness);
  ...
  KRML_MAYBE_FOR2(i, (size_t)0U, (size_t)2U, (size_t)1U, closure_010(A[i]););
  KRML_MAYBE_FOR2(
...
- ETA1_RANDOMNESS_SIZE= 192
*/
static libcrux_ml_kem_utils_extraction_helper_Keypair512 generate_keypair_e80(
    Eurydice_slice key_generation_seed) {
  tuple_4c uu____0 = generate_keypair_unpacked_a90(key_generation_seed);
  ...
  serialize_secret_key_e80(sk.secret_as_ntt, secret_key_serialized);
...
*/
static KRML_MUSTINLINE void serialize_kem_secret_key_b4(
    Eurydice_slice private_key, Eurydice_slice public_key,
...
libcrux_ml_kem_ind_cca_generate_keypair_6f0(uint8_t randomness[64U]) {
  ...
  libcrux_ml_kem_utils_extraction_helper_Keypair512 uu____0 =
      generate_keypair_e80(ind_cpa_keypair_randomness);
  ...
  libcrux_ml_kem_types_MlKemPrivateKey_5e private_key =
      libcrux_ml_kem_types_from_e7_e01(uu____1);
  ...
  return libcrux_ml_kem_types_from_64_2c1(
      uu____2, libcrux_ml_kem_types_from_07_571(uu____3));
}
...
- K= 2
*/
static KRML_MUSTINLINE void invert_ntt_montgomery_d40(
    libcrux_ml_kem_polynomial_PolynomialRingElement_f0 *re) {
  size_t zeta_i =
      LIBCRUX_ML_KEM_CONSTANTS_COEFFICIENTS_IN_RING_ELEMENT / (size_t)2U;
  invert_ntt_at_layer_1_2a(&zeta_i, re);
...
static KRML_MUSTINLINE void compute_vector_u_570(
  ...
  for (size_t i0 = (size_t)0U;
    ...
    invert_ntt_montgomery_d40(&result[i1]);
    add_error_reduce_89_b9(&result[i1], &error_1[i1]);
  }
  memcpy(
      ret, result,
...
compute_ring_element_v_c80(
  ...
  KRML_MAYBE_FOR2(i, (size_t)0U, (size_t)2U, (size_t)1U, size_t i0 = i;
                  libcrux_ml_kem_polynomial_PolynomialRingElement_f0 product =
                      ntt_multiply_89_f7(&t_as_ntt[i0], &r_as_ntt[i0]);
                  add_to_ring_element_89_8e0(&result, &product););
  invert_ntt_montgomery_d40(&result);
  result = add_message_error_reduce_89_11(error_2, message, result);
  return result;
}
...
- OUT_LEN= 320
*/
static KRML_MUSTINLINE void compress_then_serialize_10_54(
  ...
  for (size_t i = (size_t)0U;
    ...
    size_t i0 = i;
    libcrux_ml_kem_vector_portable_vector_type_PortableVector coefficient =
        compress_0d_9b(to_unsigned_representative_af(re->coefficients[i0]));
    uint8_t bytes[20U];
...
- OUT_LEN= 320
*/
static KRML_MUSTINLINE void compress_then_serialize_ring_element_u_d8(
    libcrux_ml_kem_polynomial_PolynomialRingElement_f0 *re, uint8_t ret[320U]) {
  uint8_t uu____0[320U];
  compress_then_serialize_10_54(re, uu____0);
...
- BLOCK_LEN= 320
*/
static void compress_then_serialize_u_250(
  ...
  for (size_t i = (size_t)0U;
    ...
    Eurydice_slice uu____0 = Eurydice_slice_subslice2(
        ...
        Eurydice_slice);
    uint8_t ret[320U];
    compress_then_serialize_ring_element_u_d8(&re, ret);
    core_slice___Slice_T___copy_from_slice(
        uu____0,
...
- OUT_LEN= 128
*/
static KRML_MUSTINLINE void compress_then_serialize_ring_element_v_d6(
    libcrux_ml_kem_polynomial_PolynomialRingElement_f0 re, Eurydice_slice out) {
...
- ETA2_RANDOMNESS_SIZE= 128
*/
static void encrypt_unpacked_650(
  ...
  uint8_t uu____0[33U];
  memcpy(uu____0, prf_input, (size_t)33U * sizeof(uint8_t));
  tuple_74 uu____1 = sample_vector_cbd_then_ntt_010(uu____0, 0U);
  ...
  uint8_t uu____2[33U];
  memcpy(uu____2, prf_input, (size_t)33U * sizeof(uint8_t));
  tuple_74 uu____3 = sample_ring_element_cbd_380(uu____2, domain_separator0);
  libcrux_ml_kem_polynomial_PolynomialRingElement_f0 error_1[2U];
  memcpy(
      error_1, uu____3.fst,
      (size_t)2U * sizeof(libcrux_ml_kem_polynomial_PolynomialRingElement_f0));
  ...
  compute_vector_u_570(public_key->A, r_as_ntt, error_1, u);
  uint8_t uu____4[32U];
  memcpy(uu____4, message, (size_t)32U * sizeof(uint8_t));
  libcrux_ml_kem_polynomial_PolynomialRingElement_f0 message_as_ring_element =
      deserialize_then_decompress_message_cb(uu____4);
  libcrux_ml_kem_polynomial_PolynomialRingElement_f0 v =
      compute_ring_element_v_c80(public_key->t_as_ntt, r_as_ntt, &error_2,
                                 &message_as_ring_element);
  ...
  memcpy(
      uu____5, u,
      (size_t)2U * sizeof(libcrux_ml_kem_polynomial_PolynomialRingElement_f0));
  compress_then_serialize_u_250(
      uu____5, Eurydice_array_to_subslice2(ciphertext, (size_t)0U, (size_t)640U,
                                           uint8_t, Eurydice_slice));
  libcrux_ml_kem_polynomial_PolynomialRingElement_f0 uu____6 = v;
  compress_then_serialize_ring_element_v_d6(
      uu____6,
...
- ETA2_RANDOMNESS_SIZE= 128
*/
tuple_ec libcrux_ml_kem_ind_cca_unpacked_encapsulate_unpacked_a10(
  ...
  encrypt_unpacked_650(uu____2, uu____3, pseudorandomness, ciphertext);
  uint8_t shared_secret_array[32U] = {0U};
  core_slice___Slice_T___copy_from_slice(
      Eurydice_array_to_slice((size_t)32U, shared_secret_array, uint8_t,
                              Eurydice_slice),
  ...
  libcrux_ml_kem_types_MlKemCiphertext_e8 uu____5 =
      libcrux_ml_kem_types_from_15_201(uu____4);
  uint8_t uu____6[32U];
  memcpy(uu____6, shared_secret_array, (size_t)32U * sizeof(uint8_t));
  tuple_ec lit;
  lit.fst = uu____5;
...
- K= 2
*/
static KRML_MUSTINLINE void deserialize_ring_elements_reduced_521(
    Eurydice_slice public_key,
    libcrux_ml_kem_polynomial_PolynomialRingElement_f0 ret[2U]) {
  libcrux_ml_kem_polynomial_PolynomialRingElement_f0 deserialized_pk[2U];
  KRML_MAYBE_FOR2(i, (size_t)0U, (size_t)2U, (size_t)1U,
...
- ETA2_RANDOMNESS_SIZE= 128
*/
static void encrypt_f70(Eurydice_slice public_key, uint8_t message[32U],
                        Eurydice_slice randomness, uint8_t ret[768U]) {
  libcrux_ml_kem_polynomial_PolynomialRingElement_f0 t_as_ntt[2U];
  deserialize_ring_elements_reduced_521(
  ...
  memcpy(uu____4, message, (size_t)32U * sizeof(uint8_t));
  uint8_t ret1[768U];
  encrypt_unpacked_650(uu____3, uu____4, randomness, ret1);
...
- CIPHERTEXT_SIZE= 768
*/
static KRML_MUSTINLINE void kdf_af_d3(Eurydice_slice shared_secret,
                                      uint8_t ret[32U]) {
  core_result_Result_00 dst;
  Eurydice_slice_to_array2(&dst, shared_secret, Eurydice_slice, uint8_t[32U],
                           void *);
...
tuple_ec libcrux_ml_kem_ind_cca_encapsulate_9d0(
  ...
  H_f1_af0(Eurydice_array_to_slice(
               (size_t)800U, libcrux_ml_kem_types_as_slice_f6_1f1(public_key),
               uint8_t, Eurydice_slice),
           ret);
  core_slice___Slice_T___copy_from_slice(
      uu____0,
  ...
  Eurydice_slice pseudorandomness = uu____1.snd;
  Eurydice_slice uu____2 = Eurydice_array_to_slice(
      (size_t)800U, libcrux_ml_kem_types_as_slice_f6_1f1(public_key), uint8_t,
      Eurydice_slice);
  uint8_t uu____3[32U];
  memcpy(uu____3, randomness0, (size_t)32U * sizeof(uint8_t));
  uint8_t ciphertext[768U];
  encrypt_f70(uu____2, uu____3, pseudorandomness, ciphertext);
  uint8_t uu____4[768U];
  memcpy(uu____4, ciphertext, (size_t)768U * sizeof(uint8_t));
  libcrux_ml_kem_types_MlKemCiphertext_e8 ciphertext0 =
      libcrux_ml_kem_types_from_15_201(uu____4);
  uint8_t shared_secret_array[32U];
  kdf_af_d3(shared_secret, shared_secret_array);
...
*/
static KRML_MUSTINLINE libcrux_ml_kem_polynomial_PolynomialRingElement_f0
deserialize_then_decompress_ring_element_u_38(Eurydice_slice serialized) {
  return deserialize_then_decompress_10_26(serialized);
}
...
- VECTOR_U_COMPRESSION_FACTOR= 10
*/
static KRML_MUSTINLINE void ntt_vector_u_82(
    libcrux_ml_kem_polynomial_PolynomialRingElement_f0 *re) {
  size_t zeta_i = (size_t)0U;
  ntt_at_layer_4_plus_c0(&zeta_i, re, (size_t)7U);
  ntt_at_layer_4_plus_c0(&zeta_i, re, (size_t)6U);
...
- U_COMPRESSION_FACTOR= 10
*/
static KRML_MUSTINLINE void deserialize_then_decompress_u_ec0(
    uint8_t *ciphertext,
    libcrux_ml_kem_polynomial_PolynomialRingElement_f0 ret[2U]) {
  ...
  for (size_t i = (size_t)0U;
    ...
    Eurydice_slice u_bytes = Eurydice_array_to_subslice2(
        ...
        uint8_t, Eurydice_slice);
    libcrux_ml_kem_polynomial_PolynomialRingElement_f0 uu____0 =
        deserialize_then_decompress_ring_element_u_38(u_bytes);
    u_as_ntt[i0] = uu____0;
    ntt_vector_u_82(&u_as_ntt[i0]);
  }
  memcpy(
      ret, u_as_ntt,
      (size_t)2U * sizeof(libcrux_ml_kem_polynomial_PolynomialRingElement_f0));
...
*/
static KRML_MUSTINLINE libcrux_ml_kem_polynomial_PolynomialRingElement_f0
deserialize_then_decompress_ring_element_v_0b(Eurydice_slice serialized) {
  return deserialize_then_decompress_4_51(serialized);
}
...
- V_COMPRESSION_FACTOR= 4
*/
static void decrypt_unpacked_e50(
    libcrux_ml_kem_ind_cpa_unpacked_IndCpaPrivateKeyUnpacked_ae *secret_key,
    uint8_t *ciphertext, uint8_t ret[32U]) {
  libcrux_ml_kem_polynomial_PolynomialRingElement_f0 u_as_ntt[2U];
  deserialize_then_decompress_u_ec0(ciphertext, u_as_ntt);
  libcrux_ml_kem_polynomial_PolynomialRingElement_f0 v =
      deserialize_then_decompress_ring_element_v_0b(
...
*/
void libcrux_ml_kem_ind_cca_unpacked_decapsulate_unpacked_f50(
    libcrux_ml_kem_ind_cca_unpacked_MlKemKeyPairUnpacked_ae *key_pair,
    libcrux_ml_kem_types_MlKemCiphertext_e8 *ciphertext, uint8_t ret[32U]) {
  uint8_t decrypted[32U];
  decrypt_unpacked_e50(&key_pair->private_key.ind_cpa_private_key,
                       ciphertext->value, decrypted);
  uint8_t to_hash0[64U];
  libcrux_ml_kem_utils_into_padded_array_97(
      Eurydice_array_to_slice((size_t)32U, decrypted, uint8_t, Eurydice_slice),
  ...
  Eurydice_slice uu____2 = Eurydice_array_to_subslice_from(
      ...
      uint8_t, size_t, Eurydice_slice);
  core_slice___Slice_T___copy_from_slice(
      uu____2, libcrux_ml_kem_types_as_ref_ba_2d1(ciphertext), uint8_t, void *);
  uint8_t implicit_rejection_shared_secret[32U];
  PRF_f1_6f1(
  ...
  encrypt_unpacked_650(uu____3, uu____4, pseudorandomness, expected_ciphertext);
  uint8_t selector =
      libcrux_ml_kem_constant_time_ops_compare_ciphertexts_in_constant_time(
          libcrux_ml_kem_types_as_ref_ba_2d1(ciphertext),
...
- K= 2
*/
static KRML_MUSTINLINE void deserialize_secret_key_490(
    Eurydice_slice secret_key,
    libcrux_ml_kem_polynomial_PolynomialRingElement_f0 ret[2U]) {
  libcrux_ml_kem_polynomial_PolynomialRingElement_f0 secret_as_ntt[2U];
  KRML_MAYBE_FOR2(i, (size_t)0U, (size_t)2U, (size_t)1U,
...
- V_COMPRESSION_FACTOR= 4
*/
static void decrypt_5d0(Eurydice_slice secret_key, uint8_t *ciphertext,
                        uint8_t ret[32U]) {
  libcrux_ml_kem_polynomial_PolynomialRingElement_f0 secret_as_ntt[2U];
  deserialize_secret_key_490(secret_key, secret_as_ntt);
  libcrux_ml_kem_polynomial_PolynomialRingElement_f0 uu____0[2U];
  memcpy(
      uu____0, secret_as_ntt,
      (size_t)2U * sizeof(libcrux_ml_kem_polynomial_PolynomialRingElement_f0));
  ...
  memcpy(
      ...
      (size_t)2U * sizeof(libcrux_ml_kem_polynomial_PolynomialRingElement_f0));
  uint8_t ret0[32U];
  decrypt_unpacked_e50(&secret_key_unpacked, ciphertext, ret0);
  memcpy(ret, ret0, (size_t)32U * sizeof(uint8_t));
}
...
- IMPLICIT_REJECTION_HASH_INPUT_SIZE= 800
*/
void libcrux_ml_kem_ind_cca_decapsulate_a00(
    libcrux_ml_kem_types_MlKemPrivateKey_5e *private_key,
    libcrux_ml_kem_types_MlKemCiphertext_e8 *ciphertext, uint8_t ret[32U]) {
  Eurydice_slice_uint8_t_x2 uu____0 = core_slice___Slice_T___split_at(
  ...
  Eurydice_slice implicit_rejection_value = uu____2.snd;
  uint8_t decrypted[32U];
  decrypt_5d0(ind_cpa_secret_key, ciphertext->value, decrypted);
  uint8_t to_hash0[64U];
  libcrux_ml_kem_utils_into_padded_array_97(
      Eurydice_array_to_slice((size_t)32U, decrypted, uint8_t, Eurydice_slice),
      to_hash0);
  ...
  Eurydice_slice uu____4 = Eurydice_array_to_subslice_from(
      ...
      uint8_t, size_t, Eurydice_slice);
  core_slice___Slice_T___copy_from_slice(
      uu____4, libcrux_ml_kem_types_as_ref_ba_2d1(ciphertext), uint8_t, void *);
  uint8_t implicit_rejection_shared_secret0[32U];
  PRF_f1_6f1(
      Eurydice_array_to_slice((size_t)800U, to_hash, uint8_t, Eurydice_slice),
      implicit_rejection_shared_secret0);
  ...
  kdf_af_d3(
      ...
      implicit_rejection_shared_secret);
  uint8_t shared_secret1[32U];
  kdf_af_d3(shared_secret0, shared_secret1);
  uint8_t shared_secret[32U];
  libcrux_ml_kem_constant_time_ops_compare_ciphertexts_select_shared_secret_in_constant_time(
      libcrux_ml_kem_types_as_ref_ba_2d1(ciphertext),
      Eurydice_array_to_slice((size_t)768U, expected_ciphertext, uint8_t,
...
- K= 3
*/
static KRML_MUSTINLINE void deserialize_ring_elements_reduced_520(
    Eurydice_slice public_key,
...
- OUT_LEN= 1152
*/
static KRML_MUSTINLINE void serialize_secret_key_e8(
    libcrux_ml_kem_polynomial_PolynomialRingElement_f0 *key,
    uint8_t ret[1152U]) {
...
- PUBLIC_KEY_SIZE= 1184
*/
static KRML_MUSTINLINE void serialize_public_key_9a(
    libcrux_ml_kem_polynomial_PolynomialRingElement_f0 *t_as_ntt,
  ...
  uint8_t ret0[1152U];
  serialize_secret_key_e8(t_as_ntt, ret0);
  core_slice___Slice_T___copy_from_slice(
      uu____0,
...
- ETA_RANDOMNESS_SIZE= 128
*/
static KRML_MUSTINLINE tuple_b0 sample_vector_cbd_then_ntt_01(
    uint8_t prf_input[33U], uint8_t domain_separator) {
...
- K= 3
*/
static KRML_MUSTINLINE void add_to_ring_element_89_8e(
    libcrux_ml_kem_polynomial_PolynomialRingElement_f0 *self,
    libcrux_ml_kem_polynomial_PolynomialRingElement_f0 *rhs) {
  for (size_t i = (size_t)0U;
       i < core_slice___Slice_T___len(
...
static KRML_MUSTINLINE void compute_As_plus_e_a5(
  ...
  for (size_t i0 = (size_t)0U;
    ...
    for (size_t i = (size_t)0U;
      ...
      libcrux_ml_kem_polynomial_PolynomialRingElement_f0 product =
          ntt_multiply_89_f7(matrix_element, &s_as_ntt[j]);
      add_to_ring_element_89_8e(&result[i1], &product);
    }
    add_standard_error_reduce_89_0b(&result[i1], &error_as_ntt[i1]);
  }
  memcpy(
...
- ETA1_RANDOMNESS_SIZE= 128
*/
static tuple_9b generate_keypair_unpacked_a9(
    Eurydice_slice key_generation_seed) {
  uint8_t hashed[64U];
  ...
  uint8_t uu____1[33U];
  memcpy(uu____1, prf_input, (size_t)33U * sizeof(uint8_t));
  tuple_b0 uu____2 = sample_vector_cbd_then_ntt_01(uu____1, 0U);
  ...
  memcpy(
      error_as_ntt,
      sample_vector_cbd_then_ntt_01(uu____3, domain_separator).fst,
      (size_t)3U * sizeof(libcrux_ml_kem_polynomial_PolynomialRingElement_f0));
  libcrux_ml_kem_polynomial_PolynomialRingElement_f0 t_as_ntt[3U];
  compute_As_plus_e_a5(A_transpose, secret_as_ntt, error_as_ntt, t_as_ntt);
  uint8_t seed_for_A[32U];
  core_result_Result_00 dst;
  Eurydice_slice_to_array2(&dst, seed_for_A0, Eurydice_slice, uint8_t[32U],
                           void *);
...
libcrux_ml_kem_ind_cca_unpacked_generate_keypair_unpacked_28(
    uint8_t randomness[64U]) {
  Eurydice_slice ind_cpa_keypair_randomness = Eurydice_array_to_subslice2(
      randomness, (size_t)0U,
      LIBCRUX_ML_KEM_CONSTANTS_CPA_PKE_KEY_GENERATION_SEED_SIZE, uint8_t,
  ...
  Eurydice_slice implicit_rejection_value0 = Eurydice_array_to_subslice_from(
      ...
      LIBCRUX_ML_KEM_CONSTANTS_CPA_PKE_KEY_GENERATION_SEED_SIZE, uint8_t,
      size_t, Eurydice_slice);
  tuple_9b uu____0 = generate_keypair_unpacked_a9(ind_cpa_keypair_randomness);
  ...
  KRML_MAYBE_FOR3(i, (size_t)0U, (size_t)3U, (size_t)1U, closure_01(A[i]););
  KRML_MAYBE_FOR3(
...
- ETA1_RANDOMNESS_SIZE= 128
*/
static libcrux_ml_kem_utils_extraction_helper_Keypair768 generate_keypair_e8(
    Eurydice_slice key_generation_seed) {
  tuple_9b uu____0 = generate_keypair_unpacked_a9(key_generation_seed);
  ...
  serialize_secret_key_e8(sk.secret_as_ntt, secret_key_serialized);
...
*/
static KRML_MUSTINLINE void serialize_kem_secret_key_97(
    Eurydice_slice private_key, Eurydice_slice public_key,
...
libcrux_ml_kem_ind_cca_generate_keypair_6f(uint8_t randomness[64U]) {
  ...
  libcrux_ml_kem_utils_extraction_helper_Keypair768 uu____0 =
      generate_keypair_e8(ind_cpa_keypair_randomness);
  uint8_t ind_cpa_private_key[1152U];
  memcpy(ind_cpa_private_key, uu____0.fst, (size_t)1152U * sizeof(uint8_t));
  uint8_t public_key[1184U];
  memcpy(public_key, uu____0.snd, (size_t)1184U * sizeof(uint8_t));
  uint8_t secret_key_serialized[2400U];
  serialize_kem_secret_key_97(
  ...
  libcrux_ml_kem_types_MlKemPrivateKey_55 private_key =
      libcrux_ml_kem_types_from_e7_e0(uu____1);
  ...
  return libcrux_ml_kem_types_from_64_2c(
      uu____2, libcrux_ml_kem_types_from_07_57(uu____3));
}
...
- K= 3
*/
static KRML_MUSTINLINE void invert_ntt_montgomery_d4(
    libcrux_ml_kem_polynomial_PolynomialRingElement_f0 *re) {
  size_t zeta_i =
      LIBCRUX_ML_KEM_CONSTANTS_COEFFICIENTS_IN_RING_ELEMENT / (size_t)2U;
  invert_ntt_at_layer_1_2a(&zeta_i, re);
...
- K= 3
*/
static KRML_MUSTINLINE void compute_vector_u_57(
  ...
  for (size_t i0 = (size_t)0U;
    ...
    invert_ntt_montgomery_d4(&result[i1]);
    add_error_reduce_89_b9(&result[i1], &error_1[i1]);
  }
  memcpy(
      ret, result,
...
compute_ring_element_v_c8(
  ...
  KRML_MAYBE_FOR3(i, (size_t)0U, (size_t)3U, (size_t)1U, size_t i0 = i;
                  libcrux_ml_kem_polynomial_PolynomialRingElement_f0 product =
                      ntt_multiply_89_f7(&t_as_ntt[i0], &r_as_ntt[i0]);
                  add_to_ring_element_89_8e(&result, &product););
  invert_ntt_montgomery_d4(&result);
  result = add_message_error_reduce_89_11(error_2, message, result);
  return result;
}
...
- ETA2_RANDOMNESS_SIZE= 128
*/
static void encrypt_unpacked_65(
  ...
  uint8_t uu____0[33U];
  memcpy(uu____0, prf_input, (size_t)33U * sizeof(uint8_t));
  tuple_b0 uu____1 = sample_vector_cbd_then_ntt_01(uu____0, 0U);
  ...
  uint8_t uu____2[33U];
  memcpy(uu____2, prf_input, (size_t)33U * sizeof(uint8_t));
  tuple_b0 uu____3 = sample_ring_element_cbd_38(uu____2, domain_separator0);
  libcrux_ml_kem_polynomial_PolynomialRingElement_f0 error_1[3U];
  memcpy(
      error_1, uu____3.fst,
      (size_t)3U * sizeof(libcrux_ml_kem_polynomial_PolynomialRingElement_f0));
  ...
  compute_vector_u_57(public_key->A, r_as_ntt, error_1, u);
  uint8_t uu____4[32U];
  memcpy(uu____4, message, (size_t)32U * sizeof(uint8_t));
  libcrux_ml_kem_polynomial_PolynomialRingElement_f0 message_as_ring_element =
      deserialize_then_decompress_message_cb(uu____4);
  libcrux_ml_kem_polynomial_PolynomialRingElement_f0 v =
      compute_ring_element_v_c8(public_key->t_as_ntt, r_as_ntt, &error_2,
                                &message_as_ring_element);
...
- ETA2_RANDOMNESS_SIZE= 128
*/
tuple_3c libcrux_ml_kem_ind_cca_unpacked_encapsulate_unpacked_a1(
  ...
  encrypt_unpacked_65(uu____2, uu____3, pseudorandomness, ciphertext);
  uint8_t shared_secret_array[32U] = {0U};
  core_slice___Slice_T___copy_from_slice(
      Eurydice_array_to_slice((size_t)32U, shared_secret_array, uint8_t,
                              Eurydice_slice),
  ...
  libcrux_ml_kem_mlkem768_MlKem768Ciphertext uu____5 =
      libcrux_ml_kem_types_from_15_20(uu____4);
  uint8_t uu____6[32U];
  memcpy(uu____6, shared_secret_array, (size_t)32U * sizeof(uint8_t));
  tuple_3c lit;
  lit.fst = uu____5;
...
- K= 3
*/
static KRML_MUSTINLINE void entropy_preprocess_af_39(Eurydice_slice randomness,
                                                     uint8_t ret[32U]) {
  core_result_Result_00 dst;
  Eurydice_slice_to_array2(&dst, randomness, Eurydice_slice, uint8_t[32U],
                           void *);
...
- K= 3
*/
static KRML_MUSTINLINE void deserialize_ring_elements_reduced_52(
    Eurydice_slice public_key,
    libcrux_ml_kem_polynomial_PolynomialRingElement_f0 ret[3U]) {
  libcrux_ml_kem_polynomial_PolynomialRingElement_f0 deserialized_pk[3U];
  KRML_MAYBE_FOR3(i, (size_t)0U, (size_t)3U, (size_t)1U,
...
- ETA2_RANDOMNESS_SIZE= 128
*/
static void encrypt_f7(Eurydice_slice public_key, uint8_t message[32U],
                       Eurydice_slice randomness, uint8_t ret[1088U]) {
  libcrux_ml_kem_polynomial_PolynomialRingElement_f0 t_as_ntt[3U];
  deserialize_ring_elements_reduced_52(
  ...
  memcpy(uu____4, message, (size_t)32U * sizeof(uint8_t));
  uint8_t ret1[1088U];
  encrypt_unpacked_65(uu____3, uu____4, randomness, ret1);
...
- CIPHERTEXT_SIZE= 1088
*/
static KRML_MUSTINLINE void kdf_af_6d(Eurydice_slice shared_secret,
                                      uint8_t ret[32U]) {
  core_result_Result_00 dst;
  Eurydice_slice_to_array2(&dst, shared_secret, Eurydice_slice, uint8_t[32U],
                           void *);
...
tuple_3c libcrux_ml_kem_ind_cca_encapsulate_9d(
  ...
  H_f1_af(Eurydice_array_to_slice(
              (size_t)1184U, libcrux_ml_kem_types_as_slice_f6_1f(public_key),
              uint8_t, Eurydice_slice),
          ret);
  core_slice___Slice_T___copy_from_slice(
      uu____0,
  ...
  Eurydice_slice pseudorandomness = uu____1.snd;
  Eurydice_slice uu____2 = Eurydice_array_to_slice(
      (size_t)1184U, libcrux_ml_kem_types_as_slice_f6_1f(public_key), uint8_t,
      Eurydice_slice);
  uint8_t uu____3[32U];
  memcpy(uu____3, randomness0, (size_t)32U * sizeof(uint8_t));
  uint8_t ciphertext[1088U];
  encrypt_f7(uu____2, uu____3, pseudorandomness, ciphertext);
  uint8_t uu____4[1088U];
  memcpy(uu____4, ciphertext, (size_t)1088U * sizeof(uint8_t));
  libcrux_ml_kem_mlkem768_MlKem768Ciphertext ciphertext0 =
      libcrux_ml_kem_types_from_15_20(uu____4);
  uint8_t shared_secret_array[32U];
  kdf_af_6d(shared_secret, shared_secret_array);
...
- V_COMPRESSION_FACTOR= 4
*/
static void decrypt_unpacked_e5(
...
*/
void libcrux_ml_kem_ind_cca_unpacked_decapsulate_unpacked_f5(
    libcrux_ml_kem_ind_cca_unpacked_MlKemKeyPairUnpacked_f8 *key_pair,
    libcrux_ml_kem_mlkem768_MlKem768Ciphertext *ciphertext, uint8_t ret[32U]) {
  uint8_t decrypted[32U];
  decrypt_unpacked_e5(&key_pair->private_key.ind_cpa_private_key,
                      ciphertext->value, decrypted);
  uint8_t to_hash0[64U];
  libcrux_ml_kem_utils_into_padded_array_97(
      Eurydice_array_to_slice((size_t)32U, decrypted, uint8_t, Eurydice_slice),
  ...
  Eurydice_slice uu____2 = Eurydice_array_to_subslice_from(
      ...
      uint8_t, size_t, Eurydice_slice);
  core_slice___Slice_T___copy_from_slice(
      uu____2, libcrux_ml_kem_types_as_ref_ba_2d(ciphertext), uint8_t, void *);
  uint8_t implicit_rejection_shared_secret[32U];
  PRF_f1_6f(
  ...
  encrypt_unpacked_65(uu____3, uu____4, pseudorandomness, expected_ciphertext);
  uint8_t selector =
      libcrux_ml_kem_constant_time_ops_compare_ciphertexts_in_constant_time(
          libcrux_ml_kem_types_as_ref_ba_2d(ciphertext),
...
- V_COMPRESSION_FACTOR= 4
*/
static void decrypt_5d(Eurydice_slice secret_key, uint8_t *ciphertext,
                       uint8_t ret[32U]) {
  libcrux_ml_kem_polynomial_PolynomialRingElement_f0 secret_as_ntt[3U];
  deserialize_secret_key_49(secret_key, secret_as_ntt);
  libcrux_ml_kem_polynomial_PolynomialRingElement_f0 uu____0[3U];
  memcpy(
      uu____0, secret_as_ntt,
      (size_t)3U * sizeof(libcrux_ml_kem_polynomial_PolynomialRingElement_f0));
  ...
  memcpy(
      ...
      (size_t)3U * sizeof(libcrux_ml_kem_polynomial_PolynomialRingElement_f0));
  uint8_t ret0[32U];
  decrypt_unpacked_e5(&secret_key_unpacked, ciphertext, ret0);
  memcpy(ret, ret0, (size_t)32U * sizeof(uint8_t));
}
...
- IMPLICIT_REJECTION_HASH_INPUT_SIZE= 1120
*/
void libcrux_ml_kem_ind_cca_decapsulate_a0(
    libcrux_ml_kem_types_MlKemPrivateKey_55 *private_key,
    libcrux_ml_kem_mlkem768_MlKem768Ciphertext *ciphertext, uint8_t ret[32U]) {
  Eurydice_slice_uint8_t_x2 uu____0 = core_slice___Slice_T___split_at(
  ...
  Eurydice_slice implicit_rejection_value = uu____2.snd;
  uint8_t decrypted[32U];
  decrypt_5d(ind_cpa_secret_key, ciphertext->value, decrypted);
  uint8_t to_hash0[64U];
  libcrux_ml_kem_utils_into_padded_array_97(
      Eurydice_array_to_slice((size_t)32U, decrypted, uint8_t, Eurydice_slice),
      to_hash0);
  ...
  Eurydice_slice uu____4 = Eurydice_array_to_subslice_from(
      ...
      uint8_t, size_t, Eurydice_slice);
  core_slice___Slice_T___copy_from_slice(
      uu____4, libcrux_ml_kem_types_as_ref_ba_2d(ciphertext), uint8_t, void *);
  uint8_t implicit_rejection_shared_secret0[32U];
  PRF_f1_6f(
      Eurydice_array_to_slice((size_t)1120U, to_hash, uint8_t, Eurydice_slice),
      implicit_rejection_shared_secret0);
  ...
  kdf_af_6d(
      ...
      implicit_rejection_shared_secret);
  uint8_t shared_secret1[32U];
  kdf_af_6d(shared_secret0, shared_secret1);
  uint8_t shared_secret[32U];
  libcrux_ml_kem_constant_time_ops_compare_ciphertexts_select_shared_secret_in_constant_time(
      libcrux_ml_kem_types_as_ref_ba_2d(ciphertext),
      Eurydice_array_to_slice((size_t)1088U, expected_ciphertext, uint8_t,
