...
shake128_init_absorb_411(uint8_t input[4U][34U]) {
  libcrux_sha3_generic_keccak_KeccakState_48 shake128_state[4U];
  KRML_MAYBE_FOR4(
...
*/
static KRML_MUSTINLINE PortableHash_d1
shake128_init_absorb_f1_511(uint8_t input[4U][34U]) {
  uint8_t uu____0[4U][34U];
  memcpy(uu____0, input, (size_t)4U * sizeof(uint8_t[34U]));
  return shake128_init_absorb_411(uu____0);
}
...
- K= 4
*/
static KRML_MUSTINLINE void shake128_squeeze_three_blocks_541(
...
- K= 4
*/
static KRML_MUSTINLINE void shake128_squeeze_three_blocks_f1_7f1(
    PortableHash_d1 *self, uint8_t ret[4U][504U]) {
  shake128_squeeze_three_blocks_541(self, ret);
}
...
- K= 4
*/
static KRML_MUSTINLINE void shake128_squeeze_block_881(PortableHash_d1 *st,
                                                       uint8_t ret[4U][168U]) {
...
static KRML_MUSTINLINE void shake128_squeeze_block_f1_681(
  ...
  shake128_squeeze_block_881(self, ret);
}
...
static KRML_MUSTINLINE void sample_from_xof_f61(
  ...
  PortableHash_d1 xof_state = shake128_init_absorb_f1_511(uu____0);
  uint8_t randomness0[4U][504U];
  shake128_squeeze_three_blocks_f1_7f1(&xof_state, randomness0);
  ...
  while (true) {
    if (done) {
      ...
      shake128_squeeze_block_f1_681(&xof_state, randomness);
...
shake128_init_absorb_410(uint8_t input[2U][34U]) {
  libcrux_sha3_generic_keccak_KeccakState_48 shake128_state[2U];
  KRML_MAYBE_FOR2(
...
*/
static KRML_MUSTINLINE PortableHash_8b
shake128_init_absorb_f1_510(uint8_t input[2U][34U]) {
  uint8_t uu____0[2U][34U];
  memcpy(uu____0, input, (size_t)2U * sizeof(uint8_t[34U]));
  return shake128_init_absorb_410(uu____0);
}
...
- K= 2
*/
static KRML_MUSTINLINE void shake128_squeeze_three_blocks_540(
...
- K= 2
*/
static KRML_MUSTINLINE void shake128_squeeze_three_blocks_f1_7f0(
    PortableHash_8b *self, uint8_t ret[2U][504U]) {
  shake128_squeeze_three_blocks_540(self, ret);
}
...
- K= 2
*/
static KRML_MUSTINLINE void shake128_squeeze_block_880(PortableHash_8b *st,
                                                       uint8_t ret[2U][168U]) {
...
- K= 2
*/
static KRML_MUSTINLINE void shake128_squeeze_block_f1_680(
    PortableHash_8b *self, uint8_t ret[2U][168U]) {
  shake128_squeeze_block_880(self, ret);
}
...
static KRML_MUSTINLINE void sample_from_xof_f60(
  ...
  PortableHash_8b xof_state = shake128_init_absorb_f1_510(uu____0);
  uint8_t randomness0[2U][504U];
  shake128_squeeze_three_blocks_f1_7f0(&xof_state, randomness0);
  ...
  while (true) {
    if (done) {
      ...
      shake128_squeeze_block_f1_680(&xof_state, randomness);
...
shake128_init_absorb_41(uint8_t input[3U][34U]) {
  libcrux_sha3_generic_keccak_KeccakState_48 shake128_state[3U];
  KRML_MAYBE_FOR3(
...
*/
static KRML_MUSTINLINE PortableHash_58
shake128_init_absorb_f1_51(uint8_t input[3U][34U]) {
  uint8_t uu____0[3U][34U];
  memcpy(uu____0, input, (size_t)3U * sizeof(uint8_t[34U]));
  return shake128_init_absorb_41(uu____0);
}
...
static KRML_MUSTINLINE void shake128_squeeze_three_blocks_f1_7f(
  ...
  shake128_squeeze_three_blocks_54(self, ret);
}
...
- K= 3
*/
static KRML_MUSTINLINE void shake128_squeeze_block_88(PortableHash_58 *st,
                                                      uint8_t ret[3U][168U]) {
...
- K= 3
*/
static KRML_MUSTINLINE void shake128_squeeze_block_f1_68(
    PortableHash_58 *self, uint8_t ret[3U][168U]) {
  shake128_squeeze_block_88(self, ret);
}
...
static KRML_MUSTINLINE void sample_from_xof_f6(
  ...
  PortableHash_58 xof_state = shake128_init_absorb_f1_51(uu____0);
  uint8_t randomness0[3U][504U];
  shake128_squeeze_three_blocks_f1_7f(&xof_state, randomness0);
  ...
  while (true) {
    if (done) {
      ...
      shake128_squeeze_block_f1_68(&xof_state, randomness);
