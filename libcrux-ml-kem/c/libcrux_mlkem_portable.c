...
*/
static libcrux_ml_kem_polynomial_PolynomialRingElement_f0 ZERO_89_8d(void) {
...
deserialize_to_reduced_ring_element_a4(Eurydice_slice serialized) {
...
- K= 4
*/
static KRML_MUSTINLINE void deserialize_ring_elements_reduced_1d4(
  ...
  for (size_t i = (size_t)0U;
    ...
    libcrux_ml_kem_polynomial_PolynomialRingElement_f0 uu____0 =
        deserialize_to_reduced_ring_element_a4(ring_element);
...
shift_right_68(libcrux_ml_kem_vector_portable_vector_type_PortableVector v) {
  for (size_t i = (size_t)0U;
       i < LIBCRUX_ML_KEM_VECTOR_TRAITS_FIELD_ELEMENTS_IN_VECTOR; i++) {
    size_t i0 = i;
...
shift_right_0d_f2(libcrux_ml_kem_vector_portable_vector_type_PortableVector v) {
  return shift_right_68(v);
}
...
*/
static KRML_MUSTINLINE void serialize_uncompressed_ring_element_1d(
  ...
  for (size_t i = (size_t)0U;
    ...
    size_t i0 = i;
    libcrux_ml_kem_vector_portable_vector_type_PortableVector coefficient =
        to_unsigned_representative_e5(re->coefficients[i0]);
    uint8_t bytes[24U];
...
static KRML_MUSTINLINE void serialize_secret_key_6d1(
  ...
  for (size_t i = (size_t)0U;
    ...
    Eurydice_slice uu____0 = Eurydice_array_to_subslice2(
        ...
        uint8_t, Eurydice_slice);
    uint8_t ret0[384U];
    serialize_uncompressed_ring_element_1d(&re, ret0);
    core_slice___Slice_T___copy_from_slice(
        uu____0,
...
- PUBLIC_KEY_SIZE= 1568
*/
bool libcrux_ml_kem_ind_cca_validate_public_key_601(uint8_t *public_key) {
  libcrux_ml_kem_polynomial_PolynomialRingElement_f0 deserialized_pk[4U];
  deserialize_ring_elements_reduced_1d4(
...
shake128_init_absorb_f1_8c1(uint8_t input[4U][34U]) {
  ...
  return shake128_init_absorb_b71(uu____0);
}
...
- N= 504
*/
static KRML_MUSTINLINE bool sample_from_uniform_distribution_next_2c3(
...
- N= 168
*/
static KRML_MUSTINLINE bool sample_from_uniform_distribution_next_2c4(
...
*/
static KRML_MUSTINLINE libcrux_ml_kem_polynomial_PolynomialRingElement_f0
from_i16_array_89_ca(Eurydice_slice a) {
  libcrux_ml_kem_polynomial_PolynomialRingElement_f0 result = ZERO_89_8d();
  for (size_t i = (size_t)0U;
       i < LIBCRUX_ML_KEM_POLYNOMIAL_VECTORS_IN_RING_ELEMENT; i++) {
    size_t i0 = i;
    libcrux_ml_kem_vector_portable_vector_type_PortableVector uu____0 =
...
- K= 4
*/
static libcrux_ml_kem_polynomial_PolynomialRingElement_f0 closure_2f1(
    int16_t s[272U]) {
  return from_i16_array_89_ca(Eurydice_array_to_subslice2(
...
- K= 4
*/
static KRML_MUSTINLINE void sample_from_xof_d41(
  ...
  PortableHash_d1 xof_state = shake128_init_absorb_f1_8c1(uu____0);
  ...
  bool done = sample_from_uniform_distribution_next_2c3(
  ...
  while (true) {
    if (done) {
      ...
      done = sample_from_uniform_distribution_next_2c4(
...
static KRML_MUSTINLINE void sample_matrix_A_051(
  ...
  KRML_MAYBE_FOR4(
      ...
      sample_from_xof_d41(uu____1, sampled);
      for (size_t i = (size_t)0U;
           i < core_slice___Slice_T___len(
                   Eurydice_array_to_slice(
                       (size_t)4U, sampled,
...
*/
static KRML_MUSTINLINE libcrux_ml_kem_polynomial_PolynomialRingElement_f0
sample_from_binomial_distribution_2_52(Eurydice_slice randomness) {
  ...
  return from_i16_array_89_ca(Eurydice_array_to_slice(
...
*/
static KRML_MUSTINLINE libcrux_ml_kem_polynomial_PolynomialRingElement_f0
sample_from_binomial_distribution_3_b0(Eurydice_slice randomness) {
  int16_t sampled_i16s[256U] = {0U};
  for (size_t i0 = (size_t)0U;
       i0 <
...
*/
static KRML_MUSTINLINE libcrux_ml_kem_polynomial_PolynomialRingElement_f0
sample_from_binomial_distribution_34(Eurydice_slice randomness) {
...
*/
static KRML_MUSTINLINE void ntt_at_layer_7_09(
...
static KRML_MUSTINLINE
    ...
    ntt_layer_int_vec_step_a6(
        ...
        int16_t zeta_r) {
  libcrux_ml_kem_vector_portable_vector_type_PortableVector t =
      montgomery_multiply_fe_a6(b, zeta_r);
...
*/
static KRML_MUSTINLINE void ntt_at_layer_4_plus_39(
...
*/
static KRML_MUSTINLINE void ntt_at_layer_3_a6(
    size_t *zeta_i, libcrux_ml_kem_polynomial_PolynomialRingElement_f0 *re) {
  KRML_MAYBE_FOR16(
...
*/
static KRML_MUSTINLINE void ntt_at_layer_2_23(
    size_t *zeta_i, libcrux_ml_kem_polynomial_PolynomialRingElement_f0 *re) {
  KRML_MAYBE_FOR16(
      i, (size_t)0U, (size_t)16U, (size_t)1U, size_t round = i;
      zeta_i[0U] = zeta_i[0U] + (size_t)1U;
...
*/
static KRML_MUSTINLINE void ntt_at_layer_1_43(
    size_t *zeta_i, libcrux_ml_kem_polynomial_PolynomialRingElement_f0 *re) {
  KRML_MAYBE_FOR16(
      i, (size_t)0U, (size_t)16U, (size_t)1U, size_t round = i;
      zeta_i[0U] = zeta_i[0U] + (size_t)1U;
...
*/
static KRML_MUSTINLINE void poly_barrett_reduce_89_61(
...
*/
static KRML_MUSTINLINE void ntt_binomially_sampled_ring_element_28(
    libcrux_ml_kem_polynomial_PolynomialRingElement_f0 *re) {
  ntt_at_layer_7_09(re);
  size_t zeta_i = (size_t)1U;
  ntt_at_layer_4_plus_39(&zeta_i, re, (size_t)6U);
  ntt_at_layer_4_plus_39(&zeta_i, re, (size_t)5U);
  ntt_at_layer_4_plus_39(&zeta_i, re, (size_t)4U);
  ntt_at_layer_3_a6(&zeta_i, re);
  ntt_at_layer_2_23(&zeta_i, re);
  ntt_at_layer_1_43(&zeta_i, re);
...
static KRML_MUSTINLINE tuple_710 sample_vector_cbd_then_ntt_a71(
  ...
  KRML_MAYBE_FOR4(
      ...
      libcrux_ml_kem_polynomial_PolynomialRingElement_f0 uu____1 =
          sample_from_binomial_distribution_34(Eurydice_array_to_slice(
              (size_t)128U, prf_outputs[i0], uint8_t, Eurydice_slice));
      re_as_ntt[i0] = uu____1;
      ntt_binomially_sampled_ring_element_28(&re_as_ntt[i0]););
...
*/
static KRML_MUSTINLINE libcrux_ml_kem_polynomial_PolynomialRingElement_f0
ntt_multiply_89_17(libcrux_ml_kem_polynomial_PolynomialRingElement_f0 *self,
                   libcrux_ml_kem_polynomial_PolynomialRingElement_f0 *rhs) {
  libcrux_ml_kem_polynomial_PolynomialRingElement_f0 out = ZERO_89_8d();
  for (size_t i = (size_t)0U;
       i < LIBCRUX_ML_KEM_POLYNOMIAL_VECTORS_IN_RING_ELEMENT; i++) {
    size_t i0 = i;
    libcrux_ml_kem_vector_portable_vector_type_PortableVector uu____0 =
...
- K= 4
*/
static KRML_MUSTINLINE void add_to_ring_element_89_e81(
    libcrux_ml_kem_polynomial_PolynomialRingElement_f0 *self,
    libcrux_ml_kem_polynomial_PolynomialRingElement_f0 *rhs) {
  for (size_t i = (size_t)0U;
       i < core_slice___Slice_T___len(
...
*/
static KRML_MUSTINLINE void add_standard_error_reduce_89_22(
    libcrux_ml_kem_polynomial_PolynomialRingElement_f0 *self,
  ...
  for (size_t i = (size_t)0U;
    ...
    size_t j = i;
    libcrux_ml_kem_vector_portable_vector_type_PortableVector
        coefficient_normal_form = to_standard_domain_a8(self->coefficients[j]);
    libcrux_ml_kem_vector_portable_vector_type_PortableVector uu____0 =
        libcrux_ml_kem_vector_portable_barrett_reduce_0d(
...
- K= 4
*/
static KRML_MUSTINLINE void compute_As_plus_e_cb1(
  ...
  for (size_t i0 = (size_t)0U;
    ...
    for (size_t i = (size_t)0U;
      ...
      libcrux_ml_kem_polynomial_PolynomialRingElement_f0 product =
          ntt_multiply_89_17(matrix_element, &s_as_ntt[j]);
      add_to_ring_element_89_e81(&result[i1], &product);
    }
    add_standard_error_reduce_89_22(&result[i1], &error_as_ntt[i1]);
  }
  memcpy(
      ret, result,
      (size_t)4U * sizeof(libcrux_ml_kem_polynomial_PolynomialRingElement_f0));
...
*/
static tuple_540 generate_keypair_unpacked_d11(
  ...
  tuple_710 uu____2 = sample_vector_cbd_then_ntt_a71(uu____1, 0U);
  ...
  memcpy(
      error_as_ntt,
      sample_vector_cbd_then_ntt_a71(uu____3, domain_separator).fst,
      (size_t)4U * sizeof(libcrux_ml_kem_polynomial_PolynomialRingElement_f0));
  libcrux_ml_kem_polynomial_PolynomialRingElement_f0 t_as_ntt[4U];
  compute_As_plus_e_cb1(A_transpose, secret_as_ntt, error_as_ntt, t_as_ntt);
...
*/
static inline libcrux_ml_kem_polynomial_PolynomialRingElement_f0 clone_d5_3a(
    libcrux_ml_kem_polynomial_PolynomialRingElement_f0 *self) {
  libcrux_ml_kem_polynomial_PolynomialRingElement_f0 lit;
...
libcrux_ml_kem_ind_cca_generate_keypair_unpacked_4a1(uint8_t randomness[64U]) {
  ...
  tuple_540 uu____0 = generate_keypair_unpacked_d11(ind_cpa_keypair_randomness);
  ...
  H_f1_1a1(Eurydice_array_to_slice((size_t)1568U, pk_serialized, uint8_t,
                                   Eurydice_slice),
           public_key_hash);
...
- ETA1_RANDOMNESS_SIZE= 128
*/
static libcrux_ml_kem_utils_extraction_helper_Keypair1024 generate_keypair_c51(
    Eurydice_slice key_generation_seed) {
  tuple_540 uu____0 = generate_keypair_unpacked_d11(key_generation_seed);
  ...
  serialize_secret_key_6d1(sk.secret_as_ntt, secret_key_serialized);
...
*/
static KRML_MUSTINLINE void serialize_kem_secret_key_66(
...
libcrux_ml_kem_ind_cca_generate_keypair_ef1(uint8_t randomness[64U]) {
  Eurydice_slice ind_cpa_keypair_randomness = Eurydice_array_to_subslice2(
      randomness, (size_t)0U,
      LIBCRUX_ML_KEM_CONSTANTS_CPA_PKE_KEY_GENERATION_SEED_SIZE, uint8_t,
      Eurydice_slice);
  ...
  libcrux_ml_kem_utils_extraction_helper_Keypair1024 uu____0 =
      generate_keypair_c51(ind_cpa_keypair_randomness);
...
sample_ring_element_cbd_bf1(uint8_t prf_input[33U], uint8_t domain_separator) {
...
static KRML_MUSTINLINE
  ...
  b = montgomery_multiply_fe_a6(a_minus_b, zeta_r);
  return (
      CLITERAL(libcrux_ml_kem_vector_portable_vector_type_PortableVector_x2){
          .fst = a, .snd = b});
}
...
*/
static KRML_MUSTINLINE void invert_ntt_at_layer_4_plus_52(
    size_t *zeta_i, libcrux_ml_kem_polynomial_PolynomialRingElement_f0 *re,
    size_t layer) {
  size_t step = (size_t)1U << (uint32_t)layer;
  for (size_t i0 = (size_t)0U; i0 < (size_t)128U >> (uint32_t)layer; i0++) {
...
*/
static KRML_MUSTINLINE void add_error_reduce_89_53(
    libcrux_ml_kem_polynomial_PolynomialRingElement_f0 *self,
    libcrux_ml_kem_polynomial_PolynomialRingElement_f0 *error) {
  for (size_t i = (size_t)0U;
       i < LIBCRUX_ML_KEM_POLYNOMIAL_VECTORS_IN_RING_ELEMENT; i++) {
...
- K= 4
*/
static KRML_MUSTINLINE void compute_vector_u_111(
  ...
  for (size_t i0 = (size_t)0U;
    ...
    add_error_reduce_89_53(&result[i1], &error_1[i1]);
  }
  memcpy(
      ret, result,
      (size_t)4U * sizeof(libcrux_ml_kem_polynomial_PolynomialRingElement_f0));
...
*/
static libcrux_ml_kem_vector_portable_vector_type_PortableVector
decompress_1_9f(libcrux_ml_kem_vector_portable_vector_type_PortableVector v) {
  libcrux_ml_kem_vector_portable_vector_type_PortableVector uu____0 =
...
*/
static KRML_MUSTINLINE libcrux_ml_kem_polynomial_PolynomialRingElement_f0
deserialize_then_decompress_message_c0(uint8_t serialized[32U]) {
  libcrux_ml_kem_polynomial_PolynomialRingElement_f0 re = ZERO_89_8d();
  KRML_MAYBE_FOR16(
          ...
          coefficient_compressed =
              libcrux_ml_kem_vector_portable_deserialize_1_0d(
                  Eurydice_array_to_subslice2(serialized, (size_t)2U * i0,
                                              ...
                                              uint8_t, Eurydice_slice));
      libcrux_ml_kem_vector_portable_vector_type_PortableVector uu____0 =
          decompress_1_9f(coefficient_compressed);
      re.coefficients[i0] = uu____0;);
  return re;
}
...
*/
static KRML_MUSTINLINE libcrux_ml_kem_polynomial_PolynomialRingElement_f0
add_message_error_reduce_89_60(
    libcrux_ml_kem_polynomial_PolynomialRingElement_f0 *self,
...
compute_ring_element_v_d81(
  ...
  result = add_message_error_reduce_89_60(error_2, message, result);
  return result;
}
...
*/
static KRML_MUSTINLINE libcrux_ml_kem_vector_portable_vector_type_PortableVector
compress_13(libcrux_ml_kem_vector_portable_vector_type_PortableVector v) {
  for (size_t i = (size_t)0U;
       i < LIBCRUX_ML_KEM_VECTOR_TRAITS_FIELD_ELEMENTS_IN_VECTOR; i++) {
    size_t i0 = i;
    int16_t uu____0 =
...
- COEFFICIENT_BITS= 10
*/
static libcrux_ml_kem_vector_portable_vector_type_PortableVector compress_0d_99(
    libcrux_ml_kem_vector_portable_vector_type_PortableVector v) {
  return compress_13(v);
}
...
*/
static KRML_MUSTINLINE libcrux_ml_kem_vector_portable_vector_type_PortableVector
compress_130(libcrux_ml_kem_vector_portable_vector_type_PortableVector v) {
  for (size_t i = (size_t)0U;
       i < LIBCRUX_ML_KEM_VECTOR_TRAITS_FIELD_ELEMENTS_IN_VECTOR; i++) {
    size_t i0 = i;
    int16_t uu____0 =
...
*/
static libcrux_ml_kem_vector_portable_vector_type_PortableVector
compress_0d_990(libcrux_ml_kem_vector_portable_vector_type_PortableVector v) {
  return compress_130(v);
}
...
- OUT_LEN= 352
*/
static KRML_MUSTINLINE void compress_then_serialize_11_510(
  ...
  for (size_t i = (size_t)0U;
    ...
    size_t i0 = i;
    libcrux_ml_kem_vector_portable_vector_type_PortableVector coefficient =
        compress_0d_990(to_unsigned_representative_e5(re->coefficients[i0]));
    uint8_t bytes[22U];
...
- OUT_LEN= 352
*/
static KRML_MUSTINLINE void compress_then_serialize_ring_element_u_420(
    libcrux_ml_kem_polynomial_PolynomialRingElement_f0 *re, uint8_t ret[352U]) {
  uint8_t uu____0[352U];
  compress_then_serialize_11_510(re, uu____0);
...
- BLOCK_LEN= 352
*/
static void compress_then_serialize_u_e71(
  ...
  for (size_t i = (size_t)0U;
    ...
    Eurydice_slice uu____0 = Eurydice_slice_subslice2(
        ...
        Eurydice_slice);
    uint8_t ret[352U];
    compress_then_serialize_ring_element_u_420(&re, ret);
    core_slice___Slice_T___copy_from_slice(
        uu____0,
...
*/
static KRML_MUSTINLINE libcrux_ml_kem_vector_portable_vector_type_PortableVector
compress_131(libcrux_ml_kem_vector_portable_vector_type_PortableVector v) {
  for (size_t i = (size_t)0U;
       i < LIBCRUX_ML_KEM_VECTOR_TRAITS_FIELD_ELEMENTS_IN_VECTOR; i++) {
    size_t i0 = i;
    int16_t uu____0 =
...
*/
static libcrux_ml_kem_vector_portable_vector_type_PortableVector
compress_0d_991(libcrux_ml_kem_vector_portable_vector_type_PortableVector v) {
  return compress_131(v);
}
...
*/
static KRML_MUSTINLINE void compress_then_serialize_4_59(
    libcrux_ml_kem_polynomial_PolynomialRingElement_f0 re,
  ...
  for (size_t i = (size_t)0U;
    ...
    size_t i0 = i;
    libcrux_ml_kem_vector_portable_vector_type_PortableVector coefficient =
        compress_0d_991(to_unsigned_representative_e5(re.coefficients[i0]));
    uint8_t bytes[8U];
...
*/
static KRML_MUSTINLINE libcrux_ml_kem_vector_portable_vector_type_PortableVector
compress_132(libcrux_ml_kem_vector_portable_vector_type_PortableVector v) {
  for (size_t i = (size_t)0U;
       i < LIBCRUX_ML_KEM_VECTOR_TRAITS_FIELD_ELEMENTS_IN_VECTOR; i++) {
    size_t i0 = i;
    int16_t uu____0 =
...
*/
static libcrux_ml_kem_vector_portable_vector_type_PortableVector
compress_0d_992(libcrux_ml_kem_vector_portable_vector_type_PortableVector v) {
  return compress_132(v);
}
...
static KRML_MUSTINLINE void compress_then_serialize_5_ef(
  ...
  for (size_t i = (size_t)0U;
    ...
    libcrux_ml_kem_vector_portable_vector_type_PortableVector coefficients =
        compress_0d_992(to_unsigned_representative_e5(re.coefficients[i0]));
    uint8_t bytes[10U];
...
- OUT_LEN= 160
*/
static KRML_MUSTINLINE void compress_then_serialize_ring_element_v_1d0(
    libcrux_ml_kem_polynomial_PolynomialRingElement_f0 re, Eurydice_slice out) {
  compress_then_serialize_5_ef(re, out);
}
...
- ETA2_RANDOMNESS_SIZE= 128
*/
static void encrypt_unpacked_841(
  ...
  uint8_t uu____0[33U];
  memcpy(uu____0, prf_input, (size_t)33U * sizeof(uint8_t));
  tuple_710 uu____1 = sample_vector_cbd_then_ntt_a71(uu____0, 0U);
  ...
  tuple_710 uu____3 = sample_ring_element_cbd_bf1(uu____2, domain_separator0);
  libcrux_ml_kem_polynomial_PolynomialRingElement_f0 error_1[4U];
  memcpy(
      error_1, uu____3.fst,
      (size_t)4U * sizeof(libcrux_ml_kem_polynomial_PolynomialRingElement_f0));
  ...
  compute_vector_u_111(public_key->A, r_as_ntt, error_1, u);
  uint8_t uu____4[32U];
  ...
  libcrux_ml_kem_polynomial_PolynomialRingElement_f0 message_as_ring_element =
      deserialize_then_decompress_message_c0(uu____4);
  libcrux_ml_kem_polynomial_PolynomialRingElement_f0 v =
      compute_ring_element_v_d81(public_key->t_as_ntt, r_as_ntt, &error_2,
  ...
  compress_then_serialize_ring_element_v_1d0(
      uu____6,
...
- ETA2_RANDOMNESS_SIZE= 128
*/
tuple_21 libcrux_ml_kem_ind_cca_encapsulate_unpacked_5c1(
  ...
  encrypt_unpacked_841(uu____2, uu____3, pseudorandomness, ciphertext);
...
- K= 4
*/
static KRML_MUSTINLINE void entropy_preprocess_af_fe(Eurydice_slice randomness,
                                                     uint8_t ret[32U]) {
  uint8_t out[32U] = {0U};
  core_slice___Slice_T___copy_from_slice(
...
- K= 4
*/
static KRML_MUSTINLINE void deserialize_ring_elements_reduced_1d3(
    Eurydice_slice public_key,
    libcrux_ml_kem_polynomial_PolynomialRingElement_f0 ret[4U]) {
  libcrux_ml_kem_polynomial_PolynomialRingElement_f0 deserialized_pk[4U];
  KRML_MAYBE_FOR4(i, (size_t)0U, (size_t)4U, (size_t)1U,
...
- ETA2_RANDOMNESS_SIZE= 128
*/
static void encrypt_aa1(Eurydice_slice public_key, uint8_t message[32U],
                        Eurydice_slice randomness, uint8_t ret[1568U]) {
  libcrux_ml_kem_polynomial_PolynomialRingElement_f0 t_as_ntt[4U];
  deserialize_ring_elements_reduced_1d3(
  ...
  memcpy(uu____4, message, (size_t)32U * sizeof(uint8_t));
  uint8_t ret1[1568U];
  encrypt_unpacked_841(uu____3, uu____4, randomness, ret1);
...
- CIPHERTEXT_SIZE= 1568
*/
static KRML_MUSTINLINE void kdf_af_94(Eurydice_slice shared_secret,
                                      uint8_t ret[32U]) {
  uint8_t out[32U] = {0U};
  core_slice___Slice_T___copy_from_slice(
      Eurydice_array_to_slice((size_t)32U, out, uint8_t, Eurydice_slice),
...
- ETA2_RANDOMNESS_SIZE= 128
*/
tuple_21 libcrux_ml_kem_ind_cca_encapsulate_fa1(
    libcrux_ml_kem_types_MlKemPublicKey_1f *public_key,
    uint8_t randomness[32U]) {
  uint8_t randomness0[32U];
  entropy_preprocess_af_fe(
      Eurydice_array_to_slice((size_t)32U, randomness, uint8_t, Eurydice_slice),
      randomness0);
  uint8_t to_hash[64U];
  libcrux_ml_kem_utils_into_padded_array_ea(
  ...
  uint8_t ciphertext[1568U];
  encrypt_aa1(uu____2, uu____3, pseudorandomness, ciphertext);
  uint8_t uu____4[1568U];
  memcpy(uu____4, ciphertext, (size_t)1568U * sizeof(uint8_t));
  libcrux_ml_kem_mlkem1024_MlKem1024Ciphertext ciphertext0 =
      libcrux_ml_kem_types_from_01_101(uu____4);
  uint8_t shared_secret_array[32U];
  kdf_af_94(shared_secret, shared_secret_array);
...
*/
static libcrux_ml_kem_vector_portable_vector_type_PortableVector
decompress_ciphertext_coefficient_0d_83(
    libcrux_ml_kem_vector_portable_vector_type_PortableVector v) {
  return decompress_ciphertext_coefficient_05(v);
}
...
*/
static KRML_MUSTINLINE libcrux_ml_kem_polynomial_PolynomialRingElement_f0
deserialize_then_decompress_10_52(Eurydice_slice serialized) {
  libcrux_ml_kem_polynomial_PolynomialRingElement_f0 re = ZERO_89_8d();
  for (size_t i = (size_t)0U;
       i <
    ...
    libcrux_ml_kem_vector_portable_vector_type_PortableVector uu____0 =
        decompress_ciphertext_coefficient_0d_83(coefficient);
    re.coefficients[i0] = uu____0;
  }
  return re;
}
...
*/
static KRML_MUSTINLINE libcrux_ml_kem_vector_portable_vector_type_PortableVector
decompress_ciphertext_coefficient_050(
    libcrux_ml_kem_vector_portable_vector_type_PortableVector v) {
  for (size_t i = (size_t)0U;
       i < LIBCRUX_ML_KEM_VECTOR_TRAITS_FIELD_ELEMENTS_IN_VECTOR; i++) {
    size_t i0 = i;
...
*/
static libcrux_ml_kem_vector_portable_vector_type_PortableVector
decompress_ciphertext_coefficient_0d_830(
    libcrux_ml_kem_vector_portable_vector_type_PortableVector v) {
  return decompress_ciphertext_coefficient_050(v);
}
...
*/
static KRML_MUSTINLINE libcrux_ml_kem_polynomial_PolynomialRingElement_f0
deserialize_then_decompress_11_4a(Eurydice_slice serialized) {
  libcrux_ml_kem_polynomial_PolynomialRingElement_f0 re = ZERO_89_8d();
  for (size_t i = (size_t)0U;
       i <
    ...
    libcrux_ml_kem_vector_portable_vector_type_PortableVector uu____0 =
        decompress_ciphertext_coefficient_0d_830(coefficient);
    re.coefficients[i0] = uu____0;
  }
  return re;
}
...
deserialize_then_decompress_ring_element_u_c20(Eurydice_slice serialized) {
  return deserialize_then_decompress_11_4a(serialized);
}
...
- VECTOR_U_COMPRESSION_FACTOR= 11
*/
static KRML_MUSTINLINE void ntt_vector_u_390(
    libcrux_ml_kem_polynomial_PolynomialRingElement_f0 *re) {
...
static KRML_MUSTINLINE void deserialize_then_decompress_u_221(
  ...
  for (size_t i = (size_t)0U;
    ...
    Eurydice_slice u_bytes = Eurydice_array_to_subslice2(
        ...
        uint8_t, Eurydice_slice);
    libcrux_ml_kem_polynomial_PolynomialRingElement_f0 uu____0 =
        deserialize_then_decompress_ring_element_u_c20(u_bytes);
    u_as_ntt[i0] = uu____0;
    ntt_vector_u_390(&u_as_ntt[i0]);
  }
  memcpy(
      ret, u_as_ntt,
      (size_t)4U * sizeof(libcrux_ml_kem_polynomial_PolynomialRingElement_f0));
...
*/
static KRML_MUSTINLINE libcrux_ml_kem_vector_portable_vector_type_PortableVector
decompress_ciphertext_coefficient_051(
    libcrux_ml_kem_vector_portable_vector_type_PortableVector v) {
  for (size_t i = (size_t)0U;
       i < LIBCRUX_ML_KEM_VECTOR_TRAITS_FIELD_ELEMENTS_IN_VECTOR; i++) {
    size_t i0 = i;
...
*/
static libcrux_ml_kem_vector_portable_vector_type_PortableVector
decompress_ciphertext_coefficient_0d_831(
    libcrux_ml_kem_vector_portable_vector_type_PortableVector v) {
  return decompress_ciphertext_coefficient_051(v);
}
...
*/
static KRML_MUSTINLINE libcrux_ml_kem_polynomial_PolynomialRingElement_f0
deserialize_then_decompress_4_e5(Eurydice_slice serialized) {
  libcrux_ml_kem_polynomial_PolynomialRingElement_f0 re = ZERO_89_8d();
  for (size_t i = (size_t)0U;
    ...
    libcrux_ml_kem_vector_portable_vector_type_PortableVector uu____0 =
        decompress_ciphertext_coefficient_0d_831(coefficient);
    re.coefficients[i0] = uu____0;
  }
  return re;
}
...
*/
static KRML_MUSTINLINE libcrux_ml_kem_vector_portable_vector_type_PortableVector
decompress_ciphertext_coefficient_052(
    libcrux_ml_kem_vector_portable_vector_type_PortableVector v) {
  for (size_t i = (size_t)0U;
       i < LIBCRUX_ML_KEM_VECTOR_TRAITS_FIELD_ELEMENTS_IN_VECTOR; i++) {
    size_t i0 = i;
...
*/
static libcrux_ml_kem_vector_portable_vector_type_PortableVector
decompress_ciphertext_coefficient_0d_832(
    libcrux_ml_kem_vector_portable_vector_type_PortableVector v) {
  return decompress_ciphertext_coefficient_052(v);
}
...
deserialize_then_decompress_5_a7(Eurydice_slice serialized) {
  ...
  for (size_t i = (size_t)0U;
    ...
    re.coefficients[i0] = uu____0;
    libcrux_ml_kem_vector_portable_vector_type_PortableVector uu____1 =
        decompress_ciphertext_coefficient_0d_832(re.coefficients[i0]);
...
*/
static KRML_MUSTINLINE libcrux_ml_kem_polynomial_PolynomialRingElement_f0
deserialize_then_decompress_ring_element_v_680(Eurydice_slice serialized) {
...
*/
static KRML_MUSTINLINE libcrux_ml_kem_polynomial_PolynomialRingElement_f0
subtract_reduce_89_c3(libcrux_ml_kem_polynomial_PolynomialRingElement_f0 *self,
...
compute_message_c11(
  ...
  KRML_MAYBE_FOR4(i, (size_t)0U, (size_t)4U, (size_t)1U, size_t i0 = i;
                  ...
                  add_to_ring_element_89_e81(&result, &product););
  invert_ntt_montgomery_7b1(&result);
  result = subtract_reduce_89_c3(v, result);
  return result;
}
...
- V_COMPRESSION_FACTOR= 5
*/
static void decrypt_unpacked_891(
  ...
  libcrux_ml_kem_polynomial_PolynomialRingElement_f0 v =
      deserialize_then_decompress_ring_element_v_680(
          Eurydice_array_to_subslice_from((size_t)1568U, ciphertext,
                                          (size_t)1408U, uint8_t, size_t,
                                          Eurydice_slice));
  libcrux_ml_kem_polynomial_PolynomialRingElement_f0 message =
      compute_message_c11(&v, secret_key->secret_as_ntt, u_as_ntt);
  uint8_t ret0[32U];
...
*/
void libcrux_ml_kem_ind_cca_decapsulate_unpacked_751(
    libcrux_ml_kem_ind_cca_unpacked_MlKemKeyPairUnpacked_42 *key_pair,
    libcrux_ml_kem_mlkem1024_MlKem1024Ciphertext *ciphertext,
    uint8_t ret[32U]) {
  uint8_t decrypted[32U];
  decrypt_unpacked_891(&key_pair->private_key.ind_cpa_private_key,
  ...
  encrypt_unpacked_841(uu____3, uu____4, pseudorandomness, expected_ciphertext);
  uint8_t selector =
...
*/
static KRML_MUSTINLINE libcrux_ml_kem_polynomial_PolynomialRingElement_f0
deserialize_to_uncompressed_ring_element_f3(Eurydice_slice serialized) {
  libcrux_ml_kem_polynomial_PolynomialRingElement_f0 re = ZERO_89_8d();
  for (size_t i = (size_t)0U;
       i <
       core_slice___Slice_T___len(serialized, uint8_t, size_t) / (size_t)24U;
...
static KRML_MUSTINLINE void deserialize_secret_key_421(
  ...
  for (size_t i = (size_t)0U;
    ...
    Eurydice_slice secret_bytes = Eurydice_slice_subslice2(
        ...
        uint8_t, Eurydice_slice);
    libcrux_ml_kem_polynomial_PolynomialRingElement_f0 uu____0 =
        deserialize_to_uncompressed_ring_element_f3(secret_bytes);
...
- V_COMPRESSION_FACTOR= 5
*/
static void decrypt_ac1(Eurydice_slice secret_key, uint8_t *ciphertext,
                        uint8_t ret[32U]) {
  libcrux_ml_kem_polynomial_PolynomialRingElement_f0 secret_as_ntt[4U];
  deserialize_secret_key_421(secret_key, secret_as_ntt);
  libcrux_ml_kem_polynomial_PolynomialRingElement_f0 uu____0[4U];
  memcpy(
...
- IMPLICIT_REJECTION_HASH_INPUT_SIZE= 1600
*/
void libcrux_ml_kem_ind_cca_decapsulate_241(
    libcrux_ml_kem_types_MlKemPrivateKey_95 *private_key,
    libcrux_ml_kem_mlkem1024_MlKem1024Ciphertext *ciphertext,
    uint8_t ret[32U]) {
  Eurydice_slice_uint8_t_x2 uu____0 = core_slice___Slice_T___split_at(
  ...
  uint8_t decrypted[32U];
  decrypt_ac1(ind_cpa_secret_key, ciphertext->value, decrypted);
  uint8_t to_hash0[64U];
  libcrux_ml_kem_utils_into_padded_array_ea(
      Eurydice_array_to_slice((size_t)32U, decrypted, uint8_t, Eurydice_slice),
      to_hash0);
  ...
  uint8_t expected_ciphertext[1568U];
  encrypt_aa1(uu____5, uu____6, pseudorandomness, expected_ciphertext);
  uint8_t implicit_rejection_shared_secret[32U];
  kdf_af_94(
  ...
  kdf_af_94(shared_secret0, shared_secret);
  uint8_t ret0[32U];
...
- PUBLIC_KEY_SIZE= 800
*/
bool libcrux_ml_kem_ind_cca_validate_public_key_600(uint8_t *public_key) {
  libcrux_ml_kem_polynomial_PolynomialRingElement_f0 deserialized_pk[2U];
  deserialize_ring_elements_reduced_1d2(
...
shake128_init_absorb_f1_8c0(uint8_t input[2U][34U]) {
  ...
  return shake128_init_absorb_b70(uu____0);
}
...
- N= 504
*/
static KRML_MUSTINLINE bool sample_from_uniform_distribution_next_2c1(
...
- N= 168
*/
static KRML_MUSTINLINE bool sample_from_uniform_distribution_next_2c2(
...
- K= 2
*/
static libcrux_ml_kem_polynomial_PolynomialRingElement_f0 closure_2f0(
    int16_t s[272U]) {
  return from_i16_array_89_ca(Eurydice_array_to_subslice2(
      s, (size_t)0U, (size_t)256U, int16_t, Eurydice_slice));
}
...
- K= 2
*/
static KRML_MUSTINLINE void sample_from_xof_d40(
  ...
  PortableHash_8b xof_state = shake128_init_absorb_f1_8c0(uu____0);
  ...
  bool done = sample_from_uniform_distribution_next_2c1(
      uu____1, sampled_coefficients, out);
  while (true) {
    if (done) {
      break;
      ...
      done = sample_from_uniform_distribution_next_2c2(
          uu____2, sampled_coefficients, out);
    }
  }
...
static KRML_MUSTINLINE void sample_matrix_A_050(
  ...
  KRML_MAYBE_FOR2(
      ...
      sample_from_xof_d40(uu____1, sampled);
      for (size_t i = (size_t)0U;
           i < core_slice___Slice_T___len(
                   Eurydice_array_to_slice(
                       (size_t)2U, sampled,
...
*/
static KRML_MUSTINLINE libcrux_ml_kem_polynomial_PolynomialRingElement_f0
sample_from_binomial_distribution_340(Eurydice_slice randomness) {
  return sample_from_binomial_distribution_3_b0(randomness);
}
...
static KRML_MUSTINLINE tuple_740 sample_vector_cbd_then_ntt_a70(
  ...
  KRML_MAYBE_FOR2(
      i, (size_t)0U, (size_t)2U, (size_t)1U, size_t i0 = i;
      libcrux_ml_kem_polynomial_PolynomialRingElement_f0 uu____1 =
          sample_from_binomial_distribution_340(Eurydice_array_to_slice(
...
- K= 2
*/
static KRML_MUSTINLINE void compute_As_plus_e_cb0(
...
*/
static tuple_4c0 generate_keypair_unpacked_d10(
    Eurydice_slice key_generation_seed) {
  uint8_t hashed[64U];
  ...
  uint8_t uu____1[33U];
  memcpy(uu____1, prf_input, (size_t)33U * sizeof(uint8_t));
  tuple_740 uu____2 = sample_vector_cbd_then_ntt_a70(uu____1, 0U);
  ...
  memcpy(
      error_as_ntt,
      sample_vector_cbd_then_ntt_a70(uu____3, domain_separator).fst,
      (size_t)2U * sizeof(libcrux_ml_kem_polynomial_PolynomialRingElement_f0));
  libcrux_ml_kem_polynomial_PolynomialRingElement_f0 t_as_ntt[2U];
  compute_As_plus_e_cb0(A_transpose, secret_as_ntt, error_as_ntt, t_as_ntt);
  uint8_t seed_for_A[32U];
  core_result_Result_00 dst;
  Eurydice_slice_to_array2(&dst, seed_for_A0, Eurydice_slice, uint8_t[32U],
                           void *);
...
libcrux_ml_kem_ind_cca_generate_keypair_unpacked_4a0(uint8_t randomness[64U]) {
  Eurydice_slice ind_cpa_keypair_randomness = Eurydice_array_to_subslice2(
      randomness, (size_t)0U,
      LIBCRUX_ML_KEM_CONSTANTS_CPA_PKE_KEY_GENERATION_SEED_SIZE, uint8_t,
      Eurydice_slice);
  Eurydice_slice implicit_rejection_value0 = Eurydice_array_to_subslice_from(
      ...
      LIBCRUX_ML_KEM_CONSTANTS_CPA_PKE_KEY_GENERATION_SEED_SIZE, uint8_t,
      size_t, Eurydice_slice);
  tuple_4c0 uu____0 = generate_keypair_unpacked_d10(ind_cpa_keypair_randomness);
  ...
  KRML_MAYBE_FOR2(i, (size_t)0U, (size_t)2U, (size_t)1U, closure_f00(A[i]););
  KRML_MAYBE_FOR2(
  ...
  serialize_public_key_eb0(
      ...
      pk_serialized);
  uint8_t public_key_hash[32U];
  H_f1_1a0(Eurydice_array_to_slice((size_t)800U, pk_serialized, uint8_t,
                                   Eurydice_slice),
           public_key_hash);
  uint8_t implicit_rejection_value[32U];
  core_result_Result_00 dst;
...
- ETA1_RANDOMNESS_SIZE= 192
*/
static libcrux_ml_kem_utils_extraction_helper_Keypair512 generate_keypair_c50(
    Eurydice_slice key_generation_seed) {
  tuple_4c0 uu____0 = generate_keypair_unpacked_d10(key_generation_seed);
  ...
  serialize_secret_key_6d0(sk.secret_as_ntt, secret_key_serialized);
...
*/
static KRML_MUSTINLINE void serialize_kem_secret_key_12(
    Eurydice_slice private_key, Eurydice_slice public_key,
...
libcrux_ml_kem_ind_cca_generate_keypair_ef0(uint8_t randomness[64U]) {
  Eurydice_slice ind_cpa_keypair_randomness = Eurydice_array_to_subslice2(
      randomness, (size_t)0U,
      LIBCRUX_ML_KEM_CONSTANTS_CPA_PKE_KEY_GENERATION_SEED_SIZE, uint8_t,
      Eurydice_slice);
  ...
  libcrux_ml_kem_utils_extraction_helper_Keypair512 uu____0 =
      generate_keypair_c50(ind_cpa_keypair_randomness);
...
sample_ring_element_cbd_bf0(uint8_t prf_input[33U], uint8_t domain_separator) {
...
- K= 2
*/
static KRML_MUSTINLINE void compute_vector_u_110(
...
static KRML_MUSTINLINE void compress_then_serialize_10_7b(
  ...
  for (size_t i = (size_t)0U;
    ...
    size_t i0 = i;
    libcrux_ml_kem_vector_portable_vector_type_PortableVector coefficient =
        compress_0d_99(to_unsigned_representative_e5(re->coefficients[i0]));
    uint8_t bytes[20U];
...
- OUT_LEN= 320
*/
static KRML_MUSTINLINE void compress_then_serialize_ring_element_u_42(
    libcrux_ml_kem_polynomial_PolynomialRingElement_f0 *re, uint8_t ret[320U]) {
  uint8_t uu____0[320U];
  compress_then_serialize_10_7b(re, uu____0);
...
- BLOCK_LEN= 320
*/
static void compress_then_serialize_u_e70(
  ...
  for (size_t i = (size_t)0U;
    ...
    Eurydice_slice uu____0 = Eurydice_slice_subslice2(
        ...
        Eurydice_slice);
    uint8_t ret[320U];
    compress_then_serialize_ring_element_u_42(&re, ret);
    core_slice___Slice_T___copy_from_slice(
        uu____0,
...
static KRML_MUSTINLINE void compress_then_serialize_ring_element_v_1d(
    libcrux_ml_kem_polynomial_PolynomialRingElement_f0 re, Eurydice_slice out) {
  compress_then_serialize_4_59(re, out);
}
...
- ETA2_RANDOMNESS_SIZE= 128
*/
static void encrypt_unpacked_840(
  ...
  uint8_t uu____0[33U];
  memcpy(uu____0, prf_input, (size_t)33U * sizeof(uint8_t));
  tuple_740 uu____1 = sample_vector_cbd_then_ntt_a70(uu____0, 0U);
  ...
  uint8_t uu____2[33U];
  memcpy(uu____2, prf_input, (size_t)33U * sizeof(uint8_t));
  tuple_740 uu____3 = sample_ring_element_cbd_bf0(uu____2, domain_separator0);
  libcrux_ml_kem_polynomial_PolynomialRingElement_f0 error_1[2U];
  memcpy(
      error_1, uu____3.fst,
      (size_t)2U * sizeof(libcrux_ml_kem_polynomial_PolynomialRingElement_f0));
  ...
  compute_vector_u_110(public_key->A, r_as_ntt, error_1, u);
  uint8_t uu____4[32U];
  memcpy(uu____4, message, (size_t)32U * sizeof(uint8_t));
  libcrux_ml_kem_polynomial_PolynomialRingElement_f0 message_as_ring_element =
      deserialize_then_decompress_message_c0(uu____4);
  libcrux_ml_kem_polynomial_PolynomialRingElement_f0 v =
      compute_ring_element_v_d80(public_key->t_as_ntt, r_as_ntt, &error_2,
                                 &message_as_ring_element);
  ...
  memcpy(
      uu____5, u,
      (size_t)2U * sizeof(libcrux_ml_kem_polynomial_PolynomialRingElement_f0));
  compress_then_serialize_u_e70(
      uu____5, Eurydice_array_to_subslice2(ciphertext, (size_t)0U, (size_t)640U,
                                           uint8_t, Eurydice_slice));
  libcrux_ml_kem_polynomial_PolynomialRingElement_f0 uu____6 = v;
  compress_then_serialize_ring_element_v_1d(
      uu____6,
...
- ETA2_RANDOMNESS_SIZE= 128
*/
tuple_ec libcrux_ml_kem_ind_cca_encapsulate_unpacked_5c0(
  ...
  encrypt_unpacked_840(uu____2, uu____3, pseudorandomness, ciphertext);
  uint8_t shared_secret_array[32U] = {0U};
  core_slice___Slice_T___copy_from_slice(
      Eurydice_array_to_slice((size_t)32U, shared_secret_array, uint8_t,
                              Eurydice_slice),
...
- K= 2
*/
static KRML_MUSTINLINE void deserialize_ring_elements_reduced_1d1(
    Eurydice_slice public_key,
    libcrux_ml_kem_polynomial_PolynomialRingElement_f0 ret[2U]) {
  libcrux_ml_kem_polynomial_PolynomialRingElement_f0 deserialized_pk[2U];
  KRML_MAYBE_FOR2(i, (size_t)0U, (size_t)2U, (size_t)1U,
...
- ETA2_RANDOMNESS_SIZE= 128
*/
static void encrypt_aa0(Eurydice_slice public_key, uint8_t message[32U],
                        Eurydice_slice randomness, uint8_t ret[768U]) {
  libcrux_ml_kem_polynomial_PolynomialRingElement_f0 t_as_ntt[2U];
  deserialize_ring_elements_reduced_1d1(
  ...
  memcpy(uu____4, message, (size_t)32U * sizeof(uint8_t));
  uint8_t ret1[768U];
  encrypt_unpacked_840(uu____3, uu____4, randomness, ret1);
...
- CIPHERTEXT_SIZE= 768
*/
static KRML_MUSTINLINE void kdf_af_06(Eurydice_slice shared_secret,
                                      uint8_t ret[32U]) {
  uint8_t out[32U] = {0U};
  core_slice___Slice_T___copy_from_slice(
      Eurydice_array_to_slice((size_t)32U, out, uint8_t, Eurydice_slice),
...
- ETA2_RANDOMNESS_SIZE= 128
*/
tuple_ec libcrux_ml_kem_ind_cca_encapsulate_fa0(
  ...
  memcpy(uu____3, randomness0, (size_t)32U * sizeof(uint8_t));
  uint8_t ciphertext[768U];
  encrypt_aa0(uu____2, uu____3, pseudorandomness, ciphertext);
  uint8_t uu____4[768U];
  memcpy(uu____4, ciphertext, (size_t)768U * sizeof(uint8_t));
  libcrux_ml_kem_types_MlKemCiphertext_e8 ciphertext0 =
      libcrux_ml_kem_types_from_01_10(uu____4);
  uint8_t shared_secret_array[32U];
  kdf_af_06(shared_secret, shared_secret_array);
...
- VECTOR_U_COMPRESSION_FACTOR= 10
*/
static KRML_MUSTINLINE void ntt_vector_u_39(
    libcrux_ml_kem_polynomial_PolynomialRingElement_f0 *re) {
  size_t zeta_i = (size_t)0U;
  ntt_at_layer_4_plus_39(&zeta_i, re, (size_t)7U);
  ntt_at_layer_4_plus_39(&zeta_i, re, (size_t)6U);
...
static KRML_MUSTINLINE void deserialize_then_decompress_u_220(
  ...
  for (size_t i = (size_t)0U;
    ...
    Eurydice_slice u_bytes = Eurydice_array_to_subslice2(
        ...
        uint8_t, Eurydice_slice);
    libcrux_ml_kem_polynomial_PolynomialRingElement_f0 uu____0 =
        deserialize_then_decompress_ring_element_u_c2(u_bytes);
    u_as_ntt[i0] = uu____0;
    ntt_vector_u_39(&u_as_ntt[i0]);
  }
  memcpy(
      ret, u_as_ntt,
      (size_t)2U * sizeof(libcrux_ml_kem_polynomial_PolynomialRingElement_f0));
...
*/
static KRML_MUSTINLINE libcrux_ml_kem_polynomial_PolynomialRingElement_f0
deserialize_then_decompress_ring_element_v_68(Eurydice_slice serialized) {
  return deserialize_then_decompress_4_e5(serialized);
}
...
- V_COMPRESSION_FACTOR= 4
*/
static void decrypt_unpacked_890(
  ...
  libcrux_ml_kem_polynomial_PolynomialRingElement_f0 v =
      deserialize_then_decompress_ring_element_v_68(
          Eurydice_array_to_subslice_from((size_t)768U, ciphertext,
                                          (size_t)640U, uint8_t, size_t,
                                          Eurydice_slice));
  libcrux_ml_kem_polynomial_PolynomialRingElement_f0 message =
      compute_message_c10(&v, secret_key->secret_as_ntt, u_as_ntt);
  uint8_t ret0[32U];
  compress_then_serialize_message_79(message, ret0);
  memcpy(ret, ret0, (size_t)32U * sizeof(uint8_t));
}
...
void libcrux_ml_kem_ind_cca_decapsulate_unpacked_750(
  ...
  uint8_t decrypted[32U];
  decrypt_unpacked_890(&key_pair->private_key.ind_cpa_private_key,
                       ciphertext->value, decrypted);
  uint8_t to_hash0[64U];
  libcrux_ml_kem_utils_into_padded_array_ea(
      Eurydice_array_to_slice((size_t)32U, decrypted, uint8_t, Eurydice_slice),
  ...
  encrypt_unpacked_840(uu____3, uu____4, pseudorandomness, expected_ciphertext);
  uint8_t selector =
      libcrux_ml_kem_constant_time_ops_compare_ciphertexts_in_constant_time(
...
- K= 2
*/
static KRML_MUSTINLINE void deserialize_secret_key_420(
    Eurydice_slice secret_key,
    libcrux_ml_kem_polynomial_PolynomialRingElement_f0 ret[2U]) {
  libcrux_ml_kem_polynomial_PolynomialRingElement_f0 secret_as_ntt[2U];
  KRML_MAYBE_FOR2(i, (size_t)0U, (size_t)2U, (size_t)1U,
...
- V_COMPRESSION_FACTOR= 4
*/
static void decrypt_ac0(Eurydice_slice secret_key, uint8_t *ciphertext,
                        uint8_t ret[32U]) {
  libcrux_ml_kem_polynomial_PolynomialRingElement_f0 secret_as_ntt[2U];
  deserialize_secret_key_420(secret_key, secret_as_ntt);
  libcrux_ml_kem_polynomial_PolynomialRingElement_f0 uu____0[2U];
  memcpy(
      uu____0, secret_as_ntt,
      (size_t)2U * sizeof(libcrux_ml_kem_polynomial_PolynomialRingElement_f0));
...
void libcrux_ml_kem_ind_cca_decapsulate_240(
  ...
  Eurydice_slice implicit_rejection_value = uu____2.snd;
  uint8_t decrypted[32U];
  decrypt_ac0(ind_cpa_secret_key, ciphertext->value, decrypted);
  uint8_t to_hash0[64U];
  libcrux_ml_kem_utils_into_padded_array_ea(
      Eurydice_array_to_slice((size_t)32U, decrypted, uint8_t, Eurydice_slice),
      to_hash0);
  ...
  kdf_af_06(
      ...
      implicit_rejection_shared_secret);
  uint8_t shared_secret[32U];
  kdf_af_06(shared_secret0, shared_secret);
  uint8_t ret0[32U];
  libcrux_ml_kem_constant_time_ops_compare_ciphertexts_select_shared_secret_in_constant_time(
      libcrux_ml_kem_types_as_ref_00_79(ciphertext),
      Eurydice_array_to_slice((size_t)768U, expected_ciphertext, uint8_t,
...
- K= 3
*/
static KRML_MUSTINLINE void deserialize_ring_elements_reduced_1d0(
    Eurydice_slice public_key,
...
- PUBLIC_KEY_SIZE= 1184
*/
bool libcrux_ml_kem_ind_cca_validate_public_key_60(uint8_t *public_key) {
  libcrux_ml_kem_polynomial_PolynomialRingElement_f0 deserialized_pk[3U];
  deserialize_ring_elements_reduced_1d0(
...
shake128_init_absorb_f1_8c(uint8_t input[3U][34U]) {
  ...
  return shake128_init_absorb_b7(uu____0);
}
...
- N= 504
*/
static KRML_MUSTINLINE bool sample_from_uniform_distribution_next_2c(
...
- K= 3
*/
static libcrux_ml_kem_polynomial_PolynomialRingElement_f0 closure_2f(
    int16_t s[272U]) {
  return from_i16_array_89_ca(Eurydice_array_to_subslice2(
      s, (size_t)0U, (size_t)256U, int16_t, Eurydice_slice));
}
...
- K= 3
*/
static KRML_MUSTINLINE void sample_from_xof_d4(
  ...
  PortableHash_58 xof_state = shake128_init_absorb_f1_8c(uu____0);
  ...
  bool done = sample_from_uniform_distribution_next_2c(
      uu____1, sampled_coefficients, out);
  while (true) {
    if (done) {
      break;
      ...
      done = sample_from_uniform_distribution_next_2c0(
          uu____2, sampled_coefficients, out);
    }
  }
...
static KRML_MUSTINLINE void sample_matrix_A_05(
  ...
  KRML_MAYBE_FOR3(
      ...
      sample_from_xof_d4(uu____1, sampled);
      for (size_t i = (size_t)0U;
           i < core_slice___Slice_T___len(
                   Eurydice_array_to_slice(
                       (size_t)3U, sampled,
...
- ETA_RANDOMNESS_SIZE= 128
*/
static KRML_MUSTINLINE tuple_b0 sample_vector_cbd_then_ntt_a7(
    uint8_t prf_input[33U], uint8_t domain_separator) {
...
- K= 3
*/
static KRML_MUSTINLINE void add_to_ring_element_89_e8(
    libcrux_ml_kem_polynomial_PolynomialRingElement_f0 *self,
    libcrux_ml_kem_polynomial_PolynomialRingElement_f0 *rhs) {
  for (size_t i = (size_t)0U;
       i < core_slice___Slice_T___len(
...
- K= 3
*/
static KRML_MUSTINLINE void compute_As_plus_e_cb(
...
- ETA1_RANDOMNESS_SIZE= 128
*/
static tuple_9b generate_keypair_unpacked_d1(
    Eurydice_slice key_generation_seed) {
  uint8_t hashed[64U];
  ...
  uint8_t uu____1[33U];
  memcpy(uu____1, prf_input, (size_t)33U * sizeof(uint8_t));
  tuple_b0 uu____2 = sample_vector_cbd_then_ntt_a7(uu____1, 0U);
  ...
  memcpy(
      error_as_ntt,
      sample_vector_cbd_then_ntt_a7(uu____3, domain_separator).fst,
      (size_t)3U * sizeof(libcrux_ml_kem_polynomial_PolynomialRingElement_f0));
  libcrux_ml_kem_polynomial_PolynomialRingElement_f0 t_as_ntt[3U];
  compute_As_plus_e_cb(A_transpose, secret_as_ntt, error_as_ntt, t_as_ntt);
  uint8_t seed_for_A[32U];
  core_result_Result_00 dst;
  Eurydice_slice_to_array2(&dst, seed_for_A0, Eurydice_slice, uint8_t[32U],
                           void *);
...
libcrux_ml_kem_ind_cca_generate_keypair_unpacked_4a(uint8_t randomness[64U]) {
  Eurydice_slice ind_cpa_keypair_randomness = Eurydice_array_to_subslice2(
      randomness, (size_t)0U,
      LIBCRUX_ML_KEM_CONSTANTS_CPA_PKE_KEY_GENERATION_SEED_SIZE, uint8_t,
      Eurydice_slice);
  Eurydice_slice implicit_rejection_value0 = Eurydice_array_to_subslice_from(
      ...
      LIBCRUX_ML_KEM_CONSTANTS_CPA_PKE_KEY_GENERATION_SEED_SIZE, uint8_t,
      size_t, Eurydice_slice);
  tuple_9b uu____0 = generate_keypair_unpacked_d1(ind_cpa_keypair_randomness);
  ...
  KRML_MAYBE_FOR3(i, (size_t)0U, (size_t)3U, (size_t)1U, closure_f0(A[i]););
  KRML_MAYBE_FOR3(
  ...
  serialize_public_key_eb(
      ...
      pk_serialized);
  uint8_t public_key_hash[32U];
  H_f1_1a(Eurydice_array_to_slice((size_t)1184U, pk_serialized, uint8_t,
                                  Eurydice_slice),
          public_key_hash);
  uint8_t implicit_rejection_value[32U];
  core_result_Result_00 dst;
...
- ETA1_RANDOMNESS_SIZE= 128
*/
static libcrux_ml_kem_utils_extraction_helper_Keypair768 generate_keypair_c5(
    Eurydice_slice key_generation_seed) {
  tuple_9b uu____0 = generate_keypair_unpacked_d1(key_generation_seed);
  ...
  uint8_t public_key_serialized[1184U];
  serialize_public_key_eb(pk.t_as_ntt,
                          Eurydice_array_to_slice((size_t)32U, pk.seed_for_A,
                                                  uint8_t, Eurydice_slice),
                          public_key_serialized);
  uint8_t secret_key_serialized[1152U];
  serialize_secret_key_6d(sk.secret_as_ntt, secret_key_serialized);
...
libcrux_ml_kem_ind_cca_generate_keypair_ef(uint8_t randomness[64U]) {
  Eurydice_slice ind_cpa_keypair_randomness = Eurydice_array_to_subslice2(
      randomness, (size_t)0U,
      LIBCRUX_ML_KEM_CONSTANTS_CPA_PKE_KEY_GENERATION_SEED_SIZE, uint8_t,
      Eurydice_slice);
  ...
  libcrux_ml_kem_utils_extraction_helper_Keypair768 uu____0 =
      generate_keypair_c5(ind_cpa_keypair_randomness);
...
sample_ring_element_cbd_bf(uint8_t prf_input[33U], uint8_t domain_separator) {
...
- K= 3
*/
static KRML_MUSTINLINE void compute_vector_u_11(
...
- BLOCK_LEN= 320
*/
static void compress_then_serialize_u_e7(
...
- ETA2_RANDOMNESS_SIZE= 128
*/
static void encrypt_unpacked_84(
  ...
  uint8_t uu____0[33U];
  memcpy(uu____0, prf_input, (size_t)33U * sizeof(uint8_t));
  tuple_b0 uu____1 = sample_vector_cbd_then_ntt_a7(uu____0, 0U);
  ...
  uint8_t uu____2[33U];
  memcpy(uu____2, prf_input, (size_t)33U * sizeof(uint8_t));
  tuple_b0 uu____3 = sample_ring_element_cbd_bf(uu____2, domain_separator0);
  libcrux_ml_kem_polynomial_PolynomialRingElement_f0 error_1[3U];
  memcpy(
      error_1, uu____3.fst,
      (size_t)3U * sizeof(libcrux_ml_kem_polynomial_PolynomialRingElement_f0));
  ...
  compute_vector_u_11(public_key->A, r_as_ntt, error_1, u);
  uint8_t uu____4[32U];
  memcpy(uu____4, message, (size_t)32U * sizeof(uint8_t));
  libcrux_ml_kem_polynomial_PolynomialRingElement_f0 message_as_ring_element =
      deserialize_then_decompress_message_c0(uu____4);
  libcrux_ml_kem_polynomial_PolynomialRingElement_f0 v =
      compute_ring_element_v_d8(public_key->t_as_ntt, r_as_ntt, &error_2,
                                &message_as_ring_element);
...
tuple_3c libcrux_ml_kem_ind_cca_encapsulate_unpacked_5c(
  ...
  encrypt_unpacked_84(uu____2, uu____3, pseudorandomness, ciphertext);
  uint8_t shared_secret_array[32U] = {0U};
  core_slice___Slice_T___copy_from_slice(
      Eurydice_array_to_slice((size_t)32U, shared_secret_array, uint8_t,
                              Eurydice_slice),
...
- K= 3
*/
static KRML_MUSTINLINE void entropy_preprocess_af_5a(Eurydice_slice randomness,
                                                     uint8_t ret[32U]) {
  uint8_t out[32U] = {0U};
  core_slice___Slice_T___copy_from_slice(
      Eurydice_array_to_slice((size_t)32U, out, uint8_t, Eurydice_slice),
...
- K= 3
*/
static KRML_MUSTINLINE void deserialize_ring_elements_reduced_1d(
    Eurydice_slice public_key,
    libcrux_ml_kem_polynomial_PolynomialRingElement_f0 ret[3U]) {
  libcrux_ml_kem_polynomial_PolynomialRingElement_f0 deserialized_pk[3U];
  KRML_MAYBE_FOR3(i, (size_t)0U, (size_t)3U, (size_t)1U,
...
- ETA2_RANDOMNESS_SIZE= 128
*/
static void encrypt_aa(Eurydice_slice public_key, uint8_t message[32U],
                       Eurydice_slice randomness, uint8_t ret[1088U]) {
  libcrux_ml_kem_polynomial_PolynomialRingElement_f0 t_as_ntt[3U];
  deserialize_ring_elements_reduced_1d(
  ...
  memcpy(uu____4, message, (size_t)32U * sizeof(uint8_t));
  uint8_t ret1[1088U];
  encrypt_unpacked_84(uu____3, uu____4, randomness, ret1);
...
- CIPHERTEXT_SIZE= 1088
*/
static KRML_MUSTINLINE void kdf_af_ee(Eurydice_slice shared_secret,
                                      uint8_t ret[32U]) {
  uint8_t out[32U] = {0U};
  core_slice___Slice_T___copy_from_slice(
      Eurydice_array_to_slice((size_t)32U, out, uint8_t, Eurydice_slice),
...
- ETA2_RANDOMNESS_SIZE= 128
*/
tuple_3c libcrux_ml_kem_ind_cca_encapsulate_fa(
    libcrux_ml_kem_types_MlKemPublicKey_15 *public_key,
    uint8_t randomness[32U]) {
  uint8_t randomness0[32U];
  entropy_preprocess_af_5a(
      Eurydice_array_to_slice((size_t)32U, randomness, uint8_t, Eurydice_slice),
      randomness0);
  uint8_t to_hash[64U];
  libcrux_ml_kem_utils_into_padded_array_ea(
  ...
  memcpy(uu____3, randomness0, (size_t)32U * sizeof(uint8_t));
  uint8_t ciphertext[1088U];
  encrypt_aa(uu____2, uu____3, pseudorandomness, ciphertext);
  uint8_t uu____4[1088U];
  memcpy(uu____4, ciphertext, (size_t)1088U * sizeof(uint8_t));
  libcrux_ml_kem_mlkem768_MlKem768Ciphertext ciphertext0 =
      libcrux_ml_kem_types_from_01_100(uu____4);
  uint8_t shared_secret_array[32U];
  kdf_af_ee(shared_secret, shared_secret_array);
...
- V_COMPRESSION_FACTOR= 4
*/
static void decrypt_unpacked_89(
  ...
  libcrux_ml_kem_polynomial_PolynomialRingElement_f0 v =
      deserialize_then_decompress_ring_element_v_68(
          Eurydice_array_to_subslice_from((size_t)1088U, ciphertext,
                                          ...
                                          Eurydice_slice));
  libcrux_ml_kem_polynomial_PolynomialRingElement_f0 message =
      compute_message_c1(&v, secret_key->secret_as_ntt, u_as_ntt);
  uint8_t ret0[32U];
  compress_then_serialize_message_79(message, ret0);
  memcpy(ret, ret0, (size_t)32U * sizeof(uint8_t));
}
...
*/
void libcrux_ml_kem_ind_cca_decapsulate_unpacked_75(
    libcrux_ml_kem_ind_cca_unpacked_MlKemKeyPairUnpacked_f8 *key_pair,
    libcrux_ml_kem_mlkem768_MlKem768Ciphertext *ciphertext, uint8_t ret[32U]) {
  uint8_t decrypted[32U];
  decrypt_unpacked_89(&key_pair->private_key.ind_cpa_private_key,
                      ciphertext->value, decrypted);
  uint8_t to_hash0[64U];
  libcrux_ml_kem_utils_into_padded_array_ea(
      Eurydice_array_to_slice((size_t)32U, decrypted, uint8_t, Eurydice_slice),
  ...
  encrypt_unpacked_84(uu____3, uu____4, pseudorandomness, expected_ciphertext);
  uint8_t selector =
      libcrux_ml_kem_constant_time_ops_compare_ciphertexts_in_constant_time(
...
- V_COMPRESSION_FACTOR= 4
*/
static void decrypt_ac(Eurydice_slice secret_key, uint8_t *ciphertext,
                       uint8_t ret[32U]) {
  libcrux_ml_kem_polynomial_PolynomialRingElement_f0 secret_as_ntt[3U];
...
void libcrux_ml_kem_ind_cca_decapsulate_24(
  ...
  Eurydice_slice implicit_rejection_value = uu____2.snd;
  uint8_t decrypted[32U];
  decrypt_ac(ind_cpa_secret_key, ciphertext->value, decrypted);
  uint8_t to_hash0[64U];
  libcrux_ml_kem_utils_into_padded_array_ea(
      Eurydice_array_to_slice((size_t)32U, decrypted, uint8_t, Eurydice_slice),
      to_hash0);
  ...
  kdf_af_ee(
      ...
      implicit_rejection_shared_secret);
  uint8_t shared_secret[32U];
  kdf_af_ee(shared_secret0, shared_secret);
  uint8_t ret0[32U];
  libcrux_ml_kem_constant_time_ops_compare_ciphertexts_select_shared_secret_in_constant_time(
      libcrux_ml_kem_types_as_ref_00_790(ciphertext),
      Eurydice_array_to_slice((size_t)1088U, expected_ciphertext, uint8_t,
