...
shake128_init_absorb_f1_511(uint8_t input[4U][34U]) {
  ...
  return shake128_init_absorb_411(copy_of_input);
}
...
static KRML_MUSTINLINE void sample_from_xof_f61(
  ...
  PortableHash_d1 xof_state = shake128_init_absorb_f1_511(copy_of_seeds);
  ...
  KRML_MAYBE_FOR4(i, (size_t)0U, (size_t)4U, (size_t)1U,
                  ret0[i] = closure_131(copy_of_out[i]););
  memcpy(
      ret, ret0,
      (size_t)4U * sizeof(libcrux_ml_kem_polynomial_PolynomialRingElement_f0));
}
...
static KRML_MUSTINLINE void sample_matrix_A_551(
  ...
  KRML_MAYBE_FOR4(
      ...
      sample_from_xof_f61(copy_of_seeds, sampled);
      for (size_t i = (size_t)0U;
           i < core_slice___Slice_T___len(
                   Eurydice_array_to_slice(
                       (size_t)4U, sampled,
...
static tuple_540 generate_keypair_unpacked_a91(
  ...
  tuple_710 uu____2 = sample_vector_cbd_then_ntt_011(copy_of_prf_input0, 0U);
  ...
  memcpy(
      error_as_ntt,
      sample_vector_cbd_then_ntt_011(copy_of_prf_input, domain_separator).fst,
      (size_t)4U * sizeof(libcrux_ml_kem_polynomial_PolynomialRingElement_f0));
...
static void encrypt_unpacked_651(
  ...
  uint8_t copy_of_prf_input0[33U];
  memcpy(copy_of_prf_input0, prf_input, (size_t)33U * sizeof(uint8_t));
  tuple_710 uu____1 = sample_vector_cbd_then_ntt_011(copy_of_prf_input0, 0U);
...
tuple_21 libcrux_ml_kem_ind_cca_encapsulate_unpacked_861(
  ...
  encrypt_unpacked_651(uu____2, copy_of_randomness, pseudorandomness,
                       ciphertext);
...
static void encrypt_f71(Eurydice_slice public_key, uint8_t message[32U],
  ...
  memcpy(copy_of_message, message, (size_t)32U * sizeof(uint8_t));
  uint8_t ret1[1568U];
  encrypt_unpacked_651(uu____3, copy_of_message, randomness, ret1);
...
tuple_21 libcrux_ml_kem_ind_cca_encapsulate_9d1(
  ...
  uint8_t ciphertext[1568U];
  encrypt_f71(uu____2, copy_of_randomness, pseudorandomness, ciphertext);
  /* Passing arrays by value in Rust generates a copy in C */
  uint8_t copy_of_ciphertext[1568U];
  memcpy(copy_of_ciphertext, ciphertext, (size_t)1568U * sizeof(uint8_t));
...
void libcrux_ml_kem_ind_cca_decapsulate_unpacked_f61(
  ...
  encrypt_unpacked_651(uu____3, copy_of_decrypted, pseudorandomness,
                       expected_ciphertext);
  uint8_t selector =
...
void libcrux_ml_kem_ind_cca_decapsulate_711(
  ...
  memcpy(copy_of_decrypted, decrypted, (size_t)32U * sizeof(uint8_t));
  uint8_t expected_ciphertext[1568U];
  encrypt_f71(uu____5, copy_of_decrypted, pseudorandomness,
              expected_ciphertext);
  uint8_t implicit_rejection_shared_secret[32U];
  kdf_af_f4(
...
shake128_init_absorb_f1_510(uint8_t input[2U][34U]) {
  ...
  return shake128_init_absorb_410(copy_of_input);
}
...
static KRML_MUSTINLINE void sample_from_xof_f60(
  ...
  PortableHash_8b xof_state = shake128_init_absorb_f1_510(copy_of_seeds);
  ...
  KRML_MAYBE_FOR2(i, (size_t)0U, (size_t)2U, (size_t)1U,
                  ret0[i] = closure_130(copy_of_out[i]););
  memcpy(
      ret, ret0,
      (size_t)2U * sizeof(libcrux_ml_kem_polynomial_PolynomialRingElement_f0));
}
...
static KRML_MUSTINLINE void sample_matrix_A_550(
  ...
  KRML_MAYBE_FOR2(
      ...
      sample_from_xof_f60(copy_of_seeds, sampled);
      for (size_t i = (size_t)0U;
           i < core_slice___Slice_T___len(
                   Eurydice_array_to_slice(
                       (size_t)2U, sampled,
...
static tuple_4c generate_keypair_unpacked_a90(
  ...
  uint8_t copy_of_prf_input0[33U];
  memcpy(copy_of_prf_input0, prf_input, (size_t)33U * sizeof(uint8_t));
  tuple_74 uu____2 = sample_vector_cbd_then_ntt_010(copy_of_prf_input0, 0U);
  ...
  memcpy(
      error_as_ntt,
      sample_vector_cbd_then_ntt_010(copy_of_prf_input, domain_separator).fst,
      (size_t)2U * sizeof(libcrux_ml_kem_polynomial_PolynomialRingElement_f0));
...
static void encrypt_unpacked_650(
  ...
  uint8_t copy_of_prf_input0[33U];
  memcpy(copy_of_prf_input0, prf_input, (size_t)33U * sizeof(uint8_t));
  tuple_74 uu____1 = sample_vector_cbd_then_ntt_010(copy_of_prf_input0, 0U);
...
tuple_ec libcrux_ml_kem_ind_cca_encapsulate_unpacked_860(
  ...
  encrypt_unpacked_650(uu____2, copy_of_randomness, pseudorandomness,
                       ciphertext);
  uint8_t shared_secret_array[32U] = {0U};
  core_slice___Slice_T___copy_from_slice(
      Eurydice_array_to_slice((size_t)32U, shared_secret_array, uint8_t,
...
static void encrypt_f70(Eurydice_slice public_key, uint8_t message[32U],
  ...
  memcpy(copy_of_message, message, (size_t)32U * sizeof(uint8_t));
  uint8_t ret1[768U];
  encrypt_unpacked_650(uu____3, copy_of_message, randomness, ret1);
...
tuple_ec libcrux_ml_kem_ind_cca_encapsulate_9d0(
  ...
  memcpy(copy_of_randomness, randomness0, (size_t)32U * sizeof(uint8_t));
  uint8_t ciphertext[768U];
  encrypt_f70(uu____2, copy_of_randomness, pseudorandomness, ciphertext);
  /* Passing arrays by value in Rust generates a copy in C */
  uint8_t copy_of_ciphertext[768U];
  memcpy(copy_of_ciphertext, ciphertext, (size_t)768U * sizeof(uint8_t));
...
void libcrux_ml_kem_ind_cca_decapsulate_unpacked_f60(
  ...
  encrypt_unpacked_650(uu____3, copy_of_decrypted, pseudorandomness,
                       expected_ciphertext);
  uint8_t selector =
      libcrux_ml_kem_constant_time_ops_compare_ciphertexts_in_constant_time(
...
void libcrux_ml_kem_ind_cca_decapsulate_710(
  ...
  memcpy(copy_of_decrypted, decrypted, (size_t)32U * sizeof(uint8_t));
  uint8_t expected_ciphertext[768U];
  encrypt_f70(uu____5, copy_of_decrypted, pseudorandomness,
              expected_ciphertext);
  uint8_t implicit_rejection_shared_secret[32U];
  kdf_af_26(
      Eurydice_array_to_slice((size_t)32U, implicit_rejection_shared_secret0,
...
shake128_init_absorb_f1_51(uint8_t input[3U][34U]) {
  ...
  return shake128_init_absorb_41(copy_of_input);
}
...
static KRML_MUSTINLINE void sample_from_xof_f6(
  ...
  PortableHash_58 xof_state = shake128_init_absorb_f1_51(copy_of_seeds);
  ...
  KRML_MAYBE_FOR3(i, (size_t)0U, (size_t)3U, (size_t)1U,
                  ret0[i] = closure_13(copy_of_out[i]););
  memcpy(
      ret, ret0,
      (size_t)3U * sizeof(libcrux_ml_kem_polynomial_PolynomialRingElement_f0));
}
...
static KRML_MUSTINLINE void sample_matrix_A_55(
  ...
  KRML_MAYBE_FOR3(
      ...
      sample_from_xof_f6(copy_of_seeds, sampled);
      for (size_t i = (size_t)0U;
           i < core_slice___Slice_T___len(
                   Eurydice_array_to_slice(
                       (size_t)3U, sampled,
...
static tuple_9b generate_keypair_unpacked_a9(
  ...
  uint8_t copy_of_prf_input0[33U];
  memcpy(copy_of_prf_input0, prf_input, (size_t)33U * sizeof(uint8_t));
  tuple_b0 uu____2 = sample_vector_cbd_then_ntt_01(copy_of_prf_input0, 0U);
  ...
  memcpy(
      error_as_ntt,
      sample_vector_cbd_then_ntt_01(copy_of_prf_input, domain_separator).fst,
      (size_t)3U * sizeof(libcrux_ml_kem_polynomial_PolynomialRingElement_f0));
...
static void encrypt_unpacked_65(
  ...
  uint8_t copy_of_prf_input0[33U];
  memcpy(copy_of_prf_input0, prf_input, (size_t)33U * sizeof(uint8_t));
  tuple_b0 uu____1 = sample_vector_cbd_then_ntt_01(copy_of_prf_input0, 0U);
...
tuple_3c libcrux_ml_kem_ind_cca_encapsulate_unpacked_86(
  ...
  encrypt_unpacked_65(uu____2, copy_of_randomness, pseudorandomness,
                      ciphertext);
  uint8_t shared_secret_array[32U] = {0U};
  core_slice___Slice_T___copy_from_slice(
      Eurydice_array_to_slice((size_t)32U, shared_secret_array, uint8_t,
...
static void encrypt_f7(Eurydice_slice public_key, uint8_t message[32U],
  ...
  memcpy(copy_of_message, message, (size_t)32U * sizeof(uint8_t));
  uint8_t ret1[1088U];
  encrypt_unpacked_65(uu____3, copy_of_message, randomness, ret1);
...
tuple_3c libcrux_ml_kem_ind_cca_encapsulate_9d(
  ...
  memcpy(copy_of_randomness, randomness0, (size_t)32U * sizeof(uint8_t));
  uint8_t ciphertext[1088U];
  encrypt_f7(uu____2, copy_of_randomness, pseudorandomness, ciphertext);
  /* Passing arrays by value in Rust generates a copy in C */
  uint8_t copy_of_ciphertext[1088U];
  memcpy(copy_of_ciphertext, ciphertext, (size_t)1088U * sizeof(uint8_t));
...
void libcrux_ml_kem_ind_cca_decapsulate_unpacked_f6(
  ...
  encrypt_unpacked_65(uu____3, copy_of_decrypted, pseudorandomness,
                      expected_ciphertext);
  uint8_t selector =
      libcrux_ml_kem_constant_time_ops_compare_ciphertexts_in_constant_time(
...
void libcrux_ml_kem_ind_cca_decapsulate_71(
  ...
  memcpy(copy_of_decrypted, decrypted, (size_t)32U * sizeof(uint8_t));
  uint8_t expected_ciphertext[1088U];
  encrypt_f7(uu____5, copy_of_decrypted, pseudorandomness, expected_ciphertext);
  uint8_t implicit_rejection_shared_secret[32U];
  kdf_af_69(
      Eurydice_array_to_slice((size_t)32U, implicit_rejection_shared_secret0,
                              uint8_t, Eurydice_slice),
