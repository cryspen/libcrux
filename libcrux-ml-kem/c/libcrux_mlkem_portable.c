...
deserialize_to_reduced_ring_element_19(Eurydice_slice serialized) {
...
- K= 4
*/
static KRML_MUSTINLINE void deserialize_ring_elements_reduced_644(
  ...
  for (size_t i = (size_t)0U;
    ...
    libcrux_ml_kem_polynomial_PolynomialRingElement_f0 uu____0 =
        deserialize_to_reduced_ring_element_19(ring_element);
...
- K= 4
*/
static KRML_MUSTINLINE void deserialize_ring_elements_reduced_out_da1(
    Eurydice_slice public_key,
  ...
  deserialize_ring_elements_reduced_644(public_key, deserialized_pk);
  memcpy(
      ret, deserialized_pk,
...
shift_right_56(libcrux_ml_kem_vector_portable_vector_type_PortableVector v) {
  for (size_t i = (size_t)0U;
       i < LIBCRUX_ML_KEM_VECTOR_TRAITS_FIELD_ELEMENTS_IN_VECTOR; i++) {
    size_t i0 = i;
...
shift_right_0d_12(libcrux_ml_kem_vector_portable_vector_type_PortableVector v) {
  return shift_right_56(v);
}
...
*/
static KRML_MUSTINLINE void serialize_uncompressed_ring_element_47(
  ...
  for (size_t i = (size_t)0U;
    ...
    size_t i0 = i;
    libcrux_ml_kem_vector_portable_vector_type_PortableVector coefficient =
        to_unsigned_representative_80(re->coefficients[i0]);
    uint8_t bytes[24U];
...
- OUT_LEN= 1536
*/
static KRML_MUSTINLINE void serialize_secret_key_d8(
  ...
  for (size_t i = (size_t)0U;
    ...
    Eurydice_slice uu____0 = Eurydice_array_to_subslice2(
        ...
        uint8_t);
    uint8_t ret0[384U];
    serialize_uncompressed_ring_element_47(&re, ret0);
    Eurydice_slice_copy(
...
- PUBLIC_KEY_SIZE= 1568
*/
static KRML_MUSTINLINE void serialize_public_key_mut_49(
  ...
  uint8_t ret[1536U];
  serialize_secret_key_d8(t_as_ntt, ret);
  Eurydice_slice_copy(
...
- PUBLIC_KEY_SIZE= 1568
*/
static KRML_MUSTINLINE void serialize_public_key_d3(
    libcrux_ml_kem_polynomial_PolynomialRingElement_f0 *t_as_ntt,
    Eurydice_slice seed_for_a, uint8_t ret[1568U]) {
  uint8_t public_key_serialized[1568U] = {0U};
  serialize_public_key_mut_49(t_as_ntt, seed_for_a, public_key_serialized);
...
- PUBLIC_KEY_SIZE= 1568
*/
bool libcrux_ml_kem_ind_cca_validate_public_key_c31(uint8_t *public_key) {
  libcrux_ml_kem_polynomial_PolynomialRingElement_f0 deserialized_pk[4U];
...
*/
bool libcrux_ml_kem_ind_cca_validate_private_key_9d(
...
- K= 4
*/
static KRML_MUSTINLINE void cpa_keygen_seed_d8_84(
...
- N= 504
*/
static KRML_MUSTINLINE bool sample_from_uniform_distribution_next_60(
...
- N= 168
*/
static KRML_MUSTINLINE bool sample_from_uniform_distribution_next_600(
...
*/
static KRML_MUSTINLINE libcrux_ml_kem_polynomial_PolynomialRingElement_f0
from_i16_array_d6_b3(Eurydice_slice a) {
...
- K= 4
*/
static libcrux_ml_kem_polynomial_PolynomialRingElement_f0 closure_55(
    int16_t s[272U]) {
  return from_i16_array_d6_b3(
...
static KRML_MUSTINLINE void sample_from_xof_d8(
  ...
  bool done = sample_from_uniform_distribution_next_60(
  ...
  while (true) {
    if (done) {
      ...
      done = sample_from_uniform_distribution_next_600(
  ...
  KRML_MAYBE_FOR4(i, (size_t)0U, (size_t)4U, (size_t)1U,
                  ret0[i] = closure_55(copy_of_out[i]););
  memcpy(
      ret, ret0,
      (size_t)4U * sizeof(libcrux_ml_kem_polynomial_PolynomialRingElement_f0));
}
...
- K= 4
*/
static KRML_MUSTINLINE void sample_matrix_A_95(
  ...
  KRML_MAYBE_FOR4(
      ...
      sample_from_xof_d8(copy_of_seeds, sampled);
      for (size_t i = (size_t)0U;
           i < Eurydice_slice_len(
                   Eurydice_array_to_slice(
                       (size_t)4U, sampled,
...
*/
static KRML_MUSTINLINE libcrux_ml_kem_polynomial_PolynomialRingElement_f0
sample_from_binomial_distribution_2_26(Eurydice_slice randomness) {
...
*/
static KRML_MUSTINLINE libcrux_ml_kem_polynomial_PolynomialRingElement_f0
sample_from_binomial_distribution_3_c3(Eurydice_slice randomness) {
  int16_t sampled_i16s[256U] = {0U};
  for (size_t i0 = (size_t)0U;
...
*/
static KRML_MUSTINLINE libcrux_ml_kem_polynomial_PolynomialRingElement_f0
sample_from_binomial_distribution_0f(Eurydice_slice randomness) {
  return sample_from_binomial_distribution_2_26(randomness);
}
...
*/
static KRML_MUSTINLINE void ntt_at_layer_7_39(
...
static KRML_MUSTINLINE
    libcrux_ml_kem_vector_portable_vector_type_PortableVector_x2
    ntt_layer_int_vec_step_59(
        libcrux_ml_kem_vector_portable_vector_type_PortableVector a,
        libcrux_ml_kem_vector_portable_vector_type_PortableVector b,
        int16_t zeta_r) {
  libcrux_ml_kem_vector_portable_vector_type_PortableVector t =
      montgomery_multiply_fe_3b(b, zeta_r);
...
*/
static KRML_MUSTINLINE void ntt_at_layer_4_plus_d5(
...
*/
static KRML_MUSTINLINE void ntt_at_layer_3_ae(
    size_t *zeta_i, libcrux_ml_kem_polynomial_PolynomialRingElement_f0 *re) {
  KRML_MAYBE_FOR16(
...
*/
static KRML_MUSTINLINE void ntt_at_layer_2_cf(
    size_t *zeta_i, libcrux_ml_kem_polynomial_PolynomialRingElement_f0 *re) {
  KRML_MAYBE_FOR16(
      i, (size_t)0U, (size_t)16U, (size_t)1U, size_t round = i;
      zeta_i[0U] = zeta_i[0U] + (size_t)1U;
...
*/
static KRML_MUSTINLINE void poly_barrett_reduce_d6_c2(
...
*/
static KRML_MUSTINLINE void ntt_binomially_sampled_ring_element_4d(
    libcrux_ml_kem_polynomial_PolynomialRingElement_f0 *re) {
  ntt_at_layer_7_39(re);
  size_t zeta_i = (size_t)1U;
  ntt_at_layer_4_plus_d5(&zeta_i, re, (size_t)6U);
  ntt_at_layer_4_plus_d5(&zeta_i, re, (size_t)5U);
  ntt_at_layer_4_plus_d5(&zeta_i, re, (size_t)4U);
  ntt_at_layer_3_ae(&zeta_i, re);
  ntt_at_layer_2_cf(&zeta_i, re);
  ntt_at_layer_1_01(&zeta_i, re);
  poly_barrett_reduce_d6_c2(re);
}
...
*/
static KRML_MUSTINLINE uint8_t sample_vector_cbd_then_ntt_ce(
  ...
  KRML_MAYBE_FOR4(
      i, (size_t)0U, (size_t)4U, (size_t)1U, size_t i0 = i;
      re_as_ntt[i0] = sample_from_binomial_distribution_0f(
          Eurydice_array_to_slice((size_t)128U, prf_outputs[i0], uint8_t));
      ntt_binomially_sampled_ring_element_4d(&re_as_ntt[i0]););
...
- ETA_RANDOMNESS_SIZE= 128
*/
static KRML_MUSTINLINE tuple_710 sample_vector_cbd_then_ntt_out_25(
    uint8_t prf_input[33U], uint8_t domain_separator) {
  ...
  domain_separator =
      sample_vector_cbd_then_ntt_ce(uu____0, uu____1, domain_separator);
  /* Passing arrays by value in Rust generates a copy in C */
...
*/
static KRML_MUSTINLINE libcrux_ml_kem_polynomial_PolynomialRingElement_f0
ntt_multiply_d6_1b(libcrux_ml_kem_polynomial_PolynomialRingElement_f0 *self,
...
- K= 4
*/
static KRML_MUSTINLINE void add_to_ring_element_d6_9d(
    libcrux_ml_kem_polynomial_PolynomialRingElement_f0 *self,
    libcrux_ml_kem_polynomial_PolynomialRingElement_f0 *rhs) {
  for (size_t i = (size_t)0U;
       i < Eurydice_slice_len(
...
*/
static KRML_MUSTINLINE void add_standard_error_reduce_d6_00(
    libcrux_ml_kem_polynomial_PolynomialRingElement_f0 *self,
  ...
  for (size_t i = (size_t)0U;
    ...
    size_t j = i;
    libcrux_ml_kem_vector_portable_vector_type_PortableVector
        coefficient_normal_form = to_standard_domain_38(self->coefficients[j]);
    libcrux_ml_kem_vector_portable_vector_type_PortableVector uu____0 =
        libcrux_ml_kem_vector_portable_barrett_reduce_0d(
...
- K= 4
*/
static KRML_MUSTINLINE void compute_As_plus_e_50(
    libcrux_ml_kem_polynomial_PolynomialRingElement_f0 *t_as_ntt,
  ...
  for (size_t i = (size_t)0U;
    ...
    for (size_t i1 = (size_t)0U;
      ...
      libcrux_ml_kem_polynomial_PolynomialRingElement_f0 product =
          ntt_multiply_d6_1b(matrix_element, &s_as_ntt[j]);
      add_to_ring_element_d6_9d(&t_as_ntt[i0], &product);
    }
    add_standard_error_reduce_d6_00(&t_as_ntt[i0], &error_as_ntt[i0]);
  }
}
...
*/
static void generate_keypair_unpacked_7e(
    Eurydice_slice key_generation_seed,
    IndCpaPrivateKeyUnpacked_42 *private_key,
    IndCpaPublicKeyUnpacked_42 *public_key) {
  uint8_t hashed[64U];
  cpa_keygen_seed_d8_84(key_generation_seed, hashed);
  ...
  sample_matrix_A_95(uu____1, ret, true);
  ...
  uint8_t domain_separator =
      sample_vector_cbd_then_ntt_ce(uu____2, copy_of_prf_input0, 0U);
  /* Passing arrays by value in Rust generates a copy in C */
  uint8_t copy_of_prf_input[33U];
  memcpy(copy_of_prf_input, prf_input, (size_t)33U * sizeof(uint8_t));
  ...
  memcpy(
      error_as_ntt,
      sample_vector_cbd_then_ntt_out_25(copy_of_prf_input, domain_separator)
          .fst,
      (size_t)4U * sizeof(libcrux_ml_kem_polynomial_PolynomialRingElement_f0));
  compute_As_plus_e_50(public_key->t_as_ntt, public_key->A,
...
- ETA1_RANDOMNESS_SIZE= 128
*/
static libcrux_ml_kem_utils_extraction_helper_Keypair1024 generate_keypair_e31(
    Eurydice_slice key_generation_seed) {
  IndCpaPrivateKeyUnpacked_42 private_key = default_1a_a3();
  IndCpaPublicKeyUnpacked_42 public_key = default_8d_6b();
  generate_keypair_unpacked_7e(key_generation_seed, &private_key, &public_key);
  uint8_t public_key_serialized[1568U];
  serialize_public_key_d3(
      public_key.t_as_ntt,
  ...
  serialize_secret_key_d8(private_key.secret_as_ntt, secret_key_serialized);
  /* Passing arrays by value in Rust generates a copy in C */
...
*/
static KRML_MUSTINLINE void serialize_kem_secret_key_5c(
...
libcrux_ml_kem_ind_cca_generate_keypair_7d1(uint8_t randomness[64U]) {
  ...
  libcrux_ml_kem_utils_extraction_helper_Keypair1024 uu____0 =
      generate_keypair_e31(ind_cpa_keypair_randomness);
  ...
  libcrux_ml_kem_types_MlKemPrivateKey_95 private_key =
      libcrux_ml_kem_types_from_88_3e1(copy_of_secret_key_serialized);
  ...
  return libcrux_ml_kem_types_from_17_621(
      uu____2, libcrux_ml_kem_types_from_40_1c1(copy_of_public_key));
}
...
- K= 4
*/
static KRML_MUSTINLINE void entropy_preprocess_d8_9b(Eurydice_slice randomness,
                                                     uint8_t ret[32U]) {
  uint8_t out[32U] = {0U};
...
- K= 4
*/
static KRML_MUSTINLINE void deserialize_ring_elements_reduced_64(
    Eurydice_slice public_key,
    libcrux_ml_kem_polynomial_PolynomialRingElement_f0 *deserialized_pk) {
  for (size_t i = (size_t)0U;
       i < Eurydice_slice_len(public_key, uint8_t) /
...
sample_ring_element_cbd_d8(uint8_t prf_input[33U], uint8_t domain_separator) {
...
*/
static KRML_MUSTINLINE void invert_ntt_at_layer_1_2a(
    size_t *zeta_i, libcrux_ml_kem_polynomial_PolynomialRingElement_f0 *re) {
  KRML_MAYBE_FOR16(
      i, (size_t)0U, (size_t)16U, (size_t)1U, size_t round = i;
      zeta_i[0U] = zeta_i[0U] - (size_t)1U;
...
*/
static KRML_MUSTINLINE void invert_ntt_at_layer_3_81(
    size_t *zeta_i, libcrux_ml_kem_polynomial_PolynomialRingElement_f0 *re) {
  KRML_MAYBE_FOR16(
      i, (size_t)0U, (size_t)16U, (size_t)1U, size_t round = i;
      zeta_i[0U] = zeta_i[0U] - (size_t)1U;
...
static KRML_MUSTINLINE
    libcrux_ml_kem_vector_portable_vector_type_PortableVector_x2
    inv_ntt_layer_int_vec_step_reduce_3a(
        libcrux_ml_kem_vector_portable_vector_type_PortableVector a,
        libcrux_ml_kem_vector_portable_vector_type_PortableVector b,
        int16_t zeta_r) {
  ...
  b = montgomery_multiply_fe_3b(a_minus_b, zeta_r);
  return (
      CLITERAL(libcrux_ml_kem_vector_portable_vector_type_PortableVector_x2){
          .fst = a, .snd = b});
}
...
*/
static KRML_MUSTINLINE void invert_ntt_at_layer_4_plus_ba(
    size_t *zeta_i, libcrux_ml_kem_polynomial_PolynomialRingElement_f0 *re,
    size_t layer) {
  size_t step = (size_t)1U << (uint32_t)layer;
  for (size_t i0 = (size_t)0U; i0 < (size_t)128U >> (uint32_t)layer; i0++) {
...
- K= 4
*/
static KRML_MUSTINLINE void invert_ntt_montgomery_05(
    libcrux_ml_kem_polynomial_PolynomialRingElement_f0 *re) {
  size_t zeta_i =
      LIBCRUX_ML_KEM_CONSTANTS_COEFFICIENTS_IN_RING_ELEMENT / (size_t)2U;
  invert_ntt_at_layer_1_2a(&zeta_i, re);
  invert_ntt_at_layer_2_56(&zeta_i, re);
  invert_ntt_at_layer_3_81(&zeta_i, re);
  invert_ntt_at_layer_4_plus_ba(&zeta_i, re, (size_t)4U);
  invert_ntt_at_layer_4_plus_ba(&zeta_i, re, (size_t)5U);
  invert_ntt_at_layer_4_plus_ba(&zeta_i, re, (size_t)6U);
  invert_ntt_at_layer_4_plus_ba(&zeta_i, re, (size_t)7U);
  poly_barrett_reduce_d6_c2(re);
}
...
*/
static KRML_MUSTINLINE void add_error_reduce_d6_26(
    libcrux_ml_kem_polynomial_PolynomialRingElement_f0 *self,
    libcrux_ml_kem_polynomial_PolynomialRingElement_f0 *error) {
  for (size_t i = (size_t)0U;
       i < LIBCRUX_ML_KEM_POLYNOMIAL_VECTORS_IN_RING_ELEMENT; i++) {
...
- K= 4
*/
static KRML_MUSTINLINE void compute_vector_u_0d(
  ...
  for (size_t i0 = (size_t)0U;
    ...
    for (size_t i = (size_t)0U;
      ...
      libcrux_ml_kem_polynomial_PolynomialRingElement_f0 product =
          ntt_multiply_d6_1b(a_element, &r_as_ntt[j]);
      add_to_ring_element_d6_9d(&result[i1], &product);
    }
    invert_ntt_montgomery_05(&result[i1]);
    add_error_reduce_d6_26(&result[i1], &error_1[i1]);
  }
  memcpy(
      ret, result,
      (size_t)4U * sizeof(libcrux_ml_kem_polynomial_PolynomialRingElement_f0));
...
*/
static libcrux_ml_kem_vector_portable_vector_type_PortableVector
decompress_1_ad(libcrux_ml_kem_vector_portable_vector_type_PortableVector v) {
  libcrux_ml_kem_vector_portable_vector_type_PortableVector uu____0 =
...
*/
static KRML_MUSTINLINE libcrux_ml_kem_polynomial_PolynomialRingElement_f0
deserialize_then_decompress_message_e4(uint8_t serialized[32U]) {
  libcrux_ml_kem_polynomial_PolynomialRingElement_f0 re = ZERO_d6_19();
  KRML_MAYBE_FOR16(
          ...
          coefficient_compressed =
              libcrux_ml_kem_vector_portable_deserialize_1_0d(
                  Eurydice_array_to_subslice2(serialized, (size_t)2U * i0,
                                              ...
                                              uint8_t));
      libcrux_ml_kem_vector_portable_vector_type_PortableVector uu____0 =
          decompress_1_ad(coefficient_compressed);
      re.coefficients[i0] = uu____0;);
  return re;
}
...
*/
static KRML_MUSTINLINE libcrux_ml_kem_polynomial_PolynomialRingElement_f0
add_message_error_reduce_d6_09(
    libcrux_ml_kem_polynomial_PolynomialRingElement_f0 *self,
...
compute_ring_element_v_d2(
  ...
  KRML_MAYBE_FOR4(i, (size_t)0U, (size_t)4U, (size_t)1U, size_t i0 = i;
                  libcrux_ml_kem_polynomial_PolynomialRingElement_f0 product =
                      ntt_multiply_d6_1b(&t_as_ntt[i0], &r_as_ntt[i0]);
                  add_to_ring_element_d6_9d(&result, &product););
  invert_ntt_montgomery_05(&result);
  result = add_message_error_reduce_d6_09(error_2, message, result);
  return result;
}
...
*/
static KRML_MUSTINLINE libcrux_ml_kem_vector_portable_vector_type_PortableVector
compress_35(libcrux_ml_kem_vector_portable_vector_type_PortableVector v) {
  for (size_t i = (size_t)0U;
       i < LIBCRUX_ML_KEM_VECTOR_TRAITS_FIELD_ELEMENTS_IN_VECTOR; i++) {
    size_t i0 = i;
    int16_t uu____0 =
...
- COEFFICIENT_BITS= 10
*/
static libcrux_ml_kem_vector_portable_vector_type_PortableVector compress_0d_5f(
    libcrux_ml_kem_vector_portable_vector_type_PortableVector v) {
  return compress_35(v);
}
...
*/
static KRML_MUSTINLINE libcrux_ml_kem_vector_portable_vector_type_PortableVector
compress_350(libcrux_ml_kem_vector_portable_vector_type_PortableVector v) {
  for (size_t i = (size_t)0U;
       i < LIBCRUX_ML_KEM_VECTOR_TRAITS_FIELD_ELEMENTS_IN_VECTOR; i++) {
    size_t i0 = i;
    int16_t uu____0 =
...
*/
static libcrux_ml_kem_vector_portable_vector_type_PortableVector
compress_0d_5f0(libcrux_ml_kem_vector_portable_vector_type_PortableVector v) {
  return compress_350(v);
}
...
- OUT_LEN= 352
*/
static KRML_MUSTINLINE void compress_then_serialize_11_c1(
  ...
  for (size_t i = (size_t)0U;
    ...
    size_t i0 = i;
    libcrux_ml_kem_vector_portable_vector_type_PortableVector coefficient =
        compress_0d_5f0(to_unsigned_representative_80(re->coefficients[i0]));
    uint8_t bytes[22U];
...
- OUT_LEN= 352
*/
static KRML_MUSTINLINE void compress_then_serialize_ring_element_u_90(
    libcrux_ml_kem_polynomial_PolynomialRingElement_f0 *re, uint8_t ret[352U]) {
  uint8_t uu____0[352U];
  compress_then_serialize_11_c1(re, uu____0);
...
- BLOCK_LEN= 352
*/
static void compress_then_serialize_u_e3(
  ...
  for (size_t i = (size_t)0U;
    ...
    uint8_t ret[352U];
    compress_then_serialize_ring_element_u_90(&re, ret);
    Eurydice_slice_copy(
...
*/
static KRML_MUSTINLINE libcrux_ml_kem_vector_portable_vector_type_PortableVector
compress_351(libcrux_ml_kem_vector_portable_vector_type_PortableVector v) {
  for (size_t i = (size_t)0U;
       i < LIBCRUX_ML_KEM_VECTOR_TRAITS_FIELD_ELEMENTS_IN_VECTOR; i++) {
    size_t i0 = i;
    int16_t uu____0 =
...
*/
static libcrux_ml_kem_vector_portable_vector_type_PortableVector
compress_0d_5f1(libcrux_ml_kem_vector_portable_vector_type_PortableVector v) {
  return compress_351(v);
}
...
*/
static KRML_MUSTINLINE void compress_then_serialize_4_27(
    libcrux_ml_kem_polynomial_PolynomialRingElement_f0 re,
  ...
  for (size_t i = (size_t)0U;
    ...
    size_t i0 = i;
    libcrux_ml_kem_vector_portable_vector_type_PortableVector coefficient =
        compress_0d_5f1(to_unsigned_representative_80(re.coefficients[i0]));
    uint8_t bytes[8U];
...
*/
static KRML_MUSTINLINE libcrux_ml_kem_vector_portable_vector_type_PortableVector
compress_352(libcrux_ml_kem_vector_portable_vector_type_PortableVector v) {
  for (size_t i = (size_t)0U;
       i < LIBCRUX_ML_KEM_VECTOR_TRAITS_FIELD_ELEMENTS_IN_VECTOR; i++) {
    size_t i0 = i;
    int16_t uu____0 =
...
*/
static libcrux_ml_kem_vector_portable_vector_type_PortableVector
compress_0d_5f2(libcrux_ml_kem_vector_portable_vector_type_PortableVector v) {
  return compress_352(v);
}
...
*/
static KRML_MUSTINLINE void compress_then_serialize_5_59(
    libcrux_ml_kem_polynomial_PolynomialRingElement_f0 re,
    Eurydice_slice serialized) {
  for (size_t i = (size_t)0U;
       i < LIBCRUX_ML_KEM_POLYNOMIAL_VECTORS_IN_RING_ELEMENT; i++) {
    ...
    libcrux_ml_kem_vector_portable_vector_type_PortableVector coefficients =
        compress_0d_5f2(to_unsigned_representative_80(re.coefficients[i0]));
    uint8_t bytes[10U];
...
- OUT_LEN= 160
*/
static KRML_MUSTINLINE void compress_then_serialize_ring_element_v_c8(
    libcrux_ml_kem_polynomial_PolynomialRingElement_f0 re, Eurydice_slice out) {
  compress_then_serialize_5_59(re, out);
}
...
- ETA2_RANDOMNESS_SIZE= 128
*/
static void encrypt_unpacked_88(IndCpaPublicKeyUnpacked_42 *public_key,
  ...
  uint8_t copy_of_prf_input0[33U];
  memcpy(copy_of_prf_input0, prf_input, (size_t)33U * sizeof(uint8_t));
  tuple_710 uu____1 = sample_vector_cbd_then_ntt_out_25(copy_of_prf_input0, 0U);
  ...
  memcpy(copy_of_prf_input, prf_input, (size_t)33U * sizeof(uint8_t));
  tuple_710 uu____3 =
      sample_ring_element_cbd_d8(copy_of_prf_input, domain_separator0);
  libcrux_ml_kem_polynomial_PolynomialRingElement_f0 error_1[4U];
  memcpy(
      error_1, uu____3.fst,
      (size_t)4U * sizeof(libcrux_ml_kem_polynomial_PolynomialRingElement_f0));
  ...
  compute_vector_u_0d(public_key->A, r_as_ntt, error_1, u);
  /* Passing arrays by value in Rust generates a copy in C */
  ...
  libcrux_ml_kem_polynomial_PolynomialRingElement_f0 message_as_ring_element =
      deserialize_then_decompress_message_e4(copy_of_message);
  ...
  compress_then_serialize_ring_element_v_c8(
...
- ETA2_RANDOMNESS_SIZE= 128
*/
static void encrypt_1e1(Eurydice_slice public_key, uint8_t message[32U],
                        Eurydice_slice randomness, uint8_t ret[1568U]) {
  IndCpaPublicKeyUnpacked_42 unpacked_public_key = default_8d_6b();
  deserialize_ring_elements_reduced_64(
  ...
  sample_matrix_A_95(uu____0, ret0, false);
  IndCpaPublicKeyUnpacked_42 *uu____1 = &unpacked_public_key;
  /* Passing arrays by value in Rust generates a copy in C */
  uint8_t copy_of_message[32U];
  memcpy(copy_of_message, message, (size_t)32U * sizeof(uint8_t));
  uint8_t ret1[1568U];
  encrypt_unpacked_88(uu____1, copy_of_message, randomness, ret1);
...
- CIPHERTEXT_SIZE= 1568
*/
static KRML_MUSTINLINE void kdf_d8_11(Eurydice_slice shared_secret,
                                      uint8_t ret[32U]) {
  uint8_t out[32U] = {0U};
  Eurydice_slice_copy(Eurydice_array_to_slice((size_t)32U, out, uint8_t),
...
tuple_21 libcrux_ml_kem_ind_cca_encapsulate_c11(
  ...
  H_f1_c6(Eurydice_array_to_slice(
              (size_t)1568U, libcrux_ml_kem_types_as_slice_ba_e9(public_key),
              uint8_t),
          ret);
  Eurydice_slice_copy(
  ...
  Eurydice_slice uu____2 = Eurydice_array_to_slice(
      (size_t)1568U, libcrux_ml_kem_types_as_slice_ba_e9(public_key), uint8_t);
  /* Passing arrays by value in Rust generates a copy in C */
  uint8_t copy_of_randomness[32U];
  memcpy(copy_of_randomness, randomness0, (size_t)32U * sizeof(uint8_t));
  uint8_t ciphertext[1568U];
  encrypt_1e1(uu____2, copy_of_randomness, pseudorandomness, ciphertext);
  /* Passing arrays by value in Rust generates a copy in C */
  ...
  libcrux_ml_kem_types_MlKemCiphertext_1f ciphertext0 =
      libcrux_ml_kem_types_from_fc_15(copy_of_ciphertext);
  uint8_t shared_secret_array[32U];
  kdf_d8_11(shared_secret, shared_secret_array);
...
*/
static KRML_MUSTINLINE libcrux_ml_kem_polynomial_PolynomialRingElement_f0
deserialize_to_uncompressed_ring_element_ce(Eurydice_slice serialized) {
  libcrux_ml_kem_polynomial_PolynomialRingElement_f0 re = ZERO_d6_19();
  for (size_t i = (size_t)0U;
       i < Eurydice_slice_len(serialized, uint8_t) / (size_t)24U; i++) {
    size_t i0 = i;
...
- K= 4
*/
static KRML_MUSTINLINE void deserialize_secret_key_fc1(
  ...
  for (size_t i = (size_t)0U;
    ...
    Eurydice_slice secret_bytes = Eurydice_slice_subslice2(
        ...
        uint8_t);
    libcrux_ml_kem_polynomial_PolynomialRingElement_f0 uu____0 =
        deserialize_to_uncompressed_ring_element_ce(secret_bytes);
...
*/
static KRML_MUSTINLINE libcrux_ml_kem_vector_portable_vector_type_PortableVector
decompress_ciphertext_coefficient_40(
    libcrux_ml_kem_vector_portable_vector_type_PortableVector v) {
  for (size_t i = (size_t)0U;
       i < LIBCRUX_ML_KEM_VECTOR_TRAITS_FIELD_ELEMENTS_IN_VECTOR; i++) {
    size_t i0 = i;
...
*/
static libcrux_ml_kem_vector_portable_vector_type_PortableVector
decompress_ciphertext_coefficient_0d_17(
    libcrux_ml_kem_vector_portable_vector_type_PortableVector v) {
  return decompress_ciphertext_coefficient_40(v);
}
...
*/
static KRML_MUSTINLINE libcrux_ml_kem_polynomial_PolynomialRingElement_f0
deserialize_then_decompress_10_28(Eurydice_slice serialized) {
  libcrux_ml_kem_polynomial_PolynomialRingElement_f0 re = ZERO_d6_19();
  for (size_t i = (size_t)0U;
    ...
    libcrux_ml_kem_vector_portable_vector_type_PortableVector uu____0 =
        decompress_ciphertext_coefficient_0d_17(coefficient);
    re.coefficients[i0] = uu____0;
  }
  return re;
}
...
*/
static KRML_MUSTINLINE libcrux_ml_kem_vector_portable_vector_type_PortableVector
decompress_ciphertext_coefficient_400(
    libcrux_ml_kem_vector_portable_vector_type_PortableVector v) {
  for (size_t i = (size_t)0U;
       i < LIBCRUX_ML_KEM_VECTOR_TRAITS_FIELD_ELEMENTS_IN_VECTOR; i++) {
    size_t i0 = i;
...
*/
static libcrux_ml_kem_vector_portable_vector_type_PortableVector
decompress_ciphertext_coefficient_0d_170(
    libcrux_ml_kem_vector_portable_vector_type_PortableVector v) {
  return decompress_ciphertext_coefficient_400(v);
}
...
deserialize_then_decompress_11_ca(Eurydice_slice serialized) {
  ...
  for (size_t i = (size_t)0U;
    ...
    libcrux_ml_kem_vector_portable_vector_type_PortableVector uu____0 =
        decompress_ciphertext_coefficient_0d_170(coefficient);
    re.coefficients[i0] = uu____0;
  }
  return re;
}
...
*/
static KRML_MUSTINLINE libcrux_ml_kem_polynomial_PolynomialRingElement_f0
deserialize_then_decompress_ring_element_u_7a(Eurydice_slice serialized) {
...
- VECTOR_U_COMPRESSION_FACTOR= 11
*/
static KRML_MUSTINLINE void ntt_vector_u_6d(
    libcrux_ml_kem_polynomial_PolynomialRingElement_f0 *re) {
  size_t zeta_i = (size_t)0U;
  ntt_at_layer_4_plus_d5(&zeta_i, re, (size_t)7U);
  ntt_at_layer_4_plus_d5(&zeta_i, re, (size_t)6U);
  ntt_at_layer_4_plus_d5(&zeta_i, re, (size_t)5U);
  ntt_at_layer_4_plus_d5(&zeta_i, re, (size_t)4U);
  ntt_at_layer_3_ae(&zeta_i, re);
...
- U_COMPRESSION_FACTOR= 11
*/
static KRML_MUSTINLINE void deserialize_then_decompress_u_23(
    uint8_t *ciphertext,
    libcrux_ml_kem_polynomial_PolynomialRingElement_f0 ret[4U]) {
    ...
    Eurydice_slice u_bytes = Eurydice_array_to_subslice2(
        ...
        i0 * (LIBCRUX_ML_KEM_CONSTANTS_COEFFICIENTS_IN_RING_ELEMENT *
            ...
            LIBCRUX_ML_KEM_CONSTANTS_COEFFICIENTS_IN_RING_ELEMENT *
                (size_t)11U / (size_t)8U,
        uint8_t);
    u_as_ntt[i0] = deserialize_then_decompress_ring_element_u_7a(u_bytes);
    ntt_vector_u_6d(&u_as_ntt[i0]);
  }
  memcpy(
      ret, u_as_ntt,
      (size_t)4U * sizeof(libcrux_ml_kem_polynomial_PolynomialRingElement_f0));
...
*/
static KRML_MUSTINLINE libcrux_ml_kem_vector_portable_vector_type_PortableVector
decompress_ciphertext_coefficient_401(
    libcrux_ml_kem_vector_portable_vector_type_PortableVector v) {
  for (size_t i = (size_t)0U;
       i < LIBCRUX_ML_KEM_VECTOR_TRAITS_FIELD_ELEMENTS_IN_VECTOR; i++) {
    size_t i0 = i;
...
*/
static libcrux_ml_kem_vector_portable_vector_type_PortableVector
decompress_ciphertext_coefficient_0d_171(
    libcrux_ml_kem_vector_portable_vector_type_PortableVector v) {
  return decompress_ciphertext_coefficient_401(v);
}
...
*/
static KRML_MUSTINLINE libcrux_ml_kem_polynomial_PolynomialRingElement_f0
deserialize_then_decompress_4_da(Eurydice_slice serialized) {
  libcrux_ml_kem_polynomial_PolynomialRingElement_f0 re = ZERO_d6_19();
  for (size_t i = (size_t)0U;
    ...
    libcrux_ml_kem_vector_portable_vector_type_PortableVector uu____0 =
        decompress_ciphertext_coefficient_0d_171(coefficient);
    re.coefficients[i0] = uu____0;
  }
  return re;
}
...
*/
static KRML_MUSTINLINE libcrux_ml_kem_vector_portable_vector_type_PortableVector
decompress_ciphertext_coefficient_402(
    libcrux_ml_kem_vector_portable_vector_type_PortableVector v) {
  for (size_t i = (size_t)0U;
       i < LIBCRUX_ML_KEM_VECTOR_TRAITS_FIELD_ELEMENTS_IN_VECTOR; i++) {
    size_t i0 = i;
...
*/
static libcrux_ml_kem_vector_portable_vector_type_PortableVector
decompress_ciphertext_coefficient_0d_172(
    libcrux_ml_kem_vector_portable_vector_type_PortableVector v) {
  return decompress_ciphertext_coefficient_402(v);
}
...
*/
static KRML_MUSTINLINE libcrux_ml_kem_polynomial_PolynomialRingElement_f0
deserialize_then_decompress_5_aa(Eurydice_slice serialized) {
  libcrux_ml_kem_polynomial_PolynomialRingElement_f0 re = ZERO_d6_19();
  for (size_t i = (size_t)0U;
    ...
    libcrux_ml_kem_vector_portable_vector_type_PortableVector uu____1 =
        decompress_ciphertext_coefficient_0d_172(re.coefficients[i0]);
...
*/
static KRML_MUSTINLINE libcrux_ml_kem_polynomial_PolynomialRingElement_f0
deserialize_then_decompress_ring_element_v_b6(Eurydice_slice serialized) {
  return deserialize_then_decompress_5_aa(serialized);
}
...
*/
static KRML_MUSTINLINE libcrux_ml_kem_polynomial_PolynomialRingElement_f0
subtract_reduce_d6_28(libcrux_ml_kem_polynomial_PolynomialRingElement_f0 *self,
...
compute_message_2b(
  ...
  KRML_MAYBE_FOR4(i, (size_t)0U, (size_t)4U, (size_t)1U, size_t i0 = i;
                  libcrux_ml_kem_polynomial_PolynomialRingElement_f0 product =
                      ntt_multiply_d6_1b(&secret_as_ntt[i0], &u_as_ntt[i0]);
                  add_to_ring_element_d6_9d(&result, &product););
  invert_ntt_montgomery_05(&result);
  result = subtract_reduce_d6_28(v, result);
  return result;
}
...
*/
static KRML_MUSTINLINE void compress_then_serialize_message_f3(
...
- V_COMPRESSION_FACTOR= 5
*/
static void decrypt_unpacked_ce(IndCpaPrivateKeyUnpacked_42 *secret_key,
                                uint8_t *ciphertext, uint8_t ret[32U]) {
  libcrux_ml_kem_polynomial_PolynomialRingElement_f0 u_as_ntt[4U];
  deserialize_then_decompress_u_23(ciphertext, u_as_ntt);
  libcrux_ml_kem_polynomial_PolynomialRingElement_f0 v =
      deserialize_then_decompress_ring_element_v_b6(
          Eurydice_array_to_subslice_from((size_t)1568U, ciphertext,
                                          (size_t)1408U, uint8_t, size_t));
  libcrux_ml_kem_polynomial_PolynomialRingElement_f0 message =
      compute_message_2b(&v, secret_key->secret_as_ntt, u_as_ntt);
  uint8_t ret0[32U];
  compress_then_serialize_message_f3(message, ret0);
...
- V_COMPRESSION_FACTOR= 5
*/
static void decrypt_1b1(Eurydice_slice secret_key, uint8_t *ciphertext,
                        uint8_t ret[32U]) {
  libcrux_ml_kem_polynomial_PolynomialRingElement_f0 secret_as_ntt[4U];
  deserialize_secret_key_fc1(secret_key, secret_as_ntt);
  /* Passing arrays by value in Rust generates a copy in C */
  ...
  memcpy(
      ...
      (size_t)4U * sizeof(libcrux_ml_kem_polynomial_PolynomialRingElement_f0));
  uint8_t ret0[32U];
  decrypt_unpacked_ce(&secret_key_unpacked, ciphertext, ret0);
  memcpy(ret, ret0, (size_t)32U * sizeof(uint8_t));
}
...
*/
void libcrux_ml_kem_ind_cca_decapsulate_2b1(
    libcrux_ml_kem_types_MlKemPrivateKey_95 *private_key,
  ...
  decrypt_1b1(ind_cpa_secret_key, ciphertext->value, decrypted);
  ...
  Eurydice_slice uu____4 = Eurydice_array_to_subslice_from(
      ...
      uint8_t, size_t);
  Eurydice_slice_copy(uu____4, libcrux_ml_kem_types_as_ref_fd_b6(ciphertext),
                      uint8_t);
  ...
  encrypt_1e1(uu____5, copy_of_decrypted, pseudorandomness,
              expected_ciphertext);
  uint8_t implicit_rejection_shared_secret[32U];
  kdf_d8_11(Eurydice_array_to_slice((size_t)32U,
                                    implicit_rejection_shared_secret0, uint8_t),
            implicit_rejection_shared_secret);
  uint8_t shared_secret[32U];
  kdf_d8_11(shared_secret0, shared_secret);
  uint8_t ret0[32U];
  libcrux_ml_kem_constant_time_ops_compare_ciphertexts_select_shared_secret_in_constant_time(
      libcrux_ml_kem_types_as_ref_fd_b6(ciphertext),
...
- K= 2
*/
static KRML_MUSTINLINE void deserialize_ring_elements_reduced_643(
    Eurydice_slice public_key,
    libcrux_ml_kem_polynomial_PolynomialRingElement_f0 *deserialized_pk) {
  for (size_t i = (size_t)0U;
       i < Eurydice_slice_len(public_key, uint8_t) /
...
- K= 2
*/
static KRML_MUSTINLINE void deserialize_ring_elements_reduced_out_da0(
    Eurydice_slice public_key,
  ...
  KRML_MAYBE_FOR2(i, (size_t)0U, (size_t)2U, (size_t)1U,
                  deserialized_pk[i] = ZERO_d6_19(););
  deserialize_ring_elements_reduced_643(public_key, deserialized_pk);
  memcpy(
      ret, deserialized_pk,
...
- OUT_LEN= 768
*/
static KRML_MUSTINLINE void serialize_secret_key_d80(
    libcrux_ml_kem_polynomial_PolynomialRingElement_f0 *key,
    uint8_t ret[768U]) {
  uint8_t out[768U] = {0U};
  for (size_t i = (size_t)0U;
...
- PUBLIC_KEY_SIZE= 800
*/
static KRML_MUSTINLINE void serialize_public_key_mut_490(
    libcrux_ml_kem_polynomial_PolynomialRingElement_f0 *t_as_ntt,
    Eurydice_slice seed_for_a, uint8_t *serialized) {
  Eurydice_slice uu____0 = Eurydice_array_to_subslice2(serialized, (size_t)0U,
                                                       (size_t)768U, uint8_t);
  uint8_t ret[768U];
  serialize_secret_key_d80(t_as_ntt, ret);
  Eurydice_slice_copy(
...
- PUBLIC_KEY_SIZE= 800
*/
static KRML_MUSTINLINE void serialize_public_key_d30(
    libcrux_ml_kem_polynomial_PolynomialRingElement_f0 *t_as_ntt,
    Eurydice_slice seed_for_a, uint8_t ret[800U]) {
  uint8_t public_key_serialized[800U] = {0U};
  serialize_public_key_mut_490(t_as_ntt, seed_for_a, public_key_serialized);
...
- PUBLIC_KEY_SIZE= 800
*/
bool libcrux_ml_kem_ind_cca_validate_public_key_c30(uint8_t *public_key) {
  libcrux_ml_kem_polynomial_PolynomialRingElement_f0 deserialized_pk[2U];
  deserialize_ring_elements_reduced_out_da0(
      Eurydice_array_to_subslice_to((size_t)800U, public_key, (size_t)768U,
                                    uint8_t, size_t),
      deserialized_pk);
  libcrux_ml_kem_polynomial_PolynomialRingElement_f0 *uu____0 = deserialized_pk;
  uint8_t public_key_serialized[800U];
  serialize_public_key_d30(
      uu____0,
...
- CIPHERTEXT_SIZE= 768
*/
bool libcrux_ml_kem_ind_cca_validate_private_key_df(
...
- N= 504
*/
static KRML_MUSTINLINE bool sample_from_uniform_distribution_next_601(
...
- N= 168
*/
static KRML_MUSTINLINE bool sample_from_uniform_distribution_next_602(
...
- K= 2
*/
static libcrux_ml_kem_polynomial_PolynomialRingElement_f0 closure_550(
    int16_t s[272U]) {
  return from_i16_array_d6_b3(
      Eurydice_array_to_subslice2(s, (size_t)0U, (size_t)256U, int16_t));
}
...
- K= 2
*/
static KRML_MUSTINLINE void sample_from_xof_d80(
  ...
  bool done = sample_from_uniform_distribution_next_601(
      copy_of_randomness0, sampled_coefficients, out);
  while (true) {
    if (done) {
      break;
      ...
      done = sample_from_uniform_distribution_next_602(
          copy_of_randomness, sampled_coefficients, out);
    }
  }
  /* Passing arrays by value in Rust generates a copy in C */
  ...
  KRML_MAYBE_FOR2(i, (size_t)0U, (size_t)2U, (size_t)1U,
                  ret0[i] = closure_550(copy_of_out[i]););
  memcpy(
      ret, ret0,
      (size_t)2U * sizeof(libcrux_ml_kem_polynomial_PolynomialRingElement_f0));
}
...
- K= 2
*/
static KRML_MUSTINLINE void sample_matrix_A_950(
  ...
  KRML_MAYBE_FOR2(
      ...
      sample_from_xof_d80(copy_of_seeds, sampled);
      for (size_t i = (size_t)0U;
           i < Eurydice_slice_len(
                   Eurydice_array_to_slice(
                       (size_t)2U, sampled,
...
*/
static KRML_MUSTINLINE libcrux_ml_kem_polynomial_PolynomialRingElement_f0
sample_from_binomial_distribution_0f0(Eurydice_slice randomness) {
  return sample_from_binomial_distribution_3_c3(randomness);
}
...
*/
static KRML_MUSTINLINE uint8_t sample_vector_cbd_then_ntt_ce0(
    libcrux_ml_kem_polynomial_PolynomialRingElement_f0 *re_as_ntt,
    uint8_t prf_input[33U], uint8_t domain_separator) {
  /* Passing arrays by value in Rust generates a copy in C */
  uint8_t copy_of_prf_input[33U];
  ...
  KRML_MAYBE_FOR2(
      i, (size_t)0U, (size_t)2U, (size_t)1U, size_t i0 = i;
      re_as_ntt[i0] = sample_from_binomial_distribution_0f0(
...
- ETA_RANDOMNESS_SIZE= 192
*/
static KRML_MUSTINLINE tuple_740 sample_vector_cbd_then_ntt_out_250(
    uint8_t prf_input[33U], uint8_t domain_separator) {
  ...
  memcpy(uu____1, prf_input, (size_t)33U * sizeof(uint8_t));
  domain_separator =
      sample_vector_cbd_then_ntt_ce0(uu____0, uu____1, domain_separator);
  /* Passing arrays by value in Rust generates a copy in C */
...
- K= 2
*/
static KRML_MUSTINLINE void add_to_ring_element_d6_9d0(
    libcrux_ml_kem_polynomial_PolynomialRingElement_f0 *self,
    libcrux_ml_kem_polynomial_PolynomialRingElement_f0 *rhs) {
  for (size_t i = (size_t)0U;
       i < Eurydice_slice_len(
...
- K= 2
*/
static KRML_MUSTINLINE void compute_As_plus_e_500(
    libcrux_ml_kem_polynomial_PolynomialRingElement_f0 *t_as_ntt,
  ...
  for (size_t i = (size_t)0U;
    ...
    for (size_t i1 = (size_t)0U;
      ...
      libcrux_ml_kem_polynomial_PolynomialRingElement_f0 product =
          ntt_multiply_d6_1b(matrix_element, &s_as_ntt[j]);
      add_to_ring_element_d6_9d0(&t_as_ntt[i0], &product);
    }
    add_standard_error_reduce_d6_00(&t_as_ntt[i0], &error_as_ntt[i0]);
  }
}
...
*/
static void generate_keypair_unpacked_7e0(
    Eurydice_slice key_generation_seed,
  ...
  uint8_t ret[34U];
  libcrux_ml_kem_utils_into_padded_array_422(seed_for_A, ret);
  sample_matrix_A_950(uu____1, ret, true);
  uint8_t prf_input[33U];
  libcrux_ml_kem_utils_into_padded_array_421(seed_for_secret_and_error,
                                             prf_input);
  libcrux_ml_kem_polynomial_PolynomialRingElement_f0 *uu____2 =
  ...
  memcpy(copy_of_prf_input0, prf_input, (size_t)33U * sizeof(uint8_t));
  uint8_t domain_separator =
      sample_vector_cbd_then_ntt_ce0(uu____2, copy_of_prf_input0, 0U);
  /* Passing arrays by value in Rust generates a copy in C */
  uint8_t copy_of_prf_input[33U];
  memcpy(copy_of_prf_input, prf_input, (size_t)33U * sizeof(uint8_t));
  ...
  memcpy(
      error_as_ntt,
      sample_vector_cbd_then_ntt_out_250(copy_of_prf_input, domain_separator)
          .fst,
      (size_t)2U * sizeof(libcrux_ml_kem_polynomial_PolynomialRingElement_f0));
  compute_As_plus_e_500(public_key->t_as_ntt, public_key->A,
                        private_key->secret_as_ntt, error_as_ntt);
  uint8_t uu____5[32U];
  core_result_Result_00 dst;
  Eurydice_slice_to_array2(&dst, seed_for_A, Eurydice_slice, uint8_t[32U]);
...
- ETA1_RANDOMNESS_SIZE= 192
*/
static libcrux_ml_kem_utils_extraction_helper_Keypair512 generate_keypair_e30(
    Eurydice_slice key_generation_seed) {
  ...
  serialize_secret_key_d80(private_key.secret_as_ntt, secret_key_serialized);
  /* Passing arrays by value in Rust generates a copy in C */
...
*/
static KRML_MUSTINLINE void serialize_kem_secret_key_5b(
    Eurydice_slice private_key, Eurydice_slice public_key,
...
libcrux_ml_kem_ind_cca_generate_keypair_7d0(uint8_t randomness[64U]) {
  Eurydice_slice ind_cpa_keypair_randomness = Eurydice_array_to_subslice2(
      randomness, (size_t)0U,
      LIBCRUX_ML_KEM_CONSTANTS_CPA_PKE_KEY_GENERATION_SEED_SIZE, uint8_t);
  Eurydice_slice implicit_rejection_value = Eurydice_array_to_subslice_from(
  ...
  libcrux_ml_kem_utils_extraction_helper_Keypair512 uu____0 =
      generate_keypair_e30(ind_cpa_keypair_randomness);
  ...
  libcrux_ml_kem_types_MlKemPrivateKey_5e private_key =
      libcrux_ml_kem_types_from_88_3e(copy_of_secret_key_serialized);
  ...
  return libcrux_ml_kem_types_from_17_62(
      uu____2, libcrux_ml_kem_types_from_40_1c(copy_of_public_key));
}
...
- K= 2
*/
static KRML_MUSTINLINE void entropy_preprocess_d8_90(Eurydice_slice randomness,
                                                     uint8_t ret[32U]) {
  uint8_t out[32U] = {0U};
  Eurydice_slice_copy(Eurydice_array_to_slice((size_t)32U, out, uint8_t),
                      randomness, uint8_t);
...
- K= 2
*/
static KRML_MUSTINLINE void deserialize_ring_elements_reduced_640(
    Eurydice_slice public_key,
    libcrux_ml_kem_polynomial_PolynomialRingElement_f0 *deserialized_pk) {
  for (size_t i = (size_t)0U;
       i < Eurydice_slice_len(public_key, uint8_t) /
...
sample_ring_element_cbd_d80(uint8_t prf_input[33U], uint8_t domain_separator) {
...
- K= 2
*/
static KRML_MUSTINLINE void invert_ntt_montgomery_050(
    libcrux_ml_kem_polynomial_PolynomialRingElement_f0 *re) {
  size_t zeta_i =
      LIBCRUX_ML_KEM_CONSTANTS_COEFFICIENTS_IN_RING_ELEMENT / (size_t)2U;
  invert_ntt_at_layer_1_2a(&zeta_i, re);
...
- K= 2
*/
static KRML_MUSTINLINE void compute_vector_u_0d0(
  ...
  for (size_t i0 = (size_t)0U;
    ...
    for (size_t i = (size_t)0U;
      ...
      libcrux_ml_kem_polynomial_PolynomialRingElement_f0 product =
          ntt_multiply_d6_1b(a_element, &r_as_ntt[j]);
      add_to_ring_element_d6_9d0(&result[i1], &product);
    }
    invert_ntt_montgomery_050(&result[i1]);
    add_error_reduce_d6_26(&result[i1], &error_1[i1]);
  }
  memcpy(
      ret, result,
...
compute_ring_element_v_d20(
  ...
  KRML_MAYBE_FOR2(i, (size_t)0U, (size_t)2U, (size_t)1U, size_t i0 = i;
                  libcrux_ml_kem_polynomial_PolynomialRingElement_f0 product =
                      ntt_multiply_d6_1b(&t_as_ntt[i0], &r_as_ntt[i0]);
                  add_to_ring_element_d6_9d0(&result, &product););
  invert_ntt_montgomery_050(&result);
  result = add_message_error_reduce_d6_09(error_2, message, result);
  return result;
}
...
- OUT_LEN= 320
*/
static KRML_MUSTINLINE void compress_then_serialize_10_820(
  ...
  for (size_t i = (size_t)0U;
    ...
    size_t i0 = i;
    libcrux_ml_kem_vector_portable_vector_type_PortableVector coefficient =
        compress_0d_5f(to_unsigned_representative_80(re->coefficients[i0]));
    uint8_t bytes[20U];
...
- OUT_LEN= 320
*/
static KRML_MUSTINLINE void compress_then_serialize_ring_element_u_900(
    libcrux_ml_kem_polynomial_PolynomialRingElement_f0 *re, uint8_t ret[320U]) {
  uint8_t uu____0[320U];
  compress_then_serialize_10_820(re, uu____0);
...
- BLOCK_LEN= 320
*/
static void compress_then_serialize_u_e30(
  ...
  for (size_t i = (size_t)0U;
    ...
    uint8_t ret[320U];
    compress_then_serialize_ring_element_u_900(&re, ret);
    Eurydice_slice_copy(
...
- OUT_LEN= 128
*/
static KRML_MUSTINLINE void compress_then_serialize_ring_element_v_c80(
    libcrux_ml_kem_polynomial_PolynomialRingElement_f0 re, Eurydice_slice out) {
  compress_then_serialize_4_27(re, out);
}
...
- ETA2_RANDOMNESS_SIZE= 128
*/
static void encrypt_unpacked_880(IndCpaPublicKeyUnpacked_ae *public_key,
                                 uint8_t message[32U],
  ...
  memcpy(copy_of_prf_input0, prf_input, (size_t)33U * sizeof(uint8_t));
  tuple_740 uu____1 =
      sample_vector_cbd_then_ntt_out_250(copy_of_prf_input0, 0U);
  ...
  memcpy(copy_of_prf_input, prf_input, (size_t)33U * sizeof(uint8_t));
  tuple_740 uu____3 =
      sample_ring_element_cbd_d80(copy_of_prf_input, domain_separator0);
  libcrux_ml_kem_polynomial_PolynomialRingElement_f0 error_1[2U];
  memcpy(
      error_1, uu____3.fst,
      (size_t)2U * sizeof(libcrux_ml_kem_polynomial_PolynomialRingElement_f0));
  ...
  compute_vector_u_0d0(public_key->A, r_as_ntt, error_1, u);
  /* Passing arrays by value in Rust generates a copy in C */
  uint8_t copy_of_message[32U];
  memcpy(copy_of_message, message, (size_t)32U * sizeof(uint8_t));
  libcrux_ml_kem_polynomial_PolynomialRingElement_f0 message_as_ring_element =
...
- ETA2_RANDOMNESS_SIZE= 128
*/
static void encrypt_1e0(Eurydice_slice public_key, uint8_t message[32U],
                        Eurydice_slice randomness, uint8_t ret[768U]) {
  IndCpaPublicKeyUnpacked_ae unpacked_public_key = default_8d_6b0();
  deserialize_ring_elements_reduced_640(
  ...
  uint8_t ret0[34U];
  libcrux_ml_kem_utils_into_padded_array_422(seed, ret0);
  sample_matrix_A_950(uu____0, ret0, false);
  IndCpaPublicKeyUnpacked_ae *uu____1 = &unpacked_public_key;
  /* Passing arrays by value in Rust generates a copy in C */
  uint8_t copy_of_message[32U];
  memcpy(copy_of_message, message, (size_t)32U * sizeof(uint8_t));
  uint8_t ret1[768U];
  encrypt_unpacked_880(uu____1, copy_of_message, randomness, ret1);
...
- CIPHERTEXT_SIZE= 768
*/
static KRML_MUSTINLINE void kdf_d8_01(Eurydice_slice shared_secret,
                                      uint8_t ret[32U]) {
  uint8_t out[32U] = {0U};
  Eurydice_slice_copy(Eurydice_array_to_slice((size_t)32U, out, uint8_t),
                      shared_secret, uint8_t);
...
- ETA2_RANDOMNESS_SIZE= 128
*/
tuple_ec libcrux_ml_kem_ind_cca_encapsulate_c10(
    libcrux_ml_kem_types_MlKemPublicKey_be *public_key,
    uint8_t randomness[32U]) {
  uint8_t randomness0[32U];
  entropy_preprocess_d8_90(
      Eurydice_array_to_slice((size_t)32U, randomness, uint8_t), randomness0);
  uint8_t to_hash[64U];
  libcrux_ml_kem_utils_into_padded_array_42(
      Eurydice_array_to_slice((size_t)32U, randomness0, uint8_t), to_hash);
  ...
  H_f1_c60(Eurydice_array_to_slice(
               (size_t)800U, libcrux_ml_kem_types_as_slice_ba_e90(public_key),
               uint8_t),
           ret);
  Eurydice_slice_copy(
      uu____0, Eurydice_array_to_slice((size_t)32U, ret, uint8_t), uint8_t);
  ...
  Eurydice_slice pseudorandomness = uu____1.snd;
  Eurydice_slice uu____2 = Eurydice_array_to_slice(
      (size_t)800U, libcrux_ml_kem_types_as_slice_ba_e90(public_key), uint8_t);
  /* Passing arrays by value in Rust generates a copy in C */
  uint8_t copy_of_randomness[32U];
  memcpy(copy_of_randomness, randomness0, (size_t)32U * sizeof(uint8_t));
  uint8_t ciphertext[768U];
  encrypt_1e0(uu____2, copy_of_randomness, pseudorandomness, ciphertext);
  /* Passing arrays by value in Rust generates a copy in C */
  ...
  libcrux_ml_kem_types_MlKemCiphertext_e8 ciphertext0 =
      libcrux_ml_kem_types_from_fc_150(copy_of_ciphertext);
  uint8_t shared_secret_array[32U];
  kdf_d8_01(shared_secret, shared_secret_array);
...
- K= 2
*/
static KRML_MUSTINLINE void deserialize_secret_key_fc0(
    Eurydice_slice secret_key,
    libcrux_ml_kem_polynomial_PolynomialRingElement_f0 ret[2U]) {
  libcrux_ml_kem_polynomial_PolynomialRingElement_f0 secret_as_ntt[2U];
  KRML_MAYBE_FOR2(i, (size_t)0U, (size_t)2U, (size_t)1U,
...
*/
static KRML_MUSTINLINE libcrux_ml_kem_polynomial_PolynomialRingElement_f0
deserialize_then_decompress_ring_element_u_7a0(Eurydice_slice serialized) {
...
- VECTOR_U_COMPRESSION_FACTOR= 10
*/
static KRML_MUSTINLINE void ntt_vector_u_6d0(
    libcrux_ml_kem_polynomial_PolynomialRingElement_f0 *re) {
  size_t zeta_i = (size_t)0U;
  ntt_at_layer_4_plus_d5(&zeta_i, re, (size_t)7U);
  ntt_at_layer_4_plus_d5(&zeta_i, re, (size_t)6U);
...
- U_COMPRESSION_FACTOR= 10
*/
static KRML_MUSTINLINE void deserialize_then_decompress_u_230(
    uint8_t *ciphertext,
    libcrux_ml_kem_polynomial_PolynomialRingElement_f0 ret[2U]) {
    ...
    Eurydice_slice u_bytes = Eurydice_array_to_subslice2(
        ...
        i0 * (LIBCRUX_ML_KEM_CONSTANTS_COEFFICIENTS_IN_RING_ELEMENT *
            ...
            LIBCRUX_ML_KEM_CONSTANTS_COEFFICIENTS_IN_RING_ELEMENT *
                (size_t)10U / (size_t)8U,
        uint8_t);
    u_as_ntt[i0] = deserialize_then_decompress_ring_element_u_7a0(u_bytes);
    ntt_vector_u_6d0(&u_as_ntt[i0]);
  }
  memcpy(
      ret, u_as_ntt,
      (size_t)2U * sizeof(libcrux_ml_kem_polynomial_PolynomialRingElement_f0));
...
*/
static KRML_MUSTINLINE libcrux_ml_kem_polynomial_PolynomialRingElement_f0
deserialize_then_decompress_ring_element_v_b60(Eurydice_slice serialized) {
  return deserialize_then_decompress_4_da(serialized);
}
...
- V_COMPRESSION_FACTOR= 4
*/
static void decrypt_unpacked_ce0(IndCpaPrivateKeyUnpacked_ae *secret_key,
                                 uint8_t *ciphertext, uint8_t ret[32U]) {
  libcrux_ml_kem_polynomial_PolynomialRingElement_f0 u_as_ntt[2U];
  deserialize_then_decompress_u_230(ciphertext, u_as_ntt);
  libcrux_ml_kem_polynomial_PolynomialRingElement_f0 v =
      deserialize_then_decompress_ring_element_v_b60(
          Eurydice_array_to_subslice_from((size_t)768U, ciphertext,
                                          (size_t)640U, uint8_t, size_t));
  libcrux_ml_kem_polynomial_PolynomialRingElement_f0 message =
      compute_message_2b0(&v, secret_key->secret_as_ntt, u_as_ntt);
  uint8_t ret0[32U];
  compress_then_serialize_message_f3(message, ret0);
  memcpy(ret, ret0, (size_t)32U * sizeof(uint8_t));
}
...
- V_COMPRESSION_FACTOR= 4
*/
static void decrypt_1b0(Eurydice_slice secret_key, uint8_t *ciphertext,
                        uint8_t ret[32U]) {
  libcrux_ml_kem_polynomial_PolynomialRingElement_f0 secret_as_ntt[2U];
  deserialize_secret_key_fc0(secret_key, secret_as_ntt);
  /* Passing arrays by value in Rust generates a copy in C */
  ...
  memcpy(
      ...
      (size_t)2U * sizeof(libcrux_ml_kem_polynomial_PolynomialRingElement_f0));
  uint8_t ret0[32U];
  decrypt_unpacked_ce0(&secret_key_unpacked, ciphertext, ret0);
  memcpy(ret, ret0, (size_t)32U * sizeof(uint8_t));
}
...
*/
void libcrux_ml_kem_ind_cca_decapsulate_2b0(
    libcrux_ml_kem_types_MlKemPrivateKey_5e *private_key,
  ...
  Eurydice_slice implicit_rejection_value = uu____2.snd;
  uint8_t decrypted[32U];
  decrypt_1b0(ind_cpa_secret_key, ciphertext->value, decrypted);
  uint8_t to_hash0[64U];
  libcrux_ml_kem_utils_into_padded_array_42(
      Eurydice_array_to_slice((size_t)32U, decrypted, uint8_t), to_hash0);
  Eurydice_slice_copy(
  ...
  Eurydice_slice uu____4 = Eurydice_array_to_subslice_from(
      ...
      uint8_t, size_t);
  Eurydice_slice_copy(uu____4, libcrux_ml_kem_types_as_ref_fd_b60(ciphertext),
                      uint8_t);
  uint8_t implicit_rejection_shared_secret0[32U];
  ...
  encrypt_1e0(uu____5, copy_of_decrypted, pseudorandomness,
              expected_ciphertext);
  uint8_t implicit_rejection_shared_secret[32U];
  kdf_d8_01(Eurydice_array_to_slice((size_t)32U,
                                    implicit_rejection_shared_secret0, uint8_t),
            implicit_rejection_shared_secret);
  uint8_t shared_secret[32U];
  kdf_d8_01(shared_secret0, shared_secret);
  uint8_t ret0[32U];
  libcrux_ml_kem_constant_time_ops_compare_ciphertexts_select_shared_secret_in_constant_time(
      libcrux_ml_kem_types_as_ref_fd_b60(ciphertext),
...
- K= 3
*/
static KRML_MUSTINLINE void deserialize_ring_elements_reduced_642(
    Eurydice_slice public_key,
    libcrux_ml_kem_polynomial_PolynomialRingElement_f0 *deserialized_pk) {
  for (size_t i = (size_t)0U;
       i < Eurydice_slice_len(public_key, uint8_t) /
...
- K= 3
*/
static KRML_MUSTINLINE void deserialize_ring_elements_reduced_out_da(
    Eurydice_slice public_key,
  ...
  KRML_MAYBE_FOR3(i, (size_t)0U, (size_t)3U, (size_t)1U,
                  deserialized_pk[i] = ZERO_d6_19(););
  deserialize_ring_elements_reduced_642(public_key, deserialized_pk);
  memcpy(
      ret, deserialized_pk,
...
- OUT_LEN= 1152
*/
static KRML_MUSTINLINE void serialize_secret_key_d81(
    libcrux_ml_kem_polynomial_PolynomialRingElement_f0 *key,
    uint8_t ret[1152U]) {
...
- PUBLIC_KEY_SIZE= 1184
*/
static KRML_MUSTINLINE void serialize_public_key_mut_491(
    libcrux_ml_kem_polynomial_PolynomialRingElement_f0 *t_as_ntt,
    Eurydice_slice seed_for_a, uint8_t *serialized) {
  Eurydice_slice uu____0 = Eurydice_array_to_subslice2(serialized, (size_t)0U,
                                                       (size_t)1152U, uint8_t);
  uint8_t ret[1152U];
  serialize_secret_key_d81(t_as_ntt, ret);
  Eurydice_slice_copy(
...
- PUBLIC_KEY_SIZE= 1184
*/
static KRML_MUSTINLINE void serialize_public_key_d31(
    libcrux_ml_kem_polynomial_PolynomialRingElement_f0 *t_as_ntt,
    Eurydice_slice seed_for_a, uint8_t ret[1184U]) {
  uint8_t public_key_serialized[1184U] = {0U};
  serialize_public_key_mut_491(t_as_ntt, seed_for_a, public_key_serialized);
...
- PUBLIC_KEY_SIZE= 1184
*/
bool libcrux_ml_kem_ind_cca_validate_public_key_c3(uint8_t *public_key) {
  libcrux_ml_kem_polynomial_PolynomialRingElement_f0 deserialized_pk[3U];
  deserialize_ring_elements_reduced_out_da(
...
*/
bool libcrux_ml_kem_ind_cca_validate_private_key_49(
...
- K= 3
*/
static KRML_MUSTINLINE void cpa_keygen_seed_d8_522(
    Eurydice_slice key_generation_seed, uint8_t ret[64U]) {
  uint8_t seed[33U] = {0U};
  Eurydice_slice_copy(
      Eurydice_array_to_subslice2(
...
- N= 504
*/
static KRML_MUSTINLINE bool sample_from_uniform_distribution_next_603(
...
- N= 168
*/
static KRML_MUSTINLINE bool sample_from_uniform_distribution_next_604(
...
- K= 3
*/
static libcrux_ml_kem_polynomial_PolynomialRingElement_f0 closure_551(
    int16_t s[272U]) {
  return from_i16_array_d6_b3(
      Eurydice_array_to_subslice2(s, (size_t)0U, (size_t)256U, int16_t));
}
...
- K= 3
*/
static KRML_MUSTINLINE void sample_from_xof_d81(
  ...
  bool done = sample_from_uniform_distribution_next_603(
      copy_of_randomness0, sampled_coefficients, out);
  while (true) {
    if (done) {
      break;
      ...
      done = sample_from_uniform_distribution_next_604(
          copy_of_randomness, sampled_coefficients, out);
    }
  }
  /* Passing arrays by value in Rust generates a copy in C */
  ...
  KRML_MAYBE_FOR3(i, (size_t)0U, (size_t)3U, (size_t)1U,
                  ret0[i] = closure_551(copy_of_out[i]););
  memcpy(
      ret, ret0,
      (size_t)3U * sizeof(libcrux_ml_kem_polynomial_PolynomialRingElement_f0));
}
...
- K= 3
*/
static KRML_MUSTINLINE void sample_matrix_A_951(
  ...
  KRML_MAYBE_FOR3(
      ...
      sample_from_xof_d81(copy_of_seeds, sampled);
      for (size_t i = (size_t)0U;
           i < Eurydice_slice_len(
                   Eurydice_array_to_slice(
                       (size_t)3U, sampled,
...
- ETA_RANDOMNESS_SIZE= 128
*/
static KRML_MUSTINLINE uint8_t sample_vector_cbd_then_ntt_ce1(
    libcrux_ml_kem_polynomial_PolynomialRingElement_f0 *re_as_ntt,
    uint8_t prf_input[33U], uint8_t domain_separator) {
  /* Passing arrays by value in Rust generates a copy in C */
  uint8_t copy_of_prf_input[33U];
...
- ETA_RANDOMNESS_SIZE= 128
*/
static KRML_MUSTINLINE tuple_b00 sample_vector_cbd_then_ntt_out_251(
    uint8_t prf_input[33U], uint8_t domain_separator) {
  ...
  memcpy(uu____1, prf_input, (size_t)33U * sizeof(uint8_t));
  domain_separator =
      sample_vector_cbd_then_ntt_ce1(uu____0, uu____1, domain_separator);
  /* Passing arrays by value in Rust generates a copy in C */
...
- K= 3
*/
static KRML_MUSTINLINE void add_to_ring_element_d6_9d1(
    libcrux_ml_kem_polynomial_PolynomialRingElement_f0 *self,
    libcrux_ml_kem_polynomial_PolynomialRingElement_f0 *rhs) {
  for (size_t i = (size_t)0U;
       i < Eurydice_slice_len(
...
- K= 3
*/
static KRML_MUSTINLINE void compute_As_plus_e_501(
    libcrux_ml_kem_polynomial_PolynomialRingElement_f0 *t_as_ntt,
  ...
  for (size_t i = (size_t)0U;
    ...
    for (size_t i1 = (size_t)0U;
      ...
      libcrux_ml_kem_polynomial_PolynomialRingElement_f0 product =
          ntt_multiply_d6_1b(matrix_element, &s_as_ntt[j]);
      add_to_ring_element_d6_9d1(&t_as_ntt[i0], &product);
    }
    add_standard_error_reduce_d6_00(&t_as_ntt[i0], &error_as_ntt[i0]);
  }
}
...
- ETA1_RANDOMNESS_SIZE= 128
*/
static void generate_keypair_unpacked_7e1(
    Eurydice_slice key_generation_seed,
    IndCpaPrivateKeyUnpacked_f8 *private_key,
    IndCpaPublicKeyUnpacked_f8 *public_key) {
  uint8_t hashed[64U];
  cpa_keygen_seed_d8_522(key_generation_seed, hashed);
  Eurydice_slice_uint8_t_x2 uu____0 = Eurydice_slice_split_at(
      Eurydice_array_to_slice((size_t)64U, hashed, uint8_t), (size_t)32U,
      uint8_t, Eurydice_slice_uint8_t_x2);
  Eurydice_slice seed_for_A = uu____0.fst;
  ...
  uint8_t ret[34U];
  libcrux_ml_kem_utils_into_padded_array_422(seed_for_A, ret);
  sample_matrix_A_951(uu____1, ret, true);
  uint8_t prf_input[33U];
  libcrux_ml_kem_utils_into_padded_array_421(seed_for_secret_and_error,
                                             prf_input);
  libcrux_ml_kem_polynomial_PolynomialRingElement_f0 *uu____2 =
  ...
  memcpy(copy_of_prf_input0, prf_input, (size_t)33U * sizeof(uint8_t));
  uint8_t domain_separator =
      sample_vector_cbd_then_ntt_ce1(uu____2, copy_of_prf_input0, 0U);
  /* Passing arrays by value in Rust generates a copy in C */
  uint8_t copy_of_prf_input[33U];
  memcpy(copy_of_prf_input, prf_input, (size_t)33U * sizeof(uint8_t));
  ...
  memcpy(
      error_as_ntt,
      sample_vector_cbd_then_ntt_out_251(copy_of_prf_input, domain_separator)
          .fst,
      (size_t)3U * sizeof(libcrux_ml_kem_polynomial_PolynomialRingElement_f0));
  compute_As_plus_e_501(public_key->t_as_ntt, public_key->A,
                        private_key->secret_as_ntt, error_as_ntt);
  uint8_t uu____5[32U];
  core_result_Result_00 dst;
  Eurydice_slice_to_array2(&dst, seed_for_A, Eurydice_slice, uint8_t[32U]);
...
- ETA1_RANDOMNESS_SIZE= 128
*/
static libcrux_ml_kem_utils_extraction_helper_Keypair768 generate_keypair_e3(
    Eurydice_slice key_generation_seed) {
  IndCpaPrivateKeyUnpacked_f8 private_key = default_1a_a31();
  IndCpaPublicKeyUnpacked_f8 public_key = default_8d_6b1();
  generate_keypair_unpacked_7e1(key_generation_seed, &private_key, &public_key);
  uint8_t public_key_serialized[1184U];
  serialize_public_key_d31(
      public_key.t_as_ntt,
      Eurydice_array_to_slice((size_t)32U, public_key.seed_for_A, uint8_t),
  ...
  serialize_secret_key_d81(private_key.secret_as_ntt, secret_key_serialized);
  /* Passing arrays by value in Rust generates a copy in C */
...
*/
static KRML_MUSTINLINE void serialize_kem_secret_key_0f(
    Eurydice_slice private_key, Eurydice_slice public_key,
...
libcrux_ml_kem_ind_cca_generate_keypair_7d(uint8_t randomness[64U]) {
  Eurydice_slice ind_cpa_keypair_randomness = Eurydice_array_to_subslice2(
      randomness, (size_t)0U,
      LIBCRUX_ML_KEM_CONSTANTS_CPA_PKE_KEY_GENERATION_SEED_SIZE, uint8_t);
  Eurydice_slice implicit_rejection_value = Eurydice_array_to_subslice_from(
  ...
  libcrux_ml_kem_types_MlKemPrivateKey_55 private_key =
      libcrux_ml_kem_types_from_88_3e0(copy_of_secret_key_serialized);
  ...
  return libcrux_ml_kem_types_from_17_620(
      uu____2, libcrux_ml_kem_types_from_40_1c0(copy_of_public_key));
}
...
- K= 3
*/
static KRML_MUSTINLINE void entropy_preprocess_d8_07(Eurydice_slice randomness,
                                                     uint8_t ret[32U]) {
  uint8_t out[32U] = {0U};
  Eurydice_slice_copy(Eurydice_array_to_slice((size_t)32U, out, uint8_t),
                      randomness, uint8_t);
...
- K= 3
*/
static KRML_MUSTINLINE void deserialize_ring_elements_reduced_641(
    Eurydice_slice public_key,
    libcrux_ml_kem_polynomial_PolynomialRingElement_f0 *deserialized_pk) {
  for (size_t i = (size_t)0U;
       i < Eurydice_slice_len(public_key, uint8_t) /
...
sample_ring_element_cbd_d81(uint8_t prf_input[33U], uint8_t domain_separator) {
...
- K= 3
*/
static KRML_MUSTINLINE void invert_ntt_montgomery_051(
    libcrux_ml_kem_polynomial_PolynomialRingElement_f0 *re) {
  size_t zeta_i =
      LIBCRUX_ML_KEM_CONSTANTS_COEFFICIENTS_IN_RING_ELEMENT / (size_t)2U;
  invert_ntt_at_layer_1_2a(&zeta_i, re);
...
- K= 3
*/
static KRML_MUSTINLINE void compute_vector_u_0d1(
  ...
  for (size_t i0 = (size_t)0U;
    ...
    for (size_t i = (size_t)0U;
      ...
      libcrux_ml_kem_polynomial_PolynomialRingElement_f0 product =
          ntt_multiply_d6_1b(a_element, &r_as_ntt[j]);
      add_to_ring_element_d6_9d1(&result[i1], &product);
    }
    invert_ntt_montgomery_051(&result[i1]);
    add_error_reduce_d6_26(&result[i1], &error_1[i1]);
  }
  memcpy(
      ret, result,
...
compute_ring_element_v_d21(
  ...
  KRML_MAYBE_FOR3(i, (size_t)0U, (size_t)3U, (size_t)1U, size_t i0 = i;
                  libcrux_ml_kem_polynomial_PolynomialRingElement_f0 product =
                      ntt_multiply_d6_1b(&t_as_ntt[i0], &r_as_ntt[i0]);
                  add_to_ring_element_d6_9d1(&result, &product););
  invert_ntt_montgomery_051(&result);
  result = add_message_error_reduce_d6_09(error_2, message, result);
  return result;
}
...
- BLOCK_LEN= 320
*/
static void compress_then_serialize_u_e31(
...
- ETA2_RANDOMNESS_SIZE= 128
*/
static void encrypt_unpacked_881(IndCpaPublicKeyUnpacked_f8 *public_key,
                                 uint8_t message[32U],
  ...
  memcpy(copy_of_prf_input0, prf_input, (size_t)33U * sizeof(uint8_t));
  tuple_b00 uu____1 =
      sample_vector_cbd_then_ntt_out_251(copy_of_prf_input0, 0U);
  ...
  memcpy(copy_of_prf_input, prf_input, (size_t)33U * sizeof(uint8_t));
  tuple_b00 uu____3 =
      sample_ring_element_cbd_d81(copy_of_prf_input, domain_separator0);
  libcrux_ml_kem_polynomial_PolynomialRingElement_f0 error_1[3U];
  memcpy(
      error_1, uu____3.fst,
      (size_t)3U * sizeof(libcrux_ml_kem_polynomial_PolynomialRingElement_f0));
  ...
  compute_vector_u_0d1(public_key->A, r_as_ntt, error_1, u);
  /* Passing arrays by value in Rust generates a copy in C */
  uint8_t copy_of_message[32U];
  memcpy(copy_of_message, message, (size_t)32U * sizeof(uint8_t));
  libcrux_ml_kem_polynomial_PolynomialRingElement_f0 message_as_ring_element =
...
- ETA2_RANDOMNESS_SIZE= 128
*/
static void encrypt_1e(Eurydice_slice public_key, uint8_t message[32U],
                       Eurydice_slice randomness, uint8_t ret[1088U]) {
  IndCpaPublicKeyUnpacked_f8 unpacked_public_key = default_8d_6b1();
  deserialize_ring_elements_reduced_641(
  ...
  uint8_t ret0[34U];
  libcrux_ml_kem_utils_into_padded_array_422(seed, ret0);
  sample_matrix_A_951(uu____0, ret0, false);
  IndCpaPublicKeyUnpacked_f8 *uu____1 = &unpacked_public_key;
  /* Passing arrays by value in Rust generates a copy in C */
  uint8_t copy_of_message[32U];
  memcpy(copy_of_message, message, (size_t)32U * sizeof(uint8_t));
  uint8_t ret1[1088U];
  encrypt_unpacked_881(uu____1, copy_of_message, randomness, ret1);
...
- CIPHERTEXT_SIZE= 1088
*/
static KRML_MUSTINLINE void kdf_d8_f1(Eurydice_slice shared_secret,
                                      uint8_t ret[32U]) {
  uint8_t out[32U] = {0U};
  Eurydice_slice_copy(Eurydice_array_to_slice((size_t)32U, out, uint8_t),
                      shared_secret, uint8_t);
...
- ETA2_RANDOMNESS_SIZE= 128
*/
tuple_3c libcrux_ml_kem_ind_cca_encapsulate_c1(
    libcrux_ml_kem_types_MlKemPublicKey_15 *public_key,
    uint8_t randomness[32U]) {
  uint8_t randomness0[32U];
  entropy_preprocess_d8_07(
      Eurydice_array_to_slice((size_t)32U, randomness, uint8_t), randomness0);
  uint8_t to_hash[64U];
  libcrux_ml_kem_utils_into_padded_array_42(
      Eurydice_array_to_slice((size_t)32U, randomness0, uint8_t), to_hash);
  ...
  H_f1_c61(Eurydice_array_to_slice(
               (size_t)1184U, libcrux_ml_kem_types_as_slice_ba_e91(public_key),
               uint8_t),
           ret);
  Eurydice_slice_copy(
      uu____0, Eurydice_array_to_slice((size_t)32U, ret, uint8_t), uint8_t);
  ...
  Eurydice_slice pseudorandomness = uu____1.snd;
  Eurydice_slice uu____2 = Eurydice_array_to_slice(
      (size_t)1184U, libcrux_ml_kem_types_as_slice_ba_e91(public_key), uint8_t);
  /* Passing arrays by value in Rust generates a copy in C */
  uint8_t copy_of_randomness[32U];
  memcpy(copy_of_randomness, randomness0, (size_t)32U * sizeof(uint8_t));
  uint8_t ciphertext[1088U];
  encrypt_1e(uu____2, copy_of_randomness, pseudorandomness, ciphertext);
  /* Passing arrays by value in Rust generates a copy in C */
  ...
  libcrux_ml_kem_mlkem768_MlKem768Ciphertext ciphertext0 =
      libcrux_ml_kem_types_from_fc_151(copy_of_ciphertext);
  uint8_t shared_secret_array[32U];
  kdf_d8_f1(shared_secret, shared_secret_array);
...
- U_COMPRESSION_FACTOR= 10
*/
static KRML_MUSTINLINE void deserialize_then_decompress_u_231(
    uint8_t *ciphertext,
    libcrux_ml_kem_polynomial_PolynomialRingElement_f0 ret[3U]) {
...
- V_COMPRESSION_FACTOR= 4
*/
static void decrypt_unpacked_ce1(IndCpaPrivateKeyUnpacked_f8 *secret_key,
                                 uint8_t *ciphertext, uint8_t ret[32U]) {
  libcrux_ml_kem_polynomial_PolynomialRingElement_f0 u_as_ntt[3U];
  deserialize_then_decompress_u_231(ciphertext, u_as_ntt);
  libcrux_ml_kem_polynomial_PolynomialRingElement_f0 v =
      deserialize_then_decompress_ring_element_v_b60(
          Eurydice_array_to_subslice_from((size_t)1088U, ciphertext,
                                          (size_t)960U, uint8_t, size_t));
  libcrux_ml_kem_polynomial_PolynomialRingElement_f0 message =
      compute_message_2b1(&v, secret_key->secret_as_ntt, u_as_ntt);
  uint8_t ret0[32U];
  compress_then_serialize_message_f3(message, ret0);
  memcpy(ret, ret0, (size_t)32U * sizeof(uint8_t));
}
...
- V_COMPRESSION_FACTOR= 4
*/
static void decrypt_1b(Eurydice_slice secret_key, uint8_t *ciphertext,
                       uint8_t ret[32U]) {
  libcrux_ml_kem_polynomial_PolynomialRingElement_f0 secret_as_ntt[3U];
  ...
  memcpy(
      ...
      (size_t)3U * sizeof(libcrux_ml_kem_polynomial_PolynomialRingElement_f0));
  uint8_t ret0[32U];
  decrypt_unpacked_ce1(&secret_key_unpacked, ciphertext, ret0);
  memcpy(ret, ret0, (size_t)32U * sizeof(uint8_t));
}
...
*/
void libcrux_ml_kem_ind_cca_decapsulate_2b(
    libcrux_ml_kem_types_MlKemPrivateKey_55 *private_key,
  ...
  Eurydice_slice implicit_rejection_value = uu____2.snd;
  uint8_t decrypted[32U];
  decrypt_1b(ind_cpa_secret_key, ciphertext->value, decrypted);
  uint8_t to_hash0[64U];
  libcrux_ml_kem_utils_into_padded_array_42(
      Eurydice_array_to_slice((size_t)32U, decrypted, uint8_t), to_hash0);
  Eurydice_slice_copy(
  ...
  Eurydice_slice uu____4 = Eurydice_array_to_subslice_from(
      ...
      uint8_t, size_t);
  Eurydice_slice_copy(uu____4, libcrux_ml_kem_types_as_ref_fd_b61(ciphertext),
                      uint8_t);
  uint8_t implicit_rejection_shared_secret0[32U];
  ...
  encrypt_1e(uu____5, copy_of_decrypted, pseudorandomness, expected_ciphertext);
  uint8_t implicit_rejection_shared_secret[32U];
  kdf_d8_f1(Eurydice_array_to_slice((size_t)32U,
                                    implicit_rejection_shared_secret0, uint8_t),
            implicit_rejection_shared_secret);
  uint8_t shared_secret[32U];
  kdf_d8_f1(shared_secret0, shared_secret);
  uint8_t ret0[32U];
  libcrux_ml_kem_constant_time_ops_compare_ciphertexts_select_shared_secret_in_constant_time(
      libcrux_ml_kem_types_as_ref_fd_b61(ciphertext),
