...
libcrux_ml_kem_hash_functions_portable_G(Eurydice_slice input, uint8_t ret[64U])
{
...
KRML_MUSTINLINE void
libcrux_ml_kem_hash_functions_portable_H(Eurydice_slice input, uint8_t ret[32U])
{
...
)
{
  uint8_t_x11
  r0_10 =
    libcrux_ml_kem_vector_portable_serialize_serialize_11_int(Eurydice_array_to_subslice3(v.elements,
        (size_t)0U,
        (size_t)8U,
        int16_t *));
  uint8_t_x11
...
)
{
  ...
  {
    size_t i0 = i;
    if (libcrux_secrets_int_public_integers_declassify_d8_39(vec.elements[i0]) >= (int16_t)3329)
    {
      size_t uu____0 = i0;
...
)
{
  for (size_t i = (size_t)0U; i < LIBCRUX_ML_KEM_VECTOR_TRAITS_FIELD_ELEMENTS_IN_VECTOR; i++)
  {
    size_t i0 = i;
    int16_t
    vi = libcrux_ml_kem_vector_portable_arithmetic_barrett_reduce_element(vec.elements[i0]);
    vec.elements[i0] = vi;
  }
  return vec;
}
...
)
{
  for (size_t i = (size_t)0U; i < LIBCRUX_ML_KEM_VECTOR_TRAITS_FIELD_ELEMENTS_IN_VECTOR; i++)
  {
    size_t i0 = i;
    vec.elements[i0] =
      libcrux_ml_kem_vector_portable_arithmetic_montgomery_multiply_fe_by_fer(vec.elements[i0],
        c);
  }
  return vec;
}
...
{
  libcrux_ml_kem_vector_portable_vector_type_PortableVector t = shift_right_ef(a);
  libcrux_ml_kem_vector_portable_vector_type_PortableVector
  fm =
...
)
{
  for (size_t i = (size_t)0U; i < LIBCRUX_ML_KEM_VECTOR_TRAITS_FIELD_ELEMENTS_IN_VECTOR; i++)
  {
    size_t i0 = i;
    a.elements[i0] =
      libcrux_secrets_int_as_i16_59(libcrux_ml_kem_vector_portable_compress_compress_message_coefficient(libcrux_secrets_int_as_u16_f5(a.elements[i0])));
  }
  return a;
}
...
{
  libcrux_ml_kem_vector_portable_vector_type_PortableVector
  z = libcrux_ml_kem_vector_portable_vector_type_zero();
  libcrux_ml_kem_vector_portable_vector_type_PortableVector
  s = libcrux_ml_kem_vector_portable_arithmetic_sub(z, &a);
  libcrux_ml_kem_vector_portable_vector_type_PortableVector
...
)
{
  int16_t
  t =
    libcrux_ml_kem_vector_portable_arithmetic_montgomery_multiply_fe_by_fer(vec->elements[j],
...
)
{
  uint8_t_x4
  result0_3 =
    libcrux_ml_kem_vector_portable_serialize_serialize_4_int(Eurydice_array_to_subslice3(v.elements,
        (size_t)0U,
        (size_t)8U,
        int16_t *));
  uint8_t_x4
...
)
{
  uint8_t_x5
  r0_4 =
    libcrux_ml_kem_vector_portable_serialize_serialize_5_int(Eurydice_array_to_subslice3(v.elements,
        (size_t)0U,
        (size_t)8U,
        int16_t *));
  uint8_t_x5
...
)
{
  uint8_t_x5
  r0_4 =
    libcrux_ml_kem_vector_portable_serialize_serialize_10_int(Eurydice_array_to_subslice3(v.elements,
        (size_t)0U,
        (size_t)4U,
        int16_t *));
  uint8_t_x5
...
)
{
  uint8_t_x3
  r0_2 =
    libcrux_ml_kem_vector_portable_serialize_serialize_12_int(Eurydice_array_to_subslice3(v.elements,
        (size_t)0U,
        (size_t)2U,
        int16_t *));
  uint8_t_x3
...
*/
static libcrux_ml_kem_polynomial_PolynomialRingElement_1d ZERO_d6_ea(void)
{
  libcrux_ml_kem_polynomial_PolynomialRingElement_1d lit;
  libcrux_ml_kem_vector_portable_vector_type_PortableVector repeat_expression[16U];
  KRML_MAYBE_FOR16(i,
    (size_t)0U,
    (size_t)16U,
    (size_t)1U,
    repeat_expression[i] = libcrux_ml_kem_vector_portable_ZERO_b8(););
  memcpy(lit.coefficients,
    repeat_expression,
    (size_t)16U * sizeof (libcrux_ml_kem_vector_portable_vector_type_PortableVector));
  return lit;
}
...
- K= 4
*/
static libcrux_ml_kem_polynomial_PolynomialRingElement_1d call_mut_0b_d0(void **_)
{
  return ZERO_d6_ea();
}
  ...
  for (size_t i = (size_t)0U; i < Eurydice_slice_len(serialized, uint8_t) / (size_t)24U; i++)
  {
    ...
    bytes =
      Eurydice_slice_subslice3(serialized,
        ...
        uint8_t *);
    libcrux_ml_kem_vector_portable_vector_type_PortableVector
    coefficient = libcrux_ml_kem_vector_portable_deserialize_12_b8(bytes);
    libcrux_ml_kem_vector_portable_vector_type_PortableVector
    uu____0 = libcrux_ml_kem_vector_portable_cond_subtract_3329_b8(coefficient);
...
)
{
    ...
    i++)
  {
    ...
    uu____0 = deserialize_to_reduced_ring_element_ea(ring_element);
...
*/
static KRML_MUSTINLINE libcrux_ml_kem_vector_portable_vector_type_PortableVector
to_unsigned_field_modulus_ea(libcrux_ml_kem_vector_portable_vector_type_PortableVector a)
{
...
)
{
  ...
  for (size_t i = (size_t)0U; i < LIBCRUX_ML_KEM_POLYNOMIAL_VECTORS_IN_RING_ELEMENT; i++)
  {
    size_t i0 = i;
    libcrux_ml_kem_vector_portable_vector_type_PortableVector
    coefficient = to_unsigned_field_modulus_ea(re->coefficients[i0]);
    uint8_t bytes[24U];
...
{
  uint8_t t[32U];
  H_4a_ac(Eurydice_array_to_subslice3(private_key->value,
...
- K= 4
*/
static IndCpaPrivateKeyUnpacked_af default_70_d0(void)
{
...
- K= 4
*/
static IndCpaPublicKeyUnpacked_af default_8b_d0(void)
{
  libcrux_ml_kem_polynomial_PolynomialRingElement_1d uu____0[4U];
  KRML_MAYBE_FOR4(i, (size_t)0U, (size_t)4U, (size_t)1U, uu____0[i] = ZERO_d6_ea(););
  ...
  memcpy(lit.A,
    repeat_expression0,
    (size_t)4U * sizeof (libcrux_ml_kem_polynomial_PolynomialRingElement_1d [4U]));
  return lit;
}
...
*/
static KRML_MUSTINLINE void
cpa_keygen_seed_39_03(Eurydice_slice key_generation_seed, uint8_t ret[64U])
{
  uint8_t seed[33U] = { 0U };
...
- K= 4
*/
static KRML_MUSTINLINE PortableHash_44 shake128_init_absorb_final_ac(uint8_t (*input)[34U])
{
  ...
  memcpy(shake128_state.shake128_state,
    repeat_expression,
  ...
  KRML_MAYBE_FOR4(i,
    ...
    (size_t)1U,
    size_t i0 = i;
    libcrux_sha3_portable_incremental_shake128_absorb_final(&shake128_state.shake128_state[i0],
...
- K= 4
*/
static KRML_MUSTINLINE PortableHash_44 shake128_init_absorb_final_4a_ac(uint8_t (*input)[34U])
{
...
*/
static KRML_MUSTINLINE void
shake128_squeeze_first_three_blocks_ac(PortableHash_44 *st, uint8_t ret[4U][504U])
{
  ...
  KRML_MAYBE_FOR4(i,
    ...
    (size_t)1U,
    size_t i0 = i;
    libcrux_sha3_portable_incremental_shake128_squeeze_first_three_blocks(&st->shake128_state[i0],
...
*/
static KRML_MUSTINLINE void
shake128_squeeze_first_three_blocks_4a_ac(PortableHash_44 *self, uint8_t ret[4U][504U])
{
  ...
  KRML_MAYBE_FOR4(i0,
    ...
    for (size_t i = (size_t)0U; i < (size_t)504U / (size_t)24U; i++)
    {
      ...
      if (sampled_coefficients[i1] < LIBCRUX_ML_KEM_CONSTANTS_COEFFICIENTS_IN_RING_ELEMENT)
      {
        size_t
        sampled =
          libcrux_ml_kem_vector_portable_rej_sample_b8(Eurydice_array_to_subslice3(randomness[i1],
              r * (size_t)24U,
...
*/
static KRML_MUSTINLINE void
shake128_squeeze_next_block_ac(PortableHash_44 *st, uint8_t ret[4U][168U])
{
  ...
  KRML_MAYBE_FOR4(i,
    ...
    (size_t)1U,
    size_t i0 = i;
    libcrux_sha3_portable_incremental_shake128_squeeze_next_block(&st->shake128_state[i0],
...
*/
static KRML_MUSTINLINE void
shake128_squeeze_next_block_4a_ac(PortableHash_44 *self, uint8_t ret[4U][168U])
{
...
*/
static libcrux_ml_kem_polynomial_PolynomialRingElement_1d ZERO_ea(void)
{
  libcrux_ml_kem_polynomial_PolynomialRingElement_1d lit;
  libcrux_ml_kem_vector_portable_vector_type_PortableVector repeat_expression[16U];
  KRML_MAYBE_FOR16(i,
...
call_mut_af_2b(int16_t tupled_args[272U])
{
  int16_t s[272U];
...
)
{
  ...
  bool done = sample_from_uniform_distribution_next_ff(randomness0, sampled_coefficients, out);
  while (true)
  {
    if (done)
    {
  ...
  KRML_MAYBE_FOR4(i,
    ...
    (size_t)4U,
    (size_t)1U,
    ret0[i] = call_mut_af_2b(copy_of_out[i]););
  memcpy(ret, ret0, (size_t)4U * sizeof (libcrux_ml_kem_polynomial_PolynomialRingElement_1d));
}
...
static KRML_MUSTINLINE void PRFxN_44(uint8_t (*input)[33U], uint8_t ret[4U][128U])
{
  ...
  KRML_MAYBE_FOR4(i,
    ...
    (size_t)1U,
    size_t i0 = i;
    libcrux_sha3_portable_shake256(Eurydice_array_to_slice((size_t)128U, out[i0], uint8_t),
...
- LEN= 128
*/
static KRML_MUSTINLINE void PRFxN_4a_44(uint8_t (*input)[33U], uint8_t ret[4U][128U])
{
  PRFxN_44(input, ret);
}
...
*/
static KRML_MUSTINLINE void
ntt_at_layer_7_ea(libcrux_ml_kem_polynomial_PolynomialRingElement_1d *re)
{
  ...
  for (size_t i = (size_t)0U; i < step; i++)
  {
    ...
    libcrux_ml_kem_vector_portable_vector_type_PortableVector
    t =
      libcrux_ml_kem_vector_portable_multiply_by_constant_b8(re->coefficients[j + step],
        (int16_t)-1600);
    re->coefficients[j + step] = libcrux_ml_kem_vector_portable_sub_b8(re->coefficients[j], &t);
    libcrux_ml_kem_vector_portable_vector_type_PortableVector
    uu____1 = libcrux_ml_kem_vector_portable_add_b8(re->coefficients[j], &t);
...
*/
static KRML_MUSTINLINE void
ntt_at_layer_3_ea(size_t *zeta_i, libcrux_ml_kem_polynomial_PolynomialRingElement_1d *re)
{
  KRML_MAYBE_FOR16(i,
    (size_t)0U,
    (size_t)16U,
    ...
    libcrux_ml_kem_vector_portable_vector_type_PortableVector
    uu____0 =
      libcrux_ml_kem_vector_portable_ntt_layer_3_step_b8(re->coefficients[round],
        libcrux_ml_kem_polynomial_zeta(zeta_i[0U]));
...
*/
static KRML_MUSTINLINE void
ntt_at_layer_2_ea(size_t *zeta_i, libcrux_ml_kem_polynomial_PolynomialRingElement_1d *re)
{
  KRML_MAYBE_FOR16(i,
    (size_t)0U,
    (size_t)16U,
    ...
    re->coefficients[round] =
      libcrux_ml_kem_vector_portable_ntt_layer_2_step_b8(re->coefficients[round],
        libcrux_ml_kem_polynomial_zeta(zeta_i[0U]),
...
*/
static KRML_MUSTINLINE void
ntt_at_layer_1_ea(size_t *zeta_i, libcrux_ml_kem_polynomial_PolynomialRingElement_1d *re)
{
  KRML_MAYBE_FOR16(i,
    (size_t)0U,
    (size_t)16U,
    ...
    zeta_i[0U] = zeta_i[0U] + (size_t)1U;
    re->coefficients[round] =
      libcrux_ml_kem_vector_portable_ntt_layer_1_step_b8(re->coefficients[round],
        libcrux_ml_kem_polynomial_zeta(zeta_i[0U]),
        libcrux_ml_kem_polynomial_zeta(zeta_i[0U] + (size_t)1U),
...
*/
static KRML_MUSTINLINE void
poly_barrett_reduce_ea(libcrux_ml_kem_polynomial_PolynomialRingElement_1d *myself)
{
  for (size_t i = (size_t)0U; i < LIBCRUX_ML_KEM_POLYNOMIAL_VECTORS_IN_RING_ELEMENT; i++)
  {
    size_t i0 = i;
    libcrux_ml_kem_vector_portable_vector_type_PortableVector
    uu____0 = libcrux_ml_kem_vector_portable_barrett_reduce_b8(myself->coefficients[i0]);
...
*/
static KRML_MUSTINLINE void
poly_barrett_reduce_d6_ea(libcrux_ml_kem_polynomial_PolynomialRingElement_1d *self)
{
...
*/
static KRML_MUSTINLINE void
ntt_binomially_sampled_ring_element_ea(libcrux_ml_kem_polynomial_PolynomialRingElement_1d *re)
{
...
*/
static libcrux_ml_kem_polynomial_PolynomialRingElement_1d call_mut_73_1c(void **_)
{
  return ZERO_d6_ea();
}
...
)
{
  ...
  for (size_t i = (size_t)0U; i < LIBCRUX_ML_KEM_POLYNOMIAL_VECTORS_IN_RING_ELEMENT; i++)
  {
    ...
    libcrux_ml_kem_vector_portable_vector_type_PortableVector
    uu____0 =
      libcrux_ml_kem_vector_portable_ntt_multiply_b8(&myself->coefficients[i0],
        &rhs->coefficients[i0],
...
*/
static KRML_MUSTINLINE libcrux_ml_kem_vector_portable_vector_type_PortableVector
to_standard_domain_ea(libcrux_ml_kem_vector_portable_vector_type_PortableVector vector)
{
  return
...
)
{
  for (size_t i = (size_t)0U; i < LIBCRUX_ML_KEM_POLYNOMIAL_VECTORS_IN_RING_ELEMENT; i++)
  {
    size_t j = i;
    libcrux_ml_kem_vector_portable_vector_type_PortableVector
    coefficient_normal_form = to_standard_domain_ea(myself->coefficients[j]);
    libcrux_ml_kem_vector_portable_vector_type_PortableVector
    sum = libcrux_ml_kem_vector_portable_add_b8(coefficient_normal_form, &error->coefficients[j]);
    libcrux_ml_kem_vector_portable_vector_type_PortableVector
    red = libcrux_ml_kem_vector_portable_barrett_reduce_b8(sum);
...
)
{
    ...
    i++)
  {
    ...
    {
      size_t j = i1;
      libcrux_ml_kem_polynomial_PolynomialRingElement_1d *matrix_element = &row[j];
      libcrux_ml_kem_polynomial_PolynomialRingElement_1d
      product = ntt_multiply_d6_ea(matrix_element, &s_as_ntt[j]);
...
)
{
  ...
  libcrux_ml_kem_polynomial_PolynomialRingElement_1d (*uu____1)[4U] = public_key->A;
  uint8_t ret[34U];
  ...
  uint8_t
  domain_separator = sample_vector_cbd_then_ntt_3b(private_key->secret_as_ntt, prf_input, 0U);
  ...
  LowStar_Ignore_ignore(sample_vector_cbd_then_ntt_3b(error_as_ntt, prf_input, domain_separator),
    uint8_t,
    void *);
  compute_As_plus_e_d0(public_key->t_as_ntt,
    public_key->A,
...
)
{
  ...
  serialize_vector_d0(private_key->secret_as_ntt,
...
)
{
  ...
  serialize_kem_secret_key_mut_60(private_key, public_key, implicit_rejection_value, out);
...
*/
static KRML_MUSTINLINE void
entropy_preprocess_39_03(Eurydice_slice randomness, uint8_t ret[32U])
{
  uint8_t out[32U] = { 0U };
...
)
{
  ...
  seed =
    Eurydice_slice_subslice_from(public_key,
      ...
      size_t,
      Eurydice_derefed_slice);
  libcrux_ml_kem_polynomial_PolynomialRingElement_1d (*uu____1)[4U] = unpacked_public_key->A;
  uint8_t ret[34U];
...
with types libcrux_ml_kem_polynomial_PolynomialRingElement libcrux_ml_kem_vector_portable_vector_type_PortableVector[4size_t], libcrux_ml_kem_polynomial_PolynomialRingElement libcrux_ml_kem_vector_portable_vector_type_PortableVector

*/
typedef struct tuple_080_s
{
...
*/
static libcrux_ml_kem_polynomial_PolynomialRingElement_1d call_mut_f1_85(void **_)
{
  return ZERO_d6_ea();
}
...
- ETA2_RANDOMNESS_SIZE= 128
*/
static libcrux_ml_kem_polynomial_PolynomialRingElement_1d call_mut_dd_85(void **_)
{
  return ZERO_d6_ea();
}
...
- LEN= 128
*/
static KRML_MUSTINLINE void PRF_4a_440(Eurydice_slice input, uint8_t ret[128U])
{
  PRF_a6(input, ret);
}
...
- K= 4
*/
static libcrux_ml_kem_polynomial_PolynomialRingElement_1d call_mut_a8_d0(void **_)
{
  return ZERO_d6_ea();
}
...
)
{
  KRML_MAYBE_FOR16(i,
    ...
    zeta_i[0U] = zeta_i[0U] - (size_t)1U;
    re->coefficients[round] =
      libcrux_ml_kem_vector_portable_inv_ntt_layer_1_step_b8(re->coefficients[round],
        libcrux_ml_kem_polynomial_zeta(zeta_i[0U]),
        libcrux_ml_kem_polynomial_zeta(zeta_i[0U] - (size_t)1U),
        libcrux_ml_kem_polynomial_zeta(zeta_i[0U] - (size_t)2U),
        libcrux_ml_kem_polynomial_zeta(zeta_i[0U] - (size_t)3U));
...
)
{
  KRML_MAYBE_FOR16(i,
    ...
    zeta_i[0U] = zeta_i[0U] - (size_t)1U;
    re->coefficients[round] =
      libcrux_ml_kem_vector_portable_inv_ntt_layer_2_step_b8(re->coefficients[round],
        libcrux_ml_kem_polynomial_zeta(zeta_i[0U]),
        libcrux_ml_kem_polynomial_zeta(zeta_i[0U] - (size_t)1U));
    zeta_i[0U] = zeta_i[0U] - (size_t)1U;);
}
...
)
{
  KRML_MAYBE_FOR16(i,
    ...
    libcrux_ml_kem_vector_portable_vector_type_PortableVector
    uu____0 =
      libcrux_ml_kem_vector_portable_inv_ntt_layer_3_step_b8(re->coefficients[round],
        libcrux_ml_kem_polynomial_zeta(zeta_i[0U]));
    re->coefficients[round] = uu____0;);
}
...
{
  libcrux_ml_kem_vector_portable_vector_type_PortableVector
  a_minus_b = libcrux_ml_kem_vector_portable_sub_b8(b, &a);
  a =
...
*/
static KRML_MUSTINLINE void
invert_ntt_montgomery_d0(libcrux_ml_kem_polynomial_PolynomialRingElement_1d *re)
{
...
)
{
  for (size_t i = (size_t)0U; i < LIBCRUX_ML_KEM_POLYNOMIAL_VECTORS_IN_RING_ELEMENT; i++)
  {
    ...
    coefficient_normal_form =
      libcrux_ml_kem_vector_portable_montgomery_multiply_by_constant_b8(myself->coefficients[j],
        (int16_t)1441);
    libcrux_ml_kem_vector_portable_vector_type_PortableVector
    sum = libcrux_ml_kem_vector_portable_add_b8(coefficient_normal_form, &error->coefficients[j]);
    libcrux_ml_kem_vector_portable_vector_type_PortableVector
...
)
{
    ...
    i0++)
  {
      ...
      i++)
    {
      ...
      libcrux_ml_kem_polynomial_PolynomialRingElement_1d
      product = ntt_multiply_d6_ea(a_element, &r_as_ntt[j]);
      add_to_ring_element_d6_d0(&result[i1], &product);
    }
    invert_ntt_montgomery_d0(&result[i1]);
    add_error_reduce_d6_ea(&result[i1], &error_1[i1]);
  }
  memcpy(ret, result, (size_t)4U * sizeof (libcrux_ml_kem_polynomial_PolynomialRingElement_1d));
}
...
compress_b8_ef(libcrux_ml_kem_vector_portable_vector_type_PortableVector a)
{
...
*/
static libcrux_ml_kem_vector_portable_vector_type_PortableVector
compress_b8_c4(libcrux_ml_kem_vector_portable_vector_type_PortableVector a)
{
...
)
{
  ...
  for (size_t i = (size_t)0U; i < LIBCRUX_ML_KEM_POLYNOMIAL_VECTORS_IN_RING_ELEMENT; i++)
  {
    ...
    libcrux_ml_kem_vector_portable_vector_type_PortableVector
    coefficient =
      compress_b8_c4(libcrux_ml_kem_vector_portable_to_unsigned_representative_b8(re->coefficients[i0]));
    uint8_t bytes[22U];
...
- ETA2_RANDOMNESS_SIZE= 128
*/
static KRML_MUSTINLINE tuple_080
encrypt_c1_85(
...
)
{
  ...
  PRF_4a_440(Eurydice_array_to_slice((size_t)33U, prf_input, uint8_t), prf_output);
  libcrux_ml_kem_polynomial_PolynomialRingElement_1d
  error_2 =
    sample_from_binomial_distribution_a0(Eurydice_array_to_slice((size_t)128U, prf_output, uint8_t));
  libcrux_ml_kem_polynomial_PolynomialRingElement_1d u[4U];
  compute_vector_u_d0(matrix, r_as_ntt, error_1, u);
  libcrux_ml_kem_polynomial_PolynomialRingElement_1d uu____0[4U];
  memcpy(uu____0, u, (size_t)4U * sizeof (libcrux_ml_kem_polynomial_PolynomialRingElement_1d));
...
)
{
  for (size_t i = (size_t)0U; i < LIBCRUX_ML_KEM_POLYNOMIAL_VECTORS_IN_RING_ELEMENT; i++)
  {
    ...
    libcrux_ml_kem_vector_portable_vector_type_PortableVector
    coefficient_normal_form =
      libcrux_ml_kem_vector_portable_montgomery_multiply_by_constant_b8(result.coefficients[i0],
        (int16_t)1441);
    libcrux_ml_kem_vector_portable_vector_type_PortableVector
    sum1 =
      libcrux_ml_kem_vector_portable_add_b8(myself->coefficients[i0],
    ...
    libcrux_ml_kem_vector_portable_vector_type_PortableVector
    sum2 = libcrux_ml_kem_vector_portable_add_b8(coefficient_normal_form, &sum1);
    libcrux_ml_kem_vector_portable_vector_type_PortableVector
    red = libcrux_ml_kem_vector_portable_barrett_reduce_b8(sum2);
...
)
{
  ...
  KRML_MAYBE_FOR4(i,
    ...
    size_t i0 = i;
    libcrux_ml_kem_polynomial_PolynomialRingElement_1d
    product = ntt_multiply_d6_ea(&t_as_ntt[i0], &r_as_ntt[i0]);
...
*/
static libcrux_ml_kem_vector_portable_vector_type_PortableVector
compress_b8_d1(libcrux_ml_kem_vector_portable_vector_type_PortableVector a)
{
...
)
{
  for (size_t i = (size_t)0U; i < LIBCRUX_ML_KEM_POLYNOMIAL_VECTORS_IN_RING_ELEMENT; i++)
  {
    size_t i0 = i;
    libcrux_ml_kem_vector_portable_vector_type_PortableVector
    coefficient = compress_b8_d1(to_unsigned_field_modulus_ea(re.coefficients[i0]));
    uint8_t bytes[8U];
...
*/
static libcrux_ml_kem_vector_portable_vector_type_PortableVector
compress_b8_f4(libcrux_ml_kem_vector_portable_vector_type_PortableVector a)
{
...
)
{
  for (size_t i = (size_t)0U; i < LIBCRUX_ML_KEM_POLYNOMIAL_VECTORS_IN_RING_ELEMENT; i++)
  {
    ...
    libcrux_ml_kem_vector_portable_vector_type_PortableVector
    coefficients =
      compress_b8_f4(libcrux_ml_kem_vector_portable_to_unsigned_representative_b8(re.coefficients[i0]));
    uint8_t bytes[10U];
...
{
  libcrux_ml_kem_polynomial_PolynomialRingElement_1d
  message_as_ring_element = deserialize_then_decompress_message_ea(message);
  libcrux_ml_kem_polynomial_PolynomialRingElement_1d
...
)
{
  ...
  libcrux_ml_kem_polynomial_PolynomialRingElement_1d *uu____1 = public_key->t_as_ntt;
...
{
  IndCpaPublicKeyUnpacked_af unpacked_public_key = build_unpacked_public_key_3f1(public_key);
  uint8_t ret0[1568U];
...
- CIPHERTEXT_SIZE= 1568
*/
static KRML_MUSTINLINE void kdf_39_60(Eurydice_slice shared_secret, uint8_t ret[32U])
{
  uint8_t out[32U] = { 0U };
...
- V_COMPRESSION_FACTOR= 5
*/
static libcrux_ml_kem_polynomial_PolynomialRingElement_1d call_mut_0b_7d(void **_)
{
  return ZERO_d6_ea();
}
  ...
  for (size_t i = (size_t)0U; i < Eurydice_slice_len(serialized, uint8_t) / (size_t)24U; i++)
  {
    ...
    bytes =
      Eurydice_slice_subslice3(serialized,
        ...
        uint8_t *);
    libcrux_ml_kem_vector_portable_vector_type_PortableVector
    uu____0 = libcrux_ml_kem_vector_portable_deserialize_12_b8(bytes);
    re.coefficients[i0] = uu____0;
  }
  return re;
}
...
- U_COMPRESSION_FACTOR= 11
*/
static libcrux_ml_kem_polynomial_PolynomialRingElement_1d call_mut_35_00(void **_)
{
  return ZERO_d6_ea();
}
  ...
  for (size_t i = (size_t)0U; i < Eurydice_slice_len(serialized, uint8_t) / (size_t)20U; i++)
  {
    ...
    bytes =
      Eurydice_slice_subslice3(serialized,
        ...
        uint8_t *);
    libcrux_ml_kem_vector_portable_vector_type_PortableVector
    coefficient = libcrux_ml_kem_vector_portable_deserialize_10_b8(bytes);
    libcrux_ml_kem_vector_portable_vector_type_PortableVector
    uu____0 = decompress_ciphertext_coefficient_b8_ef(coefficient);
    re.coefficients[i0] = uu____0;
  }
  return re;
}
  ...
  for (size_t i = (size_t)0U; i < Eurydice_slice_len(serialized, uint8_t) / (size_t)22U; i++)
  {
    ...
    bytes =
      Eurydice_slice_subslice3(serialized,
        ...
        uint8_t *);
    libcrux_ml_kem_vector_portable_vector_type_PortableVector
    coefficient = libcrux_ml_kem_vector_portable_deserialize_11_b8(bytes);
    libcrux_ml_kem_vector_portable_vector_type_PortableVector
    uu____0 = decompress_ciphertext_coefficient_b8_c4(coefficient);
    re.coefficients[i0] = uu____0;
  }
  return re;
}
...
*/
static KRML_MUSTINLINE void
ntt_vector_u_5e(libcrux_ml_kem_polynomial_PolynomialRingElement_1d *re)
{
  ...
  for (size_t i = (size_t)0U; i < Eurydice_slice_len(serialized, uint8_t) / (size_t)8U; i++)
  {
    ...
    bytes =
      Eurydice_slice_subslice3(serialized,
        ...
        uint8_t *);
    libcrux_ml_kem_vector_portable_vector_type_PortableVector
    coefficient = libcrux_ml_kem_vector_portable_deserialize_4_b8(bytes);
    libcrux_ml_kem_vector_portable_vector_type_PortableVector
    uu____0 = decompress_ciphertext_coefficient_b8_d1(coefficient);
    re.coefficients[i0] = uu____0;
  }
  return re;
}
  ...
  for (size_t i = (size_t)0U; i < Eurydice_slice_len(serialized, uint8_t) / (size_t)10U; i++)
  {
    ...
    bytes =
      Eurydice_slice_subslice3(serialized,
        ...
        uint8_t *);
    re.coefficients[i0] = libcrux_ml_kem_vector_portable_deserialize_5_b8(bytes);
    libcrux_ml_kem_vector_portable_vector_type_PortableVector
    uu____1 = decompress_ciphertext_coefficient_b8_f4(re.coefficients[i0]);
...
)
{
  for (size_t i = (size_t)0U; i < LIBCRUX_ML_KEM_POLYNOMIAL_VECTORS_IN_RING_ELEMENT; i++)
  {
    ...
    libcrux_ml_kem_vector_portable_vector_type_PortableVector
    coefficient_normal_form =
      libcrux_ml_kem_vector_portable_montgomery_multiply_by_constant_b8(b.coefficients[i0],
        (int16_t)1441);
    libcrux_ml_kem_vector_portable_vector_type_PortableVector
    diff =
      libcrux_ml_kem_vector_portable_sub_b8(myself->coefficients[i0],
        &coefficient_normal_form);
    libcrux_ml_kem_vector_portable_vector_type_PortableVector
    red = libcrux_ml_kem_vector_portable_barrett_reduce_b8(diff);
...
)
{
  ...
  KRML_MAYBE_FOR4(i,
    ...
    size_t i0 = i;
    libcrux_ml_kem_polynomial_PolynomialRingElement_1d
    product = ntt_multiply_d6_ea(&secret_as_ntt[i0], &u_as_ntt[i0]);
    add_to_ring_element_d6_d0(&result, &product););
  invert_ntt_montgomery_d0(&result);
...
)
{
  ...
  KRML_MAYBE_FOR16(i,
    ...
    uint8_t bytes[2U];
    libcrux_ml_kem_vector_portable_serialize_1_b8(coefficient_compressed, bytes);
    Eurydice_slice_copy(Eurydice_array_to_subslice3(serialized,
        (size_t)2U * i0,
        (size_t)2U * i0 + (size_t)2U,
        uint8_t *),
...
static KRML_MUSTINLINE void
decrypt_unpacked_7d(
  IndCpaPrivateKeyUnpacked_af *secret_key,
  uint8_t *ciphertext,
  uint8_t ret[32U]
)
{
  ...
  v =
    deserialize_then_decompress_ring_element_v_ff(Eurydice_array_to_subslice_from((size_t)1568U,
        ...
        Eurydice_derefed_slice));
  libcrux_ml_kem_polynomial_PolynomialRingElement_1d
  message = compute_message_d0(&v, secret_key->secret_as_ntt, u_as_ntt);
  uint8_t ret0[32U];
...
*/
static KRML_MUSTINLINE void
decrypt_7d(Eurydice_slice secret_key, uint8_t *ciphertext, uint8_t ret[32U])
{
...
)
{
  ...
  encrypt_2a1(ind_cpa_public_key, decrypted, pseudorandomness, expected_ciphertext);
...
- K= 2
*/
static libcrux_ml_kem_polynomial_PolynomialRingElement_1d call_mut_0b_a0(void **_)
{
  return ZERO_d6_ea();
}
...
)
{
  ...
  KRML_MAYBE_FOR2(i,
    ...
    /* original Rust expression is not an lvalue in C */
    void *lvalue = (void *)0U;
    deserialized_pk[i] = call_mut_0b_a0(&lvalue););
...
- K= 2
*/
static KRML_MUSTINLINE void H_4a_fd(Eurydice_slice input, uint8_t ret[32U])
{
  libcrux_ml_kem_hash_functions_portable_H(input, ret);
}
...
*/
bool
libcrux_ml_kem_ind_cca_validate_private_key_only_30(
  libcrux_ml_kem_types_MlKemPrivateKey_fa *private_key
)
{
  uint8_t t[32U];
  H_4a_fd(Eurydice_array_to_subslice3(private_key->value,
...
- K= 2
*/
static IndCpaPrivateKeyUnpacked_d4 default_70_a0(void)
{
...
- K= 2
*/
static IndCpaPublicKeyUnpacked_d4 default_8b_a0(void)
{
  libcrux_ml_kem_polynomial_PolynomialRingElement_1d uu____0[2U];
  KRML_MAYBE_FOR2(i, (size_t)0U, (size_t)2U, (size_t)1U, uu____0[i] = ZERO_d6_ea(););
  uint8_t uu____1[32U] = { 0U };
  ...
  memcpy(lit.A,
    repeat_expression0,
    (size_t)2U * sizeof (libcrux_ml_kem_polynomial_PolynomialRingElement_1d [2U]));
  return lit;
}
...
- K= 2
*/
static KRML_MUSTINLINE void G_4a_fd(Eurydice_slice input, uint8_t ret[64U])
{
  libcrux_ml_kem_hash_functions_portable_G(input, ret);
}
...
*/
static KRML_MUSTINLINE void
cpa_keygen_seed_39_10(Eurydice_slice key_generation_seed, uint8_t ret[64U])
{
  uint8_t seed[33U] = { 0U };
  Eurydice_slice_copy(Eurydice_array_to_subslice3(seed,
      (size_t)0U,
  ...
  uint8_t ret0[64U];
  G_4a_fd(Eurydice_array_to_slice((size_t)33U, seed, uint8_t), ret0);
  memcpy(ret, ret0, (size_t)64U * sizeof (uint8_t));
}
...
- K= 2
*/
static KRML_MUSTINLINE PortableHash_cf shake128_init_absorb_final_fd(uint8_t (*input)[34U])
{
  PortableHash_cf shake128_state;
  libcrux_sha3_generic_keccak_KeccakState_17 repeat_expression[2U];
  KRML_MAYBE_FOR2(i,
    (size_t)0U,
    (size_t)2U,
    (size_t)1U,
...
- K= 2
*/
static KRML_MUSTINLINE PortableHash_cf shake128_init_absorb_final_4a_fd(uint8_t (*input)[34U])
{
...
*/
static KRML_MUSTINLINE void
shake128_squeeze_first_three_blocks_fd(PortableHash_cf *st, uint8_t ret[2U][504U])
{
...
*/
static KRML_MUSTINLINE void
shake128_squeeze_first_three_blocks_4a_fd(PortableHash_cf *self, uint8_t ret[2U][504U])
{
...
*/
static KRML_MUSTINLINE void
shake128_squeeze_next_block_fd(PortableHash_cf *st, uint8_t ret[2U][168U])
{
...
*/
static KRML_MUSTINLINE void
shake128_squeeze_next_block_4a_fd(PortableHash_cf *self, uint8_t ret[2U][168U])
{
...
*/
static libcrux_ml_kem_polynomial_PolynomialRingElement_1d
call_mut_af_2b0(int16_t tupled_args[272U])
{
  int16_t s[272U];
  memcpy(s, tupled_args, (size_t)272U * sizeof (int16_t));
  return
...
)
{
  ...
  PortableHash_cf xof_state = shake128_init_absorb_final_4a_fd(seeds);
  uint8_t randomness0[2U][504U];
  shake128_squeeze_first_three_blocks_4a_fd(&xof_state, randomness0);
  bool done = sample_from_uniform_distribution_next_64(randomness0, sampled_coefficients, out);
  while (true)
  {
    if (done)
    {
    ...
    else
    {
      ...
      shake128_squeeze_next_block_4a_fd(&xof_state, randomness);
  ...
  KRML_MAYBE_FOR2(i,
    ...
    (size_t)2U,
    (size_t)1U,
    ret0[i] = call_mut_af_2b0(copy_of_out[i]););
  memcpy(ret, ret0, (size_t)2U * sizeof (libcrux_ml_kem_polynomial_PolynomialRingElement_1d));
}
...
static KRML_MUSTINLINE void PRFxN_49(uint8_t (*input)[33U], uint8_t ret[2U][192U])
{
  ...
  KRML_MAYBE_FOR2(i,
    ...
    (size_t)1U,
    size_t i0 = i;
    libcrux_sha3_portable_shake256(Eurydice_array_to_slice((size_t)192U, out[i0], uint8_t),
      Eurydice_array_to_slice((size_t)33U, input[i0], uint8_t)););
...
- LEN= 192
*/
static KRML_MUSTINLINE void PRFxN_4a_49(uint8_t (*input)[33U], uint8_t ret[2U][192U])
{
  PRFxN_49(input, ret);
}
...
)
{
  ...
  PRFxN_4a_49(prf_inputs, prf_outputs);
  KRML_MAYBE_FOR2(i,
    (size_t)0U,
    (size_t)2U,
    (size_t)1U,
...
*/
static libcrux_ml_kem_polynomial_PolynomialRingElement_1d call_mut_73_1c0(void **_)
{
  return ZERO_d6_ea();
}
...
{
  uint8_t hashed[64U];
  cpa_keygen_seed_39_10(key_generation_seed, hashed);
  Eurydice_slice_uint8_t_x2
  uu____0 =
    Eurydice_slice_split_at(Eurydice_array_to_slice((size_t)64U, hashed, uint8_t),
      (size_t)32U,
  ...
  Eurydice_slice seed_for_A = uu____0.fst;
  Eurydice_slice seed_for_secret_and_error = uu____0.snd;
  libcrux_ml_kem_polynomial_PolynomialRingElement_1d (*uu____1)[2U] = public_key->A;
  uint8_t ret[34U];
  libcrux_ml_kem_utils_into_padded_array_b6(seed_for_A, ret);
  ...
  libcrux_ml_kem_utils_into_padded_array_c8(seed_for_secret_and_error, prf_input);
  uint8_t
  domain_separator = sample_vector_cbd_then_ntt_3b0(private_key->secret_as_ntt, prf_input, 0U);
  ...
  LowStar_Ignore_ignore(sample_vector_cbd_then_ntt_3b0(error_as_ntt, prf_input, domain_separator),
    uint8_t,
    void *);
  compute_As_plus_e_a0(public_key->t_as_ntt,
    public_key->A,
    private_key->secret_as_ntt,
    error_as_ntt);
  uint8_t uu____2[32U];
...
)
{
  ...
  serialize_vector_a0(private_key->secret_as_ntt,
...
{
  IndCpaPrivateKeyUnpacked_d4 private_key = default_70_a0();
  IndCpaPublicKeyUnpacked_d4 public_key = default_8b_a0();
...
*/
static KRML_MUSTINLINE void
serialize_kem_secret_key_mut_30(
  Eurydice_slice private_key,
  Eurydice_slice public_key,
  Eurydice_slice implicit_rejection_value,
  uint8_t *serialized
...
)
{
  ...
  serialize_kem_secret_key_mut_30(private_key, public_key, implicit_rejection_value, out);
...
libcrux_ml_kem_ind_cca_generate_keypair_150(uint8_t *randomness)
{
  ...
  serialize_kem_secret_key_30(Eurydice_array_to_slice((size_t)768U, ind_cpa_private_key, uint8_t),
...
*/
static KRML_MUSTINLINE void
entropy_preprocess_39_10(Eurydice_slice randomness, uint8_t ret[32U])
{
  uint8_t out[32U] = { 0U };
  Eurydice_slice_copy(Eurydice_array_to_slice((size_t)32U, out, uint8_t), randomness, uint8_t);
  memcpy(ret, out, (size_t)32U * sizeof (uint8_t));
...
)
{
  ...
  seed =
    Eurydice_slice_subslice_from(public_key,
      ...
      size_t,
      Eurydice_derefed_slice);
  libcrux_ml_kem_polynomial_PolynomialRingElement_1d (*uu____1)[2U] = unpacked_public_key->A;
  uint8_t ret[34U];
  libcrux_ml_kem_utils_into_padded_array_b6(seed, ret);
...
{
  IndCpaPublicKeyUnpacked_d4 unpacked_public_key = default_8b_a0();
...
/**
A monomorphic instance of K.
with types libcrux_ml_kem_polynomial_PolynomialRingElement libcrux_ml_kem_vector_portable_vector_type_PortableVector[2size_t], libcrux_ml_kem_polynomial_PolynomialRingElement libcrux_ml_kem_vector_portable_vector_type_PortableVector

*/
typedef struct tuple_350_s
{
...
- ETA2_RANDOMNESS_SIZE= 128
*/
static libcrux_ml_kem_polynomial_PolynomialRingElement_1d call_mut_f1_850(void **_)
{
  return ZERO_d6_ea();
}
...
- ETA2_RANDOMNESS_SIZE= 128
*/
static libcrux_ml_kem_polynomial_PolynomialRingElement_1d call_mut_dd_850(void **_)
{
  return ZERO_d6_ea();
}
...
- LEN= 128
*/
static KRML_MUSTINLINE void PRFxN_4a_490(uint8_t (*input)[33U], uint8_t ret[2U][128U])
{
  PRFxN_490(input, ret);
}
...
)
{
  ...
  PRFxN_4a_490(prf_inputs, prf_outputs);
  KRML_MAYBE_FOR2(i,
    (size_t)0U,
    (size_t)2U,
    (size_t)1U,
...
- LEN= 128
*/
static KRML_MUSTINLINE void PRF_4a_490(Eurydice_slice input, uint8_t ret[128U])
{
  PRF_a6(input, ret);
}
...
- K= 2
*/
static libcrux_ml_kem_polynomial_PolynomialRingElement_1d call_mut_a8_a0(void **_)
{
  return ZERO_d6_ea();
}
...
*/
static KRML_MUSTINLINE void
invert_ntt_montgomery_a0(libcrux_ml_kem_polynomial_PolynomialRingElement_1d *re)
{
  size_t zeta_i = LIBCRUX_ML_KEM_CONSTANTS_COEFFICIENTS_IN_RING_ELEMENT / (size_t)2U;
  invert_ntt_at_layer_1_ea(&zeta_i, re);
  invert_ntt_at_layer_2_ea(&zeta_i, re);
...
)
{
  ...
  KRML_MAYBE_FOR2(i,
    ...
    /* original Rust expression is not an lvalue in C */
    void *lvalue = (void *)0U;
    result[i] = call_mut_a8_a0(&lvalue););
  for
  (size_t
    i0 = (size_t)0U;
    i0 <
  ...
  memcpy(ret, result, (size_t)2U * sizeof (libcrux_ml_kem_polynomial_PolynomialRingElement_1d));
}
...
)
{
  ...
  for (size_t i = (size_t)0U; i < LIBCRUX_ML_KEM_POLYNOMIAL_VECTORS_IN_RING_ELEMENT; i++)
  {
    size_t i0 = i;
    libcrux_ml_kem_vector_portable_vector_type_PortableVector
    coefficient = compress_b8_ef(to_unsigned_field_modulus_ea(re->coefficients[i0]));
    uint8_t bytes[20U];
...
- ETA2_RANDOMNESS_SIZE= 128
*/
static KRML_MUSTINLINE tuple_350
encrypt_c1_850(
  Eurydice_slice randomness,
  libcrux_ml_kem_polynomial_PolynomialRingElement_1d (*matrix)[2U],
  Eurydice_slice ciphertext
)
{
  uint8_t prf_input[33U];
  ...
  uint8_t domain_separator = sample_ring_element_cbd_3b0(prf_input, domain_separator0, error_1);
  prf_input[32U] = domain_separator;
  uint8_t prf_output[128U];
  PRF_4a_490(Eurydice_array_to_slice((size_t)33U, prf_input, uint8_t), prf_output);
  libcrux_ml_kem_polynomial_PolynomialRingElement_1d
  error_2 =
    sample_from_binomial_distribution_a0(Eurydice_array_to_slice((size_t)128U, prf_output, uint8_t));
  libcrux_ml_kem_polynomial_PolynomialRingElement_1d u[2U];
  compute_vector_u_a0(matrix, r_as_ntt, error_1, u);
  libcrux_ml_kem_polynomial_PolynomialRingElement_1d uu____0[2U];
  memcpy(uu____0, u, (size_t)2U * sizeof (libcrux_ml_kem_polynomial_PolynomialRingElement_1d));
  compress_then_serialize_u_6d(uu____0, ciphertext);
  /* Passing arrays by value in Rust generates a copy in C */
  libcrux_ml_kem_polynomial_PolynomialRingElement_1d copy_of_r_as_ntt[2U];
  memcpy(copy_of_r_as_ntt,
    r_as_ntt,
    (size_t)2U * sizeof (libcrux_ml_kem_polynomial_PolynomialRingElement_1d));
  tuple_350 lit;
...
{
  IndCpaPublicKeyUnpacked_d4 unpacked_public_key = build_unpacked_public_key_3f0(public_key);
  uint8_t ret0[768U];
...
- CIPHERTEXT_SIZE= 768
*/
static KRML_MUSTINLINE void kdf_39_30(Eurydice_slice shared_secret, uint8_t ret[32U])
{
  uint8_t out[32U] = { 0U };
  Eurydice_slice_copy(Eurydice_array_to_slice((size_t)32U, out, uint8_t),
    shared_secret,
...
)
{
  ...
  Eurydice_slice_copy(uu____0, Eurydice_array_to_slice((size_t)32U, ret0, uint8_t), uint8_t);
  uint8_t hashed[64U];
  G_4a_fd(Eurydice_array_to_slice((size_t)64U, to_hash, uint8_t), hashed);
  Eurydice_slice_uint8_t_x2
  uu____1 =
    Eurydice_slice_split_at(Eurydice_array_to_slice((size_t)64U, hashed, uint8_t),
      LIBCRUX_ML_KEM_CONSTANTS_SHARED_SECRET_SIZE,
...
- V_COMPRESSION_FACTOR= 4
*/
static libcrux_ml_kem_polynomial_PolynomialRingElement_1d call_mut_0b_d1(void **_)
{
  return ZERO_d6_ea();
}
...
- U_COMPRESSION_FACTOR= 10
*/
static libcrux_ml_kem_polynomial_PolynomialRingElement_1d call_mut_35_86(void **_)
{
  return ZERO_d6_ea();
}
...
*/
static KRML_MUSTINLINE void
ntt_vector_u_0a(libcrux_ml_kem_polynomial_PolynomialRingElement_1d *re)
{
  size_t zeta_i = (size_t)0U;
  ntt_at_layer_4_plus_ea(&zeta_i, re, (size_t)7U);
  ntt_at_layer_4_plus_ea(&zeta_i, re, (size_t)6U);
...
)
{
  ...
  KRML_MAYBE_FOR2(i,
    ...
    /* original Rust expression is not an lvalue in C */
    void *lvalue = (void *)0U;
    u_as_ntt[i] = call_mut_35_86(&lvalue););
  for
  (size_t
    i = (size_t)0U;
    i <
...
static KRML_MUSTINLINE void
decrypt_unpacked_d1(
  IndCpaPrivateKeyUnpacked_d4 *secret_key,
  uint8_t *ciphertext,
  uint8_t ret[32U]
)
{
  ...
  v =
    deserialize_then_decompress_ring_element_v_64(Eurydice_array_to_subslice_from((size_t)768U,
        ...
        Eurydice_derefed_slice));
  libcrux_ml_kem_polynomial_PolynomialRingElement_1d
  message = compute_message_a0(&v, secret_key->secret_as_ntt, u_as_ntt);
  uint8_t ret0[32U];
  compress_then_serialize_message_ea(message, ret0);
  memcpy(ret, ret0, (size_t)32U * sizeof (uint8_t));
}
...
*/
static KRML_MUSTINLINE void
decrypt_d1(Eurydice_slice secret_key, uint8_t *ciphertext, uint8_t ret[32U])
{
  ...
  KRML_MAYBE_FOR2(i,
    ...
    /* original Rust expression is not an lvalue in C */
    void *lvalue = (void *)0U;
    ret0[i] = call_mut_0b_d1(&lvalue););
  memcpy(secret_key_unpacked.secret_as_ntt,
    ret0,
    (size_t)2U * sizeof (libcrux_ml_kem_polynomial_PolynomialRingElement_1d));
  deserialize_vector_a0(secret_key, secret_key_unpacked.secret_as_ntt);
  uint8_t ret1[32U];
  decrypt_unpacked_d1(&secret_key_unpacked, ciphertext, ret1);
  memcpy(ret, ret1, (size_t)32U * sizeof (uint8_t));
}
...
- LEN= 32
*/
static KRML_MUSTINLINE void PRF_4a_49(Eurydice_slice input, uint8_t ret[32U])
{
  PRF_9e(input, ret);
}
...
)
{
  ...
  Eurydice_slice_copy(Eurydice_array_to_subslice_from((size_t)64U,
    ...
    uint8_t);
  uint8_t hashed[64U];
  G_4a_fd(Eurydice_array_to_slice((size_t)64U, to_hash0, uint8_t), hashed);
  Eurydice_slice_uint8_t_x2
  uu____1 =
    Eurydice_slice_split_at(Eurydice_array_to_slice((size_t)64U, hashed, uint8_t),
      LIBCRUX_ML_KEM_CONSTANTS_SHARED_SECRET_SIZE,
  ...
  encrypt_2a0(ind_cpa_public_key, decrypted, pseudorandomness, expected_ciphertext);
  uint8_t implicit_rejection_shared_secret[32U];
  kdf_39_30(Eurydice_array_to_slice((size_t)32U, implicit_rejection_shared_secret0, uint8_t),
    implicit_rejection_shared_secret);
  uint8_t shared_secret[32U];
  kdf_39_30(shared_secret0, shared_secret);
  uint8_t ret0[32U];
...
- K= 3
*/
static libcrux_ml_kem_polynomial_PolynomialRingElement_1d call_mut_0b_1b(void **_)
{
  return ZERO_d6_ea();
}
...
{
  uint8_t t[32U];
  H_4a_e0(Eurydice_array_to_subslice3(private_key->value,
...
- K= 3
*/
static IndCpaPrivateKeyUnpacked_a0 default_70_1b(void)
{
...
- K= 3
*/
static IndCpaPublicKeyUnpacked_a0 default_8b_1b(void)
{
  libcrux_ml_kem_polynomial_PolynomialRingElement_1d uu____0[3U];
  KRML_MAYBE_FOR3(i, (size_t)0U, (size_t)3U, (size_t)1U, uu____0[i] = ZERO_d6_ea(););
  uint8_t uu____1[32U] = { 0U };
  ...
  memcpy(lit.A,
    repeat_expression0,
    (size_t)3U * sizeof (libcrux_ml_kem_polynomial_PolynomialRingElement_1d [3U]));
  return lit;
}
...
*/
static KRML_MUSTINLINE void
cpa_keygen_seed_39_9c(Eurydice_slice key_generation_seed, uint8_t ret[64U])
{
  uint8_t seed[33U] = { 0U };
  Eurydice_slice_copy(Eurydice_array_to_subslice3(seed,
      (size_t)0U,
...
- K= 3
*/
static KRML_MUSTINLINE PortableHash_88 shake128_init_absorb_final_e0(uint8_t (*input)[34U])
{
...
- K= 3
*/
static KRML_MUSTINLINE PortableHash_88 shake128_init_absorb_final_4a_e0(uint8_t (*input)[34U])
{
...
*/
static KRML_MUSTINLINE void
shake128_squeeze_first_three_blocks_e0(PortableHash_88 *st, uint8_t ret[3U][504U])
{
...
*/
static KRML_MUSTINLINE void
shake128_squeeze_first_three_blocks_4a_e0(PortableHash_88 *self, uint8_t ret[3U][504U])
{
...
*/
static KRML_MUSTINLINE void
shake128_squeeze_next_block_e0(PortableHash_88 *st, uint8_t ret[3U][168U])
{
...
*/
static KRML_MUSTINLINE void
shake128_squeeze_next_block_4a_e0(PortableHash_88 *self, uint8_t ret[3U][168U])
{
...
*/
static libcrux_ml_kem_polynomial_PolynomialRingElement_1d
call_mut_af_2b1(int16_t tupled_args[272U])
{
  int16_t s[272U];
  memcpy(s, tupled_args, (size_t)272U * sizeof (int16_t));
  return
...
)
{
  ...
  bool done = sample_from_uniform_distribution_next_89(randomness0, sampled_coefficients, out);
  while (true)
  {
    if (done)
    {
  ...
  KRML_MAYBE_FOR3(i,
    ...
    (size_t)3U,
    (size_t)1U,
    ret0[i] = call_mut_af_2b1(copy_of_out[i]););
  memcpy(ret, ret0, (size_t)3U * sizeof (libcrux_ml_kem_polynomial_PolynomialRingElement_1d));
}
...
)
{
  KRML_MAYBE_FOR3(i0,
    ...
    sample_from_xof_2b1(seeds, sampled);
    for
    (size_t
      i = (size_t)0U;
      i <
...
- LEN= 128
*/
static KRML_MUSTINLINE void PRFxN_4a_41(uint8_t (*input)[33U], uint8_t ret[3U][128U])
{
  PRFxN_41(input, ret);
}
...
- ETA1_RANDOMNESS_SIZE= 128
*/
static libcrux_ml_kem_polynomial_PolynomialRingElement_1d call_mut_73_1c1(void **_)
{
  return ZERO_d6_ea();
}
...
)
{
  ...
  Eurydice_slice seed_for_A = uu____0.fst;
  Eurydice_slice seed_for_secret_and_error = uu____0.snd;
  libcrux_ml_kem_polynomial_PolynomialRingElement_1d (*uu____1)[3U] = public_key->A;
  uint8_t ret[34U];
  libcrux_ml_kem_utils_into_padded_array_b6(seed_for_A, ret);
  ...
  libcrux_ml_kem_utils_into_padded_array_c8(seed_for_secret_and_error, prf_input);
  uint8_t
  domain_separator = sample_vector_cbd_then_ntt_3b1(private_key->secret_as_ntt, prf_input, 0U);
  ...
  KRML_MAYBE_FOR3(i,
    ...
    /* original Rust expression is not an lvalue in C */
    void *lvalue = (void *)0U;
    error_as_ntt[i] = call_mut_73_1c1(&lvalue););
  LowStar_Ignore_ignore(sample_vector_cbd_then_ntt_3b1(error_as_ntt, prf_input, domain_separator),
    uint8_t,
    void *);
  compute_As_plus_e_1b(public_key->t_as_ntt,
    public_key->A,
    private_key->secret_as_ntt,
    error_as_ntt);
  uint8_t uu____2[32U];
...
)
{
  ...
  serialize_vector_1b(private_key->secret_as_ntt,
...
)
{
  ...
  serialize_kem_secret_key_mut_d6(private_key, public_key, implicit_rejection_value, out);
...
*/
static KRML_MUSTINLINE void
entropy_preprocess_39_9c(Eurydice_slice randomness, uint8_t ret[32U])
{
  uint8_t out[32U] = { 0U };
  Eurydice_slice_copy(Eurydice_array_to_slice((size_t)32U, out, uint8_t), randomness, uint8_t);
  memcpy(ret, out, (size_t)32U * sizeof (uint8_t));
...
)
{
  ...
  seed =
    Eurydice_slice_subslice_from(public_key,
      ...
      size_t,
      Eurydice_derefed_slice);
  libcrux_ml_kem_polynomial_PolynomialRingElement_1d (*uu____1)[3U] = unpacked_public_key->A;
  uint8_t ret[34U];
  libcrux_ml_kem_utils_into_padded_array_b6(seed, ret);
...
/**
A monomorphic instance of K.
with types libcrux_ml_kem_polynomial_PolynomialRingElement libcrux_ml_kem_vector_portable_vector_type_PortableVector[3size_t], libcrux_ml_kem_polynomial_PolynomialRingElement libcrux_ml_kem_vector_portable_vector_type_PortableVector

*/
typedef struct tuple_ed0_s
{
...
- ETA2_RANDOMNESS_SIZE= 128
*/
static libcrux_ml_kem_polynomial_PolynomialRingElement_1d call_mut_f1_851(void **_)
{
  return ZERO_d6_ea();
}
...
- ETA2_RANDOMNESS_SIZE= 128
*/
static libcrux_ml_kem_polynomial_PolynomialRingElement_1d call_mut_dd_851(void **_)
{
  return ZERO_d6_ea();
}
...
- LEN= 128
*/
static KRML_MUSTINLINE void PRF_4a_410(Eurydice_slice input, uint8_t ret[128U])
{
  PRF_a6(input, ret);
}
...
- K= 3
*/
static libcrux_ml_kem_polynomial_PolynomialRingElement_1d call_mut_a8_1b(void **_)
{
  return ZERO_d6_ea();
}
...
*/
static KRML_MUSTINLINE void
invert_ntt_montgomery_1b(libcrux_ml_kem_polynomial_PolynomialRingElement_1d *re)
{
  size_t zeta_i = LIBCRUX_ML_KEM_CONSTANTS_COEFFICIENTS_IN_RING_ELEMENT / (size_t)2U;
  invert_ntt_at_layer_1_ea(&zeta_i, re);
  invert_ntt_at_layer_2_ea(&zeta_i, re);
...
)
{
  ...
  memcpy(ret, result, (size_t)3U * sizeof (libcrux_ml_kem_polynomial_PolynomialRingElement_1d));
}
...
- ETA2_RANDOMNESS_SIZE= 128
*/
static KRML_MUSTINLINE tuple_ed0
encrypt_c1_851(
  Eurydice_slice randomness,
...
)
{
  ...
  KRML_MAYBE_FOR3(i,
    ...
    /* original Rust expression is not an lvalue in C */
    void *lvalue = (void *)0U;
    r_as_ntt[i] = call_mut_f1_851(&lvalue););
  ...
  KRML_MAYBE_FOR3(i,
    ...
    /* original Rust expression is not an lvalue in C */
    void *lvalue = (void *)0U;
    error_1[i] = call_mut_dd_851(&lvalue););
  uint8_t domain_separator = sample_ring_element_cbd_3b1(prf_input, domain_separator0, error_1);
  prf_input[32U] = domain_separator;
  uint8_t prf_output[128U];
  PRF_4a_410(Eurydice_array_to_slice((size_t)33U, prf_input, uint8_t), prf_output);
  libcrux_ml_kem_polynomial_PolynomialRingElement_1d
  error_2 =
    sample_from_binomial_distribution_a0(Eurydice_array_to_slice((size_t)128U, prf_output, uint8_t));
  ...
  libcrux_ml_kem_polynomial_PolynomialRingElement_1d uu____0[3U];
  memcpy(uu____0, u, (size_t)3U * sizeof (libcrux_ml_kem_polynomial_PolynomialRingElement_1d));
...
{
  IndCpaPublicKeyUnpacked_a0 unpacked_public_key = build_unpacked_public_key_3f(public_key);
  uint8_t ret0[1088U];
  encrypt_unpacked_2a1(&unpacked_public_key, message, randomness, ret0);
...
- CIPHERTEXT_SIZE= 1088
*/
static KRML_MUSTINLINE void kdf_39_d6(Eurydice_slice shared_secret, uint8_t ret[32U])
{
  uint8_t out[32U] = { 0U };
  Eurydice_slice_copy(Eurydice_array_to_slice((size_t)32U, out, uint8_t),
    shared_secret,
...
- V_COMPRESSION_FACTOR= 4
*/
static libcrux_ml_kem_polynomial_PolynomialRingElement_1d call_mut_0b_42(void **_)
{
  return ZERO_d6_ea();
}
...
- U_COMPRESSION_FACTOR= 10
*/
static libcrux_ml_kem_polynomial_PolynomialRingElement_1d call_mut_35_6c(void **_)
{
  return ZERO_d6_ea();
}
...
static KRML_MUSTINLINE void
decrypt_unpacked_42(
  IndCpaPrivateKeyUnpacked_a0 *secret_key,
  uint8_t *ciphertext,
  uint8_t ret[32U]
)
{
  ...
  v =
    deserialize_then_decompress_ring_element_v_89(Eurydice_array_to_subslice_from((size_t)1088U,
        ...
        Eurydice_derefed_slice));
  libcrux_ml_kem_polynomial_PolynomialRingElement_1d
  message = compute_message_1b(&v, secret_key->secret_as_ntt, u_as_ntt);
  uint8_t ret0[32U];
  compress_then_serialize_message_ea(message, ret0);
  memcpy(ret, ret0, (size_t)32U * sizeof (uint8_t));
}
...
*/
static KRML_MUSTINLINE void
decrypt_42(Eurydice_slice secret_key, uint8_t *ciphertext, uint8_t ret[32U])
{
...
)
{
  ...
  encrypt_2a(ind_cpa_public_key, decrypted, pseudorandomness, expected_ciphertext);
  uint8_t implicit_rejection_shared_secret[32U];
