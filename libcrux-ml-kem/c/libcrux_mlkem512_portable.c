...
{
  return libcrux_ml_kem_ind_cca_validate_private_key_fb(private_key, ciphertext);
}
...
{
  return libcrux_ml_kem_ind_cca_unpacked_encapsulate_0c0(public_key, randomness);
}
...
{
  libcrux_ml_kem_ind_cca_unpacked_keys_from_private_key_d1(private_key, key_pair);
}
...
{
  libcrux_ml_kem_ind_cca_unpacked_serialized_private_key_mut_11_6d(key_pair, serialized);
}
...
{
  libcrux_ml_kem_ind_cca_unpacked_serialized_public_key_mut_11_64(key_pair, serialized);
}
...
{
  libcrux_ml_kem_ind_cca_unpacked_unpack_public_key_73(public_key, unpacked_public_key);
}
