...
static void decapsulate_f9(libcrux_ml_kem_types_MlKemPrivateKey_5e *private_key,
                           ...
                           uint8_t ret[32U]) {
  libcrux_ml_kem_ind_cca_decapsulate_0b0(private_key, ciphertext, ret);
}

void libcrux_ml_kem_mlkem512_portable_decapsulate(
    libcrux_ml_kem_types_MlKemPrivateKey_5e *private_key,
    libcrux_ml_kem_types_MlKemCiphertext_e8 *ciphertext, uint8_t ret[32U]) {
  decapsulate_f9(private_key, ciphertext, ret);
}
...
- IMPLICIT_REJECTION_HASH_INPUT_SIZE= 800
*/
static void decapsulate_unpacked_f2(
    libcrux_ml_kem_ind_cca_unpacked_MlKemKeyPairUnpacked_ae *key_pair,
    libcrux_ml_kem_types_MlKemCiphertext_e8 *ciphertext, uint8_t ret[32U]) {
  libcrux_ml_kem_ind_cca_unpacked_decapsulate_unpacked_b90(key_pair, ciphertext,
                                                           ret);
}
...
void libcrux_ml_kem_mlkem512_portable_decapsulate_unpacked(
    ...
    libcrux_ml_kem_types_MlKemCiphertext_e8 *ciphertext, uint8_t ret[32U]) {
  decapsulate_unpacked_f2(private_key, ciphertext, ret);
}
...
- ETA2_RANDOMNESS_SIZE= 128
*/
static tuple_ec encapsulate_33(
  ...
  return libcrux_ml_kem_ind_cca_encapsulate_830(uu____0, uu____1);
}
...
tuple_ec libcrux_ml_kem_mlkem512_portable_encapsulate(
  ...
  uint8_t uu____1[32U];
  memcpy(uu____1, randomness, (size_t)32U * sizeof(uint8_t));
  return encapsulate_33(uu____0, uu____1);
}
...
- ETA2_RANDOMNESS_SIZE= 128
*/
static tuple_ec encapsulate_unpacked_7b(
  ...
  uint8_t uu____1[32U];
  memcpy(uu____1, randomness, (size_t)32U * sizeof(uint8_t));
  return libcrux_ml_kem_ind_cca_unpacked_encapsulate_unpacked_2d0(uu____0,
                                                                  uu____1);
}
...
tuple_ec libcrux_ml_kem_mlkem512_portable_encapsulate_unpacked(
  ...
  uint8_t uu____1[32U];
  memcpy(uu____1, randomness, (size_t)32U * sizeof(uint8_t));
  return encapsulate_unpacked_7b(uu____0, uu____1);
}
...
- ETA1_RANDOMNESS_SIZE= 192
*/
static libcrux_ml_kem_types_MlKemKeyPair_cb generate_keypair_71(
    uint8_t randomness[64U]) {
  uint8_t uu____0[64U];
  memcpy(uu____0, randomness, (size_t)64U * sizeof(uint8_t));
  return libcrux_ml_kem_ind_cca_generate_keypair_4a0(uu____0);
}
...
libcrux_ml_kem_mlkem512_portable_generate_key_pair(uint8_t randomness[64U]) {
  uint8_t uu____0[64U];
  memcpy(uu____0, randomness, (size_t)64U * sizeof(uint8_t));
  return generate_keypair_71(uu____0);
}
...
generate_keypair_unpacked_aa(uint8_t randomness[64U]) {
  uint8_t uu____0[64U];
  memcpy(uu____0, randomness, (size_t)64U * sizeof(uint8_t));
  return libcrux_ml_kem_ind_cca_unpacked_generate_keypair_unpacked_5b0(uu____0);
}
...
libcrux_ml_kem_mlkem512_portable_generate_key_pair_unpacked(
  ...
  uint8_t uu____0[64U];
  memcpy(uu____0, randomness, (size_t)64U * sizeof(uint8_t));
  return generate_keypair_unpacked_aa(uu____0);
}
...
- PUBLIC_KEY_SIZE= 800
*/
static bool validate_public_key_a20(uint8_t *public_key) {
  return libcrux_ml_kem_ind_cca_validate_public_key_ad0(public_key);
}

core_option_Option_04 libcrux_ml_kem_mlkem512_portable_validate_public_key(
    libcrux_ml_kem_types_MlKemPublicKey_be public_key) {
  core_option_Option_04 uu____0;
  if (validate_public_key_a20(public_key.value)) {
