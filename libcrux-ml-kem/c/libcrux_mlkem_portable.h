...
typedef struct libcrux_ml_kem_vector_portable_PortableVector_s { int16_t elements[16U]; }
...
#define LIBCRUX_ML_KEM_VECTOR_BARRETT_R ((int32_t)1 << (uint32_t)LIBCRUX_ML_KEM_VECTOR_BARRETT_SHIFT)
...
#define LIBCRUX_ML_KEM_VECTOR_MONTGOMERY_R ((int32_t)1 << (uint32_t)LIBCRUX_ML_KEM_VECTOR_MONTGOMERY_SHIFT)

int16_t libcrux_ml_kem_vector_montgomery_reduce_element(int32_t value);

int16_t libcrux_ml_kem_vector_montgomery_multiply_fe_by_fer(int16_t fe, int16_t fer);
...
uint32_t libcrux_ml_kem_vector_get_n_least_significant_bits(uint8_t n, uint32_t value);
