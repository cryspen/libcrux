...
- RATE= 136
*/
static KRML_MUSTINLINE void load_block_ef_65(__m256i (*a)[5U],
                                             Eurydice_slice b[4U]) {
...
- RATE= 136
*/
static KRML_MUSTINLINE void load_block_full_ef_e9(__m256i (*a)[5U],
                                                  uint8_t b[4U][200U]) {
  __m256i(*uu____0)[5U] = a;
  /* Passing arrays by value in Rust generates a copy in C */
...
- RATE= 136
*/
static KRML_MUSTINLINE void store_block_full_ef_43(__m256i (*a)[5U],
                                                   uint8_t ret[4U][200U]) {
...
- RATE= 136
*/
static KRML_MUSTINLINE void store_block_ef_58(__m256i (*a)[5U],
                                              Eurydice_slice b[4U]) {
  store_block_e9(a, b);
}
...
- RATE= 168
*/
static KRML_MUSTINLINE void load_block_full_ef_e90(__m256i (*a)[5U],
                                                   uint8_t b[4U][200U]) {
  __m256i(*uu____0)[5U] = a;
  /* Passing arrays by value in Rust generates a copy in C */
  uint8_t copy_of_b[4U][200U];
...
- RATE= 168
*/
static KRML_MUSTINLINE void store_block_ef_580(__m256i (*a)[5U],
                                               Eurydice_slice b[4U]) {
  store_block_e90(a, b);
}
