...
static inline void slice_4(Eurydice_slice a[4U], size_t start, size_t len,
  ...
  ret[1U] = uu____1;
  ret[2U] = uu____2;
  ret[3U] = Eurydice_slice_subslice(
      a[3U],
      ((core_ops_range_Range__size_t){.start = start, .end = start + len}),
      uint8_t, core_ops_range_Range__size_t, Eurydice_slice);
}
...
static inline void load_block___136size_t(core_core_arch_x86___m256i (*s)[5U],
  ...
  Eurydice_slice uu____7 = Eurydice_array_to_subslice(
      (size_t)32U, u8s,
      ((core_ops_range_Range__size_t){.start = (size_t)24U,
                                      .end = (size_t)32U}),
      uint8_t, core_ops_range_Range__size_t, Eurydice_slice);
  core_slice___Slice_T___copy_from_slice(
      uu____7,
  ...
  if (rem == (size_t)16U) {
    ...
    core_slice___Slice_T___copy_from_slice(
        ...
        Eurydice_slice_subslice(
            blocks[0U],
            ((core_ops_range_Range__size_t){.start = start + (size_t)8U,
...
static inline void store_block___136size_t(core_core_arch_x86___m256i (*s)[5U],
  ...
  Eurydice_slice uu____1 = Eurydice_slice_subslice(
      out[0U],
      ((core_ops_range_Range__size_t){.start = start,
                                      .end = start + (size_t)8U}),
      uint8_t, core_ops_range_Range__size_t, Eurydice_slice);
  core_slice___Slice_T___copy_from_slice(
      uu____1,
...
keccak__core_core_arch_x86___m256i_4size_t_136size_t_31uint8_t(
  ...
  if (blocks == (size_t)0U) {
    ...
    while (true) {
      if (core_iter_range___core__iter__traits__iterator__Iterator_for_core__ops__range__Range_A___3__next(
