...
usize> for libcrux_intrinsics::avx2_extract::__m256i)}
*/
static KRML_MUSTINLINE __m256i zero_bf(void) {
...
usize> for libcrux_intrinsics::avx2_extract::__m256i)}
*/
static KRML_MUSTINLINE __m256i xor5_bf(__m256i a, __m256i b, __m256i c,
                                       __m256i d, __m256i e) {
...
static KRML_MUSTINLINE __m256i _vrax1q_u64(__m256i a, __m256i b) {
  __m256i uu____0 = a;
  return mm256_xor_si256(uu____0, rotate_left_58(b));
}
...
usize> for libcrux_intrinsics::avx2_extract::__m256i)}
*/
static KRML_MUSTINLINE __m256i rotate_left1_and_xor_bf(__m256i a, __m256i b) {
...
usize> for libcrux_intrinsics::avx2_extract::__m256i)}
*/
static KRML_MUSTINLINE __m256i and_not_xor_bf(__m256i a, __m256i b, __m256i c) {
...
usize> for libcrux_intrinsics::avx2_extract::__m256i)}
*/
static KRML_MUSTINLINE __m256i xor_constant_bf(__m256i a, uint64_t c) {
...
usize> for libcrux_intrinsics::avx2_extract::__m256i)}
*/
static KRML_MUSTINLINE __m256i xor_bf(__m256i a, __m256i b) {
...
usize> for libcrux_intrinsics::avx2_extract::__m256i)}
*/
static KRML_MUSTINLINE void slice_n_bf(Eurydice_slice a[4U], size_t start,
                                       size_t len, Eurydice_slice ret[4U]) {
...
*/
static KRML_MUSTINLINE Eurydice_slice_uint8_t_4size_t__x2
split_at_mut_n_bf(Eurydice_slice a[4U], size_t mid) {
...
with types libcrux_intrinsics_avx2_extract___m256i
with const generics
- N= 4
*/
static KRML_MUSTINLINE libcrux_sha3_generic_keccak_KeccakState_f4
new_1e_5f(void) {
  libcrux_sha3_generic_keccak_KeccakState_f4 lit;
  lit.st[0U][0U] = zero_bf();
  lit.st[0U][1U] = zero_bf();
  lit.st[0U][2U] = zero_bf();
  lit.st[0U][3U] = zero_bf();
  lit.st[0U][4U] = zero_bf();
  lit.st[1U][0U] = zero_bf();
  lit.st[1U][1U] = zero_bf();
  lit.st[1U][2U] = zero_bf();
  lit.st[1U][3U] = zero_bf();
  lit.st[1U][4U] = zero_bf();
  lit.st[2U][0U] = zero_bf();
  lit.st[2U][1U] = zero_bf();
  lit.st[2U][2U] = zero_bf();
  lit.st[2U][3U] = zero_bf();
  lit.st[2U][4U] = zero_bf();
  lit.st[3U][0U] = zero_bf();
  lit.st[3U][1U] = zero_bf();
  lit.st[3U][2U] = zero_bf();
  lit.st[3U][3U] = zero_bf();
  lit.st[3U][4U] = zero_bf();
  lit.st[4U][0U] = zero_bf();
  lit.st[4U][1U] = zero_bf();
  lit.st[4U][2U] = zero_bf();
  lit.st[4U][3U] = zero_bf();
  lit.st[4U][4U] = zero_bf();
  return lit;
}
...
- RATE= 136
*/
static KRML_MUSTINLINE void load_block_c7(__m256i (*s)[5U],
                                          Eurydice_slice blocks[4U]) {
  for (size_t i = (size_t)0U; i < (size_t)136U / (size_t)32U; i++) {
    size_t i0 = i;
    __m256i v00 = mm256_loadu_si256_u8(Eurydice_slice_subslice2(
        blocks[0U], (size_t)32U * i0, (size_t)32U * (i0 + (size_t)1U), uint8_t,
        Eurydice_slice));
    __m256i v10 = mm256_loadu_si256_u8(Eurydice_slice_subslice2(
        blocks[1U], (size_t)32U * i0, (size_t)32U * (i0 + (size_t)1U), uint8_t,
        Eurydice_slice));
    __m256i v20 = mm256_loadu_si256_u8(Eurydice_slice_subslice2(
        blocks[2U], (size_t)32U * i0, (size_t)32U * (i0 + (size_t)1U), uint8_t,
        Eurydice_slice));
    __m256i v30 = mm256_loadu_si256_u8(Eurydice_slice_subslice2(
        blocks[3U], (size_t)32U * i0, (size_t)32U * (i0 + (size_t)1U), uint8_t,
        Eurydice_slice));
...
*/
/**
A monomorphic instance of libcrux_sha3.simd.avx2.load_block_bf
with const generics
- BLOCKSIZE= 136
*/
static KRML_MUSTINLINE void load_block_bf_6a(__m256i (*a)[5U],
                                             Eurydice_slice b[4U]) {
  __m256i(*uu____0)[5U] = a;
  Eurydice_slice uu____1[4U];
  memcpy(uu____1, b, (size_t)4U * sizeof(Eurydice_slice));
  load_block_c7(uu____0, uu____1);
}
...
- RIGHT= 28
*/
static KRML_MUSTINLINE __m256i rotate_left_580(__m256i x) {
...
- RIGHT= 28
*/
static KRML_MUSTINLINE __m256i _vxarq_u64_c1(__m256i a, __m256i b) {
  __m256i ab = mm256_xor_si256(a, b);
...
*/
/**
A monomorphic instance of libcrux_sha3.simd.avx2.xor_and_rotate_bf
with const generics
- LEFT= 36
- RIGHT= 28
*/
static KRML_MUSTINLINE __m256i xor_and_rotate_bf_17(__m256i a, __m256i b) {
...
- RIGHT= 61
*/
static KRML_MUSTINLINE __m256i rotate_left_581(__m256i x) {
...
- RIGHT= 61
*/
static KRML_MUSTINLINE __m256i _vxarq_u64_c10(__m256i a, __m256i b) {
  __m256i ab = mm256_xor_si256(a, b);
...
- RIGHT= 61
*/
static KRML_MUSTINLINE __m256i xor_and_rotate_bf_170(__m256i a, __m256i b) {
...
- RIGHT= 23
*/
static KRML_MUSTINLINE __m256i rotate_left_582(__m256i x) {
...
- RIGHT= 23
*/
static KRML_MUSTINLINE __m256i _vxarq_u64_c11(__m256i a, __m256i b) {
  __m256i ab = mm256_xor_si256(a, b);
...
- RIGHT= 23
*/
static KRML_MUSTINLINE __m256i xor_and_rotate_bf_171(__m256i a, __m256i b) {
...
- RIGHT= 46
*/
static KRML_MUSTINLINE __m256i rotate_left_583(__m256i x) {
...
- RIGHT= 46
*/
static KRML_MUSTINLINE __m256i _vxarq_u64_c12(__m256i a, __m256i b) {
  __m256i ab = mm256_xor_si256(a, b);
...
- RIGHT= 46
*/
static KRML_MUSTINLINE __m256i xor_and_rotate_bf_172(__m256i a, __m256i b) {
...
- RIGHT= 63
*/
static KRML_MUSTINLINE __m256i _vxarq_u64_c13(__m256i a, __m256i b) {
  __m256i ab = mm256_xor_si256(a, b);
...
- RIGHT= 63
*/
static KRML_MUSTINLINE __m256i xor_and_rotate_bf_173(__m256i a, __m256i b) {
...
- RIGHT= 20
*/
static KRML_MUSTINLINE __m256i rotate_left_584(__m256i x) {
...
- RIGHT= 20
*/
static KRML_MUSTINLINE __m256i _vxarq_u64_c14(__m256i a, __m256i b) {
  __m256i ab = mm256_xor_si256(a, b);
...
- RIGHT= 20
*/
static KRML_MUSTINLINE __m256i xor_and_rotate_bf_174(__m256i a, __m256i b) {
...
- RIGHT= 54
*/
static KRML_MUSTINLINE __m256i rotate_left_585(__m256i x) {
...
- RIGHT= 54
*/
static KRML_MUSTINLINE __m256i _vxarq_u64_c15(__m256i a, __m256i b) {
  __m256i ab = mm256_xor_si256(a, b);
...
- RIGHT= 54
*/
static KRML_MUSTINLINE __m256i xor_and_rotate_bf_175(__m256i a, __m256i b) {
...
- RIGHT= 19
*/
static KRML_MUSTINLINE __m256i rotate_left_586(__m256i x) {
...
- RIGHT= 19
*/
static KRML_MUSTINLINE __m256i _vxarq_u64_c16(__m256i a, __m256i b) {
  __m256i ab = mm256_xor_si256(a, b);
...
- RIGHT= 19
*/
static KRML_MUSTINLINE __m256i xor_and_rotate_bf_176(__m256i a, __m256i b) {
...
- RIGHT= 62
*/
static KRML_MUSTINLINE __m256i rotate_left_587(__m256i x) {
...
- RIGHT= 62
*/
static KRML_MUSTINLINE __m256i _vxarq_u64_c17(__m256i a, __m256i b) {
  __m256i ab = mm256_xor_si256(a, b);
...
- RIGHT= 62
*/
static KRML_MUSTINLINE __m256i xor_and_rotate_bf_177(__m256i a, __m256i b) {
...
- RIGHT= 2
*/
static KRML_MUSTINLINE __m256i rotate_left_588(__m256i x) {
...
- RIGHT= 2
*/
static KRML_MUSTINLINE __m256i _vxarq_u64_c18(__m256i a, __m256i b) {
  __m256i ab = mm256_xor_si256(a, b);
...
- RIGHT= 2
*/
static KRML_MUSTINLINE __m256i xor_and_rotate_bf_178(__m256i a, __m256i b) {
...
- RIGHT= 58
*/
static KRML_MUSTINLINE __m256i rotate_left_589(__m256i x) {
...
- RIGHT= 58
*/
static KRML_MUSTINLINE __m256i _vxarq_u64_c19(__m256i a, __m256i b) {
  __m256i ab = mm256_xor_si256(a, b);
...
- RIGHT= 58
*/
static KRML_MUSTINLINE __m256i xor_and_rotate_bf_179(__m256i a, __m256i b) {
...
- RIGHT= 21
*/
static KRML_MUSTINLINE __m256i rotate_left_5810(__m256i x) {
...
- RIGHT= 21
*/
static KRML_MUSTINLINE __m256i _vxarq_u64_c110(__m256i a, __m256i b) {
  __m256i ab = mm256_xor_si256(a, b);
...
- RIGHT= 21
*/
static KRML_MUSTINLINE __m256i xor_and_rotate_bf_1710(__m256i a, __m256i b) {
...
- RIGHT= 49
*/
static KRML_MUSTINLINE __m256i rotate_left_5811(__m256i x) {
...
- RIGHT= 49
*/
static KRML_MUSTINLINE __m256i _vxarq_u64_c111(__m256i a, __m256i b) {
  __m256i ab = mm256_xor_si256(a, b);
...
- RIGHT= 49
*/
static KRML_MUSTINLINE __m256i xor_and_rotate_bf_1711(__m256i a, __m256i b) {
...
- RIGHT= 3
*/
static KRML_MUSTINLINE __m256i rotate_left_5812(__m256i x) {
...
- RIGHT= 3
*/
static KRML_MUSTINLINE __m256i _vxarq_u64_c112(__m256i a, __m256i b) {
  __m256i ab = mm256_xor_si256(a, b);
...
- RIGHT= 3
*/
static KRML_MUSTINLINE __m256i xor_and_rotate_bf_1712(__m256i a, __m256i b) {
...
- RIGHT= 36
*/
static KRML_MUSTINLINE __m256i rotate_left_5813(__m256i x) {
...
- RIGHT= 36
*/
static KRML_MUSTINLINE __m256i _vxarq_u64_c113(__m256i a, __m256i b) {
  __m256i ab = mm256_xor_si256(a, b);
...
- RIGHT= 36
*/
static KRML_MUSTINLINE __m256i xor_and_rotate_bf_1713(__m256i a, __m256i b) {
...
- RIGHT= 9
*/
static KRML_MUSTINLINE __m256i rotate_left_5814(__m256i x) {
...
- RIGHT= 9
*/
static KRML_MUSTINLINE __m256i _vxarq_u64_c114(__m256i a, __m256i b) {
  __m256i ab = mm256_xor_si256(a, b);
...
- RIGHT= 9
*/
static KRML_MUSTINLINE __m256i xor_and_rotate_bf_1714(__m256i a, __m256i b) {
...
- RIGHT= 39
*/
static KRML_MUSTINLINE __m256i rotate_left_5815(__m256i x) {
...
- RIGHT= 39
*/
static KRML_MUSTINLINE __m256i _vxarq_u64_c115(__m256i a, __m256i b) {
  __m256i ab = mm256_xor_si256(a, b);
...
- RIGHT= 39
*/
static KRML_MUSTINLINE __m256i xor_and_rotate_bf_1715(__m256i a, __m256i b) {
...
- RIGHT= 43
*/
static KRML_MUSTINLINE __m256i rotate_left_5816(__m256i x) {
...
- RIGHT= 43
*/
static KRML_MUSTINLINE __m256i _vxarq_u64_c116(__m256i a, __m256i b) {
  __m256i ab = mm256_xor_si256(a, b);
...
- RIGHT= 43
*/
static KRML_MUSTINLINE __m256i xor_and_rotate_bf_1716(__m256i a, __m256i b) {
...
- RIGHT= 8
*/
static KRML_MUSTINLINE __m256i rotate_left_5817(__m256i x) {
...
- RIGHT= 8
*/
static KRML_MUSTINLINE __m256i _vxarq_u64_c117(__m256i a, __m256i b) {
  __m256i ab = mm256_xor_si256(a, b);
...
- RIGHT= 8
*/
static KRML_MUSTINLINE __m256i xor_and_rotate_bf_1717(__m256i a, __m256i b) {
...
- RIGHT= 37
*/
static KRML_MUSTINLINE __m256i rotate_left_5818(__m256i x) {
...
- RIGHT= 37
*/
static KRML_MUSTINLINE __m256i _vxarq_u64_c118(__m256i a, __m256i b) {
  __m256i ab = mm256_xor_si256(a, b);
...
- RIGHT= 37
*/
static KRML_MUSTINLINE __m256i xor_and_rotate_bf_1718(__m256i a, __m256i b) {
...
- RIGHT= 44
*/
static KRML_MUSTINLINE __m256i rotate_left_5819(__m256i x) {
...
- RIGHT= 44
*/
static KRML_MUSTINLINE __m256i _vxarq_u64_c119(__m256i a, __m256i b) {
  __m256i ab = mm256_xor_si256(a, b);
...
- RIGHT= 44
*/
static KRML_MUSTINLINE __m256i xor_and_rotate_bf_1719(__m256i a, __m256i b) {
...
- RIGHT= 25
*/
static KRML_MUSTINLINE __m256i rotate_left_5820(__m256i x) {
...
- RIGHT= 25
*/
static KRML_MUSTINLINE __m256i _vxarq_u64_c120(__m256i a, __m256i b) {
  __m256i ab = mm256_xor_si256(a, b);
...
- RIGHT= 25
*/
static KRML_MUSTINLINE __m256i xor_and_rotate_bf_1720(__m256i a, __m256i b) {
...
- RIGHT= 56
*/
static KRML_MUSTINLINE __m256i rotate_left_5821(__m256i x) {
...
- RIGHT= 56
*/
static KRML_MUSTINLINE __m256i _vxarq_u64_c121(__m256i a, __m256i b) {
  __m256i ab = mm256_xor_si256(a, b);
...
- RIGHT= 56
*/
static KRML_MUSTINLINE __m256i xor_and_rotate_bf_1721(__m256i a, __m256i b) {
...
- RIGHT= 50
*/
static KRML_MUSTINLINE __m256i rotate_left_5822(__m256i x) {
...
- RIGHT= 50
*/
static KRML_MUSTINLINE __m256i _vxarq_u64_c122(__m256i a, __m256i b) {
  __m256i ab = mm256_xor_si256(a, b);
...
- RIGHT= 50
*/
static KRML_MUSTINLINE __m256i xor_and_rotate_bf_1722(__m256i a, __m256i b) {
...
- N= 4
*/
static KRML_MUSTINLINE void theta_rho_23(
    libcrux_sha3_generic_keccak_KeccakState_f4 *s) {
  __m256i c[5U] = {xor5_bf(s->st[0U][0U], s->st[1U][0U], s->st[2U][0U],
                           s->st[3U][0U], s->st[4U][0U]),
                   xor5_bf(s->st[0U][1U], s->st[1U][1U], s->st[2U][1U],
                           s->st[3U][1U], s->st[4U][1U]),
                   xor5_bf(s->st[0U][2U], s->st[1U][2U], s->st[2U][2U],
                           s->st[3U][2U], s->st[4U][2U]),
                   xor5_bf(s->st[0U][3U], s->st[1U][3U], s->st[2U][3U],
                           s->st[3U][3U], s->st[4U][3U]),
                   xor5_bf(s->st[0U][4U], s->st[1U][4U], s->st[2U][4U],
                           s->st[3U][4U], s->st[4U][4U])};
  __m256i uu____0 =
      rotate_left1_and_xor_bf(c[((size_t)0U + (size_t)4U) % (size_t)5U],
                              c[((size_t)0U + (size_t)1U) % (size_t)5U]);
  __m256i uu____1 =
      rotate_left1_and_xor_bf(c[((size_t)1U + (size_t)4U) % (size_t)5U],
                              c[((size_t)1U + (size_t)1U) % (size_t)5U]);
  __m256i uu____2 =
      rotate_left1_and_xor_bf(c[((size_t)2U + (size_t)4U) % (size_t)5U],
                              c[((size_t)2U + (size_t)1U) % (size_t)5U]);
  __m256i uu____3 =
      rotate_left1_and_xor_bf(c[((size_t)3U + (size_t)4U) % (size_t)5U],
                              c[((size_t)3U + (size_t)1U) % (size_t)5U]);
  __m256i t[5U] = {
      uu____0, uu____1, uu____2, uu____3,
      rotate_left1_and_xor_bf(c[((size_t)4U + (size_t)4U) % (size_t)5U],
                              c[((size_t)4U + (size_t)1U) % (size_t)5U])};
  s->st[0U][0U] = xor_bf(s->st[0U][0U], t[0U]);
  s->st[1U][0U] = xor_and_rotate_bf_17(s->st[1U][0U], t[0U]);
  s->st[2U][0U] = xor_and_rotate_bf_170(s->st[2U][0U], t[0U]);
  s->st[3U][0U] = xor_and_rotate_bf_171(s->st[3U][0U], t[0U]);
  s->st[4U][0U] = xor_and_rotate_bf_172(s->st[4U][0U], t[0U]);
  s->st[0U][1U] = xor_and_rotate_bf_173(s->st[0U][1U], t[1U]);
  s->st[1U][1U] = xor_and_rotate_bf_174(s->st[1U][1U], t[1U]);
  s->st[2U][1U] = xor_and_rotate_bf_175(s->st[2U][1U], t[1U]);
  s->st[3U][1U] = xor_and_rotate_bf_176(s->st[3U][1U], t[1U]);
  s->st[4U][1U] = xor_and_rotate_bf_177(s->st[4U][1U], t[1U]);
  s->st[0U][2U] = xor_and_rotate_bf_178(s->st[0U][2U], t[2U]);
  s->st[1U][2U] = xor_and_rotate_bf_179(s->st[1U][2U], t[2U]);
  s->st[2U][2U] = xor_and_rotate_bf_1710(s->st[2U][2U], t[2U]);
  s->st[3U][2U] = xor_and_rotate_bf_1711(s->st[3U][2U], t[2U]);
  s->st[4U][2U] = xor_and_rotate_bf_1712(s->st[4U][2U], t[2U]);
  s->st[0U][3U] = xor_and_rotate_bf_1713(s->st[0U][3U], t[3U]);
  s->st[1U][3U] = xor_and_rotate_bf_1714(s->st[1U][3U], t[3U]);
  s->st[2U][3U] = xor_and_rotate_bf_1715(s->st[2U][3U], t[3U]);
  s->st[3U][3U] = xor_and_rotate_bf_1716(s->st[3U][3U], t[3U]);
  s->st[4U][3U] = xor_and_rotate_bf_1717(s->st[4U][3U], t[3U]);
  s->st[0U][4U] = xor_and_rotate_bf_1718(s->st[0U][4U], t[4U]);
  s->st[1U][4U] = xor_and_rotate_bf_1719(s->st[1U][4U], t[4U]);
  s->st[2U][4U] = xor_and_rotate_bf_1720(s->st[2U][4U], t[4U]);
  s->st[3U][4U] = xor_and_rotate_bf_1721(s->st[3U][4U], t[4U]);
  __m256i uu____27 = xor_and_rotate_bf_1722(s->st[4U][4U], t[4U]);
  s->st[4U][4U] = uu____27;
}
...
- N= 4
*/
static KRML_MUSTINLINE void pi_82(
    libcrux_sha3_generic_keccak_KeccakState_f4 *s) {
  __m256i old[5U][5U];
...
- N= 4
*/
static KRML_MUSTINLINE void chi_63(
    libcrux_sha3_generic_keccak_KeccakState_f4 *s) {
  __m256i old[5U][5U];
  memcpy(old, s->st, (size_t)5U * sizeof(__m256i[5U]));
  KRML_MAYBE_FOR5(
...
- N= 4
*/
static KRML_MUSTINLINE void iota_88(
    libcrux_sha3_generic_keccak_KeccakState_f4 *s, size_t i) {
  s->st[0U][0U] = xor_constant_bf(
...
- N= 4
*/
static KRML_MUSTINLINE void keccakf1600_17(
    libcrux_sha3_generic_keccak_KeccakState_f4 *s) {
...
- RATE= 136
*/
static KRML_MUSTINLINE void absorb_block_a6(
    libcrux_sha3_generic_keccak_KeccakState_f4 *s, Eurydice_slice blocks[4U]) {
  __m256i(*uu____0)[5U] = s->st;
  Eurydice_slice uu____1[4U];
  memcpy(uu____1, blocks, (size_t)4U * sizeof(Eurydice_slice));
  load_block_bf_6a(uu____0, uu____1);
  keccakf1600_17(s);
}
...
- RATE= 136
*/
static KRML_MUSTINLINE void load_block_full_91(__m256i (*s)[5U],
...
*/
/**
A monomorphic instance of libcrux_sha3.simd.avx2.load_block_full_bf
with const generics
- BLOCKSIZE= 136
*/
static KRML_MUSTINLINE void load_block_full_bf_05(__m256i (*a)[5U],
                                                  uint8_t b[4U][200U]) {
  __m256i(*uu____0)[5U] = a;
  uint8_t uu____1[4U][200U];
  memcpy(uu____1, b, (size_t)4U * sizeof(uint8_t[200U]));
  load_block_full_91(uu____0, uu____1);
}
...
- DELIM= 31
*/
static KRML_MUSTINLINE void absorb_final_04(
    libcrux_sha3_generic_keccak_KeccakState_f4 *s, Eurydice_slice last[4U]) {
  ...
  load_block_full_bf_05(uu____3, uu____4);
  keccakf1600_17(s);
}
...
- RATE= 136
*/
static KRML_MUSTINLINE void store_block_e9(__m256i (*s)[5U],
...
- RATE= 136
*/
static KRML_MUSTINLINE void store_block_full_0b(__m256i (*s)[5U],
                                                uint8_t ret[4U][200U]) {
...
*/
/**
A monomorphic instance of libcrux_sha3.simd.avx2.store_block_full_bf
with const generics
- BLOCKSIZE= 136
*/
static KRML_MUSTINLINE void store_block_full_bf_99(__m256i (*a)[5U],
                                                   uint8_t ret[4U][200U]) {
...
- RATE= 136
*/
static KRML_MUSTINLINE void squeeze_first_and_last_6d(
    libcrux_sha3_generic_keccak_KeccakState_f4 *s, Eurydice_slice out[4U]) {
  uint8_t b[4U][200U];
  store_block_full_bf_99(s->st, b);
  KRML_MAYBE_FOR4(
      i, (size_t)0U, (size_t)4U, (size_t)1U, size_t i0 = i;
...
*/
/**
A monomorphic instance of libcrux_sha3.simd.avx2.store_block_bf
with const generics
- BLOCKSIZE= 136
*/
static KRML_MUSTINLINE void store_block_bf_f6(__m256i (*a)[5U],
                                              Eurydice_slice b[4U]) {
  store_block_e9(a, b);
}
...
- RATE= 136
*/
static KRML_MUSTINLINE void squeeze_first_block_b3(
    libcrux_sha3_generic_keccak_KeccakState_f4 *s, Eurydice_slice out[4U]) {
  store_block_bf_f6(s->st, out);
}
...
- RATE= 136
*/
static KRML_MUSTINLINE void squeeze_next_block_23(
    libcrux_sha3_generic_keccak_KeccakState_f4 *s, Eurydice_slice out[4U]) {
  keccakf1600_17(s);
  store_block_bf_f6(s->st, out);
}
...
- RATE= 136
*/
static KRML_MUSTINLINE void squeeze_last_83(
    libcrux_sha3_generic_keccak_KeccakState_f4 s, Eurydice_slice out[4U]) {
  keccakf1600_17(&s);
  uint8_t b[4U][200U];
  store_block_full_bf_99(s.st, b);
...
- DELIM= 31
*/
static KRML_MUSTINLINE void keccak_b5(Eurydice_slice data[4U],
                                      Eurydice_slice out[4U]) {
  libcrux_sha3_generic_keccak_KeccakState_f4 s = new_1e_5f();
  for (size_t i = (size_t)0U;
       i < core_slice___Slice_T___len(data[0U], uint8_t, size_t) / (size_t)136U;
       i++) {
    size_t i0 = i;
    libcrux_sha3_generic_keccak_KeccakState_f4 *uu____0 = &s;
    Eurydice_slice uu____1[4U];
    memcpy(uu____1, data, (size_t)4U * sizeof(Eurydice_slice));
    Eurydice_slice ret[4U];
    slice_n_bf(uu____1, i0 * (size_t)136U, (size_t)136U, ret);
    absorb_block_a6(uu____0, ret);
  }
  size_t rem =
      core_slice___Slice_T___len(data[0U], uint8_t, size_t) % (size_t)136U;
  libcrux_sha3_generic_keccak_KeccakState_f4 *uu____2 = &s;
    ...
    while (true) {
      if (core_iter_range___core__iter__traits__iterator__Iterator_for_core__ops__range__Range_A___6__next(
        ...
        Eurydice_slice_uint8_t_4size_t__x2 uu____5 =
            split_at_mut_n_bf(o1, (size_t)136U);
        Eurydice_slice o[4U];
...
*/
libcrux_sha3_generic_keccak_KeccakState_f4
...
- RATE= 168
*/
static KRML_MUSTINLINE void load_block_c70(__m256i (*s)[5U],
                                           Eurydice_slice blocks[4U]) {
...
- RATE= 168
*/
static KRML_MUSTINLINE void load_block_full_910(__m256i (*s)[5U],
                                                uint8_t blocks[4U][200U]) {
  Eurydice_slice buf[4U] = {Eurydice_array_to_slice((size_t)200U, blocks[0U],
                                                    uint8_t, Eurydice_slice),
                            Eurydice_array_to_slice((size_t)200U, blocks[1U],
...
- BLOCKSIZE= 168
*/
static KRML_MUSTINLINE void load_block_full_bf_050(__m256i (*a)[5U],
                                                   uint8_t b[4U][200U]) {
  __m256i(*uu____0)[5U] = a;
  uint8_t uu____1[4U][200U];
  memcpy(uu____1, b, (size_t)4U * sizeof(uint8_t[200U]));
  load_block_full_910(uu____0, uu____1);
}
...
- DELIM= 31
*/
static KRML_MUSTINLINE void absorb_final_040(
    libcrux_sha3_generic_keccak_KeccakState_f4 *s, Eurydice_slice last[4U]) {
  size_t last_len = core_slice___Slice_T___len(last[0U], uint8_t, size_t);
  uint8_t blocks[4U][200U] = {{0U}};
  KRML_MAYBE_FOR4(
  ...
  uint8_t uu____4[4U][200U];
  memcpy(uu____4, blocks, (size_t)4U * sizeof(uint8_t[200U]));
  load_block_full_bf_050(uu____3, uu____4);
  keccakf1600_17(s);
}
...
- RATE= 168
*/
static KRML_MUSTINLINE void store_block_e90(__m256i (*s)[5U],
                                            Eurydice_slice out[4U]) {
  for (size_t i = (size_t)0U; i < (size_t)168U / (size_t)32U; i++) {
    size_t i0 = i;
    __m256i v0l = mm256_permute2x128_si256(
...
- BLOCKSIZE= 168
*/
static KRML_MUSTINLINE void store_block_bf_f60(__m256i (*a)[5U],
                                               Eurydice_slice b[4U]) {
  store_block_e90(a, b);
}
...
- RATE= 168
*/
static KRML_MUSTINLINE void squeeze_next_block_230(
    libcrux_sha3_generic_keccak_KeccakState_f4 *s, Eurydice_slice out[4U]) {
  keccakf1600_17(s);
  store_block_bf_f60(s->st, out);
}
...
void libcrux_sha3_avx2_x4_incremental_shake128_squeeze_next_block(
    libcrux_sha3_generic_keccak_KeccakState_f4 *s, Eurydice_slice out0,
    Eurydice_slice out1, Eurydice_slice out2, Eurydice_slice out3) {
  Eurydice_slice buf[4U] = {out0, out1, out2, out3};
  squeeze_next_block_230(s, buf);
}
...
- RATE= 168
*/
static KRML_MUSTINLINE void squeeze_first_block_b30(
    libcrux_sha3_generic_keccak_KeccakState_f4 *s, Eurydice_slice out[4U]) {
  store_block_bf_f60(s->st, out);
}
...
- RATE= 168
*/
static KRML_MUSTINLINE void squeeze_first_three_blocks_99(
    libcrux_sha3_generic_keccak_KeccakState_f4 *s, Eurydice_slice out[4U]) {
  Eurydice_slice_uint8_t_4size_t__x2 uu____0 =
      split_at_mut_n_bf(out, (size_t)168U);
  Eurydice_slice o0[4U];
  ...
  squeeze_first_block_b30(s, o0);
  Eurydice_slice_uint8_t_4size_t__x2 uu____1 =
      split_at_mut_n_bf(o10, (size_t)168U);
  Eurydice_slice o1[4U];
  ...
  squeeze_next_block_230(s, o1);
  squeeze_next_block_230(s, o2);
}
...
void libcrux_sha3_avx2_x4_incremental_shake128_squeeze_first_three_blocks(
    ...
    Eurydice_slice out1, Eurydice_slice out2, Eurydice_slice out3) {
  Eurydice_slice buf[4U] = {out0, out1, out2, out3};
  squeeze_first_three_blocks_99(s, buf);
}
...
- RATE= 168
*/
static KRML_MUSTINLINE void squeeze_first_five_blocks_33(
    libcrux_sha3_generic_keccak_KeccakState_f4 *s, Eurydice_slice out[4U]) {
  Eurydice_slice_uint8_t_4size_t__x2 uu____0 =
      split_at_mut_n_bf(out, (size_t)168U);
  Eurydice_slice o0[4U];
  ...
  Eurydice_slice_uint8_t_4size_t__x2 uu____2 =
      split_at_mut_n_bf(o20, (size_t)168U);
  Eurydice_slice o2[4U];
  ...
  Eurydice_slice_uint8_t_4size_t__x2 uu____3 =
      split_at_mut_n_bf(o30, (size_t)168U);
  ...
  squeeze_next_block_230(s, o3);
  squeeze_next_block_230(s, o4);
}
...
libcrux_sha3_avx2_x4_incremental_shake128_squeeze_first_five_blocks(
    ...
    Eurydice_slice out1, Eurydice_slice out2, Eurydice_slice out3) {
  Eurydice_slice buf[4U] = {out0, out1, out2, out3};
  squeeze_first_five_blocks_33(s, buf);
}
