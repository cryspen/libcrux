...
static KRML_MUSTINLINE void
squeeze_first_five_blocks__core_core_arch_x86___m256i_4size_t_168size_t(
    libcrux_sha3_generic_keccak_KeccakState__core_core_arch_x86___m256i__4size_t
        *s,
    Eurydice_slice out[4U]) {
  K___Eurydice_slice_uint8_t_4size_t__Eurydice_slice_uint8_t_4size_t_ uu____0 =
  ...
  K___Eurydice_slice_uint8_t_4size_t__Eurydice_slice_uint8_t_4size_t_ uu____2 =
      split_at_mut_n(o20, (size_t)168U);
  Eurydice_slice o2[4U];
  ...
  K___Eurydice_slice_uint8_t_4size_t__Eurydice_slice_uint8_t_4size_t_ uu____3 =
      split_at_mut_n(o30, (size_t)168U);
  ...
  squeeze_next_block__core_core_arch_x86___m256i_4size_t_168size_t(s, o3);
  squeeze_next_block__core_core_arch_x86___m256i_4size_t_168size_t(s, o4);
}
...
libcrux_sha3_avx2_x4_incremental_shake128_squeeze_first_five_blocks(
    ...
    Eurydice_slice out3) {
  Eurydice_slice buf[4U] = {out0, out1, out2, out3};
  squeeze_first_five_blocks__core_core_arch_x86___m256i_4size_t_168size_t(s,
                                                                          buf);
}
...
KRML_MUSTINLINE void libcrux_sha3_avx2_x4_incremental_shake256_absorb_final(
    ...
    Eurydice_slice data3) {
  Eurydice_slice buf[4U] = {data0, data1, data2, data3};
  absorb_final__core_core_arch_x86___m256i_4size_t_136size_t_31uint8_t(s, buf);
}
...
libcrux_sha3_avx2_x4_incremental_shake256_squeeze_first_block(
    ...
    Eurydice_slice out3) {
  Eurydice_slice buf[4U] = {out0, out1, out2, out3};
  squeeze_first_block__core_core_arch_x86___m256i_4size_t_136size_t(s, buf);
}
...
libcrux_sha3_avx2_x4_incremental_shake256_squeeze_next_block(
    ...
    Eurydice_slice out3) {
  Eurydice_slice buf[4U] = {out0, out1, out2, out3};
  squeeze_next_block__core_core_arch_x86___m256i_4size_t_136size_t(s, buf);
}
