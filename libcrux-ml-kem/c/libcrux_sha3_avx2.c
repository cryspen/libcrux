...
static inline uint8_t zero(void) {
  return libcrux_intrinsics_avx2_extract_mm256_set1_epi64x((int64_t)0);
}

static inline uint8_t _veor5q_u64(uint8_t a, uint8_t b, uint8_t c, uint8_t d,
                                  uint8_t e) {
  uint8_t ab = libcrux_intrinsics_avx2_extract_mm256_xor_si256(a, b);
  uint8_t cd = libcrux_intrinsics_avx2_extract_mm256_xor_si256(c, d);
  uint8_t abcd = libcrux_intrinsics_avx2_extract_mm256_xor_si256(ab, cd);
  return libcrux_intrinsics_avx2_extract_mm256_xor_si256(abcd, e);
}
...
static inline uint8_t rotate_left___1int32_t_63int32_t(uint8_t x) {
  uint8_t uu____0 =
      libcrux_intrinsics_avx2_extract_mm256_slli_epi64((int32_t)1, x, uint8_t);
  return libcrux_intrinsics_avx2_extract_mm256_xor_si256(
      uu____0, libcrux_intrinsics_avx2_extract_mm256_srli_epi64((int32_t)63, x,
                                                                uint8_t));
}
...
static inline uint8_t _vbcaxq_u64(uint8_t a, uint8_t b, uint8_t c) {
  uint8_t uu____0 = a;
  return libcrux_intrinsics_avx2_extract_mm256_xor_si256(
      uu____0, libcrux_intrinsics_avx2_extract_mm256_andnot_si256(c, b));
}
...
static inline uint8_t _veorq_n_u64(uint8_t a, uint64_t c) {
  uint8_t c0 = libcrux_intrinsics_avx2_extract_mm256_set1_epi64x((int64_t)c);
  return libcrux_intrinsics_avx2_extract_mm256_xor_si256(a, c0);
}
...
static inline uint8_t xor0(uint8_t a, uint8_t b) {
  return libcrux_intrinsics_avx2_extract_mm256_xor_si256(a, b);
}
...
static inline libcrux_sha3_generic_keccak_KeccakState__uint8_t__4size_t
new__uint8_t_4size_t(void) {
  libcrux_sha3_generic_keccak_KeccakState__uint8_t__4size_t lit;
  lit.st[0U][0U] = zero();
  lit.st[0U][1U] = zero();
  lit.st[0U][2U] = zero();
  lit.st[0U][3U] = zero();
...
static inline void load_block___136size_t(uint8_t (*s)[5U],
  ...
  for (size_t i = (size_t)0U; i < (size_t)136U / (size_t)32U; i++) {
    size_t i0 = i;
    uint8_t v00 = libcrux_intrinsics_avx2_extract_mm256_loadu_si256_u8(
        Eurydice_slice_subslice(blocks[0U],
                                ...
                                uint8_t, core_ops_range_Range__size_t,
                                Eurydice_slice));
    uint8_t v10 = libcrux_intrinsics_avx2_extract_mm256_loadu_si256_u8(
        Eurydice_slice_subslice(blocks[1U],
                                ...
                                uint8_t, core_ops_range_Range__size_t,
                                Eurydice_slice));
    uint8_t v20 = libcrux_intrinsics_avx2_extract_mm256_loadu_si256_u8(
        Eurydice_slice_subslice(blocks[2U],
                                ...
                                uint8_t, core_ops_range_Range__size_t,
                                Eurydice_slice));
    uint8_t v30 = libcrux_intrinsics_avx2_extract_mm256_loadu_si256_u8(
        Eurydice_slice_subslice(blocks[3U],
                                ...
                                Eurydice_slice));
    uint8_t v0l =
        libcrux_intrinsics_avx2_extract_mm256_unpacklo_epi64(v00, v10);
    uint8_t v1h =
        libcrux_intrinsics_avx2_extract_mm256_unpackhi_epi64(v00, v10);
    uint8_t v2l =
        libcrux_intrinsics_avx2_extract_mm256_unpacklo_epi64(v20, v30);
    uint8_t v3h =
        libcrux_intrinsics_avx2_extract_mm256_unpackhi_epi64(v20, v30);
    uint8_t v0 = libcrux_intrinsics_avx2_extract_mm256_permute2x128_si256(
        (int32_t)32, v0l, v2l, uint8_t);
    uint8_t v1 = libcrux_intrinsics_avx2_extract_mm256_permute2x128_si256(
        (int32_t)32, v1h, v3h, uint8_t);
    uint8_t v2 = libcrux_intrinsics_avx2_extract_mm256_permute2x128_si256(
        (int32_t)49, v0l, v2l, uint8_t);
    uint8_t v3 = libcrux_intrinsics_avx2_extract_mm256_permute2x128_si256(
        (int32_t)49, v1h, v3h, uint8_t);
    uint8_t uu____0 = libcrux_intrinsics_avx2_extract_mm256_xor_si256(
        s[(size_t)4U * i0 / (size_t)5U][(size_t)4U * i0 % (size_t)5U], v0);
    s[(size_t)4U * i0 / (size_t)5U][(size_t)4U * i0 % (size_t)5U] = uu____0;
    uint8_t uu____1 = libcrux_intrinsics_avx2_extract_mm256_xor_si256(
        s[((size_t)4U * i0 + (size_t)1U) / (size_t)5U]
         [((size_t)4U * i0 + (size_t)1U) % (size_t)5U],
        v1);
    s[((size_t)4U * i0 + (size_t)1U) / (size_t)5U]
     [((size_t)4U * i0 + (size_t)1U) % (size_t)5U] = uu____1;
    uint8_t uu____2 = libcrux_intrinsics_avx2_extract_mm256_xor_si256(
        s[((size_t)4U * i0 + (size_t)2U) / (size_t)5U]
         [((size_t)4U * i0 + (size_t)2U) % (size_t)5U],
        v2);
    s[((size_t)4U * i0 + (size_t)2U) / (size_t)5U]
     [((size_t)4U * i0 + (size_t)2U) % (size_t)5U] = uu____2;
    uint8_t uu____3 = libcrux_intrinsics_avx2_extract_mm256_xor_si256(
  ...
  core_slice___Slice_T___copy_from_slice(
      ...
      Eurydice_slice_subslice(blocks[3U],
                              ...
                              Eurydice_slice),
      uint8_t, void *);
  uint8_t u = libcrux_intrinsics_avx2_extract_mm256_loadu_si256_u8(
  ...
  uint8_t uu____8 =
      libcrux_intrinsics_avx2_extract_mm256_xor_si256(s[i0][j0], u);
  s[i0][j0] = uu____8;
  if (rem == (size_t)16U) {
    uint8_t u8s0[32U] = {0U};
    ...
    core_slice___Slice_T___copy_from_slice(
        ...
        Eurydice_slice_subslice(
            ...
            uint8_t, core_ops_range_Range__size_t, Eurydice_slice),
        uint8_t, void *);
    uint8_t u0 = libcrux_intrinsics_avx2_extract_mm256_loadu_si256_u8(
    ...
    size_t j =
        ((size_t)4U * ((size_t)136U / (size_t)32U) + (size_t)1U) % (size_t)5U;
    uint8_t uu____13 =
        libcrux_intrinsics_avx2_extract_mm256_xor_si256(s[i][j], u0);
    s[i][j] = uu____13;
  }
}
...
static inline uint8_t rotate_left___36int32_t_28int32_t(uint8_t x) {
  uint8_t uu____0 =
      libcrux_intrinsics_avx2_extract_mm256_slli_epi64((int32_t)36, x, uint8_t);
  return libcrux_intrinsics_avx2_extract_mm256_xor_si256(
      uu____0, libcrux_intrinsics_avx2_extract_mm256_srli_epi64((int32_t)28, x,
                                                                uint8_t));
}
...
static inline uint8_t rotate_left___3int32_t_61int32_t(uint8_t x) {
  uint8_t uu____0 =
      libcrux_intrinsics_avx2_extract_mm256_slli_epi64((int32_t)3, x, uint8_t);
  return libcrux_intrinsics_avx2_extract_mm256_xor_si256(
      uu____0, libcrux_intrinsics_avx2_extract_mm256_srli_epi64((int32_t)61, x,
                                                                uint8_t));
}
...
static inline uint8_t rotate_left___41int32_t_23int32_t(uint8_t x) {
  uint8_t uu____0 =
      libcrux_intrinsics_avx2_extract_mm256_slli_epi64((int32_t)41, x, uint8_t);
  return libcrux_intrinsics_avx2_extract_mm256_xor_si256(
      uu____0, libcrux_intrinsics_avx2_extract_mm256_srli_epi64((int32_t)23, x,
                                                                uint8_t));
}
...
static inline uint8_t rotate_left___18int32_t_46int32_t(uint8_t x) {
  uint8_t uu____0 =
      libcrux_intrinsics_avx2_extract_mm256_slli_epi64((int32_t)18, x, uint8_t);
  return libcrux_intrinsics_avx2_extract_mm256_xor_si256(
      uu____0, libcrux_intrinsics_avx2_extract_mm256_srli_epi64((int32_t)46, x,
                                                                uint8_t));
}
...
static inline uint8_t rotate_left___44int32_t_20int32_t(uint8_t x) {
  uint8_t uu____0 =
      libcrux_intrinsics_avx2_extract_mm256_slli_epi64((int32_t)44, x, uint8_t);
  return libcrux_intrinsics_avx2_extract_mm256_xor_si256(
      uu____0, libcrux_intrinsics_avx2_extract_mm256_srli_epi64((int32_t)20, x,
                                                                uint8_t));
}
...
static inline uint8_t rotate_left___10int32_t_54int32_t(uint8_t x) {
  uint8_t uu____0 =
      libcrux_intrinsics_avx2_extract_mm256_slli_epi64((int32_t)10, x, uint8_t);
  return libcrux_intrinsics_avx2_extract_mm256_xor_si256(
      uu____0, libcrux_intrinsics_avx2_extract_mm256_srli_epi64((int32_t)54, x,
                                                                uint8_t));
}
...
static inline uint8_t rotate_left___45int32_t_19int32_t(uint8_t x) {
  uint8_t uu____0 =
      libcrux_intrinsics_avx2_extract_mm256_slli_epi64((int32_t)45, x, uint8_t);
  return libcrux_intrinsics_avx2_extract_mm256_xor_si256(
      uu____0, libcrux_intrinsics_avx2_extract_mm256_srli_epi64((int32_t)19, x,
                                                                uint8_t));
}
...
static inline uint8_t rotate_left___2int32_t_62int32_t(uint8_t x) {
  uint8_t uu____0 =
      libcrux_intrinsics_avx2_extract_mm256_slli_epi64((int32_t)2, x, uint8_t);
  return libcrux_intrinsics_avx2_extract_mm256_xor_si256(
      uu____0, libcrux_intrinsics_avx2_extract_mm256_srli_epi64((int32_t)62, x,
                                                                uint8_t));
}
...
static inline uint8_t rotate_left___62int32_t_2int32_t(uint8_t x) {
  uint8_t uu____0 =
      libcrux_intrinsics_avx2_extract_mm256_slli_epi64((int32_t)62, x, uint8_t);
  return libcrux_intrinsics_avx2_extract_mm256_xor_si256(
      uu____0,
      libcrux_intrinsics_avx2_extract_mm256_srli_epi64((int32_t)2, x, uint8_t));
}
...
static inline uint8_t rotate_left___6int32_t_58int32_t(uint8_t x) {
  uint8_t uu____0 =
      libcrux_intrinsics_avx2_extract_mm256_slli_epi64((int32_t)6, x, uint8_t);
  return libcrux_intrinsics_avx2_extract_mm256_xor_si256(
      uu____0, libcrux_intrinsics_avx2_extract_mm256_srli_epi64((int32_t)58, x,
                                                                uint8_t));
}
...
static inline uint8_t rotate_left___43int32_t_21int32_t(uint8_t x) {
  uint8_t uu____0 =
      libcrux_intrinsics_avx2_extract_mm256_slli_epi64((int32_t)43, x, uint8_t);
  return libcrux_intrinsics_avx2_extract_mm256_xor_si256(
      uu____0, libcrux_intrinsics_avx2_extract_mm256_srli_epi64((int32_t)21, x,
                                                                uint8_t));
}
...
static inline uint8_t rotate_left___15int32_t_49int32_t(uint8_t x) {
  uint8_t uu____0 =
      libcrux_intrinsics_avx2_extract_mm256_slli_epi64((int32_t)15, x, uint8_t);
  return libcrux_intrinsics_avx2_extract_mm256_xor_si256(
      uu____0, libcrux_intrinsics_avx2_extract_mm256_srli_epi64((int32_t)49, x,
                                                                uint8_t));
}
...
static inline uint8_t rotate_left___61int32_t_3int32_t(uint8_t x) {
  uint8_t uu____0 =
      libcrux_intrinsics_avx2_extract_mm256_slli_epi64((int32_t)61, x, uint8_t);
  return libcrux_intrinsics_avx2_extract_mm256_xor_si256(
      uu____0,
      libcrux_intrinsics_avx2_extract_mm256_srli_epi64((int32_t)3, x, uint8_t));
}
...
static inline uint8_t rotate_left___28int32_t_36int32_t(uint8_t x) {
  uint8_t uu____0 =
      libcrux_intrinsics_avx2_extract_mm256_slli_epi64((int32_t)28, x, uint8_t);
  return libcrux_intrinsics_avx2_extract_mm256_xor_si256(
      uu____0, libcrux_intrinsics_avx2_extract_mm256_srli_epi64((int32_t)36, x,
                                                                uint8_t));
}
...
static inline uint8_t rotate_left___55int32_t_9int32_t(uint8_t x) {
  uint8_t uu____0 =
      libcrux_intrinsics_avx2_extract_mm256_slli_epi64((int32_t)55, x, uint8_t);
  return libcrux_intrinsics_avx2_extract_mm256_xor_si256(
      uu____0,
      libcrux_intrinsics_avx2_extract_mm256_srli_epi64((int32_t)9, x, uint8_t));
}
...
static inline uint8_t rotate_left___25int32_t_39int32_t(uint8_t x) {
  uint8_t uu____0 =
      libcrux_intrinsics_avx2_extract_mm256_slli_epi64((int32_t)25, x, uint8_t);
  return libcrux_intrinsics_avx2_extract_mm256_xor_si256(
      uu____0, libcrux_intrinsics_avx2_extract_mm256_srli_epi64((int32_t)39, x,
                                                                uint8_t));
}
...
static inline uint8_t rotate_left___21int32_t_43int32_t(uint8_t x) {
  uint8_t uu____0 =
      libcrux_intrinsics_avx2_extract_mm256_slli_epi64((int32_t)21, x, uint8_t);
  return libcrux_intrinsics_avx2_extract_mm256_xor_si256(
      uu____0, libcrux_intrinsics_avx2_extract_mm256_srli_epi64((int32_t)43, x,
                                                                uint8_t));
}
...
static inline uint8_t rotate_left___56int32_t_8int32_t(uint8_t x) {
  uint8_t uu____0 =
      libcrux_intrinsics_avx2_extract_mm256_slli_epi64((int32_t)56, x, uint8_t);
  return libcrux_intrinsics_avx2_extract_mm256_xor_si256(
      uu____0,
      libcrux_intrinsics_avx2_extract_mm256_srli_epi64((int32_t)8, x, uint8_t));
}
...
static inline uint8_t rotate_left___27int32_t_37int32_t(uint8_t x) {
  uint8_t uu____0 =
      libcrux_intrinsics_avx2_extract_mm256_slli_epi64((int32_t)27, x, uint8_t);
  return libcrux_intrinsics_avx2_extract_mm256_xor_si256(
      uu____0, libcrux_intrinsics_avx2_extract_mm256_srli_epi64((int32_t)37, x,
                                                                uint8_t));
}
...
static inline uint8_t rotate_left___20int32_t_44int32_t(uint8_t x) {
  uint8_t uu____0 =
      libcrux_intrinsics_avx2_extract_mm256_slli_epi64((int32_t)20, x, uint8_t);
  return libcrux_intrinsics_avx2_extract_mm256_xor_si256(
      uu____0, libcrux_intrinsics_avx2_extract_mm256_srli_epi64((int32_t)44, x,
                                                                uint8_t));
}
...
static inline uint8_t rotate_left___39int32_t_25int32_t(uint8_t x) {
  uint8_t uu____0 =
      libcrux_intrinsics_avx2_extract_mm256_slli_epi64((int32_t)39, x, uint8_t);
  return libcrux_intrinsics_avx2_extract_mm256_xor_si256(
      uu____0, libcrux_intrinsics_avx2_extract_mm256_srli_epi64((int32_t)25, x,
                                                                uint8_t));
}
...
static inline uint8_t rotate_left___8int32_t_56int32_t(uint8_t x) {
  uint8_t uu____0 =
      libcrux_intrinsics_avx2_extract_mm256_slli_epi64((int32_t)8, x, uint8_t);
  return libcrux_intrinsics_avx2_extract_mm256_xor_si256(
      uu____0, libcrux_intrinsics_avx2_extract_mm256_srli_epi64((int32_t)56, x,
                                                                uint8_t));
}
...
static inline uint8_t rotate_left___14int32_t_50int32_t(uint8_t x) {
  uint8_t uu____0 =
      libcrux_intrinsics_avx2_extract_mm256_slli_epi64((int32_t)14, x, uint8_t);
  return libcrux_intrinsics_avx2_extract_mm256_xor_si256(
      uu____0, libcrux_intrinsics_avx2_extract_mm256_srli_epi64((int32_t)50, x,
                                                                uint8_t));
}
...
static inline void theta_rho__uint8_t_4size_t(
...
static inline void pi__uint8_t_4size_t(
    libcrux_sha3_generic_keccak_KeccakState__uint8_t__4size_t *s) {
  uint8_t old[5U][5U];
...
static inline void chi__uint8_t_4size_t(
    libcrux_sha3_generic_keccak_KeccakState__uint8_t__4size_t *s) {
  uint8_t old[5U][5U];
...
static inline void iota__uint8_t_4size_t(
    libcrux_sha3_generic_keccak_KeccakState__uint8_t__4size_t *s, size_t i) {
  uint8_t uu____0 = xor_constant(s->st[0U][0U],
                                 libcrux_sha3_generic_keccak_ROUNDCONSTANTS[i]);
  s->st[0U][0U] = uu____0;
}

static inline void keccakf1600__uint8_t_4size_t(
    libcrux_sha3_generic_keccak_KeccakState__uint8_t__4size_t *s) {
  for (size_t i = (size_t)0U; i < (size_t)24U; i++) {
    size_t i0 = i;
    theta_rho__uint8_t_4size_t(s);
    pi__uint8_t_4size_t(s);
    chi__uint8_t_4size_t(s);
    iota__uint8_t_4size_t(s, i0);
  }
}

static inline void absorb_block__uint8_t_4size_t_136size_t(
    libcrux_sha3_generic_keccak_KeccakState__uint8_t__4size_t *s,
    Eurydice_slice blocks[4U]) {
  ...
  keccakf1600__uint8_t_4size_t(s);
}
...
static inline void absorb_final__uint8_t_4size_t_136size_t_31uint8_t(
    libcrux_sha3_generic_keccak_KeccakState__uint8_t__4size_t *s,
...
static inline void store_block___136size_t(uint8_t (*s)[5U],
  ...
  for (size_t i = (size_t)0U; i < (size_t)136U / (size_t)32U; i++) {
    size_t i0 = i;
    uint8_t v0l = libcrux_intrinsics_avx2_extract_mm256_permute2x128_si256(
        (int32_t)32,
        s[(size_t)4U * i0 / (size_t)5U][(size_t)4U * i0 % (size_t)5U],
        s[((size_t)4U * i0 + (size_t)2U) / (size_t)5U]
         [((size_t)4U * i0 + (size_t)2U) % (size_t)5U],
        uint8_t);
    uint8_t v1h = libcrux_intrinsics_avx2_extract_mm256_permute2x128_si256(
        (int32_t)32,
        s[((size_t)4U * i0 + (size_t)1U) / (size_t)5U]
         [((size_t)4U * i0 + (size_t)1U) % (size_t)5U],
        s[((size_t)4U * i0 + (size_t)3U) / (size_t)5U]
         [((size_t)4U * i0 + (size_t)3U) % (size_t)5U],
        uint8_t);
    uint8_t v2l = libcrux_intrinsics_avx2_extract_mm256_permute2x128_si256(
        (int32_t)49,
        s[(size_t)4U * i0 / (size_t)5U][(size_t)4U * i0 % (size_t)5U],
        s[((size_t)4U * i0 + (size_t)2U) / (size_t)5U]
         [((size_t)4U * i0 + (size_t)2U) % (size_t)5U],
        uint8_t);
    uint8_t v3h = libcrux_intrinsics_avx2_extract_mm256_permute2x128_si256(
        (int32_t)49,
        s[((size_t)4U * i0 + (size_t)1U) / (size_t)5U]
         [((size_t)4U * i0 + (size_t)1U) % (size_t)5U],
        s[((size_t)4U * i0 + (size_t)3U) / (size_t)5U]
         [((size_t)4U * i0 + (size_t)3U) % (size_t)5U],
        uint8_t);
    uint8_t v0 = libcrux_intrinsics_avx2_extract_mm256_unpacklo_epi64(v0l, v1h);
    uint8_t v1 = libcrux_intrinsics_avx2_extract_mm256_unpackhi_epi64(v0l, v1h);
    uint8_t v2 = libcrux_intrinsics_avx2_extract_mm256_unpacklo_epi64(v2l, v3h);
    uint8_t v3 = libcrux_intrinsics_avx2_extract_mm256_unpackhi_epi64(v2l, v3h);
    libcrux_intrinsics_avx2_extract_mm256_storeu_si256_u8(
  ...
  libcrux_intrinsics_avx2_extract_mm256_storeu_si256_u8(uu____0, s[i0][j0]);
  Eurydice_slice uu____1 = Eurydice_slice_subslice(
      out[0U],
      (CLITERAL(core_ops_range_Range__size_t){.start = start,
                                              .end = start + (size_t)8U}),
  ...
  if (rem == (size_t)16U) {
    ...
    libcrux_intrinsics_avx2_extract_mm256_storeu_si256_u8(uu____5, s[i][j]);
...
static inline void squeeze_first_and_last__uint8_t_4size_t_136size_t(
    libcrux_sha3_generic_keccak_KeccakState__uint8_t__4size_t *s,
    Eurydice_slice out[4U]) {
  uint8_t b[4U][200U];
...
static inline void squeeze_first_block__uint8_t_4size_t_136size_t(
    libcrux_sha3_generic_keccak_KeccakState__uint8_t__4size_t *s,
    Eurydice_slice out[4U]) {
  store_block___136size_t0(s->st, out);
}

static inline void squeeze_next_block__uint8_t_4size_t_136size_t(
    libcrux_sha3_generic_keccak_KeccakState__uint8_t__4size_t *s,
    Eurydice_slice out[4U]) {
  keccakf1600__uint8_t_4size_t(s);
  store_block___136size_t0(s->st, out);
...
static inline void squeeze_last__uint8_t_4size_t_136size_t(
    libcrux_sha3_generic_keccak_KeccakState__uint8_t__4size_t s,
    Eurydice_slice out[4U]) {
  keccakf1600__uint8_t_4size_t(&s);
  uint8_t b[4U][200U];
...
static inline void keccak__uint8_t_4size_t_136size_t_31uint8_t(
  ...
  slice_n(uu____3, core_slice___Slice_T___len(data[0U], uint8_t, size_t) - rem,
          rem, ret);
  absorb_final__uint8_t_4size_t_136size_t_31uint8_t(uu____2, ret);
  size_t outlen = core_slice___Slice_T___len(out[0U], uint8_t, size_t);
  size_t blocks = outlen / (size_t)136U;
  size_t last = outlen - outlen % (size_t)136U;
  if (blocks == (size_t)0U) {
    squeeze_first_and_last__uint8_t_4size_t_136size_t(&s, out);
  } else {
    ...
    squeeze_first_block__uint8_t_4size_t_136size_t(&s, o0);
    ...
    while (true) {
      if (core_iter_range___core__iter__traits__iterator__Iterator_for_core__ops__range__Range_A___6__next(
        ...
        squeeze_next_block__uint8_t_4size_t_136size_t(&s, o);
        memcpy(o1, orest, (size_t)4U * sizeof(Eurydice_slice));
      }
    }
    if (last < outlen) {
      squeeze_last__uint8_t_4size_t_136size_t(s, o1);
    }
  }
}
...
static inline void absorb_final__uint8_t_4size_t_168size_t_31uint8_t(
    libcrux_sha3_generic_keccak_KeccakState__uint8_t__4size_t *s,
    Eurydice_slice last[4U]) {
  size_t last_len = core_slice___Slice_T___len(last[0U], uint8_t, size_t);
  uint8_t blocks[4U][200U] = {{0U}};
...
void libcrux_sha3_avx2_x4_incremental_shake128_absorb_final(
  ...
  absorb_final__uint8_t_4size_t_168size_t_31uint8_t(s, buf);
}
...
static inline void squeeze_next_block__uint8_t_4size_t_168size_t(
    libcrux_sha3_generic_keccak_KeccakState__uint8_t__4size_t *s,
    Eurydice_slice out[4U]) {
  keccakf1600__uint8_t_4size_t(s);
...
void libcrux_sha3_avx2_x4_incremental_shake128_squeeze_next_block(
    ...
    Eurydice_slice out3) {
  Eurydice_slice buf[4U] = {out0, out1, out2, out3};
  squeeze_next_block__uint8_t_4size_t_168size_t(s, buf);
}

static inline void squeeze_first_block__uint8_t_4size_t_168size_t(
    libcrux_sha3_generic_keccak_KeccakState__uint8_t__4size_t *s,
    Eurydice_slice out[4U]) {
  store_block___168size_t0(s->st, out);
}

static inline void squeeze_first_three_blocks__uint8_t_4size_t_168size_t(
    libcrux_sha3_generic_keccak_KeccakState__uint8_t__4size_t *s,
    Eurydice_slice out[4U]) {
  ...
  squeeze_first_block__uint8_t_4size_t_168size_t(s, o0);
  ...
  squeeze_next_block__uint8_t_4size_t_168size_t(s, o1);
  squeeze_next_block__uint8_t_4size_t_168size_t(s, o2);
}
...
void libcrux_sha3_avx2_x4_incremental_shake128_squeeze_first_three_blocks(
    ...
    Eurydice_slice out3) {
  Eurydice_slice buf[4U] = {out0, out1, out2, out3};
  squeeze_first_three_blocks__uint8_t_4size_t_168size_t(s, buf);
}
