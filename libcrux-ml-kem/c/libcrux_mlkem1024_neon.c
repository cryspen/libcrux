...
decapsulate_e0(Eurydice_arr_17 *private_key, Eurydice_arr_00 *ciphertext)
{
...
generate_keypair_b4(libcrux_sha3_Sha3_512Digest *randomness)
{
...
validate_private_key_6b(Eurydice_arr_17 *private_key, Eurydice_arr_00 *ciphertext)
{
...
- SECRET_KEY_SIZE= 3168
*/
static KRML_MUSTINLINE bool validate_private_key_only_44(Eurydice_arr_17 *private_key)
{
...
- PUBLIC_KEY_SIZE= 1568
*/
static KRML_MUSTINLINE bool validate_public_key_44(Eurydice_arr_00 *public_key)
{
...
*/
Eurydice_arr_60
libcrux_ml_kem_mlkem1024_neon_unpacked_decapsulate(
  libcrux_ml_kem_mlkem1024_neon_unpacked_MlKem1024KeyPairUnpacked *private_key,
  Eurydice_arr_00 *ciphertext
)
{
...
*/
tuple_2b
libcrux_ml_kem_mlkem1024_neon_unpacked_encapsulate(
  libcrux_ml_kem_ind_cca_unpacked_MlKemPublicKeyUnpacked_56 *public_key,
  Eurydice_arr_60 randomness
)
{
...
*/
void
libcrux_ml_kem_mlkem1024_neon_unpacked_generate_key_pair_mut(
  libcrux_sha3_Sha3_512Digest randomness,
  libcrux_ml_kem_mlkem1024_neon_unpacked_MlKem1024KeyPairUnpacked *key_pair
)
{
...
{
  libcrux_ml_kem_mlkem1024_neon_unpacked_MlKem1024KeyPairUnpacked
  key_pair = libcrux_ml_kem_ind_cca_unpacked_default_7b_40();
  libcrux_ml_kem_mlkem1024_neon_unpacked_generate_key_pair_mut(randomness, &key_pair);
  return key_pair;
}
...
*/
static KRML_MUSTINLINE void
keypair_from_private_key_b4(
  Eurydice_arr_17 *private_key,
  libcrux_ml_kem_mlkem1024_neon_unpacked_MlKem1024KeyPairUnpacked *key_pair
)
{
  libcrux_ml_kem_ind_cca_unpacked_keys_from_private_key_21(private_key, key_pair);
}
...
*/
void
libcrux_ml_kem_mlkem1024_neon_unpacked_key_pair_from_private_mut(
  Eurydice_arr_17 *private_key,
  libcrux_ml_kem_mlkem1024_neon_unpacked_MlKem1024KeyPairUnpacked *key_pair
)
{
...
*/
void
libcrux_ml_kem_mlkem1024_neon_unpacked_key_pair_serialized_private_key_mut(
  libcrux_ml_kem_mlkem1024_neon_unpacked_MlKem1024KeyPairUnpacked *key_pair,
  Eurydice_arr_17 *serialized
)
{
  libcrux_ml_kem_ind_cca_unpacked_serialized_private_key_mut_11_fd(key_pair, serialized);
}
...
*/
void
libcrux_ml_kem_mlkem1024_neon_unpacked_key_pair_serialized_public_key_mut(
  libcrux_ml_kem_mlkem1024_neon_unpacked_MlKem1024KeyPairUnpacked *key_pair,
  Eurydice_arr_00 *serialized
)
{
  libcrux_ml_kem_ind_cca_unpacked_serialized_public_key_mut_11_a1(key_pair, serialized);
}
...
*/
void
libcrux_ml_kem_mlkem1024_neon_unpacked_serialized_public_key(
  libcrux_ml_kem_ind_cca_unpacked_MlKemPublicKeyUnpacked_56 *public_key,
  Eurydice_arr_00 *serialized
)
{
...
*/
static KRML_MUSTINLINE void
unpack_public_key_6b(
  Eurydice_arr_00 *public_key,
  libcrux_ml_kem_ind_cca_unpacked_MlKemPublicKeyUnpacked_56 *unpacked_public_key
)
{
  libcrux_ml_kem_ind_cca_unpacked_unpack_public_key_5e(public_key, unpacked_public_key);
}
...
*/
void
libcrux_ml_kem_mlkem1024_neon_unpacked_unpacked_public_key(
  Eurydice_arr_00 *public_key,
  libcrux_ml_kem_ind_cca_unpacked_MlKemPublicKeyUnpacked_56 *unpacked_public_key
)
{
