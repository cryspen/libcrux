...
static void decapsulate_f0(
    ...
    uint8_t ret[32U]) {
  libcrux_ml_kem_ind_cca_decapsulate_51(private_key, ciphertext, ret);
}
...
static void decapsulate_unpacked_f0(
    ...
    libcrux_ml_kem_mlkem1024_MlKem1024Ciphertext *ciphertext,
    uint8_t ret[32U]) {
  libcrux_ml_kem_ind_cca_decapsulate_unpacked_91(key_pair, ciphertext, ret);
}
...
encapsulate_03(libcrux_ml_kem_types_MlKemPublicKey____1568size_t *public_key,
  ...
  return libcrux_ml_kem_ind_cca_encapsulate_51(uu____0, uu____1);
}
...
encapsulate_unpacked_03(
  ...
  uint8_t uu____1[32U];
  memcpy(uu____1, randomness, (size_t)32U * sizeof(uint8_t));
  return libcrux_ml_kem_ind_cca_encapsulate_unpacked_91(uu____0, uu____1);
}
...
static libcrux_ml_kem_mlkem1024_MlKem1024KeyPair generate_keypair_d7(
  ...
  return libcrux_ml_kem_ind_cca_generate_keypair_91(uu____0);
}
...
generate_keypair_unpacked_d7(uint8_t randomness[64U]) {
  uint8_t uu____0[64U];
  memcpy(uu____0, randomness, (size_t)64U * sizeof(uint8_t));
  return libcrux_ml_kem_ind_cca_generate_keypair_unpacked_91(uu____0);
}
...
static bool validate_public_key_65(uint8_t *public_key) {
  return libcrux_ml_kem_ind_cca_validate_public_key_ae(public_key);
}
