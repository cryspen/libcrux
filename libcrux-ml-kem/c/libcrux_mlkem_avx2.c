...
static inline libcrux_sha3_avx2_x4_incremental_KeccakState
...
libcrux_ml_kem_ind_cca_generate_keypair_unpacked__libcrux_ml_kem_vector_avx2_SIMD256Vector_libcrux_ml_kem_hash_functions_avx2_Simd256Hash_3size_t_1152size_t_2400size_t_1184size_t_1152size_t_2size_t_128size_t(
  ...
  H___3size_t(Eurydice_array_to_slice((size_t)1184U, pk_serialized, uint8_t,
              ...
              public_key_hash);
  libcrux_ml_kem_types_unpacked_MlKemPrivateKeyUnpacked__libcrux_ml_kem_vector_avx2_SIMD256Vector__3size_t
      uu____1 = ind_cpa_private_key;
  libcrux_ml_kem_types_unpacked_MlKemPublicKeyUnpacked__libcrux_ml_kem_vector_avx2_SIMD256Vector__3size_t
      uu____2 = ind_cpa_public_key;
  uint8_t uu____3[32U];
  memcpy(uu____3, public_key_hash, (size_t)32U * sizeof(uint8_t));
  libcrux_ml_kem_types_unpacked_MlKemKeyPairUnpacked__libcrux_ml_kem_vector_avx2_SIMD256Vector__3size_t
      lit;
  lit.private_key = uu____1;
  lit.public_key = uu____2;
  memcpy(lit.public_key_hash, uu____3, (size_t)32U * sizeof(uint8_t));
  uint8_t ret[32U];
  core_result_Result__uint8_t_32size_t__core_array_TryFromSliceError dst;
