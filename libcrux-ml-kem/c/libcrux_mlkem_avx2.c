...
*/
static libcrux_ml_kem_polynomial_PolynomialRingElement_d2 ZERO_20_d5(void) {
...
deserialize_to_reduced_ring_element_b4(Eurydice_slice serialized) {
  libcrux_ml_kem_polynomial_PolynomialRingElement_d2 re = ZERO_20_d5();
...
- K= 3
*/
static KRML_MUSTINLINE void deserialize_ring_elements_reduced_bd4(
  ...
  for (size_t i = (size_t)0U;
    ...
    libcrux_ml_kem_polynomial_PolynomialRingElement_d2 uu____0 =
        deserialize_to_reduced_ring_element_b4(ring_element);
...
- SHIFT_BY= 15
*/
static core_core_arch_x86___m256i shift_right_ea_5e(
    core_core_arch_x86___m256i vector) {
  return shift_right_f8(vector);
}
...
static core_core_arch_x86___m256i to_unsigned_representative_d4(
  ...
  core_core_arch_x86___m256i t = shift_right_ea_5e(a);
...
*/
static KRML_MUSTINLINE void serialize_uncompressed_ring_element_d7(
  ...
  for (size_t i = (size_t)0U;
    ...
    size_t i0 = i;
    core_core_arch_x86___m256i coefficient =
        to_unsigned_representative_d4(re->coefficients[i0]);
    uint8_t bytes[24U];
...
- OUT_LEN= 1152
*/
static KRML_MUSTINLINE void serialize_secret_key_a81(
  ...
  for (size_t i = (size_t)0U;
    ...
    Eurydice_slice uu____0 = Eurydice_array_to_subslice2(
        ...
        uint8_t);
    uint8_t ret0[384U];
    serialize_uncompressed_ring_element_d7(&re, ret0);
    Eurydice_slice_copy(
...
static KRML_MUSTINLINE void serialize_public_key_371(
  ...
  uint8_t ret0[1152U];
  serialize_secret_key_a81(t_as_ntt, ret0);
  Eurydice_slice_copy(
...
- PUBLIC_KEY_SIZE= 1184
*/
bool libcrux_ml_kem_ind_cca_validate_public_key_001(uint8_t *public_key) {
  libcrux_ml_kem_polynomial_PolynomialRingElement_d2 deserialized_pk[3U];
  deserialize_ring_elements_reduced_bd4(
...
*/
static KRML_MUSTINLINE libcrux_ml_kem_polynomial_PolynomialRingElement_d2
from_i16_array_20_10(Eurydice_slice a) {
  libcrux_ml_kem_polynomial_PolynomialRingElement_d2 result = ZERO_20_d5();
  for (size_t i = (size_t)0U;
       i < LIBCRUX_ML_KEM_POLYNOMIAL_VECTORS_IN_RING_ELEMENT; i++) {
    size_t i0 = i;
...
*/
static KRML_MUSTINLINE libcrux_ml_kem_polynomial_PolynomialRingElement_d2
sample_from_binomial_distribution_2_25(Eurydice_slice randomness) {
...
*/
static KRML_MUSTINLINE libcrux_ml_kem_polynomial_PolynomialRingElement_d2
sample_from_binomial_distribution_3_92(Eurydice_slice randomness) {
  int16_t sampled_i16s[256U] = {0U};
  for (size_t i0 = (size_t)0U;
...
sample_from_binomial_distribution_920(Eurydice_slice randomness) {
  return sample_from_binomial_distribution_2_25(randomness);
}
...
*/
static KRML_MUSTINLINE void ntt_at_layer_7_64(
...
*/
static core_core_arch_x86___m256i montgomery_multiply_fe_55(
...
ntt_layer_int_vec_step_88(core_core_arch_x86___m256i a,
                          core_core_arch_x86___m256i b, int16_t zeta_r) {
  core_core_arch_x86___m256i t = montgomery_multiply_fe_55(b, zeta_r);
...
*/
static KRML_MUSTINLINE void ntt_at_layer_3_45(
    size_t *zeta_i, libcrux_ml_kem_polynomial_PolynomialRingElement_d2 *re) {
  KRML_MAYBE_FOR16(
...
*/
static KRML_MUSTINLINE void ntt_at_layer_1_83(
    size_t *zeta_i, libcrux_ml_kem_polynomial_PolynomialRingElement_d2 *re) {
  KRML_MAYBE_FOR16(
      i, (size_t)0U, (size_t)16U, (size_t)1U, size_t round = i;
      zeta_i[0U] = zeta_i[0U] + (size_t)1U;
...
*/
static KRML_MUSTINLINE void poly_barrett_reduce_20_94(
...
*/
static KRML_MUSTINLINE void ntt_binomially_sampled_ring_element_48(
    libcrux_ml_kem_polynomial_PolynomialRingElement_d2 *re) {
  ntt_at_layer_7_64(re);
  ...
  ntt_at_layer_3_45(&zeta_i, re);
  ntt_at_layer_2_10(&zeta_i, re);
  ntt_at_layer_1_83(&zeta_i, re);
  poly_barrett_reduce_20_94(re);
}
...
static KRML_MUSTINLINE tuple_b00 sample_vector_cbd_then_ntt_701(
  ...
  KRML_MAYBE_FOR3(
      ...
      ntt_binomially_sampled_ring_element_48(&re_as_ntt[i0]););
  /* Passing arrays by value in Rust generates a copy in C */
...
*/
static KRML_MUSTINLINE libcrux_ml_kem_polynomial_PolynomialRingElement_d2
ntt_multiply_20_41(libcrux_ml_kem_polynomial_PolynomialRingElement_d2 *self,
                   libcrux_ml_kem_polynomial_PolynomialRingElement_d2 *rhs) {
  libcrux_ml_kem_polynomial_PolynomialRingElement_d2 out = ZERO_20_d5();
  for (size_t i = (size_t)0U;
       i < LIBCRUX_ML_KEM_POLYNOMIAL_VECTORS_IN_RING_ELEMENT; i++) {
    size_t i0 = i;
...
- K= 3
*/
static KRML_MUSTINLINE void add_to_ring_element_20_871(
    libcrux_ml_kem_polynomial_PolynomialRingElement_d2 *self,
    libcrux_ml_kem_polynomial_PolynomialRingElement_d2 *rhs) {
  for (size_t i = (size_t)0U;
       i < Eurydice_slice_len(
...
*/
static core_core_arch_x86___m256i to_standard_domain_f0(
    core_core_arch_x86___m256i v) {
...
*/
static KRML_MUSTINLINE void add_standard_error_reduce_20_a5(
    libcrux_ml_kem_polynomial_PolynomialRingElement_d2 *self,
  ...
  for (size_t i = (size_t)0U;
    ...
    core_core_arch_x86___m256i coefficient_normal_form =
        to_standard_domain_f0(self->coefficients[j]);
...
- K= 3
*/
static KRML_MUSTINLINE void compute_As_plus_e_bb1(
  ...
  for (size_t i0 = (size_t)0U;
    ...
    for (size_t i = (size_t)0U;
      ...
      libcrux_ml_kem_polynomial_PolynomialRingElement_d2 product =
          ntt_multiply_20_41(matrix_element, &s_as_ntt[j]);
      add_to_ring_element_20_871(&result0[i1], &product);
    }
    add_standard_error_reduce_20_a5(&result0[i1], &error_as_ntt[i1]);
  }
...
*/
static tuple_9b0 generate_keypair_unpacked_751(
  ...
  tuple_b00 uu____2 = sample_vector_cbd_then_ntt_701(copy_of_prf_input0, 0U);
  ...
  memcpy(
      error_as_ntt,
      sample_vector_cbd_then_ntt_701(copy_of_prf_input, domain_separator).fst,
      (size_t)3U * sizeof(libcrux_ml_kem_polynomial_PolynomialRingElement_d2));
  libcrux_ml_kem_polynomial_PolynomialRingElement_d2 t_as_ntt[3U];
  compute_As_plus_e_bb1(A_transpose, secret_as_ntt, error_as_ntt, t_as_ntt);
...
*/
static inline libcrux_ml_kem_polynomial_PolynomialRingElement_d2 clone_3a_47(
    libcrux_ml_kem_polynomial_PolynomialRingElement_d2 *self) {
  libcrux_ml_kem_polynomial_PolynomialRingElement_d2 lit;
...
libcrux_ml_kem_ind_cca_unpacked_generate_keypair_unpacked_061(
  ...
  Eurydice_slice implicit_rejection_value0 = Eurydice_array_to_subslice_from(
      ...
      LIBCRUX_ML_KEM_CONSTANTS_CPA_PKE_KEY_GENERATION_SEED_SIZE, uint8_t,
      size_t);
  tuple_9b0 uu____0 = generate_keypair_unpacked_751(ind_cpa_keypair_randomness);
  ...
  KRML_MAYBE_FOR3(i, (size_t)0U, (size_t)3U, (size_t)1U, closure_ce1(A[i]););
  KRML_MAYBE_FOR3(
      i0, (size_t)0U, (size_t)3U, (size_t)1U, size_t i1 = i0; KRML_MAYBE_FOR3(
          ...
          libcrux_ml_kem_polynomial_PolynomialRingElement_d2 uu____1 =
              clone_3a_47(&ind_cpa_public_key.A[j][i1]);
          A[i1][j] = uu____1;););
...
- ETA1_RANDOMNESS_SIZE= 128
*/
static libcrux_ml_kem_utils_extraction_helper_Keypair768 generate_keypair_541(
    Eurydice_slice key_generation_seed) {
  tuple_9b0 uu____0 = generate_keypair_unpacked_751(key_generation_seed);
  ...
  serialize_secret_key_a81(sk.secret_as_ntt, secret_key_serialized);
  /* Passing arrays by value in Rust generates a copy in C */
...
*/
static KRML_MUSTINLINE void serialize_kem_secret_key_171(
...
libcrux_ml_kem_ind_cca_generate_keypair_3f1(uint8_t randomness[64U]) {
  Eurydice_slice ind_cpa_keypair_randomness = Eurydice_array_to_subslice2(
      randomness, (size_t)0U,
      LIBCRUX_ML_KEM_CONSTANTS_CPA_PKE_KEY_GENERATION_SEED_SIZE, uint8_t);
  ...
  libcrux_ml_kem_utils_extraction_helper_Keypair768 uu____0 =
      generate_keypair_541(ind_cpa_keypair_randomness);
  uint8_t ind_cpa_private_key[1152U];
  memcpy(ind_cpa_private_key, uu____0.fst, (size_t)1152U * sizeof(uint8_t));
  uint8_t public_key[1184U];
  memcpy(public_key, uu____0.snd, (size_t)1184U * sizeof(uint8_t));
  uint8_t secret_key_serialized[2400U];
  serialize_kem_secret_key_171(
...
sample_ring_element_cbd_991(uint8_t prf_input[33U], uint8_t domain_separator) {
  libcrux_ml_kem_polynomial_PolynomialRingElement_d2 error_1[3U];
  KRML_MAYBE_FOR3(i, (size_t)0U, (size_t)3U, (size_t)1U,
                  error_1[i] = ZERO_20_d5(););
  /* Passing arrays by value in Rust generates a copy in C */
  uint8_t copy_of_prf_input[33U];
  memcpy(copy_of_prf_input, prf_input, (size_t)33U * sizeof(uint8_t));
  uint8_t prf_inputs[3U][33U];
  ...
  KRML_MAYBE_FOR3(
      i, (size_t)0U, (size_t)3U, (size_t)1U, size_t i0 = i;
      libcrux_ml_kem_polynomial_PolynomialRingElement_d2 uu____1 =
          sample_from_binomial_distribution_920(
              Eurydice_array_to_slice((size_t)128U, prf_outputs[i0], uint8_t));
      error_1[i0] = uu____1;);
  /* Passing arrays by value in Rust generates a copy in C */
...
*/
static KRML_MUSTINLINE void invert_ntt_at_layer_1_62(
    size_t *zeta_i, libcrux_ml_kem_polynomial_PolynomialRingElement_d2 *re) {
  KRML_MAYBE_FOR16(
      i, (size_t)0U, (size_t)16U, (size_t)1U, size_t round = i;
      zeta_i[0U] = zeta_i[0U] - (size_t)1U;
...
*/
static KRML_MUSTINLINE void invert_ntt_at_layer_3_8e(
    size_t *zeta_i, libcrux_ml_kem_polynomial_PolynomialRingElement_d2 *re) {
  KRML_MAYBE_FOR16(
      i, (size_t)0U, (size_t)16U, (size_t)1U, size_t round = i;
      zeta_i[0U] = zeta_i[0U] - (size_t)1U;
...
*/
static KRML_MUSTINLINE libcrux_ml_kem_vector_avx2_SIMD256Vector_x2
inv_ntt_layer_int_vec_step_reduce_75(core_core_arch_x86___m256i a,
  ...
  b = montgomery_multiply_fe_55(a_minus_b, zeta_r);
  return (CLITERAL(libcrux_ml_kem_vector_avx2_SIMD256Vector_x2){.fst = a,
                                                                .snd = b});
}
...
*/
static KRML_MUSTINLINE void invert_ntt_at_layer_4_plus_f8(
    size_t *zeta_i, libcrux_ml_kem_polynomial_PolynomialRingElement_d2 *re,
    size_t layer) {
  size_t step = (size_t)1U << (uint32_t)layer;
  for (size_t i0 = (size_t)0U; i0 < (size_t)128U >> (uint32_t)layer; i0++) {
...
- K= 3
*/
static KRML_MUSTINLINE void invert_ntt_montgomery_8e1(
    libcrux_ml_kem_polynomial_PolynomialRingElement_d2 *re) {
  size_t zeta_i =
      LIBCRUX_ML_KEM_CONSTANTS_COEFFICIENTS_IN_RING_ELEMENT / (size_t)2U;
  invert_ntt_at_layer_1_62(&zeta_i, re);
  invert_ntt_at_layer_2_53(&zeta_i, re);
  invert_ntt_at_layer_3_8e(&zeta_i, re);
  invert_ntt_at_layer_4_plus_f8(&zeta_i, re, (size_t)4U);
  invert_ntt_at_layer_4_plus_f8(&zeta_i, re, (size_t)5U);
  invert_ntt_at_layer_4_plus_f8(&zeta_i, re, (size_t)6U);
  invert_ntt_at_layer_4_plus_f8(&zeta_i, re, (size_t)7U);
  poly_barrett_reduce_20_94(re);
}
...
*/
static KRML_MUSTINLINE void add_error_reduce_20_44(
    libcrux_ml_kem_polynomial_PolynomialRingElement_d2 *self,
    libcrux_ml_kem_polynomial_PolynomialRingElement_d2 *error) {
  for (size_t i = (size_t)0U;
       i < LIBCRUX_ML_KEM_POLYNOMIAL_VECTORS_IN_RING_ELEMENT; i++) {
...
- K= 3
*/
static KRML_MUSTINLINE void compute_vector_u_7b1(
  ...
  for (size_t i0 = (size_t)0U;
    ...
    for (size_t i = (size_t)0U;
      ...
      libcrux_ml_kem_polynomial_PolynomialRingElement_d2 product =
          ntt_multiply_20_41(a_element, &r_as_ntt[j]);
      add_to_ring_element_20_871(&result0[i1], &product);
    }
    invert_ntt_montgomery_8e1(&result0[i1]);
    add_error_reduce_20_44(&result0[i1], &error_1[i1]);
  }
  libcrux_ml_kem_polynomial_PolynomialRingElement_d2 result[3U];
  memcpy(
      result, result0,
...
*/
static core_core_arch_x86___m256i decompress_1_0c(
    core_core_arch_x86___m256i v) {
...
*/
static KRML_MUSTINLINE libcrux_ml_kem_polynomial_PolynomialRingElement_d2
deserialize_then_decompress_message_bb(uint8_t serialized[32U]) {
  libcrux_ml_kem_polynomial_PolynomialRingElement_d2 re = ZERO_20_d5();
  KRML_MAYBE_FOR16(
      ...
      core_core_arch_x86___m256i coefficient_compressed =
          libcrux_ml_kem_vector_avx2_deserialize_1_ea(
              Eurydice_array_to_subslice2(serialized, (size_t)2U * i0,
                                          ...
                                          uint8_t));
      re.coefficients[i0] = decompress_1_0c(coefficient_compressed););
  return re;
}
...
*/
static KRML_MUSTINLINE libcrux_ml_kem_polynomial_PolynomialRingElement_d2
add_message_error_reduce_20_d5(
    libcrux_ml_kem_polynomial_PolynomialRingElement_d2 *self,
...
compute_ring_element_v_321(
  ...
  KRML_MAYBE_FOR3(i, (size_t)0U, (size_t)3U, (size_t)1U, size_t i0 = i;
                  libcrux_ml_kem_polynomial_PolynomialRingElement_d2 product =
                      ntt_multiply_20_41(&t_as_ntt[i0], &r_as_ntt[i0]);
                  add_to_ring_element_20_871(&result, &product););
  invert_ntt_montgomery_8e1(&result);
  result = add_message_error_reduce_20_d5(error_2, message, result);
  return result;
}
...
- COEFFICIENT_BITS= 10
*/
static core_core_arch_x86___m256i compress_ea_2e(
    core_core_arch_x86___m256i vector) {
  return compress_ciphertext_coefficient_bc(vector);
}
...
- OUT_LEN= 320
*/
static KRML_MUSTINLINE void compress_then_serialize_10_fd(
  ...
  for (size_t i = (size_t)0U;
    ...
    size_t i0 = i;
    core_core_arch_x86___m256i coefficient =
        compress_ea_2e(to_unsigned_representative_d4(re->coefficients[i0]));
    uint8_t bytes[20U];
...
- COEFFICIENT_BITS= 11
*/
static core_core_arch_x86___m256i compress_ea_2e0(
    core_core_arch_x86___m256i vector) {
  return compress_ciphertext_coefficient_bc0(vector);
}
...
- OUT_LEN= 320
*/
static KRML_MUSTINLINE void compress_then_serialize_ring_element_u_71(
    libcrux_ml_kem_polynomial_PolynomialRingElement_d2 *re, uint8_t ret[320U]) {
  uint8_t uu____0[320U];
  compress_then_serialize_10_fd(re, uu____0);
...
- BLOCK_LEN= 320
*/
static void compress_then_serialize_u_7a1(
  ...
  for (size_t i = (size_t)0U;
    ...
    uint8_t ret[320U];
    compress_then_serialize_ring_element_u_71(&re, ret);
    Eurydice_slice_copy(
...
- COEFFICIENT_BITS= 4
*/
static core_core_arch_x86___m256i compress_ea_2e1(
    core_core_arch_x86___m256i vector) {
  return compress_ciphertext_coefficient_bc1(vector);
}
...
static KRML_MUSTINLINE void compress_then_serialize_4_f8(
  ...
  for (size_t i = (size_t)0U;
    ...
    size_t i0 = i;
    core_core_arch_x86___m256i coefficient =
        compress_ea_2e1(to_unsigned_representative_d4(re.coefficients[i0]));
    uint8_t bytes[8U];
...
*/
static KRML_MUSTINLINE core_core_arch_x86___m256i
compress_ciphertext_coefficient_bc2(core_core_arch_x86___m256i vector) {
  core_core_arch_x86___m256i field_modulus_halved =
      libcrux_intrinsics_avx2_mm256_set1_epi32(
          ((int32_t)LIBCRUX_ML_KEM_VECTOR_TRAITS_FIELD_MODULUS - (int32_t)1) /
          (int32_t)2);
...
- COEFFICIENT_BITS= 5
*/
static core_core_arch_x86___m256i compress_ea_2e2(
    core_core_arch_x86___m256i vector) {
  return compress_ciphertext_coefficient_bc2(vector);
}
...
static KRML_MUSTINLINE void compress_then_serialize_5_11(
  ...
  for (size_t i = (size_t)0U;
    ...
    size_t i0 = i;
    core_core_arch_x86___m256i coefficients =
        compress_ea_2e2(to_unsigned_representative_d4(re.coefficients[i0]));
    uint8_t bytes[10U];
...
- OUT_LEN= 128
*/
static KRML_MUSTINLINE void compress_then_serialize_ring_element_v_07(
...
- ETA2_RANDOMNESS_SIZE= 128
*/
static void encrypt_unpacked_5a1(
  ...
  uint8_t copy_of_prf_input0[33U];
  memcpy(copy_of_prf_input0, prf_input, (size_t)33U * sizeof(uint8_t));
  tuple_b00 uu____1 = sample_vector_cbd_then_ntt_701(copy_of_prf_input0, 0U);
  ...
  memcpy(copy_of_prf_input, prf_input, (size_t)33U * sizeof(uint8_t));
  tuple_b00 uu____3 =
      sample_ring_element_cbd_991(copy_of_prf_input, domain_separator0);
  libcrux_ml_kem_polynomial_PolynomialRingElement_d2 error_1[3U];
  memcpy(
      error_1, uu____3.fst,
      (size_t)3U * sizeof(libcrux_ml_kem_polynomial_PolynomialRingElement_d2));
  ...
  compute_vector_u_7b1(public_key->A, r_as_ntt, error_1, u);
  /* Passing arrays by value in Rust generates a copy in C */
  ...
  libcrux_ml_kem_polynomial_PolynomialRingElement_d2 message_as_ring_element =
      deserialize_then_decompress_message_bb(copy_of_message);
  libcrux_ml_kem_polynomial_PolynomialRingElement_d2 v =
      compute_ring_element_v_321(public_key->t_as_ntt, r_as_ntt, &error_2,
  ...
  compress_then_serialize_ring_element_v_07(
...
- ETA2_RANDOMNESS_SIZE= 128
*/
tuple_3c libcrux_ml_kem_ind_cca_unpacked_encapsulate_unpacked_981(
  ...
  encrypt_unpacked_5a1(uu____2, copy_of_randomness, pseudorandomness,
                       ciphertext);
...
- K= 3
*/
static KRML_MUSTINLINE void entropy_preprocess_af_021(Eurydice_slice randomness,
                                                      uint8_t ret[32U]) {
  core_result_Result_00 dst;
...
- K= 3
*/
static KRML_MUSTINLINE void deserialize_ring_elements_reduced_bd3(
    Eurydice_slice public_key,
    libcrux_ml_kem_polynomial_PolynomialRingElement_d2 ret[3U]) {
  libcrux_ml_kem_polynomial_PolynomialRingElement_d2 deserialized_pk[3U];
  KRML_MAYBE_FOR3(i, (size_t)0U, (size_t)3U, (size_t)1U,
...
- ETA2_RANDOMNESS_SIZE= 128
*/
static void encrypt_de1(Eurydice_slice public_key, uint8_t message[32U],
                        Eurydice_slice randomness, uint8_t ret[1088U]) {
  libcrux_ml_kem_polynomial_PolynomialRingElement_d2 t_as_ntt[3U];
  deserialize_ring_elements_reduced_bd3(
  ...
  encrypt_unpacked_5a1(uu____3, copy_of_message, randomness, result);
...
- CIPHERTEXT_SIZE= 1088
*/
static KRML_MUSTINLINE void kdf_af_401(Eurydice_slice shared_secret,
                                       uint8_t ret[32U]) {
  core_result_Result_00 dst;
...
tuple_3c libcrux_ml_kem_ind_cca_encapsulate_231(
  ...
  uint8_t ciphertext[1088U];
  encrypt_de1(uu____2, copy_of_randomness, pseudorandomness, ciphertext);
  /* Passing arrays by value in Rust generates a copy in C */
  uint8_t copy_of_ciphertext[1088U];
  memcpy(copy_of_ciphertext, ciphertext, (size_t)1088U * sizeof(uint8_t));
  ...
  kdf_af_401(shared_secret, shared_secret_array);
...
- COEFFICIENT_BITS= 10
*/
static core_core_arch_x86___m256i decompress_ciphertext_coefficient_ea_d9(
    core_core_arch_x86___m256i vector) {
  return decompress_ciphertext_coefficient_de(vector);
}
...
*/
static KRML_MUSTINLINE libcrux_ml_kem_polynomial_PolynomialRingElement_d2
deserialize_then_decompress_10_6c(Eurydice_slice serialized) {
  libcrux_ml_kem_polynomial_PolynomialRingElement_d2 re = ZERO_20_d5();
  ...
  for (size_t i = (size_t)0U;
    ...
    re.coefficients[i0] = decompress_ciphertext_coefficient_ea_d9(coefficient);
  }
  return re;
}
...
- COEFFICIENT_BITS= 11
*/
static core_core_arch_x86___m256i decompress_ciphertext_coefficient_ea_d90(
    core_core_arch_x86___m256i vector) {
  return decompress_ciphertext_coefficient_de0(vector);
}
...
*/
static KRML_MUSTINLINE libcrux_ml_kem_polynomial_PolynomialRingElement_d2
deserialize_then_decompress_11_25(Eurydice_slice serialized) {
  libcrux_ml_kem_polynomial_PolynomialRingElement_d2 re = ZERO_20_d5();
  for (size_t i = (size_t)0U;
    ...
    re.coefficients[i0] = decompress_ciphertext_coefficient_ea_d90(coefficient);
  }
  return re;
}
...
*/
static KRML_MUSTINLINE libcrux_ml_kem_polynomial_PolynomialRingElement_d2
deserialize_then_decompress_ring_element_u_4c(Eurydice_slice serialized) {
  return deserialize_then_decompress_10_6c(serialized);
}
...
- VECTOR_U_COMPRESSION_FACTOR= 10
*/
static KRML_MUSTINLINE void ntt_vector_u_21(
    libcrux_ml_kem_polynomial_PolynomialRingElement_d2 *re) {
    ...
    Eurydice_slice u_bytes = Eurydice_array_to_subslice2(
        ...
        i0 * (LIBCRUX_ML_KEM_CONSTANTS_COEFFICIENTS_IN_RING_ELEMENT *
            ...
            LIBCRUX_ML_KEM_CONSTANTS_COEFFICIENTS_IN_RING_ELEMENT *
                (size_t)10U / (size_t)8U,
        uint8_t);
    u_as_ntt[i0] = deserialize_then_decompress_ring_element_u_4c(u_bytes);
    ntt_vector_u_21(&u_as_ntt[i0]);
  }
  libcrux_ml_kem_polynomial_PolynomialRingElement_d2 result[3U];
  memcpy(
      result, u_as_ntt,
...
static core_core_arch_x86___m256i decompress_ciphertext_coefficient_ea_d91(
    core_core_arch_x86___m256i vector) {
  return decompress_ciphertext_coefficient_de1(vector);
}
...
*/
static KRML_MUSTINLINE libcrux_ml_kem_polynomial_PolynomialRingElement_d2
deserialize_then_decompress_4_f5(Eurydice_slice serialized) {
  libcrux_ml_kem_polynomial_PolynomialRingElement_d2 re = ZERO_20_d5();
  for (size_t i = (size_t)0U;
    ...
    re.coefficients[i0] = decompress_ciphertext_coefficient_ea_d91(coefficient);
  }
  return re;
}
...
- COEFFICIENT_BITS= 5
*/
static core_core_arch_x86___m256i decompress_ciphertext_coefficient_ea_d92(
    core_core_arch_x86___m256i vector) {
  return decompress_ciphertext_coefficient_de2(vector);
}
...
*/
static KRML_MUSTINLINE libcrux_ml_kem_polynomial_PolynomialRingElement_d2
deserialize_then_decompress_5_08(Eurydice_slice serialized) {
  libcrux_ml_kem_polynomial_PolynomialRingElement_d2 re = ZERO_20_d5();
  for (size_t i = (size_t)0U;
    ...
    re.coefficients[i0] =
        decompress_ciphertext_coefficient_ea_d92(re.coefficients[i0]);
  }
  return re;
}
...
*/
static KRML_MUSTINLINE libcrux_ml_kem_polynomial_PolynomialRingElement_d2
deserialize_then_decompress_ring_element_v_5e(Eurydice_slice serialized) {
  return deserialize_then_decompress_4_f5(serialized);
}
...
*/
static KRML_MUSTINLINE libcrux_ml_kem_polynomial_PolynomialRingElement_d2
subtract_reduce_20_90(libcrux_ml_kem_polynomial_PolynomialRingElement_d2 *self,
...
compute_message_c11(
  ...
  KRML_MAYBE_FOR3(i, (size_t)0U, (size_t)3U, (size_t)1U, size_t i0 = i;
                  libcrux_ml_kem_polynomial_PolynomialRingElement_d2 product =
                      ntt_multiply_20_41(&secret_as_ntt[i0], &u_as_ntt[i0]);
                  add_to_ring_element_20_871(&result, &product););
  invert_ntt_montgomery_8e1(&result);
  result = subtract_reduce_20_90(v, result);
  return result;
}
...
*/
static KRML_MUSTINLINE void compress_then_serialize_message_5d(
...
- V_COMPRESSION_FACTOR= 4
*/
static void decrypt_unpacked_991(
  ...
  libcrux_ml_kem_polynomial_PolynomialRingElement_d2 v =
      deserialize_then_decompress_ring_element_v_5e(
          Eurydice_array_to_subslice_from((size_t)1088U, ciphertext,
                                          (size_t)960U, uint8_t, size_t));
  libcrux_ml_kem_polynomial_PolynomialRingElement_d2 message =
      compute_message_c11(&v, secret_key->secret_as_ntt, u_as_ntt);
  uint8_t ret0[32U];
  compress_then_serialize_message_5d(message, ret0);
...
void libcrux_ml_kem_ind_cca_unpacked_decapsulate_unpacked_f41(
  ...
  decrypt_unpacked_991(&key_pair->private_key.ind_cpa_private_key,
  ...
  encrypt_unpacked_5a1(uu____3, copy_of_decrypted, pseudorandomness,
                       expected_ciphertext);
  uint8_t selector =
...
*/
static KRML_MUSTINLINE libcrux_ml_kem_polynomial_PolynomialRingElement_d2
deserialize_to_uncompressed_ring_element_7d(Eurydice_slice serialized) {
  libcrux_ml_kem_polynomial_PolynomialRingElement_d2 re = ZERO_20_d5();
  for (size_t i = (size_t)0U;
       i < Eurydice_slice_len(serialized, uint8_t) / (size_t)24U; i++) {
    size_t i0 = i;
...
static KRML_MUSTINLINE void deserialize_secret_key_6b1(
  ...
  for (size_t i = (size_t)0U;
    ...
    Eurydice_slice secret_bytes = Eurydice_slice_subslice2(
        ...
        uint8_t);
    libcrux_ml_kem_polynomial_PolynomialRingElement_d2 uu____0 =
        deserialize_to_uncompressed_ring_element_7d(secret_bytes);
...
- V_COMPRESSION_FACTOR= 4
*/
static void decrypt_a61(Eurydice_slice secret_key, uint8_t *ciphertext,
                        uint8_t ret[32U]) {
  libcrux_ml_kem_polynomial_PolynomialRingElement_d2 secret_as_ntt[3U];
  ...
  memcpy(
      ...
      (size_t)3U * sizeof(libcrux_ml_kem_polynomial_PolynomialRingElement_d2));
  uint8_t result[32U];
  decrypt_unpacked_991(&secret_key_unpacked, ciphertext, result);
...
- IMPLICIT_REJECTION_HASH_INPUT_SIZE= 1120
*/
void libcrux_ml_kem_ind_cca_decapsulate_4c1(
    libcrux_ml_kem_types_MlKemPrivateKey_55 *private_key,
    libcrux_ml_kem_mlkem768_MlKem768Ciphertext *ciphertext, uint8_t ret[32U]) {
  Eurydice_slice_uint8_t_x2 uu____0 = Eurydice_slice_split_at(
  ...
  uint8_t decrypted[32U];
  decrypt_a61(ind_cpa_secret_key, ciphertext->value, decrypted);
  uint8_t to_hash0[64U];
  libcrux_ml_kem_utils_into_padded_array_2d(
      Eurydice_array_to_slice((size_t)32U, decrypted, uint8_t), to_hash0);
  Eurydice_slice_copy(
  ...
  memcpy(copy_of_decrypted, decrypted, (size_t)32U * sizeof(uint8_t));
  uint8_t expected_ciphertext[1088U];
  encrypt_de1(uu____5, copy_of_decrypted, pseudorandomness,
              expected_ciphertext);
  uint8_t implicit_rejection_shared_secret[32U];
  kdf_af_401(Eurydice_array_to_slice(
                 (size_t)32U, implicit_rejection_shared_secret0, uint8_t),
             implicit_rejection_shared_secret);
  uint8_t shared_secret1[32U];
  kdf_af_401(shared_secret0, shared_secret1);
...
- K= 4
*/
static KRML_MUSTINLINE void deserialize_ring_elements_reduced_bd2(
    Eurydice_slice public_key,
...
static KRML_MUSTINLINE void serialize_public_key_370(
  ...
  uint8_t ret0[1536U];
  serialize_secret_key_a80(t_as_ntt, ret0);
  Eurydice_slice_copy(
...
- PUBLIC_KEY_SIZE= 1568
*/
bool libcrux_ml_kem_ind_cca_validate_public_key_000(uint8_t *public_key) {
  libcrux_ml_kem_polynomial_PolynomialRingElement_d2 deserialized_pk[4U];
  deserialize_ring_elements_reduced_bd2(
...
- ETA_RANDOMNESS_SIZE= 128
*/
static KRML_MUSTINLINE tuple_71 sample_vector_cbd_then_ntt_700(
    uint8_t prf_input[33U], uint8_t domain_separator) {
...
- K= 4
*/
static KRML_MUSTINLINE void add_to_ring_element_20_870(
    libcrux_ml_kem_polynomial_PolynomialRingElement_d2 *self,
    libcrux_ml_kem_polynomial_PolynomialRingElement_d2 *rhs) {
  for (size_t i = (size_t)0U;
       i < Eurydice_slice_len(
...
- K= 4
*/
static KRML_MUSTINLINE void compute_As_plus_e_bb0(
  ...
  for (size_t i0 = (size_t)0U;
    ...
    for (size_t i = (size_t)0U;
      ...
      libcrux_ml_kem_polynomial_PolynomialRingElement_d2 product =
          ntt_multiply_20_41(matrix_element, &s_as_ntt[j]);
      add_to_ring_element_20_870(&result0[i1], &product);
    }
    add_standard_error_reduce_20_a5(&result0[i1], &error_as_ntt[i1]);
  }
...
- ETA1_RANDOMNESS_SIZE= 128
*/
static tuple_54 generate_keypair_unpacked_750(
    Eurydice_slice key_generation_seed) {
  uint8_t hashed[64U];
  ...
  uint8_t copy_of_prf_input0[33U];
  memcpy(copy_of_prf_input0, prf_input, (size_t)33U * sizeof(uint8_t));
  tuple_71 uu____2 = sample_vector_cbd_then_ntt_700(copy_of_prf_input0, 0U);
  ...
  memcpy(
      error_as_ntt,
      sample_vector_cbd_then_ntt_700(copy_of_prf_input, domain_separator).fst,
      (size_t)4U * sizeof(libcrux_ml_kem_polynomial_PolynomialRingElement_d2));
  libcrux_ml_kem_polynomial_PolynomialRingElement_d2 t_as_ntt[4U];
  compute_As_plus_e_bb0(A_transpose, secret_as_ntt, error_as_ntt, t_as_ntt);
  uint8_t seed_for_A[32U];
  core_result_Result_00 dst;
  Eurydice_slice_to_array2(&dst, seed_for_A0, Eurydice_slice, uint8_t[32U]);
  core_result_unwrap_41_83(dst, seed_for_A);
...
libcrux_ml_kem_ind_cca_unpacked_generate_keypair_unpacked_060(
  ...
  Eurydice_slice implicit_rejection_value0 = Eurydice_array_to_subslice_from(
      ...
      LIBCRUX_ML_KEM_CONSTANTS_CPA_PKE_KEY_GENERATION_SEED_SIZE, uint8_t,
      size_t);
  tuple_54 uu____0 = generate_keypair_unpacked_750(ind_cpa_keypair_randomness);
  ...
  KRML_MAYBE_FOR4(i, (size_t)0U, (size_t)4U, (size_t)1U, closure_ce0(A[i]););
  KRML_MAYBE_FOR4(
...
- ETA1_RANDOMNESS_SIZE= 128
*/
static libcrux_ml_kem_utils_extraction_helper_Keypair1024 generate_keypair_540(
    Eurydice_slice key_generation_seed) {
  tuple_54 uu____0 = generate_keypair_unpacked_750(key_generation_seed);
  ...
  serialize_secret_key_a80(sk.secret_as_ntt, secret_key_serialized);
  /* Passing arrays by value in Rust generates a copy in C */
...
*/
static KRML_MUSTINLINE void serialize_kem_secret_key_170(
    Eurydice_slice private_key, Eurydice_slice public_key,
...
libcrux_ml_kem_ind_cca_generate_keypair_3f0(uint8_t randomness[64U]) {
  Eurydice_slice ind_cpa_keypair_randomness = Eurydice_array_to_subslice2(
      randomness, (size_t)0U,
      LIBCRUX_ML_KEM_CONSTANTS_CPA_PKE_KEY_GENERATION_SEED_SIZE, uint8_t);
  Eurydice_slice implicit_rejection_value = Eurydice_array_to_subslice_from(
  ...
  libcrux_ml_kem_utils_extraction_helper_Keypair1024 uu____0 =
      generate_keypair_540(ind_cpa_keypair_randomness);
...
sample_ring_element_cbd_990(uint8_t prf_input[33U], uint8_t domain_separator) {
...
- K= 4
*/
static KRML_MUSTINLINE void invert_ntt_montgomery_8e0(
    libcrux_ml_kem_polynomial_PolynomialRingElement_d2 *re) {
  size_t zeta_i =
      LIBCRUX_ML_KEM_CONSTANTS_COEFFICIENTS_IN_RING_ELEMENT / (size_t)2U;
  invert_ntt_at_layer_1_62(&zeta_i, re);
...
- K= 4
*/
static KRML_MUSTINLINE void compute_vector_u_7b0(
  ...
  for (size_t i0 = (size_t)0U;
    ...
    invert_ntt_montgomery_8e0(&result0[i1]);
    add_error_reduce_20_44(&result0[i1], &error_1[i1]);
  }
  libcrux_ml_kem_polynomial_PolynomialRingElement_d2 result[4U];
  memcpy(
...
compute_ring_element_v_320(
  ...
  KRML_MAYBE_FOR4(i, (size_t)0U, (size_t)4U, (size_t)1U, size_t i0 = i;
                  libcrux_ml_kem_polynomial_PolynomialRingElement_d2 product =
                      ntt_multiply_20_41(&t_as_ntt[i0], &r_as_ntt[i0]);
                  add_to_ring_element_20_870(&result, &product););
  invert_ntt_montgomery_8e0(&result);
  result = add_message_error_reduce_20_d5(error_2, message, result);
  return result;
}
...
- OUT_LEN= 352
*/
static KRML_MUSTINLINE void compress_then_serialize_11_e60(
  ...
  for (size_t i = (size_t)0U;
    ...
    size_t i0 = i;
    core_core_arch_x86___m256i coefficient =
        compress_ea_2e0(to_unsigned_representative_d4(re->coefficients[i0]));
    uint8_t bytes[22U];
...
- OUT_LEN= 352
*/
static KRML_MUSTINLINE void compress_then_serialize_ring_element_u_710(
    libcrux_ml_kem_polynomial_PolynomialRingElement_d2 *re, uint8_t ret[352U]) {
  uint8_t uu____0[352U];
  compress_then_serialize_11_e60(re, uu____0);
...
- BLOCK_LEN= 352
*/
static void compress_then_serialize_u_7a0(
  ...
  for (size_t i = (size_t)0U;
    ...
    uint8_t ret[352U];
    compress_then_serialize_ring_element_u_710(&re, ret);
    Eurydice_slice_copy(
...
- OUT_LEN= 160
*/
static KRML_MUSTINLINE void compress_then_serialize_ring_element_v_070(
    libcrux_ml_kem_polynomial_PolynomialRingElement_d2 re, Eurydice_slice out) {
...
- ETA2_RANDOMNESS_SIZE= 128
*/
static void encrypt_unpacked_5a0(
  ...
  uint8_t copy_of_prf_input0[33U];
  memcpy(copy_of_prf_input0, prf_input, (size_t)33U * sizeof(uint8_t));
  tuple_71 uu____1 = sample_vector_cbd_then_ntt_700(copy_of_prf_input0, 0U);
  ...
  memcpy(copy_of_prf_input, prf_input, (size_t)33U * sizeof(uint8_t));
  tuple_71 uu____3 =
      sample_ring_element_cbd_990(copy_of_prf_input, domain_separator0);
  libcrux_ml_kem_polynomial_PolynomialRingElement_d2 error_1[4U];
  memcpy(
      error_1, uu____3.fst,
      (size_t)4U * sizeof(libcrux_ml_kem_polynomial_PolynomialRingElement_d2));
  ...
  compute_vector_u_7b0(public_key->A, r_as_ntt, error_1, u);
  /* Passing arrays by value in Rust generates a copy in C */
  uint8_t copy_of_message[32U];
  memcpy(copy_of_message, message, (size_t)32U * sizeof(uint8_t));
  libcrux_ml_kem_polynomial_PolynomialRingElement_d2 message_as_ring_element =
      deserialize_then_decompress_message_bb(copy_of_message);
  libcrux_ml_kem_polynomial_PolynomialRingElement_d2 v =
      compute_ring_element_v_320(public_key->t_as_ntt, r_as_ntt, &error_2,
                                 &message_as_ring_element);
...
tuple_21 libcrux_ml_kem_ind_cca_unpacked_encapsulate_unpacked_980(
  ...
  encrypt_unpacked_5a0(uu____2, copy_of_randomness, pseudorandomness,
                       ciphertext);
  uint8_t shared_secret_array[32U] = {0U};
  Eurydice_slice_copy(
      Eurydice_array_to_slice((size_t)32U, shared_secret_array, uint8_t),
...
- K= 4
*/
static KRML_MUSTINLINE void entropy_preprocess_af_020(Eurydice_slice randomness,
                                                      uint8_t ret[32U]) {
  core_result_Result_00 dst;
  Eurydice_slice_to_array2(&dst, randomness, Eurydice_slice, uint8_t[32U]);
  core_result_unwrap_41_83(dst, ret);
...
- ETA2_RANDOMNESS_SIZE= 128
*/
static void encrypt_de0(Eurydice_slice public_key, uint8_t message[32U],
                        Eurydice_slice randomness, uint8_t ret[1568U]) {
  libcrux_ml_kem_polynomial_PolynomialRingElement_d2 t_as_ntt[4U];
  deserialize_ring_elements_reduced_bd1(
  ...
  memcpy(copy_of_message, message, (size_t)32U * sizeof(uint8_t));
  uint8_t result[1568U];
  encrypt_unpacked_5a0(uu____3, copy_of_message, randomness, result);
  memcpy(ret, result, (size_t)1568U * sizeof(uint8_t));
}
...
- CIPHERTEXT_SIZE= 1568
*/
static KRML_MUSTINLINE void kdf_af_400(Eurydice_slice shared_secret,
                                       uint8_t ret[32U]) {
  core_result_Result_00 dst;
  Eurydice_slice_to_array2(&dst, shared_secret, Eurydice_slice, uint8_t[32U]);
  core_result_unwrap_41_83(dst, ret);
...
- ETA2_RANDOMNESS_SIZE= 128
*/
tuple_21 libcrux_ml_kem_ind_cca_encapsulate_230(
    libcrux_ml_kem_types_MlKemPublicKey_1f *public_key,
    uint8_t randomness[32U]) {
  uint8_t randomness0[32U];
  entropy_preprocess_af_020(
      Eurydice_array_to_slice((size_t)32U, randomness, uint8_t), randomness0);
  uint8_t to_hash[64U];
  libcrux_ml_kem_utils_into_padded_array_2d(
      Eurydice_array_to_slice((size_t)32U, randomness0, uint8_t), to_hash);
  ...
  memcpy(copy_of_randomness, randomness0, (size_t)32U * sizeof(uint8_t));
  uint8_t ciphertext[1568U];
  encrypt_de0(uu____2, copy_of_randomness, pseudorandomness, ciphertext);
  /* Passing arrays by value in Rust generates a copy in C */
  uint8_t copy_of_ciphertext[1568U];
  memcpy(copy_of_ciphertext, ciphertext, (size_t)1568U * sizeof(uint8_t));
  libcrux_ml_kem_mlkem1024_MlKem1024Ciphertext ciphertext0 =
      libcrux_ml_kem_types_from_15_251(copy_of_ciphertext);
  uint8_t shared_secret_array[32U];
  kdf_af_400(shared_secret, shared_secret_array);
...
*/
static KRML_MUSTINLINE libcrux_ml_kem_polynomial_PolynomialRingElement_d2
deserialize_then_decompress_ring_element_u_4c0(Eurydice_slice serialized) {
  return deserialize_then_decompress_11_25(serialized);
}
...
- VECTOR_U_COMPRESSION_FACTOR= 11
*/
static KRML_MUSTINLINE void ntt_vector_u_210(
    libcrux_ml_kem_polynomial_PolynomialRingElement_d2 *re) {
  size_t zeta_i = (size_t)0U;
  ntt_at_layer_4_plus_b8(&zeta_i, re, (size_t)7U);
  ntt_at_layer_4_plus_b8(&zeta_i, re, (size_t)6U);
    ...
    Eurydice_slice u_bytes = Eurydice_array_to_subslice2(
        ...
        i0 * (LIBCRUX_ML_KEM_CONSTANTS_COEFFICIENTS_IN_RING_ELEMENT *
            ...
            LIBCRUX_ML_KEM_CONSTANTS_COEFFICIENTS_IN_RING_ELEMENT *
                (size_t)11U / (size_t)8U,
        uint8_t);
    u_as_ntt[i0] = deserialize_then_decompress_ring_element_u_4c0(u_bytes);
    ntt_vector_u_210(&u_as_ntt[i0]);
  }
  libcrux_ml_kem_polynomial_PolynomialRingElement_d2 result[4U];
  memcpy(
      result, u_as_ntt,
...
*/
static KRML_MUSTINLINE libcrux_ml_kem_polynomial_PolynomialRingElement_d2
deserialize_then_decompress_ring_element_v_5e0(Eurydice_slice serialized) {
  return deserialize_then_decompress_5_08(serialized);
}
...
- V_COMPRESSION_FACTOR= 5
*/
static void decrypt_unpacked_990(
  ...
  libcrux_ml_kem_polynomial_PolynomialRingElement_d2 v =
      deserialize_then_decompress_ring_element_v_5e0(
...
*/
void libcrux_ml_kem_ind_cca_unpacked_decapsulate_unpacked_f40(
    libcrux_ml_kem_ind_cca_unpacked_MlKemKeyPairUnpacked_01 *key_pair,
    libcrux_ml_kem_mlkem1024_MlKem1024Ciphertext *ciphertext,
    uint8_t ret[32U]) {
  uint8_t decrypted[32U];
  decrypt_unpacked_990(&key_pair->private_key.ind_cpa_private_key,
                       ciphertext->value, decrypted);
  uint8_t to_hash0[64U];
  libcrux_ml_kem_utils_into_padded_array_2d(
      Eurydice_array_to_slice((size_t)32U, decrypted, uint8_t), to_hash0);
  ...
  encrypt_unpacked_5a0(uu____3, copy_of_decrypted, pseudorandomness,
                       expected_ciphertext);
  uint8_t selector =
      libcrux_ml_kem_constant_time_ops_compare_ciphertexts_in_constant_time(
...
- V_COMPRESSION_FACTOR= 5
*/
static void decrypt_a60(Eurydice_slice secret_key, uint8_t *ciphertext,
                        uint8_t ret[32U]) {
  libcrux_ml_kem_polynomial_PolynomialRingElement_d2 secret_as_ntt[4U];
  ...
  memcpy(
      ...
      (size_t)4U * sizeof(libcrux_ml_kem_polynomial_PolynomialRingElement_d2));
  uint8_t result[32U];
  decrypt_unpacked_990(&secret_key_unpacked, ciphertext, result);
  memcpy(ret, result, (size_t)32U * sizeof(uint8_t));
}
...
- IMPLICIT_REJECTION_HASH_INPUT_SIZE= 1600
*/
void libcrux_ml_kem_ind_cca_decapsulate_4c0(
    libcrux_ml_kem_types_MlKemPrivateKey_95 *private_key,
    libcrux_ml_kem_mlkem1024_MlKem1024Ciphertext *ciphertext,
    uint8_t ret[32U]) {
  Eurydice_slice_uint8_t_x2 uu____0 = Eurydice_slice_split_at(
  ...
  Eurydice_slice implicit_rejection_value = uu____2.snd;
  uint8_t decrypted[32U];
  decrypt_a60(ind_cpa_secret_key, ciphertext->value, decrypted);
  uint8_t to_hash0[64U];
  libcrux_ml_kem_utils_into_padded_array_2d(
      Eurydice_array_to_slice((size_t)32U, decrypted, uint8_t), to_hash0);
  Eurydice_slice_copy(
  ...
  memcpy(copy_of_decrypted, decrypted, (size_t)32U * sizeof(uint8_t));
  uint8_t expected_ciphertext[1568U];
  encrypt_de0(uu____5, copy_of_decrypted, pseudorandomness,
              expected_ciphertext);
  uint8_t implicit_rejection_shared_secret[32U];
  kdf_af_400(Eurydice_array_to_slice(
                 (size_t)32U, implicit_rejection_shared_secret0, uint8_t),
             implicit_rejection_shared_secret);
  uint8_t shared_secret1[32U];
  kdf_af_400(shared_secret0, shared_secret1);
  uint8_t shared_secret[32U];
  libcrux_ml_kem_constant_time_ops_compare_ciphertexts_select_shared_secret_in_constant_time(
      libcrux_ml_kem_types_as_ref_ba_c01(ciphertext),
      Eurydice_array_to_slice((size_t)1568U, expected_ciphertext, uint8_t),
...
- OUT_LEN= 768
*/
static KRML_MUSTINLINE void serialize_secret_key_a8(
    libcrux_ml_kem_polynomial_PolynomialRingElement_d2 *key,
    uint8_t ret[768U]) {
  uint8_t out[768U] = {0U};
  for (size_t i = (size_t)0U;
...
static KRML_MUSTINLINE void serialize_public_key_37(
  ...
  uint8_t ret0[768U];
  serialize_secret_key_a8(t_as_ntt, ret0);
  Eurydice_slice_copy(
...
bool libcrux_ml_kem_ind_cca_validate_public_key_00(uint8_t *public_key) {
  libcrux_ml_kem_polynomial_PolynomialRingElement_d2 deserialized_pk[2U];
  deserialize_ring_elements_reduced_bd0(
...
sample_from_binomial_distribution_92(Eurydice_slice randomness) {
  return sample_from_binomial_distribution_3_92(randomness);
}
...
*/
static KRML_MUSTINLINE tuple_74 sample_vector_cbd_then_ntt_70(
    uint8_t prf_input[33U], uint8_t domain_separator) {
...
- K= 2
*/
static KRML_MUSTINLINE void compute_As_plus_e_bb(
  ...
  for (size_t i0 = (size_t)0U;
    ...
    for (size_t i = (size_t)0U;
      ...
      libcrux_ml_kem_polynomial_PolynomialRingElement_d2 product =
          ntt_multiply_20_41(matrix_element, &s_as_ntt[j]);
      add_to_ring_element_20_87(&result0[i1], &product);
    }
    add_standard_error_reduce_20_a5(&result0[i1], &error_as_ntt[i1]);
  }
...
*/
static tuple_4c generate_keypair_unpacked_75(
    Eurydice_slice key_generation_seed) {
  uint8_t hashed[64U];
  ...
  uint8_t copy_of_prf_input0[33U];
  memcpy(copy_of_prf_input0, prf_input, (size_t)33U * sizeof(uint8_t));
  tuple_74 uu____2 = sample_vector_cbd_then_ntt_70(copy_of_prf_input0, 0U);
  ...
  memcpy(
      error_as_ntt,
      sample_vector_cbd_then_ntt_70(copy_of_prf_input, domain_separator).fst,
      (size_t)2U * sizeof(libcrux_ml_kem_polynomial_PolynomialRingElement_d2));
  libcrux_ml_kem_polynomial_PolynomialRingElement_d2 t_as_ntt[2U];
  compute_As_plus_e_bb(A_transpose, secret_as_ntt, error_as_ntt, t_as_ntt);
  uint8_t seed_for_A[32U];
  core_result_Result_00 dst;
  Eurydice_slice_to_array2(&dst, seed_for_A0, Eurydice_slice, uint8_t[32U]);
  core_result_unwrap_41_83(dst, seed_for_A);
...
libcrux_ml_kem_ind_cca_unpacked_generate_keypair_unpacked_06(
  ...
  Eurydice_slice implicit_rejection_value0 = Eurydice_array_to_subslice_from(
      ...
      LIBCRUX_ML_KEM_CONSTANTS_CPA_PKE_KEY_GENERATION_SEED_SIZE, uint8_t,
      size_t);
  tuple_4c uu____0 = generate_keypair_unpacked_75(ind_cpa_keypair_randomness);
  ...
  KRML_MAYBE_FOR2(i, (size_t)0U, (size_t)2U, (size_t)1U, closure_ce(A[i]););
  KRML_MAYBE_FOR2(
...
- ETA1_RANDOMNESS_SIZE= 192
*/
static libcrux_ml_kem_utils_extraction_helper_Keypair512 generate_keypair_54(
    Eurydice_slice key_generation_seed) {
  tuple_4c uu____0 = generate_keypair_unpacked_75(key_generation_seed);
  ...
  serialize_secret_key_a8(sk.secret_as_ntt, secret_key_serialized);
  /* Passing arrays by value in Rust generates a copy in C */
...
*/
static KRML_MUSTINLINE void serialize_kem_secret_key_17(
    Eurydice_slice private_key, Eurydice_slice public_key,
...
- ETA1_RANDOMNESS_SIZE= 192
*/
libcrux_ml_kem_types_MlKemKeyPair_cb libcrux_ml_kem_ind_cca_generate_keypair_3f(
    uint8_t randomness[64U]) {
  Eurydice_slice ind_cpa_keypair_randomness = Eurydice_array_to_subslice2(
      randomness, (size_t)0U,
      LIBCRUX_ML_KEM_CONSTANTS_CPA_PKE_KEY_GENERATION_SEED_SIZE, uint8_t);
  ...
  libcrux_ml_kem_utils_extraction_helper_Keypair512 uu____0 =
      generate_keypair_54(ind_cpa_keypair_randomness);
...
sample_ring_element_cbd_99(uint8_t prf_input[33U], uint8_t domain_separator) {
...
- K= 2
*/
static KRML_MUSTINLINE void invert_ntt_montgomery_8e(
    libcrux_ml_kem_polynomial_PolynomialRingElement_d2 *re) {
  size_t zeta_i =
      LIBCRUX_ML_KEM_CONSTANTS_COEFFICIENTS_IN_RING_ELEMENT / (size_t)2U;
  invert_ntt_at_layer_1_62(&zeta_i, re);
...
- K= 2
*/
static KRML_MUSTINLINE void compute_vector_u_7b(
  ...
  for (size_t i0 = (size_t)0U;
    ...
    invert_ntt_montgomery_8e(&result0[i1]);
    add_error_reduce_20_44(&result0[i1], &error_1[i1]);
  }
  libcrux_ml_kem_polynomial_PolynomialRingElement_d2 result[2U];
  memcpy(
...
compute_ring_element_v_32(
  ...
  KRML_MAYBE_FOR2(i, (size_t)0U, (size_t)2U, (size_t)1U, size_t i0 = i;
                  libcrux_ml_kem_polynomial_PolynomialRingElement_d2 product =
                      ntt_multiply_20_41(&t_as_ntt[i0], &r_as_ntt[i0]);
                  add_to_ring_element_20_87(&result, &product););
  invert_ntt_montgomery_8e(&result);
  result = add_message_error_reduce_20_d5(error_2, message, result);
  return result;
}
...
- BLOCK_LEN= 320
*/
static void compress_then_serialize_u_7a(
...
- ETA2_RANDOMNESS_SIZE= 128
*/
static void encrypt_unpacked_5a(
  ...
  uint8_t copy_of_prf_input0[33U];
  memcpy(copy_of_prf_input0, prf_input, (size_t)33U * sizeof(uint8_t));
  tuple_74 uu____1 = sample_vector_cbd_then_ntt_70(copy_of_prf_input0, 0U);
  ...
  memcpy(copy_of_prf_input, prf_input, (size_t)33U * sizeof(uint8_t));
  tuple_74 uu____3 =
      sample_ring_element_cbd_99(copy_of_prf_input, domain_separator0);
  libcrux_ml_kem_polynomial_PolynomialRingElement_d2 error_1[2U];
  memcpy(
      error_1, uu____3.fst,
      (size_t)2U * sizeof(libcrux_ml_kem_polynomial_PolynomialRingElement_d2));
  ...
  compute_vector_u_7b(public_key->A, r_as_ntt, error_1, u);
  /* Passing arrays by value in Rust generates a copy in C */
  uint8_t copy_of_message[32U];
  memcpy(copy_of_message, message, (size_t)32U * sizeof(uint8_t));
  libcrux_ml_kem_polynomial_PolynomialRingElement_d2 message_as_ring_element =
      deserialize_then_decompress_message_bb(copy_of_message);
  libcrux_ml_kem_polynomial_PolynomialRingElement_d2 v =
      compute_ring_element_v_32(public_key->t_as_ntt, r_as_ntt, &error_2,
                                &message_as_ring_element);
...
- ETA2_RANDOMNESS_SIZE= 128
*/
tuple_ec libcrux_ml_kem_ind_cca_unpacked_encapsulate_unpacked_98(
  ...
  encrypt_unpacked_5a(uu____2, copy_of_randomness, pseudorandomness,
                      ciphertext);
  uint8_t shared_secret_array[32U] = {0U};
  Eurydice_slice_copy(
      Eurydice_array_to_slice((size_t)32U, shared_secret_array, uint8_t),
...
- K= 2
*/
static KRML_MUSTINLINE void entropy_preprocess_af_02(Eurydice_slice randomness,
                                                     uint8_t ret[32U]) {
  core_result_Result_00 dst;
  Eurydice_slice_to_array2(&dst, randomness, Eurydice_slice, uint8_t[32U]);
  core_result_unwrap_41_83(dst, ret);
...
- ETA2_RANDOMNESS_SIZE= 128
*/
static void encrypt_de(Eurydice_slice public_key, uint8_t message[32U],
                       Eurydice_slice randomness, uint8_t ret[768U]) {
  libcrux_ml_kem_polynomial_PolynomialRingElement_d2 t_as_ntt[2U];
  deserialize_ring_elements_reduced_bd(
  ...
  memcpy(copy_of_message, message, (size_t)32U * sizeof(uint8_t));
  uint8_t result[768U];
  encrypt_unpacked_5a(uu____3, copy_of_message, randomness, result);
  memcpy(ret, result, (size_t)768U * sizeof(uint8_t));
}
...
- CIPHERTEXT_SIZE= 768
*/
static KRML_MUSTINLINE void kdf_af_40(Eurydice_slice shared_secret,
                                      uint8_t ret[32U]) {
  core_result_Result_00 dst;
  Eurydice_slice_to_array2(&dst, shared_secret, Eurydice_slice, uint8_t[32U]);
  core_result_unwrap_41_83(dst, ret);
...
- ETA2_RANDOMNESS_SIZE= 128
*/
tuple_ec libcrux_ml_kem_ind_cca_encapsulate_23(
    libcrux_ml_kem_types_MlKemPublicKey_be *public_key,
    uint8_t randomness[32U]) {
  uint8_t randomness0[32U];
  entropy_preprocess_af_02(
      Eurydice_array_to_slice((size_t)32U, randomness, uint8_t), randomness0);
  uint8_t to_hash[64U];
  libcrux_ml_kem_utils_into_padded_array_2d(
      Eurydice_array_to_slice((size_t)32U, randomness0, uint8_t), to_hash);
  ...
  memcpy(copy_of_randomness, randomness0, (size_t)32U * sizeof(uint8_t));
  uint8_t ciphertext[768U];
  encrypt_de(uu____2, copy_of_randomness, pseudorandomness, ciphertext);
  /* Passing arrays by value in Rust generates a copy in C */
  uint8_t copy_of_ciphertext[768U];
  memcpy(copy_of_ciphertext, ciphertext, (size_t)768U * sizeof(uint8_t));
  libcrux_ml_kem_types_MlKemCiphertext_e8 ciphertext0 =
      libcrux_ml_kem_types_from_15_25(copy_of_ciphertext);
  uint8_t shared_secret_array[32U];
  kdf_af_40(shared_secret, shared_secret_array);
...
- V_COMPRESSION_FACTOR= 4
*/
static void decrypt_unpacked_99(
...
*/
void libcrux_ml_kem_ind_cca_unpacked_decapsulate_unpacked_f4(
    libcrux_ml_kem_ind_cca_unpacked_MlKemKeyPairUnpacked_d6 *key_pair,
    libcrux_ml_kem_types_MlKemCiphertext_e8 *ciphertext, uint8_t ret[32U]) {
  uint8_t decrypted[32U];
  decrypt_unpacked_99(&key_pair->private_key.ind_cpa_private_key,
                      ciphertext->value, decrypted);
  uint8_t to_hash0[64U];
  libcrux_ml_kem_utils_into_padded_array_2d(
      Eurydice_array_to_slice((size_t)32U, decrypted, uint8_t), to_hash0);
  ...
  encrypt_unpacked_5a(uu____3, copy_of_decrypted, pseudorandomness,
                      expected_ciphertext);
  uint8_t selector =
      libcrux_ml_kem_constant_time_ops_compare_ciphertexts_in_constant_time(
...
- V_COMPRESSION_FACTOR= 4
*/
static void decrypt_a6(Eurydice_slice secret_key, uint8_t *ciphertext,
                       uint8_t ret[32U]) {
  libcrux_ml_kem_polynomial_PolynomialRingElement_d2 secret_as_ntt[2U];
  ...
  memcpy(
      ...
      (size_t)2U * sizeof(libcrux_ml_kem_polynomial_PolynomialRingElement_d2));
  uint8_t result[32U];
  decrypt_unpacked_99(&secret_key_unpacked, ciphertext, result);
  memcpy(ret, result, (size_t)32U * sizeof(uint8_t));
}
...
- IMPLICIT_REJECTION_HASH_INPUT_SIZE= 800
*/
void libcrux_ml_kem_ind_cca_decapsulate_4c(
    libcrux_ml_kem_types_MlKemPrivateKey_5e *private_key,
    libcrux_ml_kem_types_MlKemCiphertext_e8 *ciphertext, uint8_t ret[32U]) {
  Eurydice_slice_uint8_t_x2 uu____0 = Eurydice_slice_split_at(
  ...
  Eurydice_slice implicit_rejection_value = uu____2.snd;
  uint8_t decrypted[32U];
  decrypt_a6(ind_cpa_secret_key, ciphertext->value, decrypted);
  uint8_t to_hash0[64U];
  libcrux_ml_kem_utils_into_padded_array_2d(
      Eurydice_array_to_slice((size_t)32U, decrypted, uint8_t), to_hash0);
  Eurydice_slice_copy(
  ...
  memcpy(copy_of_decrypted, decrypted, (size_t)32U * sizeof(uint8_t));
  uint8_t expected_ciphertext[768U];
  encrypt_de(uu____5, copy_of_decrypted, pseudorandomness, expected_ciphertext);
  uint8_t implicit_rejection_shared_secret[32U];
  kdf_af_40(Eurydice_array_to_slice((size_t)32U,
                                    implicit_rejection_shared_secret0, uint8_t),
            implicit_rejection_shared_secret);
  uint8_t shared_secret1[32U];
  kdf_af_40(shared_secret0, shared_secret1);
  uint8_t shared_secret[32U];
  libcrux_ml_kem_constant_time_ops_compare_ciphertexts_select_shared_secret_in_constant_time(
      libcrux_ml_kem_types_as_ref_ba_c0(ciphertext),
      Eurydice_array_to_slice((size_t)768U, expected_ciphertext, uint8_t),
