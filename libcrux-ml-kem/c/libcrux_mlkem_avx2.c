...
)
{
  ...
  libcrux_sha3_avx2_x4_incremental_KeccakState4 *uu____0 = &state;
  Eurydice_slice
...
)
{
  ...
  libcrux_sha3_avx2_x4_incremental_KeccakState4 *uu____1 = self;
  uint8_t ret0[504U];
...
)
{
  ...
  libcrux_sha3_avx2_x4_incremental_KeccakState4 *uu____3 = self;
  uint8_t ret0[504U];
  Eurydice_slice_index_outparam(out0, (size_t)0U, ret0, uint8_t [504U], void *);
