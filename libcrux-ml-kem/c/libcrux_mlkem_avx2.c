...
deserialize_to_reduced_ring_element_5c(Eurydice_slice serialized) {
...
static KRML_MUSTINLINE void deserialize_ring_elements_reduced_c54(
  ...
  for (size_t i = (size_t)0U;
    ...
    libcrux_ml_kem_polynomial_PolynomialRingElement_d2 uu____0 =
        deserialize_to_reduced_ring_element_5c(ring_element);
...
- K= 3
*/
static KRML_MUSTINLINE void deserialize_ring_elements_reduced_out_551(
    Eurydice_slice public_key,
  ...
  deserialize_ring_elements_reduced_c54(public_key, deserialized_pk);
  memcpy(
      ret, deserialized_pk,
...
- SHIFT_BY= 15
*/
static KRML_MUSTINLINE __m256i shift_right_d8(__m256i vector) {
...
- SHIFT_BY= 15
*/
static __m256i shift_right_ea_12(__m256i vector) {
  return shift_right_d8(vector);
}
...
*/
static __m256i to_unsigned_representative_32(__m256i a) {
  __m256i t = shift_right_ea_12(a);
...
*/
static KRML_MUSTINLINE void serialize_uncompressed_ring_element_50(
    libcrux_ml_kem_polynomial_PolynomialRingElement_d2 *re, uint8_t ret[384U]) {
  uint8_t serialized[384U] = {0U};
  for (size_t i = (size_t)0U;
       i < LIBCRUX_ML_KEM_POLYNOMIAL_VECTORS_IN_RING_ELEMENT; i++) {
    size_t i0 = i;
    __m256i coefficient = to_unsigned_representative_32(re->coefficients[i0]);
    uint8_t bytes[24U];
...
- OUT_LEN= 1152
*/
static KRML_MUSTINLINE void serialize_secret_key_191(
  ...
  for (size_t i = (size_t)0U;
    ...
    Eurydice_slice uu____0 = Eurydice_array_to_subslice2(
        ...
        uint8_t);
    uint8_t ret0[384U];
    serialize_uncompressed_ring_element_50(&re, ret0);
    Eurydice_slice_copy(
...
- PUBLIC_KEY_SIZE= 1184
*/
static KRML_MUSTINLINE void serialize_public_key_mut_ac1(
  ...
  uint8_t ret[1152U];
  serialize_secret_key_191(t_as_ntt, ret);
  Eurydice_slice_copy(
...
- PUBLIC_KEY_SIZE= 1184
*/
static KRML_MUSTINLINE void serialize_public_key_371(
    libcrux_ml_kem_polynomial_PolynomialRingElement_d2 *t_as_ntt,
    Eurydice_slice seed_for_a, uint8_t ret[1184U]) {
  uint8_t public_key_serialized[1184U] = {0U};
  serialize_public_key_mut_ac1(t_as_ntt, seed_for_a, public_key_serialized);
...
bool libcrux_ml_kem_ind_cca_validate_public_key_331(uint8_t *public_key) {
  libcrux_ml_kem_polynomial_PolynomialRingElement_d2 deserialized_pk[3U];
  deserialize_ring_elements_reduced_out_551(
...
- K= 3
*/
static KRML_MUSTINLINE void cpa_keygen_seed_d8_521(
...
- N= 504
*/
static KRML_MUSTINLINE bool sample_from_uniform_distribution_next_e03(
...
*/
static KRML_MUSTINLINE libcrux_ml_kem_polynomial_PolynomialRingElement_d2
from_i16_array_d6_34(Eurydice_slice a) {
...
- K= 3
*/
static libcrux_ml_kem_polynomial_PolynomialRingElement_d2 closure_b71(
    int16_t s[272U]) {
  return from_i16_array_d6_34(
...
- K= 3
*/
static KRML_MUSTINLINE void sample_from_xof_591(
  ...
  bool done = sample_from_uniform_distribution_next_e03(
  ...
  while (true) {
    if (done) {
      ...
      done = sample_from_uniform_distribution_next_e04(
  ...
  KRML_MAYBE_FOR3(i, (size_t)0U, (size_t)3U, (size_t)1U,
                  ret0[i] = closure_b71(copy_of_out[i]););
  memcpy(
      ret, ret0,
      (size_t)3U * sizeof(libcrux_ml_kem_polynomial_PolynomialRingElement_d2));
}
...
- K= 3
*/
static KRML_MUSTINLINE void sample_matrix_A_591(
  ...
  KRML_MAYBE_FOR3(
      ...
      sample_from_xof_591(copy_of_seeds, sampled);
      for (size_t i = (size_t)0U;
           i < Eurydice_slice_len(
                   Eurydice_array_to_slice(
                       (size_t)3U, sampled,
...
*/
static KRML_MUSTINLINE libcrux_ml_kem_polynomial_PolynomialRingElement_d2
sample_from_binomial_distribution_3_e1(Eurydice_slice randomness) {
  int16_t sampled_i16s[256U] = {0U};
  for (size_t i0 = (size_t)0U;
...
*/
static KRML_MUSTINLINE libcrux_ml_kem_polynomial_PolynomialRingElement_d2
sample_from_binomial_distribution_d5(Eurydice_slice randomness) {
...
*/
static __m256i montgomery_multiply_fe_78(__m256i v, int16_t fer) {
...
ntt_layer_int_vec_step_d7(__m256i a, __m256i b, int16_t zeta_r) {
  __m256i t = montgomery_multiply_fe_78(b, zeta_r);
...
*/
static KRML_MUSTINLINE void ntt_at_layer_4_plus_ba(
...
*/
static KRML_MUSTINLINE void ntt_at_layer_3_b7(
    size_t *zeta_i, libcrux_ml_kem_polynomial_PolynomialRingElement_d2 *re) {
  KRML_MAYBE_FOR16(
...
*/
static KRML_MUSTINLINE void ntt_at_layer_2_20(
    size_t *zeta_i, libcrux_ml_kem_polynomial_PolynomialRingElement_d2 *re) {
  KRML_MAYBE_FOR16(
      i, (size_t)0U, (size_t)16U, (size_t)1U, size_t round = i;
      zeta_i[0U] = zeta_i[0U] + (size_t)1U;
...
*/
static KRML_MUSTINLINE void ntt_at_layer_1_91(
    size_t *zeta_i, libcrux_ml_kem_polynomial_PolynomialRingElement_d2 *re) {
  KRML_MAYBE_FOR16(
      i, (size_t)0U, (size_t)16U, (size_t)1U, size_t round = i;
      zeta_i[0U] = zeta_i[0U] + (size_t)1U;
...
*/
static KRML_MUSTINLINE void poly_barrett_reduce_d6_a7(
...
static KRML_MUSTINLINE void ntt_binomially_sampled_ring_element_b6(
    libcrux_ml_kem_polynomial_PolynomialRingElement_d2 *re) {
  ntt_at_layer_7_77(re);
  size_t zeta_i = (size_t)1U;
  ntt_at_layer_4_plus_ba(&zeta_i, re, (size_t)6U);
  ntt_at_layer_4_plus_ba(&zeta_i, re, (size_t)5U);
  ntt_at_layer_4_plus_ba(&zeta_i, re, (size_t)4U);
  ntt_at_layer_3_b7(&zeta_i, re);
  ntt_at_layer_2_20(&zeta_i, re);
  ntt_at_layer_1_91(&zeta_i, re);
  poly_barrett_reduce_d6_a7(re);
}
...
*/
static KRML_MUSTINLINE uint8_t sample_vector_cbd_then_ntt_6e1(
  ...
  KRML_MAYBE_FOR3(
      i, (size_t)0U, (size_t)3U, (size_t)1U, size_t i0 = i;
      re_as_ntt[i0] = sample_from_binomial_distribution_d5(
...
- ETA_RANDOMNESS_SIZE= 128
*/
static KRML_MUSTINLINE tuple_b0 sample_vector_cbd_then_ntt_out_1a1(
    uint8_t prf_input[33U], uint8_t domain_separator) {
  ...
  domain_separator =
      sample_vector_cbd_then_ntt_6e1(uu____0, uu____1, domain_separator);
  /* Passing arrays by value in Rust generates a copy in C */
...
*/
static KRML_MUSTINLINE libcrux_ml_kem_polynomial_PolynomialRingElement_d2
ntt_multiply_d6_5f(libcrux_ml_kem_polynomial_PolynomialRingElement_d2 *self,
...
- K= 3
*/
static KRML_MUSTINLINE void add_to_ring_element_d6_131(
    libcrux_ml_kem_polynomial_PolynomialRingElement_d2 *self,
    libcrux_ml_kem_polynomial_PolynomialRingElement_d2 *rhs) {
  for (size_t i = (size_t)0U;
...
*/
static __m256i to_standard_domain_07(__m256i v) {
...
*/
static KRML_MUSTINLINE void add_standard_error_reduce_d6_9a(
    libcrux_ml_kem_polynomial_PolynomialRingElement_d2 *self,
  ...
  for (size_t i = (size_t)0U;
    ...
    __m256i coefficient_normal_form =
        to_standard_domain_07(self->coefficients[j]);
  ...
  for (size_t i = (size_t)0U;
    ...
    for (size_t i1 = (size_t)0U;
      ...
      libcrux_ml_kem_polynomial_PolynomialRingElement_d2 product =
          ntt_multiply_d6_5f(matrix_element, &s_as_ntt[j]);
      add_to_ring_element_d6_131(&t_as_ntt[i0], &product);
    }
    add_standard_error_reduce_d6_9a(&t_as_ntt[i0], &error_as_ntt[i0]);
  }
}
...
*/
static void generate_keypair_unpacked_a51(
    Eurydice_slice key_generation_seed,
    IndCpaPrivateKeyUnpacked_a0 *private_key,
    IndCpaPublicKeyUnpacked_a0 *public_key) {
  uint8_t hashed[64U];
  cpa_keygen_seed_d8_521(key_generation_seed, hashed);
  ...
  sample_matrix_A_591(uu____1, ret, true);
  ...
  uint8_t domain_separator =
      sample_vector_cbd_then_ntt_6e1(uu____2, copy_of_prf_input0, 0U);
  /* Passing arrays by value in Rust generates a copy in C */
  uint8_t copy_of_prf_input[33U];
  memcpy(copy_of_prf_input, prf_input, (size_t)33U * sizeof(uint8_t));
  ...
  memcpy(
      error_as_ntt,
      sample_vector_cbd_then_ntt_out_1a1(copy_of_prf_input, domain_separator)
          .fst,
      (size_t)3U * sizeof(libcrux_ml_kem_polynomial_PolynomialRingElement_d2));
...
- ETA1_RANDOMNESS_SIZE= 128
*/
static libcrux_ml_kem_utils_extraction_helper_Keypair768 generate_keypair_c11(
    Eurydice_slice key_generation_seed) {
  IndCpaPrivateKeyUnpacked_a0 private_key = default_1a_191();
  IndCpaPublicKeyUnpacked_a0 public_key = default_8d_801();
  generate_keypair_unpacked_a51(key_generation_seed, &private_key, &public_key);
  uint8_t public_key_serialized[1184U];
  serialize_public_key_371(
      public_key.t_as_ntt,
  ...
  serialize_secret_key_191(private_key.secret_as_ntt, secret_key_serialized);
  /* Passing arrays by value in Rust generates a copy in C */
...
*/
static KRML_MUSTINLINE void serialize_kem_secret_key_901(
...
libcrux_ml_kem_ind_cca_generate_keypair_7a1(uint8_t randomness[64U]) {
  ...
  libcrux_ml_kem_utils_extraction_helper_Keypair768 uu____0 =
      generate_keypair_c11(ind_cpa_keypair_randomness);
  uint8_t ind_cpa_private_key[1152U];
  memcpy(ind_cpa_private_key, uu____0.fst, (size_t)1152U * sizeof(uint8_t));
  uint8_t public_key[1184U];
  memcpy(public_key, uu____0.snd, (size_t)1184U * sizeof(uint8_t));
  uint8_t secret_key_serialized[2400U];
  serialize_kem_secret_key_901(
...
- K= 3
*/
static KRML_MUSTINLINE void entropy_preprocess_d8_5d1(Eurydice_slice randomness,
                                                      uint8_t ret[32U]) {
  uint8_t out[32U] = {0U};
...
- K= 3
*/
static KRML_MUSTINLINE void deserialize_ring_elements_reduced_c51(
    Eurydice_slice public_key,
    libcrux_ml_kem_polynomial_PolynomialRingElement_d2 *deserialized_pk) {
  for (size_t i = (size_t)0U;
       i < Eurydice_slice_len(public_key, uint8_t) /
...
sample_ring_element_cbd_5b1(uint8_t prf_input[33U], uint8_t domain_separator) {
  ...
  KRML_MAYBE_FOR3(
      ...
      libcrux_ml_kem_polynomial_PolynomialRingElement_d2 uu____1 =
          sample_from_binomial_distribution_d5(
              Eurydice_array_to_slice((size_t)128U, prf_outputs[i0], uint8_t));
      error_1[i0] = uu____1;);
  /* Passing arrays by value in Rust generates a copy in C */
...
*/
static KRML_MUSTINLINE void invert_ntt_at_layer_1_a9(
    size_t *zeta_i, libcrux_ml_kem_polynomial_PolynomialRingElement_d2 *re) {
  KRML_MAYBE_FOR16(
      i, (size_t)0U, (size_t)16U, (size_t)1U, size_t round = i;
      zeta_i[0U] = zeta_i[0U] - (size_t)1U;
...
*/
static KRML_MUSTINLINE void invert_ntt_at_layer_2_c9(
    size_t *zeta_i, libcrux_ml_kem_polynomial_PolynomialRingElement_d2 *re) {
  KRML_MAYBE_FOR16(
      i, (size_t)0U, (size_t)16U, (size_t)1U, size_t round = i;
      zeta_i[0U] = zeta_i[0U] - (size_t)1U;
...
*/
static KRML_MUSTINLINE void invert_ntt_at_layer_3_e8(
    size_t *zeta_i, libcrux_ml_kem_polynomial_PolynomialRingElement_d2 *re) {
  KRML_MAYBE_FOR16(
      i, (size_t)0U, (size_t)16U, (size_t)1U, size_t round = i;
      zeta_i[0U] = zeta_i[0U] - (size_t)1U;
...
*/
static KRML_MUSTINLINE libcrux_ml_kem_vector_avx2_SIMD256Vector_x2
inv_ntt_layer_int_vec_step_reduce_af(__m256i a, __m256i b, int16_t zeta_r) {
  ...
  b = montgomery_multiply_fe_78(a_minus_b, zeta_r);
  return (CLITERAL(libcrux_ml_kem_vector_avx2_SIMD256Vector_x2){.fst = a,
                                                                .snd = b});
}
...
*/
static KRML_MUSTINLINE void invert_ntt_at_layer_4_plus_4a(
    size_t *zeta_i, libcrux_ml_kem_polynomial_PolynomialRingElement_d2 *re,
    size_t layer) {
  size_t step = (size_t)1U << (uint32_t)layer;
  for (size_t i0 = (size_t)0U; i0 < (size_t)128U >> (uint32_t)layer; i0++) {
...
- K= 3
*/
static KRML_MUSTINLINE void invert_ntt_montgomery_bf1(
    libcrux_ml_kem_polynomial_PolynomialRingElement_d2 *re) {
  size_t zeta_i =
      LIBCRUX_ML_KEM_CONSTANTS_COEFFICIENTS_IN_RING_ELEMENT / (size_t)2U;
  invert_ntt_at_layer_1_a9(&zeta_i, re);
  invert_ntt_at_layer_2_c9(&zeta_i, re);
  invert_ntt_at_layer_3_e8(&zeta_i, re);
  invert_ntt_at_layer_4_plus_4a(&zeta_i, re, (size_t)4U);
  invert_ntt_at_layer_4_plus_4a(&zeta_i, re, (size_t)5U);
  invert_ntt_at_layer_4_plus_4a(&zeta_i, re, (size_t)6U);
  invert_ntt_at_layer_4_plus_4a(&zeta_i, re, (size_t)7U);
  poly_barrett_reduce_d6_a7(re);
}
...
*/
static KRML_MUSTINLINE void add_error_reduce_d6_f4(
    libcrux_ml_kem_polynomial_PolynomialRingElement_d2 *self,
    libcrux_ml_kem_polynomial_PolynomialRingElement_d2 *error) {
  for (size_t i = (size_t)0U;
       i < LIBCRUX_ML_KEM_POLYNOMIAL_VECTORS_IN_RING_ELEMENT; i++) {
...
- K= 3
*/
static KRML_MUSTINLINE void compute_vector_u_c61(
  ...
  for (size_t i0 = (size_t)0U;
    ...
    for (size_t i = (size_t)0U;
      ...
      libcrux_ml_kem_polynomial_PolynomialRingElement_d2 product =
          ntt_multiply_d6_5f(a_element, &r_as_ntt[j]);
      add_to_ring_element_d6_131(&result[i1], &product);
    }
    invert_ntt_montgomery_bf1(&result[i1]);
    add_error_reduce_d6_f4(&result[i1], &error_1[i1]);
  }
  memcpy(
      ret, result,
      (size_t)3U * sizeof(libcrux_ml_kem_polynomial_PolynomialRingElement_d2));
...
*/
static __m256i decompress_1_a0(__m256i v) {
...
*/
static KRML_MUSTINLINE libcrux_ml_kem_polynomial_PolynomialRingElement_d2
deserialize_then_decompress_message_37(uint8_t serialized[32U]) {
  libcrux_ml_kem_polynomial_PolynomialRingElement_d2 re = ZERO_d6_7d();
  KRML_MAYBE_FOR16(
      ...
      __m256i coefficient_compressed =
          libcrux_ml_kem_vector_avx2_deserialize_1_ea(
              Eurydice_array_to_subslice2(serialized, (size_t)2U * i0,
                                          ...
                                          uint8_t));
      re.coefficients[i0] = decompress_1_a0(coefficient_compressed););
  return re;
}
...
*/
static KRML_MUSTINLINE libcrux_ml_kem_polynomial_PolynomialRingElement_d2
add_message_error_reduce_d6_a6(
    libcrux_ml_kem_polynomial_PolynomialRingElement_d2 *self,
...
compute_ring_element_v_d01(
  ...
  KRML_MAYBE_FOR3(i, (size_t)0U, (size_t)3U, (size_t)1U, size_t i0 = i;
                  libcrux_ml_kem_polynomial_PolynomialRingElement_d2 product =
                      ntt_multiply_d6_5f(&t_as_ntt[i0], &r_as_ntt[i0]);
                  add_to_ring_element_d6_131(&result, &product););
  invert_ntt_montgomery_bf1(&result);
  result = add_message_error_reduce_d6_a6(error_2, message, result);
  return result;
}
...
compress_ciphertext_coefficient_fb(__m256i vector) {
...
- COEFFICIENT_BITS= 10
*/
static __m256i compress_ea_43(__m256i vector) {
  return compress_ciphertext_coefficient_fb(vector);
}
...
- OUT_LEN= 320
*/
static KRML_MUSTINLINE void compress_then_serialize_10_d20(
  ...
  for (size_t i = (size_t)0U;
    ...
    size_t i0 = i;
    __m256i coefficient =
        compress_ea_43(to_unsigned_representative_32(re->coefficients[i0]));
    uint8_t bytes[20U];
...
*/
static KRML_MUSTINLINE __m256i
compress_ciphertext_coefficient_fb0(__m256i vector) {
  __m256i field_modulus_halved = mm256_set1_epi32(
      ((int32_t)LIBCRUX_ML_KEM_VECTOR_TRAITS_FIELD_MODULUS - (int32_t)1) /
      (int32_t)2);
  __m256i compression_factor = mm256_set1_epi32((int32_t)10321340);
...
- COEFFICIENT_BITS= 11
*/
static __m256i compress_ea_430(__m256i vector) {
  return compress_ciphertext_coefficient_fb0(vector);
}
...
- OUT_LEN= 320
*/
static KRML_MUSTINLINE void compress_then_serialize_ring_element_u_cc0(
    libcrux_ml_kem_polynomial_PolynomialRingElement_d2 *re, uint8_t ret[320U]) {
  uint8_t uu____0[320U];
  compress_then_serialize_10_d20(re, uu____0);
...
- BLOCK_LEN= 320
*/
static void compress_then_serialize_u_9e1(
  ...
  for (size_t i = (size_t)0U;
    ...
    uint8_t ret[320U];
    compress_then_serialize_ring_element_u_cc0(&re, ret);
    Eurydice_slice_copy(
...
*/
static KRML_MUSTINLINE __m256i
compress_ciphertext_coefficient_fb1(__m256i vector) {
  __m256i field_modulus_halved = mm256_set1_epi32(
      ((int32_t)LIBCRUX_ML_KEM_VECTOR_TRAITS_FIELD_MODULUS - (int32_t)1) /
      (int32_t)2);
  __m256i compression_factor = mm256_set1_epi32((int32_t)10321340);
...
- COEFFICIENT_BITS= 4
*/
static __m256i compress_ea_431(__m256i vector) {
  return compress_ciphertext_coefficient_fb1(vector);
}
...
*/
static KRML_MUSTINLINE void compress_then_serialize_4_8a(
    libcrux_ml_kem_polynomial_PolynomialRingElement_d2 re,
  ...
  for (size_t i = (size_t)0U;
    ...
    size_t i0 = i;
    __m256i coefficient =
        compress_ea_431(to_unsigned_representative_32(re.coefficients[i0]));
    uint8_t bytes[8U];
...
*/
static KRML_MUSTINLINE __m256i
compress_ciphertext_coefficient_fb2(__m256i vector) {
  __m256i field_modulus_halved = mm256_set1_epi32(
      ((int32_t)LIBCRUX_ML_KEM_VECTOR_TRAITS_FIELD_MODULUS - (int32_t)1) /
      (int32_t)2);
  __m256i compression_factor = mm256_set1_epi32((int32_t)10321340);
...
- COEFFICIENT_BITS= 5
*/
static __m256i compress_ea_432(__m256i vector) {
  return compress_ciphertext_coefficient_fb2(vector);
}
...
*/
static KRML_MUSTINLINE void compress_then_serialize_5_f8(
    libcrux_ml_kem_polynomial_PolynomialRingElement_d2 re,
    Eurydice_slice serialized) {
  for (size_t i = (size_t)0U;
       i < LIBCRUX_ML_KEM_POLYNOMIAL_VECTORS_IN_RING_ELEMENT; i++) {
    ...
    __m256i coefficients =
        compress_ea_432(to_unsigned_representative_32(re.coefficients[i0]));
    uint8_t bytes[10U];
...
- OUT_LEN= 128
*/
static KRML_MUSTINLINE void compress_then_serialize_ring_element_v_bb0(
    libcrux_ml_kem_polynomial_PolynomialRingElement_d2 re, Eurydice_slice out) {
  compress_then_serialize_4_8a(re, out);
}
...
- ETA2_RANDOMNESS_SIZE= 128
*/
static void encrypt_unpacked_5d1(IndCpaPublicKeyUnpacked_a0 *public_key,
                                 uint8_t message[32U],
  ...
  uint8_t copy_of_prf_input0[33U];
  memcpy(copy_of_prf_input0, prf_input, (size_t)33U * sizeof(uint8_t));
  tuple_b0 uu____1 = sample_vector_cbd_then_ntt_out_1a1(copy_of_prf_input0, 0U);
  ...
  memcpy(copy_of_prf_input, prf_input, (size_t)33U * sizeof(uint8_t));
  tuple_b0 uu____3 =
      sample_ring_element_cbd_5b1(copy_of_prf_input, domain_separator0);
  libcrux_ml_kem_polynomial_PolynomialRingElement_d2 error_1[3U];
  memcpy(
      error_1, uu____3.fst,
      (size_t)3U * sizeof(libcrux_ml_kem_polynomial_PolynomialRingElement_d2));
  ...
  compute_vector_u_c61(public_key->A, r_as_ntt, error_1, u);
  /* Passing arrays by value in Rust generates a copy in C */
  ...
  libcrux_ml_kem_polynomial_PolynomialRingElement_d2 message_as_ring_element =
      deserialize_then_decompress_message_37(copy_of_message);
  libcrux_ml_kem_polynomial_PolynomialRingElement_d2 v =
      compute_ring_element_v_d01(public_key->t_as_ntt, r_as_ntt, &error_2,
  ...
  compress_then_serialize_ring_element_v_bb0(
...
- ETA2_RANDOMNESS_SIZE= 128
*/
static void encrypt_0f1(Eurydice_slice public_key, uint8_t message[32U],
                        Eurydice_slice randomness, uint8_t ret[1088U]) {
  IndCpaPublicKeyUnpacked_a0 unpacked_public_key = default_8d_801();
  deserialize_ring_elements_reduced_c51(
  ...
  sample_matrix_A_591(uu____0, ret0, false);
  IndCpaPublicKeyUnpacked_a0 *uu____1 = &unpacked_public_key;
  /* Passing arrays by value in Rust generates a copy in C */
  uint8_t copy_of_message[32U];
  memcpy(copy_of_message, message, (size_t)32U * sizeof(uint8_t));
  uint8_t ret1[1088U];
  encrypt_unpacked_5d1(uu____1, copy_of_message, randomness, ret1);
...
- CIPHERTEXT_SIZE= 1088
*/
static KRML_MUSTINLINE void kdf_d8_951(Eurydice_slice shared_secret,
                                       uint8_t ret[32U]) {
  uint8_t out[32U] = {0U};
  Eurydice_slice_copy(Eurydice_array_to_slice((size_t)32U, out, uint8_t),
...
tuple_3c libcrux_ml_kem_ind_cca_encapsulate_4a1(
  ...
  encrypt_0f1(uu____2, copy_of_randomness, pseudorandomness, ciphertext);
  /* Passing arrays by value in Rust generates a copy in C */
  ...
  kdf_d8_951(shared_secret, shared_secret_array);
...
*/
static KRML_MUSTINLINE libcrux_ml_kem_polynomial_PolynomialRingElement_d2
deserialize_to_uncompressed_ring_element_e3(Eurydice_slice serialized) {
  libcrux_ml_kem_polynomial_PolynomialRingElement_d2 re = ZERO_d6_7d();
  for (size_t i = (size_t)0U;
       i < Eurydice_slice_len(serialized, uint8_t) / (size_t)24U; i++) {
    size_t i0 = i;
...
- K= 3
*/
static KRML_MUSTINLINE void deserialize_secret_key_131(
  ...
  for (size_t i = (size_t)0U;
    ...
    Eurydice_slice secret_bytes = Eurydice_slice_subslice2(
        ...
        uint8_t);
    libcrux_ml_kem_polynomial_PolynomialRingElement_d2 uu____0 =
        deserialize_to_uncompressed_ring_element_e3(secret_bytes);
...
*/
static KRML_MUSTINLINE __m256i
decompress_ciphertext_coefficient_39(__m256i vector) {
  __m256i field_modulus =
...
static __m256i decompress_ciphertext_coefficient_ea_64(__m256i vector) {
  return decompress_ciphertext_coefficient_39(vector);
}
...
*/
static KRML_MUSTINLINE __m256i
decompress_ciphertext_coefficient_390(__m256i vector) {
  __m256i field_modulus =
      mm256_set1_epi32((int32_t)LIBCRUX_ML_KEM_VECTOR_TRAITS_FIELD_MODULUS);
  __m256i two_pow_coefficient_bits =
...
static __m256i decompress_ciphertext_coefficient_ea_640(__m256i vector) {
  return decompress_ciphertext_coefficient_390(vector);
}
...
*/
static KRML_MUSTINLINE libcrux_ml_kem_polynomial_PolynomialRingElement_d2
deserialize_then_decompress_ring_element_u_320(Eurydice_slice serialized) {
...
- VECTOR_U_COMPRESSION_FACTOR= 10
*/
static KRML_MUSTINLINE void ntt_vector_u_4d0(
    libcrux_ml_kem_polynomial_PolynomialRingElement_d2 *re) {
  size_t zeta_i = (size_t)0U;
  ntt_at_layer_4_plus_ba(&zeta_i, re, (size_t)7U);
  ntt_at_layer_4_plus_ba(&zeta_i, re, (size_t)6U);
  ntt_at_layer_4_plus_ba(&zeta_i, re, (size_t)5U);
  ntt_at_layer_4_plus_ba(&zeta_i, re, (size_t)4U);
  ntt_at_layer_3_b7(&zeta_i, re);
...
- U_COMPRESSION_FACTOR= 10
*/
static KRML_MUSTINLINE void deserialize_then_decompress_u_1f1(
    uint8_t *ciphertext,
    libcrux_ml_kem_polynomial_PolynomialRingElement_d2 ret[3U]) {
    ...
    Eurydice_slice u_bytes = Eurydice_array_to_subslice2(
        ...
        i0 * (LIBCRUX_ML_KEM_CONSTANTS_COEFFICIENTS_IN_RING_ELEMENT *
            ...
            LIBCRUX_ML_KEM_CONSTANTS_COEFFICIENTS_IN_RING_ELEMENT *
                (size_t)10U / (size_t)8U,
        uint8_t);
    u_as_ntt[i0] = deserialize_then_decompress_ring_element_u_320(u_bytes);
    ntt_vector_u_4d0(&u_as_ntt[i0]);
  }
  memcpy(
      ret, u_as_ntt,
      (size_t)3U * sizeof(libcrux_ml_kem_polynomial_PolynomialRingElement_d2));
...
*/
static KRML_MUSTINLINE __m256i
decompress_ciphertext_coefficient_391(__m256i vector) {
  __m256i field_modulus =
      mm256_set1_epi32((int32_t)LIBCRUX_ML_KEM_VECTOR_TRAITS_FIELD_MODULUS);
  __m256i two_pow_coefficient_bits =
...
static __m256i decompress_ciphertext_coefficient_ea_641(__m256i vector) {
  return decompress_ciphertext_coefficient_391(vector);
}
...
*/
static KRML_MUSTINLINE __m256i
decompress_ciphertext_coefficient_392(__m256i vector) {
  __m256i field_modulus =
      mm256_set1_epi32((int32_t)LIBCRUX_ML_KEM_VECTOR_TRAITS_FIELD_MODULUS);
  __m256i two_pow_coefficient_bits =
...
static __m256i decompress_ciphertext_coefficient_ea_642(__m256i vector) {
  return decompress_ciphertext_coefficient_392(vector);
}
...
*/
static KRML_MUSTINLINE libcrux_ml_kem_polynomial_PolynomialRingElement_d2
deserialize_then_decompress_5_7e(Eurydice_slice serialized) {
  libcrux_ml_kem_polynomial_PolynomialRingElement_d2 re = ZERO_d6_7d();
  for (size_t i = (size_t)0U;
...
*/
static KRML_MUSTINLINE libcrux_ml_kem_polynomial_PolynomialRingElement_d2
deserialize_then_decompress_ring_element_v_7b0(Eurydice_slice serialized) {
...
*/
static KRML_MUSTINLINE libcrux_ml_kem_polynomial_PolynomialRingElement_d2
subtract_reduce_d6_a7(libcrux_ml_kem_polynomial_PolynomialRingElement_d2 *self,
...
compute_message_1b1(
  ...
  KRML_MAYBE_FOR3(i, (size_t)0U, (size_t)3U, (size_t)1U, size_t i0 = i;
                  libcrux_ml_kem_polynomial_PolynomialRingElement_d2 product =
                      ntt_multiply_d6_5f(&secret_as_ntt[i0], &u_as_ntt[i0]);
                  add_to_ring_element_d6_131(&result, &product););
  invert_ntt_montgomery_bf1(&result);
  result = subtract_reduce_d6_a7(v, result);
  return result;
}
...
- V_COMPRESSION_FACTOR= 4
*/
static void decrypt_unpacked_e71(IndCpaPrivateKeyUnpacked_a0 *secret_key,
                                 uint8_t *ciphertext, uint8_t ret[32U]) {
  libcrux_ml_kem_polynomial_PolynomialRingElement_d2 u_as_ntt[3U];
  deserialize_then_decompress_u_1f1(ciphertext, u_as_ntt);
  libcrux_ml_kem_polynomial_PolynomialRingElement_d2 v =
      deserialize_then_decompress_ring_element_v_7b0(
          Eurydice_array_to_subslice_from((size_t)1088U, ciphertext,
                                          (size_t)960U, uint8_t, size_t));
  libcrux_ml_kem_polynomial_PolynomialRingElement_d2 message =
      compute_message_1b1(&v, secret_key->secret_as_ntt, u_as_ntt);
  uint8_t ret0[32U];
  compress_then_serialize_message_0e(message, ret0);
...
- V_COMPRESSION_FACTOR= 4
*/
static void decrypt_481(Eurydice_slice secret_key, uint8_t *ciphertext,
                        uint8_t ret[32U]) {
  libcrux_ml_kem_polynomial_PolynomialRingElement_d2 secret_as_ntt[3U];
  deserialize_secret_key_131(secret_key, secret_as_ntt);
  /* Passing arrays by value in Rust generates a copy in C */
...
void libcrux_ml_kem_ind_cca_decapsulate_051(
  ...
  decrypt_481(ind_cpa_secret_key, ciphertext->value, decrypted);
  ...
  encrypt_0f1(uu____5, copy_of_decrypted, pseudorandomness,
              expected_ciphertext);
  uint8_t implicit_rejection_shared_secret[32U];
  kdf_d8_951(Eurydice_array_to_slice(
                 (size_t)32U, implicit_rejection_shared_secret0, uint8_t),
             implicit_rejection_shared_secret);
  uint8_t shared_secret[32U];
  kdf_d8_951(shared_secret0, shared_secret);
  uint8_t ret0[32U];
...
- K= 4
*/
static KRML_MUSTINLINE void deserialize_ring_elements_reduced_c53(
    Eurydice_slice public_key,
    libcrux_ml_kem_polynomial_PolynomialRingElement_d2 *deserialized_pk) {
  for (size_t i = (size_t)0U;
       i < Eurydice_slice_len(public_key, uint8_t) /
...
- K= 4
*/
static KRML_MUSTINLINE void deserialize_ring_elements_reduced_out_550(
    Eurydice_slice public_key,
  ...
  KRML_MAYBE_FOR4(i, (size_t)0U, (size_t)4U, (size_t)1U,
                  deserialized_pk[i] = ZERO_d6_7d(););
  deserialize_ring_elements_reduced_c53(public_key, deserialized_pk);
  memcpy(
      ret, deserialized_pk,
...
- OUT_LEN= 1536
*/
static KRML_MUSTINLINE void serialize_secret_key_19(
    libcrux_ml_kem_polynomial_PolynomialRingElement_d2 *key,
    uint8_t ret[1536U]) {
...
- PUBLIC_KEY_SIZE= 1568
*/
static KRML_MUSTINLINE void serialize_public_key_mut_ac(
    libcrux_ml_kem_polynomial_PolynomialRingElement_d2 *t_as_ntt,
    Eurydice_slice seed_for_a, uint8_t *serialized) {
  Eurydice_slice uu____0 = Eurydice_array_to_subslice2(serialized, (size_t)0U,
                                                       (size_t)1536U, uint8_t);
  uint8_t ret[1536U];
  serialize_secret_key_19(t_as_ntt, ret);
  Eurydice_slice_copy(
...
- PUBLIC_KEY_SIZE= 1568
*/
static KRML_MUSTINLINE void serialize_public_key_37(
    libcrux_ml_kem_polynomial_PolynomialRingElement_d2 *t_as_ntt,
    Eurydice_slice seed_for_a, uint8_t ret[1568U]) {
  uint8_t public_key_serialized[1568U] = {0U};
  serialize_public_key_mut_ac(t_as_ntt, seed_for_a, public_key_serialized);
...
- K= 4
*/
static KRML_MUSTINLINE void cpa_keygen_seed_d8_52(
    Eurydice_slice key_generation_seed, uint8_t ret[64U]) {
  uint8_t seed[33U] = {0U};
  Eurydice_slice_copy(
      Eurydice_array_to_subslice2(
...
- N= 504
*/
static KRML_MUSTINLINE bool sample_from_uniform_distribution_next_e0(
...
- N= 168
*/
static KRML_MUSTINLINE bool sample_from_uniform_distribution_next_e00(
...
- K= 4
*/
static libcrux_ml_kem_polynomial_PolynomialRingElement_d2 closure_b7(
    int16_t s[272U]) {
  return from_i16_array_d6_34(
      Eurydice_array_to_subslice2(s, (size_t)0U, (size_t)256U, int16_t));
}
...
- K= 4
*/
static KRML_MUSTINLINE void sample_from_xof_59(
  ...
  bool done = sample_from_uniform_distribution_next_e0(
      copy_of_randomness0, sampled_coefficients, out);
  while (true) {
    if (done) {
      break;
      ...
      done = sample_from_uniform_distribution_next_e00(
          copy_of_randomness, sampled_coefficients, out);
    }
  }
  /* Passing arrays by value in Rust generates a copy in C */
  ...
  KRML_MAYBE_FOR4(i, (size_t)0U, (size_t)4U, (size_t)1U,
                  ret0[i] = closure_b7(copy_of_out[i]););
  memcpy(
      ret, ret0,
      (size_t)4U * sizeof(libcrux_ml_kem_polynomial_PolynomialRingElement_d2));
}
...
- K= 4
*/
static KRML_MUSTINLINE void sample_matrix_A_59(
  ...
  KRML_MAYBE_FOR4(
      ...
      sample_from_xof_59(copy_of_seeds, sampled);
      for (size_t i = (size_t)0U;
           i < Eurydice_slice_len(
                   Eurydice_array_to_slice(
                       (size_t)4U, sampled,
...
- ETA_RANDOMNESS_SIZE= 128
*/
static KRML_MUSTINLINE tuple_71 sample_vector_cbd_then_ntt_out_1a(
    uint8_t prf_input[33U], uint8_t domain_separator) {
  ...
  memcpy(uu____1, prf_input, (size_t)33U * sizeof(uint8_t));
  domain_separator =
      sample_vector_cbd_then_ntt_6e(uu____0, uu____1, domain_separator);
  /* Passing arrays by value in Rust generates a copy in C */
...
- K= 4
*/
static KRML_MUSTINLINE void add_to_ring_element_d6_13(
    libcrux_ml_kem_polynomial_PolynomialRingElement_d2 *self,
    libcrux_ml_kem_polynomial_PolynomialRingElement_d2 *rhs) {
  for (size_t i = (size_t)0U;
       i < Eurydice_slice_len(Eurydice_array_to_slice(
...
static KRML_MUSTINLINE void compute_As_plus_e_91(
  ...
  for (size_t i = (size_t)0U;
    ...
    for (size_t i1 = (size_t)0U;
      ...
      libcrux_ml_kem_polynomial_PolynomialRingElement_d2 product =
          ntt_multiply_d6_5f(matrix_element, &s_as_ntt[j]);
      add_to_ring_element_d6_13(&t_as_ntt[i0], &product);
    }
    add_standard_error_reduce_d6_9a(&t_as_ntt[i0], &error_as_ntt[i0]);
  }
}
...
- ETA1_RANDOMNESS_SIZE= 128
*/
static void generate_keypair_unpacked_a5(
    Eurydice_slice key_generation_seed,
    IndCpaPrivateKeyUnpacked_01 *private_key,
    IndCpaPublicKeyUnpacked_01 *public_key) {
  uint8_t hashed[64U];
  cpa_keygen_seed_d8_52(key_generation_seed, hashed);
  Eurydice_slice_uint8_t_x2 uu____0 = Eurydice_slice_split_at(
      Eurydice_array_to_slice((size_t)64U, hashed, uint8_t), (size_t)32U,
      uint8_t, Eurydice_slice_uint8_t_x2);
  Eurydice_slice seed_for_A = uu____0.fst;
  ...
  uint8_t ret[34U];
  libcrux_ml_kem_utils_into_padded_array_422(seed_for_A, ret);
  sample_matrix_A_59(uu____1, ret, true);
  uint8_t prf_input[33U];
  libcrux_ml_kem_utils_into_padded_array_421(seed_for_secret_and_error,
                                             prf_input);
  libcrux_ml_kem_polynomial_PolynomialRingElement_d2 *uu____2 =
  ...
  memcpy(copy_of_prf_input0, prf_input, (size_t)33U * sizeof(uint8_t));
  uint8_t domain_separator =
      sample_vector_cbd_then_ntt_6e(uu____2, copy_of_prf_input0, 0U);
  /* Passing arrays by value in Rust generates a copy in C */
  uint8_t copy_of_prf_input[33U];
  memcpy(copy_of_prf_input, prf_input, (size_t)33U * sizeof(uint8_t));
  ...
  memcpy(
      error_as_ntt,
      sample_vector_cbd_then_ntt_out_1a(copy_of_prf_input, domain_separator)
          .fst,
      (size_t)4U * sizeof(libcrux_ml_kem_polynomial_PolynomialRingElement_d2));
...
- ETA1_RANDOMNESS_SIZE= 128
*/
static libcrux_ml_kem_utils_extraction_helper_Keypair1024 generate_keypair_c10(
    Eurydice_slice key_generation_seed) {
  IndCpaPrivateKeyUnpacked_01 private_key = default_1a_19();
  IndCpaPublicKeyUnpacked_01 public_key = default_8d_80();
  generate_keypair_unpacked_a5(key_generation_seed, &private_key, &public_key);
  uint8_t public_key_serialized[1568U];
  serialize_public_key_37(
      public_key.t_as_ntt,
      Eurydice_array_to_slice((size_t)32U, public_key.seed_for_A, uint8_t),
  ...
  serialize_secret_key_19(private_key.secret_as_ntt, secret_key_serialized);
  /* Passing arrays by value in Rust generates a copy in C */
...
*/
static KRML_MUSTINLINE void serialize_kem_secret_key_900(
    Eurydice_slice private_key, Eurydice_slice public_key,
...
libcrux_ml_kem_ind_cca_generate_keypair_7a0(uint8_t randomness[64U]) {
  ...
  libcrux_ml_kem_utils_extraction_helper_Keypair1024 uu____0 =
      generate_keypair_c10(ind_cpa_keypair_randomness);
...
- K= 4
*/
static KRML_MUSTINLINE void entropy_preprocess_d8_5d0(Eurydice_slice randomness,
                                                      uint8_t ret[32U]) {
  uint8_t out[32U] = {0U};
  Eurydice_slice_copy(Eurydice_array_to_slice((size_t)32U, out, uint8_t),
                      randomness, uint8_t);
...
sample_ring_element_cbd_5b(uint8_t prf_input[33U], uint8_t domain_separator) {
...
- K= 4
*/
static KRML_MUSTINLINE void invert_ntt_montgomery_bf(
    libcrux_ml_kem_polynomial_PolynomialRingElement_d2 *re) {
  size_t zeta_i =
      LIBCRUX_ML_KEM_CONSTANTS_COEFFICIENTS_IN_RING_ELEMENT / (size_t)2U;
  invert_ntt_at_layer_1_a9(&zeta_i, re);
...
- K= 4
*/
static KRML_MUSTINLINE void compute_vector_u_c6(
  ...
  for (size_t i0 = (size_t)0U;
    ...
    for (size_t i = (size_t)0U;
      ...
      libcrux_ml_kem_polynomial_PolynomialRingElement_d2 product =
          ntt_multiply_d6_5f(a_element, &r_as_ntt[j]);
      add_to_ring_element_d6_13(&result[i1], &product);
    }
    invert_ntt_montgomery_bf(&result[i1]);
    add_error_reduce_d6_f4(&result[i1], &error_1[i1]);
  }
  memcpy(
      ret, result,
...
compute_ring_element_v_d0(
  ...
  KRML_MAYBE_FOR4(i, (size_t)0U, (size_t)4U, (size_t)1U, size_t i0 = i;
                  libcrux_ml_kem_polynomial_PolynomialRingElement_d2 product =
                      ntt_multiply_d6_5f(&t_as_ntt[i0], &r_as_ntt[i0]);
                  add_to_ring_element_d6_13(&result, &product););
  invert_ntt_montgomery_bf(&result);
  result = add_message_error_reduce_d6_a6(error_2, message, result);
  return result;
}
...
- OUT_LEN= 352
*/
static KRML_MUSTINLINE void compress_then_serialize_11_81(
  ...
  for (size_t i = (size_t)0U;
    ...
    size_t i0 = i;
    __m256i coefficient =
        compress_ea_430(to_unsigned_representative_32(re->coefficients[i0]));
    uint8_t bytes[22U];
...
- OUT_LEN= 352
*/
static KRML_MUSTINLINE void compress_then_serialize_ring_element_u_cc(
    libcrux_ml_kem_polynomial_PolynomialRingElement_d2 *re, uint8_t ret[352U]) {
  uint8_t uu____0[352U];
  compress_then_serialize_11_81(re, uu____0);
...
- BLOCK_LEN= 352
*/
static void compress_then_serialize_u_9e(
  ...
  for (size_t i = (size_t)0U;
    ...
    uint8_t ret[352U];
    compress_then_serialize_ring_element_u_cc(&re, ret);
    Eurydice_slice_copy(
...
- OUT_LEN= 160
*/
static KRML_MUSTINLINE void compress_then_serialize_ring_element_v_bb(
    libcrux_ml_kem_polynomial_PolynomialRingElement_d2 re, Eurydice_slice out) {
  compress_then_serialize_5_f8(re, out);
}
...
- ETA2_RANDOMNESS_SIZE= 128
*/
static void encrypt_unpacked_5d(IndCpaPublicKeyUnpacked_01 *public_key,
  ...
  uint8_t copy_of_prf_input0[33U];
  memcpy(copy_of_prf_input0, prf_input, (size_t)33U * sizeof(uint8_t));
  tuple_71 uu____1 = sample_vector_cbd_then_ntt_out_1a(copy_of_prf_input0, 0U);
  ...
  memcpy(copy_of_prf_input, prf_input, (size_t)33U * sizeof(uint8_t));
  tuple_71 uu____3 =
      sample_ring_element_cbd_5b(copy_of_prf_input, domain_separator0);
  libcrux_ml_kem_polynomial_PolynomialRingElement_d2 error_1[4U];
  memcpy(
      error_1, uu____3.fst,
      (size_t)4U * sizeof(libcrux_ml_kem_polynomial_PolynomialRingElement_d2));
  ...
  compute_vector_u_c6(public_key->A, r_as_ntt, error_1, u);
  /* Passing arrays by value in Rust generates a copy in C */
  uint8_t copy_of_message[32U];
  memcpy(copy_of_message, message, (size_t)32U * sizeof(uint8_t));
  libcrux_ml_kem_polynomial_PolynomialRingElement_d2 message_as_ring_element =
...
- ETA2_RANDOMNESS_SIZE= 128
*/
static void encrypt_0f0(Eurydice_slice public_key, uint8_t message[32U],
  ...
  uint8_t ret0[34U];
  libcrux_ml_kem_utils_into_padded_array_422(seed, ret0);
  sample_matrix_A_59(uu____0, ret0, false);
  IndCpaPublicKeyUnpacked_01 *uu____1 = &unpacked_public_key;
  /* Passing arrays by value in Rust generates a copy in C */
  uint8_t copy_of_message[32U];
  memcpy(copy_of_message, message, (size_t)32U * sizeof(uint8_t));
  uint8_t ret1[1568U];
  encrypt_unpacked_5d(uu____1, copy_of_message, randomness, ret1);
...
- CIPHERTEXT_SIZE= 1568
*/
static KRML_MUSTINLINE void kdf_d8_950(Eurydice_slice shared_secret,
                                       uint8_t ret[32U]) {
  uint8_t out[32U] = {0U};
  Eurydice_slice_copy(Eurydice_array_to_slice((size_t)32U, out, uint8_t),
                      shared_secret, uint8_t);
...
tuple_21 libcrux_ml_kem_ind_cca_encapsulate_4a0(
  ...
  encrypt_0f0(uu____2, copy_of_randomness, pseudorandomness, ciphertext);
  /* Passing arrays by value in Rust generates a copy in C */
  ...
  uint8_t shared_secret_array[32U];
  kdf_d8_950(shared_secret, shared_secret_array);
...
- K= 4
*/
static KRML_MUSTINLINE void deserialize_secret_key_130(
    Eurydice_slice secret_key,
    libcrux_ml_kem_polynomial_PolynomialRingElement_d2 ret[4U]) {
  libcrux_ml_kem_polynomial_PolynomialRingElement_d2 secret_as_ntt[4U];
  KRML_MAYBE_FOR4(i, (size_t)0U, (size_t)4U, (size_t)1U,
...
*/
static KRML_MUSTINLINE libcrux_ml_kem_polynomial_PolynomialRingElement_d2
deserialize_then_decompress_ring_element_u_32(Eurydice_slice serialized) {
...
- VECTOR_U_COMPRESSION_FACTOR= 11
*/
static KRML_MUSTINLINE void ntt_vector_u_4d(
    libcrux_ml_kem_polynomial_PolynomialRingElement_d2 *re) {
  size_t zeta_i = (size_t)0U;
  ntt_at_layer_4_plus_ba(&zeta_i, re, (size_t)7U);
  ntt_at_layer_4_plus_ba(&zeta_i, re, (size_t)6U);
...
- U_COMPRESSION_FACTOR= 11
*/
static KRML_MUSTINLINE void deserialize_then_decompress_u_1f(
    uint8_t *ciphertext,
    libcrux_ml_kem_polynomial_PolynomialRingElement_d2 ret[4U]) {
    ...
    Eurydice_slice u_bytes = Eurydice_array_to_subslice2(
        ...
        i0 * (LIBCRUX_ML_KEM_CONSTANTS_COEFFICIENTS_IN_RING_ELEMENT *
            ...
            LIBCRUX_ML_KEM_CONSTANTS_COEFFICIENTS_IN_RING_ELEMENT *
                (size_t)11U / (size_t)8U,
        uint8_t);
    u_as_ntt[i0] = deserialize_then_decompress_ring_element_u_32(u_bytes);
    ntt_vector_u_4d(&u_as_ntt[i0]);
  }
  memcpy(
      ret, u_as_ntt,
      (size_t)4U * sizeof(libcrux_ml_kem_polynomial_PolynomialRingElement_d2));
...
*/
static KRML_MUSTINLINE libcrux_ml_kem_polynomial_PolynomialRingElement_d2
deserialize_then_decompress_ring_element_v_7b(Eurydice_slice serialized) {
  return deserialize_then_decompress_5_7e(serialized);
}
...
- V_COMPRESSION_FACTOR= 5
*/
static void decrypt_unpacked_e7(IndCpaPrivateKeyUnpacked_01 *secret_key,
                                uint8_t *ciphertext, uint8_t ret[32U]) {
  libcrux_ml_kem_polynomial_PolynomialRingElement_d2 u_as_ntt[4U];
  deserialize_then_decompress_u_1f(ciphertext, u_as_ntt);
  libcrux_ml_kem_polynomial_PolynomialRingElement_d2 v =
      deserialize_then_decompress_ring_element_v_7b(
...
- V_COMPRESSION_FACTOR= 5
*/
static void decrypt_480(Eurydice_slice secret_key, uint8_t *ciphertext,
                        uint8_t ret[32U]) {
  libcrux_ml_kem_polynomial_PolynomialRingElement_d2 secret_as_ntt[4U];
  deserialize_secret_key_130(secret_key, secret_as_ntt);
  /* Passing arrays by value in Rust generates a copy in C */
...
void libcrux_ml_kem_ind_cca_decapsulate_050(
  ...
  Eurydice_slice implicit_rejection_value = uu____2.snd;
  uint8_t decrypted[32U];
  decrypt_480(ind_cpa_secret_key, ciphertext->value, decrypted);
  uint8_t to_hash0[64U];
  libcrux_ml_kem_utils_into_padded_array_42(
      Eurydice_array_to_slice((size_t)32U, decrypted, uint8_t), to_hash0);
  Eurydice_slice_copy(
  ...
  encrypt_0f0(uu____5, copy_of_decrypted, pseudorandomness,
              expected_ciphertext);
  uint8_t implicit_rejection_shared_secret[32U];
  kdf_d8_950(Eurydice_array_to_slice(
                 (size_t)32U, implicit_rejection_shared_secret0, uint8_t),
             implicit_rejection_shared_secret);
  uint8_t shared_secret[32U];
  kdf_d8_950(shared_secret0, shared_secret);
  uint8_t ret0[32U];
  libcrux_ml_kem_constant_time_ops_compare_ciphertexts_select_shared_secret_in_constant_time(
...
- K= 2
*/
static KRML_MUSTINLINE void deserialize_ring_elements_reduced_c52(
    Eurydice_slice public_key,
    libcrux_ml_kem_polynomial_PolynomialRingElement_d2 *deserialized_pk) {
  for (size_t i = (size_t)0U;
       i < Eurydice_slice_len(public_key, uint8_t) /
...
- K= 2
*/
static KRML_MUSTINLINE void deserialize_ring_elements_reduced_out_55(
    Eurydice_slice public_key,
  ...
  KRML_MAYBE_FOR2(i, (size_t)0U, (size_t)2U, (size_t)1U,
                  deserialized_pk[i] = ZERO_d6_7d(););
  deserialize_ring_elements_reduced_c52(public_key, deserialized_pk);
  memcpy(
      ret, deserialized_pk,
...
- OUT_LEN= 768
*/
static KRML_MUSTINLINE void serialize_secret_key_190(
    libcrux_ml_kem_polynomial_PolynomialRingElement_d2 *key,
    uint8_t ret[768U]) {
  uint8_t out[768U] = {0U};
  for (size_t i = (size_t)0U;
...
- PUBLIC_KEY_SIZE= 800
*/
static KRML_MUSTINLINE void serialize_public_key_mut_ac0(
    libcrux_ml_kem_polynomial_PolynomialRingElement_d2 *t_as_ntt,
    Eurydice_slice seed_for_a, uint8_t *serialized) {
  Eurydice_slice uu____0 = Eurydice_array_to_subslice2(serialized, (size_t)0U,
                                                       (size_t)768U, uint8_t);
  uint8_t ret[768U];
  serialize_secret_key_190(t_as_ntt, ret);
  Eurydice_slice_copy(
...
- PUBLIC_KEY_SIZE= 800
*/
static KRML_MUSTINLINE void serialize_public_key_370(
    libcrux_ml_kem_polynomial_PolynomialRingElement_d2 *t_as_ntt,
    Eurydice_slice seed_for_a, uint8_t ret[800U]) {
  uint8_t public_key_serialized[800U] = {0U};
  serialize_public_key_mut_ac0(t_as_ntt, seed_for_a, public_key_serialized);
...
- K= 2
*/
static KRML_MUSTINLINE void cpa_keygen_seed_d8_520(
    Eurydice_slice key_generation_seed, uint8_t ret[64U]) {
  uint8_t seed[33U] = {0U};
  Eurydice_slice_copy(
      Eurydice_array_to_subslice2(
...
- N= 504
*/
static KRML_MUSTINLINE bool sample_from_uniform_distribution_next_e01(
...
- N= 168
*/
static KRML_MUSTINLINE bool sample_from_uniform_distribution_next_e02(
...
- K= 2
*/
static libcrux_ml_kem_polynomial_PolynomialRingElement_d2 closure_b70(
    int16_t s[272U]) {
  return from_i16_array_d6_34(
      Eurydice_array_to_subslice2(s, (size_t)0U, (size_t)256U, int16_t));
}
...
- K= 2
*/
static KRML_MUSTINLINE void sample_from_xof_590(
  ...
  bool done = sample_from_uniform_distribution_next_e01(
      copy_of_randomness0, sampled_coefficients, out);
  while (true) {
    if (done) {
      break;
      ...
      done = sample_from_uniform_distribution_next_e02(
          copy_of_randomness, sampled_coefficients, out);
    }
  }
  /* Passing arrays by value in Rust generates a copy in C */
  ...
  KRML_MAYBE_FOR2(i, (size_t)0U, (size_t)2U, (size_t)1U,
                  ret0[i] = closure_b70(copy_of_out[i]););
  memcpy(
      ret, ret0,
      (size_t)2U * sizeof(libcrux_ml_kem_polynomial_PolynomialRingElement_d2));
}
...
- K= 2
*/
static KRML_MUSTINLINE void sample_matrix_A_590(
  ...
  KRML_MAYBE_FOR2(
      ...
      sample_from_xof_590(copy_of_seeds, sampled);
      for (size_t i = (size_t)0U;
           i < Eurydice_slice_len(
                   Eurydice_array_to_slice(
                       (size_t)2U, sampled,
...
*/
static KRML_MUSTINLINE libcrux_ml_kem_polynomial_PolynomialRingElement_d2
sample_from_binomial_distribution_d50(Eurydice_slice randomness) {
  return sample_from_binomial_distribution_3_e1(randomness);
}
...
*/
static KRML_MUSTINLINE uint8_t sample_vector_cbd_then_ntt_6e0(
    libcrux_ml_kem_polynomial_PolynomialRingElement_d2 *re_as_ntt,
    uint8_t prf_input[33U], uint8_t domain_separator) {
  /* Passing arrays by value in Rust generates a copy in C */
  uint8_t copy_of_prf_input[33U];
  ...
  KRML_MAYBE_FOR2(
      i, (size_t)0U, (size_t)2U, (size_t)1U, size_t i0 = i;
      re_as_ntt[i0] = sample_from_binomial_distribution_d50(
...
- ETA_RANDOMNESS_SIZE= 192
*/
static KRML_MUSTINLINE tuple_74 sample_vector_cbd_then_ntt_out_1a0(
    uint8_t prf_input[33U], uint8_t domain_separator) {
  ...
  memcpy(uu____1, prf_input, (size_t)33U * sizeof(uint8_t));
  domain_separator =
      sample_vector_cbd_then_ntt_6e0(uu____0, uu____1, domain_separator);
  /* Passing arrays by value in Rust generates a copy in C */
...
- K= 2
*/
static KRML_MUSTINLINE void add_to_ring_element_d6_130(
    libcrux_ml_kem_polynomial_PolynomialRingElement_d2 *self,
    libcrux_ml_kem_polynomial_PolynomialRingElement_d2 *rhs) {
  for (size_t i = (size_t)0U;
       i < Eurydice_slice_len(Eurydice_array_to_slice(
...
static KRML_MUSTINLINE void compute_As_plus_e_910(
  ...
  for (size_t i = (size_t)0U;
    ...
    for (size_t i1 = (size_t)0U;
      ...
      libcrux_ml_kem_polynomial_PolynomialRingElement_d2 product =
          ntt_multiply_d6_5f(matrix_element, &s_as_ntt[j]);
      add_to_ring_element_d6_130(&t_as_ntt[i0], &product);
    }
    add_standard_error_reduce_d6_9a(&t_as_ntt[i0], &error_as_ntt[i0]);
  }
}
...
*/
static void generate_keypair_unpacked_a50(
    Eurydice_slice key_generation_seed,
    IndCpaPrivateKeyUnpacked_d6 *private_key,
    IndCpaPublicKeyUnpacked_d6 *public_key) {
  uint8_t hashed[64U];
  cpa_keygen_seed_d8_520(key_generation_seed, hashed);
  Eurydice_slice_uint8_t_x2 uu____0 = Eurydice_slice_split_at(
      Eurydice_array_to_slice((size_t)64U, hashed, uint8_t), (size_t)32U,
      uint8_t, Eurydice_slice_uint8_t_x2);
  Eurydice_slice seed_for_A = uu____0.fst;
  ...
  uint8_t ret[34U];
  libcrux_ml_kem_utils_into_padded_array_422(seed_for_A, ret);
  sample_matrix_A_590(uu____1, ret, true);
  uint8_t prf_input[33U];
  libcrux_ml_kem_utils_into_padded_array_421(seed_for_secret_and_error,
                                             prf_input);
  libcrux_ml_kem_polynomial_PolynomialRingElement_d2 *uu____2 =
  ...
  memcpy(copy_of_prf_input0, prf_input, (size_t)33U * sizeof(uint8_t));
  uint8_t domain_separator =
      sample_vector_cbd_then_ntt_6e0(uu____2, copy_of_prf_input0, 0U);
  /* Passing arrays by value in Rust generates a copy in C */
  uint8_t copy_of_prf_input[33U];
  memcpy(copy_of_prf_input, prf_input, (size_t)33U * sizeof(uint8_t));
  ...
  memcpy(
      error_as_ntt,
      sample_vector_cbd_then_ntt_out_1a0(copy_of_prf_input, domain_separator)
          .fst,
      (size_t)2U * sizeof(libcrux_ml_kem_polynomial_PolynomialRingElement_d2));
...
- ETA1_RANDOMNESS_SIZE= 192
*/
static libcrux_ml_kem_utils_extraction_helper_Keypair512 generate_keypair_c1(
    Eurydice_slice key_generation_seed) {
  ...
  serialize_secret_key_190(private_key.secret_as_ntt, secret_key_serialized);
  /* Passing arrays by value in Rust generates a copy in C */
...
libcrux_ml_kem_types_MlKemKeyPair_cb libcrux_ml_kem_ind_cca_generate_keypair_7a(
  ...
  libcrux_ml_kem_utils_extraction_helper_Keypair512 uu____0 =
      generate_keypair_c1(ind_cpa_keypair_randomness);
...
- K= 2
*/
static KRML_MUSTINLINE void entropy_preprocess_d8_5d(Eurydice_slice randomness,
                                                     uint8_t ret[32U]) {
  uint8_t out[32U] = {0U};
  Eurydice_slice_copy(Eurydice_array_to_slice((size_t)32U, out, uint8_t),
                      randomness, uint8_t);
...
- K= 2
*/
static KRML_MUSTINLINE void deserialize_ring_elements_reduced_c50(
    Eurydice_slice public_key,
    libcrux_ml_kem_polynomial_PolynomialRingElement_d2 *deserialized_pk) {
  for (size_t i = (size_t)0U;
       i < Eurydice_slice_len(public_key, uint8_t) /
...
sample_ring_element_cbd_5b0(uint8_t prf_input[33U], uint8_t domain_separator) {
...
- K= 2
*/
static KRML_MUSTINLINE void invert_ntt_montgomery_bf0(
    libcrux_ml_kem_polynomial_PolynomialRingElement_d2 *re) {
  size_t zeta_i =
      LIBCRUX_ML_KEM_CONSTANTS_COEFFICIENTS_IN_RING_ELEMENT / (size_t)2U;
  invert_ntt_at_layer_1_a9(&zeta_i, re);
...
- K= 2
*/
static KRML_MUSTINLINE void compute_vector_u_c60(
  ...
  for (size_t i0 = (size_t)0U;
    ...
    for (size_t i = (size_t)0U;
      ...
      libcrux_ml_kem_polynomial_PolynomialRingElement_d2 product =
          ntt_multiply_d6_5f(a_element, &r_as_ntt[j]);
      add_to_ring_element_d6_130(&result[i1], &product);
    }
    invert_ntt_montgomery_bf0(&result[i1]);
    add_error_reduce_d6_f4(&result[i1], &error_1[i1]);
  }
  memcpy(
      ret, result,
...
compute_ring_element_v_d00(
  ...
  KRML_MAYBE_FOR2(i, (size_t)0U, (size_t)2U, (size_t)1U, size_t i0 = i;
                  libcrux_ml_kem_polynomial_PolynomialRingElement_d2 product =
                      ntt_multiply_d6_5f(&t_as_ntt[i0], &r_as_ntt[i0]);
                  add_to_ring_element_d6_130(&result, &product););
  invert_ntt_montgomery_bf0(&result);
  result = add_message_error_reduce_d6_a6(error_2, message, result);
  return result;
}
...
- BLOCK_LEN= 320
*/
static void compress_then_serialize_u_9e0(
...
- ETA2_RANDOMNESS_SIZE= 128
*/
static void encrypt_unpacked_5d0(IndCpaPublicKeyUnpacked_d6 *public_key,
                                 uint8_t message[32U],
  ...
  uint8_t copy_of_prf_input0[33U];
  memcpy(copy_of_prf_input0, prf_input, (size_t)33U * sizeof(uint8_t));
  tuple_74 uu____1 = sample_vector_cbd_then_ntt_out_1a0(copy_of_prf_input0, 0U);
  ...
  memcpy(copy_of_prf_input, prf_input, (size_t)33U * sizeof(uint8_t));
  tuple_74 uu____3 =
      sample_ring_element_cbd_5b0(copy_of_prf_input, domain_separator0);
  libcrux_ml_kem_polynomial_PolynomialRingElement_d2 error_1[2U];
  memcpy(
      error_1, uu____3.fst,
      (size_t)2U * sizeof(libcrux_ml_kem_polynomial_PolynomialRingElement_d2));
  ...
  compute_vector_u_c60(public_key->A, r_as_ntt, error_1, u);
  /* Passing arrays by value in Rust generates a copy in C */
  uint8_t copy_of_message[32U];
  memcpy(copy_of_message, message, (size_t)32U * sizeof(uint8_t));
  libcrux_ml_kem_polynomial_PolynomialRingElement_d2 message_as_ring_element =
      deserialize_then_decompress_message_37(copy_of_message);
  libcrux_ml_kem_polynomial_PolynomialRingElement_d2 v =
      compute_ring_element_v_d00(public_key->t_as_ntt, r_as_ntt, &error_2,
                                 &message_as_ring_element);
...
- ETA2_RANDOMNESS_SIZE= 128
*/
static void encrypt_0f(Eurydice_slice public_key, uint8_t message[32U],
                       Eurydice_slice randomness, uint8_t ret[768U]) {
  IndCpaPublicKeyUnpacked_d6 unpacked_public_key = default_8d_800();
  deserialize_ring_elements_reduced_c50(
  ...
  uint8_t ret0[34U];
  libcrux_ml_kem_utils_into_padded_array_422(seed, ret0);
  sample_matrix_A_590(uu____0, ret0, false);
  IndCpaPublicKeyUnpacked_d6 *uu____1 = &unpacked_public_key;
  /* Passing arrays by value in Rust generates a copy in C */
  uint8_t copy_of_message[32U];
  memcpy(copy_of_message, message, (size_t)32U * sizeof(uint8_t));
  uint8_t ret1[768U];
  encrypt_unpacked_5d0(uu____1, copy_of_message, randomness, ret1);
...
- CIPHERTEXT_SIZE= 768
*/
static KRML_MUSTINLINE void kdf_d8_95(Eurydice_slice shared_secret,
                                      uint8_t ret[32U]) {
  uint8_t out[32U] = {0U};
  Eurydice_slice_copy(Eurydice_array_to_slice((size_t)32U, out, uint8_t),
                      shared_secret, uint8_t);
...
tuple_ec libcrux_ml_kem_ind_cca_encapsulate_4a(
  ...
  encrypt_0f(uu____2, copy_of_randomness, pseudorandomness, ciphertext);
  /* Passing arrays by value in Rust generates a copy in C */
  ...
  uint8_t shared_secret_array[32U];
  kdf_d8_95(shared_secret, shared_secret_array);
...
- K= 2
*/
static KRML_MUSTINLINE void deserialize_secret_key_13(
    Eurydice_slice secret_key,
    libcrux_ml_kem_polynomial_PolynomialRingElement_d2 ret[2U]) {
  libcrux_ml_kem_polynomial_PolynomialRingElement_d2 secret_as_ntt[2U];
  KRML_MAYBE_FOR2(i, (size_t)0U, (size_t)2U, (size_t)1U,
...
- U_COMPRESSION_FACTOR= 10
*/
static KRML_MUSTINLINE void deserialize_then_decompress_u_1f0(
    uint8_t *ciphertext,
    libcrux_ml_kem_polynomial_PolynomialRingElement_d2 ret[2U]) {
...
- V_COMPRESSION_FACTOR= 4
*/
static void decrypt_unpacked_e70(IndCpaPrivateKeyUnpacked_d6 *secret_key,
                                 uint8_t *ciphertext, uint8_t ret[32U]) {
  libcrux_ml_kem_polynomial_PolynomialRingElement_d2 u_as_ntt[2U];
  deserialize_then_decompress_u_1f0(ciphertext, u_as_ntt);
  libcrux_ml_kem_polynomial_PolynomialRingElement_d2 v =
      deserialize_then_decompress_ring_element_v_7b0(
          Eurydice_array_to_subslice_from((size_t)768U, ciphertext,
                                          (size_t)640U, uint8_t, size_t));
  libcrux_ml_kem_polynomial_PolynomialRingElement_d2 message =
      compute_message_1b0(&v, secret_key->secret_as_ntt, u_as_ntt);
  uint8_t ret0[32U];
  compress_then_serialize_message_0e(message, ret0);
  memcpy(ret, ret0, (size_t)32U * sizeof(uint8_t));
}
...
- V_COMPRESSION_FACTOR= 4
*/
static void decrypt_48(Eurydice_slice secret_key, uint8_t *ciphertext,
                       uint8_t ret[32U]) {
  libcrux_ml_kem_polynomial_PolynomialRingElement_d2 secret_as_ntt[2U];
  deserialize_secret_key_13(secret_key, secret_as_ntt);
  /* Passing arrays by value in Rust generates a copy in C */
...
void libcrux_ml_kem_ind_cca_decapsulate_05(
  ...
  Eurydice_slice implicit_rejection_value = uu____2.snd;
  uint8_t decrypted[32U];
  decrypt_48(ind_cpa_secret_key, ciphertext->value, decrypted);
  uint8_t to_hash0[64U];
  libcrux_ml_kem_utils_into_padded_array_42(
      Eurydice_array_to_slice((size_t)32U, decrypted, uint8_t), to_hash0);
  Eurydice_slice_copy(
  ...
  encrypt_0f(uu____5, copy_of_decrypted, pseudorandomness, expected_ciphertext);
  uint8_t implicit_rejection_shared_secret[32U];
  kdf_d8_95(Eurydice_array_to_slice((size_t)32U,
                                    implicit_rejection_shared_secret0, uint8_t),
            implicit_rejection_shared_secret);
  uint8_t shared_secret[32U];
  kdf_d8_95(shared_secret0, shared_secret);
  uint8_t ret0[32U];
  libcrux_ml_kem_constant_time_ops_compare_ciphertexts_select_shared_secret_in_constant_time(
