...
static void decapsulate_d0(libcrux_ml_kem_types_MlKemPrivateKey_5e *private_key,
                           ...
                           uint8_t ret[32U]) {
  libcrux_ml_kem_ind_cca_decapsulate_281(private_key, ciphertext, ret);
}

void libcrux_ml_kem_mlkem512_neon_decapsulate(
    libcrux_ml_kem_types_MlKemPrivateKey_5e *private_key,
    libcrux_ml_kem_types_MlKemCiphertext_e8 *ciphertext, uint8_t ret[32U]) {
  decapsulate_d0(private_key, ciphertext, ret);
}
...
static void decapsulate_unpacked_25(
    ...
    libcrux_ml_kem_types_MlKemCiphertext_e8 *ciphertext, uint8_t ret[32U]) {
  libcrux_ml_kem_ind_cca_unpacked_decapsulate_unpacked_1d1(key_pair, ciphertext,
                                                           ret);
}
...
- ETA2_RANDOMNESS_SIZE= 128
*/
static tuple_ec encapsulate_c8(
  ...
  return libcrux_ml_kem_ind_cca_encapsulate_711(uu____0, uu____1);
}
...
tuple_ec libcrux_ml_kem_mlkem512_neon_encapsulate(
  ...
  uint8_t uu____1[32U];
  memcpy(uu____1, randomness, (size_t)32U * sizeof(uint8_t));
  return encapsulate_c8(uu____0, uu____1);
}
...
- ETA2_RANDOMNESS_SIZE= 128
*/
static tuple_ec encapsulate_unpacked_92(
  ...
  uint8_t uu____1[32U];
  memcpy(uu____1, randomness, (size_t)32U * sizeof(uint8_t));
  return libcrux_ml_kem_ind_cca_unpacked_encapsulate_unpacked_851(uu____0,
                                                                  uu____1);
}
...
tuple_ec libcrux_ml_kem_mlkem512_neon_encapsulate_unpacked(
  ...
  uint8_t uu____1[32U];
  memcpy(uu____1, randomness, (size_t)32U * sizeof(uint8_t));
  return encapsulate_unpacked_92(uu____0, uu____1);
}
...
- ETA1_RANDOMNESS_SIZE= 192
*/
static libcrux_ml_kem_types_MlKemKeyPair_cb generate_keypair_c3(
...
libcrux_ml_kem_mlkem512_neon_generate_key_pair(uint8_t randomness[64U]) {
  uint8_t uu____0[64U];
  memcpy(uu____0, randomness, (size_t)64U * sizeof(uint8_t));
  return generate_keypair_c3(uu____0);
}
...
libcrux_ml_kem_mlkem512_neon_generate_key_pair_unpacked(
  ...
  uint8_t uu____0[64U];
  memcpy(uu____0, randomness, (size_t)64U * sizeof(uint8_t));
  return generate_keypair_unpacked_96(uu____0);
}
...
- PUBLIC_KEY_SIZE= 800
*/
static bool validate_public_key_151(uint8_t *public_key) {
...
core_option_Option_04 libcrux_ml_kem_mlkem512_neon_validate_public_key(
  ...
  if (validate_public_key_151(public_key.value)) {
