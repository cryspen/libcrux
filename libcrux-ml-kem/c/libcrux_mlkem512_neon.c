...
static KRML_MUSTINLINE bool validate_private_key_1c(
    Eurydice_arr_7f0 *private_key, Eurydice_arr_56 *ciphertext) {
  return libcrux_ml_kem_ind_cca_validate_private_key_ac(private_key,
                                                        ciphertext);
}
...
static KRML_MUSTINLINE tuple_17 encapsulate_350(
    ...
    Eurydice_arr_60 *randomness) {
  return libcrux_ml_kem_ind_cca_unpacked_encapsulate_551(public_key,
                                                         randomness);
}
...
libcrux_ml_kem_mlkem512_neon_unpacked_generate_key_pair(
  ...
  libcrux_ml_kem_mlkem512_neon_unpacked_generate_key_pair_mut(randomness,
                                                              &key_pair);
  return key_pair;
}
...
static KRML_MUSTINLINE void keypair_from_private_key_30(
    Eurydice_arr_7f0 *private_key,
    libcrux_ml_kem_mlkem512_neon_unpacked_MlKem512KeyPairUnpacked *key_pair) {
  libcrux_ml_kem_ind_cca_unpacked_keys_from_private_key_c2(private_key,
                                                           key_pair);
}
...
void libcrux_ml_kem_mlkem512_neon_unpacked_key_pair_serialized_private_key_mut(
  ...
  libcrux_ml_kem_ind_cca_unpacked_serialized_private_key_mut_11_90(key_pair,
                                                                   serialized);
}
...
void libcrux_ml_kem_mlkem512_neon_unpacked_key_pair_serialized_public_key_mut(
  ...
  libcrux_ml_kem_ind_cca_unpacked_serialized_public_key_mut_11_37(key_pair,
                                                                  serialized);
}
...
static KRML_MUSTINLINE void unpack_public_key_1c(
    ...
    libcrux_ml_kem_ind_cca_unpacked_MlKemPublicKeyUnpacked_7d
        *unpacked_public_key) {
  libcrux_ml_kem_ind_cca_unpacked_unpack_public_key_5e1(public_key,
                                                        unpacked_public_key);
}
