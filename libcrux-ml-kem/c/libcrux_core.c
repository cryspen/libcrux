...
)
{
  ...
  for (size_t i = (size_t)0U; i < LIBCRUX_ML_KEM_CONSTANTS_SHARED_SECRET_SIZE; i++)
  {
    size_t i0 = i;
    uint8_t
    uu____0 = (uint32_t)Eurydice_slice_index(lhs, i0, uint8_t, uint8_t *, uint8_t) & (uint32_t)mask;
    uint8_t *uu____1 = &Eurydice_slice_index(rhs, i0, uint8_t, uint8_t *, uint8_t);
  ...
  while (true)
  {
    ...
    else
    {
      ...
      if (d1 < LIBCRUX_ML_KEM_VECTOR_TRAITS_FIELD_MODULUS)
      {
        ...
        {
          int16_t uu____8 = d1;
          Eurydice_slice_index(result, sampled, int16_t, int16_t *, int16_t) = uu____8;
          sampled++;
          uu____2 = d2;
          ...
          if (uu____1)
          {
            ...
            if (uu____3)
            {
              uu____5 = d2;
              uu____6 = sampled;
              Eurydice_slice_index(result, uu____6, int16_t, int16_t *, int16_t) = uu____5;
              sampled++;
              continue;
            }
          }
...
)
{
  ...
  {
    size_t i0 = i;
    uint8_t uu____0 = Eurydice_slice_index(lhs, i0, uint8_t, uint8_t *, uint8_t);
    r =
      (uint32_t)r
      | ((uint32_t)uu____0 ^ (uint32_t)Eurydice_slice_index(rhs, i0, uint8_t, uint8_t *, uint8_t));
  }
