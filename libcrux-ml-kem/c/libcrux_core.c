...
static libcrux_ml_kem_vector_PortableVector ZERO(void) { return zero(); }
...
static inline libcrux_ml_kem_vector_PortableVector from_i16_array(
...
static libcrux_ml_kem_vector_PortableVector from_i16_array0(
    Eurydice_slice array) {
  return from_i16_array(array);
}

static inline libcrux_ml_kem_vector_PortableVector add(
...
static inline libcrux_ml_kem_vector_PortableVector sub(
    libcrux_ml_kem_vector_PortableVector lhs,
    libcrux_ml_kem_vector_PortableVector *rhs) {
  for (size_t i = (size_t)0U;
       i < LIBCRUX_ML_KEM_VECTOR_TRAITS_FIELD_ELEMENTS_IN_VECTOR; i++) {
...
static inline libcrux_ml_kem_vector_PortableVector multiply_by_constant(
...
static inline libcrux_ml_kem_vector_PortableVector bitwise_and_with_constant(
    libcrux_ml_kem_vector_PortableVector v, int16_t c) {
  for (size_t i = (size_t)0U;
       i < LIBCRUX_ML_KEM_VECTOR_TRAITS_FIELD_ELEMENTS_IN_VECTOR; i++) {
    size_t i0 = i;
...
static libcrux_ml_kem_vector_PortableVector bitwise_and_with_constant0(
    libcrux_ml_kem_vector_PortableVector v, int16_t c) {
  return bitwise_and_with_constant(v, c);
}

static inline libcrux_ml_kem_vector_PortableVector cond_subtract_3329(
...
static inline libcrux_ml_kem_vector_PortableVector barrett_reduce(
    libcrux_ml_kem_vector_PortableVector v) {
  for (size_t i = (size_t)0U;
       i < LIBCRUX_ML_KEM_VECTOR_TRAITS_FIELD_ELEMENTS_IN_VECTOR; i++) {
    size_t i0 = i;
...
montgomery_multiply_by_constant(libcrux_ml_kem_vector_PortableVector v,
                                int16_t c) {
  for (size_t i = (size_t)0U;
       i < LIBCRUX_ML_KEM_VECTOR_TRAITS_FIELD_ELEMENTS_IN_VECTOR; i++) {
    size_t i0 = i;
...
static libcrux_ml_kem_vector_PortableVector montgomery_multiply_by_constant0(
    libcrux_ml_kem_vector_PortableVector v, int16_t r) {
...
static inline libcrux_ml_kem_vector_PortableVector compress_1(
    libcrux_ml_kem_vector_PortableVector v) {
  for (size_t i = (size_t)0U;
       i < LIBCRUX_ML_KEM_VECTOR_TRAITS_FIELD_ELEMENTS_IN_VECTOR; i++) {
    size_t i0 = i;
...
static int16_t compress_ciphertext_coefficient(uint8_t coefficient_bits,
                                               uint16_t fe) {
  uint64_t compressed = (uint64_t)fe << (uint32_t)coefficient_bits;
  compressed = compressed + 1664ULL;
  compressed = compressed * 10321340ULL;
  compressed = compressed >> 35U;
  return (int16_t)get_n_least_significant_bits(coefficient_bits,
                                               (uint32_t)compressed);
}

static inline libcrux_ml_kem_vector_PortableVector ntt_layer_1_step(
    libcrux_ml_kem_vector_PortableVector v, int16_t zeta0, int16_t zeta1,
...
static inline libcrux_ml_kem_vector_PortableVector ntt_layer_2_step(
    libcrux_ml_kem_vector_PortableVector v, int16_t zeta0, int16_t zeta1) {
  ...
  int16_t t3 =
      montgomery_multiply_fe_by_fer(v.elements[(size_t)8U + (size_t)4U], zeta1);
  v.elements[(size_t)8U + (size_t)4U] =
      v.elements[(size_t)8U + (size_t)0U] - t3;
  v.elements[(size_t)8U + (size_t)0U] =
      v.elements[(size_t)8U + (size_t)0U] + t3;
  int16_t t4 =
      montgomery_multiply_fe_by_fer(v.elements[(size_t)8U + (size_t)5U], zeta1);
  v.elements[(size_t)8U + (size_t)5U] =
      v.elements[(size_t)8U + (size_t)1U] - t4;
  v.elements[(size_t)8U + (size_t)1U] =
      v.elements[(size_t)8U + (size_t)1U] + t4;
  int16_t t5 =
      montgomery_multiply_fe_by_fer(v.elements[(size_t)8U + (size_t)6U], zeta1);
  v.elements[(size_t)8U + (size_t)6U] =
      v.elements[(size_t)8U + (size_t)2U] - t5;
  v.elements[(size_t)8U + (size_t)2U] =
      v.elements[(size_t)8U + (size_t)2U] + t5;
  int16_t t6 =
      montgomery_multiply_fe_by_fer(v.elements[(size_t)8U + (size_t)7U], zeta1);
  v.elements[(size_t)8U + (size_t)7U] =
...
static inline libcrux_ml_kem_vector_PortableVector ntt_layer_3_step(
    libcrux_ml_kem_vector_PortableVector v, int16_t zeta) {
...
static inline libcrux_ml_kem_vector_PortableVector inv_ntt_layer_1_step(
    libcrux_ml_kem_vector_PortableVector v, int16_t zeta0, int16_t zeta1,
    int16_t zeta2, int16_t zeta3) {
  ...
  int16_t uu____8 = barrett_reduce_element(v.elements[(size_t)8U + (size_t)0U] +
                                           v.elements[(size_t)8U + (size_t)2U]);
  ...
  int16_t uu____10 =
      barrett_reduce_element(v.elements[(size_t)8U + (size_t)1U] +
                             v.elements[(size_t)8U + (size_t)3U]);
  ...
  int16_t uu____12 =
      barrett_reduce_element(v.elements[(size_t)8U + (size_t)4U] +
                             v.elements[(size_t)8U + (size_t)6U]);
  ...
  int16_t uu____14 =
      barrett_reduce_element(v.elements[(size_t)8U + (size_t)5U] +
                             v.elements[(size_t)8U + (size_t)7U]);
...
static inline libcrux_ml_kem_vector_PortableVector inv_ntt_layer_2_step(
    libcrux_ml_kem_vector_PortableVector v, int16_t zeta0, int16_t zeta1) {
...
static inline libcrux_ml_kem_vector_PortableVector inv_ntt_layer_3_step(
    libcrux_ml_kem_vector_PortableVector v, int16_t zeta) {
...
static inline __int16_t_int16_t ntt_multiply_binomials(__int16_t_int16_t _,
                                                       __int16_t_int16_t _0,
                                                       int16_t zeta) {
  int16_t a0 = _.fst;
  int16_t a1 = _.snd;
  int16_t b0 = _0.fst;
  ...
  int16_t uu____1 = montgomery_reduce_element(
      uu____0 + (int32_t)montgomery_reduce_element((int32_t)a1 * (int32_t)b1) *
                    (int32_t)zeta);
  return ((__int16_t_int16_t){
      .fst = uu____1,
      .snd = montgomery_reduce_element((int32_t)a0 * (int32_t)b1 +
                                       (int32_t)a1 * (int32_t)b0)});
}

static inline libcrux_ml_kem_vector_PortableVector ntt_multiply(
    libcrux_ml_kem_vector_PortableVector *lhs,
    libcrux_ml_kem_vector_PortableVector *rhs, int16_t zeta0, int16_t zeta1,
    int16_t zeta2, int16_t zeta3) {
...
static libcrux_ml_kem_vector_PortableVector ntt_multiply0(
    libcrux_ml_kem_vector_PortableVector *lhs,
    libcrux_ml_kem_vector_PortableVector *rhs, int16_t zeta0, int16_t zeta1,
    int16_t zeta2, int16_t zeta3) {
...
static inline void serialize_1(libcrux_ml_kem_vector_PortableVector v,
                               uint8_t ret[2U]) {
...
static inline libcrux_ml_kem_vector_PortableVector deserialize_1(
    Eurydice_slice v) {
...
static inline void serialize_4(libcrux_ml_kem_vector_PortableVector v,
                               uint8_t ret[8U]) {
...
static inline libcrux_ml_kem_vector_PortableVector deserialize_4(
...
static inline void serialize_5(libcrux_ml_kem_vector_PortableVector v,
                               uint8_t ret[10U]) {
...
static inline libcrux_ml_kem_vector_PortableVector deserialize_5(
    Eurydice_slice bytes) {
  libcrux_ml_kem_vector_PortableVector v = zero();
  uint8_t *uu____0 =
      &Eurydice_slice_index(bytes, (size_t)0U, uint8_t, uint8_t *, uint8_t);
...
static inline void serialize_10(libcrux_ml_kem_vector_PortableVector v,
                                uint8_t ret[20U]) {
...
static inline libcrux_ml_kem_vector_PortableVector deserialize_10(
    Eurydice_slice bytes) {
  libcrux_ml_kem_vector_PortableVector result = zero();
...
static inline void serialize_11(libcrux_ml_kem_vector_PortableVector v,
                                uint8_t ret[22U]) {
...
static inline libcrux_ml_kem_vector_PortableVector deserialize_11(
    Eurydice_slice bytes) {
  libcrux_ml_kem_vector_PortableVector result = zero();
  int16_t uu____0 = ((int16_t)Eurydice_slice_index(bytes, (size_t)1U, uint8_t,
                                                   uint8_t *, uint8_t) &
...
static inline void serialize_12(libcrux_ml_kem_vector_PortableVector v,
                                uint8_t ret[24U]) {
...
static inline libcrux_ml_kem_vector_PortableVector deserialize_12(
    Eurydice_slice bytes) {
...
libcrux_ml_kem_types__libcrux_ml_kem__types__MlKemKeyPair_PRIVATE_KEY_SIZE__PUBLIC_KEY_SIZE___from___1632size_t_800size_t(
  ...
  return ((libcrux_ml_kem_mlkem512_MlKem512KeyPair){.sk = sk, .pk = pk});
}
...
libcrux_ml_kem_types___core__convert__From__Array_u8__SIZE___for_libcrux_ml_kem__types__MlKemCiphertext_SIZE___2__from___768size_t(
  ...
  libcrux_ml_kem_mlkem512_MlKem512Ciphertext lit;
  ...
  for (size_t i = (size_t)0U;
       i < core_slice___Slice_T___len(
               Eurydice_array_to_slice((size_t)16U, self->coefficients,
                                       libcrux_ml_kem_vector_PortableVector,
                                       Eurydice_slice),
               libcrux_ml_kem_vector_PortableVector, size_t);
       i++) {
    size_t i0 = i;
...
to_standard_domain__libcrux_ml_kem_vector_PortableVector(
    libcrux_ml_kem_vector_PortableVector v) {
  return montgomery_multiply_by_constant0(
...
void libcrux_ml_kem_polynomial__libcrux_ml_kem__polynomial__PolynomialRingElement_Vector__TraitClause_0___add_standard_error_reduce__libcrux_ml_kem_vector_PortableVector(
  ...
  for (size_t i = (size_t)0U;
    ...
    size_t j = i;
    libcrux_ml_kem_vector_PortableVector coefficient_normal_form =
        to_standard_domain__libcrux_ml_kem_vector_PortableVector(
            self->coefficients[j]);
    libcrux_ml_kem_vector_PortableVector uu____0 =
        libcrux_ml_kem_vector___libcrux_ml_kem__vector__traits__Operations_for_libcrux_ml_kem__vector__PortableVector___barrett_reduce(
...
static inline libcrux_ml_kem_vector_PortableVector compress___5int32_t(
    libcrux_ml_kem_vector_PortableVector v) {
  for (size_t i = (size_t)0U;
       i < LIBCRUX_ML_KEM_VECTOR_TRAITS_FIELD_ELEMENTS_IN_VECTOR; i++) {
    size_t i0 = i;
    int16_t uu____0 = compress_ciphertext_coefficient((uint8_t)(int32_t)5,
...
static inline libcrux_ml_kem_vector_PortableVector compress___4int32_t(
    libcrux_ml_kem_vector_PortableVector v) {
  for (size_t i = (size_t)0U;
       i < LIBCRUX_ML_KEM_VECTOR_TRAITS_FIELD_ELEMENTS_IN_VECTOR; i++) {
    size_t i0 = i;
    int16_t uu____0 = compress_ciphertext_coefficient((uint8_t)(int32_t)4,
                                                      (uint16_t)v.elements[i0]);
    v.elements[i0] = uu____0;
  }
  return v;
...
static inline libcrux_ml_kem_vector_PortableVector compress___11int32_t(
    libcrux_ml_kem_vector_PortableVector v) {
  for (size_t i = (size_t)0U;
       i < LIBCRUX_ML_KEM_VECTOR_TRAITS_FIELD_ELEMENTS_IN_VECTOR; i++) {
    size_t i0 = i;
    int16_t uu____0 = compress_ciphertext_coefficient((uint8_t)(int32_t)11,
                                                      (uint16_t)v.elements[i0]);
    v.elements[i0] = uu____0;
  }
  return v;
...
static inline libcrux_ml_kem_vector_PortableVector compress___10int32_t(
    libcrux_ml_kem_vector_PortableVector v) {
  for (size_t i = (size_t)0U;
       i < LIBCRUX_ML_KEM_VECTOR_TRAITS_FIELD_ELEMENTS_IN_VECTOR; i++) {
    size_t i0 = i;
    int16_t uu____0 = compress_ciphertext_coefficient((uint8_t)(int32_t)10,
                                                      (uint16_t)v.elements[i0]);
    v.elements[i0] = uu____0;
  }
  return v;
  ...
  for (size_t i = (size_t)0U;
    ...
    libcrux_ml_kem_vector_PortableVector coefficient_normal_form =
        montgomery_multiply_by_constant0(result.coefficients[i0],
                                         (int16_t)1441);
    libcrux_ml_kem_vector_PortableVector tmp =
        libcrux_ml_kem_vector___libcrux_ml_kem__vector__traits__Operations_for_libcrux_ml_kem__vector__PortableVector___add(
            self->coefficients[i0], &message->coefficients[i0]);
    libcrux_ml_kem_vector_PortableVector tmp0 =
        libcrux_ml_kem_vector___libcrux_ml_kem__vector__traits__Operations_for_libcrux_ml_kem__vector__PortableVector___add(
...
libcrux_ml_kem_vector_traits_decompress_1__libcrux_ml_kem_vector_PortableVector(
    libcrux_ml_kem_vector_PortableVector v) {
  return bitwise_and_with_constant0(
      libcrux_ml_kem_vector___libcrux_ml_kem__vector__traits__Operations_for_libcrux_ml_kem__vector__PortableVector___sub(
          ZERO(), &v),
      (int16_t)1665);
}
...
void libcrux_ml_kem_polynomial__libcrux_ml_kem__polynomial__PolynomialRingElement_Vector__TraitClause_0___add_error_reduce__libcrux_ml_kem_vector_PortableVector(
  ...
  for (size_t i = (size_t)0U;
    ...
    size_t j = i;
    libcrux_ml_kem_vector_PortableVector coefficient_normal_form =
        montgomery_multiply_by_constant0(self->coefficients[j], (int16_t)1441);
    libcrux_ml_kem_vector_PortableVector uu____0 =
        libcrux_ml_kem_vector___libcrux_ml_kem__vector__traits__Operations_for_libcrux_ml_kem__vector__PortableVector___barrett_reduce(
            libcrux_ml_kem_vector___libcrux_ml_kem__vector__traits__Operations_for_libcrux_ml_kem__vector__PortableVector___add(
                coefficient_normal_form, &error->coefficients[j]));
...
libcrux_ml_kem_polynomial__libcrux_ml_kem__polynomial__PolynomialRingElement_Vector__TraitClause_0___from_i16_array__libcrux_ml_kem_vector_PortableVector(
  ...
  for (size_t i = (size_t)0U;
    ...
    size_t i0 = i;
    libcrux_ml_kem_vector_PortableVector uu____0 =
        from_i16_array0(Eurydice_slice_subslice(
            a,
            ((core_ops_range_Range__size_t){
                .start = i0 * (size_t)16U,
...
static inline libcrux_ml_kem_vector_PortableVector shift_right___15int32_t(
    libcrux_ml_kem_vector_PortableVector v) {
  for (size_t i = (size_t)0U;
       i < LIBCRUX_ML_KEM_VECTOR_TRAITS_FIELD_ELEMENTS_IN_VECTOR; i++) {
    size_t i0 = i;
...
static libcrux_ml_kem_vector_PortableVector shift_right___15int32_t0(
    libcrux_ml_kem_vector_PortableVector v) {
...
libcrux_ml_kem_vector_traits_to_unsigned_representative__libcrux_ml_kem_vector_PortableVector(
  ...
  libcrux_ml_kem_vector_PortableVector fm =
      bitwise_and_with_constant0(t, LIBCRUX_ML_KEM_VECTOR_TRAITS_FIELD_MODULUS);
  return libcrux_ml_kem_vector___libcrux_ml_kem__vector__traits__Operations_for_libcrux_ml_kem__vector__PortableVector___add(
      a, &fm);
}
...
libcrux_ml_kem_polynomial__libcrux_ml_kem__polynomial__PolynomialRingElement_Vector__TraitClause_0___subtract_reduce__libcrux_ml_kem_vector_PortableVector(
  ...
  for (size_t i = (size_t)0U;
    ...
    size_t i0 = i;
    libcrux_ml_kem_vector_PortableVector coefficient_normal_form =
        montgomery_multiply_by_constant0(b.coefficients[i0], (int16_t)1441);
    libcrux_ml_kem_vector_PortableVector uu____0 =
        libcrux_ml_kem_vector___libcrux_ml_kem__vector__traits__Operations_for_libcrux_ml_kem__vector__PortableVector___barrett_reduce(
            libcrux_ml_kem_vector___libcrux_ml_kem__vector__traits__Operations_for_libcrux_ml_kem__vector__PortableVector___sub(
...
libcrux_ml_kem_polynomial__libcrux_ml_kem__polynomial__PolynomialRingElement_Vector__TraitClause_0___ntt_multiply__libcrux_ml_kem_vector_PortableVector(
  ...
  for (size_t i = (size_t)0U;
       i < LIBCRUX_ML_KEM_POLYNOMIAL_VECTORS_IN_RING_ELEMENT; i++) {
    size_t i0 = i;
    libcrux_ml_kem_vector_PortableVector uu____0 = ntt_multiply0(
        &self->coefficients[i0], &rhs->coefficients[i0],
