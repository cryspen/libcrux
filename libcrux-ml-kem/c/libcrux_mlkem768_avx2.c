...
*/
static Eurydice_arr_60 decapsulate_avx2_35(Eurydice_arr_ea *private_key,
                                           Eurydice_arr_2c *ciphertext) {
  return libcrux_ml_kem_ind_cca_decapsulate_a11(private_key, ciphertext);
}
...
static Eurydice_arr_60 decapsulate_35(Eurydice_arr_ea *private_key,
                                      Eurydice_arr_2c *ciphertext) {
  return decapsulate_avx2_35(private_key, ciphertext);
}
...
- ETA2_RANDOMNESS_SIZE= 128
*/
static tuple_56 encapsulate_avx2_cd(Eurydice_arr_74 *public_key,
...
- CIPHERTEXT_SIZE= 1088
*/
static bool validate_private_key_avx2_31(Eurydice_arr_ea *private_key,
                                         Eurydice_arr_2c *ciphertext) {
...
- CIPHERTEXT_SIZE= 1088
*/
static bool validate_private_key_31(Eurydice_arr_ea *private_key,
                                    Eurydice_arr_2c *ciphertext) {
...
- PUBLIC_KEY_SIZE= 1184
*/
static bool validate_public_key_avx2_41(Eurydice_arr_74 *public_key) {
...
- PUBLIC_KEY_SIZE= 1184
*/
static bool validate_public_key_41(Eurydice_arr_74 *public_key) {
...
- IMPLICIT_REJECTION_HASH_INPUT_SIZE= 1120
*/
static Eurydice_arr_60 decapsulate_avx2_350(
    libcrux_ml_kem_mlkem768_avx2_unpacked_MlKem768KeyPairUnpacked *key_pair,
    Eurydice_arr_2c *ciphertext) {
  return libcrux_ml_kem_ind_cca_unpacked_decapsulate_121(key_pair, ciphertext);
}
...
- IMPLICIT_REJECTION_HASH_INPUT_SIZE= 1120
*/
static Eurydice_arr_60 decapsulate_350(
    libcrux_ml_kem_mlkem768_avx2_unpacked_MlKem768KeyPairUnpacked *key_pair,
    Eurydice_arr_2c *ciphertext) {
  return decapsulate_avx2_350(key_pair, ciphertext);
}
...
*/
Eurydice_arr_60 libcrux_ml_kem_mlkem768_avx2_unpacked_decapsulate(
...
- ETA2_RANDOMNESS_SIZE= 128
*/
static tuple_56 encapsulate_avx2_cd0(
    libcrux_ml_kem_ind_cca_unpacked_MlKemPublicKeyUnpacked_63 *public_key,
    Eurydice_arr_60 *randomness) {
  return libcrux_ml_kem_ind_cca_unpacked_encapsulate_701(public_key,
                                                         randomness);
}
...
- ETA2_RANDOMNESS_SIZE= 128
*/
static tuple_56 encapsulate_cd0(
    libcrux_ml_kem_ind_cca_unpacked_MlKemPublicKeyUnpacked_63 *public_key,
    Eurydice_arr_60 *randomness) {
  return encapsulate_avx2_cd0(public_key, randomness);
}
...
*/
tuple_56 libcrux_ml_kem_mlkem768_avx2_unpacked_encapsulate(
    libcrux_ml_kem_ind_cca_unpacked_MlKemPublicKeyUnpacked_63 *public_key,
    Eurydice_arr_60 randomness) {
...
- ETA1_RANDOMNESS_SIZE= 128
*/
static void generate_keypair_avx2_ce0(
    libcrux_sha3_Sha3_512Digest randomness,
    libcrux_ml_kem_mlkem768_avx2_unpacked_MlKem768KeyPairUnpacked *out) {
  libcrux_ml_kem_ind_cca_unpacked_generate_keypair_bb1(randomness, out);
}
...
- ETA1_RANDOMNESS_SIZE= 128
*/
static void generate_keypair_ce0(
    libcrux_sha3_Sha3_512Digest randomness,
    libcrux_ml_kem_mlkem768_avx2_unpacked_MlKem768KeyPairUnpacked *out) {
  generate_keypair_avx2_ce0(randomness, out);
}

/**
 Generate ML-KEM 768 Key Pair in "unpacked" form.
*/
void libcrux_ml_kem_mlkem768_avx2_unpacked_generate_key_pair_mut(
    libcrux_sha3_Sha3_512Digest randomness,
    libcrux_ml_kem_mlkem768_avx2_unpacked_MlKem768KeyPairUnpacked *key_pair) {
...
*/
void libcrux_ml_kem_mlkem768_avx2_unpacked_key_pair_from_private_mut(
    Eurydice_arr_ea *private_key,
    libcrux_ml_kem_mlkem768_avx2_unpacked_MlKem768KeyPairUnpacked *key_pair) {
...
/**
 Get the serialized private key.
*/
void libcrux_ml_kem_mlkem768_avx2_unpacked_key_pair_serialized_private_key_mut(
    libcrux_ml_kem_mlkem768_avx2_unpacked_MlKem768KeyPairUnpacked *key_pair,
...
/**
 Get the serialized public key.
*/
void libcrux_ml_kem_mlkem768_avx2_unpacked_key_pair_serialized_public_key_mut(
    libcrux_ml_kem_mlkem768_avx2_unpacked_MlKem768KeyPairUnpacked *key_pair,
...
*/
void libcrux_ml_kem_mlkem768_avx2_unpacked_public_key(
    libcrux_ml_kem_mlkem768_avx2_unpacked_MlKem768KeyPairUnpacked *key_pair,
...
/**
 Get the serialized public key.
*/
void libcrux_ml_kem_mlkem768_avx2_unpacked_serialized_public_key(
    libcrux_ml_kem_ind_cca_unpacked_MlKemPublicKeyUnpacked_63 *public_key,
    Eurydice_arr_74 *serialized) {
...
- PUBLIC_KEY_SIZE= 1184
*/
static void unpack_public_key_avx2_31(
    Eurydice_arr_74 *public_key,
    libcrux_ml_kem_ind_cca_unpacked_MlKemPublicKeyUnpacked_63
        *unpacked_public_key) {
  libcrux_ml_kem_ind_cca_unpacked_unpack_public_key_fb1(public_key,
                                                        unpacked_public_key);
}
...
- PUBLIC_KEY_SIZE= 1184
*/
static void unpack_public_key_31(
    Eurydice_arr_74 *public_key,
    libcrux_ml_kem_ind_cca_unpacked_MlKemPublicKeyUnpacked_63
        *unpacked_public_key) {
  unpack_public_key_avx2_31(public_key, unpacked_public_key);
}

/**
 Get the unpacked public key.
*/
void libcrux_ml_kem_mlkem768_avx2_unpacked_unpacked_public_key(
    Eurydice_arr_74 *public_key,
    libcrux_ml_kem_ind_cca_unpacked_MlKemPublicKeyUnpacked_63
        *unpacked_public_key) {
