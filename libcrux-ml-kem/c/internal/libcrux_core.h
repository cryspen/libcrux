...
*/
Eurydice_slice
libcrux_ml_kem_types_as_ref_d3_d0(libcrux_ml_kem_types_MlKemCiphertext_1a *self);
...
*/
Eurydice_slice
libcrux_ml_kem_types_as_ref_d3_af(libcrux_ml_kem_types_MlKemCiphertext_64 *self);
