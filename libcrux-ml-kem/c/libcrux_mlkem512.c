...
libcrux_ml_kem_mlkem512_encapsulate(
  ...
  return libcrux_ml_kem_ind_cca_multiplexing_encapsulate___2size_t_768size_t_800size_t_768size_t_640size_t_128size_t_10size_t_4size_t_320size_t_3size_t_192size_t_2size_t_128size_t(
      uu____0, uu____1);
}
...
libcrux_ml_kem_mlkem512_generate_key_pair(uint8_t randomness[64U]) {
  ...
  return libcrux_ml_kem_ind_cca_multiplexing_generate_keypair___2size_t_768size_t_1632size_t_800size_t_768size_t_3size_t_192size_t(
      uu____0);
}
...
libcrux_ml_kem_mlkem512_validate_public_key(
  ...
  if (libcrux_ml_kem_ind_cca_multiplexing_validate_public_key___2size_t_768size_t_800size_t(
          public_key.value)) {
    uu____0 = ((
        core_option_Option__libcrux_ml_kem_types_MlKemPublicKey___800size_t__){
