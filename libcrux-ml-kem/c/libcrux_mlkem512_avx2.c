...
*/
static tuple_41
encapsulate_avx2_35(libcrux_ml_kem_types_MlKemPublicKey_52 *public_key, uint8_t *randomness)
{
...
*/
static tuple_41
encapsulate_35(libcrux_ml_kem_types_MlKemPublicKey_52 *public_key, uint8_t *randomness)
{
...
- ETA1_RANDOMNESS_SIZE= 192
*/
static libcrux_ml_kem_types_MlKemKeyPair_3e generate_keypair_avx2_9c(uint8_t *randomness)
{
...
- ETA1_RANDOMNESS_SIZE= 192
*/
static libcrux_ml_kem_types_MlKemKeyPair_3e generate_keypair_9c(uint8_t *randomness)
{
...
*/
static bool
validate_private_key_avx2_1c(
  libcrux_ml_kem_types_MlKemPrivateKey_fa *private_key,
  libcrux_ml_kem_types_MlKemCiphertext_1a *ciphertext
)
{
  return libcrux_ml_kem_ind_cca_validate_private_key_ad(private_key, ciphertext);
}
...
validate_private_key_only_49(libcrux_ml_kem_types_MlKemPrivateKey_fa *private_key)
{
