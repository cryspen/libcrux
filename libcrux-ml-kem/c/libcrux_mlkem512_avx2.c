...
static void decapsulate_01(libcrux_ml_kem_types_MlKemPrivateKey_5e *private_key,
                           ...
                           uint8_t ret[32U]) {
  libcrux_ml_kem_ind_cca_decapsulate_e2(private_key, ciphertext, ret);
}
...
void libcrux_ml_kem_mlkem512_avx2_decapsulate(
  ...
  decapsulate_01(private_key, ciphertext, ret);
}
...
static void decapsulate_unpacked_30(
    ...
    libcrux_ml_kem_types_MlKemCiphertext_e8 *ciphertext, uint8_t ret[32U]) {
  libcrux_ml_kem_ind_cca_unpacked_decapsulate_unpacked_d6(key_pair, ciphertext,
                                                          ret);
}
...
=======
static void decapsulate_80(libcrux_ml_kem_types_MlKemPrivateKey_5e *private_key,
                           libcrux_ml_kem_types_MlKemCiphertext_e8 *ciphertext,
                           uint8_t ret[32U]) {
  libcrux_ml_kem_ind_cca_decapsulate_97(private_key, ciphertext, ret);
}
...
void libcrux_ml_kem_mlkem512_avx2_decapsulate(
    libcrux_ml_kem_types_MlKemPrivateKey_5e *private_key,
    libcrux_ml_kem_types_MlKemCiphertext_e8 *ciphertext, uint8_t ret[32U]) {
  decapsulate_80(private_key, ciphertext, ret);
>>>>>>> main
}
...
*/
<<<<<<< HEAD
static tuple_ec encapsulate_d9(
=======
static tuple_ec encapsulate_4d(
>>>>>>> main
...
=======
  return libcrux_ml_kem_ind_cca_encapsulate_9c(uu____0, copy_of_randomness);
>>>>>>> main
}
...
tuple_ec libcrux_ml_kem_mlkem512_avx2_encapsulate(
  ...
  memcpy(copy_of_randomness, randomness, (size_t)32U * sizeof(uint8_t));
<<<<<<< HEAD
  return encapsulate_d9(uu____0, copy_of_randomness);
}
...
- ETA2_RANDOMNESS_SIZE= 128
*/
static tuple_ec encapsulate_unpacked_8b(
  ...
  uint8_t copy_of_randomness[32U];
  memcpy(copy_of_randomness, randomness, (size_t)32U * sizeof(uint8_t));
  return libcrux_ml_kem_ind_cca_unpacked_encapsulate_unpacked_25(
...
tuple_ec libcrux_ml_kem_mlkem512_avx2_encapsulate_unpacked(
  ...
  uint8_t copy_of_randomness[32U];
  memcpy(copy_of_randomness, randomness, (size_t)32U * sizeof(uint8_t));
  return encapsulate_unpacked_8b(uu____0, copy_of_randomness);
}

=======
  return encapsulate_4d(uu____0, copy_of_randomness);
}
...
*/
<<<<<<< HEAD
static libcrux_ml_kem_types_MlKemKeyPair_cb generate_keypair_50(
=======
static libcrux_ml_kem_types_MlKemKeyPair_cb generate_keypair_74(
>>>>>>> main
...
libcrux_ml_kem_mlkem512_avx2_generate_key_pair(uint8_t randomness[64U]) {
  ...
  uint8_t copy_of_randomness[64U];
  memcpy(copy_of_randomness, randomness, (size_t)64U * sizeof(uint8_t));
  return generate_keypair_50(copy_of_randomness);
}
...
libcrux_ml_kem_mlkem512_avx2_generate_key_pair(uint8_t randomness[64U]) {
  ...
  uint8_t copy_of_randomness[64U];
  memcpy(copy_of_randomness, randomness, (size_t)64U * sizeof(uint8_t));
  return generate_keypair_74(copy_of_randomness);
}
...
generate_keypair_unpacked_5a(uint8_t randomness[64U]) {
  /* Passing arrays by value in Rust generates a copy in C */
  uint8_t copy_of_randomness[64U];
  memcpy(copy_of_randomness, randomness, (size_t)64U * sizeof(uint8_t));
...
libcrux_ml_kem_mlkem512_avx2_generate_key_pair_unpacked(
  ...
  uint8_t copy_of_randomness[64U];
  memcpy(copy_of_randomness, randomness, (size_t)64U * sizeof(uint8_t));
  return generate_keypair_unpacked_5a(copy_of_randomness);
=======
static KRML_MUSTINLINE bool validate_private_key_2d(
    libcrux_ml_kem_types_MlKemPrivateKey_5e *private_key,
    libcrux_ml_kem_types_MlKemCiphertext_e8 *ciphertext) {
  return libcrux_ml_kem_ind_cca_validate_private_key_4d(private_key,
                                                        ciphertext);
}
...
bool libcrux_ml_kem_mlkem512_avx2_validate_private_key(
    libcrux_ml_kem_types_MlKemPrivateKey_5e *private_key,
    libcrux_ml_kem_types_MlKemCiphertext_e8 *ciphertext) {
  return validate_private_key_2d(private_key, ciphertext);
>>>>>>> main
}
...
*/
<<<<<<< HEAD
static bool validate_public_key_ae(uint8_t *public_key) {
  return libcrux_ml_kem_ind_cca_validate_public_key_06(public_key);
=======
static KRML_MUSTINLINE bool validate_public_key_06(uint8_t *public_key) {
  return libcrux_ml_kem_ind_cca_validate_public_key_05(public_key);
>>>>>>> main
}
...
core_option_Option_04 libcrux_ml_kem_mlkem512_avx2_validate_public_key(
  ...
  if (validate_public_key_ae(public_key.value)) {
...
bool libcrux_ml_kem_mlkem512_avx2_validate_public_key(
    libcrux_ml_kem_types_MlKemPublicKey_be *public_key) {
  return validate_public_key_06(public_key->value);
>>>>>>> main
}
