...
static void decapsulate_de(libcrux_ml_kem_types_MlKemPrivateKey_5e *private_key,
                           ...
                           uint8_t ret[32U]) {
  libcrux_ml_kem_ind_cca_decapsulate_42(private_key, ciphertext, ret);
}
...
void libcrux_ml_kem_mlkem512_avx2_decapsulate(
  ...
  decapsulate_de(private_key, ciphertext, ret);
}
...
- ETA2_RANDOMNESS_SIZE= 128
*/
static tuple_ec encapsulate_c7(
  ...
  return libcrux_ml_kem_ind_cca_encapsulate_d2(uu____0, copy_of_randomness);
}
...
tuple_ec libcrux_ml_kem_mlkem512_avx2_encapsulate(
  ...
  uint8_t copy_of_randomness[32U];
  memcpy(copy_of_randomness, randomness, (size_t)32U * sizeof(uint8_t));
  return encapsulate_c7(uu____0, copy_of_randomness);
}
...
- ETA1_RANDOMNESS_SIZE= 192
*/
static libcrux_ml_kem_types_MlKemKeyPair_cb generate_keypair_c0(
...
- PUBLIC_KEY_SIZE= 800
*/
static bool validate_public_key_6d(uint8_t *public_key) {
...
core_option_Option_04 libcrux_ml_kem_mlkem512_avx2_validate_public_key(
  ...
  if (validate_public_key_6d(public_key.value)) {
