...
mm256_castsi256_si128(core_core_arch_x86___m256i a) {
  return _mm256_castsi256_si128(a);
}

static inline core_core_arch_x86___m256i
mm256_cvtepi16_epi32(core_core_arch_x86___m128i a) {
  return _mm256_cvtepi16_epi32(a);
}

static inline core_core_arch_x86___m256i
mm256_castsi128_si256(core_core_arch_x86___m128i a) {
...
static inline core_core_arch_x86___m256i
mm256_setzero_si256(void) {
  return _mm256_setzero_si256();
}

static inline core_core_arch_x86___m256i
mm256_set1_epi16(int16_t a) {
  return _mm256_set1_epi16(a);
}

static inline core_core_arch_x86___m256i
mm256_set1_epi32(int32_t a) {
  return _mm256_set1_epi32(a);
}

static inline core_core_arch_x86___m256i
mm256_set1_epi64x(int64_t a) {
  return _mm256_set1_epi64x(a);
}

static inline core_core_arch_x86___m128i mm_set1_epi16(
    int16_t a) {
  return _mm_set1_epi16(a);
}

static inline core_core_arch_x86___m256i
mm256_set_epi16(int16_t x0, int16_t x1, int16_t x2,
...
static inline core_core_arch_x86___m256i
mm256_set_epi32(int32_t x0, int32_t x1, int32_t x2,
...
static inline core_core_arch_x86___m256i
mm256_loadu_si256_i16(Eurydice_slice a) {
  return _mm256_loadu_si256((const __m256i*)a.ptr);
}

static inline core_core_arch_x86___m256i
mm256_loadu_si256_u8(Eurydice_slice a) {
  return _mm256_loadu_si256((const __m256i*)a.ptr);
}
...
static inline core_core_arch_x86___m256i
mm256_add_epi16(core_core_arch_x86___m256i a,
                                        core_core_arch_x86___m256i b) {
  return _mm256_add_epi16(a, b);
}

static inline core_core_arch_x86___m256i
mm256_add_epi32(core_core_arch_x86___m256i a,
                                        core_core_arch_x86___m256i b) {
...
static inline core_core_arch_x86___m256i
mm256_sub_epi16(core_core_arch_x86___m256i a,
                                        core_core_arch_x86___m256i b) {
...
static inline core_core_arch_x86___m256i
mm256_mullo_epi16(core_core_arch_x86___m256i a,
                                          core_core_arch_x86___m256i b) {
  return _mm256_mullo_epi16(a, b);
}

static inline core_core_arch_x86___m256i
mm256_mulhi_epi16(core_core_arch_x86___m256i a,
                                          core_core_arch_x86___m256i b) {
  return _mm256_mulhi_epi16(a, b);
}

static inline core_core_arch_x86___m256i
mm256_mul_epu32(core_core_arch_x86___m256i a,
                                        core_core_arch_x86___m256i b) {
  return _mm256_mul_epu32(a, b);
}

static inline core_core_arch_x86___m256i
mm256_mullo_epi32(core_core_arch_x86___m256i a,
                                          core_core_arch_x86___m256i b) {
...
static inline core_core_arch_x86___m256i
mm256_madd_epi16(core_core_arch_x86___m256i a,
                                         core_core_arch_x86___m256i b) {
...
static inline core_core_arch_x86___m256i
mm256_cmpgt_epi16(core_core_arch_x86___m256i a,
                                          core_core_arch_x86___m256i b) {
...
static inline core_core_arch_x86___m256i
mm256_and_si256(core_core_arch_x86___m256i a,
                                        core_core_arch_x86___m256i b) {
  return _mm256_and_si256(a, b);
}

static inline core_core_arch_x86___m256i
mm256_andnot_si256(core_core_arch_x86___m256i a,
                                           core_core_arch_x86___m256i b) {
  return _mm256_andnot_si256(a, b);
}

static inline core_core_arch_x86___m256i
mm256_xor_si256(core_core_arch_x86___m256i a,
                                        core_core_arch_x86___m256i b) {
  return _mm256_xor_si256(a, b);
}

static inline int32_t mm_movemask_epi8(
    core_core_arch_x86___m128i a) {
  return _mm_movemask_epi8(a);
}

// Shift operations
#define mm256_srai_epi16(a, b, _) \
  (_mm256_srai_epi16(b, a))

#define mm256_srli_epi16(a, b, _) \
  (_mm256_srli_epi16(b, a))

#define mm256_slli_epi16(a, b, _) \
  (_mm256_slli_epi16(b, a))

#define mm256_slli_epi32(a, b, _) \
  (_mm256_slli_epi32(b, a))

static inline core_core_arch_x86___m256i
mm256_slli_epi64_(int32_t a,
                                          core_core_arch_x86___m256i b) {
  return _mm256_slli_epi64(b, a);
}

#define mm256_slli_epi64(a, b, c) \
  (mm256_slli_epi64_(a, b))

#define mm256_srai_epi32(a, b, _) \
  (_mm256_srai_epi32(b, a))

#define mm256_srli_epi32(a, b, _) \
  (_mm256_srli_epi32(b, a))

static inline core_core_arch_x86___m256i
mm256_sllv_epi32(core_core_arch_x86___m256i a,
                                         core_core_arch_x86___m256i b) {
  return _mm256_sllv_epi32(a, b);
}

static inline core_core_arch_x86___m256i
mm256_srli_epi64_(int32_t a,
                                          core_core_arch_x86___m256i b) {
  return _mm256_srli_epi64(b, a);
}

#define mm256_srli_epi64(a, b, c) \
  (mm256_srli_epi64_(a, b))

// Shuffle and Vector Interleaving

static inline core_core_arch_x86___m256i
mm256_unpacklo_epi32(core_core_arch_x86___m256i a,
                                             core_core_arch_x86___m256i b) {
  return _mm256_unpacklo_epi32(a, b);
}

static inline core_core_arch_x86___m256i
mm256_unpacklo_epi64(core_core_arch_x86___m256i a,
                                             core_core_arch_x86___m256i b) {
  return _mm256_unpacklo_epi64(a, b);
}

static inline core_core_arch_x86___m256i
mm256_unpackhi_epi32(core_core_arch_x86___m256i a,
                                             core_core_arch_x86___m256i b) {
  return _mm256_unpackhi_epi32(a, b);
}

static inline core_core_arch_x86___m256i
mm256_unpackhi_epi64(core_core_arch_x86___m256i a,
                                             core_core_arch_x86___m256i b) {
  return _mm256_unpackhi_epi64(a, b);
}

static inline core_core_arch_x86___m256i
mm256_packs_epi32(core_core_arch_x86___m256i a,
                                          core_core_arch_x86___m256i b) {
...
#define mm256_shuffle_epi32(a, b, _) \
  (_mm256_shuffle_epi32(b, a))

#define mm256_extracti128_si256(a, b, _) \
  (_mm256_extracti128_si256(b, a))

#define mm256_permute4x64_epi64(a, b, _) \
  (_mm256_permute4x64_epi64(b, a))

#define mm256_permute2x128_si256(a, b, c, d) \
  (_mm256_permute2x128_si256(b, c, a))

#define mm256_inserti128_si256(a, b, c, _) \
  (_mm256_inserti128_si256(b, c, a))

#define mm256_blend_epi16(a, b, c, _) \
  (_mm256_blend_epi16(b, c, a))

static inline core_core_arch_x86___m256i
mm256_shuffle_epi8(core_core_arch_x86___m256i a,
                                           core_core_arch_x86___m256i b) {
...
static inline core_core_arch_x86___m128i
mm_shuffle_epi8(core_core_arch_x86___m128i a,
