...
- SIZE= 1088
*/
static inline uint8_t *libcrux_ml_kem_types_as_slice_a8_06(
...
libcrux_ml_kem_types_from_07_57(uint8_t value[1184U]) {
...
libcrux_ml_kem_types_from_64_2c(libcrux_ml_kem_types_MlKemPrivateKey_55 sk,
                                libcrux_ml_kem_types_MlKemPublicKey_15 pk) {
  return (
...
libcrux_ml_kem_types_from_e7_e0(uint8_t value[2400U]) {
...
libcrux_ml_kem_types_from_15_20(uint8_t value[1088U]) {
...
- SIZE= 1184
*/
static inline uint8_t *libcrux_ml_kem_types_as_slice_f6_1f(
...
- SIZE= 1088
*/
static inline Eurydice_slice libcrux_ml_kem_types_as_ref_ba_88(
    libcrux_ml_kem_mlkem768_MlKem768Ciphertext *self) {
