...
- LEN= 32
*/
static KRML_MUSTINLINE void libcrux_ml_kem_utils_into_padded_array_ca(
...
- SIZE= 1088
*/
static inline uint8_t *libcrux_ml_kem_types_as_slice_07_59(
...
libcrux_ml_kem_types_from_40_c9(uint8_t value[1184U]) {
...
libcrux_ml_kem_types_from_17_b5(libcrux_ml_kem_types_MlKemPrivateKey_d9 sk,
                                libcrux_ml_kem_types_MlKemPublicKey_30 pk) {
  return (
...
libcrux_ml_kem_types_from_88_06(uint8_t value[2400U]) {
  /* Passing arrays by value in Rust generates a copy in C */
...
libcrux_ml_kem_types_from_fc_59(uint8_t value[1088U]) {
  /* Passing arrays by value in Rust generates a copy in C */
...
- SIZE= 1184
*/
static inline uint8_t *libcrux_ml_kem_types_as_slice_ba_c9(
...
- LEN= 33
*/
static KRML_MUSTINLINE void libcrux_ml_kem_utils_into_padded_array_95(
...
- LEN= 34
*/
static KRML_MUSTINLINE void libcrux_ml_kem_utils_into_padded_array_3a(
...
- SIZE= 1088
*/
static inline Eurydice_slice libcrux_ml_kem_types_as_ref_fd_59(
    libcrux_ml_kem_mlkem768_MlKem768Ciphertext *self) {
...
- LEN= 1120
*/
static KRML_MUSTINLINE void libcrux_ml_kem_utils_into_padded_array_08(
...
- LEN= 64
*/
static KRML_MUSTINLINE void libcrux_ml_kem_utils_into_padded_array_a2(
