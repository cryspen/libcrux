...
- SIZE= 1088
*/
static inline uint8_t *libcrux_ml_kem_types_as_slice_a8_a2(
...
libcrux_ml_kem_types_from_07_18(uint8_t value[1184U]) {
...
libcrux_ml_kem_types_from_64_a6(libcrux_ml_kem_types_MlKemPrivateKey_55 sk,
                                libcrux_ml_kem_types_MlKemPublicKey_15 pk) {
  return (
...
libcrux_ml_kem_types_from_e7_a6(uint8_t value[2400U]) {
  /* Passing arrays by value in Rust generates a copy in C */
...
libcrux_ml_kem_types_from_15_64(uint8_t value[1088U]) {
  /* Passing arrays by value in Rust generates a copy in C */
...
- SIZE= 1184
*/
static inline uint8_t *libcrux_ml_kem_types_as_slice_f6_eb(
