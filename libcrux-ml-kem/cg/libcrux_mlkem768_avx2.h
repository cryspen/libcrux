...
libcrux_ml_kem_polynomial_ZERO_d6_61(void) {
...
libcrux_ml_kem_ind_cpa_deserialize_secret_key_closure_ab(size_t _) {
  return libcrux_ml_kem_polynomial_ZERO_d6_61();
}
...
libcrux_ml_kem_serialize_deserialize_to_uncompressed_ring_element_61(
  ...
  libcrux_ml_kem_polynomial_PolynomialRingElement_f6 re =
      libcrux_ml_kem_polynomial_ZERO_d6_61();
...
static KRML_MUSTINLINE void libcrux_ml_kem_ind_cpa_deserialize_secret_key_ab(
  ...
  for (size_t i = (size_t)0U; i < (size_t)3U; i++) {
    secret_as_ntt[i] = libcrux_ml_kem_polynomial_ZERO_d6_61();
  }
  for (size_t i = (size_t)0U;
...
*/
KRML_ATTRIBUTE_TARGET("avx2")
static KRML_MUSTINLINE void libcrux_ml_kem_polynomial_poly_barrett_reduce_d6_61(
...
static KRML_MUSTINLINE void libcrux_ml_kem_ntt_ntt_vector_u_ee(
  ...
  libcrux_ml_kem_ntt_ntt_at_layer_4_plus_61(&zeta_i, re, (size_t)4U,
                                            (size_t)3328U);
  libcrux_ml_kem_ntt_ntt_at_layer_3_61(&zeta_i, re, (size_t)3U, (size_t)3328U);
  libcrux_ml_kem_ntt_ntt_at_layer_2_61(&zeta_i, re, (size_t)2U, (size_t)3328U);
  libcrux_ml_kem_ntt_ntt_at_layer_1_61(&zeta_i, re, (size_t)1U, (size_t)3328U);
  libcrux_ml_kem_polynomial_poly_barrett_reduce_d6_61(re);
}
...
libcrux_ml_kem_ind_cpa_deserialize_then_decompress_u_ed(
  ...
  for (size_t i = (size_t)0U; i < (size_t)3U; i++) {
    u_as_ntt[i] = libcrux_ml_kem_polynomial_ZERO_d6_61();
  }
  for (size_t i = (size_t)0U;
...
KRML_ATTRIBUTE_TARGET("avx2")
static KRML_MUSTINLINE libcrux_ml_kem_polynomial_PolynomialRingElement_f6
libcrux_ml_kem_polynomial_subtract_reduce_d6_61(
    libcrux_ml_kem_polynomial_PolynomialRingElement_f6 *self,
...
libcrux_ml_kem_matrix_compute_message_ab(
  ...
  for (size_t i = (size_t)0U; i < (size_t)3U; i++) {
    ...
    libcrux_ml_kem_polynomial_PolynomialRingElement_f6 product =
        libcrux_ml_kem_polynomial_ntt_multiply_d6_61(&secret_as_ntt[i0],
                                                     &u_as_ntt[i0]);
  ...
  result = libcrux_ml_kem_polynomial_subtract_reduce_d6_61(v, result);
  return result;
}
...
/**
A monomorphic instance of libcrux_ml_kem.serialize.to_unsigned_field_element
with types libcrux_ml_kem_vector_avx2_SIMD256Vector
with const generics
...
KRML_ATTRIBUTE_TARGET("avx2")
static KRML_MUSTINLINE __m256i
libcrux_ml_kem_serialize_to_unsigned_field_element_61(__m256i a) {
...
libcrux_ml_kem_ind_cpa_unpacked_default_8d_ab(void) {
  ...
  for (size_t i = (size_t)0U; i < (size_t)3U; i++) {
    uu____0[i] = libcrux_ml_kem_polynomial_ZERO_d6_61();
  }
  ...
  lit.A[0U][0U] = libcrux_ml_kem_polynomial_ZERO_d6_61();
  lit.A[0U][1U] = libcrux_ml_kem_polynomial_ZERO_d6_61();
  lit.A[0U][2U] = libcrux_ml_kem_polynomial_ZERO_d6_61();
  lit.A[1U][0U] = libcrux_ml_kem_polynomial_ZERO_d6_61();
  lit.A[1U][1U] = libcrux_ml_kem_polynomial_ZERO_d6_61();
  lit.A[1U][2U] = libcrux_ml_kem_polynomial_ZERO_d6_61();
  lit.A[2U][0U] = libcrux_ml_kem_polynomial_ZERO_d6_61();
  lit.A[2U][1U] = libcrux_ml_kem_polynomial_ZERO_d6_61();
  lit.A[2U][2U] = libcrux_ml_kem_polynomial_ZERO_d6_61();
  return lit;
}
...
KRML_ATTRIBUTE_TARGET("avx2")
static KRML_MUSTINLINE libcrux_ml_kem_polynomial_PolynomialRingElement_f6
libcrux_ml_kem_polynomial_from_i16_array_d6_61(Eurydice_slice a) {
  libcrux_ml_kem_polynomial_PolynomialRingElement_f6 result =
      libcrux_ml_kem_polynomial_ZERO_d6_61();
  for (size_t i = (size_t)0U;
       i < LIBCRUX_ML_KEM_POLYNOMIAL_VECTORS_IN_RING_ELEMENT; i++) {
...
libcrux_ml_kem_sampling_sample_from_xof_closure_6c(int16_t s[272U]) {
  return libcrux_ml_kem_polynomial_from_i16_array_d6_61(
...
libcrux_ml_kem_ntt_ntt_binomially_sampled_ring_element_61(
  ...
  libcrux_ml_kem_ntt_ntt_at_layer_4_plus_61(&zeta_i, re, (size_t)4U,
                                            (size_t)3U);
  libcrux_ml_kem_ntt_ntt_at_layer_3_61(&zeta_i, re, (size_t)3U, (size_t)3U);
  libcrux_ml_kem_ntt_ntt_at_layer_2_61(&zeta_i, re, (size_t)2U, (size_t)3U);
  libcrux_ml_kem_ntt_ntt_at_layer_1_61(&zeta_i, re, (size_t)1U, (size_t)3U);
  libcrux_ml_kem_polynomial_poly_barrett_reduce_d6_61(re);
}
...
libcrux_ml_kem_ind_cpa_sample_vector_cbd_then_ntt_out_b4(
  ...
  for (size_t i = (size_t)0U; i < (size_t)3U; i++) {
    re_as_ntt[i] = libcrux_ml_kem_polynomial_ZERO_d6_61();
  }
...
libcrux_ml_kem_ind_cpa_sample_ring_element_cbd_b4(uint8_t prf_input[33U],
  ...
  for (size_t i = (size_t)0U; i < (size_t)3U; i++) {
    error_1[i] = libcrux_ml_kem_polynomial_ZERO_d6_61();
  }
  /* Passing arrays by value in Rust generates a copy in C */
  uint8_t copy_of_prf_input[33U];
  memcpy(copy_of_prf_input, prf_input, (size_t)33U * sizeof(uint8_t));
...
static KRML_MUSTINLINE void libcrux_ml_kem_matrix_compute_vector_u_ab(
  ...
  for (size_t i = (size_t)0U; i < (size_t)3U; i++) {
    result[i] = libcrux_ml_kem_polynomial_ZERO_d6_61();
  }
  for (size_t i0 = (size_t)0U;
    ...
    for (size_t i = (size_t)0U;
      ...
      libcrux_ml_kem_polynomial_PolynomialRingElement_f6 product =
          libcrux_ml_kem_polynomial_ntt_multiply_d6_61(a_element, &r_as_ntt[j]);
...
libcrux_ml_kem_matrix_compute_ring_element_v_ab(
  ...
  for (size_t i = (size_t)0U; i < (size_t)3U; i++) {
    size_t i0 = i;
    libcrux_ml_kem_polynomial_PolynomialRingElement_f6 product =
        libcrux_ml_kem_polynomial_ntt_multiply_d6_61(&t_as_ntt[i0],
                                                     &r_as_ntt[i0]);
    libcrux_ml_kem_polynomial_add_to_ring_element_d6_ab(&result, &product);
  }
  libcrux_ml_kem_invert_ntt_invert_ntt_montgomery_ab(&result);
  result = libcrux_ml_kem_polynomial_add_message_error_reduce_d6_61(
...
libcrux_ml_kem_ind_cpa_unpacked_default_1a_ab(void) {
  ...
  lit.secret_as_ntt[0U] = libcrux_ml_kem_polynomial_ZERO_d6_61();
  lit.secret_as_ntt[1U] = libcrux_ml_kem_polynomial_ZERO_d6_61();
  lit.secret_as_ntt[2U] = libcrux_ml_kem_polynomial_ZERO_d6_61();
  return lit;
}
...
KRML_ATTRIBUTE_TARGET("avx2")
static KRML_MUSTINLINE void
libcrux_ml_kem_polynomial_add_standard_error_reduce_d6_61(
    libcrux_ml_kem_polynomial_PolynomialRingElement_f6 *self,
    libcrux_ml_kem_polynomial_PolynomialRingElement_f6 *error) {
  for (size_t i = (size_t)0U;
       i <
  ...
  for (size_t i = (size_t)0U;
    ...
    for (size_t i1 = (size_t)0U;
      ...
      libcrux_ml_kem_polynomial_PolynomialRingElement_f6 *matrix_element =
          &row[j];
      libcrux_ml_kem_polynomial_PolynomialRingElement_f6 product =
          libcrux_ml_kem_polynomial_ntt_multiply_d6_61(matrix_element,
                                                       &s_as_ntt[j]);
...
libcrux_ml_kem_serialize_deserialize_ring_elements_reduced_out_b1(
  ...
  for (size_t i = (size_t)0U; i < (size_t)3U; i++) {
    deserialized_pk[i] = libcrux_ml_kem_polynomial_ZERO_d6_61();
  }
  libcrux_ml_kem_serialize_deserialize_ring_elements_reduced_b1(
...
static inline void libcrux_ml_kem_ind_cca_unpacked_transpose_a_closure_ab(
  ...
  for (size_t i = (size_t)0U; i < (size_t)3U; i++) {
    ret[i] = libcrux_ml_kem_polynomial_ZERO_d6_61();
  }
}
...
KRML_ATTRIBUTE_TARGET("avx2")
static inline libcrux_ml_kem_polynomial_PolynomialRingElement_f6
libcrux_ml_kem_polynomial_clone_17_61(
    libcrux_ml_kem_polynomial_PolynomialRingElement_f6 *self) {
  libcrux_ml_kem_polynomial_PolynomialRingElement_f6 lit;
  __m256i ret[16U];
...
static inline void libcrux_ml_kem_ind_cca_unpacked_transpose_a_ab(
  ...
  for (size_t i = (size_t)0U; i < (size_t)3U; i++) {
    ...
    for (size_t i1 = (size_t)0U; i1 < (size_t)3U; i1++) {
      size_t j = i1;
      libcrux_ml_kem_polynomial_PolynomialRingElement_f6 uu____0 =
          libcrux_ml_kem_polynomial_clone_17_61(&ind_cpa_a[j][i0]);
      A[i0][j] = uu____0;
    }
  }
  memcpy(ret, A,
