...
TEST(MlKem1024TestAvx2, ConsistencyTest)
{
    ...
    auto ctxt = libcrux_ml_kem_mlkem1024_avx2_encapsulate(&key_pair.pk, randomness);
...
TEST(MlKem1024TestAvx2Unpacked, NISTKnownAnswerTest)
{
    ...
    {
        auto key_pair =
            libcrux_ml_kem_mlkem1024_avx2_generate_key_pair_unpacked(kat.key_generation_seed.data());
