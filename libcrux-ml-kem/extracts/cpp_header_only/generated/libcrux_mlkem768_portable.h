...
libcrux_ml_kem_vector_portable_serialize_serialize_4_int(Eurydice_slice v) {
  ...
  return (uint8_t_x4{
      libcrux_secrets_int_public_integers_declassify_d8_90(result0),
      libcrux_secrets_int_public_integers_declassify_d8_90(result1),
      libcrux_secrets_int_public_integers_declassify_d8_90(result2),
      libcrux_secrets_int_public_integers_declassify_d8_90(result3)});
}
...
libcrux_ml_kem_vector_portable_serialize_serialize_10_int(Eurydice_slice v) {
  ...
  uint8_t r4 = libcrux_secrets_int_as_u8_f5(
      ...
      (int16_t)255);
  return (uint8_t_x5{libcrux_secrets_int_public_integers_declassify_d8_90(r0),
                     libcrux_secrets_int_public_integers_declassify_d8_90(r1),
                     libcrux_secrets_int_public_integers_declassify_d8_90(r2),
                     libcrux_secrets_int_public_integers_declassify_d8_90(r3),
                     libcrux_secrets_int_public_integers_declassify_d8_90(r4)});
}
...
libcrux_ml_kem_vector_portable_serialize_serialize_12_int(Eurydice_slice v) {
  ...
  uint8_t r2 = libcrux_secrets_int_as_u8_f5(
      ...
      (int16_t)255);
  return (uint8_t_x3{libcrux_secrets_int_public_integers_declassify_d8_90(r0),
                     libcrux_secrets_int_public_integers_declassify_d8_90(r1),
                     libcrux_secrets_int_public_integers_declassify_d8_90(r2)});
}
...
libcrux_ml_kem_ind_cpa_unpacked_default_50_89(void) {
  ...
  for (size_t i = (size_t)0U; i < (size_t)3U; i++) {
    uu____0[i] = libcrux_ml_kem_polynomial_ZERO_d6_df();
  }
  ...
  for (size_t i = (size_t)0U; i < (size_t)9U; i++) {
    repeat_expression[i] = libcrux_ml_kem_polynomial_ZERO_d6_df();
  }
  memcpy(
...
static KRML_MUSTINLINE void libcrux_ml_kem_ind_cca_unpacked_transpose_a_89(
  ...
  for (size_t i = (size_t)0U; i < (size_t)3U; i++) {
    size_t i0 = i;
    libcrux_ml_kem_polynomial_PolynomialRingElement_1d _a_i[9U];
    memcpy(_a_i, A,
           (size_t)9U *
    ...
    for (size_t i1 = (size_t)0U; i1 < (size_t)3U; i1++) {
      ...
      libcrux_ml_kem_polynomial_PolynomialRingElement_1d uu____0 =
          libcrux_ml_kem_polynomial_clone_c1_df(
              libcrux_ml_kem_matrix_entry_1b(ind_cpa_a, j, i0));
...
libcrux_ml_kem_ind_cca_unpacked_default_3f_89(void) {
  return (libcrux_ml_kem_ind_cca_unpacked_MlKemPublicKeyUnpacked_be{
      libcrux_ml_kem_ind_cpa_unpacked_default_50_89(), {0U}});
}
...
static KRML_MUSTINLINE
  ...
  return (libcrux_ml_kem_mlkem768_portable_unpacked_MlKem768KeyPairUnpacked{
      uu____0, libcrux_ml_kem_ind_cca_unpacked_default_3f_89()});
}
