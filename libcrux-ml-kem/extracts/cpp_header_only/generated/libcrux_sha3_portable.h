...
static KRML_MUSTINLINE void libcrux_sha3_simd_portable_load_block_f8(
  ...
  for (size_t i = (size_t)0U; i < (size_t)72U / (size_t)8U; i++) {
    ...
    Eurydice_arr_c4 uu____0 = unwrap_26_ab(dst);
...
static inline void libcrux_sha3_simd_portable_load_block_a1_f8(
    Eurydice_arr_26 *self, Eurydice_arr_34 *input, size_t start) {
...
static inline void libcrux_sha3_simd_portable_load_last_a1_96(
    Eurydice_arr_26 *self, Eurydice_arr_34 *input, size_t start, size_t len) {
...
static inline void libcrux_sha3_simd_portable_squeeze_13_f8(
    Eurydice_arr_26 *self, Eurydice_slice out, size_t start, size_t len) {
...
libcrux_sha3_portable_incremental_shake128_absorb_final(Eurydice_arr_26 *s,
                                                        Eurydice_slice data0) {
  Eurydice_arr_26 *uu____0 = s;
  /* original Rust expression is not an lvalue in C */
  Eurydice_arr_34 lvalue = {{data0}};
...
/**
 SHA3 256
*/
static inline Eurydice_arr_600 libcrux_sha3_sha256(Eurydice_slice data) {
...
*/
static KRML_MUSTINLINE void
libcrux_sha3_portable_incremental_shake256_absorb_final(Eurydice_arr_26 *s,
                                                        Eurydice_slice data) {
  Eurydice_arr_26 *uu____0 = s;
  /* original Rust expression is not an lvalue in C */
  Eurydice_arr_34 lvalue = {{data}};
