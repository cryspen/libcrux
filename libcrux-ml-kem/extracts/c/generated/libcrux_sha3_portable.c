...
- N= 1
*/
KRML_MUSTINLINE void libcrux_sha3_generic_keccak_rho_0_80_04(
...
- N= 1
*/
KRML_MUSTINLINE void libcrux_sha3_generic_keccak_rho_1_80_04(
    Eurydice_arr_26 *self, Eurydice_arr_a5 t) {
  libcrux_sha3_generic_keccak_set_80_04(
...
- N= 1
*/
KRML_MUSTINLINE void libcrux_sha3_generic_keccak_rho_2_80_04(
    Eurydice_arr_26 *self, Eurydice_arr_a5 t) {
  libcrux_sha3_generic_keccak_set_80_04(
...
- N= 1
*/
KRML_MUSTINLINE void libcrux_sha3_generic_keccak_rho_3_80_04(
    Eurydice_arr_26 *self, Eurydice_arr_a5 t) {
  libcrux_sha3_generic_keccak_set_80_04(
...
- N= 1
*/
KRML_MUSTINLINE void libcrux_sha3_generic_keccak_rho_4_80_04(
    Eurydice_arr_26 *self, Eurydice_arr_a5 t) {
  libcrux_sha3_generic_keccak_set_80_04(
...
- N= 1
*/
KRML_MUSTINLINE void libcrux_sha3_generic_keccak_pi_0_80_04(
...
- N= 1
*/
KRML_MUSTINLINE void libcrux_sha3_generic_keccak_pi_1_80_04(
    Eurydice_arr_26 *self, Eurydice_arr_26 old) {
  libcrux_sha3_generic_keccak_set_80_04(
      self, (size_t)0U, (size_t)1U,
      libcrux_sha3_generic_keccak_index_c2_04(
...
- N= 1
*/
KRML_MUSTINLINE void libcrux_sha3_generic_keccak_pi_2_80_04(
    Eurydice_arr_26 *self, Eurydice_arr_26 old) {
  libcrux_sha3_generic_keccak_set_80_04(
      self, (size_t)0U, (size_t)2U,
      libcrux_sha3_generic_keccak_index_c2_04(
...
- N= 1
*/
KRML_MUSTINLINE void libcrux_sha3_generic_keccak_pi_3_80_04(
    Eurydice_arr_26 *self, Eurydice_arr_26 old) {
  libcrux_sha3_generic_keccak_set_80_04(
      self, (size_t)0U, (size_t)3U,
      libcrux_sha3_generic_keccak_index_c2_04(
...
- N= 1
*/
KRML_MUSTINLINE void libcrux_sha3_generic_keccak_pi_4_80_04(
    Eurydice_arr_26 *self, Eurydice_arr_26 old) {
  libcrux_sha3_generic_keccak_set_80_04(
      self, (size_t)0U, (size_t)4U,
      libcrux_sha3_generic_keccak_index_c2_04(
...
- RATE= 72
*/
void libcrux_sha3_simd_portable_squeeze_9b_f8(const Eurydice_arr_26 *self,
...
inline void libcrux_sha3_generic_keccak_portable_keccak1_96(
  ...
  for (size_t i = (size_t)0U; i < input_blocks; i++) {
    ...
    Eurydice_arr_8e lvalue = {.data = {input}};
  ...
  size_t output_len =
      Eurydice_slice_len((KRML_CLITERAL(Eurydice_borrow_slice_u8){
                             .ptr = output.ptr, .meta = output.meta}),
                         uint8_t);
...
- RATE= 136
*/
void libcrux_sha3_simd_portable_squeeze_9b_5b(const Eurydice_arr_26 *self,
                                              Eurydice_mut_borrow_slice_u8 out,
                                              size_t start, size_t len) {
...
- RATE= 168
*/
void libcrux_sha3_simd_portable_squeeze_9b_3a(const Eurydice_arr_26 *self,
                                              Eurydice_mut_borrow_slice_u8 out,
                                              size_t start, size_t len) {
...
- RATE= 144
*/
void libcrux_sha3_simd_portable_squeeze_9b_2c(const Eurydice_arr_26 *self,
                                              Eurydice_mut_borrow_slice_u8 out,
                                              size_t start, size_t len) {
...
- RATE= 104
*/
void libcrux_sha3_simd_portable_squeeze_9b_7a(const Eurydice_arr_26 *self,
                                              Eurydice_mut_borrow_slice_u8 out,
                                              size_t start, size_t len) {
...
/**
 ...
 - `digest.len() == 28`
*/
KRML_MUSTINLINE void libcrux_sha3_sha224_ema(
...
/**
 SHA3 224
*/
KRML_MUSTINLINE Eurydice_arr_f1
...
/**
 SHA3 256
*/
KRML_MUSTINLINE void libcrux_sha3_sha256_ema(
    Eurydice_mut_borrow_slice_u8 digest, Eurydice_borrow_slice_u8 payload) {
...
/**
 SHA3 384
*/
KRML_MUSTINLINE void libcrux_sha3_sha384_ema(
    Eurydice_mut_borrow_slice_u8 digest, Eurydice_borrow_slice_u8 payload) {
...
/**
 SHA3 384
*/
KRML_MUSTINLINE Eurydice_arr_5f
...
/**
 SHA3 512
*/
KRML_MUSTINLINE void libcrux_sha3_sha512_ema(
    Eurydice_mut_borrow_slice_u8 digest, Eurydice_borrow_slice_u8 payload) {
...
/**
 SHA3 512
*/
KRML_MUSTINLINE Eurydice_arr_06
