...
- N= 1
*/
KRML_MUSTINLINE uint64_t *libcrux_sha3_traits_get_ij_04(Eurydice_arr_26 *arr,
                                                        size_t i, size_t j) {
...
KRML_MUSTINLINE void libcrux_sha3_simd_portable_load_last_96(
  ...
  Eurydice_slice_copy(Eurydice_array_to_subslice_36(
...
- RATE= 72
*/
void libcrux_sha3_simd_portable_squeeze_13_f8(Eurydice_arr_26 *self,
...
inline void libcrux_sha3_generic_keccak_portable_keccak1_96(
  ...
  for (size_t i = (size_t)0U; i < data_len / (size_t)72U; i++) {
    size_t i0 = i;
    /* original Rust expression is not an lvalue in C */
    Eurydice_arr_e2 lvalue = {.data = {data}};
...
*/
void libcrux_sha3_portable_sha512(Eurydice_dst_ref_87 digest,
...
KRML_MUSTINLINE void libcrux_sha3_simd_portable_load_last_ad(
  ...
  Eurydice_slice_copy(Eurydice_array_to_subslice_361(
                          &buffer, (KRML_CLITERAL(core_ops_range_Range_08){
                                       .start = (size_t)0U, .end = len})),
                      Eurydice_slice_subslice_7e(
                          blocks, (KRML_CLITERAL(core_ops_range_Range_08){
...
- RATE= 136
*/
void libcrux_sha3_simd_portable_squeeze_13_5b(Eurydice_arr_26 *self,
                                              Eurydice_dst_ref_87 out,
                                              size_t start, size_t len) {
...
*/
void libcrux_sha3_portable_sha256(Eurydice_dst_ref_87 digest,
                                  Eurydice_dst_ref_87 data) {
...
*/
void libcrux_sha3_portable_shake256(Eurydice_dst_ref_87 digest,
                                    Eurydice_dst_ref_87 data) {
...
KRML_MUSTINLINE void libcrux_sha3_simd_portable_load_last_c6(
  ...
  Eurydice_slice_copy(Eurydice_array_to_subslice_362(
                          &buffer, (KRML_CLITERAL(core_ops_range_Range_08){
                                       .start = (size_t)0U, .end = len})),
                      Eurydice_slice_subslice_7e(
                          blocks, (KRML_CLITERAL(core_ops_range_Range_08){
...
void libcrux_sha3_portable_incremental_shake128_absorb_final(
  ...
  /* original Rust expression is not an lvalue in C */
  Eurydice_arr_e2 lvalue = {.data = {data0}};
...
- RATE= 168
*/
void libcrux_sha3_simd_portable_squeeze_13_3a(Eurydice_arr_26 *self,
                                              Eurydice_dst_ref_87 out,
                                              size_t start, size_t len) {
...
KRML_MUSTINLINE void libcrux_sha3_simd_portable_load_last_1e(
  ...
  Eurydice_slice_copy(Eurydice_array_to_subslice_363(
                          &buffer, (KRML_CLITERAL(core_ops_range_Range_08){
                                       .start = (size_t)0U, .end = len})),
                      Eurydice_slice_subslice_7e(
                          blocks, (KRML_CLITERAL(core_ops_range_Range_08){
...
- RATE= 144
*/
void libcrux_sha3_simd_portable_squeeze_13_2c(Eurydice_arr_26 *self,
                                              Eurydice_dst_ref_87 out,
                                              size_t start, size_t len) {
...
*/
KRML_MUSTINLINE void libcrux_sha3_portable_sha224(Eurydice_dst_ref_87 digest,
                                                  Eurydice_dst_ref_87 data) {
...
KRML_MUSTINLINE void libcrux_sha3_simd_portable_load_last_7c(
  ...
  Eurydice_slice_copy(Eurydice_array_to_subslice_364(
                          &buffer, (KRML_CLITERAL(core_ops_range_Range_08){
                                       .start = (size_t)0U, .end = len})),
                      Eurydice_slice_subslice_7e(
                          blocks, (KRML_CLITERAL(core_ops_range_Range_08){
...
- RATE= 104
*/
void libcrux_sha3_simd_portable_squeeze_13_7a(Eurydice_arr_26 *self,
                                              Eurydice_dst_ref_87 out,
                                              size_t start, size_t len) {
...
*/
KRML_MUSTINLINE void libcrux_sha3_portable_sha384(Eurydice_dst_ref_87 digest,
                                                  Eurydice_dst_ref_87 data) {
...
/**
 ...
 - `digest.len() == 28`
*/
void libcrux_sha3_sha224_ema(Eurydice_dst_ref_87 digest,
...
/**
 SHA3 256
*/
void libcrux_sha3_sha256_ema(Eurydice_dst_ref_87 digest,
                             Eurydice_dst_ref_87 payload) {
...
/**
 SHA3 384
*/
void libcrux_sha3_sha384_ema(Eurydice_dst_ref_87 digest,
                             Eurydice_dst_ref_87 payload) {
...
/**
 SHA3 512
*/
void libcrux_sha3_sha512_ema(Eurydice_dst_ref_87 digest,
                             Eurydice_dst_ref_87 payload) {
...
*/
KRML_MUSTINLINE void libcrux_sha3_portable_shake128(Eurydice_dst_ref_87 digest,
                                                    Eurydice_dst_ref_87 data) {
...
*/
void libcrux_sha3_shake128_ema(Eurydice_dst_ref_87 out,
                               Eurydice_dst_ref_87 data) {
...
/**
 ...
 Writes `out.len()` bytes.
*/
void libcrux_sha3_shake256_ema(Eurydice_dst_ref_87 out,
                               Eurydice_dst_ref_87 data) {
