...
inline libcrux_sha3_Sha3_512Digest libcrux_ml_kem_hash_functions_portable_G(
    Eurydice_dst_ref_87 input) {
  libcrux_sha3_Sha3_512Digest digest = {.data = {0U}};
  libcrux_sha3_portable_sha512(Eurydice_array_to_slice_d8(&digest), input);
  return digest;
}
...
inline Eurydice_arr_60 libcrux_ml_kem_hash_functions_portable_H(
  ...
  libcrux_sha3_portable_sha256(Eurydice_array_to_slice_6e(&digest), input);
  return digest;
}
...
*/
Eurydice_arr_e20 libcrux_ml_kem_vector_portable_ZERO_b8(void) {
  return libcrux_ml_kem_vector_portable_vector_type_zero();
}

KRML_MUSTINLINE Eurydice_arr_e20
libcrux_ml_kem_vector_portable_vector_type_from_i16_array(
    Eurydice_dst_ref_9a array) {
  Eurydice_arr_e20 arr;
  memcpy(arr.data,
         Eurydice_slice_subslice_76(
...
libcrux_ml_kem::vector::portable::vector_type::PortableVector}
*/
Eurydice_arr_e20 libcrux_ml_kem_vector_portable_from_i16_array_b8(
    Eurydice_dst_ref_9a array) {
...
KRML_MUSTINLINE Eurydice_arr_e20
libcrux_ml_kem_vector_portable_vector_type_to_i16_array(Eurydice_arr_e20 x) {
  return x;
}
...
libcrux_ml_kem::vector::portable::vector_type::PortableVector}
*/
Eurydice_arr_e20 libcrux_ml_kem_vector_portable_to_i16_array_b8(
    Eurydice_arr_e20 x) {
...
libcrux_ml_kem_vector_portable_vector_type_from_bytes(
    Eurydice_dst_ref_87 array) {
  Eurydice_arr_e20 elements;
  ...
  for (size_t i = (size_t)0U;
    ...
    size_t i0 = i;
    elements.data[i0] = libcrux_secrets_int_as_i16_59(Eurydice_slice_index(
...
libcrux_ml_kem::vector::portable::vector_type::PortableVector}
*/
Eurydice_arr_e20 libcrux_ml_kem_vector_portable_from_bytes_b8(
    Eurydice_dst_ref_87 array) {
...
KRML_MUSTINLINE void libcrux_ml_kem_vector_portable_vector_type_to_bytes(
    Eurydice_arr_e20 x, Eurydice_dst_ref_87 bytes) {
  for (size_t i = (size_t)0U;
       i < LIBCRUX_ML_KEM_VECTOR_TRAITS_FIELD_ELEMENTS_IN_VECTOR; i++) {
    size_t i0 = i;
    Eurydice_slice_index(bytes, (size_t)2U * i0, uint8_t) =
...
libcrux_ml_kem::vector::portable::vector_type::PortableVector}
*/
void libcrux_ml_kem_vector_portable_to_bytes_b8(Eurydice_arr_e20 x,
                                                Eurydice_dst_ref_87 bytes) {
  libcrux_ml_kem_vector_portable_vector_type_to_bytes(
      x, libcrux_secrets_int_public_integers_classify_mut_slice_44(bytes));
}

KRML_MUSTINLINE Eurydice_arr_e20 libcrux_ml_kem_vector_portable_arithmetic_add(
    Eurydice_arr_e20 lhs, Eurydice_arr_e20 *rhs) {
  for (size_t i = (size_t)0U;
       i < LIBCRUX_ML_KEM_VECTOR_TRAITS_FIELD_ELEMENTS_IN_VECTOR; i++) {
    size_t i0 = i;
    size_t uu____0 = i0;
...
libcrux_ml_kem::vector::portable::vector_type::PortableVector}
*/
Eurydice_arr_e20 libcrux_ml_kem_vector_portable_add_b8(Eurydice_arr_e20 lhs,
                                                       Eurydice_arr_e20 *rhs) {
  return libcrux_ml_kem_vector_portable_arithmetic_add(lhs, rhs);
}

KRML_MUSTINLINE Eurydice_arr_e20 libcrux_ml_kem_vector_portable_arithmetic_sub(
    Eurydice_arr_e20 lhs, Eurydice_arr_e20 *rhs) {
  for (size_t i = (size_t)0U;
       i < LIBCRUX_ML_KEM_VECTOR_TRAITS_FIELD_ELEMENTS_IN_VECTOR; i++) {
    size_t i0 = i;
...
libcrux_ml_kem::vector::portable::vector_type::PortableVector}
*/
Eurydice_arr_e20 libcrux_ml_kem_vector_portable_sub_b8(Eurydice_arr_e20 lhs,
                                                       Eurydice_arr_e20 *rhs) {
...
libcrux_ml_kem_vector_portable_arithmetic_multiply_by_constant(
    Eurydice_arr_e20 vec, int16_t c) {
  for (size_t i = (size_t)0U;
       i < LIBCRUX_ML_KEM_VECTOR_TRAITS_FIELD_ELEMENTS_IN_VECTOR; i++) {
    size_t i0 = i;
    size_t uu____0 = i0;
...
libcrux_ml_kem::vector::portable::vector_type::PortableVector}
*/
Eurydice_arr_e20 libcrux_ml_kem_vector_portable_multiply_by_constant_b8(
    Eurydice_arr_e20 vec, int16_t c) {
...
libcrux_ml_kem::vector::portable::vector_type::PortableVector}
*/
Eurydice_arr_e20 libcrux_ml_kem_vector_portable_cond_subtract_3329_b8(
    Eurydice_arr_e20 v) {
...
KRML_MUSTINLINE Eurydice_arr_e20
libcrux_ml_kem_vector_portable_arithmetic_barrett_reduce(Eurydice_arr_e20 vec) {
  for (size_t i = (size_t)0U;
       i < LIBCRUX_ML_KEM_VECTOR_TRAITS_FIELD_ELEMENTS_IN_VECTOR; i++) {
    size_t i0 = i;
    int16_t vi =
...
libcrux_ml_kem::vector::portable::vector_type::PortableVector}
*/
Eurydice_arr_e20 libcrux_ml_kem_vector_portable_barrett_reduce_b8(
    Eurydice_arr_e20 vector) {
...
libcrux_ml_kem_vector_portable_montgomery_multiply_by_constant_b8(
    Eurydice_arr_e20 vector, int16_t constant) {
...
- SHIFT_BY= 15
*/
static KRML_MUSTINLINE Eurydice_arr_e20 shift_right_ef(Eurydice_arr_e20 vec) {
  for (size_t i = (size_t)0U;
       i < LIBCRUX_ML_KEM_VECTOR_TRAITS_FIELD_ELEMENTS_IN_VECTOR; i++) {
    size_t i0 = i;
...
libcrux_ml_kem_vector_portable_arithmetic_to_unsigned_representative(
    Eurydice_arr_e20 a) {
  Eurydice_arr_e20 t = shift_right_ef(a);
  Eurydice_arr_e20 fm =
      libcrux_ml_kem_vector_portable_arithmetic_bitwise_and_with_constant(
...
libcrux_ml_kem::vector::portable::vector_type::PortableVector}
*/
Eurydice_arr_e20 libcrux_ml_kem_vector_portable_to_unsigned_representative_b8(
    Eurydice_arr_e20 a) {
...
KRML_MUSTINLINE Eurydice_arr_e20
libcrux_ml_kem_vector_portable_compress_compress_1(Eurydice_arr_e20 a) {
  for (size_t i = (size_t)0U;
       i < LIBCRUX_ML_KEM_VECTOR_TRAITS_FIELD_ELEMENTS_IN_VECTOR; i++) {
    size_t i0 = i;
...
libcrux_ml_kem::vector::portable::vector_type::PortableVector}
*/
Eurydice_arr_e20 libcrux_ml_kem_vector_portable_compress_1_b8(
    Eurydice_arr_e20 a) {
...
KRML_MUSTINLINE Eurydice_arr_e20
libcrux_ml_kem_vector_portable_compress_decompress_1(Eurydice_arr_e20 a) {
  Eurydice_arr_e20 z = libcrux_ml_kem_vector_portable_vector_type_zero();
  Eurydice_arr_e20 s = libcrux_ml_kem_vector_portable_arithmetic_sub(z, &a);
  Eurydice_arr_e20 res =
      libcrux_ml_kem_vector_portable_arithmetic_bitwise_and_with_constant(
          s, (int16_t)1665);
  return res;
}
...
libcrux_ml_kem::vector::portable::vector_type::PortableVector}
*/
Eurydice_arr_e20 libcrux_ml_kem_vector_portable_decompress_1_b8(
    Eurydice_arr_e20 a) {
...
KRML_MUSTINLINE void libcrux_ml_kem_vector_portable_ntt_ntt_step(
    Eurydice_arr_e20 *vec, int16_t zeta, size_t i, size_t j) {
  int16_t t =
      libcrux_ml_kem_vector_portable_arithmetic_montgomery_multiply_fe_by_fer(
          vec->data[j],
...
KRML_MUSTINLINE Eurydice_arr_e20
libcrux_ml_kem_vector_portable_ntt_ntt_layer_1_step(Eurydice_arr_e20 vec,
                                                    int16_t zeta0,
                                                    int16_t zeta1,
                                                    int16_t zeta2,
                                                    int16_t zeta3) {
...
libcrux_ml_kem::vector::portable::vector_type::PortableVector}
*/
Eurydice_arr_e20 libcrux_ml_kem_vector_portable_ntt_layer_1_step_b8(
    Eurydice_arr_e20 a, int16_t zeta0, int16_t zeta1, int16_t zeta2,
    int16_t zeta3) {
...
KRML_MUSTINLINE Eurydice_arr_e20
libcrux_ml_kem_vector_portable_ntt_ntt_layer_2_step(Eurydice_arr_e20 vec,
                                                    int16_t zeta0,
                                                    int16_t zeta1) {
  libcrux_ml_kem_vector_portable_ntt_ntt_step(&vec, zeta0, (size_t)0U,
                                              (size_t)4U);
...
libcrux_ml_kem::vector::portable::vector_type::PortableVector}
*/
Eurydice_arr_e20 libcrux_ml_kem_vector_portable_ntt_layer_2_step_b8(
    Eurydice_arr_e20 a, int16_t zeta0, int16_t zeta1) {
  return libcrux_ml_kem_vector_portable_ntt_ntt_layer_2_step(a, zeta0, zeta1);
}

KRML_MUSTINLINE Eurydice_arr_e20
libcrux_ml_kem_vector_portable_ntt_ntt_layer_3_step(Eurydice_arr_e20 vec,
                                                    int16_t zeta) {
...
libcrux_ml_kem::vector::portable::vector_type::PortableVector}
*/
Eurydice_arr_e20 libcrux_ml_kem_vector_portable_ntt_layer_3_step_b8(
    Eurydice_arr_e20 a, int16_t zeta) {
...
KRML_MUSTINLINE Eurydice_arr_e20
libcrux_ml_kem_vector_portable_ntt_inv_ntt_layer_1_step(Eurydice_arr_e20 vec,
                                                        int16_t zeta0,
                                                        int16_t zeta1,
                                                        int16_t zeta2,
                                                        int16_t zeta3) {
...
libcrux_ml_kem::vector::portable::vector_type::PortableVector}
*/
Eurydice_arr_e20 libcrux_ml_kem_vector_portable_inv_ntt_layer_1_step_b8(
    Eurydice_arr_e20 a, int16_t zeta0, int16_t zeta1, int16_t zeta2,
    int16_t zeta3) {
...
KRML_MUSTINLINE Eurydice_arr_e20
libcrux_ml_kem_vector_portable_ntt_inv_ntt_layer_2_step(Eurydice_arr_e20 vec,
                                                        int16_t zeta0,
                                                        int16_t zeta1) {
  libcrux_ml_kem_vector_portable_ntt_inv_ntt_step(&vec, zeta0, (size_t)0U,
                                                  (size_t)4U);
...
libcrux_ml_kem::vector::portable::vector_type::PortableVector}
*/
Eurydice_arr_e20 libcrux_ml_kem_vector_portable_inv_ntt_layer_2_step_b8(
    Eurydice_arr_e20 a, int16_t zeta0, int16_t zeta1) {
...
KRML_MUSTINLINE Eurydice_arr_e20
libcrux_ml_kem_vector_portable_ntt_inv_ntt_layer_3_step(Eurydice_arr_e20 vec,
                                                        int16_t zeta) {
...
libcrux_ml_kem::vector::portable::vector_type::PortableVector}
*/
Eurydice_arr_e20 libcrux_ml_kem_vector_portable_inv_ntt_layer_3_step_b8(
    Eurydice_arr_e20 a, int16_t zeta) {
...
KRML_MUSTINLINE void libcrux_ml_kem_vector_portable_ntt_ntt_multiply_binomials(
    Eurydice_arr_e20 *a, Eurydice_arr_e20 *b, int16_t zeta, size_t i,
    Eurydice_arr_e20 *out) {
...
KRML_MUSTINLINE Eurydice_arr_e20
libcrux_ml_kem_vector_portable_ntt_ntt_multiply(Eurydice_arr_e20 *lhs,
                                                Eurydice_arr_e20 *rhs,
  ...
  Eurydice_arr_e20 out = libcrux_ml_kem_vector_portable_vector_type_zero();
...
libcrux_ml_kem::vector::portable::vector_type::PortableVector}
*/
Eurydice_arr_e20 libcrux_ml_kem_vector_portable_ntt_multiply_b8(
    Eurydice_arr_e20 *lhs, Eurydice_arr_e20 *rhs, int16_t zeta0, int16_t zeta1,
    int16_t zeta2, int16_t zeta3) {
...
libcrux_ml_kem_vector_portable_serialize_serialize_1(Eurydice_arr_e20 v) {
  uint8_t result0 =
...
Eurydice_arr_8b libcrux_ml_kem_vector_portable_serialize_1(Eurydice_arr_e20 a) {
...
KRML_MUSTINLINE Eurydice_arr_e20
libcrux_ml_kem_vector_portable_serialize_deserialize_1(Eurydice_dst_ref_87 v) {
  int16_t result0 = libcrux_secrets_int_as_i16_59(
      (uint32_t)Eurydice_slice_index(v, (size_t)0U, uint8_t) & 1U);
  int16_t result1 = libcrux_secrets_int_as_i16_59(
      (uint32_t)Eurydice_slice_index(v, (size_t)0U, uint8_t) >> 1U & 1U);
  int16_t result2 = libcrux_secrets_int_as_i16_59(
      (uint32_t)Eurydice_slice_index(v, (size_t)0U, uint8_t) >> 2U & 1U);
  int16_t result3 = libcrux_secrets_int_as_i16_59(
      (uint32_t)Eurydice_slice_index(v, (size_t)0U, uint8_t) >> 3U & 1U);
  int16_t result4 = libcrux_secrets_int_as_i16_59(
      (uint32_t)Eurydice_slice_index(v, (size_t)0U, uint8_t) >> 4U & 1U);
  int16_t result5 = libcrux_secrets_int_as_i16_59(
      (uint32_t)Eurydice_slice_index(v, (size_t)0U, uint8_t) >> 5U & 1U);
  int16_t result6 = libcrux_secrets_int_as_i16_59(
      (uint32_t)Eurydice_slice_index(v, (size_t)0U, uint8_t) >> 6U & 1U);
  int16_t result7 = libcrux_secrets_int_as_i16_59(
      (uint32_t)Eurydice_slice_index(v, (size_t)0U, uint8_t) >> 7U & 1U);
  int16_t result8 = libcrux_secrets_int_as_i16_59(
      (uint32_t)Eurydice_slice_index(v, (size_t)1U, uint8_t) & 1U);
  int16_t result9 = libcrux_secrets_int_as_i16_59(
      (uint32_t)Eurydice_slice_index(v, (size_t)1U, uint8_t) >> 1U & 1U);
  int16_t result10 = libcrux_secrets_int_as_i16_59(
      (uint32_t)Eurydice_slice_index(v, (size_t)1U, uint8_t) >> 2U & 1U);
  int16_t result11 = libcrux_secrets_int_as_i16_59(
      (uint32_t)Eurydice_slice_index(v, (size_t)1U, uint8_t) >> 3U & 1U);
  int16_t result12 = libcrux_secrets_int_as_i16_59(
      (uint32_t)Eurydice_slice_index(v, (size_t)1U, uint8_t) >> 4U & 1U);
  int16_t result13 = libcrux_secrets_int_as_i16_59(
      (uint32_t)Eurydice_slice_index(v, (size_t)1U, uint8_t) >> 5U & 1U);
  int16_t result14 = libcrux_secrets_int_as_i16_59(
      (uint32_t)Eurydice_slice_index(v, (size_t)1U, uint8_t) >> 6U & 1U);
  int16_t result15 = libcrux_secrets_int_as_i16_59(
      (uint32_t)Eurydice_slice_index(v, (size_t)1U, uint8_t) >> 7U & 1U);
  return (KRML_CLITERAL(Eurydice_arr_e20){
...
Eurydice_arr_e20 libcrux_ml_kem_vector_portable_deserialize_1(
    Eurydice_dst_ref_87 a) {
...
libcrux_ml_kem::vector::portable::vector_type::PortableVector}
*/
Eurydice_arr_e20 libcrux_ml_kem_vector_portable_deserialize_1_b8(
    Eurydice_dst_ref_87 a) {
...
libcrux_ml_kem_vector_portable_serialize_serialize_4_int(
  ...
  uint8_t result0 = (uint32_t)libcrux_secrets_int_as_u8_f5(
                    ...
                    (uint32_t)libcrux_secrets_int_as_u8_f5(
                        Eurydice_slice_index(v, (size_t)0U, int16_t));
  uint8_t result1 = (uint32_t)libcrux_secrets_int_as_u8_f5(
                        Eurydice_slice_index(v, (size_t)3U, int16_t))
                        << 4U |
                    (uint32_t)libcrux_secrets_int_as_u8_f5(
                        Eurydice_slice_index(v, (size_t)2U, int16_t));
  uint8_t result2 = (uint32_t)libcrux_secrets_int_as_u8_f5(
                        Eurydice_slice_index(v, (size_t)5U, int16_t))
                        << 4U |
                    (uint32_t)libcrux_secrets_int_as_u8_f5(
                        Eurydice_slice_index(v, (size_t)4U, int16_t));
  uint8_t result3 = (uint32_t)libcrux_secrets_int_as_u8_f5(
                        Eurydice_slice_index(v, (size_t)7U, int16_t))
                        << 4U |
                    (uint32_t)libcrux_secrets_int_as_u8_f5(
                        Eurydice_slice_index(v, (size_t)6U, int16_t));
  return (KRML_CLITERAL(uint8_t_x4){
      .fst = result0, .snd = result1, .thd = result2, .f3 = result3});
}

KRML_MUSTINLINE Eurydice_arr_c4
libcrux_ml_kem_vector_portable_serialize_serialize_4(Eurydice_arr_e20 v) {
  uint8_t_x4 result0_3 =
      libcrux_ml_kem_vector_portable_serialize_serialize_4_int(
          Eurydice_array_to_subslice_85(
...
Eurydice_arr_c4 libcrux_ml_kem_vector_portable_serialize_4(Eurydice_arr_e20 a) {
...
libcrux_ml_kem_vector_portable_serialize_deserialize_4_int(
  ...
  int16_t v0 = libcrux_secrets_int_as_i16_59(
      (uint32_t)Eurydice_slice_index(bytes, (size_t)0U, uint8_t) & 15U);
  int16_t v1 = libcrux_secrets_int_as_i16_59(
      (uint32_t)Eurydice_slice_index(bytes, (size_t)0U, uint8_t) >> 4U & 15U);
  int16_t v2 = libcrux_secrets_int_as_i16_59(
      (uint32_t)Eurydice_slice_index(bytes, (size_t)1U, uint8_t) & 15U);
  int16_t v3 = libcrux_secrets_int_as_i16_59(
      (uint32_t)Eurydice_slice_index(bytes, (size_t)1U, uint8_t) >> 4U & 15U);
  int16_t v4 = libcrux_secrets_int_as_i16_59(
      (uint32_t)Eurydice_slice_index(bytes, (size_t)2U, uint8_t) & 15U);
  int16_t v5 = libcrux_secrets_int_as_i16_59(
      (uint32_t)Eurydice_slice_index(bytes, (size_t)2U, uint8_t) >> 4U & 15U);
  int16_t v6 = libcrux_secrets_int_as_i16_59(
      (uint32_t)Eurydice_slice_index(bytes, (size_t)3U, uint8_t) & 15U);
  int16_t v7 = libcrux_secrets_int_as_i16_59(
      (uint32_t)Eurydice_slice_index(bytes, (size_t)3U, uint8_t) >> 4U & 15U);
...
Eurydice_arr_e20 libcrux_ml_kem_vector_portable_deserialize_4(
    Eurydice_dst_ref_87 a) {
...
libcrux_ml_kem::vector::portable::vector_type::PortableVector}
*/
Eurydice_arr_e20 libcrux_ml_kem_vector_portable_deserialize_4_b8(
    Eurydice_dst_ref_87 a) {
...
libcrux_ml_kem_vector_portable_serialize_serialize_5_int(
  ...
  uint8_t r0 = libcrux_secrets_int_as_u8_f5(
      Eurydice_slice_index(v, (size_t)0U, int16_t) |
      Eurydice_slice_index(v, (size_t)1U, int16_t) << 5U);
  uint8_t r1 = libcrux_secrets_int_as_u8_f5(
      (Eurydice_slice_index(v, (size_t)1U, int16_t) >> 3U |
       Eurydice_slice_index(v, (size_t)2U, int16_t) << 2U) |
      Eurydice_slice_index(v, (size_t)3U, int16_t) << 7U);
  uint8_t r2 = libcrux_secrets_int_as_u8_f5(
      Eurydice_slice_index(v, (size_t)3U, int16_t) >> 1U |
      Eurydice_slice_index(v, (size_t)4U, int16_t) << 4U);
  uint8_t r3 = libcrux_secrets_int_as_u8_f5(
      (Eurydice_slice_index(v, (size_t)4U, int16_t) >> 4U |
       Eurydice_slice_index(v, (size_t)5U, int16_t) << 1U) |
      Eurydice_slice_index(v, (size_t)6U, int16_t) << 6U);
  uint8_t r4 = libcrux_secrets_int_as_u8_f5(
      Eurydice_slice_index(v, (size_t)6U, int16_t) >> 2U |
      Eurydice_slice_index(v, (size_t)7U, int16_t) << 3U);
  return (KRML_CLITERAL(uint8_t_x5){
      .fst = r0, .snd = r1, .thd = r2, .f3 = r3, .f4 = r4});
}

KRML_MUSTINLINE Eurydice_arr_77
libcrux_ml_kem_vector_portable_serialize_serialize_5(Eurydice_arr_e20 v) {
...
Eurydice_arr_77 libcrux_ml_kem_vector_portable_serialize_5(Eurydice_arr_e20 a) {
...
libcrux_ml_kem_vector_portable_serialize_deserialize_5_int(
    Eurydice_dst_ref_87 bytes) {
  int16_t v0 = libcrux_secrets_int_as_i16_59(
      (uint32_t)Eurydice_slice_index(bytes, (size_t)0U, uint8_t) & 31U);
  int16_t v1 = libcrux_secrets_int_as_i16_59(
      ((uint32_t)Eurydice_slice_index(bytes, (size_t)1U, uint8_t) & 3U) << 3U |
      (uint32_t)Eurydice_slice_index(bytes, (size_t)0U, uint8_t) >> 5U);
  int16_t v2 = libcrux_secrets_int_as_i16_59(
      (uint32_t)Eurydice_slice_index(bytes, (size_t)1U, uint8_t) >> 2U & 31U);
  int16_t v3 = libcrux_secrets_int_as_i16_59(
      ((uint32_t)Eurydice_slice_index(bytes, (size_t)2U, uint8_t) & 15U) << 1U |
      (uint32_t)Eurydice_slice_index(bytes, (size_t)1U, uint8_t) >> 7U);
  int16_t v4 = libcrux_secrets_int_as_i16_59(
      ((uint32_t)Eurydice_slice_index(bytes, (size_t)3U, uint8_t) & 1U) << 4U |
      (uint32_t)Eurydice_slice_index(bytes, (size_t)2U, uint8_t) >> 4U);
  int16_t v5 = libcrux_secrets_int_as_i16_59(
      (uint32_t)Eurydice_slice_index(bytes, (size_t)3U, uint8_t) >> 1U & 31U);
  int16_t v6 = libcrux_secrets_int_as_i16_59(
      ((uint32_t)Eurydice_slice_index(bytes, (size_t)4U, uint8_t) & 7U) << 2U |
      (uint32_t)Eurydice_slice_index(bytes, (size_t)3U, uint8_t) >> 6U);
  int16_t v7 = libcrux_secrets_int_as_i16_59(
      (uint32_t)Eurydice_slice_index(bytes, (size_t)4U, uint8_t) >> 3U);
  return (KRML_CLITERAL(int16_t_x8){.fst = v0,
                                    .snd = v1,
                                    .thd = v2,
                                    .f3 = v3,
...
Eurydice_arr_e20 libcrux_ml_kem_vector_portable_deserialize_5(
    Eurydice_dst_ref_87 a) {
...
libcrux_ml_kem::vector::portable::vector_type::PortableVector}
*/
Eurydice_arr_e20 libcrux_ml_kem_vector_portable_deserialize_5_b8(
    Eurydice_dst_ref_87 a) {
...
libcrux_ml_kem_vector_portable_serialize_serialize_10_int(
    Eurydice_dst_ref_9a v) {
  uint8_t r0 = libcrux_secrets_int_as_u8_f5(
      Eurydice_slice_index(v, (size_t)0U, int16_t) & (int16_t)255);
  uint8_t r1 =
      (uint32_t)libcrux_secrets_int_as_u8_f5(
          Eurydice_slice_index(v, (size_t)1U, int16_t) & (int16_t)63)
          << 2U |
      (uint32_t)libcrux_secrets_int_as_u8_f5(
          Eurydice_slice_index(v, (size_t)0U, int16_t) >> 8U & (int16_t)3);
  uint8_t r2 =
      (uint32_t)libcrux_secrets_int_as_u8_f5(
          Eurydice_slice_index(v, (size_t)2U, int16_t) & (int16_t)15)
          << 4U |
      (uint32_t)libcrux_secrets_int_as_u8_f5(
          Eurydice_slice_index(v, (size_t)1U, int16_t) >> 6U & (int16_t)15);
  uint8_t r3 =
      (uint32_t)libcrux_secrets_int_as_u8_f5(
          Eurydice_slice_index(v, (size_t)3U, int16_t) & (int16_t)3)
          << 6U |
      (uint32_t)libcrux_secrets_int_as_u8_f5(
          Eurydice_slice_index(v, (size_t)2U, int16_t) >> 4U & (int16_t)63);
  uint8_t r4 = libcrux_secrets_int_as_u8_f5(
      Eurydice_slice_index(v, (size_t)3U, int16_t) >> 2U & (int16_t)255);
  return (KRML_CLITERAL(uint8_t_x5){
      .fst = r0, .snd = r1, .thd = r2, .f3 = r3, .f4 = r4});
}

KRML_MUSTINLINE Eurydice_arr_dc
libcrux_ml_kem_vector_portable_serialize_serialize_10(Eurydice_arr_e20 v) {
...
Eurydice_arr_dc libcrux_ml_kem_vector_portable_serialize_10(
    Eurydice_arr_e20 a) {
...
libcrux_ml_kem_vector_portable_serialize_deserialize_10_int(
  ...
  int16_t r0 = libcrux_secrets_int_as_i16_f5(
      (libcrux_secrets_int_as_i16_59(
           Eurydice_slice_index(bytes, (size_t)1U, uint8_t)) &
       (int16_t)3)
          << 8U |
      (libcrux_secrets_int_as_i16_59(
  ...
  int16_t r1 = libcrux_secrets_int_as_i16_f5(
      (libcrux_secrets_int_as_i16_59(
           Eurydice_slice_index(bytes, (size_t)2U, uint8_t)) &
       (int16_t)15)
          << 6U |
      libcrux_secrets_int_as_i16_59(
          Eurydice_slice_index(bytes, (size_t)1U, uint8_t)) >>
  ...
  int16_t r3 = libcrux_secrets_int_as_i16_f5(
      libcrux_secrets_int_as_i16_59(
          Eurydice_slice_index(bytes, (size_t)4U, uint8_t))
          << 2U |
      libcrux_secrets_int_as_i16_59(
          Eurydice_slice_index(bytes, (size_t)3U, uint8_t)) >>
          6U);
  int16_t r4 = libcrux_secrets_int_as_i16_f5(
      (libcrux_secrets_int_as_i16_59(
           Eurydice_slice_index(bytes, (size_t)6U, uint8_t)) &
       (int16_t)3)
          << 8U |
      (libcrux_secrets_int_as_i16_59(
           Eurydice_slice_index(bytes, (size_t)5U, uint8_t)) &
       (int16_t)255));
  int16_t r5 = libcrux_secrets_int_as_i16_f5(
      (libcrux_secrets_int_as_i16_59(
           Eurydice_slice_index(bytes, (size_t)7U, uint8_t)) &
       (int16_t)15)
          << 6U |
      libcrux_secrets_int_as_i16_59(
          Eurydice_slice_index(bytes, (size_t)6U, uint8_t)) >>
  ...
  int16_t r6 = libcrux_secrets_int_as_i16_f5(
      (libcrux_secrets_int_as_i16_59(
           Eurydice_slice_index(bytes, (size_t)8U, uint8_t)) &
       (int16_t)63)
          << 4U |
      libcrux_secrets_int_as_i16_59(
          Eurydice_slice_index(bytes, (size_t)7U, uint8_t)) >>
  ...
  int16_t r7 = libcrux_secrets_int_as_i16_f5(
      libcrux_secrets_int_as_i16_59(
          Eurydice_slice_index(bytes, (size_t)9U, uint8_t))
          << 2U |
      libcrux_secrets_int_as_i16_59(
          Eurydice_slice_index(bytes, (size_t)8U, uint8_t)) >>
          6U);
...
Eurydice_arr_e20 libcrux_ml_kem_vector_portable_deserialize_10(
    Eurydice_dst_ref_87 a) {
...
libcrux_ml_kem::vector::portable::vector_type::PortableVector}
*/
Eurydice_arr_e20 libcrux_ml_kem_vector_portable_deserialize_10_b8(
    Eurydice_dst_ref_87 a) {
...
libcrux_ml_kem_vector_portable_serialize_serialize_11_int(
  ...
  uint8_t r0 = libcrux_secrets_int_as_u8_f5(
      Eurydice_slice_index(v, (size_t)0U, int16_t));
  uint8_t r1 = (uint32_t)libcrux_secrets_int_as_u8_f5(
                   Eurydice_slice_index(v, (size_t)1U, int16_t) & (int16_t)31)
                   << 3U |
               (uint32_t)libcrux_secrets_int_as_u8_f5(
                   Eurydice_slice_index(v, (size_t)0U, int16_t) >> 8U);
  uint8_t r2 = (uint32_t)libcrux_secrets_int_as_u8_f5(
                   Eurydice_slice_index(v, (size_t)2U, int16_t) & (int16_t)3)
                   << 6U |
               (uint32_t)libcrux_secrets_int_as_u8_f5(
                   Eurydice_slice_index(v, (size_t)1U, int16_t) >> 5U);
  uint8_t r3 = libcrux_secrets_int_as_u8_f5(
      Eurydice_slice_index(v, (size_t)2U, int16_t) >> 2U & (int16_t)255);
  uint8_t r4 = (uint32_t)libcrux_secrets_int_as_u8_f5(
                   Eurydice_slice_index(v, (size_t)3U, int16_t) & (int16_t)127)
                   << 1U |
               (uint32_t)libcrux_secrets_int_as_u8_f5(
                   Eurydice_slice_index(v, (size_t)2U, int16_t) >> 10U);
  uint8_t r5 = (uint32_t)libcrux_secrets_int_as_u8_f5(
                   Eurydice_slice_index(v, (size_t)4U, int16_t) & (int16_t)15)
                   << 4U |
               (uint32_t)libcrux_secrets_int_as_u8_f5(
                   Eurydice_slice_index(v, (size_t)3U, int16_t) >> 7U);
  uint8_t r6 = (uint32_t)libcrux_secrets_int_as_u8_f5(
                   Eurydice_slice_index(v, (size_t)5U, int16_t) & (int16_t)1)
                   << 7U |
               (uint32_t)libcrux_secrets_int_as_u8_f5(
                   Eurydice_slice_index(v, (size_t)4U, int16_t) >> 4U);
  uint8_t r7 = libcrux_secrets_int_as_u8_f5(
      Eurydice_slice_index(v, (size_t)5U, int16_t) >> 1U & (int16_t)255);
  uint8_t r8 = (uint32_t)libcrux_secrets_int_as_u8_f5(
                   Eurydice_slice_index(v, (size_t)6U, int16_t) & (int16_t)63)
                   << 2U |
               (uint32_t)libcrux_secrets_int_as_u8_f5(
                   Eurydice_slice_index(v, (size_t)5U, int16_t) >> 9U);
  uint8_t r9 = (uint32_t)libcrux_secrets_int_as_u8_f5(
                   Eurydice_slice_index(v, (size_t)7U, int16_t) & (int16_t)7)
                   << 5U |
               (uint32_t)libcrux_secrets_int_as_u8_f5(
                   Eurydice_slice_index(v, (size_t)6U, int16_t) >> 6U);
...
libcrux_ml_kem_vector_portable_serialize_serialize_11(Eurydice_arr_e20 v) {
...
Eurydice_arr_f3 libcrux_ml_kem_vector_portable_serialize_11(
    Eurydice_arr_e20 a) {
...
libcrux_ml_kem_vector_portable_serialize_deserialize_11_int(
  ...
  int16_t r7 = libcrux_secrets_int_as_i16_59(
                   Eurydice_slice_index(bytes, (size_t)10U, uint8_t))
                   << 3U |
               libcrux_secrets_int_as_i16_59(
                   Eurydice_slice_index(bytes, (size_t)9U, uint8_t)) >>
                   5U;
...
Eurydice_arr_e20 libcrux_ml_kem_vector_portable_deserialize_11(
    Eurydice_dst_ref_87 a) {
...
libcrux_ml_kem::vector::portable::vector_type::PortableVector}
*/
Eurydice_arr_e20 libcrux_ml_kem_vector_portable_deserialize_11_b8(
    Eurydice_dst_ref_87 a) {
...
libcrux_ml_kem_vector_portable_serialize_serialize_12_int(
  ...
  uint8_t r1 = libcrux_secrets_int_as_u8_f5(
      Eurydice_slice_index(v, (size_t)0U, int16_t) >> 8U |
      (Eurydice_slice_index(v, (size_t)1U, int16_t) & (int16_t)15) << 4U);
  uint8_t r2 = libcrux_secrets_int_as_u8_f5(
      Eurydice_slice_index(v, (size_t)1U, int16_t) >> 4U & (int16_t)255);
  return (KRML_CLITERAL(uint8_t_x3){.fst = r0, .snd = r1, .thd = r2});
}

KRML_MUSTINLINE Eurydice_arr_6d
libcrux_ml_kem_vector_portable_serialize_serialize_12(Eurydice_arr_e20 v) {
...
Eurydice_arr_6d libcrux_ml_kem_vector_portable_serialize_12(
    Eurydice_arr_e20 a) {
...
Eurydice_arr_e20 libcrux_ml_kem_vector_portable_deserialize_12(
    Eurydice_dst_ref_87 a) {
...
libcrux_ml_kem::vector::portable::vector_type::PortableVector}
*/
Eurydice_arr_e20 libcrux_ml_kem_vector_portable_deserialize_12_b8(
    Eurydice_dst_ref_87 a) {
...
KRML_MUSTINLINE size_t libcrux_ml_kem_vector_portable_sampling_rej_sample(
    Eurydice_dst_ref_87 a, Eurydice_dst_ref_9a result) {
  size_t sampled = (size_t)0U;
  for (size_t i = (size_t)0U; i < Eurydice_slice_len(a, uint8_t) / (size_t)3U;
       i++) {
    size_t i0 = i;
    int16_t b1 =
        (int16_t)Eurydice_slice_index(a, i0 * (size_t)3U + (size_t)0U, uint8_t);
    int16_t b2 =
        (int16_t)Eurydice_slice_index(a, i0 * (size_t)3U + (size_t)1U, uint8_t);
    int16_t b3 =
        (int16_t)Eurydice_slice_index(a, i0 * (size_t)3U + (size_t)2U, uint8_t);
    ...
    if (d1 < LIBCRUX_ML_KEM_VECTOR_TRAITS_FIELD_MODULUS) {
      if (sampled < (size_t)16U) {
        Eurydice_slice_index(result, sampled, int16_t) = d1;
        sampled++;
      }
    }
    if (d2 < LIBCRUX_ML_KEM_VECTOR_TRAITS_FIELD_MODULUS) {
      if (sampled < (size_t)16U) {
        Eurydice_slice_index(result, sampled, int16_t) = d2;
        sampled++;
      }
    }
  }
...
libcrux_ml_kem::vector::portable::vector_type::PortableVector}
*/
size_t libcrux_ml_kem_vector_portable_rej_sample_b8(Eurydice_dst_ref_87 a,
                                                    Eurydice_dst_ref_9a out) {
...
libcrux_ml_kem::vector::portable::vector_type::PortableVector}
*/
inline Eurydice_arr_e20 libcrux_ml_kem_vector_portable_vector_type_clone_9c(
...
static Eurydice_arr_b9 ZERO_d6_ea(void) {
  Eurydice_arr_b9 lit;
  Eurydice_arr_e20 repeat_expression[16U];
  KRML_MAYBE_FOR16(
      i, (size_t)0U, (size_t)16U, (size_t)1U,
      repeat_expression[i] = libcrux_ml_kem_vector_portable_ZERO_b8(););
  memcpy(lit.data, repeat_expression, (size_t)16U * sizeof(Eurydice_arr_e20));
  return lit;
}
...
static KRML_MUSTINLINE void deserialize_ring_elements_reduced_d0(
    Eurydice_dst_ref_87 public_key, Eurydice_arr_0d *deserialized_pk) {
  for (size_t i = (size_t)0U;
       i < Eurydice_slice_len(public_key, uint8_t) /
               LIBCRUX_ML_KEM_CONSTANTS_BYTES_PER_RING_ELEMENT;
       i++) {
    size_t i0 = i;
    Eurydice_dst_ref_87 ring_element = Eurydice_slice_subslice_7e(
        public_key,
        (KRML_CLITERAL(core_ops_range_Range_08){
...
static inline Eurydice_arr_180 shake128_init_absorb_final_ac(
  ...
  KRML_MAYBE_FOR4(i, (size_t)0U, (size_t)4U, (size_t)1U, size_t i0 = i;
                  libcrux_sha3_portable_incremental_shake128_absorb_final(
                      ...
                      Eurydice_array_to_slice_8d(&input->data[i0])););
...
static inline Eurydice_arr_ec shake128_squeeze_first_three_blocks_ac(
  ...
  KRML_MAYBE_FOR4(
      ...
      libcrux_sha3_portable_incremental_shake128_squeeze_first_three_blocks(
          &st->data[i0], Eurydice_array_to_slice_85(&out.data[i0])););
  return out;
}
      ...
      for (size_t i = (size_t)0U; i < (size_t)504U / (size_t)24U; i++) {
        ...
        if (sampled_coefficients->data[i1] <
          ...
          size_t sampled = libcrux_ml_kem_vector_portable_rej_sample_b8(
              Eurydice_array_to_subslice_369(
                  &randomness->data[i1],
                  (KRML_CLITERAL(core_ops_range_Range_08){
                      .start = r * (size_t)24U,
                      .end = r * (size_t)24U + (size_t)24U})),
              Eurydice_array_to_subslice_850(
                  &out->data[i1],
                  (KRML_CLITERAL(core_ops_range_Range_08){
...
static inline Eurydice_arr_a6 shake128_squeeze_next_block_ac(
  ...
  KRML_MAYBE_FOR4(
      ...
      libcrux_sha3_portable_incremental_shake128_squeeze_next_block(
          &st->data[i0], Eurydice_array_to_slice_7b(&out.data[i0])););
  return out;
}
  ...
  KRML_MAYBE_FOR4(
      ...
      for (size_t i = (size_t)0U; i < (size_t)168U / (size_t)24U; i++) {
        ...
        if (sampled_coefficients->data[i1] <
            LIBCRUX_ML_KEM_CONSTANTS_COEFFICIENTS_IN_RING_ELEMENT) {
          size_t sampled = libcrux_ml_kem_vector_portable_rej_sample_b8(
              Eurydice_array_to_subslice_362(
                  &randomness->data[i1],
                  (KRML_CLITERAL(core_ops_range_Range_08){
                      .start = r * (size_t)24U,
                      .end = r * (size_t)24U + (size_t)24U})),
...
*/
static KRML_MUSTINLINE Eurydice_arr_b9
from_i16_array_ea(Eurydice_dst_ref_9a a) {
  Eurydice_arr_b9 result = ZERO_ea();
  for (size_t i = (size_t)0U; i < VECTORS_IN_RING_ELEMENT; i++) {
    size_t i0 = i;
    Eurydice_arr_e20 uu____0 = libcrux_ml_kem_vector_portable_from_i16_array_b8(
        Eurydice_slice_subslice_76(
...
*/
static KRML_MUSTINLINE Eurydice_arr_b9
from_i16_array_d6_ea(Eurydice_dst_ref_9a a) {
...
static Eurydice_arr_b9 call_mut_e7_2b0(Eurydice_arr_a00 tupled_args) {
  ...
  return from_i16_array_d6_ea(Eurydice_array_to_subslice_850(
...
sample_from_xof_2b0(Eurydice_arr_78 *seeds) {
...
- N= 4
*/
static Eurydice_dst_ref_30 array_to_slice_cf0(Eurydice_arr_0d *a) {
  Eurydice_dst_ref_30 lit;
  lit.ptr = a->data;
  lit.meta = (size_t)4U;
  return lit;
}
...
static KRML_MUSTINLINE void sample_matrix_A_2b0(Eurydice_arr_95 *A_transpose,
  ...
  KRML_MAYBE_FOR4(
      ...
      for (size_t i = (size_t)0U;
           i <
           Eurydice_slice_len(array_to_slice_cf0(&sampled), Eurydice_arr_b9);
           i++) {
        size_t j = i;
...
- K= 4
*/
static inline Eurydice_arr_60 H_4a_ac(Eurydice_dst_ref_87 input) {
...
void libcrux_ml_kem_ind_cca_unpacked_unpack_public_key_30(
    ...
    libcrux_ml_kem_ind_cca_unpacked_MlKemPublicKeyUnpacked_af
        *unpacked_public_key) {
  Eurydice_dst_ref_87 uu____0 =
      Eurydice_array_to_subslice_to_6e0(public_key, (size_t)1536U);
  ...
  unpacked_public_key->ind_cpa_public_key.seed_for_A =
      libcrux_ml_kem_utils_into_padded_array_9e(
          Eurydice_array_to_subslice_from_8c3(public_key, (size_t)1536U));
  ...
  Eurydice_arr_60 uu____3 = H_4a_ac(Eurydice_array_to_slice_4e(
...
to_unsigned_field_modulus_ea(Eurydice_arr_e20 a) {
...
static KRML_MUSTINLINE void serialize_vector_d0(Eurydice_arr_0d *key,
  ...
  for (size_t i = (size_t)0U;
       i < Eurydice_slice_len(array_to_slice_cf0(key), Eurydice_arr_b9); i++) {
    size_t i0 = i;
    Eurydice_arr_b9 re = key->data[i0];
    Eurydice_dst_ref_87 uu____0 = Eurydice_slice_subslice_7e(
    ...
    Eurydice_slice_copy(uu____0, Eurydice_array_to_slice_fe(&lvalue), uint8_t);
  }
}
...
static KRML_MUSTINLINE void serialize_public_key_mut_ff(
    Eurydice_arr_0d *t_as_ntt, Eurydice_dst_ref_87 seed_for_a,
    Eurydice_arr_00 *serialized) {
  serialize_vector_d0(
      t_as_ntt,
      Eurydice_array_to_subslice_3616(
          serialized,
          (KRML_CLITERAL(core_ops_range_Range_08){
              .start = (size_t)0U,
              .end = libcrux_ml_kem_constants_ranked_bytes_per_ring_element(
                  (size_t)4U)})));
  Eurydice_slice_copy(
      Eurydice_array_to_subslice_from_8c3(
          serialized,
...
void libcrux_ml_kem_ind_cca_unpacked_serialized_mut_dd_ff(
  ...
  serialize_public_key_mut_ff(
      ...
      Eurydice_array_to_slice_6e(&self->ind_cpa_public_key.seed_for_A),
      serialized);
}
...
serialize_unpacked_secret_key_00(
  ...
  Eurydice_arr_00 public_key_serialized = serialize_public_key_ff(
      &public_key->t_as_ntt,
      Eurydice_array_to_slice_6e(&public_key->seed_for_A));
  Eurydice_arr_38 secret_key_serialized = {.data = {0U}};
  serialize_vector_d0(private_key,
                      Eurydice_array_to_slice_c9(&secret_key_serialized));
...
static KRML_MUSTINLINE void serialize_kem_secret_key_mut_60(
    Eurydice_dst_ref_87 private_key, Eurydice_dst_ref_87 public_key,
    Eurydice_dst_ref_87 implicit_rejection_value, Eurydice_arr_17 *serialized) {
  size_t pointer = (size_t)0U;
  Eurydice_arr_17 *uu____0 = serialized;
  size_t uu____1 = pointer;
  size_t uu____2 = pointer;
  Eurydice_slice_copy(
      Eurydice_array_to_subslice_3619(
          uu____0,
          (KRML_CLITERAL(core_ops_range_Range_08){
              .start = uu____1,
  ...
  Eurydice_dst_ref_87 uu____6 = Eurydice_array_to_subslice_3619(
      serialized,
      (KRML_CLITERAL(core_ops_range_Range_08){
          .start = pointer,
  ...
  Eurydice_slice_copy(uu____6, Eurydice_array_to_slice_6e(&lvalue), uint8_t);
...
void libcrux_ml_kem_ind_cca_unpacked_serialized_private_key_mut_11_2f(
  ...
  serialize_kem_secret_key_mut_60(
      Eurydice_array_to_slice_c9(&ind_cpa_private_key),
      Eurydice_array_to_slice_4e(&ind_cpa_public_key),
      Eurydice_array_to_slice_6e(&self->private_key.implicit_rejection_value),
      serialized);
}
...
*/
static KRML_MUSTINLINE Eurydice_arr_b9
deserialize_to_uncompressed_ring_element_ea(Eurydice_dst_ref_87 serialized) {
  Eurydice_arr_b9 re = ZERO_d6_ea();
  for (size_t i = (size_t)0U;
       i < Eurydice_slice_len(serialized, uint8_t) / (size_t)24U; i++) {
    size_t i0 = i;
...
static KRML_MUSTINLINE void deserialize_vector_d0(
    Eurydice_dst_ref_87 secret_key, Eurydice_arr_0d *secret_as_ntt) {
  KRML_MAYBE_FOR4(
      i, (size_t)0U, (size_t)4U, (size_t)1U, size_t i0 = i;
...
static KRML_MUSTINLINE void build_unpacked_public_key_mut_3f0(
    Eurydice_dst_ref_87 public_key,
    libcrux_ml_kem_ind_cpa_unpacked_IndCpaPublicKeyUnpacked_af
        *unpacked_public_key) {
  deserialize_ring_elements_reduced_d0(
      Eurydice_slice_subslice_to_c6(public_key, (size_t)1536U),
      &unpacked_public_key->t_as_ntt);
  Eurydice_dst_ref_87 seed =
      Eurydice_slice_subslice_from_6b(public_key, (size_t)1536U);
...
void libcrux_ml_kem_ind_cca_unpacked_keys_from_private_key_7d(
    ...
    libcrux_ml_kem_mlkem1024_portable_unpacked_MlKem1024KeyPairUnpacked
        *key_pair) {
  Eurydice_dst_ref_uint8_t_size_t_x4 uu____0 =
      libcrux_ml_kem_types_unpack_private_key_1f(
          Eurydice_array_to_slice_a6(private_key));
  Eurydice_dst_ref_87 ind_cpa_secret_key = uu____0.fst;
  Eurydice_dst_ref_87 ind_cpa_public_key = uu____0.snd;
  Eurydice_dst_ref_87 ind_cpa_public_key_hash = uu____0.thd;
  Eurydice_dst_ref_87 implicit_rejection_value = uu____0.f3;
  ...
  Eurydice_slice_copy(
      Eurydice_array_to_slice_6e(&key_pair->public_key.public_key_hash),
      ind_cpa_public_key_hash, uint8_t);
  Eurydice_slice_copy(Eurydice_array_to_slice_6e(
                          &key_pair->private_key.implicit_rejection_value),
                      implicit_rejection_value, uint8_t);
  Eurydice_slice_copy(
      Eurydice_array_to_slice_6e(
          &key_pair->public_key.ind_cpa_public_key.seed_for_A),
      Eurydice_slice_subslice_from_6b(ind_cpa_public_key, (size_t)1536U),
      uint8_t);
}
...
- K= 4
*/
static inline libcrux_sha3_Sha3_512Digest G_4a_ac(Eurydice_dst_ref_87 input) {
...
cpa_keygen_seed_39_03(Eurydice_dst_ref_87 key_generation_seed) {
  ...
  seed.data[LIBCRUX_ML_KEM_CONSTANTS_CPA_PKE_KEY_GENERATION_SEED_SIZE] =
      (uint8_t)(size_t)4U;
  return G_4a_ac(Eurydice_array_to_slice_61(&seed));
}
...
- LEN= 128
*/
static inline Eurydice_arr_cc0 PRFxN_44(Eurydice_arr_65 *input) {
  Eurydice_arr_cc0 out = {
      .data = {{.data = {0U}}, {.data = {0U}}, {.data = {0U}}, {.data = {0U}}}};
  KRML_MAYBE_FOR4(i, (size_t)0U, (size_t)4U, (size_t)1U, size_t i0 = i;
                  libcrux_sha3_portable_shake256(
                      Eurydice_array_to_slice_18(&out.data[i0]),
                      Eurydice_array_to_slice_61(&input->data[i0])););
  return out;
}
...
- LEN= 128
*/
static inline Eurydice_arr_cc0 PRFxN_4a_44(Eurydice_arr_65 *input) {
...
*/
static KRML_MUSTINLINE Eurydice_arr_b9
sample_from_binomial_distribution_2_ea(Eurydice_dst_ref_87 randomness) {
  Eurydice_arr_c1 sampled_i16s = {.data = {0U}};
  for (size_t i0 = (size_t)0U;
       i0 < Eurydice_slice_len(randomness, uint8_t) / (size_t)4U; i0++) {
    size_t chunk_number = i0;
    Eurydice_dst_ref_87 byte_chunk = Eurydice_slice_subslice_7e(
  ...
  return from_i16_array_d6_ea(Eurydice_array_to_slice_1a(&sampled_i16s));
}
...
*/
static KRML_MUSTINLINE Eurydice_arr_b9
sample_from_binomial_distribution_a0(Eurydice_dst_ref_87 randomness) {
...
static KRML_MUSTINLINE void ntt_at_layer_7_ea(Eurydice_arr_b9 *re) {
  ...
  for (size_t i = (size_t)0U; i < step; i++) {
    size_t j = i;
    Eurydice_arr_e20 t = libcrux_ml_kem_vector_portable_multiply_by_constant_b8(
        re->data[j + step], (int16_t)-1600);
    re->data[j + step] = libcrux_ml_kem_vector_portable_sub_b8(re->data[j], &t);
    Eurydice_arr_e20 uu____1 =
...
typedef struct libcrux_ml_kem_vector_portable_vector_type_PortableVector_x2_s {
  Eurydice_arr_e20 fst;
  Eurydice_arr_e20 snd;
...
static KRML_MUSTINLINE
    libcrux_ml_kem_vector_portable_vector_type_PortableVector_x2
    ntt_layer_int_vec_step_ea(Eurydice_arr_e20 a, Eurydice_arr_e20 b,
                              int16_t zeta_r) {
  Eurydice_arr_e20 t =
    ...
    for (size_t i = offset_vec; i < offset_vec + step_vec; i++) {
      ...
      libcrux_ml_kem_vector_portable_vector_type_PortableVector_x2 uu____0 =
          ntt_layer_int_vec_step_ea(re->data[j], re->data[j + step_vec],
                                    zeta(zeta_i[0U]));
      Eurydice_arr_e20 x = uu____0.fst;
      Eurydice_arr_e20 y = uu____0.snd;
      re->data[j] = x;
...
static KRML_MUSTINLINE uint8_t sample_vector_cbd_then_ntt_3b0(
  ...
  KRML_MAYBE_FOR4(
      ...
      Eurydice_arr_b9 uu____0 = sample_from_binomial_distribution_a0(
          Eurydice_array_to_slice_18(&prf_outputs.data[i0]));
...
- N= 4
*/
static Eurydice_dst_ref_44 array_to_slice_7c(Eurydice_arr_95 *a) {
  Eurydice_dst_ref_44 lit;
  lit.ptr = a->data;
  lit.meta = (size_t)4U;
  return lit;
}
...
static KRML_MUSTINLINE Eurydice_arr_b9 ntt_multiply_ea(Eurydice_arr_b9 *myself,
  ...
  for (size_t i = (size_t)0U; i < VECTORS_IN_RING_ELEMENT; i++) {
    size_t i0 = i;
    Eurydice_arr_e20 uu____0 = libcrux_ml_kem_vector_portable_ntt_multiply_b8(
...
- N= 16
*/
static Eurydice_dst_ref_f3 array_to_slice_24(Eurydice_arr_b9 *a) {
  Eurydice_dst_ref_f3 lit;
  lit.ptr = a->data;
  lit.meta = (size_t)16U;
  return lit;
}
...
static KRML_MUSTINLINE void add_to_ring_element_d0(Eurydice_arr_b9 *myself,
                                                   Eurydice_arr_b9 *rhs) {
  for (size_t i = (size_t)0U;
       i < Eurydice_slice_len(array_to_slice_24(myself), Eurydice_arr_e20);
       i++) {
    size_t i0 = i;
    Eurydice_arr_e20 uu____0 =
...
*/
static KRML_MUSTINLINE Eurydice_arr_e20
to_standard_domain_ea(Eurydice_arr_e20 vector) {
...
static KRML_MUSTINLINE void add_standard_error_reduce_ea(
  ...
  for (size_t i = (size_t)0U; i < VECTORS_IN_RING_ELEMENT; i++) {
    size_t j = i;
    Eurydice_arr_e20 coefficient_normal_form =
        to_standard_domain_ea(myself->data[j]);
    Eurydice_arr_e20 sum = libcrux_ml_kem_vector_portable_add_b8(
        coefficient_normal_form, &error->data[j]);
    Eurydice_arr_e20 red =
...
static KRML_MUSTINLINE void compute_As_plus_e_d0(
    Eurydice_arr_0d *t_as_ntt, Eurydice_arr_95 *matrix_A,
    Eurydice_arr_0d *s_as_ntt, Eurydice_arr_0d *error_as_ntt) {
  for (size_t i = (size_t)0U;
       i < Eurydice_slice_len(array_to_slice_7c(matrix_A), Eurydice_arr_0d);
       i++) {
    size_t i0 = i;
    ...
    for (size_t i1 = (size_t)0U;
         i1 < Eurydice_slice_len(array_to_slice_cf0(row), Eurydice_arr_b9);
         i1++) {
      size_t j = i1;
...
static KRML_MUSTINLINE void generate_keypair_unpacked_1c0(
    Eurydice_dst_ref_87 key_generation_seed, Eurydice_arr_0d *private_key,
    libcrux_ml_kem_ind_cpa_unpacked_IndCpaPublicKeyUnpacked_af *public_key) {
  libcrux_sha3_Sha3_512Digest hashed =
      cpa_keygen_seed_39_03(key_generation_seed);
  Eurydice_dst_ref_uint8_t_size_t_x2 uu____0 =
      Eurydice_slice_split_at(Eurydice_array_to_slice_d8(&hashed), (size_t)32U,
                              uint8_t, Eurydice_dst_ref_uint8_t_size_t_x2);
  Eurydice_dst_ref_87 seed_for_A = uu____0.fst;
  Eurydice_dst_ref_87 seed_for_secret_and_error = uu____0.snd;
...
static inline Eurydice_arr_b9 clone_c1_ea(Eurydice_arr_b9 *self) {
  return core_array__core__clone__Clone_for__Array_T__N___clone(
      (size_t)16U, self, Eurydice_arr_e20, Eurydice_arr_b9);
}
...
void libcrux_ml_kem_ind_cca_unpacked_generate_keypair_150(
  ...
  Eurydice_dst_ref_87 ind_cpa_keypair_randomness =
      Eurydice_array_to_subslice_367(
          ...
          (KRML_CLITERAL(core_ops_range_Range_08){
              ...
              .end =
                  LIBCRUX_ML_KEM_CONSTANTS_CPA_PKE_KEY_GENERATION_SEED_SIZE}));
  Eurydice_dst_ref_87 implicit_rejection_value =
      Eurydice_array_to_subslice_from_8c0(
          &randomness,
          LIBCRUX_ML_KEM_CONSTANTS_CPA_PKE_KEY_GENERATION_SEED_SIZE);
  ...
  Eurydice_arr_60 uu____0 = H_4a_ac(Eurydice_array_to_slice_4e(&pk_serialized));
...
- K= 4
*/
static libcrux_sha3_Sha3_512Digest encaps_prepare_03(
    Eurydice_dst_ref_87 randomness, Eurydice_dst_ref_87 pk_hash) {
  libcrux_sha3_Sha3_512Digest to_hash =
      libcrux_ml_kem_utils_into_padded_array_24(randomness);
  Eurydice_slice_copy(Eurydice_array_to_subslice_from_8c0(
                          &to_hash, LIBCRUX_ML_KEM_CONSTANTS_H_DIGEST_SIZE),
                      pk_hash, uint8_t);
  return G_4a_ac(Eurydice_array_to_slice_d8(&to_hash));
}
...
- LEN= 128
*/
static inline Eurydice_arr_d1 PRF_a6(Eurydice_dst_ref_87 input) {
  Eurydice_arr_d1 digest = {.data = {0U}};
  libcrux_sha3_portable_shake256(Eurydice_array_to_slice_18(&digest), input);
  return digest;
}
...
- LEN= 128
*/
static inline Eurydice_arr_d1 PRF_4a_440(Eurydice_dst_ref_87 input) {
  return PRF_a6(input);
}
...
static KRML_MUSTINLINE
    libcrux_ml_kem_vector_portable_vector_type_PortableVector_x2
    inv_ntt_layer_int_vec_step_reduce_ea(Eurydice_arr_e20 a, Eurydice_arr_e20 b,
                                         int16_t zeta_r) {
  Eurydice_arr_e20 a_minus_b = libcrux_ml_kem_vector_portable_sub_b8(b, &a);
...
*/
static KRML_MUSTINLINE Eurydice_arr_0d
compute_vector_u_d0(Eurydice_arr_95 *a_as_ntt, Eurydice_arr_0d *r_as_ntt,
                    Eurydice_arr_0d *error_1) {
  Eurydice_arr_0d arr_struct;
  KRML_MAYBE_FOR4(i, (size_t)0U, (size_t)4U, (size_t)1U,
                  /* original Rust expression is not an lvalue in C */
  ...
  for (size_t i0 = (size_t)0U;
       i0 < Eurydice_slice_len(array_to_slice_7c(a_as_ntt), Eurydice_arr_0d);
       i0++) {
    size_t i1 = i0;
    Eurydice_arr_0d *row = &a_as_ntt->data[i1];
    for (size_t i = (size_t)0U;
         i < Eurydice_slice_len(array_to_slice_cf0(row), Eurydice_arr_b9);
         i++) {
      size_t j = i;
...
- COEFFICIENT_BITS= 10
*/
static KRML_MUSTINLINE Eurydice_arr_e20 compress_ef(Eurydice_arr_e20 a) {
  for (size_t i = (size_t)0U;
       i < LIBCRUX_ML_KEM_VECTOR_TRAITS_FIELD_ELEMENTS_IN_VECTOR; i++) {
    size_t i0 = i;
...
- COEFFICIENT_BITS= 10
*/
static Eurydice_arr_e20 compress_b8_ef(Eurydice_arr_e20 a) {
...
- COEFFICIENT_BITS= 11
*/
static KRML_MUSTINLINE Eurydice_arr_e20 compress_c4(Eurydice_arr_e20 a) {
  for (size_t i = (size_t)0U;
       i < LIBCRUX_ML_KEM_VECTOR_TRAITS_FIELD_ELEMENTS_IN_VECTOR; i++) {
    size_t i0 = i;
    int16_t uu____0 = libcrux_secrets_int_as_i16_f5(
...
- COEFFICIENT_BITS= 11
*/
static Eurydice_arr_e20 compress_b8_c4(Eurydice_arr_e20 a) {
...
compress_then_serialize_11_54(Eurydice_arr_b9 *re) {
  ...
  for (size_t i = (size_t)0U; i < VECTORS_IN_RING_ELEMENT; i++) {
    size_t i0 = i;
    Eurydice_arr_e20 coefficient = compress_b8_c4(
    ...
    Eurydice_slice_copy(
        Eurydice_array_to_subslice_3618(
            &serialized, (KRML_CLITERAL(core_ops_range_Range_08){
                             .start = (size_t)22U * i0,
                             .end = (size_t)22U * i0 + (size_t)22U})),
        Eurydice_array_to_slice_ad(&bytes), uint8_t);
  }
  return serialized;
}
...
static KRML_MUSTINLINE void compress_then_serialize_u_2f(
    Eurydice_arr_0d input, Eurydice_dst_ref_87 out) {
  for (size_t i = (size_t)0U;
       i < Eurydice_slice_len(array_to_slice_cf0(&input), Eurydice_arr_b9);
       i++) {
    size_t i0 = i;
    ...
    Eurydice_slice_copy(uu____0, Eurydice_array_to_slice_89(&lvalue), uint8_t);
  }
}
...
- ETA2_RANDOMNESS_SIZE= 128
*/
static KRML_MUSTINLINE tuple_0c encrypt_c1_850(Eurydice_dst_ref_87 randomness,
                                               Eurydice_arr_95 *matrix,
                                               Eurydice_dst_ref_87 ciphertext) {
  Eurydice_arr_3e prf_input =
  ...
  Eurydice_arr_d1 prf_output =
      PRF_4a_440(Eurydice_array_to_slice_61(&prf_input));
  Eurydice_arr_b9 error_2 = sample_from_binomial_distribution_a0(
      Eurydice_array_to_slice_18(&prf_output));
...
deserialize_then_decompress_message_ea(Eurydice_arr_60 *serialized) {
  ...
  KRML_MAYBE_FOR16(
      ...
      Eurydice_arr_e20 coefficient_compressed =
          libcrux_ml_kem_vector_portable_deserialize_1_b8(
              Eurydice_array_to_subslice_366(
                  serialized, (KRML_CLITERAL(core_ops_range_Range_08){
                                  .start = (size_t)2U * i0,
                                  .end = (size_t)2U * i0 + (size_t)2U})));
      Eurydice_arr_e20 uu____0 = libcrux_ml_kem_vector_portable_decompress_1_b8(
...
static KRML_MUSTINLINE Eurydice_arr_b9 add_message_error_reduce_ea(
  ...
  for (size_t i = (size_t)0U; i < VECTORS_IN_RING_ELEMENT; i++) {
    ...
    Eurydice_arr_e20 sum1 = libcrux_ml_kem_vector_portable_add_b8(
        myself->data[i0], &message->data[i0]);
    Eurydice_arr_e20 sum2 =
...
- COEFFICIENT_BITS= 4
*/
static KRML_MUSTINLINE Eurydice_arr_e20 compress_d1(Eurydice_arr_e20 a) {
  for (size_t i = (size_t)0U;
       i < LIBCRUX_ML_KEM_VECTOR_TRAITS_FIELD_ELEMENTS_IN_VECTOR; i++) {
    size_t i0 = i;
    int16_t uu____0 = libcrux_secrets_int_as_i16_f5(
...
- COEFFICIENT_BITS= 4
*/
static Eurydice_arr_e20 compress_b8_d1(Eurydice_arr_e20 a) {
...
static KRML_MUSTINLINE void compress_then_serialize_4_ea(
    Eurydice_arr_b9 re, Eurydice_dst_ref_87 serialized) {
  for (size_t i = (size_t)0U; i < VECTORS_IN_RING_ELEMENT; i++) {
    size_t i0 = i;
    Eurydice_arr_e20 coefficient =
    ...
    Eurydice_slice_copy(
        Eurydice_slice_subslice_7e(serialized,
                                   (KRML_CLITERAL(core_ops_range_Range_08){
                                       .start = (size_t)8U * i0,
                                       .end = (size_t)8U * i0 + (size_t)8U})),
        Eurydice_array_to_slice_41(&bytes), uint8_t);
  }
}
...
- COEFFICIENT_BITS= 5
*/
static KRML_MUSTINLINE Eurydice_arr_e20 compress_f4(Eurydice_arr_e20 a) {
  for (size_t i = (size_t)0U;
       i < LIBCRUX_ML_KEM_VECTOR_TRAITS_FIELD_ELEMENTS_IN_VECTOR; i++) {
    size_t i0 = i;
    int16_t uu____0 = libcrux_secrets_int_as_i16_f5(
...
- COEFFICIENT_BITS= 5
*/
static Eurydice_arr_e20 compress_b8_f4(Eurydice_arr_e20 a) {
...
static KRML_MUSTINLINE void compress_then_serialize_5_ea(
  ...
  for (size_t i = (size_t)0U; i < VECTORS_IN_RING_ELEMENT; i++) {
    size_t i0 = i;
    Eurydice_arr_e20 coefficients = compress_b8_f4(
        libcrux_ml_kem_vector_portable_to_unsigned_representative_b8(
            re.data[i0]));
    ...
    Eurydice_slice_copy(
        ...
        Eurydice_array_to_slice_2f(&bytes), uint8_t);
  }
}
...
static KRML_MUSTINLINE void compress_then_serialize_ring_element_v_00(
    Eurydice_arr_b9 re, Eurydice_dst_ref_87 out) {
...
static KRML_MUSTINLINE Eurydice_arr_00 encrypt_unpacked_2a0(
    libcrux_ml_kem_ind_cpa_unpacked_IndCpaPublicKeyUnpacked_af *public_key,
    Eurydice_arr_60 *message, Eurydice_dst_ref_87 randomness) {
  ...
  encrypt_c2_00(
      ...
      Eurydice_array_to_subslice_from_8c3(&ciphertext, (size_t)1408U));
  return ciphertext;
}
...
tuple_2b libcrux_ml_kem_ind_cca_unpacked_encapsulate_0c0(
  ...
  libcrux_sha3_Sha3_512Digest hashed = encaps_prepare_03(
      Eurydice_array_to_slice_6e(randomness),
      Eurydice_array_to_slice_6e(&public_key->public_key_hash));
  Eurydice_dst_ref_uint8_t_size_t_x2 uu____0 =
      Eurydice_slice_split_at(Eurydice_array_to_slice_d8(&hashed),
                              LIBCRUX_ML_KEM_CONSTANTS_SHARED_SECRET_SIZE,
                              uint8_t, Eurydice_dst_ref_uint8_t_size_t_x2);
  Eurydice_dst_ref_87 shared_secret = uu____0.fst;
  Eurydice_dst_ref_87 pseudorandomness = uu____0.snd;
  ...
  Eurydice_slice_copy(Eurydice_array_to_slice_6e(&shared_secret_array),
...
*/
static KRML_MUSTINLINE Eurydice_arr_e20
decompress_ciphertext_coefficient_ef(Eurydice_arr_e20 a) {
  for (size_t i = (size_t)0U;
       i < LIBCRUX_ML_KEM_VECTOR_TRAITS_FIELD_ELEMENTS_IN_VECTOR; i++) {
    size_t i0 = i;
...
- COEFFICIENT_BITS= 10
*/
static Eurydice_arr_e20 decompress_ciphertext_coefficient_b8_ef(
    Eurydice_arr_e20 a) {
...
*/
static KRML_MUSTINLINE Eurydice_arr_b9
deserialize_then_decompress_10_ea(Eurydice_dst_ref_87 serialized) {
  Eurydice_arr_b9 re = ZERO_d6_ea();
  for (size_t i = (size_t)0U;
...
*/
static KRML_MUSTINLINE Eurydice_arr_e20
decompress_ciphertext_coefficient_c4(Eurydice_arr_e20 a) {
  for (size_t i = (size_t)0U;
       i < LIBCRUX_ML_KEM_VECTOR_TRAITS_FIELD_ELEMENTS_IN_VECTOR; i++) {
    size_t i0 = i;
    int32_t decompressed =
...
- COEFFICIENT_BITS= 11
*/
static Eurydice_arr_e20 decompress_ciphertext_coefficient_b8_c4(
    Eurydice_arr_e20 a) {
...
*/
static KRML_MUSTINLINE Eurydice_arr_b9
deserialize_then_decompress_11_ea(Eurydice_dst_ref_87 serialized) {
  Eurydice_arr_b9 re = ZERO_d6_ea();
  for (size_t i = (size_t)0U;
...
*/
static KRML_MUSTINLINE Eurydice_arr_b9
deserialize_then_decompress_ring_element_u_5e(Eurydice_dst_ref_87 serialized) {
...
deserialize_then_decompress_u_00(Eurydice_arr_00 *ciphertext) {
  ...
  for (size_t i = (size_t)0U;
       i < Eurydice_slice_len(Eurydice_array_to_slice_4e(ciphertext), uint8_t) /
               (LIBCRUX_ML_KEM_CONSTANTS_COEFFICIENTS_IN_RING_ELEMENT *
                (size_t)11U / (size_t)8U);
       i++) {
    size_t i0 = i;
    Eurydice_dst_ref_87 u_bytes = Eurydice_array_to_subslice_3616(
        ciphertext,
        (KRML_CLITERAL(core_ops_range_Range_08){
            .start =
...
*/
static KRML_MUSTINLINE Eurydice_arr_e20
decompress_ciphertext_coefficient_d1(Eurydice_arr_e20 a) {
  for (size_t i = (size_t)0U;
       i < LIBCRUX_ML_KEM_VECTOR_TRAITS_FIELD_ELEMENTS_IN_VECTOR; i++) {
    size_t i0 = i;
    int32_t decompressed =
...
- COEFFICIENT_BITS= 4
*/
static Eurydice_arr_e20 decompress_ciphertext_coefficient_b8_d1(
    Eurydice_arr_e20 a) {
...
*/
static KRML_MUSTINLINE Eurydice_arr_b9
deserialize_then_decompress_4_ea(Eurydice_dst_ref_87 serialized) {
  Eurydice_arr_b9 re = ZERO_d6_ea();
  for (size_t i = (size_t)0U;
...
*/
static KRML_MUSTINLINE Eurydice_arr_e20
decompress_ciphertext_coefficient_f4(Eurydice_arr_e20 a) {
  for (size_t i = (size_t)0U;
       i < LIBCRUX_ML_KEM_VECTOR_TRAITS_FIELD_ELEMENTS_IN_VECTOR; i++) {
    size_t i0 = i;
    int32_t decompressed =
...
- COEFFICIENT_BITS= 5
*/
static Eurydice_arr_e20 decompress_ciphertext_coefficient_b8_f4(
    Eurydice_arr_e20 a) {
...
*/
static KRML_MUSTINLINE Eurydice_arr_b9
deserialize_then_decompress_5_ea(Eurydice_dst_ref_87 serialized) {
  Eurydice_arr_b9 re = ZERO_d6_ea();
  for (size_t i = (size_t)0U;
...
*/
static KRML_MUSTINLINE Eurydice_arr_b9
deserialize_then_decompress_ring_element_v_ff(Eurydice_dst_ref_87 serialized) {
...
subtract_reduce_ea(Eurydice_arr_b9 *myself, Eurydice_arr_b9 b) {
  for (size_t i = (size_t)0U; i < VECTORS_IN_RING_ELEMENT; i++) {
    ...
    Eurydice_arr_e20 diff = libcrux_ml_kem_vector_portable_sub_b8(
      ...
      Eurydice_slice_copy(
          Eurydice_array_to_subslice_366(
              &serialized, (KRML_CLITERAL(core_ops_range_Range_08){
                               .start = (size_t)2U * i0,
                               .end = (size_t)2U * i0 + (size_t)2U})),
          Eurydice_array_to_slice_26(&bytes), uint8_t););
  return serialized;
}
...
- LEN= 32
*/
static inline Eurydice_arr_60 PRF_9e(Eurydice_dst_ref_87 input) {
  Eurydice_arr_60 digest = {.data = {0U}};
  libcrux_sha3_portable_shake256(Eurydice_array_to_slice_6e(&digest), input);
  return digest;
}
...
- LEN= 32
*/
static inline Eurydice_arr_60 PRF_4a_44(Eurydice_dst_ref_87 input) {
  return PRF_9e(input);
}
...
Eurydice_arr_60 libcrux_ml_kem_ind_cca_unpacked_decapsulate_510(
  ...
  libcrux_sha3_Sha3_512Digest to_hash0 =
      libcrux_ml_kem_utils_into_padded_array_24(
          Eurydice_array_to_slice_6e(&decrypted));
  Eurydice_dst_ref_87 uu____0 = Eurydice_array_to_subslice_from_8c0(
  ...
  Eurydice_slice_copy(
      ...
      uint8_t);
  libcrux_sha3_Sha3_512Digest hashed =
      G_4a_ac(Eurydice_array_to_slice_d8(&to_hash0));
  Eurydice_dst_ref_uint8_t_size_t_x2 uu____1 =
      Eurydice_slice_split_at(Eurydice_array_to_slice_d8(&hashed),
                              LIBCRUX_ML_KEM_CONSTANTS_SHARED_SECRET_SIZE,
                              uint8_t, Eurydice_dst_ref_uint8_t_size_t_x2);
  Eurydice_dst_ref_87 shared_secret = uu____1.fst;
  Eurydice_dst_ref_87 pseudorandomness = uu____1.snd;
  Eurydice_arr_e7 to_hash =
      libcrux_ml_kem_utils_into_padded_array_7f(Eurydice_array_to_slice_6e(
          &key_pair->private_key.implicit_rejection_value));
  Eurydice_dst_ref_87 uu____2 = Eurydice_array_to_subslice_from_8c4(
  ...
  Eurydice_arr_60 implicit_rejection_shared_secret =
      PRF_4a_44(Eurydice_array_to_slice_8e(&to_hash));
  ...
  Eurydice_dst_ref_87 uu____3 = libcrux_ml_kem_types_as_ref_d3_af(ciphertext);
  uint8_t selector =
      libcrux_ml_kem_constant_time_ops_compare_ciphertexts_in_constant_time(
          uu____3, Eurydice_array_to_slice_4e(&expected_ciphertext));
  return libcrux_ml_kem_constant_time_ops_select_shared_secret_in_constant_time(
      shared_secret,
      Eurydice_array_to_slice_6e(&implicit_rejection_shared_secret), selector);
}
...
*/
static KRML_MUSTINLINE Eurydice_arr_0d
deserialize_ring_elements_reduced_out_d0(Eurydice_dst_ref_87 public_key) {
  Eurydice_arr_0d arr_struct;
  KRML_MAYBE_FOR4(i, (size_t)0U, (size_t)4U, (size_t)1U,
                  /* original Rust expression is not an lvalue in C */
                  void *lvalue = (void *)0U;
...
bool libcrux_ml_kem_ind_cca_validate_public_key_ff(
  ...
  Eurydice_arr_0d deserialized_pk = deserialize_ring_elements_reduced_out_d0(
      Eurydice_array_to_subslice_to_6e0(
          public_key,
          libcrux_ml_kem_constants_ranked_bytes_per_ring_element((size_t)4U)));
  Eurydice_arr_00 public_key_serialized = serialize_public_key_ff(
      &deserialized_pk,
...
bool libcrux_ml_kem_ind_cca_validate_private_key_only_60(
    Eurydice_arr_17 *private_key) {
  Eurydice_arr_60 t = H_4a_ac(Eurydice_array_to_subslice_3619(
      private_key, (KRML_CLITERAL(core_ops_range_Range_08){
                       .start = (size_t)384U * (size_t)4U,
                       .end = (size_t)768U * (size_t)4U + (size_t)32U})));
  Eurydice_dst_ref_87 expected = Eurydice_array_to_subslice_3619(
      private_key, (KRML_CLITERAL(core_ops_range_Range_08){
...
generate_keypair_ea0(Eurydice_dst_ref_87 key_generation_seed) {
...
libcrux_ml_kem_ind_cca_generate_keypair_150(
  ...
  Eurydice_arr_17 secret_key_serialized = serialize_kem_secret_key_60(
      Eurydice_array_to_slice_c9(&ind_cpa_private_key),
      Eurydice_array_to_slice_4e(&public_key), implicit_rejection_value);
  Eurydice_arr_17 private_key =
...
*/
static KRML_MUSTINLINE Eurydice_arr_60
entropy_preprocess_39_03(Eurydice_dst_ref_87 randomness) {
  Eurydice_arr_60 out = {.data = {0U}};
  Eurydice_slice_copy(Eurydice_array_to_slice_6e(&out), randomness, uint8_t);
  return out;
}
...
static KRML_MUSTINLINE
    libcrux_ml_kem_ind_cpa_unpacked_IndCpaPublicKeyUnpacked_af
    build_unpacked_public_key_3f0(Eurydice_dst_ref_87 public_key) {
  libcrux_ml_kem_ind_cpa_unpacked_IndCpaPublicKeyUnpacked_af
...
encrypt_2a0(Eurydice_dst_ref_87 public_key, Eurydice_arr_60 *message,
            Eurydice_dst_ref_87 randomness) {
  libcrux_ml_kem_ind_cpa_unpacked_IndCpaPublicKeyUnpacked_af
...
*/
static KRML_MUSTINLINE Eurydice_arr_60
kdf_39_60(Eurydice_dst_ref_87 shared_secret) {
  Eurydice_arr_60 out = {.data = {0U}};
  Eurydice_slice_copy(Eurydice_array_to_slice_6e(&out), shared_secret, uint8_t);
  return out;
}
...
tuple_2b libcrux_ml_kem_ind_cca_encapsulate_ca0(Eurydice_arr_00 *public_key,
  ...
  Eurydice_arr_60 randomness0 =
      entropy_preprocess_39_03(Eurydice_array_to_slice_6e(randomness));
  libcrux_sha3_Sha3_512Digest to_hash =
      libcrux_ml_kem_utils_into_padded_array_24(
          Eurydice_array_to_slice_6e(&randomness0));
  Eurydice_dst_ref_87 uu____0 = Eurydice_array_to_subslice_from_8c0(
      &to_hash, LIBCRUX_ML_KEM_CONSTANTS_H_DIGEST_SIZE);
  /* original Rust expression is not an lvalue in C */
  Eurydice_arr_60 lvalue = H_4a_ac(Eurydice_array_to_slice_4e(
      libcrux_ml_kem_types_as_slice_e6_af(public_key)));
  Eurydice_slice_copy(uu____0, Eurydice_array_to_slice_6e(&lvalue), uint8_t);
  libcrux_sha3_Sha3_512Digest hashed =
      G_4a_ac(Eurydice_array_to_slice_d8(&to_hash));
  Eurydice_dst_ref_uint8_t_size_t_x2 uu____1 =
      Eurydice_slice_split_at(Eurydice_array_to_slice_d8(&hashed),
                              LIBCRUX_ML_KEM_CONSTANTS_SHARED_SECRET_SIZE,
                              uint8_t, Eurydice_dst_ref_uint8_t_size_t_x2);
  ...
  Eurydice_dst_ref_87 pseudorandomness = uu____1.snd;
  Eurydice_arr_00 ciphertext =
      encrypt_2a0(Eurydice_array_to_slice_4e(
                      libcrux_ml_kem_types_as_slice_e6_af(public_key)),
...
*/
static KRML_MUSTINLINE Eurydice_arr_60
decrypt_7d(Eurydice_dst_ref_87 secret_key, Eurydice_arr_00 *ciphertext) {
  Eurydice_arr_0d arr_struct;
  KRML_MAYBE_FOR4(i, (size_t)0U, (size_t)4U, (size_t)1U,
                  /* original Rust expression is not an lvalue in C */
                  void *lvalue = (void *)0U;
...
Eurydice_arr_60 libcrux_ml_kem_ind_cca_decapsulate_620(
  ...
  Eurydice_dst_ref_uint8_t_size_t_x2 uu____1 =
      Eurydice_slice_split_at(Eurydice_array_to_slice_d8(&hashed),
                              LIBCRUX_ML_KEM_CONSTANTS_SHARED_SECRET_SIZE,
                              uint8_t, Eurydice_dst_ref_uint8_t_size_t_x2);
  Eurydice_dst_ref_87 shared_secret0 = uu____1.fst;
  Eurydice_dst_ref_87 pseudorandomness = uu____1.snd;
  Eurydice_arr_e7 to_hash =
  ...
  Eurydice_dst_ref_87 uu____3 =
      Eurydice_array_to_slice_6e(&implicit_rejection_shared_secret);
  ...
  Eurydice_dst_ref_87 uu____4 = libcrux_ml_kem_types_as_ref_d3_af(ciphertext);
  return libcrux_ml_kem_constant_time_ops_compare_ciphertexts_select_shared_secret_in_constant_time(
      uu____4, Eurydice_array_to_slice_4e(&expected_ciphertext),
      Eurydice_array_to_slice_6e(&shared_secret),
      Eurydice_array_to_slice_6e(&implicit_rejection_shared_secret0));
}
...
static KRML_MUSTINLINE void deserialize_ring_elements_reduced_1b(
    Eurydice_dst_ref_87 public_key, Eurydice_arr_c41 *deserialized_pk) {
  for (size_t i = (size_t)0U;
       i < Eurydice_slice_len(public_key, uint8_t) /
               LIBCRUX_ML_KEM_CONSTANTS_BYTES_PER_RING_ELEMENT;
       i++) {
...
- N= 3
*/
static Eurydice_dst_ref_30 array_to_slice_cf(Eurydice_arr_c41 *a) {
  Eurydice_dst_ref_30 lit;
  lit.ptr = a->data;
  lit.meta = (size_t)3U;
  return lit;
...
static KRML_MUSTINLINE void sample_matrix_A_2b(Eurydice_arr_aa *A_transpose,
  ...
  KRML_MAYBE_FOR3(
      ...
      for (size_t i = (size_t)0U;
           i < Eurydice_slice_len(array_to_slice_cf(&sampled), Eurydice_arr_b9);
           i++) {
        size_t j = i;
        Eurydice_arr_b9 sample = sampled.data[j];
        if (transpose) {
...
- K= 3
*/
static inline Eurydice_arr_60 H_4a_e0(Eurydice_dst_ref_87 input) {
  return libcrux_ml_kem_hash_functions_portable_H(input);
}
...
void libcrux_ml_kem_ind_cca_unpacked_unpack_public_key_0a(
    ...
    libcrux_ml_kem_ind_cca_unpacked_MlKemPublicKeyUnpacked_a0
        *unpacked_public_key) {
  Eurydice_dst_ref_87 uu____0 =
      Eurydice_array_to_subslice_to_6e(public_key, (size_t)1152U);
  deserialize_ring_elements_reduced_1b(
      uu____0, &unpacked_public_key->ind_cpa_public_key.t_as_ntt);
  unpacked_public_key->ind_cpa_public_key.seed_for_A =
      libcrux_ml_kem_utils_into_padded_array_9e(
          Eurydice_array_to_subslice_from_8c2(public_key, (size_t)1152U));
  Eurydice_arr_aa *uu____2 = &unpacked_public_key->ind_cpa_public_key.A;
  /* original Rust expression is not an lvalue in C */
  Eurydice_arr_48 lvalue = libcrux_ml_kem_utils_into_padded_array_b6(
      Eurydice_array_to_subslice_from_8c2(public_key, (size_t)1152U));
  sample_matrix_A_2b(uu____2, &lvalue, false);
  Eurydice_arr_60 uu____3 = H_4a_e0(Eurydice_array_to_slice_45(
...
static KRML_MUSTINLINE void serialize_vector_1b(Eurydice_arr_c41 *key,
                                                Eurydice_dst_ref_87 out) {
  for (size_t i = (size_t)0U;
       i < Eurydice_slice_len(array_to_slice_cf(key), Eurydice_arr_b9); i++) {
    size_t i0 = i;
    Eurydice_arr_b9 re = key->data[i0];
    Eurydice_dst_ref_87 uu____0 = Eurydice_slice_subslice_7e(
        out, (KRML_CLITERAL(core_ops_range_Range_08){
...
static KRML_MUSTINLINE void serialize_public_key_mut_89(
    Eurydice_arr_c41 *t_as_ntt, Eurydice_dst_ref_87 seed_for_a,
    Eurydice_arr_74 *serialized) {
  serialize_vector_1b(
      t_as_ntt,
      Eurydice_array_to_subslice_3614(
          serialized,
          (KRML_CLITERAL(core_ops_range_Range_08){
              .start = (size_t)0U,
              .end = libcrux_ml_kem_constants_ranked_bytes_per_ring_element(
                  (size_t)3U)})));
  Eurydice_slice_copy(
      Eurydice_array_to_subslice_from_8c2(
          serialized,
...
serialize_unpacked_secret_key_6c(
  ...
  serialize_vector_1b(private_key,
                      Eurydice_array_to_slice_06(&secret_key_serialized));
...
static KRML_MUSTINLINE void serialize_kem_secret_key_mut_d6(
    Eurydice_dst_ref_87 private_key, Eurydice_dst_ref_87 public_key,
    Eurydice_dst_ref_87 implicit_rejection_value, Eurydice_arr_ea *serialized) {
  size_t pointer = (size_t)0U;
  Eurydice_arr_ea *uu____0 = serialized;
  size_t uu____1 = pointer;
  size_t uu____2 = pointer;
  Eurydice_slice_copy(
      Eurydice_array_to_subslice_3615(
          uu____0,
          (KRML_CLITERAL(core_ops_range_Range_08){
              .start = uu____1,
              .end = uu____2 + Eurydice_slice_len(private_key, uint8_t)})),
  ...
  Eurydice_slice_copy(
      ...
      public_key, uint8_t);
  pointer = pointer + Eurydice_slice_len(public_key, uint8_t);
  Eurydice_dst_ref_87 uu____6 = Eurydice_array_to_subslice_3615(
      serialized,
      (KRML_CLITERAL(core_ops_range_Range_08){
          .start = pointer,
          .end = pointer + LIBCRUX_ML_KEM_CONSTANTS_H_DIGEST_SIZE}));
...
void libcrux_ml_kem_ind_cca_unpacked_serialized_private_key_mut_11_43(
  ...
  serialize_kem_secret_key_mut_d6(
      Eurydice_array_to_slice_06(&ind_cpa_private_key),
      Eurydice_array_to_slice_45(&ind_cpa_public_key),
      Eurydice_array_to_slice_6e(&self->private_key.implicit_rejection_value),
      serialized);
}
...
static KRML_MUSTINLINE void deserialize_vector_1b(
    Eurydice_dst_ref_87 secret_key, Eurydice_arr_c41 *secret_as_ntt) {
  KRML_MAYBE_FOR3(
      i, (size_t)0U, (size_t)3U, (size_t)1U, size_t i0 = i;
      Eurydice_arr_b9 uu____0 = deserialize_to_uncompressed_ring_element_ea(
          Eurydice_slice_subslice_7e(
...
static KRML_MUSTINLINE void build_unpacked_public_key_mut_3f(
    ...
    libcrux_ml_kem_ind_cpa_unpacked_IndCpaPublicKeyUnpacked_a0
        *unpacked_public_key) {
  deserialize_ring_elements_reduced_1b(
      Eurydice_slice_subslice_to_c6(public_key, (size_t)1152U),
      &unpacked_public_key->t_as_ntt);
  Eurydice_dst_ref_87 seed =
      Eurydice_slice_subslice_from_6b(public_key, (size_t)1152U);
...
void libcrux_ml_kem_ind_cca_unpacked_keys_from_private_key_42(
  ...
  Eurydice_dst_ref_uint8_t_size_t_x4 uu____0 =
      libcrux_ml_kem_types_unpack_private_key_b4(
          Eurydice_array_to_slice_ec(private_key));
  Eurydice_dst_ref_87 ind_cpa_secret_key = uu____0.fst;
  Eurydice_dst_ref_87 ind_cpa_public_key = uu____0.snd;
  Eurydice_dst_ref_87 ind_cpa_public_key_hash = uu____0.thd;
  Eurydice_dst_ref_87 implicit_rejection_value = uu____0.f3;
  ...
  Eurydice_slice_copy(
      Eurydice_array_to_slice_6e(
          &key_pair->public_key.ind_cpa_public_key.seed_for_A),
      Eurydice_slice_subslice_from_6b(ind_cpa_public_key, (size_t)1152U),
      uint8_t);
}
...
- K= 3
*/
static inline libcrux_sha3_Sha3_512Digest G_4a_e0(Eurydice_dst_ref_87 input) {
  return libcrux_ml_kem_hash_functions_portable_G(input);
}
...
*/
static KRML_MUSTINLINE libcrux_sha3_Sha3_512Digest
cpa_keygen_seed_39_9c(Eurydice_dst_ref_87 key_generation_seed) {
  Eurydice_arr_3e seed = {.data = {0U}};
  Eurydice_slice_copy(
      Eurydice_array_to_subslice_3611(
          &seed,
  ...
  seed.data[LIBCRUX_ML_KEM_CONSTANTS_CPA_PKE_KEY_GENERATION_SEED_SIZE] =
      (uint8_t)(size_t)3U;
  return G_4a_e0(Eurydice_array_to_slice_61(&seed));
}
...
- LEN= 128
*/
static inline Eurydice_arr_db PRFxN_41(Eurydice_arr_46 *input) {
  Eurydice_arr_db out = {
      .data = {{.data = {0U}}, {.data = {0U}}, {.data = {0U}}}};
  KRML_MAYBE_FOR3(i, (size_t)0U, (size_t)3U, (size_t)1U, size_t i0 = i;
                  libcrux_sha3_portable_shake256(
...
- LEN= 128
*/
static inline Eurydice_arr_db PRFxN_4a_41(Eurydice_arr_46 *input) {
...
- N= 3
*/
static Eurydice_dst_ref_94 array_to_slice_b5(Eurydice_arr_aa *a) {
  Eurydice_dst_ref_94 lit;
  lit.ptr = a->data;
  lit.meta = (size_t)3U;
  return lit;
}
...
static KRML_MUSTINLINE void compute_As_plus_e_1b(
  ...
  for (size_t i = (size_t)0U;
       i < Eurydice_slice_len(array_to_slice_b5(matrix_A), Eurydice_arr_c41);
       i++) {
    size_t i0 = i;
    ...
    t_as_ntt->data[i0] = uu____0;
    for (size_t i1 = (size_t)0U;
         i1 < Eurydice_slice_len(array_to_slice_cf(row), Eurydice_arr_b9);
         i1++) {
      size_t j = i1;
      Eurydice_arr_b9 *matrix_element = &row->data[j];
      Eurydice_arr_b9 product =
...
static KRML_MUSTINLINE void generate_keypair_unpacked_1c(
    Eurydice_dst_ref_87 key_generation_seed, Eurydice_arr_c41 *private_key,
    libcrux_ml_kem_ind_cpa_unpacked_IndCpaPublicKeyUnpacked_a0 *public_key) {
  libcrux_sha3_Sha3_512Digest hashed =
...
void libcrux_ml_kem_ind_cca_unpacked_generate_keypair_15(
  ...
  Eurydice_arr_74 pk_serialized = serialize_public_key_89(
      ...
      Eurydice_array_to_slice_6e(
          &out->public_key.ind_cpa_public_key.seed_for_A));
  Eurydice_arr_60 uu____0 = H_4a_e0(Eurydice_array_to_slice_45(&pk_serialized));
  out->public_key.public_key_hash = uu____0;
  Eurydice_arr_60 arr;
  memcpy(arr.data, implicit_rejection_value.ptr, (size_t)32U * sizeof(uint8_t));
  Eurydice_arr_60 uu____1 = core_result_unwrap_26_07((KRML_CLITERAL(
...
- K= 3
*/
static libcrux_sha3_Sha3_512Digest encaps_prepare_9c(
    Eurydice_dst_ref_87 randomness, Eurydice_dst_ref_87 pk_hash) {
  libcrux_sha3_Sha3_512Digest to_hash =
      libcrux_ml_kem_utils_into_padded_array_24(randomness);
  Eurydice_slice_copy(Eurydice_array_to_subslice_from_8c0(
                          &to_hash, LIBCRUX_ML_KEM_CONSTANTS_H_DIGEST_SIZE),
                      pk_hash, uint8_t);
  return G_4a_e0(Eurydice_array_to_slice_d8(&to_hash));
}
...
- LEN= 128
*/
static inline Eurydice_arr_d1 PRF_4a_410(Eurydice_dst_ref_87 input) {
  return PRF_a6(input);
}
...
compute_vector_u_1b(Eurydice_arr_aa *a_as_ntt, Eurydice_arr_c41 *r_as_ntt,
  ...
  for (size_t i0 = (size_t)0U;
       i0 < Eurydice_slice_len(array_to_slice_b5(a_as_ntt), Eurydice_arr_c41);
       i0++) {
    size_t i1 = i0;
    Eurydice_arr_c41 *row = &a_as_ntt->data[i1];
    for (size_t i = (size_t)0U;
         i < Eurydice_slice_len(array_to_slice_cf(row), Eurydice_arr_b9); i++) {
      size_t j = i;
      Eurydice_arr_b9 *a_element = &row->data[j];
      Eurydice_arr_b9 product =
          ntt_multiply_d6_ea(a_element, &r_as_ntt->data[j]);
...
compress_then_serialize_10_ff(Eurydice_arr_b9 *re) {
  ...
  for (size_t i = (size_t)0U; i < VECTORS_IN_RING_ELEMENT; i++) {
    ...
    Eurydice_slice_copy(
        Eurydice_array_to_subslice_3612(
            &serialized, (KRML_CLITERAL(core_ops_range_Range_08){
                             .start = (size_t)20U * i0,
                             .end = (size_t)20U * i0 + (size_t)20U})),
        Eurydice_array_to_slice_c2(&bytes), uint8_t);
  }
  return serialized;
}
...
static KRML_MUSTINLINE void compress_then_serialize_u_43(
    Eurydice_arr_c41 input, Eurydice_dst_ref_87 out) {
  for (size_t i = (size_t)0U;
       i < Eurydice_slice_len(array_to_slice_cf(&input), Eurydice_arr_b9);
       i++) {
    size_t i0 = i;
    Eurydice_arr_b9 re = input.data[i0];
    Eurydice_dst_ref_87 uu____0 = Eurydice_slice_subslice_7e(
    ...
    Eurydice_slice_copy(uu____0, Eurydice_array_to_slice_d3(&lvalue), uint8_t);
  }
}
...
- ETA2_RANDOMNESS_SIZE= 128
*/
static KRML_MUSTINLINE tuple_88 encrypt_c1_85(Eurydice_dst_ref_87 randomness,
  ...
  prf_input.data[32U] = domain_separator;
  Eurydice_arr_d1 prf_output =
      PRF_4a_410(Eurydice_array_to_slice_61(&prf_input));
  Eurydice_arr_b9 error_2 = sample_from_binomial_distribution_a0(
      Eurydice_array_to_slice_18(&prf_output));
...
static KRML_MUSTINLINE Eurydice_arr_2c encrypt_unpacked_2a(
  ...
  tuple_88 uu____0 = encrypt_c1_85(
      randomness, &public_key->A,
      Eurydice_array_to_subslice_365(
          &ciphertext, (KRML_CLITERAL(core_ops_range_Range_08){
                           .start = (size_t)0U, .end = (size_t)960U})));
  Eurydice_arr_c41 r_as_ntt = uu____0.fst;
  Eurydice_arr_b9 error_2 = uu____0.snd;
  encrypt_c2_6c(&public_key->t_as_ntt, &r_as_ntt, &error_2, message,
                Eurydice_array_to_subslice_from_8c(&ciphertext, (size_t)960U));
  return ciphertext;
}
...
*/
static KRML_MUSTINLINE Eurydice_arr_b9
deserialize_then_decompress_ring_element_u_0a(Eurydice_dst_ref_87 serialized) {
...
deserialize_then_decompress_u_6c(Eurydice_arr_2c *ciphertext) {
  ...
  for (size_t i = (size_t)0U;
       i < Eurydice_slice_len(Eurydice_array_to_slice_42(ciphertext), uint8_t) /
               (LIBCRUX_ML_KEM_CONSTANTS_COEFFICIENTS_IN_RING_ELEMENT *
                (size_t)10U / (size_t)8U);
       i++) {
    size_t i0 = i;
    Eurydice_dst_ref_87 u_bytes = Eurydice_array_to_subslice_365(
        ciphertext,
        (KRML_CLITERAL(core_ops_range_Range_08){
            .start =
                i0 * (LIBCRUX_ML_KEM_CONSTANTS_COEFFICIENTS_IN_RING_ELEMENT *
...
*/
static KRML_MUSTINLINE Eurydice_arr_b9
deserialize_then_decompress_ring_element_v_89(Eurydice_dst_ref_87 serialized) {
...
- LEN= 32
*/
static inline Eurydice_arr_60 PRF_4a_41(Eurydice_dst_ref_87 input) {
  return PRF_9e(input);
}
...
Eurydice_arr_60 libcrux_ml_kem_ind_cca_unpacked_decapsulate_51(
  ...
  Eurydice_slice_copy(
      ...
      uint8_t);
  libcrux_sha3_Sha3_512Digest hashed =
      G_4a_e0(Eurydice_array_to_slice_d8(&to_hash0));
  Eurydice_dst_ref_uint8_t_size_t_x2 uu____1 =
      Eurydice_slice_split_at(Eurydice_array_to_slice_d8(&hashed),
                              LIBCRUX_ML_KEM_CONSTANTS_SHARED_SECRET_SIZE,
                              uint8_t, Eurydice_dst_ref_uint8_t_size_t_x2);
  ...
  Eurydice_arr_480 to_hash =
      libcrux_ml_kem_utils_into_padded_array_15(Eurydice_array_to_slice_6e(
          &key_pair->private_key.implicit_rejection_value));
  Eurydice_dst_ref_87 uu____2 = Eurydice_array_to_subslice_from_8c1(
      &to_hash, LIBCRUX_ML_KEM_CONSTANTS_SHARED_SECRET_SIZE);
  Eurydice_slice_copy(uu____2, libcrux_ml_kem_types_as_ref_d3_80(ciphertext),
                      uint8_t);
  Eurydice_arr_60 implicit_rejection_shared_secret =
      PRF_4a_41(Eurydice_array_to_slice_74(&to_hash));
  Eurydice_arr_2c expected_ciphertext = encrypt_unpacked_2a(
      &key_pair->public_key.ind_cpa_public_key, &decrypted, pseudorandomness);
  Eurydice_dst_ref_87 uu____3 = libcrux_ml_kem_types_as_ref_d3_80(ciphertext);
  uint8_t selector =
      libcrux_ml_kem_constant_time_ops_compare_ciphertexts_in_constant_time(
          uu____3, Eurydice_array_to_slice_42(&expected_ciphertext));
  return libcrux_ml_kem_constant_time_ops_select_shared_secret_in_constant_time(
      shared_secret,
      Eurydice_array_to_slice_6e(&implicit_rejection_shared_secret), selector);
}
...
*/
static KRML_MUSTINLINE Eurydice_arr_c41
deserialize_ring_elements_reduced_out_1b(Eurydice_dst_ref_87 public_key) {
  Eurydice_arr_c41 arr_struct;
  KRML_MAYBE_FOR3(i, (size_t)0U, (size_t)3U, (size_t)1U,
                  /* original Rust expression is not an lvalue in C */
                  void *lvalue = (void *)0U;
...
bool libcrux_ml_kem_ind_cca_validate_public_key_89(
  ...
  Eurydice_arr_c41 deserialized_pk =
      deserialize_ring_elements_reduced_out_1b(Eurydice_array_to_subslice_to_6e(
          public_key,
          libcrux_ml_kem_constants_ranked_bytes_per_ring_element((size_t)3U)));
  Eurydice_arr_74 public_key_serialized = serialize_public_key_89(
      &deserialized_pk,
...
bool libcrux_ml_kem_ind_cca_validate_private_key_only_d6(
    Eurydice_arr_ea *private_key) {
  Eurydice_arr_60 t = H_4a_e0(Eurydice_array_to_subslice_3615(
      private_key, (KRML_CLITERAL(core_ops_range_Range_08){
                       .start = (size_t)384U * (size_t)3U,
                       .end = (size_t)768U * (size_t)3U + (size_t)32U})));
  Eurydice_dst_ref_87 expected = Eurydice_array_to_subslice_3615(
      private_key, (KRML_CLITERAL(core_ops_range_Range_08){
...
generate_keypair_ea(Eurydice_dst_ref_87 key_generation_seed) {
...
libcrux_ml_kem_ind_cca_generate_keypair_15(
  ...
  Eurydice_arr_ea secret_key_serialized = serialize_kem_secret_key_d6(
      Eurydice_array_to_slice_06(&ind_cpa_private_key),
      Eurydice_array_to_slice_45(&public_key), implicit_rejection_value);
  Eurydice_arr_ea private_key =
...
*/
static KRML_MUSTINLINE Eurydice_arr_60
entropy_preprocess_39_9c(Eurydice_dst_ref_87 randomness) {
  Eurydice_arr_60 out = {.data = {0U}};
  Eurydice_slice_copy(Eurydice_array_to_slice_6e(&out), randomness, uint8_t);
  return out;
}
...
static KRML_MUSTINLINE
    libcrux_ml_kem_ind_cpa_unpacked_IndCpaPublicKeyUnpacked_a0
    build_unpacked_public_key_3f(Eurydice_dst_ref_87 public_key) {
  libcrux_ml_kem_ind_cpa_unpacked_IndCpaPublicKeyUnpacked_a0
...
encrypt_2a(Eurydice_dst_ref_87 public_key, Eurydice_arr_60 *message,
           Eurydice_dst_ref_87 randomness) {
  libcrux_ml_kem_ind_cpa_unpacked_IndCpaPublicKeyUnpacked_a0
...
*/
static KRML_MUSTINLINE Eurydice_arr_60
kdf_39_d6(Eurydice_dst_ref_87 shared_secret) {
  Eurydice_arr_60 out = {.data = {0U}};
  Eurydice_slice_copy(Eurydice_array_to_slice_6e(&out), shared_secret, uint8_t);
  return out;
}
...
tuple_56 libcrux_ml_kem_ind_cca_encapsulate_ca(Eurydice_arr_74 *public_key,
                                               Eurydice_arr_60 *randomness) {
  Eurydice_arr_60 randomness0 =
      entropy_preprocess_39_9c(Eurydice_array_to_slice_6e(randomness));
  libcrux_sha3_Sha3_512Digest to_hash =
      libcrux_ml_kem_utils_into_padded_array_24(
          Eurydice_array_to_slice_6e(&randomness0));
  Eurydice_dst_ref_87 uu____0 = Eurydice_array_to_subslice_from_8c0(
      &to_hash, LIBCRUX_ML_KEM_CONSTANTS_H_DIGEST_SIZE);
  /* original Rust expression is not an lvalue in C */
  Eurydice_arr_60 lvalue = H_4a_e0(Eurydice_array_to_slice_45(
      libcrux_ml_kem_types_as_slice_e6_d0(public_key)));
  Eurydice_slice_copy(uu____0, Eurydice_array_to_slice_6e(&lvalue), uint8_t);
  libcrux_sha3_Sha3_512Digest hashed =
      G_4a_e0(Eurydice_array_to_slice_d8(&to_hash));
  Eurydice_dst_ref_uint8_t_size_t_x2 uu____1 =
      Eurydice_slice_split_at(Eurydice_array_to_slice_d8(&hashed),
                              LIBCRUX_ML_KEM_CONSTANTS_SHARED_SECRET_SIZE,
                              uint8_t, Eurydice_dst_ref_uint8_t_size_t_x2);
  ...
  Eurydice_dst_ref_87 pseudorandomness = uu____1.snd;
  Eurydice_arr_2c ciphertext =
      encrypt_2a(Eurydice_array_to_slice_45(
                     libcrux_ml_kem_types_as_slice_e6_d0(public_key)),
                 &randomness0, pseudorandomness);
...
*/
static KRML_MUSTINLINE Eurydice_arr_60
decrypt_42(Eurydice_dst_ref_87 secret_key, Eurydice_arr_2c *ciphertext) {
  Eurydice_arr_c41 arr_struct;
  KRML_MAYBE_FOR3(i, (size_t)0U, (size_t)3U, (size_t)1U,
                  /* original Rust expression is not an lvalue in C */
                  void *lvalue = (void *)0U;
...
Eurydice_arr_60 libcrux_ml_kem_ind_cca_decapsulate_62(
  ...
  Eurydice_dst_ref_87 uu____4 = libcrux_ml_kem_types_as_ref_d3_80(ciphertext);
  return libcrux_ml_kem_constant_time_ops_compare_ciphertexts_select_shared_secret_in_constant_time(
      uu____4, Eurydice_array_to_slice_42(&expected_ciphertext),
      Eurydice_array_to_slice_6e(&shared_secret),
      Eurydice_array_to_slice_6e(&implicit_rejection_shared_secret0));
}
