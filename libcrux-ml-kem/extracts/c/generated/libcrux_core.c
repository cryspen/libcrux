...
*/
static KRML_NOINLINE uint8_t compare(Eurydice_dst_ref_87 lhs,
...
/**
 ...
 `lhs` otherwise.
*/
static KRML_NOINLINE Eurydice_arr_60 select_ct(Eurydice_dst_ref_87 lhs,
                                               Eurydice_dst_ref_87 rhs,
                                               uint8_t selector) {
...
Eurydice_dst_ref_87 Eurydice_array_to_subslice_3619(Eurydice_arr_17 *a,
  ...
  return (KRML_CLITERAL(Eurydice_dst_ref_87){.ptr = a->data + r.start,
                                             .meta = r.end - r.start});
}
...
Eurydice_dst_ref_87 libcrux_ml_kem_types_as_ref_d3_af(Eurydice_arr_00 *self) {
  return Eurydice_array_to_slice_4e(self);
}
...
Eurydice_dst_ref_87 Eurydice_array_to_subslice_from_8c4(Eurydice_arr_e7 *a,
                                                        size_t r) {
  return (KRML_CLITERAL(Eurydice_dst_ref_87){.ptr = a->data + r,
                                             .meta = (size_t)1600U - r});
}
...
- N= 1600
*/
static Eurydice_dst_ref_87 array_to_subslice_3617(Eurydice_arr_e7 *a,
                                                  core_ops_range_Range_08 r) {
  return (KRML_CLITERAL(Eurydice_dst_ref_87){.ptr = a->data + r.start,
                                             .meta = r.end - r.start});
}
...
Eurydice_dst_ref_uint8_t_size_t_x4 libcrux_ml_kem_types_unpack_private_key_1f(
  ...
  Eurydice_dst_ref_uint8_t_size_t_x2 uu____0 = Eurydice_slice_split_at(
      private_key, (size_t)1536U, uint8_t, Eurydice_dst_ref_uint8_t_size_t_x2);
  ...
  Eurydice_dst_ref_uint8_t_size_t_x2 uu____1 = Eurydice_slice_split_at(
      secret_key0, (size_t)1568U, uint8_t, Eurydice_dst_ref_uint8_t_size_t_x2);
  ...
  return (KRML_CLITERAL(Eurydice_dst_ref_uint8_t_size_t_x4){
...
- N= 34
*/
static Eurydice_dst_ref_87 array_to_subslice_3610(Eurydice_arr_48 *a,
                                                  core_ops_range_Range_08 r) {
  return (KRML_CLITERAL(Eurydice_dst_ref_87){.ptr = a->data + r.start,
                                             .meta = r.end - r.start});
}
...
Eurydice_dst_ref_9a Eurydice_array_to_subslice_850(Eurydice_arr_a00 *a,
                                                   core_ops_range_Range_08 r) {
  return (KRML_CLITERAL(Eurydice_dst_ref_9a){.ptr = a->data + r.start,
                                             .meta = r.end - r.start});
}
...
Eurydice_dst_ref_87 Eurydice_slice_subslice_from_6b(Eurydice_dst_ref_87 s,
                                                    size_t r) {
  return (
      KRML_CLITERAL(Eurydice_dst_ref_87){.ptr = s.ptr + r, .meta = s.meta - r});
}
...
Eurydice_dst_ref_87 Eurydice_slice_subslice_to_c6(Eurydice_dst_ref_87 s,
                                                  size_t r) {
  return (KRML_CLITERAL(Eurydice_dst_ref_87){.ptr = s.ptr, .meta = r});
}
...
- N= 1120
*/
static Eurydice_dst_ref_87 array_to_subslice_368(Eurydice_arr_480 *a,
                                                 core_ops_range_Range_08 r) {
  return (KRML_CLITERAL(Eurydice_dst_ref_87){.ptr = a->data + r.start,
                                             .meta = r.end - r.start});
}
...
Eurydice_dst_ref_9a Eurydice_slice_subslice_76(Eurydice_dst_ref_9a s,
                                               core_ops_range_Range_08 r) {
  return (KRML_CLITERAL(Eurydice_dst_ref_9a){.ptr = s.ptr + r.start,
                                             .meta = r.end - r.start});
}
...
Eurydice_dst_ref_87 Eurydice_slice_subslice_7e(Eurydice_dst_ref_87 s,
                                               core_ops_range_Range_08 r) {
  return (KRML_CLITERAL(Eurydice_dst_ref_87){.ptr = s.ptr + r.start,
                                             .meta = r.end - r.start});
}
