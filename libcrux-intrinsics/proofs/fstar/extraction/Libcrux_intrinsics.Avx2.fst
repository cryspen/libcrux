...
assume
val mm256_set1_epi32': constant: i32 -> Minicore.Core_arch.X86.t_e_ee_m256i
...
assume
val mm256_sub_epi32': lhs: Minicore.Core_arch.X86.t_e_ee_m256i -> rhs: Minicore.Core_arch.X86.t_e_ee_m256i
  -> Minicore.Core_arch.X86.t_e_ee_m256i
...
assume
val mm256_mul_epi32': lhs: Minicore.Core_arch.X86.t_e_ee_m256i -> rhs: Minicore.Core_arch.X86.t_e_ee_m256i
  -> Minicore.Core_arch.X86.t_e_ee_m256i
...
let mm256_srli_epi64 (v_SHIFT_BY: i32) (vector: Minicore.Core_arch.X86.t_e_ee_m256i)
  ...
  let _:Prims.unit =
    ...
    then
      ...
      ()
  in
  Minicore.Core_arch.X86.Avx2.e_mm256_srli_epi64 v_SHIFT_BY vector
...
assume
val mm256_shuffle_epi32': v_CONTROL: i32 -> vector: Minicore.Core_arch.X86.t_e_ee_m256i
  -> Minicore.Core_arch.X86.t_e_ee_m256i
