...
pub type _int16x8_t = Secret<int16x8_t>;
pub type _int32x4_t = Secret<int32x4_t>;
pub type _int64x2_t = Secret<int64x2_t>;
pub type _int16x4_t = Secret<int16x4_t>;
pub type _uint8x16_t = Secret<uint8x16_t>;
pub type _uint16x4_t = Secret<uint16x4_t>;
pub type _uint32x4_t = Secret<uint32x4_t>;
...
pub fn _vst1q_s16(out: &mut [i16], v: _int16x8_t) {
    unsafe { vst1q_s16(out.as_mut_ptr(), v.declassify()) }
}

#[inline(always)]
pub fn _vld1q_s16(array: &[I16]) -> _int16x8_t {
    unsafe { vld1q_s16(array.declassify().as_ptr()).classify() }
}

#[inline(always)]
pub fn _vld1q_bytes_u64(array: &[U8]) -> _uint64x2_t {
    unsafe { vld1q_u64(array.declassify().as_ptr() as *const u64).classify() }
}

#[inline(always)]
pub fn _vld1q_u64(array: &[U64]) -> _uint64x2_t {
    unsafe { vld1q_u64(array.declassify().as_ptr()).classify() }
}

#[inline(always)]
pub fn _vst1q_u64(out: &mut [u64], v: _uint64x2_t) {
    unsafe { vst1q_u64(out.as_mut_ptr(), v.declassify()) }
}

#[inline(always)]
pub fn _vst1q_bytes_u64(out: &mut [u8], v: _uint64x2_t) {
    unsafe { vst1q_u64(out.as_mut_ptr() as *mut u64, v.declassify()) }
}

#[inline(always)]
pub fn _vaddq_s16(lhs: _int16x8_t, rhs: _int16x8_t) -> _int16x8_t {
    unsafe { vaddq_s16(lhs.declassify(), rhs.declassify()).classify() }
}

#[inline(always)]
pub fn _vsubq_s16(lhs: _int16x8_t, rhs: _int16x8_t) -> _int16x8_t {
    unsafe { vsubq_s16(lhs.declassify(), rhs.declassify()).classify() }
}
...
pub fn _vqdmulhq_s16(v: _int16x8_t, c: _int16x8_t) -> _int16x8_t {
    unsafe { vqdmulhq_s16(v.declassify(), c.declassify()).classify() }
}
#[inline(always)]
pub fn _vcgeq_s16(v: _int16x8_t, c: _int16x8_t) -> _uint16x8_t {
    unsafe { vcgeq_s16(v.declassify(), c.declassify()).classify() }
}
#[inline(always)]
pub fn _vandq_s16(a: _int16x8_t, b: _int16x8_t) -> _int16x8_t {
    unsafe { vandq_s16(a.declassify(), b.declassify()).classify() }
}

#[inline(always)]
pub fn _vbicq_u64(a: _uint64x2_t, b: _uint64x2_t) -> _uint64x2_t {
    unsafe { vbicq_u64(a.declassify(), b.declassify()).classify() }
}

#[inline(always)]
pub fn _vreinterpretq_s16_u16(m0: _uint16x8_t) -> _int16x8_t {
    unsafe { vreinterpretq_s16_u16(m0.declassify()).classify() }
}
#[inline(always)]
pub fn _vreinterpretq_u16_s16(m0: _int16x8_t) -> _uint16x8_t {
    unsafe { vreinterpretq_u16_s16(m0.declassify()).classify() }
}
#[inline(always)]
pub fn _vmulq_s16(v: _int16x8_t, c: _int16x8_t) -> _int16x8_t {
    unsafe { vmulq_s16(v.declassify(), c.declassify()).classify() }
}

#[inline(always)]
pub fn _veorq_s16(mask: _int16x8_t, shifted: _int16x8_t) -> _int16x8_t {
    unsafe { veorq_s16(mask.declassify(), shifted.declassify()).classify() }
}

#[inline(always)]
pub fn _veorq_u64(mask: _uint64x2_t, shifted: _uint64x2_t) -> _uint64x2_t {
    unsafe { veorq_u64(mask.declassify(), shifted.declassify()).classify() }
}
...
pub fn _vaddq_u32(compressed: _uint32x4_t, half: _uint32x4_t) -> _uint32x4_t {
    unsafe { vaddq_u32(compressed.declassify(), half.declassify()).classify() }
}
#[inline(always)]
...
pub fn _vreinterpretq_u32_s32(a: _int32x4_t) -> _uint32x4_t {
    unsafe { vreinterpretq_u32_s32(a.declassify()).classify() }
}

#[inline(always)]
pub fn _vshrq_n_u32<const N: i32>(a: _uint32x4_t) -> _uint32x4_t {
    unsafe { vshrq_n_u32::<N>(a.declassify()).classify() }
}
#[inline(always)]
pub fn _vandq_u32(a: _uint32x4_t, b: _uint32x4_t) -> _uint32x4_t {
    unsafe { vandq_u32(a.declassify(), b.declassify()).classify() }
}
#[inline(always)]
pub fn _vreinterpretq_u32_s16(a: _int16x8_t) -> _uint32x4_t {
    unsafe { vreinterpretq_u32_s16(a.declassify()).classify() }
}
#[inline(always)]
pub fn _vreinterpretq_s16_u32(a: _uint32x4_t) -> _int16x8_t {
    unsafe { vreinterpretq_s16_u32(a.declassify()).classify() }
}
#[inline(always)]
pub fn _vtrn1q_s16(a: _int16x8_t, b: _int16x8_t) -> _int16x8_t {
    unsafe { vtrn1q_s16(a.declassify(), b.declassify()).classify() }
}
#[inline(always)]
...
pub fn _vandq_u16(a: _uint16x8_t, b: _uint16x8_t) -> _uint16x8_t {
    unsafe { vandq_u16(a.declassify(), b.declassify()).classify() }
}
#[inline(always)]
pub fn _vreinterpretq_u16_u8(a: _uint8x16_t) -> _uint16x8_t {
    unsafe { vreinterpretq_u16_u8(a.declassify()).classify() }
}
#[inline(always)]
pub fn _vld1q_u16(ptr: &[U16]) -> _uint16x8_t {
    unsafe { vld1q_u16(ptr.declassify().as_ptr()).classify() }
}
#[inline(always)]
pub fn _vcleq_s16(a: _int16x8_t, b: _int16x8_t) -> _uint16x8_t {
    unsafe { vcleq_s16(a.declassify(), b.declassify()).classify() }
}
#[inline(always)]
pub fn _vaddvq_u16(a: _uint16x8_t) -> U16 {
    unsafe { vaddvq_u16(a.declassify()).classify() }
}
