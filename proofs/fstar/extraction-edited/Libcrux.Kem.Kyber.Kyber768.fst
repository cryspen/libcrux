...
let decapsulate_768_
  ...
  Libcrux.Kem.Kyber.decapsulate #Spec.Kyber.kyber768_params 
    (sz 3) (sz 2400) (sz 1152) (sz 1184) (sz 1088) (sz 1152) (sz 960)
...
let encapsulate_768_
  ...
  Libcrux.Kem.Kyber.encapsulate #Spec.Kyber.kyber768_params 
    (sz 3) (sz 1088) (sz 1184) (sz 1152) (sz 960) (sz 128) (sz 10)
    (sz 4) (sz 320) (sz 2) (sz 128) (sz 2) (sz 128) public_key randomness

let generate_key_pair_768_ (randomness: t_Array u8 (sz 64)) =
  Libcrux.Kem.Kyber.generate_keypair #Spec.Kyber.kyber768_params 
    (sz 3)
    (sz 1152)
    (sz 2400)
    (sz 1184)
