...
let is_polynomialRingElement_wf re =
  forall i. i < 256 ==> is_fe (v (re.Libcrux.Kem.Kyber.Arithmetic.f_coefficients.[sz i] <: i32))

type wfPolynomialRingElement =
  re: Libcrux.Kem.Kyber.Arithmetic.t_PolynomialRingElement {is_polynomialRingElement_wf re}
...
val compress_then_serialize_message (re: wfPolynomialRingElement)
