...
#ifndef __Libcrux_Kem_Kyber_Ntt_H
#define __Libcrux_Kem_Kyber_Ntt_H
...
extern int32_t *Libcrux_Kem_Kyber_Ntt_v_ZETAS_TIMES_MONTGOMERY_R;
...
#define __Libcrux_Kem_Kyber_Ntt_H_DEFINED
#endif
