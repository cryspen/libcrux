...
#ifndef __Libcrux_Kem_Kyber_Arithmetic_H
#define __Libcrux_Kem_Kyber_Arithmetic_H
...
typedef int32_t Libcrux_Kem_Kyber_Arithmetic_t_KyberFieldElement;

extern int64_t Libcrux_Kem_Kyber_Arithmetic_v_BARRETT_MULTIPLIER;

extern int64_t Libcrux_Kem_Kyber_Arithmetic_v_BARRETT_SHIFT;

extern int64_t Libcrux_Kem_Kyber_Arithmetic_v_BARRETT_R;

extern int32_t Libcrux_Kem_Kyber_Arithmetic_v_INVERSE_OF_MODULUS_MOD_R;

extern uint8_t Libcrux_Kem_Kyber_Arithmetic_v_MONTGOMERY_SHIFT;

extern int32_t Libcrux_Kem_Kyber_Arithmetic_v_MONTGOMERY_R;
...
typedef int32_t *Libcrux_Kem_Kyber_Arithmetic_t_KyberPolynomialRingElement;

extern int32_t Libcrux_Kem_Kyber_Arithmetic_impl__KyberPolynomialRingElement__ZERO[256U];

void
Libcrux_Kem_Kyber_Arithmetic_add_to_ring_element(uint32_t v_K, int32_t *lhs, int32_t *rhs);


#define __Libcrux_Kem_Kyber_Arithmetic_H_DEFINED
#endif
