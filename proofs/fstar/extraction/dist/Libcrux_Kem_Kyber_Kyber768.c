...
sample_matrix_A(uint32_t v_K, uint8_t *seed, bool transpose)
{
  ...
  for (uint32_t i0 = start; i0 < finish; i0++)
  {
    ...
    for (uint32_t _i = 0U; _i < v_K; ++_i)
      out[_i] = buf0;
    uint32_t start11 = 0U;
    uint32_t finish11 = v_K;
    for (uint32_t i = start11; i < finish11; i++)
    {
      uint32_t i3 = i;
      out[i3] =
        Libcrux_Digest_shake128(840U,
          ((t_nonempty_Slice__uint8_t){ .buffer = seeds[i3], .len = 34U }));
    }
    uint8_t **xof_bytes = out;
    uint32_t start1 = 0U;
...
)
{
  ...
  uint32_t start2 = 0U;
  uint32_t finish2 = v_K;
  for (uint32_t i = start2; i < finish2; i++)
  {
    uint32_t i1 = i;
    ...
    uint8_t
    *prf_output =
      v_PRF(v_ETA1_RANDOMNESS_SIZE,
        ((t_nonempty_Slice__uint8_t){ .buffer = prf_input, .len = 33U }));
    int32_t
    *r =
      sample_from_binomial_distribution(v_ETA1,
        ((t_nonempty_Slice__uint8_t){ .buffer = prf_output, .len = v_ETA1_RANDOMNESS_SIZE }));
    re_as_ntt[i1] = ntt_binomially_sampled_ring_element(r);
  }
  int32_t **r_as_ntt = re_as_ntt;
  KRML_CHECK_SIZE(sizeof (int32_t *), v_K);
  int32_t *error_1_[v_K];
  for (uint32_t _i = 0U; _i < v_K; ++_i)
    error_1_[_i] = impl__PolynomialRingElement__ZERO;
  uint32_t start3 = 0U;
  uint32_t finish3 = v_K;
  for (uint32_t i = start3; i < finish3; i++)
  {
    uint32_t i1 = i;
    prf_input[32U] = domain_separator;
    update_domain_separator(domain_separator);
  ...
  *error_2_ =
  ...
  uint32_t start4 = 0U;
  uint32_t finish4 = v_K;
  for (uint32_t i0 = start4; i0 < finish4; i0++)
  {
    uint32_t i1 = i0;
    int32_t **row = v_A_transpose[i1];
    uint32_t start1 = 0U;
    uint32_t finish10 = v_K;
    ...
    for (uint32_t i = start10; i < finish1; i++)
    {
      ...
      int32_t *uu____2 = result[i1];
      uu____2[j] = barrett_reduce(coefficient_normal_form + error_1_i[j]);
    }
  }
  int32_t **u = result;
  ...
  *v = compute_ring_element_v(v_K, tt_as_ntt, r_as_ntt, error_2_, message_as_ring_element);
  KRML_CHECK_SIZE(sizeof (uint8_t), v_C1_LEN);
  uint8_t out2[v_C1_LEN];
  memset(out2, 0U, v_C1_LEN * sizeof (uint8_t));
  uint32_t start5 = 0U;
  uint32_t finish5 = v_K;
  for (uint32_t i0 = start5; i0 < finish5; i0++)
  {
    uint32_t i1 = i0;
    int32_t *re = u[i1];
    uint32_t f_start = i1 * (v_C1_LEN / v_K);
    uint32_t f_end = (i1 + 1U) * (v_C1_LEN / v_K);
    uint32_t len2 = f_end - f_start;
    uint8_t *buffer = out2 + f_start;
    t_nonempty_Slice__uint8_t uu____3 = { .buffer = buffer, .len = len2 };
    uint8_t *sw;
    switch (v_U_COMPRESSION_FACTOR)
    {
      case 10U:
        {
          KRML_CHECK_SIZE(sizeof (uint8_t), v_BLOCK_LEN);
          uint8_t serialized[v_BLOCK_LEN];
          memset(serialized, 0U, v_BLOCK_LEN * sizeof (uint8_t));
          uint32_t start1 = 0U;
          uint32_t finish1 = 256U / 4U;
          for (uint32_t i = start1; i < finish1; i++)
          {
            uint32_t i3 = i;
            int32_t
            coefficient1 =
              compress_ciphertext_coefficient(10U,
                to_unsigned_representative(re[i3 * 4U + 0U]));
            int32_t
            coefficient2 =
              compress_ciphertext_coefficient(10U,
                to_unsigned_representative(re[i3 * 4U + 1U]));
            int32_t
            coefficient3 =
              compress_ciphertext_coefficient(10U,
                to_unsigned_representative(re[i3 * 4U + 2U]));
            int32_t
            coefficient4 =
              compress_ciphertext_coefficient(10U,
                to_unsigned_representative(re[i3 * 4U + 3U]));
            uint32_t m0 = 8U;
            int32_t pow2_bits0 = (int32_t)1 << 8U;
            int32_t pow2_bits_minus_one0 = (int32_t)1 << 7U;
            int32_t
            a2 =
              ((coefficient1 & (int32_t)255) & (((int32_t)1 << m0) - (int32_t)1))
              - pow2_bits_minus_one0;
            int32_t mask = FStar_Int32_shift_arithmetic_right(a2, 31U);
            int32_t
            a30 = ((coefficient1 & (int32_t)255) & (((int32_t)1 << m0) - (int32_t)1)) - pow2_bits0;
            int32_t b = a30 + (mask & pow2_bits0);
            serialized[5U * i3] = (uint8_t)b;
            uint32_t m1 = 8U;
            int32_t pow2_bits1 = (int32_t)1 << 8U;
            int32_t pow2_bits_minus_one1 = (int32_t)1 << 7U;
            int32_t
            a20 =
              ((coefficient2 & (int32_t)63) & (((int32_t)1 << m1) - (int32_t)1))
              - pow2_bits_minus_one1;
            int32_t mask0 = FStar_Int32_shift_arithmetic_right(a20, 31U);
            int32_t
            a31 = ((coefficient2 & (int32_t)63) & (((int32_t)1 << m1) - (int32_t)1)) - pow2_bits1;
            ...
            int32_t
            a22 =
              ((coefficient3 & (int32_t)15) & (((int32_t)1 << m3) - (int32_t)1))
              - pow2_bits_minus_one3;
            int32_t mask2 = FStar_Int32_shift_arithmetic_right(a22, 31U);
            int32_t
            a33 = ((coefficient3 & (int32_t)15) & (((int32_t)1 << m3) - (int32_t)1)) - pow2_bits3;
            ...
            int32_t
            a24 =
              ((coefficient4 & (int32_t)3) & (((int32_t)1 << m5) - (int32_t)1))
              - pow2_bits_minus_one5;
            int32_t mask4 = FStar_Int32_shift_arithmetic_right(a24, 31U);
            int32_t
            a35 = ((coefficient4 & (int32_t)3) & (((int32_t)1 << m5) - (int32_t)1)) - pow2_bits5;
            ...
            serialized[5U * i3 + 4U] = (uint8_t)b6;
          }
          sw = serialized;
          break;
        }
          ...
          for (uint32_t i = start1; i < finish1; i++)
          {
            ...
            coefficient1 =
              compress_ciphertext_coefficient(11U,
                to_unsigned_representative(re[i3 * 8U + 0U]));
            int32_t
            coefficient2 =
              compress_ciphertext_coefficient(11U,
                to_unsigned_representative(re[i3 * 8U + 1U]));
            int32_t
            coefficient3 =
              compress_ciphertext_coefficient(11U,
                to_unsigned_representative(re[i3 * 8U + 2U]));
            int32_t
            coefficient4 =
              compress_ciphertext_coefficient(11U,
                to_unsigned_representative(re[i3 * 8U + 3U]));
            int32_t
            coefficient5 =
              compress_ciphertext_coefficient(11U,
                to_unsigned_representative(re[i3 * 8U + 4U]));
            int32_t
            coefficient6 =
              compress_ciphertext_coefficient(11U,
                to_unsigned_representative(re[i3 * 8U + 5U]));
            int32_t
            coefficient7 =
              compress_ciphertext_coefficient(11U,
                to_unsigned_representative(re[i3 * 8U + 6U]));
            int32_t
            coefficient8 =
              compress_ciphertext_coefficient(11U,
                to_unsigned_representative(re[i3 * 8U + 7U]));
            uint32_t m0 = 8U;
            int32_t pow2_bits0 = (int32_t)1 << 8U;
            int32_t pow2_bits_minus_one0 = (int32_t)1 << 7U;
            ...
            int32_t b = a30 + (mask & pow2_bits0);
            serialized[11U * i3] = (uint8_t)b;
            uint32_t m1 = 8U;
            int32_t pow2_bits1 = (int32_t)1 << 8U;
            int32_t pow2_bits_minus_one1 = (int32_t)1 << 7U;
            int32_t
            a20 =
              ((coefficient2 & (int32_t)31) & (((int32_t)1 << m1) - (int32_t)1))
              - pow2_bits_minus_one1;
            int32_t mask0 = FStar_Int32_shift_arithmetic_right(a20, 31U);
            int32_t
            a31 = ((coefficient2 & (int32_t)31) & (((int32_t)1 << m1) - (int32_t)1)) - pow2_bits1;
            int32_t b0 = a31 + (mask0 & pow2_bits1);
            uint32_t m2 = 8U;
            int32_t pow2_bits2 = (int32_t)1 << 8U;
            int32_t pow2_bits_minus_one2 = (int32_t)1 << 7U;
            ...
            int32_t
            a22 =
              ((coefficient3 & (int32_t)3) & (((int32_t)1 << m3) - (int32_t)1))
              - pow2_bits_minus_one3;
            int32_t mask2 = FStar_Int32_shift_arithmetic_right(a22, 31U);
            int32_t
            a33 = ((coefficient3 & (int32_t)3) & (((int32_t)1 << m3) - (int32_t)1)) - pow2_bits3;
            int32_t b2 = a33 + (mask2 & pow2_bits3);
            uint32_t m4 = 8U;
            int32_t pow2_bits4 = (int32_t)1 << 8U;
            int32_t pow2_bits_minus_one4 = (int32_t)1 << 7U;
            ...
            a35 =
              ...
              - pow2_bits5;
            int32_t b4 = a35 + (mask4 & pow2_bits5);
            serialized[11U * i3 + 3U] = (uint8_t)b4;
            uint32_t m6 = 8U;
            int32_t pow2_bits6 = (int32_t)1 << 8U;
            int32_t pow2_bits_minus_one6 = (int32_t)1 << 7U;
            int32_t
            ...
            int32_t mask5 = FStar_Int32_shift_arithmetic_right(a25, 31U);
            int32_t
            a36 = ((coefficient4 & (int32_t)127) & (((int32_t)1 << m6) - (int32_t)1)) - pow2_bits6;
            int32_t b5 = a36 + (mask5 & pow2_bits6);
            uint32_t m7 = 8U;
            ...
            int32_t
            a27 =
              ((coefficient5 & (int32_t)15) & (((int32_t)1 << m8) - (int32_t)1))
              - pow2_bits_minus_one8;
            int32_t mask7 = FStar_Int32_shift_arithmetic_right(a27, 31U);
            int32_t
            a38 = ((coefficient5 & (int32_t)15) & (((int32_t)1 << m8) - (int32_t)1)) - pow2_bits8;
            ...
            serialized[11U * i3 + 7U] = (uint8_t)b11;
            uint32_t m13 = 8U;
            ...
            serialized[11U * i3 + 10U] = (uint8_t)b16;
          }
          sw = serialized;
          break;
        }
    ...
    t_nonempty_Slice__uint8_t uu____4 = { .buffer = sw, .len = v_BLOCK_LEN };
    memcpy(uu____4.buffer, uu____3.buffer, uu____4.len * sizeof (uint8_t));
  }
  uint8_t *c1 = out2;
  uint8_t *c2;
  switch (v_V_COMPRESSION_FACTOR)
  {
    case 4U:
      {
        KRML_CHECK_SIZE(sizeof (uint8_t), v_C2_LEN);
        uint8_t serialized[v_C2_LEN];
        memset(serialized, 0U, v_C2_LEN * sizeof (uint8_t));
        uint32_t start = 0U;
        ...
        for (uint32_t i = start; i < finish; i++)
        {
          uint32_t i1 = i;
          int32_t
          uu____5 = compress_ciphertext_coefficient(4U, to_unsigned_representative(v[i1 * 2U + 0U]));
          uint32_t m0 = 8U;
          int32_t pow2_bits0 = (int32_t)1 << 8U;
          int32_t pow2_bits_minus_one0 = (int32_t)1 << 7U;
          int32_t a2 = (uu____5 & (((int32_t)1 << m0) - (int32_t)1)) - pow2_bits_minus_one0;
          int32_t mask = FStar_Int32_shift_arithmetic_right(a2, 31U);
          int32_t a30 = (uu____5 & (((int32_t)1 << m0) - (int32_t)1)) - pow2_bits0;
          int32_t b = a30 + (mask & pow2_bits0);
          uint8_t coefficient1 = (uint8_t)b;
          int32_t
          uu____6 = compress_ciphertext_coefficient(4U, to_unsigned_representative(v[i1 * 2U + 1U]));
          uint32_t m = 8U;
          int32_t pow2_bits = (int32_t)1 << 8U;
          int32_t pow2_bits_minus_one = (int32_t)1 << 7U;
          int32_t a20 = (uu____6 & (((int32_t)1 << m) - (int32_t)1)) - pow2_bits_minus_one;
          int32_t mask0 = FStar_Int32_shift_arithmetic_right(a20, 31U);
          int32_t a3 = (uu____6 & (((int32_t)1 << m) - (int32_t)1)) - pow2_bits;
    ...
    case 5U:
      {
        ...
        for (uint32_t i = start; i < finish; i++)
        {
          uint32_t i1 = i;
          int32_t
          uu____7 = compress_ciphertext_coefficient(5U, to_unsigned_representative(v[i1 * 8U + 0U]));
          uint32_t m0 = 8U;
          int32_t pow2_bits0 = (int32_t)1 << 8U;
          int32_t pow2_bits_minus_one0 = (int32_t)1 << 7U;
          int32_t a2 = (uu____7 & (((int32_t)1 << m0) - (int32_t)1)) - pow2_bits_minus_one0;
          int32_t mask = FStar_Int32_shift_arithmetic_right(a2, 31U);
          int32_t a30 = (uu____7 & (((int32_t)1 << m0) - (int32_t)1)) - pow2_bits0;
          int32_t b = a30 + (mask & pow2_bits0);
          uint8_t coefficient1 = (uint8_t)b;
          int32_t
          uu____8 = compress_ciphertext_coefficient(5U, to_unsigned_representative(v[i1 * 8U + 1U]));
          uint32_t m1 = 8U;
          int32_t pow2_bits1 = (int32_t)1 << 8U;
          int32_t pow2_bits_minus_one1 = (int32_t)1 << 7U;
          int32_t a20 = (uu____8 & (((int32_t)1 << m1) - (int32_t)1)) - pow2_bits_minus_one1;
          int32_t mask0 = FStar_Int32_shift_arithmetic_right(a20, 31U);
          int32_t a31 = (uu____8 & (((int32_t)1 << m1) - (int32_t)1)) - pow2_bits1;
          int32_t b0 = a31 + (mask0 & pow2_bits1);
          uint8_t coefficient2 = (uint8_t)b0;
          int32_t
          uu____9 = compress_ciphertext_coefficient(5U, to_unsigned_representative(v[i1 * 8U + 2U]));
          uint32_t m2 = 8U;
          int32_t pow2_bits2 = (int32_t)1 << 8U;
          int32_t pow2_bits_minus_one2 = (int32_t)1 << 7U;
          int32_t a21 = (uu____9 & (((int32_t)1 << m2) - (int32_t)1)) - pow2_bits_minus_one2;
          int32_t mask1 = FStar_Int32_shift_arithmetic_right(a21, 31U);
          int32_t a32 = (uu____9 & (((int32_t)1 << m2) - (int32_t)1)) - pow2_bits2;
          int32_t b1 = a32 + (mask1 & pow2_bits2);
          uint8_t coefficient3 = (uint8_t)b1;
          int32_t
          uu____10 =
            compress_ciphertext_coefficient(5U,
              to_unsigned_representative(v[i1 * 8U + 3U]));
          uint32_t m3 = 8U;
          int32_t pow2_bits3 = (int32_t)1 << 8U;
          int32_t pow2_bits_minus_one3 = (int32_t)1 << 7U;
          int32_t a22 = (uu____10 & (((int32_t)1 << m3) - (int32_t)1)) - pow2_bits_minus_one3;
          int32_t mask2 = FStar_Int32_shift_arithmetic_right(a22, 31U);
          int32_t a33 = (uu____10 & (((int32_t)1 << m3) - (int32_t)1)) - pow2_bits3;
          int32_t b2 = a33 + (mask2 & pow2_bits3);
          uint8_t coefficient4 = (uint8_t)b2;
          int32_t
          uu____11 =
            compress_ciphertext_coefficient(5U,
              to_unsigned_representative(v[i1 * 8U + 4U]));
          uint32_t m4 = 8U;
          int32_t pow2_bits4 = (int32_t)1 << 8U;
          int32_t pow2_bits_minus_one4 = (int32_t)1 << 7U;
          int32_t a23 = (uu____11 & (((int32_t)1 << m4) - (int32_t)1)) - pow2_bits_minus_one4;
          int32_t mask3 = FStar_Int32_shift_arithmetic_right(a23, 31U);
          int32_t a34 = (uu____11 & (((int32_t)1 << m4) - (int32_t)1)) - pow2_bits4;
          int32_t b3 = a34 + (mask3 & pow2_bits4);
          uint8_t coefficient5 = (uint8_t)b3;
          int32_t
          uu____12 =
            compress_ciphertext_coefficient(5U,
              to_unsigned_representative(v[i1 * 8U + 5U]));
          uint32_t m5 = 8U;
          int32_t pow2_bits5 = (int32_t)1 << 8U;
          int32_t pow2_bits_minus_one5 = (int32_t)1 << 7U;
          int32_t a24 = (uu____12 & (((int32_t)1 << m5) - (int32_t)1)) - pow2_bits_minus_one5;
          int32_t mask4 = FStar_Int32_shift_arithmetic_right(a24, 31U);
          int32_t a35 = (uu____12 & (((int32_t)1 << m5) - (int32_t)1)) - pow2_bits5;
          int32_t b4 = a35 + (mask4 & pow2_bits5);
          uint8_t coefficient6 = (uint8_t)b4;
          int32_t
          uu____13 =
            compress_ciphertext_coefficient(5U,
              to_unsigned_representative(v[i1 * 8U + 6U]));
          uint32_t m6 = 8U;
          int32_t pow2_bits6 = (int32_t)1 << 8U;
          int32_t pow2_bits_minus_one6 = (int32_t)1 << 7U;
          int32_t a25 = (uu____13 & (((int32_t)1 << m6) - (int32_t)1)) - pow2_bits_minus_one6;
          int32_t mask5 = FStar_Int32_shift_arithmetic_right(a25, 31U);
          int32_t a36 = (uu____13 & (((int32_t)1 << m6) - (int32_t)1)) - pow2_bits6;
          int32_t b5 = a36 + (mask5 & pow2_bits6);
          uint8_t coefficient7 = (uint8_t)b5;
          int32_t
          uu____14 =
            compress_ciphertext_coefficient(5U,
              to_unsigned_representative(v[i1 * 8U + 7U]));
          uint32_t m = 8U;
          int32_t pow2_bits = (int32_t)1 << 8U;
          int32_t pow2_bits_minus_one = (int32_t)1 << 7U;
          int32_t a26 = (uu____14 & (((int32_t)1 << m) - (int32_t)1)) - pow2_bits_minus_one;
          int32_t mask6 = FStar_Int32_shift_arithmetic_right(a26, 31U);
          int32_t a3 = (uu____14 & (((int32_t)1 << m) - (int32_t)1)) - pow2_bits;
          int32_t b6 = a3 + (mask6 & pow2_bits);
  ...
  t_nonempty_Slice__uint8_t uu____15 = { .buffer = c2, .len = v_C2_LEN };
  uint32_t f_start = v_C1_LEN;
  uint32_t f_end = v_CIPHERTEXT_SIZE;
  uint32_t len2 = f_end - f_start;
  uint8_t *buffer = ciphertext + f_start;
  memcpy(uu____15.buffer,
    ((t_nonempty_Slice__uint8_t){ .buffer = buffer, .len = len2 }).buffer,
    uu____15.len * sizeof (uint8_t));
  return
    (
      (__Libcrux_Kem_Kyber_Types_t_KyberCiphertext_Core_Option_t_Option__Libcrux_Kem_Kyber_Types_t_Error){
...
)
{
  ...
  uint8_t domain_separator = 0U;
  KRML_CHECK_SIZE(sizeof (int32_t *), v_K);
  int32_t *re_as_ntt0[v_K];
  for (uint32_t _i = 0U; _i < v_K; ++_i)
    re_as_ntt0[_i] = impl__PolynomialRingElement__ZERO;
  uint32_t start0 = 0U;
  uint32_t finish0 = v_K;
  for (uint32_t i = start0; i < finish0; i++)
  {
    ...
    *r =
      sample_from_binomial_distribution(v_ETA1,
        ((t_nonempty_Slice__uint8_t){ .buffer = prf_output, .len = v_ETA1_RANDOMNESS_SIZE }));
    re_as_ntt0[i1] = ntt_binomially_sampled_ring_element(r);
  }
  int32_t **secret_as_ntt = re_as_ntt0;
  KRML_CHECK_SIZE(sizeof (int32_t *), v_K);
  int32_t *re_as_ntt[v_K];
  for (uint32_t _i = 0U; _i < v_K; ++_i)
    re_as_ntt[_i] = impl__PolynomialRingElement__ZERO;
  ...
  int32_t **error_as_ntt = re_as_ntt;
  KRML_CHECK_SIZE(sizeof (int32_t *), v_K);
  int32_t *result[v_K];
  for (uint32_t _i = 0U; _i < v_K; ++_i)
    result[_i] = impl__PolynomialRingElement__ZERO;
  ...
  for (uint32_t i0 = start3; i0 < finish3; i0++)
  {
    ...
    for (uint32_t i = start1; i < finish10; i++)
    {
      ...
      int32_t *product = ntt_multiply(matrix_element, secret_as_ntt[j]);
      add_to_ring_element(result[i1], product);
    }
    uint32_t start10 = 0U;
    uint32_t finish1 = v_COEFFICIENTS_IN_RING_ELEMENT;
    for (uint32_t i = start10; i < finish1; i++)
    {
      ...
      int32_t *uu____2 = result[i1];
      uu____2[j] = barrett_reduce(coefficient_normal_form + error_as_ntt_i[j]);
    }
  }
  int32_t **tt_as_ntt = result;
  ...
  KRML_CHECK_SIZE(sizeof (uint8_t), v_BYTES_PER_RING_ELEMENT);
  uint8_t out2[v_BYTES_PER_RING_ELEMENT];
  memset(out2, 0U, v_BYTES_PER_RING_ELEMENT * sizeof (uint8_t));
  uint32_t start4 = 0U;
  uint32_t finish4 = v_K;
  for (uint32_t i0 = start4; i0 < finish4; i0++)
  {
    uint32_t i1 = i0;
    int32_t *re = tt_as_ntt[i1];
    uint32_t f_start = i1 * v_BYTES_PER_RING_ELEMENT;
    uint32_t f_end = (i1 + 1U) * v_BYTES_PER_RING_ELEMENT;
    uint32_t len1 = f_end - f_start;
    uint8_t *buffer = out2 + f_start;
    t_nonempty_Slice__uint8_t uu____3 = { .buffer = buffer, .len = len1 };
    uint8_t serialized[384U] = { 0U };
    uint32_t start1 = 0U;
    uint32_t finish1 = 256U / 2U;
    for (uint32_t i = start1; i < finish1; i++)
    {
      uint32_t i3 = i;
      uint16_t coefficient1 = to_unsigned_representative(re[i3 * 2U + 0U]);
      uint16_t coefficient2 = to_unsigned_representative(re[i3 * 2U + 1U]);
      uint32_t m = 8U;
      ...
      uint16_t b10 = (uint32_t)a30 + ((uint32_t)mask & (uint32_t)pow2_bits0);
      serialized[3U * i3] = (uint8_t)b10;
      uint32_t m0 = 8U;
      ...
      a31 =
        ...
        & ((1U << m0) - 1U))
        - (uint32_t)pow2_bits1;
      uint16_t b11 = (uint32_t)a31 + ((uint32_t)mask0 & (uint32_t)pow2_bits1);
      serialized[3U * i3 + 1U] = (uint8_t)b11;
      uint32_t m1 = 8U;
      uint16_t pow2_bits = 256U;
      uint16_t pow2_bits_minus_one = 128U;
      uint16_t
      ...
      a3 =
        (((uint32_t)coefficient2 >> (uint32_t)(int32_t)4 & 255U) & ((1U << m1) - 1U))
        - (uint32_t)pow2_bits;
      uint16_t b12 = (uint32_t)a3 + ((uint32_t)mask1 & (uint32_t)pow2_bits);
      serialized[3U * i3 + 2U] = (uint8_t)b12;
    }
    t_nonempty_Slice__uint8_t uu____4 = { .buffer = serialized, .len = 384U };
    memcpy(uu____4.buffer, uu____3.buffer, uu____4.len * sizeof (uint8_t));
  }
  t_nonempty_Slice__uint8_t uu____5 = { .buffer = out2, .len = v_BYTES_PER_RING_ELEMENT };
  t_Range__uint32_t
  uu____6 =
    {
      .f_start1 = public_key_serialized.f_pointer,
      .f_end1 = public_key_serialized.f_pointer + uu____5.len
    };
  uint32_t f_start2 = uu____6.f_start1;
  uint32_t f_end2 = uu____6.f_end1;
  uint32_t len1 = f_end2 - f_start2;
  ...
  public_key_serialized1 =
    {
      ...
      .f_pointer = public_key_serialized.f_pointer + uu____5.len
    };
  t_Range__uint32_t
  uu____7 =
    {
  ...
  uint32_t f_start3 = uu____7.f_start1;
  uint32_t f_end3 = uu____7.f_end1;
  uint32_t len2 = f_end3 - f_start3;
  uint8_t *buffer3 = public_key_serialized1.f_value + f_start3;
  memcpy(seed_for_A.buffer,
    ((t_nonempty_Slice__uint8_t){ .buffer = buffer3, .len = len2 }).buffer,
    seed_for_A.len * sizeof (uint8_t));
  uint8_t *public_key_serialized2 = public_key_serialized1.f_value;
  KRML_CHECK_SIZE(sizeof (uint8_t), v_CPA_PRIVATE_KEY_SIZE);
  uint8_t out[v_CPA_PRIVATE_KEY_SIZE];
  memset(out, 0U, v_CPA_PRIVATE_KEY_SIZE * sizeof (uint8_t));
  uint32_t start = 0U;
  uint32_t finish = v_K;
  for (uint32_t i0 = start; i0 < finish; i0++)
  {
    uint32_t i1 = i0;
    int32_t *re = secret_as_ntt[i1];
    uint32_t f_start = i1 * v_BYTES_PER_RING_ELEMENT;
    uint32_t f_end = (i1 + 1U) * v_BYTES_PER_RING_ELEMENT;
    uint32_t len3 = f_end - f_start;
    uint8_t *buffer = out + f_start;
    t_nonempty_Slice__uint8_t uu____8 = { .buffer = buffer, .len = len3 };
    uint8_t serialized[384U] = { 0U };
    uint32_t start1 = 0U;
    uint32_t finish1 = 256U / 2U;
    for (uint32_t i = start1; i < finish1; i++)
    ...
    t_nonempty_Slice__uint8_t uu____9 = { .buffer = serialized, .len = 384U };
    memcpy(uu____9.buffer, uu____8.buffer, uu____9.len * sizeof (uint8_t));
  }
  uint8_t *secret_key_serialized = out;
  __Libcrux_Kem_Kyber_Types_t_PrivateKey___Libcrux_Kem_Kyber_Types_t_KyberPublicKey_Core_Option_t_Option__Libcrux_Kem_Kyber_Types_t_Error
  scrut0 =
    {
      .fst = {
...
uint8_t *Libcrux_Kem_Kyber_Kyber768_decapsulate_768_(uint8_t *secret_key, uint8_t *ciphertext)
{
  ...
  uint32_t l20 = 1248U;
  uint8_t *b20 = secret_key + 1152U;
  t_nonempty_Slice__uint8_t s10 = { .buffer = b10, .len = 1152U };
  ...
  uint32_t l21 = secret_key1.len - 1184U;
  uint8_t *b21 = secret_key1.buffer + 1184U;
  t_nonempty_Slice__uint8_t s11 = { .buffer = b11, .len = 1184U };
  ...
  KRML_CHECK_SIZE(sizeof (int32_t *), 3U);
  int32_t *u_as_ntt[3U];
  for (uint32_t _i = 0U; _i < 3U; ++_i)
    u_as_ntt[_i] = impl__PolynomialRingElement__ZERO;
  KRML_CHECK_SIZE(sizeof (int32_t *), 3U);
  int32_t *secret_as_ntt[3U];
  for (uint32_t _i = 0U; _i < 3U; ++_i)
    secret_as_ntt[_i] = impl__PolynomialRingElement__ZERO;
  uint32_t start0 = 0U;
  uint32_t finish0 = 960U / (v_COEFFICIENTS_IN_RING_ELEMENT * 10U / 8U);
  for (uint32_t i = start0; i < finish0; i++)
  {
    uint32_t i1 = i;
    uint32_t len = v_COEFFICIENTS_IN_RING_ELEMENT * 10U / 8U;
    uint8_t *u_buf = ciphertext + i1 * (v_COEFFICIENTS_IN_RING_ELEMENT * 10U / 8U);
    t_nonempty_Slice__uint8_t u_bytes = { .buffer = u_buf, .len = len };
    int32_t *u = deserialize_then_decompress_ring_element_u(10U, u_bytes);
    u_as_ntt[i1] = ntt_vector_u(u);
  }
  uint32_t len0 = 128U;
  uint8_t *subbuf0 = ciphertext + 960U;
  int32_t
  *v =
    deserialize_then_decompress_ring_element_v(4U,
      ((t_nonempty_Slice__uint8_t){ .buffer = subbuf0, .len = len0 }));
  uint32_t start2 = 0U;
  uint32_t finish2 = ind_cpa_secret_key.len / v_BYTES_PER_RING_ELEMENT;
  for (uint32_t i = start2; i < finish2; i++)
  {
    uint32_t i1 = i;
    uint32_t
    len = i1 * v_BYTES_PER_RING_ELEMENT + v_BYTES_PER_RING_ELEMENT - i1 * v_BYTES_PER_RING_ELEMENT;
    uint8_t *subbuf = ind_cpa_secret_key.buffer + i1 * v_BYTES_PER_RING_ELEMENT;
  ...
  int32_t *message = compute_message(3U, v, secret_as_ntt, u_as_ntt);
  uint8_t serialized[32U] = { 0U };
  uint32_t start3 = 0U;
  uint32_t finish3 = 256U / 8U;
  for (uint32_t i0 = start3; i0 < finish3; i0++)
  {
    uint32_t i1 = i0;
    uint32_t start1 = 0U;
    ...
    {
      uint32_t j = i;
      uint16_t coefficient = to_unsigned_representative(message[i1 * 8U + j]);
  ...
  uint32_t len1 = f_end - f_start2;
  uint8_t *buffer = out1 + f_start2;
  memcpy(implicit_rejection_value.buffer,
    ((t_nonempty_Slice__uint8_t){ .buffer = buffer, .len = len1 }).buffer,
    implicit_rejection_value.len * sizeof (uint8_t));
  uint8_t *to_hash1 = out1;
  uint32_t f_start = v_SHARED_SECRET_SIZE;
  memcpy(ciphertext, to_hash1 + f_start, 1088U * sizeof (uint8_t));
  uint8_t
  *implicit_rejection_shared_secret =
    v_PRF(32U,
      ((t_nonempty_Slice__uint8_t){ .buffer = to_hash1, .len = 1120U }));
  uint8_t
  *expected_ciphertext =
    encrypt(3U,
      1088U,
  ...
  for (uint32_t i = start; i < finish; i++)
  {
    ...
    out[i1] =
      (uint32_t)out[i1]
      |
        (((uint32_t)shared_secret.buffer[i1] & (uint32_t)mask)
        | ((uint32_t)implicit_rejection_shared_secret[i1] & (uint32_t)~mask));
  }
  return out;
}
