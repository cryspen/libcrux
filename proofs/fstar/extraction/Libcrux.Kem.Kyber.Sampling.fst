...
let sample_from_xof (v_K: usize) (seeds: t_Array (t_Array u8 (sz 34)) v_K) =
  ...
  in
  let xof_state:Libcrux.Kem.Kyber.Hash_functions.t_XofState v_K =
  ...
  in
  let xof_state:Libcrux.Kem.Kyber.Hash_functions.t_XofState v_K = new_state in
