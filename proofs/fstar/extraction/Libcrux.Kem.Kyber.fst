...
let generate_keypair
  ...
  let secret_key_serialized:t_Array u8 v_PRIVATE_KEY_SIZE =
    Libcrux.Kem.Kyber.Ind_cpa.serialize_secret_key v_PRIVATE_KEY_SIZE
      (Rust_primitives.unsize (Libcrux.Kem.Kyber.Types.impl_50__as_slice v_CPA_PRIVATE_KEY_SIZE
              ind_cpa_private_key
            <:
            t_Array u8 v_CPA_PRIVATE_KEY_SIZE)
        <:
        t_Slice u8)
      (Rust_primitives.unsize (Libcrux.Kem.Kyber.Types.impl_40__as_slice v_PUBLIC_KEY_SIZE
              public_key
            <:
...
let decapsulate
  ...
  let ind_cpa_secret_key, secret_key:(t_Slice u8 & t_Slice u8) =
    Libcrux.Kem.Kyber.Types.impl_30__split_at v_SECRET_KEY_SIZE secret_key v_CPA_SECRET_KEY_SIZE
  in
