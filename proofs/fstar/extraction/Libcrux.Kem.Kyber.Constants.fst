...
let v_BITS_PER_RING_ELEMENT: usize = normalize_term (v_COEFFICIENTS_IN_RING_ELEMENT *! sz 12)

let v_BYTES_PER_RING_ELEMENT: usize = normalize_term (v_BITS_PER_RING_ELEMENT /! sz 8)

let v_CPA_PKE_KEY_GENERATION_SEED_SIZE: usize = sz 32

let v_FIELD_MODULUS: i32 = 3329l

let v_H_DIGEST_SIZE: usize = normalize_term (
  Libcrux.Digest.digest_size (Libcrux.Digest.Algorithm_Sha3_256_ <: Libcrux.Digest.t_Algorithm))

let v_REJECTION_SAMPLING_SEED_SIZE: usize = normalize_term (sz 168 *! sz 5)
