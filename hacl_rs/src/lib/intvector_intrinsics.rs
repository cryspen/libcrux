...
#[inline(always)]
pub fn vec128_mul64(x0: vec128, x1: vec128) -> vec128 {
    unsafe {
        vreinterpretq_u32_u64(vmull_u32(
...
#[inline(always)]
pub fn vec128_and(x0: vec128, x2: vec128) -> vec128 {
    todo!()
}

pub fn vec128_add64(x0: vec128, x2: vec128) -> vec128 {
    todo!()
}
...
#[inline(always)]
pub fn vec128_load64(x: u64) -> vec128 {
    unsafe { vreinterpretq_u32_u64(vdupq_n_u64(x)) }
}
