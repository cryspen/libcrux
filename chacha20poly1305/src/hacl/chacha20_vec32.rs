...
#[inline]
fn chacha20_core_32(k: &mut [u32], ctx: &[u32], ctr: u32) {
...
#[inline]
fn chacha20_init_32(ctx: &mut [u32], k: &[u8], n: &[u8], ctr: u32) {
...
pub fn chacha20_encrypt_32(len: u32, out: &mut [u8], text: &[u8], key: &[u8], n: &[u8], ctr: u32) {
    let mut ctx: [u32; 16] = [0u32; 16usize];
    crate::hacl::chacha20_vec32::chacha20_init_32(&mut ctx, key, n, ctr);
    ...
    for i in 0u32..nb {
        ...
        crate::hacl::chacha20_vec32::chacha20_core_32(&mut k, &ctx, i);
    ...
    if rem1 > 0u32 {
        ...
        ((&mut plain)[0usize..rem as usize])
            .copy_from_slice(&(&text[nb.wrapping_mul(64u32) as usize..])[0usize..rem as usize]);
        let mut k: [u32; 16] = [0u32; 16usize];
        crate::hacl::chacha20_vec32::chacha20_core_32(&mut k, &ctx, nb);
        krml::unroll_for!(16, "i", 0u32, 1u32, {
            let u: u32 = lowstar::endianness::load32_le(&(&plain)[i.wrapping_mul(4u32) as usize..]);
            let x: u32 = u;
            let y: u32 = x ^ (&k)[i as usize];
            lowstar::endianness::store32_le(&mut (&mut plain)[i.wrapping_mul(4u32) as usize..], y)
        });
        (uu____2.1[0usize..rem as usize])
            .copy_from_slice(&(&(&plain)[0usize..])[0usize..rem as usize])
    }
}
...
pub fn chacha20_decrypt_32(
    ...
    if rem1 > 0u32 {
        ...
        let mut plain: [u8; 64] = [0u8; 64usize];
        ((&mut plain)[0usize..rem as usize])
            .copy_from_slice(&(&cipher[nb.wrapping_mul(64u32) as usize..])[0usize..rem as usize]);
        let mut k: [u32; 16] = [0u32; 16usize];
        crate::hacl::chacha20_vec32::chacha20_core_32(&mut k, &ctx, nb);
        krml::unroll_for!(16, "i", 0u32, 1u32, {
            let u: u32 = lowstar::endianness::load32_le(&(&plain)[i.wrapping_mul(4u32) as usize..]);
