...
assume
val impl_4': Core.Clone.t_Clone t_Bit

let impl_4 = impl_4'

[@@ FStar.Tactics.Typeclasses.tcinstance]
assume
val impl_3': Core.Marker.t_Copy t_Bit

let impl_3 = impl_3'

[@@ FStar.Tactics.Typeclasses.tcinstance]
assume
val impl_6': Core.Marker.t_StructuralPartialEq t_Bit

let impl_6 = impl_6'

[@@ FStar.Tactics.Typeclasses.tcinstance]
assume
val impl_7': Core.Cmp.t_PartialEq t_Bit t_Bit

let impl_7 = impl_7'

[@@ FStar.Tactics.Typeclasses.tcinstance]
assume
val impl_5': Core.Cmp.t_Eq t_Bit

let impl_5 = impl_5'

[@@ FStar.Tactics.Typeclasses.tcinstance]
assume
val impl_8': Core.Fmt.t_Debug t_Bit
...
[@@ FStar.Tactics.Typeclasses.tcinstance]
let impl_9: Core.Convert.t_From u8 t_Bit =
  {
    f_from_pre = (fun (bit: t_Bit) -> true);
...
[@@ FStar.Tactics.Typeclasses.tcinstance]
let impl_10: Core.Convert.t_From u16 t_Bit =
  {
    f_from_pre = (fun (bit: t_Bit) -> true);
...
[@@ FStar.Tactics.Typeclasses.tcinstance]
let impl_11: Core.Convert.t_From u32 t_Bit =
  {
    f_from_pre = (fun (bit: t_Bit) -> true);
...
[@@ FStar.Tactics.Typeclasses.tcinstance]
let impl_12: Core.Convert.t_From u64 t_Bit =
  {
    f_from_pre = (fun (bit: t_Bit) -> true);
...
[@@ FStar.Tactics.Typeclasses.tcinstance]
let impl_13: Core.Convert.t_From u128 t_Bit =
  {
    f_from_pre = (fun (bit: t_Bit) -> true);
...
[@@ FStar.Tactics.Typeclasses.tcinstance]
let impl_14: Core.Convert.t_From i8 t_Bit =
  {
    f_from_pre = (fun (bit: t_Bit) -> true);
...
[@@ FStar.Tactics.Typeclasses.tcinstance]
let impl_15: Core.Convert.t_From i16 t_Bit =
  {
    f_from_pre = (fun (bit: t_Bit) -> true);
...
[@@ FStar.Tactics.Typeclasses.tcinstance]
let impl_16: Core.Convert.t_From i32 t_Bit =
  {
    f_from_pre = (fun (bit: t_Bit) -> true);
...
[@@ FStar.Tactics.Typeclasses.tcinstance]
let impl_17: Core.Convert.t_From i64 t_Bit =
  {
    f_from_pre = (fun (bit: t_Bit) -> true);
...
[@@ FStar.Tactics.Typeclasses.tcinstance]
let impl_18: Core.Convert.t_From i128 t_Bit =
  {
    f_from_pre = (fun (bit: t_Bit) -> true);
...
let impl_Bit__and (self other: t_Bit) : t_Bit =
  match self, other <: (t_Bit & t_Bit) with
  | Bit_One , Bit_One  -> Bit_One <: t_Bit
  | _ -> Bit_Zero <: t_Bit

let impl_Bit__or (self other: t_Bit) : t_Bit =
  match self, other <: (t_Bit & t_Bit) with
  | Bit_Zero , Bit_Zero  -> Bit_Zero <: t_Bit
  | _ -> Bit_One <: t_Bit

let impl_Bit__xor (self other: t_Bit) : t_Bit =
  match self, other <: (t_Bit & t_Bit) with
  | Bit_Zero , Bit_Zero  | Bit_One , Bit_One  -> Bit_Zero <: t_Bit
  | _ -> Bit_One <: t_Bit

let full_adder (a b carry: t_Bit) : (t_Bit & t_Bit) =
  let sum:t_Bit = impl_Bit__xor (impl_Bit__xor a b <: t_Bit) carry in
  let carry_out:t_Bit =
    impl_Bit__or (impl_Bit__or (impl_Bit__and a b <: t_Bit) (impl_Bit__and a carry <: t_Bit)
        <:
        t_Bit)
      (impl_Bit__and b carry <: t_Bit)
  in
  sum, carry_out <: (t_Bit & t_Bit)
