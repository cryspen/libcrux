module Minicore.Core_arch.X86.Extra
...
let mm256_shuffle_epi8_i8_array
      (vector: Minicore.Abstractions.Bitvec.t_BitVec (mk_u64 256))
      (indexes: Minicore.Abstractions.Funarr.t_FunArray (mk_u64 32) i8)
    : Minicore.Abstractions.Bitvec.t_BitVec (mk_u64 256) =
  Minicore.Abstractions.Bitvec.impl_9__from_fn (mk_u64 256)
    (fun i ->
        let i:u64 = i in
...
let mm256_shuffle_epi8_i8
      ...
      (byte31 byte30 byte29 byte28 byte27 byte26 byte25 byte24 byte23 byte22 byte21 byte20 byte19 byte18 byte17 byte16 byte15 byte14 byte13 byte12 byte11 byte10 byte9 byte8 byte7 byte6 byte5 byte4 byte3 byte2 byte1 byte0:
          i8)
    : Minicore.Abstractions.Bitvec.t_BitVec (mk_u64 256) =
  let indexes:Minicore.Abstractions.Funarr.t_FunArray (mk_u64 32) i8 =
    Minicore.Abstractions.Funarr.impl_5__from_fn (mk_u64 32)
      #i8
      (fun i ->
          let i:u64 = i in
          match i <: u64 with
