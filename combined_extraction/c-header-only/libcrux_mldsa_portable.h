...
)
{
  ...
  core_option_Option_d9 signer_response0 = { core_option_None };
      ...
      )
      {
        ...
        )
        {
          ...
          if (!(ones_in_hint > LIBCRUX_ML_DSA_CONSTANTS_ML_DSA_44_MAX_ONES_IN_HINT))
          {
            ...
            signer_response0 = (core_option_Option_d9{ core_option_Some, mask });
...
)
{
  ...
  core_option_Option_2d signer_response0 = { core_option_None };
      ...
      )
      {
        ...
        )
        {
          ...
          if (!(ones_in_hint > LIBCRUX_ML_DSA_CONSTANTS_ML_DSA_87_MAX_ONES_IN_HINT))
          {
            ...
            signer_response0 = (core_option_Option_2d{ core_option_Some, mask });
