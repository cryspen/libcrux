...
static inline Eurydice_arr_c7 G(Eurydice_borrow_slice_u8 input)
{
...
static inline Eurydice_arr_ec H(Eurydice_borrow_slice_u8 input)
{
...
static KRML_MUSTINLINE Eurydice_arr_d6 from_i16_array(Eurydice_borrow_slice_i16 array)
{
  Eurydice_arr_d6 arr;
  memcpy(arr.data,
...
*/
static Eurydice_arr_d6 from_i16_array_b8(Eurydice_borrow_slice_i16 array)
{
  return from_i16_array(libcrux_secrets_int_classify_public_classify_ref_6d_39(array));
}

static KRML_MUSTINLINE Eurydice_arr_d6 zero(void)
{
  return
...
This function found in impl {libcrux_ml_kem::vector::traits::Operations for libcrux_ml_kem::vector::portable::vector_type::PortableVector}
*/
static Eurydice_arr_d6 ZERO_b8(void)
{
  return zero();
}

static KRML_MUSTINLINE Eurydice_arr_d6 add(Eurydice_arr_d6 lhs, const Eurydice_arr_d6 *rhs)
{
...
This function found in impl {libcrux_ml_kem::vector::traits::Operations for libcrux_ml_kem::vector::portable::vector_type::PortableVector}
*/
static Eurydice_arr_d6 add_b8(Eurydice_arr_d6 lhs, const Eurydice_arr_d6 *rhs)
{
  return add(lhs, rhs);
}

static KRML_MUSTINLINE Eurydice_arr_d6 sub(Eurydice_arr_d6 lhs, const Eurydice_arr_d6 *rhs)
{
  for (size_t i = (size_t)0U; i < LIBCRUX_ML_KEM_VECTOR_TRAITS_FIELD_ELEMENTS_IN_VECTOR; i++)
  {
    size_t i0 = i;
...
This function found in impl {libcrux_ml_kem::vector::traits::Operations for libcrux_ml_kem::vector::portable::vector_type::PortableVector}
*/
static Eurydice_arr_d6 sub_b8(Eurydice_arr_d6 lhs, const Eurydice_arr_d6 *rhs)
{
  return sub(lhs, rhs);
}

static KRML_MUSTINLINE Eurydice_arr_d6 multiply_by_constant(Eurydice_arr_d6 vec, int16_t c)
{
  for (size_t i = (size_t)0U; i < LIBCRUX_ML_KEM_VECTOR_TRAITS_FIELD_ELEMENTS_IN_VECTOR; i++)
  {
    size_t i0 = i;
...
This function found in impl {libcrux_ml_kem::vector::traits::Operations for libcrux_ml_kem::vector::portable::vector_type::PortableVector}
*/
static Eurydice_arr_d6 multiply_by_constant_b8(Eurydice_arr_d6 vec, int16_t c)
{
...
*/
static KRML_MUSTINLINE Eurydice_arr_d6 cond_subtract_3329(Eurydice_arr_d6 vec)
{
  for (size_t i = (size_t)0U; i < LIBCRUX_ML_KEM_VECTOR_TRAITS_FIELD_ELEMENTS_IN_VECTOR; i++)
  {
    size_t i0 = i;
...
This function found in impl {libcrux_ml_kem::vector::traits::Operations for libcrux_ml_kem::vector::portable::vector_type::PortableVector}
*/
static Eurydice_arr_d6 cond_subtract_3329_b8(Eurydice_arr_d6 v)
{
...
#define BARRETT_R ((int32_t)((uint32_t)1 << (uint32_t)BARRETT_SHIFT))
...
{
  int32_t t = libcrux_secrets_int_as_i32_f5(value) * BARRETT_MULTIPLIER + (BARRETT_R >> 1U);
  int16_t quotient = libcrux_secrets_int_as_i16_36(t >> (uint32_t)BARRETT_SHIFT);
  return value - quotient * LIBCRUX_ML_KEM_VECTOR_TRAITS_FIELD_MODULUS;
}

static KRML_MUSTINLINE Eurydice_arr_d6 barrett_reduce(Eurydice_arr_d6 vec)
{
  for (size_t i = (size_t)0U; i < LIBCRUX_ML_KEM_VECTOR_TRAITS_FIELD_ELEMENTS_IN_VECTOR; i++)
  {
    size_t i0 = i;
    int16_t vi = barrett_reduce_element(vec.data[i0]);
    vec.data[i0] = vi;
  }
  return vec;
}
...
This function found in impl {libcrux_ml_kem::vector::traits::Operations for libcrux_ml_kem::vector::portable::vector_type::PortableVector}
*/
static Eurydice_arr_d6 barrett_reduce_b8(Eurydice_arr_d6 vector)
{
...
static int16_t montgomery_reduce_element(int32_t value)
{
  ...
  int16_t c = libcrux_secrets_int_as_i16_36(k_times_modulus >> (uint32_t)MONTGOMERY_SHIFT);
  int16_t value_high = libcrux_secrets_int_as_i16_36(value >> (uint32_t)MONTGOMERY_SHIFT);
  return value_high - c;
}
...
*/
static KRML_MUSTINLINE int16_t montgomery_multiply_fe_by_fer(int16_t fe, int16_t fer)
{
  int32_t product = libcrux_secrets_int_as_i32_f5(fe) * libcrux_secrets_int_as_i32_f5(fer);
  return montgomery_reduce_element(product);
}

static KRML_MUSTINLINE Eurydice_arr_d6
montgomery_multiply_by_constant(Eurydice_arr_d6 vec, int16_t c)
{
  for (size_t i = (size_t)0U; i < LIBCRUX_ML_KEM_VECTOR_TRAITS_FIELD_ELEMENTS_IN_VECTOR; i++)
  {
    size_t i0 = i;
    vec.data[i0] = montgomery_multiply_fe_by_fer(vec.data[i0], c);
  }
  return vec;
}
...
This function found in impl {libcrux_ml_kem::vector::traits::Operations for libcrux_ml_kem::vector::portable::vector_type::PortableVector}
*/
static Eurydice_arr_d6
montgomery_multiply_by_constant_b8(Eurydice_arr_d6 vector, int16_t constant)
{
  return
    montgomery_multiply_by_constant(vector,
      libcrux_secrets_int_public_integers_classify_27_39(constant));
}

static KRML_MUSTINLINE Eurydice_arr_d6
bitwise_and_with_constant(Eurydice_arr_d6 vec, int16_t c)
{
  for (size_t i = (size_t)0U; i < LIBCRUX_ML_KEM_VECTOR_TRAITS_FIELD_ELEMENTS_IN_VECTOR; i++)
  {
    size_t i0 = i;
...
static KRML_MUSTINLINE Eurydice_arr_d6 to_unsigned_representative(Eurydice_arr_d6 a)
{
  Eurydice_arr_d6 t = shift_right_ef(a);
  Eurydice_arr_d6 fm = bitwise_and_with_constant(t, LIBCRUX_ML_KEM_VECTOR_TRAITS_FIELD_MODULUS);
  return add(a, &fm);
}
...
This function found in impl {libcrux_ml_kem::vector::traits::Operations for libcrux_ml_kem::vector::portable::vector_type::PortableVector}
*/
static Eurydice_arr_d6 to_unsigned_representative_b8(Eurydice_arr_d6 a)
{
...
static KRML_MUSTINLINE Eurydice_arr_d6 compress_1(Eurydice_arr_d6 a)
{
  for (size_t i = (size_t)0U; i < LIBCRUX_ML_KEM_VECTOR_TRAITS_FIELD_ELEMENTS_IN_VECTOR; i++)
  {
    size_t i0 = i;
    a.data[i0] =
      libcrux_secrets_int_as_i16_59(compress_message_coefficient(libcrux_secrets_int_as_u16_f5(a.data[i0])));
  }
  return a;
}
...
This function found in impl {libcrux_ml_kem::vector::traits::Operations for libcrux_ml_kem::vector::portable::vector_type::PortableVector}
*/
static Eurydice_arr_d6 compress_1_b8(Eurydice_arr_d6 a)
{
  return compress_1(a);
}

static KRML_MUSTINLINE uint32_t get_n_least_significant_bits(uint8_t n, uint32_t value)
{
...
static int16_t compress_ciphertext_coefficient(uint8_t coefficient_bits, uint16_t fe)
{
  ...
  compressed >>= 35U;
  return
    libcrux_secrets_int_as_i16_b8(get_n_least_significant_bits(coefficient_bits,
        libcrux_secrets_int_as_u32_a3(compressed)));
}

static KRML_MUSTINLINE Eurydice_arr_d6 decompress_1(Eurydice_arr_d6 a)
{
  Eurydice_arr_d6 z = zero();
  Eurydice_arr_d6 s = sub(z, &a);
  Eurydice_arr_d6 res = bitwise_and_with_constant(s, 1665);
  return res;
}
...
This function found in impl {libcrux_ml_kem::vector::traits::Operations for libcrux_ml_kem::vector::portable::vector_type::PortableVector}
*/
static Eurydice_arr_d6 decompress_1_b8(Eurydice_arr_d6 a)
{
  return decompress_1(a);
}

static KRML_MUSTINLINE void ntt_step(Eurydice_arr_d6 *vec, int16_t zeta, size_t i, size_t j)
{
  int16_t
  t =
    montgomery_multiply_fe_by_fer(vec->data[j],
...
{
  ntt_step(&vec, zeta0, (size_t)0U, (size_t)2U);
  ntt_step(&vec, zeta0, (size_t)1U, (size_t)3U);
  ntt_step(&vec, zeta1, (size_t)4U, (size_t)6U);
  ntt_step(&vec, zeta1, (size_t)5U, (size_t)7U);
  ntt_step(&vec, zeta2, (size_t)8U, (size_t)10U);
  ntt_step(&vec, zeta2, (size_t)9U, (size_t)11U);
  ntt_step(&vec, zeta3, (size_t)12U, (size_t)14U);
  ntt_step(&vec, zeta3, (size_t)13U, (size_t)15U);
  return vec;
}
...
static KRML_MUSTINLINE Eurydice_arr_d6
ntt_layer_2_step(Eurydice_arr_d6 vec, int16_t zeta0, int16_t zeta1)
{
  ntt_step(&vec, zeta0, (size_t)0U, (size_t)4U);
  ntt_step(&vec, zeta0, (size_t)1U, (size_t)5U);
  ntt_step(&vec, zeta0, (size_t)2U, (size_t)6U);
  ntt_step(&vec, zeta0, (size_t)3U, (size_t)7U);
  ntt_step(&vec, zeta1, (size_t)8U, (size_t)12U);
  ntt_step(&vec, zeta1, (size_t)9U, (size_t)13U);
  ntt_step(&vec, zeta1, (size_t)10U, (size_t)14U);
  ntt_step(&vec, zeta1, (size_t)11U, (size_t)15U);
  return vec;
}
...
This function found in impl {libcrux_ml_kem::vector::traits::Operations for libcrux_ml_kem::vector::portable::vector_type::PortableVector}
*/
static Eurydice_arr_d6 ntt_layer_2_step_b8(Eurydice_arr_d6 a, int16_t zeta0, int16_t zeta1)
{
  return ntt_layer_2_step(a, zeta0, zeta1);
}

static KRML_MUSTINLINE Eurydice_arr_d6 ntt_layer_3_step(Eurydice_arr_d6 vec, int16_t zeta)
{
  ntt_step(&vec, zeta, (size_t)0U, (size_t)8U);
  ntt_step(&vec, zeta, (size_t)1U, (size_t)9U);
  ntt_step(&vec, zeta, (size_t)2U, (size_t)10U);
  ntt_step(&vec, zeta, (size_t)3U, (size_t)11U);
  ntt_step(&vec, zeta, (size_t)4U, (size_t)12U);
  ntt_step(&vec, zeta, (size_t)5U, (size_t)13U);
  ntt_step(&vec, zeta, (size_t)6U, (size_t)14U);
  ntt_step(&vec, zeta, (size_t)7U, (size_t)15U);
  return vec;
}
...
This function found in impl {libcrux_ml_kem::vector::traits::Operations for libcrux_ml_kem::vector::portable::vector_type::PortableVector}
*/
static Eurydice_arr_d6 ntt_layer_3_step_b8(Eurydice_arr_d6 a, int16_t zeta)
{
  return ntt_layer_3_step(a, zeta);
}

static KRML_MUSTINLINE void
inv_ntt_step(Eurydice_arr_d6 *vec, int16_t zeta, size_t i, size_t j)
{
  int16_t a_minus_b = vec->data[j] - vec->data[i];
  int16_t a_plus_b = vec->data[j] + vec->data[i];
  int16_t o0 = barrett_reduce_element(a_plus_b);
  int16_t
  o1 =
    montgomery_multiply_fe_by_fer(a_minus_b,
      libcrux_secrets_int_public_integers_classify_27_39(zeta));
  vec->data[i] = o0;
  vec->data[j] = o1;
}
...
{
  inv_ntt_step(&vec, zeta0, (size_t)0U, (size_t)2U);
  inv_ntt_step(&vec, zeta0, (size_t)1U, (size_t)3U);
  inv_ntt_step(&vec, zeta1, (size_t)4U, (size_t)6U);
  inv_ntt_step(&vec, zeta1, (size_t)5U, (size_t)7U);
  inv_ntt_step(&vec, zeta2, (size_t)8U, (size_t)10U);
  inv_ntt_step(&vec, zeta2, (size_t)9U, (size_t)11U);
  inv_ntt_step(&vec, zeta3, (size_t)12U, (size_t)14U);
  inv_ntt_step(&vec, zeta3, (size_t)13U, (size_t)15U);
  return vec;
}
...
static KRML_MUSTINLINE Eurydice_arr_d6
inv_ntt_layer_2_step(Eurydice_arr_d6 vec, int16_t zeta0, int16_t zeta1)
{
  inv_ntt_step(&vec, zeta0, (size_t)0U, (size_t)4U);
  inv_ntt_step(&vec, zeta0, (size_t)1U, (size_t)5U);
  inv_ntt_step(&vec, zeta0, (size_t)2U, (size_t)6U);
  inv_ntt_step(&vec, zeta0, (size_t)3U, (size_t)7U);
  inv_ntt_step(&vec, zeta1, (size_t)8U, (size_t)12U);
  inv_ntt_step(&vec, zeta1, (size_t)9U, (size_t)13U);
  inv_ntt_step(&vec, zeta1, (size_t)10U, (size_t)14U);
  inv_ntt_step(&vec, zeta1, (size_t)11U, (size_t)15U);
  return vec;
}
...
This function found in impl {libcrux_ml_kem::vector::traits::Operations for libcrux_ml_kem::vector::portable::vector_type::PortableVector}
*/
static Eurydice_arr_d6 inv_ntt_layer_2_step_b8(Eurydice_arr_d6 a, int16_t zeta0, int16_t zeta1)
{
  return inv_ntt_layer_2_step(a, zeta0, zeta1);
}

static KRML_MUSTINLINE Eurydice_arr_d6 inv_ntt_layer_3_step(Eurydice_arr_d6 vec, int16_t zeta)
{
  inv_ntt_step(&vec, zeta, (size_t)0U, (size_t)8U);
  inv_ntt_step(&vec, zeta, (size_t)1U, (size_t)9U);
  inv_ntt_step(&vec, zeta, (size_t)2U, (size_t)10U);
  inv_ntt_step(&vec, zeta, (size_t)3U, (size_t)11U);
  inv_ntt_step(&vec, zeta, (size_t)4U, (size_t)12U);
  inv_ntt_step(&vec, zeta, (size_t)5U, (size_t)13U);
  inv_ntt_step(&vec, zeta, (size_t)6U, (size_t)14U);
  inv_ntt_step(&vec, zeta, (size_t)7U, (size_t)15U);
  return vec;
}
...
This function found in impl {libcrux_ml_kem::vector::traits::Operations for libcrux_ml_kem::vector::portable::vector_type::PortableVector}
*/
static Eurydice_arr_d6 inv_ntt_layer_3_step_b8(Eurydice_arr_d6 a, int16_t zeta)
{
...
)
{
  ...
  int16_t o1 = montgomery_reduce_element(ai_bj_aj_bi);
...
static KRML_MUSTINLINE Eurydice_array_u8x2 serialize_1(Eurydice_arr_d6 v)
{
  uint8_t
  result0 =
...
static Eurydice_array_u8x2 serialize_10(Eurydice_arr_d6 a)
{
  return libcrux_secrets_int_public_integers_declassify_d8_75(serialize_1(a));
}

/**
This function found in impl {libcrux_ml_kem::vector::traits::Operations for libcrux_ml_kem::vector::portable::vector_type::PortableVector}
*/
static Eurydice_array_u8x2 serialize_1_b8(Eurydice_arr_d6 a)
{
  return serialize_10(a);
}

static KRML_MUSTINLINE Eurydice_arr_d6 deserialize_1(Eurydice_borrow_slice_u8 v)
{
...
static Eurydice_arr_d6 deserialize_10(Eurydice_borrow_slice_u8 a)
{
  return deserialize_1(libcrux_secrets_int_classify_public_classify_ref_6d_90(a));
}

/**
This function found in impl {libcrux_ml_kem::vector::traits::Operations for libcrux_ml_kem::vector::portable::vector_type::PortableVector}
*/
static Eurydice_arr_d6 deserialize_1_b8(Eurydice_borrow_slice_u8 a)
{
  return deserialize_10(a);
}

static KRML_MUSTINLINE uint8_t_x4 serialize_4_int(Eurydice_borrow_slice_i16 v)
{
  uint8_t
  result0 =
...
static KRML_MUSTINLINE Eurydice_array_u8x8 serialize_4(Eurydice_arr_d6 v)
{
  uint8_t_x4
  result0_3 =
    serialize_4_int(Eurydice_array_to_subslice_shared_e7(&v,
...
static Eurydice_array_u8x8 serialize_40(Eurydice_arr_d6 a)
{
  return libcrux_secrets_int_public_integers_declassify_d8_52(serialize_4(a));
}

/**
This function found in impl {libcrux_ml_kem::vector::traits::Operations for libcrux_ml_kem::vector::portable::vector_type::PortableVector}
*/
static Eurydice_array_u8x8 serialize_4_b8(Eurydice_arr_d6 a)
{
  return serialize_40(a);
}

static KRML_MUSTINLINE int16_t_x8 deserialize_4_int(Eurydice_borrow_slice_u8 bytes)
{
...
static KRML_MUSTINLINE Eurydice_arr_d6 deserialize_4(Eurydice_borrow_slice_u8 bytes)
{
  int16_t_x8
  v0_7 =
    deserialize_4_int(Eurydice_slice_subslice_shared_c8(bytes,
...
static Eurydice_arr_d6 deserialize_40(Eurydice_borrow_slice_u8 a)
{
  return deserialize_4(libcrux_secrets_int_classify_public_classify_ref_6d_90(a));
}

/**
This function found in impl {libcrux_ml_kem::vector::traits::Operations for libcrux_ml_kem::vector::portable::vector_type::PortableVector}
*/
static Eurydice_arr_d6 deserialize_4_b8(Eurydice_borrow_slice_u8 a)
{
  return deserialize_40(a);
}

static KRML_MUSTINLINE uint8_t_x5 serialize_10_int(Eurydice_borrow_slice_i16 v)
{
...
static KRML_MUSTINLINE Eurydice_arr_fc serialize_100(Eurydice_arr_d6 v)
{
  uint8_t_x5
  r0_4 =
    serialize_10_int(Eurydice_array_to_subslice_shared_e7(&v,
        (KRML_CLITERAL(core_ops_range_Range_87){ .start = (size_t)0U, .end = (size_t)4U })));
  uint8_t_x5
  r5_9 =
    serialize_10_int(Eurydice_array_to_subslice_shared_e7(&v,
...
static Eurydice_arr_fc serialize_101(Eurydice_arr_d6 a)
{
  return libcrux_secrets_int_public_integers_declassify_d8_2b(serialize_100(a));
}

/**
This function found in impl {libcrux_ml_kem::vector::traits::Operations for libcrux_ml_kem::vector::portable::vector_type::PortableVector}
*/
static Eurydice_arr_fc serialize_10_b8(Eurydice_arr_d6 a)
{
  return serialize_101(a);
}

static KRML_MUSTINLINE int16_t_x8 deserialize_10_int(Eurydice_borrow_slice_u8 bytes)
{
  int16_t
  r0 =
...
static KRML_MUSTINLINE Eurydice_arr_d6 deserialize_100(Eurydice_borrow_slice_u8 bytes)
{
  int16_t_x8
  v0_7 =
    deserialize_10_int(Eurydice_slice_subslice_shared_c8(bytes,
...
static Eurydice_arr_d6 deserialize_101(Eurydice_borrow_slice_u8 a)
{
  return deserialize_100(libcrux_secrets_int_classify_public_classify_ref_6d_90(a));
}

/**
This function found in impl {libcrux_ml_kem::vector::traits::Operations for libcrux_ml_kem::vector::portable::vector_type::PortableVector}
*/
static Eurydice_arr_d6 deserialize_10_b8(Eurydice_borrow_slice_u8 a)
{
  return deserialize_101(a);
}

static KRML_MUSTINLINE uint8_t_x3 serialize_12_int(Eurydice_borrow_slice_i16 v)
{
  uint8_t r0 = libcrux_secrets_int_as_u8_f5(v.ptr[0U] & 255);
  uint8_t
  r1 =
...
static KRML_MUSTINLINE Eurydice_arr_94 serialize_12(Eurydice_arr_d6 v)
{
  uint8_t_x3
  r0_2 =
    serialize_12_int(Eurydice_array_to_subslice_shared_e7(&v,
...
static Eurydice_arr_94 serialize_120(Eurydice_arr_d6 a)
{
  return libcrux_secrets_int_public_integers_declassify_d8_40(serialize_12(a));
}

/**
This function found in impl {libcrux_ml_kem::vector::traits::Operations for libcrux_ml_kem::vector::portable::vector_type::PortableVector}
*/
static Eurydice_arr_94 serialize_12_b8(Eurydice_arr_d6 a)
{
  return serialize_120(a);
}

static KRML_MUSTINLINE int16_t_x2 deserialize_12_int(Eurydice_borrow_slice_u8 bytes)
{
...
static KRML_MUSTINLINE Eurydice_arr_d6 deserialize_12(Eurydice_borrow_slice_u8 bytes)
{
  int16_t_x2
  v0_1 =
    deserialize_12_int(Eurydice_slice_subslice_shared_c8(bytes,
...
static Eurydice_arr_d6 deserialize_120(Eurydice_borrow_slice_u8 a)
{
  return deserialize_12(libcrux_secrets_int_classify_public_classify_ref_6d_90(a));
}

/**
This function found in impl {libcrux_ml_kem::vector::traits::Operations for libcrux_ml_kem::vector::portable::vector_type::PortableVector}
*/
static Eurydice_arr_d6 deserialize_12_b8(Eurydice_borrow_slice_u8 a)
{
  return deserialize_120(a);
}

static KRML_MUSTINLINE size_t
rej_sample(Eurydice_borrow_slice_u8 a, Eurydice_mut_borrow_slice_i16 result)
{
...
This function found in impl {libcrux_ml_kem::vector::traits::Operations for libcrux_ml_kem::vector::portable::vector_type::PortableVector}
*/
static size_t rej_sample_b8(Eurydice_borrow_slice_u8 a, Eurydice_mut_borrow_slice_i16 out)
{
...
deserialize_to_uncompressed_ring_element_ea(Eurydice_borrow_slice_u8 serialized)
{
  ...
  for (size_t i = (size_t)0U; i < serialized.meta / (size_t)24U; i++)
  {
    ...
    Eurydice_arr_d6 uu____0 = deserialize_12_b8(bytes);
    re.data[i0] = uu____0;
  }
  return re;
}
...
deserialize_then_decompress_10_ea(Eurydice_borrow_slice_u8 serialized)
{
  ...
  for (size_t i = (size_t)0U; i < serialized.meta / (size_t)20U; i++)
  {
    ...
    Eurydice_arr_d6 coefficient = deserialize_10_b8(bytes);
...
{
  Eurydice_arr_d6 t = montgomery_multiply_by_constant_b8(b, zeta_r);
  b = sub_b8(a, &t);
  a = add_b8(a, &t);
  return
    (
...
static KRML_MUSTINLINE void ntt_at_layer_3_ea(size_t *zeta_i, Eurydice_arr_9e *re)
{
  for (size_t i = (size_t)0U; i < (size_t)16U; i++)
  {
    ...
    zeta_i[0U]++;
    Eurydice_arr_d6
    uu____0 = ntt_layer_3_step_b8(re->data[round], libcrux_ml_kem_polynomial_zeta(zeta_i[0U]));
...
static KRML_MUSTINLINE void ntt_at_layer_2_ea(size_t *zeta_i, Eurydice_arr_9e *re)
{
  for (size_t i = (size_t)0U; i < (size_t)16U; i++)
  {
    ...
    zeta_i[0U]++;
    re->data[round] =
      ntt_layer_2_step_b8(re->data[round],
        libcrux_ml_kem_polynomial_zeta(zeta_i[0U]),
...
static KRML_MUSTINLINE void ntt_at_layer_1_ea(size_t *zeta_i, Eurydice_arr_9e *re)
{
  for (size_t i = (size_t)0U; i < (size_t)16U; i++)
  {
    ...
    zeta_i[0U]++;
    re->data[round] =
      ntt_layer_1_step_b8(re->data[round],
        libcrux_ml_kem_polynomial_zeta(zeta_i[0U]),
        libcrux_ml_kem_polynomial_zeta(zeta_i[0U] + (size_t)1U),
...
static KRML_MUSTINLINE void poly_barrett_reduce_ea(Eurydice_arr_9e *myself)
{
  ...
  {
    size_t i0 = i;
    Eurydice_arr_d6 uu____0 = barrett_reduce_b8(myself->data[i0]);
...
deserialize_then_decompress_4_ea(Eurydice_borrow_slice_u8 serialized)
{
  ...
  for (size_t i = (size_t)0U; i < serialized.meta / (size_t)8U; i++)
  {
    ...
    Eurydice_arr_d6 coefficient = deserialize_4_b8(bytes);
...
ntt_multiply_ea(const Eurydice_arr_9e *myself, const Eurydice_arr_9e *rhs)
{
  ...
  for (size_t i = (size_t)0U; i < LIBCRUX_ML_KEM_POLYNOMIAL_VECTORS_IN_RING_ELEMENT; i++)
  {
    ...
    Eurydice_arr_d6
    uu____0 =
      ntt_multiply_b8(&myself->data[i0],
        &rhs->data[i0],
...
add_to_ring_element_68(Eurydice_arr_9e *myself, const Eurydice_arr_9e *rhs)
{
  ...
  {
    size_t i0 = i;
    Eurydice_arr_d6 uu____0 = add_b8(myself->data[i0], &rhs->data[i0]);
    myself->data[i0] = uu____0;
  }
}
...
static KRML_MUSTINLINE void invert_ntt_at_layer_1_ea(size_t *zeta_i, Eurydice_arr_9e *re)
{
  for (size_t i = (size_t)0U; i < (size_t)16U; i++)
  {
    ...
    zeta_i[0U]--;
    re->data[round] =
      inv_ntt_layer_1_step_b8(re->data[round],
        libcrux_ml_kem_polynomial_zeta(zeta_i[0U]),
        libcrux_ml_kem_polynomial_zeta(zeta_i[0U] - (size_t)1U),
        libcrux_ml_kem_polynomial_zeta(zeta_i[0U] - (size_t)2U),
        libcrux_ml_kem_polynomial_zeta(zeta_i[0U] - (size_t)3U));
...
static KRML_MUSTINLINE void invert_ntt_at_layer_2_ea(size_t *zeta_i, Eurydice_arr_9e *re)
{
  for (size_t i = (size_t)0U; i < (size_t)16U; i++)
  {
    ...
    zeta_i[0U]--;
    re->data[round] =
      inv_ntt_layer_2_step_b8(re->data[round],
        libcrux_ml_kem_polynomial_zeta(zeta_i[0U]),
        libcrux_ml_kem_polynomial_zeta(zeta_i[0U] - (size_t)1U));
    zeta_i[0U]--;
  }
...
static KRML_MUSTINLINE void invert_ntt_at_layer_3_ea(size_t *zeta_i, Eurydice_arr_9e *re)
{
  for (size_t i = (size_t)0U; i < (size_t)16U; i++)
  {
    ...
    zeta_i[0U]--;
    Eurydice_arr_d6
    uu____0 = inv_ntt_layer_3_step_b8(re->data[round], libcrux_ml_kem_polynomial_zeta(zeta_i[0U]));
    re->data[round] = uu____0;
  }
}
...
{
  Eurydice_arr_d6 a_minus_b = sub_b8(b, &a);
  a = barrett_reduce_b8(add_b8(a, &b));
  b = montgomery_multiply_by_constant_b8(a_minus_b, zeta_r);
  return
    (
      KRML_CLITERAL(libcrux_ml_kem_vector_portable_vector_type_PortableVector_x2){
        .fst = a,
...
subtract_reduce_ea(const Eurydice_arr_9e *myself, Eurydice_arr_9e b)
{
  ...
  {
    size_t i0 = i;
    Eurydice_arr_d6 coefficient_normal_form = montgomery_multiply_by_constant_b8(b.data[i0], 1441);
    Eurydice_arr_d6 diff = sub_b8(myself->data[i0], &coefficient_normal_form);
    Eurydice_arr_d6 red = barrett_reduce_b8(diff);
    b.data[i0] = red;
  }
  return b;
}
...
{
  return to_unsigned_representative_b8(a);
}
...
static KRML_MUSTINLINE Eurydice_arr_ec compress_then_serialize_message_ea(Eurydice_arr_9e re)
{
  ...
  for (size_t i = (size_t)0U; i < (size_t)16U; i++)
  {
    ...
    Eurydice_arr_d6 coefficient_compressed = compress_1_b8(coefficient);
    Eurydice_array_u8x2 bytes = serialize_1_b8(coefficient_compressed);
...
decrypt_unpacked_01(const Eurydice_arr_bb0 *secret_key, const Eurydice_arr_2b *ciphertext)
{
  ...
  Eurydice_arr_9e
  v =
    deserialize_then_decompress_ring_element_v_b6(Eurydice_array_to_subslice_from_shared_5f0(ciphertext,
        (size_t)960U));
...
deserialize_to_reduced_ring_element_ea(Eurydice_borrow_slice_u8 serialized)
{
  ...
  for (size_t i = (size_t)0U; i < serialized.meta / (size_t)24U; i++)
  {
    ...
    Eurydice_arr_d6 coefficient = deserialize_12_b8(bytes);
    Eurydice_arr_d6 uu____0 = cond_subtract_3329_b8(coefficient);
    re.data[i0] = uu____0;
  }
  return re;
}
  ...
  for (size_t i0 = (size_t)0U; i0 < (size_t)3U; i0++)
  {
    ...
    for (size_t i = (size_t)0U; i < (size_t)504U / (size_t)24U; i++)
    {
      ...
      if (sampled_coefficients->data[i1] < LIBCRUX_ML_KEM_CONSTANTS_COEFFICIENTS_IN_RING_ELEMENT)
      {
        size_t
        sampled =
          rej_sample_b8(Eurydice_array_to_subslice_shared_d45(&randomness->data[i1],
              (
                KRML_CLITERAL(core_ops_range_Range_87){
                  .start = r * (size_t)24U,
  ...
  for (size_t i0 = (size_t)0U; i0 < (size_t)3U; i0++)
  {
    ...
    for (size_t i = (size_t)0U; i < (size_t)168U / (size_t)24U; i++)
    {
      ...
      if (sampled_coefficients->data[i1] < LIBCRUX_ML_KEM_CONSTANTS_COEFFICIENTS_IN_RING_ELEMENT)
      {
        size_t
        sampled =
          rej_sample_b8(Eurydice_array_to_subslice_shared_d46(&randomness->data[i1],
              (
                KRML_CLITERAL(core_ops_range_Range_87){
                  .start = r * (size_t)24U,
                  .end = r * (size_t)24U + (size_t)24U
...
static KRML_MUSTINLINE Eurydice_arr_9e from_i16_array_ea(Eurydice_borrow_slice_i16 a)
{
  ...
  for (size_t i = (size_t)0U; i < LIBCRUX_ML_KEM_POLYNOMIAL_VECTORS_IN_RING_ELEMENT; i++)
  {
    ...
    Eurydice_arr_d6
    uu____0 =
      from_i16_array_b8(Eurydice_slice_subslice_shared_a6(a,
          (
            KRML_CLITERAL(core_ops_range_Range_87){
              .start = i0 * (size_t)16U,
...
- LEN= 128
*/
static inline Eurydice_arr_58 PRFxN_4a_3b(const Eurydice_arr_fd *input)
{
...
static KRML_MUSTINLINE void ntt_at_layer_7_ea(Eurydice_arr_9e *re)
{
  ...
  {
    size_t j = i;
    Eurydice_arr_d6 t = multiply_by_constant_b8(re->data[j + step], -1600);
    re->data[j + step] = sub_b8(re->data[j], &t);
    Eurydice_arr_d6 uu____1 = add_b8(re->data[j], &t);
    re->data[j] = uu____1;
  }
}
...
add_error_reduce_ea(Eurydice_arr_9e *myself, const Eurydice_arr_9e *error)
{
  for (size_t i = (size_t)0U; i < LIBCRUX_ML_KEM_POLYNOMIAL_VECTORS_IN_RING_ELEMENT; i++)
  {
    size_t j = i;
    Eurydice_arr_d6
    coefficient_normal_form = montgomery_multiply_by_constant_b8(myself->data[j], 1441);
    Eurydice_arr_d6 sum = add_b8(coefficient_normal_form, &error->data[j]);
    Eurydice_arr_d6 red = barrett_reduce_b8(sum);
    myself->data[j] = red;
  }
}
...
static KRML_MUSTINLINE Eurydice_arr_d6 compress_ef(Eurydice_arr_d6 a)
{
  for (size_t i = (size_t)0U; i < LIBCRUX_ML_KEM_VECTOR_TRAITS_FIELD_ELEMENTS_IN_VECTOR; i++)
  {
    ...
    int16_t
    uu____0 =
      libcrux_secrets_int_as_i16_f5(compress_ciphertext_coefficient((uint8_t)10,
...
static KRML_MUSTINLINE Eurydice_arr_b0 compress_then_serialize_10_e1(const Eurydice_arr_9e *re)
{
  ...
  for (size_t i = (size_t)0U; i < LIBCRUX_ML_KEM_POLYNOMIAL_VECTORS_IN_RING_ELEMENT; i++)
  {
    ...
    Eurydice_arr_fc bytes = serialize_10_b8(coefficient);
...
deserialize_then_decompress_message_ea(const Eurydice_arr_ec *serialized)
{
  ...
  for (size_t i = (size_t)0U; i < (size_t)16U; i++)
  {
    ...
    coefficient_compressed =
      deserialize_1_b8(Eurydice_array_to_subslice_shared_d4(serialized,
          (
            KRML_CLITERAL(core_ops_range_Range_87){
              .start = (size_t)2U * i0,
              .end = (size_t)2U * i0 + (size_t)2U
    ...
    Eurydice_arr_d6 uu____0 = decompress_1_b8(coefficient_compressed);
    re.data[i0] = uu____0;
  }
  return re;
}
...
)
{
  for (size_t i = (size_t)0U; i < LIBCRUX_ML_KEM_POLYNOMIAL_VECTORS_IN_RING_ELEMENT; i++)
  {
    size_t i0 = i;
    Eurydice_arr_d6
    coefficient_normal_form = montgomery_multiply_by_constant_b8(result.data[i0], 1441);
    Eurydice_arr_d6 sum1 = add_b8(myself->data[i0], &message->data[i0]);
    Eurydice_arr_d6 sum2 = add_b8(coefficient_normal_form, &sum1);
    Eurydice_arr_d6 red = barrett_reduce_b8(sum2);
    result.data[i0] = red;
  }
  return result;
}
...
static KRML_MUSTINLINE Eurydice_arr_d6 compress_d1(Eurydice_arr_d6 a)
{
  for (size_t i = (size_t)0U; i < LIBCRUX_ML_KEM_VECTOR_TRAITS_FIELD_ELEMENTS_IN_VECTOR; i++)
  {
    ...
    int16_t
    uu____0 =
      libcrux_secrets_int_as_i16_f5(compress_ciphertext_coefficient((uint8_t)4,
          libcrux_secrets_int_as_u16_f5(a.data[i0])));
    a.data[i0] = uu____0;
  }
  return a;
...
compress_then_serialize_4_ea(Eurydice_arr_9e re, Eurydice_mut_borrow_slice_u8 serialized)
{
  for (size_t i = (size_t)0U; i < LIBCRUX_ML_KEM_POLYNOMIAL_VECTORS_IN_RING_ELEMENT; i++)
  {
    ...
    Eurydice_array_u8x8 bytes = serialize_4_b8(coefficient);
...
*/
static KRML_MUSTINLINE Eurydice_arr_ec
decapsulate_fd(const Eurydice_arr_7d *private_key, const Eurydice_arr_2b *ciphertext)
{
...
{
  return decapsulate_fd(private_key, ciphertext);
}
...
encapsulate_99(const Eurydice_arr_5f *public_key, const Eurydice_arr_ec *randomness)
{
  Eurydice_arr_ec
...
{
  return encapsulate_99(public_key, randomness);
}
...
{
  return
    montgomery_multiply_by_constant_b8(vector,
...
serialize_uncompressed_ring_element_ea(const Eurydice_arr_9e *re)
{
  ...
  for (size_t i = (size_t)0U; i < LIBCRUX_ML_KEM_POLYNOMIAL_VECTORS_IN_RING_ELEMENT; i++)
  {
    size_t i0 = i;
    Eurydice_arr_d6 coefficient = to_unsigned_field_modulus_ea(re->data[i0]);
    Eurydice_arr_94 bytes = serialize_12_b8(coefficient);
...
- SECRET_KEY_SIZE= 2400
*/
static KRML_MUSTINLINE bool validate_private_key_only_52(const Eurydice_arr_7d *private_key)
{
  Eurydice_arr_ec
  t =
    H_4a_78(Eurydice_array_to_subslice_shared_d48(private_key,
        (
          KRML_CLITERAL(core_ops_range_Range_87){
...
- CIPHERTEXT_SIZE= 1088
*/
static KRML_MUSTINLINE bool validate_private_key_ba(const Eurydice_arr_7d *private_key)
{
  return validate_private_key_only_52(private_key);
}
...
- CIPHERTEXT_SIZE= 1088
*/
static KRML_MUSTINLINE bool validate_private_key_d3(const Eurydice_arr_7d *private_key)
{
  return validate_private_key_ba(private_key);
}
...
- SECRET_KEY_SIZE= 2400
*/
static KRML_MUSTINLINE bool validate_private_key_only_3b(const Eurydice_arr_7d *private_key)
{
  return validate_private_key_only_52(private_key);
}
...
- PUBLIC_KEY_SIZE= 1184
*/
static KRML_MUSTINLINE bool validate_public_key_b6(const Eurydice_arr_5f *public_key)
{
  Eurydice_arr_bb0
  deserialized_pk =
    deserialize_ring_elements_reduced_out_68(Eurydice_array_to_subslice_to_shared_210(public_key,
        libcrux_ml_kem_constants_ranked_bytes_per_ring_element((size_t)3U)));
  Eurydice_arr_5f
  public_key_serialized =
...
- PUBLIC_KEY_SIZE= 1184
*/
static KRML_MUSTINLINE bool validate_public_key_3b(const Eurydice_arr_5f *public_key)
{
  return validate_public_key_b6(public_key);
}
...
{
  return decapsulate_0c(key_pair, ciphertext);
}
...
{
  return encapsulate_a7(public_key, randomness);
}
...
{
  generate_keypair_b80(randomness, out);
}
...
{
  libcrux_ml_kem_mlkem768_portable_unpacked_MlKem768KeyPairUnpacked key_pair = default_7b_68();
...
{
  keys_from_private_key_01(private_key, key_pair);
}
...
*/
static KRML_MUSTINLINE void
serialized_private_key_mut_11_21(
...
*/
static KRML_MUSTINLINE Eurydice_arr_7d
serialized_private_key_11_21(
  const libcrux_ml_kem_mlkem768_portable_unpacked_MlKem768KeyPairUnpacked *self
)
{
  Eurydice_arr_7d sk = libcrux_ml_kem_types_default_d3_79();
  serialized_private_key_mut_11_21(self, &sk);
  return sk;
}
...
{
  return serialized_private_key_11_21(key_pair);
}
...
{
  serialized_private_key_mut_11_21(key_pair, serialized);
}
...
{
  return serialized_public_key_11_b6(key_pair);
}
...
*/
static KRML_MUSTINLINE void
serialized_public_key_mut_11_b6(
  const libcrux_ml_kem_mlkem768_portable_unpacked_MlKem768KeyPairUnpacked *self,
  Eurydice_arr_5f *serialized
)
{
  serialized_mut_dd_b6(&self->public_key, serialized);
}
...
{
  serialized_public_key_mut_11_b6(key_pair, serialized);
}
...
clone_d7_68(const libcrux_ml_kem_ind_cca_unpacked_MlKemPublicKeyUnpacked_51 *self)
{
  libcrux_ml_kem_ind_cpa_unpacked_IndCpaPublicKeyUnpacked_51
...
{
  libcrux_ml_kem_ind_cca_unpacked_MlKemPublicKeyUnpacked_51
  uu____0 = clone_d7_68(public_key_11_68(key_pair));
  pk[0U] = uu____0;
}
...
{
  serialized_mut_dd_b6(public_key, serialized);
}
...
{
  unpack_public_key_22(public_key, unpacked_public_key);
}
