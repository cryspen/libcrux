...
KRML_ATTRIBUTE_TARGET("avx2")
static KRML_MUSTINLINE Eurydice_arr_600
libcrux_ml_kem_sampling_sample_from_xof_28(const Eurydice_arr_810 *seeds)
{
...
KRML_ATTRIBUTE_TARGET("avx2")
static KRML_MUSTINLINE Eurydice_arr_58
libcrux_ml_kem_hash_functions_avx2_PRFxN_41_3b(const Eurydice_arr_fd *input)
{
...
KRML_ATTRIBUTE_TARGET("avx2")
static KRML_MUSTINLINE Eurydice_arr_600
libcrux_ml_kem_sampling_sample_from_xof_7e(const Eurydice_arr_810 *seeds)
{
  Eurydice_arr_eb sampled_coefficients = { .data = { 0U } };
  Eurydice_arr_b1
  out = { .data = { { .data = { 0U } }, { .data = { 0U } }, { .data = { 0U } } } };
