...
static inline void
libcrux_ml_dsa_simd_portable_arithmetic_barrett_reduce_simd_unit(Eurydice_arr_d4 *simd_unit)
{
  for (size_t i = (size_t)0U; i < (size_t)8U; i++)
  {
    size_t i0 = i;
...
*/
static inline void
libcrux_ml_dsa_simd_portable_barrett_reduce_simd_unit_65(Eurydice_arr_d4 *simd_unit)
{
...
*/
static KRML_MUSTINLINE void
libcrux_ml_dsa_polynomial_barrett_reduce_ff_37(Eurydice_arr_a4 *self)
{
  for (size_t i = (size_t)0U; i < (size_t)32U; i++)
  {
    size_t i0 = i;
