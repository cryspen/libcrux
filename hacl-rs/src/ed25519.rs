...
fn recover_x(x: &mut [u64], y: &[u64], sign: u64) -> bool {
    ...
    let res: bool = if b {
        ...
        if z == 0u8 {
            ...
            if !t0_is_0 {
                crate::ed25519::mul_modp_sqrt_m1(t0.0)
            };
...
fn point_mul_g(out: &mut [u64], scalar: &[u8]) {
    ...
    krml::unroll_for!(16, "i", 0u32, 1u32, {
        ...
        lowstar::ignore::ignore::<&[u64]>(&crate::ed25519_precomptable::precomp_g_pow2_64_table_w4);
        crate::ed25519::precomp_get_consttime(
        ...
        lowstar::ignore::ignore::<&[u64]>(&crate::ed25519_precomptable::precomp_basepoint_table_w4);
        crate::ed25519::precomp_get_consttime(
...
fn point_mul_g_double_vartime(out: &mut [u64], scalar1: &[u8], scalar2: &[u8], q2: &[u64]) {
    ...
    let a_bits_l: &[u64] = &(&crate::ed25519_precomptable::precomp_basepoint_table_w5)
    ...
    for i1 in 0u32..51u32 {
        ...
        let a_bits_l2: &[u64] = &(&crate::ed25519_precomptable::precomp_basepoint_table_w5)
...
fn sha512_pre_pre2_msg(hash: &mut [u8], prefix: &[u8], prefix2: &[u8], len: u32, input: &[u8]) {
    ...
    let st: &mut [crate::streaming_types::state_64] = &mut p;
    let err0: crate::streaming_types::error_code = crate::hash_sha2::update_512(st, prefix, 32u32);
    let err1: crate::streaming_types::error_code = crate::hash_sha2::update_512(st, prefix2, 32u32);
