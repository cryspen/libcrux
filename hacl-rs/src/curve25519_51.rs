...
#[inline(always)]
fn point_add_and_double(q: &[u64], p01_tmp1: &mut [u64]) {
    let nq_p1: (&mut [u64], &mut [u64]) = p01_tmp1.split_at_mut(10usize);
    let tmp1: (&mut [u64], &mut [u64]) = nq_p1.1.split_at_mut(10usize);
    let z2: (&[u64], &[u64]) = nq_p1.0.split_at(5usize);
    let dc: (&mut [u64], &mut [u64]) = tmp1.1.split_at_mut(10usize);
    let b: (&mut [u64], &mut [u64]) = dc.0.split_at_mut(5usize);
    crate::bignum25519_51::fadd(b.0, z2.0, z2.1);
    crate::bignum25519_51::fsub(b.1, z2.0, z2.1);
    let z31: (&mut [u64], &mut [u64]) = tmp1.0.split_at_mut(5usize);
    let c: (&mut [u64], &mut [u64]) = dc.1.split_at_mut(5usize);
    ...
    crate::bignum25519_51::fmul2(dc.1, &f1_copy, dc.0);
    let c1: (&[u64], &[u64]) = dc.1.split_at(5usize);
    crate::bignum25519_51::fadd(z31.0, c1.0, c1.1);
    crate::bignum25519_51::fsub(z31.1, c1.0, c1.1);
    crate::bignum25519_51::fsqr2(dc.1, dc.0);
    let mut f1_copy0: [u64; 10] = [0u64; 10usize];
    ((&mut f1_copy0)[0usize..10usize]).copy_from_slice(&tmp1.0[0usize..10usize]);
    crate::bignum25519_51::fsqr2(tmp1.0, &f1_copy0);
    let b1: (&mut [u64], &mut [u64]) = dc.0.split_at_mut(5usize);
    let c0: (&mut [u64], &mut [u64]) = dc.1.split_at_mut(5usize);
    ...
    crate::bignum25519_51::fmul2(nq_p1.0, dc.1, dc.0);
    ...
    crate::bignum25519_51::fmul(z310.1, &f1_copy2, q)
}

#[inline(always)]
fn point_double(nq: &mut [u64], tmp1: &mut [u64]) {
    ...
    crate::bignum25519_51::fmul2(nq, dc1.1, ab1.1)
}
...
fn montgomery_ladder(out: &mut [u64], key: &[u8], init: &[u64]) {
    ...
    crate::curve25519_51::point_add_and_double(init, p01_tmp11.1);
    swap.1[0usize] = 1u64;
    for i in 0u32..251u32 {
        ...
        let bit: u64 = ((key[253u32.wrapping_sub(i).wrapping_div(8u32) as usize])
            .wrapping_shr(253u32.wrapping_sub(i).wrapping_rem(8u32))
            & 1u8) as u64;
        let sw: u64 = swap1.1[0usize] ^ bit;
        crate::bignum25519_51::cswap2(sw, nq_p11.0, nq_p11.1);
        crate::curve25519_51::point_add_and_double(init, p01_tmp12.1);
        swap1.1[0usize] = bit
    }
    ...
    crate::curve25519_51::point_double(tmp1.0, tmp1.1);
    crate::curve25519_51::point_double(tmp1.0, tmp1.1);
    crate::curve25519_51::point_double(tmp1.0, tmp1.1);
...
#[inline(always)]
pub fn fsquare_times(o: &mut [u64], inp: &[u64], n: u32) {
    crate::bignum25519_51::fsqr(o, inp);
    for _i in 0u32..n.wrapping_sub(1u32) {
        let mut f1_copy: [u64; 5] = [0u64; 5usize];
        ((&mut f1_copy)[0usize..5usize]).copy_from_slice(&o[0usize..5usize]);
        crate::bignum25519_51::fsqr(o, &f1_copy)
    }
}

#[inline(always)]
pub fn finv(o: &mut [u64], i: &[u64]) {
    ...
    crate::curve25519_51::fsquare_times(b1.0, i, 1u32);
    crate::curve25519_51::fsquare_times(t01.1, b1.0, 2u32);
    crate::bignum25519_51::fmul(t01.0, t01.1, i);
    let mut f2_copy: [u64; 5] = [0u64; 5usize];
    ((&mut f2_copy)[0usize..5usize]).copy_from_slice(&b1.0[0usize..5usize]);
    crate::bignum25519_51::fmul(b1.0, t01.0, &f2_copy);
    crate::curve25519_51::fsquare_times(t01.1, b1.0, 1u32);
    let mut f2_copy0: [u64; 5] = [0u64; 5usize];
    ((&mut f2_copy0)[0usize..5usize]).copy_from_slice(&t01.0[0usize..5usize]);
    crate::bignum25519_51::fmul(t01.0, t01.1, &f2_copy0);
    crate::curve25519_51::fsquare_times(t01.1, t01.0, 5u32);
    let mut f2_copy1: [u64; 5] = [0u64; 5usize];
    ((&mut f2_copy1)[0usize..5usize]).copy_from_slice(&t01.0[0usize..5usize]);
    crate::bignum25519_51::fmul(t01.0, t01.1, &f2_copy1);
    ...
    crate::curve25519_51::fsquare_times(t010.1, c1.0, 10u32);
    crate::bignum25519_51::fmul(c1.1, t010.1, c1.0);
    crate::curve25519_51::fsquare_times(t010.1, c1.1, 20u32);
    let mut f1_copy: [u64; 5] = [0u64; 5usize];
    ((&mut f1_copy)[0usize..5usize]).copy_from_slice(&t010.1[0usize..5usize]);
    crate::bignum25519_51::fmul(t010.1, &f1_copy, c1.1);
    let mut i_copy: [u64; 5] = [0u64; 5usize];
    ((&mut i_copy)[0usize..5usize]).copy_from_slice(&t010.1[0usize..5usize]);
    crate::curve25519_51::fsquare_times(t010.1, &i_copy, 10u32);
    let mut f2_copy2: [u64; 5] = [0u64; 5usize];
    ((&mut f2_copy2)[0usize..5usize]).copy_from_slice(&c1.0[0usize..5usize]);
    crate::bignum25519_51::fmul(c1.0, t010.1, &f2_copy2);
    crate::curve25519_51::fsquare_times(t010.1, c1.0, 50u32);
    crate::bignum25519_51::fmul(c1.1, t010.1, c1.0);
...
fn encode_point(o: &mut [u8], i: &[u64]) {
    ...
    crate::curve25519_51::finv(&mut tmp, z.1);
    let mut f1_copy: [u64; 5] = [0u64; 5usize];
    ((&mut f1_copy)[0usize..5usize]).copy_from_slice(&(&tmp)[0usize..5usize]);
    crate::bignum25519_51::fmul(&mut tmp, &f1_copy, z.0);
...
pub fn ecdh(out: &mut [u8], r#priv: &[u8], r#pub: &[u8]) -> bool {
    ...
    krml::unroll_for!(32, "i", 0u32, 1u32, {
        let uu_0: u8 = fstar::uint8::eq_mask(out[i as usize], (&zeros)[i as usize]);
        (&mut res)[0usize] = uu_0 & (&res)[0usize]
    });
    let z: u8 = (&res)[0usize];
    let r: bool = z == 255u8;
    !r
