...
pub(crate) fn rejection_sample(uniform_bytes: &[u8]) -> (usize, [i16; 16]) {
    ...
    let count = unsafe {
        ...
        _mm_storeu_si128(sampled.as_mut_ptr() as *mut __m128i, lower_coefficients);
        ...
        _mm_storeu_si128(sampled.as_mut_ptr().offset(sampled_count as isize) as *mut __m128i, upper_coefficients);
