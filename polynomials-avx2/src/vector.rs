...
#[inline(always)]
fn to_i32_array(v: Vector) -> [i32; 8] {
    let mut out = [0i32; 8];
...
#[inline(always)]
fn from_i32_array(array: [i32; 8]) -> Vector {
    Vector {
...
#[inline(always)]
fn add_constant(mut v: Vector, c: i32) -> Vector {
...
#[inline(always)]
fn add(mut lhs: Vector, rhs: &Vector) -> Vector {
...
#[inline(always)]
fn sub(mut lhs: Vector, rhs: &Vector) -> Vector {
...
#[inline(always)]
fn multiply_by_constant(mut v: Vector, c: i32) -> Vector {
    let c = unsafe { _mm256_set1_epi32(c) };
...
#[inline(always)]
fn bitwise_and_with_constant(mut v: Vector, c: i32) -> Vector {
    let c = unsafe { _mm256_set1_epi32(c) };
...
#[inline(always)]
fn shift_right<const SHIFT_BY: i32>(mut v: Vector) -> Vector {
...
#[inline(always)]
fn shift_left<const SHIFT_BY: i32>(mut v: Vector) -> Vector {
...
#[inline(always)]
fn cond_subtract_3329(mut v: Vector) -> Vector {
    unsafe {
...
#[inline(always)]
fn barrett_reduce(v: Vector) -> Vector {
    let reduced = unsafe {
    ...
    Vector { elements: reduced }
}

#[inline(always)]
fn montgomery_reduce(v: Vector) -> Vector {
    let reduced = unsafe {
        let field_modulus = _mm256_set1_epi32(FIELD_MODULUS);
...
#[inline(always)]
fn compress_1(mut v: Vector) -> Vector {
    unsafe {
...
#[inline(always)]
fn compress<const COEFFICIENT_BITS: i32>(mut v: Vector) -> Vector {
...
#[inline(always)]
fn ntt_layer_1_step(v: Vector, zeta1: i32, zeta2: i32) -> Vector {
    let result = unsafe {
        ...
        let rhs = montgomery_reduce(Vector { elements: rhs }).elements;
...
#[inline(always)]
fn ntt_layer_2_step(v: Vector, zeta: i32) -> Vector {
    let result = unsafe {
...
#[inline(always)]
fn inv_ntt_layer_1_step(v: Vector, zeta1: i32, zeta2: i32) -> Vector {
    let result = unsafe {
        ...
        let products_reduced = montgomery_reduce(Vector { elements: products }).elements;
...
#[inline(always)]
fn inv_ntt_layer_2_step(v: Vector, zeta: i32) -> Vector {
    let result = unsafe {
...
#[inline(always)]
fn ntt_multiply(lhs: &Vector, rhs: &Vector, zeta0: i32, zeta1: i32) -> Vector {
    let result = unsafe {
        ...
        let right = montgomery_reduce(Vector { elements: left });
    ...
    montgomery_reduce(Vector { elements: result })
}

#[inline(always)]
fn serialize_1(v: Vector) -> u8 {
...
#[inline(always)]
fn serialize_4(mut v: Vector) -> [u8; 4] {
    let mut out = [0u8; 4];
...
#[inline(always)]
fn serialize_10(v: Vector) -> [u8; 10] {
    let mut out = [0u8; 16];
...
#[inline(always)]
fn serialize_11(v: Vector) -> [u8; 11] {
    let input = PortableVector::from_i32_array(to_i32_array(v));
    PortableVector::serialize_11(input)
}

#[inline(always)]
fn deserialize_11(v: &[u8]) -> Vector {
...
#[inline(always)]
fn serialize_12(v: Vector) -> [u8; 12] {
    let input = PortableVector::from_i32_array(to_i32_array(v));
