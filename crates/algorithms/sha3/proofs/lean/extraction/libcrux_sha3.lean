...
def rotate_left.spec (LEFT : i32) (RIGHT : i32) (x : u64) :
  ...
  contract := by hax_mvcgen [rotate_left] <;> sorry
}
...
def _vxarq_u64.spec (LEFT : i32) (RIGHT : i32) (a : u64) (b : u64) :
  ...
  pureRequires := by hax_construct_pure <;> sorry
  pureEnsures := by hax_construct_pure <;> sorry
  contract := by hax_mvcgen [_vxarq_u64] <;> sorry
}
...
namespace libcrux_sha3.simd.avx2

@[spec]
def rotate_left (LEFT : i32) (RIGHT : i32)
  ...
  (libcrux_intrinsics.avx2.mm256_xor_si256
    (← (libcrux_intrinsics.avx2.mm256_slli_epi64 (LEFT) x))
    (← (libcrux_intrinsics.avx2.mm256_srli_epi64 (RIGHT) x)))
...
def _veor5q_u64
    ...
    (d : (core_models.abstractions.bitvec.BitVec ((256 : u64))))
    (e : (core_models.abstractions.bitvec.BitVec ((256 : u64)))) :
    RustM (core_models.abstractions.bitvec.BitVec ((256 : u64))) := do
  let ab : (core_models.abstractions.bitvec.BitVec ((256 : u64))) ←
    (libcrux_intrinsics.avx2.mm256_xor_si256 a b);
  let cd : (core_models.abstractions.bitvec.BitVec ((256 : u64))) ←
    (libcrux_intrinsics.avx2.mm256_xor_si256 c d);
  let abcd : (core_models.abstractions.bitvec.BitVec ((256 : u64))) ←
    (libcrux_intrinsics.avx2.mm256_xor_si256 ab cd);
...
def _vbcaxq_u64
  ...
  (libcrux_intrinsics.avx2.mm256_xor_si256
    a
    (← (libcrux_intrinsics.avx2.mm256_andnot_si256 c b)))
...
def _veorq_n_u64
  ...
  let c : (core_models.abstractions.bitvec.BitVec ((256 : u64))) ←
    (libcrux_intrinsics.avx2.mm256_set1_epi64x
      (← (rust_primitives.hax.cast_op c : RustM i64)));
  (libcrux_intrinsics.avx2.mm256_xor_si256 a c)

end libcrux_sha3.simd.avx2
...
@[reducible] instance Impl.AssociatedTypes :
  ...
  (core_models.abstractions.bitvec.BitVec ((256 : u64)))
  ((4 : usize))
  where
...
instance Impl :
  ...
  xor5 :=
    fun
      ...
      (c : (core_models.abstractions.bitvec.BitVec ((256 : u64))))
      (d : (core_models.abstractions.bitvec.BitVec ((256 : u64))))
      (e : (core_models.abstractions.bitvec.BitVec ((256 : u64)))) => do
    (_veor5q_u64 a b c d e)
  rotate_left1_and_xor :=
    fun
      (a : (core_models.abstractions.bitvec.BitVec ((256 : u64))))
      (b : (core_models.abstractions.bitvec.BitVec ((256 : u64)))) => do
    (_vrax1q_u64 a b)
  xor_and_rotate :=
  ...
  and_not_xor :=
    fun
      (a : (core_models.abstractions.bitvec.BitVec ((256 : u64))))
      (b : (core_models.abstractions.bitvec.BitVec ((256 : u64))))
      (c : (core_models.abstractions.bitvec.BitVec ((256 : u64)))) => do
    (_vbcaxq_u64 a b c)
  xor_constant :=
    fun (a : (core_models.abstractions.bitvec.BitVec ((256 : u64)))) (c : u64)
      => do
    (_veorq_n_u64 a c)
  xor :=
    fun
...
def
  ...
  pureRequires := by hax_construct_pure <;> sorry
  pureEnsures := by hax_construct_pure <;> sorry
  contract := by hax_mvcgen [get_ij] <;> sorry
}
...
def store_block (RATE : usize)
    (s : (RustArray (core_models.abstractions.bitvec.BitVec ((256 : u64))) 25))
    (out0 : (RustSlice u8))
    (out1 : (RustSlice u8))
    (out2 : (RustSlice u8))
    (out3 : (RustSlice u8))
    ...
    (rust_primitives.hax.Tuple4
      ...
      (RustSlice u8))
    := do
  let chunks : usize ← (len /? (32 : usize));
  let ⟨out0, out1, out2, out3⟩ ←
    (rust_primitives.hax.folds.fold_range
      (0 : usize)
      chunks
      (fun ⟨out0, out1, out2, out3⟩ _ => (do (pure true) : RustM Bool))
      (rust_primitives.hax.Tuple4.mk out0 out1 out2 out3)
      (fun ⟨out0, out1, out2, out3⟩ i =>
        (do
        let i0 : usize ← ((← ((4 : usize) *? i)) /? (5 : usize));
        let j0 : usize ← ((← ((4 : usize) *? i)) %? (5 : usize));
        let i1 : usize ←
          ((← ((← ((4 : usize) *? i)) +? (1 : usize))) /? (5 : usize));
        let j1 : usize ←
          ((← ((← ((4 : usize) *? i)) +? (1 : usize))) %? (5 : usize));
        let i2 : usize ←
          ((← ((← ((4 : usize) *? i)) +? (2 : usize))) /? (5 : usize));
        let j2 : usize ←
          ((← ((← ((4 : usize) *? i)) +? (2 : usize))) %? (5 : usize));
        let i3 : usize ←
          ((← ((← ((4 : usize) *? i)) +? (3 : usize))) /? (5 : usize));
        let j3 : usize ←
          ((← ((← ((4 : usize) *? i)) +? (3 : usize))) %? (5 : usize));
        let v0l : (core_models.abstractions.bitvec.BitVec ((256 : u64))) ←
          (libcrux_intrinsics.avx2.mm256_permute2x128_si256 ((32 : i32))
            (← (libcrux_sha3.traits.get_ij
              ((4 : usize))
              (core_models.abstractions.bitvec.BitVec ((256 : u64))) s i0 j0))
            (← (libcrux_sha3.traits.get_ij
              ((4 : usize))
              (core_models.abstractions.bitvec.BitVec ((256 : u64))) s i2 j2)));
        let v1h : (core_models.abstractions.bitvec.BitVec ((256 : u64))) ←
          (libcrux_intrinsics.avx2.mm256_permute2x128_si256 ((32 : i32))
            (← (libcrux_sha3.traits.get_ij
              ((4 : usize))
              (core_models.abstractions.bitvec.BitVec ((256 : u64))) s i1 j1))
            (← (libcrux_sha3.traits.get_ij
              ((4 : usize))
              (core_models.abstractions.bitvec.BitVec ((256 : u64))) s i3 j3)));
        let v2l : (core_models.abstractions.bitvec.BitVec ((256 : u64))) ←
          (libcrux_intrinsics.avx2.mm256_permute2x128_si256 ((49 : i32))
            (← (libcrux_sha3.traits.get_ij
              ((4 : usize))
              (core_models.abstractions.bitvec.BitVec ((256 : u64))) s i0 j0))
            (← (libcrux_sha3.traits.get_ij
              ((4 : usize))
              (core_models.abstractions.bitvec.BitVec ((256 : u64))) s i2 j2)));
        let v3h : (core_models.abstractions.bitvec.BitVec ((256 : u64))) ←
          (libcrux_intrinsics.avx2.mm256_permute2x128_si256 ((49 : i32))
            (← (libcrux_sha3.traits.get_ij
              ((4 : usize))
              (core_models.abstractions.bitvec.BitVec ((256 : u64))) s i1 j1))
            (← (libcrux_sha3.traits.get_ij
              ((4 : usize))
              (core_models.abstractions.bitvec.BitVec ((256 : u64))) s i3 j3)));
        let v0 : (core_models.abstractions.bitvec.BitVec ((256 : u64))) ←
          (libcrux_intrinsics.avx2.mm256_unpacklo_epi64 v0l v1h);
        let v1 : (core_models.abstractions.bitvec.BitVec ((256 : u64))) ←
          (libcrux_intrinsics.avx2.mm256_unpackhi_epi64 v0l v1h);
        let v2 : (core_models.abstractions.bitvec.BitVec ((256 : u64))) ←
          (libcrux_intrinsics.avx2.mm256_unpacklo_epi64 v2l v3h);
        let v3 : (core_models.abstractions.bitvec.BitVec ((256 : u64))) ←
          (libcrux_intrinsics.avx2.mm256_unpackhi_epi64 v2l v3h);
        let out0 : (RustSlice u8) ←
          (rust_primitives.hax.monomorphized_update_at.update_at_range
            out0
            (core_models.ops.range.Range.mk
              (start := (← (start +? (← ((32 : usize) *? i)))))
              (_end := (← (start
                +? (← ((32 : usize) *? (← (i +? (1 : usize)))))))))
        ...
        let out3 : (RustSlice u8) ←
          (rust_primitives.hax.monomorphized_update_at.update_at_range
            ...
            (← (libcrux_intrinsics.avx2.mm256_storeu_si256_u8
              ...
              v3)));
        (pure (rust_primitives.hax.Tuple4.mk out0 out1 out2 out3)) :
        RustM
        (rust_primitives.hax.Tuple4
          (RustSlice u8)
          (RustSlice u8)
          (RustSlice u8)
          (RustSlice u8)))));
  let rem : usize ← (len %? (32 : usize));
  let ⟨out0, out1, out2, out3⟩ ←
    if (← (rem >? (0 : usize))) then do
      let start : usize ← (start +? (← ((32 : usize) *? chunks)));
      let u8s : (RustArray u8 32) ←
        (rust_primitives.hax.repeat (0 : u8) (32 : usize));
      let chunks8 : usize ← (rem /? (8 : usize));
      let ⟨out0, out1, out2, out3, u8s⟩ ←
        (rust_primitives.hax.folds.fold_range
          (0 : usize)
          chunks8
          (fun ⟨out0, out1, out2, out3, u8s⟩ _ => (do (pure true) : RustM Bool))
          (rust_primitives.hax.Tuple5.mk out0 out1 out2 out3 u8s)
          (fun ⟨out0, out1, out2, out3, u8s⟩ k =>
            (do
            let i : usize ←
              ((← ((← ((4 : usize) *? chunks)) +? k)) /? (5 : usize));
            let j : usize ←
              ((← ((← ((4 : usize) *? chunks)) +? k)) %? (5 : usize));
            let u8s : (RustArray u8 32) ←
              (libcrux_intrinsics.avx2.mm256_storeu_si256_u8
            ...
            (pure (rust_primitives.hax.Tuple5.mk out0 out1 out2 out3 u8s)) :
            RustM
            (rust_primitives.hax.Tuple5
              ...
              (RustSlice u8)
              (RustArray u8 32)))));
      let rem8 : usize ← (rem %? (8 : usize));
      if (← (rem8 >? (0 : usize))) then do
        let i : usize ←
          ((← ((← ((4 : usize) *? chunks)) +? chunks8)) /? (5 : usize));
        let j : usize ←
          ((← ((← ((4 : usize) *? chunks)) +? chunks8)) %? (5 : usize));
        let u8s : (RustArray u8 32) ←
          (libcrux_intrinsics.avx2.mm256_storeu_si256_u8
            ...
            (← (libcrux_sha3.traits.get_ij
              ((4 : usize))
              (core_models.abstractions.bitvec.BitVec ((256 : u64))) s i j)));
        let out0 : (RustSlice u8) ←
          (rust_primitives.hax.monomorphized_update_at.update_at_range
            out0
            (core_models.ops.range.Range.mk
              (start := (← ((← (start +? len)) -? rem8)))
              (_end := (← (start +? len))))
            (← (core_models.slice.Impl.copy_from_slice u8
              (← out0[
                (core_models.ops.range.Range.mk
...
def
  ...
  pureRequires := by hax_construct_pure <;> sorry
  pureEnsures := by hax_construct_pure <;> sorry
  contract := by hax_mvcgen [set_ij] <;> sorry
}
...
def load_block (RATE : usize)
    (state :
    (RustArray (core_models.abstractions.bitvec.BitVec ((256 : u64))) 25))
    (blocks : (RustArray (RustSlice u8) 4))
    (offset : usize) :
    RustM
    (RustArray (core_models.abstractions.bitvec.BitVec ((256 : u64))) 25)
    := do
  ...
  let
    ...
    (rust_primitives.hax.folds.fold_range
      ...
      (fun state i =>
        (do
        let start : usize ← (offset +? (← ((32 : usize) *? i)));
        let v0 : (core_models.abstractions.bitvec.BitVec ((256 : u64))) ←
        ...
        let v0l : (core_models.abstractions.bitvec.BitVec ((256 : u64))) ←
          (libcrux_intrinsics.avx2.mm256_unpacklo_epi64 v0 v1);
        let v1h : (core_models.abstractions.bitvec.BitVec ((256 : u64))) ←
          (libcrux_intrinsics.avx2.mm256_unpackhi_epi64 v0 v1);
        let v2l : (core_models.abstractions.bitvec.BitVec ((256 : u64))) ←
          (libcrux_intrinsics.avx2.mm256_unpacklo_epi64 v2 v3);
        let v3h : (core_models.abstractions.bitvec.BitVec ((256 : u64))) ←
          (libcrux_intrinsics.avx2.mm256_unpackhi_epi64 v2 v3);
        let v0 : (core_models.abstractions.bitvec.BitVec ((256 : u64))) ←
          (libcrux_intrinsics.avx2.mm256_permute2x128_si256 ((32 : i32))
            v0l
            v2l);
        ...
        (core_models.abstractions.bitvec.BitVec ((256 : u64)))
        25))));
  let rem : usize ← (RATE %? (32 : usize));
  let start : usize ←
    (offset +? (← ((32 : usize) *? (← (RATE /? (32 : usize))))));
  let u8s : (RustArray u8 32) ←
    (rust_primitives.hax.repeat (0 : u8) (32 : usize));
  let u8s : (RustArray u8 32) ←
    (rust_primitives.hax.monomorphized_update_at.update_at_range
  ...
  let u : (core_models.abstractions.bitvec.BitVec ((256 : u64))) ←
    (libcrux_intrinsics.avx2.mm256_loadu_si256_u8
      (← (core_models.array.Impl_23.as_slice u8 ((32 : usize)) u8s)));
  let i : usize ←
    ((← ((4 : usize) *? (← (RATE /? (32 : usize))))) /? (5 : usize));
  let j : usize ←
    ((← ((4 : usize) *? (← (RATE /? (32 : usize))))) %? (5 : usize));
  let
    state : (RustArray
    ...
    (libcrux_sha3.traits.set_ij
      ...
      (← (libcrux_intrinsics.avx2.mm256_xor_si256
        (← (libcrux_sha3.traits.get_ij
          ((4 : usize))
          (core_models.abstractions.bitvec.BitVec ((256 : u64))) state i j))
        u)));
  let
    state : (RustArray
    (core_models.abstractions.bitvec.BitVec ((256 : u64)))
    25) ←
    if (← (rem ==? (16 : usize))) then do
      let u8s : (RustArray u8 32) ←
        (rust_primitives.hax.repeat (0 : u8) (32 : usize));
      let u8s : (RustArray u8 32) ←
        (rust_primitives.hax.monomorphized_update_at.update_at_range
...
def load_last (RATE : usize) (DELIMITER : u8)
    ...
    (RustArray (core_models.abstractions.bitvec.BitVec ((256 : u64))) 25)
    := do
  let buffers : (RustArray (RustArray u8 RATE) 4) ←
  ...
  let buffers : (RustArray (RustArray u8 RATE) 4) ←
    (rust_primitives.hax.folds.fold_range
      (0 : usize)
      (4 : usize)
      (fun buffers _ => (do (pure true) : RustM Bool))
      buffers
      (fun buffers i =>
        (do
        let buffers : (RustArray (RustArray u8 RATE) 4) ←
        ...
        let buffers : (RustArray (RustArray u8 RATE) 4) ←
          (rust_primitives.hax.monomorphized_update_at.update_at_usize
            ...
            (← (rust_primitives.hax.monomorphized_update_at.update_at_usize
              (← buffers[i]_?)
              (← (RATE -? (1 : usize)))
              (← ((← (← buffers[i]_?)[(← (RATE -? (1 : usize)))]_?)
                |||? (128 : u8))))));
        (pure buffers) :
        RustM (RustArray (RustArray u8 RATE) 4))));
  let
    state : (RustArray
    (core_models.abstractions.bitvec.BitVec ((256 : u64)))
    25) ←
    (load_block (RATE)
      state
      (RustArray.ofVec #v[(← (rust_primitives.unsize
                              (← buffers[(0 : usize)]_?))),
...
def
  ...
  pureRequires := by hax_construct_pure <;> sorry
  pureEnsures := by hax_construct_pure <;> sorry
  contract := by hax_mvcgen [Impl_2.set] <;> sorry
}
...
def
  ...
  pureRequires := by hax_construct_pure <;> sorry
  pureEnsures := by hax_construct_pure <;> sorry
  contract := by hax_mvcgen [Impl_2.iota] <;> sorry
}
...
--
--  Store blocks `N = 4`
class Squeeze4.AssociatedTypes (Self : Type) (T : Type) where
  [trait_constr_Squeeze4_i0 : KeccakItem.AssociatedTypes T ((4 : usize))]

attribute [instance_reducible, instance]
  Squeeze4.AssociatedTypes.trait_constr_Squeeze4_i0

class Squeeze4 (Self : Type) (T : Type)
  [associatedTypes : outParam (Squeeze4.AssociatedTypes (Self : Type) (T :
      Type))]
  where
  [trait_constr_Squeeze4_i0 : KeccakItem T ((4 : usize))]
  squeeze4 (Self) (T) (RATE : usize) :
    (Self ->
    (RustSlice u8) ->
    (RustSlice u8) ->
    (RustSlice u8) ->
    ...
    usize ->
    usize ->
    RustM (rust_primitives.hax.Tuple4
      (RustSlice u8)
      (RustSlice u8)
      (RustSlice u8)
      (RustSlice u8)))

attribute [instance_reducible, instance] Squeeze4.trait_constr_Squeeze4_i0
...
@[reducible] instance Impl_2.AssociatedTypes :
  libcrux_sha3.traits.Squeeze4.AssociatedTypes
...
instance Impl_2 :
  ...
  squeeze4 :=
    ...
    let out2 : (RustSlice u8) := tmp2;
    let out3 : (RustSlice u8) := tmp3;
...
namespace libcrux_sha3.generic_keccak.simd256
...
def Impl.squeeze_next_block (RATE : usize)
  ...
  let
    ...
    (libcrux_sha3.generic_keccak.Impl_2.keccakf1600
      ((4 : usize))
      (core_models.abstractions.bitvec.BitVec ((256 : u64))) self);
  let ⟨tmp0, tmp1, tmp2, tmp3⟩ ←
    (libcrux_sha3.traits.Squeeze4.squeeze4
      (libcrux_sha3.generic_keccak.KeccakState
        ((4 : usize))
        (core_models.abstractions.bitvec.BitVec ((256 : u64))))
      (core_models.abstractions.bitvec.BitVec ((256 : u64))) (RATE)
      self
      out0
      out1
      out2
  ...
  let out3 : (RustSlice u8) := tmp3;
  let _ := rust_primitives.hax.Tuple0.mk;
  (pure (rust_primitives.hax.Tuple5.mk self out0 out1 out2 out3))
...
end libcrux_sha3.generic_keccak.simd256
  ...
  (hax_lib.prop.constructors.forall
    (fun i =>
      ...
      (hax_lib.prop.constructors.implies
        (← (hax_lib.prop.constructors.from_bool (← (i <? N))))
        (← (hax_lib.prop.constructors.from_bool
          (← ((← (core_models.slice.Impl.len u8 (← slices[(0 : usize)]_?)))
            ==? (← (core_models.slice.Impl.len u8 (← slices[i]_?)))))))) :
...
def
  ...
  pureRequires := by hax_construct_pure <;> sorry
  pureEnsures := by hax_construct_pure <;> sorry
  contract := by hax_mvcgen [load_block] <;> sorry
}
...
def
  ...
  pureRequires := by hax_construct_pure <;> sorry
  pureEnsures := by hax_construct_pure <;> sorry
  contract := by hax_mvcgen [load_last] <;> sorry
}
...
def
  ...
  pureRequires := by hax_construct_pure <;> sorry
  pureEnsures := by hax_construct_pure <;> sorry
  contract := by hax_mvcgen [store_block] <;> sorry
}
  ...
  load_block :=
    fun (RATE : usize)
      ...
      (libcrux_sha3.generic_keccak.KeccakState
        ((4 : usize))
        (core_models.abstractions.bitvec.BitVec ((256 : u64)))))
      (input : (RustArray (RustSlice u8) 4))
      (start : usize) => do
    let
      self : (libcrux_sha3.generic_keccak.KeccakState
        ((4 : usize))
...
def
  ...
  pureRequires := by hax_construct_pure <;> sorry
  pureEnsures := by hax_construct_pure <;> sorry
  contract := by hax_mvcgen [Impl_2.absorb_block] <;> sorry
}
...
def
  ...
  pureRequires := by hax_construct_pure <;> sorry
  pureEnsures := by hax_construct_pure <;> sorry
  contract := by hax_mvcgen [Impl_2.absorb_final] <;> sorry
}
...
@[spec]
def keccak4 (RATE : usize) (DELIM : u8)
    (data : (RustArray (RustSlice u8) 4))
    (out0 : (RustSlice u8))
    (out1 : (RustSlice u8))
    (out2 : (RustSlice u8))
    (out3 : (RustSlice u8)) :
      ...
      let _ ←
        (hax_lib.assert
          (← ((← ((← ((← (core_models.slice.Impl.len u8 out0))
              ...
              &&? (← ((← (core_models.slice.Impl.len u8 out0))
                ==? (← (core_models.slice.Impl.len u8 out2))))))
            &&? (← ((← (core_models.slice.Impl.len u8 out0))
              ==? (← (core_models.slice.Impl.len u8 out3)))))));
      (pure rust_primitives.hax.Tuple0.mk)
    else do
      (pure rust_primitives.hax.Tuple0.mk);
  let _ ←
    if true then do
        ...
        (hax_lib.assert
          (← ((← ((← ((← (core_models.slice.Impl.len u8
              ...
              &&? (← ((← (core_models.slice.Impl.len u8
                ...
                ==? (← (core_models.slice.Impl.len u8
                  (← data[(2 : usize)]_?)))))))
            &&? (← ((← (core_models.slice.Impl.len u8 (← data[(0 : usize)]_?)))
              ==? (← (core_models.slice.Impl.len u8
                (← data[(3 : usize)]_?))))))));
      (pure rust_primitives.hax.Tuple0.mk)
    else do
      (pure rust_primitives.hax.Tuple0.mk);
  let
    s : (libcrux_sha3.generic_keccak.KeccakState
      ((4 : usize))
      (core_models.abstractions.bitvec.BitVec ((256 : u64)))) ←
    (libcrux_sha3.generic_keccak.Impl_2.new
      ((4 : usize))
      (core_models.abstractions.bitvec.BitVec ((256 : u64)))
  ...
  let
    ...
    (libcrux_sha3.generic_keccak.Impl_2.absorb_final
      ...
      (core_models.abstractions.bitvec.BitVec ((256 : u64)))
      (RATE)
      (DELIM) s data (← (data_len -? rem)) rem);
  let outlen : usize ← (core_models.slice.Impl.len u8 out0);
  let blocks : usize ← (outlen /? RATE);
  let last : usize ← (outlen -? (← (outlen %? RATE)));
  let ⟨out0, out1, out2, out3, s⟩ ←
    if (← (blocks ==? (0 : usize))) then do
      ...
      let out3 : (RustSlice u8) := tmp3;
      let _ := rust_primitives.hax.Tuple0.mk;
      (pure (rust_primitives.hax.Tuple5.mk out0 out1 out2 out3 s))
    else do
      let ⟨tmp0, tmp1, tmp2, tmp3⟩ ←
        (libcrux_sha3.traits.Squeeze4.squeeze4
          (libcrux_sha3.generic_keccak.KeccakState
      ...
      let ⟨out0, out1, out2, out3, s⟩ ←
        (rust_primitives.hax.folds.fold_range
          (1 : usize)
          blocks
          (fun ⟨out0, out1, out2, out3, s⟩ _ => (do (pure true) : RustM Bool))
          (rust_primitives.hax.Tuple5.mk out0 out1 out2 out3 s)
          (fun ⟨out0, out1, out2, out3, s⟩ i =>
            (do
            let
              s : (libcrux_sha3.generic_keccak.KeccakState
                ((4 : usize))
              ...
              (libcrux_sha3.generic_keccak.Impl_2.keccakf1600
                ((4 : usize))
                (core_models.abstractions.bitvec.BitVec ((256 : u64))) s);
            let ⟨tmp0, tmp1, tmp2, tmp3⟩ ←
              (libcrux_sha3.traits.Squeeze4.squeeze4
                (libcrux_sha3.generic_keccak.KeccakState
                  ((4 : usize))
...
def
  ...
  pureRequires := by hax_construct_pure <;> sorry
  pureEnsures := by hax_construct_pure <;> sorry
  contract := by hax_mvcgen [Impl.squeeze_next_block] <;> sorry
}
...
def
  ...
  pureRequires := by hax_construct_pure <;> sorry
  pureEnsures := by hax_construct_pure <;> sorry
  contract := by hax_mvcgen [Impl.squeeze_first_block] <;> sorry
}
...
def
  ...
  pureRequires := by hax_construct_pure <;> sorry
  pureEnsures := by hax_construct_pure <;> sorry
  contract := by hax_mvcgen [Impl.squeeze_first_three_blocks] <;> sorry
}
...
def
  ...
  pureRequires := by hax_construct_pure <;> sorry
  pureEnsures := by hax_construct_pure <;> sorry
  contract := by hax_mvcgen [Impl.squeeze_first_five_blocks] <;> sorry
}
...
def
  ...
  pureRequires := by hax_construct_pure <;> sorry
  pureEnsures := by hax_construct_pure <;> sorry
  contract := by hax_mvcgen [Impl.new] <;> sorry
}
...
def
  ...
  pureRequires := by hax_construct_pure <;> sorry
  pureEnsures := by hax_construct_pure <;> sorry
  contract := by hax_mvcgen [Impl.fill_buffer] <;> sorry
}
...
def
  ...
  pureRequires := by hax_construct_pure <;> sorry
  pureEnsures := by hax_construct_pure <;> sorry
  contract := by hax_mvcgen [Impl_1.squeeze] <;> sorry
}
...
def
  ...
  pureRequires := by hax_construct_pure <;> sorry
  pureEnsures := by hax_construct_pure <;> sorry
  contract := by hax_mvcgen [Impl.absorb_full] <;> sorry
}
...
def
  ...
  pureRequires := by hax_construct_pure <;> sorry
  pureEnsures := by hax_construct_pure <;> sorry
  contract := by hax_mvcgen [Impl.absorb] <;> sorry
}
...
def
  ...
  pureRequires := by hax_construct_pure <;> sorry
  pureEnsures := by hax_construct_pure <;> sorry
  contract := by hax_mvcgen [Impl.absorb_final] <;> sorry
}
...
def
  ...
  pureRequires := by hax_construct_pure <;> sorry
  pureEnsures := by hax_construct_pure <;> sorry
  contract := by hax_mvcgen [keccak1] <;> sorry
}
...
def sha224_ema.spec (digest : (RustSlice u8)) (payload : (RustSlice u8)) :
  ...
  pureRequires := by hax_construct_pure <;> sorry
  pureEnsures := by hax_construct_pure <;> sorry
  contract := by hax_mvcgen [sha224_ema] <;> sorry
}
...
def sha224.spec (data : (RustSlice u8)) :
  ...
  pureRequires := by hax_construct_pure <;> sorry
  pureEnsures := by hax_construct_pure <;> sorry
  contract := by hax_mvcgen [sha224] <;> sorry
}
...
def sha256_ema.spec (digest : (RustSlice u8)) (payload : (RustSlice u8)) :
  ...
  pureRequires := by hax_construct_pure <;> sorry
  pureEnsures := by hax_construct_pure <;> sorry
  contract := by hax_mvcgen [sha256_ema] <;> sorry
}
...
def sha256.spec (data : (RustSlice u8)) :
  ...
  pureRequires := by hax_construct_pure <;> sorry
  pureEnsures := by hax_construct_pure <;> sorry
  contract := by hax_mvcgen [sha256] <;> sorry
}
...
def sha384_ema.spec (digest : (RustSlice u8)) (payload : (RustSlice u8)) :
  ...
  pureRequires := by hax_construct_pure <;> sorry
  pureEnsures := by hax_construct_pure <;> sorry
  contract := by hax_mvcgen [sha384_ema] <;> sorry
}
...
def sha384.spec (data : (RustSlice u8)) :
  ...
  pureRequires := by hax_construct_pure <;> sorry
  pureEnsures := by hax_construct_pure <;> sorry
  contract := by hax_mvcgen [sha384] <;> sorry
}
      ...
      (hash (LEN : usize) (algorithm : Algorithm) (payload : (RustSlice u8))) :=
{
  pureRequires := by hax_construct_pure <;> sorry
  pureEnsures := by hax_construct_pure <;> sorry
  contract := by hax_mvcgen [hash] <;> sorry
}
...
def sha512_ema.spec (digest : (RustSlice u8)) (payload : (RustSlice u8)) :
  ...
  pureRequires := by hax_construct_pure <;> sorry
  pureEnsures := by hax_construct_pure <;> sorry
  contract := by hax_mvcgen [sha512_ema] <;> sorry
}
...
def sha512.spec (data : (RustSlice u8)) :
  ...
  pureRequires := by hax_construct_pure <;> sorry
  pureEnsures := by hax_construct_pure <;> sorry
  contract := by hax_mvcgen [sha512] <;> sorry
}
...
def
  ...
  pureRequires := by hax_construct_pure <;> sorry
  pureEnsures := by hax_construct_pure <;> sorry
  contract := by hax_mvcgen [shake128_absorb_final] <;> sorry
}
...
def
  ...
  pureRequires := by hax_construct_pure <;> sorry
  pureEnsures := by hax_construct_pure <;> sorry
  contract := by hax_mvcgen [shake128_squeeze_first_three_blocks] <;> sorry
}
...
def
  ...
  pureRequires := by hax_construct_pure <;> sorry
  pureEnsures := by hax_construct_pure <;> sorry
  contract := by hax_mvcgen [shake128_squeeze_first_five_blocks] <;> sorry
}
...
def
  ...
  pureRequires := by hax_construct_pure <;> sorry
  pureEnsures := by hax_construct_pure <;> sorry
  contract := by hax_mvcgen [shake128_squeeze_next_block] <;> sorry
}
...
def
  ...
  pureRequires := by hax_construct_pure <;> sorry
  pureEnsures := by hax_construct_pure <;> sorry
  contract := by hax_mvcgen [shake256_absorb_final] <;> sorry
}
...
def
  ...
  pureRequires := by hax_construct_pure <;> sorry
  pureEnsures := by hax_construct_pure <;> sorry
  contract := by hax_mvcgen [shake256_squeeze_first_block] <;> sorry
}
...
def
  ...
  pureRequires := by hax_construct_pure <;> sorry
  pureEnsures := by hax_construct_pure <;> sorry
  contract := by hax_mvcgen [shake256_squeeze_next_block] <;> sorry
}

end libcrux_sha3.portable.incremental


namespace libcrux_sha3.avx2.x4
...
def shake256
    ...
    := do
  let ⟨tmp0, tmp1, tmp2, tmp3⟩ ←
    (libcrux_sha3.generic_keccak.simd256.keccak4 ((136 : usize)) ((31 : u8))
      (RustArray.ofVec #v[input0, input1, input2, input3])
      out0
      out1
      out2
      out3);
...
end libcrux_sha3.avx2.x4


namespace libcrux_sha3.avx2.x4.incremental

--  The Keccak state for the incremental API.
structure KeccakState where
  state : (libcrux_sha3.generic_keccak.KeccakState
      ((4 : usize))
      (core_models.abstractions.bitvec.BitVec ((256 : u64))))

--  Initialise the [`KeccakState`].
@[spec]
def init (_ : rust_primitives.hax.Tuple0) : RustM KeccakState := do
  (pure (KeccakState.mk
    (state := (← (libcrux_sha3.generic_keccak.Impl_2.new
      ((4 : usize))
      (core_models.abstractions.bitvec.BitVec ((256 : u64)))
      rust_primitives.hax.Tuple0.mk)))))
...
def shake128_absorb_final
  ...
  let s : KeccakState :=
    ...
    with state := (← (libcrux_sha3.generic_keccak.Impl_2.absorb_final
      ...
      ((31 : u8))
      (KeccakState.state s)
      (RustArray.ofVec #v[data0, data1, data2, data3])
      (0 : usize)
      (← (core_models.slice.Impl.len u8 data0))))};
  (pure s)
...
def shake256_squeeze_first_block
    ...
    := do
  let ⟨tmp0, tmp1, tmp2, tmp3⟩ ←
    (libcrux_sha3.generic_keccak.simd256.Impl.squeeze_first_block
      ((136 : usize)) (KeccakState.state s) out0 out1 out2 out3);
  let out0 : (RustSlice u8) := tmp0;
  let out1 : (RustSlice u8) := tmp1;
  let out2 : (RustSlice u8) := tmp2;
  let out3 : (RustSlice u8) := tmp3;
  let _ := rust_primitives.hax.Tuple0.mk;
  (pure (rust_primitives.hax.Tuple5.mk s out0 out1 out2 out3))
...
def shake256_squeeze_next_block
    ...
    (rust_primitives.hax.Tuple5
      ...
      (RustSlice u8))
    := do
  let ⟨tmp0, tmp1, tmp2, tmp3, tmp4⟩ ←
    (libcrux_sha3.generic_keccak.simd256.Impl.squeeze_next_block ((136 : usize))
      (KeccakState.state s)
      out0
      out1
      out2
      out3
      (0 : usize));
  let s : KeccakState := {s with state := tmp0};
  let out0 : (RustSlice u8) := tmp1;
  let out1 : (RustSlice u8) := tmp2;
  let out2 : (RustSlice u8) := tmp3;
  let out3 : (RustSlice u8) := tmp4;
  let _ := rust_primitives.hax.Tuple0.mk;
  (pure (rust_primitives.hax.Tuple5.mk s out0 out1 out2 out3))
...
def shake128_squeeze_first_three_blocks
    ...
    := do
  let ⟨tmp0, tmp1, tmp2, tmp3, tmp4⟩ ←
    (libcrux_sha3.generic_keccak.simd256.Impl.squeeze_first_three_blocks
      ((168 : usize)) (KeccakState.state s) out0 out1 out2 out3);
  let s : KeccakState := {s with state := tmp0};
  let out0 : (RustSlice u8) := tmp1;
  let out1 : (RustSlice u8) := tmp2;
  let out2 : (RustSlice u8) := tmp3;
...
def shake128_squeeze_first_five_blocks
    ...
    := do
  let ⟨tmp0, tmp1, tmp2, tmp3, tmp4⟩ ←
    (libcrux_sha3.generic_keccak.simd256.Impl.squeeze_first_five_blocks
      ((168 : usize)) (KeccakState.state s) out0 out1 out2 out3);
  let s : KeccakState := {s with state := tmp0};
  let out0 : (RustSlice u8) := tmp1;
  let out1 : (RustSlice u8) := tmp2;
...
def shake128_squeeze_next_block
    ...
    := do
  let ⟨tmp0, tmp1, tmp2, tmp3, tmp4⟩ ←
    (libcrux_sha3.generic_keccak.simd256.Impl.squeeze_next_block ((168 : usize))
      (KeccakState.state s)
      out0
      out1
      out2
...
end libcrux_sha3.avx2.x4.incremental
