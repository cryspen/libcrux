...
- [#XYZ](https://github.com/cryspen/libcrux/pull/XYZ): Update dependencies: `libcrux-sha2`, `libcrux-p256`
...
- [#1324](https://github.com/cryspen/libcrux/pull/1324): Update dependencies: `libcrux-p256`, `libcrux-sha2`
...
- [#1060](https://github.com/cryspen/libcrux/pull/1060): Fixes for `libcrux-ecdsa` with `--no-default-features`
