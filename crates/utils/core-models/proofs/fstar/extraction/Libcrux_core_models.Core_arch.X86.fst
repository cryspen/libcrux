module Libcrux_core_models.Core_arch.X86
#set-options "--fuel 0 --ifuel 1 --z3rlimit 15"
open FStar.Mul
open Core_models

unfold type t_e_ee_m256i = Libcrux_core_models.Abstractions.Bitvec.t_BitVec (mk_u64 256)
    unfold type t_e_ee_m128i = Libcrux_core_models.Abstractions.Bitvec.t_BitVec (mk_u64 128)
...
val e___e_rw_mm256_sllv_epi32':
  ...
  -> Lemma
    (ensures
      (Libcrux_core_models.Core_arch.X86.Avx2.e_mm256_sllv_epi32 vector
          (Libcrux_core_models.Core_arch.X86.Avx.e_mm256_set_epi32 b7 b6 b5 b4 b3 b2 b1 b0
            <:
            Libcrux_core_models.Abstractions.Bitvec.t_BitVec (mk_u64 256))
        <:
        Libcrux_core_models.Abstractions.Bitvec.t_BitVec (mk_u64 256)) ==
      (Libcrux_core_models.Core_arch.X86.Extra.mm256_sllv_epi32_u32 vector
          (cast (b7 <: i32) <: u32)
          (cast (b6 <: i32) <: u32)
          (cast (b5 <: i32) <: u32)
          (cast (b4 <: i32) <: u32)
...
val e___e_rw_mm256_srlv_epi32':
  ...
  -> Lemma
    (ensures
      (Libcrux_core_models.Core_arch.X86.Avx2.e_mm256_srlv_epi32 vector
          (Libcrux_core_models.Core_arch.X86.Avx.e_mm256_set_epi32 b7 b6 b5 b4 b3 b2 b1 b0
            <:
            Libcrux_core_models.Abstractions.Bitvec.t_BitVec (mk_u64 256))
        <:
        Libcrux_core_models.Abstractions.Bitvec.t_BitVec (mk_u64 256)) ==
      (Libcrux_core_models.Core_arch.X86.Extra.mm256_srlv_epi32_u32 vector
          (cast (b7 <: i32) <: u32)
          (cast (b6 <: i32) <: u32)
          (cast (b5 <: i32) <: u32)
          (cast (b4 <: i32) <: u32)
...
val e___e_rw_mm256_permutevar8x32_epi32':
  ...
  -> Lemma
    (ensures
      (Libcrux_core_models.Core_arch.X86.Avx2.e_mm256_permutevar8x32_epi32 vector
          (Libcrux_core_models.Core_arch.X86.Avx.e_mm256_set_epi32 b7 b6 b5 b4 b3 b2 b1 b0
            <:
            Libcrux_core_models.Abstractions.Bitvec.t_BitVec (mk_u64 256))
        <:
        Libcrux_core_models.Abstractions.Bitvec.t_BitVec (mk_u64 256)) ==
      (Libcrux_core_models.Core_arch.X86.Extra.mm256_permutevar8x32_epi32_u32 vector
          (cast (b7 <: i32) <: u32)
          (cast (b6 <: i32) <: u32)
          (cast (b5 <: i32) <: u32)
          (cast (b4 <: i32) <: u32)
...
val e___e_rw_mm256_mullo_epi16_shifts':
  ...
  -> Lemma
    (ensures
      (Libcrux_core_models.Core_arch.X86.Avx2.e_mm256_mullo_epi16 vector
          (Libcrux_core_models.Core_arch.X86.Avx.e_mm256_set_epi16 (mk_i16 1 <<! s15 <: i16)
      ...
      (Libcrux_core_models.Core_arch.X86.Extra.mm256_mullo_epi16_shifts vector s15 s14 s13 s12 s11 s10 s9 s8 s7
...
val e___e_rw_mm_shuffle_epi8':
  ...
  -> Lemma
    (ensures
      (Libcrux_core_models.Core_arch.X86.Ssse3.e_mm_shuffle_epi8 vector
          (Libcrux_core_models.Core_arch.X86.Sse2.e_mm_set_epi8 e15 e14 e13 e12 e11 e10 e9 e8 e7 e6 e5 e4 e3
              e2 e1 e0
            <:
            Libcrux_core_models.Abstractions.Bitvec.t_BitVec (mk_u64 128))
        <:
        Libcrux_core_models.Abstractions.Bitvec.t_BitVec (mk_u64 128)) ==
      (Libcrux_core_models.Core_arch.X86.Extra.mm_shuffle_epi8_u8 vector (cast (e15 <: i8) <: u8)
...
val e___e_rw_mm256_shuffle_epi8':
  ...
  -> Lemma
    (ensures
      (Libcrux_core_models.Core_arch.X86.Avx2.e_mm256_shuffle_epi8 vector
          (Libcrux_core_models.Core_arch.X86.Avx.e_mm256_set_epi8 byte31 byte30 byte29 byte28 byte27 byte26
        ...
        <:
        Libcrux_core_models.Abstractions.Bitvec.t_BitVec (mk_u64 256)) ==
      (Libcrux_core_models.Core_arch.X86.Extra.mm256_shuffle_epi8_i8 vector byte31 byte30 byte29 byte28
