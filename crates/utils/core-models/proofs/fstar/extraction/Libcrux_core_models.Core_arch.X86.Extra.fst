module Libcrux_core_models.Core_arch.X86.Extra
...
let mm256_sllv_epi32_u32_array
      ...
      (counts: Libcrux_core_models.Abstractions.Funarr.t_FunArray (mk_u64 8) u32)
  ...
  Libcrux_core_models.Abstractions.Bitvec.impl_10__chunked_shift (mk_u64 256)
    ...
    (Libcrux_core_models.Abstractions.Funarr.impl_5__from_fn (mk_u64 8)
      ...
      <:
      Libcrux_core_models.Abstractions.Funarr.t_FunArray (mk_u64 8) i128)
...
let mm256_srlv_epi32_u32_array
  ...
  Libcrux_core_models.Abstractions.Bitvec.impl_10__chunked_shift (mk_u64 256)
    ...
    (Libcrux_core_models.Abstractions.Funarr.impl_5__from_fn (mk_u64 8)
        ...
        (fun i ->
            let i:u64 = i in
            Rust_primitives.Arithmetic.neg (cast (counts.[ i ] <: u32) <: i128) <: i128)
      <:
      Libcrux_core_models.Abstractions.Funarr.t_FunArray (mk_u64 8) i128)
...
let mm256_permutevar8x32_epi32_u32_array
      ...
      (b: Libcrux_core_models.Abstractions.Funarr.t_FunArray (mk_u64 8) u32)
    : Libcrux_core_models.Abstractions.Bitvec.t_BitVec (mk_u64 256) =
...
let mm_shuffle_epi8_u8_array
      ...
      (indexes: Libcrux_core_models.Abstractions.Funarr.t_FunArray (mk_u64 16) u8)
  ...
  Libcrux_core_models.Abstractions.Bitvec.impl_9__from_fn (mk_u64 128)
    (fun i ->
        ...
        if index >. mk_u8 127
        then Libcrux_core_models.Abstractions.Bit.Bit_Zero <: Libcrux_core_models.Abstractions.Bit.t_Bit
        else
...
let mm_shuffle_epi8_u8
    ...
    : Libcrux_core_models.Abstractions.Bitvec.t_BitVec (mk_u64 128) =
  let indexes:Libcrux_core_models.Abstractions.Funarr.t_FunArray (mk_u64 16) u8 =
...
let mm256_shuffle_epi8_i8_array
      (vector: Libcrux_core_models.Abstractions.Bitvec.t_BitVec (mk_u64 256))
      (indexes: Libcrux_core_models.Abstractions.Funarr.t_FunArray (mk_u64 32) i8)
    : Libcrux_core_models.Abstractions.Bitvec.t_BitVec (mk_u64 256) =
  Libcrux_core_models.Abstractions.Bitvec.impl_9__from_fn (mk_u64 256)
    (fun i ->
        let i:u64 = i in
...
let mm256_shuffle_epi8_i8
      ...
      (byte31 byte30 byte29 byte28 byte27 byte26 byte25 byte24 byte23 byte22 byte21 byte20 byte19 byte18 byte17 byte16 byte15 byte14 byte13 byte12 byte11 byte10 byte9 byte8 byte7 byte6 byte5 byte4 byte3 byte2 byte1 byte0:
          i8)
    : Libcrux_core_models.Abstractions.Bitvec.t_BitVec (mk_u64 256) =
  let indexes:Libcrux_core_models.Abstractions.Funarr.t_FunArray (mk_u64 32) i8 =
    Libcrux_core_models.Abstractions.Funarr.impl_5__from_fn (mk_u64 32)
      #i8
      (fun i ->
          let i:u64 = i in
          match i <: u64 with
...
let mm256_mullo_epi16_shifts_array
      (vector: Libcrux_core_models.Abstractions.Bitvec.t_BitVec (mk_u64 256))
      (shifts: Libcrux_core_models.Abstractions.Funarr.t_FunArray (mk_u64 16) u8)
    : Libcrux_core_models.Abstractions.Bitvec.t_BitVec (mk_u64 256) =
  Libcrux_core_models.Abstractions.Bitvec.impl_9__from_fn (mk_u64 256)
    (fun i ->
        let i:u64 = i in
...
let mm256_mullo_epi16_shifts
    ...
    : Libcrux_core_models.Abstractions.Bitvec.t_BitVec (mk_u64 256) =
  let shifts:Libcrux_core_models.Abstractions.Funarr.t_FunArray (mk_u64 16) u8 =
    Libcrux_core_models.Abstractions.Funarr.impl_5__from_fn (mk_u64 16)
      #u8
      (fun i ->
          let i:u64 = i in
