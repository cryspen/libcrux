module Libcrux_core_models.Core_arch.X86.Avx
...
assume
val e_mm256_set1_epi64x': i64 -> Libcrux_core_models.Abstractions.Bitvec.t_BitVec (mk_u64 256)
...
assume
val e_mm256_castsi128_si256': Libcrux_core_models.Abstractions.Bitvec.t_BitVec (mk_u64 128)
  -> Libcrux_core_models.Abstractions.Bitvec.t_BitVec (mk_u64 256)
...
assume
val e_mm256_castsi256_ps': Libcrux_core_models.Abstractions.Bitvec.t_BitVec (mk_u64 256)
  -> Libcrux_core_models.Abstractions.Bitvec.t_BitVec (mk_u64 256)
...
assume
val e_mm256_castps_si256': Libcrux_core_models.Abstractions.Bitvec.t_BitVec (mk_u64 256)
  -> Libcrux_core_models.Abstractions.Bitvec.t_BitVec (mk_u64 256)
...
assume
val e_mm256_movemask_ps': Libcrux_core_models.Abstractions.Bitvec.t_BitVec (mk_u64 256) -> i32
...
assume
val e_mm256_setzero_si256': Prims.unit -> Libcrux_core_models.Abstractions.Bitvec.t_BitVec (mk_u64 256)
...
val e_mm256_set_m128i':
    hi: Libcrux_core_models.Abstractions.Bitvec.t_BitVec (mk_u64 128) ->
    lo: Libcrux_core_models.Abstractions.Bitvec.t_BitVec (mk_u64 128)
  -> Libcrux_core_models.Abstractions.Bitvec.t_BitVec (mk_u64 256)

unfold
let e_mm256_set_m128i = e_mm256_set_m128i'

let e_mm256_castsi256_si128 (vector: Libcrux_core_models.Abstractions.Bitvec.t_BitVec (mk_u64 256))
  ...
  Libcrux_core_models.Abstractions.Bitvec.impl_9__from_fn (mk_u64 128)
    (fun i ->
        let i:u64 = i in
        vector.[ i ] <: Libcrux_core_models.Abstractions.Bit.t_Bit)

/// This is opaque to Hax: it is defined only via the integer
/// interpretation. See `interpretations::int_vec::_mm256_set1_epi32`.
assume
val e_mm256_set1_epi32': i32 -> Libcrux_core_models.Abstractions.Bitvec.t_BitVec (mk_u64 256)
...
assume
val e_mm256_set1_epi16': i16 -> Libcrux_core_models.Abstractions.Bitvec.t_BitVec (mk_u64 256)
