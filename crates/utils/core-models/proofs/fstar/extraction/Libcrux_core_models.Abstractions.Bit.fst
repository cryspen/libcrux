module Libcrux_core_models.Abstractions.Bit
...
let impl_3: Core_models.Clone.t_Clone t_Bit =
  { f_clone = (fun x -> x); f_clone_pre = (fun _ -> True); f_clone_post = (fun _ _ -> True) }

[@@ FStar.Tactics.Typeclasses.tcinstance]
assume
val impl_2': Core_models.Marker.t_Copy t_Bit
...
[@@ FStar.Tactics.Typeclasses.tcinstance]
assume
val impl_5': Core_models.Marker.t_StructuralPartialEq t_Bit
...
[@@ FStar.Tactics.Typeclasses.tcinstance]
assume
val impl_6': Core_models.Cmp.t_PartialEq t_Bit t_Bit
...
[@@ FStar.Tactics.Typeclasses.tcinstance]
assume
val impl_4': Core_models.Cmp.t_Eq t_Bit
...
[@@ FStar.Tactics.Typeclasses.tcinstance]
assume
val impl_7': Core_models.Fmt.t_Debug t_Bit

unfold
let impl_7 = impl_7'

[@@ FStar.Tactics.Typeclasses.tcinstance]
let impl: Core_models.Convert.t_From bool t_Bit =
  {
...
[@@ FStar.Tactics.Typeclasses.tcinstance]
let impl_8: Core_models.Convert.t_From u8 t_Bit =
  {
    f_from_pre = (fun (bit: t_Bit) -> true);
    ...
    =
    fun (bit: t_Bit) ->
      cast (Core_models.Convert.f_from #bool #t_Bit #FStar.Tactics.Typeclasses.solve bit <: bool)
      <:
      u8
  }

[@@ FStar.Tactics.Typeclasses.tcinstance]
let impl_9: Core_models.Convert.t_From u16 t_Bit =
  {
    f_from_pre = (fun (bit: t_Bit) -> true);
...
[@@ FStar.Tactics.Typeclasses.tcinstance]
let impl_10: Core_models.Convert.t_From u32 t_Bit =
  {
    f_from_pre = (fun (bit: t_Bit) -> true);
...
[@@ FStar.Tactics.Typeclasses.tcinstance]
let impl_11: Core_models.Convert.t_From u64 t_Bit =
  {
    f_from_pre = (fun (bit: t_Bit) -> true);
...
[@@ FStar.Tactics.Typeclasses.tcinstance]
let impl_12: Core_models.Convert.t_From u128 t_Bit =
  {
    f_from_pre = (fun (bit: t_Bit) -> true);
...
[@@ FStar.Tactics.Typeclasses.tcinstance]
let impl_13: Core_models.Convert.t_From i8 t_Bit =
  {
    f_from_pre = (fun (bit: t_Bit) -> true);
...
[@@ FStar.Tactics.Typeclasses.tcinstance]
let impl_14: Core_models.Convert.t_From i16 t_Bit =
  {
    f_from_pre = (fun (bit: t_Bit) -> true);
...
[@@ FStar.Tactics.Typeclasses.tcinstance]
let impl_15: Core_models.Convert.t_From i32 t_Bit =
  {
    f_from_pre = (fun (bit: t_Bit) -> true);
...
[@@ FStar.Tactics.Typeclasses.tcinstance]
let impl_16: Core_models.Convert.t_From i64 t_Bit =
  {
    f_from_pre = (fun (bit: t_Bit) -> true);
...
[@@ FStar.Tactics.Typeclasses.tcinstance]
let impl_17: Core_models.Convert.t_From i128 t_Bit =
  {
    f_from_pre = (fun (bit: t_Bit) -> true);
...
[@@ FStar.Tactics.Typeclasses.tcinstance]
let impl_1: Core_models.Convert.t_From t_Bit bool =
  {
