module Libcrux_core_models.Abstractions.Funarr
...
let impl_1
    ...
    : Core_models.Clone.t_Clone (t_FunArray v_N v_T) =
  { f_clone = (fun x -> x); f_clone_pre = (fun _ -> True); f_clone_post = (fun _ _ -> True) }

[@@ FStar.Tactics.Typeclasses.tcinstance]
assume
val impl': v_N: u64 -> #v_T: Type0 -> {| i0: Core_models.Marker.t_Copy v_T |}
  -> Core_models.Marker.t_Copy (t_FunArray v_N v_T)
...
[@@ FStar.Tactics.Typeclasses.tcinstance]
assume
val impl_3': v_N: u64 -> #v_T: Type0
  -> Core_models.Marker.t_StructuralPartialEq (t_FunArray v_N v_T)
...
[@@ FStar.Tactics.Typeclasses.tcinstance]
assume
val impl_4': v_N: u64 -> #v_T: Type0 -> {| i0: Core_models.Cmp.t_PartialEq v_T v_T |}
  -> Core_models.Cmp.t_PartialEq (t_FunArray v_N v_T) (t_FunArray v_N v_T)
...
[@@ FStar.Tactics.Typeclasses.tcinstance]
assume
val impl_2': v_N: u64 -> #v_T: Type0 -> {| i0: Core_models.Cmp.t_Eq v_T |}
  -> Core_models.Cmp.t_Eq (t_FunArray v_N v_T)

unfold
let impl_2
      (v_N: u64)
      (#v_T: Type0)
      (#[FStar.Tactics.Typeclasses.tcresolve ()] i0: Core_models.Cmp.t_Eq v_T)
     = impl_2' v_N #v_T #i0

[@@ FStar.Tactics.Typeclasses.tcinstance]
let impl_11 (v_N: u64) (#v_T: Type0) : Core_models.Ops.Index.t_Index (t_FunArray v_N v_T) u64 =
  {
    f_Output = v_T;
