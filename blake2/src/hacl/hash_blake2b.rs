...
pub(crate) fn malloc_raw<'a>(
...
) -> Box<[crate::hacl::hash_blake2b::state_t]> {
    ...
    let p0: Box<[crate::hacl::hash_blake2b::state_t]> = vec![s].into_boxed_slice();
    p0
}
...
pub fn copy(
    ...
    let p: Box<[crate::hacl::hash_blake2b::state_t]> = vec![s].into_boxed_slice();
    p
}
