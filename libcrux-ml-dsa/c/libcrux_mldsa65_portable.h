...
static inline Result_a8 libcrux_ml_dsa_pre_hash_new_88(
  ...
  if (!(Eurydice_slice_len(context, uint8_t) >
    ...
    return (KRML_CLITERAL(Result_a8){
        .tag = Ok,
        .val = {
...
libcrux_ml_dsa_sample_sample_four_error_ring_elements_29(
  ...
  size_t max;
  if (Eurydice_slice_len((KRML_CLITERAL(Eurydice_dst_ref_shared_f3){
                             .ptr = re.ptr, .meta = re.meta}),
                         Eurydice_arr_a4) < max0) {
    max = Eurydice_slice_len((KRML_CLITERAL(Eurydice_dst_ref_shared_f3){
                                 .ptr = re.ptr, .meta = re.meta}),
                             Eurydice_arr_a4);
  } else {
    max = max0;
...
static KRML_MUSTINLINE void libcrux_ml_dsa_samplex4_sample_s1_and_s2_29(
  ...
  size_t len = Eurydice_slice_len((KRML_CLITERAL(Eurydice_dst_ref_shared_f3){
...
static KRML_MUSTINLINE void libcrux_ml_dsa_samplex4_matrix_flat_63(
  ...
  Eurydice_arr_46 tmp_stack = {
      .data = {{.data = {0U}}, {.data = {0U}}, {.data = {0U}}, {.data = {0U}}}};
  for (size_t i = (size_t)0U;
       i < Eurydice_slice_len((KRML_CLITERAL(Eurydice_dst_ref_shared_f3){
    ...
    if (!(uu____0 >=
          Eurydice_slice_len((KRML_CLITERAL(Eurydice_dst_ref_shared_f3){
                                 .ptr = matrix.ptr, .meta = matrix.meta}),
                             Eurydice_arr_a4))) {
...
static inline Eurydice_dst_ref_shared_f3 Eurydice_array_to_subslice_shared_c3(
  ...
  return (KRML_CLITERAL(Eurydice_dst_ref_shared_f3){.ptr = a->data + r.start,
                                                    .meta = r.end - r.start});
}
...
static KRML_MUSTINLINE void libcrux_ml_dsa_arithmetic_power2round_vector_37(
  ...
  for (size_t i0 = (size_t)0U;
       i0 < Eurydice_slice_len((KRML_CLITERAL(Eurydice_dst_ref_shared_f3){
    ...
    for (size_t i = (size_t)0U;
         i < Eurydice_slice_len(
                 Eurydice_array_to_slice_shared_a2(&Eurydice_slice_index_shared(
                     (KRML_CLITERAL(Eurydice_dst_ref_shared_f3){
                         .ptr = t.ptr, .meta = t.meta}),
                     i1, Eurydice_arr_a4)),
                 Eurydice_arr_d4);
         i++) {
...
static KRML_MUSTINLINE void libcrux_ml_dsa_matrix_compute_w_approx_37(
  ...
  for (size_t i0 = (size_t)0U; i0 < rows_in_a; i0++) {
    ...
    libcrux_ml_dsa_polynomial_subtract_ff_37(
        &inner_result,
        &Eurydice_slice_index_shared((KRML_CLITERAL(Eurydice_dst_ref_shared_f3){
