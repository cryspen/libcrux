...
let impl: Libcrux_ml_dsa.Simd.Traits.t_Operations t_PortableSIMDUnit =
  {
    ...
    f_ntt_pre = (fun (simd_units: t_Array t_PortableSIMDUnit (Rust_primitives.mk_usize 32)) -> true);
    f_ntt_post
    =
    (fun
        (simd_units: t_Array t_PortableSIMDUnit (Rust_primitives.mk_usize 32))
        (out: t_Array t_PortableSIMDUnit (Rust_primitives.mk_usize 32))
        ->
        true);
    f_ntt
    =
    (fun (simd_units: t_Array t_PortableSIMDUnit (Rust_primitives.mk_usize 32)) ->
