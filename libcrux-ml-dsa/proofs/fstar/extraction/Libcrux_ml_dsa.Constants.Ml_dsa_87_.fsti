...
let v_COLUMNS_IN_A: usize = mk_usize 7

let v_COMMITMENT_HASH_SIZE: usize = mk_usize 64
...
let v_MAX_ONES_IN_HINT: usize = mk_usize 75

let v_ONES_IN_VERIFIER_CHALLENGE: usize = mk_usize 60

let v_ROWS_IN_A: usize = mk_usize 8
