...
let impl: Libcrux_ml_dsa.Hash_functions.Shake128.t_XofX4 t_Shake128x4 =
  {
    ...
    (fun
        ...
        let out2:t_Array u8 (Rust_primitives.mk_usize 840) = tmp3 in
        let out3:t_Array u8 (Rust_primitives.mk_usize 840) = tmp4 in
        let _:Prims.unit = () in
    ...
    fun (self: t_Shake128x4) ->
      ...
      let out2:t_Array u8 (Rust_primitives.mk_usize 168) = tmp3 in
      let out3:t_Array u8 (Rust_primitives.mk_usize 168) = tmp4 in
      let _:Prims.unit = () in
...
let impl_2: Libcrux_ml_dsa.Hash_functions.Shake256.t_XofX4 t_Shake256x4 =
  {
    ...
    (fun (self: t_Shake256x4) ->
        ...
        let out2:t_Array u8 (Rust_primitives.mk_usize 136) = tmp3 in
        let out3:t_Array u8 (Rust_primitives.mk_usize 136) = tmp4 in
        let _:Prims.unit = () in
