...
let generate_key_pair (randomness: t_Array u8 (sz 32)) =
  ...
  let tmp0, tmp1:(t_Array u8 (sz 4032) & t_Array u8 (sz 1952)) =
    Libcrux_ml_dsa.Ml_dsa_generic.Multiplexing.generate_key_pair_v65 randomness
      signing_key
      verification_key
  in
...
let sign
     ...
     =
  Libcrux_ml_dsa.Ml_dsa_generic.Multiplexing.sign (sz 6) (sz 5) (sz 30) (sz 4) (sz 128) (sz 19)
...
let sign_pre_hashed_shake128
      ...
      (randomness: t_Array u8 (sz 32))
     =
  Libcrux_ml_dsa.Ml_dsa_generic.Multiplexing.sign_pre_hashed_shake128 (sz 6) (sz 5) (sz 30) (sz 4)
...
let verify
     ...
     =
  Libcrux_ml_dsa.Ml_dsa_generic.Multiplexing.verify (sz 6) (sz 5) (sz 30) (sz 3309) (sz 1952)
...
let verify_pre_hashed_shake128
      ...
      (signature: Libcrux_ml_dsa.Types.t_MLDSASignature (sz 3309))
     =
  Libcrux_ml_dsa.Ml_dsa_generic.Multiplexing.verify_pre_hashed_shake128 (sz 6) (sz 5) (sz 30)
