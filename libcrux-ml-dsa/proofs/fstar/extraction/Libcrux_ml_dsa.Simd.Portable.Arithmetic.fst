...
let compute_one_hint (low high gamma2: i32) : i32 =
  if
...
let compute_hint
    ...
    : (Libcrux_ml_dsa.Simd.Portable.Vector_type.t_Coefficients & usize) =
...
let decompose_element (gamma2 r: i32) : (i32 & i32) =
  let _:Prims.unit =
    if true
    then
      let _:Prims.unit =
...
let uuse_one_hint (gamma2 r hint: i32) : i32 =
