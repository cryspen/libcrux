...
let use_one_hint (v_GAMMA2 r hint: i32) =
  Rust_primitives.Hax.Control_flow_monad.Mexception.run (let r0, r1:(i32 & i32) =
        decompose_element v_GAMMA2 r
      in
      let! _:Prims.unit =
        if hint =. 0l
        then
          let! hoist1:Rust_primitives.Hax.t_Never =
            Core.Ops.Control_flow.ControlFlow_Break r1
            <:
            Core.Ops.Control_flow.t_ControlFlow i32 Rust_primitives.Hax.t_Never
          in
          Core.Ops.Control_flow.ControlFlow_Continue (Rust_primitives.Hax.never_to_any hoist1)
          <:
          Core.Ops.Control_flow.t_ControlFlow i32 Prims.unit
        else
...
let infinity_norm_exceeds (simd_unit: Libcrux_ml_dsa.Simd.Portable.t_PortableSIMDUnit) (bound: i32) =
  ...
  let exceeds:bool =
    Core.Iter.Traits.Iterator.f_fold (Core.Iter.Traits.Collect.f_into_iter #(Core.Array.Iter.t_IntoIter
          ...
          (Core.Iter.Traits.Collect.f_into_iter #(t_Array i32 (sz 8))
              #FStar.Tactics.Typeclasses.solve
              simd_unit.Libcrux_ml_dsa.Simd.Portable.f_coefficients
            <:
          ...
          let i:usize = i in
          {
            ...
            Rust_primitives.Hax.Monomorphized_update_at.update_at_usize simd_unit
              ...
              (montgomery_reduce_element ((cast (simd_unit
                            .Libcrux_ml_dsa.Simd.Portable.f_coefficients.[ i ]
                          <:
                          i32)
                      <:
                      i64) *!
...
let add (lhs rhs: Libcrux_ml_dsa.Simd.Portable.t_PortableSIMDUnit) =
  let sum:Libcrux_ml_dsa.Simd.Portable.t_PortableSIMDUnit =
  ...
  let sum:Libcrux_ml_dsa.Simd.Portable.t_PortableSIMDUnit =
    Rust_primitives.Hax.Folds.fold_range (sz 0)
      (Core.Slice.impl__len #i32 (sum.Libcrux_ml_dsa.Simd.Portable.f_coefficients <: t_Slice i32)
        <:
        usize)
      (fun sum temp_1_ ->
          let sum:Libcrux_ml_dsa.Simd.Portable.t_PortableSIMDUnit = sum in
          let _:usize = temp_1_ in
          true)
      sum
      (fun sum i ->
          ...
          let i:usize = i in
          {
            ...
            Rust_primitives.Hax.Monomorphized_update_at.update_at_usize sum
                .Libcrux_ml_dsa.Simd.Portable.f_coefficients
              i
              ((lhs.Libcrux_ml_dsa.Simd.Portable.f_coefficients.[ i ] <: i32) +!
                (rhs.Libcrux_ml_dsa.Simd.Portable.f_coefficients.[ i ] <: i32)
                <:
                i32)
            <:
            t_Array i32 (sz 8)
...
let compute_hint (v_GAMMA2: i32) (low high: Libcrux_ml_dsa.Simd.Portable.t_PortableSIMDUnit) =
  let hint:Libcrux_ml_dsa.Simd.Portable.t_PortableSIMDUnit =
    Libcrux_ml_dsa.Simd.Traits.f_ZERO #Libcrux_ml_dsa.Simd.Portable.t_PortableSIMDUnit
      #FStar.Tactics.Typeclasses.solve
      ()
  in
  let one_hints_count:usize = sz 0 in
  let hint, one_hints_count:(Libcrux_ml_dsa.Simd.Portable.t_PortableSIMDUnit & usize) =
    Rust_primitives.Hax.Folds.fold_range (sz 0)
      (Core.Slice.impl__len #i32 (hint.Libcrux_ml_dsa.Simd.Portable.f_coefficients <: t_Slice i32)
        <:
        usize)
      (fun temp_0_ temp_1_ ->
          let hint, one_hints_count:(Libcrux_ml_dsa.Simd.Portable.t_PortableSIMDUnit & usize) =
          ...
          let _:usize = temp_1_ in
          true)
      (hint, one_hints_count <: (Libcrux_ml_dsa.Simd.Portable.t_PortableSIMDUnit & usize))
      (fun temp_0_ i ->
          let hint, one_hints_count:(Libcrux_ml_dsa.Simd.Portable.t_PortableSIMDUnit & usize) =
            temp_0_
          in
          ...
          let hint:Libcrux_ml_dsa.Simd.Portable.t_PortableSIMDUnit =
            {
              ...
              Rust_primitives.Hax.Monomorphized_update_at.update_at_usize hint
                ...
                (compute_one_hint v_GAMMA2
                    (low.Libcrux_ml_dsa.Simd.Portable.f_coefficients.[ i ] <: i32)
                    (high.Libcrux_ml_dsa.Simd.Portable.f_coefficients.[ i ] <: i32)
                  <:
                  i32)
            }
            <:
          ...
          let one_hints_count:usize =
            one_hints_count +!
            (cast (hint.Libcrux_ml_dsa.Simd.Portable.f_coefficients.[ i ] <: i32) <: usize)
          in
          hint, one_hints_count <: (Libcrux_ml_dsa.Simd.Portable.t_PortableSIMDUnit & usize))
  in
  one_hints_count, hint <: (usize & Libcrux_ml_dsa.Simd.Portable.t_PortableSIMDUnit)

let decompose (v_GAMMA2: i32) (simd_unit: Libcrux_ml_dsa.Simd.Portable.t_PortableSIMDUnit) =
  let low:Libcrux_ml_dsa.Simd.Portable.t_PortableSIMDUnit =
    Libcrux_ml_dsa.Simd.Traits.f_ZERO #Libcrux_ml_dsa.Simd.Portable.t_PortableSIMDUnit
      #FStar.Tactics.Typeclasses.solve
      ()
  in
  let high:Libcrux_ml_dsa.Simd.Portable.t_PortableSIMDUnit =
    Libcrux_ml_dsa.Simd.Traits.f_ZERO #Libcrux_ml_dsa.Simd.Portable.t_PortableSIMDUnit
      #FStar.Tactics.Typeclasses.solve
      ()
  in
  let high, low:(Libcrux_ml_dsa.Simd.Portable.t_PortableSIMDUnit &
    Libcrux_ml_dsa.Simd.Portable.t_PortableSIMDUnit) =
    Rust_primitives.Hax.Folds.fold_range (sz 0)
      (Core.Slice.impl__len #i32 (low.Libcrux_ml_dsa.Simd.Portable.f_coefficients <: t_Slice i32)
        <:
        usize)
      (fun temp_0_ temp_1_ ->
          let high, low:(Libcrux_ml_dsa.Simd.Portable.t_PortableSIMDUnit &
      ...
      (fun temp_0_ i ->
          ...
          let low_part, high_part:(i32 & i32) =
            decompose_element v_GAMMA2
              (simd_unit.Libcrux_ml_dsa.Simd.Portable.f_coefficients.[ i ] <: i32)
          in
          let low:Libcrux_ml_dsa.Simd.Portable.t_PortableSIMDUnit =
            {
              low with
  ...
  low, high
  <:
  (Libcrux_ml_dsa.Simd.Portable.t_PortableSIMDUnit & Libcrux_ml_dsa.Simd.Portable.t_PortableSIMDUnit
  )

let montgomery_multiply (lhs rhs: Libcrux_ml_dsa.Simd.Portable.t_PortableSIMDUnit) =
  let product:Libcrux_ml_dsa.Simd.Portable.t_PortableSIMDUnit =
    Libcrux_ml_dsa.Simd.Traits.f_ZERO #Libcrux_ml_dsa.Simd.Portable.t_PortableSIMDUnit
      #FStar.Tactics.Typeclasses.solve
      ()
  in
  let product:Libcrux_ml_dsa.Simd.Portable.t_PortableSIMDUnit =
    Rust_primitives.Hax.Folds.fold_range (sz 0)
      (Core.Slice.impl__len #i32
          (product.Libcrux_ml_dsa.Simd.Portable.f_coefficients <: t_Slice i32)
        <:
        usize)
      (fun product temp_1_ ->
          let product:Libcrux_ml_dsa.Simd.Portable.t_PortableSIMDUnit = product in
          let _:usize = temp_1_ in
          true)
      product
      (fun product i ->
          ...
          let i:usize = i in
          {
            ...
            Rust_primitives.Hax.Monomorphized_update_at.update_at_usize product
                .Libcrux_ml_dsa.Simd.Portable.f_coefficients
              i
              (montgomery_reduce_element ((cast (lhs.Libcrux_ml_dsa.Simd.Portable.f_coefficients.[ i
                          ]
                          <:
                          i32)
                      <:
                      i64) *!
                    (cast (rhs.Libcrux_ml_dsa.Simd.Portable.f_coefficients.[ i ] <: i32) <: i64)
                    <:
                    i64)
                <:
                i32)
...
let power2round (simd_unit: Libcrux_ml_dsa.Simd.Portable.t_PortableSIMDUnit) =
  let t0_simd_unit:Libcrux_ml_dsa.Simd.Portable.t_PortableSIMDUnit =
    Libcrux_ml_dsa.Simd.Traits.f_ZERO #Libcrux_ml_dsa.Simd.Portable.t_PortableSIMDUnit
      #FStar.Tactics.Typeclasses.solve
      ()
  in
  let t1_simd_unit:Libcrux_ml_dsa.Simd.Portable.t_PortableSIMDUnit =
    Libcrux_ml_dsa.Simd.Traits.f_ZERO #Libcrux_ml_dsa.Simd.Portable.t_PortableSIMDUnit
      #FStar.Tactics.Typeclasses.solve
      ()
  in
  let t0_simd_unit, t1_simd_unit:(Libcrux_ml_dsa.Simd.Portable.t_PortableSIMDUnit &
    Libcrux_ml_dsa.Simd.Portable.t_PortableSIMDUnit) =
...
let shift_left_then_reduce
      ...
      (simd_unit: Libcrux_ml_dsa.Simd.Portable.t_PortableSIMDUnit)
     =
  let out:Libcrux_ml_dsa.Simd.Portable.t_PortableSIMDUnit =
    Libcrux_ml_dsa.Simd.Traits.f_ZERO #Libcrux_ml_dsa.Simd.Portable.t_PortableSIMDUnit
      #FStar.Tactics.Typeclasses.solve
      ()
  in
  let out:Libcrux_ml_dsa.Simd.Portable.t_PortableSIMDUnit =
    Rust_primitives.Hax.Folds.fold_range (sz 0)
      (Core.Slice.impl__len #i32
        ...
        usize)
      (fun out temp_1_ ->
          let out:Libcrux_ml_dsa.Simd.Portable.t_PortableSIMDUnit = out in
          let _:usize = temp_1_ in
          true)
      out
      (fun out i ->
          ...
          let i:usize = i in
          {
            ...
            Rust_primitives.Hax.Monomorphized_update_at.update_at_usize out
                .Libcrux_ml_dsa.Simd.Portable.f_coefficients
              i
              (reduce_element ((simd_unit.Libcrux_ml_dsa.Simd.Portable.f_coefficients.[ i ] <: i32) <<!
                    v_SHIFT_BY
                    <:
                    i32)
                <:
...
let subtract (lhs rhs: Libcrux_ml_dsa.Simd.Portable.t_PortableSIMDUnit) =
  let difference:Libcrux_ml_dsa.Simd.Portable.t_PortableSIMDUnit =
    Libcrux_ml_dsa.Simd.Traits.f_ZERO #Libcrux_ml_dsa.Simd.Portable.t_PortableSIMDUnit
      #FStar.Tactics.Typeclasses.solve
      ()
  in
  let difference:Libcrux_ml_dsa.Simd.Portable.t_PortableSIMDUnit =
    Rust_primitives.Hax.Folds.fold_range (sz 0)
      (Core.Slice.impl__len #i32
          (difference.Libcrux_ml_dsa.Simd.Portable.f_coefficients <: t_Slice i32)
        <:
        usize)
      (fun difference temp_1_ ->
          let difference:Libcrux_ml_dsa.Simd.Portable.t_PortableSIMDUnit = difference in
          let _:usize = temp_1_ in
          true)
      difference
      (fun difference i ->
...
let use_hint (v_GAMMA2: i32) (simd_unit hint: Libcrux_ml_dsa.Simd.Portable.t_PortableSIMDUnit) =
  let result:Libcrux_ml_dsa.Simd.Portable.t_PortableSIMDUnit =
    Libcrux_ml_dsa.Simd.Traits.f_ZERO #Libcrux_ml_dsa.Simd.Portable.t_PortableSIMDUnit
      #FStar.Tactics.Typeclasses.solve
      ()
  in
  let result:Libcrux_ml_dsa.Simd.Portable.t_PortableSIMDUnit =
    Rust_primitives.Hax.Folds.fold_range (sz 0)
      (Core.Slice.impl__len #i32 (result.Libcrux_ml_dsa.Simd.Portable.f_coefficients <: t_Slice i32)
        <:
        usize)
      (fun result temp_1_ ->
          let result:Libcrux_ml_dsa.Simd.Portable.t_PortableSIMDUnit = result in
          let _:usize = temp_1_ in
          true)
      result
      (fun result i ->
          ...
          let i:usize = i in
          {
            ...
            Rust_primitives.Hax.Monomorphized_update_at.update_at_usize result
              ...
              (use_one_hint v_GAMMA2
                  (simd_unit.Libcrux_ml_dsa.Simd.Portable.f_coefficients.[ i ] <: i32)
                  (hint.Libcrux_ml_dsa.Simd.Portable.f_coefficients.[ i ] <: i32)
                <:
                i32)
            <:
            t_Array i32 (sz 8)
