...
class t_XofX4 (v_Self: Type0) = {
  ...
  f_shake256:
    ...
    -> Prims.Pure
        (t_Array u8 v_OUT_LEN & t_Array u8 v_OUT_LEN & t_Array u8 v_OUT_LEN & t_Array u8 v_OUT_LEN)
        (f_shake256_pre v_OUT_LEN x0 x1 x2 x3 x4 x5 x6 x7)
        (fun result -> f_shake256_post v_OUT_LEN x0 x1 x2 x3 x4 x5 x6 x7 result);
...
let v_BLOCK_SIZE: usize = Rust_primitives.mk_usize 136
