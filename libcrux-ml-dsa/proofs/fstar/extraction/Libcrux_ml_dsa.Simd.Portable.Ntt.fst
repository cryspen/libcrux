...
let invert_ntt_at_layer_0_
     ...
     =
  let a_minus_b:i32 =
    (simd_unit.Libcrux_ml_dsa.Simd.Portable.Vector_type.f_coefficients.[ Rust_primitives.mk_usize 1
      ]
      <:
      i32) -!
    (simd_unit.Libcrux_ml_dsa.Simd.Portable.Vector_type.f_coefficients.[ Rust_primitives.mk_usize 0
      ]
      <:
      i32)
  in
  ...
  in
  let a_minus_b:i32 =
    (simd_unit.Libcrux_ml_dsa.Simd.Portable.Vector_type.f_coefficients.[ Rust_primitives.mk_usize 3
      ]
      <:
      i32) -!
    (simd_unit.Libcrux_ml_dsa.Simd.Portable.Vector_type.f_coefficients.[ Rust_primitives.mk_usize 2
      ]
      <:
      i32)
  in
  ...
  in
  let a_minus_b:i32 =
    (simd_unit.Libcrux_ml_dsa.Simd.Portable.Vector_type.f_coefficients.[ Rust_primitives.mk_usize 5
      ]
      <:
      i32) -!
    (simd_unit.Libcrux_ml_dsa.Simd.Portable.Vector_type.f_coefficients.[ Rust_primitives.mk_usize 4
      ]
      <:
      i32)
  in
  ...
  in
  let a_minus_b:i32 =
    (simd_unit.Libcrux_ml_dsa.Simd.Portable.Vector_type.f_coefficients.[ Rust_primitives.mk_usize 7
      ]
      <:
      i32) -!
    (simd_unit.Libcrux_ml_dsa.Simd.Portable.Vector_type.f_coefficients.[ Rust_primitives.mk_usize 6
      ]
      <:
      i32)
  in
...
let simd_unit_ntt_at_layer_0_
  ...
  let t:i32 =
    Libcrux_ml_dsa.Simd.Portable.Arithmetic.montgomery_multiply_fe_by_fer (simd_unit
          .Libcrux_ml_dsa.Simd.Portable.Vector_type.f_coefficients.[ Rust_primitives.mk_usize 1 ]
        <:
        i32)
      zeta0
  in
  ...
  let t:i32 =
    Libcrux_ml_dsa.Simd.Portable.Arithmetic.montgomery_multiply_fe_by_fer (simd_unit
          .Libcrux_ml_dsa.Simd.Portable.Vector_type.f_coefficients.[ Rust_primitives.mk_usize 3 ]
        <:
        i32)
      zeta1
  in
  ...
  let t:i32 =
    Libcrux_ml_dsa.Simd.Portable.Arithmetic.montgomery_multiply_fe_by_fer (simd_unit
          .Libcrux_ml_dsa.Simd.Portable.Vector_type.f_coefficients.[ Rust_primitives.mk_usize 5 ]
        <:
        i32)
      zeta2
  in
  ...
  let t:i32 =
    Libcrux_ml_dsa.Simd.Portable.Arithmetic.montgomery_multiply_fe_by_fer (simd_unit
          .Libcrux_ml_dsa.Simd.Portable.Vector_type.f_coefficients.[ Rust_primitives.mk_usize 7 ]
        <:
        i32)
      zeta3
  in
  ...
  let re, zeta_i:(t_Array Libcrux_ml_dsa.Simd.Portable.Vector_type.t_PortableSIMDUnit
    ...
    Rust_primitives.Hax.Folds.fold_range (Rust_primitives.mk_usize 0)
      ...
      (fun temp_0_ round ->
          ...
          let re:t_Array Libcrux_ml_dsa.Simd.Portable.Vector_type.t_PortableSIMDUnit
            (Rust_primitives.mk_usize 32) =
...
let simd_unit_ntt_at_layer_1_
  ...
  let t:i32 =
    Libcrux_ml_dsa.Simd.Portable.Arithmetic.montgomery_multiply_fe_by_fer (simd_unit
          .Libcrux_ml_dsa.Simd.Portable.Vector_type.f_coefficients.[ Rust_primitives.mk_usize 2 ]
        <:
        i32)
      zeta1
  in
  ...
  let t:i32 =
    Libcrux_ml_dsa.Simd.Portable.Arithmetic.montgomery_multiply_fe_by_fer (simd_unit
          .Libcrux_ml_dsa.Simd.Portable.Vector_type.f_coefficients.[ Rust_primitives.mk_usize 6 ]
        <:
        i32)
      zeta2
  in
...
let simd_unit_ntt_at_layer_2_
  ...
  let t:i32 =
    Libcrux_ml_dsa.Simd.Portable.Arithmetic.montgomery_multiply_fe_by_fer (simd_unit
          .Libcrux_ml_dsa.Simd.Portable.Vector_type.f_coefficients.[ Rust_primitives.mk_usize 4 ]
        <:
        i32)
      zeta
  in
...
let ntt_at_layer_2_
  ...
  let (re, zeta_i), hax_temp_output:(t_Array
      Libcrux_ml_dsa.Simd.Portable.Vector_type.t_PortableSIMDUnit (Rust_primitives.mk_usize 32) &
    usize) =
    Rust_primitives.Hax.Folds.fold_range (Rust_primitives.mk_usize 0)
      (Core.Slice.impl__len #Libcrux_ml_dsa.Simd.Portable.Vector_type.t_PortableSIMDUnit
          (re <: t_Slice Libcrux_ml_dsa.Simd.Portable.Vector_type.t_PortableSIMDUnit)
            ...
            Rust_primitives.Hax.Folds.fold_range offset
              ...
              (fun re j ->
                  ...
                  let t:Libcrux_ml_dsa.Simd.Portable.Vector_type.t_PortableSIMDUnit =
                    Libcrux_ml_dsa.Simd.Traits.montgomery_multiply_by_fer #Libcrux_ml_dsa.Simd.Portable.Vector_type.t_PortableSIMDUnit
                      (re.[ j +! step_by <: usize ]
                        <:
                        Libcrux_ml_dsa.Simd.Portable.Vector_type.t_PortableSIMDUnit)
                      (Libcrux_ml_dsa.Simd.Traits.v_ZETAS_TIMES_MONTGOMERY_R.[ zeta_i ] <: i32)
