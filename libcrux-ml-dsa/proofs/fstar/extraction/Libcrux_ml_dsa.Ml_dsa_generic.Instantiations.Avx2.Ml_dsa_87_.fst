...
let generate_key_pair___inner
  ...
  let tmp0, tmp1:(t_Slice u8 & t_Slice u8) =
    Libcrux_ml_dsa.Ml_dsa_generic.Ml_dsa_87_.generate_key_pair #Libcrux_ml_dsa.Simd.Avx2.Vector_type.t_AVX2SIMDUnit
...
let sign___inner
      ...
      (randomness: t_Array u8 (sz 32))
     =
  Libcrux_ml_dsa.Ml_dsa_generic.Ml_dsa_87_.sign #Libcrux_ml_dsa.Simd.Avx2.Vector_type.t_AVX2SIMDUnit
...
let sign_pre_hashed_shake128___inner
  ...
  let tmp0, out:(t_Slice u8 &
    ...
    Libcrux_ml_dsa.Ml_dsa_generic.Ml_dsa_87_.sign_pre_hashed #Libcrux_ml_dsa.Simd.Avx2.Vector_type.t_AVX2SIMDUnit
...
let verify___inner
     ...
     =
  Libcrux_ml_dsa.Ml_dsa_generic.Ml_dsa_87_.verify #Libcrux_ml_dsa.Simd.Avx2.Vector_type.t_AVX2SIMDUnit
    #Libcrux_ml_dsa.Samplex4.Avx2.t_AVX2Sampler
    #Libcrux_ml_dsa.Hash_functions.Simd256.t_Shake128x4
    #Libcrux_ml_dsa.Hash_functions.Simd256.t_Shake256
    #Libcrux_ml_dsa.Hash_functions.Portable.t_Shake256Xof
...
let verify_pre_hashed_shake128___inner
  ...
  let tmp0, out:(t_Slice u8 &
    ...
    Libcrux_ml_dsa.Ml_dsa_generic.Ml_dsa_87_.verify_pre_hashed #Libcrux_ml_dsa.Simd.Avx2.Vector_type.t_AVX2SIMDUnit
      #Libcrux_ml_dsa.Samplex4.Avx2.t_AVX2Sampler #Libcrux_ml_dsa.Hash_functions.Portable.t_Shake128
      #Libcrux_ml_dsa.Hash_functions.Simd256.t_Shake128x4
      #Libcrux_ml_dsa.Hash_functions.Simd256.t_Shake256
