...
let sign_internal
  ...
  let eta:Libcrux_ml_dsa.Constants.t_Eta =
    match
      cast (Libcrux_ml_dsa.Constants.t_Eta_cast_to_repr Libcrux_ml_dsa.Constants.Ml_dsa_44_.v_ETA
          <:
          isize)
      <:
      u8
      ...
      | Core.Option.Option_Some signer_response ->
        ...
        (match hint <: Core.Option.t_Option (t_Array (t_Array i32 (sz 256)) (sz 4)) with
          | Core.Option.Option_Some hint ->
            ...
            let signature:t_Array u8 (sz 2420) = Rust_primitives.Hax.repeat 0uy (sz 2420) in
            ...
            in
            Core.Result.Result_Ok (Libcrux_ml_dsa.Types.impl_4__new (sz 2420) signature)
            <:
