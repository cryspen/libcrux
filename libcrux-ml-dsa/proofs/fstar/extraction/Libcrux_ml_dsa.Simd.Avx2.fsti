...
let impl_1: Libcrux_ml_dsa.Simd.Traits.t_Operations t_AVX2SIMDUnit =
  {
    ...
    (fun (lhs: t_AVX2SIMDUnit) (rhs: t_AVX2SIMDUnit) ->
        Core.Convert.f_into #Libcrux_intrinsics.Avx2_extract.t_Vec256
          #t_AVX2SIMDUnit
          #FStar.Tactics.Typeclasses.solve
          (Libcrux_ml_dsa.Simd.Avx2.Arithmetic.add lhs.f_coefficients rhs.f_coefficients
            <:
            Libcrux_intrinsics.Avx2_extract.t_Vec256));
    ...
    (fun (lhs: t_AVX2SIMDUnit) (rhs: t_AVX2SIMDUnit) ->
        Core.Convert.f_into #Libcrux_intrinsics.Avx2_extract.t_Vec256
          #t_AVX2SIMDUnit
          #FStar.Tactics.Typeclasses.solve
          (Libcrux_ml_dsa.Simd.Avx2.Arithmetic.subtract lhs.f_coefficients rhs.f_coefficients
            <:
            Libcrux_intrinsics.Avx2_extract.t_Vec256));
    ...
    (fun (simd_unit: t_AVX2SIMDUnit) (zeta0: i32) (zeta1: i32) (zeta2: i32) (zeta3: i32) ->
        Core.Convert.f_into #Libcrux_intrinsics.Avx2_extract.t_Vec256
          #t_AVX2SIMDUnit
          #FStar.Tactics.Typeclasses.solve
          (Libcrux_ml_dsa.Simd.Avx2.Ntt.ntt_at_layer_0_ simd_unit.f_coefficients
              zeta0
              zeta1
              zeta2
              zeta3
            <:
            Libcrux_intrinsics.Avx2_extract.t_Vec256));
    f_ntt_at_layer_1_pre = (fun (simd_unit: t_AVX2SIMDUnit) (zeta0: i32) (zeta1: i32) -> true);
    ...
    (fun (simd_unit: t_AVX2SIMDUnit) (zeta0: i32) (zeta1: i32) ->
        Core.Convert.f_into #Libcrux_intrinsics.Avx2_extract.t_Vec256
          #t_AVX2SIMDUnit
          #FStar.Tactics.Typeclasses.solve
          (Libcrux_ml_dsa.Simd.Avx2.Ntt.ntt_at_layer_1_ simd_unit.f_coefficients zeta0 zeta1
            <:
            Libcrux_intrinsics.Avx2_extract.t_Vec256));
    f_ntt_at_layer_2_pre = (fun (simd_unit: t_AVX2SIMDUnit) (zeta: i32) -> true);
    ...
    (fun (simd_unit: t_AVX2SIMDUnit) (zeta: i32) ->
        Core.Convert.f_into #Libcrux_intrinsics.Avx2_extract.t_Vec256
          #t_AVX2SIMDUnit
          #FStar.Tactics.Typeclasses.solve
          (Libcrux_ml_dsa.Simd.Avx2.Ntt.ntt_at_layer_2_ simd_unit.f_coefficients zeta
            <:
            Libcrux_intrinsics.Avx2_extract.t_Vec256));
    ...
    fun (simd_unit: t_AVX2SIMDUnit) (zeta: i32) ->
      Core.Convert.f_into #Libcrux_intrinsics.Avx2_extract.t_Vec256
        #t_AVX2SIMDUnit
        #FStar.Tactics.Typeclasses.solve
        (Libcrux_ml_dsa.Simd.Avx2.Ntt.invert_ntt_at_layer_2_ simd_unit.f_coefficients zeta
          <:
          Libcrux_intrinsics.Avx2_extract.t_Vec256)
  }
