...
class t_Operations (v_Self: Type0) = {
  ...
  f_ntt_at_layer_0_pre:v_Self -> i32 -> i32 -> i32 -> i32 -> Type0;
  f_ntt_at_layer_0_post:v_Self -> i32 -> i32 -> i32 -> i32 -> v_Self -> Type0;
  f_ntt_at_layer_0_:x0: v_Self -> x1: i32 -> x2: i32 -> x3: i32 -> x4: i32
    -> Prims.Pure v_Self
        (f_ntt_at_layer_0_pre x0 x1 x2 x3 x4)
        (fun result -> f_ntt_at_layer_0_post x0 x1 x2 x3 x4 result);
  f_ntt_at_layer_1_pre:v_Self -> i32 -> i32 -> Type0;
  f_ntt_at_layer_1_post:v_Self -> i32 -> i32 -> v_Self -> Type0;
  f_ntt_at_layer_1_:x0: v_Self -> x1: i32 -> x2: i32
    -> Prims.Pure v_Self
        (f_ntt_at_layer_1_pre x0 x1 x2)
        (fun result -> f_ntt_at_layer_1_post x0 x1 x2 result);
  f_ntt_at_layer_2_pre:v_Self -> i32 -> Type0;
  f_ntt_at_layer_2_post:v_Self -> i32 -> v_Self -> Type0;
  f_ntt_at_layer_2_:x0: v_Self -> x1: i32
    -> Prims.Pure v_Self
        (f_ntt_at_layer_2_pre x0 x1)
        (fun result -> f_ntt_at_layer_2_post x0 x1 result);
