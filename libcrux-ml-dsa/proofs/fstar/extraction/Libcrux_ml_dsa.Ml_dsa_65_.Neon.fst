...
let sign
  ...
  Libcrux_ml_dsa.Ml_dsa_generic.Instantiations.Neon.sign (Rust_primitives.mk_usize 6)
...
let verify
  ...
  Libcrux_ml_dsa.Ml_dsa_generic.Instantiations.Neon.verify (Rust_primitives.mk_usize 6)
...
let generate_key_pair (randomness: t_Array u8 (Rust_primitives.mk_usize 32))
  ...
  let signing_key, verification_key:(t_Array u8 (Rust_primitives.mk_usize 4032) &
    ...
    Libcrux_ml_dsa.Ml_dsa_generic.Instantiations.Neon.generate_key_pair (Rust_primitives.mk_usize 6)
