...
let change_interval (simd_unit: Minicore.Abstractions.Bitvec.t_BitVec (mk_u64 256)) =
  let interval_end:Minicore.Abstractions.Bitvec.t_BitVec (mk_u64 256) =
...
let serialize (simd_unit: Minicore.Abstractions.Bitvec.t_BitVec (mk_u64 256)) (out: t_Slice u8) =
  ...
  let simd_unit:Minicore.Abstractions.Bitvec.t_BitVec (mk_u64 256) = change_interval simd_unit in
  ...
  in
  let second_4_combined:Minicore.Abstractions.Bitvec.t_BitVec (mk_u64 256) =
    Libcrux_intrinsics.Avx2_extract.mm256_bsrli_epi128 (mk_i32 8) adjacent_4_combined
  in
  let least_12_bits_shifted_up:Minicore.Abstractions.Bitvec.t_BitVec (mk_u64 256) =
    Libcrux_intrinsics.Avx2_extract.mm256_slli_epi64 (mk_i32 52) second_4_combined
  in
  let bits_sequential:Minicore.Abstractions.Bitvec.t_BitVec (mk_u64 256) =
  ...
  let bits_sequential:Minicore.Abstractions.Bitvec.t_BitVec (mk_u64 256) =
    Libcrux_intrinsics.Avx2_extract.mm256_srlv_epi64 bits_sequential
      (Libcrux_intrinsics.Avx2_extract.mm256_set_epi64x (mk_i64 0) (mk_i64 0) (mk_i64 12) (mk_i64 0)
        ...
        Minicore.Abstractions.Bitvec.t_BitVec (mk_u64 256))
  in
  let bits_sequential:Minicore.Abstractions.Bitvec.t_BitVec (mk_u64 128) =
...
let deserialize (serialized: t_Slice u8) (out: Minicore.Abstractions.Bitvec.t_BitVec (mk_u64 256)) =
  let _:Prims.unit =
    if true
    then
      let _:Prims.unit =
  ...
  let serialized_extended:t_Array u8 (mk_usize 16) =
    Rust_primitives.Hax.Monomorphized_update_at.update_at_range serialized_extended
      ...
      (Core.Slice.impl__copy_from_slice #u8
        ...
        t_Slice u8)
  in
  let serialized:Minicore.Abstractions.Bitvec.t_BitVec (mk_u64 128) =
  ...
  let coefficients:Minicore.Abstractions.Bitvec.t_BitVec (mk_u64 256) =
    Libcrux_intrinsics.Avx2_extract.mm256_and_si256 coefficients
      (Libcrux_intrinsics.Avx2_extract.mm256_set1_epi32 deserialize__v_COEFFICIENT_MASK
        ...
        Minicore.Abstractions.Bitvec.t_BitVec (mk_u64 256))
  in
  let out:Minicore.Abstractions.Bitvec.t_BitVec (mk_u64 256) = change_interval coefficients in
  out
