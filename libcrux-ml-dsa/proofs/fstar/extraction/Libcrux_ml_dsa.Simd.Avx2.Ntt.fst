...
let butterfly_2_
  ...
  let a:Core_models.Abstractions.Bitvec.t_BitVec (mk_u64 256) =
    Libcrux_intrinsics.Avx2.mm256_shuffle_epi32 (mk_i32 216)
...
assume val get_i32x8: vec:Libcrux_ml_dsa.Simd.Avx2.Vector_type.t_Vec256 -> i:nat {i < 8} -> i32

let butterfly_2_spec (a b a' b': Libcrux_ml_dsa.Simd.Avx2.Vector_type.t_Vec256)
                     (zb3 zb2 za3 za2 zb1 zb0 za1 za0: i32)
=
    ...
    // summands = ( A75, B75, A31, B31 )
    // zeta_products = ( A64, B64, A20, B20 )

    // zeta_products = (a6 a4 b6 b4 a2 a0 b2 b0) m* (zb3 zb2 za3 za2 zb1 zb0 za1 za0)
    // zeta_products = (a6 m* zb3, a4 m* zb2, b6 m* za3, b4 m* za2, a2 m* zb1, a0 m* zb0, b2 m* za1, b0 m* za0)

    // sub_terms = ( a7 a5 b7 b5 a3 a1 b3 b1 )
    //           - (a6 m* zb3, a4 m* zb2, b6 m* za3, b4 m* za2, a2 m* zb1, a0 m* zb0, b2 m* za1, b0 m* za0) 
    // sub_terms = (a7 - (a6 m* zb3), a5 - (a4 m* zb2), b7 - (b6 m* za3), b5 - (b4 m* za2)
    //            , a3 - (a2 m* zb1), a1 - (a0 m* zb0), b3 - (b2 m* za1), b1 - (b0 m* za0))
    // add_terms = (a7 + (a6 m* zb3), a5 + (a4 m* zb2), b7 + (b6 m* za3), b5 + (b4 m* za2)
    //            , a3 + (a2 m* zb1), a1 + (a0 m* zb0), b3 + (b2 m* za1), b1 + (b0 m* za0))
    ...
    //   get_i32x8 b' 0 == get_i32x8 a 6 *. zb3
    // /\ get_i32x8 b' 1 == get_i32x8 a 4 *. zb2
    // /\ get_i32x8 b' 2 == get_i32x8 b 6 *. za3
    // /\ get_i32x8 b' 3 == get_i32x8 b 4 *. za2
    // /\ get_i32x8 b' 4 == get_i32x8 a 2 *. zb1
    // /\ get_i32x8 b' 5 == get_i32x8 a 0 *. zb0
    // /\ get_i32x8 b' 6 == get_i32x8 b 2 *. za1
    // /\ get_i32x8 b' 7 == get_i32x8 b 0 *. za0

let butterfly_2_lemma
      (re: t_Array Libcrux_ml_dsa.Simd.Avx2.Vector_type.t_Vec256 (mk_usize 32))
      (index: usize {v index < 31})
      (zeta_a0 zeta_a1 zeta_a2 zeta_a3 zeta_b0 zeta_b1 zeta_b2 zeta_b3: i32) =
  let re' = butterfly_2_ re index zeta_a0 zeta_a1 zeta_a2 zeta_a3 zeta_b0 zeta_b1 zeta_b2 zeta_b3 in
    modifies2_32 re re' index (index +. mk_int 1)
  /\ butterfly_2_spec
                (Seq.index re  (v index)) (Seq.index re  (v index + 1))
                (Seq.index re' (v index)) (Seq.index re' (v index + 1))
...
let butterfly_4_
    ...
    : t_Array Libcrux_ml_dsa.Simd.Avx2.Vector_type.t_Vec256 (mk_usize 32) =
  let summands:Core_models.Abstractions.Bitvec.t_BitVec (mk_u64 256) =
    Libcrux_intrinsics.Avx2.mm256_unpacklo_epi64 (re.[ index ]
        <:
        Libcrux_ml_dsa.Simd.Avx2.Vector_type.t_Vec256)
        .Libcrux_ml_dsa.Simd.Avx2.Vector_type.f_value
      (re.[ index +! mk_usize 1 <: usize ] <: Libcrux_ml_dsa.Simd.Avx2.Vector_type.t_Vec256)
  ...
  in
  let zeta_products:Core_models.Abstractions.Bitvec.t_BitVec (mk_u64 256) =
    Libcrux_intrinsics.Avx2.mm256_unpackhi_epi64 (re.[ index ]
        <:
        Libcrux_ml_dsa.Simd.Avx2.Vector_type.t_Vec256)
        .Libcrux_ml_dsa.Simd.Avx2.Vector_type.f_value
      (re.[ index +! mk_usize 1 <: usize ] <: Libcrux_ml_dsa.Simd.Avx2.Vector_type.t_Vec256)
...
let butterfly_8_
    ...
    : t_Array Libcrux_ml_dsa.Simd.Avx2.Vector_type.t_Vec256 (mk_usize 32) =
  let summands:Core_models.Abstractions.Bitvec.t_BitVec (mk_u64 256) =
    Libcrux_intrinsics.Avx2.mm256_set_m128i (Libcrux_intrinsics.Avx2.mm256_castsi256_si128 (re.[ index +!
              mk_usize 1
              <:
              usize ]
            <:
      ...
      (Libcrux_intrinsics.Avx2.mm256_castsi256_si128 (re.[ index ]
            <:
            Libcrux_ml_dsa.Simd.Avx2.Vector_type.t_Vec256)
            .Libcrux_ml_dsa.Simd.Avx2.Vector_type.f_value
        <:
  ...
  in
  let zeta_products:Core_models.Abstractions.Bitvec.t_BitVec (mk_u64 256) =
    Libcrux_intrinsics.Avx2.mm256_permute2x128_si256 (mk_i32 19)
      (re.[ index +! mk_usize 1 <: usize ] <: Libcrux_ml_dsa.Simd.Avx2.Vector_type.t_Vec256)
        .Libcrux_ml_dsa.Simd.Avx2.Vector_type.f_value
      (re.[ index ] <: Libcrux_ml_dsa.Simd.Avx2.Vector_type.t_Vec256)
        .Libcrux_ml_dsa.Simd.Avx2.Vector_type.f_value
...
let ntt_at_layer_7_and_6___mul
  ...
  let prod02:Core_models.Abstractions.Bitvec.t_BitVec (mk_u64 256) =
    Libcrux_intrinsics.Avx2.mm256_mul_epi32 (re.[ index +! step_by <: usize ]
        <:
        Libcrux_ml_dsa.Simd.Avx2.Vector_type.t_Vec256)
        .Libcrux_ml_dsa.Simd.Avx2.Vector_type.f_value
      zeta
  ...
  let prod13:Core_models.Abstractions.Bitvec.t_BitVec (mk_u64 256) =
    Libcrux_intrinsics.Avx2.mm256_mul_epi32 (Libcrux_intrinsics.Avx2.mm256_shuffle_epi32 (mk_i32 245
        ...
        <:
        Core_models.Abstractions.Bitvec.t_BitVec (mk_u64 256))
      (Libcrux_intrinsics.Avx2.mm256_shuffle_epi32 (mk_i32 245) zeta
        <:
        Core_models.Abstractions.Bitvec.t_BitVec (mk_u64 256))
  in
