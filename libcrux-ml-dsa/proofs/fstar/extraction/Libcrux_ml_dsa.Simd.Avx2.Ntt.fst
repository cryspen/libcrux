...
let ntt_at_layer_7_and_6___mul
  ...
  let re:t_Array Libcrux_intrinsics.Avx2_extract.t_Vec256 (sz 32) =
    Rust_primitives.Hax.Monomorphized_update_at.update_at_usize re
      (index +! step_by <: usize)
      (re.[ index ] <: Libcrux_intrinsics.Avx2_extract.t_Vec256)
  in
  let re:t_Array Libcrux_intrinsics.Avx2_extract.t_Vec256 (sz 32) =
    Rust_primitives.Hax.Monomorphized_update_at.update_at_usize re
      (index +! step_by <: usize)
...
let ntt__avx2_ntt (re: t_Array Libcrux_intrinsics.Avx2_extract.t_Vec256 (sz 32)) =
...
let ntt (re: t_Array Libcrux_intrinsics.Avx2_extract.t_Vec256 (sz 32)) =
  let hax_temp_output, re:(Prims.unit & t_Array Libcrux_intrinsics.Avx2_extract.t_Vec256 (sz 32)) =
    (), ntt__avx2_ntt re <: (Prims.unit & t_Array Libcrux_intrinsics.Avx2_extract.t_Vec256 (sz 32))
  in
  re
