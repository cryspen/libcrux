...
let butterfly_2_
  ...
  let a_shuffled:Libcrux_intrinsics.Avx2_extract.t_Vec256 =
    Libcrux_intrinsics.Avx2_extract.mm256_shuffle_epi32 (Rust_primitives.mk_i32 216) a
  in
  let b_shuffled:Libcrux_intrinsics.Avx2_extract.t_Vec256 =
    Libcrux_intrinsics.Avx2_extract.mm256_shuffle_epi32 (Rust_primitives.mk_i32 216) b
  in
  ...
  let a_out:Libcrux_intrinsics.Avx2_extract.t_Vec256 =
    Libcrux_intrinsics.Avx2_extract.mm256_shuffle_epi32 (Rust_primitives.mk_i32 216)
      a_terms_shuffled
  in
...
let butterfly_8_ (a b: Libcrux_intrinsics.Avx2_extract.t_Vec256) (zeta0 zeta1: i32) =
  ...
  in
  let zeta_multiplicands:Libcrux_intrinsics.Avx2_extract.t_Vec256 =
    Libcrux_intrinsics.Avx2_extract.mm256_permute2x128_si256 (Rust_primitives.mk_i32 19) b a
  in
  let zetas:Libcrux_intrinsics.Avx2_extract.t_Vec256 =
  ...
  in
  let b_out:Libcrux_intrinsics.Avx2_extract.t_Vec256 =
    Libcrux_intrinsics.Avx2_extract.mm256_permute2x128_si256 (Rust_primitives.mk_i32 19)
      sub_terms
      add_terms
  in
  a_out, b_out
...
let ntt_at_layer_3_plus
  ...
  let (re, zeta_i), hax_temp_output:(t_Array Libcrux_intrinsics.Avx2_extract.t_Vec256
    ...
    Rust_primitives.Hax.Folds.fold_range (Rust_primitives.mk_usize 0)
      ...
      (fun temp_0_ temp_1_ ->
          let re, zeta_i:(t_Array Libcrux_intrinsics.Avx2_extract.t_Vec256
              (Rust_primitives.mk_usize 32) &
            usize) =
            temp_0_
          in
      ...
      (re, zeta_i
        <:
        (t_Array Libcrux_intrinsics.Avx2_extract.t_Vec256 (Rust_primitives.mk_usize 32) & usize))
      (fun temp_0_ round ->
          let re, zeta_i:(t_Array Libcrux_intrinsics.Avx2_extract.t_Vec256
              (Rust_primitives.mk_usize 32) &
            usize) =
          ...
          let re:t_Array Libcrux_intrinsics.Avx2_extract.t_Vec256 (Rust_primitives.mk_usize 32) =
            Rust_primitives.Hax.Folds.fold_range offset
              (offset +! step_by <: usize)
              (fun re temp_1_ ->
                  let re:t_Array Libcrux_intrinsics.Avx2_extract.t_Vec256
                    (Rust_primitives.mk_usize 32) =
                    re
                  in
                  let _:usize = temp_1_ in
...
let ntt_at_layer_0_
     ...
     =
  let zeta_i:usize = zeta_i +! Rust_primitives.mk_usize 1 in
  let re, zeta_i:(t_Array Libcrux_intrinsics.Avx2_extract.t_Vec256 (Rust_primitives.mk_usize 32) &
    usize) =
    Rust_primitives.Hax.Folds.fold_range_step_by (Rust_primitives.mk_usize 0)
      ...
      (fun temp_0_ round ->
          ...
          let a, b:(Libcrux_intrinsics.Avx2_extract.t_Vec256 &
            ...
            butterfly_2_ (re.[ round ] <: Libcrux_intrinsics.Avx2_extract.t_Vec256)
              (re.[ round +! Rust_primitives.mk_usize 1 <: usize ]
                <:
                Libcrux_intrinsics.Avx2_extract.t_Vec256)
              (Libcrux_ml_dsa.Simd.Traits.v_ZETAS_TIMES_MONTGOMERY_R.[ zeta_i ] <: i32)
          ...
          let re:t_Array Libcrux_intrinsics.Avx2_extract.t_Vec256 (Rust_primitives.mk_usize 32) =
            Rust_primitives.Hax.Monomorphized_update_at.update_at_usize re
              (round +! Rust_primitives.mk_usize 1 <: usize)
              b
          in
          let zeta_i:usize = zeta_i +! Rust_primitives.mk_usize 8 in
          re, zeta_i
          <:
          (t_Array Libcrux_intrinsics.Avx2_extract.t_Vec256 (Rust_primitives.mk_usize 32) & usize))
  in
...
let ntt (re: t_Array Libcrux_intrinsics.Avx2_extract.t_Vec256 (Rust_primitives.mk_usize 32)) =
  ...
  let re:t_Array Libcrux_intrinsics.Avx2_extract.t_Vec256 (Rust_primitives.mk_usize 32) = tmp1 in
  let _:Prims.unit = () in
  let tmp0, tmp1:(usize &
    t_Array Libcrux_intrinsics.Avx2_extract.t_Vec256 (Rust_primitives.mk_usize 32)) =
