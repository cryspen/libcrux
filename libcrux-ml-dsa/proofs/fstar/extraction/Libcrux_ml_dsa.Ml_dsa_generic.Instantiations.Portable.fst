...
let generate_key_pair_v44
  ...
  let tmp0, tmp1:(t_Slice u8 & t_Slice u8) =
    Libcrux_ml_dsa.Ml_dsa_generic.generate_key_pair_v44 #Libcrux_ml_dsa.Simd.Portable.Vector_type.t_PortableSIMDUnit
...
let generate_key_pair_v65
     ...
     =
  let tmp0, tmp1:(t_Slice u8 & t_Slice u8) =
    Libcrux_ml_dsa.Ml_dsa_generic.generate_key_pair_v65 #Libcrux_ml_dsa.Simd.Portable.Vector_type.t_PortableSIMDUnit
      #Libcrux_ml_dsa.Samplex4.Portable.t_PortableSampler
      #Libcrux_ml_dsa.Hash_functions.Portable.t_Shake128X4
      #Libcrux_ml_dsa.Hash_functions.Portable.t_Shake256
      #Libcrux_ml_dsa.Hash_functions.Portable.t_Shake256Xof
...
let generate_key_pair_v87
     ...
     =
  let tmp0, tmp1:(t_Slice u8 & t_Slice u8) =
    Libcrux_ml_dsa.Ml_dsa_generic.generate_key_pair_v87 #Libcrux_ml_dsa.Simd.Portable.Vector_type.t_PortableSIMDUnit
      #Libcrux_ml_dsa.Samplex4.Portable.t_PortableSampler
      #Libcrux_ml_dsa.Hash_functions.Portable.t_Shake128X4
      #Libcrux_ml_dsa.Hash_functions.Portable.t_Shake256
      #Libcrux_ml_dsa.Hash_functions.Portable.t_Shake256Xof
...
let sign
  ...
  Libcrux_ml_dsa.Ml_dsa_generic.sign #Libcrux_ml_dsa.Simd.Portable.Vector_type.t_PortableSIMDUnit
    ...
    #Libcrux_ml_dsa.Hash_functions.Portable.t_Shake256
    #Libcrux_ml_dsa.Hash_functions.Portable.t_Shake256Xof
    #Libcrux_ml_dsa.Hash_functions.Portable.t_Shake256X4 v_ROWS_IN_A v_COLUMNS_IN_A v_ROWS_X_COLUMNS
...
let verify_pre_hashed_shake128
  ...
  Libcrux_ml_dsa.Ml_dsa_generic.verify_pre_hashed #Libcrux_ml_dsa.Simd.Portable.Vector_type.t_PortableSIMDUnit
    ...
    (sz 256) v_ROWS_IN_A v_COLUMNS_IN_A v_ROWS_X_COLUMNS v_SIGNATURE_SIZE v_VERIFICATION_KEY_SIZE
    v_GAMMA1_EXPONENT v_GAMMA1_RING_ELEMENT_SIZE v_GAMMA2 v_BETA v_COMMITMENT_RING_ELEMENT_SIZE
    v_COMMITMENT_VECTOR_SIZE v_COMMITMENT_HASH_SIZE v_ONES_IN_VERIFIER_CHALLENGE v_MAX_ONES_IN_HINT
    verification_key message context signature
