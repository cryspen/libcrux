...
let generate_key_pair (randomness: t_Array u8 (sz 32)) =
  ...
  let tmp0, tmp1:(t_Array u8 (sz 4896) & t_Array u8 (sz 2592)) =
    Libcrux_ml_dsa.Ml_dsa_generic.Multiplexing.generate_key_pair_v87 randomness
      signing_key
      verification_key
  in
...
let sign
     ...
     =
  Libcrux_ml_dsa.Ml_dsa_generic.Multiplexing.sign (sz 8) (sz 7) (sz 56) (sz 2) (sz 96) (sz 19)
...
let sign_pre_hashed_shake128
      ...
      (randomness: t_Array u8 (sz 32))
     =
  Libcrux_ml_dsa.Ml_dsa_generic.Multiplexing.sign_pre_hashed_shake128 (sz 8) (sz 7) (sz 56) (sz 2)
...
let verify
     ...
     =
  Libcrux_ml_dsa.Ml_dsa_generic.Multiplexing.verify (sz 8) (sz 7) (sz 56) (sz 4627) (sz 2592)
...
let verify_pre_hashed_shake128
      ...
      (signature: Libcrux_ml_dsa.Types.t_MLDSASignature (sz 4627))
     =
  Libcrux_ml_dsa.Ml_dsa_generic.Multiplexing.verify_pre_hashed_shake128 (sz 8) (sz 7) (sz 56)
