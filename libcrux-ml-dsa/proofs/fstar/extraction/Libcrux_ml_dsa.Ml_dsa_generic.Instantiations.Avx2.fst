...
let generate_key_pair
     ...
     =
  Libcrux_ml_dsa.Ml_dsa_generic.generate_key_pair #Libcrux_ml_dsa.Simd.Avx2.t_AVX2SIMDUnit
...
let sign
      ...
      (randomness: t_Array u8 (sz 32))
     =
  Libcrux_ml_dsa.Ml_dsa_generic.sign #Libcrux_ml_dsa.Simd.Avx2.t_AVX2SIMDUnit
    #Libcrux_ml_dsa.Hash_functions.Simd256.t_Shake128x4
    #Libcrux_ml_dsa.Hash_functions.Simd256.t_Shake256
    #Libcrux_ml_dsa.Hash_functions.Simd256.t_Shake256x4 v_ROWS_IN_A v_COLUMNS_IN_A v_ETA
...
let verify
     ...
     =
  Libcrux_ml_dsa.Ml_dsa_generic.verify #Libcrux_ml_dsa.Simd.Avx2.t_AVX2SIMDUnit
    #Libcrux_ml_dsa.Hash_functions.Simd256.t_Shake128x4
