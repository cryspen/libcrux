...
let serialize_6_ (simd_unit: Minicore.Abstractions.Bitvec.t_BitVec (mk_u64 256)) =
  ...
  in
  let adjacent_3_combined:Minicore.Abstractions.Bitvec.t_BitVec (mk_u64 256) =
    Minicore.Arch.X86.Extra.mm256_mullo_epi16_shifts adjacent_3_combined (mk_u8 0) (mk_u8 0)
      ...
      let serialized:t_Array u8 (mk_usize 19) =
        Rust_primitives.Hax.Monomorphized_update_at.update_at_range serialized
          ...
          (Libcrux_intrinsics.Avx2_extract.mm_storeu_bytes_si128 (serialized.[ {
                ...
                <:
                t_Slice u8)
              (serialize_4_ simd_unit <: Minicore.Abstractions.Bitvec.t_BitVec (mk_u64 128))
            <:
            t_Slice u8)
      in
      let out:t_Slice u8 =
