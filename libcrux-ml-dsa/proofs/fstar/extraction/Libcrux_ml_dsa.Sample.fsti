...
val update_seed (seed: t_Array u8 (Rust_primitives.mk_usize 66)) (domain_separator: u16)
    : Prims.Pure (u16 & t_Array u8 (Rust_primitives.mk_usize 66))
      Prims.l_True
      (fun _ -> Prims.l_True)
...
val rejection_sample_less_than_eta_equals_2_
    ...
    : Prims.Pure (usize & t_Array i32 (Rust_primitives.mk_usize 263) & bool)
      Prims.l_True
      (fun _ -> Prims.l_True)
...
val inside_out_shuffle
    ...
    : Prims.Pure (usize & u64 & t_Array i32 (Rust_primitives.mk_usize 256) & bool)
      Prims.l_True
      (fun _ -> Prims.l_True)
