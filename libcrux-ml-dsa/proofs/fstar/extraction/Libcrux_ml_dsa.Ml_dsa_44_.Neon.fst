...
let sign
     ...
     =
  Libcrux_ml_dsa.Ml_dsa_generic.Instantiations.Neon.sign (sz 4) (sz 4) (sz 16) (sz 2) (sz 96)
...
let sign_pre_hashed_shake128
      ...
      (randomness: t_Array u8 (sz 32))
     =
  Libcrux_ml_dsa.Ml_dsa_generic.Instantiations.Neon.sign_pre_hashed_shake128 (sz 4) (sz 4) (sz 16)
...
let verify
     ...
     =
  Libcrux_ml_dsa.Ml_dsa_generic.Instantiations.Neon.verify (sz 4) (sz 4) (sz 16) (sz 2420) (sz 1312)
...
let verify_pre_hashed_shake128
      ...
      (signature: Libcrux_ml_dsa.Types.t_MLDSASignature (sz 2420))
     =
  Libcrux_ml_dsa.Ml_dsa_generic.Instantiations.Neon.verify_pre_hashed_shake128 (sz 4) (sz 4) (sz 16)
