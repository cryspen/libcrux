...
let butterfly_2_aux__v_SHUFFLE: i32 = mk_i32 216
...
let butterfly_2_aux
      (re0 re1: Core_models.Abstractions.Bitvec.t_BitVec (mk_u64 256))
  ...
  let a:Core_models.Abstractions.Bitvec.t_BitVec (mk_u64 256) =
    Libcrux_intrinsics.Avx2.mm256_shuffle_epi32 (mk_i32 216) re0
  in
  let b:Core_models.Abstractions.Bitvec.t_BitVec (mk_u64 256) =
    Libcrux_intrinsics.Avx2.mm256_shuffle_epi32 (mk_i32 216) re1
  in
  let summands:Core_models.Abstractions.Bitvec.t_BitVec (mk_u64 256) =
    Libcrux_intrinsics.Avx2.mm256_unpacklo_epi64 a b
  in
  let zeta_products:Core_models.Abstractions.Bitvec.t_BitVec (mk_u64 256) =
    Libcrux_intrinsics.Avx2.mm256_unpackhi_epi64 a b
  in
  let zetas:Core_models.Abstractions.Bitvec.t_BitVec (mk_u64 256) =
    Libcrux_intrinsics.Avx2.mm256_set_epi32 zeta_b3
      zeta_b2
      zeta_a3
      zeta_a2
      zeta_b1
  ...
  in
  let sub_terms:Core_models.Abstractions.Bitvec.t_BitVec (mk_u64 256) =
    Libcrux_intrinsics.Avx2.mm256_sub_epi32 summands zeta_products
  in
  let add_terms:Core_models.Abstractions.Bitvec.t_BitVec (mk_u64 256) =
    Libcrux_intrinsics.Avx2.mm256_add_epi32 summands zeta_products
  in
  let a_terms_shuffled:Core_models.Abstractions.Bitvec.t_BitVec (mk_u64 256) =
    Libcrux_intrinsics.Avx2.mm256_unpacklo_epi64 add_terms sub_terms
  in
  let b_terms_shuffled:Core_models.Abstractions.Bitvec.t_BitVec (mk_u64 256) =
    Libcrux_intrinsics.Avx2.mm256_unpackhi_epi64 add_terms sub_terms
  in
  let nre0:Core_models.Abstractions.Bitvec.t_BitVec (mk_u64 256) =
    Libcrux_intrinsics.Avx2.mm256_shuffle_epi32 (mk_i32 216) a_terms_shuffled
  in
  let nre1:Core_models.Abstractions.Bitvec.t_BitVec (mk_u64 256) =
    Libcrux_intrinsics.Avx2.mm256_shuffle_epi32 (mk_i32 216) b_terms_shuffled
  in
  nre0, nre1
  <:
  (Core_models.Abstractions.Bitvec.t_BitVec (mk_u64 256) &
...
let butterfly_2_
    ...
    : Prims.Pure (t_Array Libcrux_ml_dsa.Simd.Avx2.Vector_type.t_Vec256 (mk_usize 32))
      (requires index <. mk_usize 31)
      (ensures
        fun re_future ->
          let re_future:t_Array Libcrux_ml_dsa.Simd.Avx2.Vector_type.t_Vec256 (mk_usize 32) =
            re_future
          in
          let open Libcrux_ml_dsa.Simd.Avx2.Vector_type in
          let nre0, nre1 =
            butterfly_2_aux (re.[ index ]).f_value (re.[ index +! mk_int 1 ]).f_value zeta_a0
              zeta_a1 zeta_a2 zeta_a3 zeta_b0 zeta_b1 zeta_b2 zeta_b3
          in
          Spec.Utils.modifies2_32 re re_future index (index +! mk_int 1) /\
          (Seq.index re_future (v index)).f_value == nre0 /\
          (Seq.index re_future (v index + 1)).f_value == nre1) =
  let nre0, nre1:(Core_models.Abstractions.Bitvec.t_BitVec (mk_u64 256) &
    Core_models.Abstractions.Bitvec.t_BitVec (mk_u64 256)) =
    butterfly_2_aux (re.[ index ] <: Libcrux_ml_dsa.Simd.Avx2.Vector_type.t_Vec256)
        .Libcrux_ml_dsa.Simd.Avx2.Vector_type.f_value
      (re.[ index +! mk_usize 1 <: usize ] <: Libcrux_ml_dsa.Simd.Avx2.Vector_type.t_Vec256)
        .Libcrux_ml_dsa.Simd.Avx2.Vector_type.f_value zeta_a0 zeta_a1 zeta_a2 zeta_a3 zeta_b0
      zeta_b1 zeta_b2 zeta_b3
  in
  let re:t_Array Libcrux_ml_dsa.Simd.Avx2.Vector_type.t_Vec256 (mk_usize 32) =
    Rust_primitives.Hax.Monomorphized_update_at.update_at_usize re
      ...
      ({
          ...
          Libcrux_ml_dsa.Simd.Avx2.Vector_type.f_value = nre0
        }
        <:
  ...
  let re:t_Array Libcrux_ml_dsa.Simd.Avx2.Vector_type.t_Vec256 (mk_usize 32) =
    Rust_primitives.Hax.Monomorphized_update_at.update_at_usize re
      ...
      ({
          (re.[ index +! mk_usize 1 <: usize ] <: Libcrux_ml_dsa.Simd.Avx2.Vector_type.t_Vec256) with
          Libcrux_ml_dsa.Simd.Avx2.Vector_type.f_value = nre1
        }
        <:
        Libcrux_ml_dsa.Simd.Avx2.Vector_type.t_Vec256)
  in
...
let butterfly_4_aux
  ...
  let summands:Core_models.Abstractions.Bitvec.t_BitVec (mk_u64 256) =
    Libcrux_intrinsics.Avx2.mm256_unpacklo_epi64 re0 re1
  in
  let zeta_products:Core_models.Abstractions.Bitvec.t_BitVec (mk_u64 256) =
    Libcrux_intrinsics.Avx2.mm256_unpackhi_epi64 re0 re1
  in
  let zetas:Core_models.Abstractions.Bitvec.t_BitVec (mk_u64 256) =
    Libcrux_intrinsics.Avx2.mm256_set_epi32 zeta_b1
      zeta_b1
      zeta_a1
      zeta_a1
      zeta_b0
...
let butterfly_4_
  ...
  let nre0, nre1:(Core_models.Abstractions.Bitvec.t_BitVec (mk_u64 256) &
    Core_models.Abstractions.Bitvec.t_BitVec (mk_u64 256)) =
    butterfly_4_aux (re.[ index ] <: Libcrux_ml_dsa.Simd.Avx2.Vector_type.t_Vec256)
        .Libcrux_ml_dsa.Simd.Avx2.Vector_type.f_value
      (re.[ index +! mk_usize 1 <: usize ] <: Libcrux_ml_dsa.Simd.Avx2.Vector_type.t_Vec256)
        .Libcrux_ml_dsa.Simd.Avx2.Vector_type.f_value
      zeta_a0
...
let butterfly_8_aux
  ...
  let summands:Core_models.Abstractions.Bitvec.t_BitVec (mk_u64 256) =
    Libcrux_intrinsics.Avx2.mm256_set_m128i (Libcrux_intrinsics.Avx2.mm256_castsi256_si128 re1
        <:
        Core_models.Abstractions.Bitvec.t_BitVec (mk_u64 128))
      (Libcrux_intrinsics.Avx2.mm256_castsi256_si128 re0
        <:
        Core_models.Abstractions.Bitvec.t_BitVec (mk_u64 128))
  in
  let zeta_products:Core_models.Abstractions.Bitvec.t_BitVec (mk_u64 256) =
    Libcrux_intrinsics.Avx2.mm256_permute2x128_si256 (mk_i32 19) re1 re0
  in
  let zetas:Core_models.Abstractions.Bitvec.t_BitVec (mk_u64 256) =
    Libcrux_intrinsics.Avx2.mm256_set_epi32 zeta1 zeta1 zeta1 zeta1 zeta0 zeta0 zeta0 zeta0
  in
  let zeta_products:Core_models.Abstractions.Bitvec.t_BitVec (mk_u64 256) =
    Libcrux_ml_dsa.Simd.Avx2.Arithmetic.montgomery_multiply zeta_products zetas
  in
  ...
  let add_terms:Core_models.Abstractions.Bitvec.t_BitVec (mk_u64 256) =
    Libcrux_intrinsics.Avx2.mm256_add_epi32 summands zeta_products
  in
  Libcrux_intrinsics.Avx2.mm256_set_m128i (Libcrux_intrinsics.Avx2.mm256_castsi256_si128 sub_terms
      <:
      Core_models.Abstractions.Bitvec.t_BitVec (mk_u64 128))
    (Libcrux_intrinsics.Avx2.mm256_castsi256_si128 add_terms
      <:
      Core_models.Abstractions.Bitvec.t_BitVec (mk_u64 128)),
  Libcrux_intrinsics.Avx2.mm256_permute2x128_si256 (mk_i32 19) sub_terms add_terms
  <:
  (Core_models.Abstractions.Bitvec.t_BitVec (mk_u64 256) &
    Core_models.Abstractions.Bitvec.t_BitVec (mk_u64 256))
...
let butterfly_8_
    ...
    : Prims.Pure (t_Array Libcrux_ml_dsa.Simd.Avx2.Vector_type.t_Vec256 (mk_usize 32))
      ...
      (ensures
        fun re_future ->
          ...
          let open Libcrux_ml_dsa.Simd.Avx2.Vector_type in
          let nre0, nre1 =
            butterfly_8_aux (re.[ index ]).f_value (re.[ index +! mk_int 1 ]).f_value zeta0 zeta1
          in
          Spec.Utils.modifies2_32 re re_future index (index +! mk_int 1) /\
          (Seq.index re_future (v index)).f_value == nre0 /\
          (Seq.index re_future (v index + 1)).f_value == nre1) =
  let nre0, nre1:(Core_models.Abstractions.Bitvec.t_BitVec (mk_u64 256) &
    Core_models.Abstractions.Bitvec.t_BitVec (mk_u64 256)) =
    butterfly_8_aux (re.[ index ] <: Libcrux_ml_dsa.Simd.Avx2.Vector_type.t_Vec256)
        .Libcrux_ml_dsa.Simd.Avx2.Vector_type.f_value
      (re.[ index +! mk_usize 1 <: usize ] <: Libcrux_ml_dsa.Simd.Avx2.Vector_type.t_Vec256)
        .Libcrux_ml_dsa.Simd.Avx2.Vector_type.f_value
      zeta0
...
let ntt_at_layer_7_and_6___mul_aux
      (re0 re1 zeta field_modulus inverse_of_modulus_mod_montgomery_r:
          Core_models.Abstractions.Bitvec.t_BitVec (mk_u64 256))
    : Prims.Pure
      (Core_models.Abstractions.Bitvec.t_BitVec (mk_u64 256) &
        Core_models.Abstractions.Bitvec.t_BitVec (mk_u64 256))
      ...
      (ensures
        fun result ->
          ...
          Spec.Utils.forall8 (fun i ->
                ...
                ntt_step (to_i32x8 zeta (mk_int i))
                  (to_i32x8 re0 (mk_u64 i), to_i32x8 re1 (mk_u64 i)))) =
  let t:Core_models.Abstractions.Bitvec.t_BitVec (mk_u64 256) = re1 in
  let t:Core_models.Abstractions.Bitvec.t_BitVec (mk_u64 256) =
    Libcrux_ml_dsa.Simd.Avx2.Arithmetic.montgomery_multiply_aux field_modulus
      inverse_of_modulus_mod_montgomery_r
      t
      zeta
  in
  let re1:Core_models.Abstractions.Bitvec.t_BitVec (mk_u64 256) = re0 in
  let re1:Core_models.Abstractions.Bitvec.t_BitVec (mk_u64 256) =
    Libcrux_ml_dsa.Simd.Avx2.Arithmetic.subtract re1 t
  in
  let re0:Core_models.Abstractions.Bitvec.t_BitVec (mk_u64 256) =
    Libcrux_ml_dsa.Simd.Avx2.Arithmetic.add re0 t
  in
  re0, re1
  <:
  (Core_models.Abstractions.Bitvec.t_BitVec (mk_u64 256) &
...
let ntt_at_layer_7_and_6___mul
      (re: t_Array Libcrux_ml_dsa.Simd.Avx2.Vector_type.t_Vec256 (mk_usize 32))
      (index: usize)
      (zeta: Core_models.Abstractions.Bitvec.t_BitVec (mk_u64 256))
      (step_by: usize)
    ...
    : Prims.Pure (t_Array Libcrux_ml_dsa.Simd.Avx2.Vector_type.t_Vec256 (mk_usize 32))
      (requires
        ...
        (Libcrux_intrinsics.Avx2.mm256_set1_epi32 (cast (Libcrux_ml_dsa.Simd.Traits.v_INVERSE_OF_MODULUS_MOD_MONTGOMERY_R
          ...
          Core_models.Abstractions.Bitvec.t_BitVec (mk_u64 256)) /\
        b2t
        (((Rust_primitives.Hax.Int.from_machine index <: Hax_lib.Int.t_Int) +
            (Rust_primitives.Hax.Int.from_machine step_by <: Hax_lib.Int.t_Int)
            <:
            Hax_lib.Int.t_Int) <
          (32 <: Hax_lib.Int.t_Int)
          <:
          bool) /\ b2t (step_by >. mk_usize 0 <: bool))
      (ensures
        fun re_future ->
          let re_future:t_Array Libcrux_ml_dsa.Simd.Avx2.Vector_type.t_Vec256 (mk_usize 32) =
            re_future
          ...
          let open Libcrux_ml_dsa.Simd.Avx2.Vector_type in
          let nre0, nre1 =
            ntt_at_layer_7_and_6___mul_aux (re.[ index ]).f_value
          ...
          (Seq.index re_future (v index)).f_value == nre0 /\
          (Seq.index re_future (v index + v step_by)).f_value == nre1) =
  let nre0, nre1:(Core_models.Abstractions.Bitvec.t_BitVec (mk_u64 256) &
    Core_models.Abstractions.Bitvec.t_BitVec (mk_u64 256)) =
    ntt_at_layer_7_and_6___mul_aux (re.[ index ] <: Libcrux_ml_dsa.Simd.Avx2.Vector_type.t_Vec256)
        .Libcrux_ml_dsa.Simd.Avx2.Vector_type.f_value
...
let ntt_at_layer_7_and_6___one_layer
      (re: t_Array Libcrux_ml_dsa.Simd.Avx2.Vector_type.t_Vec256 (mk_usize 32))
...
let ntt_at_layer_7_and_6___one_layer_1
      (re: t_Array Libcrux_ml_dsa.Simd.Avx2.Vector_type.t_Vec256 (mk_usize 32))
      (zeta field_modulus inverse_of_modulus_mod_montgomery_r:
          Core_models.Abstractions.Bitvec.t_BitVec (mk_u64 256))
    : Prims.Pure (t_Array Libcrux_ml_dsa.Simd.Avx2.Vector_type.t_Vec256 (mk_usize 32))
...
let ntt_at_layer_7_and_6___one_layer_2
      (re: t_Array Libcrux_ml_dsa.Simd.Avx2.Vector_type.t_Vec256 (mk_usize 32))
      (zeta field_modulus inverse_of_modulus_mod_montgomery_r:
          Core_models.Abstractions.Bitvec.t_BitVec (mk_u64 256))
    : Prims.Pure (t_Array Libcrux_ml_dsa.Simd.Avx2.Vector_type.t_Vec256 (mk_usize 32))
...
let ntt_at_layer_7_and_6___one_layer_3
      (re: t_Array Libcrux_ml_dsa.Simd.Avx2.Vector_type.t_Vec256 (mk_usize 32))
      (zeta field_modulus inverse_of_modulus_mod_montgomery_r:
          Core_models.Abstractions.Bitvec.t_BitVec (mk_u64 256))
    : Prims.Pure (t_Array Libcrux_ml_dsa.Simd.Avx2.Vector_type.t_Vec256 (mk_usize 32))
...
let ntt_at_layer_7_and_6___one_layer_4
      (re: t_Array Libcrux_ml_dsa.Simd.Avx2.Vector_type.t_Vec256 (mk_usize 32))
      (zeta field_modulus inverse_of_modulus_mod_montgomery_r:
          Core_models.Abstractions.Bitvec.t_BitVec (mk_u64 256))
    : Prims.Pure (t_Array Libcrux_ml_dsa.Simd.Avx2.Vector_type.t_Vec256 (mk_usize 32))
...
let ntt_at_layer_7_and_6___one_layer_5
      (re: t_Array Libcrux_ml_dsa.Simd.Avx2.Vector_type.t_Vec256 (mk_usize 32))
      (zeta field_modulus inverse_of_modulus_mod_montgomery_r:
          Core_models.Abstractions.Bitvec.t_BitVec (mk_u64 256))
    : Prims.Pure (t_Array Libcrux_ml_dsa.Simd.Avx2.Vector_type.t_Vec256 (mk_usize 32))
...
let ntt_at_layer_7_and_6___one_layer_6
      (re: t_Array Libcrux_ml_dsa.Simd.Avx2.Vector_type.t_Vec256 (mk_usize 32))
      (zeta field_modulus inverse_of_modulus_mod_montgomery_r:
          Core_models.Abstractions.Bitvec.t_BitVec (mk_u64 256))
    : Prims.Pure (t_Array Libcrux_ml_dsa.Simd.Avx2.Vector_type.t_Vec256 (mk_usize 32))
...
let ntt_at_layer_7_and_6___one_layer_7
      (re: t_Array Libcrux_ml_dsa.Simd.Avx2.Vector_type.t_Vec256 (mk_usize 32))
      (zeta field_modulus inverse_of_modulus_mod_montgomery_r:
          Core_models.Abstractions.Bitvec.t_BitVec (mk_u64 256))
    : Prims.Pure (t_Array Libcrux_ml_dsa.Simd.Avx2.Vector_type.t_Vec256 (mk_usize 32))
...
let ntt_at_layer_7_and_6_ (re: t_Array Libcrux_ml_dsa.Simd.Avx2.Vector_type.t_Vec256 (mk_usize 32))
  ...
  let inverse_of_modulus_mod_montgomery_r:Core_models.Abstractions.Bitvec.t_BitVec (mk_u64 256) =
    Libcrux_intrinsics.Avx2.mm256_set1_epi32 (cast (Libcrux_ml_dsa.Simd.Traits.v_INVERSE_OF_MODULUS_MOD_MONTGOMERY_R
        ...
        i32)
  in
  let zeta7:Core_models.Abstractions.Bitvec.t_BitVec (mk_u64 256) =
    Libcrux_intrinsics.Avx2.mm256_set1_epi32 (mk_i32 25847)
  in
  let zeta60:Core_models.Abstractions.Bitvec.t_BitVec (mk_u64 256) =
    Libcrux_intrinsics.Avx2.mm256_set1_epi32 (mk_i32 (-2608894))
  in
  let zeta61:Core_models.Abstractions.Bitvec.t_BitVec (mk_u64 256) =
    Libcrux_intrinsics.Avx2.mm256_set1_epi32 (mk_i32 (-518909))
  in
  let re:t_Array Libcrux_ml_dsa.Simd.Avx2.Vector_type.t_Vec256 (mk_usize 32) =
    ntt_at_layer_7_and_6___one_layer re zeta7 field_modulus inverse_of_modulus_mod_montgomery_r
  in
  let re:t_Array Libcrux_ml_dsa.Simd.Avx2.Vector_type.t_Vec256 (mk_usize 32) =
    ntt_at_layer_7_and_6___one_layer_1 re zeta7 field_modulus inverse_of_modulus_mod_montgomery_r
  in
  let re:t_Array Libcrux_ml_dsa.Simd.Avx2.Vector_type.t_Vec256 (mk_usize 32) =
    ntt_at_layer_7_and_6___one_layer_2 re zeta60 field_modulus inverse_of_modulus_mod_montgomery_r
  in
  let re:t_Array Libcrux_ml_dsa.Simd.Avx2.Vector_type.t_Vec256 (mk_usize 32) =
    ntt_at_layer_7_and_6___one_layer_3 re zeta61 field_modulus inverse_of_modulus_mod_montgomery_r
  in
  let re:t_Array Libcrux_ml_dsa.Simd.Avx2.Vector_type.t_Vec256 (mk_usize 32) =
    ntt_at_layer_7_and_6___one_layer_4 re zeta7 field_modulus inverse_of_modulus_mod_montgomery_r
  in
  let re:t_Array Libcrux_ml_dsa.Simd.Avx2.Vector_type.t_Vec256 (mk_usize 32) =
    ntt_at_layer_7_and_6___one_layer_5 re zeta7 field_modulus inverse_of_modulus_mod_montgomery_r
  in
  let re:t_Array Libcrux_ml_dsa.Simd.Avx2.Vector_type.t_Vec256 (mk_usize 32) =
    ntt_at_layer_7_and_6___one_layer_6 re zeta60 field_modulus inverse_of_modulus_mod_montgomery_r
  in
  let re:t_Array Libcrux_ml_dsa.Simd.Avx2.Vector_type.t_Vec256 (mk_usize 32) =
    ntt_at_layer_7_and_6___one_layer_7 re zeta61 field_modulus inverse_of_modulus_mod_montgomery_r
  in
  re
...
let ntt_at_layer_5_to_3___round
    ...
    : Prims.Pure (t_Array Libcrux_ml_dsa.Simd.Avx2.Vector_type.t_Vec256 (mk_usize 32))
      (requires
        (v_STEP =. mk_usize 8 || v_STEP =. mk_usize 16 || v_STEP =. mk_usize 32) &&
        v_STEP_BY =. (v_STEP /! Libcrux_ml_dsa.Simd.Traits.v_COEFFICIENTS_IN_SIMD_UNIT <: usize) &&
        index <. (mk_usize 128 /! v_STEP <: usize))
      (fun _ -> Prims.l_True) =
    ...
    Rust_primitives.Hax.Folds.fold_range offset
      ...
      (fun re j ->
          ...
          let tmp:Core_models.Abstractions.Bitvec.t_BitVec (mk_u64 256) =
            Libcrux_intrinsics.Avx2.mm256_sub_epi32 (re.[ j ]
                <:
                Libcrux_ml_dsa.Simd.Avx2.Vector_type.t_Vec256)
                .Libcrux_ml_dsa.Simd.Avx2.Vector_type.f_value
          ...
          let re:t_Array Libcrux_ml_dsa.Simd.Avx2.Vector_type.t_Vec256 (mk_usize 32) =
            Rust_primitives.Hax.Monomorphized_update_at.update_at_usize re
              ...
              ({
                  Libcrux_ml_dsa.Simd.Avx2.Vector_type.f_value
                  =
                  Libcrux_intrinsics.Avx2.mm256_add_epi32 (re.[ j ]
                      <:
                      Libcrux_ml_dsa.Simd.Avx2.Vector_type.t_Vec256)
                      .Libcrux_ml_dsa.Simd.Avx2.Vector_type.f_value
                    (re.[ j +! v_STEP_BY <: usize ] <: Libcrux_ml_dsa.Simd.Avx2.Vector_type.t_Vec256
