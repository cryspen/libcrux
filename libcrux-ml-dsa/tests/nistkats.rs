...
fn ml_dsa_44_nist_known_answer_tests() {
    ...
    for kat in nist_kats {
        ...
        let signature =
            libcrux_ml_dsa::ml_dsa_44::sign(key_pair.signing_key, &message, kat.signing_randomness);
...
fn ml_dsa_87_nist_known_answer_tests() {
    ...
    for kat in nist_kats {
        ...
        let signature =
            libcrux_ml_dsa::ml_dsa_87::sign(key_pair.signing_key, &message, kat.signing_randomness);
