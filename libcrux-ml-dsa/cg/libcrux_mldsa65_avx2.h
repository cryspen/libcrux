...
libcrux_ml_dsa_ml_dsa_generic_instantiations_avx2_generate_key_pair_c9(
  ...
  return libcrux_ml_dsa_ml_dsa_generic_instantiations_avx2_avx2_feature_generate_key_pair_c9(
      copy_of_randomness);
}
...
libcrux_ml_dsa_simd_avx2_arithmetic_to_unsigned_representatives(__m256i *t) {
  ...
  t[0U] = libcrux_intrinsics_avx2_mm256_add_epi32(
      t[0U], conditional_add_field_modulus);
}
...
static KRML_MUSTINLINE void libcrux_ml_dsa_simd_avx2_invntt_outer_3_plus_99(
  ...
  for (size_t i = (size_t)0U; i < (size_t)0U + (size_t)1U; i++) {
    size_t j = i;
    __m256i rejs = re[j + (size_t)1U];
    __m256i a_minus_b = rejs;
    libcrux_ml_dsa_simd_avx2_arithmetic_subtract(&a_minus_b, &re[j]);
    libcrux_ml_dsa_simd_avx2_arithmetic_add(&re[j], &rejs);
    re[j + (size_t)1U] =
        libcrux_ml_dsa_simd_avx2_arithmetic_montgomery_multiply_by_constant(
...
#define LIBCRUX_ML_DSA_SIMD_AVX2_INVNTT_INVERT_NTT_MONTGOMERY_FACTOR \
  ((int32_t)41978)
...
libcrux_ml_dsa_simd_avx2_invntt_invert_ntt_montgomery(__m256i *re) {
  ...
  for (size_t i = (size_t)0U;
    ...
    re[i0] =
        libcrux_ml_dsa_simd_avx2_arithmetic_montgomery_multiply_by_constant(
            re[i0],
            LIBCRUX_ML_DSA_SIMD_AVX2_INVNTT_INVERT_NTT_MONTGOMERY_FACTOR);
  }
}
...
libcrux_ml_dsa_simd_avx2_ntt_butterfly_2(__m256i a, __m256i b, int32_t zeta_a0,
  ...
  libcrux_ml_dsa_simd_avx2_arithmetic_montgomery_multiply(&zeta_products,
                                                          &zetas);
  __m256i sub_terms = summands;
  libcrux_ml_dsa_simd_avx2_arithmetic_subtract(&sub_terms, &zeta_products);
  libcrux_ml_dsa_simd_avx2_arithmetic_add(&summands, &zeta_products);
  __m256i add_terms = summands;
...
libcrux_ml_dsa_simd_avx2_ntt_ntt_at_layer_5_to_3_round_f6(__m256i *re,
  ...
  for (size_t i = offset; i < offset + (size_t)4U; i++) {
    size_t j = i;
    __m256i t = re[j + (size_t)4U];
    libcrux_ml_dsa_simd_avx2_arithmetic_montgomery_multiply(&t, &rhs);
    re[j + (size_t)4U] = re[j];
    libcrux_ml_dsa_simd_avx2_arithmetic_subtract(&re[j + (size_t)4U], &t);
    libcrux_ml_dsa_simd_avx2_arithmetic_add(&re[j], &t);
  }
}
...
libcrux_ml_dsa_simd_avx2_ntt_ntt_at_layer_5_to_3_round_90(__m256i *re,
  ...
  for (size_t i = offset; i < offset + (size_t)2U; i++) {
    size_t j = i;
    __m256i t = re[j + (size_t)2U];
    libcrux_ml_dsa_simd_avx2_arithmetic_montgomery_multiply(&t, &rhs);
    re[j + (size_t)2U] = re[j];
    libcrux_ml_dsa_simd_avx2_arithmetic_subtract(&re[j + (size_t)2U], &t);
    libcrux_ml_dsa_simd_avx2_arithmetic_add(&re[j], &t);
  }
}
...
libcrux_ml_dsa_simd_avx2_ntt_ntt_at_layer_5_to_3_round_7b(__m256i *re,
  ...
  for (size_t i = offset; i < offset + (size_t)1U; i++) {
    size_t j = i;
    __m256i t = re[j + (size_t)1U];
    libcrux_ml_dsa_simd_avx2_arithmetic_montgomery_multiply(&t, &rhs);
    re[j + (size_t)1U] = re[j];
    libcrux_ml_dsa_simd_avx2_arithmetic_subtract(&re[j + (size_t)1U], &t);
    libcrux_ml_dsa_simd_avx2_arithmetic_add(&re[j], &t);
  }
}
...
*/
KRML_ATTRIBUTE_TARGET("avx2")
static inline void libcrux_ml_dsa_simd_avx2_vector_type_clone_ca(void **self) {}
...
libcrux_ml_dsa_sample_sample_up_to_four_ring_elements_f4(
  ...
  uint8_t seed0[34U];
  libcrux_ml_dsa_sample_add_domain_separator(seed, indices[0U], seed0);
  uint8_t seed1[34U];
  libcrux_ml_dsa_sample_add_domain_separator(seed, indices[1U], seed1);
  uint8_t seed2[34U];
  libcrux_ml_dsa_sample_add_domain_separator(seed, indices[2U], seed2);
  uint8_t seed3[34U];
  libcrux_ml_dsa_sample_add_domain_separator(seed, indices[3U], seed3);
  libcrux_sha3_avx2_x4_incremental_KeccakState state =
...
/**
A monomorphic instance of libcrux_ml_dsa.samplex4.matrix_6_by_5
with types libcrux_ml_dsa_simd_avx2_vector_type_AVX2SIMDUnit,
libcrux_ml_dsa_hash_functions_simd256_Shake128x4 with const generics
- ROWS_IN_A= 6
- COLUMNS_IN_A= 5
*/
KRML_ATTRIBUTE_TARGET("avx2")
static KRML_MUSTINLINE void libcrux_ml_dsa_samplex4_matrix_6_by_5_f4(
    Eurydice_slice seed,
    libcrux_ml_dsa_polynomial_PolynomialRingElement_24 (*matrix)[5U]) {
  ...
  uint8_t_x2 buf[4U] = {(CLITERAL(uint8_t_x2){.fst = 0U, .snd = 0U}),
                        (CLITERAL(uint8_t_x2){.fst = 0U, .snd = 1U}),
                        (CLITERAL(uint8_t_x2){.fst = 0U, .snd = 2U}),
                        (CLITERAL(uint8_t_x2){.fst = 0U, .snd = 3U})};
  libcrux_ml_dsa_sample_sample_up_to_four_ring_elements_f4(
      seed, matrix, rand_stack0, rand_stack1, rand_stack2, rand_stack3,
      Eurydice_array_to_slice((size_t)4U, tmp_stack, int32_t[263U]), buf,
      (size_t)4U);
  uint8_t_x2 buf0[4U] = {(CLITERAL(uint8_t_x2){.fst = 0U, .snd = 4U}),
  ...
  libcrux_ml_dsa_sample_sample_up_to_four_ring_elements_f4(
      ...
      (size_t)4U);
  uint8_t_x2 buf1[4U] = {(CLITERAL(uint8_t_x2){.fst = 1U, .snd = 3U}),
  ...
  libcrux_ml_dsa_sample_sample_up_to_four_ring_elements_f4(
      ...
      (size_t)4U);
  uint8_t_x2 buf2[4U] = {(CLITERAL(uint8_t_x2){.fst = 2U, .snd = 2U}),
  ...
  libcrux_ml_dsa_sample_sample_up_to_four_ring_elements_f4(
      ...
      (size_t)4U);
  uint8_t_x2 buf3[4U] = {(CLITERAL(uint8_t_x2){.fst = 3U, .snd = 1U}),
  ...
  libcrux_ml_dsa_sample_sample_up_to_four_ring_elements_f4(
      ...
      (size_t)4U);
  uint8_t_x2 buf4[4U] = {(CLITERAL(uint8_t_x2){.fst = 4U, .snd = 0U}),
  ...
  libcrux_ml_dsa_sample_sample_up_to_four_ring_elements_f4(
      ...
      (size_t)4U);
  uint8_t_x2 buf5[4U] = {(CLITERAL(uint8_t_x2){.fst = 4U, .snd = 4U}),
  ...
  libcrux_ml_dsa_sample_sample_up_to_four_ring_elements_f4(
      ...
      (size_t)4U);
  uint8_t_x2 buf6[4U] = {(CLITERAL(uint8_t_x2){.fst = 5U, .snd = 3U}),
...
/**
A monomorphic instance of libcrux_ml_dsa.samplex4.avx2.matrix_avx2
with types libcrux_ml_dsa_simd_avx2_vector_type_AVX2SIMDUnit
with const generics
- ROWS_IN_A= 6
- COLUMNS_IN_A= 5
*/
KRML_ATTRIBUTE_TARGET("avx2")
static inline void libcrux_ml_dsa_samplex4_avx2_matrix_avx2_fe(
    Eurydice_slice seed,
    libcrux_ml_dsa_polynomial_PolynomialRingElement_24 (*matrix)[5U]) {
  ...
  switch (uu____0.fst) {
    case 6U: {
      switch (uu____0.snd) {
        case 5U: {
          libcrux_ml_dsa_samplex4_matrix_6_by_5_f4(seed, matrix);
          return;
        }
        default: {
        }
...
*/
/**
A monomorphic instance of libcrux_ml_dsa.samplex4.avx2.matrix_b8
with types libcrux_ml_dsa_simd_avx2_vector_type_AVX2SIMDUnit
with const generics
- ROWS_IN_A= 6
- COLUMNS_IN_A= 5
*/
KRML_ATTRIBUTE_TARGET("avx2")
static KRML_MUSTINLINE void libcrux_ml_dsa_samplex4_avx2_matrix_b8_fe(
    Eurydice_slice seed,
    libcrux_ml_dsa_polynomial_PolynomialRingElement_24 (*matrix)[5U]) {
  libcrux_ml_dsa_samplex4_avx2_matrix_avx2_fe(seed, matrix);
}
...
KRML_ATTRIBUTE_TARGET("avx2")
static KRML_MUSTINLINE void
libcrux_ml_dsa_sample_sample_four_error_ring_elements_cb(Eurydice_slice seed,
                                                         uint16_t start_index,
                                                         Eurydice_slice re) {
  KRML_HOST_EPRINTF("KaRaMeL abort at %s:%d\n%s\n", __FILE__, __LINE__,
                    "Eurydice error: Failure(\"Error looking trait impl: "
                    "core::cmp::impls::{core::cmp::Ord for usize}#59 min\")\n");
  KRML_HOST_EXIT(255U);
}
...
*/
KRML_ATTRIBUTE_TARGET("avx2")
static KRML_MUSTINLINE void libcrux_ml_dsa_samplex4_sample_s1_and_s2_31(
    Eurydice_slice seed,
    libcrux_ml_dsa_polynomial_PolynomialRingElement_24 *s1_s2) {
  for (size_t i = (size_t)0U;
       i < core_num__usize_11__div_ceil((size_t)11U, (size_t)4U); i++) {
    size_t i0 = i;
    libcrux_ml_dsa_sample_sample_four_error_ring_elements_cb(
        seed, 4U * (uint32_t)(uint16_t)i0,
...
KRML_ATTRIBUTE_TARGET("avx2")
static inline libcrux_ml_dsa_polynomial_PolynomialRingElement_24
libcrux_ml_dsa_matrix_compute_As1_plus_s2_closure_fe(Eurydice_slice *state,
                                                     size_t i) {
  return libcrux_ml_dsa_ntt_ntt_ea(Eurydice_slice_index(
      state[0U], i, libcrux_ml_dsa_polynomial_PolynomialRingElement_24,
      libcrux_ml_dsa_polynomial_PolynomialRingElement_24 *));
}
...
static KRML_MUSTINLINE void libcrux_ml_dsa_matrix_compute_As1_plus_s2_fe(
  ...
  for (size_t i = (size_t)0U; i < (size_t)5U; i++) {
    s1_ntt[i] = libcrux_ml_dsa_ntt_ntt_ea(Eurydice_slice_index(
        s1_s2, i, libcrux_ml_dsa_polynomial_PolynomialRingElement_24,
        libcrux_ml_dsa_polynomial_PolynomialRingElement_24 *));
  }
  for (size_t i0 = (size_t)0U; i0 < (size_t)6U; i0++) {
    ...
    for (size_t i = (size_t)0U; i < (size_t)5U; i++) {
      ...
      libcrux_ml_dsa_polynomial_PolynomialRingElement_24 product =
          libcrux_ml_dsa_ntt_ntt_multiply_montgomery_ea(&a_as_ntt[i1][j],
                                                        &s1_ntt[j]);
  ...
  for (size_t i = (size_t)0U;
       ...
       i++) {
    size_t i0 = i;
    result[i0] = libcrux_ml_dsa_ntt_invert_ntt_montgomery_ea(result[i0]);
...
libcrux_ml_dsa_encoding_signing_key_generate_serialized_a9(
    ...
    Eurydice_slice verification_key, Eurydice_slice s1_2,
    libcrux_ml_dsa_polynomial_PolynomialRingElement_24 t0[6U],
    uint8_t ret[4032U]) {
  ...
  for (size_t i = (size_t)0U;
       i < Eurydice_slice_len(
               s1_2, libcrux_ml_dsa_polynomial_PolynomialRingElement_24);
       i++) {
    size_t i0 = i;
    libcrux_ml_dsa_polynomial_PolynomialRingElement_24 *uu____1 =
        &Eurydice_slice_index(
            s1_2, i0, libcrux_ml_dsa_polynomial_PolynomialRingElement_24,
            libcrux_ml_dsa_polynomial_PolynomialRingElement_24 *);
  ...
  for (size_t i = (size_t)0U;
    ...
    libcrux_ml_dsa_encoding_t0_serialize_ea(
        uu____2, Eurydice_array_to_subslice2(
                     signing_key_serialized, offset,
...
libcrux_ml_dsa_ml_dsa_generic_generate_key_pair_99(uint8_t randomness[32U]) {
  ...
  for (size_t i = (size_t)0U; i < (size_t)6U; i++) {
    a_as_ntt[i][0U] = libcrux_ml_dsa_polynomial_ZERO_ff_ea();
    a_as_ntt[i][1U] = libcrux_ml_dsa_polynomial_ZERO_ff_ea();
    a_as_ntt[i][2U] = libcrux_ml_dsa_polynomial_ZERO_ff_ea();
    a_as_ntt[i][3U] = libcrux_ml_dsa_polynomial_ZERO_ff_ea();
    a_as_ntt[i][4U] = libcrux_ml_dsa_polynomial_ZERO_ff_ea();
  }
  libcrux_ml_dsa_samplex4_avx2_matrix_b8_fe(seed_for_a, a_as_ntt);
  libcrux_ml_dsa_polynomial_PolynomialRingElement_24 s1_s2[11U];
  for (size_t i = (size_t)0U; i < (size_t)11U; i++) {
    s1_s2[i] = libcrux_ml_dsa_polynomial_ZERO_ff_ea();
  }
  libcrux_ml_dsa_samplex4_sample_s1_and_s2_31(seed_for_error_vectors, s1_s2);
  libcrux_ml_dsa_polynomial_PolynomialRingElement_24 t[6U];
  for (size_t i = (size_t)0U; i < (size_t)6U; i++) {
    t[i] = libcrux_ml_dsa_polynomial_ZERO_ff_ea();
  }
  libcrux_ml_dsa_matrix_compute_As1_plus_s2_fe(
      a_as_ntt,
      Eurydice_array_to_slice(
          (size_t)11U, s1_s2,
          libcrux_ml_dsa_polynomial_PolynomialRingElement_24),
  ...
  memcpy(
      ...
      (size_t)6U * sizeof(libcrux_ml_dsa_polynomial_PolynomialRingElement_24));
  libcrux_ml_dsa_polynomial_PolynomialRingElement_libcrux_ml_dsa_simd_avx2_vector_type_AVX2SIMDUnit_6size_t__x2
      uu____3 = libcrux_ml_dsa_arithmetic_power2round_vector_a3(copy_of_t);
  libcrux_ml_dsa_polynomial_PolynomialRingElement_24 t0[6U];
  memcpy(
      t0, uu____3.fst,
      (size_t)6U * sizeof(libcrux_ml_dsa_polynomial_PolynomialRingElement_24));
  ...
  memcpy(
      t1, uu____3.snd,
      (size_t)6U * sizeof(libcrux_ml_dsa_polynomial_PolynomialRingElement_24));
  Eurydice_slice uu____4 = seed_for_a;
  /* Passing arrays by value in Rust generates a copy in C */
  libcrux_ml_dsa_polynomial_PolynomialRingElement_24 copy_of_t1[6U];
  memcpy(
      copy_of_t1, t1,
  ...
  libcrux_ml_dsa_encoding_verification_key_generate_serialized_fe(
      uu____4, copy_of_t1, verification_key_serialized);
  Eurydice_slice uu____6 = seed_for_a;
  Eurydice_slice uu____7 = seed_for_signing;
  ...
  libcrux_ml_dsa_encoding_signing_key_generate_serialized_a9(
      uu____6, uu____7, uu____8, uu____9, copy_of_t0, signing_key_serialized);
  /* Passing arrays by value in Rust generates a copy in C */
...
libcrux_ml_dsa_ml_dsa_generic_instantiations_avx2_avx2_feature_generate_key_pair_c9(
  ...
  uint8_t copy_of_randomness[32U];
  memcpy(copy_of_randomness, randomness, (size_t)32U * sizeof(uint8_t));
  return libcrux_ml_dsa_ml_dsa_generic_generate_key_pair_99(copy_of_randomness);
}
...
static KRML_MUSTINLINE Result_2e libcrux_ml_dsa_ml_dsa_generic_sign_internal_6b(
  ...
  memcpy(
      ...
      (size_t)6U * sizeof(libcrux_ml_dsa_polynomial_PolynomialRingElement_24));
  libcrux_ml_dsa_polynomial_PolynomialRingElement_24 matrix[6U][5U];
  for (size_t i = (size_t)0U; i < (size_t)6U; i++) {
    matrix[i][0U] = libcrux_ml_dsa_polynomial_ZERO_ff_ea();
    matrix[i][1U] = libcrux_ml_dsa_polynomial_ZERO_ff_ea();
    matrix[i][2U] = libcrux_ml_dsa_polynomial_ZERO_ff_ea();
    matrix[i][3U] = libcrux_ml_dsa_polynomial_ZERO_ff_ea();
    matrix[i][4U] = libcrux_ml_dsa_polynomial_ZERO_ff_ea();
  }
  libcrux_ml_dsa_samplex4_avx2_matrix_b8_fe(
...
libcrux_ml_dsa_ml_dsa_generic_verify_internal_44(
  ...
  if (uu____1.tag == Ok) {
    ...
    if (libcrux_ml_dsa_arithmetic_vector_infinity_norm_exceeds_1f(
      ...
      libcrux_ml_dsa_polynomial_PolynomialRingElement_24(*uu____6)[5U] = matrix;
