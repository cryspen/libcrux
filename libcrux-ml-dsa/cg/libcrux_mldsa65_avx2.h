 ...
 * Eurydice: b166c09465bc206e7c6b353f28dcdb7f0ddbd39e
 * Karamel: 5e16cd5abf3f2323b0d27e3070ec2974657a391b
 * F*: 0c4b790fd608bccfc332d3ff1e9b29c9be8b0595
 * Libcrux: 2dab092608011aacc8ad8756657c297b2e38121a
 */
...
libcrux_ml_dsa_hash_functions_simd256_squeeze_first_block_d9(
  libcrux_sha3_portable_KeccakState *self,
  uint8_t ret[136U]
)
{
        ...
        adjacent_3_combined1 =
          libcrux_intrinsics_avx2_mm256_srlv_epi32(adjacent_3_combined0,
            libcrux_intrinsics_avx2_mm256_set_epi32((int32_t)0,
              ...
              (int32_t)0,
              (int32_t)4));
        __m128i lower_3 = libcrux_intrinsics_avx2_mm256_castsi256_si128(adjacent_3_combined1);
        libcrux_intrinsics_avx2_mm_storeu_bytes_si128(Eurydice_array_to_subslice2(serialized,
            (size_t)0U,
            (size_t)16U,
            uint8_t),
...
#define LIBCRUX_ML_DSA_SIMD_AVX2_NTT_NTT_AT_LAYER_7_AND_6_STEP_BY_7 ((size_t)2U * LIBCRUX_ML_DSA_SIMD_TRAITS_COEFFICIENTS_IN_SIMD_UNIT)
...
{
  __m256i prod02 = libcrux_intrinsics_avx2_mm256_mul_epi32(re[index + step_by], zeta);
  __m256i
  prod13 =
    libcrux_intrinsics_avx2_mm256_mul_epi32(libcrux_intrinsics_avx2_mm256_shuffle_epi32((int32_t)245,
        re[index + step_by],
  ...
  res02_shifted = libcrux_intrinsics_avx2_mm256_shuffle_epi32((int32_t)245, res02, __m256i);
  __m256i
  t = libcrux_intrinsics_avx2_mm256_blend_epi32((int32_t)170, res02_shifted, res13, __m256i);
...
#define LIBCRUX_ML_DSA_SIMD_AVX2_NTT_NTT_AT_LAYER_7_AND_6_STEP_BY_6 (((size_t)1U << 6U) / LIBCRUX_ML_DSA_SIMD_TRAITS_COEFFICIENTS_IN_SIMD_UNIT)
...
)
{
  __m256i
  summands =
    libcrux_intrinsics_avx2_mm256_set_m128i(libcrux_intrinsics_avx2_mm256_castsi256_si128(re[index
        + (size_t)1U]),
...
{
  __m256i
  summands = libcrux_intrinsics_avx2_mm256_unpacklo_epi64(re[index], re[index + (size_t)1U]);
  __m256i
  zeta_products = libcrux_intrinsics_avx2_mm256_unpackhi_epi64(re[index], re[index + (size_t)1U]);
  __m256i
  zetas =
  ...
  __m256i sub_terms = libcrux_intrinsics_avx2_mm256_sub_epi32(summands, zeta_products);
  __m256i add_terms = libcrux_intrinsics_avx2_mm256_add_epi32(summands, zeta_products);
  re[index] = libcrux_intrinsics_avx2_mm256_unpacklo_epi64(add_terms, sub_terms);
  re[index + (size_t)1U] = libcrux_intrinsics_avx2_mm256_unpackhi_epi64(add_terms, sub_terms);
}
...
{
  __m256i a = libcrux_intrinsics_avx2_mm256_shuffle_epi32((int32_t)216, re[index], __m256i);
  __m256i
  b = libcrux_intrinsics_avx2_mm256_shuffle_epi32((int32_t)216, re[index + (size_t)1U], __m256i);
  ...
  re[index] =
    libcrux_intrinsics_avx2_mm256_shuffle_epi32((int32_t)216,
      a_terms_shuffled,
      __m256i);
  re[index + (size_t)1U] =
    libcrux_intrinsics_avx2_mm256_shuffle_epi32((int32_t)216,
...
libcrux_ml_dsa_simd_avx2_invntt_invert_ntt_montgomery_inv_inner(__m256i *re)
{
  ...
  (size_t
    i = (size_t)0U;
    i
    < Eurydice_slice_len(Eurydice_array_to_slice((size_t)32U, re, __m256i), __m256i);
    i++)
  {
    size_t i0 = i;
    re[i0] =
...
)
{
  ...
  {
    size_t k = i;
    libcrux_ml_dsa_polynomial_from_i32_array_ff_21(Eurydice_array_to_slice((size_t)263U,
...
)
{
  ...
  (size_t
    i = (size_t)0U;
    i
    < Eurydice_slice_len(matrix, libcrux_ml_dsa_polynomial_PolynomialRingElement_4b) / (size_t)4U;
    i++)
  {
...
)
{
  ...
  (size_t
    i = (size_t)0U;
    i
    < Eurydice_slice_len(Eurydice_array_to_slice((size_t)32U, lhs->simd_units, __m256i), __m256i);
    i++)
  {
    size_t i0 = i;
...
)
{
  ...
  (size_t
    i = (size_t)0U;
    i
    < Eurydice_slice_len(Eurydice_array_to_slice((size_t)32U, self->simd_units, __m256i), __m256i);
    i++)
  {
    size_t i0 = i;
...
)
{
    ...
    for (size_t i = (size_t)0U; i < columns_in_a; i++)
    {
      ...
      libcrux_ml_dsa_ntt_ntt_multiply_montgomery_21(&product,
        &Eurydice_slice_index(s1_ntt,
          ...
          libcrux_ml_dsa_polynomial_PolynomialRingElement_4b,
          libcrux_ml_dsa_polynomial_PolynomialRingElement_4b *));
      libcrux_ml_dsa_polynomial_add_ff_21(&Eurydice_slice_index(result,
          i1,
          libcrux_ml_dsa_polynomial_PolynomialRingElement_4b,
          libcrux_ml_dsa_polynomial_PolynomialRingElement_4b *),
        &product);
  ...
  (size_t
    i = (size_t)0U;
    i
    < Eurydice_slice_len(result, libcrux_ml_dsa_polynomial_PolynomialRingElement_4b);
    i++)
  {
    size_t i0 = i;
...
libcrux_ml_dsa_arithmetic_power2round_vector_21(Eurydice_slice t, Eurydice_slice t1)
{
  ...
  (size_t
    i0 = (size_t)0U;
    i0
    < Eurydice_slice_len(t, libcrux_ml_dsa_polynomial_PolynomialRingElement_4b);
    i0++)
  {
    size_t i1 = i0;
    for
...
)
{
  ...
  (size_t
    i = (size_t)0U;
    i
    < Eurydice_slice_len(Eurydice_array_to_slice((size_t)32U, re->simd_units, __m256i), __m256i);
    i++)
  {
    size_t i0 = i;
...
)
{
  ...
  (size_t
    i = (size_t)0U;
    i
    < Eurydice_slice_len(t1, libcrux_ml_dsa_polynomial_PolynomialRingElement_4b);
    i++)
  {
    size_t i0 = i;
    libcrux_ml_dsa_polynomial_PolynomialRingElement_4b
...
)
{
  ...
  (size_t
    i = (size_t)0U;
    i
    < Eurydice_slice_len(s1_2, libcrux_ml_dsa_polynomial_PolynomialRingElement_4b);
    i++)
  {
    size_t i0 = i;
  ...
  (size_t
    i = (size_t)0U;
    i
    < Eurydice_slice_len(t0, libcrux_ml_dsa_polynomial_PolynomialRingElement_4b);
    i++)
  {
    size_t _cloop_j = i;
    libcrux_ml_dsa_polynomial_PolynomialRingElement_4b
...
)
{
  ...
  (size_t
    i = (size_t)0U;
    i
    < Eurydice_slice_len(serialized, uint8_t) / ring_element_size;
    i++)
  {
    size_t i0 = i;
    Eurydice_slice
...
)
{
  ...
  (size_t
    i = (size_t)0U;
    i
    < Eurydice_slice_len(serialized, uint8_t) / LIBCRUX_ML_DSA_CONSTANTS_RING_ELEMENT_OF_T0S_SIZE;
    i++)
  {
    size_t i0 = i;
    Eurydice_slice
...
)
{
  ...
  (size_t
    i = (size_t)0U;
    i
    < Eurydice_slice_len(vector, libcrux_ml_dsa_polynomial_PolynomialRingElement_4b);
    i++)
  {
    size_t _cloop_j = i;
    libcrux_ml_dsa_polynomial_PolynomialRingElement_4b
...
)
{
  ...
  libcrux_ml_dsa_polynomial_from_i32_array_ff_21(Eurydice_array_to_slice((size_t)256U,
      result,
      int32_t),
    re);
}
...
libcrux_ml_dsa_matrix_add_vectors_21(size_t dimension, Eurydice_slice lhs, Eurydice_slice rhs)
{
  ...
  {
    size_t i0 = i;
    libcrux_ml_dsa_polynomial_add_ff_21(&Eurydice_slice_index(lhs,
        i0,
        libcrux_ml_dsa_polynomial_PolynomialRingElement_4b,
        libcrux_ml_dsa_polynomial_PolynomialRingElement_4b *),
...
)
{
  ...
  {
    size_t i0 = i;
    libcrux_ml_dsa_polynomial_subtract_ff_21(&Eurydice_slice_index(lhs,
        i0,
        libcrux_ml_dsa_polynomial_PolynomialRingElement_4b,
        libcrux_ml_dsa_polynomial_PolynomialRingElement_4b *),
      &Eurydice_slice_index(rhs,
...
libcrux_ml_dsa_arithmetic_vector_infinity_norm_exceeds_21(Eurydice_slice vector, int32_t bound)
{
    ...
    i++)
  {
    ...
    *ring_element =
    ...
    {
      uu____0 = libcrux_ml_dsa_polynomial_infinity_norm_exceeds_ff_21(ring_element, bound);
    }
    result = uu____0;
  }
  return result;
...
KRML_ATTRIBUTE_TARGET("avx2")
static inline void
libcrux_ml_dsa_polynomial_to_i32_array_ff_21(
  libcrux_ml_dsa_polynomial_PolynomialRingElement_4b *self,
  int32_t ret[256U]
)
{
...
)
{
  ...
  libcrux_ml_dsa_polynomial_PolynomialRingElement_4b
  hint_simd = libcrux_ml_dsa_polynomial_zero_ff_21();
  for
  (size_t
    i0 = (size_t)0U;
    i0
    < Eurydice_slice_len(low, libcrux_ml_dsa_polynomial_PolynomialRingElement_4b);
    i0++)
  {
    size_t i1 = i0;
    for
...
)
{
  ...
  while (attempt < LIBCRUX_ML_DSA_CONSTANTS_REJECTION_SAMPLE_BOUND_SIGN)
  {
    ...
    libcrux_ml_dsa_polynomial_PolynomialRingElement_4b
    verifier_challenge = libcrux_ml_dsa_polynomial_zero_ff_21();
          ...
          if (j > previous_true_hints_seen)
          {
            ...
            (
              Eurydice_slice_index(hint_serialized,
                ...
                uint8_t,
                uint8_t *)
              <= Eurydice_slice_index(hint_serialized, j - (size_t)1U, uint8_t, uint8_t *)
            )
            {
              uu____2 =
...
)
{
  for (size_t i0 = (size_t)0U; i0 < rows_in_a; i0++)
  {
    size_t i1 = i0;
    libcrux_ml_dsa_polynomial_PolynomialRingElement_4b
    inner_result = libcrux_ml_dsa_polynomial_zero_ff_21();
    for (size_t i = (size_t)0U; i < columns_in_a; i++)
    {
      size_t j = i;
      libcrux_ml_dsa_polynomial_PolynomialRingElement_4b
    ...
    libcrux_ml_dsa_polynomial_subtract_ff_21(&inner_result,
      &Eurydice_slice_index(t1,
        i1,
        libcrux_ml_dsa_polynomial_PolynomialRingElement_4b,
        libcrux_ml_dsa_polynomial_PolynomialRingElement_4b *));
...
)
{
  ...
  (size_t
    i0 = (size_t)0U;
    i0
    < Eurydice_slice_len(re_vector, libcrux_ml_dsa_polynomial_PolynomialRingElement_4b);
    i0++)
  {
    size_t i1 = i0;
    libcrux_ml_dsa_polynomial_PolynomialRingElement_4b
