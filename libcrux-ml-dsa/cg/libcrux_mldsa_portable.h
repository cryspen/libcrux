...
libcrux_ml_dsa_sample_sample_four_error_ring_elements_29(
    ...
    uint16_t start_index, Eurydice_dst_ref_mut_44 re) {
...
libcrux_ml_dsa_sample_sample_up_to_four_ring_elements_flat_63(
    ...
    Eurydice_dst_ref_mut_44 matrix, Eurydice_arr_d1 *rand_stack0,
...
- OUTPUT_LENGTH= 64
*/
static KRML_MUSTINLINE void libcrux_ml_dsa_hash_functions_portable_shake256_c9(
...
libcrux_ml_dsa_encoding_signing_key_generate_serialized_2e(
    ...
    Eurydice_borrow_slice_u8 verification_key, Eurydice_dst_ref_shared_44 s1_2,
...
libcrux_ml_dsa_ml_dsa_generic_ml_dsa_65_generate_key_pair_5a(
  ...
  memcpy(a_as_ntt.data, repeat_expression2,
         (size_t)30U * sizeof(Eurydice_arr_a3));
  ...
  Eurydice_slice_copy(
      Eurydice_array_to_slice_mut_201(&s1_ntt),
  ...
  libcrux_ml_dsa_encoding_verification_key_generate_serialized_37(
      seed_for_a, Eurydice_array_to_slice_shared_201(&t1), verification_key);
  libcrux_ml_dsa_encoding_signing_key_generate_serialized_2e(
      ...
      Eurydice_array_to_slice_shared_200(&s1_s2),
      Eurydice_array_to_slice_shared_201(&t0), signing_key);
}
...
- OUTPUT_LENGTH= 576
*/
static KRML_MUSTINLINE void libcrux_ml_dsa_hash_functions_portable_shake256_5a(
...
- OUTPUT_LENGTH= 640
*/
static KRML_MUSTINLINE void libcrux_ml_dsa_hash_functions_portable_shake256_0e(
...
static KRML_MUSTINLINE void libcrux_ml_dsa_sample_sample_mask_ring_element_2e(
    const Eurydice_arr_91 *seed, Eurydice_arr_a3 *result,
...
static KRML_MUSTINLINE void libcrux_ml_dsa_sample_sample_mask_vector_67(
    ...
    uint16_t *domain_separator, Eurydice_dst_ref_mut_44 mask) {
  ...
  for (size_t i = (size_t)4U; i < dimension; i++) {
    ...
    libcrux_ml_dsa_sample_sample_mask_ring_element_2e(&seed4, &mask.ptr[i0],
                                                      gamma1_exponent);
  }
}
...
libcrux_ml_dsa_sample_sample_challenge_ring_element_2e(
    Eurydice_borrow_slice_u8 seed, size_t number_of_ones, Eurydice_arr_a3 *re) {
  Eurydice_arr_7c state =
...
libcrux_ml_dsa_ml_dsa_generic_ml_dsa_65_sign_internal_5a(
  ...
  memcpy(s2_as_ntt.data, repeat_expression1,
         (size_t)6U * sizeof(Eurydice_arr_a3));
  ...
  libcrux_ml_dsa_encoding_error_deserialize_to_vector_then_ntt_37(
      LIBCRUX_ML_DSA_CONSTANTS_ML_DSA_65_ETA,
      LIBCRUX_ML_DSA_ML_DSA_GENERIC_ML_DSA_65_ERROR_RING_ELEMENT_SIZE,
      s1_serialized, Eurydice_array_to_slice_mut_201(&s1_as_ntt));
  libcrux_ml_dsa_encoding_error_deserialize_to_vector_then_ntt_37(
      LIBCRUX_ML_DSA_CONSTANTS_ML_DSA_65_ETA,
      LIBCRUX_ML_DSA_ML_DSA_GENERIC_ML_DSA_65_ERROR_RING_ELEMENT_SIZE,
      s2_serialized, Eurydice_array_to_slice_mut_202(&s2_as_ntt));
  libcrux_ml_dsa_encoding_t0_deserialize_to_vector_then_ntt_37(
      t0_serialized, Eurydice_array_to_slice_mut_202(&t0_as_ntt));
  ...
  while (attempt < LIBCRUX_ML_DSA_CONSTANTS_REJECTION_SAMPLE_BOUND_SIGN) {
    ...
    libcrux_ml_dsa_sample_sample_mask_vector_67(
        ...
        &domain_separator_for_mask, Eurydice_array_to_slice_mut_201(&mask));
    ...
    memcpy(a_x_mask.data, repeat_expression,
           (size_t)6U * sizeof(Eurydice_arr_a3));
    Eurydice_arr_5d mask_ntt = core_array__core__clone__Clone_for__T__N___clone(
        (size_t)5U, &mask, Eurydice_arr_a3, Eurydice_arr_5d);
    for (size_t i = (size_t)0U; i < (size_t)5U; i++) {
      size_t i0 = i;
    ...
    Eurydice_arr_5d challenge_times_s1 =
        core_array__core__clone__Clone_for__T__N___clone(
            (size_t)5U, &s1_as_ntt, Eurydice_arr_a3, Eurydice_arr_5d);
    Eurydice_arr_dc1 challenge_times_s2 =
        core_array__core__clone__Clone_for__T__N___clone(
            (size_t)6U, &s2_as_ntt, Eurydice_arr_a3, Eurydice_arr_dc1);
    libcrux_ml_dsa_matrix_vector_times_ring_element_37(
        Eurydice_array_to_slice_mut_201(&challenge_times_s1),
        &verifier_challenge);
    libcrux_ml_dsa_matrix_vector_times_ring_element_37(
        Eurydice_array_to_slice_mut_202(&challenge_times_s2),
        &verifier_challenge);
    ...
    if (!libcrux_ml_dsa_arithmetic_vector_infinity_norm_exceeds_37(
            Eurydice_array_to_slice_shared_20(&mask),
      ...
      if (!libcrux_ml_dsa_arithmetic_vector_infinity_norm_exceeds_37(
              Eurydice_array_to_slice_shared_201(&w0),
              LIBCRUX_ML_DSA_CONSTANTS_ML_DSA_65_GAMMA2 -
                  LIBCRUX_ML_DSA_ML_DSA_GENERIC_ML_DSA_65_BETA)) {
        Eurydice_arr_dc1 challenge_times_t0 =
            core_array__core__clone__Clone_for__T__N___clone(
                (size_t)6U, &t0_as_ntt, Eurydice_arr_a3, Eurydice_arr_dc1);
        libcrux_ml_dsa_matrix_vector_times_ring_element_37(
            Eurydice_array_to_slice_mut_202(&challenge_times_t0),
            &verifier_challenge);
        if (!libcrux_ml_dsa_arithmetic_vector_infinity_norm_exceeds_37(
...
libcrux_ml_dsa_ml_dsa_generic_ml_dsa_65_verify_internal_5a(
  ...
  libcrux_ml_dsa_encoding_verification_key_deserialize_37(
      ...
      t1_serialized, Eurydice_array_to_slice_mut_202(&t1));
  ...
  if (uu____1.tag == core_result_Ok) {
    if (libcrux_ml_dsa_arithmetic_vector_infinity_norm_exceeds_37(
      ...
      Eurydice_arr_a3 verifier_challenge =
      ...
      libcrux_ml_dsa_matrix_compute_w_approx_37(
          ...
          Eurydice_array_to_slice_shared_202(&matrix),
          Eurydice_array_to_slice_shared_20(&deserialized_signer_response),
          &verifier_challenge, Eurydice_array_to_slice_mut_202(&t1));
