...
*/
static inline core_result_Result_a8 libcrux_ml_dsa_pre_hash_new_88(
    Eurydice_borrow_slice_u8 context, core_option_Option_57 pre_hash_oid) {
  if (!(context.meta > LIBCRUX_ML_DSA_CONSTANTS_CONTEXT_MAX_LEN)) {
    return core_result_Result_a8_s(core_result_Ok,
                                   &core_result_Result_a8_s::U::case_Ok,
                                   {context, pre_hash_oid});
  }
  return core_result_Result_a8_s(
      core_result_Err, &core_result_Result_a8_s::U::case_Err,
...
{libcrux_ml_dsa::pre_hash::DomainSeparationContext<'a>}
*/
static inline const core_option_Option_57 *
...
#define LIBCRUX_ML_DSA_PRE_HASH_SHAKE128_OID \
  ((Eurydice_arr_c9{{6U, 9U, 96U, 134U, 72U, 1U, 101U, 3U, 4U, 2U, 11U}}))
...
static KRML_MUSTINLINE Eurydice_arr_4d
...
- N= 8
*/
static inline Eurydice_dst_ref_mut_83 Eurydice_array_to_slice_mut_fd(
    Eurydice_arr_4d *a) {
...
*/
static inline Eurydice_dst_ref_shared_83 Eurydice_slice_subslice_shared_47(
...
- N= 8
*/
static inline Eurydice_dst_ref_shared_83 Eurydice_array_to_slice_shared_fd(
...
libcrux_ml_dsa_simd_portable_sample_rejection_sample_less_than_field_modulus(
  ...
  for (size_t i = (size_t)0U; i < randomness.meta / (size_t)3U; i++) {
    ...
    int32_t b1 =
        (int32_t)(uint32_t)randomness.ptr[i0 * (size_t)3U + (size_t)1U];
    int32_t b2 =
        (int32_t)(uint32_t)randomness.ptr[i0 * (size_t)3U + (size_t)2U];
    int32_t coefficient =
...
- N= 8
*/
static inline Eurydice_dst_ref_shared_83 Eurydice_array_to_subslice_shared_44(
  ...
  for (size_t i = (size_t)0U; i < (size_t)8U / (size_t)2U; i++) {
    ...
    Eurydice_dst_ref_shared_83 coefficients =
        Eurydice_array_to_subslice_shared_44(
            simd_unit, (core_ops_range_Range_87{i0 * (size_t)2U,
...
libcrux_ml_dsa_simd_portable_encoding_gamma1_serialize_when_gamma1_is_2_pow_17(
  ...
  for (size_t i = (size_t)0U; i < (size_t)8U / (size_t)4U; i++) {
    ...
    Eurydice_dst_ref_shared_83 coefficients =
        Eurydice_array_to_subslice_shared_44(
            simd_unit, (core_ops_range_Range_87{i0 * (size_t)4U,
...
libcrux_ml_dsa_simd_portable_encoding_gamma1_deserialize_when_gamma1_is_2_pow_19(
  ...
  for (size_t i = (size_t)0U; i < serialized.meta / (size_t)5U; i++) {
    ...
    Eurydice_borrow_slice_u8 bytes = Eurydice_slice_subslice_shared_c8(
        serialized, (core_ops_range_Range_87{i0 * (size_t)5U,
    ...
    coefficient0 |=
        (int32_t)((uint32_t)(int32_t)(uint32_t)bytes.ptr[2U] << 16U);
    coefficient0 &=
    ...
    coefficient1 |=
        (int32_t)((uint32_t)(int32_t)(uint32_t)bytes.ptr[4U] << 12U);
...
libcrux_ml_dsa_simd_portable_encoding_gamma1_deserialize_when_gamma1_is_2_pow_17(
  ...
  for (size_t i = (size_t)0U; i < serialized.meta / (size_t)9U; i++) {
    size_t i0 = i;
    Eurydice_borrow_slice_u8 bytes = Eurydice_slice_subslice_shared_c8(
        serialized, (core_ops_range_Range_87{i0 * (size_t)9U,
...
libcrux_ml_dsa_simd_portable_encoding_error_serialize(
    libcrux_ml_dsa_constants_Eta eta, const Eurydice_arr_4d *simd_unit,
...
- ZETA= 25847
*/
static KRML_MUSTINLINE void libcrux_ml_dsa_simd_portable_ntt_outer_3_plus_30(
    Eurydice_arr_a3 *re) {
...
- ZETA= -2608894
*/
static KRML_MUSTINLINE void libcrux_ml_dsa_simd_portable_ntt_outer_3_plus_300(
    Eurydice_arr_a3 *re) {
...
- ZETA= -518909
*/
static KRML_MUSTINLINE void libcrux_ml_dsa_simd_portable_ntt_outer_3_plus_42(
    Eurydice_arr_a3 *re) {
...
- ZETA= 237124
*/
static KRML_MUSTINLINE void libcrux_ml_dsa_simd_portable_ntt_outer_3_plus_301(
    Eurydice_arr_a3 *re) {
...
- ZETA= -777960
*/
static KRML_MUSTINLINE void libcrux_ml_dsa_simd_portable_ntt_outer_3_plus_82(
    Eurydice_arr_a3 *re) {
...
- ZETA= -876248
*/
static KRML_MUSTINLINE void libcrux_ml_dsa_simd_portable_ntt_outer_3_plus_420(
    Eurydice_arr_a3 *re) {
...
- ZETA= 466468
*/
static KRML_MUSTINLINE void libcrux_ml_dsa_simd_portable_ntt_outer_3_plus_fe(
    Eurydice_arr_a3 *re) {
...
- ZETA= 1826347
*/
static KRML_MUSTINLINE void libcrux_ml_dsa_simd_portable_ntt_outer_3_plus_302(
    Eurydice_arr_a3 *re) {
...
- ZETA= 2353451
*/
static KRML_MUSTINLINE void libcrux_ml_dsa_simd_portable_ntt_outer_3_plus_43(
    Eurydice_arr_a3 *re) {
...
- ZETA= -359251
*/
static KRML_MUSTINLINE void libcrux_ml_dsa_simd_portable_ntt_outer_3_plus_820(
    Eurydice_arr_a3 *re) {
...
- ZETA= -2091905
*/
static KRML_MUSTINLINE void libcrux_ml_dsa_simd_portable_ntt_outer_3_plus_ea(
    Eurydice_arr_a3 *re) {
...
- ZETA= 3119733
*/
static KRML_MUSTINLINE void libcrux_ml_dsa_simd_portable_ntt_outer_3_plus_421(
    Eurydice_arr_a3 *re) {
...
- ZETA= -2884855
*/
static KRML_MUSTINLINE void libcrux_ml_dsa_simd_portable_ntt_outer_3_plus_61(
    Eurydice_arr_a3 *re) {
...
- ZETA= 3111497
*/
static KRML_MUSTINLINE void libcrux_ml_dsa_simd_portable_ntt_outer_3_plus_fe0(
    Eurydice_arr_a3 *re) {
...
- ZETA= 2680103
*/
static KRML_MUSTINLINE void libcrux_ml_dsa_simd_portable_ntt_outer_3_plus_38(
    Eurydice_arr_a3 *re) {
...
- ZETA= 2725464
*/
static KRML_MUSTINLINE void libcrux_ml_dsa_simd_portable_ntt_outer_3_plus_303(
    Eurydice_arr_a3 *re) {
...
- ZETA= 1024112
*/
static KRML_MUSTINLINE void libcrux_ml_dsa_simd_portable_ntt_outer_3_plus_25(
    Eurydice_arr_a3 *re) {
...
- ZETA= -1079900
*/
static KRML_MUSTINLINE void libcrux_ml_dsa_simd_portable_ntt_outer_3_plus_430(
    Eurydice_arr_a3 *re) {
...
- ZETA= 3585928
*/
static KRML_MUSTINLINE void libcrux_ml_dsa_simd_portable_ntt_outer_3_plus_f4(
    Eurydice_arr_a3 *re) {
...
- ZETA= -549488
*/
static KRML_MUSTINLINE void libcrux_ml_dsa_simd_portable_ntt_outer_3_plus_821(
    Eurydice_arr_a3 *re) {
...
- ZETA= -1119584
*/
static KRML_MUSTINLINE void libcrux_ml_dsa_simd_portable_ntt_outer_3_plus_1d(
    Eurydice_arr_a3 *re) {
...
- ZETA= 2619752
*/
static KRML_MUSTINLINE void libcrux_ml_dsa_simd_portable_ntt_outer_3_plus_ea0(
    Eurydice_arr_a3 *re) {
...
- ZETA= -2108549
*/
static KRML_MUSTINLINE void libcrux_ml_dsa_simd_portable_ntt_outer_3_plus_d8(
    Eurydice_arr_a3 *re) {
...
- ZETA= -2118186
*/
static KRML_MUSTINLINE void libcrux_ml_dsa_simd_portable_ntt_outer_3_plus_422(
    Eurydice_arr_a3 *re) {
...
- ZETA= -3859737
*/
static KRML_MUSTINLINE void libcrux_ml_dsa_simd_portable_ntt_outer_3_plus_60(
    Eurydice_arr_a3 *re) {
...
- ZETA= -1399561
*/
static KRML_MUSTINLINE void libcrux_ml_dsa_simd_portable_ntt_outer_3_plus_610(
    Eurydice_arr_a3 *re) {
...
- ZETA= -3277672
*/
static KRML_MUSTINLINE void libcrux_ml_dsa_simd_portable_ntt_outer_3_plus_29(
    Eurydice_arr_a3 *re) {
...
- ZETA= 1757237
*/
static KRML_MUSTINLINE void libcrux_ml_dsa_simd_portable_ntt_outer_3_plus_fe1(
    Eurydice_arr_a3 *re) {
...
- ZETA= -19422
*/
static KRML_MUSTINLINE void libcrux_ml_dsa_simd_portable_ntt_outer_3_plus_9d(
    Eurydice_arr_a3 *re) {
...
- ZETA= 4010497
*/
static KRML_MUSTINLINE void libcrux_ml_dsa_simd_portable_ntt_outer_3_plus_380(
    Eurydice_arr_a3 *re) {
...
- ZETA= 280005
*/
static KRML_MUSTINLINE void libcrux_ml_dsa_simd_portable_ntt_outer_3_plus_5f(
    Eurydice_arr_a3 *re) {
...
static KRML_MUSTINLINE void libcrux_ml_dsa_simd_portable_ntt_simd_unit_ntt_step(
    Eurydice_arr_4d *simd_unit, int32_t zeta, size_t index, size_t step) {
  int32_t t =
      libcrux_ml_dsa_simd_portable_arithmetic_montgomery_multiply_fe_by_fer(
...
static KRML_MUSTINLINE void
libcrux_ml_dsa_simd_portable_ntt_ntt_at_layer_2_round(Eurydice_arr_a3 *re,
                                                      size_t index,
                                                      int32_t zeta) {
...
static KRML_MUSTINLINE void
libcrux_ml_dsa_simd_portable_ntt_ntt_at_layer_1_round(Eurydice_arr_a3 *re,
                                                      size_t index,
                                                      int32_t zeta_0,
                                                      int32_t zeta_1) {
...
libcrux_ml_dsa_simd_portable_ntt_ntt_at_layer_0_round(
    Eurydice_arr_a3 *re, size_t index, int32_t zeta_0, int32_t zeta_1,
...
libcrux_ml_dsa_simd_portable_invntt_invert_ntt_at_layer_0_round(
    Eurydice_arr_a3 *re, size_t index, int32_t zeta0, int32_t zeta1,
...
libcrux_ml_dsa_simd_portable_invntt_invert_ntt_at_layer_1_round(
    Eurydice_arr_a3 *re, size_t index, int32_t zeta_00, int32_t zeta_01) {
  libcrux_ml_dsa_simd_portable_invntt_simd_unit_invert_ntt_at_layer_1(
...
libcrux_ml_dsa_simd_portable_invntt_invert_ntt_at_layer_2_round(
    Eurydice_arr_a3 *re, size_t index, int32_t zeta1) {
  libcrux_ml_dsa_simd_portable_invntt_simd_unit_invert_ntt_at_layer_2(
      &re->data[index], zeta1);
}
...
- ZETA= 280005
*/
static KRML_MUSTINLINE void libcrux_ml_dsa_simd_portable_invntt_outer_3_plus_30(
    Eurydice_arr_a3 *re) {
  for (size_t i = (size_t)0U; i < (size_t)0U + (size_t)1U; i++) {
    size_t j = i;
...
- ZETA= 4010497
*/
static KRML_MUSTINLINE void libcrux_ml_dsa_simd_portable_invntt_outer_3_plus_25(
    Eurydice_arr_a3 *re) {
  for (size_t i = (size_t)2U; i < (size_t)2U + (size_t)1U; i++) {
    size_t j = i;
    Eurydice_arr_4d rej = re->data[j];
...
- ZETA= 1757237
*/
static KRML_MUSTINLINE void libcrux_ml_dsa_simd_portable_invntt_outer_3_plus_f4(
    Eurydice_arr_a3 *re) {
  for (size_t i = (size_t)6U; i < (size_t)6U + (size_t)1U; i++) {
    size_t j = i;
    Eurydice_arr_4d rej = re->data[j];
...
- ZETA= -3277672
*/
static KRML_MUSTINLINE void libcrux_ml_dsa_simd_portable_invntt_outer_3_plus_82(
    Eurydice_arr_a3 *re) {
  for (size_t i = (size_t)8U; i < (size_t)8U + (size_t)1U; i++) {
    size_t j = i;
    Eurydice_arr_4d rej = re->data[j];
...
- ZETA= -1399561
*/
static KRML_MUSTINLINE void libcrux_ml_dsa_simd_portable_invntt_outer_3_plus_1d(
    Eurydice_arr_a3 *re) {
  for (size_t i = (size_t)10U; i < (size_t)10U + (size_t)1U; i++) {
    size_t j = i;
    Eurydice_arr_4d rej = re->data[j];
...
- ZETA= -3859737
*/
static KRML_MUSTINLINE void libcrux_ml_dsa_simd_portable_invntt_outer_3_plus_ea(
    Eurydice_arr_a3 *re) {
  for (size_t i = (size_t)12U; i < (size_t)12U + (size_t)1U; i++) {
    size_t j = i;
    Eurydice_arr_4d rej = re->data[j];
...
- ZETA= -2118186
*/
static KRML_MUSTINLINE void libcrux_ml_dsa_simd_portable_invntt_outer_3_plus_d8(
    Eurydice_arr_a3 *re) {
  for (size_t i = (size_t)14U; i < (size_t)14U + (size_t)1U; i++) {
    size_t j = i;
    Eurydice_arr_4d rej = re->data[j];
...
- ZETA= -2108549
*/
static KRML_MUSTINLINE void libcrux_ml_dsa_simd_portable_invntt_outer_3_plus_42(
    Eurydice_arr_a3 *re) {
  for (size_t i = (size_t)16U; i < (size_t)16U + (size_t)1U; i++) {
    size_t j = i;
    Eurydice_arr_4d rej = re->data[j];
...
- ZETA= 2619752
*/
static KRML_MUSTINLINE void libcrux_ml_dsa_simd_portable_invntt_outer_3_plus_60(
    Eurydice_arr_a3 *re) {
  for (size_t i = (size_t)18U; i < (size_t)18U + (size_t)1U; i++) {
    size_t j = i;
    Eurydice_arr_4d rej = re->data[j];
...
- ZETA= -1119584
*/
static KRML_MUSTINLINE void libcrux_ml_dsa_simd_portable_invntt_outer_3_plus_61(
    Eurydice_arr_a3 *re) {
  for (size_t i = (size_t)20U; i < (size_t)20U + (size_t)1U; i++) {
    size_t j = i;
    Eurydice_arr_4d rej = re->data[j];
...
- ZETA= -549488
*/
static KRML_MUSTINLINE void libcrux_ml_dsa_simd_portable_invntt_outer_3_plus_29(
    Eurydice_arr_a3 *re) {
  for (size_t i = (size_t)22U; i < (size_t)22U + (size_t)1U; i++) {
    size_t j = i;
    Eurydice_arr_4d rej = re->data[j];
...
- ZETA= 3585928
*/
static KRML_MUSTINLINE void libcrux_ml_dsa_simd_portable_invntt_outer_3_plus_fe(
    Eurydice_arr_a3 *re) {
  for (size_t i = (size_t)24U; i < (size_t)24U + (size_t)1U; i++) {
    size_t j = i;
    Eurydice_arr_4d rej = re->data[j];
...
- ZETA= -1079900
*/
static KRML_MUSTINLINE void libcrux_ml_dsa_simd_portable_invntt_outer_3_plus_9d(
    Eurydice_arr_a3 *re) {
  for (size_t i = (size_t)26U; i < (size_t)26U + (size_t)1U; i++) {
    size_t j = i;
    Eurydice_arr_4d rej = re->data[j];
...
- ZETA= 1024112
*/
static KRML_MUSTINLINE void libcrux_ml_dsa_simd_portable_invntt_outer_3_plus_38(
    Eurydice_arr_a3 *re) {
  for (size_t i = (size_t)28U; i < (size_t)28U + (size_t)1U; i++) {
    size_t j = i;
    Eurydice_arr_4d rej = re->data[j];
...
- ZETA= 2725464
*/
static KRML_MUSTINLINE void libcrux_ml_dsa_simd_portable_invntt_outer_3_plus_5f(
    Eurydice_arr_a3 *re) {
  for (size_t i = (size_t)30U; i < (size_t)30U + (size_t)1U; i++) {
    size_t j = i;
    Eurydice_arr_4d rej = re->data[j];
...
- SIZE= 3309
*/
static inline const Eurydice_arr_0c *libcrux_ml_dsa_types_as_ref_c5_5c(
...
- SIZE= 1952
*/
static inline const Eurydice_arr_29 *libcrux_ml_dsa_types_as_ref_7f_a2(
...
- SIZE= 4032
*/
static inline const Eurydice_arr_24 *libcrux_ml_dsa_types_as_ref_9b_e5(
...
- SIZE= 1952
*/
static inline Eurydice_arr_29 libcrux_ml_dsa_types_new_7f_a2(
    Eurydice_arr_29 value) {
  return value;
}
...
- SIZE= 4032
*/
static inline Eurydice_arr_24 libcrux_ml_dsa_types_new_9b_e5(
    Eurydice_arr_24 value) {
  return value;
}
...
static inline Eurydice_borrow_slice_u8 Eurydice_array_to_subslice_shared_d43(
    const Eurydice_arr_94 *a, core_ops_range_Range_87 r) {
...
static inline Eurydice_mut_borrow_slice_u8 Eurydice_array_to_subslice_mut_d49(
    Eurydice_arr_94 *a, core_ops_range_Range_87 r) {
  return (Eurydice_mut_borrow_slice_u8{a->data + r.start, r.end - r.start});
}
...
static inline Eurydice_borrow_slice_u8 Eurydice_array_to_subslice_shared_d41(
    const Eurydice_arr_38 *a, core_ops_range_Range_87 r) {
  return (Eurydice_borrow_slice_u8{a->data + r.start, r.end - r.start});
}
...
static inline Eurydice_mut_borrow_slice_u8 Eurydice_array_to_subslice_mut_d47(
    Eurydice_arr_38 *a, core_ops_range_Range_87 r) {
  return (Eurydice_mut_borrow_slice_u8{a->data + r.start, r.end - r.start});
}
...
*/
static inline Eurydice_dst_ref_mut_83 Eurydice_slice_subslice_mut_47(
    Eurydice_dst_ref_mut_83 s, core_ops_range_Range_87 r) {
...
- $16size_t
*/
typedef struct Eurydice_arr_a30_s {
  Eurydice_arr_b2 data[16U];
} Eurydice_arr_a30;
...
- N= 32
*/
static inline Eurydice_mut_borrow_slice_u8 Eurydice_array_to_subslice_to_mut_21(
    Eurydice_arr_ec *a, size_t r) {
  Eurydice_mut_borrow_slice_u8 lit;
  lit.ptr = a->data;
  lit.meta = r;
  return lit;
...
static inline void libcrux_ml_dsa_polynomial_from_i32_array_ff_37(
    Eurydice_dst_ref_shared_83 array, Eurydice_arr_a3 *result) {
...
- N= 256
*/
static inline Eurydice_dst_ref_shared_83 Eurydice_array_to_slice_shared_af(
...
static KRML_MUSTINLINE void libcrux_ml_dsa_ntt_ntt_multiply_montgomery_37(
    Eurydice_arr_a3 *lhs, const Eurydice_arr_a3 *rhs) {
  for (size_t i = (size_t)0U; i < (size_t)32U; i++) {
    size_t i0 = i;
...
static KRML_MUSTINLINE void libcrux_ml_dsa_polynomial_add_ff_37(
    Eurydice_arr_a3 *self, const Eurydice_arr_a3 *rhs) {
  for (size_t i = (size_t)0U; i < (size_t)32U; i++) {
    size_t i0 = i;
...
static KRML_MUSTINLINE void libcrux_ml_dsa_matrix_compute_w_approx_37(
    size_t rows_in_a, size_t columns_in_a, Eurydice_dst_ref_shared_44 matrix,
  ...
  for (size_t i0 = (size_t)0U; i0 < rows_in_a; i0++) {
    ...
    for (size_t i = (size_t)0U; i < columns_in_a; i++) {
      ...
      libcrux_ml_dsa_ntt_ntt_multiply_montgomery_37(&product,
    ...
    libcrux_ml_dsa_ntt_ntt_multiply_montgomery_37(&t1.ptr[i1],
...
- N= 3309
*/
static inline Eurydice_borrow_slice_u8 Eurydice_array_to_slice_shared_6b(
...
static inline void libcrux_ml_dsa_encoding_t1_deserialize_37(
    Eurydice_borrow_slice_u8 serialized, Eurydice_arr_a3 *result) {
  for (size_t i = (size_t)0U; i < (size_t)32U; i++) {
    size_t i0 = i;
...
libcrux_ml_dsa_encoding_verification_key_deserialize_37(
    ...
    Eurydice_borrow_slice_u8 serialized, Eurydice_dst_ref_mut_44 t1) {
...
- N= 1952
*/
static inline Eurydice_borrow_slice_u8 Eurydice_array_to_slice_shared_37(
...
- N= 4032
*/
static inline Eurydice_borrow_slice_u8 Eurydice_array_to_slice_shared_98(
...
/**
A monomorphic instance of core.result.Result
with types libcrux_ml_dsa_ml_dsa_generic_ml_dsa_65_MLDSA65Signature,
...
- $6size_t
*/
typedef struct Eurydice_arr_5d0_s {
...
- N= 3309
*/
static inline Eurydice_mut_borrow_slice_u8 Eurydice_array_to_slice_mut_6b(
    Eurydice_arr_0c *a) {
  Eurydice_mut_borrow_slice_u8 lit;
  lit.ptr = a->data;
  lit.meta = (size_t)3309U;
...
- N= 6
*/
static inline Eurydice_dst_ref_shared_20 Eurydice_array_to_slice_shared_86(
    const Eurydice_arr_5d0 *a) {
...
static KRML_MUSTINLINE void libcrux_ml_dsa_encoding_gamma1_serialize_37(
    const Eurydice_arr_a3 *re, Eurydice_mut_borrow_slice_u8 serialized,
    size_t gamma1_exponent) {
  for (size_t i = (size_t)0U; i < (size_t)32U; i++) {
    size_t i0 = i;
...
static KRML_MUSTINLINE void libcrux_ml_dsa_encoding_signature_serialize_37(
    ...
    Eurydice_dst_ref_shared_44 signer_response, Eurydice_dst_ref_shared_20 hint,
...
- N= 6
*/
static inline Eurydice_dst_ref_mut_20 Eurydice_array_to_slice_mut_86(
    Eurydice_arr_5d0 *a) {
...
- N= 256
*/
static inline Eurydice_dst_ref_mut_83 Eurydice_array_to_subslice_mut_44(
...
*/
static inline Eurydice_arr_6c libcrux_ml_dsa_polynomial_to_i32_array_ff_37(
...
static KRML_MUSTINLINE size_t libcrux_ml_dsa_arithmetic_make_hint_37(
    Eurydice_dst_ref_shared_44 low, Eurydice_dst_ref_shared_44 high,
...
libcrux_ml_dsa_polynomial_infinity_norm_exceeds_ff_37(
    const Eurydice_arr_a3 *self, int32_t bound) {
  bool result = false;
  for (size_t i = (size_t)0U; i < (size_t)32U; i++) {
    size_t i0 = i;
...
libcrux_ml_dsa_arithmetic_vector_infinity_norm_exceeds_37(
    Eurydice_dst_ref_shared_44 vector, int32_t bound) {
  bool result = false;
...
static KRML_MUSTINLINE void libcrux_ml_dsa_matrix_subtract_vectors_37(
    size_t dimension, Eurydice_dst_ref_mut_44 lhs,
...
static KRML_MUSTINLINE void libcrux_ml_dsa_matrix_vector_times_ring_element_37(
    Eurydice_dst_ref_mut_44 vector, const Eurydice_arr_a3 *ring_element) {
  for (size_t i = (size_t)0U; i < vector.meta; i++) {
    size_t i0 = i;
    libcrux_ml_dsa_ntt_ntt_multiply_montgomery_37(&vector.ptr[i0],
                                                  ring_element);
...
- N= 48
*/
static inline Eurydice_borrow_slice_u8 Eurydice_array_to_slice_shared_9f(
...
*/
static KRML_MUSTINLINE void libcrux_secrets_mem_requests_ct_declassify_69(
    const Eurydice_arr_65 *val) {}
...
- N= 768
*/
static inline Eurydice_borrow_slice_u8 Eurydice_array_to_slice_shared_27(
...
- N= 768
*/
static inline Eurydice_mut_borrow_slice_u8 Eurydice_array_to_slice_mut_27(
    Eurydice_arr_d2 *a) {
  Eurydice_mut_borrow_slice_u8 lit;
  lit.ptr = a->data;
  lit.meta = (size_t)768U;
...
libcrux_ml_dsa_encoding_commitment_serialize_vector_37(
    size_t ring_element_size, Eurydice_dst_ref_shared_44 vector,
    Eurydice_mut_borrow_slice_u8 serialized) {
  size_t offset = (size_t)0U;
  for (size_t i = (size_t)0U; i < vector.meta; i++) {
    size_t _cloop_j = i;
...
static KRML_MUSTINLINE void libcrux_ml_dsa_arithmetic_decompose_vector_37(
    size_t dimension, int32_t gamma2, Eurydice_dst_ref_shared_44 t,
    Eurydice_dst_ref_mut_44 low, Eurydice_dst_ref_mut_44 high) {
  for (size_t i0 = (size_t)0U; i0 < dimension; i0++) {
    size_t i1 = i0;
    for (size_t i = (size_t)0U; i < (size_t)32U; i++) {
      size_t j = i;
      libcrux_ml_dsa_simd_portable_decompose_65(gamma2, &t.ptr[i1].data[j],
                                                &low.ptr[i1].data[j],
                                                &high.ptr[i1].data[j]);
    }
  }
...
- $30size_t
*/
typedef struct Eurydice_arr_5a_s {
  Eurydice_arr_a3 data[30U];
} Eurydice_arr_5a;
...
- N= 30
*/
static inline Eurydice_dst_ref_shared_44 Eurydice_array_to_slice_shared_202(
    const Eurydice_arr_5a *a) {
...
static KRML_MUSTINLINE void libcrux_ml_dsa_matrix_compute_matrix_x_mask_37(
    size_t rows_in_a, size_t columns_in_a, Eurydice_dst_ref_shared_44 matrix,
    Eurydice_dst_ref_shared_44 mask, Eurydice_dst_ref_mut_44 result) {
  for (size_t i0 = (size_t)0U; i0 < rows_in_a; i0++) {
    size_t i1 = i0;
    for (size_t i = (size_t)0U; i < columns_in_a; i++) {
      size_t j = i;
...
- N= 640
*/
static inline Eurydice_borrow_slice_u8 Eurydice_array_to_slice_shared_4f(
...
- N= 640
*/
static inline Eurydice_mut_borrow_slice_u8 Eurydice_array_to_slice_mut_4f(
    Eurydice_arr_20 *a) {
  Eurydice_mut_borrow_slice_u8 lit;
  lit.ptr = a->data;
  lit.meta = (size_t)640U;
...
- $576size_t
*/
typedef struct Eurydice_arr_220_s {
  uint8_t data[576U];
} Eurydice_arr_220;
...
- N= 576
*/
static inline Eurydice_mut_borrow_slice_u8 Eurydice_array_to_slice_mut_8a(
    Eurydice_arr_220 *a) {
  Eurydice_mut_borrow_slice_u8 lit;
  lit.ptr = a->data;
  lit.meta = (size_t)576U;
...
- N= 11
*/
static inline Eurydice_borrow_slice_u8 Eurydice_array_to_slice_shared_2f(
...
- N= 1
*/
static inline Eurydice_borrow_slice_u8 Eurydice_array_to_slice_shared_79(
...
libcrux_ml_dsa_encoding_error_deserialize_to_vector_then_ntt_37(
  ...
  for (size_t i = (size_t)0U; i < serialized.meta / ring_element_size; i++) {
    ...
    libcrux_ml_dsa_encoding_error_deserialize_37(eta, bytes,
...
- N= 1952
*/
static inline Eurydice_mut_borrow_slice_u8 Eurydice_array_to_slice_mut_37(
    Eurydice_arr_29 *a) {
  Eurydice_mut_borrow_slice_u8 lit;
  lit.ptr = a->data;
  lit.meta = (size_t)1952U;
...
- N= 4032
*/
static inline Eurydice_mut_borrow_slice_u8 Eurydice_array_to_slice_mut_98(
    Eurydice_arr_24 *a) {
  Eurydice_mut_borrow_slice_u8 lit;
  lit.ptr = a->data;
  lit.meta = (size_t)4032U;
...
static KRML_MUSTINLINE void libcrux_ml_dsa_encoding_error_serialize_37(
    libcrux_ml_dsa_constants_Eta eta, const Eurydice_arr_a3 *re,
    Eurydice_mut_borrow_slice_u8 serialized) {
  size_t output_bytes_per_simd_unit =
...
- $6size_t
*/
typedef struct Eurydice_arr_dc1_s {
  Eurydice_arr_a3 data[6U];
} Eurydice_arr_dc1;
...
- N= 6
*/
static inline Eurydice_dst_ref_shared_44 Eurydice_array_to_slice_shared_201(
    const Eurydice_arr_dc1 *a) {
  Eurydice_dst_ref_shared_44 lit;
  lit.ptr = a->data;
  lit.meta = (size_t)6U;
  return lit;
...
libcrux_ml_dsa_encoding_verification_key_generate_serialized_37(
    Eurydice_borrow_slice_u8 seed, Eurydice_dst_ref_shared_44 t1,
...
static KRML_MUSTINLINE void libcrux_ml_dsa_arithmetic_power2round_vector_37(
    Eurydice_dst_ref_mut_44 t, Eurydice_dst_ref_mut_44 t1) {
  for (size_t i0 = (size_t)0U; i0 < t.meta; i0++) {
    size_t i1 = i0;
    for (size_t i = (size_t)0U; i < (size_t)32U; i++) {
      size_t j = i;
      libcrux_ml_dsa_simd_portable_power2round_65(&t.ptr[i1].data[j],
                                                  &t1.ptr[i1].data[j]);
    }
  }
}
...
*/
static KRML_MUSTINLINE void libcrux_secrets_mem_requests_ct_declassify_b2(
    const Eurydice_arr_dc1 *val) {}
...
- N= 6
*/
static inline Eurydice_dst_ref_mut_44 Eurydice_array_to_slice_mut_202(
    Eurydice_arr_dc1 *a) {
...
- N= 11
*/
static inline Eurydice_dst_ref_shared_44 Eurydice_array_to_slice_shared_200(
...
- N= 5
*/
static inline Eurydice_dst_ref_shared_44 Eurydice_array_to_slice_shared_20(
...
static KRML_MUSTINLINE void libcrux_ml_dsa_matrix_compute_as1_plus_s2_37(
    size_t rows_in_a, size_t columns_in_a, Eurydice_dst_ref_mut_44 a_as_ntt,
    Eurydice_dst_ref_shared_44 s1_ntt, Eurydice_dst_ref_shared_44 s1_s2,
  ...
  for (size_t i0 = (size_t)0U; i0 < rows_in_a; i0++) {
    ...
    for (size_t i = (size_t)0U; i < columns_in_a; i++) {
      ...
      libcrux_ml_dsa_polynomial_add_ff_37(&result.ptr[i1],
...
- N= 11
*/
static inline Eurydice_dst_ref_shared_44 Eurydice_array_to_subslice_shared_25(
    const Eurydice_arr_47 *a, core_ops_range_Range_87 r) {
...
- N= 5
*/
static inline Eurydice_dst_ref_mut_44 Eurydice_array_to_slice_mut_201(
    Eurydice_arr_5d *a) {
  Eurydice_dst_ref_mut_44 lit;
  lit.ptr = a->data;
  lit.meta = (size_t)5U;
...
- N= 30
*/
static inline Eurydice_dst_ref_mut_44 Eurydice_array_to_slice_mut_200(
    Eurydice_arr_5a *a) {
  Eurydice_dst_ref_mut_44 lit;
  lit.ptr = a->data;
  lit.meta = (size_t)30U;
...
- N= 4
*/
static inline Eurydice_dst_ref_mut_33 Eurydice_array_to_slice_mut_7e(
    Eurydice_arr_93 *a) {
...
- N= 840
*/
static inline Eurydice_borrow_slice_u8 Eurydice_array_to_slice_shared_4c(
...
- N= 263
*/
static inline Eurydice_dst_ref_mut_83 Eurydice_array_to_subslice_from_mut_11(
...
- N= 11
*/
static inline Eurydice_dst_ref_mut_44 Eurydice_array_to_slice_mut_20(
    Eurydice_arr_47 *a) {
  Eurydice_dst_ref_mut_44 lit;
  lit.ptr = a->data;
  lit.meta = (size_t)11U;
...
- N= 263
*/
static inline Eurydice_dst_ref_shared_83 Eurydice_array_to_slice_shared_2c0(
...
- N= 66
*/
static inline Eurydice_borrow_slice_u8 Eurydice_array_to_slice_shared_f1(
...
*/
static KRML_MUSTINLINE void libcrux_secrets_mem_requests_ct_classify_4b(
    const Eurydice_arr_ec *val) {}
...
- N= 840
*/
static inline Eurydice_mut_borrow_slice_u8 Eurydice_array_to_slice_mut_4c(
    Eurydice_arr_d1 *a) {
  Eurydice_mut_borrow_slice_u8 lit;
  lit.ptr = a->data;
  lit.meta = (size_t)840U;
...
static inline Eurydice_mut_borrow_slice_u8 Eurydice_array_to_subslice_mut_d46(
    Eurydice_arr_c40 *a, core_ops_range_Range_87 r) {
  return (Eurydice_mut_borrow_slice_u8{a->data + r.start, r.end - r.start});
}
...
- N= 136
*/
static inline Eurydice_mut_borrow_slice_u8 Eurydice_array_to_slice_mut_58(
    Eurydice_arr_ff *a) {
  Eurydice_mut_borrow_slice_u8 lit;
  lit.ptr = a->data;
...
*/
static inline Eurydice_mut_borrow_slice_u8 Eurydice_slice_subslice_to_mut_72(
...
*/
static inline Eurydice_array_u8x8 core_result_unwrap_26_e0(
    core_result_Result_8e self) {
