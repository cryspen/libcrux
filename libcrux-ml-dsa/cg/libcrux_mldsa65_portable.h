...
libcrux_ml_dsa_constants_clone_f8(libcrux_ml_dsa_constants_Eta *self)
{
  return self[0U];
}
...
libcrux_ml_dsa_encoding_signature_set_hint(Eurydice_slice out_hint, size_t i, size_t j)
{
  Eurydice_slice_index(out_hint, i, int32_t [256U], int32_t (*)[256U])[j] = (int32_t)1;
}
...
)
{
  ...
  state0 = libcrux_sha3_portable_incremental_shake128_init();
  libcrux_sha3_portable_incremental_shake128_absorb_final(&state0, input0);
  libcrux_sha3_generic_keccak_KeccakState_17
  state1 = libcrux_sha3_portable_incremental_shake128_init();
  libcrux_sha3_portable_incremental_shake128_absorb_final(&state1, input1);
  libcrux_sha3_generic_keccak_KeccakState_17
  state2 = libcrux_sha3_portable_incremental_shake128_init();
  libcrux_sha3_portable_incremental_shake128_absorb_final(&state2, input2);
  libcrux_sha3_generic_keccak_KeccakState_17
  state3 = libcrux_sha3_portable_incremental_shake128_init();
...
libcrux_ml_dsa_hash_functions_portable_init_absorb_final_shake256(Eurydice_slice input)
{
  libcrux_sha3_generic_keccak_KeccakState_17
...
)
{
  ...
  libcrux_sha3_generic_keccak_KeccakState_17
  state1 = libcrux_sha3_portable_incremental_shake256_init();
  libcrux_sha3_portable_incremental_shake256_absorb_final(&state1, input1);
  libcrux_sha3_generic_keccak_KeccakState_17
  state2 = libcrux_sha3_portable_incremental_shake256_init();
  libcrux_sha3_portable_incremental_shake256_absorb_final(&state2, input2);
  libcrux_sha3_generic_keccak_KeccakState_17
  state3 = libcrux_sha3_portable_incremental_shake256_init();
...
static KRML_MUSTINLINE void
libcrux_ml_dsa_hash_functions_portable_shake128(Eurydice_slice input, Eurydice_slice out)
{
...
/**
This function found in impl {(libcrux_ml_dsa::hash_functions::shake128::Xof for libcrux_ml_dsa::hash_functions::portable::Shake128)#1}
*/
static KRML_MUSTINLINE void
libcrux_ml_dsa_hash_functions_portable_shake128_a0(Eurydice_slice input, Eurydice_slice out)
{
...
/**
This function found in impl {(libcrux_ml_dsa::hash_functions::shake256::DsaXof for libcrux_ml_dsa::hash_functions::portable::Shake256)#2}
*/
static KRML_MUSTINLINE libcrux_sha3_generic_keccak_KeccakState_17
libcrux_ml_dsa_hash_functions_portable_init_absorb_final_5c(Eurydice_slice input)
{
...
{
  libcrux_ml_dsa_hash_functions_portable_squeeze_first_block_shake256(self, ret);
}
...
/**
This function found in impl {(libcrux_ml_dsa::hash_functions::shake256::Xof for libcrux_ml_dsa::hash_functions::portable::Shake256Xof)#4}
*/
static inline void
...
/**
This function found in impl {(libcrux_ml_dsa::hash_functions::shake256::XofX4 for libcrux_ml_dsa::hash_functions::portable::Shake256X4)#3}
*/
static KRML_MUSTINLINE libcrux_ml_dsa_hash_functions_portable_Shake256X4
...
)
{
  uint8_t out[66U] = { 0U };
  uint8_t *uu____0 = out;
  Eurydice_slice_copy(Eurydice_array_to_subslice2(uu____0,
      (size_t)0U,
...
*/
/**
This function found in impl {libcrux_ml_dsa::pre_hash::DomainSeparationContext<'a>#1}
*/
static inline Result_a8
libcrux_ml_dsa_pre_hash_new_45(Eurydice_slice context, Option_30 pre_hash_oid)
{
...
This function found in impl {libcrux_ml_dsa::pre_hash::DomainSeparationContext<'a>#1}
*/
static inline Option_30
*libcrux_ml_dsa_pre_hash_pre_hash_oid_45(libcrux_ml_dsa_pre_hash_DomainSeparationContext *self)
{
...
libcrux_ml_dsa_pre_hash_context_45(libcrux_ml_dsa_pre_hash_DomainSeparationContext *self)
{
  return self->context;
}
...
{
  bool done = false;
  for (size_t i = (size_t)0U; i < Eurydice_slice_len(randomness, uint8_t); i++)
  {
    size_t _cloop_j = i;
    uint8_t *byte = &Eurydice_slice_index(randomness, _cloop_j, uint8_t, uint8_t *);
    if (!done)
    {
      ...
      if (sample_at <= out_index[0U])
      {
        ...
        result[sample_at] = (int32_t)1 - (int32_t)2 * (int32_t)(signs[0U] & 1ULL);
...
static const
uint8_t
libcrux_ml_dsa_pre_hash_SHAKE128_OID[11U] =
...
{
  memcpy(ret, libcrux_ml_dsa_pre_hash_SHAKE128_OID, (size_t)11U * sizeof (uint8_t));
}
...
typedef struct libcrux_ml_dsa_simd_portable_vector_type_Coefficients_s { int32_t values[8U]; }
...
{
  Eurydice_slice_copy(Eurydice_array_to_slice((size_t)8U, out->values, int32_t),
    Eurydice_slice_subslice2(array,
      (size_t)0U,
...
{
  Eurydice_slice_copy(out, Eurydice_array_to_slice((size_t)8U, value->values, int32_t), int32_t);
}
...
)
{
  ...
  (size_t
    i = (size_t)0U;
    i < Eurydice_slice_len(Eurydice_array_to_slice((size_t)8U, lhs->values, int32_t), int32_t);
    i++)
  {
    size_t i0 = i;
    size_t uu____0 = i0;
...
*/
static inline void
libcrux_ml_dsa_simd_portable_add_e9(
  libcrux_ml_dsa_simd_portable_vector_type_Coefficients *lhs,
  libcrux_ml_dsa_simd_portable_vector_type_Coefficients *rhs
)
{
...
*/
static inline void
libcrux_ml_dsa_simd_portable_subtract_e9(
  libcrux_ml_dsa_simd_portable_vector_type_Coefficients *lhs,
  libcrux_ml_dsa_simd_portable_vector_type_Coefficients *rhs
)
{
...
)
{
  ...
  (size_t
    i = (size_t)0U;
    i <
      Eurydice_slice_len(Eurydice_array_to_slice((size_t)8U, simd_unit->values, int32_t),
        int32_t);
    i++)
  {
    size_t i0 = i;
...
*/
static inline bool
libcrux_ml_dsa_simd_portable_infinity_norm_exceeds_e9(
  libcrux_ml_dsa_simd_portable_vector_type_Coefficients *simd_unit,
  int32_t bound
)
{
...
)
{
  ...
  (size_t
    i = (size_t)0U;
    i < Eurydice_slice_len(Eurydice_array_to_slice((size_t)8U, low->values, int32_t), int32_t);
    i++)
  {
    size_t i0 = i;
    int32_t_x2
...
)
{
  ...
  (size_t
    i = (size_t)0U;
    i < Eurydice_slice_len(Eurydice_array_to_slice((size_t)8U, hint->values, int32_t), int32_t);
    i++)
  {
    size_t i0 = i;
    hint->values[i0] =
      libcrux_ml_dsa_simd_portable_arithmetic_compute_one_hint(low->values[i0],
        high->values[i0],
        gamma2);
...
*/
static inline size_t
libcrux_ml_dsa_simd_portable_compute_hint_e9(
  libcrux_ml_dsa_simd_portable_vector_type_Coefficients *low,
  libcrux_ml_dsa_simd_portable_vector_type_Coefficients *high,
  int32_t gamma2,
  libcrux_ml_dsa_simd_portable_vector_type_Coefficients *hint
...
)
{
    ...
    i++)
  {
    size_t i0 = i;
    lhs->values[i0] =
      libcrux_ml_dsa_simd_portable_arithmetic_montgomery_reduce_element((int64_t)lhs->values[i0] *
          (int64_t)rhs->values[i0]);
  }
}
...
*/
static inline void
libcrux_ml_dsa_simd_portable_montgomery_multiply_e9(
  libcrux_ml_dsa_simd_portable_vector_type_Coefficients *lhs,
  libcrux_ml_dsa_simd_portable_vector_type_Coefficients *rhs
)
{
...
)
{
  ...
  (size_t
    i = (size_t)0U;
    i < Eurydice_slice_len(Eurydice_array_to_slice((size_t)8U, t0->values, int32_t), int32_t);
    i++)
  {
    size_t i0 = i;
    int32_t_x2
    uu____0 = libcrux_ml_dsa_simd_portable_arithmetic_power2round_element(t0->values[i0]);
    int32_t uu____1 = uu____0.snd;
...
)
{
  ...
  for (size_t i = (size_t)0U; i < Eurydice_slice_len(randomness, uint8_t) / (size_t)3U; i++)
  {
    size_t i0 = i;
    int32_t b0 = (int32_t)Eurydice_slice_index(randomness, i0 * (size_t)3U, uint8_t, uint8_t *);
    int32_t
    b1 =
      (int32_t)Eurydice_slice_index(randomness, i0 * (size_t)3U + (size_t)1U, uint8_t, uint8_t *);
    int32_t
    b2 =
      (int32_t)Eurydice_slice_index(randomness, i0 * (size_t)3U + (size_t)2U, uint8_t, uint8_t *);
...
)
{
  ...
  for (size_t i = (size_t)0U; i < Eurydice_slice_len(randomness, uint8_t); i++)
  {
    ...
    if (try_0 < 15U)
    {
      ...
      Eurydice_slice_index(out, sampled, int32_t, int32_t *) = (int32_t)2 - try_0_mod_5;
      sampled++;
    }
    if (try_1 < 15U)
    {
      ...
      Eurydice_slice_index(out, sampled, int32_t, int32_t *) = (int32_t)2 - try_1_mod_5;
      sampled++;
    }
  }
  return sampled;
...
)
{
  ...
  for (size_t i = (size_t)0U; i < Eurydice_slice_len(randomness, uint8_t); i++)
  {
    ...
    if (try_0 < 9U)
    {
      Eurydice_slice_index(out, sampled, int32_t, int32_t *) = (int32_t)4 - (int32_t)try_0;
      sampled++;
    }
    if (try_1 < 9U)
    {
      Eurydice_slice_index(out, sampled, int32_t, int32_t *) = (int32_t)4 - (int32_t)try_1;
      sampled++;
    }
  }
  return sampled;
...
)
{
  ...
  (size_t
    i = (size_t)0U;
    i <
      Eurydice_slice_len(Eurydice_array_to_slice((size_t)8U, simd_unit->values, int32_t), int32_t) /
        (size_t)4U;
    i++)
  {
    size_t i0 = i;
    Eurydice_slice
    coefficients =
      Eurydice_array_to_subslice2(simd_unit->values,
        i0 * (size_t)4U,
    ...
    coefficient3 =
      LIBCRUX_ML_DSA_SIMD_PORTABLE_ENCODING_GAMMA1_SERIALIZE_WHEN_GAMMA1_IS_2_POW_17_GAMMA1 -
        Eurydice_slice_index(coefficients,
          ...
          int32_t,
          int32_t *);
    Eurydice_slice_index(serialized, (size_t)9U * i0, uint8_t, uint8_t *) = (uint8_t)coefficient0;
    Eurydice_slice_index(serialized, (size_t)9U * i0 + (size_t)1U, uint8_t, uint8_t *) =
      (uint8_t)(coefficient0 >> 8U);
    Eurydice_slice_index(serialized, (size_t)9U * i0 + (size_t)2U, uint8_t, uint8_t *) =
    ...
    Eurydice_slice_index(serialized, (size_t)9U * i0 + (size_t)3U, uint8_t, uint8_t *) =
      (uint8_t)(coefficient1 >> 6U);
    Eurydice_slice_index(serialized, (size_t)9U * i0 + (size_t)4U, uint8_t, uint8_t *) =
    ...
    Eurydice_slice_index(serialized, (size_t)9U * i0 + (size_t)5U, uint8_t, uint8_t *) =
      (uint8_t)(coefficient2 >> 4U);
    Eurydice_slice_index(serialized, (size_t)9U * i0 + (size_t)6U, uint8_t, uint8_t *) =
    ...
    Eurydice_slice_index(serialized, (size_t)9U * i0 + (size_t)7U, uint8_t, uint8_t *) =
      (uint8_t)(coefficient3 >> 2U);
    Eurydice_slice_index(serialized, (size_t)9U * i0 + (size_t)8U, uint8_t, uint8_t *) =
    ...
    coefficient1 =
      LIBCRUX_ML_DSA_SIMD_PORTABLE_ENCODING_GAMMA1_SERIALIZE_WHEN_GAMMA1_IS_2_POW_19_GAMMA1 -
        Eurydice_slice_index(coefficients,
          ...
          int32_t,
          int32_t *);
    Eurydice_slice_index(serialized, (size_t)5U * i0, uint8_t, uint8_t *) = (uint8_t)coefficient0;
    Eurydice_slice_index(serialized, (size_t)5U * i0 + (size_t)1U, uint8_t, uint8_t *) =
      (uint8_t)(coefficient0 >> 8U);
    Eurydice_slice_index(serialized, (size_t)5U * i0 + (size_t)2U, uint8_t, uint8_t *) =
      (uint8_t)(coefficient0 >> 16U);
    size_t uu____0 = (size_t)5U * i0 + (size_t)2U;
    Eurydice_slice_index(serialized, uu____0, uint8_t, uint8_t *) =
      (uint32_t)Eurydice_slice_index(serialized, uu____0, uint8_t, uint8_t *) |
        (uint32_t)(uint8_t)(coefficient1 << 4U);
    Eurydice_slice_index(serialized, (size_t)5U * i0 + (size_t)3U, uint8_t, uint8_t *) =
      (uint8_t)(coefficient1 >> 4U);
    Eurydice_slice_index(serialized, (size_t)5U * i0 + (size_t)4U, uint8_t, uint8_t *) =
...
{
  for (size_t i = (size_t)0U; i < Eurydice_slice_len(serialized, uint8_t) / (size_t)9U; i++)
  {
    size_t i0 = i;
    Eurydice_slice
    bytes =
      Eurydice_slice_subslice2(serialized,
        ...
        uint8_t);
    int32_t coefficient0 = (int32_t)Eurydice_slice_index(bytes, (size_t)0U, uint8_t, uint8_t *);
    coefficient0 =
      coefficient0 | (int32_t)Eurydice_slice_index(bytes, (size_t)1U, uint8_t, uint8_t *) << 8U;
    coefficient0 =
      coefficient0 | (int32_t)Eurydice_slice_index(bytes, (size_t)2U, uint8_t, uint8_t *) << 16U;
    coefficient0 =
      coefficient0 &
        LIBCRUX_ML_DSA_SIMD_PORTABLE_ENCODING_GAMMA1_DESERIALIZE_WHEN_GAMMA1_IS_2_POW_17_GAMMA1_TIMES_2_BITMASK;
    int32_t
    coefficient1 = (int32_t)Eurydice_slice_index(bytes, (size_t)2U, uint8_t, uint8_t *) >> 2U;
    coefficient1 =
      coefficient1 | (int32_t)Eurydice_slice_index(bytes, (size_t)3U, uint8_t, uint8_t *) << 6U;
    coefficient1 =
      coefficient1 | (int32_t)Eurydice_slice_index(bytes, (size_t)4U, uint8_t, uint8_t *) << 14U;
    coefficient1 =
      coefficient1 &
        LIBCRUX_ML_DSA_SIMD_PORTABLE_ENCODING_GAMMA1_DESERIALIZE_WHEN_GAMMA1_IS_2_POW_17_GAMMA1_TIMES_2_BITMASK;
    int32_t
    coefficient2 = (int32_t)Eurydice_slice_index(bytes, (size_t)4U, uint8_t, uint8_t *) >> 4U;
    coefficient2 =
      coefficient2 | (int32_t)Eurydice_slice_index(bytes, (size_t)5U, uint8_t, uint8_t *) << 4U;
    coefficient2 =
      coefficient2 | (int32_t)Eurydice_slice_index(bytes, (size_t)6U, uint8_t, uint8_t *) << 12U;
    coefficient2 =
      coefficient2 &
        LIBCRUX_ML_DSA_SIMD_PORTABLE_ENCODING_GAMMA1_DESERIALIZE_WHEN_GAMMA1_IS_2_POW_17_GAMMA1_TIMES_2_BITMASK;
    int32_t
    coefficient3 = (int32_t)Eurydice_slice_index(bytes, (size_t)6U, uint8_t, uint8_t *) >> 6U;
    coefficient3 =
      coefficient3 | (int32_t)Eurydice_slice_index(bytes, (size_t)7U, uint8_t, uint8_t *) << 2U;
    coefficient3 =
      coefficient3 | (int32_t)Eurydice_slice_index(bytes, (size_t)8U, uint8_t, uint8_t *) << 10U;
    coefficient3 =
      coefficient3 &
        LIBCRUX_ML_DSA_SIMD_PORTABLE_ENCODING_GAMMA1_DESERIALIZE_WHEN_GAMMA1_IS_2_POW_17_GAMMA1_TIMES_2_BITMASK;
...
{
  for (size_t i = (size_t)0U; i < Eurydice_slice_len(serialized, uint8_t) / (size_t)5U; i++)
  {
    size_t i0 = i;
    Eurydice_slice
    bytes =
    ...
    int32_t
    coefficient1 = (int32_t)Eurydice_slice_index(bytes, (size_t)2U, uint8_t, uint8_t *) >> 4U;
    coefficient1 =
      coefficient1 | (int32_t)Eurydice_slice_index(bytes, (size_t)3U, uint8_t, uint8_t *) << 4U;
    coefficient1 =
      coefficient1 | (int32_t)Eurydice_slice_index(bytes, (size_t)4U, uint8_t, uint8_t *) << 12U;
...
{
  for (size_t i = (size_t)0U; i < Eurydice_slice_len(serialized, uint8_t); i++)
  {
    size_t i0 = i;
    uint8_t *byte = &Eurydice_slice_index(serialized, i0, uint8_t, uint8_t *);
    uint8_t
    uu____0 = core_ops_bit___core__ops__bit__BitAnd_u8__u8__for___a__u8___46__bitand(byte, 15U);
    simd_units->values[(size_t)2U * i0] =
      LIBCRUX_ML_DSA_SIMD_PORTABLE_ENCODING_ERROR_DESERIALIZE_WHEN_ETA_IS_4_ETA - (int32_t)uu____0;
    uint8_t
    uu____1 = core_ops_bit___core__ops__bit__Shr_i32__u8__for___a__u8___792__shr(byte, (int32_t)4);
...
{
  int32_t byte0 = (int32_t)Eurydice_slice_index(serialized, (size_t)0U, uint8_t, uint8_t *);
  int32_t byte1 = (int32_t)Eurydice_slice_index(serialized, (size_t)1U, uint8_t, uint8_t *);
  int32_t byte2 = (int32_t)Eurydice_slice_index(serialized, (size_t)2U, uint8_t, uint8_t *);
  simd_unit->values[0U] =
...
)
{
  int32_t
  coefficient0 =
    libcrux_ml_dsa_simd_portable_encoding_t0_change_t0_interval(simd_unit->values[0U]);
  int32_t
  coefficient1 =
    libcrux_ml_dsa_simd_portable_encoding_t0_change_t0_interval(simd_unit->values[1U]);
  int32_t
  coefficient2 =
    libcrux_ml_dsa_simd_portable_encoding_t0_change_t0_interval(simd_unit->values[2U]);
  int32_t
  coefficient3 =
    libcrux_ml_dsa_simd_portable_encoding_t0_change_t0_interval(simd_unit->values[3U]);
  int32_t
  coefficient4 =
    libcrux_ml_dsa_simd_portable_encoding_t0_change_t0_interval(simd_unit->values[4U]);
  int32_t
  coefficient5 =
    libcrux_ml_dsa_simd_portable_encoding_t0_change_t0_interval(simd_unit->values[5U]);
  int32_t
  coefficient6 =
    libcrux_ml_dsa_simd_portable_encoding_t0_change_t0_interval(simd_unit->values[6U]);
  int32_t
  coefficient7 =
    libcrux_ml_dsa_simd_portable_encoding_t0_change_t0_interval(simd_unit->values[7U]);
  Eurydice_slice_index(serialized, (size_t)0U, uint8_t, uint8_t *) = (uint8_t)coefficient0;
  Eurydice_slice_index(serialized, (size_t)1U, uint8_t, uint8_t *) =
    (uint8_t)(coefficient0 >> 8U);
...
)
{
  ...
  int32_t byte1 = (int32_t)Eurydice_slice_index(serialized, (size_t)1U, uint8_t, uint8_t *);
  int32_t byte2 = (int32_t)Eurydice_slice_index(serialized, (size_t)2U, uint8_t, uint8_t *);
  int32_t byte3 = (int32_t)Eurydice_slice_index(serialized, (size_t)3U, uint8_t, uint8_t *);
  int32_t byte4 = (int32_t)Eurydice_slice_index(serialized, (size_t)4U, uint8_t, uint8_t *);
  int32_t byte5 = (int32_t)Eurydice_slice_index(serialized, (size_t)5U, uint8_t, uint8_t *);
  int32_t byte6 = (int32_t)Eurydice_slice_index(serialized, (size_t)6U, uint8_t, uint8_t *);
  int32_t byte7 = (int32_t)Eurydice_slice_index(serialized, (size_t)7U, uint8_t, uint8_t *);
  int32_t byte8 = (int32_t)Eurydice_slice_index(serialized, (size_t)8U, uint8_t, uint8_t *);
  int32_t byte9 = (int32_t)Eurydice_slice_index(serialized, (size_t)9U, uint8_t, uint8_t *);
  int32_t byte10 = (int32_t)Eurydice_slice_index(serialized, (size_t)10U, uint8_t, uint8_t *);
  int32_t byte11 = (int32_t)Eurydice_slice_index(serialized, (size_t)11U, uint8_t, uint8_t *);
  int32_t byte12 = (int32_t)Eurydice_slice_index(serialized, (size_t)12U, uint8_t, uint8_t *);
...
)
{
    ...
    i++)
  {
    ...
    Eurydice_slice_index(serialized, (size_t)5U * i0, uint8_t, uint8_t *) =
      (uint8_t)(Eurydice_slice_index(coefficients, (size_t)0U, int32_t, int32_t *) & (int32_t)255);
    Eurydice_slice_index(serialized, (size_t)5U * i0 + (size_t)1U, uint8_t, uint8_t *) =
      (uint32_t)(uint8_t)(Eurydice_slice_index(coefficients, (size_t)1U, int32_t, int32_t *) &
        (int32_t)63)
      << 2U
      |
        (uint32_t)(uint8_t)(Eurydice_slice_index(coefficients, (size_t)0U, int32_t, int32_t *) >> 8U
        & (int32_t)3);
    Eurydice_slice_index(serialized, (size_t)5U * i0 + (size_t)2U, uint8_t, uint8_t *) =
      (uint32_t)(uint8_t)(Eurydice_slice_index(coefficients, (size_t)2U, int32_t, int32_t *) &
        (int32_t)15)
      << 4U
      |
        (uint32_t)(uint8_t)(Eurydice_slice_index(coefficients, (size_t)1U, int32_t, int32_t *) >> 6U
        & (int32_t)15);
    Eurydice_slice_index(serialized, (size_t)5U * i0 + (size_t)3U, uint8_t, uint8_t *) =
      (uint32_t)(uint8_t)(Eurydice_slice_index(coefficients, (size_t)3U, int32_t, int32_t *) &
        (int32_t)3)
      << 6U
      |
        (uint32_t)(uint8_t)(Eurydice_slice_index(coefficients, (size_t)2U, int32_t, int32_t *) >> 4U
        & (int32_t)63);
    Eurydice_slice_index(serialized, (size_t)5U * i0 + (size_t)4U, uint8_t, uint8_t *) =
      (uint8_t)(Eurydice_slice_index(coefficients, (size_t)3U, int32_t, int32_t *) >> 2U &
        (int32_t)255);
  }
}
  ...
  for (size_t i = (size_t)0U; i < Eurydice_slice_len(serialized, uint8_t) / (size_t)5U; i++)
  {
    ...
    bytes =
      Eurydice_slice_subslice2(serialized,
        ...
        i0 * (size_t)5U + (size_t)5U,
        uint8_t);
    int32_t byte0 = (int32_t)Eurydice_slice_index(bytes, (size_t)0U, uint8_t, uint8_t *);
    int32_t byte1 = (int32_t)Eurydice_slice_index(bytes, (size_t)1U, uint8_t, uint8_t *);
    int32_t byte2 = (int32_t)Eurydice_slice_index(bytes, (size_t)2U, uint8_t, uint8_t *);
    int32_t byte3 = (int32_t)Eurydice_slice_index(bytes, (size_t)3U, uint8_t, uint8_t *);
    int32_t byte4 = (int32_t)Eurydice_slice_index(bytes, (size_t)4U, uint8_t, uint8_t *);
    simd_unit->values[(size_t)4U * i0] = (byte0 | byte1 << 8U) & mask;
    simd_unit->values[(size_t)4U * i0 + (size_t)1U] = (byte1 >> 2U | byte2 << 6U) & mask;
    simd_unit->values[(size_t)4U * i0 + (size_t)2U] = (byte2 >> 4U | byte3 << 4U) & mask;
    simd_unit->values[(size_t)4U * i0 + (size_t)3U] = (byte3 >> 6U | byte4 << 2U) & mask;
  }
}
...
)
{
    ...
    i++)
  {
    size_t i0 = i;
    simd_unit->values[i0] =
      libcrux_ml_dsa_simd_portable_arithmetic_montgomery_reduce_element((int64_t)simd_unit->values[i0]
        * (int64_t)c);
  }
}
...
*/
static KRML_MUSTINLINE void
libcrux_ml_dsa_simd_portable_ntt_outer_3_plus_99(
...
)
{
  ...
  {
    size_t j = i;
    libcrux_ml_dsa_simd_portable_vector_type_Coefficients tmp = re[j + (size_t)16U];
    libcrux_ml_dsa_simd_portable_arithmetic_montgomery_multiply_by_constant(&tmp, (int32_t)25847);
    re[j + (size_t)16U] = re[j];
    libcrux_ml_dsa_simd_portable_arithmetic_subtract(&re[j + (size_t)16U], &tmp);
    libcrux_ml_dsa_simd_portable_arithmetic_add(&re[j], &tmp);
  }
}

static KRML_MUSTINLINE void
libcrux_ml_dsa_simd_portable_ntt_ntt_at_layer_7(
  libcrux_ml_dsa_simd_portable_vector_type_Coefficients *re
)
{
...
*/
static KRML_MUSTINLINE void
libcrux_ml_dsa_simd_portable_ntt_outer_3_plus_990(
  libcrux_ml_dsa_simd_portable_vector_type_Coefficients *re
)
{
  ...
  {
    size_t j = i;
    libcrux_ml_dsa_simd_portable_vector_type_Coefficients tmp = re[j + (size_t)8U];
...
*/
static KRML_MUSTINLINE void
libcrux_ml_dsa_simd_portable_ntt_outer_3_plus_7a(
  libcrux_ml_dsa_simd_portable_vector_type_Coefficients *re
)
{
...
static KRML_MUSTINLINE void
libcrux_ml_dsa_simd_portable_ntt_ntt_at_layer_6(
  libcrux_ml_dsa_simd_portable_vector_type_Coefficients *re
)
{
...
*/
static KRML_MUSTINLINE void
libcrux_ml_dsa_simd_portable_ntt_outer_3_plus_991(
  libcrux_ml_dsa_simd_portable_vector_type_Coefficients *re
)
{
  ...
  {
    size_t j = i;
    libcrux_ml_dsa_simd_portable_vector_type_Coefficients tmp = re[j + (size_t)4U];
    libcrux_ml_dsa_simd_portable_arithmetic_montgomery_multiply_by_constant(&tmp, (int32_t)237124);
    re[j + (size_t)4U] = re[j];
...
*/
static KRML_MUSTINLINE void
libcrux_ml_dsa_simd_portable_ntt_outer_3_plus_a8(
  libcrux_ml_dsa_simd_portable_vector_type_Coefficients *re
)
{
...
*/
static KRML_MUSTINLINE void
libcrux_ml_dsa_simd_portable_ntt_outer_3_plus_d9(
  libcrux_ml_dsa_simd_portable_vector_type_Coefficients *re
)
{
  for (size_t i = (size_t)24U; i < (size_t)24U + (size_t)4U; i++)
  {
    size_t j = i;
    libcrux_ml_dsa_simd_portable_vector_type_Coefficients tmp = re[j + (size_t)4U];
    libcrux_ml_dsa_simd_portable_arithmetic_montgomery_multiply_by_constant(&tmp, (int32_t)466468);
    re[j + (size_t)4U] = re[j];
    libcrux_ml_dsa_simd_portable_arithmetic_subtract(&re[j + (size_t)4U], &tmp);
    libcrux_ml_dsa_simd_portable_arithmetic_add(&re[j], &tmp);
  }
...
static KRML_MUSTINLINE void
libcrux_ml_dsa_simd_portable_ntt_ntt_at_layer_5(
  libcrux_ml_dsa_simd_portable_vector_type_Coefficients *re
)
{
...
*/
static KRML_MUSTINLINE void
libcrux_ml_dsa_simd_portable_ntt_outer_3_plus_992(
  libcrux_ml_dsa_simd_portable_vector_type_Coefficients *re
)
{
  ...
  {
    size_t j = i;
    libcrux_ml_dsa_simd_portable_vector_type_Coefficients tmp = re[j + (size_t)2U];
    libcrux_ml_dsa_simd_portable_arithmetic_montgomery_multiply_by_constant(&tmp,
      (int32_t)1826347);
    re[j + (size_t)2U] = re[j];
...
*/
static KRML_MUSTINLINE void
libcrux_ml_dsa_simd_portable_ntt_outer_3_plus_6b(
  libcrux_ml_dsa_simd_portable_vector_type_Coefficients *re
)
{
...
*/
static KRML_MUSTINLINE void
libcrux_ml_dsa_simd_portable_ntt_outer_3_plus_a80(
  libcrux_ml_dsa_simd_portable_vector_type_Coefficients *re
)
{
...
*/
static KRML_MUSTINLINE void
libcrux_ml_dsa_simd_portable_ntt_outer_3_plus_95(
  libcrux_ml_dsa_simd_portable_vector_type_Coefficients *re
)
{
...
*/
static KRML_MUSTINLINE void
libcrux_ml_dsa_simd_portable_ntt_outer_3_plus_7a1(
  libcrux_ml_dsa_simd_portable_vector_type_Coefficients *re
)
{
...
*/
static KRML_MUSTINLINE void
libcrux_ml_dsa_simd_portable_ntt_outer_3_plus_de(
  libcrux_ml_dsa_simd_portable_vector_type_Coefficients *re
)
{
...
*/
static KRML_MUSTINLINE void
libcrux_ml_dsa_simd_portable_ntt_outer_3_plus_d90(
  libcrux_ml_dsa_simd_portable_vector_type_Coefficients *re
)
{
...
*/
static KRML_MUSTINLINE void
libcrux_ml_dsa_simd_portable_ntt_outer_3_plus_3b(
  libcrux_ml_dsa_simd_portable_vector_type_Coefficients *re
)
{
...
*/
static KRML_MUSTINLINE void
libcrux_ml_dsa_simd_portable_ntt_outer_3_plus_993(
  libcrux_ml_dsa_simd_portable_vector_type_Coefficients *re
)
{
  ...
  {
    size_t j = i;
    libcrux_ml_dsa_simd_portable_vector_type_Coefficients tmp = re[j + (size_t)1U];
    libcrux_ml_dsa_simd_portable_arithmetic_montgomery_multiply_by_constant(&tmp,
      (int32_t)2725464);
    re[j + (size_t)1U] = re[j];
...
*/
static KRML_MUSTINLINE void
libcrux_ml_dsa_simd_portable_ntt_outer_3_plus_1c(
  libcrux_ml_dsa_simd_portable_vector_type_Coefficients *re
)
{
...
*/
static KRML_MUSTINLINE void
libcrux_ml_dsa_simd_portable_ntt_outer_3_plus_6b0(
  libcrux_ml_dsa_simd_portable_vector_type_Coefficients *re
)
{
...
*/
static KRML_MUSTINLINE void
libcrux_ml_dsa_simd_portable_ntt_outer_3_plus_44(
  libcrux_ml_dsa_simd_portable_vector_type_Coefficients *re
)
{
...
*/
static KRML_MUSTINLINE void
libcrux_ml_dsa_simd_portable_ntt_outer_3_plus_a81(
  libcrux_ml_dsa_simd_portable_vector_type_Coefficients *re
)
{
...
*/
static KRML_MUSTINLINE void
libcrux_ml_dsa_simd_portable_ntt_outer_3_plus_1f(
  libcrux_ml_dsa_simd_portable_vector_type_Coefficients *re
)
{
...
*/
static KRML_MUSTINLINE void
libcrux_ml_dsa_simd_portable_ntt_outer_3_plus_950(
  libcrux_ml_dsa_simd_portable_vector_type_Coefficients *re
)
{
...
*/
static KRML_MUSTINLINE void
libcrux_ml_dsa_simd_portable_ntt_outer_3_plus_3b0(
  libcrux_ml_dsa_simd_portable_vector_type_Coefficients *re
)
{
...
*/
static KRML_MUSTINLINE void
libcrux_ml_dsa_simd_portable_ntt_outer_3_plus_7a2(
  libcrux_ml_dsa_simd_portable_vector_type_Coefficients *re
)
{
...
*/
static KRML_MUSTINLINE void
libcrux_ml_dsa_simd_portable_ntt_outer_3_plus_e4(
  libcrux_ml_dsa_simd_portable_vector_type_Coefficients *re
)
{
...
*/
static KRML_MUSTINLINE void
libcrux_ml_dsa_simd_portable_ntt_outer_3_plus_de0(
  libcrux_ml_dsa_simd_portable_vector_type_Coefficients *re
)
{
...
*/
static KRML_MUSTINLINE void
libcrux_ml_dsa_simd_portable_ntt_outer_3_plus_05(
  libcrux_ml_dsa_simd_portable_vector_type_Coefficients *re
)
{
...
*/
static KRML_MUSTINLINE void
libcrux_ml_dsa_simd_portable_ntt_outer_3_plus_d91(
  libcrux_ml_dsa_simd_portable_vector_type_Coefficients *re
)
{
...
*/
static KRML_MUSTINLINE void
libcrux_ml_dsa_simd_portable_ntt_outer_3_plus_3a(
  libcrux_ml_dsa_simd_portable_vector_type_Coefficients *re
)
{
  for (size_t i = (size_t)26U; i < (size_t)26U + (size_t)1U; i++)
  {
    size_t j = i;
    libcrux_ml_dsa_simd_portable_vector_type_Coefficients tmp = re[j + (size_t)1U];
    libcrux_ml_dsa_simd_portable_arithmetic_montgomery_multiply_by_constant(&tmp, (int32_t)-19422);
    re[j + (size_t)1U] = re[j];
    libcrux_ml_dsa_simd_portable_arithmetic_subtract(&re[j + (size_t)1U], &tmp);
    libcrux_ml_dsa_simd_portable_arithmetic_add(&re[j], &tmp);
  }
...
*/
static KRML_MUSTINLINE void
libcrux_ml_dsa_simd_portable_ntt_outer_3_plus_3b1(
  libcrux_ml_dsa_simd_portable_vector_type_Coefficients *re
)
{
...
*/
static KRML_MUSTINLINE void
libcrux_ml_dsa_simd_portable_ntt_outer_3_plus_a0(
  libcrux_ml_dsa_simd_portable_vector_type_Coefficients *re
)
{
  for (size_t i = (size_t)30U; i < (size_t)30U + (size_t)1U; i++)
  {
    size_t j = i;
    libcrux_ml_dsa_simd_portable_vector_type_Coefficients tmp = re[j + (size_t)1U];
    libcrux_ml_dsa_simd_portable_arithmetic_montgomery_multiply_by_constant(&tmp, (int32_t)280005);
    re[j + (size_t)1U] = re[j];
    libcrux_ml_dsa_simd_portable_arithmetic_subtract(&re[j + (size_t)1U], &tmp);
    libcrux_ml_dsa_simd_portable_arithmetic_add(&re[j], &tmp);
  }
...
static KRML_MUSTINLINE void
libcrux_ml_dsa_simd_portable_ntt_ntt_at_layer_3(
  libcrux_ml_dsa_simd_portable_vector_type_Coefficients *re
)
{
...
)
{
  int32_t
  t =
    libcrux_ml_dsa_simd_portable_arithmetic_montgomery_multiply_fe_by_fer(simd_unit->values[index +
        step],
      zeta);
...
static KRML_MUSTINLINE void
libcrux_ml_dsa_simd_portable_ntt_ntt_at_layer_2(
  libcrux_ml_dsa_simd_portable_vector_type_Coefficients *re
)
{
...
{
  libcrux_ml_dsa_simd_portable_ntt_simd_unit_ntt_at_layer_1(&re[index], zeta_0, zeta_1);
}
...
{
  libcrux_ml_dsa_simd_portable_ntt_simd_unit_ntt_at_layer_0(&re[index],
    zeta_0,
    zeta_1,
    zeta_2,
    zeta_3);
...
static KRML_MUSTINLINE void
libcrux_ml_dsa_simd_portable_ntt_ntt_at_layer_0(
  libcrux_ml_dsa_simd_portable_vector_type_Coefficients *re
)
{
...
static KRML_MUSTINLINE void
libcrux_ml_dsa_simd_portable_ntt_ntt(libcrux_ml_dsa_simd_portable_vector_type_Coefficients *re)
{
...
*/
static inline void
libcrux_ml_dsa_simd_portable_ntt_e9(
  libcrux_ml_dsa_simd_portable_vector_type_Coefficients *simd_units
)
{
...
{
  int32_t a_minus_b = simd_unit->values[index + step] - simd_unit->values[index];
  simd_unit->values[index] = simd_unit->values[index] + simd_unit->values[index + step];
  simd_unit->values[index + step] =
...
{
  libcrux_ml_dsa_simd_portable_invntt_simd_unit_invert_ntt_at_layer_0(&re[index],
    zeta0,
    zeta1,
    zeta2,
    zeta3);
...
{
  libcrux_ml_dsa_simd_portable_invntt_simd_unit_invert_ntt_at_layer_1(&re[index],
    zeta_00,
    zeta_01);
}
...
{
  libcrux_ml_dsa_simd_portable_invntt_simd_unit_invert_ntt_at_layer_2(&re[index], zeta1);
}
...
*/
static KRML_MUSTINLINE void
libcrux_ml_dsa_simd_portable_invntt_outer_3_plus_99(
  libcrux_ml_dsa_simd_portable_vector_type_Coefficients *re
)
{
  for (size_t i = (size_t)0U; i < (size_t)0U + (size_t)1U; i++)
  {
    size_t j = i;
    libcrux_ml_dsa_simd_portable_vector_type_Coefficients rej = re[j];
    libcrux_ml_dsa_simd_portable_vector_type_Coefficients rejs = re[j + (size_t)1U];
    libcrux_ml_dsa_simd_portable_arithmetic_add(&re[j], &rejs);
    libcrux_ml_dsa_simd_portable_arithmetic_subtract(&re[j + (size_t)1U], &rej);
    libcrux_ml_dsa_simd_portable_arithmetic_montgomery_multiply_by_constant(&re[j + (size_t)1U],
      (int32_t)280005);
  }
}
...
*/
static KRML_MUSTINLINE void
libcrux_ml_dsa_simd_portable_invntt_outer_3_plus_1c(
  libcrux_ml_dsa_simd_portable_vector_type_Coefficients *re
)
{
  for (size_t i = (size_t)2U; i < (size_t)2U + (size_t)1U; i++)
...
*/
static KRML_MUSTINLINE void
libcrux_ml_dsa_simd_portable_invntt_outer_3_plus_6b(
  libcrux_ml_dsa_simd_portable_vector_type_Coefficients *re
)
{
  for (size_t i = (size_t)4U; i < (size_t)4U + (size_t)1U; i++)
...
*/
static KRML_MUSTINLINE void
libcrux_ml_dsa_simd_portable_invntt_outer_3_plus_44(
  libcrux_ml_dsa_simd_portable_vector_type_Coefficients *re
)
{
  for (size_t i = (size_t)6U; i < (size_t)6U + (size_t)1U; i++)
...
*/
static KRML_MUSTINLINE void
libcrux_ml_dsa_simd_portable_invntt_outer_3_plus_a8(
  libcrux_ml_dsa_simd_portable_vector_type_Coefficients *re
)
{
  for (size_t i = (size_t)8U; i < (size_t)8U + (size_t)1U; i++)
...
*/
static KRML_MUSTINLINE void
libcrux_ml_dsa_simd_portable_invntt_outer_3_plus_1f(
  libcrux_ml_dsa_simd_portable_vector_type_Coefficients *re
)
{
  for (size_t i = (size_t)10U; i < (size_t)10U + (size_t)1U; i++)
...
*/
static KRML_MUSTINLINE void
libcrux_ml_dsa_simd_portable_invntt_outer_3_plus_95(
  libcrux_ml_dsa_simd_portable_vector_type_Coefficients *re
)
{
  for (size_t i = (size_t)12U; i < (size_t)12U + (size_t)1U; i++)
...
*/
static KRML_MUSTINLINE void
libcrux_ml_dsa_simd_portable_invntt_outer_3_plus_3b(
  libcrux_ml_dsa_simd_portable_vector_type_Coefficients *re
)
{
  for (size_t i = (size_t)14U; i < (size_t)14U + (size_t)1U; i++)
...
*/
static KRML_MUSTINLINE void
libcrux_ml_dsa_simd_portable_invntt_outer_3_plus_7a(
  libcrux_ml_dsa_simd_portable_vector_type_Coefficients *re
)
{
  for (size_t i = (size_t)16U; i < (size_t)16U + (size_t)1U; i++)
...
*/
static KRML_MUSTINLINE void
libcrux_ml_dsa_simd_portable_invntt_outer_3_plus_e4(
  libcrux_ml_dsa_simd_portable_vector_type_Coefficients *re
)
{
  for (size_t i = (size_t)18U; i < (size_t)18U + (size_t)1U; i++)
...
*/
static KRML_MUSTINLINE void
libcrux_ml_dsa_simd_portable_invntt_outer_3_plus_de(
  libcrux_ml_dsa_simd_portable_vector_type_Coefficients *re
)
{
  for (size_t i = (size_t)20U; i < (size_t)20U + (size_t)1U; i++)
...
*/
static KRML_MUSTINLINE void
libcrux_ml_dsa_simd_portable_invntt_outer_3_plus_05(
  libcrux_ml_dsa_simd_portable_vector_type_Coefficients *re
)
{
  for (size_t i = (size_t)22U; i < (size_t)22U + (size_t)1U; i++)
...
*/
static KRML_MUSTINLINE void
libcrux_ml_dsa_simd_portable_invntt_outer_3_plus_d9(
  libcrux_ml_dsa_simd_portable_vector_type_Coefficients *re
)
{
  for (size_t i = (size_t)24U; i < (size_t)24U + (size_t)1U; i++)
...
*/
static KRML_MUSTINLINE void
libcrux_ml_dsa_simd_portable_invntt_outer_3_plus_3a(
  libcrux_ml_dsa_simd_portable_vector_type_Coefficients *re
)
{
  for (size_t i = (size_t)26U; i < (size_t)26U + (size_t)1U; i++)
...
*/
static KRML_MUSTINLINE void
libcrux_ml_dsa_simd_portable_invntt_outer_3_plus_a0(
  libcrux_ml_dsa_simd_portable_vector_type_Coefficients *re
)
{
  for (size_t i = (size_t)30U; i < (size_t)30U + (size_t)1U; i++)
...
)
{
  for (size_t i = (size_t)0U; i < (size_t)0U + (size_t)2U; i++)
  {
    size_t j = i;
    libcrux_ml_dsa_simd_portable_vector_type_Coefficients rej = re[j];
    libcrux_ml_dsa_simd_portable_vector_type_Coefficients rejs = re[j + (size_t)2U];
    libcrux_ml_dsa_simd_portable_arithmetic_add(&re[j], &rejs);
    libcrux_ml_dsa_simd_portable_arithmetic_subtract(&re[j + (size_t)2U], &rej);
    libcrux_ml_dsa_simd_portable_arithmetic_montgomery_multiply_by_constant(&re[j + (size_t)2U],
      (int32_t)2680103);
  }
}
...
)
{
  for (size_t i = (size_t)0U; i < (size_t)0U + (size_t)4U; i++)
  {
    size_t j = i;
    libcrux_ml_dsa_simd_portable_vector_type_Coefficients rej = re[j];
    libcrux_ml_dsa_simd_portable_vector_type_Coefficients rejs = re[j + (size_t)4U];
    libcrux_ml_dsa_simd_portable_arithmetic_add(&re[j], &rejs);
    libcrux_ml_dsa_simd_portable_arithmetic_subtract(&re[j + (size_t)4U], &rej);
    libcrux_ml_dsa_simd_portable_arithmetic_montgomery_multiply_by_constant(&re[j + (size_t)4U],
      (int32_t)466468);
  }
}
...
)
{
  for (size_t i = (size_t)0U; i < (size_t)0U + (size_t)8U; i++)
  {
    size_t j = i;
    libcrux_ml_dsa_simd_portable_vector_type_Coefficients rej = re[j];
    libcrux_ml_dsa_simd_portable_vector_type_Coefficients rejs = re[j + (size_t)8U];
    libcrux_ml_dsa_simd_portable_arithmetic_add(&re[j], &rejs);
    libcrux_ml_dsa_simd_portable_arithmetic_subtract(&re[j + (size_t)8U], &rej);
    libcrux_ml_dsa_simd_portable_arithmetic_montgomery_multiply_by_constant(&re[j + (size_t)8U],
      (int32_t)-518909);
  }
}
...
)
{
  for (size_t i = (size_t)0U; i < (size_t)0U + (size_t)16U; i++)
  {
    size_t j = i;
    libcrux_ml_dsa_simd_portable_vector_type_Coefficients rej = re[j];
    libcrux_ml_dsa_simd_portable_vector_type_Coefficients rejs = re[j + (size_t)16U];
    libcrux_ml_dsa_simd_portable_arithmetic_add(&re[j], &rejs);
    libcrux_ml_dsa_simd_portable_arithmetic_subtract(&re[j + (size_t)16U], &rej);
    libcrux_ml_dsa_simd_portable_arithmetic_montgomery_multiply_by_constant(&re[j + (size_t)16U],
      (int32_t)25847);
  }
}
...
static KRML_MUSTINLINE void
libcrux_ml_dsa_simd_portable_invntt_invert_ntt_montgomery(
  libcrux_ml_dsa_simd_portable_vector_type_Coefficients *re
)
{
  ...
  {
    size_t i0 = i;
    libcrux_ml_dsa_simd_portable_arithmetic_montgomery_multiply_by_constant(&re[i0],
      (int32_t)41978);
  }
}
...
*/
static inline void
libcrux_ml_dsa_simd_portable_invert_ntt_montgomery_e9(
  libcrux_ml_dsa_simd_portable_vector_type_Coefficients *simd_units
)
{
...
)
{
    ...
    i++)
  {
    size_t i0 = i;
    simd_unit->values[i0] =
      libcrux_ml_dsa_simd_portable_arithmetic_reduce_element(simd_unit->values[i0] <<
          (uint32_t)(int32_t)0);
  }
}
...
*/
static inline void
libcrux_ml_dsa_simd_portable_reduce_e9(
  libcrux_ml_dsa_simd_portable_vector_type_Coefficients *simd_units
)
{
  for
  ...
  {
    size_t i0 = i;
    libcrux_ml_dsa_simd_portable_arithmetic_shift_left_then_reduce_c3(&simd_units[i0]);
  }
}
...
libcrux_ml_dsa_polynomial_zero_bc_5b(void)
{
  ...
  memcpy(lit.simd_units,
    repeat_expression,
    (size_t)32U * sizeof (libcrux_ml_dsa_simd_portable_vector_type_Coefficients));
  return lit;
}
...
)
{
  ...
  for (size_t i = (size_t)0U; i < Eurydice_slice_len(randomness, uint8_t) / (size_t)4U; i++)
  {
    ...
    if (!done)
    {
      ...
      size_t
      sampled =
        libcrux_ml_dsa_simd_portable_rejection_sample_less_than_eta_equals_4_e9(uu____0,
...
)
{
  ...
  for (size_t i = (size_t)0U; i < Eurydice_slice_len(randomness, uint8_t) / (size_t)4U; i++)
  {
    ...
    if (!done)
    {
      ...
      size_t
      sampled =
        libcrux_ml_dsa_simd_portable_rejection_sample_less_than_eta_equals_2_e9(uu____0,
          Eurydice_array_to_subslice_from((size_t)263U,
            out,
            sampled_coefficients[0U],
            int32_t,
...
)
{
  ...
  {
    return
      libcrux_ml_dsa_sample_rejection_sample_less_than_eta_equals_4_5b(randomness,
        sampled,
        out);
  }
  return
    libcrux_ml_dsa_sample_rejection_sample_less_than_eta_equals_2_5b(randomness,
      sampled,
      out);
}
...
*/
static inline void
libcrux_ml_dsa_polynomial_from_i32_array_bc_5b(
  Eurydice_slice array,
...
)
{
  ...
  {
    size_t i0 = i;
    libcrux_ml_dsa_simd_portable_from_coefficient_array_e9(Eurydice_slice_subslice2(array,
...
)
{
  ...
  libcrux_ml_dsa_hash_functions_portable_Shake256X4
  state =
    libcrux_ml_dsa_hash_functions_portable_init_absorb_x4_50(Eurydice_array_to_slice((size_t)66U,
        seed0,
        uint8_t),
  ...
  uint8_t_136size_t__x4
  randomnesses0 = libcrux_ml_dsa_hash_functions_portable_squeeze_first_block_x4_50(&state);
  ...
  bool
  done0 =
    libcrux_ml_dsa_sample_rejection_sample_less_than_eta_5b(eta,
    ...
    if (done0)
    {
      if (done1)
      {
        if (done2)
        {
          ...
          {
            uint8_t_136size_t__x4
            randomnesses = libcrux_ml_dsa_hash_functions_portable_squeeze_next_block_x4_50(&state);
            if (!done0)
            {
              done0 =
                libcrux_ml_dsa_sample_rejection_sample_less_than_eta_5b(eta,
  ...
  size_t max;
  if (Eurydice_slice_len(re, libcrux_ml_dsa_polynomial_PolynomialRingElement_e8) < max0)
  {
    max = Eurydice_slice_len(re, libcrux_ml_dsa_polynomial_PolynomialRingElement_e8);
  }
  else
  {
    max = max0;
  ...
  {
    size_t i0 = i;
    libcrux_ml_dsa_polynomial_from_i32_array_bc_5b(Eurydice_array_to_slice((size_t)263U,
        out[i0 % (size_t)4U],
        int32_t),
...
{
  size_t len = Eurydice_slice_len(s1_s2, libcrux_ml_dsa_polynomial_PolynomialRingElement_e8);
...
)
{
  ...
  for (size_t i = (size_t)0U; i < Eurydice_slice_len(randomness, uint8_t) / (size_t)24U; i++)
  {
    ...
    if (!done)
    {
      ...
      size_t
      sampled =
        libcrux_ml_dsa_simd_portable_rejection_sample_less_than_field_modulus_e9(uu____0,
          Eurydice_array_to_subslice_from((size_t)263U,
            out,
            sampled_coefficients[0U],
            int32_t,
...
)
{
  ...
  libcrux_ml_dsa_hash_functions_portable_Shake128X4
  state =
    libcrux_ml_dsa_hash_functions_portable_init_absorb_ed(Eurydice_array_to_slice((size_t)34U,
        seed0,
        uint8_t),
  ...
  libcrux_ml_dsa_hash_functions_portable_squeeze_first_five_blocks_ed(&state,
    rand_stack0,
    rand_stack1,
    rand_stack2,
    rand_stack3);
  ...
  bool
  done0 =
    libcrux_ml_dsa_sample_rejection_sample_less_than_field_modulus_5b(Eurydice_array_to_slice((size_t)840U,
        rand_stack0,
        uint8_t),
      &sampled0,
    ...
    if (done0)
    {
      if (done1)
      {
        if (done2)
        {
          ...
          {
            uint8_t_168size_t__x4
            randomnesses = libcrux_ml_dsa_hash_functions_portable_squeeze_next_block_ed(&state);
            if (!done0)
            {
              done0 =
                libcrux_ml_dsa_sample_rejection_sample_less_than_field_modulus_5b(Eurydice_array_to_slice((size_t)168U,
                    randomnesses.fst,
                    uint8_t),
                  &sampled0,
                  Eurydice_slice_index(tmp_stack, (size_t)0U, int32_t [263U], int32_t (*)[263U]));
...
)
{
  ...
  (size_t
    i = (size_t)0U;
    i < Eurydice_slice_len(matrix, libcrux_ml_dsa_polynomial_PolynomialRingElement_e8) / (size_t)4U;
    i++)
  {
    ...
    size_t elements_requested;
    if (uu____0 <= Eurydice_slice_len(matrix, libcrux_ml_dsa_polynomial_PolynomialRingElement_e8))
    {
    ...
    {
      elements_requested =
        Eurydice_slice_len(matrix, libcrux_ml_dsa_polynomial_PolynomialRingElement_e8) -
          start_index0;
    }
...
*/
static KRML_MUSTINLINE void
libcrux_ml_dsa_ntt_ntt_5b(libcrux_ml_dsa_polynomial_PolynomialRingElement_e8 *re)
{
...
*/
static KRML_MUSTINLINE void
libcrux_ml_dsa_polynomial_add_bc_5b(
...
)
{
  ...
  {
    size_t i0 = i;
    libcrux_ml_dsa_simd_portable_add_e9(&self->simd_units[i0], &rhs->simd_units[i0]);
  }
}
...
*/
static KRML_MUSTINLINE void
libcrux_ml_dsa_ntt_reduce_5b(libcrux_ml_dsa_polynomial_PolynomialRingElement_e8 *re)
{
...
*/
static KRML_MUSTINLINE void
libcrux_ml_dsa_ntt_invert_ntt_montgomery_5b(
...
)
{
  for (size_t i0 = (size_t)0U; i0 < rows_in_a; i0++)
  {
    ...
    {
      size_t j = i;
      libcrux_ml_dsa_ntt_ntt_multiply_montgomery_5b(&Eurydice_slice_index(a_as_ntt,
          i1 * columns_in_a + j,
          libcrux_ml_dsa_polynomial_PolynomialRingElement_e8,
          libcrux_ml_dsa_polynomial_PolynomialRingElement_e8 *),
        &Eurydice_slice_index(s1_ntt,
          ...
          libcrux_ml_dsa_polynomial_PolynomialRingElement_e8,
          libcrux_ml_dsa_polynomial_PolynomialRingElement_e8 *));
      libcrux_ml_dsa_polynomial_add_bc_5b(&Eurydice_slice_index(result,
          i1,
          libcrux_ml_dsa_polynomial_PolynomialRingElement_e8,
          libcrux_ml_dsa_polynomial_PolynomialRingElement_e8 *),
  ...
  (size_t
    i = (size_t)0U;
    i < Eurydice_slice_len(result, libcrux_ml_dsa_polynomial_PolynomialRingElement_e8);
    i++)
  {
    size_t i0 = i;
    libcrux_ml_dsa_ntt_reduce_5b(&Eurydice_slice_index(result,
        i0,
        libcrux_ml_dsa_polynomial_PolynomialRingElement_e8,
        libcrux_ml_dsa_polynomial_PolynomialRingElement_e8 *));
    libcrux_ml_dsa_ntt_invert_ntt_montgomery_5b(&Eurydice_slice_index(result,
        i0,
        libcrux_ml_dsa_polynomial_PolynomialRingElement_e8,
        libcrux_ml_dsa_polynomial_PolynomialRingElement_e8 *));
    libcrux_ml_dsa_polynomial_add_bc_5b(&Eurydice_slice_index(result,
...
*/
static KRML_MUSTINLINE void
libcrux_ml_dsa_arithmetic_power2round_vector_5b(Eurydice_slice t, Eurydice_slice t1)
{
  for
  (size_t
    i0 = (size_t)0U;
    i0 < Eurydice_slice_len(t, libcrux_ml_dsa_polynomial_PolynomialRingElement_e8);
    i0++)
  {
    size_t i1 = i0;
    for
      ...
      i <
        Eurydice_slice_len(Eurydice_array_to_slice((size_t)32U,
            Eurydice_slice_index(t,
              i1,
              libcrux_ml_dsa_polynomial_PolynomialRingElement_e8,
              libcrux_ml_dsa_polynomial_PolynomialRingElement_e8 *).simd_units,
            libcrux_ml_dsa_simd_portable_vector_type_Coefficients),
          libcrux_ml_dsa_simd_portable_vector_type_Coefficients);
      i++)
    {
      size_t j = i;
      libcrux_ml_dsa_simd_portable_power2round_e9(&Eurydice_slice_index(t,
          i1,
          libcrux_ml_dsa_polynomial_PolynomialRingElement_e8,
          libcrux_ml_dsa_polynomial_PolynomialRingElement_e8 *).simd_units[j],
...
)
{
  ...
  {
    size_t i0 = i;
    libcrux_ml_dsa_simd_portable_vector_type_Coefficients *simd_unit = &re->simd_units[i0];
    libcrux_ml_dsa_simd_portable_t1_serialize_e9(simd_unit,
      Eurydice_slice_subslice2(serialized,
...
)
{
  ...
  (size_t
    i = (size_t)0U;
    i < Eurydice_slice_len(t1, libcrux_ml_dsa_polynomial_PolynomialRingElement_e8);
    i++)
  {
    size_t i0 = i;
    libcrux_ml_dsa_polynomial_PolynomialRingElement_e8
    *ring_element =
    ...
    libcrux_ml_dsa_encoding_t1_serialize_5b(ring_element,
...
*/
static KRML_MUSTINLINE void
libcrux_ml_dsa_hash_functions_portable_shake256_24(Eurydice_slice input, uint8_t *out)
{
...
*/
static KRML_MUSTINLINE void
libcrux_ml_dsa_hash_functions_portable_shake256_5c_24(Eurydice_slice input, uint8_t *out)
{
...
)
{
    ...
    i++)
  {
    size_t i0 = i;
    libcrux_ml_dsa_simd_portable_vector_type_Coefficients *simd_unit = &re->simd_units[i0];
    libcrux_ml_dsa_simd_portable_error_serialize_e9(eta,
      simd_unit,
      Eurydice_slice_subslice2(serialized,
...
)
{
    ...
    i++)
  {
    size_t i0 = i;
    libcrux_ml_dsa_simd_portable_vector_type_Coefficients *simd_unit = &re->simd_units[i0];
    libcrux_ml_dsa_simd_portable_t0_serialize_e9(simd_unit,
      Eurydice_slice_subslice2(serialized,
...
)
{
  ...
  libcrux_ml_dsa_hash_functions_portable_shake256_5c_24(verification_key, verification_key_hash);
  Eurydice_slice_copy(Eurydice_slice_subslice2(signing_key_serialized,
      offset,
  ...
  (size_t
    i = (size_t)0U;
    i < Eurydice_slice_len(s1_2, libcrux_ml_dsa_polynomial_PolynomialRingElement_e8);
    i++)
  {
    size_t i0 = i;
    libcrux_ml_dsa_encoding_error_serialize_5b(eta,
  ...
  (size_t
    i = (size_t)0U;
    i < Eurydice_slice_len(t0, libcrux_ml_dsa_polynomial_PolynomialRingElement_e8);
    i++)
  {
    size_t _cloop_j = i;
    libcrux_ml_dsa_polynomial_PolynomialRingElement_e8
    *ring_element =
      &Eurydice_slice_index(t0,
        ...
        libcrux_ml_dsa_polynomial_PolynomialRingElement_e8,
        libcrux_ml_dsa_polynomial_PolynomialRingElement_e8 *);
    libcrux_ml_dsa_encoding_t0_serialize_5b(ring_element,
      Eurydice_slice_subslice2(signing_key_serialized,
        offset,
...
)
{
  ...
  {
    s1_s2[i] = libcrux_ml_dsa_polynomial_zero_bc_5b();
  }
  libcrux_ml_dsa_samplex4_sample_s1_and_s2_29(LIBCRUX_ML_DSA_CONSTANTS_ML_DSA_65_ETA,
    seed_for_error_vectors,
    Eurydice_array_to_slice((size_t)11U, s1_s2, libcrux_ml_dsa_polynomial_PolynomialRingElement_e8));
  libcrux_ml_dsa_polynomial_PolynomialRingElement_e8 t0[6U];
  for (size_t i = (size_t)0U; i < (size_t)6U; i++)
  {
    t0[i] = libcrux_ml_dsa_polynomial_zero_bc_5b();
  }
  libcrux_ml_dsa_polynomial_PolynomialRingElement_e8 a_as_ntt[30U];
  for (size_t i = (size_t)0U; i < (size_t)30U; i++)
  {
    a_as_ntt[i] = libcrux_ml_dsa_polynomial_zero_bc_5b();
  }
  libcrux_ml_dsa_samplex4_portable_matrix_flat_36_5b(LIBCRUX_ML_DSA_CONSTANTS_ML_DSA_65_COLUMNS_IN_A,
    seed_for_a,
  ...
  {
    s1_ntt[i] = libcrux_ml_dsa_polynomial_zero_bc_5b();
  }
  Eurydice_slice
  uu____2 =
  ...
  libcrux_ml_dsa_matrix_compute_as1_plus_s2_5b(LIBCRUX_ML_DSA_CONSTANTS_ML_DSA_65_ROWS_IN_A,
    LIBCRUX_ML_DSA_CONSTANTS_ML_DSA_65_COLUMNS_IN_A,
    Eurydice_array_to_slice((size_t)30U,
      a_as_ntt,
      libcrux_ml_dsa_polynomial_PolynomialRingElement_e8),
    ...
    Eurydice_array_to_slice((size_t)11U, s1_s2, libcrux_ml_dsa_polynomial_PolynomialRingElement_e8),
    Eurydice_array_to_slice((size_t)6U, t0, libcrux_ml_dsa_polynomial_PolynomialRingElement_e8));
  libcrux_ml_dsa_polynomial_PolynomialRingElement_e8 t1[6U];
  for (size_t i = (size_t)0U; i < (size_t)6U; i++)
  {
    t1[i] = libcrux_ml_dsa_polynomial_zero_bc_5b();
  }
  libcrux_ml_dsa_arithmetic_power2round_vector_5b(Eurydice_array_to_slice((size_t)6U,
      t0,
      libcrux_ml_dsa_polynomial_PolynomialRingElement_e8),
    Eurydice_array_to_slice((size_t)6U, t1, libcrux_ml_dsa_polynomial_PolynomialRingElement_e8));
  libcrux_ml_dsa_encoding_verification_key_generate_serialized_5b(seed_for_a,
    Eurydice_array_to_slice((size_t)6U, t1, libcrux_ml_dsa_polynomial_PolynomialRingElement_e8),
    verification_key);
...
)
{
  ...
  libcrux_ml_dsa_ml_dsa_generic_ml_dsa_65_generate_key_pair_5a(copy_of_randomness,
...
libcrux_ml_dsa_ml_dsa_65_portable_generate_key_pair(uint8_t randomness[32U])
{
  ...
  libcrux_ml_dsa_ml_dsa_generic_instantiations_portable_ml_dsa_65_generate_key_pair(uu____0,
    signing_key,
    verification_key);
  /* Passing arrays by value in Rust generates a copy in C */
...
)
{
  ...
  uint8_t copy_of_randomness[32U];
  memcpy(copy_of_randomness, randomness, (size_t)32U * sizeof (uint8_t));
  libcrux_ml_dsa_ml_dsa_generic_instantiations_portable_ml_dsa_65_generate_key_pair(copy_of_randomness,
    signing_key,
    verification_key);
}
...
)
{
  ...
  {
    size_t i0 = i;
    libcrux_ml_dsa_simd_portable_error_deserialize_e9(eta,
    ...
    i++)
  {
    ...
    bytes =
      Eurydice_slice_subslice2(serialized,
        ...
        uint8_t);
    libcrux_ml_dsa_encoding_error_deserialize_5b(eta,
      bytes,
      &Eurydice_slice_index(ring_elements,
        i0,
        libcrux_ml_dsa_polynomial_PolynomialRingElement_e8,
        libcrux_ml_dsa_polynomial_PolynomialRingElement_e8 *));
    libcrux_ml_dsa_ntt_ntt_5b(&Eurydice_slice_index(ring_elements,
        i0,
        libcrux_ml_dsa_polynomial_PolynomialRingElement_e8,
        libcrux_ml_dsa_polynomial_PolynomialRingElement_e8 *));
  }
...
)
{
  ...
  {
    size_t i0 = i;
    libcrux_ml_dsa_simd_portable_t0_deserialize_e9(Eurydice_slice_subslice2(serialized,
        i0 * LIBCRUX_ML_DSA_ENCODING_T0_OUTPUT_BYTES_PER_SIMD_UNIT,
        (i0 + (size_t)1U) * LIBCRUX_ML_DSA_ENCODING_T0_OUTPUT_BYTES_PER_SIMD_UNIT,
        uint8_t),
      &result->simd_units[i0]);
    ...
    i++)
  {
    ...
    bytes =
      Eurydice_slice_subslice2(serialized,
        ...
        uint8_t);
    libcrux_ml_dsa_encoding_t0_deserialize_5b(bytes,
      &Eurydice_slice_index(ring_elements,
        i0,
        libcrux_ml_dsa_polynomial_PolynomialRingElement_e8,
        libcrux_ml_dsa_polynomial_PolynomialRingElement_e8 *));
...
)
{
  libcrux_sha3_generic_keccak_xof_KeccakXofState_e2
  shake = libcrux_ml_dsa_hash_functions_portable_init_83();
  libcrux_ml_dsa_hash_functions_portable_absorb_83(&shake, verification_key_hash);
  if (domain_separation_context->tag == Some)
  {
    ...
    *domain_separation_context0 = &domain_separation_context->f0;
    ...
    buf0[1U] =
      {
        (uint8_t)core_option__core__option__Option_T__TraitClause_0___is_some(libcrux_ml_dsa_pre_hash_pre_hash_oid_45(domain_separation_context0),
          uint8_t [11U],
          bool)
      };
    libcrux_ml_dsa_hash_functions_portable_absorb_83(uu____0,
      Eurydice_array_to_slice((size_t)1U, buf0, uint8_t));
    libcrux_sha3_generic_keccak_xof_KeccakXofState_e2 *uu____1 = &shake;
    uint8_t
    buf[1U] =
      {
        (uint8_t)Eurydice_slice_len(libcrux_ml_dsa_pre_hash_context_45(domain_separation_context0),
          uint8_t)
      };
    libcrux_ml_dsa_hash_functions_portable_absorb_83(uu____1,
      Eurydice_array_to_slice((size_t)1U, buf, uint8_t));
    libcrux_ml_dsa_hash_functions_portable_absorb_83(&shake,
      libcrux_ml_dsa_pre_hash_context_45(domain_separation_context0));
    Option_30 *uu____2 = libcrux_ml_dsa_pre_hash_pre_hash_oid_45(domain_separation_context0);
    if (uu____2->tag == Some)
    {
      uint8_t *pre_hash_oid = uu____2->f0;
      libcrux_ml_dsa_hash_functions_portable_absorb_83(&shake,
        Eurydice_array_to_slice((size_t)11U, pre_hash_oid, uint8_t));
    }
  }
...
/**
A monomorphic instance of core.option.Option
with types libcrux_ml_dsa_polynomial_PolynomialRingElement libcrux_ml_dsa_simd_portable_vector_type_Coefficients[5size_t]
...
*/
static KRML_MUSTINLINE void
libcrux_ml_dsa_hash_functions_portable_shake256_1b(Eurydice_slice input, uint8_t *out)
{
...
)
{
  ...
  {
    size_t i0 = i;
    libcrux_ml_dsa_simd_portable_gamma1_deserialize_e9(Eurydice_slice_subslice2(serialized,
...
*/
static KRML_MUSTINLINE void
libcrux_ml_dsa_hash_functions_portable_shake256_c8(Eurydice_slice input, uint8_t *out)
{
...
*/
static KRML_MUSTINLINE void
libcrux_ml_dsa_hash_functions_portable_shake256_5c_1b(Eurydice_slice input, uint8_t *out)
{
...
*/
static KRML_MUSTINLINE void
libcrux_ml_dsa_hash_functions_portable_shake256_5c_c8(Eurydice_slice input, uint8_t *out)
{
...
)
{
  switch ((uint8_t)gamma1_exponent)
  {
    case 17U:
      {
        uint8_t out[576U] = { 0U };
        libcrux_ml_dsa_hash_functions_portable_shake256_5c_1b(Eurydice_array_to_slice((size_t)66U,
            seed,
            uint8_t),
          out);
        libcrux_ml_dsa_encoding_gamma1_deserialize_5b(gamma1_exponent,
    ...
    case 19U:
      {
        uint8_t out[640U] = { 0U };
        libcrux_ml_dsa_hash_functions_portable_shake256_5c_c8(Eurydice_array_to_slice((size_t)66U,
            seed,
            uint8_t),
          out);
        libcrux_ml_dsa_encoding_gamma1_deserialize_5b(gamma1_exponent,
...
)
{
    ...
    case 17U:
      {
        ...
        libcrux_ml_dsa_hash_functions_portable_shake256_x4_50_1b(Eurydice_array_to_slice((size_t)66U,
            seed0,
            uint8_t),
          Eurydice_array_to_slice((size_t)66U, seed1, uint8_t),
          Eurydice_array_to_slice((size_t)66U, seed2, uint8_t),
    ...
    case 19U:
      {
        ...
        libcrux_ml_dsa_hash_functions_portable_shake256_x4_50_c8(Eurydice_array_to_slice((size_t)66U,
            seed0,
            uint8_t),
          Eurydice_array_to_slice((size_t)66U, seed1, uint8_t),
          Eurydice_array_to_slice((size_t)66U, seed2, uint8_t),
  ...
  for (size_t i = (size_t)4U; i < dimension; i++)
  {
    ...
    libcrux_ml_dsa_sample_sample_mask_ring_element_2e(seed4,
      &Eurydice_slice_index(mask,
        i0,
        libcrux_ml_dsa_polynomial_PolynomialRingElement_e8,
        libcrux_ml_dsa_polynomial_PolynomialRingElement_e8 *),
    ...
    for (size_t i = (size_t)0U; i < columns_in_a; i++)
    {
      ...
      product =
        Eurydice_slice_index(mask,
          ...
          libcrux_ml_dsa_polynomial_PolynomialRingElement_e8,
          libcrux_ml_dsa_polynomial_PolynomialRingElement_e8 *);
      libcrux_ml_dsa_ntt_ntt_multiply_montgomery_5b(&product,
        &Eurydice_slice_index(matrix,
          i1 * columns_in_a + j,
          libcrux_ml_dsa_polynomial_PolynomialRingElement_e8,
          libcrux_ml_dsa_polynomial_PolynomialRingElement_e8 *));
...
)
{
  for (size_t i0 = (size_t)0U; i0 < dimension; i0++)
  {
    ...
    {
      size_t j = i;
      libcrux_ml_dsa_simd_portable_decompose_e9(gamma2,
        &Eurydice_slice_index(t,
          i1,
          libcrux_ml_dsa_polynomial_PolynomialRingElement_e8,
          libcrux_ml_dsa_polynomial_PolynomialRingElement_e8 *).simd_units[j],
...
)
{
    ...
    i++)
  {
    size_t i0 = i;
    libcrux_ml_dsa_simd_portable_vector_type_Coefficients *simd_unit = &re->simd_units[i0];
    libcrux_ml_dsa_simd_portable_commitment_serialize_e9(simd_unit,
      Eurydice_slice_subslice2(serialized,
        i0 * output_bytes_per_simd_unit,
        (i0 + (size_t)1U) * output_bytes_per_simd_unit,
        uint8_t));
...
)
{
  ...
  (size_t
    i = (size_t)0U;
    i < Eurydice_slice_len(vector, libcrux_ml_dsa_polynomial_PolynomialRingElement_e8);
    i++)
  {
    size_t _cloop_j = i;
    libcrux_ml_dsa_polynomial_PolynomialRingElement_e8
    *ring_element =
      &Eurydice_slice_index(vector,
        ...
        libcrux_ml_dsa_polynomial_PolynomialRingElement_e8,
        libcrux_ml_dsa_polynomial_PolynomialRingElement_e8 *);
    libcrux_ml_dsa_encoding_commitment_serialize_5b(ring_element,
...
{
  libcrux_sha3_generic_keccak_KeccakState_17
  state = libcrux_ml_dsa_hash_functions_portable_init_absorb_final_5c(seed);
  uint8_t randomness0[136U];
  libcrux_ml_dsa_hash_functions_portable_squeeze_first_block_5c(&state, randomness0);
  uint8_t ret[8U];
  Result_15 dst;
  ...
  while (true)
  {
    ...
    else
    {
      ...
      libcrux_ml_dsa_hash_functions_portable_squeeze_next_block_5c(&state, randomness);
      done =
  ...
  libcrux_ml_dsa_polynomial_from_i32_array_bc_5b(Eurydice_array_to_slice((size_t)256U,
      result,
      int32_t),
    re);
}
...
)
{
  ...
  {
    size_t i0 = i;
    libcrux_ml_dsa_ntt_ntt_multiply_montgomery_5b(&Eurydice_slice_index(vector,
        i0,
        libcrux_ml_dsa_polynomial_PolynomialRingElement_e8,
        libcrux_ml_dsa_polynomial_PolynomialRingElement_e8 *),
      ring_element);
    libcrux_ml_dsa_ntt_invert_ntt_montgomery_5b(&Eurydice_slice_index(vector,
        i0,
        libcrux_ml_dsa_polynomial_PolynomialRingElement_e8,
        libcrux_ml_dsa_polynomial_PolynomialRingElement_e8 *));
  }
...
*/
static KRML_MUSTINLINE void
libcrux_ml_dsa_matrix_add_vectors_5b(size_t dimension, Eurydice_slice lhs, Eurydice_slice rhs)
{
  for (size_t i = (size_t)0U; i < dimension; i++)
  {
    size_t i0 = i;
    libcrux_ml_dsa_polynomial_add_bc_5b(&Eurydice_slice_index(lhs,
        i0,
        libcrux_ml_dsa_polynomial_PolynomialRingElement_e8,
        libcrux_ml_dsa_polynomial_PolynomialRingElement_e8 *),
...
*/
static KRML_MUSTINLINE void
libcrux_ml_dsa_polynomial_subtract_bc_5b(
  libcrux_ml_dsa_polynomial_PolynomialRingElement_e8 *self,
  libcrux_ml_dsa_polynomial_PolynomialRingElement_e8 *rhs
)
{
  ...
  {
    size_t i0 = i;
    libcrux_ml_dsa_simd_portable_subtract_e9(&self->simd_units[i0], &rhs->simd_units[i0]);
  }
}
...
)
{
  ...
  {
    size_t i0 = i;
    libcrux_ml_dsa_polynomial_subtract_bc_5b(&Eurydice_slice_index(lhs,
        i0,
        libcrux_ml_dsa_polynomial_PolynomialRingElement_e8,
        libcrux_ml_dsa_polynomial_PolynomialRingElement_e8 *),
      &Eurydice_slice_index(rhs,
...
*/
static KRML_MUSTINLINE bool
libcrux_ml_dsa_polynomial_infinity_norm_exceeds_bc_5b(
  libcrux_ml_dsa_polynomial_PolynomialRingElement_e8 *self,
  int32_t bound
)
{
...
*/
static KRML_MUSTINLINE bool
libcrux_ml_dsa_arithmetic_vector_infinity_norm_exceeds_5b(Eurydice_slice vector, int32_t bound)
{
  bool result = false;
  for
  (size_t
    ...
    i++)
  {
    ...
    {
      uu____0 =
        libcrux_ml_dsa_polynomial_infinity_norm_exceeds_bc_5b(&Eurydice_slice_index(vector,
            i0,
            libcrux_ml_dsa_polynomial_PolynomialRingElement_e8,
            libcrux_ml_dsa_polynomial_PolynomialRingElement_e8 *),
          bound);
...
*/
static inline void
libcrux_ml_dsa_polynomial_to_i32_array_bc_5b(
  libcrux_ml_dsa_polynomial_PolynomialRingElement_e8 *self,
  int32_t ret[256U]
)
{
  ...
  {
    size_t i0 = i;
    libcrux_ml_dsa_simd_portable_vector_type_Coefficients *uu____0 = &self->simd_units[i0];
    libcrux_ml_dsa_simd_portable_to_coefficient_array_e9(uu____0,
...
*/
static KRML_MUSTINLINE size_t
libcrux_ml_dsa_arithmetic_make_hint_5b(
  Eurydice_slice low,
  Eurydice_slice high,
  int32_t gamma2,
  Eurydice_slice hint
)
{
  ...
  libcrux_ml_dsa_polynomial_PolynomialRingElement_e8
  hint_simd = libcrux_ml_dsa_polynomial_zero_bc_5b();
  for
  (size_t
    i0 = (size_t)0U;
    i0 < Eurydice_slice_len(low, libcrux_ml_dsa_polynomial_PolynomialRingElement_e8);
    i0++)
  {
    size_t i1 = i0;
    for
      ...
      i++)
    {
      ...
      size_t
      one_hints_count =
        libcrux_ml_dsa_simd_portable_compute_hint_e9(&Eurydice_slice_index(low,
            i1,
            libcrux_ml_dsa_polynomial_PolynomialRingElement_e8,
            libcrux_ml_dsa_polynomial_PolynomialRingElement_e8 *).simd_units[j],
          &Eurydice_slice_index(high,
    ...
    libcrux_ml_dsa_polynomial_to_i32_array_bc_5b(&hint_simd, uu____0);
...
)
{
    ...
    i++)
  {
    size_t i0 = i;
    libcrux_ml_dsa_simd_portable_vector_type_Coefficients *simd_unit = &re->simd_units[i0];
    libcrux_ml_dsa_simd_portable_gamma1_serialize_e9(simd_unit,
      Eurydice_slice_subslice2(serialized,
        i0 * (gamma1_exponent + (size_t)1U),
        (i0 + (size_t)1U) * (gamma1_exponent + (size_t)1U),
        uint8_t),
...
)
{
  ...
  {
    size_t i0 = i;
    libcrux_ml_dsa_encoding_gamma1_serialize_5b(&Eurydice_slice_index(signer_response,
        i0,
        libcrux_ml_dsa_polynomial_PolynomialRingElement_e8,
        libcrux_ml_dsa_polynomial_PolynomialRingElement_e8 *),
...
)
{
  ...
  for (size_t i = (size_t)0U; i < (size_t)5U; i++)
  {
    s1_as_ntt[i] = libcrux_ml_dsa_polynomial_zero_bc_5b();
  }
  libcrux_ml_dsa_polynomial_PolynomialRingElement_e8 s2_as_ntt[6U];
  for (size_t i = (size_t)0U; i < (size_t)6U; i++)
  {
    s2_as_ntt[i] = libcrux_ml_dsa_polynomial_zero_bc_5b();
  }
  libcrux_ml_dsa_polynomial_PolynomialRingElement_e8 t0_as_ntt[6U];
  for (size_t i = (size_t)0U; i < (size_t)6U; i++)
  {
    t0_as_ntt[i] = libcrux_ml_dsa_polynomial_zero_bc_5b();
  }
  libcrux_ml_dsa_encoding_error_deserialize_to_vector_then_ntt_5b(LIBCRUX_ML_DSA_CONSTANTS_ML_DSA_65_ETA,
    LIBCRUX_ML_DSA_ML_DSA_GENERIC_ML_DSA_65_ERROR_RING_ELEMENT_SIZE,
    s1_serialized,
    Eurydice_array_to_slice((size_t)5U,
      s1_as_ntt,
  ...
  libcrux_ml_dsa_encoding_error_deserialize_to_vector_then_ntt_5b(LIBCRUX_ML_DSA_CONSTANTS_ML_DSA_65_ETA,
    ...
    Eurydice_array_to_slice((size_t)6U,
      s2_as_ntt,
      libcrux_ml_dsa_polynomial_PolynomialRingElement_e8));
  libcrux_ml_dsa_encoding_t0_deserialize_to_vector_then_ntt_5b(t0_serialized,
    Eurydice_array_to_slice((size_t)6U,
      t0_as_ntt,
      libcrux_ml_dsa_polynomial_PolynomialRingElement_e8));
  ...
  for (size_t i = (size_t)0U; i < (size_t)30U; i++)
  {
    matrix[i] = libcrux_ml_dsa_polynomial_zero_bc_5b();
  }
  libcrux_ml_dsa_samplex4_portable_matrix_flat_36_5b(LIBCRUX_ML_DSA_CONSTANTS_ML_DSA_65_COLUMNS_IN_A,
    seed_for_a,
    Eurydice_array_to_slice((size_t)30U,
  ...
  while (attempt < LIBCRUX_ML_DSA_CONSTANTS_REJECTION_SAMPLE_BOUND_SIGN)
  {
    ...
    for (size_t i = (size_t)0U; i < (size_t)5U; i++)
    {
      mask[i] = libcrux_ml_dsa_polynomial_zero_bc_5b();
    }
    libcrux_ml_dsa_polynomial_PolynomialRingElement_e8 w0[6U];
    for (size_t i = (size_t)0U; i < (size_t)6U; i++)
    {
      w0[i] = libcrux_ml_dsa_polynomial_zero_bc_5b();
    }
    libcrux_ml_dsa_polynomial_PolynomialRingElement_e8 commitment[6U];
    for (size_t i = (size_t)0U; i < (size_t)6U; i++)
    {
      commitment[i] = libcrux_ml_dsa_polynomial_zero_bc_5b();
    }
    libcrux_ml_dsa_sample_sample_mask_vector_67(LIBCRUX_ML_DSA_CONSTANTS_ML_DSA_65_COLUMNS_IN_A,
      ...
      Eurydice_array_to_slice((size_t)5U, mask, libcrux_ml_dsa_polynomial_PolynomialRingElement_e8));
    libcrux_ml_dsa_polynomial_PolynomialRingElement_e8 a_x_mask[6U];
    for (size_t i = (size_t)0U; i < (size_t)6U; i++)
    {
      a_x_mask[i] = libcrux_ml_dsa_polynomial_zero_bc_5b();
    }
    ...
    libcrux_ml_dsa_matrix_compute_matrix_x_mask_5b(LIBCRUX_ML_DSA_CONSTANTS_ML_DSA_65_ROWS_IN_A,
      LIBCRUX_ML_DSA_CONSTANTS_ML_DSA_65_COLUMNS_IN_A,
      Eurydice_array_to_slice((size_t)30U,
        matrix,
        libcrux_ml_dsa_polynomial_PolynomialRingElement_e8),
      ...
      Eurydice_array_to_slice((size_t)6U,
        a_x_mask,
        libcrux_ml_dsa_polynomial_PolynomialRingElement_e8));
    libcrux_ml_dsa_arithmetic_decompose_vector_5b(LIBCRUX_ML_DSA_CONSTANTS_ML_DSA_65_ROWS_IN_A,
      LIBCRUX_ML_DSA_CONSTANTS_ML_DSA_65_GAMMA2,
      Eurydice_array_to_slice((size_t)6U,
        a_x_mask,
        libcrux_ml_dsa_polynomial_PolynomialRingElement_e8),
      Eurydice_array_to_slice((size_t)6U, w0, libcrux_ml_dsa_polynomial_PolynomialRingElement_e8),
      Eurydice_array_to_slice((size_t)6U,
        commitment,
        libcrux_ml_dsa_polynomial_PolynomialRingElement_e8));
    uint8_t commitment_hash_candidate[48U] = { 0U };
    uint8_t commitment_serialized[768U] = { 0U };
    libcrux_ml_dsa_encoding_commitment_serialize_vector_5b(LIBCRUX_ML_DSA_ML_DSA_GENERIC_ML_DSA_65_COMMITMENT_RING_ELEMENT_SIZE,
      Eurydice_array_to_slice((size_t)6U,
        commitment,
        libcrux_ml_dsa_polynomial_PolynomialRingElement_e8),
    ...
    libcrux_ml_dsa_polynomial_PolynomialRingElement_e8
    verifier_challenge = libcrux_ml_dsa_polynomial_zero_bc_5b();
    libcrux_ml_dsa_sample_sample_challenge_ring_element_2e(Eurydice_array_to_slice((size_t)48U,
    ...
    core_array___core__clone__Clone_for__Array_T__N___20__clone((size_t)6U,
      ...
      libcrux_ml_dsa_polynomial_PolynomialRingElement_e8,
      void *);
    libcrux_ml_dsa_matrix_vector_times_ring_element_5b(Eurydice_array_to_slice((size_t)5U,
        challenge_times_s1,
        libcrux_ml_dsa_polynomial_PolynomialRingElement_e8),
      &verifier_challenge);
    libcrux_ml_dsa_matrix_vector_times_ring_element_5b(Eurydice_array_to_slice((size_t)6U,
        challenge_times_s2,
        libcrux_ml_dsa_polynomial_PolynomialRingElement_e8),
      &verifier_challenge);
    libcrux_ml_dsa_matrix_add_vectors_5b(LIBCRUX_ML_DSA_CONSTANTS_ML_DSA_65_COLUMNS_IN_A,
      Eurydice_array_to_slice((size_t)5U, mask, libcrux_ml_dsa_polynomial_PolynomialRingElement_e8),
      Eurydice_array_to_slice((size_t)5U,
        challenge_times_s1,
        libcrux_ml_dsa_polynomial_PolynomialRingElement_e8));
    libcrux_ml_dsa_matrix_subtract_vectors_5b(LIBCRUX_ML_DSA_CONSTANTS_ML_DSA_65_ROWS_IN_A,
      Eurydice_array_to_slice((size_t)6U, w0, libcrux_ml_dsa_polynomial_PolynomialRingElement_e8),
      Eurydice_array_to_slice((size_t)6U,
        challenge_times_s2,
        libcrux_ml_dsa_polynomial_PolynomialRingElement_e8));
    if
    (
      !libcrux_ml_dsa_arithmetic_vector_infinity_norm_exceeds_5b(Eurydice_array_to_slice((size_t)5U,
          mask,
          libcrux_ml_dsa_polynomial_PolynomialRingElement_e8),
    ...
    )
    {
      if
      (
        !libcrux_ml_dsa_arithmetic_vector_infinity_norm_exceeds_5b(Eurydice_array_to_slice((size_t)6U,
            w0,
            libcrux_ml_dsa_polynomial_PolynomialRingElement_e8),
          LIBCRUX_ML_DSA_CONSTANTS_ML_DSA_65_GAMMA2 - LIBCRUX_ML_DSA_ML_DSA_GENERIC_ML_DSA_65_BETA)
      )
      {
        libcrux_ml_dsa_polynomial_PolynomialRingElement_e8 challenge_times_t0[6U];
        core_array___core__clone__Clone_for__Array_T__N___20__clone((size_t)6U,
          t0_as_ntt,
          challenge_times_t0,
          libcrux_ml_dsa_polynomial_PolynomialRingElement_e8,
        ...
        {
          libcrux_ml_dsa_matrix_add_vectors_5b(LIBCRUX_ML_DSA_CONSTANTS_ML_DSA_65_ROWS_IN_A,
            Eurydice_array_to_slice((size_t)6U,
              w0,
              libcrux_ml_dsa_polynomial_PolynomialRingElement_e8),
            Eurydice_array_to_slice((size_t)6U,
          ...
          size_t
          ones_in_hint =
            libcrux_ml_dsa_arithmetic_make_hint_5b(Eurydice_array_to_slice((size_t)6U,
                w0,
                libcrux_ml_dsa_polynomial_PolynomialRingElement_e8),
              Eurydice_array_to_slice((size_t)6U,
                commitment,
          ...
          if (!(ones_in_hint > LIBCRUX_ML_DSA_CONSTANTS_ML_DSA_65_MAX_ONES_IN_HINT))
          {
            ...
            memcpy(copy_of_mask,
              mask,
              (size_t)5U * sizeof (libcrux_ml_dsa_polynomial_PolynomialRingElement_e8));
            Option_a5 lit1;
            lit1.tag = Some;
            memcpy(lit1.f0,
              copy_of_mask,
  ...
  else
  {
    ...
    else
    {
      ...
      if (!(hint0.tag == None))
      {
        ...
        libcrux_ml_dsa_encoding_signature_serialize_5b(Eurydice_array_to_slice((size_t)48U,
            commitment_hash,
            uint8_t),
          Eurydice_array_to_slice((size_t)5U,
            signer_response,
...
)
{
  ...
  memcpy(copy_of_randomness, randomness, (size_t)32U * sizeof (uint8_t));
  return
    libcrux_ml_dsa_ml_dsa_generic_ml_dsa_65_sign_internal_5a(uu____1,
      uu____2,
      uu____3,
      copy_of_randomness,
      signature);
...
)
{
  ...
  Result_53
  uu____4 =
    libcrux_ml_dsa_ml_dsa_generic_ml_dsa_65_sign_mut_5a(uu____0,
      uu____1,
      uu____2,
      copy_of_randomness,
      signature.value);
...
)
{
  ...
  memcpy(copy_of_randomness, randomness, (size_t)32U * sizeof (uint8_t));
  return
    libcrux_ml_dsa_ml_dsa_generic_ml_dsa_65_sign_5a(uu____0,
      uu____1,
      uu____2,
      copy_of_randomness);
}
...
)
{
  ...
  memcpy(copy_of_randomness, randomness, (size_t)32U * sizeof (uint8_t));
  return
    libcrux_ml_dsa_ml_dsa_generic_instantiations_portable_ml_dsa_65_sign(uu____0,
      uu____1,
      uu____2,
      copy_of_randomness);
}
...
)
{
  ...
  memcpy(copy_of_randomness, randomness, (size_t)32U * sizeof (uint8_t));
  return
    libcrux_ml_dsa_ml_dsa_generic_instantiations_portable_ml_dsa_65_sign_mut(uu____0,
      uu____1,
      uu____2,
      copy_of_randomness,
      signature);
...
*/
static KRML_MUSTINLINE void
libcrux_ml_dsa_pre_hash_hash_3e_cc(Eurydice_slice message, Eurydice_slice output)
{
...
)
{
  if (!(Eurydice_slice_len(context, uint8_t) > LIBCRUX_ML_DSA_CONSTANTS_CONTEXT_MAX_LEN))
  {
    ...
    memcpy(copy_of_randomness, randomness, (size_t)32U * sizeof (uint8_t));
    return
      libcrux_ml_dsa_ml_dsa_generic_ml_dsa_65_sign_internal_5a(uu____2,
        uu____3,
        uu____4,
        copy_of_randomness,
        signature);
...
)
{
  ...
  Result_53
  uu____5 =
    libcrux_ml_dsa_ml_dsa_generic_ml_dsa_65_sign_pre_hashed_mut_3f(uu____0,
      uu____1,
      uu____2,
      uu____3,
      copy_of_randomness,
...
)
{
  ...
  memcpy(copy_of_randomness, randomness, (size_t)32U * sizeof (uint8_t));
  return
    libcrux_ml_dsa_ml_dsa_generic_ml_dsa_65_sign_pre_hashed_3f(uu____0,
      uu____1,
      uu____2,
      uu____3,
      copy_of_randomness);
...
)
{
  ...
  {
    size_t i0 = i;
    libcrux_ml_dsa_simd_portable_t1_deserialize_e9(Eurydice_slice_subslice2(serialized,
...
)
{
  ...
  {
    size_t i0 = i;
    libcrux_ml_dsa_encoding_t1_deserialize_5b(Eurydice_slice_subslice2(serialized,
        i0 * LIBCRUX_ML_DSA_CONSTANTS_RING_ELEMENT_OF_T1S_SIZE,
...
)
{
  ...
  {
    size_t i0 = i;
    libcrux_ml_dsa_simd_portable_shift_left_then_reduce_e9_84(&re->simd_units[i0]);
  }
}
...
libcrux_ml_dsa_matrix_compute_w_approx_5b(
  ...
  Eurydice_slice matrix,
  Eurydice_slice signer_response,
  libcrux_ml_dsa_polynomial_PolynomialRingElement_e8 *verifier_challenge_as_ntt,
  Eurydice_slice t1
)
{
  for (size_t i0 = (size_t)0U; i0 < rows_in_a; i0++)
  {
    size_t i1 = i0;
    libcrux_ml_dsa_polynomial_PolynomialRingElement_e8
    inner_result = libcrux_ml_dsa_polynomial_zero_bc_5b();
    for (size_t i = (size_t)0U; i < columns_in_a; i++)
    {
      size_t j = i;
      libcrux_ml_dsa_polynomial_PolynomialRingElement_e8
      ...
      libcrux_ml_dsa_ntt_ntt_multiply_montgomery_5b(&product,
        &Eurydice_slice_index(signer_response,
          ...
          libcrux_ml_dsa_polynomial_PolynomialRingElement_e8,
          libcrux_ml_dsa_polynomial_PolynomialRingElement_e8 *));
      libcrux_ml_dsa_polynomial_add_bc_5b(&inner_result, &product);
    }
    libcrux_ml_dsa_arithmetic_shift_left_then_reduce_68(&Eurydice_slice_index(t1,
        i1,
        libcrux_ml_dsa_polynomial_PolynomialRingElement_e8,
        libcrux_ml_dsa_polynomial_PolynomialRingElement_e8 *));
    libcrux_ml_dsa_ntt_ntt_5b(&Eurydice_slice_index(t1,
        i1,
        libcrux_ml_dsa_polynomial_PolynomialRingElement_e8,
        libcrux_ml_dsa_polynomial_PolynomialRingElement_e8 *));
    libcrux_ml_dsa_ntt_ntt_multiply_montgomery_5b(&Eurydice_slice_index(t1,
        i1,
        libcrux_ml_dsa_polynomial_PolynomialRingElement_e8,
        libcrux_ml_dsa_polynomial_PolynomialRingElement_e8 *),
      verifier_challenge_as_ntt);
    libcrux_ml_dsa_polynomial_subtract_bc_5b(&inner_result,
      &Eurydice_slice_index(t1,
        i1,
        libcrux_ml_dsa_polynomial_PolynomialRingElement_e8,
        libcrux_ml_dsa_polynomial_PolynomialRingElement_e8 *));
    Eurydice_slice_index(t1,
      ...
      libcrux_ml_dsa_polynomial_PolynomialRingElement_e8 *)
    = inner_result;
    libcrux_ml_dsa_ntt_reduce_5b(&Eurydice_slice_index(t1,
        i1,
        libcrux_ml_dsa_polynomial_PolynomialRingElement_e8,
        libcrux_ml_dsa_polynomial_PolynomialRingElement_e8 *));
    libcrux_ml_dsa_ntt_invert_ntt_montgomery_5b(&Eurydice_slice_index(t1,
        i1,
        libcrux_ml_dsa_polynomial_PolynomialRingElement_e8,
        libcrux_ml_dsa_polynomial_PolynomialRingElement_e8 *));
  }
...
)
{
  ...
  (size_t
    i0 = (size_t)0U;
    i0 < Eurydice_slice_len(re_vector, libcrux_ml_dsa_polynomial_PolynomialRingElement_e8);
    i0++)
  {
    size_t i1 = i0;
    libcrux_ml_dsa_polynomial_PolynomialRingElement_e8
    tmp = libcrux_ml_dsa_polynomial_zero_bc_5b();
    libcrux_ml_dsa_polynomial_from_i32_array_bc_5b(Eurydice_array_to_slice((size_t)256U,
        Eurydice_slice_index(hint, i1, int32_t [256U], int32_t (*)[256U]),
        int32_t),
      &tmp);
    ...
    {
      size_t j = i;
      libcrux_ml_dsa_simd_portable_use_hint_e9(gamma2,
        &Eurydice_slice_index(re_vector,
          i1,
          libcrux_ml_dsa_polynomial_PolynomialRingElement_e8,
          libcrux_ml_dsa_polynomial_PolynomialRingElement_e8 *).simd_units[j],
...
)
{
  ...
  libcrux_ml_dsa_encoding_verification_key_deserialize_5b(LIBCRUX_ML_DSA_CONSTANTS_ML_DSA_65_ROWS_IN_A,
    LIBCRUX_ML_DSA_ML_DSA_GENERIC_ML_DSA_65_VERIFICATION_KEY_SIZE,
    t1_serialized,
    Eurydice_array_to_slice((size_t)6U, t1, libcrux_ml_dsa_polynomial_PolynomialRingElement_e8));
  uint8_t deserialized_commitment_hash[48U] = { 0U };
  libcrux_ml_dsa_polynomial_PolynomialRingElement_e8 deserialized_signer_response[5U];
  for (size_t i = (size_t)0U; i < (size_t)5U; i++)
  {
    deserialized_signer_response[i] = libcrux_ml_dsa_polynomial_zero_bc_5b();
  }
  int32_t deserialized_hint[6U][256U] = { { 0U } };
  Result_41
  uu____1 =
    libcrux_ml_dsa_encoding_signature_deserialize_5b(LIBCRUX_ML_DSA_CONSTANTS_ML_DSA_65_COLUMNS_IN_A,
      LIBCRUX_ML_DSA_CONSTANTS_ML_DSA_65_ROWS_IN_A,
      LIBCRUX_ML_DSA_CONSTANTS_ML_DSA_65_COMMITMENT_HASH_SIZE,
      LIBCRUX_ML_DSA_CONSTANTS_ML_DSA_65_GAMMA1_EXPONENT,
      LIBCRUX_ML_DSA_ML_DSA_GENERIC_ML_DSA_65_GAMMA1_RING_ELEMENT_SIZE,
    ...
    else
    {
      ...
      libcrux_ml_dsa_samplex4_portable_matrix_flat_36_5b(LIBCRUX_ML_DSA_CONSTANTS_ML_DSA_65_COLUMNS_IN_A,
        ...
        Eurydice_array_to_slice((size_t)30U,
          ...
          libcrux_ml_dsa_polynomial_PolynomialRingElement_e8));
      uint8_t verification_key_hash[64U] = { 0U };
      libcrux_ml_dsa_hash_functions_portable_shake256_5c_24(Eurydice_array_to_slice((size_t)1952U,
          verification_key,
          uint8_t),
      ...
      libcrux_ml_dsa_matrix_compute_w_approx_5b(LIBCRUX_ML_DSA_CONSTANTS_ML_DSA_65_ROWS_IN_A,
        LIBCRUX_ML_DSA_CONSTANTS_ML_DSA_65_COLUMNS_IN_A,
        Eurydice_array_to_slice((size_t)30U,
          matrix,
          libcrux_ml_dsa_polynomial_PolynomialRingElement_e8),
      ...
      libcrux_ml_dsa_arithmetic_use_hint_5b(LIBCRUX_ML_DSA_CONSTANTS_ML_DSA_65_GAMMA2,
        Eurydice_array_to_slice((size_t)6U, deserialized_hint, int32_t [256U]),
        Eurydice_array_to_slice((size_t)6U, t1, libcrux_ml_dsa_polynomial_PolynomialRingElement_e8));
      uint8_t commitment_serialized[768U] = { 0U };
      libcrux_ml_dsa_encoding_commitment_serialize_vector_5b(LIBCRUX_ML_DSA_ML_DSA_GENERIC_ML_DSA_65_COMMITMENT_RING_ELEMENT_SIZE,
...
{
  return
    libcrux_ml_dsa_ml_dsa_generic_instantiations_portable_ml_dsa_65_verify(libcrux_ml_dsa_types_as_ref_66_97(verification_key),
      message,
      context,
...
)
{
  uint8_t pre_hash_buffer[256U] = { 0U };
  return
    libcrux_ml_dsa_ml_dsa_generic_instantiations_portable_ml_dsa_65_verify_pre_hashed_shake128(libcrux_ml_dsa_types_as_ref_66_97(verification_key),
      message,
      context,
...
/**
This function found in impl {(core::convert::From<libcrux_ml_dsa::pre_hash::DomainSeparationError> for libcrux_ml_dsa::types::SigningError)#2}
*/
static inline libcrux_ml_dsa_types_SigningError
libcrux_ml_dsa_pre_hash_from_4b(libcrux_ml_dsa_pre_hash_DomainSeparationError e)
{
  return libcrux_ml_dsa_types_SigningError_ContextTooLongError;
}

/**
This function found in impl {(core::convert::From<libcrux_ml_dsa::pre_hash::DomainSeparationError> for libcrux_ml_dsa::types::VerificationError)#3}
*/
static inline libcrux_ml_dsa_types_VerificationError
libcrux_ml_dsa_pre_hash_from_b6(libcrux_ml_dsa_pre_hash_DomainSeparationError e)
{
