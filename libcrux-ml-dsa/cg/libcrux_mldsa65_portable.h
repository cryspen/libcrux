...
#define LIBCRUX_ML_DSA_ML_DSA_65_ROW_COLUMN \
  (LIBCRUX_ML_DSA_ML_DSA_65_ROWS_IN_A + LIBCRUX_ML_DSA_ML_DSA_65_COLUMNS_IN_A)
...
libcrux_ml_dsa_ml_dsa_generic_instantiations_portable_generate_key_pair_c9(
  ...
  KRML_HOST_EPRINTF(
      ...
      "Eurydice error: Failure(\"TODO: TraitTypes Self::Coefficient\")\n");
  KRML_HOST_EXIT(255U);
}
...
libcrux_ml_dsa_pre_hash_new_45(Eurydice_slice context, Option_30 pre_hash_oid) {
  if (!(Eurydice_slice_len(context, uint8_t) >
    ...
    return (CLITERAL(libcrux_ml_dsa_pre_hash_PreHashResult){
...
static KRML_MUSTINLINE void libcrux_ml_dsa_simd_portable_arithmetic_add(
  ...
  for (size_t i = (size_t)0U;
       i < Eurydice_slice_len(Eurydice_array_to_slice((size_t)8U, lhs, int32_t),
                              int32_t);
       i++) {
    size_t i0 = i;
    size_t uu____0 = i0;
    lhs[uu____0] = lhs[uu____0] + rhs[i0];
  }
}
...
libcrux_ml_dsa_simd_portable_arithmetic_infinity_norm_exceeds(
    int32_t *simd_unit, int32_t bound) {
  KRML_HOST_EPRINTF(
      "KaRaMeL abort at %s:%d\n%s\n", __FILE__, __LINE__,
      "Eurydice error: Failure(\"TODO: TraitTypes "
      "core::ops::bit::{core::ops::bit::Shr<i32> for i32}#1175::Output\")\n");
  KRML_HOST_EXIT(255U);
}
...
static KRML_MUSTINLINE void
libcrux_ml_dsa_simd_portable_arithmetic_montgomery_multiply(int32_t *lhs,
                                                            int32_t *rhs) {
  for (size_t i = (size_t)0U;
       i < Eurydice_slice_len(Eurydice_array_to_slice((size_t)8U, lhs, int32_t),
                              int32_t);
       i++) {
    size_t i0 = i;
    lhs[i0] = libcrux_ml_dsa_simd_portable_arithmetic_montgomery_reduce_element(
        (int64_t)lhs[i0] * (int64_t)rhs[i0]);
  }
}

static KRML_MUSTINLINE void
libcrux_ml_dsa_simd_portable_arithmetic_montgomery_multiply_by_constant(
    int32_t *simd_unit, int32_t c) {
  for (size_t i = (size_t)0U;
       i <
       Eurydice_slice_len(
           Eurydice_array_to_slice((size_t)8U, simd_unit, int32_t), int32_t);
       i++) {
    size_t i0 = i;
    simd_unit[i0] =
        libcrux_ml_dsa_simd_portable_arithmetic_montgomery_reduce_element(
            (int64_t)simd_unit[i0] * (int64_t)c);
  }
}
...
static KRML_MUSTINLINE void libcrux_ml_dsa_simd_portable_arithmetic_power2round(
  ...
  for (size_t i = (size_t)0U;
       i < Eurydice_slice_len(Eurydice_array_to_slice((size_t)8U, t0, int32_t),
                              int32_t);
       i++) {
    size_t i0 = i;
    int32_t_x2 uu____0 =
        libcrux_ml_dsa_simd_portable_arithmetic_power2round_element(t0[i0]);
...
libcrux_ml_dsa_simd_portable_encoding_commitment_serialize(
    int32_t *simd_unit, Eurydice_slice serialized) {
  switch ((uint8_t)Eurydice_slice_len(serialized, uint8_t)) {
    case 4U: {
      for (size_t i = (size_t)0U;
           i < Eurydice_slice_len(
                   Eurydice_array_to_slice((size_t)8U, simd_unit, int32_t),
                   int32_t) /
                   (size_t)2U;
           i++) {
        size_t i0 = i;
        Eurydice_slice coefficients = Eurydice_array_to_subslice2(
            simd_unit, i0 * (size_t)2U, i0 * (size_t)2U + (size_t)2U, int32_t);
    ...
    case 6U: {
      for (size_t i = (size_t)0U;
        ...
        size_t i0 = i;
        Eurydice_slice coefficients = Eurydice_array_to_subslice2(
            simd_unit, i0 * (size_t)4U, i0 * (size_t)4U + (size_t)4U, int32_t);
        uint8_t coefficient0 = (uint8_t)Eurydice_slice_index(
            coefficients, (size_t)0U, int32_t, int32_t *);
        uint8_t coefficient1 = (uint8_t)Eurydice_slice_index(
            coefficients, (size_t)1U, int32_t, int32_t *);
...
libcrux_ml_dsa_simd_portable_encoding_error_deserialize_when_eta_is_2(
    Eurydice_slice serialized, int32_t *simd_unit) {
  int32_t byte0 =
...
libcrux_ml_dsa_simd_portable_encoding_error_deserialize_when_eta_is_4(
    Eurydice_slice serialized, int32_t *simd_units) {
  for (size_t i = (size_t)0U; i < Eurydice_slice_len(serialized, uint8_t);
    ...
    simd_units[(size_t)2U * i0 + (size_t)1U] =
        LIBCRUX_ML_DSA_SIMD_PORTABLE_ENCODING_ERROR_DESERIALIZE_WHEN_ETA_IS_4_ETA -
        (int32_t)uu____1;
  }
}
...
libcrux_ml_dsa_simd_portable_encoding_gamma1_deserialize_when_gamma1_is_2_pow_17(
  ...
  for (size_t i = (size_t)0U;
    ...
    coefficient3 =
        coefficient3 &
        LIBCRUX_ML_DSA_SIMD_PORTABLE_ENCODING_GAMMA1_DESERIALIZE_WHEN_GAMMA1_IS_2_POW_17_GAMMA1_TIMES_2_BITMASK;
    simd_unit[(size_t)4U * i0] =
        LIBCRUX_ML_DSA_SIMD_PORTABLE_ENCODING_GAMMA1_DESERIALIZE_WHEN_GAMMA1_IS_2_POW_17_GAMMA1 -
        coefficient0;
    simd_unit[(size_t)4U * i0 + (size_t)1U] =
        LIBCRUX_ML_DSA_SIMD_PORTABLE_ENCODING_GAMMA1_DESERIALIZE_WHEN_GAMMA1_IS_2_POW_17_GAMMA1 -
        coefficient1;
    simd_unit[(size_t)4U * i0 + (size_t)2U] =
        LIBCRUX_ML_DSA_SIMD_PORTABLE_ENCODING_GAMMA1_DESERIALIZE_WHEN_GAMMA1_IS_2_POW_17_GAMMA1 -
        coefficient2;
    simd_unit[(size_t)4U * i0 + (size_t)3U] =
        LIBCRUX_ML_DSA_SIMD_PORTABLE_ENCODING_GAMMA1_DESERIALIZE_WHEN_GAMMA1_IS_2_POW_17_GAMMA1 -
        coefficient3;
  }
}
...
libcrux_ml_dsa_simd_portable_encoding_gamma1_deserialize_when_gamma1_is_2_pow_19(
  ...
  for (size_t i = (size_t)0U;
    ...
    coefficient1 =
        ...
        (int32_t)Eurydice_slice_index(bytes, (size_t)4U, uint8_t, uint8_t *)
            << 12U;
    simd_unit[(size_t)2U * i0] =
        LIBCRUX_ML_DSA_SIMD_PORTABLE_ENCODING_GAMMA1_DESERIALIZE_WHEN_GAMMA1_IS_2_POW_19_GAMMA1 -
        coefficient0;
    simd_unit[(size_t)2U * i0 + (size_t)1U] =
        LIBCRUX_ML_DSA_SIMD_PORTABLE_ENCODING_GAMMA1_DESERIALIZE_WHEN_GAMMA1_IS_2_POW_19_GAMMA1 -
        coefficient1;
  }
}
...
static KRML_MUSTINLINE void
libcrux_ml_dsa_simd_portable_encoding_t0_deserialize(Eurydice_slice serialized,
                                                     int32_t *simd_unit) {
  int32_t byte0 =
      (int32_t)Eurydice_slice_index(serialized, (size_t)0U, uint8_t, uint8_t *);
  int32_t byte1 =
...
static KRML_MUSTINLINE void
libcrux_ml_dsa_simd_portable_encoding_t1_deserialize(Eurydice_slice serialized,
                                                     int32_t *simd_unit) {
  ...
  for (size_t i = (size_t)0U;
    ...
    int32_t byte4 =
        (int32_t)Eurydice_slice_index(bytes, (size_t)4U, uint8_t, uint8_t *);
    simd_unit[(size_t)4U * i0] = (byte0 | byte1 << 8U) & mask;
    simd_unit[(size_t)4U * i0 + (size_t)1U] =
...
libcrux_ml_dsa_simd_portable_invntt_simd_unit_invert_ntt_at_layer_0(
    int32_t *simd_unit, int32_t zeta0, int32_t zeta1, int32_t zeta2,
    int32_t zeta3) {
  int32_t a_minus_b = simd_unit[1U] - simd_unit[0U];
  simd_unit[0U] = simd_unit[0U] + simd_unit[1U];
  simd_unit[1U] =
      libcrux_ml_dsa_simd_portable_arithmetic_montgomery_multiply_fe_by_fer(
          a_minus_b, zeta0);
  int32_t a_minus_b0 = simd_unit[3U] - simd_unit[2U];
  simd_unit[2U] = simd_unit[2U] + simd_unit[3U];
  simd_unit[3U] =
      libcrux_ml_dsa_simd_portable_arithmetic_montgomery_multiply_fe_by_fer(
          a_minus_b0, zeta1);
  int32_t a_minus_b1 = simd_unit[5U] - simd_unit[4U];
  simd_unit[4U] = simd_unit[4U] + simd_unit[5U];
  simd_unit[5U] =
      libcrux_ml_dsa_simd_portable_arithmetic_montgomery_multiply_fe_by_fer(
          a_minus_b1, zeta2);
  int32_t a_minus_b2 = simd_unit[7U] - simd_unit[6U];
  simd_unit[6U] = simd_unit[6U] + simd_unit[7U];
  simd_unit[7U] =
      libcrux_ml_dsa_simd_portable_arithmetic_montgomery_multiply_fe_by_fer(
          a_minus_b2, zeta3);
}
...
libcrux_ml_dsa_simd_portable_invntt_invert_ntt_at_layer_0_round(
    int32_t (*re)[8U], size_t index, int32_t zeta0, int32_t zeta1,
...
static KRML_MUSTINLINE void
libcrux_ml_dsa_simd_portable_invntt_invert_ntt_at_layer_0(int32_t (*re)[8U]) {
  libcrux_ml_dsa_simd_portable_invntt_invert_ntt_at_layer_0_round(
...
libcrux_ml_dsa_simd_portable_invntt_simd_unit_invert_ntt_at_layer_1(
    int32_t *simd_unit, int32_t zeta0, int32_t zeta1) {
  int32_t a_minus_b = simd_unit[2U] - simd_unit[0U];
  simd_unit[0U] = simd_unit[0U] + simd_unit[2U];
  simd_unit[2U] =
      libcrux_ml_dsa_simd_portable_arithmetic_montgomery_multiply_fe_by_fer(
          a_minus_b, zeta0);
  int32_t a_minus_b0 = simd_unit[3U] - simd_unit[1U];
  simd_unit[1U] = simd_unit[1U] + simd_unit[3U];
  simd_unit[3U] =
      libcrux_ml_dsa_simd_portable_arithmetic_montgomery_multiply_fe_by_fer(
          a_minus_b0, zeta0);
  int32_t a_minus_b1 = simd_unit[6U] - simd_unit[4U];
  simd_unit[4U] = simd_unit[4U] + simd_unit[6U];
  simd_unit[6U] =
      libcrux_ml_dsa_simd_portable_arithmetic_montgomery_multiply_fe_by_fer(
          a_minus_b1, zeta1);
  int32_t a_minus_b2 = simd_unit[7U] - simd_unit[5U];
  simd_unit[5U] = simd_unit[5U] + simd_unit[7U];
  simd_unit[7U] =
      libcrux_ml_dsa_simd_portable_arithmetic_montgomery_multiply_fe_by_fer(
          a_minus_b2, zeta1);
}
...
libcrux_ml_dsa_simd_portable_invntt_invert_ntt_at_layer_1_round(
    int32_t (*re)[8U], size_t index, int32_t zeta_00, int32_t zeta_01) {
  libcrux_ml_dsa_simd_portable_invntt_simd_unit_invert_ntt_at_layer_1(
      re[index], zeta_00, zeta_01);
}

static KRML_MUSTINLINE void
libcrux_ml_dsa_simd_portable_invntt_invert_ntt_at_layer_1(int32_t (*re)[8U]) {
  libcrux_ml_dsa_simd_portable_invntt_invert_ntt_at_layer_1_round(
...
libcrux_ml_dsa_simd_portable_invntt_simd_unit_invert_ntt_at_layer_2(
    int32_t *simd_unit, int32_t zeta) {
  int32_t a_minus_b = simd_unit[4U] - simd_unit[0U];
  simd_unit[0U] = simd_unit[0U] + simd_unit[4U];
  simd_unit[4U] =
      libcrux_ml_dsa_simd_portable_arithmetic_montgomery_multiply_fe_by_fer(
          a_minus_b, zeta);
  int32_t a_minus_b0 = simd_unit[5U] - simd_unit[1U];
  simd_unit[1U] = simd_unit[1U] + simd_unit[5U];
  simd_unit[5U] =
      libcrux_ml_dsa_simd_portable_arithmetic_montgomery_multiply_fe_by_fer(
          a_minus_b0, zeta);
  int32_t a_minus_b1 = simd_unit[6U] - simd_unit[2U];
  simd_unit[2U] = simd_unit[2U] + simd_unit[6U];
  simd_unit[6U] =
      libcrux_ml_dsa_simd_portable_arithmetic_montgomery_multiply_fe_by_fer(
          a_minus_b1, zeta);
  int32_t a_minus_b2 = simd_unit[7U] - simd_unit[3U];
  simd_unit[3U] = simd_unit[3U] + simd_unit[7U];
  simd_unit[7U] =
      libcrux_ml_dsa_simd_portable_arithmetic_montgomery_multiply_fe_by_fer(
          a_minus_b2, zeta);
}
...
libcrux_ml_dsa_simd_portable_invntt_invert_ntt_at_layer_2_round(
    int32_t (*re)[8U], size_t index, int32_t zeta1) {
  libcrux_ml_dsa_simd_portable_invntt_simd_unit_invert_ntt_at_layer_2(re[index],
                                                                      zeta1);
}

static KRML_MUSTINLINE void
libcrux_ml_dsa_simd_portable_invntt_invert_ntt_at_layer_2(int32_t (*re)[8U]) {
  libcrux_ml_dsa_simd_portable_invntt_invert_ntt_at_layer_2_round(
...
static KRML_MUSTINLINE void libcrux_ml_dsa_simd_portable_invntt_outer_3_plus_99(
  ...
  for (size_t i = (size_t)0U; i < (size_t)0U + (size_t)1U; i++) {
    ...
    core_array___core__clone__Clone_for__Array_T__N___20__clone(
        (size_t)8U, re[j + (size_t)1U], rejs, int32_t, void *);
    int32_t a_minus_b[8U];
    core_array___core__clone__Clone_for__Array_T__N___20__clone(
        (size_t)8U, rejs, a_minus_b, int32_t, void *);
    libcrux_ml_dsa_simd_portable_arithmetic_subtract(a_minus_b, re[j]);
    libcrux_ml_dsa_simd_portable_arithmetic_add(re[j], rejs);
    int32_t uu____0[8U];
    memcpy(uu____0, a_minus_b, (size_t)8U * sizeof(int32_t));
    memcpy(re[j + (size_t)1U], uu____0, (size_t)8U * sizeof(int32_t));
    libcrux_ml_dsa_simd_portable_arithmetic_montgomery_multiply_by_constant(
...
*/
static KRML_MUSTINLINE void
libcrux_ml_dsa_simd_portable_invntt_outer_3_plus_3b0(int32_t (*re)[8U]) {
...
static KRML_MUSTINLINE void
libcrux_ml_dsa_simd_portable_invntt_invert_ntt_at_layer_3(int32_t (*re)[8U]) {
...
*/
static KRML_MUSTINLINE void
libcrux_ml_dsa_simd_portable_invntt_outer_3_plus_990(int32_t (*re)[8U]) {
  for (size_t i = (size_t)0U; i < (size_t)0U + (size_t)2U; i++) {
    size_t j = i;
    int32_t rejs[8U];
    core_array___core__clone__Clone_for__Array_T__N___20__clone(
        (size_t)8U, re[j + (size_t)2U], rejs, int32_t, void *);
    int32_t a_minus_b[8U];
    core_array___core__clone__Clone_for__Array_T__N___20__clone(
        (size_t)8U, rejs, a_minus_b, int32_t, void *);
    libcrux_ml_dsa_simd_portable_arithmetic_subtract(a_minus_b, re[j]);
    ...
    int32_t uu____0[8U];
    memcpy(uu____0, a_minus_b, (size_t)8U * sizeof(int32_t));
    memcpy(re[j + (size_t)2U], uu____0, (size_t)8U * sizeof(int32_t));
    libcrux_ml_dsa_simd_portable_arithmetic_montgomery_multiply_by_constant(
...
*/
static KRML_MUSTINLINE void
libcrux_ml_dsa_simd_portable_invntt_outer_3_plus_6b0(int32_t (*re)[8U]) {
...
*/
static KRML_MUSTINLINE void
libcrux_ml_dsa_simd_portable_invntt_outer_3_plus_a80(int32_t (*re)[8U]) {
...
*/
static KRML_MUSTINLINE void
libcrux_ml_dsa_simd_portable_invntt_outer_3_plus_950(int32_t (*re)[8U]) {
...
*/
static KRML_MUSTINLINE void
libcrux_ml_dsa_simd_portable_invntt_outer_3_plus_7a0(int32_t (*re)[8U]) {
...
*/
static KRML_MUSTINLINE void
libcrux_ml_dsa_simd_portable_invntt_outer_3_plus_de0(int32_t (*re)[8U]) {
...
*/
static KRML_MUSTINLINE void
libcrux_ml_dsa_simd_portable_invntt_outer_3_plus_d90(int32_t (*re)[8U]) {
...
*/
static KRML_MUSTINLINE void
libcrux_ml_dsa_simd_portable_invntt_outer_3_plus_3b1(int32_t (*re)[8U]) {
...
static KRML_MUSTINLINE void
libcrux_ml_dsa_simd_portable_invntt_invert_ntt_at_layer_4(int32_t (*re)[8U]) {
...
*/
static KRML_MUSTINLINE void
libcrux_ml_dsa_simd_portable_invntt_outer_3_plus_991(int32_t (*re)[8U]) {
  for (size_t i = (size_t)0U; i < (size_t)0U + (size_t)4U; i++) {
    size_t j = i;
    int32_t rejs[8U];
    core_array___core__clone__Clone_for__Array_T__N___20__clone(
        (size_t)8U, re[j + (size_t)4U], rejs, int32_t, void *);
    int32_t a_minus_b[8U];
    core_array___core__clone__Clone_for__Array_T__N___20__clone(
        (size_t)8U, rejs, a_minus_b, int32_t, void *);
    libcrux_ml_dsa_simd_portable_arithmetic_subtract(a_minus_b, re[j]);
    ...
    int32_t uu____0[8U];
    memcpy(uu____0, a_minus_b, (size_t)8U * sizeof(int32_t));
    memcpy(re[j + (size_t)4U], uu____0, (size_t)8U * sizeof(int32_t));
    libcrux_ml_dsa_simd_portable_arithmetic_montgomery_multiply_by_constant(
...
*/
static KRML_MUSTINLINE void
libcrux_ml_dsa_simd_portable_invntt_outer_3_plus_a81(int32_t (*re)[8U]) {
...
*/
static KRML_MUSTINLINE void
libcrux_ml_dsa_simd_portable_invntt_outer_3_plus_7a1(int32_t (*re)[8U]) {
...
*/
static KRML_MUSTINLINE void
libcrux_ml_dsa_simd_portable_invntt_outer_3_plus_d91(int32_t (*re)[8U]) {
...
static KRML_MUSTINLINE void
libcrux_ml_dsa_simd_portable_invntt_invert_ntt_at_layer_5(int32_t (*re)[8U]) {
...
*/
static KRML_MUSTINLINE void
libcrux_ml_dsa_simd_portable_invntt_outer_3_plus_992(int32_t (*re)[8U]) {
  for (size_t i = (size_t)0U; i < (size_t)0U + (size_t)8U; i++) {
    size_t j = i;
    int32_t rejs[8U];
    core_array___core__clone__Clone_for__Array_T__N___20__clone(
        (size_t)8U, re[j + (size_t)8U], rejs, int32_t, void *);
    int32_t a_minus_b[8U];
    core_array___core__clone__Clone_for__Array_T__N___20__clone(
        (size_t)8U, rejs, a_minus_b, int32_t, void *);
    libcrux_ml_dsa_simd_portable_arithmetic_subtract(a_minus_b, re[j]);
    ...
    int32_t uu____0[8U];
    memcpy(uu____0, a_minus_b, (size_t)8U * sizeof(int32_t));
    memcpy(re[j + (size_t)8U], uu____0, (size_t)8U * sizeof(int32_t));
    libcrux_ml_dsa_simd_portable_arithmetic_montgomery_multiply_by_constant(
...
*/
static KRML_MUSTINLINE void
libcrux_ml_dsa_simd_portable_invntt_outer_3_plus_7a2(int32_t (*re)[8U]) {
...
static KRML_MUSTINLINE void
libcrux_ml_dsa_simd_portable_invntt_invert_ntt_at_layer_6(int32_t (*re)[8U]) {
...
*/
static KRML_MUSTINLINE void
libcrux_ml_dsa_simd_portable_invntt_outer_3_plus_993(int32_t (*re)[8U]) {
  for (size_t i = (size_t)0U; i < (size_t)0U + (size_t)16U; i++) {
    size_t j = i;
    int32_t rejs[8U];
    core_array___core__clone__Clone_for__Array_T__N___20__clone(
        (size_t)8U, re[j + (size_t)16U], rejs, int32_t, void *);
    int32_t a_minus_b[8U];
    core_array___core__clone__Clone_for__Array_T__N___20__clone(
        (size_t)8U, rejs, a_minus_b, int32_t, void *);
    libcrux_ml_dsa_simd_portable_arithmetic_subtract(a_minus_b, re[j]);
    ...
    int32_t uu____0[8U];
    memcpy(uu____0, a_minus_b, (size_t)8U * sizeof(int32_t));
    memcpy(re[j + (size_t)16U], uu____0, (size_t)8U * sizeof(int32_t));
    libcrux_ml_dsa_simd_portable_arithmetic_montgomery_multiply_by_constant(
...
static KRML_MUSTINLINE void
libcrux_ml_dsa_simd_portable_invntt_invert_ntt_at_layer_7(int32_t (*re)[8U]) {
...
static inline void libcrux_ml_dsa_simd_portable_invntt_invert_ntt_montgomery(
  ...
  for (size_t i = (size_t)0U;
       i <
       Eurydice_slice_len(Eurydice_array_to_slice((size_t)32U, re, int32_t[8U]),
                          int32_t[8U]);
       i++) {
    size_t i0 = i;
    libcrux_ml_dsa_simd_portable_arithmetic_montgomery_multiply_by_constant(
...
static KRML_MUSTINLINE void libcrux_ml_dsa_simd_portable_ntt_outer_3_plus_99(
  ...
  for (size_t i = (size_t)0U; i < (size_t)0U + (size_t)16U; i++) {
    size_t j = i;
    int32_t tmp[8U];
    memcpy(tmp, re[j + (size_t)16U], (size_t)8U * sizeof(int32_t));
    libcrux_ml_dsa_simd_portable_arithmetic_montgomery_multiply_by_constant(
        tmp, (int32_t)25847);
    int32_t uu____0[8U];
    memcpy(uu____0, re[j], (size_t)8U * sizeof(int32_t));
    memcpy(re[j + (size_t)16U], uu____0, (size_t)8U * sizeof(int32_t));
...
static KRML_MUSTINLINE void libcrux_ml_dsa_simd_portable_ntt_outer_3_plus_990(
  ...
  for (size_t i = (size_t)0U; i < (size_t)0U + (size_t)8U; i++) {
    size_t j = i;
    int32_t tmp[8U];
    memcpy(tmp, re[j + (size_t)8U], (size_t)8U * sizeof(int32_t));
    libcrux_ml_dsa_simd_portable_arithmetic_montgomery_multiply_by_constant(
        tmp, (int32_t)-2608894);
    int32_t uu____0[8U];
    memcpy(uu____0, re[j], (size_t)8U * sizeof(int32_t));
...
static KRML_MUSTINLINE void libcrux_ml_dsa_simd_portable_ntt_outer_3_plus_991(
  ...
  for (size_t i = (size_t)0U; i < (size_t)0U + (size_t)4U; i++) {
    size_t j = i;
    int32_t tmp[8U];
    memcpy(tmp, re[j + (size_t)4U], (size_t)8U * sizeof(int32_t));
    libcrux_ml_dsa_simd_portable_arithmetic_montgomery_multiply_by_constant(
        tmp, (int32_t)237124);
    int32_t uu____0[8U];
    memcpy(uu____0, re[j], (size_t)8U * sizeof(int32_t));
...
static KRML_MUSTINLINE void libcrux_ml_dsa_simd_portable_ntt_outer_3_plus_992(
  ...
  for (size_t i = (size_t)0U; i < (size_t)0U + (size_t)2U; i++) {
    size_t j = i;
    int32_t tmp[8U];
    memcpy(tmp, re[j + (size_t)2U], (size_t)8U * sizeof(int32_t));
    libcrux_ml_dsa_simd_portable_arithmetic_montgomery_multiply_by_constant(
        tmp, (int32_t)1826347);
    int32_t uu____0[8U];
    memcpy(uu____0, re[j], (size_t)8U * sizeof(int32_t));
...
static KRML_MUSTINLINE void libcrux_ml_dsa_simd_portable_ntt_outer_3_plus_993(
  ...
  for (size_t i = (size_t)0U; i < (size_t)0U + (size_t)1U; i++) {
    size_t j = i;
    int32_t tmp[8U];
    memcpy(tmp, re[j + (size_t)1U], (size_t)8U * sizeof(int32_t));
    libcrux_ml_dsa_simd_portable_arithmetic_montgomery_multiply_by_constant(
        tmp, (int32_t)2725464);
    int32_t uu____0[8U];
    memcpy(uu____0, re[j], (size_t)8U * sizeof(int32_t));
...
static KRML_MUSTINLINE void
libcrux_ml_dsa_simd_portable_ntt_simd_unit_ntt_at_layer_2(int32_t *simd_unit,
                                                          int32_t zeta) {
  int32_t t =
      libcrux_ml_dsa_simd_portable_arithmetic_montgomery_multiply_fe_by_fer(
          simd_unit[4U], zeta);
  simd_unit[4U] = simd_unit[0U] - t;
  simd_unit[0U] = simd_unit[0U] + t;
  int32_t t0 =
      libcrux_ml_dsa_simd_portable_arithmetic_montgomery_multiply_fe_by_fer(
          simd_unit[5U], zeta);
  simd_unit[5U] = simd_unit[1U] - t0;
  simd_unit[1U] = simd_unit[1U] + t0;
  int32_t t1 =
      libcrux_ml_dsa_simd_portable_arithmetic_montgomery_multiply_fe_by_fer(
          simd_unit[6U], zeta);
  simd_unit[6U] = simd_unit[2U] - t1;
  simd_unit[2U] = simd_unit[2U] + t1;
  int32_t t2 =
      libcrux_ml_dsa_simd_portable_arithmetic_montgomery_multiply_fe_by_fer(
          simd_unit[7U], zeta);
  simd_unit[7U] = simd_unit[3U] - t2;
  simd_unit[3U] = simd_unit[3U] + t2;
}

static KRML_MUSTINLINE void
libcrux_ml_dsa_simd_portable_ntt_ntt_at_layer_2_round(int32_t (*re)[8U],
                                                      size_t index,
                                                      int32_t zeta) {
...
static KRML_MUSTINLINE void
libcrux_ml_dsa_simd_portable_ntt_simd_unit_ntt_at_layer_1(int32_t *simd_unit,
                                                          int32_t zeta1,
                                                          int32_t zeta2) {
  int32_t t =
      libcrux_ml_dsa_simd_portable_arithmetic_montgomery_multiply_fe_by_fer(
          simd_unit[2U], zeta1);
  simd_unit[2U] = simd_unit[0U] - t;
  simd_unit[0U] = simd_unit[0U] + t;
  int32_t t0 =
      libcrux_ml_dsa_simd_portable_arithmetic_montgomery_multiply_fe_by_fer(
          simd_unit[3U], zeta1);
  simd_unit[3U] = simd_unit[1U] - t0;
  simd_unit[1U] = simd_unit[1U] + t0;
  int32_t t1 =
      libcrux_ml_dsa_simd_portable_arithmetic_montgomery_multiply_fe_by_fer(
          simd_unit[6U], zeta2);
  simd_unit[6U] = simd_unit[4U] - t1;
  simd_unit[4U] = simd_unit[4U] + t1;
  int32_t t2 =
      libcrux_ml_dsa_simd_portable_arithmetic_montgomery_multiply_fe_by_fer(
          simd_unit[7U], zeta2);
  simd_unit[7U] = simd_unit[5U] - t2;
  simd_unit[5U] = simd_unit[5U] + t2;
}

static KRML_MUSTINLINE void
libcrux_ml_dsa_simd_portable_ntt_ntt_at_layer_1_round(int32_t (*re)[8U],
                                                      size_t index,
                                                      int32_t zeta_0,
                                                      int32_t zeta_1) {
...
static KRML_MUSTINLINE void
libcrux_ml_dsa_simd_portable_ntt_simd_unit_ntt_at_layer_0(int32_t *simd_unit,
                                                          int32_t zeta0,
                                                          int32_t zeta1,
                                                          int32_t zeta2,
                                                          int32_t zeta3) {
  int32_t t =
      libcrux_ml_dsa_simd_portable_arithmetic_montgomery_multiply_fe_by_fer(
          simd_unit[1U], zeta0);
  simd_unit[1U] = simd_unit[0U] - t;
  simd_unit[0U] = simd_unit[0U] + t;
  int32_t t0 =
      libcrux_ml_dsa_simd_portable_arithmetic_montgomery_multiply_fe_by_fer(
          simd_unit[3U], zeta1);
  simd_unit[3U] = simd_unit[2U] - t0;
  simd_unit[2U] = simd_unit[2U] + t0;
  int32_t t1 =
      libcrux_ml_dsa_simd_portable_arithmetic_montgomery_multiply_fe_by_fer(
          simd_unit[5U], zeta2);
  simd_unit[5U] = simd_unit[4U] - t1;
  simd_unit[4U] = simd_unit[4U] + t1;
  int32_t t2 =
      libcrux_ml_dsa_simd_portable_arithmetic_montgomery_multiply_fe_by_fer(
          simd_unit[7U], zeta3);
  simd_unit[7U] = simd_unit[6U] - t2;
  simd_unit[6U] = simd_unit[6U] + t2;
}

static KRML_MUSTINLINE void
libcrux_ml_dsa_simd_portable_ntt_ntt_at_layer_0_round(
    int32_t (*re)[8U], size_t index, int32_t zeta_0, int32_t zeta_1,
...
libcrux_ml_dsa_simd_portable_vector_type_from_coefficient_array(
    Eurydice_slice array, int32_t ret[8U]) {
  Result_6c dst;
...
libcrux_ml_dsa_simd_portable_vector_type_to_coefficient_array(
    int32_t *value, Eurydice_slice out) {
  Eurydice_slice_copy(out, Eurydice_array_to_slice((size_t)8U, value, int32_t),
                      int32_t);
}
...
*/
static inline void libcrux_ml_dsa_simd_portable_vector_type_clone_ae(
    void **self) {}
...
libcrux_ml_dsa::simd::portable::vector_type::PortableSIMDUnit)}
*/
static inline void libcrux_ml_dsa_simd_portable_add_36(int32_t *lhs,
                                                       int32_t *rhs) {
...
libcrux_ml_dsa::simd::portable::vector_type::PortableSIMDUnit)}
*/
static inline void libcrux_ml_dsa_simd_portable_from_coefficient_array_36(
    Eurydice_slice array, int32_t ret[8U]) {
  libcrux_ml_dsa_simd_portable_vector_type_from_coefficient_array(array, ret);
}
...
libcrux_ml_dsa::simd::portable::vector_type::PortableSIMDUnit)}
*/
static inline void libcrux_ml_dsa_simd_portable_power2round_36(int32_t *t0,
                                                               int32_t *t1) {
...
static KRML_MUSTINLINE Result_2e libcrux_ml_dsa_ml_dsa_generic_sign_internal_3f(
  ...
  memcpy(
      ...
      (size_t)6U * sizeof(libcrux_ml_dsa_polynomial_PolynomialRingElement_9b));
  libcrux_ml_dsa_polynomial_PolynomialRingElement_9b matrix[6U][5U];
  for (size_t i = (size_t)0U; i < (size_t)6U; i++) {
    matrix[i][0U] = libcrux_ml_dsa_polynomial_ZERO_ff_ba();
    matrix[i][1U] = libcrux_ml_dsa_polynomial_ZERO_ff_ba();
    matrix[i][2U] = libcrux_ml_dsa_polynomial_ZERO_ff_ba();
    matrix[i][3U] = libcrux_ml_dsa_polynomial_ZERO_ff_ba();
    matrix[i][4U] = libcrux_ml_dsa_polynomial_ZERO_ff_ba();
  }
  libcrux_ml_dsa_samplex4_portable_matrix_36_2f(
      Eurydice_array_to_slice((size_t)32U, seed_for_a, uint8_t), matrix);
...
libcrux_ml_dsa::simd::portable::vector_type::PortableSIMDUnit)}
*/
static inline void libcrux_ml_dsa_simd_portable_t0_deserialize_36(
    Eurydice_slice serialized, int32_t *out) {
...
libcrux_ml_dsa_ml_dsa_generic_verify_internal_51(
  ...
  if (uu____1.tag == Ok) {
    ...
    if (libcrux_ml_dsa_arithmetic_vector_infinity_norm_exceeds_4f(
      ...
      libcrux_ml_dsa_polynomial_PolynomialRingElement_9b(*uu____6)[5U] = matrix;
...
static inline void libcrux_ml_dsa_simd_portable_t0_serialize_36(
    int32_t *simd_unit, Eurydice_slice out) {
...
libcrux_ml_dsa::simd::portable::vector_type::PortableSIMDUnit)}
*/
static inline void libcrux_ml_dsa_simd_portable_t1_deserialize_36(
    Eurydice_slice serialized, int32_t *out) {
...
libcrux_ml_dsa::simd::portable::vector_type::PortableSIMDUnit)}
*/
static inline void libcrux_ml_dsa_simd_portable_zero_36(int32_t ret[8U]) {
  libcrux_ml_dsa_simd_portable_vector_type_zero(ret);
}
...
typedef int32_t libcrux_ml_dsa_simd_portable_vector_type_Coefficients[8U];
