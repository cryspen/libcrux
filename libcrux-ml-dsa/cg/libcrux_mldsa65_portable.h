...
static KRML_MUSTINLINE void libcrux_ml_dsa_encoding_signature_set_hint(
    Eurydice_dst_ref_59 out_hint, size_t i, size_t j) {
  Eurydice_slice_index(out_hint, i, Eurydice_arr_c3).data[j] = (int32_t)1;
}
...
libcrux_ml_dsa_hash_functions_portable_init_absorb(Eurydice_dst_ref_87 input0,
                                                   Eurydice_dst_ref_87 input1,
                                                   Eurydice_dst_ref_87 input2,
                                                   Eurydice_dst_ref_87 input3) {
...
static KRML_MUSTINLINE void libcrux_ml_dsa_hash_functions_portable_shake128(
    Eurydice_dst_ref_87 input, Eurydice_dst_ref_87 out) {
...
libcrux_ml_dsa_hash_functions_portable_squeeze_first_block_shake256(
  ...
  libcrux_sha3_portable_incremental_shake256_squeeze_first_block(
      state, Eurydice_array_to_slice_d4(&out));
  return out;
}
...
libcrux_ml_dsa_hash_functions_portable_squeeze_first_block_x4(
  ...
  libcrux_sha3_portable_incremental_shake256_squeeze_first_block(
      &state->state0, Eurydice_array_to_slice_d4(&out0));
  Eurydice_arr_3d out1 = {{0U}};
  libcrux_sha3_portable_incremental_shake256_squeeze_first_block(
      &state->state1, Eurydice_array_to_slice_d4(&out1));
  Eurydice_arr_3d out2 = {{0U}};
  libcrux_sha3_portable_incremental_shake256_squeeze_first_block(
      &state->state2, Eurydice_array_to_slice_d4(&out2));
  Eurydice_arr_3d out3 = {{0U}};
  libcrux_sha3_portable_incremental_shake256_squeeze_first_block(
      &state->state3, Eurydice_array_to_slice_d4(&out3));
...
libcrux_ml_dsa_hash_functions_portable_squeeze_first_five_blocks(
  ...
  libcrux_sha3_portable_incremental_shake128_squeeze_first_five_blocks(
      &state->state0, Eurydice_array_to_slice_a8(out0));
  libcrux_sha3_portable_incremental_shake128_squeeze_first_five_blocks(
      &state->state1, Eurydice_array_to_slice_a8(out1));
  libcrux_sha3_portable_incremental_shake128_squeeze_first_five_blocks(
      &state->state2, Eurydice_array_to_slice_a8(out2));
  libcrux_sha3_portable_incremental_shake128_squeeze_first_five_blocks(
      &state->state3, Eurydice_array_to_slice_a8(out3));
}
...
libcrux_ml_dsa_hash_functions_portable_squeeze_next_block(
  ...
  libcrux_sha3_portable_incremental_shake128_squeeze_next_block(
      &state->state0, Eurydice_array_to_slice_7b(&out0));
  Eurydice_arr_27 out1 = {{0U}};
  libcrux_sha3_portable_incremental_shake128_squeeze_next_block(
      &state->state1, Eurydice_array_to_slice_7b(&out1));
  Eurydice_arr_27 out2 = {{0U}};
  libcrux_sha3_portable_incremental_shake128_squeeze_next_block(
      &state->state2, Eurydice_array_to_slice_7b(&out2));
  Eurydice_arr_27 out3 = {{0U}};
  libcrux_sha3_portable_incremental_shake128_squeeze_next_block(
      &state->state3, Eurydice_array_to_slice_7b(&out3));
...
libcrux_ml_dsa_sample_add_domain_separator(Eurydice_dst_ref_87 slice,
                                           uint8_t_x2 indices) {
...
static inline Result_a8 libcrux_ml_dsa_pre_hash_new_88(
    Eurydice_dst_ref_87 context, Option_3b pre_hash_oid) {
...
{libcrux_ml_dsa::pre_hash::DomainSeparationContext<'a>}
*/
static inline Option_3b *libcrux_ml_dsa_pre_hash_pre_hash_oid_88(
...
{libcrux_ml_dsa::pre_hash::DomainSeparationContext<'a>}
*/
static inline Eurydice_dst_ref_87 libcrux_ml_dsa_pre_hash_context_88(
    libcrux_ml_dsa_pre_hash_DomainSeparationContext *self) {
  return self->context;
}
...
static KRML_MUSTINLINE bool libcrux_ml_dsa_sample_inside_out_shuffle(
    Eurydice_dst_ref_87 randomness, size_t *out_index, uint64_t *signs,
    Eurydice_arr_c3 *result) {
  bool done = false;
  for (size_t i = (size_t)0U; i < Eurydice_slice_len(randomness, uint8_t);
       i++) {
    size_t _cloop_j = i;
    uint8_t *byte = &Eurydice_slice_index(randomness, _cloop_j, uint8_t);
    if (!done) {
      ...
      size_t uu____0 = out_index[0U];
             ...
             Eurydice_slice_len(Eurydice_array_to_slice_20(result), int32_t);
    }
  }
  return done;
}
...
libcrux_ml_dsa_simd_portable_vector_type_from_coefficient_array(
    Eurydice_dst_ref_fc array, Eurydice_arr_d4 *out) {
  Eurydice_slice_copy(
      Eurydice_array_to_slice_a7(out),
      Eurydice_slice_subslice_46(
...
libcrux_ml_dsa_simd_portable_vector_type_to_coefficient_array(
    Eurydice_arr_d4 *value, Eurydice_dst_ref_fc out) {
  Eurydice_slice_copy(out, Eurydice_array_to_slice_a7(value), int32_t);
}
...
static KRML_MUSTINLINE void libcrux_ml_dsa_simd_portable_arithmetic_add(
    Eurydice_arr_d4 *lhs, Eurydice_arr_d4 *rhs) {
  for (size_t i = (size_t)0U;
       i < Eurydice_slice_len(Eurydice_array_to_slice_a7(lhs), int32_t); i++) {
    size_t i0 = i;
    size_t uu____0 = i0;
...
libcrux_ml_dsa::simd::portable::vector_type::Coefficients}
*/
static inline void libcrux_ml_dsa_simd_portable_add_65(Eurydice_arr_d4 *lhs,
                                                       Eurydice_arr_d4 *rhs) {
...
libcrux_ml_dsa_simd_portable_arithmetic_infinity_norm_exceeds(
    Eurydice_arr_d4 *simd_unit, int32_t bound) {
  bool result = false;
  for (size_t i = (size_t)0U;
       i < Eurydice_slice_len(Eurydice_array_to_slice_a7(simd_unit), int32_t);
       i++) {
    size_t i0 = i;
...
static KRML_MUSTINLINE void libcrux_ml_dsa_simd_portable_arithmetic_decompose(
    int32_t gamma2, Eurydice_arr_d4 *simd_unit, Eurydice_arr_d4 *low,
    Eurydice_arr_d4 *high) {
  for (size_t i = (size_t)0U;
       i < Eurydice_slice_len(Eurydice_array_to_slice_a7(low), int32_t); i++) {
    size_t i0 = i;
    int32_t_x2 uu____0 =
...
static KRML_MUSTINLINE size_t
libcrux_ml_dsa_simd_portable_arithmetic_compute_hint(Eurydice_arr_d4 *low,
                                                     Eurydice_arr_d4 *high,
                                                     int32_t gamma2,
                                                     Eurydice_arr_d4 *hint) {
  size_t one_hints_count = (size_t)0U;
  for (size_t i = (size_t)0U;
       i < Eurydice_slice_len(Eurydice_array_to_slice_a7(hint), int32_t); i++) {
    size_t i0 = i;
...
static inline size_t libcrux_ml_dsa_simd_portable_compute_hint_65(
    Eurydice_arr_d4 *low, Eurydice_arr_d4 *high, int32_t gamma2,
    Eurydice_arr_d4 *hint) {
...
static KRML_MUSTINLINE void libcrux_ml_dsa_simd_portable_arithmetic_use_hint(
    int32_t gamma2, Eurydice_arr_d4 *simd_unit, Eurydice_arr_d4 *hint) {
  for (size_t i = (size_t)0U;
       i < Eurydice_slice_len(Eurydice_array_to_slice_a7(hint), int32_t); i++) {
    size_t i0 = i;
...
static KRML_MUSTINLINE void libcrux_ml_dsa_simd_portable_arithmetic_power2round(
  ...
  for (size_t i = (size_t)0U;
       i < Eurydice_slice_len(Eurydice_array_to_slice_a7(t0), int32_t); i++) {
    size_t i0 = i;
    int32_t_x2 uu____0 =
...
libcrux_ml_dsa_simd_portable_sample_rejection_sample_less_than_field_modulus(
    Eurydice_dst_ref_87 randomness, Eurydice_dst_ref_fc out) {
  size_t sampled = (size_t)0U;
  for (size_t i = (size_t)0U;
       i < Eurydice_slice_len(randomness, uint8_t) / (size_t)3U; i++) {
    size_t i0 = i;
    int32_t b0 =
        (int32_t)Eurydice_slice_index(randomness, i0 * (size_t)3U, uint8_t);
    ...
    if (coefficient < LIBCRUX_ML_DSA_CONSTANTS_FIELD_MODULUS) {
      Eurydice_slice_index(out, sampled, int32_t) = coefficient;
      sampled++;
    }
  }
  return sampled;
...
libcrux_ml_dsa_simd_portable_sample_rejection_sample_less_than_eta_equals_2(
  ...
  for (size_t i = (size_t)0U; i < Eurydice_slice_len(randomness, uint8_t);
       i++) {
    size_t i0 = i;
    uint8_t byte = Eurydice_slice_index(randomness, i0, uint8_t);
    ...
    if (try_0 < 15U) {
      ...
      Eurydice_slice_index(out, sampled, int32_t) = (int32_t)2 - try_0_mod_5;
      sampled++;
    }
    if (try_1 < 15U) {
      int32_t try_10 = (int32_t)try_1;
      int32_t try_1_mod_5 = try_10 - (try_10 * (int32_t)26 >> 7U) * (int32_t)5;
      Eurydice_slice_index(out, sampled, int32_t) = (int32_t)2 - try_1_mod_5;
      sampled++;
    }
  }
  return sampled;
...
libcrux_ml_dsa_simd_portable_sample_rejection_sample_less_than_eta_equals_4(
  ...
  for (size_t i = (size_t)0U; i < Eurydice_slice_len(randomness, uint8_t);
    ...
    uint8_t try_1 = (uint32_t)byte >> 4U;
    if (try_0 < 9U) {
      Eurydice_slice_index(out, sampled, int32_t) = (int32_t)4 - (int32_t)try_0;
      sampled++;
    }
    if (try_1 < 9U) {
      Eurydice_slice_index(out, sampled, int32_t) = (int32_t)4 - (int32_t)try_1;
      sampled++;
    }
  }
  return sampled;
...
libcrux_ml_dsa_simd_portable_encoding_gamma1_serialize_when_gamma1_is_2_pow_19(
    Eurydice_arr_d4 *simd_unit, Eurydice_dst_ref_87 serialized) {
  for (size_t i = (size_t)0U;
       i < Eurydice_slice_len(Eurydice_array_to_slice_a7(simd_unit), int32_t) /
               (size_t)2U;
       i++) {
    size_t i0 = i;
    Eurydice_dst_ref_fc coefficients = Eurydice_array_to_subslice_7f(
    ...
    Eurydice_slice_index(serialized, (size_t)5U * i0, uint8_t) =
    ...
    Eurydice_slice_index(serialized, uu____0, uint8_t) =
...
libcrux_ml_dsa_simd_portable_encoding_gamma1_serialize_when_gamma1_is_2_pow_17(
  ...
  for (size_t i = (size_t)0U;
    ...
    Eurydice_slice_index(serialized, (size_t)9U * i0, uint8_t) =
        (uint8_t)coefficient0;
    ...
    Eurydice_slice_index(serialized, uu____1, uint8_t) =
    ...
    Eurydice_slice_index(serialized, uu____2, uint8_t) =
...
libcrux_ml_dsa_simd_portable_encoding_gamma1_deserialize_when_gamma1_is_2_pow_19(
    Eurydice_dst_ref_87 serialized, Eurydice_arr_d4 *simd_unit) {
  for (size_t i = (size_t)0U;
    ...
    int32_t coefficient0 =
        (int32_t)Eurydice_slice_index(bytes, (size_t)0U, uint8_t);
    coefficient0 =
        coefficient0 | (int32_t)Eurydice_slice_index(bytes, (size_t)1U, uint8_t)
                           << 8U;
    coefficient0 =
        coefficient0 | (int32_t)Eurydice_slice_index(bytes, (size_t)2U, uint8_t)
                           << 16U;
    coefficient0 =
        coefficient0 &
        LIBCRUX_ML_DSA_SIMD_PORTABLE_ENCODING_GAMMA1_DESERIALIZE_WHEN_GAMMA1_IS_2_POW_19_GAMMA1_TIMES_2_BITMASK;
    int32_t coefficient1 =
        (int32_t)Eurydice_slice_index(bytes, (size_t)2U, uint8_t) >> 4U;
    coefficient1 =
        coefficient1 | (int32_t)Eurydice_slice_index(bytes, (size_t)3U, uint8_t)
                           << 4U;
    coefficient1 =
        coefficient1 | (int32_t)Eurydice_slice_index(bytes, (size_t)4U, uint8_t)
                           << 12U;
...
libcrux_ml_dsa_simd_portable_encoding_gamma1_deserialize_when_gamma1_is_2_pow_17(
  ...
  for (size_t i = (size_t)0U;
    ...
    int32_t coefficient1 =
        (int32_t)Eurydice_slice_index(bytes, (size_t)2U, uint8_t) >> 2U;
    coefficient1 =
        coefficient1 | (int32_t)Eurydice_slice_index(bytes, (size_t)3U, uint8_t)
                           << 6U;
    coefficient1 =
    ...
    coefficient1 =
        ...
        LIBCRUX_ML_DSA_SIMD_PORTABLE_ENCODING_GAMMA1_DESERIALIZE_WHEN_GAMMA1_IS_2_POW_17_GAMMA1_TIMES_2_BITMASK;
    int32_t coefficient2 =
        (int32_t)Eurydice_slice_index(bytes, (size_t)4U, uint8_t) >> 4U;
    coefficient2 =
        coefficient2 | (int32_t)Eurydice_slice_index(bytes, (size_t)5U, uint8_t)
                           << 4U;
    coefficient2 =
        coefficient2 | (int32_t)Eurydice_slice_index(bytes, (size_t)6U, uint8_t)
                           << 12U;
    coefficient2 =
        coefficient2 &
        LIBCRUX_ML_DSA_SIMD_PORTABLE_ENCODING_GAMMA1_DESERIALIZE_WHEN_GAMMA1_IS_2_POW_17_GAMMA1_TIMES_2_BITMASK;
    int32_t coefficient3 =
        (int32_t)Eurydice_slice_index(bytes, (size_t)6U, uint8_t) >> 6U;
    coefficient3 =
        coefficient3 | (int32_t)Eurydice_slice_index(bytes, (size_t)7U, uint8_t)
                           << 2U;
    coefficient3 =
        coefficient3 | (int32_t)Eurydice_slice_index(bytes, (size_t)8U, uint8_t)
                           << 10U;
    coefficient3 =
        coefficient3 &
        LIBCRUX_ML_DSA_SIMD_PORTABLE_ENCODING_GAMMA1_DESERIALIZE_WHEN_GAMMA1_IS_2_POW_17_GAMMA1_TIMES_2_BITMASK;
...
libcrux_ml_dsa_simd_portable_encoding_gamma1_deserialize(
    Eurydice_dst_ref_87 serialized, Eurydice_arr_d4 *out,
    size_t gamma1_exponent) {
  void *uu____0 = (void *)0U;
  switch (gamma1_exponent) {
    case 17U: {
...
libcrux_ml_dsa_simd_portable_encoding_commitment_serialize_4(
  ...
  Eurydice_slice_index(serialized, (size_t)0U, uint8_t) = byte0;
  Eurydice_slice_index(serialized, (size_t)1U, uint8_t) = byte1;
  Eurydice_slice_index(serialized, (size_t)2U, uint8_t) = byte2;
  Eurydice_slice_index(serialized, (size_t)3U, uint8_t) = byte3;
}
...
libcrux_ml_dsa_simd_portable_encoding_commitment_serialize_6(
  ...
  Eurydice_slice_index(serialized, (size_t)2U, uint8_t) = byte2;
  Eurydice_slice_index(serialized, (size_t)3U, uint8_t) = byte3;
  Eurydice_slice_index(serialized, (size_t)4U, uint8_t) = byte4;
  Eurydice_slice_index(serialized, (size_t)5U, uint8_t) = byte5;
}
...
libcrux_ml_dsa_simd_portable_encoding_error_serialize_when_eta_is_4(
  ...
  for (size_t i = (size_t)0U;
    ...
    uint8_t coefficient1 =
        (uint8_t)(LIBCRUX_ML_DSA_SIMD_PORTABLE_ENCODING_ERROR_SERIALIZE_WHEN_ETA_IS_4_ETA -
                  Eurydice_slice_index(coefficients, (size_t)1U, int32_t));
    Eurydice_slice_index(serialized, i0, uint8_t) =
...
libcrux_ml_dsa_simd_portable_encoding_error_serialize(
    libcrux_ml_dsa_constants_Eta eta, Eurydice_arr_d4 *simd_unit,
    Eurydice_dst_ref_87 serialized) {
  void *uu____0 = (void *)0U;
  switch (eta) {
    case libcrux_ml_dsa_constants_Eta_Two: {
      break;
...
libcrux_ml_dsa_simd_portable_encoding_error_deserialize_when_eta_is_4(
    Eurydice_dst_ref_87 serialized, Eurydice_arr_d4 *simd_units) {
  for (size_t i = (size_t)0U; i < Eurydice_slice_len(serialized, uint8_t);
       i++) {
    size_t i0 = i;
    uint8_t *byte = &Eurydice_slice_index(serialized, i0, uint8_t);
    uint8_t uu____0 =
...
libcrux_ml_dsa_simd_portable_encoding_error_deserialize_when_eta_is_2(
    Eurydice_dst_ref_87 serialized, Eurydice_arr_d4 *simd_unit) {
  int32_t byte0 =
      (int32_t)Eurydice_slice_index(serialized, (size_t)0U, uint8_t);
  int32_t byte1 =
      (int32_t)Eurydice_slice_index(serialized, (size_t)1U, uint8_t);
  int32_t byte2 =
      (int32_t)Eurydice_slice_index(serialized, (size_t)2U, uint8_t);
  simd_unit->data[0U] =
...
libcrux_ml_dsa_simd_portable_encoding_error_deserialize(
    libcrux_ml_dsa_constants_Eta eta, Eurydice_dst_ref_87 serialized,
    Eurydice_arr_d4 *out) {
  void *uu____0 = (void *)0U;
  switch (eta) {
    case libcrux_ml_dsa_constants_Eta_Two: {
...
static KRML_MUSTINLINE void libcrux_ml_dsa_simd_portable_encoding_t0_serialize(
  ...
  int32_t coefficient7 =
      libcrux_ml_dsa_simd_portable_encoding_t0_change_t0_interval(
          simd_unit->data[7U]);
  Eurydice_slice_index(serialized, (size_t)0U, uint8_t) = (uint8_t)coefficient0;
  Eurydice_slice_index(serialized, (size_t)1U, uint8_t) =
      (uint32_t)(uint8_t)(coefficient0 >> 8U) |
      (uint32_t)(uint8_t)(coefficient1 << 5U);
  Eurydice_slice_index(serialized, (size_t)2U, uint8_t) =
      (uint8_t)(coefficient1 >> 3U);
  Eurydice_slice_index(serialized, (size_t)3U, uint8_t) =
      (uint32_t)(uint8_t)(coefficient1 >> 11U) |
      (uint32_t)(uint8_t)(coefficient2 << 2U);
  Eurydice_slice_index(serialized, (size_t)4U, uint8_t) =
      (uint32_t)(uint8_t)(coefficient2 >> 6U) |
      (uint32_t)(uint8_t)(coefficient3 << 7U);
  Eurydice_slice_index(serialized, (size_t)5U, uint8_t) =
      (uint8_t)(coefficient3 >> 1U);
  Eurydice_slice_index(serialized, (size_t)6U, uint8_t) =
      (uint32_t)(uint8_t)(coefficient3 >> 9U) |
      (uint32_t)(uint8_t)(coefficient4 << 4U);
  Eurydice_slice_index(serialized, (size_t)7U, uint8_t) =
      (uint8_t)(coefficient4 >> 4U);
  Eurydice_slice_index(serialized, (size_t)8U, uint8_t) =
      (uint32_t)(uint8_t)(coefficient4 >> 12U) |
      (uint32_t)(uint8_t)(coefficient5 << 1U);
  Eurydice_slice_index(serialized, (size_t)9U, uint8_t) =
      (uint32_t)(uint8_t)(coefficient5 >> 7U) |
      (uint32_t)(uint8_t)(coefficient6 << 6U);
  Eurydice_slice_index(serialized, (size_t)10U, uint8_t) =
      (uint8_t)(coefficient6 >> 2U);
  Eurydice_slice_index(serialized, (size_t)11U, uint8_t) =
      (uint32_t)(uint8_t)(coefficient6 >> 10U) |
      (uint32_t)(uint8_t)(coefficient7 << 3U);
  Eurydice_slice_index(serialized, (size_t)12U, uint8_t) =
...
static inline void libcrux_ml_dsa_simd_portable_t0_serialize_65(
    Eurydice_arr_d4 *simd_unit, Eurydice_dst_ref_87 out) {
...
libcrux_ml_dsa_simd_portable_encoding_t0_deserialize(
  ...
  int32_t byte2 =
      (int32_t)Eurydice_slice_index(serialized, (size_t)2U, uint8_t);
  int32_t byte3 =
      (int32_t)Eurydice_slice_index(serialized, (size_t)3U, uint8_t);
  int32_t byte4 =
      (int32_t)Eurydice_slice_index(serialized, (size_t)4U, uint8_t);
  int32_t byte5 =
      (int32_t)Eurydice_slice_index(serialized, (size_t)5U, uint8_t);
  int32_t byte6 =
      (int32_t)Eurydice_slice_index(serialized, (size_t)6U, uint8_t);
  int32_t byte7 =
      (int32_t)Eurydice_slice_index(serialized, (size_t)7U, uint8_t);
  int32_t byte8 =
      (int32_t)Eurydice_slice_index(serialized, (size_t)8U, uint8_t);
  int32_t byte9 =
      (int32_t)Eurydice_slice_index(serialized, (size_t)9U, uint8_t);
  int32_t byte10 =
      (int32_t)Eurydice_slice_index(serialized, (size_t)10U, uint8_t);
  int32_t byte11 =
      (int32_t)Eurydice_slice_index(serialized, (size_t)11U, uint8_t);
  int32_t byte12 =
      (int32_t)Eurydice_slice_index(serialized, (size_t)12U, uint8_t);
...
libcrux_ml_dsa_simd_portable_encoding_t1_deserialize(
  ...
  for (size_t i = (size_t)0U;
    ...
    Eurydice_dst_ref_87 bytes = Eurydice_slice_subslice_7e(
        serialized, (core_ops_range_Range_08{i0 * (size_t)5U,
                                             i0 * (size_t)5U + (size_t)5U}));
    int32_t byte0 = (int32_t)Eurydice_slice_index(bytes, (size_t)0U, uint8_t);
    int32_t byte1 = (int32_t)Eurydice_slice_index(bytes, (size_t)1U, uint8_t);
    int32_t byte2 = (int32_t)Eurydice_slice_index(bytes, (size_t)2U, uint8_t);
    int32_t byte3 = (int32_t)Eurydice_slice_index(bytes, (size_t)3U, uint8_t);
    int32_t byte4 = (int32_t)Eurydice_slice_index(bytes, (size_t)4U, uint8_t);
...
*/
typedef struct Eurydice_dst_ref_b7_s {
  Eurydice_arr_d4 *ptr;
  size_t meta;
} Eurydice_dst_ref_b7;
...
- N= 32
*/
static inline Eurydice_dst_ref_b7 Eurydice_array_to_slice_a2(
    Eurydice_arr_a4 *a) {
  Eurydice_dst_ref_b7 lit;
  lit.ptr = a->data;
  lit.meta = (size_t)32U;
  return lit;
}
...
libcrux_ml_dsa_simd_portable_invntt_invert_ntt_montgomery(Eurydice_arr_a4 *re) {
  ...
  for (size_t i = (size_t)0U;
       i < Eurydice_slice_len(Eurydice_array_to_slice_a2(re), Eurydice_arr_d4);
       i++) {
    size_t i0 = i;
    libcrux_ml_dsa_simd_portable_arithmetic_montgomery_multiply_by_constant(
...
static inline void libcrux_ml_dsa_simd_portable_reduce_65(
    Eurydice_arr_a4 *simd_units) {
  for (size_t i = (size_t)0U;
       i < Eurydice_slice_len(Eurydice_array_to_slice_a2(simd_units),
                              Eurydice_arr_d4);
       i++) {
    size_t i0 = i;
    libcrux_ml_dsa_simd_portable_arithmetic_shift_left_then_reduce_c3(
...
libcrux_ml_dsa_sample_rejection_sample_less_than_eta_equals_4_37(
    Eurydice_dst_ref_87 randomness, size_t *sampled_coefficients,
    Eurydice_arr_13 *out) {
  bool done = false;
  for (size_t i = (size_t)0U;
       i < Eurydice_slice_len(randomness, uint8_t) / (size_t)4U; i++) {
    size_t _cloop_i = i;
    Eurydice_dst_ref_87 random_bytes = Eurydice_slice_subslice_7e(
        randomness,
    ...
    if (!done) {
      size_t sampled =
          libcrux_ml_dsa_simd_portable_rejection_sample_less_than_eta_equals_4_65(
              random_bytes, Eurydice_array_to_subslice_from_96(
...
libcrux_ml_dsa_sample_rejection_sample_less_than_eta_37(
    libcrux_ml_dsa_constants_Eta eta, Eurydice_dst_ref_87 randomness,
...
static inline void libcrux_ml_dsa_polynomial_from_i32_array_ff_37(
    Eurydice_dst_ref_fc array, Eurydice_arr_a4 *result) {
  for (size_t i = (size_t)0U;
...
libcrux_ml_dsa_sample_sample_four_error_ring_elements_29(
    libcrux_ml_dsa_constants_Eta eta, Eurydice_dst_ref_87 seed,
    uint16_t start_index, Eurydice_dst_ref_f3 re) {
  ...
  libcrux_ml_dsa_hash_functions_portable_Shake256X4 state =
      libcrux_ml_dsa_hash_functions_portable_init_absorb_x4_9b(
          Eurydice_array_to_slice_39(&seed0),
          Eurydice_array_to_slice_39(&seed1),
          Eurydice_array_to_slice_39(&seed2),
          Eurydice_array_to_slice_39(&seed3));
  ...
  while (true) {
    if (done0) {
      if (done1) {
        if (done2) {
          if (done3) {
            ...
            if (!done0) {
              ...
              done0 = libcrux_ml_dsa_sample_rejection_sample_less_than_eta_37(
                  uu____4, Eurydice_array_to_slice_d4(&randomnesses.fst),
                  &sampled0, out.data);
            }
            if (!done1) {
              libcrux_ml_dsa_constants_Eta uu____5 = eta;
              done1 = libcrux_ml_dsa_sample_rejection_sample_less_than_eta_37(
                  uu____5, Eurydice_array_to_slice_d4(&randomnesses.snd),
            ...
            if (!done2) {
              ...
              done2 = libcrux_ml_dsa_sample_rejection_sample_less_than_eta_37(
                  uu____6, Eurydice_array_to_slice_d4(&randomnesses.thd),
            ...
            if (!done3) {
              ...
              done3 = libcrux_ml_dsa_sample_rejection_sample_less_than_eta_37(
                  uu____7, Eurydice_array_to_slice_d4(&randomnesses.f3),
          ...
          if (!done0) {
            ...
            done0 = libcrux_ml_dsa_sample_rejection_sample_less_than_eta_37(
                uu____8, Eurydice_array_to_slice_d4(&randomnesses.fst),
                &sampled0, out.data);
          }
          if (!done1) {
            libcrux_ml_dsa_constants_Eta uu____9 = eta;
            done1 = libcrux_ml_dsa_sample_rejection_sample_less_than_eta_37(
                uu____9, Eurydice_array_to_slice_d4(&randomnesses.snd),
                &sampled1, &out.data[1U]);
          }
          if (!done2) {
            libcrux_ml_dsa_constants_Eta uu____10 = eta;
            done2 = libcrux_ml_dsa_sample_rejection_sample_less_than_eta_37(
                uu____10, Eurydice_array_to_slice_d4(&randomnesses.thd),
                &sampled2, &out.data[2U]);
          }
          if (!done3) {
            libcrux_ml_dsa_constants_Eta uu____11 = eta;
            done3 = libcrux_ml_dsa_sample_rejection_sample_less_than_eta_37(
                uu____11, Eurydice_array_to_slice_d4(&randomnesses.f3),
                &sampled3, &out.data[3U]);
          }
        }
      } else {
        ...
        if (!done0) {
          ...
          done0 = libcrux_ml_dsa_sample_rejection_sample_less_than_eta_37(
              uu____12, Eurydice_array_to_slice_d4(&randomnesses.fst),
              &sampled0, out.data);
        }
        if (!done1) {
          libcrux_ml_dsa_constants_Eta uu____13 = eta;
          done1 = libcrux_ml_dsa_sample_rejection_sample_less_than_eta_37(
              uu____13, Eurydice_array_to_slice_d4(&randomnesses.snd),
              &sampled1, &out.data[1U]);
        }
        if (!done2) {
          libcrux_ml_dsa_constants_Eta uu____14 = eta;
          done2 = libcrux_ml_dsa_sample_rejection_sample_less_than_eta_37(
              uu____14, Eurydice_array_to_slice_d4(&randomnesses.thd),
              &sampled2, &out.data[2U]);
        }
        if (!done3) {
          libcrux_ml_dsa_constants_Eta uu____15 = eta;
          done3 = libcrux_ml_dsa_sample_rejection_sample_less_than_eta_37(
              uu____15, Eurydice_array_to_slice_d4(&randomnesses.f3), &sampled3,
              &out.data[3U]);
        }
      }
    } else {
      ...
      if (!done0) {
        ...
        done0 = libcrux_ml_dsa_sample_rejection_sample_less_than_eta_37(
            uu____16, Eurydice_array_to_slice_d4(&randomnesses.fst), &sampled0,
            out.data);
      }
      if (!done1) {
        libcrux_ml_dsa_constants_Eta uu____17 = eta;
        done1 = libcrux_ml_dsa_sample_rejection_sample_less_than_eta_37(
            uu____17, Eurydice_array_to_slice_d4(&randomnesses.snd), &sampled1,
            &out.data[1U]);
      }
      if (!done2) {
        libcrux_ml_dsa_constants_Eta uu____18 = eta;
        done2 = libcrux_ml_dsa_sample_rejection_sample_less_than_eta_37(
            uu____18, Eurydice_array_to_slice_d4(&randomnesses.thd), &sampled2,
            &out.data[2U]);
      }
      if (!done3) {
        libcrux_ml_dsa_constants_Eta uu____19 = eta;
        done3 = libcrux_ml_dsa_sample_rejection_sample_less_than_eta_37(
            uu____19, Eurydice_array_to_slice_d4(&randomnesses.f3), &sampled3,
            &out.data[3U]);
      }
    }
  }
  ...
  size_t max;
  if (Eurydice_slice_len(re, Eurydice_arr_a4) < max0) {
    max = Eurydice_slice_len(re, Eurydice_arr_a4);
  } else {
    max = max0;
  }
  for (size_t i = (size_t)start_index; i < max; i++) {
    ...
    libcrux_ml_dsa_polynomial_from_i32_array_ff_37(
        Eurydice_array_to_slice_200(&out.data[i0 % (size_t)4U]),
        &Eurydice_slice_index(re, i0, Eurydice_arr_a4));
  }
}
...
static KRML_MUSTINLINE void libcrux_ml_dsa_samplex4_sample_s1_and_s2_29(
    libcrux_ml_dsa_constants_Eta eta, Eurydice_dst_ref_87 seed,
    Eurydice_dst_ref_f3 s1_s2) {
  size_t len = Eurydice_slice_len(s1_s2, Eurydice_arr_a4);
...
- N= 11
*/
static inline Eurydice_dst_ref_f3 Eurydice_array_to_slice_71(
    Eurydice_arr_93 *a) {
...
libcrux_ml_dsa_sample_sample_up_to_four_ring_elements_flat_63(
    size_t columns, Eurydice_dst_ref_87 seed, Eurydice_dst_ref_f3 matrix,
    Eurydice_arr_12 *rand_stack0, Eurydice_arr_12 *rand_stack1,
    Eurydice_arr_12 *rand_stack2, Eurydice_arr_12 *rand_stack3,
    Eurydice_dst_ref_2c tmp_stack, size_t start_index,
  ...
  libcrux_ml_dsa_hash_functions_portable_Shake128X4 state =
      libcrux_ml_dsa_hash_functions_portable_init_absorb_11(
          Eurydice_array_to_slice_8d(&seed0),
          Eurydice_array_to_slice_8d(&seed1),
          Eurydice_array_to_slice_8d(&seed2),
          Eurydice_array_to_slice_8d(&seed3));
  libcrux_ml_dsa_hash_functions_portable_squeeze_first_five_blocks_11(
  ...
  bool done0 =
      libcrux_ml_dsa_sample_rejection_sample_less_than_field_modulus_37(
          Eurydice_array_to_slice_a8(rand_stack0), &sampled0,
          &Eurydice_slice_index(tmp_stack, (size_t)0U, Eurydice_arr_13));
  bool done1 =
      libcrux_ml_dsa_sample_rejection_sample_less_than_field_modulus_37(
          Eurydice_array_to_slice_a8(rand_stack1), &sampled1,
          &Eurydice_slice_index(tmp_stack, (size_t)1U, Eurydice_arr_13));
  bool done2 =
      libcrux_ml_dsa_sample_rejection_sample_less_than_field_modulus_37(
          Eurydice_array_to_slice_a8(rand_stack2), &sampled2,
          &Eurydice_slice_index(tmp_stack, (size_t)2U, Eurydice_arr_13));
  bool done3 =
      libcrux_ml_dsa_sample_rejection_sample_less_than_field_modulus_37(
          Eurydice_array_to_slice_a8(rand_stack3), &sampled3,
          &Eurydice_slice_index(tmp_stack, (size_t)3U, Eurydice_arr_13));
  while (true) {
    if (done0) {
      if (done1) {
        if (done2) {
          if (done3) {
            ...
            if (!done0) {
              done0 =
                  libcrux_ml_dsa_sample_rejection_sample_less_than_field_modulus_37(
                      Eurydice_array_to_slice_7b(&randomnesses.fst), &sampled0,
                      &Eurydice_slice_index(tmp_stack, (size_t)0U,
                                            Eurydice_arr_13));
            }
            if (!done1) {
              done1 =
                  libcrux_ml_dsa_sample_rejection_sample_less_than_field_modulus_37(
                      Eurydice_array_to_slice_7b(&randomnesses.snd), &sampled1,
                      &Eurydice_slice_index(tmp_stack, (size_t)1U,
                                            Eurydice_arr_13));
            }
            if (!done2) {
              done2 =
                  libcrux_ml_dsa_sample_rejection_sample_less_than_field_modulus_37(
                      Eurydice_array_to_slice_7b(&randomnesses.thd), &sampled2,
                      &Eurydice_slice_index(tmp_stack, (size_t)2U,
                                            Eurydice_arr_13));
            }
            if (!done3) {
              done3 =
                  libcrux_ml_dsa_sample_rejection_sample_less_than_field_modulus_37(
                      Eurydice_array_to_slice_7b(&randomnesses.f3), &sampled3,
                      &Eurydice_slice_index(tmp_stack, (size_t)3U,
                                            Eurydice_arr_13));
            }
          }
        } else {
  ...
  for (size_t i = (size_t)0U; i < elements_requested; i++) {
    size_t k = i;
    libcrux_ml_dsa_polynomial_from_i32_array_ff_37(
        Eurydice_array_to_slice_200(
            &Eurydice_slice_index(tmp_stack, k, Eurydice_arr_13)),
        &Eurydice_slice_index(matrix, start_index + k, Eurydice_arr_a4));
  }
}
...
static KRML_MUSTINLINE void libcrux_ml_dsa_samplex4_matrix_flat_63(
  ...
  for (size_t i = (size_t)0U;
       i < Eurydice_slice_len(matrix, Eurydice_arr_a4) / (size_t)4U; i++) {
    size_t start_index = i;
    size_t start_index0 = start_index * (size_t)4U;
    size_t uu____0 = start_index0 + (size_t)4U;
    size_t elements_requested;
    if (uu____0 <= Eurydice_slice_len(matrix, Eurydice_arr_a4)) {
      elements_requested = (size_t)4U;
    } else {
      elements_requested =
          Eurydice_slice_len(matrix, Eurydice_arr_a4) - start_index0;
    }
    libcrux_ml_dsa_sample_sample_up_to_four_ring_elements_flat_63(
        columns, seed, matrix, &rand_stack0, &rand_stack1, &rand_stack2,
        &rand_stack3, Eurydice_array_to_slice_f6(&tmp_stack), start_index0,
        elements_requested);
  }
}
...
- N= 30
*/
static inline Eurydice_dst_ref_f3 Eurydice_array_to_slice_710(
    Eurydice_arr_c9 *a) {
  Eurydice_dst_ref_f3 lit;
  lit.ptr = a->data;
  lit.meta = (size_t)30U;
...
- N= 5
*/
static inline Eurydice_dst_ref_f3 Eurydice_array_to_slice_711(
    Eurydice_arr_40 *a) {
  Eurydice_dst_ref_f3 lit;
  lit.ptr = a->data;
  lit.meta = (size_t)5U;
...
- N= 11
*/
static inline Eurydice_dst_ref_f3 Eurydice_array_to_subslice_c3(
    Eurydice_arr_93 *a, core_ops_range_Range_08 r) {
  return (Eurydice_dst_ref_f3{a->data + r.start, r.end - r.start});
}
...
static KRML_MUSTINLINE void libcrux_ml_dsa_ntt_ntt_multiply_montgomery_37(
    Eurydice_arr_a4 *lhs, Eurydice_arr_a4 *rhs) {
  for (size_t i = (size_t)0U;
       i < Eurydice_slice_len(Eurydice_array_to_slice_a2(lhs), Eurydice_arr_d4);
       i++) {
    size_t i0 = i;
...
static KRML_MUSTINLINE void libcrux_ml_dsa_polynomial_add_ff_37(
    Eurydice_arr_a4 *self, Eurydice_arr_a4 *rhs) {
  for (size_t i = (size_t)0U;
       i <
       Eurydice_slice_len(Eurydice_array_to_slice_a2(self), Eurydice_arr_d4);
       i++) {
    size_t i0 = i;
...
static KRML_MUSTINLINE void libcrux_ml_dsa_matrix_compute_as1_plus_s2_37(
    size_t rows_in_a, size_t columns_in_a, Eurydice_dst_ref_f3 a_as_ntt,
    Eurydice_dst_ref_f3 s1_ntt, Eurydice_dst_ref_f3 s1_s2,
    Eurydice_dst_ref_f3 result) {
  for (size_t i0 = (size_t)0U; i0 < rows_in_a; i0++) {
    ...
    for (size_t i = (size_t)0U; i < columns_in_a; i++) {
      ...
      libcrux_ml_dsa_ntt_ntt_multiply_montgomery_37(
          &Eurydice_slice_index(a_as_ntt, i1 * columns_in_a + j,
                                Eurydice_arr_a4),
          &Eurydice_slice_index(s1_ntt, j, Eurydice_arr_a4));
      libcrux_ml_dsa_polynomial_add_ff_37(
          &Eurydice_slice_index(result, i1, Eurydice_arr_a4),
          &Eurydice_slice_index(a_as_ntt, i1 * columns_in_a + j,
                                Eurydice_arr_a4));
    }
  }
  for (size_t i = (size_t)0U; i < Eurydice_slice_len(result, Eurydice_arr_a4);
       i++) {
    size_t i0 = i;
    libcrux_ml_dsa_ntt_reduce_37(
        &Eurydice_slice_index(result, i0, Eurydice_arr_a4));
    libcrux_ml_dsa_ntt_invert_ntt_montgomery_37(
        &Eurydice_slice_index(result, i0, Eurydice_arr_a4));
    libcrux_ml_dsa_polynomial_add_ff_37(
        &Eurydice_slice_index(result, i0, Eurydice_arr_a4),
        &Eurydice_slice_index(s1_s2, columns_in_a + i0, Eurydice_arr_a4));
  }
}
...
- N= 6
*/
static inline Eurydice_dst_ref_f3 Eurydice_array_to_slice_712(
    Eurydice_arr_47 *a) {
  Eurydice_dst_ref_f3 lit;
  lit.ptr = a->data;
  lit.meta = (size_t)6U;
...
static KRML_MUSTINLINE void libcrux_ml_dsa_arithmetic_power2round_vector_37(
    Eurydice_dst_ref_f3 t, Eurydice_dst_ref_f3 t1) {
  for (size_t i0 = (size_t)0U; i0 < Eurydice_slice_len(t, Eurydice_arr_a4);
       i0++) {
    size_t i1 = i0;
    for (size_t i = (size_t)0U;
         i <
         Eurydice_slice_len(Eurydice_array_to_slice_a2(
                                &Eurydice_slice_index(t, i1, Eurydice_arr_a4)),
                            Eurydice_arr_d4);
         i++) {
      size_t j = i;
      libcrux_ml_dsa_simd_portable_power2round_65(
          &Eurydice_slice_index(t, i1, Eurydice_arr_a4).data[j],
          &Eurydice_slice_index(t1, i1, Eurydice_arr_a4).data[j]);
    }
  }
}
...
static KRML_MUSTINLINE void libcrux_ml_dsa_encoding_t1_serialize_37(
    Eurydice_arr_a4 *re, Eurydice_dst_ref_87 serialized) {
  for (size_t i = (size_t)0U;
       i < Eurydice_slice_len(Eurydice_array_to_slice_a2(re), Eurydice_arr_d4);
       i++) {
    size_t i0 = i;
    Eurydice_arr_d4 *simd_unit = &re->data[i0];
...
libcrux_ml_dsa_encoding_verification_key_generate_serialized_37(
    Eurydice_dst_ref_87 seed, Eurydice_dst_ref_f3 t1,
    Eurydice_dst_ref_87 verification_key_serialized) {
  Eurydice_slice_copy(
      Eurydice_slice_subslice_7e(
  ...
  for (size_t i = (size_t)0U; i < Eurydice_slice_len(t1, Eurydice_arr_a4);
       i++) {
    size_t i0 = i;
    Eurydice_arr_a4 *ring_element =
        &Eurydice_slice_index(t1, i0, Eurydice_arr_a4);
...
static KRML_MUSTINLINE void libcrux_ml_dsa_hash_functions_portable_shake256_24(
    Eurydice_dst_ref_87 input, libcrux_sha3_Sha3_512Digest *out) {
  libcrux_sha3_portable_shake256(Eurydice_array_to_slice_d8(out), input);
}
...
static KRML_MUSTINLINE void libcrux_ml_dsa_encoding_error_serialize_37(
    libcrux_ml_dsa_constants_Eta eta, Eurydice_arr_a4 *re,
    Eurydice_dst_ref_87 serialized) {
...
libcrux_ml_dsa_encoding_signing_key_generate_serialized_2e(
    ...
    Eurydice_dst_ref_87 seed_matrix, Eurydice_dst_ref_87 seed_signing,
    Eurydice_dst_ref_87 verification_key, Eurydice_dst_ref_f3 s1_2,
    Eurydice_dst_ref_f3 t0, Eurydice_dst_ref_87 signing_key_serialized) {
  ...
  libcrux_sha3_Sha3_512Digest verification_key_hash = {{0U}};
  ...
  Eurydice_slice_copy(
      ...
      Eurydice_array_to_slice_d8(&verification_key_hash), uint8_t);
  ...
  for (size_t i = (size_t)0U; i < Eurydice_slice_len(s1_2, Eurydice_arr_a4);
    ...
    libcrux_ml_dsa_encoding_error_serialize_37(
        eta, &Eurydice_slice_index(s1_2, i0, Eurydice_arr_a4),
        Eurydice_slice_subslice_7e(
            signing_key_serialized,
  ...
  for (size_t i = (size_t)0U; i < Eurydice_slice_len(t0, Eurydice_arr_a4);
    ...
    size_t _cloop_j = i;
    Eurydice_arr_a4 *ring_element =
        &Eurydice_slice_index(t0, _cloop_j, Eurydice_arr_a4);
...
libcrux_ml_dsa_ml_dsa_generic_ml_dsa_65_generate_key_pair_5a(
    libcrux_sha3_Sha3_256Digest randomness, Eurydice_dst_ref_87 signing_key,
    Eurydice_dst_ref_87 verification_key) {
  ...
  libcrux_ml_dsa_hash_functions_portable_absorb_26(
      &shake, Eurydice_array_to_slice_6e(&randomness));
  /* original Rust expression is not an lvalue in C */
  Eurydice_arr_8b lvalue = {
  ...
  libcrux_ml_dsa_hash_functions_portable_absorb_final_26(
      &shake, Eurydice_array_to_slice_26(&lvalue));
  libcrux_ml_dsa_hash_functions_portable_squeeze_26(
      &shake, Eurydice_array_to_slice_18(&seed_expanded0));
  Eurydice_dst_ref_uint8_t_size_t_x2 uu____0 =
      Eurydice_slice_split_at(Eurydice_array_to_slice_18(&seed_expanded0),
                              LIBCRUX_ML_DSA_CONSTANTS_SEED_FOR_A_SIZE, uint8_t,
                              Eurydice_dst_ref_uint8_t_size_t_x2);
  Eurydice_dst_ref_87 seed_for_a = uu____0.fst;
  Eurydice_dst_ref_87 seed_expanded = uu____0.snd;
  ...
  Eurydice_dst_ref_87 seed_for_error_vectors = uu____1.fst;
  Eurydice_dst_ref_87 seed_for_signing = uu____1.snd;
  ...
  libcrux_ml_dsa_samplex4_sample_s1_and_s2_29(
      ...
      Eurydice_array_to_slice_71(&s1_s2));
  Eurydice_arr_47 t0;
  ...
  libcrux_ml_dsa_samplex4_portable_matrix_flat_a8_37(
      ...
      Eurydice_array_to_slice_710(&a_as_ntt));
  ...
  Eurydice_slice_copy(
      Eurydice_array_to_slice_711(&s1_ntt),
      Eurydice_array_to_subslice_c3(
          &s1_s2,
          (core_ops_range_Range_08{
              (size_t)0U, LIBCRUX_ML_DSA_CONSTANTS_ML_DSA_65_COLUMNS_IN_A})),
      Eurydice_arr_a4);
  for (size_t i = (size_t)0U;
       i < Eurydice_slice_len(Eurydice_array_to_slice_711(&s1_ntt),
                              Eurydice_arr_a4);
       i++) {
    size_t i0 = i;
  ...
  libcrux_ml_dsa_matrix_compute_as1_plus_s2_37(
      ...
      LIBCRUX_ML_DSA_CONSTANTS_ML_DSA_65_COLUMNS_IN_A,
      Eurydice_array_to_slice_710(&a_as_ntt),
      Eurydice_array_to_slice_711(&s1_ntt), Eurydice_array_to_slice_71(&s1_s2),
      Eurydice_array_to_slice_712(&t0));
  Eurydice_arr_47 t1;
  ...
  libcrux_ml_dsa_arithmetic_power2round_vector_37(
      Eurydice_array_to_slice_712(&t0), Eurydice_array_to_slice_712(&t1));
  libcrux_ml_dsa_encoding_verification_key_generate_serialized_37(
      seed_for_a, Eurydice_array_to_slice_712(&t1), verification_key);
  libcrux_ml_dsa_encoding_signing_key_generate_serialized_2e(
      LIBCRUX_ML_DSA_CONSTANTS_ML_DSA_65_ETA,
      LIBCRUX_ML_DSA_ML_DSA_GENERIC_ML_DSA_65_ERROR_RING_ELEMENT_SIZE,
      seed_for_a, seed_for_signing, verification_key,
      Eurydice_array_to_slice_71(&s1_s2), Eurydice_array_to_slice_712(&t0),
      signing_key);
}
...
libcrux_ml_dsa_ml_dsa_generic_instantiations_portable_ml_dsa_65_generate_key_pair(
    libcrux_sha3_Sha3_256Digest randomness, Eurydice_arr_d10 *signing_key,
    Eurydice_arr_4a *verification_key) {
  libcrux_ml_dsa_ml_dsa_generic_ml_dsa_65_generate_key_pair_5a(
      randomness, Eurydice_array_to_slice_ef(signing_key),
      Eurydice_array_to_slice_5b(verification_key));
}
...
libcrux_ml_dsa_ml_dsa_65_portable_generate_key_pair(
    libcrux_sha3_Sha3_256Digest randomness) {
...
typedef struct Option_91_s {
  Option_08_tags tag;
  libcrux_sha3_Sha3_384Digest f0;
} Option_91;
...
static KRML_MUSTINLINE void libcrux_ml_dsa_encoding_error_deserialize_37(
  ...
  for (size_t i = (size_t)0U;
       i <
       Eurydice_slice_len(Eurydice_array_to_slice_a2(result), Eurydice_arr_d4);
       i++) {
    size_t i0 = i;
...
libcrux_ml_dsa_encoding_error_deserialize_to_vector_then_ntt_37(
    ...
    Eurydice_dst_ref_87 serialized, Eurydice_dst_ref_f3 ring_elements) {
  for (size_t i = (size_t)0U;
    ...
    libcrux_ml_dsa_encoding_error_deserialize_37(
        eta, bytes, &Eurydice_slice_index(ring_elements, i0, Eurydice_arr_a4));
    libcrux_ml_dsa_ntt_ntt_37(
        &Eurydice_slice_index(ring_elements, i0, Eurydice_arr_a4));
  }
}
...
static KRML_MUSTINLINE void libcrux_ml_dsa_encoding_t0_deserialize_37(
    Eurydice_dst_ref_87 serialized, Eurydice_arr_a4 *result) {
  for (size_t i = (size_t)0U;
       i <
       Eurydice_slice_len(Eurydice_array_to_slice_a2(result), Eurydice_arr_d4);
       i++) {
...
libcrux_ml_dsa_encoding_t0_deserialize_to_vector_then_ntt_37(
  ...
  for (size_t i = (size_t)0U;
    ...
    libcrux_ml_dsa_encoding_t0_deserialize_37(
        bytes, &Eurydice_slice_index(ring_elements, i0, Eurydice_arr_a4));
    libcrux_ml_dsa_ntt_ntt_37(
        &Eurydice_slice_index(ring_elements, i0, Eurydice_arr_a4));
  }
}
...
libcrux_ml_dsa_ml_dsa_generic_derive_message_representative_43(
    Eurydice_dst_ref_87 verification_key_hash,
    Option_84 *domain_separation_context, Eurydice_dst_ref_87 message,
    libcrux_sha3_Sha3_512Digest *message_representative) {
  libcrux_sha3_generic_keccak_xof_KeccakXofState_e2 shake =
      libcrux_ml_dsa_hash_functions_portable_init_26();
  ...
  if (domain_separation_context->tag == Some) {
    ...
    libcrux_ml_dsa_hash_functions_portable_absorb_26(
        uu____0, Eurydice_array_to_slice_07(&lvalue0));
    libcrux_sha3_generic_keccak_xof_KeccakXofState_e2 *uu____1 = &shake;
    /* original Rust expression is not an lvalue in C */
    Eurydice_arr_f1 lvalue = {{(uint8_t)Eurydice_slice_len(
        libcrux_ml_dsa_pre_hash_context_88(domain_separation_context0),
        uint8_t)}};
    libcrux_ml_dsa_hash_functions_portable_absorb_26(
        uu____1, Eurydice_array_to_slice_07(&lvalue));
    libcrux_ml_dsa_hash_functions_portable_absorb_26(
        &shake, libcrux_ml_dsa_pre_hash_context_88(domain_separation_context0));
    Option_3b *uu____2 =
        libcrux_ml_dsa_pre_hash_pre_hash_oid_88(domain_separation_context0);
    if (uu____2->tag == Some) {
      Eurydice_arr_cb *pre_hash_oid = &uu____2->f0;
      libcrux_ml_dsa_hash_functions_portable_absorb_26(
          &shake, Eurydice_array_to_slice_da(pre_hash_oid));
    }
  }
  libcrux_ml_dsa_hash_functions_portable_absorb_final_26(&shake, message);
  libcrux_ml_dsa_hash_functions_portable_squeeze_26(
      &shake, Eurydice_array_to_slice_d8(message_representative));
}
...
static KRML_MUSTINLINE void libcrux_ml_dsa_hash_functions_portable_shake256_1b(
    Eurydice_dst_ref_87 input, Eurydice_arr_5f *out) {
  libcrux_sha3_portable_shake256(Eurydice_array_to_slice_fa(out), input);
}
...
libcrux_ml_dsa_hash_functions_portable_shake256_x4_9b_1b(
    Eurydice_dst_ref_87 input0, Eurydice_dst_ref_87 input1,
    Eurydice_dst_ref_87 input2, Eurydice_dst_ref_87 input3,
    Eurydice_arr_5f *out0, Eurydice_arr_5f *out1, Eurydice_arr_5f *out2,
    Eurydice_arr_5f *out3) {
...
static KRML_MUSTINLINE void libcrux_ml_dsa_encoding_gamma1_deserialize_37(
    size_t gamma1_exponent, Eurydice_dst_ref_87 serialized,
    Eurydice_arr_a4 *result) {
  for (size_t i = (size_t)0U;
       i <
       Eurydice_slice_len(Eurydice_array_to_slice_a2(result), Eurydice_arr_d4);
...
static KRML_MUSTINLINE void libcrux_ml_dsa_hash_functions_portable_shake256_c8(
    Eurydice_dst_ref_87 input, Eurydice_arr_c30 *out) {
  libcrux_sha3_portable_shake256(Eurydice_array_to_slice_7d0(out), input);
}
...
*/
static KRML_MUSTINLINE void
libcrux_ml_dsa_hash_functions_portable_shake256_61_c8(Eurydice_dst_ref_87 input,
...
*/
static KRML_MUSTINLINE void
libcrux_ml_dsa_hash_functions_portable_shake256_61_1b(Eurydice_dst_ref_87 input,
                                                      Eurydice_arr_5f *out) {
...
static KRML_MUSTINLINE void libcrux_ml_dsa_sample_sample_mask_ring_element_2e(
    Eurydice_arr_a2 *seed, Eurydice_arr_a4 *result, size_t gamma1_exponent) {
  void *uu____0 = (void *)0U;
  switch (gamma1_exponent) {
    case 17U: {
      break;
    ...
    case 19U: {
      ...
      libcrux_ml_dsa_hash_functions_portable_shake256_61_c8(
          Eurydice_array_to_slice_39(seed), &out);
      libcrux_ml_dsa_encoding_gamma1_deserialize_37(
          gamma1_exponent, Eurydice_array_to_slice_7d0(&out), result);
      return;
    }
    default: {
      KRML_HOST_EPRINTF("KaRaMeL abort at %s:%d\n%s\n", __FILE__, __LINE__,
  ...
  libcrux_ml_dsa_hash_functions_portable_shake256_61_1b(
      Eurydice_array_to_slice_39(seed), &out);
  libcrux_ml_dsa_encoding_gamma1_deserialize_37(
      gamma1_exponent, Eurydice_array_to_slice_fa(&out), result);
}
...
static KRML_MUSTINLINE void libcrux_ml_dsa_sample_sample_mask_vector_67(
    size_t dimension, size_t gamma1_exponent, libcrux_sha3_Sha3_512Digest *seed,
    uint16_t *domain_separator, Eurydice_dst_ref_f3 mask) {
  Eurydice_arr_a2 seed0 = libcrux_ml_dsa_sample_add_error_domain_separator(
      Eurydice_array_to_slice_d8(seed), domain_separator[0U]);
  Eurydice_arr_a2 seed1 = libcrux_ml_dsa_sample_add_error_domain_separator(
      Eurydice_array_to_slice_d8(seed), (uint32_t)domain_separator[0U] + 1U);
  Eurydice_arr_a2 seed2 = libcrux_ml_dsa_sample_add_error_domain_separator(
      Eurydice_array_to_slice_d8(seed), (uint32_t)domain_separator[0U] + 2U);
  Eurydice_arr_a2 seed3 = libcrux_ml_dsa_sample_add_error_domain_separator(
      Eurydice_array_to_slice_d8(seed), (uint32_t)domain_separator[0U] + 3U);
  domain_separator[0U] = (uint32_t)domain_separator[0U] + 4U;
  switch (gamma1_exponent) {
    case 17U: {
      Eurydice_arr_5f out0 = {{0U}};
      Eurydice_arr_5f out1 = {{0U}};
      Eurydice_arr_5f out2 = {{0U}};
      Eurydice_arr_5f out3 = {{0U}};
      libcrux_ml_dsa_hash_functions_portable_shake256_x4_9b_1b(
          Eurydice_array_to_slice_39(&seed0),
          Eurydice_array_to_slice_39(&seed1),
          Eurydice_array_to_slice_39(&seed2),
          Eurydice_array_to_slice_39(&seed3), &out0, &out1, &out2, &out3);
      libcrux_ml_dsa_encoding_gamma1_deserialize_37(
          gamma1_exponent, Eurydice_array_to_slice_fa(&out0),
          &Eurydice_slice_index(mask, (size_t)0U, Eurydice_arr_a4));
      libcrux_ml_dsa_encoding_gamma1_deserialize_37(
          gamma1_exponent, Eurydice_array_to_slice_fa(&out1),
          &Eurydice_slice_index(mask, (size_t)1U, Eurydice_arr_a4));
      libcrux_ml_dsa_encoding_gamma1_deserialize_37(
          gamma1_exponent, Eurydice_array_to_slice_fa(&out2),
          &Eurydice_slice_index(mask, (size_t)2U, Eurydice_arr_a4));
      libcrux_ml_dsa_encoding_gamma1_deserialize_37(
          gamma1_exponent, Eurydice_array_to_slice_fa(&out3),
          &Eurydice_slice_index(mask, (size_t)3U, Eurydice_arr_a4));
      break;
    }
    case 19U: {
      ...
      libcrux_ml_dsa_hash_functions_portable_shake256_x4_9b_c8(
          ...
          Eurydice_array_to_slice_39(&seed3), &out0, &out1, &out2, &out3);
      libcrux_ml_dsa_encoding_gamma1_deserialize_37(
          gamma1_exponent, Eurydice_array_to_slice_7d0(&out0),
          &Eurydice_slice_index(mask, (size_t)0U, Eurydice_arr_a4));
      libcrux_ml_dsa_encoding_gamma1_deserialize_37(
          gamma1_exponent, Eurydice_array_to_slice_7d0(&out1),
          &Eurydice_slice_index(mask, (size_t)1U, Eurydice_arr_a4));
      libcrux_ml_dsa_encoding_gamma1_deserialize_37(
          gamma1_exponent, Eurydice_array_to_slice_7d0(&out2),
          &Eurydice_slice_index(mask, (size_t)2U, Eurydice_arr_a4));
      libcrux_ml_dsa_encoding_gamma1_deserialize_37(
          gamma1_exponent, Eurydice_array_to_slice_7d0(&out3),
          &Eurydice_slice_index(mask, (size_t)3U, Eurydice_arr_a4));
      break;
    }
    default: {
  ...
  for (size_t i = (size_t)4U; i < dimension; i++) {
    ...
    libcrux_ml_dsa_sample_sample_mask_ring_element_2e(
        &seed4, &Eurydice_slice_index(mask, i0, Eurydice_arr_a4),
        gamma1_exponent);
  }
}
...
static KRML_MUSTINLINE void libcrux_ml_dsa_matrix_compute_matrix_x_mask_37(
    size_t rows_in_a, size_t columns_in_a, Eurydice_dst_ref_f3 matrix,
    Eurydice_dst_ref_f3 mask, Eurydice_dst_ref_f3 result) {
  for (size_t i0 = (size_t)0U; i0 < rows_in_a; i0++) {
    size_t i1 = i0;
    for (size_t i = (size_t)0U; i < columns_in_a; i++) {
      size_t j = i;
      Eurydice_arr_a4 product = Eurydice_slice_index(mask, j, Eurydice_arr_a4);
      libcrux_ml_dsa_ntt_ntt_multiply_montgomery_37(
          &product, &Eurydice_slice_index(matrix, i1 * columns_in_a + j,
                                          Eurydice_arr_a4));
      libcrux_ml_dsa_polynomial_add_ff_37(
          &Eurydice_slice_index(result, i1, Eurydice_arr_a4), &product);
    }
    libcrux_ml_dsa_ntt_reduce_37(
        &Eurydice_slice_index(result, i1, Eurydice_arr_a4));
    libcrux_ml_dsa_ntt_invert_ntt_montgomery_37(
...
static KRML_MUSTINLINE void libcrux_ml_dsa_arithmetic_decompose_vector_37(
    size_t dimension, int32_t gamma2, Eurydice_dst_ref_f3 t,
    Eurydice_dst_ref_f3 low, Eurydice_dst_ref_f3 high) {
  for (size_t i0 = (size_t)0U; i0 < dimension; i0++) {
    size_t i1 = i0;
    for (size_t i = (size_t)0U;
         i <
         Eurydice_slice_len(Eurydice_array_to_slice_a2(&Eurydice_slice_index(
                                low, (size_t)0U, Eurydice_arr_a4)),
                            Eurydice_arr_d4);
         i++) {
      size_t j = i;
      libcrux_ml_dsa_simd_portable_decompose_65(
          gamma2, &Eurydice_slice_index(t, i1, Eurydice_arr_a4).data[j],
          &Eurydice_slice_index(low, i1, Eurydice_arr_a4).data[j],
          &Eurydice_slice_index(high, i1, Eurydice_arr_a4).data[j]);
    }
  }
}
...
libcrux_ml_dsa_encoding_commitment_serialize_vector_37(
    size_t ring_element_size, Eurydice_dst_ref_f3 vector,
    Eurydice_dst_ref_87 serialized) {
  size_t offset = (size_t)0U;
  for (size_t i = (size_t)0U; i < Eurydice_slice_len(vector, Eurydice_arr_a4);
    ...
    size_t _cloop_j = i;
    Eurydice_arr_a4 *ring_element =
        &Eurydice_slice_index(vector, _cloop_j, Eurydice_arr_a4);
...
*/
static KRML_MUSTINLINE void
libcrux_ml_dsa_sample_sample_challenge_ring_element_2e(Eurydice_dst_ref_87 seed,
  ...
  Eurydice_arr_c4 arr;
  memcpy(arr.data,
         Eurydice_array_to_subslice_360(
  ...
  bool done = libcrux_ml_dsa_sample_inside_out_shuffle(
      Eurydice_array_to_subslice_from_8c(&randomness0, (size_t)8U), &out_index,
      &signs, &result);
  while (true) {
    if (done) {
      break;
      ...
      Eurydice_arr_3d randomness =
          ...
          Eurydice_array_to_slice_d4(&randomness), &out_index, &signs, &result);
    }
  }
  libcrux_ml_dsa_polynomial_from_i32_array_ff_37(
      Eurydice_array_to_slice_20(&result), re);
}
...
static KRML_MUSTINLINE void libcrux_ml_dsa_matrix_vector_times_ring_element_37(
    Eurydice_dst_ref_f3 vector, Eurydice_arr_a4 *ring_element) {
  for (size_t i = (size_t)0U; i < Eurydice_slice_len(vector, Eurydice_arr_a4);
       i++) {
    size_t i0 = i;
    libcrux_ml_dsa_ntt_ntt_multiply_montgomery_37(
        &Eurydice_slice_index(vector, i0, Eurydice_arr_a4), ring_element);
    libcrux_ml_dsa_ntt_invert_ntt_montgomery_37(
        &Eurydice_slice_index(vector, i0, Eurydice_arr_a4));
  }
}
...
static KRML_MUSTINLINE void libcrux_ml_dsa_matrix_add_vectors_37(
    size_t dimension, Eurydice_dst_ref_f3 lhs, Eurydice_dst_ref_f3 rhs) {
  for (size_t i = (size_t)0U; i < dimension; i++) {
    size_t i0 = i;
    libcrux_ml_dsa_polynomial_add_ff_37(
        &Eurydice_slice_index(lhs, i0, Eurydice_arr_a4),
        &Eurydice_slice_index(rhs, i0, Eurydice_arr_a4));
  }
}
...
*/
static KRML_MUSTINLINE bool
libcrux_ml_dsa_polynomial_infinity_norm_exceeds_ff_37(Eurydice_arr_a4 *self,
                                                      int32_t bound) {
  bool result = false;
  for (size_t i = (size_t)0U;
       i <
...
libcrux_ml_dsa_arithmetic_vector_infinity_norm_exceeds_37(
    Eurydice_dst_ref_f3 vector, int32_t bound) {
  bool result = false;
  for (size_t i = (size_t)0U; i < Eurydice_slice_len(vector, Eurydice_arr_a4);
       i++) {
    size_t i0 = i;
    ...
    if (result) {
      ...
      uu____0 = libcrux_ml_dsa_polynomial_infinity_norm_exceeds_ff_37(
          &Eurydice_slice_index(vector, i0, Eurydice_arr_a4), bound);
    }
    result = uu____0;
  }
  return result;
...
static inline Eurydice_arr_c3 libcrux_ml_dsa_polynomial_to_i32_array_ff_37(
  ...
  for (size_t i = (size_t)0U;
    ...
    libcrux_ml_dsa_simd_portable_to_coefficient_array_65(
        &self->data[i0],
        Eurydice_array_to_subslice_7f0(
            &result,
            (core_ops_range_Range_08{
                i0 * LIBCRUX_ML_DSA_SIMD_TRAITS_COEFFICIENTS_IN_SIMD_UNIT,
                (i0 + (size_t)1U) *
...
static KRML_MUSTINLINE size_t libcrux_ml_dsa_arithmetic_make_hint_37(
    Eurydice_dst_ref_f3 low, Eurydice_dst_ref_f3 high, int32_t gamma2,
    Eurydice_dst_ref_59 hint) {
...
static KRML_MUSTINLINE void libcrux_ml_dsa_encoding_signature_serialize_37(
    Eurydice_dst_ref_87 commitment_hash, Eurydice_dst_ref_f3 signer_response,
    Eurydice_dst_ref_59 hint, size_t commitment_hash_size, size_t columns_in_a,
    size_t rows_in_a, size_t gamma1_exponent, size_t gamma1_ring_element_size,
    size_t max_ones_in_hint, Eurydice_dst_ref_87 signature) {
  size_t offset = (size_t)0U;
  Eurydice_slice_copy(
      Eurydice_slice_subslice_7e(
          signature,
  ...
  for (size_t i = (size_t)0U; i < columns_in_a; i++) {
    ...
    libcrux_ml_dsa_encoding_gamma1_serialize_37(
        &Eurydice_slice_index(signer_response, i0, Eurydice_arr_a4),
        Eurydice_slice_subslice_7e(
  ...
  for (size_t i0 = (size_t)0U; i0 < rows_in_a; i0++) {
    ...
    for (size_t i = (size_t)0U;
         i <
         Eurydice_slice_len(Eurydice_array_to_slice_20(&Eurydice_slice_index(
                                hint, i1, Eurydice_arr_c3)),
                            int32_t);
         i++) {
      size_t j = i;
      if (Eurydice_slice_index(hint, i1, Eurydice_arr_c3).data[j] ==
          (int32_t)1) {
...
libcrux_ml_dsa_ml_dsa_generic_ml_dsa_65_sign_internal_5a(
    Eurydice_dst_ref_87 signing_key, Eurydice_dst_ref_87 message,
    Option_84 domain_separation_context, libcrux_sha3_Sha3_256Digest randomness,
  ...
  Eurydice_dst_ref_uint8_t_size_t_x2 uu____0 = Eurydice_slice_split_at(
      ...
      Eurydice_dst_ref_uint8_t_size_t_x2);
  Eurydice_dst_ref_87 seed_for_a = uu____0.fst;
  Eurydice_dst_ref_87 remaining_serialized0 = uu____0.snd;
  Eurydice_dst_ref_uint8_t_size_t_x2 uu____1 = Eurydice_slice_split_at(
      remaining_serialized0, LIBCRUX_ML_DSA_CONSTANTS_SEED_FOR_SIGNING_SIZE,
      uint8_t, Eurydice_dst_ref_uint8_t_size_t_x2);
  Eurydice_dst_ref_87 seed_for_signing = uu____1.fst;
  Eurydice_dst_ref_87 remaining_serialized1 = uu____1.snd;
  Eurydice_dst_ref_uint8_t_size_t_x2 uu____2 = Eurydice_slice_split_at(
      ...
      Eurydice_dst_ref_uint8_t_size_t_x2);
  Eurydice_dst_ref_87 verification_key_hash = uu____2.fst;
  Eurydice_dst_ref_87 remaining_serialized2 = uu____2.snd;
  Eurydice_dst_ref_uint8_t_size_t_x2 uu____3 = Eurydice_slice_split_at(
      remaining_serialized2,
      LIBCRUX_ML_DSA_ML_DSA_GENERIC_ML_DSA_65_ERROR_RING_ELEMENT_SIZE *
          LIBCRUX_ML_DSA_CONSTANTS_ML_DSA_65_COLUMNS_IN_A,
      uint8_t, Eurydice_dst_ref_uint8_t_size_t_x2);
  Eurydice_dst_ref_87 s1_serialized = uu____3.fst;
  Eurydice_dst_ref_87 remaining_serialized = uu____3.snd;
  Eurydice_dst_ref_uint8_t_size_t_x2 uu____4 = Eurydice_slice_split_at(
      remaining_serialized,
      LIBCRUX_ML_DSA_ML_DSA_GENERIC_ML_DSA_65_ERROR_RING_ELEMENT_SIZE *
          LIBCRUX_ML_DSA_CONSTANTS_ML_DSA_65_ROWS_IN_A,
      uint8_t, Eurydice_dst_ref_uint8_t_size_t_x2);
  Eurydice_dst_ref_87 s2_serialized = uu____4.fst;
  Eurydice_dst_ref_87 t0_serialized = uu____4.snd;
  ...
  libcrux_ml_dsa_encoding_error_deserialize_to_vector_then_ntt_37(
      LIBCRUX_ML_DSA_CONSTANTS_ML_DSA_65_ETA,
      LIBCRUX_ML_DSA_ML_DSA_GENERIC_ML_DSA_65_ERROR_RING_ELEMENT_SIZE,
      s1_serialized, Eurydice_array_to_slice_711(&s1_as_ntt));
  libcrux_ml_dsa_encoding_error_deserialize_to_vector_then_ntt_37(
      LIBCRUX_ML_DSA_CONSTANTS_ML_DSA_65_ETA,
      LIBCRUX_ML_DSA_ML_DSA_GENERIC_ML_DSA_65_ERROR_RING_ELEMENT_SIZE,
      s2_serialized, Eurydice_array_to_slice_712(&s2_as_ntt));
  libcrux_ml_dsa_encoding_t0_deserialize_to_vector_then_ntt_37(
      t0_serialized, Eurydice_array_to_slice_712(&t0_as_ntt));
  ...
  libcrux_ml_dsa_samplex4_portable_matrix_flat_a8_37(
      LIBCRUX_ML_DSA_CONSTANTS_ML_DSA_65_COLUMNS_IN_A, seed_for_a,
      Eurydice_array_to_slice_710(&matrix));
  libcrux_sha3_Sha3_512Digest message_representative = {{0U}};
  libcrux_ml_dsa_ml_dsa_generic_derive_message_representative_43(
      verification_key_hash, &domain_separation_context, message,
      &message_representative);
  libcrux_sha3_Sha3_512Digest mask_seed = {{0U}};
  ...
  libcrux_ml_dsa_hash_functions_portable_absorb_26(
      &shake0, Eurydice_array_to_slice_6e(&randomness));
  libcrux_ml_dsa_hash_functions_portable_absorb_final_26(
      &shake0, Eurydice_array_to_slice_d8(&message_representative));
  libcrux_ml_dsa_hash_functions_portable_squeeze_26(
      &shake0, Eurydice_array_to_slice_d8(&mask_seed));
  ...
  while (attempt < LIBCRUX_ML_DSA_CONSTANTS_REJECTION_SAMPLE_BOUND_SIGN) {
    ...
    libcrux_ml_dsa_sample_sample_mask_vector_67(
        ...
        &domain_separator_for_mask, Eurydice_array_to_slice_711(&mask));
    ...
    for (size_t i = (size_t)0U;
         i < Eurydice_slice_len(Eurydice_array_to_slice_711(&mask_ntt),
                                Eurydice_arr_a4);
         i++) {
      size_t i0 = i;
    ...
    libcrux_ml_dsa_matrix_compute_matrix_x_mask_37(
        ...
        LIBCRUX_ML_DSA_CONSTANTS_ML_DSA_65_COLUMNS_IN_A,
        Eurydice_array_to_slice_710(&matrix),
        Eurydice_array_to_slice_711(&mask_ntt),
        Eurydice_array_to_slice_712(&a_x_mask));
    libcrux_ml_dsa_arithmetic_decompose_vector_37(
        LIBCRUX_ML_DSA_CONSTANTS_ML_DSA_65_ROWS_IN_A,
        LIBCRUX_ML_DSA_CONSTANTS_ML_DSA_65_GAMMA2,
        Eurydice_array_to_slice_712(&a_x_mask),
        Eurydice_array_to_slice_712(&w0),
        Eurydice_array_to_slice_712(&commitment));
    libcrux_sha3_Sha3_384Digest commitment_hash_candidate = {{0U}};
    Eurydice_arr_56 commitment_serialized = {{0U}};
    libcrux_ml_dsa_encoding_commitment_serialize_vector_37(
        LIBCRUX_ML_DSA_ML_DSA_GENERIC_ML_DSA_65_COMMITMENT_RING_ELEMENT_SIZE,
        Eurydice_array_to_slice_712(&commitment),
        Eurydice_array_to_slice_ee(&commitment_serialized));
    libcrux_sha3_generic_keccak_xof_KeccakXofState_e2 shake =
        libcrux_ml_dsa_hash_functions_portable_init_26();
    libcrux_ml_dsa_hash_functions_portable_absorb_26(
        &shake, Eurydice_array_to_slice_d8(&message_representative));
    libcrux_ml_dsa_hash_functions_portable_absorb_final_26(
        &shake, Eurydice_array_to_slice_ee(&commitment_serialized));
    libcrux_ml_dsa_hash_functions_portable_squeeze_26(
        &shake, Eurydice_array_to_slice_95(&commitment_hash_candidate));
    ...
    libcrux_ml_dsa_sample_sample_challenge_ring_element_2e(
        Eurydice_array_to_slice_95(&commitment_hash_candidate),
        LIBCRUX_ML_DSA_CONSTANTS_ML_DSA_65_ONES_IN_VERIFIER_CHALLENGE,
        &verifier_challenge);
    ...
    libcrux_ml_dsa_matrix_vector_times_ring_element_37(
        Eurydice_array_to_slice_711(&challenge_times_s1), &verifier_challenge);
    libcrux_ml_dsa_matrix_vector_times_ring_element_37(
        Eurydice_array_to_slice_712(&challenge_times_s2), &verifier_challenge);
    libcrux_ml_dsa_matrix_add_vectors_37(
        LIBCRUX_ML_DSA_CONSTANTS_ML_DSA_65_COLUMNS_IN_A,
        Eurydice_array_to_slice_711(&mask),
        Eurydice_array_to_slice_711(&challenge_times_s1));
    libcrux_ml_dsa_matrix_subtract_vectors_37(
        LIBCRUX_ML_DSA_CONSTANTS_ML_DSA_65_ROWS_IN_A,
        Eurydice_array_to_slice_712(&w0),
        Eurydice_array_to_slice_712(&challenge_times_s2));
    if (!libcrux_ml_dsa_arithmetic_vector_infinity_norm_exceeds_37(
      ...
      if (!libcrux_ml_dsa_arithmetic_vector_infinity_norm_exceeds_37(
        ...
        libcrux_ml_dsa_matrix_vector_times_ring_element_37(
            Eurydice_array_to_slice_712(&challenge_times_t0),
            &verifier_challenge);
        if (!libcrux_ml_dsa_arithmetic_vector_infinity_norm_exceeds_37(
                Eurydice_array_to_slice_712(&challenge_times_t0),
                LIBCRUX_ML_DSA_CONSTANTS_ML_DSA_65_GAMMA2)) {
          ...
          size_t ones_in_hint = libcrux_ml_dsa_arithmetic_make_hint_37(
              ...
              Eurydice_array_to_slice_712(&commitment),
              LIBCRUX_ML_DSA_CONSTANTS_ML_DSA_65_GAMMA2,
              Eurydice_array_to_slice_6d(&hint_candidate));
          if (!(ones_in_hint >
                LIBCRUX_ML_DSA_CONSTANTS_ML_DSA_65_MAX_ONES_IN_HINT)) {
  ...
  if (commitment_hash0.tag == None) {
    ...
    libcrux_sha3_Sha3_384Digest commitment_hash = commitment_hash0.f0;
    libcrux_sha3_Sha3_384Digest commitment_hash1 = commitment_hash;
    if (signer_response0.tag == None) {
      ...
      if (!(hint0.tag == None)) {
        ...
        libcrux_ml_dsa_encoding_signature_serialize_37(
            Eurydice_array_to_slice_95(&commitment_hash1),
            Eurydice_array_to_slice_711(&signer_response1),
            Eurydice_array_to_slice_6d(&hint1),
            LIBCRUX_ML_DSA_CONSTANTS_ML_DSA_65_COMMITMENT_HASH_SIZE,
            LIBCRUX_ML_DSA_CONSTANTS_ML_DSA_65_COLUMNS_IN_A,
            LIBCRUX_ML_DSA_CONSTANTS_ML_DSA_65_ROWS_IN_A,
            LIBCRUX_ML_DSA_CONSTANTS_ML_DSA_65_GAMMA1_EXPONENT,
            ...
            LIBCRUX_ML_DSA_CONSTANTS_ML_DSA_65_MAX_ONES_IN_HINT,
            Eurydice_array_to_slice_ee0(signature));
        return (Result_53{Ok});
      }
      uu____5 = (Result_53{
          Err, libcrux_ml_dsa_types_SigningError_RejectionSamplingError});
...
libcrux_ml_dsa_ml_dsa_generic_ml_dsa_65_sign_mut_5a(
    Eurydice_dst_ref_87 signing_key, Eurydice_dst_ref_87 message,
    Eurydice_dst_ref_87 context, libcrux_sha3_Sha3_256Digest randomness,
    Eurydice_arr_96 *signature) {
  Result_a8 uu____0 =
...
libcrux_ml_dsa_ml_dsa_generic_instantiations_portable_ml_dsa_65_sign(
    Eurydice_arr_d10 *signing_key, Eurydice_dst_ref_87 message,
    Eurydice_dst_ref_87 context, libcrux_sha3_Sha3_256Digest randomness) {
  return libcrux_ml_dsa_ml_dsa_generic_ml_dsa_65_sign_5a(
      Eurydice_array_to_slice_ef(signing_key), message, context, randomness);
}
...
static KRML_MUSTINLINE void libcrux_ml_dsa_pre_hash_hash_30_83(
    Eurydice_dst_ref_87 message, Eurydice_dst_ref_87 output) {
...
libcrux_ml_dsa_ml_dsa_generic_ml_dsa_65_sign_pre_hashed_mut_3f(
    Eurydice_dst_ref_87 signing_key, Eurydice_dst_ref_87 message,
    Eurydice_dst_ref_87 context, Eurydice_dst_ref_87 pre_hash_buffer,
    libcrux_sha3_Sha3_256Digest randomness, Eurydice_arr_96 *signature) {
  if (!(Eurydice_slice_len(context, uint8_t) >
        LIBCRUX_ML_DSA_CONSTANTS_CONTEXT_MAX_LEN)) {
...
libcrux_ml_dsa_ml_dsa_generic_instantiations_portable_ml_dsa_65_sign_pre_hashed_shake128(
  ...
  return libcrux_ml_dsa_ml_dsa_generic_ml_dsa_65_sign_pre_hashed_3f(
      Eurydice_array_to_slice_ef(signing_key), message, context,
...
libcrux_ml_dsa_ml_dsa_65_portable_sign_pre_hashed_shake128(
    Eurydice_arr_d10 *signing_key, Eurydice_dst_ref_87 message,
    Eurydice_dst_ref_87 context, libcrux_sha3_Sha3_256Digest randomness) {
  libcrux_sha3_Sha3_256Digest pre_hash_buffer = {{0U}};
  Eurydice_arr_d10 *uu____0 = libcrux_ml_dsa_types_as_ref_9b_09(signing_key);
  return libcrux_ml_dsa_ml_dsa_generic_instantiations_portable_ml_dsa_65_sign_pre_hashed_shake128(
      uu____0, message, context, Eurydice_array_to_slice_6e(&pre_hash_buffer),
      randomness);
}
...
libcrux_ml_dsa_encoding_verification_key_deserialize_37(
    ...
    Eurydice_dst_ref_87 serialized, Eurydice_dst_ref_f3 t1) {
...
libcrux_ml_dsa_encoding_signature_deserialize_37(
    ...
    Eurydice_dst_ref_87 serialized, Eurydice_dst_ref_87 out_commitment_hash,
    Eurydice_dst_ref_f3 out_signer_response, Eurydice_dst_ref_59 out_hint) {
  Eurydice_dst_ref_uint8_t_size_t_x2 uu____0 =
      Eurydice_slice_split_at(serialized, commitment_hash_size, uint8_t,
                              Eurydice_dst_ref_uint8_t_size_t_x2);
  Eurydice_dst_ref_87 commitment_hash = uu____0.fst;
  Eurydice_dst_ref_87 rest_of_serialized = uu____0.snd;
  Eurydice_slice_copy(
      Eurydice_slice_subslice_7e(
          out_commitment_hash,
  ...
  Eurydice_dst_ref_uint8_t_size_t_x2 uu____1 = Eurydice_slice_split_at(
      ...
      Eurydice_dst_ref_uint8_t_size_t_x2);
  Eurydice_dst_ref_87 signer_response_serialized = uu____1.fst;
  Eurydice_dst_ref_87 hint_serialized = uu____1.snd;
  for (size_t i = (size_t)0U; i < columns_in_a; i++) {
    size_t i0 = i;
    libcrux_ml_dsa_encoding_gamma1_deserialize_37(
        gamma1_exponent,
...
static KRML_MUSTINLINE void libcrux_ml_dsa_matrix_compute_w_approx_37(
    size_t rows_in_a, size_t columns_in_a, Eurydice_dst_ref_f3 matrix,
    Eurydice_dst_ref_f3 signer_response,
    Eurydice_arr_a4 *verifier_challenge_as_ntt, Eurydice_dst_ref_f3 t1) {
  for (size_t i0 = (size_t)0U; i0 < rows_in_a; i0++) {
    size_t i1 = i0;
    ...
    for (size_t i = (size_t)0U; i < columns_in_a; i++) {
      ...
      Eurydice_arr_a4 product =
          Eurydice_slice_index(matrix, i1 * columns_in_a + j, Eurydice_arr_a4);
      libcrux_ml_dsa_ntt_ntt_multiply_montgomery_37(
          &product, &Eurydice_slice_index(signer_response, j, Eurydice_arr_a4));
      libcrux_ml_dsa_polynomial_add_ff_37(&inner_result, &product);
    }
    libcrux_ml_dsa_arithmetic_shift_left_then_reduce_68(
        &Eurydice_slice_index(t1, i1, Eurydice_arr_a4));
    libcrux_ml_dsa_ntt_ntt_37(&Eurydice_slice_index(t1, i1, Eurydice_arr_a4));
    libcrux_ml_dsa_ntt_ntt_multiply_montgomery_37(
        &Eurydice_slice_index(t1, i1, Eurydice_arr_a4),
        verifier_challenge_as_ntt);
    libcrux_ml_dsa_polynomial_subtract_ff_37(
        &inner_result, &Eurydice_slice_index(t1, i1, Eurydice_arr_a4));
    Eurydice_slice_index(t1, i1, Eurydice_arr_a4) = inner_result;
    libcrux_ml_dsa_ntt_reduce_37(
        &Eurydice_slice_index(t1, i1, Eurydice_arr_a4));
    libcrux_ml_dsa_ntt_invert_ntt_montgomery_37(
        &Eurydice_slice_index(t1, i1, Eurydice_arr_a4));
...
static KRML_MUSTINLINE void libcrux_ml_dsa_arithmetic_use_hint_37(
    int32_t gamma2, Eurydice_dst_ref_59 hint, Eurydice_dst_ref_f3 re_vector) {
  for (size_t i0 = (size_t)0U;
       i0 < Eurydice_slice_len(re_vector, Eurydice_arr_a4); i0++) {
    size_t i1 = i0;
    Eurydice_arr_a4 tmp = libcrux_ml_dsa_polynomial_zero_ff_37();
    libcrux_ml_dsa_polynomial_from_i32_array_ff_37(
        Eurydice_array_to_slice_20(
            &Eurydice_slice_index(hint, i1, Eurydice_arr_c3)),
        &tmp);
    for (size_t i = (size_t)0U;
         i <
         Eurydice_slice_len(Eurydice_array_to_slice_a2(&Eurydice_slice_index(
                                re_vector, (size_t)0U, Eurydice_arr_a4)),
                            Eurydice_arr_d4);
         i++) {
      size_t j = i;
      libcrux_ml_dsa_simd_portable_use_hint_65(
          gamma2, &Eurydice_slice_index(re_vector, i1, Eurydice_arr_a4).data[j],
          &tmp.data[j]);
    }
    Eurydice_slice_index(re_vector, i1, Eurydice_arr_a4) = tmp;
  }
}
...
libcrux_ml_dsa_ml_dsa_generic_ml_dsa_65_verify_internal_5a(
    Eurydice_arr_4a *verification_key, Eurydice_dst_ref_87 message,
    Option_84 domain_separation_context,
    Eurydice_arr_96 *signature_serialized) {
  Eurydice_dst_ref_uint8_t_size_t_x2 uu____0 =
      Eurydice_slice_split_at(Eurydice_array_to_slice_5b(verification_key),
                              LIBCRUX_ML_DSA_CONSTANTS_SEED_FOR_A_SIZE, uint8_t,
                              Eurydice_dst_ref_uint8_t_size_t_x2);
  Eurydice_dst_ref_87 seed_for_a = uu____0.fst;
  Eurydice_dst_ref_87 t1_serialized = uu____0.snd;
  Eurydice_arr_47 t1;
  ...
  libcrux_ml_dsa_encoding_verification_key_deserialize_37(
      ...
      t1_serialized, Eurydice_array_to_slice_712(&t1));
  libcrux_sha3_Sha3_384Digest deserialized_commitment_hash = {{0U}};
  ...
  Result_41 uu____1 = libcrux_ml_dsa_encoding_signature_deserialize_37(
      ...
      Eurydice_array_to_slice_ee0(signature_serialized),
      Eurydice_array_to_slice_95(&deserialized_commitment_hash),
      Eurydice_array_to_slice_711(&deserialized_signer_response),
      Eurydice_array_to_slice_6d(&deserialized_hint));
  Result_41 uu____2;
  if (uu____1.tag == Ok) {
    if (libcrux_ml_dsa_arithmetic_vector_infinity_norm_exceeds_37(
            Eurydice_array_to_slice_711(&deserialized_signer_response),
      ...
      libcrux_sha3_Sha3_512Digest verification_key_hash = {{0U}};
      libcrux_ml_dsa_hash_functions_portable_shake256_61_24(
          Eurydice_array_to_slice_5b(verification_key), &verification_key_hash);
      libcrux_sha3_Sha3_512Digest message_representative = {{0U}};
      libcrux_ml_dsa_ml_dsa_generic_derive_message_representative_43(
          Eurydice_array_to_slice_d8(&verification_key_hash),
      ...
      libcrux_ml_dsa_matrix_compute_w_approx_37(
          ...
          Eurydice_array_to_slice_710(&matrix),
          Eurydice_array_to_slice_711(&deserialized_signer_response),
          &verifier_challenge, Eurydice_array_to_slice_712(&t1));
      libcrux_sha3_Sha3_384Digest recomputed_commitment_hash = {{0U}};
      libcrux_ml_dsa_arithmetic_use_hint_37(
          LIBCRUX_ML_DSA_CONSTANTS_ML_DSA_65_GAMMA2,
          Eurydice_array_to_slice_6d(&deserialized_hint),
          Eurydice_array_to_slice_712(&t1));
      Eurydice_arr_56 commitment_serialized = {{0U}};
      libcrux_ml_dsa_encoding_commitment_serialize_vector_37(
          LIBCRUX_ML_DSA_ML_DSA_GENERIC_ML_DSA_65_COMMITMENT_RING_ELEMENT_SIZE,
          Eurydice_array_to_slice_712(&t1),
      ...
      libcrux_ml_dsa_hash_functions_portable_absorb_final_26(
          &shake, Eurydice_array_to_slice_ee(&commitment_serialized));
      libcrux_ml_dsa_hash_functions_portable_squeeze_26(
          &shake, Eurydice_array_to_slice_95(&recomputed_commitment_hash));
...
libcrux_ml_dsa_ml_dsa_generic_ml_dsa_65_verify_5a(
    Eurydice_arr_4a *verification_key_serialized, Eurydice_dst_ref_87 message,
    Eurydice_dst_ref_87 context, Eurydice_arr_96 *signature_serialized) {
  Result_a8 uu____0 =
      libcrux_ml_dsa_pre_hash_new_88(context, (Option_3b{None}));
  if (!(uu____0.tag == Ok)) {
    return (Result_41{
...
libcrux_ml_dsa_ml_dsa_generic_instantiations_portable_ml_dsa_65_verify(
    Eurydice_arr_4a *verification_key, Eurydice_dst_ref_87 message,
    Eurydice_dst_ref_87 context, Eurydice_arr_96 *signature) {
...
libcrux_ml_dsa_ml_dsa_65_portable_verify_pre_hashed_shake128(
    ...
    Eurydice_dst_ref_87 context, Eurydice_arr_96 *signature) {
  libcrux_sha3_Sha3_256Digest pre_hash_buffer = {{0U}};
  Eurydice_arr_4a *uu____0 =
      libcrux_ml_dsa_types_as_ref_7f_97(verification_key);
  Eurydice_dst_ref_87 uu____1 = message;
  Eurydice_dst_ref_87 uu____2 = context;
  Eurydice_dst_ref_87 uu____3 = Eurydice_array_to_slice_6e(&pre_hash_buffer);
