...
static KRML_MUSTINLINE void libcrux_sha3_simd_avx2_load_block_3a(
  ...
  Eurydice_slice_len(blocks->data[0U], uint8_t);
...
static KRML_MUSTINLINE void libcrux_sha3_simd_avx2_load_last_c6(
  ...
  Eurydice_arr_66 lvalue = {{Eurydice_array_to_slice_7b(buffers.data),
...
libcrux_sha3_avx2_x4_incremental_shake128_absorb_final(
  ...
  /* original Rust expression is not an lvalue in C */
  Eurydice_arr_66 lvalue = {{data0, data1, data2, data3}};
...
static KRML_MUSTINLINE void libcrux_sha3_simd_avx2_load_last_ad(
  ...
  /* original Rust expression is not an lvalue in C */
  Eurydice_arr_66 lvalue = {{Eurydice_array_to_slice_d4(buffers.data),
...
static KRML_MUSTINLINE void libcrux_sha3_simd_avx2_store_block_5b(
  ...
  if (rem > (size_t)0U) {
    ...
    if (rem8 > (size_t)0U) {
      ...
      Eurydice_slice_copy(Eurydice_slice_subslice_7e(
                              out0, (core_ops_range_Range_08{
...
static KRML_MUSTINLINE void libcrux_sha3_generic_keccak_simd256_keccak4_ad(
  ...
  KRML_HOST_EPRINTF("KaRaMeL abort at %s:%d\n%s\n", __FILE__, __LINE__,
                    "panic!");
  KRML_HOST_EXIT(255U);
  size_t uu____3 = Eurydice_slice_len(data->data[0U], uint8_t);
  if (uu____3 == Eurydice_slice_len(data->data[1U], uint8_t)) {
    size_t uu____4 = Eurydice_slice_len(data->data[0U], uint8_t);
    if (uu____4 == Eurydice_slice_len(data->data[2U], uint8_t)) {
      size_t uu____5 = Eurydice_slice_len(data->data[0U], uint8_t);
      if (uu____5 == Eurydice_slice_len(data->data[3U], uint8_t)) {
      }
    }
  }
  KRML_HOST_EPRINTF("KaRaMeL abort at %s:%d\n%s\n", __FILE__, __LINE__,
...
static KRML_MUSTINLINE void libcrux_sha3_avx2_x4_shake256(
    ...
    Eurydice_dst_ref_87 out2, Eurydice_dst_ref_87 out3) {
  /* original Rust expression is not an lvalue in C */
  Eurydice_arr_66 lvalue = {{input0, input1, input2, input3}};
