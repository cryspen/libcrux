...
/**
This function found in impl {(libcrux_sha3::traits::internal::KeccakItem<4: usize> for core::core_arch::x86::__m256i)}
*/
...
KRML_ATTRIBUTE_TARGET("avx2")
static KRML_MUSTINLINE __m256i
libcrux_sha3_simd_avx2_xor5_ef(__m256i a, __m256i b, __m256i c, __m256i d, __m256i e)
{
...
KRML_ATTRIBUTE_TARGET("avx2")
static KRML_MUSTINLINE __m256i
libcrux_sha3_simd_avx2_xor_ef(__m256i a, __m256i b)
{
...
libcrux_sha3_simd_avx2_split_at_mut_4(Eurydice_slice out[4U], size_t mid)
{
  ...
  uu____0 = Eurydice_slice_split_at_mut(out0, mid, uint8_t, Eurydice_slice_uint8_t_x2);
  Eurydice_slice out00 = uu____0.fst;
  Eurydice_slice out01 = uu____0.snd;
  Eurydice_slice_uint8_t_x2
  uu____1 = Eurydice_slice_split_at_mut(out1, mid, uint8_t, Eurydice_slice_uint8_t_x2);
  Eurydice_slice out10 = uu____1.fst;
  Eurydice_slice out11 = uu____1.snd;
  Eurydice_slice_uint8_t_x2
  uu____2 = Eurydice_slice_split_at_mut(out2, mid, uint8_t, Eurydice_slice_uint8_t_x2);
  Eurydice_slice out20 = uu____2.fst;
  Eurydice_slice out21 = uu____2.snd;
  Eurydice_slice_uint8_t_x2
  uu____3 = Eurydice_slice_split_at_mut(out3, mid, uint8_t, Eurydice_slice_uint8_t_x2);
...
- $4size_t
*/
typedef struct libcrux_sha3_generic_keccak_KeccakState_55_s { __m256i st[5U][5U]; }
...
libcrux_sha3_generic_keccak_new_89_a6(void)
{
  ...
  for (size_t i0 = (size_t)0U; i0 < (size_t)5U; i0++)
  {
    ...
    memcpy(repeat_expression0[i0], repeat_expression, (size_t)5U * sizeof (__m256i));
  }
...
)
{
  for (size_t i = (size_t)0U; i < (size_t)168U / (size_t)32U; i++)
  {
    ...
    state[(size_t)4U * i0 / (size_t)5U][(size_t)4U * i0 % (size_t)5U] =
      libcrux_intrinsics_avx2_mm256_xor_si256(state[(size_t)4U
        * i0
        / (size_t)5U][(size_t)4U
        * i0
        % (size_t)5U],
        v0);
    state[((size_t)4U * i0 + (size_t)1U)
    / (size_t)5U][((size_t)4U * i0 + (size_t)1U)
    % (size_t)5U]
    =
      libcrux_intrinsics_avx2_mm256_xor_si256(state[((size_t)4U * i0 + (size_t)1U)
        / (size_t)5U][((size_t)4U * i0 + (size_t)1U)
        % (size_t)5U],
        v1);
    state[((size_t)4U * i0 + (size_t)2U)
    / (size_t)5U][((size_t)4U * i0 + (size_t)2U)
    % (size_t)5U]
    =
      libcrux_intrinsics_avx2_mm256_xor_si256(state[((size_t)4U * i0 + (size_t)2U)
        / (size_t)5U][((size_t)4U * i0 + (size_t)2U)
        % (size_t)5U],
        v2);
    state[((size_t)4U * i0 + (size_t)3U)
    / (size_t)5U][((size_t)4U * i0 + (size_t)3U)
    % (size_t)5U]
    =
      libcrux_intrinsics_avx2_mm256_xor_si256(state[((size_t)4U * i0 + (size_t)3U)
        / (size_t)5U][((size_t)4U * i0 + (size_t)3U)
        % (size_t)5U],
        v3);
  }
...
KRML_ATTRIBUTE_TARGET("avx2")
static KRML_MUSTINLINE void
libcrux_sha3_simd_avx2_load_block_full_3a(
  __m256i (*state)[5U],
  uint8_t (*blocks)[200U],
  size_t start
)
...
KRML_ATTRIBUTE_TARGET("avx2")
static KRML_MUSTINLINE void
libcrux_sha3_simd_avx2_load_block_full_ef_3a(
  __m256i (*state)[5U],
  uint8_t (*blocks)[200U],
  size_t start
)
...
KRML_ATTRIBUTE_TARGET("avx2")
static KRML_MUSTINLINE void
libcrux_sha3_generic_keccak_theta_rho_a6(libcrux_sha3_generic_keccak_KeccakState_55 *s)
{
  __m256i
  c[5U] =
    {
      libcrux_sha3_simd_avx2_xor5_ef(s->st[0U][0U],
        s->st[1U][0U],
        s->st[2U][0U],
        s->st[3U][0U],
        s->st[4U][0U]),
      libcrux_sha3_simd_avx2_xor5_ef(s->st[0U][1U],
        s->st[1U][1U],
        s->st[2U][1U],
        s->st[3U][1U],
        s->st[4U][1U]),
      libcrux_sha3_simd_avx2_xor5_ef(s->st[0U][2U],
        s->st[1U][2U],
        s->st[2U][2U],
        s->st[3U][2U],
        s->st[4U][2U]),
      libcrux_sha3_simd_avx2_xor5_ef(s->st[0U][3U],
        s->st[1U][3U],
        s->st[2U][3U],
        s->st[3U][3U],
        s->st[4U][3U]),
      libcrux_sha3_simd_avx2_xor5_ef(s->st[0U][4U],
        s->st[1U][4U],
        s->st[2U][4U],
        s->st[3U][4U],
        s->st[4U][4U])
  ...
  __m256i
  uu____0 =
    libcrux_sha3_simd_avx2_rotate_left1_and_xor_ef(c[((size_t)0U + (size_t)4U) % (size_t)5U],
      c[((size_t)0U + (size_t)1U) % (size_t)5U]);
  __m256i
  uu____1 =
    libcrux_sha3_simd_avx2_rotate_left1_and_xor_ef(c[((size_t)1U + (size_t)4U) % (size_t)5U],
      c[((size_t)1U + (size_t)1U) % (size_t)5U]);
  __m256i
  uu____2 =
    libcrux_sha3_simd_avx2_rotate_left1_and_xor_ef(c[((size_t)2U + (size_t)4U) % (size_t)5U],
      c[((size_t)2U + (size_t)1U) % (size_t)5U]);
  __m256i
  uu____3 =
    libcrux_sha3_simd_avx2_rotate_left1_and_xor_ef(c[((size_t)3U + (size_t)4U) % (size_t)5U],
      c[((size_t)3U + (size_t)1U) % (size_t)5U]);
  __m256i
  t[5U] =
    {
      uu____0, uu____1, uu____2, uu____3,
      libcrux_sha3_simd_avx2_rotate_left1_and_xor_ef(c[((size_t)4U + (size_t)4U) % (size_t)5U],
        c[((size_t)4U + (size_t)1U) % (size_t)5U])
    };
  s->st[0U][0U] = libcrux_sha3_simd_avx2_xor_ef(s->st[0U][0U], t[0U]);
  s->st[1U][0U] = libcrux_sha3_simd_avx2_xor_and_rotate_ef_02(s->st[1U][0U], t[0U]);
  s->st[2U][0U] = libcrux_sha3_simd_avx2_xor_and_rotate_ef_ac(s->st[2U][0U], t[0U]);
  s->st[3U][0U] = libcrux_sha3_simd_avx2_xor_and_rotate_ef_020(s->st[3U][0U], t[0U]);
  s->st[4U][0U] = libcrux_sha3_simd_avx2_xor_and_rotate_ef_a9(s->st[4U][0U], t[0U]);
  s->st[0U][1U] = libcrux_sha3_simd_avx2_xor_and_rotate_ef_76(s->st[0U][1U], t[1U]);
  s->st[1U][1U] = libcrux_sha3_simd_avx2_xor_and_rotate_ef_58(s->st[1U][1U], t[1U]);
  s->st[2U][1U] = libcrux_sha3_simd_avx2_xor_and_rotate_ef_e0(s->st[2U][1U], t[1U]);
  s->st[3U][1U] = libcrux_sha3_simd_avx2_xor_and_rotate_ef_63(s->st[3U][1U], t[1U]);
  s->st[4U][1U] = libcrux_sha3_simd_avx2_xor_and_rotate_ef_6a(s->st[4U][1U], t[1U]);
  s->st[0U][2U] = libcrux_sha3_simd_avx2_xor_and_rotate_ef_ab(s->st[0U][2U], t[2U]);
  s->st[1U][2U] = libcrux_sha3_simd_avx2_xor_and_rotate_ef_5b(s->st[1U][2U], t[2U]);
  s->st[2U][2U] = libcrux_sha3_simd_avx2_xor_and_rotate_ef_6f(s->st[2U][2U], t[2U]);
  s->st[3U][2U] = libcrux_sha3_simd_avx2_xor_and_rotate_ef_62(s->st[3U][2U], t[2U]);
  s->st[4U][2U] = libcrux_sha3_simd_avx2_xor_and_rotate_ef_23(s->st[4U][2U], t[2U]);
  s->st[0U][3U] = libcrux_sha3_simd_avx2_xor_and_rotate_ef_37(s->st[0U][3U], t[3U]);
  s->st[1U][3U] = libcrux_sha3_simd_avx2_xor_and_rotate_ef_bb(s->st[1U][3U], t[3U]);
  s->st[2U][3U] = libcrux_sha3_simd_avx2_xor_and_rotate_ef_b9(s->st[2U][3U], t[3U]);
  s->st[3U][3U] = libcrux_sha3_simd_avx2_xor_and_rotate_ef_54(s->st[3U][3U], t[3U]);
  s->st[4U][3U] = libcrux_sha3_simd_avx2_xor_and_rotate_ef_4c(s->st[4U][3U], t[3U]);
  s->st[0U][4U] = libcrux_sha3_simd_avx2_xor_and_rotate_ef_ce(s->st[0U][4U], t[4U]);
  s->st[1U][4U] = libcrux_sha3_simd_avx2_xor_and_rotate_ef_77(s->st[1U][4U], t[4U]);
  s->st[2U][4U] = libcrux_sha3_simd_avx2_xor_and_rotate_ef_25(s->st[2U][4U], t[4U]);
  s->st[3U][4U] = libcrux_sha3_simd_avx2_xor_and_rotate_ef_af(s->st[3U][4U], t[4U]);
  __m256i uu____27 = libcrux_sha3_simd_avx2_xor_and_rotate_ef_fd(s->st[4U][4U], t[4U]);
  s->st[4U][4U] = uu____27;
}
...
KRML_ATTRIBUTE_TARGET("avx2")
static KRML_MUSTINLINE void
libcrux_sha3_generic_keccak_pi_a6(libcrux_sha3_generic_keccak_KeccakState_55 *s)
{
  __m256i old[5U][5U];
...
KRML_ATTRIBUTE_TARGET("avx2")
static KRML_MUSTINLINE void
libcrux_sha3_generic_keccak_chi_a6(libcrux_sha3_generic_keccak_KeccakState_55 *s)
{
  __m256i old[5U][5U];
  memcpy(old, s->st, (size_t)5U * sizeof (__m256i [5U]));
  for (size_t i0 = (size_t)0U; i0 < (size_t)5U; i0++)
  {
    ...
    for (size_t i = (size_t)0U; i < (size_t)5U; i++)
    {
      size_t j = i;
      s->st[i1][j] =
        libcrux_sha3_simd_avx2_and_not_xor_ef(s->st[i1][j],
...
KRML_ATTRIBUTE_TARGET("avx2")
static KRML_MUSTINLINE void
libcrux_sha3_generic_keccak_iota_a6(libcrux_sha3_generic_keccak_KeccakState_55 *s, size_t i)
{
  s->st[0U][0U] =
    libcrux_sha3_simd_avx2_xor_constant_ef(s->st[0U][0U],
...
KRML_ATTRIBUTE_TARGET("avx2")
static KRML_MUSTINLINE void
libcrux_sha3_generic_keccak_keccakf1600_a6(libcrux_sha3_generic_keccak_KeccakState_55 *s)
{
...
)
{
  ...
  libcrux_sha3_generic_keccak_absorb_final_fb(uu____0,
    uu____1,
    (size_t)0U,
...
KRML_ATTRIBUTE_TARGET("avx2")
static KRML_MUSTINLINE void
libcrux_sha3_simd_avx2_load_block_full_5b(
  __m256i (*state)[5U],
  uint8_t (*blocks)[200U],
  size_t start
)
...
KRML_ATTRIBUTE_TARGET("avx2")
static KRML_MUSTINLINE void
libcrux_sha3_simd_avx2_load_block_full_ef_5b(
  __m256i (*state)[5U],
  uint8_t (*blocks)[200U],
  size_t start
)
...
)
{
  libcrux_sha3_generic_keccak_KeccakState_55 *uu____0 = s;
  Eurydice_slice uu____1[4U] = { data0, data1, data2, data3 };
  libcrux_sha3_generic_keccak_absorb_final_fb0(uu____0,
    uu____1,
    (size_t)0U,
    Eurydice_slice_len(data0, uint8_t));
}
...
KRML_ATTRIBUTE_TARGET("avx2")
static KRML_MUSTINLINE void
libcrux_sha3_simd_avx2_load_block_ef_5b(
  __m256i (*state)[5U],
  Eurydice_slice *blocks,
  size_t start
)
...
KRML_ATTRIBUTE_TARGET("avx2")
static KRML_MUSTINLINE void
libcrux_sha3_generic_keccak_absorb_block_97(
  libcrux_sha3_generic_keccak_KeccakState_55 *s,
  Eurydice_slice *blocks,
  size_t start
)
...
KRML_ATTRIBUTE_TARGET("avx2")
static KRML_MUSTINLINE void
libcrux_sha3_simd_avx2_store_block_5b(__m256i (*s)[5U], Eurydice_slice *out)
{
  for (size_t i = (size_t)0U; i < (size_t)136U / (size_t)32U; i++)
  {
    size_t i0 = i;
    ...
    libcrux_intrinsics_avx2_mm256_storeu_si256_u8(Eurydice_slice_subslice2(out[0U],
        (size_t)32U * i0,
        (size_t)32U * (i0 + (size_t)1U),
        uint8_t),
      v0);
    libcrux_intrinsics_avx2_mm256_storeu_si256_u8(Eurydice_slice_subslice2(out[1U],
        (size_t)32U * i0,
        (size_t)32U * (i0 + (size_t)1U),
        uint8_t),
      v1);
    libcrux_intrinsics_avx2_mm256_storeu_si256_u8(Eurydice_slice_subslice2(out[2U],
        (size_t)32U * i0,
        (size_t)32U * (i0 + (size_t)1U),
        uint8_t),
      v2);
    libcrux_intrinsics_avx2_mm256_storeu_si256_u8(Eurydice_slice_subslice2(out[3U],
        (size_t)32U * i0,
        (size_t)32U * (i0 + (size_t)1U),
        uint8_t),
      v3);
  ...
  libcrux_intrinsics_avx2_mm256_storeu_si256_u8(Eurydice_array_to_slice((size_t)32U,
      ...
      uint8_t),
    s[i0][j0]);
  Eurydice_slice uu____0 = Eurydice_slice_subslice2(out[0U], start, start + (size_t)8U, uint8_t);
  Eurydice_slice_copy(uu____0,
    Eurydice_array_to_subslice2(u8s, (size_t)0U, (size_t)8U, uint8_t),
    uint8_t);
  Eurydice_slice uu____1 = Eurydice_slice_subslice2(out[1U], start, start + (size_t)8U, uint8_t);
  Eurydice_slice_copy(uu____1,
    Eurydice_array_to_subslice2(u8s, (size_t)8U, (size_t)16U, uint8_t),
    uint8_t);
  Eurydice_slice uu____2 = Eurydice_slice_subslice2(out[2U], start, start + (size_t)8U, uint8_t);
  Eurydice_slice_copy(uu____2,
    Eurydice_array_to_subslice2(u8s, (size_t)16U, (size_t)24U, uint8_t),
    uint8_t);
  Eurydice_slice uu____3 = Eurydice_slice_subslice2(out[3U], start, start + (size_t)8U, uint8_t);
  Eurydice_slice_copy(uu____3,
  ...
  if (rem == (size_t)16U)
  {
    ...
    libcrux_intrinsics_avx2_mm256_storeu_si256_u8(Eurydice_array_to_slice((size_t)32U,
      ...
      s[i][j]);
    Eurydice_slice
    uu____4 = Eurydice_slice_subslice2(out[0U], start + (size_t)8U, start + (size_t)16U, uint8_t);
    Eurydice_slice_copy(uu____4,
      Eurydice_array_to_subslice2(u8s0, (size_t)0U, (size_t)8U, uint8_t),
      uint8_t);
    Eurydice_slice
    uu____5 = Eurydice_slice_subslice2(out[1U], start + (size_t)8U, start + (size_t)16U, uint8_t);
    Eurydice_slice_copy(uu____5,
      Eurydice_array_to_subslice2(u8s0, (size_t)8U, (size_t)16U, uint8_t),
      uint8_t);
    Eurydice_slice
    uu____6 = Eurydice_slice_subslice2(out[2U], start + (size_t)8U, start + (size_t)16U, uint8_t);
    Eurydice_slice_copy(uu____6,
      Eurydice_array_to_subslice2(u8s0, (size_t)16U, (size_t)24U, uint8_t),
      uint8_t);
    Eurydice_slice
    uu____7 = Eurydice_slice_subslice2(out[3U], start + (size_t)8U, start + (size_t)16U, uint8_t);
    Eurydice_slice_copy(uu____7,
...
KRML_ATTRIBUTE_TARGET("avx2")
static KRML_MUSTINLINE void
libcrux_sha3_simd_avx2_store_block_full_5b(__m256i (*state)[5U], uint8_t (*out)[200U])
{
  Eurydice_slice_uint8_t_200size_t__x2
  uu____0 =
    Eurydice_slice_split_at_mut(Eurydice_array_to_slice((size_t)4U, out, uint8_t [200U]),
      (size_t)1U,
      uint8_t [200U],
      Eurydice_slice_uint8_t_200size_t__x2);
  ...
  Eurydice_slice_uint8_t_200size_t__x2
  uu____1 =
    Eurydice_slice_split_at_mut(rest0,
      (size_t)1U,
      uint8_t [200U],
      Eurydice_slice_uint8_t_200size_t__x2);
  ...
  Eurydice_slice_uint8_t_200size_t__x2
  uu____2 =
    Eurydice_slice_split_at_mut(rest,
      (size_t)1U,
      uint8_t [200U],
      Eurydice_slice_uint8_t_200size_t__x2);
  ...
  buf[4U] =
    {
      Eurydice_array_to_slice((size_t)200U,
        Eurydice_slice_index(out0, (size_t)0U, uint8_t [200U], uint8_t (*)[200U]),
        uint8_t),
      Eurydice_array_to_slice((size_t)200U,
        Eurydice_slice_index(out1, (size_t)0U, uint8_t [200U], uint8_t (*)[200U]),
        uint8_t),
      Eurydice_array_to_slice((size_t)200U,
        Eurydice_slice_index(out2, (size_t)0U, uint8_t [200U], uint8_t (*)[200U]),
        uint8_t),
      Eurydice_array_to_slice((size_t)200U,
        Eurydice_slice_index(out3, (size_t)0U, uint8_t [200U], uint8_t (*)[200U]),
        uint8_t)
    };
...
KRML_ATTRIBUTE_TARGET("avx2")
static KRML_MUSTINLINE void
libcrux_sha3_simd_avx2_store_block_full_ef_5b(__m256i (*state)[5U], uint8_t (*out)[200U])
{
...
KRML_ATTRIBUTE_TARGET("avx2")
static KRML_MUSTINLINE void
libcrux_sha3_simd_avx2_store_block_ef_5b(__m256i (*a)[5U], Eurydice_slice *b)
{
...
KRML_ATTRIBUTE_TARGET("avx2")
static KRML_MUSTINLINE void
libcrux_sha3_generic_keccak_squeeze_first_block_97(
  libcrux_sha3_generic_keccak_KeccakState_55 *s,
  Eurydice_slice *out
)
{
...
KRML_ATTRIBUTE_TARGET("avx2")
static KRML_MUSTINLINE void
libcrux_sha3_generic_keccak_squeeze_next_block_97(
  libcrux_sha3_generic_keccak_KeccakState_55 *s,
  Eurydice_slice *out
)
{
...
KRML_ATTRIBUTE_TARGET("avx2")
static KRML_MUSTINLINE void
libcrux_sha3_generic_keccak_squeeze_last_97(
  libcrux_sha3_generic_keccak_KeccakState_55 s,
  Eurydice_slice out[4U]
)
{
...
KRML_ATTRIBUTE_TARGET("avx2")
static KRML_MUSTINLINE void
libcrux_sha3_generic_keccak_keccak_fb(Eurydice_slice *data, Eurydice_slice out[4U])
{
  libcrux_sha3_generic_keccak_KeccakState_55 s = libcrux_sha3_generic_keccak_new_89_a6();
  ...
  else
  {
    ...
    uu____2 = libcrux_sha3_simd_avx2_split_at_mut_n_ef(out, (size_t)136U);
    ...
    while (true)
    {
      ...
      {
        Eurydice_slice_uint8_t_4size_t__x2
        uu____3 = libcrux_sha3_simd_avx2_split_at_mut_n_ef(o1, (size_t)136U);
        Eurydice_slice o[4U];
...
KRML_ATTRIBUTE_TARGET("avx2")
static KRML_MUSTINLINE void
libcrux_sha3_simd_avx2_store_block_3a(__m256i (*s)[5U], Eurydice_slice *out)
{
  for (size_t i = (size_t)0U; i < (size_t)168U / (size_t)32U; i++)
  {
    size_t i0 = i;
...
KRML_ATTRIBUTE_TARGET("avx2")
static KRML_MUSTINLINE void
libcrux_sha3_simd_avx2_store_block_ef_3a(__m256i (*a)[5U], Eurydice_slice *b)
{
...
KRML_ATTRIBUTE_TARGET("avx2")
static KRML_MUSTINLINE void
libcrux_sha3_generic_keccak_squeeze_first_block_970(
  libcrux_sha3_generic_keccak_KeccakState_55 *s,
  Eurydice_slice *out
)
{
...
KRML_ATTRIBUTE_TARGET("avx2")
static KRML_MUSTINLINE void
libcrux_sha3_generic_keccak_squeeze_next_block_970(
  libcrux_sha3_generic_keccak_KeccakState_55 *s,
  Eurydice_slice *out
)
{
...
{
  Eurydice_slice_uint8_t_4size_t__x2
  uu____0 = libcrux_sha3_simd_avx2_split_at_mut_n_ef(out, (size_t)168U);
  Eurydice_slice o0[4U];
  ...
  Eurydice_slice_uint8_t_4size_t__x2
  uu____1 = libcrux_sha3_simd_avx2_split_at_mut_n_ef(o10, (size_t)168U);
  Eurydice_slice o1[4U];
  ...
  Eurydice_slice_uint8_t_4size_t__x2
  uu____2 = libcrux_sha3_simd_avx2_split_at_mut_n_ef(o20, (size_t)168U);
  ...
  Eurydice_slice_uint8_t_4size_t__x2
  uu____3 = libcrux_sha3_simd_avx2_split_at_mut_n_ef(o30, (size_t)168U);
