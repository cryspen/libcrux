...
#[inline(never)]
fn keygen(seed: [u8; 32]) -> ml_dsa_65::MLDSA65KeyPair {
    ml_dsa_65::generate_key_pair(seed)
}

#[inline(never)]
fn sign(
    signing_key: &ml_dsa_65::MLDSA65SigningKey,
    message: &[u8],
    randomness: [u8; 32],
) -> ml_dsa_65::MLDSA65Signature {
    ml_dsa_65::sign(signing_key, message, randomness)
}

#[inline(never)]
fn verify(
    verification_key: &ml_dsa_65::MLDSA65VerificationKey,
    message: &[u8],
