...
use instantiations::avx2::{
    generate_key_pair as generate_key_pair_avx2, sign as sign_avx2, verify as verify_avx2,
};

#[cfg(feature = "simd128")]
use instantiations::neon::{
    generate_key_pair as generate_key_pair_neon, sign as sign_neon, verify as verify_neon,
};
