...
fn invert_ntt_at_layer_0<SIMDUnit: Operations>(re: &mut PolynomialRingElement<SIMDUnit>) {
    ...
    fn round<SIMDUnit: Operations>(
        ...
        (re.simd_units[index], re.simd_units[index + 1]) = SIMDUnit::invert_ntt_at_layer_0(
            re.simd_units[index],
            re.simd_units[index + 1],
            zeta00,
            zeta01,
            zeta02,
            zeta03,
...
fn invert_ntt_at_layer_1<SIMDUnit: Operations>(re: &mut PolynomialRingElement<SIMDUnit>) {
    ...
    fn round<SIMDUnit: Operations>(
        ...
        (re.simd_units[index], re.simd_units[index + 1]) = SIMDUnit::invert_ntt_at_layer_1(
            re.simd_units[index],
            re.simd_units[index + 1],
            zeta_00,
            zeta_01,
...
fn invert_ntt_at_layer_2<SIMDUnit: Operations>(re: &mut PolynomialRingElement<SIMDUnit>) {
    fn round<SIMDUnit: Operations>(
        ...
        (re.simd_units[index], re.simd_units[index + 1]) = SIMDUnit::invert_ntt_at_layer_2(
            re.simd_units[index],
            re.simd_units[index + 1],
            zeta1,
            zeta2,
