...
#[hax_lib::fstar::before(r#"
    let is_i32b_polynomial (b:nat) (re:t_Array Libcrux_ml_dsa.Simd.Portable.Vector_type.t_Coefficients $SIMD_UNITS_IN_RING_ELEMENT) = 
...
fn ntt_at_layer_0(re: &mut [Coefficients; SIMD_UNITS_IN_RING_ELEMENT]) {
    ...
    #[hax_lib::ensures(|_| fstar!(r#"
        forall i. i < v $SIMD_UNITS_IN_RING_ELEMENT ==>
                  (i <> v index ==> (Seq.index ${re}_future i) == (Seq.index ${re} i))
     "#))]
    fn round(
