use crate::simd::avx2::simd_unit_type::*;
...
#[inline(always)]
fn deserialize_when_gamma1_is_2_pow_17(serialized: &[u8]) -> AVX2SIMDUnit {
    // Each set of 9 bytes deserializes to 4 elements, and since each AVX2SIMDUnit
...
#[inline(always)]
fn deserialize_when_gamma1_is_2_pow_19(serialized: &[u8]) -> AVX2SIMDUnit {
    // Each set of 5 bytes deserializes to 2 elements, and since each AVX2SIMDUnit
...
#[inline(always)]
pub(crate) fn deserialize<const GAMMA1_EXPONENT: usize>(serialized: &[u8]) -> AVX2SIMDUnit {
