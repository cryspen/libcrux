...
#[inline(always)]
pub fn add(lhs: &AVX2SIMDUnit, rhs: &AVX2SIMDUnit) -> AVX2SIMDUnit {
    let mut sum = ZERO();
...
#[inline(always)]
pub fn subtract(lhs: &AVX2SIMDUnit, rhs: &AVX2SIMDUnit) -> AVX2SIMDUnit {
...
#[inline(always)]
pub(crate) fn montgomery_multiply_by_constant(mut simd_unit: AVX2SIMDUnit, c: i32) -> AVX2SIMDUnit {
...
#[inline(always)]
pub(crate) fn montgomery_multiply(lhs: &AVX2SIMDUnit, rhs: &AVX2SIMDUnit) -> AVX2SIMDUnit {
...
pub fn power2round(simd_unit: AVX2SIMDUnit) -> (AVX2SIMDUnit, AVX2SIMDUnit) {
...
// additional KATs.
#[inline(always)]
pub fn infinity_norm_exceeds(simd_unit: AVX2SIMDUnit, bound: i32) -> bool {
...
#[inline(always)]
pub fn shift_left_then_reduce(simd_unit: AVX2SIMDUnit, shift_by: usize) -> AVX2SIMDUnit {
    let mut out = ZERO();
...
#[inline(always)]
pub fn decompose<const GAMMA2: i32>(simd_unit: AVX2SIMDUnit) -> (AVX2SIMDUnit, AVX2SIMDUnit) {
    let mut low = ZERO();
    let mut high = ZERO();
...
#[inline(always)]
pub fn use_hint<const GAMMA2: i32>(simd_unit: AVX2SIMDUnit, hint: AVX2SIMDUnit) -> AVX2SIMDUnit {
    let mut result = ZERO();
