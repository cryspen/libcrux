...
impl<SIMDUnit: Operations> PolynomialRingElement<SIMDUnit> {
    ...
    #[hax_lib::requires(fstar!(r#"v $bound > 0 /\ 
        (forall i. Spec.Utils.is_i32b_array_opaque 
            (v ${FIELD_MAX}) 
            (i1._super_1586179615636010033.f_repr (Seq.index self.f_simd_units i)))"#))]
    ...
    #[hax_lib::requires(fstar!(r#"forall i. 
        add_pre (i1._super_1586179615636010033.f_repr (Seq.index self.f_simd_units i)) 
                (i1._super_1586179615636010033.f_repr (Seq.index rhs.f_simd_units i))"#))]
    ...
    #[inline(always)]
    #[hax_lib::requires(fstar!(r#"forall i. 
        sub_pre (i1._super_1586179615636010033.f_repr (Seq.index self.f_simd_units i)) 
                (i1._super_1586179615636010033.f_repr (Seq.index rhs.f_simd_units i))"#))]
