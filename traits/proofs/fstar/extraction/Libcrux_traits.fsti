module Libcrux_traits
#set-options "--fuel 0 --ifuel 1 --z3rlimit 15"
open Core
open FStar.Mul

class t_GenericOperations (v_Self: Type) = {
  f_montgomery_multiply_fe_by_fer_pre:v_Self -> i16 -> bool;
  f_montgomery_multiply_fe_by_fer_post:v_Self -> i16 -> v_Self -> bool;
  f_montgomery_multiply_fe_by_fer:x0: v_Self -> x1: i16
    -> Prims.Pure v_Self
...
class t_Operations (v_Self: Type) = {
  ...
  f_from_i16_array_pre:t_Array i16 (sz 16) -> bool;
  f_from_i16_array_post:t_Array i16 (sz 16) -> v_Self -> bool;
  f_from_i16_array:x0: t_Array i16 (sz 16)
  ...
  f_multiply_by_constant_pre:v_Self -> i16 -> bool;
  f_multiply_by_constant_post:v_Self -> i16 -> v_Self -> bool;
  ...
  f_bitwise_and_with_constant_pre:v_Self -> i16 -> bool;
  f_bitwise_and_with_constant_post:v_Self -> i16 -> v_Self -> bool;
  ...
  f_montgomery_multiply_by_constant_pre:v_Self -> i16 -> bool;
  f_montgomery_multiply_by_constant_post:v_Self -> i16 -> v_Self -> bool;
  ...
  f_ntt_layer_2_step_pre:v_Self -> i16 -> i16 -> bool;
  f_ntt_layer_2_step_post:v_Self -> i16 -> i16 -> v_Self -> bool;
  ...
  f_ntt_layer_3_step_pre:v_Self -> i16 -> bool;
  f_ntt_layer_3_step_post:v_Self -> i16 -> v_Self -> bool;
  f_ntt_layer_3_step:x0: v_Self -> x1: i16
    -> Prims.Pure v_Self
        (f_ntt_layer_3_step_pre x0 x1)
        (fun result -> f_ntt_layer_3_step_post x0 x1 result);
  f_inv_ntt_layer_1_step_pre:v_Self -> i16 -> i16 -> i16 -> i16 -> bool;
  f_inv_ntt_layer_1_step_post:v_Self -> i16 -> i16 -> i16 -> i16 -> v_Self -> bool;
  ...
  f_inv_ntt_layer_2_step_pre:v_Self -> i16 -> i16 -> bool;
  f_inv_ntt_layer_2_step_post:v_Self -> i16 -> i16 -> v_Self -> bool;
  ...
  f_inv_ntt_layer_3_step_pre:v_Self -> i16 -> bool;
  f_inv_ntt_layer_3_step_post:v_Self -> i16 -> v_Self -> bool;
  ...
  f_ntt_multiply_pre:v_Self -> v_Self -> i16 -> i16 -> i16 -> i16 -> bool;
  f_ntt_multiply_post:v_Self -> v_Self -> i16 -> i16 -> i16 -> i16 -> v_Self -> bool;
  ...
  f_serialize_1_post:v_Self -> t_Array u8 (sz 2) -> bool;
  f_serialize_1_:x0: v_Self
    -> Prims.Pure (t_Array u8 (sz 2))
        (f_serialize_1_pre x0)
        (fun result -> f_serialize_1_post x0 result);
  f_deserialize_1_pre:t_Slice u8 -> bool;
  f_deserialize_1_post:t_Slice u8 -> v_Self -> bool;
  ...
  f_serialize_4_post:v_Self -> t_Array u8 (sz 8) -> bool;
  ...
  f_serialize_5_post:v_Self -> t_Array u8 (sz 10) -> bool;
  ...
  f_serialize_10_post:v_Self -> t_Array u8 (sz 20) -> bool;
  ...
  f_serialize_11_post:v_Self -> t_Array u8 (sz 22) -> bool;
  ...
  f_serialize_12_post:v_Self -> t_Array u8 (sz 24) -> bool;
  ...
  f_rej_sample_pre:t_Slice u8 -> bool;
  f_rej_sample_post:t_Slice u8 -> (usize & t_Array i16 (sz 16)) -> bool;
  f_rej_sample:x0: t_Slice u8
    -> Prims.Pure (usize & t_Array i16 (sz 16))
        (f_rej_sample_pre x0)
        (fun result -> f_rej_sample_post x0 result)
}
...
let impl
  ...
  {
    f_montgomery_multiply_fe_by_fer_pre = (fun (v: v_T) (fer: i16) -> true);
