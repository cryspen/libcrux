...
class t_GenericOperations (v_Self: Type0) = {
...
class t_Operations (v_Self: Type0) = {
  [@@@ FStar.Tactics.Typeclasses.no_method]_super_14285531652857523276:Core.Marker.t_Copy v_Self;
  ...
  f_from_i16_array_pre:t_Slice i16 -> bool;
  ...
  f_rej_sample_pre:t_Slice u8 -> t_Slice i16 -> bool;
  f_rej_sample_post:t_Slice u8 -> t_Slice i16 -> (t_Slice i16 & usize) -> bool;
