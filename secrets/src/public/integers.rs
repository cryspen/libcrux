use super::sequences::array::SecretArray;
use crate::traits::*;
use core::ops::*;
    ...
    T::Output: Scalar,
{
    ...
    fn add(self, rhs: V) -> Self::Output {
        self.0.add(rhs.into().declassify()).classify()
    }
}
    ...
    T::Output: Scalar,
{
    ...
    fn sub(self, rhs: V) -> Self::Output {
        self.0.sub(rhs.into().declassify()).into()
    }
}
    ...
    T::Output: Scalar,
{
    ...
    fn mul(self, rhs: V) -> Self::Output {
        self.0.mul(rhs.into().declassify()).into()
    }
}
    ...
    T::Output: Scalar,
{
    ...
    fn bitxor(self, rhs: V) -> Self::Output {
        self.0.bitxor(rhs.into().declassify()).into()
    }
}
