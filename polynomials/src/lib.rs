...
fn from_i16_array(array: &[i16]) -> PortableVector {
    PortableVector { elements: array[0..16].try_into().unwrap() }
}
...
#[inline(always)]
fn ntt_layer_3_step(mut v: PortableVector, zeta: i16) -> PortableVector {
...
#[inline(always)]
fn inv_ntt_layer_3_step(mut v: PortableVector, zeta: i16) -> PortableVector {
...
#[inline(always)]
fn serialize_1(v: PortableVector) -> [u8; 2] {
...
#[inline(always)]
fn serialize_4(v: PortableVector) -> [u8; 8] {
...
#[inline(always)]
fn serialize_5(v: PortableVector) -> [u8; 10] {
...
#[inline(always)]
fn serialize_10(v: PortableVector) -> [u8; 20] {
...
#[inline(always)]
fn serialize_11(v: PortableVector) -> [u8; 22] {
...
#[inline(always)]
fn serialize_12(v: PortableVector) -> [u8; 24] {
