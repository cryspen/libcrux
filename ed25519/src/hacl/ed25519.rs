...
fn times_d(out: &mut [u64], a: &[u64]) {
    ...
    crate::hacl::ed25519::fmul(out, &d, a)
}

#[inline]
fn times_2d(out: &mut [u64], a: &[u64]) {
    ...
    crate::hacl::ed25519::fmul(out, &d2, a)
}
...
pub(crate) fn load_51(output: &mut [u64], input: &[u8]) {
    ...
    output[1usize] = ((&u64s)[0usize]).wrapping_shr(51u32)
        | ((&u64s)[1usize] & 0x3fffffffffu64).wrapping_shl(13u32);
    output[2usize] = ((&u64s)[1usize]).wrapping_shr(38u32)
        | ((&u64s)[2usize] & 0x1ffffffu64).wrapping_shl(26u32);
    output[3usize] =
...
pub(crate) fn point_double(out: &mut [u64], p: &[u64]) {
    ...
    crate::hacl::ed25519::fsquare(tmp2.0, y1.0);
    crate::hacl::ed25519::fsquare(tmp3.0, z1.0);
    crate::hacl::ed25519::fsum(tmp4.0, tmp2.0, tmp3.0);
    crate::hacl::ed25519::fdifference(tmp4.1, tmp2.0, tmp3.0);
    crate::hacl::ed25519::fsquare(tmp2.0, z1.1);
    let mut a_copy: [u64; 5] = [0u64; 5usize];
    ((&mut a_copy)[0usize..5usize]).copy_from_slice(&tmp2.0[0usize..5usize]);
    crate::hacl::ed25519::times_2(tmp2.0, &a_copy);
    ...
    crate::hacl::ed25519::fsum(tmp20.1, x10.1, y10.1);
    let mut a_copy0: [u64; 5] = [0u64; 5usize];
    ((&mut a_copy0)[0usize..5usize]).copy_from_slice(&tmp20.1[0usize..5usize]);
    crate::hacl::ed25519::fsquare(tmp20.1, &a_copy0);
    crate::hacl::ed25519::reduce_513(tmp30.1);
    let mut b_copy: [u64; 5] = [0u64; 5usize];
    ((&mut b_copy)[0usize..5usize]).copy_from_slice(&tmp20.1[0usize..5usize]);
    crate::hacl::ed25519::fdifference(tmp20.1, tmp30.1, &b_copy);
    crate::hacl::ed25519::reduce_513(tmp10.1);
    crate::hacl::ed25519::reduce_513(tmp40.1);
    let mut a_copy1: [u64; 5] = [0u64; 5usize];
    ((&mut a_copy1)[0usize..5usize]).copy_from_slice(&tmp10.1[0usize..5usize]);
    crate::hacl::ed25519::fsum(tmp10.1, &a_copy1, tmp40.1);
    ...
    crate::hacl::ed25519::fmul(y3.0, tmp_e.1, tmp_f.1);
    crate::hacl::ed25519::fmul(z3.0, tmp_g.1, tmp_h.1);
    crate::hacl::ed25519::fmul(t3.1, tmp_e.1, tmp_h.1);
    crate::hacl::ed25519::fmul(t3.0, tmp_f.1, tmp_g.1)
}
...
pub(crate) fn point_add(out: &mut [u64], p: &[u64], q: &[u64]) {
    ...
    crate::hacl::ed25519::fdifference(tmp2.0, y1.1, y1.0);
    crate::hacl::ed25519::fdifference(tmp3.0, y2.1, y2.0);
    crate::hacl::ed25519::fmul(tmp4.0, tmp2.0, tmp3.0);
    crate::hacl::ed25519::fsum(tmp2.0, y1.1, y1.0);
    crate::hacl::ed25519::fsum(tmp3.0, y2.1, y2.0);
    crate::hacl::ed25519::fmul(tmp4.1, tmp2.0, tmp3.0);
    let tmp10: (&mut [u64], &mut [u64]) = tmp2.0.split_at_mut(0usize);
    let tmp20: (&mut [u64], &mut [u64]) = tmp3.0.split_at_mut(0usize);
    ...
    crate::hacl::ed25519::times_2d(tmp10.1, t1.1);
    let mut inp_copy: [u64; 5] = [0u64; 5usize];
    ((&mut inp_copy)[0usize..5usize]).copy_from_slice(&tmp10.1[0usize..5usize]);
    crate::hacl::ed25519::fmul(tmp10.1, &inp_copy, t2.1);
    crate::hacl::ed25519::times_2(tmp20.1, t1.0);
    let mut inp_copy0: [u64; 5] = [0u64; 5usize];
    ((&mut inp_copy0)[0usize..5usize]).copy_from_slice(&tmp20.1[0usize..5usize]);
    crate::hacl::ed25519::fmul(tmp20.1, &inp_copy0, t2.0);
    crate::hacl::ed25519::fdifference(tmp6.0, tmp5.0, tmp30.1);
    crate::hacl::ed25519::fdifference(tmp6.1, tmp20.1, tmp10.1);
    let mut a_copy: [u64; 5] = [0u64; 5usize];
    ((&mut a_copy)[0usize..5usize]).copy_from_slice(&tmp10.1[0usize..5usize]);
    crate::hacl::ed25519::fsum(tmp10.1, &a_copy, tmp20.1);
    crate::hacl::ed25519::fsum(tmp20.1, tmp5.0, tmp30.1);
...
#[inline]
fn pow2_252m2(out: &mut [u64], z: &[u64]) {
    ...
    crate::hacl::ed25519::fsquare_times(t0.0, z, 1u32);
    crate::hacl::ed25519::fsquare_times(b.0, t0.0, 2u32);
    crate::hacl::ed25519::fmul(c.0, b.0, z);
    let mut inp_copy: [u64; 5] = [0u64; 5usize];
    ((&mut inp_copy)[0usize..5usize]).copy_from_slice(&t0.0[0usize..5usize]);
    crate::hacl::ed25519::fmul(t0.0, &inp_copy, c.0);
    crate::hacl::ed25519::fsquare_times(b.0, t0.0, 1u32);
    let mut inp_copy0: [u64; 5] = [0u64; 5usize];
    ((&mut inp_copy0)[0usize..5usize]).copy_from_slice(&c.0[0usize..5usize]);
    crate::hacl::ed25519::fmul(c.0, &inp_copy0, b.0);
    crate::hacl::ed25519::fsquare_times(b.0, c.0, 5u32);
    let mut inp_copy1: [u64; 5] = [0u64; 5usize];
    ((&mut inp_copy1)[0usize..5usize]).copy_from_slice(&c.0[0usize..5usize]);
    crate::hacl::ed25519::fmul(c.0, &inp_copy1, b.0);
    crate::hacl::ed25519::fsquare_times(b.0, c.0, 10u32);
    crate::hacl::ed25519::fmul(c.1, b.0, c.0);
    crate::hacl::ed25519::fsquare_times(b.0, c.1, 20u32);
    let mut inp_copy2: [u64; 5] = [0u64; 5usize];
    ((&mut inp_copy2)[0usize..5usize]).copy_from_slice(&b.0[0usize..5usize]);
    crate::hacl::ed25519::fmul(b.0, &inp_copy2, c.1);
    crate::hacl::ed25519::fsquare_times_inplace(b.0, 10u32);
    let mut inp_copy3: [u64; 5] = [0u64; 5usize];
    ((&mut inp_copy3)[0usize..5usize]).copy_from_slice(&c.0[0usize..5usize]);
    crate::hacl::ed25519::fmul(c.0, &inp_copy3, b.0);
    crate::hacl::ed25519::fsquare_times(b.0, c.0, 50u32);
    ...
    crate::hacl::ed25519::fsquare_times(a0.1, z, 1u32);
    crate::hacl::ed25519::fmul(c0.1, t00.1, b0.1);
    crate::hacl::ed25519::fsquare_times(t00.1, c0.1, 100u32);
    let mut inp_copy4: [u64; 5] = [0u64; 5usize];
    ((&mut inp_copy4)[0usize..5usize]).copy_from_slice(&t00.1[0usize..5usize]);
    crate::hacl::ed25519::fmul(t00.1, &inp_copy4, c0.1);
    crate::hacl::ed25519::fsquare_times_inplace(t00.1, 50u32);
    let mut inp_copy5: [u64; 5] = [0u64; 5usize];
    ((&mut inp_copy5)[0usize..5usize]).copy_from_slice(&t00.1[0usize..5usize]);
    crate::hacl::ed25519::fmul(t00.1, &inp_copy5, b0.1);
    crate::hacl::ed25519::fsquare_times_inplace(t00.1, 2u32);
    crate::hacl::ed25519::fmul(out, t00.1, a0.1)
}
...
fn mul_modp_sqrt_m1(x: &mut [u64]) {
    ...
    crate::hacl::ed25519::fmul(x, &inp_copy, &sqrt_m1)
}

#[inline]
fn recover_x(x: &mut [u64], y: &[u64], sign: u64) -> bool {
    ...
    let x3: u64 = y[3usize];
    let x4: u64 = y[4usize];
    let b: bool = x0 >= 0x7ffffffffffedu64
        && x1 == 0x7ffffffffffffu64
        && x21 == 0x7ffffffffffffu64
    ...
    let res: bool = if b {
        ...
        y2.0[3usize] = 0u64;
        y2.0[4usize] = 0u64;
        crate::hacl::ed25519::fsquare(dyyi.0, y);
        crate::hacl::ed25519::times_d(dyy.1, dyyi.0);
        let mut a_copy: [u64; 5] = [0u64; 5usize];
        ((&mut a_copy)[0usize..5usize]).copy_from_slice(&dyy.1[0usize..5usize]);
        crate::hacl::ed25519::fsum(dyy.1, &a_copy, y2.0);
        crate::hacl::ed25519::reduce_513(dyy.1);
        crate::hacl::ed25519::inverse(dyy.0, dyy.1);
        crate::hacl::ed25519::fdifference(x2.1, dyyi.0, y2.0);
        let mut inp_copy: [u64; 5] = [0u64; 5usize];
        ((&mut inp_copy)[0usize..5usize]).copy_from_slice(&x2.1[0usize..5usize]);
        crate::hacl::ed25519::fmul(x2.1, &inp_copy, dyy.0);
        crate::hacl::ed25519::reduce(x2.1);
        let x2_is_0: bool = crate::hacl::ed25519::is_0(x2.1);
        let z: u8 = if x2_is_0 {
            if sign == 0u64 {
                x[0usize] = 0u64;
                x[1usize] = 0u64;
        ...
        if z == 0u8 {
            ...
            crate::hacl::ed25519::pow2_252m2(t0.0, x30.0);
            crate::hacl::ed25519::fsquare(t0.1, t0.0);
            let mut a_copy0: [u64; 5] = [0u64; 5usize];
            ((&mut a_copy0)[0usize..5usize]).copy_from_slice(&t0.1[0usize..5usize]);
            crate::hacl::ed25519::fdifference(t0.1, &a_copy0, x30.0);
            crate::hacl::ed25519::reduce_513(t0.1);
            crate::hacl::ed25519::reduce(t0.1);
            let t0_is_0: bool = crate::hacl::ed25519::is_0(t0.1);
            if !t0_is_0 {
                crate::hacl::ed25519::mul_modp_sqrt_m1(t0.0)
            };
            ...
            crate::hacl::ed25519::fsquare(t00.1, x31.1);
            let mut a_copy1: [u64; 5] = [0u64; 5usize];
            ((&mut a_copy1)[0usize..5usize]).copy_from_slice(&t00.1[0usize..5usize]);
            crate::hacl::ed25519::fdifference(t00.1, &a_copy1, x211.1);
            crate::hacl::ed25519::reduce_513(t00.1);
            crate::hacl::ed25519::reduce(t00.1);
            let z1: bool = crate::hacl::ed25519::is_0(t00.1);
            if z1 {
                let x32: (&mut [u64], &mut [u64]) = x31.1.split_at_mut(0usize);
                let t01: (&mut [u64], &mut [u64]) = t00.1.split_at_mut(0usize);
                crate::hacl::ed25519::reduce(x32.1);
                ...
                if x01 != sign {
                    ...
                    crate::hacl::ed25519::fdifference(x32.1, t01.1, &b_copy);
                    crate::hacl::ed25519::reduce_513(x32.1);
                    crate::hacl::ed25519::reduce(x32.1)
                };
...
pub(crate) fn point_decompress(out: &mut [u64], s: &[u8]) -> bool {
    ...
    crate::hacl::ed25519::load_51(x.0, s);
    let z0: bool = crate::hacl::ed25519::recover_x(x.1, x.0, sign);
    let res: bool = if z0 {
        ...
        outt.0[3usize] = 0u64;
        outt.0[4usize] = 0u64;
        crate::hacl::ed25519::fmul(outt.1, x.1, x.0);
        true
    } else {
        false
    };
...
pub(crate) fn point_compress(z: &mut [u8], p: &[u64]) {
    ...
    crate::hacl::ed25519::inverse(x.0, pz.1);
    crate::hacl::ed25519::fmul(out.0, py.0, x.0);
    crate::hacl::ed25519::reduce(out.0);
    crate::hacl::ed25519::fmul(out.1, pz.0, x.0);
    crate::hacl::ed25519::reduce_513(out.1);
    let x0: (&[u64], &[u64]) = out.0.split_at(0usize);
    let out0: (&[u64], &[u64]) = out.1.split_at(0usize);
    let x00: u64 = x0.1[0usize];
    let b: u64 = x00 & 1u64;
    crate::hacl::ed25519::store_51(z, out0.1);
...
#[inline]
fn barrett_reduction(z: &mut [u64], t: &[u64]) {
    let t0: u64 = t[0usize];
    let t1: u64 = t[1usize];
    let t2: u64 = t[2usize];
    let t3: u64 = t[3usize];
    ...
    let z30: fstar::uint128::uint128 = fstar::uint128::add_mod(
        fstar::uint128::add_mod(fstar::uint128::add_mod(xy03, xy12), xy21),
        xy30,
    );
    let z40: fstar::uint128::uint128 = fstar::uint128::add_mod(
    ...
    let z5: fstar::uint128::uint128 = fstar::uint128::add_mod(
    ...
    let t01: u64 = t104;
    let carry9: fstar::uint128::uint128 = fstar::uint128::shift_right(
        fstar::uint128::add_mod(fstar::uint128::add_mod(xy010, xy100), c00),
        56u32,
    );
    let t105: u64 = fstar::uint128::uint128_to_uint64(fstar::uint128::add_mod(
        fstar::uint128::add_mod(xy010, xy100),
        c00,
    )) & 0xffffffffffffffu64;
    let c10: fstar::uint128::uint128 = carry9;
    let t11: u64 = t105;
    let carry10: fstar::uint128::uint128 = fstar::uint128::shift_right(
        fstar::uint128::add_mod(
    ...
    let t106: u64 = fstar::uint128::uint128_to_uint64(fstar::uint128::add_mod(
        fstar::uint128::add_mod(fstar::uint128::add_mod(xy020, xy110), xy200),
        c10,
    )) & 0xffffffffffffffu64;
    let c20: fstar::uint128::uint128 = carry10;
    let t21: u64 = t106;
    let carry11: fstar::uint128::uint128 = fstar::uint128::shift_right(
        fstar::uint128::add_mod(
            fstar::uint128::add_mod(
    ...
    let t107: u64 = fstar::uint128::uint128_to_uint64(fstar::uint128::add_mod(
        fstar::uint128::add_mod(
            fstar::uint128::add_mod(fstar::uint128::add_mod(xy030, xy120), xy210),
            xy300,
        ),
    ...
    let t31: u64 = t107;
    let t410: u64 = fstar::uint128::uint128_to_uint64(fstar::uint128::add_mod(
        fstar::uint128::add_mod(
            fstar::uint128::add_mod(
    ...
    let t109: u64 = b0
        .wrapping_shl(56u32)
        .wrapping_add(r1)
        .wrapping_sub(qmul1.wrapping_add(c11));
    let c21: u64 = b0;
    let t110: u64 = t109;
    ...
    let t1010: u64 = b1
        .wrapping_shl(56u32)
        .wrapping_add(r2)
        .wrapping_sub(qmul2.wrapping_add(c21));
    let c31: u64 = b1;
    let t210: u64 = t1010;
    ...
    let t1011: u64 = b2
        .wrapping_shl(56u32)
        .wrapping_add(r3)
        .wrapping_sub(qmul3.wrapping_add(c31));
    let c40: u64 = b2;
    let t310: u64 = t1011;
    ...
    let t1012: u64 = b3
        .wrapping_shl(40u32)
        .wrapping_add(r4)
        .wrapping_sub(qmul4.wrapping_add(c40));
    let t411: u64 = t1012;
    let s0: u64 = t010;
    let s1: u64 = t110;
    let s2: u64 = t210;
    ...
    let t1014: u64 = b5
        .wrapping_shl(56u32)
        .wrapping_add(s1)
        .wrapping_sub(y1.wrapping_add(b00));
    let b10: u64 = b5;
    let t111: u64 = t1014;
    ...
    let t1015: u64 = b6
        .wrapping_shl(56u32)
        .wrapping_add(s2)
        .wrapping_sub(y2.wrapping_add(b10));
    let b20: u64 = b6;
    let t211: u64 = t1015;
    ...
    let t1016: u64 = b7
        .wrapping_shl(56u32)
        .wrapping_add(s3)
        .wrapping_sub(y3.wrapping_add(b20));
    let b30: u64 = b7;
    let t311: u64 = t1016;
    ...
    let t1017: u64 = b8
        .wrapping_shl(56u32)
        .wrapping_add(s4)
        .wrapping_sub(y4.wrapping_add(b30));
    let b40: u64 = b8;
    let t412: u64 = t1017;
...
#[inline]
fn mul_modq(out: &mut [u64], x: &[u64], y: &[u64]) {
    let mut tmp: [u64; 10] = [0u64; 10usize];
    let x0: u64 = x[0usize];
    let x1: u64 = x[1usize];
    let x2: u64 = x[2usize];
    ...
    let z2: fstar::uint128::uint128 =
        fstar::uint128::add_mod(fstar::uint128::add_mod(xy02, xy11), xy20);
    let z3: fstar::uint128::uint128 = fstar::uint128::add_mod(
        fstar::uint128::add_mod(fstar::uint128::add_mod(xy03, xy12), xy21),
        xy30,
    );
    let z4: fstar::uint128::uint128 = fstar::uint128::add_mod(
        fstar::uint128::add_mod(
            fstar::uint128::add_mod(fstar::uint128::add_mod(xy04, xy13), xy22),
            xy31,
        ),
    ...
    (&mut tmp)[8usize] = z80;
    (&mut tmp)[9usize] = z9;
    crate::hacl::ed25519::barrett_reduction(out, &tmp)
}

#[inline]
fn add_modq(out: &mut [u64], x: &[u64], y: &[u64]) {
    let x0: u64 = x[0usize];
    let x1: u64 = x[1usize];
    let x2: u64 = x[2usize];
    let x3: u64 = x[3usize];
    ...
    let t6: u64 = b1
        .wrapping_shl(56u32)
        .wrapping_add(t10)
        .wrapping_sub(y11.wrapping_add(b0));
    let b10: u64 = b1;
    let t11: u64 = t6;
    ...
    let t7: u64 = b2
        .wrapping_shl(56u32)
        .wrapping_add(t20)
        .wrapping_sub(y21.wrapping_add(b10));
    let b20: u64 = b2;
    let t21: u64 = t7;
    ...
    let t8: u64 = b3
        .wrapping_shl(56u32)
        .wrapping_add(t30)
        .wrapping_sub(y31.wrapping_add(b20));
    let b30: u64 = b3;
    let t31: u64 = t8;
    ...
    let t9: u64 = b4
        .wrapping_shl(56u32)
        .wrapping_add(t4)
        .wrapping_sub(y41.wrapping_add(b30));
    let b40: u64 = b4;
    let t41: u64 = t9;
    let mask: u64 = b40.wrapping_sub(1u64);
...
pub(crate) fn point_equal(p: &[u64], q: &[u64]) -> bool {
    ...
    crate::hacl::ed25519::fmul(qxpz.0, &p[0usize..], &q[10usize..]);
    crate::hacl::ed25519::reduce(qxpz.0);
    crate::hacl::ed25519::fmul(qxpz.1, &q[0usize..], &p[10usize..]);
    crate::hacl::ed25519::reduce(qxpz.1);
    let b: bool = crate::hacl::ed25519::eq(qxpz.0, qxpz.1);
    if b {
        let pyqz: (&mut [u64], &mut [u64]) = qxpz.1.split_at_mut(5usize);
        let qypz: (&mut [u64], &mut [u64]) = pyqz.1.split_at_mut(5usize);
        crate::hacl::ed25519::fmul(qypz.0, &p[5usize..], &q[10usize..]);
        crate::hacl::ed25519::reduce(qypz.0);
        crate::hacl::ed25519::fmul(qypz.1, &q[5usize..], &p[10usize..]);
        crate::hacl::ed25519::reduce(qypz.1);
        crate::hacl::ed25519::eq(qypz.0, qypz.1)
    } else {
        false
    }
}
...
pub(crate) fn point_negate(p: &[u64], out: &mut [u64]) {
    ...
    crate::hacl::ed25519::fdifference(y1.0, &zero, y.0);
    crate::hacl::ed25519::reduce_513(y1.0);
    (z1.0[0usize..5usize]).copy_from_slice(&z.0[0usize..5usize]);
    (t1.0[0usize..5usize]).copy_from_slice(&t.0[0usize..5usize]);
    crate::hacl::ed25519::fdifference(t1.1, &zero, t.1);
...
fn precomp_get_consttime(table: &[u64], bits_l: u64, tmp: &mut [u64]) {
    ...
    krml::unroll_for!(15, "i", 0u32, 1u32, {
        ...
        krml::unroll_for!(20, "i0", 0u32, 1u32, {
...
#[inline]
fn point_mul_g(out: &mut [u64], scalar: &[u8]) {
    ...
    krml::unroll_for!(16, "i", 0u32, 1u32, {
        ...
        crate::hacl::ed25519::precomp_get_consttime(
            &crate::hacl::ed25519_precomptable::precomp_g_pow2_192_table_w4,
            bits_l,
            &mut tmp,
        );
        ...
        crate::hacl::ed25519::point_add(out, &p_copy0, &tmp);
        ...
        crate::hacl::ed25519::point_add(out, &p_copy1, &tmp);
        ...
        crate::hacl::ed25519::point_add(out, &p_copy2, &tmp)
    });
...
#[inline]
fn point_mul_g_double_vartime(out: &mut [u64], scalar1: &[u8], scalar2: &[u8], q2: &[u64]) {
    ...
    krml::unroll_for!(15, "i", 0u32, 1u32, {
        ...
        ((&mut table2)[2u32.wrapping_mul(i).wrapping_add(2u32).wrapping_mul(20u32) as usize
            ..2u32.wrapping_mul(i).wrapping_add(2u32).wrapping_mul(20u32) as usize + 20usize])
            .copy_from_slice(&(&tmp1)[0usize..20usize]);
        let t2: (&[u64], &[u64]) =
            table2.split_at(2u32.wrapping_mul(i).wrapping_add(2u32).wrapping_mul(20u32) as usize);
        let mut p_copy0: [u64; 20] = [0u64; 20usize];
        ((&mut p_copy0)[0usize..20usize]).copy_from_slice(&q2[0usize..20usize]);
        crate::hacl::ed25519::point_add(&mut tmp1, &p_copy0, t2.1);
        ((&mut table2)[2u32.wrapping_mul(i).wrapping_add(3u32).wrapping_mul(20u32) as usize
    ...
    let a_bits_l: &[u64] = &(&crate::hacl::ed25519_precomptable::precomp_basepoint_table_w5)
        [bits_l32.wrapping_mul(20u32) as usize..];
    ...
    let mut p_copy: [u64; 20] = [0u64; 20usize];
    ((&mut p_copy)[0usize..20usize]).copy_from_slice(&out[0usize..20usize]);
    crate::hacl::ed25519::point_add(out, &p_copy, &tmp10);
    let mut tmp11: [u64; 20] = [0u64; 20usize];
    for i1 in 0u32..51u32 {
        krml::unroll_for!(5, "_i", 0u32, 1u32, {
            let mut p_copy0: [u64; 20] = [0u64; 20usize];
            ((&mut p_copy0)[0usize..20usize]).copy_from_slice(&out[0usize..20usize]);
            crate::hacl::ed25519::point_double(out, &p_copy0)
        });
        let k: u32 = 255u32
        ...
        let mut p_copy0: [u64; 20] = [0u64; 20usize];
        ((&mut p_copy0)[0usize..20usize]).copy_from_slice(&out[0usize..20usize]);
        crate::hacl::ed25519::point_add(out, &p_copy0, &tmp11);
        let k0: u32 = 255u32
            .wrapping_sub(5u32.wrapping_mul(i1))
            .wrapping_sub(5u32);
        ...
        let a_bits_l2: &[u64] = &(&crate::hacl::ed25519_precomptable::precomp_basepoint_table_w5)
            [bits_l322.wrapping_mul(20u32) as usize..];
        ((&mut tmp11)[0usize..20usize]).copy_from_slice(&a_bits_l2[0usize..20usize]);
        let mut p_copy1: [u64; 20] = [0u64; 20usize];
        ((&mut p_copy1)[0usize..20usize]).copy_from_slice(&out[0usize..20usize]);
        crate::hacl::ed25519::point_add(out, &p_copy1, &tmp11)
    }
}

#[inline]
fn point_negate_mul_double_g_vartime(out: &mut [u64], scalar1: &[u8], scalar2: &[u8], q2: &[u64]) {
    let mut q2_neg: [u64; 20] = [0u64; 20usize];
    crate::hacl::ed25519::point_negate(q2, &mut q2_neg);
    crate::hacl::ed25519::point_mul_g_double_vartime(out, scalar1, scalar2, &q2_neg)
}

#[inline]
fn store_56(out: &mut [u8], b: &[u64]) {
    let b0: u64 = b[0usize];
    let b1: u64 = b[1usize];
    let b2: u64 = b[2usize];
    let b3: u64 = b[3usize];
...
#[inline]
fn load_64_bytes(out: &mut [u64], b: &[u8]) {
...
#[inline]
fn load_32_bytes(out: &mut [u64], b: &[u8]) {
    let b8: (&[u8], &[u8]) = b.split_at(0usize);
    let u: u64 = lowstar::endianness::load64_le(b8.1);
    let z: u64 = u;
    let b0: u64 = z & 0xffffffffffffffu64;
...
#[inline]
fn sha512_modq_pre(out: &mut [u64], prefix: &[u8], len: u32, input: &[u8]) {
    let mut tmp: [u64; 10] = [0u64; 10usize];
    let mut hash: [u8; 64] = [0u8; 64usize];
    crate::hacl::ed25519::sha512_pre_msg(&mut hash, prefix, len, input);
    crate::hacl::ed25519::load_64_bytes(&mut tmp, &hash);
    crate::hacl::ed25519::barrett_reduction(out, &tmp)
}

#[inline]
fn sha512_modq_pre_pre2(out: &mut [u64], prefix: &[u8], prefix2: &[u8], len: u32, input: &[u8]) {
    let mut tmp: [u64; 10] = [0u64; 10usize];
    let mut hash: [u8; 64] = [0u8; 64usize];
    crate::hacl::ed25519::sha512_pre_pre2_msg(&mut hash, prefix, prefix2, len, input);
    crate::hacl::ed25519::load_64_bytes(&mut tmp, &hash);
    crate::hacl::ed25519::barrett_reduction(out, &tmp)
}

#[inline]
fn point_mul_g_compress(out: &mut [u8], s: &[u8]) {
    let mut tmp: [u64; 20] = [0u64; 20usize];
    crate::hacl::ed25519::point_mul_g(&mut tmp, s);
    crate::hacl::ed25519::point_compress(out, &tmp)
}
...
pub fn secret_to_public(public_key: &mut [u8], private_key: &[u8]) {
    ...
    crate::hacl::ed25519::secret_expand(&mut expanded_secret, private_key);
    let a: (&[u8], &[u8]) = expanded_secret.split_at(0usize);
    crate::hacl::ed25519::point_mul_g_compress(public_key, a.1)
}
...
pub fn expand_keys(expanded_keys: &mut [u8], private_key: &[u8]) {
    ...
    crate::hacl::ed25519::secret_expand(s_prefix.1, private_key);
    let public_key: (&mut [u8], &mut [u8]) = s_prefix.0.split_at_mut(0usize);
    let s: (&[u8], &[u8]) = s_prefix.1.split_at(0usize);
    crate::hacl::ed25519::point_mul_g_compress(public_key.1, s.1)
}
...
pub fn sign_expanded(signature: &mut [u8], expanded_keys: &[u8], msg_len: u32, msg: &[u8]) {
    ...
    crate::hacl::ed25519::sha512_modq_pre(&mut rq, prefix.1, msg_len, msg);
    crate::hacl::ed25519::store_56(&mut rb, &rq);
    crate::hacl::ed25519::point_mul_g_compress(ss.0, &rb);
    crate::hacl::ed25519::sha512_modq_pre_pre2(&mut hq, ss.0, s.0, msg_len, msg);
    let mut aq: [u64; 5] = [0u64; 5usize];
    crate::hacl::ed25519::load_32_bytes(&mut aq, prefix.0);
    let mut y_copy: [u64; 5] = [0u64; 5usize];
    ((&mut y_copy)[0usize..5usize]).copy_from_slice(&(&aq)[0usize..5usize]);
    crate::hacl::ed25519::mul_modq(&mut aq, &hq, &y_copy);
    let mut y_copy0: [u64; 5] = [0u64; 5usize];
    ((&mut y_copy0)[0usize..5usize]).copy_from_slice(&(&aq)[0usize..5usize]);
    crate::hacl::ed25519::add_modq(&mut aq, &rq, &y_copy0);
    crate::hacl::ed25519::store_56(ss.1, &aq)
}
...
pub fn sign(signature: &mut [u8], private_key: &[u8], msg_len: u32, msg: &[u8]) {
    ...
    crate::hacl::ed25519::expand_keys(&mut expanded_keys, private_key);
...
pub fn verify(public_key: &[u8], msg_len: u32, msg: &[u8], signature: &[u8]) -> bool {
    ...
    let b: bool = crate::hacl::ed25519::point_decompress(&mut a·, public_key);
    if b {
        let mut r·: [u64; 20] = [0u64; 20usize];
        let rs: (&[u8], &[u8]) = signature.split_at(0usize);
        let b·: bool = crate::hacl::ed25519::point_decompress(&mut r·, rs.1);
        if b· {
            ...
            crate::hacl::ed25519::load_32_bytes(&mut tmp, sb.1);
            let b1: bool = crate::hacl::ed25519::gte_q(&tmp);
            let b10: bool = b1;
            if b10 {
                false
            } else {
                let mut tmp0: [u64; 5] = [0u64; 5usize];
                crate::hacl::ed25519::sha512_modq_pre_pre2(
                    &mut tmp0, sb.0, public_key, msg_len, msg,
                );
                crate::hacl::ed25519::store_56(&mut hb, &tmp0);
                let mut exp_d: [u64; 20] = [0u64; 20usize];
                crate::hacl::ed25519::point_negate_mul_double_g_vartime(&mut exp_d, sb.1, &hb, &a·);
                let b2: bool = crate::hacl::ed25519::point_equal(&exp_d, &r·);
                b2
            }
        } else {
            false
