...
use libcrux_secrets::{Classify, U64, U8};
    ...
    KeccakXofState<PARALLEL_LANES, RATE, STATE>
{
    ...
    fn absorb_full(&mut self, inputs: [&[U8]; PARALLEL_LANES]) -> usize {
        ...
        if input_consumed > 0 {
            // FIXME
            let tmp = [U8(0); RATE];
            let mut borrowed = [tmp.as_slice(); PARALLEL_LANES];
    ...
    pub(crate) fn absorb_final<const DELIMITER: u8>(&mut self, inputs: [&[U8]; PARALLEL_LANES]) {
        ...
        let input_len = inputs[0].len();
        let mut blocks = [[U8(0); 200]; PARALLEL_LANES];
        for i in 0..PARALLEL_LANES {
            if self.buf_len > 0 {
            ...
            blocks[i][self.buf_len + input_remainder_len] = DELIMITER.classify();
...
const ROUNDCONSTANTS: [U64; 24] = [
    U64(0x0000_0000_0000_0001u64),
    U64(0x0000_0000_0000_8082u64),
    U64(0x8000_0000_0000_808au64),
    U64(0x8000_0000_8000_8000u64),
    U64(0x0000_0000_0000_808bu64),
    U64(0x0000_0000_8000_0001u64),
    U64(0x8000_0000_8000_8081u64),
    U64(0x8000_0000_0000_8009u64),
    U64(0x0000_0000_0000_008au64),
    U64(0x0000_0000_0000_0088u64),
    U64(0x0000_0000_8000_8009u64),
    U64(0x0000_0000_8000_000au64),
    U64(0x0000_0000_8000_808bu64),
    U64(0x8000_0000_0000_008bu64),
    U64(0x8000_0000_0000_8089u64),
    U64(0x8000_0000_0000_8003u64),
    U64(0x8000_0000_0000_8002u64),
    U64(0x8000_0000_0000_0080u64),
    U64(0x0000_0000_0000_800au64),
    U64(0x8000_0000_8000_000au64),
    U64(0x8000_0000_8000_8081u64),
    U64(0x8000_0000_0000_8080u64),
    U64(0x0000_0000_8000_0001u64),
    U64(0x8000_0000_8000_8008u64),
];
