...
class t_KeccakStateItem (v_Self: Type0) (v_N: usize) = {
  [@@@ FStar.Tactics.Typeclasses.no_method]_super_13906339340395649455:Libcrux_sha3.Traits.Internal.t_KeccakItem
    v_Self v_N
}
...
let impl
  ...
  { _super_13906339340395649455 = FStar.Tactics.Typeclasses.solve; __marker_trait = () }
